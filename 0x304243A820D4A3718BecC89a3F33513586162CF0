...
contract CRI3 is Context, ERC20, Ownable {
    ...
    constructor() ERC20 ("Crib Loyalty", "CRI3") {

        _buyProductionFee = 6;
        _buyMarketingFee = 6;
        _buyFilmCribFee = 2;

        _sellProductionFee = 6;
        _sellMarketingFee = 6;
        _sellFilmCribFee = 2;
        ...
        _maxWallet = 5000000 * 10**6 * (10**18);
        _maxBuy = 2500000 * 10**6 * (10**18);
        _maxSell = 2500000 * 10**6 * (10**18);
        ...
        productionWallet = address(payable(0xF264aa6c8d743A1ADC3b6c29Fd8b896f911bff7B));
        marketingWallet = address(payable(0x2d8bb09018D6aCe7B41fDD5ba7a3764B565F5AB5));
        filmCribWallet = address(payable(0x58148B2f3188eDB39b4793a414Ca796012967CBf));
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Crib Loyalty: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Crib Loyalty: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool isBlacklisted) public onlyOwner {
        require(_isBlacklisted[account] != isBlacklisted, "Crib Loyalty: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Crib Loyalty: The Uniswap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Crib Loyalty: Automated market maker pair is already set to that value");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        ...
        require(newMarketingWallet != marketingWallet, "Crib Loyalty: The marketing wallet is already this address");
    ...
    function updateProductionWallet(address newProductionWallet) public onlyOwner {
        ...
        require(newProductionWallet != productionWallet, "Crib Loyalty: The marketing wallet is already this address");
    ...
    function updateFilmCribWallet(address newFilmCribWallet) public onlyOwner {
        ...
        require(newFilmCribWallet != filmCribWallet, "Crib Loyalty: The film crib wallet is already this address");
    ...
    function addLP() external onlyOwner() {
        ...
        updateMaxWallet(1000000000 * 10**6);
        updateMaxBuySell((1000000000 * 10**6), (1000000000 * 10**6));
	...
	function letsGoLive() external onlyOwner() {
        updateBuyFees(6,6,2);
        updateSellFees(6,6,2);

        updateMaxWallet(5000000 * 10**6);
        updateMaxBuySell(2500000 * 10**6, 2500000 * 10**6);
    ...
    function updateMaxWallet(uint256 newMaxWallet) public onlyOwner {
        require(newMaxWallet >= 5000000 * 10**6, "Cannot lower max wallet below .5% of total supply");
    ...
    function updateMaxBuySell(uint256 newMaxBuy, uint256 newMaxSell) public onlyOwner {
        require(newMaxBuy >= 2500000 * 10**6, "Cannot lower max buy below .25% of total supply");
        require(newMaxSell >= 2500000 * 10**6, "Cannot lower max sell below .25% of total supply");
