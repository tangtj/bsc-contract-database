...
contract HeIsAi is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "HEISAI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3c489c061F216bBe33BbCA0d1c8b7F288377b7Af);
    address payable private _marketingAddress = payable(0x3c489c061F216bBe33BbCA0d1c8b7F288377b7Af);
