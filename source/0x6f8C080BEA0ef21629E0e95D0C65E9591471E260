...
contract LaFly is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2588 * 10**9;
    ...
    string private constant _name = "LaFly";
    string private constant _symbol = "LaFly";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xDfF7797C6ED15F1800E0dC9A871D9652328635a6);
    address payable private _marketingAddress = payable(0xDfF7797C6ED15F1800E0dC9A871D9652328635a6);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 1, "Tax cannot be more than 1.");
	    require(taxFeeOnSell < 1, "Tax cannot be more than 1.");
