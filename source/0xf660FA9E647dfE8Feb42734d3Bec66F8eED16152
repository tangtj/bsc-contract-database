...
contract PlutoLink is ERC20 {
    ...
    constructor() ERC20("PlutoLink", "PLUTOLINK", 9, 10**15) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        // Any BNB outside of swaps is seen as donation to dev
        if (leftoverBalance > 0) {
            payable(_creator).transfer(leftoverBalance);
        }
