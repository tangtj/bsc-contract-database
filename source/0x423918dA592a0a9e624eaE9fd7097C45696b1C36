...
contract DefiBuilder is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB5d55d57d5009CCEAecde0626057BCBD873A19d3;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Defi Builder";
    string constant _symbol = "$BUILDER";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x3DdD0c14B4e6200d42B81f7a54Cf6D6fa72Aa946;
