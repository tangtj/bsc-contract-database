...
moonshot x1000 based on elon twet
*/

pragma solidity ^0.8.12;
// SPDX-License-Identifier: Licensed

interface IBEP20ANTIBOTS {
...
contract ElonTitterInu is Context, IBEP20ANTIBOTS, Ownable {
    ...
    mapping (address => uint256) private _ALLOwned;
    ...
    string private constant _name = "Elon Titter Inu"; //
    string private constant _symbol = "ELTINU "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address private _ELONWALLET = 0x557238BAe1945f463115f03665df290b5480d371 ;
    ...
    constructor () {
        _ALLOwned[_msgSender()] = _tOTALSUPPLY;
        ...
        _isExcludedFromFee[_ELONWALLET] = true;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _ALLOwned[address(this)] += marketingFee + liquidityFee;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(_ELONWALLET).transfer(ethToSend);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0)
            payable(_ELONWALLET).sendValue (ethAmount - ethFromLiquidity);
    }
}