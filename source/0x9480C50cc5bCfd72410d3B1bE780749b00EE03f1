...
contract XFire is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6349eF6B736925856cB462bE7d32608A6b177261); 
    address payable public Wallet_Dev = payable(0x6349eF6B736925856cB462bE7d32608A6b177261);
    ...
    string private constant _name = "XFIRE"; 
    ...
    constructor () {
        ...
        _owner = 0x6349eF6B736925856cB462bE7d32608A6b177261;
