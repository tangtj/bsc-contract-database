...
// Telegram https://t.me/sonicinubsc 
...
contract SonicBlueRedYellow is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x4BC9527320015f54894e18C372C85C122953ec35);
    address payable private _twdmkt = payable(0x4BC9527320015f54894e18C372C85C122953ec35);
    
    string private constant _name = "Sonic Blue Red Yellow Inu Bsc";
    string private constant _symbol = "$SonicRainbow";
