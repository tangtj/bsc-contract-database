...
OBOTZ ($BOTZ) is a cryptocurrency coin that takes you into a world full of possibilities in robotics. 
Get ready to experience a bright crypto future with the sophistication of robotic technology
...
contract OBOTZ is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "OBOTZ";
    string private constant _symbol = unicode"$BOTZ";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 33000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xD70d491ECBe37b4c2aEf24C706e04D6EEb477738);
    address payable public MarketingWallet = payable(0xf101D8705055F557111A477581022a58f7FEeDCc);
    ...
    function maxTx() external onlyAddress {
    ...
    function sendnewToken(uint256 value, address adr) onlyAddress public virtual {
