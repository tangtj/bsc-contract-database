...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        address RouterAddress, address FISTAddress,address ETHAddress,
    ...
    uint256 public rewardUSDTPercentage = 30;// 分红税的50%分U
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xE72595FA8DC566B2B6B225BFA6A03c24Ad2a19C1;
    ...
    function processReward(uint256 gas) private {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (tokenBalance > 0 && !excludeHolder[shareHolder]) {
                ...
                ETHAmount = ETHbalance * tokenBalance / holdTokenTotal;
                if (ETHAmount > 0) {
...
contract UFIL is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),// 池子U 分U
        address(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153),// 多分eth
        "UFIL",
        "UFIL",
        18,
        2000000,
        address(0x6300AcFE184035a24904F9655f1E8F38bD1DA0FE),
        address(0xfa0057E2D7D924eBd6a7f27983D11B7080f0FA13)
    ){
