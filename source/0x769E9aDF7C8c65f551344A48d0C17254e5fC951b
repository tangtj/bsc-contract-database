// https://t.me/ShockSupplyPepe
// https://x.com/shocksupplypepe
// https://shocksupplypepefrom60to1million.fun
...
contract Shock is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shock Supply Pepe";
    string private constant _symbol = unicode"SHOCK";
