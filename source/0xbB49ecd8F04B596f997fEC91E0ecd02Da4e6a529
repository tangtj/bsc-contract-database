...
contract NoHomoFOMO is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x1097c1c85A4c77BA7Cfa9abA84A85130e113FCBd;
    ...
    string private _name = "NoHomoFOMO";
    string private _symbol = "NoHomoFOMO";
    ...
    uint256 public _maxWalletToken = 3000000 * 10**6 * 10**9; // 5 trillion max wallet
