...
// https://t.me/CyberInuCoin

// https://cyberinu.finance/
...
contract CyberInuCoin is Context, IERC20, Ownable {
   ...
   uint256 public  buyTotalFees;
    ...
    string private constant _name = unicode"Cyber Inu";
    string private constant _symbol = unicode"CYBERINU";
