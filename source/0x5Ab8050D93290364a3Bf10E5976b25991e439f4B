...
contract TOPAYS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TO PAYS", "TO") {

        address owner = address(0x19A85a06dB12Bb9268D5D079313e20415c954212);
        ...
        maxTransactionAmountBuy = totalSupply * 1 / 1000; // 0.1% maxTransactionAmountTxn
        maxTransactionAmountSell = totalSupply * 1 / 1000; // 0.1% maxTransactionAmountTxn
    	...
    	marketingWallet = address(0xedC4ef356Dbe6c6c235f39FbDF640dB84FAFf90f); // set as marketing wallet
    	buyBackWallet = address(0x327138adE09FC37A8A25D0a1be60C18d7fD51747); // set as buyback wallet
