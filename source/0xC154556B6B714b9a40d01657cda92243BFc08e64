...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x123458C167a371250d325Bd8B1ffF12C8AF692A7); 
...
contract BabyDRAC is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0x123458C167a371250d325Bd8B1ffF12C8AF692A7; //change in two places
    address routerv2 = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyDRAC";
    string constant _symbol = "BRAC";
    ...
    uint256 transferMultiplier = 1300;
