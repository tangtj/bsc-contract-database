...
contract BABYELON is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xF18013527a710bA7e5cE9F0146a9b0B88aa0ff01);
    address payable private _marketingAddress = payable(0xF18013527a710bA7e5cE9F0146a9b0B88aa0ff01);
