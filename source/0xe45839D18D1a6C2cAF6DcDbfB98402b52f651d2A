...
// Telegram     : https://t.me/illumisharesrg
// Certik       : https://skynet.certik.com/mobile/projects/lumishare/info
...
contract LUMISHARE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lumi Share SRG L1";
    string private _symbol = "$Lumi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA6a23E135fcDb7230CA55E3be1b785bE86AeE90A); // Marketing Address
    address payable public teamWalletAddress = payable(0xA6a23E135fcDb7230CA55E3be1b785bE86AeE90A); // Team Address
