...
contract HOP is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOP";
    ...
    address payable private _twddev = payable(0xB425291e440e7Be5a70CBC93C8a096a0D3Ef2F80);
    address payable private _twdmkt = payable(0xB425291e440e7Be5a70CBC93C8a096a0D3Ef2F80);
