...
contract THISIS$FINEBSC is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420000000000000000* 10**9;
    ...
    string private constant _name = "This is $fine bsc";
    string private constant _symbol = "$FIB";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x5Ec01468872AFe00e71dA8Ac985392e9f2608C48);
    address payable private _marketingAddress = payable(0x5Ec01468872AFe00e71dA8Ac985392e9f2608C48);
