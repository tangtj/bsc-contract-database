...
contract tokenname is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x5fF8c3F75f4277f088A90B8D19aDD3CAC551039a);
    ...
    string private _name = "PFTest"; 
    string private _symbol = "PFTest";  
    ...
    uint256 private maxPossibleFee = 100;  //10%
