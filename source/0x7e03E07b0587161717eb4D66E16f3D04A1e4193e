...
contract FairFinance is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 4_900_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "Fair Finance"; //
    string private constant _symbol = "FAFI"; //
    uint8 private constant _decimals = 0; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 4;
    address private _marketingWallet = 0x557238BAe1945f463115f03665df290b5480d371 ;
