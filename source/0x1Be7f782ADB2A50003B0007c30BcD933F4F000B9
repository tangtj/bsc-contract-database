...
-- Telegram: https://t.me/safemoonop

-- Website: https://opsafemoon.com/

-- Twitter: https://twitter.com/safemoonop
...
contract SFMOP is Ownable, ERC20 {
    ...
    string constant _name = "safemoonOP";
    string constant _symbol = "SFMOP";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xD54279c3A777DD571315518b2fe5aF3BcF03F7dC;
