...
contract KetaiCoin is ERC20, Ownable, ReentrancyGuard {
    ...
    address public marketingWallet = 0xf7674092E8970441043051caEc155e6066A10893;
    ...
    constructor() ERC20("Ketaicoin", "Ketaicoin") {
