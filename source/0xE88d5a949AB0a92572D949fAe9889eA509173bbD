...
interface IDEXRouter {
 ...
 contract EmojiInu is IBEP20, Auth {
    ...
    string constant _name = "Emoji inu";
    string constant _symbol = "EI";
    ...
    address private marketingFeeReceiver =0x1DFCAC1Fc5787d43813850235C6A13EA45979dAC;
    address private buybackFeeReceiver =0x94C7306fC92B27833Ab29A1411dFFD2ad3184784;
