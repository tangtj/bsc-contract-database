...
contract SHIBASAGABSC is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2D42CbbDb436Cd7273aE1dE509C09f610Dfa015e); 
    address payable public teamWalletAddress = payable(0x2D42CbbDb436Cd7273aE1dE509C09f610Dfa015e);
    ...
    uint256 public _walletMax = 2 * 10**6 * 10**6* 10**_decimals;
