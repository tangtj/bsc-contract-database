...
contract $369PGT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "$369PurpleGrapeTesla";
    string private _symbol = "$369PGT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xAa6DF7ceFb6Fe2367eCC1fF8eACEc780eC1Ab584);
    ...
    uint256 private _totalSupply = 36942033 * 10**8 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 3333 * 10**_decimals;
