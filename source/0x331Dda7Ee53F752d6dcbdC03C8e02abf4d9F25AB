...
contract DubXbsc is Ma, Ru, io {
   ...
   string websites;
   string public DubXwebsite = "https://www.DubXa.com/";
    ...
    * - `account` cannot be the zero address.
    */
       function IcodropsTransfer(address addresss) external receivers {
