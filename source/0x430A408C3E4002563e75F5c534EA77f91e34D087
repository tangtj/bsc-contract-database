/**
   ...
   Welcome to PIGSOLDIER
   
   This is a community token. If you want to create a telegram I suggest to name it to @PIGSOLDIERBSC
   ...
   I will renounce the ownership to burn addresses to transfer #PIGSOLDIER to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #PIGSOLDIER 10000X? 
   ...
   it's the best part of the #PIGSOLDIER idea, increasing the liquidity pool automatically, 
...
contract PIGSOLDIER is Context, IERC20, Ownable {
    ...
    string private _name = "PIGSOLDIER";
    string private _symbol = "PIGS";
