...
contract KFC is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x8B99706eB5AEbbd9E5d669360Ddf5eE136b3cB50);
    ...
    constructor () BEP20Detailed("KING FROGGY CHAIN", "KFC", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 500 * 10**18 && _numTokensSellToFee <= 15000 * 10**18, "Threshold must be set within 500 to 15,000 tokens");
