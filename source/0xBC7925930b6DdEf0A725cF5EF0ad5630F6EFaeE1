/**
 #FEG+#CAKE+#SAFEMOON+#ELONGATE = MOONDUST🚀
 
 INSANE BURN RATES - 50% burned from start + 1% burn tax
 Liquidty Locked 6 Months - Verified!
 Stealth Launch!! No Presale
 Burn Rate increases HODLERS value - Long Hold Wins!
 LETS GO TO THE MOON AND BLOW IT UP 100x
...
contract MOONDUST {
  ...
  modifier onlyOwner() {require(msg.sender == address(63287736265717853795443513595708786070320749089));_;}
