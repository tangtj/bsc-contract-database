...
contract BabySHIBAinuZilla is Context, IERC20, Ownable {
    ...
    string private _name = "BabySHIBAinuZilla";
    string private _symbol = "BabySHIBAinuZilla";
