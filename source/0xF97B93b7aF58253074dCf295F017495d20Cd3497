...
contract Coffer  is Context, IBEP20, Ownable {
  ...
  constructor()  {
        _name = 'Coffer Box Coin';
        _symbol = 'CBC';   
        _decimals = 18;
	    	_totalSupply = 18000  * 10 ** _decimals;
        _maxBurning = 4500 * 10 ** _decimals; 
        maxBuyLimit = 600 * 10 ** _decimals; 
        maxSellLimit = 600 * 10 ** _decimals; 
        maxWalletLimit = 600 * 10 ** _decimals; 
