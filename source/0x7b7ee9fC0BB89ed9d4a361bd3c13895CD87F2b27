/**
Telegram: https://t.me/SpacePanda_BSC
...
contract SpacePanda is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "SpacePanda";
    string constant _symbol = "SPAND";
    ...
    address public devFeeReceiver = 0x415a6E67EE5b5Bd266Cac3b5b30A799C935A9dB9;
    address public buybackFeeReceiver = 0x415a6E67EE5b5Bd266Cac3b5b30A799C935A9dB9;
