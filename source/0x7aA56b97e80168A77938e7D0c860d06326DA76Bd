...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"TAO";
    string private _symbol = unicode"TAO";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x76e093e265574f8fa8f292812C0a44E50E6AB93F); 
    address payable public BurnedWalletAddress = payable(0x76e093e265574f8fa8f292812C0a44E50E6AB93F); 
