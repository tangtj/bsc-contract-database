...
contract Doge3 is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0xA828314168403eFd76E65209938cEfF1a431b0F5);

    address payable private cxWallet =
        payable(msg.sender);
    ...
    //Token Definition.
    string public constant name = "Doge 3.0";
    string public constant symbol = "Doge3.0";
    ...
    uint256 private totalMarketingTokensCollected = 0;

    uint256 private minimumTokensBeforeSwap = 1_000_000 ether;
    ...
    constructor() {
        ...
        //Exclude from fees the owner, contract, wallet and marketing.
