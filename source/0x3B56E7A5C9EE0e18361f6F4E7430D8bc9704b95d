...
contract FukuToshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FukuToshi";
    string private _symbol = "FUKU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xd2Db796a20BE3d70634eCe091009dFA2859C0007);
    address payable public teamWalletAddress =
        payable(0x522Db3CE9003C609Eb764De584390b3743F0a66E);
