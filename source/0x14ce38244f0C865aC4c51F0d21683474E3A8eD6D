...
contract XrpGold is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Xrp Gold";
    string private _symbol = unicode"XRPGOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x729D9b7502B7f66c83BdB6Cd1cE52bA7b449805B);
    address payable public teamWalletAddress =
        payable(0xD7A92A91485BD0Db0dB58C41F39eE2C054422596);
