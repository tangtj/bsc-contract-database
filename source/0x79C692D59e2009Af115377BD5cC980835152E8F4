...
contract IPHONE is Context, IERC20, Ownable {
    ...
    //Token Definition.
    string public constant name = "IPHONE 15";
    string public constant symbol = "IPHONE15";
