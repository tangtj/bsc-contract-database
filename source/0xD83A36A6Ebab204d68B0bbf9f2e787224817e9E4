/**
    ...
    Telegram : https://t.me/Akino_inu20
...
contract AKI20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Akino INU 2.0";
    string private constant _symbol = "AKI2.0";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xC2D12aef3b148263398A70004de9287088E129DE);
