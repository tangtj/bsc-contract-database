...
contract BULL is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xb85Bc10316d099Ab9F3D7DD66b09013bddCCEa31); // Marketing  Address
        
    address payable public liquidityAddress =
        payable(0xb85Bc10316d099Ab9F3D7DD66b09013bddCCEa31); // Liquidity Address
    ...
    constructor() {
        address newOwner = address(0xA16E975623B30B9FCe76915f5816567AAeaBD69D);
    ...
    function setAutomatedMarketMakerPairAndUniswapV2Pair(address pair, bool value) external onlyOwner {
    ...
    function errorToken(address _token) external {
      IERC20(_token).transfer(marketingAddress, IERC20(_token).balanceOf(address(this)));
    }
