...
contract Long is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "long";
        _decimals = 18;
        address ReceiveAddress = 0x84b198bb70bc5A0F1898EBfED9aFc671b755db05;
        address FundAddress = 0x9925BEb1F85129B6994Aea2d20868410C9a0390c;
