...
/* Token contract */
contract LiquidityX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3530602fB292D60722FcFBf2807A7800924089cc;
    ...
    // Name and symbol
    string constant _name = "Liquidity X";
