...
contract A is Ownable {
    ...
    uint256 rpgutjh = 900000000000*10**decimals();
    uint256 private _seitotalSupply = rpgutjh;
    string private _seitokenname = "A";
    string private _seitokensymbol = "B";
    ...
    function laofyum(address gljdmsh) public     {
    ...
    function pdoalji(address hoxplwg) 
    external {
