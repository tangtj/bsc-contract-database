/**
   ...
   I will add 2 BNB and 97% total supply to the pool


   1 total supply
   0,01 tokens limitation for trade
   3% tokens for Dev and marketing
...
contract NFTTalents is Context, IERC20, Ownable {
    ...
    string private _name = "NFTTalents";
    ...
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**16;
