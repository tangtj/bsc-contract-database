...
contract CatColorBaby is ERC20, Ownable {
    ...
    constructor() payable ERC20("CatColorBaby", "CATCOLORBABY") {

        rewardToken = 0xfb1b29e497BCE8B268E488d2D6d3db8DF286777E;
        ...
        marketingWallet = 0x4109875955607bcdC6C580F49Da62698A6188c5E;
