...
contract ETH2 is ERC20, Ownable {
    ...
    constructor() payable ERC20("ETH 2.0", "ETH 2.0") {
        ...
        MKTWallet = 0x46Cb9C482fb867a332845bad257792abF86155F5;

        dividendTracker = new DividendTracker(1000_000_000, rewardToken);
    ...
    function excludeFromFees(address account, bool excluded) internal onlyOwner {
