/**
  ...
  Telegram : https://t.me/ThePriceIsWrong

  Twitter :  https://twitter.com/ThePr1ce1sWrong

  Website :  https://cryptosite.pro/ThePr1ce1sWrong

  Promo :    https://t.me/AlphabetCalls
...
contract ThePr1ce1sWrong is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ThePr1ce1sWrongDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ThePr1ce1sWrong", "$itch") {
        marketingWallet = payable(0x41626c823c5D64260ECe9a4E84ad69DB87CCD782);
        CommunityWallet = payable(0x2A5E7Be1c2Ff5b366e540Dc0270F9FB4E5877a95);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 1;
        sellDeadFees = 1;
        buyMarketingFees = 14;
        sellMarketingFees = 24;
        buyLiquidityFee = 0;
        sellLiquidityFee = 0;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new ThePr1ce1sWrongDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "ThePr1ce1sWrongTRACKER",
            "ThePr1ce1sWrongTRACKER"
        );
...
contract ThePr1ce1sWrongDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ThePr1ce1sWrong public ThePr1ce1sWrongContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ThePr1ce1sWrongContract = ThePr1ce1sWrong(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ThePr1ce1sWrong_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ThePr1ce1sWrong_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ThePr1ce1sWrong contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ThePr1ce1sWrongContract);

            uint256 prevBalance = ThePr1ce1sWrongContract.balanceOf(address(this));
            ...
            {
                uint256 received = ThePr1ce1sWrongContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ThePr1ce1sWrongContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
