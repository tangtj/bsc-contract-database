...
contract blockreum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "blockreum";
    string private _symbol = "BLC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0585f9dB55827D503F91a50d5039b1dc7E00b934);
    address payable private DevelopmentWalletAddress = payable(0x0585f9dB55827D503F91a50d5039b1dc7E00b934);
