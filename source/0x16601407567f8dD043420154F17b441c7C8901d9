...
contract Bitcoin is Ownable, IERC20 {
    ...
    string constant private _symbol = "BTC";
    ...
    constructor() {
        ...
        marketingWallet = 0xAE2E73501947d7BC9dC6c1c0c0C2a352a9E10b53;
        devWallet = 0x91d387E5FF59b25f898390444826BA12b1E94429;
        teslaWallet = 0x9c7c25eb282b0fe148aD875d631655C4E02a9533;
        nativeWallet = 0xAE2E73501947d7BC9dC6c1c0c0C2a352a9E10b53;

        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(Fee).add(nativeFee).add(devFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBTesla = amountBNB.mul(Fee).div(totalBNBFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDevFee, uint256 newFee, uint256 newNativeFee, uint256 extraSellFee) external onlyOwner {
        ...
        totalFee = liquidityFee.add(marketingFee).add(devFee).add(Fee).add(nativeFee);
