...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4467478a7A5C2092dD4EE85720C8eaA88E801b64; // owner address
...
contract PepeGoMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeGoMoon";
    string private _symbol = "$PGM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x069baCfab87f977E9820f11fd83534B0B7f7dB17); 
    address payable public teamWalletAddress = payable(0x4467478a7A5C2092dD4EE85720C8eaA88E801b64);
