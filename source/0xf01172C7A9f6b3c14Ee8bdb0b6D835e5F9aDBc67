//Project Name: Almoctar (AMC)
//Contract Name: Almoctar 
//Total Supply: 50 Million
//Telegram: https://t.me/AlmoctarAmcOfficial
//Twitter: https://twitter.com/AlmoctarAmc
//Website: https://almoctar.com/
...
contract Almoctar is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    AlmoctarDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Almoctar", "AMC") {
        marketingWallet = payable(0x32c9d4dB1650268035Df6735b603393860a9eE21);
        devWallet = payable(0x32c9d4dB1650268035Df6735b603393860a9eE21);
        ...
        dividendTracker = new AlmoctarDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply * 5 / 100; // 5% 
...
contract AlmoctarDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Almoctar public AlmoctarContract;
    ...
    constructor(
        ...
        defaultToken = token;
        AlmoctarContract = Almoctar(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Almoctar_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Almoctar_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Almoctar contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(AlmoctarContract);

            uint256 prevBalance = AlmoctarContract.balanceOf(address(this));
            ...
            {
                uint256 received = AlmoctarContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    AlmoctarContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
