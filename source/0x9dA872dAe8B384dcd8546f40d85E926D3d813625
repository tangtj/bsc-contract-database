/**
 Telegram: https://t.me/spurdo_bsc
*/
...
contract Spurdo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe9f967C490A628337B7c265b2952E9638e06A6F2); // Marketing Address
    address payable public teamWalletAddress = payable(0xe9f967C490A628337B7c265b2952E9638e06A6F2); // Team Address
    ...
    uint256 private _sellMaxTxAmount = 40000000 * 10**_decimals; 
