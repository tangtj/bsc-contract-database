...
contract Xshiba is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 420_699_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0x69Bfe8758a8B2E24Bc88C5908FD8994ffa5aAc5F);


    IRouter02 public swapRouter;
    string constant private _name = "Xshiba";
    string constant private _symbol = "Xshiba";
