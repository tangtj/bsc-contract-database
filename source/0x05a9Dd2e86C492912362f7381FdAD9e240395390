/**
   Welcome to TWISTER DOGE a puppy made   
   of ballons, twisted and turned into a 
   different shape on BSC Chain.
  TELEGRAM: https://t.me/TwisterDoge_BSC
*/
...
contract TwisterDoge is Context, IBEP2022, Ownable {
