...
contract Shibarium is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3b40d0b4f63Bec66B2b18ad69Fd58a2E12Dd4A2B); 
    address payable private Wallet_Dev = payable(0x3b40d0b4f63Bec66B2b18ad69Fd58a2E12Dd4A2B);
    ...
    string private constant _symbol = unicode"SHIBNET"; 
    ...
    constructor () {
        ...
        _owner = 0x3b40d0b4f63Bec66B2b18ad69Fd58a2E12Dd4A2B;
