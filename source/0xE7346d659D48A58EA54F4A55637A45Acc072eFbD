/**
  ...
  Telegram : https://t.me/J33t3rsPay

  Twitter :  https://twitter.com/J33t3rsPay

  Project Owner : https://cryptosite.pro/beastmodegod/vc
...
contract J33t3rsPay is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    J33t3rsPayDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 0; //default cooldown 0
    ...
    constructor() ERC20("J33t3rs Pay", "J33t3rs Pay") {
        marketingWallet = payable(0x650d69a1E2E4FCaE0e5eF928c452F61213AF3A21);
        CommunityWallet = payable(0xBdc48BfEd2C237d9d099F97D4Bb417176cC3267C);
        ...
        dividendTracker = new J33t3rsPayDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (333_333) * (10**18);
    ...
    function updateFees(
        ...
        require(totalSellFees <= 31 && totalBuyFees <= 31, "total");
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling) {
                ...
                if (limitsInEffect) {
                require(block.number > launchblock + 8,"So sorry. Please try again.");
...
contract J33t3rsPayDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    J33t3rsPay public J33t3rsPayContract;
    ...
    constructor(
        ...
        defaultToken = token;
        J33t3rsPayContract = J33t3rsPay(mainContract);
    ...
    function _transfer(
        ...
        require(false, "J33t3rsPay_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "J33t3rsPay_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main J33t3rsPay contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(J33t3rsPayContract);

            uint256 prevBalance = J33t3rsPayContract.balanceOf(address(this));
            ...
            {
                uint256 received = J33t3rsPayContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    J33t3rsPayContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
