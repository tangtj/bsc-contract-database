...
/**
   Two token features GiraffeMoon:
   ...
   Let's get this coin to 100,000x
 */
...
contract GiraffeMoon is Context, IERC20, Ownable {
    ...
    string private _name = "GiraffeMoon";
    string private _symbol = "GRFM";
