...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * 10**9 * 10**9; // 1 Billion
    ...
    uint256 public _numTokensSellToAddToLiquidity = 20 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 200 * 10**6 * 10**9; 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'DogelonNightLive';
    string private _symbol = 'DOGENL';
