...
contract ASNDAO is Token {
    constructor() ERC20(
        "ASNDAO",   // 名字
        "ASNDAO"        // 符号
    ) {
        uint256 _totalSupply = 50000 ether; // 发行量 1e11 个
        address _marketing = address(0xB18aA5770A42967C0bB3dC47d6A59E25fBa3Ca9c); // 营销钱包
