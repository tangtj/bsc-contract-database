...
🍑Welcome to BIG BOOBS COIN🍑 $BBC, a cryptocurrency that doesn't just change the way you think about finances, 
but also drives significant growth in every aspect of your life.

💦Renounced Contract After Launch
💦LP Locked
💦Low Tax 4/4
💦Supply 34.000.000 
💦Massive Marketing
💦Token Burn After Launch 
**/
...
contract BIGBOOBSCOIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BIG BOOBS COIN";
    string private constant _symbol = unicode"$BBC";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 34000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x72d7a2200d4fE0Fdbe5Cefcbbb6048e03aDC6f5E);
    address payable public MarketingWallet = payable(0xef47Ad2c6c4e94478Ca1AC8571E095854736D405);
    ...
    function newFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
