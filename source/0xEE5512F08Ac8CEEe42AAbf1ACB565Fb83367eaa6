...
contract Sanzijing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sanzijing";
    string private _symbol = "SZJ";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x4C5DdD96F212f0c1538B8Fac67FCDbcb789254E4); 
    address payable public ttWal = payable(0x4C5DdD96F212f0c1538B8Fac67FCDbcb789254E4); 
    ...
    uint256 private _totalSupply = 3333 * 10**_decimals;
    uint256 public _maxTxAmount = 3333 * 10**_decimals; 
    uint256 public _walletMax = 3333 * 10**_decimals;
