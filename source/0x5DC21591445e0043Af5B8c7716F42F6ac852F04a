...
contract simpsonpower is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SIMPSON POWER";
    string private constant _symbol = unicode"Spower";
