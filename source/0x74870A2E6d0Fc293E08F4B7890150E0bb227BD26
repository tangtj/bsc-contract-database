...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _approve(
        ...
        require(owner != address(0), "ERC20: approve from the zer address");
        require(spender != address(0), "ERC20: approve to the zer address");
...
abstract contract Ownable is Context {
    ...
    constructor() {
        _setOwner(0xDc186AD62D2F23e3FcFbBC80A52F33e974eBf098);
    }
...
contract WebTourToken is ERC20, Ownable {
    ...
    address public marketingWalletAddress =
        0xDc186AD62D2F23e3FcFbBC80A52F33e974eBf098;
    ...
    constructor() payable ERC20("WebTour Token", "WTT", 18) {
        uint256 totalSupply_ = 5e7 * 10 ** 18;
