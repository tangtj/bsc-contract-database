...
contract ClasterCryptex is Context, IERC20, Ownable {
    using SafeMath for uint256;
    // Claster
    string private constant _name = "ClasterCryptex";
    string private constant _symbol = "CLCR";
    ...
    address payable private _ClasterFourthSAddress =
        payable(0xC8f0582A971e88912BC0225Be5963E3D28168fc3);
    ...
    uint256 public _maxTAClaster = 25000000000 * 10 ** 9;
