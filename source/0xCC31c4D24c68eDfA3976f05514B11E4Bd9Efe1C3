...
//Dogecoin v3 features:
   //3% fee auto distribute to all holders
   //100% Supply is burned at start.

   //https://t.me/DogeCoinBep20
   //https://twitter.com/DogeCoinV3Bep20
   //https://www.dogv3.site/
...
contract DOGEV3 is IERC20, Ownable {
    ...
    string _name = "DOGE COIN V3";
    string _symbol = "DOGE3";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x0fc5e8A866378b35Afd66C239fBD3066ddc7d06C;
        marketingFeeReceiver = 0x0fc5e8A866378b35Afd66C239fBD3066ddc7d06C;
