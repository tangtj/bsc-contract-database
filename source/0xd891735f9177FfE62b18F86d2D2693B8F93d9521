...
*/
/**
 🌐OritoNetwork is a groundbreaking blockchain 
...
contract OritoNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "OritoNetwork";
    string private _symbol = "ORT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0x9567B9cB7185a54c23896Afe8aC7f78336a00735);
