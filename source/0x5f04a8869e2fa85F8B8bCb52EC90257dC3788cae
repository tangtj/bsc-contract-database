...
contract Satoshi is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0x04Ca40f8fFF2da720f8087E684ED31919E75E6c3);
    address public liquidityreceiverWallet = 0x06ad731A5E734811679ACfD4F37DF422debbC80E;

    string private _name = "Satoshi Tears";
