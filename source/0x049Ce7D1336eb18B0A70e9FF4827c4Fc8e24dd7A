/*
獨角獸 - Dú jiǎo shòu is a meme token launched on the BSC chain, celebrating the Moon Festival . 

📝 Twitter : twitter.com/DuJiaoShouBSC

🌐 Website : dújiǎoshòu.online

✉️Telegram : t.me/Dujiaoshou_Bsc
*/
...
contract Djioshu is Context, IERC20 {
    string private _name = unicode"Dújiǎoshòu";
    string private _symbol = unicode"$Dújiǎoshòu";
    ...
    address payable public MarketingWallet = payable(0x6CEfb93E53Cb717366cBfC737a9930Db671e464b);
