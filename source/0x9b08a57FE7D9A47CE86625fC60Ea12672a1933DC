...
/**
Telegram: https://t.me/alpha
X (Twitter): https://twitter.com/alpha
...
contract Beta is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x0C2aDDe2343E6b05f474786a2809934eDe848ee8); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0C2aDDe2343E6b05f474786a2809934eDe848ee8); // Team Address
        
    address payable public liquidityAddress =
        payable(0x0C2aDDe2343E6b05f474786a2809934eDe848ee8); // Liquidity Address
    ...
    string private constant _name = "Beta Coin";
    ...
    uint256 private minimumTokensBeforeSwap = 20000 * 10**9; // 0.07%
    ...
    constructor() {
        ...
        maxTransactionAmount = 2000000 * 10**9; 
        maxWallet = 2000000 * 10**9; 
