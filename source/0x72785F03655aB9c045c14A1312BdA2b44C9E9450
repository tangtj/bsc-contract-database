...
contract PepeOgVsDogeOg is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PEPE OG VS DOGE OG";
    string private _symbol = unicode"PEPEVSDOGE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xF30f6e40e0aE43E2e077E686e6Da6F6441aBCBf3);
    address payable private taxWallet2 = payable(0xF30f6e40e0aE43E2e077E686e6Da6F6441aBCBf3);
