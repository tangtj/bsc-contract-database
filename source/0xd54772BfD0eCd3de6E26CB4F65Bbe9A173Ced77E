...
contract BTGCASH is Context, IERC20, Ownable {
    using Address for address;

    address payable public DerpWallet =
        payable(0xAcC1FEDf19D065dffc54a2945dfaE3d8C63b9C4B);
    ...
    string public constant name = "BTGCASH";
    ...
    uint256 public minimumTokensBeforeSwap = 0.01 ether;
