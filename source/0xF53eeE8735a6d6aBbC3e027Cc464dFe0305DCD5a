...
contract COMMUNISM  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8BFF28B27AAc10eCDb06fb1f8e5EE5462025387d); 
    address payable public Wallet_Dev = payable(0x8BFF28B27AAc10eCDb06fb1f8e5EE5462025387d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42000* 10**9* 9**10 * 10**_decimals;
    string private constant _name = "CM"; 
    ...
    constructor () {
        _owner = 0x8BFF28B27AAc10eCDb06fb1f8e5EE5462025387d ;
