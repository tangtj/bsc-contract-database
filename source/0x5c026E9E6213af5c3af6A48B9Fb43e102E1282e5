...
contract MooMoohHelperV3 is permission {
    ...
    address HelperV2 = 0xc1762C19EBabd70f59cb7AB1Cf28A6E83D88Dadf;

    uint256 public current_price = 150000;
    ...
    function presaleClaimed(address account) public view returns (uint256) {
        return IHelper(HelperV1).presaleClaimed(account) + IHelper(HelperV2).thisClaimed(account) + thisClaimed[account];
    }
    ...
    function update_Price(uint256 amount) public forRole("owner") returns (bool) {
