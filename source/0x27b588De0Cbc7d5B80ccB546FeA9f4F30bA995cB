...
contract YooshiGrow is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x2a8968611b1eBCF0Ae576c343AD8f2fDa386bEc1);
    address payable private _marketingAddress = payable(0x2a8968611b1eBCF0Ae576c343AD8f2fDa386bEc1);
