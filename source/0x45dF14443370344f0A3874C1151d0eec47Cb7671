...
contract ERC20PledgeToken is Ownable{
    ...
    address public  uniswapV2Pair = address(0x166B894D7d4F4A7Dff1ce847a62180693ef73682);
    ...
    address public token = address(0xDbd06a93f165b64B8691faDB23357B24c26f020F);
