...
/**
TELEGRAM : https://t.me/GreenDildo_BSC
TWITTER : https://twitter.com/Greendildo_BSC
WEBSITE : https://greendildo.my.canva.site/
*/
...
contract GreenDildo is Context, IERC20, Ownable {
    ...
    string private constant _name = "GrrenDildo";
    string private constant _symbol = "GreenDildo";
    ...
    address public marketingAddress = 0x1616C0f46E9cEcC4116019d243f88CD844948461; // Marketing Fee Receiver
    ...
    Taxes public Buytaxes = Taxes(3,5,1,2);
    Taxes public sellTaxes = Taxes(3,19,1,2);
