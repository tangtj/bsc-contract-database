...
contract LiqBurnt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"LIQ BURNT";
    string private _symbol = unicode"LIQBURNT";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x8b6bDab22A7534cE49E184039E55585c02e13818);
    address payable private taxWallet2 = payable(0x8b6bDab22A7534cE49E184039E55585c02e13818);
    ...
    uint256 public _walletMax = _totalSupply*500/10000;
