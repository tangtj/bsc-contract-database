//Telegram: https://t.me/INFINITUM_BSC
//X: https://twitter.com/BSC_Infinitum
...
contract Ownable is Context {
   ...
   constructor () {
        _owner = 0xEc2F3c1F0EEa25bd61aB98766211EE050EDde6d6;
...
contract Infinitum is Context, IERC20, Ownable {
    ...
    string private  _name = "Infinitum";
    string private  _symbol = unicode"∞";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90E2CCC531ec48FF445fab6D8C03e8AAc378FE7b); // Marketing
    address payable public teamWalletAddress = payable(0xEc2F3c1F0EEa25bd61aB98766211EE050EDde6d6); // Team
    ...
    function set_Distribution_Settings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newTeamShare) external onlyOwner() {
        ...
        require(_totalDistributionShares <= 60, "Total distribution is over 60%");
    }
