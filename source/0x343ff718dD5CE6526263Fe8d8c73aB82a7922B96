...
contract XPRO_PEPE is IERC20, Ownable, LibreMount {
    ...
    uint256 private _totalSupply =  500000000000000000000000000000; //Wei

    string private _name = "XPRO_PEPE";
