...
contract KITTY is IBEP20, Auth {
    ...
    string constant _name = "Kitty Gold";
    string constant _symbol = "KIG";
    ...
    address private marketingFeeReceiver = 0xBb960323B3d22183130ed751eb0e3B48717fa5C1;
    address private teamFeeReceiver = 0x531b7DFc8cF8Ed328EFB8174B41a955DbAF4fa7e;
