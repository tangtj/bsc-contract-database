/**
 ...
 Telegram @doxxedofficial @doxUpdates Backup @thedoxxed  
...
contract DOXXED is Context, IBEP20, Ownable {
    ...
    string private _name     = "DOXXED";
    string private _symbol   = "DOX";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee       = 2; 
    uint256 public _liquidityFee = 8; 
    uint256 public _percentageOfLiquidityForMarketing = 63; 
