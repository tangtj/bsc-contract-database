...
contract Bshitc is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420e12 * 10**9; //369 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private zeroFee; //0%
    uint256 public treasury1Fee = 6; //6%
    uint256 public treasury2Fee = 6; //6%
    uint256 public protocolFee = 6; //gowth hacking(3%) + protocol(3%)
    uint256 private prevProtocolFee; //gowth hacking(3%) + protocol(3%)
    address payable public treasury1; //6%
