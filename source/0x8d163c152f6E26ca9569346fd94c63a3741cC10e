...
contract COOSHAAURORA is IERC20, Context, Ownable {
    ...
    string private constant _symbol = "COOSHA";
    string private constant _name = "Coosha Aurora";

    uint256 public Coosha_max_BuyLimit = 10000000 * 10**9;
    uint256 public Coosha_max_SellLimit = 10000000 * 10**9;

    address public Coosha_Aurora_Wallet = 0xA8d12Aa57F347A6CD3eEfdA0aDb0B3B703188888;
    address public Coosha_Team_Wallet = 0x1E7D723F72829cAc2FF1DE660604c09041c17777;
