...
contract SCToken is ExcludedFromFeeList, LpDividendBNB, BlackList, FirstLaunch, MaxHave {
    uint256 public numTokensSellToAddToLiquidity = 0.1 ether;
    address public lpReceiver = address(0x53DEED317B7d02d9E22341F68D6C7B037f1C9e12);

    address constant marketAddr = address(0xCc716F74412c48BE6fdD31Cb1989E509267f565C); //5‰
    ...
    constructor() payable Owned(msg.sender) ERC20("FHS", "FHS", 18, 1888 ether) {
