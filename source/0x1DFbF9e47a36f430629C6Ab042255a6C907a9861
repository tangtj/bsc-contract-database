...
contract Bitex is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x04D67Da8eD3A357Bd88eE89d9e89dcD0Ef66F4D2); 
    address payable public Wallet_Dev = payable(0x04D67Da8eD3A357Bd88eE89d9e89dcD0Ef66F4D2);
    ...
    string private constant _symbol = unicode"BITEX"; 
    ...
    constructor () {
        ...
        _owner = 0x04D67Da8eD3A357Bd88eE89d9e89dcD0Ef66F4D2;
