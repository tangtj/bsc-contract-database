...
contract GeniusTradeUSD is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor()
        ERC20("Genius Trade USD", "GTUSD")
        ERC20Permit("Genius Trade USD")
    {
