/*
Official Community: 
   https://t.me/mugiwaraportal
   https://mugiwaranoluffy.com
   https://twitter.com/MugiwaraNetwrk 
*/
...
contract MUGIWARA is IERC20, Context, Ownable {
    ...
    string private constant _name = "Mugiwara Network";

    uint256 public Max_Buy_Limit = 10000000 * 10**9;
    uint256 public Max_Sell_Limit = 10000000 * 10**9;

    address private Marketing_Wallet = 0x795B9e118B48B6630dc270a9Ba2Ca1EFc654a823;
    address private Team_Wallet = 0xEFA1bb30a82c3a8ADD5D06880D6471E72d71dC47;
    ...
    Taxes public sellTaxes = Taxes(0, 35, 5, 0);
