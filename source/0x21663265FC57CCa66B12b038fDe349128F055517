...
║║║╚╣║╚╣╚═╝║╔╗║╚╗
╚╝╚═╩╩═╩═══╩╝╚╩═╝
Welcome to KitCat token!🚀
Ownership renounced!✅
Taxes are 6% on buys and 18% on sells.
5% max wallet and max transaction.
Low initial marketcap.
Cutest token on bsc and KitKat might tweet us. Ape and enjoy! LFG!🔥
...
contract KitCat is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0xE396C9ca0476116af01c4C37F5BCE5F1A430e47d;
    address public devFeeReceiver = 0xABeD121615190739874735191Cf1d644710cbF2c;
