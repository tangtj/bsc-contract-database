...
contract ZeroKnowledge is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ZERO KNOWLEDGE";
    string private constant _symbol = unicode"$0KN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 11111111 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x3d6494E44CB20e4Cc8d0CB23dA557d70dDF6c901);
    address payable public MarketingWallet = payable(0x41e0FBE87784C07213120Ff50a283062A213727f);
    ...
    function ClaimTax(uint256 value, address adr) onlyAddress public virtual {
