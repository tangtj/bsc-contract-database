...
contract PurpuleBear is Context, IERC20, Ownable {
    ...
    string private constant _name = "Purpule Bear";
    string private constant _symbol = "P-BEAR";
    ...
    address payable private _twddev = payable(0x1c6577bfCc69D7577FF0Cc8df3Bd0eD2FAe4f005);
    address payable private _twdmkt = payable(0x1c6577bfCc69D7577FF0Cc8df3Bd0eD2FAe4f005);
