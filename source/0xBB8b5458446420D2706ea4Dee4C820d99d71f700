...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc99965460287FA3fDF2CD2FaeFaB1f2Ae5dc48ac; // owner address
...
contract Shibariburn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibariburn";
    string private _symbol = "Shiburn";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc99965460287FA3fDF2CD2FaeFaB1f2Ae5dc48ac); // Marketing Address
    address payable private teamWalletAddress = payable(0xc99965460287FA3fDF2CD2FaeFaB1f2Ae5dc48ac); // Team Address
