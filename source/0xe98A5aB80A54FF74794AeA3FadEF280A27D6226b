...
contract USDTStake {
    ...
    constructor(IERC20 _busd, address powerwallet, address wallet, uint startDate) {
        ...
        plans.push(Plan(7, 112, 100));
        plans.push(Plan(14, 125, 2000));
        plans.push(Plan(30, 145, 5000));
        plans.push(Plan(45, 158, 10000));
        plans.push(Plan(60, 181, 10000));
        plans.push(Plan(75, 206, 30000));
        plans.push(Plan(90, 223, 50000));
        plans.push(Plan(120, 265, 100000));
