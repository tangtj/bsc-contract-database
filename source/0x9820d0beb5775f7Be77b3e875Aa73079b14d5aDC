...
contract OralPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OralPepe";
    ...
    address payable public marketingWalletAddress = payable(0x8647ce9Abd990eb1d44572509d4ff220ed88d225); // Marketing Address
    address payable public teamWalletAddress = payable(0x8647ce9Abd990eb1d44572509d4ff220ed88d225); // Team Address
