...
contract BitminerFinancial is ERC20, Ownable {

    mapping(address => bool) public liquidityPool;


    address public rewardsPool;
    address public developmentWallet = 0xA5dC576bD199a209ec18dDcc3A499328C4b77F95;
    uint public constant PERCENT_DIVIDER = 1000;
    uint public constant BUYTAX = 0;
    uint public constant SELLTAX = 60;


    event changeLiquidityPoolStatus(address lpAddress, bool status);


    constructor() ERC20("Bitminer Financial", "BIT") {
