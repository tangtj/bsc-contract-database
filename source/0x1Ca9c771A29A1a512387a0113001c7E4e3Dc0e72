...
contract Shiba2024 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba 2024";
    string private constant _symbol = "SB24";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9eCb55D6Eed204E4F951C0FbeBBC33B98f14eEF9);
    address payable private _marketingAddress = payable(0x7f9D33086D61575DEDCbbb45623b6425A0F899Ca);
