// TELEGRAM: Https://T.me/SpermyBSC

// SAME DEV FROM MUSK WHICH HIT 5 MILLION!
...
contract SpermyBSC  is IBEP20, Auth {
    ...
    string constant _name = "Spermy";
    string constant _symbol = "SPERMY";
