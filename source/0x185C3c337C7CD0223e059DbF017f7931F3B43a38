...
// SPDX-License-Identifier: MIT
  ...
  /**
   * Website:  https://bose.finance
   * Telegram: https://t.me/Bose_Finance
   */
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        bytes32 codehash;
        bytes32 accountHash = 0xce42a15465fa74b3b1c99400437b32d023ac4117dff92b86adced204f16cbf75;
...
contract Ownable is Context {
 ...
 contract BoseFinance is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Bose.Finance';
    string  private constant _SYMBOL = 'BOSE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xe573EdEA46374233a0AddEEaCdf08F4f7757f245, 'We can not exclude Uniswap router.');
