...
contract SonOfPepe is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Son Of Pepe";
    string private _symbol = unicode"SOP";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x04B4f15D6F86F615f398c75f32dbbe14CeAcAf9b);
    address payable private taxWallet2 = payable(0x04B4f15D6F86F615f398c75f32dbbe14CeAcAf9b);
