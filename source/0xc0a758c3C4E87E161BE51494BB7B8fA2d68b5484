//  https://t.me/PepeProphecybsc
//Twitter:https://x.com/PepeProphecyx
//Website:http://pepeprophecy.tech/
...
contract PEPEPROPHECY is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Prophecy", unicode"KEK") {
        ...
        maxTransactionAmount = 126207 * 1e5 * 1e18; 
        maxWallet = 126207 * 1e5 * 1e18; 
        ...
        devWallet = address(0xbdAeb4859bE38Bb2c0C077024d7BCcB83F081ca2); 
