...
contract gum is Ownable, IERC20 {
    ...
    string constant private _name = "gum";
    string constant private _symbol = "gum";
    ...
    constructor() {
        ...
        nativeWallet = 0x13e7D50CAdA80499C4f79556975Ce65dA48564f8;//  deployer
