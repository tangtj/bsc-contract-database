...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeWhiteList[address(0x1Af74478581ce09Da837A14DD68c9Fe44cA460ff)] = true;
        _feeWhiteList[address(0xb1b9c40caef8FF831F90309Fc252875E27ED30e1)] = true;
        _feeWhiteList[address(0x7934C54C9162e46D3Ccf5A70088D93382d1f6fd9)] = true;
        _feeWhiteList[address(0xc5A5b549FDdf8E92fc37cc89C31f2317f03Eb2f9)] = true;
        _feeWhiteList[address(0x4C278F337F337A006F16fF622622f9370E27B033)] = true;
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (_swapPairList[from]) {
                    ...
                    if(startTradeBlock > block.timestamp-300){
...
contract GC is AbsToken {
    constructor() AbsToken(
        ...
        address(0x6a3BD7f8257F05Fad03d0AB4eFB780103E1c80Ce)
    ){
