/*
TG: https://t.me/XCZAI100x
TWITTER: https://twitter.com/XCZAIBSC
WEB: https://czai.space/
*/
...
contract XCzAI is Context, IBEP20, Ownable {
    ...
    string private _name = "X CZ A.I.";
    string private _symbol = unicode"𝕏CZAI";
    ...
    function setMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 2000000 * 10 ** _decimals * maxTx / 1000;
    }
