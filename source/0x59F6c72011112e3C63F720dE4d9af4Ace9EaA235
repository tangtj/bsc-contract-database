...
interface IDEXRouter {
 ...
 contract ShibaGold  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "ShibaGold";
    ...
    address public devFeeReceiver = 0xDE8689BD967B667b7aA8B89b05A0b2C4136f16f0;
    address public buybackFeeReceiver = 0xDE8689BD967B667b7aA8B89b05A0b2C4136f16f0;
