...
contract HODLTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public ekazgj82;
    ...
    string private _tokenname = "HODL2MOON";
    string private _tokensymbol = "HODL";
