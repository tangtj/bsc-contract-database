...
contract LayerZero is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x81A16DAd2eC662290679BDf508a37fbc65c08b65); 
    address payable public developmentAddress = payable(0x81A16DAd2eC662290679BDf508a37fbc65c08b65); 
    address payable public charityAddress = payable(0x81A16DAd2eC662290679BDf508a37fbc65c08b65); 
    address payable public vaultRewardAddress = payable(0x81A16DAd2eC662290679BDf508a37fbc65c08b65); 
    ...
    string private constant _name = " ZRO";
