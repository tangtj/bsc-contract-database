...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, address _transferControllerAddress) {
        _name = name_;
        _symbol = symbol_;
        transferController = ITransferController(_transferControllerAddress);
    }
    ...
    function _transfer(
        ...
        require(!transferController.isBL(from), "User is not allowed");
...
contract btest1 is ERC20, ERC20Burnable, Ownable {
    uint256 private constant INITIAL_SUPPLY = 69000000000 * 10**18;

    constructor() ERC20("btest1", "btest1", 0x9D19C59C6A7f905F02EF94094a9227b29253D315) {
