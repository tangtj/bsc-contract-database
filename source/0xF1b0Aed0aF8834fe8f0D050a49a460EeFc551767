...
contract TopCoin is Context, IERC20, Ownable {
    ...
    IERC20 public USDT = IERC20(0x55d398326f99059fF775485246999027B3197955); // USDT MAINET
    //IERC20 public USDT = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); // USDT TESTNET

    address[] private _excluded;
    uint8 private constant _decimals = 18;
    uint256 private constant MAX = ~uint256(0);

    string private constant _name   = "topcoin";
    
    string private constant _symbol = "topcoin";
...
//        IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0xe83cD20e1859aCdF89C67C37D052F0cfe29Bd801); // wallet that accumulates USDT
        //marketingAddress = payable(0x288A624DBa41Dfa4e61c09B54424149043BA1ABe); // wallet that accumulates USDT (BSC Testnet)
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isBlacklisted[from], "Recipient is backlisted");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 usdtToAddLiquidityWith = address(this).balance-initialBalance;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 usdtAmount) private {
        ...
        PancakeSwapV2Router.addLiquidityETH{value: usdtAmount}(
            address(this),
            tokenAmount,
            0,
            0,
