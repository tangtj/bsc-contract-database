...
contract MADAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MADAPE";
    string private constant _symbol = unicode"MADAPE";
