...
https://twitter.com/pepequeen
https://pepequeens.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96F590c99A9eBe7abE166F052b6E9B690ad9E567; // owner address
...
contract PEPEQUEEN is Context, IERC20, Ownable {
    ...
    string private _symbol = "$PQUEEN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x96F590c99A9eBe7abE166F052b6E9B690ad9E567); // Marketing Address
    address payable private teamWalletAddress = payable(0x96F590c99A9eBe7abE166F052b6E9B690ad9E567); // Team Address
