...
contract Change is Token {
    constructor() ERC20(
        "Chang'e",   // 名字
        "Chang'e"   // 符号
    ) {
        uint256 _totalSupply = 1388 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0xc57F510b439458cd542402497daA901cFA45f898); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xc57F510b439458cd542402497daA901cFA45f898)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(10 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x3E17960Dd8A15A193B32BFC331B83862fdDa240e);
        feeEarn = 0;
        isLiquified = true;
    }
}