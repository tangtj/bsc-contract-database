...
TELEGRAM: https://t.me/ItoshiNoMucoPORTAL
*/
...
contract ITOSHINOMUCO is Context, IERC20, Ownable {
    ...
    string private constant _name = "ITOSHI NO MUCO"; // 
    string private constant _symbol = "MUCO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x721Eb8217F5ABCB0F70cEc209C7bb798FC13355c;
