/*
Defirium is an innovative decentralized finance (DeFi) protocol that operates on blockchain technology.

It aims to revolutionize the traditional financial landscape by providing users with an open, transparent, and permissionless platform for various financial activities. 

Defirium enables users to lend, borrow, trade, and earn interest on their cryptocurrency holdings without the need for intermediaries like banks. 

Through smart contracts and automated processes, Defirium strives to create a more efficient, inclusive, and decentralized financial ecosystem for users around the world.
...
contract Defirium is Context, IERC20 {
    ...
    address payable public MarketingWallet = payable(0x384CE61AE635419E2EB3b8C53C0090a0e08DffC6);
