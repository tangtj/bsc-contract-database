...
contract LMGSwapper is ReentrancyGuard {
    bool public swapperEnabled;
    address public owner;
    //
    IPancakeRouter02 router;
    //PANCAKE ROUTER RIGHT HERE MAXIMUS WOMBAT
    address constant BNB =  0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c ;
    address constant LMG = 0xA7efd5D0575cD4682B0c83155bB9e4Ff1a85a6F9 ; // LMG TOKEN
    ...
    function buyWithToken(uint amt, IBEP20 token) external nonReentrant {
        ...
        try
            ...
            revert("Error swapping to LMG TOKEN.");
        }
    }
}