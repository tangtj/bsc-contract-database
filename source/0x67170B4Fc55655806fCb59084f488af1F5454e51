...
contract Safelynx is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0xB229cfEfB37455fbF6F8421Bb767C491C1a4e8Da;
    address private _donationAddress = 0x2f0cC4eDCe94F5C88ea6DfeE16B0683edC359c32;

    string private _name = "Safelynx";
    string private _symbol = "$SafeLynx";
