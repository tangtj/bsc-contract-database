...
contract SQUIDSHRINK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Squid Shrink";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x08C98287E5f94b23ac47249C9D62811F1B5d93b0;
        buybackFeeReceiver = 0x000000000000000000000000000000000000dEaD;
        teamFeeReceiver = 0xf691d29FA9ea24118c77a243834423e77548B301;
