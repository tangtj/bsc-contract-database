...
contract DOOMPROTOCOL is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"DOOMPROTOCOL";
    string private constant _symbol = unicode"DOOMS";
