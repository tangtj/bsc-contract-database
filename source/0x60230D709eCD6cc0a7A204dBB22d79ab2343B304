...
🦂SCORPIO🦂 ($CORP) is a revolutionary cryptocurrency born from the powerful and 
transformative zodiac sign of Scorpio, Like a confident scorpion.

🚀 Unleash the Power of $CORP! 🚀
TG : https://t.me/ScorpioTokenBEP20
**/
...
contract SCORPIO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SCORPIO";
    string private constant _symbol = unicode"$CORP";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 26000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x9b19d509ABb0Bc33b79413cC89a1E69d12858B99);
    address payable public MarketingWallet = payable(0xcbB37D266AF7309ca2600dd3BDd3703b2f83e51D);
