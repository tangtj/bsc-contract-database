...
contract StakeGfamBusd is Ownable, Pausable {
    ...
    function restake(uint _stakeIndex) public whenNotPaused {
        require(lockedUnstake == true, "Locked");
    ...
    function unstake(address _user, uint _stakeIndex) public onlyOwner {
        ...
        totaRequestedBusd -= _stake.rewardGoal - _stake.rewardClaimed;//
    ...
    function addToRewardPool (uint _value) public onlyOwner {rewardBusdPool += _value;}
