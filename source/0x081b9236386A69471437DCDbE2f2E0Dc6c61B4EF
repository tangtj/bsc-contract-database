...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x78f46756468837B3ADcf2c4adCaB95d6678650dd; 
...
contract POOCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "POOCOIN";
    string private _symbol = "POOCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78f46756468837B3ADcf2c4adCaB95d6678650dd);
    address payable public teamWalletAddress = payable(0x78f46756468837B3ADcf2c4adCaB95d6678650dd); 
