...
contract TURBOLIGHT is Context, IERC20, Ownable {
    ...
    string private _name = "TURBO LIGHT";
    ...
    address public marketingWallet = 0x572288E1eBe79CEfDE519D75eC7f0164F495c1Ff;
