...
Tg: https://t.me/+ncMan_9VQek1NWU9
**/
...
contract BOXY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BOXY";
    string private constant _symbol = unicode"$BOXY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 19000000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x948718BB3fe1bb198DAb01a9EcB7e703878b27d7);
    address payable public MarketingWallet = payable(0xCDDC0622c4a7bA553188766086a3EB918e46D469);
