...
/**
 * TG: https://t.me/PancakeBUSD
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * PancakeBUSD gathers PancakeBUSD and delivers direct to your wallet!!!!
*/
...
contract PancakeBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PancakeBUSD";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "PancakeBUSD";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x1e711fFEB96C6C1c74150e9978037c5207049d2A;
