/**
 * PayPal Inu | PayPal has now entered the crypto space
 *                                                  
 *                                               
 *
*/
...
contract PayPalInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5164d5C9e7FD9FcBF656ae9DD5d94E30765a28d6;

    string constant _name = "PayPal Inu";
    string constant _symbol = "PayPal";
