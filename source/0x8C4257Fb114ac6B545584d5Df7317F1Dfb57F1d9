...
contract Hydra is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    ...
    constructor() ERC20("Hydra", "HYD") ERC20Permit("Hydra") {
