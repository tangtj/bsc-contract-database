...
contract Fourium is Context, IERC20, Ownable {
    ...
    string private _name = "Fourium";
    string private _symbol = "FRM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38281E29d1349f9452CB42ca09d6927eC04776EB);
    address payable public teamWalletAddress = payable(0x38281E29d1349f9452CB42ca09d6927eC04776EB);
