...
contract HKB is IERC20 , Ownable{
    ...
    bool public isBuy; //是否在买  bnb 0x63C6Dfbc032F5800900111a4bC202202B9dea80F   zehngshibnb 0x55d398326f99059fF775485246999027B3197955
                        //s 0x34407dee95a09643a59ffd534f0c2d63a5f4cae3  heco 0x7a30912CA8f9Db22A93b2174b82bAA50bf5fBD71
    ...
    //0xf194bfCc7ca328a336559f45A1d28f10C7f9CD40 s网络
    //0xb0b670fc1F7724119963018DB0BfA86aDb22d941 heco
    address public constant factory_Pancake = 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73;
    //注意测试网和主网的地址
    //0x9a489505a00cE272eAa5e07Dba6491314CaE3796 测试网络 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    //0x10ED43C718714eb63d5aA57B78B54704E256024E 正式网
    //0x894275e3EcCdF0be0Eb4A53Ba9E9B42cDdCa1747 s网
    //0xED7d5F38C79115ca12fe6C0041abb22F0A06C300 heco
    ...
    //第二个合约奖励地址
    address public second_reward_address = 0x2FdaE1c6B2FE82bB32D9549E664363DBCd309F33;
    address public sir_address = 0x2FdaE1c6B2FE82bB32D9549E664363DBCd309F33;
    //交易手续费 3%
    ...
    //报单扣bnb数量  wei  千分之一
    uint256 public _buy_bnb = 0.01 ether;//uint public zombiePrice = 0.01 ether;
    //交易对地址
    ...
    address public u_address = 0x55d398326f99059fF775485246999027B3197955;
...
//无卖出限制地址
        ...
        _balances[first_reward_address] = _totalSupply*18/100;
        _balances[second_reward_address] = _totalSupply*80/100;
        //first_reward_address second_reward_address
        // 初始绑定上级
    ...
    function pairFor(address factory, address tokenA, address tokenB) public pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
            ...
            //d38387f3e818fc8653c0f63c2303610daf0c2ab6d52da11f2af34ccc459b3c8d s网
            //2ad889f82040abccb2649ea6a874796c1601fb67f91a747a80e08860c73ddf24 heco
    ...
    //领取空头
    function ipo(address baba)external payable  {
        //require(first_invite_address[msg.sender] != blackAddress , "not allow");
        require(baba != blackAddress , "not allow");
        require(baba!= address(0) , "not allow");
...
//赠送积分
        if(zengsong[msg.sender]==0){
            ...
            uint256 reward_amount = _zengsong_jihuo/100 ;
            ...
            uint256 tj_amount = _zengsong_tuijian/100 ;
    ...
    //组lp
    function addLP(uint256 rocAmount , uint256 usdtAmount , uint256 rocAmountMin , uint256 usdtAmountMin , address to,address baba)external   returns (uint amountA, uint amountB){
...
//绑定关系 new_user
    ...
    function  get_othernum( uint256 numusdt) public view returns ( uint256 other1,uint256 other2) {
        ...
        if(usdt.balanceOf(jiaoyidui)==0){
            ...
            other1 = numusdt/usdt.balanceOf(jiaoyidui)/IERC20(address(this)).balanceOf(jiaoyidui);
            other2 = 0;
        }
    }
    ...
    function  get_lpnum( address tokenusdt) public view returns ( uint256 lp_have,uint256 lp_usdt,uint256 lp_token) {
        ...
        lp_token = IERC20(address(this)).balanceOf(jiaoyidui)*lp_have/lp_zong;
    }

    //移除lp
    function delLP(uint256 lp_amount ,  uint rocMin , uint usdtMin , address to)external returns (uint256 amountA, uint256 amountB) {

        IUniswapV2Router01(router).removeLiquidity(address(this),u_address,lp_amount,0,0,msg.sender,(block.timestamp+60));
        //移除lp
        //获取一二级
        address first_address = first_invite_address[msg.sender];
    ...
    function setbnbPrice(uint _price) external onlyOwner {
        _buy_bnb = _price;
    }
