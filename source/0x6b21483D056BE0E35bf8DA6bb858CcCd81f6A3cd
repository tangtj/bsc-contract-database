...
contract CARDSOFGLORY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
 
    address payable public marketingAddress =
        payable(0x44fe5B467750726A2bf2ADc58FEFc5BCC3971fd6); // Marketing Address
 
    address payable public teamAddress =
        payable(0x44fe5B467750726A2bf2ADc58FEFc5BCC3971fd6); // Team Address
 
    address payable public liquidityAddress =
        payable(0x44fe5B467750726A2bf2ADc58FEFc5BCC3971fd6); // Liquidity Address
    ...
    string private constant _name = "CARDS OF GLORY";
