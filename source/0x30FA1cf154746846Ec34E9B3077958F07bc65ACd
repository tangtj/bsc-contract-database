...
contract FREEPALESTINE is Context, IERC20, Ownable {
    ...
    string private _name = "FREE PALESTINE";
    string private _symbol = "PALESTINE";
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(signatory != address(0), "MEALS::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MEALS::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "MEALS::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "MEALS::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint32 blockNumber = safe32(block.number, "MEALS::_writeCheckpoint: block number exceeds 32 bits");
