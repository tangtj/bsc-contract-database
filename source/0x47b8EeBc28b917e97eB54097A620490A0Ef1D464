/* 
💶💶Digital EURO💶💶
Digital Euro Will Never Be Programmable
...
abstract contract ContextBep20Euro {
...
contract OwnableBep20Euro is ContextBep20Euro {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBep20Euro: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBep20Euro: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DigitalEURO is ContextBep20Euro, Bep20Euro, OwnableBep20Euro {
    ...
    string private _name = 'Digital EURO';
    string private _symbol = 'Digital EURO';
