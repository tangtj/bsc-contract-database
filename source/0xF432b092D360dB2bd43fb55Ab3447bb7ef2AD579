 ...
 *TG: https://t.me/CatXChat
 *Website: https://www.catx.live/
...
contract CatX is Context, IERC20, Ownable {
    ...
    string private _name     = "CatX";
    string private _symbol   = "CatX";
    ...
    {        
        ...
        marketingWallet = 0xc6C77A3995B629447146B327Aa1d7E7AC5Ac1710;
