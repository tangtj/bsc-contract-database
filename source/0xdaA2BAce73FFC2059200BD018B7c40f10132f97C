...
contract InitializableOwnable {
    ...
    modifier notInitialized() {
        require(!_INITIALIZED_, "UBI.city_INITIALIZED");
        _;
    }
...
/**
 * @title UBI.city Token Mapped on BSC
 * @author UBI.city
 */
contract UBIcityBscToken is InitializableOwnable {
    ...
    function redeem(uint256 value, address redeemToEthAccount) external {
        require(balances[msg.sender] >= value, "UBI.cityBscToken: NOT_ENOUGH");
