...
contract FrogDollars is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x6cF080f124b4B5df71fa091C9B908b2A71C243eA);
    ...
    constructor () {
        ...
        _owner = 0x6cF080f124b4B5df71fa091C9B908b2A71C243eA;
