...
Group Telegram: https://t.me/armadillomemecoin
...
contract ArmadilloToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x562167e48EbA20aec77805459c9165A803eC9A4A); 
    address payable public Wallet_Dev = payable(0xf559a31E61C66c6899c45744426B19BAD635e2a3);
    address payable public Wallet_Charity = payable(0x37d7dd6BdEcb790C1bAAa21D63DB54D396D14eF3);
    ...
    string private constant _name = "Armadillo Token"; 
    ...
    constructor () {
        ...
        _owner = 0x58F1Ac1146547118A5e29c350EFf2D4A1B57F45e;
