...
// Metapotamians emerges as a WEB 3.0 project that provides digital services in a special universe and receives the support of organizations that are affiliated with Turkey's largest companies in the field of metaverse and NFT.
// Metapotamians Token sale MTP
...
contract MTP is Context, IERC20, IERC20Metadata, Ownable {   
