...
contract BNBX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA485240faaD0882E51e93980aDfa384D5E044e7e); 
    address payable public teamWalletAddress = payable(0x7514445a3286A0180E6A4E19aD4d5D3847C0296F);
