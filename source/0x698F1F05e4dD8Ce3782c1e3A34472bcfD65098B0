// https://t.me/AIFootballBSC
// https://aifootball.godaddysites.com/
...
contract AiFootball is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AIFOOTBALL";
    string private constant _symbol = unicode"AIFOOT";
