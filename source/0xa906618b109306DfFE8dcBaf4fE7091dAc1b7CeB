...
contract AlveyBurn is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "AlveyBurn";
    string constant _symbol = "$AB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 16 * 10**7 * 10**_decimals;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x4D9CE5577182469f0B4d60306Ed66cc4AF092233;
