...
contract ETHEREUMTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "ETHEREUM";
    string private _seitokensymbol = "ETHEREUM";
    address public rssah71;
