...
Superson is a meme-inspired crypto token featuring The Simpsons 
joining superman superheroes. We're here to be the biggest meme. And to make BSC great again.

Fairlaunch 11.30AM (TODAY!!)

🦸‍♂️ Contract Renounce after launch
🦸‍♂️ No Presale tokens
🦸‍♂️ Liquidity locked
🦸‍♂️ Low tax (1/1)
🦸‍♂️ CA Verified
...
Ride, Relax & Enjoy the Journey 🚀
TG: https://t.me/SuperSonBSC
...
contract SUPERSON is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SUPERSON";
    string private constant _symbol = unicode"$SUPSON";
    ...
    address payable public DevWallet = payable(0xC19F6BdF1FeA6052604E514E6D24f91e64a5E4cd);
    address payable public MarketingWallet = payable(0x7fD43c3b75de8c1c9e36e5a1ae457BeAC9C5942a);
