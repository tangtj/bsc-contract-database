// Pawrium Protocol: The Layer 2 Solution for Ultimate Scalability and Interoperability
...
contract PawriumProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pawrium Protocol";
    string private _symbol = "PAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA08Cc5617e2f017afb2b365a28FB2bf429938884); // Marketing Address
    address payable public teamWalletAddress = payable(0x40dAB8E22066b9AfA503cDf209205725FB5f5452); // Team Address
