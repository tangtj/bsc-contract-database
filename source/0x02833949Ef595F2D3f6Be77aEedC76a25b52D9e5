...
contract BigBiteDonuts is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BIG BITE DONUTS";
    string private _symbol = unicode"$DONUTS";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x1f4987d076f17c6082e46141f4F8E34009FabB21);
    address payable private taxWallet2 = payable(0x1f4987d076f17c6082e46141f4F8E34009FabB21);
