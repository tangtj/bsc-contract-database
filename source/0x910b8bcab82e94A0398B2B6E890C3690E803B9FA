...
https://t.me/BABYTIGEINUBSC

Baby Tige Inu $BabyTINU GIVES 4% REWARDS IN $TINU
...
contract BabyTigeInu is IBEP20, Auth {
    ...
    address DEV = 0xc00F9224F8BEcb6657154888f9b5DAeF8fd0B07b;

    string constant _name = "Baby Tige Inu";
    string constant _symbol = "BabyTINU";
