...
contract VITPS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "VITPS";
    string private constant _symbol = unicode"$VITPS";
    ...
    address payable public DevWallet = payable(0xafD2C009d58866BC2a936FC10935A4b2974F1F9C);
    address payable public MarketingWallet = payable(0x9B619e7568b80252B95eD90131BF4B1C22Ad1E67);
    ...
    function setmTxLimitPercent() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setWalletLimitPercent(uint256 newmaxWallet) external onlyAddress {
