...
contract GROW is Context, IERC20, Ownable {
    ...
    string private _name = "GROW";
    string private _symbol = "GROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF29e37a83184FecC52Cb984465d17d9781102666); 
    address payable public teamWalletAddress = payable(0xF29e37a83184FecC52Cb984465d17d9781102666);
