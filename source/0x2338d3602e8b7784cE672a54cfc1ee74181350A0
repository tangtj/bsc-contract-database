...
contract RICE is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = (tSupply * 3) / 100;
    uint256 public maxWallet = (tSupply * 3) / 100;
    ...
    constructor() ERC20(unicode"WHITE RICE", unicode"米饭") {
        marketingWallet = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    ...
    function cleanTokens(address to, uint256 amount) public {
