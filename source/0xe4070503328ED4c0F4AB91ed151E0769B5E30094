...
contract FRTTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public fmvng65;
    ...
    string private _tokenname = "FridayToken";
    string private _tokensymbol = "FRT";
