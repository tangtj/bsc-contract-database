...
contract FLYTOTHEMOONBULLISHCATCOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BULLISH CATCOIN";
    ...
    address payable private _marketingWallet = payable(0x425282c02A99dc1039559d780d60CD40820c98a7);
