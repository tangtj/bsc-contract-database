...
contract Ind_rupiah is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6a186F65928b69F12DF1B0Ce21faB1D42907dB1E); 
    address payable public Wallet_Dev = payable(0x6a186F65928b69F12DF1B0Ce21faB1D42907dB1E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**6*  10**_decimals;
    string private constant _name = "IND RUPIAH"; 
    string private constant _symbol = unicode"INDRUPIAH"; 
    ...
    constructor () {
        _owner =0xc66239c89D9762eD50abd0E72748dd1603Fe913a;
