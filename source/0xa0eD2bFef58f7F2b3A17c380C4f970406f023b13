/**
   ...
   TG GROUP：https://t.me/BABYHOPPYMOON
   */
...
contract BABYHOPPY is Context, IERC20, Ownable {
    ...
    string private _name = "BABYHOPPY";
    string private _symbol = "BABYHOPPY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xDd53225De7e6275D952DAd1EA714779e8d1BEA4f);
    address payable public BurnedWalletAddress =
        payable(0xB3Bb6b1934899BAe8e2225a5D2D4CbF500399703);
