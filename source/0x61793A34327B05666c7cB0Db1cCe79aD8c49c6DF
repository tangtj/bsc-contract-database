...
// File: contracts\FiveTigerBox2.sol

pragma solidity ^0.8.0;


contract FiveTigerBox is ERC1155Supply, Ownable{
    ...
    function getBalances(address user) view external returns(uint256[] memory balances){
        uint256 len = maxId + 1;
