/**
https://twitter.com/mobycoinbsc
https://t.me/MobyOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30973eC423bc797AEeaD8461f7b714396ad12763; // owner address
...
contract MOBY is Context, IERC20, Ownable {
    ...
    string private _name = "Moby";
    string private _symbol = "MOBY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe1ff89b7Ae9B74ea0a9c29EE2121361eEe885AF0); // Marketing Address
    address payable private teamWalletAddress = payable(0x30973eC423bc797AEeaD8461f7b714396ad12763); // Team Address
