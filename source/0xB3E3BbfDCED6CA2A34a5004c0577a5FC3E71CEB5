...
TELEGRAM: https://t.me/mafia_catcoin
...
contract MAFIACATCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mafia CatCoin"; // 
    string private constant _symbol = "$MAFIA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x8b95253A67E65eFE7235D6Ac1E7879Ac9D937369;
