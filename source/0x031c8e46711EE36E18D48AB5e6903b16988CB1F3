...
Obito Inu is an anime based community driven token. We are establishing a new generation token that you can safely invest with no scam codes and contract is renounced for your safety.  
 
GENIOUS DEV DEPLOYER: 
Please cooperate to make this project moon! We will do BIG marketing after we hit our next floor target.

🔥Based and Experienced DEV
🔥Contract Verified
🔥No Scam/Honeypot codes
🔥Locked Liquidity 
 
Marketing Plan/Calls 
Launch - small calls to spread the word in the community 
10k Marketcap - Obito 
50k Marketcap - Venom 
...
Telegram: https://t.me/ObitoInuOfficial
...
contract OBITO is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x603187E166d8b00bB71c5f3b5088C8e40CBE2d8D;
