...
contract OWNER is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x850C3c5A1BFe5F9e9823F38c1F466812086f784A);
    ...
    uint256 public _maxTxAmount = 630000 * 10**18;
