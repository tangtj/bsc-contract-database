/*
    ...
    \\     Wallet - 4%                                             \\
    \\     Tax - 3/3                                               \\                                 
    \\     Telegram: https://t.me/Overwatch_X_Portal               \\
...
contract OverwatchX is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingAddress = payable(0x97fffd0287Ed04F536D23437c37F06DbF016a6FF);
        treasuryAddress = payable(0x97fffd0287Ed04F536D23437c37F06DbF016a6FF);
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        _sellLiquidityFee = newLiquidityTax; //Max tax 3%
        _sellMarketingFee = newMarketingTax; //Max tax 3%
        _sellTreasuryFee = newTeamTax; //Max tax 3%
