...
contract SpongsCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Spongebob CEO";
    string private constant _symbol = unicode"SPONGS";
