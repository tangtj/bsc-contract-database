...
contract P1 is IERC20, Ownable {
    ...
    string _name = "pointOne";
    string _symbol = "P1";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 42690 * 10**_decimals;
    uint256 public _maxTxAmount = 427 * 10**_decimals; 
    uint256 public _maxWalletSize = 427 * 10**_decimals; 
  ...
  /* rOwned = ratio of tokens owned relative to [[circulating]] supply */
    ...
    uint256 smallSwapThreshold = 155 * 10**_decimals; 
    uint256 largeSwapThreshold = 195 * 10**_decimals; 
    ...
    constructor () {
        ...
        devFeeReceiver = 0x96c1C11CBBcA9f6E060Be9bbBA98c8C8cd346a77;
        marketingFeeReceiver = 0x96c1C11CBBcA9f6E060Be9bbBA98c8C8cd346a77;
