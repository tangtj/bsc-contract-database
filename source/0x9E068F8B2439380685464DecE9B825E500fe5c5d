...
contract PIGzilla is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("PIGzilla", "PIGzilla") {
        addressForMarketing =address(0x8420E1676f2fb9B9af334cF4D33a885eaA1D9687);
