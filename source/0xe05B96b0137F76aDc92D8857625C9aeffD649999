...
Cute Bomber
   ...
   Shiba,Rfi,Feg,CT,Safemoon,CuteBomber combine together to creat CuteBomber designed.
    
    I make this #CuteBomber to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/CuteBomber
   ...
   I will renounce the ownership to burn addresses to transfer #CuteBomber to the community, make sure it's 100% safe.

   I will add 0.35 BNB and all the left 50% total supply to the pool
   Can you make #CuteBomber 100000X? 

   1,000,000,000,000,000 total supply
   50,000,000,000,000 CuteBomber max limit for per trade
   ...
   it's the best part of the #CuteBomber idea, increasing the liquidity pool automatically, 
...
contract CuteBomber is Context, IERC20, Ownable {
    ...
    string private _name = "CuteBomber";
