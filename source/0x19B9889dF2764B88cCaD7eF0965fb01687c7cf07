/*
          ...
          XTESLA Is a Community Driven  Meme Token Launching On BSC Network Based On  ELON Tweet CHANGING TWITTER NAME TO "X" and CZ Binance tweet Let's X.

        // Telegram:https://t.me/XTESLABSC
        
        // Twtter:  https://twitter.com/xteslabsc
...
contract XTESLA is Context, IERC20, Ownable {
    ...
    string private _name     = "XTESLA";
    string private _symbol   = "XTESLA";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 5_000_000_000_000 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xac7D148f8c1fA13Ce7674DfD9D79d80AB2b0E1D7;
