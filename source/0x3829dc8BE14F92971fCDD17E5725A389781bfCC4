...
interface Ru {
  ...
  */
   ...
   * AndyNFTOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract Andy is Ma, Ru, io {
   ...
   address private AndyNFTOwner; 
   string public AndyNFTwebsite = "https://andy.fr.softonic.com/";
   string public ownerAddress = "0x22e1FBA185597cBBC6433970D6558738a040050b";  
    constructor() {
        AndyNFTOwner = 0x22e1FBA185597cBBC6433970D6558738a040050b;    
        _name = "Andy";
        _symbol = "ANDY";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getAndyNFTwebsite() public view returns (string memory) {
        return AndyNFTwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(AndyNFTOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
