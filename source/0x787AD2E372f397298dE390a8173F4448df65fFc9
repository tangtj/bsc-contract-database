/*
⚔️ OFFICIAL LINK $SMO ⚔️

⚔️TG : https://t.me/Samuraioffcl
⚔️Twitter : https://twitter.com/samuraioffcl
⚔️Website : https://samurai-official.webflow.io/
*/
...
contract SamuraiOfficial is Context, IERC20 {
    string private _name = "SAMURAI OFFICIAL";
    string private _symbol = "$SMO";
    ...
    uint256 public _buy_free = 14;
    uint256 public _sell_free = 14;
    ...
    address payable public MarketingWallet = payable(0x8Dfc2a13d5C421915cfb3f1ad6d2edf1F8a4d2F5);
