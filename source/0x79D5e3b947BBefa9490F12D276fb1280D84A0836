/*
Unitydefi is a Multi-Chain Decentralized Platform with many features enabling users to trade crypto, Yield-farm, Stake cryptocurrencies, Stake NFTs , play the Crypto Lottery, utilize the NFT Marketplace and launch NFT Collections
...
TG:https://t.me/unitydefiofficial
*/
...
contract unitydefiwallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Unity Defi Wallet";
