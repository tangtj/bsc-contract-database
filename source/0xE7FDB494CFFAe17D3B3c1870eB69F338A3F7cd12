...
contract CYCAITOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public acmfnf84;
    ...
    string private _tokenname = "RECYCLING AI";
    string private _tokensymbol = "CYCAI";
