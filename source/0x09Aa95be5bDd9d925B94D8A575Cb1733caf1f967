...
contract XHJ is ERC20, Ownable {
    ...
    address public marketingAddress = 0x272d2be26735aC9D6a629B1B3B6469D83eC757c8;
    ...
    uint256 public _protectTime = 24;
    ...
    constructor() ERC20("XHJ", "XHJ") {
        uint256 totalSupply = 1580 * (10**18);
    ...
    function takeSwapFee(address from, uint256 amount) private returns (uint256 amountAfter) {
        ...
        uint256 LFee = amount.mul(lpRewardFee).div(10000);
        if (LFee > 0) {
        ...
        if (MFee + LFee > 0) {
            super._transfer(from, address(this), LFee.add(MFee));
        }
    }
