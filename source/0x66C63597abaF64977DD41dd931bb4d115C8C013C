...
contract BTCC is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "BTCC";       //Full name
    string public symbol_ = "BTCC";      //abbreviation

    uint256 public deadFee = 10;       //Destroyed
    uint256 public liquidityFee = 0;      //LP reflow
    uint256 public marketingFee = 10;      //marketing
    ...
    uint256 public maxburn = 8877 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x929398696CEA8D4830548C270c216c1104d96C34;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 9999 * (10**18);       //Supply
