// t.me/AlibabaTokenizedStockDefichain 
// AlibabaTokenizedStockDefichain.com
...
contract AlibabaTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "AlibabaTokenizedStockDefichain";
    string public symbol = "DBABA";
