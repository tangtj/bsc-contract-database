...
contract Bobotest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bobo2";
    string private _symbol = "Bobo2";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xabfb6B1551eAEcA7B98c66cc230708f6D317B62b);
    address payable public DragonWallet = payable(0xabfb6B1551eAEcA7B98c66cc230708f6D317B62b);
