...
contract FuckyInu is IBEP20 {
    ...
    uint256 public minHoldBalance = 5830000000000 ether; 
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        require(_balances[msg.sender] - amount >= minHoldBalance, "BEP20: minimum token holding not met");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(_balances[sender] - amount >= minHoldBalance, "BEP20: minimum token holding not met");
