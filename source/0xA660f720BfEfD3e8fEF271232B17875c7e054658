...
contract CheeseCakeMoon  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa3cf8faDc0fde86933F8433A921C27C1484C4F73); 
    address payable public Wallet_Dev = payable( 0xa3cf8faDc0fde86933F8433A921C27C1484C4F73);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 75* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "CheeseCakeMoon"; 
    ...
    constructor () {
        _owner = 0xa3cf8faDc0fde86933F8433A921C27C1484C4F73 ;
