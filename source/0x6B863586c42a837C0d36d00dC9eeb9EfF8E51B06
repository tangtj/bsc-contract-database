...
contract fpfloki is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x24Ff08bffc696684403f656d5F1A93Fd3D43a23D;
    ...
    string private _name = "Frunk Floki Puppy";
