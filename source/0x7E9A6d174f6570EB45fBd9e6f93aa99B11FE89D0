...
⚛️Welcome to ATOMIC BUNNY - ($ATOM)⚛️

ATOMIC BUNNY $ATOM is a new meme coin, 
$ATOM creating a strong and stable foundation for its community.

🔥🚀 Let's hop into the future together with ATOMIC BUNNY $ATOM ⚛️

TG : https://t.me/AtomicBunnyBSC
...
contract ATOMICBUNNY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ATOMIC BUNNY";
    ...
    address payable public DevWallet = payable(0x59689ABCe5661961685fdf286bC5B67F46b7F95b);
    address payable public MarketingWallet = payable(0xc38190DFF4d717D737b02A4F75b58fB187D5a12d);
