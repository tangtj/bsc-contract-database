...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60A8287457d30177B61B7DcDe8BF1b07Af756389; // owner address
...
contract CCCS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCS";
    string private _symbol = "CCCS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x60A8287457d30177B61B7DcDe8BF1b07Af756389); // Marketing Address
    address payable private teamWalletAddress = payable(0x60A8287457d30177B61B7DcDe8BF1b07Af756389); // Team Address
