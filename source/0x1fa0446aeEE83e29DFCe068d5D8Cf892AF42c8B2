...
contract AustinWeirder is IBEP20, Auth {
    ...
    string constant _name = "Austin Weirder";
    string constant _symbol = "A&W";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x81b14d463373648bD396D5559a6D146b45db8432;
        teamFeeReceiver = 0x98e6789651Ccb877991A4A9417AdC1797fFAC10e;
