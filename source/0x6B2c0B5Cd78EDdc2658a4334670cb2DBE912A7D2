...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x586c2A7f3EFC82B712e7D33DE6DaB5c9EF2E9CB0; // owner address
...
contract MaoMao is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9Ff143A73B1Bf595DCdb2E510cF9E4c5D59AE72E);
    address payable public teamWalletAddress = payable(0x9Ff143A73B1Bf595DCdb2E510cF9E4c5D59AE72E);
