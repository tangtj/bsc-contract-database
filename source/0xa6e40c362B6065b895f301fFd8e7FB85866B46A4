...
contract STABLES is ERC20, Ownable {
    ...
    constructor() payable ERC20("$STABLES", "USTB") {
        ...
        marketingWallet = 0x6A238E2ee8A05EF24593A203ed85E9d8810ecf86;
