...
contract babypepe is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBC356ffBEEc8E248781c6DcaF581D0710E9128E1); // Marketing Address
    address payable public teamWalletAddress = payable(0xBC356ffBEEc8E248781c6DcaF581D0710E9128E1); // Team Address
