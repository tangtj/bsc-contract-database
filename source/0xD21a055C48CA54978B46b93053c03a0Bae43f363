...
contract Token is ERC20,Ownable,AccessControl {
    ...
    constructor()ERC20("CCGDS", "CCGDS") {
        admin=0xe7e38148962a4947e37e9011d449FCc67de460F3;
        address sentTo=0xA9f3cF6214B1529c755Ea0266CbEA6AAE04EF221;
        //admin=msg.sender;
        fundAddr=0x87929f21efA147265e7DCEB612290C8B8623aFE6;
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair) {
            ...
            uint256 swapAmount = fundCount.mul(13).div(14);
    ...
    function swapUsdt(uint256 tokenAmount,address to) private lockTheSwap {
        ...
        usdtHelper.withdrawToken(usdt, address(this),lpfees);
