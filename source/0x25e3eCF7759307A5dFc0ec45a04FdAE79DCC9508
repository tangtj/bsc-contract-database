...
contract SHIELTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public zhnfbd73;
    ...
    string private _tokenname = "SHIEL";
    string private _tokensymbol = "SHIEL";
