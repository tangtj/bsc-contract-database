...
BobbyZilla - LP will be burnt and ownership will be renounced
...
library Address{
 ...
 contract BobbyZilla is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9Db67CdA059Ae7c5d6b2920281F485502B147779;
    address public donationWallet = 0x8EdDF998737F13d18618d523727Da2A0Cb3182f2;

    string private constant _name = "BobbyZilla";
    string private constant _symbol = "BobbyZilla";
