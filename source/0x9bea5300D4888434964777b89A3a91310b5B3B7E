...
contract Spectranium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spectranium";
    string private _symbol = "SPECTRA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7f0135685c591F0D3a03cC7b8abcC8c759d5a695); // Marketing Address
    address payable public teamWalletAddress = payable(0xfD354C9641f9a39b55852B4997D37c004EDFa1B1); // Team Address
