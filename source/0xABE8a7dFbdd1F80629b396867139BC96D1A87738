...
Elon tweet!
Baby Denmark Inu | Based dev | Low cap | FOMO

BabyDenmarkInuBSC, we are the real ElonTweet on this chain! Stealth launch soon! 
Safu dev, low cap gem! 
Last project hit 20k mcap with small liq!! 
Calls coming! Let's hit 100k today!

💵 Buy tax 12%
💵 Sell tax 12%
💵 Marketing 7%
💵 Liq Pool 5%
💵 LP will be lock in Mudra

TG: https://t.me/BabyDenmarkInuBSC
...
contract BabyDenmarkInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyDenmarkInu";
    string constant _symbol = "Elon Tweet";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5FDd6ab97A08D3b654631250c13eB4b024bf7a1B;
