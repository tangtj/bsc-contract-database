...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81eBB6F8792757B6219DFeCa80C7f35d1d68b85C; // owner address
...
contract BOTCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOTCOIN";
    string private _symbol = "BTC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x81eBB6F8792757B6219DFeCa80C7f35d1d68b85C); // Marketing Address
    address payable private teamWalletAddress = payable(0x81eBB6F8792757B6219DFeCa80C7f35d1d68b85C); // Team Address
