...
contract RICHPEPE is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'RICHPEPE: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'RICHPEPE: incorrect fee percent');
        require(owner != address(0), 'RICHPEPE: incorrect owner address');
        require(mintToAddr != address(0), 'RICHPEPE: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'RICHPEPE: transfer from the zero address');
        require(recipient != address(0), 'RICHPEPE: transfer to the zero address');
