...
contract CHEEMS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x410352de6372f81042E7DCDc7E21Fca606dCA299); // Marketing Address
    address payable public teamWalletAddress = payable(0x410352de6372f81042E7DCDc7E21Fca606dCA299); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x410352de6372f81042E7DCDc7E21Fca606dCA299),
            block.timestamp
        );
    }
