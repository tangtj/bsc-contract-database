...
Telegram : https://t.me/QuadrillionXRP

Twitter  : https://twitter.com/QuadrillionXRP

Website  : https://www.quadrillionxrp.com/
...
contract QuadrillionXRP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    QuadrillionXRPDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Quadrillion XRP", "Quadrillion") {
        marketingWallet = payable(0xa3F84Fe0ab46df864F4B34d649200405951ad711);
        devWallet = payable(0xa3F84Fe0ab46df864F4B34d649200405951ad711);
        ...
        dividendTracker = new QuadrillionXRPDividendTracker(
            payable(this),
            router,
            0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE,
            "QuadrillionXRPTRACKER",
            "QuadrillionXRPTRACKER"
        );
...
contract QuadrillionXRPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    QuadrillionXRP public QuadrillionXRPContract;
    ...
    constructor(
        ...
        defaultToken = token;
        QuadrillionXRPContract = QuadrillionXRP(mainContract);
    ...
    function _transfer(
        ...
        require(false, "QuadrillionXRP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "QuadrillionXRP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main QuadrillionXRP contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(QuadrillionXRPContract);

            uint256 prevBalance = QuadrillionXRPContract.balanceOf(address(this));
            ...
            {
                uint256 received = QuadrillionXRPContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    QuadrillionXRPContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
