        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xe6805f5B25d11eaA9b6616BAa754D5c6F1eDeB9e), block.timestamp
                );
            }
        }
    }
...
contract papaufo is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xf88C999772B4a762a4367383ABe4A8E0A6C5dBAC),//FundAddress
        address(0xe6805f5B25d11eaA9b6616BAa754D5c6F1eDeB9e)//ReceiveAddress
    ){
    }
}