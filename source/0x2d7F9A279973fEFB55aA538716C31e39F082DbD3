/*
website : https://optimusnetwork.tech/
Telegram : https://t.me/optimusnetworkL1
*/
...
contract OptimusNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Optimus Network";
    string private _symbol = "OPTIMUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEA65dA50D6216750310a30c0Dd12C871d36Cf9b4); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xEA65dA50D6216750310a30c0Dd12C871d36Cf9b4); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (3 * 10**5 * 10**9), "Max wallet should be less or euqal to 5% totalSupply");
