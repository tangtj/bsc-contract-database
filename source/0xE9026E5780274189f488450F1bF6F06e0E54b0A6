...
// telegram : https://t.me/SHINRAL_INU
// x : https://x.com/shinrai_INU
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x481c25674f64df1f293019888cB7e0fD1438B7dd ; // owner address
...
contract SHINRAIINU  is Context, IERC20, Ownable {
    ...
    string private _name = "SHINRAIINU";
    string private _symbol = "SRINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18C50e8fe011fE463d8E902643966F724bEad8A0); 
    address payable public teamWalletAddress = payable(0x18C50e8fe011fE463d8E902643966F724bEad8A0);
