...
contract PHYSICSTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Physics Token";
    string private constant _symbol = "PHYT"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 7;
    address public _marketingWallet = 0xddd8531B0B07BF2a70111EcEA07952b3E0dD5e5B;
