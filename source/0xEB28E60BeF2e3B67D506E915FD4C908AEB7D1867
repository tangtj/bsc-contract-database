/**
   #MoonBSC is a token which was created to the community, and will be governed by the community.
   
   It's a community token, DEV = Community.
   every holder should promote it, or create a group for it, 
   if you want to pump your investment, you need to do your duty.
   
   I make this #MOONBSC to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #MOONBSC to the community, DEV = Community

   I will add 0.5 BNB and all the left 50% total supply to the pool
   Can you make #MOONBSC 1000X? 
   ...
   it's the best part of the #MOONBSC idea, increasing the liquidity pool automatically, 
...
contract MOONBSC is Context, IERC20, Ownable {
    ...
    string private _name = "MOONBSC";
    string private _symbol = "MOONBSC";
