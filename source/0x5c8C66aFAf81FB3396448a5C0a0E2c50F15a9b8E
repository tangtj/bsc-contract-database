/**
   TELEGRAM : https://t.me/yourturnbsc
*/
...
contract YourTurn is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xcbC00Fca19650ae57631f3919A78D0c8a4dCC68b;

    string private constant _name = "Your Turn";
    string private constant _symbol = "YOUR";
