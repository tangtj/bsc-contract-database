...
//Telegram :https://t.me/grimacexbsc
...
contract GX is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    string private _name = "Grimace X";
    string private _symbol = "GRIMAX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f16A287198b0E22C380A28899612Df00c3323fB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3f16A287198b0E22C380A28899612Df00c3323fB); // BuyBack Address
