/**
Telegram : https://t.me/SierraProtocol
Website :https://sierra-protocol.ltd
*/
...
contract SIERRAPROTOCOL is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3d62a393B8E4c7818E240119C01c6FDB608d977d); 
    address payable private Wallet_Dev = payable(0x3d62a393B8E4c7818E240119C01c6FDB608d977d);
    ...
    string private constant _name = "Sierra Protocol "; 
    ...
    constructor () {
        ...
        _owner = 0x3d62a393B8E4c7818E240119C01c6FDB608d977d;
