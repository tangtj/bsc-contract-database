// https://t.me/MinionaireInuBSC
// https://twitter.com/MinionaireINU
...
contract MinionaireInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Minionaire Inu";
    string private constant _symbol = unicode"MNUR";
