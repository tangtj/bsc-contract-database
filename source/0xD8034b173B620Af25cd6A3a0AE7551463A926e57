...
contract Fauget is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"FAUGET";
    string private _symbol = unicode"FAUGET";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x3CC96C9D783Bfad588FeFDa86637e01898E7ab9D);
    address payable private taxWallet2 = payable(0x3CC96C9D783Bfad588FeFDa86637e01898E7ab9D);
