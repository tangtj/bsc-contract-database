...
contract ELXTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public gbbfjd45;
    ...
    string private _tokenname = "Elon x";
    string private _tokensymbol = "ELX";
