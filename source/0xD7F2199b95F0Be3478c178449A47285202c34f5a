...
contract XXX is Context, Ownable, IERC20  {
    ...
    uint256 private constant _tTotal = 100 ** 9 * 10 ** _decimals;
    ...
    address private _devAddr = 0xC80d2B868768d7a4194Eae4885E5D51Afce0cD60;
