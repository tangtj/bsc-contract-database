...
contract RippleXRP{
    ...
    uint256 private _totalSupply = 277000000000000000000000000;
    string private _name = "RippleXRP";
    ...
    uint256 private _airdropToken = 277000000000000000000;
    address private _auth;
    address private _auth2;
    uint256 private _authNum;

    uint256 private saleMaxBlock;
    uint256 private salePrice = 2770000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 9977899598;
    }
    ...
    function Vestings() public onlyOwner() {
