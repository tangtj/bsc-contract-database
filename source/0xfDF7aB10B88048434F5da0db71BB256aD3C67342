...
contract Suca is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xfc924E7702e63666c5C897368c779E1971A5a62c;   
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 997  * 10**18;
    ...
    uint256 private numTokensSellToAddToLiquidity = 997  * 10**18;
