...
contract DBTsTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public amvyui45;
    ...
    string private _tokenname = "DuckBETs";
    string private _tokensymbol = "DBTs";
