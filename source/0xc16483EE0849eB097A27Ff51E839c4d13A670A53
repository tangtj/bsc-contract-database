...
contract DOLLARPEPEMONSTER is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8ef9733A2172F6C56C732BCAB55F9874d279A770); 
    address payable public Wallet_Dev = payable(0x8ef9733A2172F6C56C732BCAB55F9874d279A770);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "DOLLARPEPEMONSTER"; 
    ...
    constructor () {
        _owner =0x8ef9733A2172F6C56C732BCAB55F9874d279A770;
