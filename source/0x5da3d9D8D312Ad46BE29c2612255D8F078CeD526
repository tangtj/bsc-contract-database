...
contract MBP_LIQUIYIELD_T3_IDO is Context, Ownable {
    ...
    // Can only invest in one tier
    uint256 private UPPER_LIMIT_MBP_HOLDING = 150_000 * (10**18);
    ...
    uint256 private MINIMUM_INVESTMENT = 9 * (10**18);
    uint256 private MAXIMUM_BUY_AMOUNT = 17 * (10**18);
    ...
    uint256 private HARDCAP = 952 * (10**18);
