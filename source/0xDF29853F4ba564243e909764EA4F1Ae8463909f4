/*
        "NITROUS LABS BLOCK CHAIN"

Telegram : https://t.me/NitrousLabsPortal
Website : https://nitrouslabs.online
*/
...
contract NitrousChain is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Nitrous Chain";
    string private _symbol = unicode"NITROUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xDb6603773a40B3cD1B7Fb9B8Dd2e5e132A106595);
