// PENG COIN - the new meme coin on the Smart chain that is going to revolutionize your investment portfolio! Based on our love for penguins, PENG COIN comes packed with exciting features including an AutoBurn Mechanism, Low Tax Liquidity Lock that lasts for one year, and RenounceOwnership. With these innovative features in place, PENG COIN offers a unique investment opportunity that shouldn't be missed. Join our community today and enjoy the rewards that come with investing in this amazing project!

pragma solidity ^0.8.18;
// SPDX-License-Identifier: MIT


//https://t.me/PengCoinCommunity
//https://twitter.com/PengcoinBsc
interface IERC20 {
...
contract PENG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC3168585f3A5351f5a0016B9e446b7A234f60e66); 
    address payable public Wallet_Dev = payable(0xC3168585f3A5351f5a0016B9e446b7A234f60e66);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =500000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "PENG COIN"; 
    ...
    constructor () {
        _owner =0xC3168585f3A5351f5a0016B9e446b7A234f60e66;
