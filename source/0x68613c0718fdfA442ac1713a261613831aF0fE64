...
Website : https://control2xy.ai/
Telegram : https://t.me/ControlAI21M
...
contract CTRLAI is ERC20, Ownable {
    ...
    constructor() ERC20("ControlAI", "CTRLAI") {
        ...
        swapTokensAtAmount = totalSupply * 5 / 1000000000000; // 0.05% swap wallet
