...
/**
https://t.me/NIOCTIB_TNEMECNUONNA
...
contract NIOCTIB is Context, IERC20, Ownable {
    ...
    string private _name = "Uni01cinoSamabOrettoPyrraH";
    string private _symbol = "NIOCTIB";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x3D5F3eE54cD0A0396c48C99afF38718923F17d74); // Marketing Address
    address payable public teamWalletAddress = payable(0x3D5F3eE54cD0A0396c48C99afF38718923F17d74); // Team Address
