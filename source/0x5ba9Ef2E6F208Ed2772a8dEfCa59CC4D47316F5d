// https://t.me/metaprintlaunchpad
// https://twitter.com/Metaprintpad
// https://www.metaprintpad.org/
...
contract MetaPrint is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaPrint";
    string private _symbol = "MetaPrint";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1D105A248ae6E5f040A5E63167A430A52EBc67D); // Marketing Address
