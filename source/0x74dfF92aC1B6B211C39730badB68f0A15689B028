        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x000000000000000000000000000000000000dEaD), block.timestamp
                );
            }
        }
    }
...
contract b2049 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x000000000000000000000000000000000000dEaD)//ReceiveAddress
    ){
    }
}