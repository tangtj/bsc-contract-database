...
contract FGC  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 9100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Fox Gold Coin";
    ...
    uint256 public _maxTxAmount = 9100000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 910000 * 10**18;
