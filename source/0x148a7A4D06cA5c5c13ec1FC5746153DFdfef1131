...
contract ETHBOT is Context, Ownable, IERC20 {
    ...
    string internal constant _name = "ETHBOT";
    string internal constant _symbol = "ETHBOT";
    uint internal _totalSupply = 1000000000 * (10 ** _decimals);
    uint public maxHoldingPrecent = 2;
    uint internal saleThresold = 1; // 0 ether
