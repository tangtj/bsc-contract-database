...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90FcF5AE37D1cfA416c5afDf56E98fbB2B340c03; // owner address
...
contract Dogly is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogly";
    string private _symbol = "DOGLY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x021A440B29C966c078a7f41B869484f1aC0f6Adc); // Marketing Address
    address payable public teamWalletAddress = payable(0x021A440B29C966c078a7f41B869484f1aC0f6Adc); // Team Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public pinksaleLock = 0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE;
    ...
    constructor () {
        ...
        isExcludedFromFee[pinksaleLock] = true;
