...
contract FC is ERC20 {
    ...
    address _fundAddress = address(0xfb4F6290cAeB91Fa93fbA16ae627c84246Df5125);
    ...
    uint256 public buy_fee = 200;
    uint256 public sell_fee = 200;
     uint256 public all_buy_fee = 9800;
    uint256 public all_sell_fee = 9800;
   
    uint256 _kill = 3;
	uint256 total;

    constructor(address tokenOwner) ERC20("FC", "FC") {
