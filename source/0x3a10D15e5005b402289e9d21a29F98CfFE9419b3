...
"DREAMS COME TRUE UNTIL YOU UNDERSTAND WE ARE GOING DOWN
THIS PROJECT IS JUST A COMMUNITY PROJECT"

                         "DCVIRUS"
 
https://t.me/Decentralizedvirus

https://radiotvirus.github.io/
...
contract DCVIRUS is IERC20, Ownable {
    ...
    string _name = "DECENTRALIZED VIRUS";
    string _symbol = "DCVIRUS";
    ...
    constructor () {
        ...
        address marketingreceiver = 0x4a17f96255300900c6e5feA313c1f78CC9A711D4;
