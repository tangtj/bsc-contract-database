...
/**
 * Skull Heroes
 * welcome to Skull Heroes
 * this Coin is a community Coin
 * please join tg https://t.me/skullheroes
 * 2BNB Liquidity Pool will be burnt at 3kmc
 * please make sure to check everything before aping in.
 * */
...
contract SkullHeroes is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Skull Heroes (t.me/skullheroes)';
