/**
The nautilus community is a vibrant and lively group of cryptocurrency enthusiasts, meme aficionados, and blockchain believers.
...
contract NautilusNetwork is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0xe29A920C13F303c6B0Fb69056Fbe108169257D87;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x20437B31C4B2c4809608b7b24FceE2E7aBdA894f;
