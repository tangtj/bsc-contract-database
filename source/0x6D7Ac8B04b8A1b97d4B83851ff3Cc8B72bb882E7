...
contract TokenTimelock is Ownable {
    ...
    uint256 constant public AMOUNT_PER_RELEASE = 5000000 *10**18;
    uint256 constant public PERIOD = 1123200; 
    uint256 constant public START_TIME = 1684598400; // 00:00:00 GMT 15/7/2021
    address public PVU_TOKEN = 0x31471E0791fCdbE82fbF4C44943255e923F1b794;

    uint256 public lockToken = 80000000 * 10**18;
    ...
    function release() public onlyOwner {
        ...
        if (amount >= lockToken) {
            ERC20(PVU_TOKEN).transfer(owner(), getBalance());
            lockToken = 0;
        } else {
