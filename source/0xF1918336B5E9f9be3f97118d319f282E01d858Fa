...
// File: contracts/DigitalRouter.sol
...
/**
 * @author Heisenberg
 * @notice Digital Options Router Contract
 */
contract DigitalRouter is AccessControl, IDigitalRouter {
    ...
    function initiateTrade(
        ...
        IDigitalBinaryOptions optionsContract = IDigitalBinaryOptions(
            targetContract
        );
    ...
    function _openQueuedTrade(uint256 queueId, uint256 price) internal {
        ...
        uint256 revisedFee;
        bool isReferralValid;
        IDigitalBinaryOptions.OptionParams
            memory optionParams = IDigitalBinaryOptions.OptionParams(
                queuedTrade.expectedStrike,
                0,
                queuedTrade.period,
                queuedTrade.isAbove,
