...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb957804E6dC21c7c140d7b906f2CD871A8af3943; // owner address
...
contract DEADMIGOS is Context, IERC20, Ownable {
    ...
    string private _name = "DEADMIGOS";
    string private _symbol = "DEADMIGOS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb957804E6dC21c7c140d7b906f2CD871A8af3943); // Marketing Address
    address payable private teamWalletAddress = payable(0xb957804E6dC21c7c140d7b906f2CD871A8af3943); // Team Address
