...
// Telegram: https://t.me/calciumnetwork_bsc
...
contract CalciumNetwork is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xCEEceB0a91115C2Ae43b29903Bb2DDa2Aa38d333);
    address payable private _twdmkt = payable(0xCEEceB0a91115C2Ae43b29903Bb2DDa2Aa38d333);
    
    string private constant _name = "Calcium Network";
