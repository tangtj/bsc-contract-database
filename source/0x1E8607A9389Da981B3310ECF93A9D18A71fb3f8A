// Join Now: https://t.me/stewiecoin_Portal
...
contract STEWIE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "STEWIE";
    string private constant _symbol = unicode"$STE";
    ...
    address payable public DevWallet = payable(0x71BA8863aeFC08c6A06FBEE2C079D3EE55b9F04B);
    address payable public MarketingWallet = payable(0x55dc8414C1d91Cee7988CBEa5839458fd0Ca416d);
