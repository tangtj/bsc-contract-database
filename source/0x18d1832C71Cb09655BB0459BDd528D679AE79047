...
contract PePeWonka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PePe Wonka";
    string private _symbol = "PWONKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8837b0Af11C24AfA4f2874E5F7FFBe8c17Ef18BB); // Marketing Address
    address payable public teamWalletAddress = payable(0xdA971EF66Fe5CAc9Bd9286FC39233543Af79aCa8); // Team Address
