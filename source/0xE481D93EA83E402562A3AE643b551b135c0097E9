...
contract BewareSCammer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beware SCammer";
    string private _symbol = "$BSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE5dAD8fcd17C96620424Ca51d5F1078cF0e608EC); // Marketing Address
    address payable public teamWalletAddress = payable(0xE5dAD8fcd17C96620424Ca51d5F1078cF0e608EC); // Team Address
