...
contract victorybsc is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1500000000000 * (10 ** _decimals);
    ...
    string constant _name = "VICTORY BSC";
    ...
    constructor() {
        ...
        marketingWallet = 0xA5b0Ab82497e8a855B34CaFd14E3a15Cc16Da76C;
        devWallet = 0xA5b0Ab82497e8a855B34CaFd14E3a15Cc16Da76C;
