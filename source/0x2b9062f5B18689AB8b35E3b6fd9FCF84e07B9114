/*
About Pepe Thug LIfe

The project wants to encourage the Pepe meme community to be more creative 
in creating entertaining meme content. By allowing users to add 'Thug Life' elements to Pepe memes, 
PEPETHUG creates a source of inspiration for different and unique memes.

TG: https://t.me/PepeThugLifeCoin
*/
...
contract PepeThugLife is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Thug Life";
    string private _symbol = "PEPETHUG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFEA3257b2EC2ac6555954D41b61316bfccB7A3Bb); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x5AEeBe1Cb5BF5FbCf9288a9C34A91FC17BE8C8Af); // Development Address
