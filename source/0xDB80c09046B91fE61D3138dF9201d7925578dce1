/**
Inspired by HarryPotterObamaSonic10Inu


https://t.me/HPOS20InuBINANCE
-----------------------------------------------------------------------------------
*/
...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"HarryPotterObamaSonic10Inu";
    string constant _symbol = unicode"BITCOIN";
