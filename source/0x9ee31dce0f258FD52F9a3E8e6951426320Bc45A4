...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x20B96123317c447Aeee32525f7F75FC8c8606a25; // owner address
...
contract Token2094 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "2094";
    string private _symbol = "2094";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x20B96123317c447Aeee32525f7F75FC8c8606a25); // Marketing Address
    address payable private teamWalletAddress = payable(0x20B96123317c447Aeee32525f7F75FC8c8606a25); // Team Address
