...
contract BnbBonk is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BNB BONK";
    string constant _symbol = "BNB BONK";
    ...
    uint256 public _maxTxAmount = 10 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 10 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        //
        autoLiquidityReceiver = 0x9B942eeab422775fF3B7B9005B326AC015e8BDC5;
        marketingWallet = 0x9B942eeab422775fF3B7B9005B326AC015e8BDC5;
        devWallet = 0x9B942eeab422775fF3B7B9005B326AC015e8BDC5;
