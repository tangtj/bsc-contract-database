...
contract DOGESI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGESI";
    string private _symbol = "DOGESI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x546D4d6b6A96943D43Bb0d52eF47271682eD7bd1); // Marketing Address
    address payable public teamWalletAddress = payable(0xDf7cB770122975A087b50D28909611656fA22bf0); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xDf7cB770122975A087b50D28909611656fA22bf0),
            block.timestamp
        );
    }
