/*
🔵EPChain Network is an all-in-one decentralized cryptocurrency platform with huge plans! EPChain Network is fairly distributed, eco-friendly and consumes minimal battery power. EPChain Network is fair and valuable to everyone

🔵Download APP : https://play.google.com/store/apps/details?id=com.epcrypto.network
🔵Staking
🔵Web3 Wallet
🔵Swap/Dex
🔵Blockchain
🔵Buy/Sell Tax = 1%
🔵Testnet SOON
🔵Website :https://epchainnetwork.org
🔵TG: https://t.me/epchainnetworkbsc
*/
...
contract Epchainnetwork is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Epchain";
