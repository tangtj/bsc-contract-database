...
// File: contracts/MasterChefPoolRewardPairGoblinV2.sol
...
contract MasterChefPoolRewardPairGoblinV2 is Ownable, ReentrancyGuard, Goblin {
    /// @notice Libraries
    ...
    constructor(
        ...
        IERC20 _lpToken = masterChef.lpToken(pid);
