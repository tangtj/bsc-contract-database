...
Telegram : https://t.me/Indomietoken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x791cf7611A3A294B18f532c3Bb40Cb8bd09FCfcc; // owner address
...
contract INDOMIE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"INDOMIE";
    string private _symbol = unicode"$INDOMIE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x791cf7611A3A294B18f532c3Bb40Cb8bd09FCfcc); 
    address payable public teamWalletAddress = payable(0x791cf7611A3A294B18f532c3Bb40Cb8bd09FCfcc);
