...
contract Mycoin is ERC20, Ownable  {
    ...
    address public constant marketAddress = 0xB435923DC197C5D1E023BD2B844517Dfc7A217fA;
    address public constant devAddress = 0x488df3c5773a06317579D36D264ceC96Fc038955;

    uint256 private constant total =  10 * 1e8 * 1e18;

    uint256 public _liquidityFee = 1; //iquidityFee
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketFee = 2; //marketFee
    uint256 private _previousMarketFeeFee = _marketFee;

    uint256 public _devFee = 2; //developmentFee
    ...
    //uint256 public numTokensSellToAddToLiquidity = 2000 * 1e18;
    ...
    constructor() ERC20("NEON CITY", "NCY") {
...
*/
    ...
    function _takeLiquidity(address sender, uint256 tLiquidity) private {
        if(tLiquidity > 0){
            _balances[marketAddress] += tLiquidity;
            emit Transfer(sender, marketAddress, tLiquidity);
        }
    }
