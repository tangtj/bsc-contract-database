...
contract Ownable is Context {
    ...
    function CryptoCartelOwnership() public virtual onlyOwner {
...
contract CryptoCartel is ERC20, Ownable {
    ...
    CryptoCartelDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CryptoCartel", "CARTEL") {
        marketingWallet = payable(0x6B5008182674413d07E7d1DE09c853B27997c5b9);
        devWallet = payable(0x1b24Bf12935344c0Cbd8833825083B13B79F1673);
        ...
        dividendTracker = new CryptoCartelDividendTracker(
            payable(this),
            router,
...
contract CryptoCartelDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CryptoCartel public CryptoCartelContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CryptoCartelContract = CryptoCartel(mainContract);
    ...
    function _transfer(
        ...
        require(false, "CryptoCartel_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CryptoCartel_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CryptoCartel contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CryptoCartelContract);

            uint256 prevBalance = CryptoCartelContract.balanceOf(address(this));
            ...
            {
                uint256 received = CryptoCartelContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CryptoCartelContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
