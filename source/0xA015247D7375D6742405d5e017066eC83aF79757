...
/*
3% DOGE Rewards - 2% EMB Reflection - 1% Buyback&Burn = Elon Money Glitch! 

50% Total Supply Burnt at Launch

Telegram: https://t.me/ElonMuskBoys_BSC
...
library SafeMath {
     ...
     * overflow.
     *
     * Counterpart to Solidity's `+` oEMBtor.
     *
     * Requirements:
     *
     ...
     *
     * Counterpart to Solidity's `/` oEMBtor. Note: this function uses a
     ...
     *
     * Counterpart to Solidity's `%` oEMBtor. This function uses a `revert`
...
contract ElonMuskBoys is Context, IBEP20, Ownable {
    ...
    address DOGE = 0x25d887Ce7a35172C62FeBFD67a1856F20FaEbB00; // DOGE

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xb6a419A2E9EF7A8E12919C401200B28E18797F22;
    address public liquidityWallet = 0x95C56EA03Fe69fa2b6Bb808d111C2A2d46836111;

    string private constant _name = "ElonMuskBoys";
    string private constant _symbol = "EMB";
    ...
    // tax reflection, mkt, lp, DOGE Rewards
    ...
    constructor() {
       IRouter _router = IRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        ...
        distributor = new DividendDistributor(address(router), DOGE, _router.WETH());
    ...
    function setDistributorGas(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "EMB: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != distributorGas, "EMB: Cannot update gasForProcessing to same value");
