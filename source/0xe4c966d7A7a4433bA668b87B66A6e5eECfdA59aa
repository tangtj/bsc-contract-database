...
contract flokifirebsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Fire";
    string private _symbol = "FlokiFire";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78878976b76Ec2516C4662bD0e355619166B1809);
    address payable public teamWalletAddress = payable(0x78878976b76Ec2516C4662bD0e355619166B1809);
