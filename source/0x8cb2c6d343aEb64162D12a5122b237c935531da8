...
//TELEGRAM: https://t.me/reflectionaibot
interface IERC20 {
...
contract REFLECTIONAI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 111100000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 11111 * 10**_decimals;
    
    uint256 public maxSellAmount = 111100000 * 10**_decimals;
    uint256 public maxBuyAmount = 111100000 * 10**_decimals;
    uint256 public maxWalletBalance = 111100000 * 10**_decimals;

    address public marketingAddress = 0xCea3ba7111Cc3057b1Ad71df9764867D85AEb5AE;
    address public devAddress = 0xCea3ba7111Cc3057b1Ad71df9764867D85AEb5AE;

    string private constant _name = "REFLECTION AI";
    ...
    Taxes public taxes = Taxes(1,3,3,0);
    Taxes public sellTaxes = Taxes(1,3,3,0);
