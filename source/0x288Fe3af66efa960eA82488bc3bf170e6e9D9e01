...
contract NFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("PG WHY", "PG WHY"){
        _minter[msg.sender] = true;
        _uris[1] = "http://nftc.difiproject.top/li_1.json";
        _uris[2] = "http://nftc.difiproject.top/li_2.json";
        _cash = address(0x255838189aEDCa6203c05e070b9A05338e98E9a3);
    }
}