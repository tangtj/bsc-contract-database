...
contract BETARIUM is Context, IERC20, Ownable {
    ...
    string private _name = "Wagie Coin";
    string private _symbol = "$WAGIE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x441c873a13f17960be58A2e9DF10D29F474F2a1E);
    address payable private DevelopmentWalletAddress = payable(0x441c873a13f17960be58A2e9DF10D29F474F2a1E);
