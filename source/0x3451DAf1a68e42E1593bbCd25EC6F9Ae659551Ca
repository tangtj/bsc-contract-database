...
contract apple is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "apple15";
        _decimals = 18;
        address ReceiveAddress = 0x4ee52506ea11A3aAe54437497c436044958EDd5C;
        address FundAddress = 0x4ee52506ea11A3aAe54437497c436044958EDd5C;
    ...
    function swapToken(uint256 tokenAmountOut, address to) private lockTheSwap {
        ...
        uint256[] memory tokenAmountList = _swapRouter.getAmountsIn(
            tokenAmountOut,
            path
        );
        uint256 tokenAmount = tokenAmountList[0];
