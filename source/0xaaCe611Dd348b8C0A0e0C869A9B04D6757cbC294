...
contract Raichu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Raichu";
    string private constant _symbol = "$RAICHU";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x1560a1f3Abd9676900Eab934b568215fC624770a);
    address payable private _marketingAddress = payable(0x1560a1f3Abd9676900Eab934b568215fC624770a);
