...
contract OneDollarLp is Context, IERC20, Ownable {
    ...
    string private constant _name = "1$ LP";
    string private constant _symbol = "1$";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0668f0514b9a5E510E4783d0844a5113974E0895);
    address payable private _marketingAddress = payable(0x0668f0514b9a5E510E4783d0844a5113974E0895);
