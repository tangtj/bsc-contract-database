// telegram     : https://t.me/astronium_network
// Website      : https://astronium.site
...
contract ASTROI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Astronium Network";
    string private _symbol = "ASTROI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x299590f146D60B385D98911CB0F1487D311f7598); // Marketing Address
    address payable public teamWalletAddress = payable(0x299590f146D60B385D98911CB0F1487D311f7598); // Team Address
