...
// Website: https://www.safehiphi.pro
// Telegram: https://t.me/safehiphi
// Twitter: https://twitter.com/safehiphi
...
contract SAFEHIPHI  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SafeHiphi";
    string private constant _symbol = unicode"SFH";
