...
/**
   ...
   Welcome to MAJESTICLAMBO
   
   This is a community token. If you want to create a telegram I suggest to name it to @MAJESTICLAMBOBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MAJESTICLAMBO to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MAJESTICLAMBO 10000X? 
   ...
   it's the best part of the #MAJESTICLAMBO idea, increasing the liquidity pool automatically, 
...
contract MAJESTICLAMBO is Context, IERC20, Ownable {
    ...
    string private _name = "MAJESTICLAMBO";
    string private _symbol = "MJCL";
