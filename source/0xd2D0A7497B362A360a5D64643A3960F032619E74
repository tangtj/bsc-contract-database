...
contract DoneLomi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 800_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DoneLomi";
    string private _symbol = "Resp";
    ...
    uint256 public _maxTxAmount = 800_000_000 * 10**18;
