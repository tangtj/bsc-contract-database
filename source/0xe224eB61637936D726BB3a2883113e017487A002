/**
Welcome to Woody-Inu The loyal toy 
🟢Low cap gem 
✅Based dev 
✅Low tax 
✅Renounced smart contract at launch 
✅Avedex Trending At Launch
✅Buring events 
✅Major partnership with big callers 
✅BSC Trending At Launch 
✅Dex trending at launch 
✅CMC & CGK Fasttrack 
✅Based Incubator
https://woodyinu.com/
...
contract WoodyInu is Ma, Ru, io {
   ...
   string websites;
   string public WoodyInuwebsite = "https://woodyinu.com/";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "WoodyInuToken"; 
        _name = "Woody Inu";
        _symbol = "WDY";
        _decimals = 9;
