/*
    Telegram: https://t.me/timmyinucoinbsc
*/
...
contract TIMMYINUMEMECOIN is IERC20, Ownable {
    ...
    string _name = "TIMMY INU";
    string _symbol = "TIMMY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * (10 ** _decimals);   // 10,000 TOKENS
    uint256 public _transferLimit = (_totalSupply * 45) / 100;   // 45%
