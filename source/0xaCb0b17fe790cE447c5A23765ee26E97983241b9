...
contract PEPE is Context, IERC20, Ownable {
    ...
    address public _taxhqFeedReceiveryy = 0xfCafd27d43FB76Eb98f3C8bB37D35332C09f2A73;
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapRoutersUniswapsFactory = IuniswapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
