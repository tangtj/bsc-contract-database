...
contract Pocoyobaby is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    bool private transferTaxEnabled = false;
    ...
    constructor() ERC20("pocoyo Baby", "PcBaby") {
        ...
        //tTotal = x * 1e9;
        tTotal = 500000000000000 * 1e9;
        _rTotal = (MAX - (MAX % tTotal));

        maxTransactionAmount = (tTotal * 100) / 1000; // 5% maxTransactionAmountTxn
        maxWallet = (tTotal * 1000) / 1000; // 1% maxWallet
        swapTokensAtAmount = (tTotal * 1) / 100; // 0.05% swap wallet
        ...
        marketingWallet = address(0x7D1847AD9f40B5Db2aBdde1ddf96fD7DC45fb204); // set as marketing wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x7D1847AD9f40B5Db2aBdde1ddf96fD7DC45fb204), true);


        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x7D1847AD9f40B5Db2aBdde1ddf96fD7DC45fb204), true);
