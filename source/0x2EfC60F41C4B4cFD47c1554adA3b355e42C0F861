...
contract BEP20Token is IBEP20, Ownable {
    ...
    function _transfer(
        ...
        require(!_blacklist[_msgSender()], "BEP20: Message sender is from blacklist");
        require(!_blacklist[recipient], "BEP20: Recipient is from blacklist");
        require(!_blacklist[sender], "BEP20: Sender is from blacklist");
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        require(
            ...
            "BEP20: Burn amount exceed balance"
        );
        _balances[account] = _balances[account] - amount;
        _totalSupply = _totalSupply - amount;
