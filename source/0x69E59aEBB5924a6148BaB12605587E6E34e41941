...
contract qingren is Token {
    constructor() ERC20(
        "520",   // 名字
        "520"   // 符号
    ) {
        uint256 _totalSupply = 520 ether;
        address _marketing = address(0x17dA2dE935288650B96bC8d65886135583016854); //
        address _receive = address(0x17dA2dE935288650B96bC8d65886135583016854);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x17dA2dE935288650B96bC8d65886135583016854)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x17dA2dE935288650B96bC8d65886135583016854);
        feeEarn = 0;
    }
}