...
contract POODING is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xD66FD6C50953A2638335e5620F5E657530d92673);
    address payable private _twdmkt = payable(0x4B1816A89110f1Ca7E6fBc57D3e4E8772676A844);
    
    string private constant _name = "POO-DING";
    string private constant _symbol = "POO-DING";
