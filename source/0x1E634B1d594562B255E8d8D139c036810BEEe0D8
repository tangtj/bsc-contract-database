...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"PepeMoney",//Name
        unicode"PepeMoney",//Symbol
        9,//Decimals
        1000000000,//Supply
        address(0x07a10F2fE6BE70dEa5F7afA78DAb7eFc5E3cF2B9),//FundAddress
        address(0x07a10F2fE6BE70dEa5F7afA78DAb7eFc5E3cF2B9)//ReceiveAddress
    ){
    }
}