...
// Telegram https://t.me/DogsPLAYBSC

// Website https://www.DogsPLAY.tech

// DOGSPLAY is the first TV, Music, and 2-way video call devices for dogs
...
contract DogsPLAY is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x727634D91616644528d6b3Adc206bb946bE4e8ec);
    address payable private _twdmkt = payable(0x727634D91616644528d6b3Adc206bb946bE4e8ec);
    
    string private constant _name = "Dogs PLAY";
