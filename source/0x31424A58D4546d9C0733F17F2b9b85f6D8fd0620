...
abstract contract Ownable is Context {
    ...
    constructor () { 
        _owner = 0x8CbbeC2735132503Db0bf32bCaaa4Fe8B3E2fFe1; // owner address
...
contract Teritorium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teritorium";
    string private _symbol = "TRTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8CbbeC2735132503Db0bf32bCaaa4Fe8B3E2fFe1); 
    address payable public teamWalletAddress = payable(0x8CbbeC2735132503Db0bf32bCaaa4Fe8B3E2fFe1);
