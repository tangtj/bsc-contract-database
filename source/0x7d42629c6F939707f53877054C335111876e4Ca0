...
Website  : oriumprotocol.site
Telegràm : https://t.me/OriumProtocol
...
contract OriumProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ORIUM Protocol";
    string private _symbol = "$ORIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1336b7f4E0848F088258504e67b2b39743B319f2); // Marketing Address
    address payable public teamWalletAddress = payable(0x1336b7f4E0848F088258504e67b2b39743B319f2); // Team Address
