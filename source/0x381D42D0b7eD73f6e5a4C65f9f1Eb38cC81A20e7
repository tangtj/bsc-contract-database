...
/**TG: https://t.me/BabyAkino_Inu
/**Twitter: https://x.com/Baby_Akinoinu
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  AKI = IBEP20(0xe8D0658b9b52C00A15E4a1a738Ce7C90dC95A44c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AKI .balanceOf(address(this));
        ...
        uint256 amount = AKI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AKI.transfer(shareholder, amount);
...
contract BabyAkinoInu is IBEP20, Auth {
    using SafeMath for uint256;

    address AKI = 0xe8D0658b9b52C00A15E4a1a738Ce7C90dC95A44c; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x6D053312E9F0d586b23DA135dFC381550be8F301;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Baby Akino Inu";
    string constant _symbol = "BABYAKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x6D053312E9F0d586b23DA135dFC381550be8F301;
