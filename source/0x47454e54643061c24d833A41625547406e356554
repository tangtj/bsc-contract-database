...
contract $1DOGE is ERC20, Ownable {
    ...
    constructor() payable ERC20("$1 DOGE", "$1 DOGE") {
        ...
        marketingWallet = 0x242A75386A6fd8D7F90fffaa15e590Db0FcA4395;
