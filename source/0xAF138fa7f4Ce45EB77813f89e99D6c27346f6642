...
contract SellToken is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("TD-gold","TD-gold", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;//QmXgJoQxbQyXbR9RiJREiYFh9YoJF2pqHwQxsAqXLE633e
        sethiddenBaseURI("https://ipfs.io/ipfs/QmXgJoQxbQyXbR9RiJREiYFh9YoJF2pqHwQxsAqXLE633e?filename=qianjin.jpg");
    }
