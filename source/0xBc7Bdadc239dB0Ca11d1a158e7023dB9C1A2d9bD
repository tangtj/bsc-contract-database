// BITCOIN BLACK A FAIRLY DISTRIBUTED, GREENER, FEE FREE & INSTANT CRYPTOCURRENCY DESIGNED FOR MASS ADOPTION
// 90-99% OF ALL THE BITCOIN IS OWNED BY 1% OF ALL THE USERS


// SUPPLY: 34,028,226,692
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
   ...
   /* function _burn2() internal {
     ...
     * e.g. implement auto BBLACK token fees, slashing mechanisms, etc.
     *
     * Emits a {Transfer} event.
     *
     * Requirements:
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(TIME = true && timeNow < transData[sender] + 60 minutes){
            revert("FOR FUNDS PROTECTION, YOU CAN ONLY SELL 1 Sale PER 60 MIN");
        }
     ...
     * e.g. set autoDONKEY BBLACK allowances for certain subsystems, etc.
     *
     * Emits an {Approval} event.
     *
     * Requirements:
...
contract BITCOINBKLACK is DeflationaryERC20 {

    constructor() DeflationaryERC20("BITCOINBKLACK", "BBLACK") {

        _mint(msg.sender, 34028226692e18);  
    }
