...
contract PUSSHUTOKUN is Context, IERC20, Ownable {
    ...
    string private _name = "PUSSHUTOKUN";
    string private _symbol = "PUSSHU";
    ...
    address payable public marketingWallet = payable(0x3425B4D6191a14d7FAE522E5E95431daB228Fae6);
    ...
    uint256 public _maxWalletLimit = 5 * 10**18;
    address admin;
