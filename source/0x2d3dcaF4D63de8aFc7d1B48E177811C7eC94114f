...
contract SSSSSS is ERC20, Ownable {
    ...
    constructor() payable ERC20("SS", "S") {
        ...
        _marketaddress = address(0x45939d1c98027B7e5e458F2C00e2b7694Fa37ddE);
        _devAddress = address(0x45939d1c98027B7e5e458F2C00e2b7694Fa37ddE);
