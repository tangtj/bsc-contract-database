// Telegram : https://t.me/garfieldxbsc
// Twitter : https://twitter.com/garfieldxbsc
...
contract GarfieldX is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x8027D2e17b404b67102611aDb3302A5Ae0FB66C5);
    address payable private _twdmkt = payable(0x8027D2e17b404b67102611aDb3302A5Ae0FB66C5);
    
    string private constant _name = "GARFIELD X";
    string private constant _symbol = "GARFIELDX";
