...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55315E676654D82Fe8c8B1A50bd8eFEd229e4fE5; // owner address
...
contract babydodo is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Dodo";
    string private _symbol = "BOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55315E676654D82Fe8c8B1A50bd8eFEd229e4fE5); // Marketing Address
    address payable public teamWalletAddress = payable(0x55315E676654D82Fe8c8B1A50bd8eFEd229e4fE5); // Team Address
