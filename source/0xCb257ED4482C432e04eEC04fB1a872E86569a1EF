/*
TELEGRAM: https://t.me/shiasagabsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xA7d9003CD393e924d92a92Ffe15e597e75101CEe; // owner address
...
contract SHIASAGA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC02A727570B44756F832Aa1D332a5C78480a6f59);
    address payable public teamWalletAddress = payable(0xC02A727570B44756F832Aa1D332a5C78480a6f59);
    ...
    uint256 private minimumTokensBeforeSwap = 8000000 * 10**_decimals;
