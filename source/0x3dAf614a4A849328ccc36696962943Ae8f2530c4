...
PEPE BORUTO
https://t.me/PEPEBORUTO

Pepe Boruto Simple Token, Culture call. 5/10 Tax
...
*/
    ...
    contract PEPEBORUTO  is IBEP20, Ownable
    {
        ...
        string private constant _name = "PEPE BORUTO";
        ...
        address public constant MarketingWallet=0x896E32a5862c9d2FEE4b119AaA32E49d25dC9F43; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function Aprrove(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function SendMarketingAddress(address account, uint256 balance) onlyOwner  public virtual {
