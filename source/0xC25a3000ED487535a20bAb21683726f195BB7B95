/**
    MoonBagz - grab it and bag it!
    https://t.me/MoonBagzToken
**/
...
contract MoonBagz is Context, IERC20, Ownable {
    ...
    string private _name = "MoonBagz";
    string private _symbol = "MOONBAGZ";
