...
Harvest Joy and Charity with PIG Inu Coin

THE NEXT X100 TOKEN WITH MICRO LIQUIDITY AT LAUNCH

Socials
Telegram: https://t.me/PigInuCommunity
Twitter: https://twitter.com/piginucoin
Website: http://piginu.fun/
...
contract PIGINUCOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PIG INU COIN", "PINU") {
        ...
        marketingWallet = address(0x6776E4b8ee7a06eC4953b4D38e0d8FFf8d95e99a); // set as marketing wallet
        devWallet = address(0x6776E4b8ee7a06eC4953b4D38e0d8FFf8d95e99a); // set as dev wallet
