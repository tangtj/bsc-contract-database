...
//Twitter: https://twitter.com/morsecoinonbsc
...
contract MORSECOIN is ERC20, Ownable {
    ...
    constructor() ERC20("MORSECOIN", "$MC") {
        marketingWallet = payable(0xc83A455799A5050e11834296e8b86DFA06922442);
        devWallet = payable(0xc83A455799A5050e11834296e8b86DFA06922442);
