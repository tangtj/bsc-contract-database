...
contract FUSDT is Context, IERC20, Ownable {
    ...
    address public treasuryAddress = 0x024D9FD00372bBfc7a490045B87cFcb863F35f0E;
    address public crmContract ;
    address public nodeAddresss;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "FUSDT Token";
    ...
    function setSellFeeRates(uint256 _burns) external {
        ...
        require(msg.sender == nodeAddresss || msg.sender == owner(),"Only Verified can do");
    ...
    function mintFromContract(uint256 _amount,address _receiver) external returns (bool) {
