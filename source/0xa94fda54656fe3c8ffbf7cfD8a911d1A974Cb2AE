...
//Telegram: https://t.me/pepevseveryone
...
contract PepeVsEveryone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"PEVE";
    string private _symbol = unicode"$PepeOne";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xA6664ce213c07DedD13320857ecf3B1E0466C63A);
    address payable private taxWallet2 = payable(0xA6664ce213c07DedD13320857ecf3B1E0466C63A);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*2000000/100000000; 
