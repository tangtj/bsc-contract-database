...
contract RUNX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"RUNX";
    string private constant _symbol = unicode"$RUNX";
