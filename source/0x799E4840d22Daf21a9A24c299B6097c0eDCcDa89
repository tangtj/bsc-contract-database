...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22255Dd347626eca65456615035261408E7C2248; // owner address
...
contract BLUI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blui Coin";
    string private _symbol = "BLUI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x22255Dd347626eca65456615035261408E7C2248); // Marketing Address
    address payable private teamWalletAddress = payable(0x22255Dd347626eca65456615035261408E7C2248); // Team Address
