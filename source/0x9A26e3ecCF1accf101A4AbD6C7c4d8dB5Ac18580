/**
X PAYPAL USD( $XPYUSD ) is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community
...
contract XPAYPALUSD is Context, IERC20, Ownable {
    ...
    string private constant _name = "X PAYPAL USD"; // 
    string private constant _symbol = "XPYUSD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xFB8c0Ce07d3a48DEE78264560a7546F101d3144f;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x7b4c5f67296E34e7aB58bB5FAe10a40D0AdB1963;
