...
contract DorkShibaToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dork Shiba";
    string private _symbol = "DST";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5fd0aF86BD4704660e7a45Fbd74F1d06F51b4A2d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x253c3bb19e0Dc4f3fC8Ae9cfc46E27052B1e3278); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000 * 10**6 * 10**18; // 1 billion
    uint256 public _maxTxAmount = 50 * 10**6 * 10**9; // 50 million
    uint256 public _walletMax = 100 * 10**6 * 10**9; // 100 million
    uint256 private minimumTokensBeforeSwap = 1 * 10**6 * 10**9; // 1 million
