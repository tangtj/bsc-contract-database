...
contract BABYALIENS  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x172BEF587ea2346594F8E07DA9E384AA6607F1dE); 
    address payable public Wallet_Dev = payable(0x172BEF587ea2346594F8E07DA9E384AA6607F1dE);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 500* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "BABYALIENSBSC"; 
    string private constant _symbol = unicode"$BABYALIENS"; 
    ...
    constructor () {
        _owner =0x172BEF587ea2346594F8E07DA9E384AA6607F1dE;
