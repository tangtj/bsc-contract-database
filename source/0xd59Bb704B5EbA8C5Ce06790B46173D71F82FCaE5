...
contract PEPEDIE is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE DIE";
    string private constant _symbol = "PEDIE";
    ...
    address payable private _twddev = payable(0x55F5D1eF3f6Ed12581C7DfF71332Af4eA65a7278);
    address payable private _twdmkt = payable(0x55F5D1eF3f6Ed12581C7DfF71332Af4eA65a7278);
