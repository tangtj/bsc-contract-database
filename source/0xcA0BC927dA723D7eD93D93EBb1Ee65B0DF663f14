...
contract DOGCOINTWO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8fA56f43e84CCdC616f0B68F0D811168D60468f6); 
    address payable public Wallet_Dev = payable(0x8fA56f43e84CCdC616f0B68F0D811168D60468f6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1*100000 * 10**_decimals;
    string private constant _name = "DOGCOIN 2.0"; 
    string private constant _symbol = unicode"WOOF2.0"; 
    ...
    constructor () {
        ...
        _owner = 0x8fA56f43e84CCdC616f0B68F0D811168D60468f6;
