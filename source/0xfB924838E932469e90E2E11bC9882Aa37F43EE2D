...
//--- Contract v2 ---//
contract MiraAI is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x40986A52461fa576D94EBFe16650af1e43aaBa29);


    IRouter02 public swapRouter;
    string constant private _name = "Miraverse Ultimate";
    string constant private _symbol = "Mira AI";
