...
// File contracts/HagridToken.sol

// contracts/PyramidToken.sol
// Original license: SPDX_License_Identifier: MIT

pragma solidity ^0.8.19;
contract HagridToken is ERC20Capped, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    constructor() ERC20("Hagrid Token", "HAGR") ERC20Capped(100_000_000 * (10 ** decimals())) {
        // for liquidity
        _mint(msg.sender, 97_000_000 * (10 ** decimals()));
        // 1% dev
