/**
   ...
   Welcome to Lil Floki
   
   This is a community token. If you want to create a telegram I suggest to name it to @LilFlokiBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LilFloki to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LilFloki 10000X? 
   ...
   it's the best part of the #LilFloki idea, increasing the liquidity pool automatically, 
