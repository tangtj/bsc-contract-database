...
contract SIMPSONCASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "SIMPSON CASH"; // 
    string private constant _symbol = "SIMCASH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x19b2ED9469FdF26fc138418A7Bc52408085F3178;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xF81056A9F9cC4659777a87075839C858355BB0ee;
