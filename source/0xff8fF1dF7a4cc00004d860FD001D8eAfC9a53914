...
contract BabyVault is Context, IERC20, Ownable {
    ...
    string private _name = "BabyVault";
    string private _symbol = "BABYVAULT";
    ...
    uint256 public _sellBuyBackFee = 15;
    uint256 public _previousSellBuyBackFee = _sellBuyBackFee;
    ...
    uint256 private buyBackDivNum = 100;
    ...
    function buyBackDivNumAmount() public view returns (uint256) {
        return buyBackDivNum;
    }
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            uint256 forBuyBack;
            forBuyBack = amount.mul(_sellBuyBackFee).div(100);
            ...
            if (buyBackEnabled) {
                ...
                buyBackTokens(balance.div(buyBackDivNum));
            }
        }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _sellBuyBackFee == 0) return;
    ...
    function setBuybackDivNum(uint256 _buyBackDivNum) external onlyOwner() {
        buyBackDivNum = _buyBackDivNum;
    }
