...
contract KRAKENPAD is IERC20 {
    ...
    string constant private _name = "KRAKENPAD";
    string constant private _symbol = "KRP";
    ...
    address payable public marketingWallet = payable(0xb0d2E12fD7283b1b9da041939891aF4553e7d6aE);
