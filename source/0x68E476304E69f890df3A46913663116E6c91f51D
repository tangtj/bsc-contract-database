...
contract TrevorInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trevor Inu"; // 
    string private constant _symbol = "Trevor"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x728a0175776bC7178d1E5E51cb71A36101509011;
