...
contract ATH is Context, IERC20, Ownable {
    ...
    string private _name = "ATH AFTER ATH"; 
    string private _symbol = "$AAA"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF5d5Dff48e5fB5fCedf64c5eA24BAD93d7E77eC6); 
    address payable public teamWalletAddress = payable(0xca0bB4DC344cc6b91Bd823F7B42eaC51E6DA38B6); 
