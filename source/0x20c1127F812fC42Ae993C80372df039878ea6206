/**
TG: https://t.me/SDFSHIBOFFICIALBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80da2752607cdCb46C88b8663f7202d927AcC1d1; // owner address
...
contract ShibaDogeFlokiShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaDogeFlokiShib";
    string private _symbol = "$SHIB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x80da2752607cdCb46C88b8663f7202d927AcC1d1); // Marketing Address
    address payable private teamWalletAddress = payable(0x80da2752607cdCb46C88b8663f7202d927AcC1d1); // Team Address
