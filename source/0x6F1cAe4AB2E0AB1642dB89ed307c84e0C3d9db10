...
/**
   ...
   Welcome to CoffeeCream
   
   This is a community token. If you want to create a telegram I suggest to name it to @CoffeeCream
   ...
   I will renounce the ownership to burn addresses to transfer #CoffeeCream to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #CoffeeCream 10000X? 
...
contract CoffeeCream is Context, IERC20, Ownable {
    ...
    string private _name = "CoffeeCream";
    string private _symbol = "CC☕️";
