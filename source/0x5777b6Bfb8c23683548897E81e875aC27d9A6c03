...
// File contracts/interfaces/IBlockMonsters.sol
...
// File contracts/sales/ClaimContract.sol
...
contract ClaimContract is Ownable {
    ...
    function activateClaim() public onlyOwner {
        ...
        uint256 seventyPercent = 700 ether;
        uint256 tokensLiquidity = 92750000000000000000000000;
