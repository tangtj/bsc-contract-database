...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xB4521f568b2DecD9701484dC9C5F476C31666b0e; 
...
contract DogeOrigins is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Origins";
    string private _symbol = "DogeOrigins";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB4521f568b2DecD9701484dC9C5F476C31666b0e);
    address payable public teamWalletAddress = payable(0xB4521f568b2DecD9701484dC9C5F476C31666b0e); 
