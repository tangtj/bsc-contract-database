...
contract pepeai is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x81265104Ac20B960C55F7deaE593df41a4A0F7da);
    address payable public teamWalletAddress = payable(0x81265104Ac20B960C55F7deaE593df41a4A0F7da);
    address public immutable deadAddress = 0x81265104Ac20B960C55F7deaE593df41a4A0F7da;
