// TG: https://t.me/dolphybsc
// TWITTER: twitter.com/dolphhybsc
...
contract DolphyBsc is Context, IERC20, Ownable {
    ...
    string private _name = "DolphyBsc";
    string private _symbol = "DOLPHY";
    ...
    address payable public marketingWallet = payable(0xaAe6D6c8be0edE499B0a55f68D6184a832825c12);
