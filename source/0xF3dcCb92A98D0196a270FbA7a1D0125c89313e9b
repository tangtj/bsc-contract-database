...
contract Tourniverse is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x1aeb122935fAEFC224f9AA70553601D537753695;
    ...
    string private _name = "Tourniverse";
    string private _symbol = "TRNI";
