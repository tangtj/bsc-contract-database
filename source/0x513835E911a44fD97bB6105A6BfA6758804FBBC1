...
🥇 BEAR GUN’S  is the next big hype in the crypto space! 
...
LAUNCH: 15.00 UTC, TODAY🚀

💎TG: https://t.me/+71qzmtbTztxkNDJl
...
contract BEARGUNS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BEAR GUN'S";
    ...
    address payable public DevWallet = payable(0x648c8b0638DA3BD819ED540Ab921Ac6cF2A18BFd);
    address payable public MarketingWallet = payable(0x4e86B0d37ff19973bA8746CeAa14e20713a30b99);
    ...
    function getmxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function getmxWallet(uint256 newmaxWallet) external onlyAddress {
