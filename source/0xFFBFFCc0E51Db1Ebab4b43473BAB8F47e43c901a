/**
https://t.me/UrbaniumChain
https://twitter.com/urbaniumchain
https://urbanium.chain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8AFB320fdFd3A1E3C4dbcC20fe7BB2ed070D91Ea; 
...
contract UrbaniumChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "URBANIUM CHAIN";
    string private _symbol = "URBAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8AFB320fdFd3A1E3C4dbcC20fe7BB2ed070D91Ea); 
    address payable public teamWalletAddress = payable(0x8AFB320fdFd3A1E3C4dbcC20fe7BB2ed070D91Ea); 
