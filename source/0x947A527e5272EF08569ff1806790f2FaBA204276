...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC394C87d78c1E1a7bc2A219a4528851A76238eA5; // owner address
...
contract DORK20 is Context, IERC20, Ownable {
    ...
    string private _name = "DORK 2.0";
    string private _symbol = "D20";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC394C87d78c1E1a7bc2A219a4528851A76238eA5); // Marketing Address
    address payable private teamWalletAddress = payable(0xC394C87d78c1E1a7bc2A219a4528851A76238eA5); // Team Address
