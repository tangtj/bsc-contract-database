//=======================================================================
// 'JudCoin' token contract
//
// Deployed to : 0x16f2D249D394b5189AE58c200c0bE2427B608515
// Symbol      : JDC 
// Name        : JudCoin
...
//|__/                                      
//
//website: www.judcoin.com.br
//telegram: https://t.me/Jud_coin
//=======================================================================
...
contract JudCoin is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "JudCoin";
  string constant tokenSymbol = "JDC";
