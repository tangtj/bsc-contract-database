...
contract HOPEMONEYToken is IBEP20 {
...
contract HOPEMONEYBUSD {
    address payable admin;
    HOPEMONEYToken public tokenContract;
    ...
    constructor(HOPEMONEYToken _tokenContract, uint256 _tokensSold)  {
