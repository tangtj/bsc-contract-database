...
Upgrade Your Crypto Journey - It's 2.0 Time, Buckle Up!

⭐️FAIRLAUNCH 1PM(UTC)⭐️
...
contract The20Coin is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "2.0 COIN";
    string private constant _symbol = unicode"$2.0COIN";
    ...
    address payable public DevWallet = payable(0xbbd3962E9c0dDa76b413b412B23718Fe824622B1);
    address payable public MarketingWallet = payable(0x31d4BC1DEdF6Ed8070e936E205f042cD7E9687EE);
