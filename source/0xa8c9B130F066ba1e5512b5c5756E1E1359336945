// Telegram : https://t.me/nanodorkkiller
...
contract NANODORKKILLER is Context, IERC20, Ownable {
    ...
    string private constant _name = "NANODORKKILLER";
    string private constant _symbol = "$DORK";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xBA513e32BCE4dB531a71A676f3fB1f801fDC7b8A);
    address payable private _marketingAddress = payable(0xBA513e32BCE4dB531a71A676f3fB1f801fDC7b8A);
