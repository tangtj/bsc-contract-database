...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfe992312D9fB61006D019A7eA4D985f953aE2f79; // owner address
...
contract G25GLECoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "G25GLE";
    string private _symbol = "G25GLE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfe992312D9fB61006D019A7eA4D985f953aE2f79); // Marketing Address
    address payable private teamWalletAddress = payable(0xfe992312D9fB61006D019A7eA4D985f953aE2f79); // Team Address
