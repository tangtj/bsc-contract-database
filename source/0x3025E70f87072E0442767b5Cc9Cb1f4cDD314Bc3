...
// Begin sauce.
contract MHG is Context, IERC20, Ownable {
    ...
    string private  _name               = "Meta Hangry Games";
    string private  _symbol             = "MHG";


    // 0 to disable conversion
    // an integer to convert only fixed number of tokens
    uint256 public _fee_team_convert_limit = _supply_total * 5 / 10000;
    uint256 public _fee_marketing_convert_limit = _supply_total * 3 / 10000;
    ...
    //refection fee
    uint256 public _fee_reflection = 500;
    ...
    address public _wallet_burn = 0x000000000000000000000000000000000000dEaD;

    // for team
    uint256 public _fee_team = 700;
    ...
    constructor () {
        ...
        _wallet_marketing = payable(msg.sender);
        _wallet_team = payable(msg.sender);
