//
// https://t.me/Hydra_bsc
// https://twitter.com/hydra_bsc
// http://www.hydrabsc.online/
...
contract Hydra is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1170ed5D6b53fBD80bEA1E06D56506AA04AD4d25); // Marketing Address
    address payable public buybackWalletAddress = payable(0x1170ed5D6b53fBD80bEA1E06D56506AA04AD4d25); // Buyback Address
    ...
    uint256 private _totalSupply = 30 * 10**6 * 10**9; // 1 Billion
