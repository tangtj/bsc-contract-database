// t.me/NvidiaTokenizedStockDefichain 
// NvidiaTokenizedStockDefichain.com
...
contract NvidiaTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "NvidiaTokenizedStockDefichain";
