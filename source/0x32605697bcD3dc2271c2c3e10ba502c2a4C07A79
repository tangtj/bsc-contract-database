...
contract BULLRIUM is ERC20, Ownable {
    ...
    constructor() ERC20("BULLRIUM", "BRM") {
        ...
        maxTransactionAmount = 8 * 1e6 * 1e18;
        maxWallet = 8 * 1e6 * 1e18;
        ...
        devWallet = address(0x67E017e059B97c3718559a4554763F180C68a6e6);
