...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3F67E8fa6e300eaFA211373A268d25750B540C04; // owner address
...
contract PaypalBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Paypal Burn";
    string private _symbol = "PYUSDBurn";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3F67E8fa6e300eaFA211373A268d25750B540C04); // Marketing Address
    address payable private teamWalletAddress = payable(0x3F67E8fa6e300eaFA211373A268d25750B540C04); // Team Address
