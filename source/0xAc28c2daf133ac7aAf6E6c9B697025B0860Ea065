...
contract AkitaPluto is Context, IERC20, Ownable {
    ...
    string private _name = "AkitaPluto";
    string private _symbol = "AKTP";
    ...
    address payable public marketingAddress = 0x4AC38C4EB17fE123B92E95a3f8E495b0383Cf2c6; //Marketing address
