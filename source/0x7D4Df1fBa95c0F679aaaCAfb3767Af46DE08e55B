...
contract ChubbyInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "CHUBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C887dc8808645F8BDBA345262EFcB93471961b3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3481b111bc1a6ff93327078f91E26dDa2b6dc4C7); // BuyBack Address
