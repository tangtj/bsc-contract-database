...
contract KKC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1020000 * 10 ** 18;

    string private _name = "Khon Kaen,Thailand";
    ...
    constructor (address _route) public {
        _tOwned[address(0xE5C01A0D266144DF531F7da7faA9829B2a4a3f44)] = _tTotal;
        ...
        _isExcludedFromFees[address(0xE5C01A0D266144DF531F7da7faA9829B2a4a3f44)] = true;
        _isExcludedFromFees[address(this)] = true;

        emit Transfer(address(0), address(0xE5C01A0D266144DF531F7da7faA9829B2a4a3f44), _tTotal);
    }
    ...
    function _transfer(
        ...
        if( ammPairs[from] && !_isExcludedFromFees[to] && !isDelLiquidity){
            ...
            _tOwned[burnAddress] = _tOwned[burnAddress].add(fee);
            emit Transfer(from, burnAddress, fee);
