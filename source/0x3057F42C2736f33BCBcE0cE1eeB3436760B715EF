...
/**
Telegram: https://t.me/greenbot_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa217F4662d1A69ACb3ef3CB88823743a77E502C1; // owner address
...
contract GreenBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GREEN BOT";
    string private _symbol = "$GBOT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa217F4662d1A69ACb3ef3CB88823743a77E502C1); // Marketing Address
    address payable private teamWalletAddress = payable(0xa217F4662d1A69ACb3ef3CB88823743a77E502C1); // Team Address
