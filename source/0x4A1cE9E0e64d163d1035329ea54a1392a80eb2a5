// https://t.me/HulkDogeTokenBSC
// https://twitter.com/HulkDoge
// https://www.hulkdogetoken.com/
...
contract HulkDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HULKDOGE";
    string private constant _symbol = unicode"HULKDOGE";
