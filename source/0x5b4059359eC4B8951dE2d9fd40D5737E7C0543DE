...
contract WangpaiYushi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wangpai Yushi";
    string private constant _symbol = "WY";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xC2E9C21997Bb4Ba8DcB57Fe3D636d27Bd9104d95);
    ...
    function beginWAR() external onlyOwner {
        launch = 1;
