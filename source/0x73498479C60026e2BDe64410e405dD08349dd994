...
contract MoonCake is Context, IERC20, Ownable {
    ...
    string private _name = "Monn Cake";
    ...
    uint256 private _totalSupply = 11111111111 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 111111111 * 10 **_decimals; 
