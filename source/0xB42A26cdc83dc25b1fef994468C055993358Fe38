...
contract cycle is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x81E95D3B07CF4a0c44f841699405281cf392d765);
    address payable private DevelopmentWalletAddress = payable(0x81E95D3B07CF4a0c44f841699405281cf392d765);
