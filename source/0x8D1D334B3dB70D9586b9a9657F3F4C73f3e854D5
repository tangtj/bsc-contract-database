/**
Welcome to the RealSmurf Dog Token Community! BSC 

🐾 Are you ready to embark on an extraordinary journey with us? 🍄

Smurf Dog Token is not just a cryptocurrency; it's a fusion of creativity, fun, and innovation! Our mission is to create a thriving and engaging community where every member is a valued part of our Smurfy family.
...
🌐Tg :  https://t.me/RsDog
🌐 Website:https://smurfdog.com/
🟦 Get ready to ride those blue pumps!
*/
...
contract RealSmurfDog is Context, IERC20, OwnableIERC20 {
    using SafeMath for uint256;

    string private constant _name = "Real Smurf Dog";
    string private constant _symbol = "RSDog";
    ...
    uint256 private constant _tTotal = 42069 * 1e9 * 10**18;
    ...
    address payable private _marketingAddress = payable(0xF08C1E8e7fCA36F32aB4C3AdE6B48b59176A4101);
