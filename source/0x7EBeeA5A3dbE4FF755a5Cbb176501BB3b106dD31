...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6B0EfD8629E18A419c9E7534Cefa5ce22B8240Be; // owner address
...
contract ArchieEcosystem is Context, IERC20, Ownable {
    ...
    string private _symbol = "$ArcE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B0EfD8629E18A419c9E7534Cefa5ce22B8240Be); // Marketing Address
    address payable public teamWalletAddress = payable(0x6B0EfD8629E18A419c9E7534Cefa5ce22B8240Be); // Team Address
