            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0x8274D04ec4601b70aA79EfB0bd921068473CF410), destroyAmount);
                    }
                }
...
contract ET is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0x8274D04ec4601b70aA79EfB0bd921068473CF410),
        address(0x505A72901e88E44d18Cb6119D69aF23149ABc881),
        address(0x95dA4b5a824eBD8b7fFE0ec07dE88ABBB7a56B4F),
