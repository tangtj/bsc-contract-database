...
contract FreeDAO is IBEP20 , Auth { 
    ...
    function setEx(address[] calldata  users,uint8 fee,bool txLimit,bool positionLimit,bool dividend) external authorized {
    ...
    function init(uint256[4] memory f_,uint256[4] memory a_,address routerAddress_,address token_) external authorized{
