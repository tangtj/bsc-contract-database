...
Welcome to BakeUp Unique and flawless code that provides automatic rebasing as well as Automatic BAKE rewards distributed fairly and evenly among holders. 
First in BSC to provide a always green chart with plentiful BAKE rewards. 

Introducing BakeUp The first token on the BSC smartchain to combine the rebase rewards with rewards in $Bake. 
Hold $BakeUp and receive $Bake directly to your BEP-20 wallet as a reward for holding. 

TG: https://t.me/bakeupbsc
Website: Bakeup.finance
medium : https://medium.com/@bakeupbsc
github : https://github.com/bakeup
instagram : https://www.instagram.com/bakeupbsc/
...
contract BAKEUP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BAKEUP";
    string constant _symbol = "$BAKEUP";
    ...
    uint256 public swapThreshold = rSupply * 10 / 20000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3e5468e566089154f0F8C02eEb1cDbDd1a16e41e;
