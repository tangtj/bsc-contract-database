...
IronInu is ERC20Interface, SafeMath, AccessRestriction {
    
string
 
public
 name =  "Iron Inu" ;
    string public symbol =  "II";
    ...
    function _transfer(address from, address to, uint256 tokens) public returns (bool success) {
        uint256 tax = safdiv(tokens, 25); // 4% of the transaction shall be taxed
