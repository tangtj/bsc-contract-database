...
contract AntiRekt {
    address payable public feeRecipient = 0xC9AA66425127dA0fccF861FdCACB49d93240B69b;
    uint256 public feeAmount = 0.01 ether;  // 0.01 BNB fee to the ANTI REKT creator
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor() public {}

    function antiRekt(address _tokenA, uint256 _amountTokenA) external payable {
