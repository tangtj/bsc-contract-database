...
contract TVNFT is ERC721URIStorage,Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public holderNum;

    bool public canTransfer;

    constructor() ERC721("TVN Node NFT", "tvNft") {
