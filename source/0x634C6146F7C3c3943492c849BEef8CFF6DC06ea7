...
library Address{
 ...
 contract DogRapEliteClub is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xDbAe450732c53C23B59627169771FF1143E63758;
    address public donationWallet = 0xDbAe450732c53C23B59627169771FF1143E63758;

    string private constant _name = "DogRapEliteClub";
    string private constant _symbol = "DREC";
