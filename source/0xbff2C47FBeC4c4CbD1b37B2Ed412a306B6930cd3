...
contract XMN is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("XMN", "XMN") {
        ...
        lpAddress = payable(0xFE6A278655Cb7d81f6Cdb34aeD2f84883E60d2a9);
        marketAddress = payable(0x6c6855d1FEc2bF950Cf060e540C8ed9f7B2fc15F);
        teamAddress = payable(0xF40f5CD3284E7Db1F7252ee108CaC0C379A347fb);
        _mint(
