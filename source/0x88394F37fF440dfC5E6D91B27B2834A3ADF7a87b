...
contract SaleTOKEN {
    ...
    require(usdtContract.transferFrom(msg.sender, address(this), usdtAmount), "USDT transfer failed");

    // Calculate the amount of tokens to transfer
    uint256 tokensToTransfer = usdtAmount * 41666; // 41666 TOKEN per 1 USDT
    require(tokensToTransfer > 0, "Amount must be greater than 0");
    ...
    usdtContract.transfer(_Referral, usdtAmount * 10 / 100);
    }
