// https://t.me/WalkingDreadBSC
// https://x.com/TheWalkDread?t=FA7TcNTLX5GEEBxPup5rgQ&s=09
// https://test7ld3.wixsite.com/thewalkingdread
...
contract Walking is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Walking Dread";
    string private constant _symbol = unicode"WLKNGDRD";
