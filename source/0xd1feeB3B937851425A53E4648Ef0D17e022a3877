...
/**
telegram: : https://t.me/MegaBigHugeSuperX
*/
...
contract MegaBigHugeSuperX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MegaBigHugeSuperX";
    string private _symbol = "MegaBigHugeSuperX";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0x8bF1be803ee3aEAC453C63b71A03112A0baD9EAC); 
    ...
    uint256 public _maxTransactionAmount =   500000000; 
    uint256 public minimumTokensBeforeSwap = 100000; 
    uint256 public _walletMax = 500000000;
    ...
    constructor () {
        ...
        antiBot[owner()] = true;
        antiBot[marketingWalletAddress] = true;
    ...
    function TurnOnMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   500000000;
    }
