...
contract IBOX is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0xCF7Bc6c59DD4C36803B61662A53B833d8B168C02;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 2000 * 10**_decimals;
        marketingWalletAddress = payable(0x7797b8964fd9171E8B88543B5dd5a0BEF55a522e);
        teamWalletAddress = payable(0x50792c5A1e72DD05ed2c27684C550C1bf059F9C1);
