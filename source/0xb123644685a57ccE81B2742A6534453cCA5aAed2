...
contract SHIBAOFWALLSTREET is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBA OF WALL STREET";
    string private constant _symbol = "$SOW";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x44339BdEEe79A759c7a5417d226bD978BAEEF395);
