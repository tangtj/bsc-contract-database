/**
https://t.me/Stellar_0x
Website: https://stellar0x.space
*/
...
contract Stellar0x is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xF9dBE719e0747cCc7d187d3DFA4Bc72B1e36e0ed); // Marketing Address
        
    address payable public teamAddress =
        payable(0xBc1CA5B8238d88DEFe23F4C5193bd1cfcD65Ddde); // Team Address
        
    address payable public liquidityAddress =
        payable(0xF9dBE719e0747cCc7d187d3DFA4Bc72B1e36e0ed); // Liquidity Address
    ...
    string private constant _name = "STELLAR 0x";
