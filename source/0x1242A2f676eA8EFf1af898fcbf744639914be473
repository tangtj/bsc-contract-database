...
ETH VERSION FLYING +40M

WEB: https://monkeys-bsc.com
TG: https://t.me/monkeystokenbep20
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8a618A62795D96b61D1157FD06Da9Ebea84ed6C1; // owner address
...
contract MonkeysToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monkeys Token";
    string private _symbol = "$MONKEYS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8a618A62795D96b61D1157FD06Da9Ebea84ed6C1); // Marketing Address
    address payable private teamWalletAddress = payable(0x8a618A62795D96b61D1157FD06Da9Ebea84ed6C1); // Team Address
