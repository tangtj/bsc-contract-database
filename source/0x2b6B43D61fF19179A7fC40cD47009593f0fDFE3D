/**
https://t.me/SpurdoTwoPointZeroBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18f090f4FA481db9218C1DE85965bB1c533A32Cd; // owner address
...
contract SpurdoTwoPointZeroBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPURDO";
    string private _symbol = "$SPURDO2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x793880AF05cdCAAE5119a9d4A48D7CFC286F56B5); // Marketing Address
    address payable private teamWalletAddress = payable(0x18f090f4FA481db9218C1DE85965bB1c533A32Cd); // Team Address
