...
contract DarkPhoenix is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"DARK PHOENIX";
    string private _symbol = unicode"$DARK";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x26e38051Bb1f7dE9Ac990f6a5890d8Ff2f0F8B28);
    address payable private taxWallet2 = payable(0x26e38051Bb1f7dE9Ac990f6a5890d8Ff2f0F8B28);
