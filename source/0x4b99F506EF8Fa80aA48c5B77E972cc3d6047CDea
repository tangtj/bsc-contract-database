...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public DogeCoin = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract DogeSamurai is IBEP20, Auth {
    ...
    string constant _name = "Doge Samurai";
    string constant _symbol = "DogeSamurai";
    ...
    address public pair;
    address recSup = 0xEf1b418E8188dC5D9FBAD23441701DDb440bBD6c;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0xEf1b418E8188dC5D9FBAD23441701DDb440bBD6c;
        ...
        _balances[recSup] = ((_totalSupply * 100) / 100);
        emit Transfer(address(0), recSup, ((_totalSupply * 100) / 100));
    }
