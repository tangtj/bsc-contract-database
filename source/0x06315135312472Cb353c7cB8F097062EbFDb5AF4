// telegram     : https://t.me/xinu_announcement
// Website      : https://x-inu.live
...
contract XInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x55C3bF629d93f54ebc3c4A2015eC264A3deca96b); // Marketing Address
    address payable public teamWalletAddress = payable(0x55C3bF629d93f54ebc3c4A2015eC264A3deca96b); // Team Address
