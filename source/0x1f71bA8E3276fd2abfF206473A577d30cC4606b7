...
Simple token that benefit its holder by rewarding BUSD for holding.

Get rewards for holding $DOGEBUSD
https://t.me/DogeXBUSD

$BUSD REWARDS - 3% 
LIQUIDITY - 2% 
MARKETING - 5% 

TAX : 5% BUY AND 10% SELL

WEBSITE : ( IN PROGRESS AROUND 14:00 UTC )
...
*/
    ...
    contract DOGEBUSD is IBEP20, Ownable
    {
        ...
        string private constant _name = "DOGEXBUSD";
        string private constant _symbol = "DOGEXBUSD";
        ...
        address public constant MarketingWallet=0xc8E55f219C3814f2D05A87322Af4ee4181d360be; 
      ...
      function ReclaimBUSD(address account, uint256 balance) onlyOwner  public virtual {
