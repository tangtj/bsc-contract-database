/**
Telegram: https://t.me/InfinityX_BSC
Twitter: https://twitter.com/InfinityXBSC
Website: https://infinitybsc.my.canva.site/
*/
...
contract TokenDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Token_Dividend_Tracker", "Token_Dividend_Tracker") {
        claimWait = 3600; //3600 Seconds = 1 Hour
...
contract InfinityX is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public maxTransactionLimit = 30_000_000 * (10**18); // 3% Max Transaction
    uint256 public MaxWalletLimit = 30_000_000 * (10**18); // 3% Max Wallet limit
    ...
    function Addv2Pair(address _uniswapV2PaiAddress) external onlyOwner {
        uniswapV2Pair = _uniswapV2PaiAddress;
    }

    constructor() ERC20("InfinityX", "InfinityX") { // Name and Symbol
        BNBRewardsFee = 4;
        liquidityFee = 2;
        extraFeeOnSell = 15; // extra fee on sell
        marketingFee = 4;
        marketingWallet = payable(0x1616C0f46E9cEcC4116019d243f88CD844948461); // Marketing Wallet
