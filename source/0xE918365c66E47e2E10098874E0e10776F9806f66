// https://t.me/OceanPirates
// https://twitter.com/oceanpiratesbsc
// https://oceanpirates.xyz/
...
contract OceanPirates is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ocean Pirates";
