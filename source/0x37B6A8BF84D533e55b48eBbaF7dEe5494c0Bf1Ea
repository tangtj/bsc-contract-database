...
contract OggyKiller is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0xbaECb6e469C3CC3b9A76e8e35BA1b4ab15266c5D); 
    address payable private teamWalletAddress = payable(0xbaECb6e469C3CC3b9A76e8e35BA1b4ab15266c5D); 
