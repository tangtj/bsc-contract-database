/**
   ...
   No telegram group if u want to create telegram group i suggest to name it to @hypercoinss
   ...
   I will renounce the ownership to burn addresses to transfer #HyperCoin to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #HyperCoin 10000X? 
...
contract HyperCoin is Context, IERC20, Ownable {
