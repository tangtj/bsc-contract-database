/**
*/
//   ✅Telegram:https://t.me/babyfififi
//   ✅WebSite:https://babyfificoin.com
//   ✅launch 07/06 21:30 UTC
...
contract babyfifi is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 170000000 * _decimalFactor; // Supply Token
    ...
    uint256 public maxWalletBalance = 5100000 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 3400000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 1700000 * _decimalFactor; // 0.5% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 1700000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Baby fifi";
