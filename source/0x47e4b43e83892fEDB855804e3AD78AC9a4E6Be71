...
contract BlackGoku is Context, IERC20, Ownable {
    ...
    string private _name = "Black Goku Coin";
    string private _symbol = "Black Goku";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x5eeD719ea98BebFe0e3d3E4f34a1354cC1a32F02); 
    address payable private teamWalletAddress = payable(0x5eeD719ea98BebFe0e3d3E4f34a1354cC1a32F02); 
