/**
   ...
   Welcome Warcraft Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @WarcraftDogeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #WarcraftDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #WarcraftDoge 10000X? 
...
contract WarcraftDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Warcraft Doge";
    string private _symbol = "WARCRAFTDOGE";
