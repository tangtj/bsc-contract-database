...
contract CatX is Context, IERC20, Ownable {
    ...
    string private constant _name = "CAT X";
    string private constant _symbol = "CatX";
    ...
    address payable private _twddev = payable(0x0Abcef25b47A474c31953F053101543AB0080fbb);
    address payable private _twdmkt = payable(0x0Abcef25b47A474c31953F053101543AB0080fbb);
