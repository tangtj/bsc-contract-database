...
//Telegram: https://t.me/TestMetaBSC 
...
contract TesTMetaBSC is ERC20, Ownable {
    ...
    constructor() ERC20("TesTMetaBSC","TesT Meta BSC") {
        ...
        devWallet = address(0x29E8D72d7D6BB2aA9d2738d61be83327C5644CE5); 
