/**
Grumpy Cat
😾 Hey grumpy face! Grumpy Cat is here again! 😾 
($GRUM) Fed up with current currency market? 
Break the market down and turn those grumpy emotions together! 
😺 KYC - AUDIT - SAFU - DOXXED 
😺 Big Experienced Team 
😺 Professional Marketer 
😺 Giant Postlaunch Marketing 
😺 NO TEAM TOKENS 
😺 NO PRIVATE SELL 
😺 LOW TAX 
😺 BSC CHAIN 😺 
Dexview - Dextools - AVE - BSC TRENDING after launch 
😺 Transparent tokenomics 😺
https://twitter.com/RealGrumpy
...
contract GrumpyCat is Ma, Ru, io {
   ...
   string websites;
   string public GrumpyCatwebsite = "https://twitter.com/RealGrumpy";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "GrumpyCatToken"; 
        _name = "Grumpy Cat";
        _symbol = "GRUM";
        _decimals = 9;
