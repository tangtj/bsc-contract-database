// telegram     : https://t.me/Orbitrumprotocol
// Website      : https://orbitrumprotocol.org/
// Twitter      : https://twitter.com/Orbitrum_

// Orbitrum Protocol: The Layer 3 Solution for Ultimate Scalability and Interoperability
...
contract OrbitrumProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orbitrum Protocol";
    string private _symbol = "ORB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3Ff5aB716ff177e35bf8c43AA92B60C08aaB629b); // Marketing Address
    address payable public teamWalletAddress = payable(0x3C5523e9Ef625dD7A23f895250081f510530471E); // Team Address
