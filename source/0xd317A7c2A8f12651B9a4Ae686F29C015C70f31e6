...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5e059356a7b8C66FBf665C502023B1A1D406b807; // owner address
...
contract XBIRD is Context, IERC20, Ownable {
    ...
    string private _name = "X BIRD";
    string private _symbol = "X BIRD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5e059356a7b8C66FBf665C502023B1A1D406b807); 
    address payable public teamWalletAddress = payable(0x5e059356a7b8C66FBf665C502023B1A1D406b807);
