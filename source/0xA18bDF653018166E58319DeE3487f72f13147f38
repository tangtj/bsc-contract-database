...
contract MetaClass is ERC20Detailed, Ownable {
    ...
    uint256 public mclsInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(mclsInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public mclsInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("MCLS", "MCLS", uint8(DECIMALS)) Ownable() {
        ...
        mclsInsuranceFundReceiver = 0x499C8BfCC2216FCe8B5C13d1FD0ac8020eabD382;
    ...
    function takeFee(
        ...
        uint256 _mclsInsuranceFundFee = mclsInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _mclsInsuranceFundFee = mclsInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(mclsInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(mclsInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(mclsInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(mclsInsuranceFundFee).div(
                treasuryFee.add(mclsInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function setFeeReceivers(
        ...
        address _mclsInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        mclsInsuranceFundReceiver = _mclsInsuranceFundReceiver;
        firePit = _firePit;
    }
