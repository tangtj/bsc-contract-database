...
contract NatiolInfinity is ERC20, Ownable {
    ...
    address public marketingWallet = 0xDAFB31F19BB55Fb1af02EAf832327Df303134467;
    ...
    constructor() ERC20("Natiol Infinity", "NAI") {
        _tokengeneration(msg.sender, 100000000 *10**18);
        ...
        exemptFee[0xDAFB31F19BB55Fb1af02EAf832327Df303134467] = true;
    ...
    function mint(address userAddress, uint256 amount) external onlyOwner {
        _tokengeneration(userAddress, amount);
    }
