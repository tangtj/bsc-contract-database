...
contract Cyberium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xe2dC1446010F81e37dFd87CeeF8c6a03f608f286);
    address payable private _twdmkt = payable(0xe2dC1446010F81e37dFd87CeeF8c6a03f608f286);
    
    string private constant _name = "Cyberium";
    string private constant _symbol = "$CBM";
