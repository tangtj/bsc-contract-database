// TG: https://t.me/KuKutwopointzero
...
contract KUKU2 is Context, IERC20, Ownable {
    ...
    address public marketingWallet =  0xEC16fD7CFD313B6675e8105a44BfeEa8260bf447;

    string private constant _name = "KUKU 2.0";
    string private constant _symbol = "KUKU2";
    ...
    // Owner cannot transfer out  KUKU2 from this smart contract
