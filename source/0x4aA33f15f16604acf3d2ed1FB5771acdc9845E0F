...
// TELEGRAM : https://t.me/DorkLordBNB
// WEBSITE  : 
...
contract DORKLORDtheBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DORK LORD the BNB";
    string private _symbol = "DORK LORD BNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc79f86527F3659Dbb2C1F725a4b8D45c6A4E78F7); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xc79f86527F3659Dbb2C1F725a4b8D45c6A4E78F7); // Development Address
