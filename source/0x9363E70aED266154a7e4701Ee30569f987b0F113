...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36ee837aa054754919c09e5Ff37BB051ADC7944C; // owner address
...
contract SpurdoGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spurdo Grow";
    string private _symbol = "$SG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0B3b6A81375C4FeB3ad2778C7A7E14fa22541f0d); // Marketing Address
    address payable private teamWalletAddress = payable(0x36ee837aa054754919c09e5Ff37BB051ADC7944C); // Team Address
