...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x90eF6a690Aba432DD405c2Cff588E913773327a8;
    ...
    {
        require(tax <=13,"Cannot set the fee more than 13%");
        marketingTax = tax;
    }
...
contract $BTC is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("$1 Bitcoin", "$BTC", 9) {
    _owner = msg.sender;
