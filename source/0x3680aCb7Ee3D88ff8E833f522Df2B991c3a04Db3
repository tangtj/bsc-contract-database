/*
QixBit is a fully open source  With an easy to use user interface and quick and speedy transactions, this wallet is ideal for anyone no matter how much they know about the cryptocurrency space. The app is actively maintained to provide new user friendly features
...
contract QIXBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = "QIXBIT";
    string private constant _symbol = "Qixbit";
