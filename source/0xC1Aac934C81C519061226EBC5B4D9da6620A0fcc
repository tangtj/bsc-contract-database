...
contract SAMOcoin is Context, IERC20, Ownable {
    ...
    address payable public _taxWallet = payable(0x6bAc4fB64544a5C7a185F135CE17cB19149818CA);
    ...
    string private constant _name = unicode"SAMO coin";
    ...
    function updateTaxes(uint256 buyFee, uint256 sellFee, uint256 transferFee) public onlyOwner {
        require(buyFee <= 19, "Tax too high");
        require(sellFee <= 19, "Tax too high");
        require(transferFee <= 19, "Tax too high");
        _buyTax = buyFee;
        _sellTax = sellFee;
        _transferTax = transferFee;
    }
