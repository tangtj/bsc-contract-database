...
// Telegram https://t.me/pepedrugsbsc 
...
contract PEPESHROOM is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x74fBF5aE3C30DDBACed649793a7C351D2560952D);
    address payable private _twdmkt = payable(0x74fBF5aE3C30DDBACed649793a7C351D2560952D);
    
    string private constant _name = "PEPE EAT MUSHROOM";
    string private constant _symbol = "$SHROOM";
