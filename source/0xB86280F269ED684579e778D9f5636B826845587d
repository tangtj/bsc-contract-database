...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x3BBF3054Ac05B8678fF571438FD50c0B9395e16e; // owner address
...
contract ChimpX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChimpX";
    string private _symbol = "Chix";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4028Bca287848b61B0931b53286b2f3F9cc8fb8E); 
    address payable public teamWalletAddress = payable(0x4028Bca287848b61B0931b53286b2f3F9cc8fb8E);
