...
contract XXHXX2 is Context, IERC20, Ownable {
    ...
    uint256 public _maxInAmount = 500_000;    
    uint256 public _maxOutAmount = 500_000;   
    ...
    // function setBuyBackFee(uint8 _buybackfee ) public onlyOwnerOrAdmin {
    ...
    require(amount > 0, "ERC20: transfer amount must be greater than zero");
		...
		if(_EnableContract)
        {
		    ...
		    if (contractBalance.marketing_balance>= numTokensToSwapMarketing && !inSwapAndLiquify && from != uniSwapV2Pair && swapAndLiquifyEnabled) {
                ...
                //     contractBalance.buyback_balance += valuebb;
