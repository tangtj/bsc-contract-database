...
contract CLOVER is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x0622462C14F1DDb27CAd77Da2DEaC4bbA16B9a89);
    address payable public MarketingWallet = payable(0x834a0Ef8a14e333c8743f5370B4aE11Cf287D7C5);
