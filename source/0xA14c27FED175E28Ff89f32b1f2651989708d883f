...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc4E6649f04F369199Af566591862A5D440e14854;
...
contract CyberX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8b5443c3f9966FC213Ced2f40B55cc9e596Af2e3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CYBER X";
    string private _symbol = "CYBER X";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 280;
