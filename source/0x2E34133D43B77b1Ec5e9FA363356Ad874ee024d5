...
contract FireFloki is Context, IERC20 {
    ...
    string constant private _name = "FireFloki";
    string constant private _symbol = "FFLOKI";
    ...
    address payable private _marketingWallet = payable(0x6Edb434f9301f4B92BFBA4691746EcE9588e0518);
    address payable private _developmentWallet = payable(0x82ce84c64AFd3A1475C09548839E4150bE8F5358);
    address payable private _buybackWallet = payable(0x3EB3fa69B4ED46be930fb4E309E10D59D6cE7B22);
