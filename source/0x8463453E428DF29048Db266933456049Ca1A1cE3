...
contract PinkCatToken is Context, IBEP20, Ownable {
    ...
    address public _marketingWallet = 0xbB05e2788ce696c399e627F1a953C80D119196C5;

    string private constant _name     = "PinkCat Token";
