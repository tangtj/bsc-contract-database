...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "BinanceAngel";
    string private _symbol = "BinanceAngel";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x12DD40c2792A25faB963678cec742482F7B082d5);
    address payable public teamWalletAddress = payable(0xC801A0D87692e83e5d5A8CB564224cfF770a221B);
