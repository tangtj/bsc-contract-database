...
contract BD is Context, IERC20, Ownable {
    ...
    string private _name = "CYTZ";
    string private _symbol = "CYTZ";
    ...
    uint256 public _burnFee = 0; // 2% burn fee
    ...
    uint256 public _maxTxAmount = 1888 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 0.1888 * 10**18;
    uint256 public _maxWalletToken = 1888 * 10**18;
