...
//TG https://t.me/+QqcS1T6CiLQwNTk9
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8098F636FfF84524229099Dda869F3A77B0Fe2ac; 
...
contract TAX0 is Context, IERC20, Ownable {
    ...
    string private _name = "TAX0";
    string private _symbol = "$TAX0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8098F636FfF84524229099Dda869F3A77B0Fe2ac);
    address payable public teamWalletAddress = payable(0x8098F636FfF84524229099Dda869F3A77B0Fe2ac); 
    ...
    uint256 private _totalSupply = 4500000000* 10**_decimals;
    uint256 public _maxTxAmount = 4500000000* 10**_decimals; 
    uint256 public _walletMax = 4500000000* 10**_decimals;
