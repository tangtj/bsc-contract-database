...
contract AstatineNetwork is Context, IERC20, Ownable {
    ...
    string private _name     = "Astatine Network";
    string private _symbol   = "ASTATINE";
    ...
    {        
        ...
        marketingWallet = 0xF2215a9ea54faf6F200966324781E1d680298594;
