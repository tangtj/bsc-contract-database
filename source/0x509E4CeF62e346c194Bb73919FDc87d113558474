...
contract ReverseShib is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x4Ee88fB379db7cf119bD5cA39A479470F9995586); // Marketing Address
        
    address payable public teamAddress =
        payable(0xBCE5715897B7DCBF24a4390c8FE5A1B8210806a3); // Team Address
        
    address payable public liquidityAddress =
        payable(0xBCE5715897B7DCBF24a4390c8FE5A1B8210806a3); // Liquidity Address
    ...
    string private constant _name = unicode"nuI ɐqᴉɥS";
