...
contract ABC is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "ABC";       //Full name
    string public symbol_ = "ABC";      //abbreviation
    ...
    address public marketingWalletAddress = 0x918CbFF3e7D7fC907793a221c32268358349832c;  //Marketing address
