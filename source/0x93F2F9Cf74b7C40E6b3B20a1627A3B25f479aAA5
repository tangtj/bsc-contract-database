...
contract WWW is IBEP20 {
    ...
    string public override name = "WIN WIN WIN";
    string public override symbol = "WWW";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 33 / 100;
        balances[foundersPot] = totalSupply * 33 / 100;
        
        balances[owner] = totalSupply * 34 / 100;
    }
