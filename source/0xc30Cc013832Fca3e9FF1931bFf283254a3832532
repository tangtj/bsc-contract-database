...
contract BGD is Ownable,ERC20Burnable {
    using SafeMath for uint256;

    address public  uniswapV2Pair;
    
    address public recipient = 0xA4A407048559bC115Aefd9410F7fF26E8fb0B65c;
    address public liquidity = 0xA4A407048559bC115Aefd9410F7fF26E8fb0B65c;
    address public USDT = 0x55d398326f99059fF775485246999027B3197955;
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    constructor() ERC20("belgrade beogradcoin", "BGD") {
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), USDT);

        _mint(recipient, 2300000000 * (10**18));
    }
