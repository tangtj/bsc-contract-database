...
-- LINK --
Telegram: https://t.me/zerogravitybsc
Website: https://zerogravitybsc.xyz/
-- LINK --
...
contract ZEROGRAVITY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ZEROGRAVITY";
