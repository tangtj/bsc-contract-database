...
contract DSWAPTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public ehhcnf17;
    ...
    string private _tokenname = "DogeriumSwap";
    string private _tokensymbol = "DSWAP";
