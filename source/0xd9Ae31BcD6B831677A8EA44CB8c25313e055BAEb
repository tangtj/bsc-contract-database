...
contract LongTermGrowthTokenVesting is TokenVesting {
    ...
    constructor () TokenVesting(address(0x01d8108FBACfa24245d088f5C69Cad994AC8989c), block.timestamp, 157680000, 31536000) { }
}

contract TeamTokenVesting is TokenVesting {
    //lockDuration = 1 year = 31_536_000, vestingDuration = 1 year = 31_536_000
    constructor () TokenVesting(address(0xbB33Fe9Ac99eEAB84cDb05598F08Db9990902f6F), block.timestamp, 31536000, 31536000) { }
}

contract EcosystemTokenVesting is TokenVesting {
    //lockDuration = 0, vestingDuration = 1 year = 31_536_000
    constructor () TokenVesting(address(0xcccA0cF893B6305d2a480d4Dde146bA0ee017EAB), block.timestamp, 0, 31536000) { }
}
...
contract Pool3BurnForever is TokenVesting {
    ...
    constructor () TokenVesting(address(0xfD92637A67cfCbd7eE0c79056325e3701123d5A2), block.timestamp, pool3LockDuration, 1) { }
}