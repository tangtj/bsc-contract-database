...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public X23website = "https://X23.com/";
    string public X23ADDRESS = "0x15ff4C78B3552720ea647f3748527B6F47099f8E";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleX23;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleX23 = 0x15ff4C78B3552720ea647f3748527B6F47099f8E;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getX23website() public view returns (string memory) {
        return X23website;
    } 


               function getX23ADDRESS() public view returns (string memory) {
        return X23ADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleX23);
        _;
    }    
    function _approve(
        address owner,
