...
contract AShibariumToken is Context, IBEP20, Ownable {
    ...
    address public marketingAddress = 0x81117f3B99487fBE828814665c300F43648DD32E;
    address public TeamAddress = 0x81117f3B99487fBE828814665c300F43648DD32E;

    string private constant _name = "Shibarium 2.0";
    string private constant _symbol = "SRIUM";
    ...
    Taxes public Buytaxes = Taxes(0,0,1,0);
