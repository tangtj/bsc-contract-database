/**
Telegram: https://t.me/ProtoriumGlobal
Website: https://protorium.online/
Twitter: https://twitter.com/ProtoriumBsc
...
contract Protorium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Protorium";
    string private _symbol = "PRO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2E39C88dDC68a46a6d8B3ed9D0F73B542EeAf27f); // Marketing Address
    address payable public teamWalletAddress = payable(0x2E39C88dDC68a46a6d8B3ed9D0F73B542EeAf27f); // Team Address
