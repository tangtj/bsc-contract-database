...
Time to put your meme tokens into work. 
...
We all know how stressful it is when you are holding a meme token that you love 
to hold for the long term and you are all in. But as the number of projects that 
are launching every minute, hour , making you miss a 10x or 100X opportunity.

💬: https://t.me/poGGersbsc
**/
...
contract poGGers is Context, IERC20 { 
    ...
    string private constant _name = "pooGGers";
    ...
    address payable public DevWallet = payable(0x36054Aca701D9c67078984e9155F82EcE66D2aB2);
    address payable public MarketingWallet = payable(0xbAC005529Ce255741DA711cA92890d1cE938edaf);
