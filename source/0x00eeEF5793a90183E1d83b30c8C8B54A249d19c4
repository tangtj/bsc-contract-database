...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xE11E28e102B26E2d9473B26d7e8d91ec0c12b02f; // owner address
...
contract SALAMANDERSALLY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SALAMANDER";
    string private _symbol = "SALLY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE11E28e102B26E2d9473B26d7e8d91ec0c12b02f); 
    address payable public teamWalletAddress = payable(0xE11E28e102B26E2d9473B26d7e8d91ec0c12b02f);
    ...
    uint256 private _totalSupply = 42000000000000000 * 10**_decimals;
