// t.me/CoinbaseTokenizedStockDefichain 
// CoinbaseTokenizedStockDefichain.com
...
contract CoinbaseTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "CoinbaseTokenizedStockDefichain";
