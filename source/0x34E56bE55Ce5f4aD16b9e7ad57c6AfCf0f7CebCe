...
contract MICROTIGER  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9b92BD65B0054bFDE2efD829cA8678e9bAAFEa6e); 
    address payable public Wallet_Dev = payable( 0x9b92BD65B0054bFDE2efD829cA8678e9bAAFEa6e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 420060* 10**8* 10**8 * 10**_decimals;
    string private constant _name = "Micro Tiger"; 
    string private constant _symbol = unicode"$mTIGER"; 
    ...
    constructor () {
        _owner = 0x9b92BD65B0054bFDE2efD829cA8678e9bAAFEa6e ;
