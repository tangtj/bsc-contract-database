/**
   ...
   3% fee auto contribute to charity wallet.
...
contract SAPT is Context, IERC20, Ownable {
    ...
    string private _name = "SAPT";
    string private _symbol = "SAPT";
    ...
    address public _charityWalletAddress = 0x5C9E5571B17D91e6ACcD4F0c29bBe199Af1f7B09;
    ...
    uint256 public _maxTxAmount = 500 * 10**7 * 10**9;
    ...
    function _sendToCharity(uint256 tCharity, address sender) private {
        uint256 currentRate = _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        address currentCharity = _charityWalletAddress;
