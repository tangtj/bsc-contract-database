...
/// @custom:security-contact security@leepay.com
contract LiteEcosystemElectronicPay is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor()
        ERC20("Lite Ecosystem Electronic Pay", "LEEP")
        ERC20Permit("Lite Ecosystem Electronic Pay")
    {
