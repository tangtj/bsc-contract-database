...
contract SonikCoin is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("Sonik Coin", "SONIK") {
        _mint(msg.sender, 299792458000000000000000000000);
    }
