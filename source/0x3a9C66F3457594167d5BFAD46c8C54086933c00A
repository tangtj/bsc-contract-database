...
contract MetaFox is Context, IBEP20, Ownable {
    ...
    address public TeamAddress = 0xbaA073dBADe235Ab3C474309638D7b075ab74fa2;

    string private constant _name = "MetaFox";
    ...
    Taxes public Buytaxes = Taxes(1,1,2,2);
    Taxes public sellTaxes = Taxes(2,2,5,3);
