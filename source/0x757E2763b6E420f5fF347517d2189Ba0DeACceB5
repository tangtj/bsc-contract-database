...
contract Coinflip is Ownable {
    ...
    uint devFee = 1000;
    uint houseFee = 2000;
    address house = 0x8A28e566FC13e736A360A4B538894b8166B55C0A;
    address dev = 0x3a9f7bb857cAbE18a8278dAb463ECD5366aD1Cc7;
    ...
    function flip(uint oneZero) public payable {
        ...
        require(msg.value > 5*(10**16), "minimum amount should be greater than 0.05 BNB");
    ...
    function withdrawUserWinnings() public {
        ...
        uint totalFeePercent = SafeMath.add(devFee, houseFee);
        uint totalFee = SafeMath.div(SafeMath.mul(balance, totalFeePercent), 10000);
        uint toTransfer = SafeMath.sub(balance, totalFee);
        playerWinnings[msg.sender] = 0;
        playerWinnings[dev] = SafeMath.add(playerWinnings[dev], SafeMath.div(SafeMath.mul(balance, devFee), 10000));
        playerWinnings[house] = SafeMath.add(playerWinnings[house], SafeMath.div(SafeMath.mul(balance, houseFee), 10000));
