...
contract Fukushu is Context, IERC20, Ownable {
    ...
    string private _name = "Fukushu";
    string private _symbol = "FUKU";
    ...
    address payable public marketingWallet = payable(0x1fb2F3aFA02D8b94c389761FBD4b63b2cf90c608);
    ...
    uint256 public _maxWalletLimit = 1000 * 10 ** 18;
