...
contract rr is ERC20, Ownable {
    ...
    constructor() ERC20("REALPEPE", "RP") {
    	...
    	operationsWallet = address(0xD0d226D024C0Fe92aAAf910d81fd6e6126675942); // set as operations wallet
        developmentWallet = address(0xD0d226D024C0Fe92aAAf910d81fd6e6126675942);
        buybackburnWallet = address(0xD0d226D024C0Fe92aAAf910d81fd6e6126675942);
        projectWallet = address(0xD0d226D024C0Fe92aAAf910d81fd6e6126675942);
        reserveWallet = address(0xD0d226D024C0Fe92aAAf910d81fd6e6126675942);
