...
Telegram: https://t.me/ButcherToken
...
/* Token contract */
contract Butcher is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xA23244AfAb3E14b7C533aA0d93a1Dd8274ed95E5;
    ...
    // Name and symbol
    string constant _name = "Butcher";
    string constant _symbol = "BUTCH";
