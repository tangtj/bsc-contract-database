/**
TG: https://t.me/memekingX
TWITTER: https://twitter.com/memekingX
*/
...
contract memekingx is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    memekingxDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Meme King X", "MKX") {
        marketingWallet = payable(0x5604b83b776D184eA8Fc72Ddf6Cbe0F949B85CAD);
        devWallet = payable(0xcB3dA7E0F1616eCBf94d2e26c40600B6C7cc0cb9);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 99;
        sellMarketingFees = 99;
        buyLiquidityFee = 0;
        sellLiquidityFee = 0;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new memekingxDividendTracker(
            payable(this),
            router,
...
contract memekingxDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    memekingx public memekingxContract;
    ...
    constructor(
        ...
        defaultToken = token;
        memekingxContract = memekingx(mainContract);
    ...
    function _transfer(
        ...
        require(false, "memekingx_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "memekingx_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main memekingx contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(memekingxContract);

            uint256 prevBalance = memekingxContract.balanceOf(address(this));
            ...
            {
                uint256 received = memekingxContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    memekingxContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
