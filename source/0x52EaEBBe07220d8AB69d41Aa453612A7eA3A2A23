...
contract Claster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    // Claster
    string private constant _name = "Claster";
    string private constant _symbol = "Claster";
    ...
    address payable private _ClasterFourSAddress =
        payable(0x32BD3F80c75b00E6Bc93132Cf4479d22e4a8a996); //Rewards Wallet
    ...
    uint256 public _maxTA = 25000000000 * 10 ** 9;
    // swpTA
