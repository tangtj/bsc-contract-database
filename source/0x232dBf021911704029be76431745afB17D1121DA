/**
   ...
   Telegram : https://t.me/RandyCunningHam
 ____   __   __ _  ____  _  _           
(  _ \ / _\ (  ( \(    \( \/ )          
 )   //    \/    / ) D ( )  /           
(__\_)\_/\_/\_)__)(____/(__/            
  ___  _  _  __ _  __ _  __  __ _   ___ 
 / __)/ )( \(  ( \(  ( \(  )(  ( \ / __)
( (__ ) \/ (/    //    / )( /    /( (_ \
 \___)\____/\_)__)\_)__)(__)\_)__) \___/
 _  _   __   __ _                       
( \/ ) / _\ (  ( \                      
/ \/ \/    \/    /                      
\_)(_/\_/\_/\_)__)         
 
Randy Cunningham is a ninth-grader who is an unlikely hero with a superhuman ninja suit, 

the NinjaNomicon. $RCH uses the suit and help from his best friend, Howard, 
to battle evil while trying to survive high school and guard his secret identity -
all while trying to protect his school and the world from certain destruction.
 */
...
contract RCH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Randy Cunning man";
    string private _symbol = "RCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12e3Cb7635D1634c20913cc24BCD9AFAF2048562); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCCf24BBc77243200427c755AB762064ed91f69a7); // 2nd marketing Address
