...
contract zsbToken is ERC20("Stabilize Strategy USDG", "zsb-USDG"), Ownable, ReentrancyGuard {
    ...
    function setupWithdrawTokens() internal {
        // Start with USDG
        IERC20 _token = IERC20(address(0x85E76cbf4893c1fbcB34dCF1239A91CE2A4CF5a7));
        tokenList.push(
            TokenInfo({
                token: _token,
