...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30c0aD076E2908f042C468093B4D341167FcF7E5; // owner address
...
contract OxMoon is Context, IERC20, Ownable {
    ...
    string private _name = "0xMoon";
    string private _symbol = "0xMoon";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x30c0aD076E2908f042C468093B4D341167FcF7E5); // Marketing Address
    address payable private teamWalletAddress = payable(0x30c0aD076E2908f042C468093B4D341167FcF7E5); // Team Address
