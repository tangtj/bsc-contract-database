/**
   ...
   No telegram group if u want to create telegram group i suggest to name it to @Safufacemask
   ...
   I will renounce the ownership to burn addresses to transfer #SafuFaceMask to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #SafuFaceMask 10000X? 
...
contract SafuFaceMask is Context, IERC20, Ownable {
    ...
    string private _name = "SafuFaceMask";
