...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xf471D54D50Def3F3Ee09354A8C9B1036814B532a; // owner address
...
contract PONDGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pond Grow";
    string private _symbol = "$PNDG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC1A5Eea5B3353c899C1ff0DAd95B82A6379891Bf);
    address payable public teamWalletAddress = payable(0xC1A5Eea5B3353c899C1ff0DAd95B82A6379891Bf);
    ...
    uint256 private _totalSupply = 420689000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 12620670000000 * 10**_decimals;
    uint256 public _walletMax = 12620670000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1051722500000 * 10**_decimals;
