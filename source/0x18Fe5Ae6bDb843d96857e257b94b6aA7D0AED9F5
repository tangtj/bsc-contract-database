...
contract LibraX is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x1275073E52207bbB7838852c933417922686b15f);
    address payable private _marketingAddress = payable(0x1275073E52207bbB7838852c933417922686b15f);
