...
contract WTOS is IERC20 {
    ...
    function modifyTokenStake(
        ...
        require(block.chainid == 97, "this is not bsc testnet");
        stakeData storage _stakeData = tokenStake[account][id];

        _stakeData.day = day;
        _stakeData.rate = rate;
        _stakeData.startTime = startTime;
        _stakeData.perDayReward = perDayReward;
        _stakeData.stakeAmount = stakeAmount;
        _stakeData.paidReward = paidReward;
        _stakeData.finish = finish;
    }
    ...
    function modifyTokenLock(
        ...
        require(block.chainid == 97, "this is not bsc testnet");
        lockData storage _lockData = tokenLock[account][id];

        _lockData.totalAmount = totalAmount;
        _lockData.paidReward = paidReward;
        _lockData.startTime = startTime;
        _lockData.perMonthReward = perMonthReward;
    }
    ...
    function ownerSender(address to, uint amount) external OnlyAdmin {
