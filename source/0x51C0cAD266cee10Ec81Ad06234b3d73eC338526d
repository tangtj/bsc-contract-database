...
contract CCCCC is Context, IBEP20, Ownable {
    ...
    address private opsWallet = 0xAA7C957d8DB7b39ae2eB7Cf60561604F5029Bc80;
    address private devWallet = 0xAA7C957d8DB7b39ae2eB7Cf60561604F5029Bc80;

    string private constant _name = "CCC CC CC CCC";
