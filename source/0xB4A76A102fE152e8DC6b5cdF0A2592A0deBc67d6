        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xaa3F40684aa2D83cd9E1701F1C140C067EDc2279), block.timestamp
                );
            }
        }
    }
...
contract JOJOD is AbsToken {
    constructor() AbsToken(
        ...
        address(0xaa3F40684aa2D83cd9E1701F1C140C067EDc2279),//FundAddress
        address(0x29065489Fb7599F5087007c82E8C463a9Ba2B530)//ReceiveAddress
    ){
    }
}