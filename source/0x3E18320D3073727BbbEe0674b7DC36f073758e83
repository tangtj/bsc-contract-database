...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingwallet = 0x32d59D8115b2E4C049300d10d1f2Ad83Cc4716B1;
...
contract DGN is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Digital Gold Nugget", "DGN", 18) {
    _owner = msg.sender;
