...
contract PEPE6 is Context, IERC20, Ownable {
    ...
    string private _name     = "PEPE6.0 TOKEN";
    string private _symbol   = "PEPE6.0";
    ...
    constructor() {        
        ...
        marketingWallet = 0xeC7ecaB65689ddEAA73FfE0Ffb04eEb5DB1D9520;
