...
interface IDigitalBinaryOptions {
...
interface IDigitalOptionsForReader is IDigitalBinaryOptions {
...
// File: contracts/DigitalBinaryPool.sol
...
/**
 * @author Heisenberg
 * @title Digital TokenX Liquidity Pool
 * @notice Accumulates liquidity in TokenX from LPs and distributes P&L in TokenX
 */
contract DigitalBinaryPool is
    ERC20("Digital LP Token", "BLP"),
    AccessControl,
    ILiquidityPool
{
    ...
    /**
     * @notice Called by DigitalBinaryOptions to lock the funds
     * @param id optionId
    ...
    /**
     * @notice Called by DigitalOptions to unlock the funds
    ...
    /**
     * @notice Called by DigitalBinaryOptions to send funds to liquidity providers after an option's expiration
...
contract OptionsConfig is Ownable, IOptionsConfig {
    ...
    constructor(DigitalBinaryPool _pool) {
        pool = _pool;
    }
