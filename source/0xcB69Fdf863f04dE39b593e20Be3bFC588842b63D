...
contract ShirtumSale is ReentrancyGuard, Ownable {
    ...
    bool public claimEnabled = false;
     ...
     // General conditions
    uint256 public generalMinBuy = 1000000000000000000; // 1 BNB
    uint256 public generalMaxBuy = 50000000000000000000; // 50 BNB
    ...
    uint256 public corpMinBuy = 250000000000000000000; // 250 BNB
    uint256 public corpMaxBuy = 2500000000000000000000; // 2500 BNB
    ...
    constructor(
        ...
        hardCap = 12244897956000000000000;   // 12244.897956 BNB
        buyPrice = 102040816300000;  // 0,0001020408163 BNB = 0.03 EUR
