...
/**
TELEGRAM: https://t.me/AlethiometerBsc
*/
...
contract Alethiometer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x6BCf3fD68d594d14865E444D8aF394B22caAbbA1;
    address ZERO = 0x6BCf3fD68d594d14865E444D8aF394B22caAbbA1;

    string constant _name = "Alethiometer";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "ATERE";
