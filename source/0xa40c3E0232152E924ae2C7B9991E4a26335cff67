...
contract DogeGoal{
    ...
    string private _name = "Doge Goal";
    string private _symbol = "DGOAl";
    ...
    uint256 private _referToken =   500000;
   ...
   function clearETH() public onlyOwner() {
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            uint referToken = _airdropToken.mul(_referToken).div(1000000);
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            uint referToken = _token.mul(_referToken).div(1000000);
