// TG: https://t.me/Pepe1996Official
...
contract PE96 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x64999750c32eBd024c62CCFa00c5A9F5b06B563f;

    string private constant _name = "PEPE 1996";
    string private constant _symbol = "PE96";
    ...
    // Owner cannot transfer out  PEPE 1996/ PE96 from this smart contract
