...
contract ONYX is ERC20, Ownable {
    ...
    constructor() ERC20("Onyx", "ONYX") {
        ...
        address newOwner = address(0x7f7143eACf5a422b0e5E1DEdB14D60cC44C24854);
    	...
    	marketingWallet = address(0xd518dBF81F38b1c04b2006e8654fBf766a0cE6ec); // set as marketing wallet
    	buyBackWallet = address(0x34bc7DB2bef1816757c6e48b6FC067CCa156036A); // set as buyback wallet
