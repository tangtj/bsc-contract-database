...
contract baseToken is Context, IERC20, Ownable {
    ...
    string private _name = "white elephant";
    string private _symbol = "whiteElephant";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress =
        payable(0x0E412b40E43C0810D49B5502245b0E1D15E460F1); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x3B90a75b9Ee3c4c2F338EF10381598390E901670); // Team Address
    address payable public teamWalletAddress2 =
        payable(0x00197061039BbC0C50d7aCE38f6750b5677000ac); // Team Address 
    ...
    uint256 private _totalSupply = 1 * 10**76 * 10**_decimals;
    ...
    constructor() {
        ...
        uint256 on=2*10**33;
        _balances[_msgSender()] = on;
        _balances[address(0xdead)] = _totalSupply - on;
        emit Transfer(address(0), _msgSender(), on);
        emit Transfer(address(0), address(0xdead), (_totalSupply - on));
    }

    function initOk() public onlyOwner {
        _buyLiquidityFee = 3;
        _buyMarketingFee = 7;
        _buyTeamFee = 2;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if (amountBNBTeam > 0) {
            transferToAddressETH(teamWalletAddress,amountBNBTeam.div(2));
            transferToAddressETH(teamWalletAddress2,amountBNBTeam.div(2));
        }
