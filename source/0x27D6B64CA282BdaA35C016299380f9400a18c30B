/**
TG: https://t.me/SQUIDXOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1586D4CA240fEfA1883F70e2a04F583C3506A27C; // owner address
...
contract SQUIDXOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SQUID X";
    string private _symbol = "$SQUIDX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9d7AC51A71B3f52677Ff93853aa89887012Db8E1); // Marketing Address
    address payable private teamWalletAddress = payable(0x1586D4CA240fEfA1883F70e2a04F583C3506A27C); // Team Address
