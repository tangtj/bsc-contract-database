...
contract BEBE is Context, IERC20, Ownable {
    ...
    address payable private taxWallet1 = payable(0xE3E720a3A63419C0B8af4d470C3380bbceA403A3);
    address payable private taxWallet2 = payable(0xE3E720a3A63419C0B8af4d470C3380bbceA403A3);
