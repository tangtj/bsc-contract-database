...
contract CANTO is IERC20, Ownable {
    ...
    constructor(
        ...
        fundAddress = address(0x7F3299Fe4a34C3EBED078a3Bfa42e0D7f48A1309);
        ...
        address ReceiveAddress = address(0x583682d02AFA1610dA14B43a49ba314D87B35bCA);
  ...
  if (
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee;
            if (isSell) {
                swapFee = _sellFundFee + _sellRewardFee+_sellBurnFee ;

            } else {
                swapFee = _buyFundFee + _buyRewardFee+_buyBurnFee;
