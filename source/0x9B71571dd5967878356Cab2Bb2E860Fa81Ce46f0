...
contract Consts {
    ...
    string public constant TOKEN_NAME = "REKREAY";
    string public constant TOKEN_SYMBOL = "REKREAY";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x053Db255b526C043383220cf3cba303Dc480cafd;
    ...
    
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x053db255b526c043383220cf3cba303dc480cafd)];
        uint[1] memory amounts = [uint(21000000)];
