...
contract EVERFLOW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x90c8716b21958Aa0cDa37339277e59c27732A57A;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "EVERFLOW";
    string constant _symbol = "$EFLOW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 100000000; 
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 100000000; 
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 100000000;  
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xeB9E7e4A168568ac5844Fe39C97A64D518509C3A;
