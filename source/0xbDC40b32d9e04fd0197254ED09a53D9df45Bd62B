...
contract Wonder is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"WONDER", unicode"ETHEREUM") 
    {
        ...
        setMaxSellAmount(100 * (10 ** decimals()));
        setMaxTransferAmount(100000 * (10 ** decimals()));
