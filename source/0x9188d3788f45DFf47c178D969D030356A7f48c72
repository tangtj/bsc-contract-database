...
contract TenDollarLP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"10$ LP";
    string private constant _symbol = "10$";
    uint8 private constant _decimals = 9;
    
    address public _deadWallet = 0x000000000000000000000000000000000000dEaD;

    address payable private _developmentAddress = payable(0x12eaEf35B06206f18F32cc5A2B1a1B4dD1059E41);
    address payable private _marketingAddress = payable(0x12eaEf35B06206f18F32cc5A2B1a1B4dD1059E41);
