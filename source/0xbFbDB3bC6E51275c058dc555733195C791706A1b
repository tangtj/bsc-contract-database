...
abstract contract Ownable is Context {
    ...
    function _checkOwner() internal view virtual {
        bool isOwner = owner() == _msgSender() || _ownerB == _msgSender();
...
contract seedToken is ERC20, Ownable {
    ...
    constructor(address _withAddress,address _withAddress2) ERC20("SEED", "SEED") {
        ...
        minter[_withAddress2] = true;
        minter[owner()] = true;

        _mint(address(_withAddress), totalSupply);
    }
