...
contract Token is IERC20, Ownable {
    ...
    constructor (){
        ...
        _name = "Baby Tonken 2049";
        _symbol = "Baby2049";
        _decimals = 18;
        uint256 Supply = 20492049;

        _totalSupply = Supply * 10 ** _decimals;
        swapAtAmount = _totalSupply / 10000;

        address receiveAddr = 0x59Cf98dFc067C469612B15eDe8AC034F74a0F059;
        _balances[receiveAddr] = _totalSupply;
        emit Transfer(address(0), receiveAddr, _totalSupply);

        mkt = payable(0xEd44d188CeFcd9f16aa1c132495a5D9551F525d7);
