...
contract HJ is Token {
    constructor() ERC20(
        "HJ",   // 名字
        "HJ"   // 符号
    ) {
        uint256 _totalSupply = 36666 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x7bB44fB587b161f12B9A980CB1B12382BE65AA1B); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x7bB44fB587b161f12B9A980CB1B12382BE65AA1B)
        );
