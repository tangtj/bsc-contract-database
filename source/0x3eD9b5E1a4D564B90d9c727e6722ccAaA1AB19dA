...
contract PuggyInu  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Puggy Inu", "PUGG") {
        ...
        marketingWallet = address(0x6EDD058b819a0c3b624bE789F1b69851cB08b700); // set as marketing wallet
        devWallet = address(0x6EDD058b819a0c3b624bE789F1b69851cB08b700); // set as dev wallet
