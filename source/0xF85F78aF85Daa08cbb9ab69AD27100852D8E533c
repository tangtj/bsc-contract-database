...
contract X100X is IBEP20, Auth {
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x9D1A5460F8fB8a56824Ff9C1D43693521334e7BE;
    address ZERO = 0x9D1A5460F8fB8a56824Ff9C1D43693521334e7BE;

    string constant _name = "X 100 X";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "X100X";
