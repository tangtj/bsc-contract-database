...
contract bisonproject is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb9400F4ae2c38B63ECD231Dde4E0bC0D8eD032FE); 
    address payable public Wallet_Dev = payable(0xb9400F4ae2c38B63ECD231Dde4E0bC0D8eD032FE);
    ...
    string private constant _name = "Bison V2"; 
    string private constant _symbol = unicode"BISON V2"; 
    ...
    constructor () {
        ...
        _owner = 0xb9400F4ae2c38B63ECD231Dde4E0bC0D8eD032FE;
