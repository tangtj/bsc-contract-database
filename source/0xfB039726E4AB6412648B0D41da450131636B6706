...
contract Kechang is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x5D9e6615a5FE735C5aC41895653F41Fa8f23b0b6;

    string private constant _name = "Kechang currency";
    string private constant _symbol = "Kechang";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 2% reflection, 4% mkt
