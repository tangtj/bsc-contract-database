        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x80d0BF50371029F1c6fe0f833C6d9853B5D7d374), block.timestamp
                );
            }
        }
    }
...
contract a2049 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        20490000,//Supply
        address(0x80d0BF50371029F1c6fe0f833C6d9853B5D7d374),//FundAddress
        address(0x80d0BF50371029F1c6fe0f833C6d9853B5D7d374)//ReceiveAddress
    ){
    }
}