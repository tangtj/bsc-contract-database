/**
Telegram: https://t.me/Hetarium_official
Twitter: https://twitter.com/HetariumBSC
Website: https://hetarium.online/
**/
...
contract HETARIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HETARIUM"; 
    string private _symbol = "HETA"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9681bbBbCCA9E0613b0e9cD8Cd58fD2b312143fB); 
    address payable public teamWalletAddress = payable(0xB6ED5BA0Ed115686c5aADEDf2386745D9DE201E5); 
