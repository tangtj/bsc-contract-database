/**
 *LilBabyShiba BSC Token - Cute Shiba to the shiba family.
 * 12% Rewards to holders.
 * 2% Marketing Fee.
 * 4% liquidity Fee.
 * No Presale, 100% LP Lock, Owner Renounce.
 * Telegram: @LilBabyShiba
*/
...
contract LilBabyShiba is Context,IBEP20,Ownable {
    ...
    string private constant _name = "LilBabyShiba";
    string private constant _symbol = "LBSHB";
