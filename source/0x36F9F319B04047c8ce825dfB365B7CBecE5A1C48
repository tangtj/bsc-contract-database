...
// File: contracts/core/giveaway/EGoldGiveawayT2.sol
...
contract EGoldGiveAwayT2 is AccessControl , ReentrancyGuard{
    ...
    function Giveaway( uint256 _type , address _user  ) external isVaildMint( _user) nonReentrant {
...
// File: contracts/interfaces/iEGoldMinerNFT.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/interfaces/iEGLDTreasury2.sol
