...
/**
 *TG: https://t.me/BabyLayeriumCommunity
  *TWITTER: https://twitter.com/babylayerium
 with 6% LAYERIUM REWARDS , 3% BUY BACK 3% MARKETING
*/
...
contract BABYLAYERIUM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Baby Layerium ";
    string constant _symbol = " BABYLAYERIUM ";
