...
contract YOYO is Token {
    constructor() ERC20(
        "YOYO",   // 名字
        "YOYO"   // 符号
    ) {
        uint256 _totalSupply = 666 ether; 
        address _marketing = address(0x33ab35783451Da841C2DA2549176CD280A5BBfFF); // 
        address _receive = address(0x20AB4aC55aE9Bc5E4d67a6Fee4E4759f704a873e);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x20AB4aC55aE9Bc5E4d67a6Fee4E4759f704a873e)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(10 ether);  
        setInitPrice(5 ether); 
        feeMarketingTo2 = address(0x20AB4aC55aE9Bc5E4d67a6Fee4E4759f704a873e);   
        feeEarn = 1000; 
    }
}