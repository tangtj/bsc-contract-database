/**
   ...
   Welcome to PitAstroSurf
   
   This is a community token. If you want to create a telegram I suggest to name it to https://t.me/PitAstroSurf
   ...
   I will renounce the ownership to burn addresses to transfer #PitAstroSurfBSC to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   No Dev Token
   Can you make #PitAstroSurf 10000X? 
   ...
   it's the best part of the #PitAstroSurfBSC idea, increasing the liquidity pool automatically, 
...
contract PitAstroSurf is Context, IERC20, Ownable {
    ...
    string private _name = "PitAstroSurf";
    string private _symbol = "PitAstroSurf";
    ...
    uint256 private numTokensSellToAddToLiquidity = 2500000000000 * 10**18;
