...
contract BNBChain {
    ...
    address payable public project_fee;
    ...
    constructor(address payable _owner) public {
        owner = _owner;
        project_fee = 0xf55Beb4911F52504cae8FE2F72Fb9ff4C4E5F79F;
        admin_fee = 0xDccF1439c43698197a04bEB8bB9fB28da804c1d9;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        else require(_amount >= 1e16 && _amount <= cycles[0], "Bad amount");
        ...
        project_fee.transfer(_amount * 3 / 100);
    }
