...
contract MatrixPepe is ERC20, Ownable {
    ...
    MatrixPepeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("MatrixPepe", "MXP") {
        marketingWallet = payable(0x54b04a0d5a74470a1041d38c12e4969ADcaB912e);
        devWallet = payable(0x54b04a0d5a74470a1041d38c12e4969ADcaB912e);
        ...
        dividendTracker = new MatrixPepeDividendTracker(
            payable(this),
            router,
...
contract MatrixPepeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MatrixPepe public MatrixPepeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MatrixPepeContract = MatrixPepe(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MatrixPepe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MatrixPepe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MatrixPepe contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MatrixPepeContract);

            uint256 prevBalance = MatrixPepeContract.balanceOf(address(this));
            ...
            {
                uint256 received = MatrixPepeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MatrixPepeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
