...
contract ArcMarket is ERC20, Ownable, ReentrancyGuard {
	...
	uint constant _initial_supply = 600000000 * (10**18);
    constructor() ERC20("ArcMarket", "ARC") {
    ...
    function lockTokens(
        ...
        _transfer(_tokenAddress, address(this), _amount);
