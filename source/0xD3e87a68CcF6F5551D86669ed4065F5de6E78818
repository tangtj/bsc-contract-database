...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderCondition = 300 * tokenDecimals;

        addLpProvider(ReceiveAddress);
        
        _limitAmount = 300 * tokenDecimals;
        
        _numToSell = 50000 * tokenDecimals;
    }
...
contract YTT is AbsToken {
    ...
    //总量
        8888888,
    //Receive，接收地址
        address(0xab6043170F76C6e518436cFeC1A32CA1a7Fc31de),
    //Fund，营销
        address(0x922c8FaCF1b562b37d250A2DD33df60d0F7dc71A)
    ){
