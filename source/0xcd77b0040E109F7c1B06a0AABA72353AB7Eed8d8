...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA010F8b05CcBAD2f526Ec0893d7ABFd07Bae187D;
...
contract SWOOPX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x35537159cF194F727A8821Eeff3d11C13D8678D6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SWOOPX";
    string private _symbol = "SWOOP";
