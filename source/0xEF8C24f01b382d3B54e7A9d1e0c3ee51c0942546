/**
   ...
   No telegram group if u want to create telegram group i suggest to name it to @RocketBlastChat
   ...
   I will renounce the ownership to burn addresses to transfer #RocketBlast to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #RocketBlast 50000X? 
   ...
   it's the best part of the #RocketBlast idea, increasing the liquidity pool automatically, 
...
contract RocketBlast is Context, IERC20, Ownable {
    ...
    string private _name = "RocketBlast";
