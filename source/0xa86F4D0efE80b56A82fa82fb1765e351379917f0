// Telegram : Make it please

// I have marketing wallet 8% and im going to use it the best i can

// There will be some milestones for calls
...
// This is not bullshit , so please share this the best you can
...
contract UnknownGrimace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UnknownGrimace";
    string constant _symbol = "UnknownGrimace";
