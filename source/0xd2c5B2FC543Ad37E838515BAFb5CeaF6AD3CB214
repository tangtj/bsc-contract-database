...
contract noox is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NOOX";
    string private _symbol = "NOOX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x6e7eB591C435961B00A17571ddC0daFC337E6EB6);
    address payable public teamWalletAddress =
        payable(0xb05C85F4aB2cf9AacF7570e5a1Aef3dD186A46Be);
