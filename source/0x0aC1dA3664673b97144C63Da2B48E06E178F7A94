...
contract BabyDoge20 is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x2Da256bcEce50Ab84195feC598a20b0E23410F1b);
    address payable private _marketingAddress = payable(0x2Da256bcEce50Ab84195feC598a20b0E23410F1b);
