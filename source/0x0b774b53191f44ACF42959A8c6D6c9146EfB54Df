...
contract bullseye is Context, IERC20, Ownable {
    ...
    string private _name = "Bull's Eye";
    string private _symbol = "BSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5369a69f393bddb32C0C27b5c68DAd367152b784); // Marketing Address
    address payable public devFee = payable(0x5369a69f393bddb32C0C27b5c68DAd367152b784); // devFee
