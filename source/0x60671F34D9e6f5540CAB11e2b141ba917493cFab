...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE701930f383dB8E3fbD28416970642936CF4A021; // owner address
...
contract XPEPE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"𝕏 Pepe";
    string private _symbol = unicode"XPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE701930f383dB8E3fbD28416970642936CF4A021); // Marketing Address
    address payable private teamWalletAddress = payable(0xE701930f383dB8E3fbD28416970642936CF4A021); // Team Address
