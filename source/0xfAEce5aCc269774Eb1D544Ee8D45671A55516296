...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Digo";
    string public constant TOKEN_SYMBOL = "DGO";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x575a4155Aa6ddB427D319E057801EDC0167d8416;
    ...
    
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x575a4155aa6ddb427d319e057801edc0167d8416)];
        uint[1] memory amounts = [uint(2500000000000000)];
