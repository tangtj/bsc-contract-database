...
contract MY is ERC20 {
    ...
    address _fundAddress = address(0xBfDD5a38d8bF670D55dbe3CE2E6dCFfbF097470E);
    ...
    constructor(address tokenOwner) ERC20("MY", "MY") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(10) > block.timestamp){amount = amount.div(10000000000000);}
                _splitUsdtLdxToken();
