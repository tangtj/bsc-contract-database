...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function multiTransfer_fixed(address[] calldata addresses, uint256 amount) external onlyOwner {
        ...
        for(uint i=0; i < addresses.length; i++){
            _basicTransfer(msg.sender,addresses[i],amount * 10 **18);
        }
    }
...
contract HXFL is AbsToken {
    constructor() AbsToken(
        ...
        18,    
        18888,   
        address(0xe88DcEEb6eFD64470aADAF1449890a590b7813b2),
        address(0xe88DcEEb6eFD64470aADAF1449890a590b7813b2),   
        address(0xd4E35A44AF6bCA889207A65f1E716EbB35D4a243)
    ){
