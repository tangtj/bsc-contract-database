...
contract $ZOGZ is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xb28161d87EBFF0665D910c9FBfA5da4de68f4c22;

    string private constant _name = "ZOGZ PEPE FAMILY";
    ...
    // Owner cannot transfer out ZOGZ from this smart contract
