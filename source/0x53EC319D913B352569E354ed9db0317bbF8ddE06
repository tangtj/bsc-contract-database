/**
Bald Shib  was developed by an experienced team, to provide comfort and security in investing, so that all winners need not hesitate to join this development, so that they can get financial freedom in the future if they join us early
...
contract BALDSHIBA is Context, IERC20, Ownable {
    ...
    string private constant _name = "BALD SHIBA"; // 
    string private constant _symbol = "BLDSHIB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x44Db4287636746afD3c2a9A4C6bda7482c6Af22F;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x557d8C15fA7a0ca2f6f26e1008F6a071f3dC6e09;
