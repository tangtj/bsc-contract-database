...
//Just launched in $KishuClassic. We have created a token so rewarding for everyone.
//KishuClassic Hold we will Tothemoon
//Tg : t.me/KishuClassic
...
contract KishuClassic is Context, IERC20, Ownable {
    ...
    string private _name = "KISHU CLASSIC";
    string private _symbol = "KishuClassic";
