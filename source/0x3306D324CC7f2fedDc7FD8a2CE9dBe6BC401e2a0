...
contract TooShi is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("Tooshi", "Tooshi") {
        ...
        maxTransactionAmount = totalSupply * 10 / 3000; // 3% maxtxn
        maxWallet = totalSupply * 30 / 1000; // 3% maxw
        ...
        marketingWallet = address(0x63e9dD6D365c8A26588Accedf16ed9EB9fAaAeC9); // set as marketing wallet
        devWallet = address(0x63e9dD6D365c8A26588Accedf16ed9EB9fAaAeC9); // set as dev wallet
