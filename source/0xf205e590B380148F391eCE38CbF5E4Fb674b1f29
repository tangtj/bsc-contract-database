/*
    ...
    BinanceShiba (BNBShib)
    TG:  https://t.me/BinanceShibaBSC
...
contract BinanceShiba is IERC20, Ownable {
    ...
    string constant _name = "BinanceShiba";
    string constant _symbol = "BNBShib";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xDBa6297D7cD97fE90F1A195614f5B0544d4C9321;
