...
// Telegram: https://t.me/BlueBirlProtocol
...
contract BLUEBIRL is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x3759940d1F2bEcE2c43CD868DA78A8bB5eAF8C24);
    address payable private _twdmkt = payable(0x3759940d1F2bEcE2c43CD868DA78A8bB5eAF8C24);
    
    string private constant _name = "B L U E B I R L";
    string private constant _symbol = "BLUEBIRL";
