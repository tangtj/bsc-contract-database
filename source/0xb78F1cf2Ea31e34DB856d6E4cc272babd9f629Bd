...
contract GrowGrowGrow is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x530e62Ff3F63cC6FAE5323090696902e1DFb1fE5);
    address payable private _twdmkt = payable(0x530e62Ff3F63cC6FAE5323090696902e1DFb1fE5);
    
    string private constant _name = "GROW GROW GROW";
