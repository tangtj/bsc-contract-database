/*  
    Welcome to the #MOONPAW Project!
    
    Website: https://moonpaw.cc
    Telegram: https://t.me/MoonPawToken
...
contract MoonPaw is Context, IERC20, Ownable {
    ...
    string private _name = "MoonPaw";
    string private _symbol = "MOONPAW";
    ...
    address payable public charityAddress = 0x13f5232EF194242C7E7F1499AC9608A01A16b9B9; // Charity Wallet
