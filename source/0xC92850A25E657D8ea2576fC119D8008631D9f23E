/**
   ...
   Welcome to MOONSHARD
   
   This is a community token. If you want to create a telegram I suggest to name it to @MOONSHARD
   ...
   I will renounce the ownership to burn addresses to transfer #MOONSHARD to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MOONSHARD 10000X? 
   ...
   it's the best part of the #MOONSHARD idea, increasing the liquidity pool automatically, 
...
contract MOONSHARD is Context, IERC20, Ownable {
    ...
    string private _name = "MOONSHARD";
    string private _symbol = "MOONSHARD";
