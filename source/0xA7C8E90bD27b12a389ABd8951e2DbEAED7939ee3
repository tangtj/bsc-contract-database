...
contract Pepe is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x5101058CC2a6cdD7B536CbFBebe28f5FAD7D9941;
    address public devAddress = 0x5101058CC2a6cdD7B536CbFBebe28f5FAD7D9941;
    ...
    // Owner cannot transfer out $KEK from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out $KEK!");
