...
contract ONFTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public rjjgh67;
    ...
    string private _tokenname = "OnlyFine";
    string private _tokensymbol = "ONF";
