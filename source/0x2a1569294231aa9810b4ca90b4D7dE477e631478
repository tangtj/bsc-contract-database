...
contract XBRTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Xbarium";
    string private _seitokensymbol = "XBR";
    address public XBRrrse4;
