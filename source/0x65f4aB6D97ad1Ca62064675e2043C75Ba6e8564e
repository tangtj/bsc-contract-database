/**
Welcome to OddBods BSC, the community-owned meme token 
that brings laughter and fun to the world of blockchain. 

Our project is built on the Binance Smart Chain (BSC), 
where we combine the power of decentralized finance with the humor and creativity of meme culture.

OddBods BSC aims to provide a unique and enjoyable experience 
for our community of holders while promoting transparency and community-driven governance.

TELEGRAM: https://t.me/OddbodsBsc
TWITTER: https://twitter.com/OddBodsBsc
*/
...
contract OddBodsBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "OddBods";
    string private _symbol = "OddBods";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0x13691f74eb4E0C8E70Aef01c384FAa7E19D2f5b5);
