...
contract OBAMACEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xC74fbf505ab388085D8839d8FAfbeB3d9dBEc983;

    string private constant _name = "OBAMA CEO";
    string private constant _symbol = "OBAMACEO";
