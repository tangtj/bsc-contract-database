...
contract BETONMUSK is Context, Ownable {

    using SafeMath for uint256;

    string private _name = "Bet On Musk";
    string private _symbol = "BETONMUSK";
    ...
    address public BETONMUSKDividendReceiver;
    ...
    constructor() {
        ...
        address owner = address(0xDd077dfd6f15E2F529E87812539AF33b87dAd063);

        distributor = new DividendDistributor(owner);
        BETONMUSKDividendReceiver = address(distributor);
    ...
    function changeDistributor(address _newDis) external onlyOwner {
        ...
        BETONMUSKDividendReceiver = _newDis;
    }
