...
//https://snakebattle.games/
//https://twitter.com/snake1coin
//https://t.me/+gSOQCI2SxKM4ZmZl
...
contract SNAKE is Context, IERC20, Ownable {
    ...
    address payable public DerpWallet =
        payable(0xDe950c8a82241b6cF2abe41B71C40639959ba8eD);

    address payable public cxWallet =
        payable(0xDe950c8a82241b6cF2abe41B71C40639959ba8eD);

    address public constant deadWallet =
        0xDe950c8a82241b6cF2abe41B71C40639959ba8eD;
    ...
    string public constant name = "SNAKE COIN";
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            path,
            address(0xDe950c8a82241b6cF2abe41B71C40639959ba8eD), // The contract
            block.timestamp
        );
