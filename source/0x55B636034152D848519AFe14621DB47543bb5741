// https://t.me/ShenronXBSC
// https://twitter.com/RealShenronX
// https:/ShenronX.com
...
contract ShenronX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ShenronX";
    string private constant _symbol = unicode"ShenronX";
