...
contract HulkZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HulkZilla"; // 
    string private constant _symbol = unicode"HZL";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xfbf4B0738E0cFBBED21cA1aacAC8953dB5B8EA79;
