...
https://t.me/ShibaGrow_BSC_Portal
...
contract ShibaGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Grow";
    string private _symbol = "SBG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xD0314A4775836555d33d2d7505442526013f5983);
    address payable public teamWalletAddress =
        payable(0x9619DA100c69402deaFB4748cD9D4f38f39228ec);
