...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"RabbitGod",//Name
        unicode"RabbitGod",//Symbol
        9,//Decimals
        40000,//Supply
        address(0x24A365FAf7a617d9eDAEF40B769923d478006652),//FundAddress
        address(0x24A365FAf7a617d9eDAEF40B769923d478006652)//ReceiveAddress
    ){
    }
}