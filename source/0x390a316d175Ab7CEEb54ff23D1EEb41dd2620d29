...
contract Binarium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Binarium";
    string private _symbol = "BNR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xda5566cE871272d65C05D98B601ebb0Aaf2F483e);
    address payable private DevelopmentWalletAddress = payable(0xda5566cE871272d65C05D98B601ebb0Aaf2F483e);
