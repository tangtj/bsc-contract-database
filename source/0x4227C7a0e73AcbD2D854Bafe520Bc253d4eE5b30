...
contract FatClown is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD5e88f61d3e311fE35e591D7D7BE35FBA0E4d221;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FatClown";
    string private _symbol = "FATC";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**18; // -> 0.1% of Total supply (1000000000)
