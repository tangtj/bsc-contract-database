...
https://t.me/ReverseShiba




Join my call channel https://t.me/gubbinscalls
...
contract ReverseShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4571E3c8be2Db480224057036055f21C5Ce3e437); 
    address payable public Wallet_Dev = payable(0x4571E3c8be2Db480224057036055f21C5Ce3e437);
    address payable public constant Wallet_Burn = payable(0x4571E3c8be2Db480224057036055f21C5Ce3e437); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Reverse Shiba"; 
    ...
    constructor () {
        _owner =0x4571E3c8be2Db480224057036055f21C5Ce3e437;
