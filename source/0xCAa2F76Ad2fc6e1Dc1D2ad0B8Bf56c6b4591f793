...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    address public mainAddres = address(0x21C9DCD7e3037A00A68ac6f3f95a20350C86F0b5);
    address public pointAddress = address(0x21C9DCD7e3037A00A68ac6f3f95a20350C86F0b5);
