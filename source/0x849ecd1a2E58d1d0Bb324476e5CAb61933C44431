...
contract SAFEMOONX is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x2E2639D258cF476E4438eFD6E1857A3d068244B5;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x0431FeDB5eD5362e0351bc47B20946c45AB24681;
