/**
TELEGRAM: https://t.me/SDFSHIBOFFICIALBSC
TWITTER: CHECK IN TG
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe4Aaa52f1ed4fdaEc03DaB70DF76aB056b0c0F74; // owner address
...
contract SDFSHIBOFFICIALBSC is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x74BC7a6d3D784cb0c4f1832DAaDBd7Ac8CF3D8AD); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 60;  // original 12
