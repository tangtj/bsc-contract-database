...
contract GBCTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public eajjhs46;
    ...
    string private _tokenname = "GBC";
    string private _tokensymbol = "GBC";
