...
contract D330TOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Shikoku Inu 2.0";
    string private _seitokensymbol = "Shikoku2.0";
    address public D330AACT;
