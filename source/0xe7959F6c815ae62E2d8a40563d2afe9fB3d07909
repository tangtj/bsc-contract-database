...
contract QZ is Token {
    constructor() ERC20(
        "QZ",   // 名字
        "QZ"   // 符号
    ) {
        uint256 _totalSupply = 3000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x54CB810631c5fE34999AE126eacC1edf23bB0246); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x54CB810631c5fE34999AE126eacC1edf23bB0246)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(10 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x7B0f211eA9F0c3C775fa6e1D5dE22BdA6cBA65e0);
        feeEarn = 0;
        isLiquified = true;
    }
}