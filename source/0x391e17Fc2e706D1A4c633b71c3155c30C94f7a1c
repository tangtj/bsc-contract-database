...
Telegram : https://t.me/Fluffy_Unicorn_Coin
...
contract $FLUPPYUNICOIN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7C3F763C799849e3ecdaFf720F597d780251776E;

    string private constant _name = "FLUPPYUNICORN2.0";
    string private constant _symbol = "FLUPPYUNICOIN";
