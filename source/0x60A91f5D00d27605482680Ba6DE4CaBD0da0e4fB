...
//https://twitter.com/xTaurusCoin
//https://t.me/TaurusCoinCommunity
...
contract TAURUS  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6ec3fA724CDC107b7411dA2E4AAC239cd9D73462); 
    address payable public Wallet_Dev = payable(0x6ec3fA724CDC107b7411dA2E4AAC239cd9D73462);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 30000* 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner =0x6ec3fA724CDC107b7411dA2E4AAC239cd9D73462;
