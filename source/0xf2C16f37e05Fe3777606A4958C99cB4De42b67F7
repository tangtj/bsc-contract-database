// t.me/ARKInnovationETFDefichain 
// ARKInnovationETFDefichain.com
...
contract ARKInnovationETFDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "ARKInnovationETFDefichain";
    string public symbol = "DARKK";
