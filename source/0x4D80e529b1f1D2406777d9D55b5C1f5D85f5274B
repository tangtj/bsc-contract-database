...
/**
   ...
   Welcome to SALTYMARS
   
   This is a community token. If you want to create a telegram I suggest to name it to @SALTYMARSBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SALTYMARS to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #SALTYMARS 10000X? 
...
contract SALTYMARS is Context, IERC20, Ownable {
    ...
    string private _name = "SALTYMARS";
