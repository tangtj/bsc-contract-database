...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  Shinja = IBEP20(0xab167E816E4d76089119900e941BEfdfA37d6b32);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Shinja.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Shinja);
        ...
        uint256 amount = Shinja.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Shinja.transfer(shareholder, amount);
...
contract BabyShinja is IBEP20, Auth {
    ...
    // Addresses
    address Shinja = 0xab167E816E4d76089119900e941BEfdfA37d6b32; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xCC16ABc9B10839D0b09A6ceE3fc48460D37B9054;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x1ac11A6EC810Ce4F877ed49A919121ca705dEE8F;
