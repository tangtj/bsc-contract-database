...
contract Rasabot is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9e8f77524ca0BdA239e60596D271F7e3Bd3328bE); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 10; // 8% BUY TAX
    uint256 public _totalTaxIfSelling = 10; // 8% SELL TAX
