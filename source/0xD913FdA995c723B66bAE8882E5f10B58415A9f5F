...
contract Xplore is IBEP20, Auth {
    using SafeMath for uint256;

    address BTCB = 0x78650B139471520656b9E7aA7A5e9276814a38e9;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Xplore";
    string constant _symbol = "XGC";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x0589668f9317829A3E05B68C98f8E466f066AeD1;
