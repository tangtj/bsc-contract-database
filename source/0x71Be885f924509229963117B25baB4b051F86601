...
contract TRUMPDOGE is ERC20, Ownable {
    ...
    address public teamWallet = 0x3d0769Ce96F5B86cCE6Ab07C03FF25c66b350716;
    ...
    constructor() ERC20("TrumpDoge", "TRUMPDOGE") {
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.team;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = taxes.liquidity + taxes.team;
            feesum = feeswap;
            currentTaxes = taxes;
        } else if (useLaunchFee) {
            feeswap = launchtax;
