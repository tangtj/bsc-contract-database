...
contract HABIBIAI is IERC20 {
    ...
    string constant private _name = "HABIBI AI";
    string constant private _symbol = "$HABAI";
    ...
    address payable public marketingWallet = payable(0x8013e73dAa2071DDD2d4B41Deb1D59e26aB78962);
