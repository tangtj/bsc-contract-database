...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x33cd3A3d6DD84D8123c60804957f5D2AE7a28AD2; // owner address
...
contract YYY is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x33cd3A3d6DD84D8123c60804957f5D2AE7a28AD2); // Marketing Address
    address payable private teamWalletAddress = payable(0x33cd3A3d6DD84D8123c60804957f5D2AE7a28AD2); // Team Address
    ...
    uint256 public _walletMax = 16 * 10**_decimals;
