...
contract Floki_inu_Valentine is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x23EB536aa33A438725241CbDDC16016cAC622EEA));


    string private _name = "Floki Inu Valentine";
    string private _symbol = "FINUV";
