...
contract DoomerTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ynbcfh3;
    ...
    string private _tokenname = "Doomer";
    string private _tokensymbol = "Doomer";
