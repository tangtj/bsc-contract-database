...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb1B9e2D41A18b7aDe4240Fdd516937E5c500A0Bb; // owner address
...
contract MicroPepeBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Micro Pepe Burn";
    string private _symbol = "MPB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb1B9e2D41A18b7aDe4240Fdd516937E5c500A0Bb); // Marketing Address
    address payable private teamWalletAddress = payable(0xb1B9e2D41A18b7aDe4240Fdd516937E5c500A0Bb); // Team Address
