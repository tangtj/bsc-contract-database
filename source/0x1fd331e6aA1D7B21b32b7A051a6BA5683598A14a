...
contract INFINITY is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x56c9662CfdAB15ABD68392441a69dEbB2636176E);
    address payable private DevelopmentWalletAddress = payable(0x56c9662CfdAB15ABD68392441a69dEbB2636176E);
