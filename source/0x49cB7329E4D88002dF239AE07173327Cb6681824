...
contract WideAreaNetwork is IERC20, Ownable {
    ...
    string _name = "Wide Area Network";
    string _symbol = "WAN";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x44C56949c5Bd04deB0007869571A7516165e737d;
        marketingFeeReceiver = 0x44C56949c5Bd04deB0007869571A7516165e737d;
