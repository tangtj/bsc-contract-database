// https://t.me/AdventureIslands
// https://twitter.com/adventureisles
// https://adventureislands.io/
...
contract Isla is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ADVENTURE ISLANDS";
    string private constant _symbol = unicode"$ISLE";
