...
//NO Team NO vesting low marketcap, contract renounced no rug no whales.
...
contract MEEOW is ERC20, Ownable {
    ...
    address public marketingWallet = 0x93Eff511C3532134Cd63b3925915b0853341621c;
    ...
    {   
        ...
        _mint(owner(),499000000 * 1e6 * (10 ** 18));
