...
contract Max is ERC20, Ownable {
    ...
    constructor() ERC20("Max Token", "MAX") {
        marketingWallet = payable(0xe09a282091ef6294F8706DaE3416Cf95238fc358);
        devWallet = payable(0xe09a282091ef6294F8706DaE3416Cf95238fc358);
        ...
        uint256 totalTokenSupply = (700_000_000_000) * (10**18);
...
contract MaxDividendTracker is DividendPayingToken, Ownable {
    ...
    function _transfer(
        ...
        require(false, "Max Token_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Max Token_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Max Token contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MaxContract);

            uint256 prevBalance = MaxContract.balanceOf(address(this));
            ...
            {
                uint256 received = MaxContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MaxContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
