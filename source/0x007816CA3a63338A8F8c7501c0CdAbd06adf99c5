...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XWLDwebsite = "http://XWLD.io/";
    string public XWLDADDRESS = "0xb1D532B9cfae8E9d978A177a95444C1Dee25Cf67";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXWLD;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXWLD = 0xb1D532B9cfae8E9d978A177a95444C1Dee25Cf67;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXWLDwebsite() public view returns (string memory) {
        return XWLDwebsite;
    } 


               function getXWLDADDRESS() public view returns (string memory) {
        return XWLDADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXWLD);
        _;
    }    
    function _approve(
        address owner,
...
contract XWLD is ERC20, Ownable {
    constructor () ERC20("X Worldcoin", "XWLD") 
    {    
