// t.me/NewParadigmAssetsSolution 
// NewParadigmAssetsSolution.com
...
contract NewParadigmAssetsSolution is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "NewParadigmAssetsSolution";
    string public symbol = "NPAS";
