// https://t.me/btcdogebsc
// https://twitter.com/btc_doge_coin
...
contract BTCDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BTCDOGE";
    string private constant _symbol = unicode"$BTCDOGE";
