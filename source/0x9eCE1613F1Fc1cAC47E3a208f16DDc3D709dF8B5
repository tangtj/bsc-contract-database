...
contract peachcoin is IERC20, Ownable {
    ...
    string _name = "PEACH COIN";
    string _symbol = "#PEACH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69000000 * 10**9 * 10**_decimals;
    ...
    constructor () {
        ...
        devFeeReceiver = 0x9B82655E5A8A11a13f89b13AbC0882A24Fa85303;
        marketingFeeReceiver = 0x9B82655E5A8A11a13f89b13AbC0882A24Fa85303;
