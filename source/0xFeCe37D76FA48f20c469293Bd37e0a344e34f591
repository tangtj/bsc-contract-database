/**
 ...
 TG:https://t.me/orbitzportal
 website: http://orbitzcommunity.xyz
 twitter: https://x.com/Orbitzcommunity
...
contract orbitz is IBEP20, Ownable {
    ...
    string constant _name = "Orbitz";
    string constant _symbol = "$ORBZ";
    ...
    address public marketingFeeReceiver = 0x2D19f7fB4bB5ae62A9D97FF7CD721DF3d8D7c80E;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 3; // 0.3%
    bool inSwap;
