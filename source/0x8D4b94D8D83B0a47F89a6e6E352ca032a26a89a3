/**
   ...
   This is an invite to all the fans of the Inu's to INU TOWN!
   Come for fun & we'll make you wish you stay forever.
 
   Telegram: https://t.me/InuTown
   Website: https://inu-town.com/
   Twitter: https://twitter.com/InuTown
...
contract InuTown is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "INU TOWN";
    string constant _symbol = "INU";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x257bF4B78f7ba210b9A85F4d980dEAe6F702a7CB;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
