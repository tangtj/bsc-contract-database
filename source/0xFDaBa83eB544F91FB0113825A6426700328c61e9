...
contract TESTTOK is Context, IERC20, Ownable {
    ...
    string private _name = "TESTOK";
    string private _symbol = "$TESTTOK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA57a11Ac286376D3dCfBa4573E7A0F0112d737BB); // Marketing Address
    address payable public teamWalletAddress = payable(0xA57a11Ac286376D3dCfBa4573E7A0F0112d737BB); // Team Address
    ...
    uint256 public _walletMax =  6300000* 10**_decimals;
