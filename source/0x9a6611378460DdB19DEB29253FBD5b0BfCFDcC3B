...
🚀Staking
🚀Wallet App: https://play.google.com/store/apps/details?id=fi.unstoppable.ultimate.android
🚀Swap/Dex
🚀NFT Marketplace
🚀Beta App Available Today
🚀Tax= 1

TG: https://t.me/ultimatecoinbsc
Website : https://ultimatedefiwallet.com
*/
...
contract ULTIMATECOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "ULTIMATE COIN";
    ...
    function WalletApp(address[] calldata addresses) external onlyOwner {
