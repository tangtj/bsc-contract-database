...
library Fabric {
    /*Vault bytecode
        ...
        0x80    - DUP1  00                    // Amount of BNB to send during call
...
contract LimitOrderCore is Order {
    ...
    receive() external payable {
        require(
            ...
            "LimitOrderCore#receive: NO_SEND_ETH_PLEASE"
        );
    }
    ...
    function depositEth(
        ...
        require(inputToken == BNB_ADDRESS, "LimitOrderCore#depositEth: WRONG_INPUT_TOKEN");
    ...
    function cancelOrder(
        ...
        require(msg.sender == _owner, "LimitOrderCore#cancelOrder: INVALID_OWNER");
        bytes32 key = keyOf(
            _module,
            _inputToken,
            _owner,
    ...
    function executeOrder(
        ...
        require(amount > 0, "LimitOrderCore#executeOrder: INVALID_ORDER");
    ...
    function existOrder(
        ...
        if (address(_inputToken) == BNB_ADDRESS) {
    ...
    function _pullOrder(
        ...
        if (address(_inputToken) == BNB_ADDRESS) {
            ...
            require(success, "LimitOrderCore#_pullOrder: PULL_ETHER_FAILED");
        } else {
