...
contract FOMOinu is Context, IERC20, LockToken 
{

    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x7ea707457AE3A4B66ff70fad8F1c8b6b10a91aE9);
    address payable public devAddress = payable(0x68Dbf4829493E264a084Bc28F1e7B33C77135a05);
    address public newOwner = 0xC7442C0CA90011e1E302c07426a51243cc1D2280;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner()
    {
        ...
        require(_maxTxAmount >= _tTotal.div(100).mul(1), "Too low limit"); //min 1%
    }
