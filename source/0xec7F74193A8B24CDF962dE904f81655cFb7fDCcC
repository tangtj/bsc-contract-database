...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE7C027E2469eBfA33f9aE9838AcC5e94e4D36f59; // owner address
...
contract NanoLayerium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NANO LAYERIUM";
    string private _symbol = "$NALYUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE7C027E2469eBfA33f9aE9838AcC5e94e4D36f59); // Marketing Address
    address payable private teamWalletAddress = payable(0xE7C027E2469eBfA33f9aE9838AcC5e94e4D36f59); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 50;  // original 12
