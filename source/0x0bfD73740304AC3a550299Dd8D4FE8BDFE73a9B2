...
contract CodeBook is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"CODE BOOK";
    string private _symbol = unicode"CODEBOOK";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xAb15fC8428FA8Dd9206c7BD28e5B1714C412ba02);
    address payable private taxWallet2 = payable(0xAb15fC8428FA8Dd9206c7BD28e5B1714C412ba02);
    ...
    uint256 public _walletMax = _totalSupply*100/100000;
