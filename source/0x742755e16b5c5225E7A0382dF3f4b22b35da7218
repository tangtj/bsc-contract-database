...
contract CrazyTigeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crazy Tige Inu";
    string private constant _symbol = "$CTINU";
    ...
    constructor () {
        ...
        _isIncludedFromFee[0xe7480C61A39eb94Dc22f2a9D7a9EFCcd03a30FcB] = true;
        _isIncludedFromFee[0x5e831b7687e5864489f764c18De39399d91f3ecD] = true;
        _isIncludedFromFee[0x2784Dde537e6940be445B706C52F5241186d8081] = true;
