...
contract XFLASH is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "XFLASH";
    string private _symbol = "XFH";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA04869baEa93a898E201207d84146FC98c82943E);
    address payable public liqWalletAddress = payable(0xA04869baEa93a898E201207d84146FC98c82943E);
