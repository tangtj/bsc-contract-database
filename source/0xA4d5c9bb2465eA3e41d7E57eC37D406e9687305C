...
contract Babytoken is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xD2fDBA5225Fb52Ec9e8c019b09d62e9A92ec6eFa); // Marketing Address
    address payable private teamWalletAddress = payable(0x39B1Eb608955e7798f7E1A90B5e1Fb9e2d3822cd); // Team Address
