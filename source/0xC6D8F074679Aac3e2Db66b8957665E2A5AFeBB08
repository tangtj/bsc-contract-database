/**
   The DOG三COIN community cares about 
   supporting each other, being kind, teaching 
   people about cryptocurrency.
  TELEGRAM: https://t.me/Dog3coin_BSC
*/
...
contract Doge is Context, IBEP2022, Ownable {
  ...
  constructor() public {
    ...
    function contribute(uint256 amount, address recipient) external {
