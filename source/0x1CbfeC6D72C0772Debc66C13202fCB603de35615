...
TG: https://t.me/CatClubEntryPortal

CATTAX (9LIVES equals 9%)
7% FORTHECATS / 2% LP
...
contract CatClub is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa37C17a681207fCF512B75d84138AEEFF54a095d);
    address payable public teamWalletAddress = payable(0xFb4eECa0e2D4143055D7CACB60Bd828775c0ecfa);
