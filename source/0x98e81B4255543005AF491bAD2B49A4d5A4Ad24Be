...
contract TheForgottenKings is Context, IERC20, Ownable {
    ...
    string private _name = "The Forgotten Kings";
    ...
    address payable public developmentWallet = payable(0xD8414F4412AB18048Df1B36f5144AA74944031DF);

    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;

    uint256 public numTokensSellToAddToLiquidity = 500000 * 10**18;
    uint256 public _maxTxAmount = 777000000 * 10**18;
