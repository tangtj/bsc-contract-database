 ...
 *WebSite Project : https://decentralexvalley.com
*/
...
contract dexvalley is Context, IERC20, Ownable {
    ...
    string private _name = "Dex valley";
    ...
    address public MarketingWallet = 0xf2aC93A545975d392B79dcA4CE16fBe1d76bAA75;
    ...
    uint256 private numTokensSellToAddToLiquidity = 500000000 * 10*1 * 10**9;
