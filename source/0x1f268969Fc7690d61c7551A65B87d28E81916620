...
contract LayerConnect is ERC20, Ownable {
    ...
    mapping (address => bool) private _isLayerExcluded;
    ...
    constructor() payable ERC20 ("LayerConnect", "Layer") {

        rewardToken = 0x09cF7ca1B4Ca6aB3855F23020e8e0e9E721CC03d;
        ...
        marketingWallet =  0xF2223827ba6aE907D431DBa6649A7420dc9F73db;

        dividendTracker = new DividendTracker(2000000, rewardToken);
        ...
        _isWalletExcluded[0xF2223827ba6aE907D431DBa6649A7420dc9F73db] = true;
    
        _mint(owner(), 2000000 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 1000000 * 555;
    }
