...
telegram: : https://t.me/hoptokenbsc
twitter : https://twitter.com/HopBsc
...
contract HOP is Context, IERC20, Ownable {
    ...
    string private _name = "HOP";
    string private _symbol = "HOP";
    uint8 private _decimals = 7;

    address payable public marketingWalletAddress = payable(0xB425291e440e7Be5a70CBC93C8a096a0D3Ef2F80); 
    ...
    uint256 public _maxTransactionAmount =   10000000000000; 
    uint256 public minimumTokensBeforeSwap = 10000000000; 
    uint256 public _walletMax = 10000000000000;
    ...
    function TurnOnMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   10000000000000;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {           
            ...
            if(WalletLimit && !isWalletLimitExempt[recipient])
