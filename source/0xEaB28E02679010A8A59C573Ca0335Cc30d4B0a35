...
contract SYNCITY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x22bf95cf78A823EFC45d5EE8702D90CBE51f94cB); 
    address payable public developmentAddress = payable(0x22bf95cf78A823EFC45d5EE8702D90CBE51f94cB); 
    address payable public charityAddress = payable(0x22bf95cf78A823EFC45d5EE8702D90CBE51f94cB); 
    address payable public vaultRewardAddress = payable(0x22bf95cf78A823EFC45d5EE8702D90CBE51f94cB); 
    address payable public liquidityWallet = payable(0x22bf95cf78A823EFC45d5EE8702D90CBE51f94cB); 
    ...
    string private constant _name = "Syndicate Token";
    string private constant _symbol = "SYNR";
    ...
    uint256 public _bMaxTxAmount = 10000000000  * 10**2;
    uint256 public _sMaxTxAmount = 10000000000  * 10**2;
    uint256 private _trigger = 10000000000  * 10**2;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 10000000000 * 10**2; // 1000000
        _sMaxTxAmount = 10000000000 * 10**2;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 10000000000 * 10**2;
        _sMaxTxAmount = 10000000000 * 10**2;
        setTradingOpen(true);
    }
