...
contract PiNetworkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pi Network Inu";
    string private constant _symbol = "PII";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x2bA95995aBE9d69FEec0D791f734F591d0bBDe31);
    address payable private _marketingAddress = payable(0x8267bAa45daAF3c17E82f1aE07D00685BF448C0d);
