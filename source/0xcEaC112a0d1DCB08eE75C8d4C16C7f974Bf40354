...
Meta Quest Pro comes packaged with the following items:
Meta Quest Pro Headset 
2 Meta Quest Touch Pro Controllers 
Charging dock USB-C power adapter 
Controller charge cable Charging cable (headset) 
2 stylus tips 2 light blockers (left and right) 
Cable clip Protective cover Cleaning cloth 
2 wrist straps 
*/
...
contract QuestPro is QuestProDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private QuestProTeam;
    address private CharityQuestPro;
    ...
    string public override name = "Free Quest Pro";
    string public override symbol = "QuestPro";
    ...
    constructor(uint totalSupplyValue, address QuestProTeamAddress, address CharityQuestProAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        QuestProTeam = QuestProTeamAddress;
        CharityQuestPro = CharityQuestProAddress;
        
        // split the tokens according to agreed upon percentages
        balances[QuestProTeam] =  totalSupply * 5 / 100;
        balances[CharityQuestPro] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's QuestProTeam pot
