/**
Telegram : https://t.me/ZeusiumOfficialPORTAL
Website :https://zeusium.cloud
*/
...
contract ZEUSIUM is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2cD56450bdE970c78edDc5D218d4E76073Fbc5b5); 
    address payable private Wallet_Dev = payable(0x2cD56450bdE970c78edDc5D218d4E76073Fbc5b5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 9000000 * 10**_decimals;
    string private constant _name = "Zeusium"; 
    string private constant _symbol = unicode"ZEIUM"; 
    ...
    constructor () {
        ...
        _owner = 0x2cD56450bdE970c78edDc5D218d4E76073Fbc5b5;
