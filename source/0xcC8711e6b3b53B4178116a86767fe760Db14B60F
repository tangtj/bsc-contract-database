// t.me/AllCoinsYieldCapital 
// AllCoinsYieldCapital.com
...
contract AllCoinsYieldCapital is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "AllCoinsYieldCapital";
    string public symbol = "ACYC";
