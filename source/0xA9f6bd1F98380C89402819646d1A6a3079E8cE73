...
contract Vitaldog is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000 * 10**9 * 10**18;
    ...
    address payable public marketingWallet = payable(0x86Cb020C6510C093be2ffc790468db9f0B7D5256);

    string private _name = "Vitaldog";
    string private _symbol = "Vdog";
