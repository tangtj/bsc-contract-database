...
contract TestTreasury is ERC20, Ownable {
    ...
    uint256 public transferTreasuryFee;
    ...
    constructor() ERC20("Test Treasury", "TestTreasury") {
        ...
        uint256 _transferTreasuryFee = 0;
        ...
        totalFeesSell = sellMarketingFee + sellLiquidityFee + sellDevFee + sellTreasuryFee;
        ...
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferDevFee + transferTreasuryFee;

        marketingWallet = address(0x5E64efa28eEB99fBE9445a077333dC365Fa73718); 
        devWallet = address(0x5E64efa28eEB99fBE9445a077333dC365Fa73718);
        treasuryWallet = address(0x5E64efa28eEB99fBE9445a077333dC365Fa73718);
        lpWallet = msg.sender;
    ...
    function updateBuyFees(
        ...
        totalFeesBuy = buyMarketingFee + buyLiquidityFee + buyDevFee + buyTreasuryFee;
    }
    ...
    function updateTransferFees(
        ...
        transferTreasuryFee = _treasuryFee;
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferDevFee + transferTreasuryFee;
    }
    ...
    /// @notice Sets if the blacklist is enabled or not
    /// @param enabled If the blacklist is enabled or not
    function updateBlacklistEnabled(bool enabled) external onlyOwner {
    ...
    function updateTreasuryWallet(address newTreasuryWallet)
        ...
        onlyOwner
    {
           emit marketingWalletUpdated(newTreasuryWallet, treasuryWallet);
    ...
    function _transfer(
        ...
        if (!_isFeeExempt[from] && !_isFeeExempt[to] && blacklistEnabled) {
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && totalFeesSell > 0) {
                ...
                tokensForTreasury += (fees * sellTreasuryFee) / totalFeesSell;
            }
            // on buy
            ...
            // on transfer
                ...
                tokensForTreasury += (fees * transferTreasuryFee) / totalFeesTransfer;
            }
