...
contract Kingdingoglobalinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdc05d2748D474275D944C4F485d437b623EA9f32); 
    address payable public Wallet_Dev = payable(0xdc05d2748D474275D944C4F485d437b623EA9f32);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000 * 10**5 * 10**5 * 10**_decimals;
    string private constant _name = "KING DING"; 
    string private constant _symbol = unicode"$KD"; 
    ...
    constructor () {
        _owner =0xdc05d2748D474275D944C4F485d437b623EA9f32;
