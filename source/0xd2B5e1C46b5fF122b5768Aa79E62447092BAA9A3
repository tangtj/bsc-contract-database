...
contract BabyShia is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BABY SHIA";
    string private _symbol = unicode"BABYSHIA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x37678643b667B8E886BA43666f78ba9fCE3c5ece);
    address payable private taxWallet2 = payable(0x37678643b667B8E886BA43666f78ba9fCE3c5ece);
