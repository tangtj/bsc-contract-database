...
Website : https://faicchi.tech/
Twitter  : https://twitter.com/FaicchiBsc
Telegram : https://t.me/Faicchi
...
contract faicchi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Faicchi";
    string private _symbol = "$FCI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5D844e9a2d80458eC9D8Bd03D4E4e454c765F3Db); // Marketing Address
    address payable public teamWalletAddress = payable(0x5D844e9a2d80458eC9D8Bd03D4E4e454c765F3Db); // Team Address
