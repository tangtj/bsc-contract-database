...
contract METASHI is Context, IBEP20, LockToken {
    using SafeMath for uint256;
    using Address for address;

    address public deadAddress = 0x000000000000000000000000000000000000dEaD; //burn wallet address. 
    ...
    uint256 private _tTotal = 10_000_000_000 * 10**18;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "METASHI"; //token name
    string private _symbol = "METASHI"; // token symbol. 
    ...
    uint256 public _maxTxAmount = 1_000_000_000 * 10**18; //10%
    ...
    function setAllSaleFeesPercents(uint256 taxFee, uint256 liquidityFee, uint256 burnFee) 
    external onlyOwner
    {
        _saleTaxFee = taxFee;
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 10_000_000_000 * 10**18;
    }
