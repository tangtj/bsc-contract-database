...
contract spax is Token {
    constructor() ERC20(
        "spax",   // 名字
        "spax"   // 符号
    ) {
        uint256 _totalSupply = 10000000 ether;
        address _marketing = address(0x1c80D37e0e9e75658f3c1CcDC2316F692E232573); //
        address _receive = address(0x1c80D37e0e9e75658f3c1CcDC2316F692E232573);   //
        ...
        super.setSurprise(
            90,
            3,
            address(0x1c80D37e0e9e75658f3c1CcDC2316F692E232573)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0x1c80D37e0e9e75658f3c1CcDC2316F692E232573);
        feeEarn = 0;
    }
}