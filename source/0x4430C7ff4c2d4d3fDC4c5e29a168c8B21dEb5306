...
contract PollyCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "PollyCoin";
    string private constant _symbol = "Pcoin";
    ...
    address payable private _twddev = payable(0x00CD0B5c2739C72Ff565cae1b31eCDc0f6EB8ee3);
    address payable private _twdmkt = payable(0x00CD0B5c2739C72Ff565cae1b31eCDc0f6EB8ee3);
