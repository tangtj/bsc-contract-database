...
contract Diamond is Ownable, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    ...
    function updateLootbox(address newLootbox) external onlyOwner {
        lootbox = newLootbox;
        _approve(address(this), lootbox, (2 ** 256 -  1));
    }
