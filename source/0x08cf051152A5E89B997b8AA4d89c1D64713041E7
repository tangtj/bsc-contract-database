/*
Cryo Wallet is created to suit the expectations of all individuals in crypto space looking for a decentralized wallet. If you're searching for a simple solution to store Ethereum, Binance, Avalanche, Polygon, Heco, Fantom Opera, Optimistic, Arbitrum One, Palm, ARTIS sigma1, POA, Ethereum Classic, xDai and many more cryptocurrency, this app is for you

🟤Cyro Wallet Ecosystem:
🟤Staking
🟤Web3 Wallet
🟤Swap/Dex
🟤Buy/Sell Tax = 1%

TG: https://t.me/cyrowallet
*/
...
contract CyroWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "CYRO WALLET";
    string private constant _symbol = "Cyro";
