...
contract KuKuKuKuKuKu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0xCC591466AF4344486912A8C2Df3d335192900912;
    ...
    // Supply 1 trillion
    constructor() ERC20("KuKuKuKuKuKu", "KuKuKuKuKuKu") {
        ...
        uint256 _supply = 420_000_000_000_00 * 10**18;
        // 0.5% MaxTx amount
        ...
        address _toBeOwner = 0xCC591466AF4344486912A8C2Df3d335192900912;
