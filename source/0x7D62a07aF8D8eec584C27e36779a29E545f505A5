...
>https://t.me/fortunatokenoficial
...
contract Fortuna {
    ...
    BEP20 BUSD = BEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);//endereço Busd Bep20
    string constant _name = "Fortuna";
    string constant _symbol = "FRT";
    uint8 constant _decimals = 9;
     uint256 _totalSupply = 50000 * (10**_decimals);
        uint256 public maxBuyAmount = 500 * (10**_decimals); 
    uint256 public maxSellAmount = 500 * (10**_decimals); 
    ...
    uint256 public marketingFee = 998; 
    uint256 public reflectionFee = 1; 
    uint256 public burnFee = 1;

    //SELL FEES

    uint256 public sellMarketingFee = 998; 
...
function setFees(
    ...
    buyTax = _marketingFee + _reflectionFee + _burnFee;

    sellReflectionFee = _sellReflectionFee;
    sellBurnFee = _sellBurnFee;
    sellMarketingFee = _sellMarketingFee;

    sellTax = _sellReflectionFee + _sellBurnFee + _sellMarketingFee;
}
