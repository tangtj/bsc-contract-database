...
contract HalfPepe is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x04A5087A97a03E775d0a65F92b5b8feb5d4eA48C;

    string private constant _name = "Pepe 0.5";
    string private constant _symbol = "Half Pepe";
    ...
    // Owner cannot transfer out  Half Pepe from this smart contract
