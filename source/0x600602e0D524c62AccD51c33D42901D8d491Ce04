...
contract Marbles is Context, IERC20, Ownable {
    ...
    string private   _name = "Marbles";
    string private _symbol = "Marbles";
  ...
  function getMarketingWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xe1330077D2D3EcAdE149e7d332e47007C4A4B9a9, 'We can not exclude Uniswap router.');
