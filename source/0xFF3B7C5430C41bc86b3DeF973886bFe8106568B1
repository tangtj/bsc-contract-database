// TG: https://t.me/bububsc
// TWITTER: twitter.com/bububsctoken
...
contract BUBUTHEMONKEY is ERC20, Ownable {

    uint256 public _totalSupply = 100000 * 10 ** decimals();
    address public uniswapV2Pair;
    uint256 public _maxWalletLimit = 4000 * 10 ** decimals();
    bool public limitEnabled;
    mapping (address => bool) public _isExcludedFromLimit;


    constructor() ERC20("BUBU THE MONKEY", "BUBU") {
        //MINT TOTAL SUPPLY
    ...
    function _transfer(
        ...
        if(!_isExcludedFromLimit[sender] && !_isExcludedFromLimit[recipient]) {
        if(limitEnabled) {
