...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf33A7417A294ce025d15EcC070ff226a59Fdd82b; // owner address
...
contract XBow is Context, IERC20, Ownable {
    ...
    string private _name = "X Bow Bot";
    string private _symbol = "$XBow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf33A7417A294ce025d15EcC070ff226a59Fdd82b); // Marketing Address
    address payable public teamWalletAddress = payable(0xf33A7417A294ce025d15EcC070ff226a59Fdd82b); // Team Address
