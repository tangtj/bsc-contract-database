...
contract Purr is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x6C04F75468c0317f5c0349518C1e2949dE31A15b;
        ...
        _mint(owner(), 500_000_000_000_000 * (10 ** decimals()));
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _buyBackFeeOnSell) external onlyOwner {
        ...
        require(totalFeeOnSell <= 8, "Total Fees cannot exceed the maximum");
