...
contract BLOCKPRIME is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC66a780Df953F4B31981ED9cf17C86dE1C431965); // Marketing Address
    address payable public teamWalletAddress = payable(0xC66a780Df953F4B31981ED9cf17C86dE1C431965); // Team Address
