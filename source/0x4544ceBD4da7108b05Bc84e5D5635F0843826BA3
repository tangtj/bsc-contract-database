...
contract DLI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x99283692dF4A4Db2B434bb347DB96fBF324c545C;

    string private constant _name = "Dork Lord Inu";
    string private constant _symbol = "$DLI";
    ...
    // Owner cannot transfer out  DORKLORDINU from this smart contract
