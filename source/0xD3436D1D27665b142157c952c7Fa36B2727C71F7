...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5B5db068EaEad532cB741156a637A02b4889D7B;
...
contract MOONSIENFTMETAVERSE is Context, IERC20, Ownable {
    ...
    string private _name = "Moonsie NFT";
    string private _symbol = "MOONGEMS";
