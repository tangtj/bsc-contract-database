...
contract PixelShark is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pixel Shark";
    string private constant _symbol = "$PSHARK";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xDE0eA9F2B9b209B75794e98443e3eEc387802135);
    address payable private _marketingAddress = payable(0xDE0eA9F2B9b209B75794e98443e3eEc387802135);
