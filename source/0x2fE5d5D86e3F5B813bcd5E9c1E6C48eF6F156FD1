...
contract Business {
    ...
    user.singleUplineBonusTaken = _getUplineIncomeByUserId(msg.sender);
    user.singleDownlineBonusTaken = _getDownlineIncomeByUserId(msg.sender);

    user.totalWithdrawn += actualAmountToSend;
    user.remainingWithdrawn += actualAmountToSend;
