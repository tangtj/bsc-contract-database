...
contract CuteShiba is IBEP20, Auth {
    ...
    address DEV = 0x8EB0c5e73C93b459775161c56BbfbFC227dB66bb;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "CUTE SHIBA";
    string constant _symbol = "$CUTESHIBA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x8EB0c5e73C93b459775161c56BbfbFC227dB66bb;
