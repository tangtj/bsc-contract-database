...
interface IDEXRouter {
 ...
 contract BullishTigerCheems is IBEP20, Auth {
    ...
    string constant _name = "BullishTigerCheems";
    ...
    address public marketingFeeReceiver = 0x3D9542a66b8b38f902E9e8d3bD7A9dDE51280D45;
    address public buybackFeeReceiver = 0xF25a75cF18498C02fbD5CB4BC42f4eEB23EC9a4d;
