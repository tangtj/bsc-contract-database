...
contract Fourium is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x0a1da7242a0358CCa1aa37f8dB02A56a5760233b);
    address payable private _marketingAddress = payable(0x68d4E5fFBB527F336f3FeCD7283628C876C2D75b);
