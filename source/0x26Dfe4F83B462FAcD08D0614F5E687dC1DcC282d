...
contract TANCOIN is Ownable, ERC20 {
    ...
    address constant DEV = 0xb9736db1efACd1386B1438c230e869672c4B55E1;
    

    string constant _name = "TAN COIN";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x701aA8728fa4358DA05FAcB9a7092357F3C7E9a9;
        devFeeReceiver = DEV;
