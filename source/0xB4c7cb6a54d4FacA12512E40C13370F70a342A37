...
contract BotStakeApp {
    ...
    uint256[] public TARIF_DAILY_PERCENTS = [120, 127, 159, 191, 261]; // /100
    uint256[] public TARIF_TOTAL_PERCENTS = [1200, 1904, 3182, 4783, 7833]; // /100
    ...
    constructor(
      ...
      address[] memory partnersAddrs, uint256[] memory partnersPercents
        ...
        unpauseTime = block.timestamp; // ❓❓убрать debug = start.srazu
    }
...
//        require(_percent > 0 && _percent <= 1000, "Invalid shiller percent");
