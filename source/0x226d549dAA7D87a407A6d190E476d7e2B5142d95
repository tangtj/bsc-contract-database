...
contract SQUIDGAMEX is IBEP20, Auth {
    ...
    string constant _name = "SQUIDGAMEX";
    string constant _symbol = "SQUIDGAMEX";
    ...
    address private marketingFeeReceiver = 0x8052078e1F24C2ba4243a3464643886b45254952;
    address private developmentFeeReceiver = 0x8052078e1F24C2ba4243a3464643886b45254952;
