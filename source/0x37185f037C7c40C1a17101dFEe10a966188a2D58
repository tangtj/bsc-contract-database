...
contract lionbot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "lionbot";
    string private _symbol = "$LIB";
    uint8 private _decimals = 9; 

    address payable private marketingWalletAddress = payable(0x17492Db5013Aaaf8a629B0DbEd67fc58AaEfdBcb);
    address payable private teamWalletAddress = payable(0x17492Db5013Aaaf8a629B0DbEd67fc58AaEfdBcb);
