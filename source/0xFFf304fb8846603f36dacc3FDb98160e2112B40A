...
/**
   ...
   Welcome to GHOST FACE
   
   This is a community token. If you want to create a telegram I suggest to name it to @GHOSTFACE
   ...
   I will renounce the ownership to burn addresses to transfer #GHOSTFACE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #GHOSTFACE 10000X? 
   ...
   it's the best part of the #GHOSTFACE idea, increasing the liquidity pool automatically, 
