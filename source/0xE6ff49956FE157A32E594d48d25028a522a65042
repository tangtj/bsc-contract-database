...
contract TipPepe is ERC20, Ownable {
    ...
    constructor() ERC20("Tip Pepe", "TipPepe") {
        ...
        marketingWallet = address(0x4622C1799B4E99bcEEC36f34174c47a87A70DD2B); // set as marketing wallet
        devWallet = address(0x4622C1799B4E99bcEEC36f34174c47a87A70DD2B); // set as dev wallet
