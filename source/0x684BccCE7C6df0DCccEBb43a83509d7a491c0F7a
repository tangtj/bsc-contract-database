...
/**
*/
// https://t.me/letsmoonthisfornoreason
/**
...
contract LetsMoonThisForNoReason is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    LetsMoonThisForNoReasonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("LetsMoonThisForNoReason", "MOON") {
        marketingWallet = payable(0x043Bf53C672352AFEDC8bF6E573D654E1aff9957);
        devWallet = payable(0x043Bf53C672352AFEDC8bF6E573D654E1aff9957);
        ...
        dividendTracker = new LetsMoonThisForNoReasonDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "LetsMoonThisForNoReasonTRACKER",
            "MOONTRACKER"
        );
...
contract LetsMoonThisForNoReasonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    LetsMoonThisForNoReason public LetsMoonThisForNoReasonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        LetsMoonThisForNoReasonContract = LetsMoonThisForNoReason(mainContract);
    ...
    function _transfer(
        ...
        require(false, "LetsMoonThisForNoReason_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "LetsMoonThisForNoReason_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LetsMoonThisForNoReason contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(LetsMoonThisForNoReasonContract);

            uint256 prevBalance = LetsMoonThisForNoReasonContract.balanceOf(address(this));
            ...
            {
                uint256 received = LetsMoonThisForNoReasonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    LetsMoonThisForNoReasonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
