...
contract Ballot_hemcs is ERC20, Ownable, ERC20Burnable {
    ...
    constructor(address _account) ERC20("HemcsSwap", "HEMCS") {
        ...
        sellFee = 10;
        sellBurnFee = 50;
        buyPreAddress = 0x3be7bd4C902b22eeFA0646786EcCBfA15DD95546;
        sellPreAddress = 0x3be7bd4C902b22eeFA0646786EcCBfA15DD95546;
    ...
    function seeCoinWallet() public view returns (address[] memory) {
        ...
        wallet[2] = airdrop;
        wallet[3] = node;
        wallet[4] = buyPreAddress;
        wallet[5] = sellPreAddress;
        return wallet;
    }
    ...
    function isGuarded(address account) public view returns (bool){
        return isGuardedOf[account];
    }
    ...
    function _transfer(
        ...
        if(from == ecology){
            require(ecologyFreeTime < block.timestamp, "Unlocking time has not arrived");
        }else if(from == lock){
            require(lockFreeTime < block.timestamp, "Unlocking time has not arrived");
        }
