...
contract PieceTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dunnfg74;
    ...
    string private _tokenname = "One Piece Fan Token";
    string private _tokensymbol = "One Piece";
