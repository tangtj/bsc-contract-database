...
contract XCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420_000_000_000_000 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0x22fF48f2886A7b156C754ee8a5566845eAA79722;
    ...
    function setBuyFeePercentages(uint256 _taxFeeonBuy, uint256 _buybackBurnFeeOnBuy, uint256 _marketingFeeonBuy) external onlyOwner {
        ...
        require(totalBuyFees <= 1, "Buy fees cannot be greater than 1%");
