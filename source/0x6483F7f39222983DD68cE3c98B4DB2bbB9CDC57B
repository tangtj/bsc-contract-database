...
//TG Community - https://t.me/pepetoshicommunity
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC28AEa5A2b11e8A4F12af8FeE9a61cd776ae0807;
...
contract $PETOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE TOSHI"; // 
    string private constant _symbol = "$PETOSHI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xC28AEa5A2b11e8A4F12af8FeE9a61cd776ae0807);
