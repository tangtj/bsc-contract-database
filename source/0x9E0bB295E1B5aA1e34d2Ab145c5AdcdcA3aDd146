...
contract PumpxBSC is IBEP20, Auth {
    ...
    string constant _name = "PUMP X";
    string constant _symbol = "PUMP X";
    ...
    address private marketingFeeReceiver = 0x65b983F13D75A092696f4803941937d1a280C262;
    address private buybackFeeReceiver =   0x65b983F13D75A092696f4803941937d1a280C262;
