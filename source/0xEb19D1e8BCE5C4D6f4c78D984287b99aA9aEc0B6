...
contract GOTCHI is Ownable {
    string public constant name = "CryptoGotchies";
    string public constant symbol = "GOTCHI";
    uint256 public constant totalSupply = 1000000000e9;
