...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/c_a_k_e_m_e+d+a+d+d+y/pull/522
        if (a == 0) {
            return 0;
        }
...
contract CakeMeDaddy is IERC20 {
    ...
    string constant _name = "CakeMeDaddy";
    string constant _symbol = "CAKEMEDADDY";
    ...
    address payable private _marketingWallet = payable(0xD7a3cdc700514F6219AE0034dd2F203d48a354AA);
