...
contract napoleonInu is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Napoleon Inu"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (4); // 1%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (4); // 1%
    uint256 public _maxWalletToken = _totalSupply / (100) * (1); // 1%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0x520C7a550dCf886362AFaEc459028bFE70ca8a00;
    address public devFeeReceiver = 0x520C7a550dCf886362AFaEc459028bFE70ca8a00;
    address public buybackFeeReceiver = 0x520C7a550dCf886362AFaEc459028bFE70ca8a00;
