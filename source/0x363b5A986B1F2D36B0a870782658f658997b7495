...
contract DexterLabs is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0x1553b0F77679AFe9b29961129F1f249959C7709a;
    address public developmentAddress = 0x5Db65Bc34Bc211bf4385825294978BBB252F4FA1;
    address public buybackAddress = 0xbc01Bb073A625eFa757cCe1BF515724022a298d1;
    address public LPtokenReciver = 0xF90813BfCe569A7DBd3a9a59f2d01b7E1209a431;
...
//uint
    ...
    uint public maxSellTxAmount = 30000000*10**9;
...
// constructor
    constructor() ERC20("DexterLabs", "DLABS") {
        total_supply = 100_000_000_000_000 * 10 ** decimals();
        // set gvars
...
// operational functions
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint trade_type = automatedMarketMakerPairs[from] ? 1 : automatedMarketMakerPairs[to] ? 2 : 0;
        ...
        if(!isInternalTransaction) {
            ...
            if(trade_type == 1) { //buy
                ...
                if(!excludedFromFees[to]) {
                   ...
                   if(feeStatus && buyFeeStatus) { // fees management
            ...
            //sell
                ...
                if(!excludedFromFees[from]) {
                    ...
                    if(feeStatus && sellFeeStatus) { // fees management
