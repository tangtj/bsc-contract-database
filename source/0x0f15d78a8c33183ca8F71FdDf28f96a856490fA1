...
contract liveium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Liveium";
    string private _symbol = "$LVM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0d5f340ee54Ca7A54CEeF4465f728066EfD7738D);
    address payable private DevelopmentWalletAddress = payable(0x0d5f340ee54Ca7A54CEeF4465f728066EfD7738D);
