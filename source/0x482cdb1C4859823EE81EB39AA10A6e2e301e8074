...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF9a2083169F2d70eC66E231356E258B47D2A9ED7;
...
contract VirtualJourney is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x16BF2442537B888e6BbbE419a401E5c83343955C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VirtualJourney";
    string private _symbol = "VJN";
