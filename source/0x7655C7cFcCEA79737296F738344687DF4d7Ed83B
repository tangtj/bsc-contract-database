/**
* Website: https://x-floki.com/
* Twitter: https://twitter.com/XFlokiBSC
* Telegram: https://t.me/XFlokiBSC
**/
...
contract XFloki is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 42 * (10**9) * (10**9);
    ...
    address payable private _marketingAddress = payable(0xbF0574F9aD6B95F259B5C238F888E6149aBA0312);
    address payable private _burnAddress = payable(0xac3Aef9eEBB0CCf3D1435Ec652f694674c6bb9B2);
