...
contract XRG is ERC20, Ownable {
    ...
    mapping (address => bool) private _isXRGExcluded;
    mapping (address => bool) private _isBotExcluded;
    ...
    constructor() payable ERC20 ("XRP Gold", "XRG") {
        ...
        marketingWallet =  0xA9606830BfC9879d88e2ba1109D09B586E717690;
        ...
        _isExcludedFromFees[marketingWallet] = true;
        _isWalletExcluded[marketingWallet] = true;
