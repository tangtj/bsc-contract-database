...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xa8CfE725C45bc9beA0c68ffB06fB2a264Dc57f33; // owner address
...
contract AAAAAAAAAA is Context, IERC20, Ownable {
    ...
    string private _name = "Aaaaaaaaaa";
    string private _symbol = "AAAAAAAAAA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc090776112691269590507ea2e3398D17Db61d54); 
    address payable public teamWalletAddress = payable(0x12029A5567812bFcc610ff36EFDff70D2e50bFE8);
    ...
    uint256 private _totalSupply = 82200000000000000 * 10**_decimals;
