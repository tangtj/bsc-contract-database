...
https://t.me/+mYkn9IlkfSFkYWNk

Through The Eye Of The Beholder All Is Clear.
...
contract DONTFADE is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DONTFADE"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (2); // 10%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (2); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (4); // 40%

    // Fees receivers
    address private autoLiquidityReceiver = 0xa5408E55ebf238d8E7468cB2c6B180532015B21F; //LP receiver
    address private marketingFeeReceiver = 0x18127865DA14B711C3AF1EA5582939987C797557; //mkt
    address private devFeeReceiver = 0xa5408E55ebf238d8E7468cB2c6B180532015B21F; //31 BuyBack
    address private teamFeeReceiver = 0xa5408E55ebf238d8E7468cB2c6B180532015B21F; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x3FAaCE51CaD89434feBcC1A076Dc4BC75983996E;
