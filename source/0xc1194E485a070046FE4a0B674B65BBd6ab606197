...
contract BabyShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2F075ff0Ea4562e0FD79699b5b747D84Ef8CD335); 
    address payable private Wallet_Dev = payable(0xdBFA6C5e9497BA3687e21a84bf1F6b1eEf02FbC6);
    ...
    constructor () {
        ...
        _owner = 0xdBFA6C5e9497BA3687e21a84bf1F6b1eEf02FbC6;
