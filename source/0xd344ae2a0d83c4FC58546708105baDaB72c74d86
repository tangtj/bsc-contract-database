...
contract BNBKISHU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB KISHU INU";
    string private _symbol = "BNBKISHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD51BD082073A2BaA51a2f26178479edD65C94A5f); // Marketing Address
    address payable public teamWalletAddress = payable(0xD51BD082073A2BaA51a2f26178479edD65C94A5f); // Team Address
