...
// File: contracts/CommunityNFT.sol
...
contract TTCommunityPartner is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    // Token base URI
    string  public baseURI = "https://static.titiapp.ai/nft/ttpartner/";

    event TokenBaseURIUpdated(string uri);

    constructor() ERC721("TTCommunityPartner", "TTCP") {
