...
contract ASTROMOON is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xC5C321E0c3ef3f2bc79d4111266020f96BE1ea93);
    address payable private _twdmkt = payable(0xC5C321E0c3ef3f2bc79d4111266020f96BE1ea93);
    
    string private constant _name = "ASTRO MOON";
    string private constant _symbol = "ASTRO MOON";
