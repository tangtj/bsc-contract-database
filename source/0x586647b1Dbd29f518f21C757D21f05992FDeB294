...
/**
   ...
   Welcome to DREAMPUMP
   
   This is a community token. If you want to create a telegram I suggest to name it to @DREAMPUMPBSC
   ...
   I will renounce the ownership to burn addresses to transfer #DREAMPUMP to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #DREAMPUMP 10000X? 
   ...
   it's the best part of the #DREAMPUMP0x586647b1Dbd29f518f21C757D21f05992FDeB294 idea, increasing the liquidity pool automatically, 
...
contract DREAMPUMP is Context, IERC20, Ownable {
    ...
    string private _name = "DREAMPUMP";
    string private _symbol = "DRP";
