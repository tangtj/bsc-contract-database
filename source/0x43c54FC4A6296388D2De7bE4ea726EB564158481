...
// File: contracts/Archive/Drakkar1155.sol
...
contract Drakkar1155 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    string public name = "VelhallaDrakkar1155";
    string public constant symbol = "Drakkar";
