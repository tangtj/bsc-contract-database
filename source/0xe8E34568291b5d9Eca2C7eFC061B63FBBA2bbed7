...
contract GetRichOrDieAping is Context, IERC20, Ownable {
    ...
    uint256 private _marketingFeeOnBuy = 8;
    
    uint256 private _reflectionFeeOnSell = 0;
    uint256 private _marketingFeeOnSell = 8;
    
    uint256 private _reflectionFee;
    uint256 private _marketingFee;
  
    string private constant _name = "GetRichOrDieAping";
    string private constant _symbol = "GRODA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x58C9A6Db47c3D0e578013D6f5eA3B7A8E478513f);
    address payable private _marketingAddress = payable(0x58C9A6Db47c3D0e578013D6f5eA3B7A8E478513f);
    ...
    constructor () {
        ...
        _isExcludedFrommaxTXAmount[uniswapV2Pair] = true;
        _isExcludedFrommaxWalletSize[uniswapV2Pair] = true;
        ...
        _isExcludedFrommaxTXAmount[_developmentAddress] = true;
        ...
        _isExcludedFrommaxWalletSize[_developmentAddress] = true;
        _isExcludedFrommaxWalletSize[_marketingAddress] = true;
    ...
    function setFee(uint256 reflectionFeeOnBuy, uint256 reflectionFeeOnSell, uint256 marketingFeeOnBuy, uint256 marketingFeeOnSell) public onlyOwner {
