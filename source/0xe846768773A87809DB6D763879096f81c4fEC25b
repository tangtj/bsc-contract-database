...
contract JustFun is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xa18764a9057c28A341fdd297B1a991D7e9091C33);
    address payable private _twdmkt = payable(0xa18764a9057c28A341fdd297B1a991D7e9091C33);
    
    string private constant _name = "JUST FUN";
    string private constant _symbol = "JUSTFUN";
