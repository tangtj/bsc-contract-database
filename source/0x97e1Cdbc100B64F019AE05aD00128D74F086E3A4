...
contract FFITOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public uhgfvvb5;
    ...
    string private _tokenname = "FriendFi";
    string private _tokensymbol = "FFI";
