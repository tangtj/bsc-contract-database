...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x83A28475CE5F5680A96FC7BFB12B3991770dB49B; // owner address
...
contract XPenguin is Context, IERC20, Ownable {
    ...
    string private _name = "X-PENGUIN";
    string private _symbol = "xPENGUIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x83A28475CE5F5680A96FC7BFB12B3991770dB49B); // Marketing Address
    address payable private teamWalletAddress = payable(0x83A28475CE5F5680A96FC7BFB12B3991770dB49B); // Team Address
