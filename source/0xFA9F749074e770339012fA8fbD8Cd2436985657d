//
// Fair Launch on BNB Chain for supporters of @elonmusk on X: Up, Down, Strange, Charm, Beauty & Truth
//
// Twitter : https://twitter.com/elonmusk/status/1704667973229703206
//
//
...
contract UDSCBT is Context, IERC20, Ownable {
    ...
    string private constant _name = "UpDownStrangeCharmBeautyTruth";
    string private constant _symbol = "UDSCBT";
    ...
    address payable private _dev = payable(0x64Cd767a6CB320beF42AD43216a1a09CcD7a37cd);
    address payable private _mkt = payable(0x64Cd767a6CB320beF42AD43216a1a09CcD7a37cd);
