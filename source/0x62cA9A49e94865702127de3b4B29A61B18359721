...
contract Vepe is Context, IERC20, Ownable {
    ...
    string private _name = unicode"VEPE";
    string private _symbol = unicode"$VEPE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x7Cf7f6bbA824A7eFAb83E049cD62f19E193247f1);
    address payable private taxWallet2 = payable(0x7Cf7f6bbA824A7eFAb83E049cD62f19E193247f1);
