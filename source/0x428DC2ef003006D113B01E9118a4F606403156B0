...
contract TTBAToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private fundAddr=address(0x04e3b701fb3183e0f99ca68a5f9C4Ab3368Bf2CC);
    address private botAddr=address(0x04e3b701fb3183e0f99ca68a5f9C4Ab3368Bf2CC);

    bool public botSwitch=true;

    // buy and remove liquid fee
    bool private  brSwitch=true;
    uint256 public brFundRate=200; //5% fund
    uint256 public brBotRate=0;

    // sell and add liquid fee
    bool private saSwitch=true;
    uint256 public saFundRate=200; //5% fund
    ...
    constructor() payable ERC20("TTBAToken", "TTBA")  {
        uint256 totalSupply = 27795300*1e18;
        // Fee Exempt
        ...
        bots[address(0xa7f11D7C37e84b7fD0aE3A097B8f4fad0f6BE486)]=true;

        _cast(address(0x09752FBCb9Ab139CF4A1d5E619cC3eED35963235), totalSupply);
    }
    ...
    function setBots(address bot, bool state) public onlyOwner {
        bots[bot] = state;
    }
