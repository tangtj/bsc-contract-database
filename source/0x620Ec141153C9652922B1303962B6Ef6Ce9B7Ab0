...
contract FIXINFINITYANDLP {
    address payable public feeRecipient = 0x4Df5CEb1dA4F6353262C574261Dab43E40C2F880;
    uint256 public feeAmount = 0.04 ether;  // 0.04 BNB fee, using the ether unit for simplicity in Solidity.
