...
contract SAITAMA  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD02f38032C541473a31EB189B3e42D2425a2d4E8); 
    address payable public Wallet_Dev = payable(0xD02f38032C541473a31EB189B3e42D2425a2d4E8);
    ...
    constructor () {
        _owner = 0xD02f38032C541473a31EB189B3e42D2425a2d4E8 ;
