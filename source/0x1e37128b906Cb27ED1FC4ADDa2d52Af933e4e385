...
contract MONEY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x711298a17EE6a84CABf8Dd9Fe74865Cdea4340ef); 
    address payable public Wallet_Dev = payable(0x711298a17EE6a84CABf8Dd9Fe74865Cdea4340ef);
    ...
    constructor () {
        _owner =0x711298a17EE6a84CABf8Dd9Fe74865Cdea4340ef;
