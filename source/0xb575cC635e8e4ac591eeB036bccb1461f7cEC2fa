...
contract TBC is ERC20 {
    ...
    address _marketAddress = address(0x000000000000000000000000000000000000dEaD);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                super._transfer(from, _fundAddress, amount.div(100000).mul(2499));
                super._transfer(from, _marketAddress, amount.div(100000).mul(2499));
                super._transfer(from, address(this), amount.div(100000).mul(2));
