...
contract JuggerNewYear is ERC1155Tradable {
	constructor() public ERC1155Tradable("JuggerNewYear", "JuggerNewYear") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api6/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api6/contract/jgn";
	}
}