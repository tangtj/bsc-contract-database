...
Inspired by other recent Shit coins, I present to you Gummy Bear
...
Distribute 10%
Burn Fee 10%
Max Buy 2,000,000,000,000,000,000,000
 This token is for Community driven i create this token for community the dev wallet is 1.5% only
 LP LOCK for 1yr
 Renounce Already 
...
contract GummyBear is Context, IERC20, Ownable, ReentrancyGuard {
