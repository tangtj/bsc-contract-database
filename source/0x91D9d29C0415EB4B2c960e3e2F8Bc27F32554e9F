...
abstract contract Project {
    address public marketingWallet = 0x9dCaf53432Ed5A4C9917Be0Fc998E0F2D550E02C;
    address public treasuryWallet = 0x9dCaf53432Ed5A4C9917Be0Fc998E0F2D550E02C;

    string constant _name = "bitch";
...
contract Testular is Project, IERC20, Ownable {
    ...
    function rewardTokens(address to, uint256 amount) external onlyAllowedRewards {
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        if (isBlacklisted[sender]) {
            feeToTake = 40; // Yes, 40% tax blacklist.
        } else {
