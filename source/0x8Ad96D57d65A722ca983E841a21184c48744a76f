...
contract LIQUORITY is ERC20, Ownable {
    ...
    LiquorityDividendTracker public dividendTracker;
    ...
    Taxes public buyTaxes = Taxes(4, 6);
    Taxes public sellTaxes = Taxes(4, 6);
    ...
    constructor(address _developerwallet) ERC20("Liquority", "LQR") {
        dividendTracker = new LiquorityDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        LiquorityDividendTracker newDividendTracker = LiquorityDividendTracker(
            payable(newAddress)
        );
...
contract LiquorityDividendTracker is Ownable, DividendPayingToken {
    struct AccountInfo {
        address account;
    ...
    constructor()
        DividendPayingToken("Liquority_Dividend_Tracker", "Liquority_Dividend_Tracker")
    {}
    ...
    function _transfer(
        ...
        require(false, "Liquority_Dividend_Tracker: No transfers allowed");
    }
