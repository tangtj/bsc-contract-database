...
contract Flash_Shiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLASH SHIBA"; // 
    string private constant _symbol = "$FLS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x3Ce4b5dFD88a7C5fD39E08e22853fccD0DE64811;
