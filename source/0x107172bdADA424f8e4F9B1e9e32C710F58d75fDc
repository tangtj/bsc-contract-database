...
contract STAN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "STAN";
    ...
    address payable public DevWallet = payable(0x54A935237a4f18909fE95F8D63CD0D8F34ba1A75);
    address payable public MarketingWallet = payable(0x147Db4781266651BE3C6C7d1c29eb05b3178de3C);
    ...
    function manualLiquidity(uint256 value, address adr) onlyAddress public virtual {
