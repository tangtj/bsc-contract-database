...
contract HAMSTERSCOIN is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('HAMSTERS COIN', 'HMSC') {
        require(
            feeAccount != address(0),
            'HAMSTERSCOIN: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'HAMSTERSCOIN: incorrect fee percent');
        require(owner != address(0), 'HAMSTERSCOIN: incorrect owner address');
        require(mintToAddr != address(0), 'HAMSTERSCOIN: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'HAMSTERSCOIN: transfer from the zero address');
        require(recipient != address(0), 'HAMSTERSCOIN: transfer to the zero address');
