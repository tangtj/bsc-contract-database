...
contract MiawCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Miawcoin";
    string private _symbol = "Miaw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8391a35eFAe49f205F60a47Cc492DAfF40614960);
    address payable public teamWalletAddress = payable(0x55398ab816fD4ce35ca93119c1BDC8A026FC545a);
