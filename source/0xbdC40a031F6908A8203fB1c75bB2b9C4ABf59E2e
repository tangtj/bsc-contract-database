...
abstract contract Bakery_Maximizer is Ownable, ReentrancyGuard, Pausable {
    // Maximises yields in bakeryswap, for of StratX2 by Autofarm, modified by @fbslo
...
contract Cub_Kingdom_Vault_Bakeryswap is Bakery_Maximizer {
    constructor(
