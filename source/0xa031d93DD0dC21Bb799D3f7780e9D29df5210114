...
/**
                   ...
                   oy+.                  ./o+hh.          
                   /Mh++-..--......````-/oss/hN/          
                   .Ny+ssooosoooooooooosssso:hMh`         
                  `:sossssssosssssssssssssss++sh/`        
                .:osssssssssosssssssssssssssso++//.       
             `-+ossyhsossssossssshdhysssssssssso+//:`     
           `:ossydmNNMosso+/sssoNNmddhyossssssssso///.    
          .ossshmmmmmNdo+///++odMmNNMMNhsssssssssso///.   
         `osooddo+hMdNNmhsooshmNNmMNdhdNNhsssssssss+///.  
         -osohNh..:NNNNNNNNNNNNNNdh/:  +mMNhsssssss+///d+ 
         +hdNMMNNNNNmmNNNNNNNNNNNNNh::/hdmMMNdhyyyyyydmNN-
         :MMMMMMNNMMMMMMMMMMMNNNMMMMMMMNMMMMMMMMMMMMNNNNNo
         hMMMMMdNMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNNNNNNo
         MMMMMhNMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNNNNNNN:
         NMMMdNMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNNNNNNNy 
         sMMMyMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNNNNNNNNy` 
         `dMdmMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMNNNNNNNm+`  
          .yyMMMNNNMMMMMMMMMMMMMMMMMmMMMMMMMNNNNNNNd+.    
            .NmysoosydmMMMMMMMMMMNMddMMNmMMNNNNNdy:`      
             +.`````  ./MMMMNNNNMNhdNmddmmmmds+-`         
               `      -sMMMMMNNdyoo/--:/+---`             
                    .sNMMMNNNh+.     .:/oyd/`             
                   `/ooo++/-`      ..-dyo//:              
                                  sMMNm/     
...
abstract contract Tokenomics {
    ...
    uint256 internal constant TOTAL_SUPPLY = 500000000 * ZEROES;
     ...
     * See: `Liquifier`
     */
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 1500; // 0.15% of the total supply

    // --------------------- Fees  ------------------- //

    address internal marketingAddress = 0x44fb6B31080b258E7693eF196e8574CEf87121F1;
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if ( isInPresale ){ takeFee = false; }
            ...
            */
            if ( amount > maxTransactionAmount && !_isUnlimitedSender(sender) && !_isUnlimitedRecipient(recipient) && !_isExcludedFromMaxTx[sender] && !_isExcludedFromMaxTx[recipient]){
...
abstract contract BEPISTOKEN is BaseRfiToken, Liquifier, Antiwhale {
