...
contract BATINU is ERC20, Ownable {
    ...
    constructor () ERC20("Batman Inu", "BATINU") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xD4E1E7078F7d3562f95Ea23320f915Fae5Da93FA;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy <= 8, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(_totalFeesOnSell <= 8, "Total Fees cannot exceed the maximum");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 8, "Wallet to Wallet Transfer Fee cannot exceed the maximum");
