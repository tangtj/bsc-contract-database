// https://t.me/DogeMemoBSC
// https://twitter.com/DogeMemo
// https://dogememo.com/
...
contract MemoDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DogeMemo";
    string private constant _symbol = unicode"DogeMemo";
