...
/*
    ...
    Telegram : https://t.me/NEKOTOSHIPORTAL
...
contract NEKOTOSHI is ERC20, Ownable {
    ...
    constructor() ERC20("NEKOTOSHI", "NEKO") {
        ...
        devWallet = address(0x04C4bBbF2Ad992593C3d71309567b38372D884ab);
