/*
    ...
    Anti-Whale:  1% Max Txn, 3% max wallet
...
contract Ruellia is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ruellia", "Ruellia") {
        ...
        address newOwner = address(0x65349F9FC0442746C2E6793fb6429616505e73C0);
    	...
    	marketingWallet = address(0x65349F9FC0442746C2E6793fb6429616505e73C0);
        ...
        */
        ...
        _mint(newOwner, totalSupply); // 100 Trillion total supply
