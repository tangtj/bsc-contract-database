...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xD7aeE1C9a5FfC930b2c052f27a70eFC6963215A9); // Marketing Address
    address payable public teamWalletAddress = payable(0xD7aeE1C9a5FfC930b2c052f27a70eFC6963215A9); // Team Address
    ...
    function setFarmPools(address _pool, bool ok) public onlyOwner {
    farmPools[_pool] = ok;
}
...
contract PEPIK is BEP20("PEPIK", "PEPIK") {
