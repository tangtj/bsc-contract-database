...
// File: contracts/BaseRewardToken.sol
contract BaseRewardToken is BEP20Capped, Ownable {
    constructor() 
        public
        BEP20("BASE REWARD TOKEN", "BRT")
        BEP20Capped(12000000 * (10 ** 18))
    {
        _mint(_msgSender(), 4000000 * (10 ** 18));
    }
