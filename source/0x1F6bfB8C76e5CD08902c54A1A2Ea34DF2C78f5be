...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0177080c10c5B555De04DB7B14c93f4C692831f; // owner address
...
contract AuxyliumProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Auxylium Protocol";
    string private _symbol = "AXL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc0177080c10c5B555De04DB7B14c93f4C692831f); // Marketing Address
    address payable private teamWalletAddress = payable(0xc0177080c10c5B555De04DB7B14c93f4C692831f); // Team Address
