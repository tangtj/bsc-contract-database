...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x857F9635000a50A9fbCB0B2dFCF1a1C4C5d2F67b;
...
contract LITE is Context, IERC20, Ownable {
    ...
    string private _name = "Literium";
    string private _symbol = "LIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x857F9635000a50A9fbCB0B2dFCF1a1C4C5d2F67b);
    address payable public teamWalletAddress = payable(0x857F9635000a50A9fbCB0B2dFCF1a1C4C5d2F67b);
