...
// Telegram: https://t.me/SoraInu_official
...
contract SOINU is Context, IERC20 { 
    ...
    address payable private Wallet_Dev = payable(0xB3E599FE55995B1a450C3AaAF1f41970bfF027ED);
    ...
    string private constant _symbol = unicode"SOINU"; 
    ...
    constructor () {
        ...
        _owner = 0x8D6fcCEc0616675283ABB2A373F7fbb6f123eF6E;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            _sellFEE = tAmount*_Diamond_f/100;            
