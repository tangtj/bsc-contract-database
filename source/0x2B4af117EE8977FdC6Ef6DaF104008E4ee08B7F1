...
contract NewToken is Context, IBEP20, Ownable{
    ...
    address marketingWalletAddress = 0x4B4698ab6013C4BD3cc885Ff8a14C4e3A1884d04; // market wallet

    address public contractHash = 0xC74924123479783e0Ea8BE4048486a6cf5B27b39; // contract hash
