...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        8888,
        address(0x5F5F9dfa19BFB7915128e77323E11DBFf050f3b0), //fund 1
        address(0x1eD14b27D7cc4bc91B9524a3cB9201505eBeA840), //fund 2 
        address(0x16CEd82EFEF10cd45B16fF63a9cc3774Ac0F6B3A) //receiver 
    ){
    }
}