...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6EC376eE616116EE2F4a9E98a233a001f14E3Cd7; // owner address
...
contract Coin69 is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x6EC376eE616116EE2F4a9E98a233a001f14E3Cd7); // Marketing Address
    address payable private teamWalletAddress = payable(0x6EC376eE616116EE2F4a9E98a233a001f14E3Cd7); // Team Address
    ...
    uint256 public _walletMax = 180 * 10**_decimals;
