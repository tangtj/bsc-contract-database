// https://t.me/XNUSANTARABINANCE
// https://XNUSANTARABINANCE.CO.ID
...
contract XNUSANTARABINANCE is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 279 * 10**6 * 10**9;
    ...
    string private constant _name = "XNUSANTARABINANCE";
    string private constant _symbol = "XNB";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xe643447d0A28297082981c9f18Cccf87a1FA0440);
    address payable private _marketingAddress = payable(0xe643447d0A28297082981c9f18Cccf87a1FA0440);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 5, "Tax cannot be more than 4.");
	    require(taxFeeOnSell < 9, "Tax cannot be more than 8.");
