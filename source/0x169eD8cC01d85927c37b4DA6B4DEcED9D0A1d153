...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90C72d3459DcE08e81A6Cc946b328499858a06c6; // owner address
...
contract ApedNowRichLater is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aped Now Rich Later";
    string private _symbol = "Rich";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x90C72d3459DcE08e81A6Cc946b328499858a06c6); // Marketing Address
    address payable private teamWalletAddress = payable(0x90C72d3459DcE08e81A6Cc946b328499858a06c6); // Team Address
