...
is a reaction to the overall situation in the crypto world. Bad Cexs practices, constant scams, bad tokenomics. Pepe Reborn wants to bring crypto back to good standing. Lets build a new robust community with no regrets!

Web: https://peperebornvip.io
X: https://twitter.com/pepereborn_bsc
TG: https://t.me/pepereborn_official
...
contract PepeReborn is Context, IERC20, Ownable { 
    ...
    string private _name = "Pepe Reborn"; 
    string private _symbol = "PepeReborn";  
