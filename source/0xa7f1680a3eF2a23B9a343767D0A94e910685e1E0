...
contract TEST is ERC20, Ownable {
    ...
    event UpdatedMarketingddress(address indexed newWallet);
    ...
    constructor() ERC20("TEST", "TEST") {
        ...
        jackpotWallet = address(newOwner);
    ...
    function updateBuyFees(uint256 _marketingBuyFee, uint256 _jackpotBuyFee, uint256 _liquidityBuyFee, uint256 _marketingSellFee, uint256 _jackpotSellFee, uint256 _liquiditySellFee) external onlyOwner {
        buyMarketingFee = _marketingBuyFee;
        buyJackpotFee = _jackpotBuyFee;
        buyLiquidityFee = _liquidityBuyFee;
        buyTotalFees = buyMarketingFee + buyJackpotFee + buyLiquidityFee;
        sellMarketingFee = _marketingSellFee;
        sellJackpotFee = _jackpotSellFee;
    ...
    function swapBack() private {
        ...
        tokensForJackpot = balanceOf(address(this));
    }
    ...
    function setMarketingWallet(address _marketingWallet) external onlyOwner {
     ...
     function setJackpotWallet(address _jackpotWallet) external onlyOwner {
        require(_jackpotWallet != address(0), "_jackpotWallet address cannot be 0");
