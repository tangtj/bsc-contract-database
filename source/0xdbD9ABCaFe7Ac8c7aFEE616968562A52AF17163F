...
*/
//https://t.me/PandaRichCoin

// https://pandarichcoin.com/
// PANDA PO COIN (POCOIN) - The most shillable, memeable, ultimate cure for boredom, & the masters of the meme-iverse where meme conservation meets blockchain.
/**
*/
...
contract Pandamonium is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8080000000000 * 10**_decimals;
    //uint256 public _maxTxAmount = 1000000000000000 * 10**18; // 
    uint256 private  SWAP_TOKENS_AT_AMOUNT = 200000000000 * 10**_decimals; //
    string private constant _name = "PANDA PO COIN"; // 
    string private constant _symbol = "POCOIN"; //    
    uint8 private constant _decimals = 18; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xa09cC37E7dE19Ed7883F4435efF1381268F673d8;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function updatemarketingfee(uint256 amount) external onlyOwner {
       _marketingFee = amount * 10**_decimals;
       }

    function updateliquidityFee(uint256 amount) external onlyOwner {
       _liquidityFee = amount * 10**_decimals;
       }
