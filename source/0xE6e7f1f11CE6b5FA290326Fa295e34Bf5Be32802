...
contract X_Elonmask is Context, IERC20, Ownable {
    ...
    string private constant _name = "X-Elonmask";
    string private constant _symbol = "X-Elonmask";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x03D6bcE3f10F374CFb7CEfF54b8a85e1Ff453537);
    address payable private _marketingAddress = payable(0x03D6bcE3f10F374CFb7CEfF54b8a85e1Ff453537);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 20);
	    require(redisFeeOnSell < 20);
	    require(taxFeeOnBuy < 40);
	    require(taxFeeOnSell < 40);
