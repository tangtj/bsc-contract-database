/**
 Website : https://virtualcoin.cash
 Telegram : https://t.me/VirtualCoinGroup
 Twitter : https://twitter.com/VirtualCoinOFC
*/
...
contract VirtualCoin{
    ...
    string private _name = "VirtualCoin";
    string private _symbol = "VIC";
