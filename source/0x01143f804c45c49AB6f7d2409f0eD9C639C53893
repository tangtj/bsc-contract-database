// File: contracts/Contract/Pancakeswap.sol
...
// File: contracts/Contract/MandYoda.sol
...
contract MandYodaToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {

    using SafeERC20 for IERC20;

    uint256 public constant DENOMINATOR=10000;

    uint96 public swapThreshold = 395000*10**18;
    ...
    constructor(address marketing, address team) ERC20("MandYoda Token", "MAND") ERC20Permit("MAND") {
