 ...
 * Telegram Channel - t.me/BonkBuster
 */
interface IERC20 {
    /**
...
contract BonkBuster is Context, IERC20, Ownable {
   ...
   address public _MarketingAddress = 0x06132F4E2ec3d72fD8058551D7747d6C705dD431;
    ...
    string private _name = "BonkBuster";
    string private _symbol = "BOBU";
