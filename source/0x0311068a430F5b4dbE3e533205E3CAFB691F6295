/**
HashDog is a token driven by community,total 5% fees
3% distribution
1% add liquidity
1% burn
everyone has a chance to get rich if you hodl.
HashDog metaverse games will be published in Q1,2022
Stay tuned.
tokenomics:70% P2E,10% Burned,20% LP
*/
...
contract HashDog is Context, IERC20, Ownable {
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     function setBurner(address account) public onlyOwner() {
        burnAddress = account ;
    }
