...
contract Sale_Contract {
    ...
    if (referralCount[msg.sender] >= referralCountThreshold) {
        ...
        uint256 bonusIncrement = levelIncrements.mul(referralBonusRateIncrement).add(3);

        if (levelIncrements >= 1 && levelIncrements <= 3) {
            return _weiAmount.mul(10).div(100); // 10% referral bonus
        } else if (levelIncrements > 3 && levelIncrements <= 6) {
            return _weiAmount.mul(15).div(100); // 15% referral bonus
        } else if (levelIncrements > 6 && levelIncrements <= 9) {
            return _weiAmount.mul(20).div(100); // 20% referral bonus
        } else if (levelIncrements > 9 && levelIncrements <= 12) {
            return _weiAmount.mul(25).div(100); // 25% referral bonus
        } else if (levelIncrements > 12 && levelIncrements <= 15) {
            return _weiAmount.mul(30).div(100); // 30% referral bonus
        } else if (levelIncrements > 15 && levelIncrements <= 18) {
            return _weiAmount.mul(35).div(100); // 35% referral bonus
        } else if (levelIncrements > 18 && levelIncrements <= 21) {
            return _weiAmount.mul(40).div(100); // 40% referral bonus
        } else if (levelIncrements > 21 && levelIncrements <= 24) {
            return _weiAmount.mul(45).div(100); // 45% referral bonus
        } else if (levelIncrements > 24 && levelIncrements <= 27) {
            return _weiAmount.mul(50).div(100); // 50% referral bonus
        } else if (levelIncrements > 27 && levelIncrements <= 30) {
            return _weiAmount.mul(55).div(100); // 55% referral bonus
        } else if (levelIncrements > 30 && levelIncrements <= 33) {
            return _weiAmount.mul(60).div(100); // 60% referral bonus
        } else if (levelIncrements > 33 && levelIncrements <= 36) {
            return _weiAmount.mul(65).div(100); // 65% referral bonus
        } else if (levelIncrements > 36 && levelIncrements <= 39) {
            return _weiAmount.mul(70).div(100); // 70% referral bonus
        } else if (levelIncrements > 39 && levelIncrements <= 42) {
            return _weiAmount.mul(75).div(100); // 75% referral bonus
        } else if (levelIncrements > 42) {
            return _weiAmount.mul(maxReferralBonusRate).div(100); // Maximum referral bonus rate (80%)
        }
