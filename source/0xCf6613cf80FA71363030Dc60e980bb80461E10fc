...
contract EarlyAiToken is Context, EarlyAiIERC20 { 

    address private _owner = 0xEF860AeF36DeD48Dc3878C042F0EdB206b3B26f0; // Deploying wallet
    ...
    // Token Info
    string private  constant _name = "EarlyAi"; 
    string private  constant _symbol = "EarlyAi"; 

    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 420_690_000_000_000 * 10 ** _decimals;
   address private marketingAddress = 0xF977814e90dA44bFA03b6295A0616a897441aceC;
    string public constant EarlyAisite = "https://EarlyAi.com";
    string public constant EarlyAitg = "https://t.me/EarlyAi";
    string public constant EarlyAiaudited = "EarlyAi is audited by: https://www.certik.com/";
    string public constant EarlyAitwitter = "https://twitter.com/EarlyAi";
