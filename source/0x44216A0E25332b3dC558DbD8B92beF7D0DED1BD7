...
// ARRRRRR https://t.me/+sYB5o9wuWFZhMDQ1
...
contract ODIN is Context, IERC20, Ownable {
    ...
    string private _name = "OD1N";
    string private _symbol = "OD1N";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xf6fdD1299590136f37EDD90F25DE3a6af3707792); 
