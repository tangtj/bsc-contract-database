/*
Telegram : https://t.me/eggplantpepe
*/
...
contract eggplantpepe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Egg Plant Pepe";
    string private constant _symbol = unicode"EPP";
