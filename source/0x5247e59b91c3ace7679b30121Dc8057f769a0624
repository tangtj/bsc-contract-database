...
contract SmurfDoge is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Smurfs Doge BSC";
    string private _symbol = unicode"$SMURFSDOGE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xd22c084c8Cd5339286D3dE82Aa93E60251F217aE);
    address payable private taxWallet2 = payable(0xd22c084c8Cd5339286D3dE82Aa93E60251F217aE);
    ...
    uint256 public _buyLiquidityFees = 20;
    uint256 public _buyMarketingFees = 0;
    uint256 public _buyDevelopmentFees = 0;
    uint256 public _sellLiquidityFees = 20;
