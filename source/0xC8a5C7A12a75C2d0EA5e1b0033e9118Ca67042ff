...
contract UBOT is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 3 / 1000; // THRESHOLD: 1 = 0.03%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 2 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xCC4379a2c1d0D8A99F77703400f903D4e548BAab; //

    string private constant _name = "UselessBOT"; //
    string private constant _symbol = "UBOT"; //
