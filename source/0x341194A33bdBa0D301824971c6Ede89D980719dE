/**
https://t.me/ShiaGrowOFFICIALBSC
https://twitter.com/ShiaGrow
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8A871525a01C4cD8584198f92725F602eaEF00A2; // owner address
...
contract SHIAGROW is Context, IERC20, Ownable {
    ...
    string private _name = "SHIA GROW";
    string private _symbol = "$SG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8A871525a01C4cD8584198f92725F602eaEF00A2); // Marketing Address
    address payable private teamWalletAddress = payable(0x8A871525a01C4cD8584198f92725F602eaEF00A2); // Team Address
