...
contract OriginX is Context, IERC20, Ownable{
    ...
    address payable public _marketingWallet = payable(0x751114c4cfEDD0AF2c586170d6b761B71150004E); 
    address payable public _buyBackWallet = payable(0x751114c4cfEDD0AF2c586170d6b761B71150004E); 
    address payable public _lotteryWallet = payable(0xB484eA9f8A28d663aC3A349F05B40E55380C2e2c); 
    address payable public _ecosystemWallet = payable(0x751114c4cfEDD0AF2c586170d6b761B71150004E);  
    ...
    IERC20 public busdToken = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    string private constant _name     = "OriginX";
