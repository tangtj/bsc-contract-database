/*  https://t.me/wsbbep20
    https://twitter.com/wallstreetbetbsc */
...
contract $WallStreetBets is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 12345000 * 10**_decimals;
    uint256 public maxTxAmount = _tTotal * 10**_decimals;
    uint256 public maxWalletAmount = 30000000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x06B99D6C7d5e8235B21575aaa29f7b5C55b053be;
    ...
    // Owner cannot transfer out $WSB from this smart contract
