...
contract test is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x6C00646003246F686900f8382C87C4f8CABC32D1); 
    address payable private _marketingAddress = payable(0xb27aaeC13775eD4401C854A077985f03E4abEeE4);
