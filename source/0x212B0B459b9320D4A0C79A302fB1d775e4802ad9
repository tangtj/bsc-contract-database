// https://t.me/RoyalShibaBSC
// https://twitter.com/RoyalShibaBSC
// https://RoyalShiba.com/
...
contract RoyalShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ROYAL SHIBA";
    string private constant _symbol = unicode"ROYALSHIBA";
