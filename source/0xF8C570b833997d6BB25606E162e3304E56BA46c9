...
X: https://twitter.com/TripperPepeBSC
...
contract TripperPepe is Context, IERC20 {
    string private _name = "TRIPPER PEPE";
    ...
    address payable public MarketingWallet = payable(0x393A841eF4654e07Af23a592b897C9b684E48c22);
