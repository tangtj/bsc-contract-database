...
/**
Telegram https://t.me/jayonverse
Website  https://jayon.org/
Twitter  https://twitter.com/jayonverse
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4422fAF294d0Eaac33527e5f8557E60Eb94609b5; // owner address
...
contract JayoVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JayonVerse";
    string private _symbol = "JYN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71e3A98Ab13FB3582B4bD6856eF0aBFD56e198fF); // Marketing Address
    address payable public teamWalletAddress = payable(0xb2F28Ccc98f7fa169aD0CA3eD70Ad0e03FAE142C); // Team Address
