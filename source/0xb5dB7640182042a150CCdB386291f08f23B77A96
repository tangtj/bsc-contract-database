/**
   ...
   https://realgoldeninu.com
   https://t.me/realgoldeninu
   https://twitter.com/RealGoldenInu
...
contract TheRealGoldenInu is Context, IERC20, Ownable {
    ...
    string private _name = "The Real Golden Inu";
    string private _symbol = "TRGI";
    ...
    address payable public charityAddress = 0x37b835aaEC19FC1aa6082e80580fD2dDDF1261bC; // Charity Address
