/**
   The one and only, the singular, the 
   super special High APY token ITC, man
   it´s like your secret portal.
  TELEGRAM: https://t.me/ITC_BSC
*/
...
contract ITC is Context, IBEP2022, Ownable {
  ...
  constructor() public {
    _name = 'Internet Trillionaire Club';
    _symbol = 'ITC';
    _decimals = 9;
