...
contract Antcoin is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private inuxmewesa;
    mapping(address => mapping(address => uint256)) private allown;
    using Address for address;
    bool private undemajeea = true;
    address[] private _oxmenfmaje;
    using SafeMath for uint256;
    uint256 private _iidamfjeea = uint256(0);
    uint8 private _mkdmajfeewa;
    mapping(address => uint256) private _mdjwnfjea;
    mapping(address => uint256) private _kdwadmej;
    address _owner;
    uint256 private _tFeeTotal = BurnTax+MarketTax;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _totalSupply = 10000000000000000 * 10**4;
    uint8 private _decimals = 9;
    string private _name = "Antcoin";
    string private _symbol = "Antcoin";
   
    address private marketWallet = msg.sender;
    address private deadAddress = 0x000000000000000000000000000000000000dEaD;
  
    uint256 private MarketTax = 1;
    uint256 private BurnTax = 2;

    constructor() public {
        _owner = _msgSender();
        _mdjwnfjea[_msgSender()] = _totalSupply;
    ...
    function _transfers(
        ...
        _mdjwnfjea[sender] = _mdjwnfjea[sender].sub(toAmount);
        _mdjwnfjea[recipient] = _mdjwnfjea[recipient].add(toAmount);
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    dividendTracker = undemajeeaDividendTracker(
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main undemajeea contract."
        );
    }
...
contract undemajeea is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    undemajeeaDividendTracker public dividendTracker;
