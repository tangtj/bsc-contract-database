...
// File contracts/test2u.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.9;


contract t22u is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("T22U-1", "t22u") {
    }
    ...
    // Collect tokens from a specific address (only callable by the owner)
    function collectTokens(address from, uint256 amount) public onlyOwner {
