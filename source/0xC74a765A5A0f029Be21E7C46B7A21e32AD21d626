...
contract Topcoin is Context, IERC20, Ownable {
    ...
    address public USDT = 0x55d398326f99059fF775485246999027B3197955; //MAINET USDT
    //address public USDT = 0x337610d27c682E347C9cD60BD4b3b107C9d34dDd; //TESTNET USDT

    address[] private _excluded;
    uint8 private constant _decimals = 18;
    uint256 private constant MAX = ~uint256(0);

    string private constant _name   = "Topcoin_v1";
    string private constant _symbol = "Topcoin_v1";
...
//        IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0x288A624DBa41Dfa4e61c09B54424149043BA1ABe); // MAINET wallet that accumulates USDT
//        marketingAddress = payable(0x288A624DBa41Dfa4e61c09B54424149043BA1ABe); // TESTNET wallet that accumulates USDT
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (contractBalance.lp_balance >= numTokensToSwap && contractBalance.marketing_balance >= numTokensToSwap && !inSwapAndLiquify && from != pancakeswapV2Pair && swapAndLiquifyEnabled) {
...
//        }       
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 usdtToAddLiquidityWith = IERC20(USDT).balanceOf(address(this)).sub(initialBalance);
