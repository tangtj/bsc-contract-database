...
contract PepeTheBoss is Context, IERC20 {
    string private _name = "PEPE THE BOSS";
    string private _symbol = "PBOSS";
    ...
    address payable public MarketingWallet = payable(0x4b7606d8b0F989b29bDff75459bB52C8af05750c);
