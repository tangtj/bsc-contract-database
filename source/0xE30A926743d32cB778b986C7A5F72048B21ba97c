/**
 Hey yoo... Just Fun this launch.
Lp burnt and renounce
Inıtıal lp just 0.01 bnb 
No max tax 5
Join the fun :)
*/

//https://t.me/whenmarketingsirbsc
...
contract WhenMarketingSir is Context, IERC20, Ownable {
    ...
    string private constant _name = "WHEN MARKETING SIR";
    string private constant _symbol = "WMS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x18388F7925b153dF65F8fd03f9E920Ff9Bc709F5);
    address payable private _marketingAddress = payable(0x18388F7925b153dF65F8fd03f9E920Ff9Bc709F5);
