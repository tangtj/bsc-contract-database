...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6B7a00e5dAeF763fc59922D44f177c33698427E1; // owner address
...
contract BNBAlpha is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB Alpha";
    string private _symbol = "$ALP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B7a00e5dAeF763fc59922D44f177c33698427E1); // Marketing Address
    address payable public teamWalletAddress = payable(0x6B7a00e5dAeF763fc59922D44f177c33698427E1); // Team Address
