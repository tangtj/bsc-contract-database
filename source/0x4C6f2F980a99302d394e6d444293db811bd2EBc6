...
 * Hello BSC Community
 *
 * TG: https://t.me/ivorycoinnft 
 *
 *
 * More than just a #PlayToEarn game, #Ivory Insights's shared vision is #P2E empire where users have many earning options.

In a market of fierce competition and rapid turnover, we choose the path of sustainable growth, bringing profits to loyal users over the years.
—————————————-
 *
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6b1301Af16Bae96197cd7dEAF32013ed8C517fbd;
...
contract IVORYCOIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x034B47761aAffc3ff87f9C22003c2feD5e14c01D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "IVORY COIN";
