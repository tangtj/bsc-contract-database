...
contract GreenLifeEnergy is IERC20 {
    ...
    string constant private _name = "Green Life Energy";
    string constant private _symbol = "GLE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        tokens: 0xF565985c95895Bd9A5707129C409647Ac6B2ED98,
        swap: payable(0x56cb67C8cf09DD114Cd48A4C0ED1697aE8676fa6)
        });
