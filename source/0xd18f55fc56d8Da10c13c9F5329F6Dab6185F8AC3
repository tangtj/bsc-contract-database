...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3538837dbD3Cc58E4f34C7c6bC9E1df803b762EE; // owner address
...
contract Xepe is Context, IERC20, Ownable {
    ...
    string private _name = "Xepe";
    string private _symbol = "XEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x79Dcf991264F7a62c6Aa49d163dadB80B59972F3); // Marketing Address
    address payable private teamWalletAddress = payable(0x79Dcf991264F7a62c6Aa49d163dadB80B59972F3); // Team Address
