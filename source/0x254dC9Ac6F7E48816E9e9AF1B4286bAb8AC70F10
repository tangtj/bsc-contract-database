...
contract Toshi is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x10E660f3992E68888A956faeeDC1dE7a5a8B49F8);
    address payable private _marketingAddress = payable(0x10E660f3992E68888A956faeeDC1dE7a5a8B49F8);
