...
contract MegaPepa is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Mega Pepe";
    string private constant _symbol = "MGPP";
    ...
    mapping(address => bool) public bots; mapping (address => uint256) public _addrRewards;
