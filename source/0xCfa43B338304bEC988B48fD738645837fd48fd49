...
contract $BSC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 24e15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 48_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 24_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 24_000_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 24_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x59A5e110c543F28318FC4Dfb3D4F8fb703054523;
    address public devAddress = 0xe8765145ADBcBE9fB0432CEcB08181f5530ef862;

    string private constant _name = "BSC INU";
    ...
    // Owner cannot transfer out $BSC from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out $BSC!");
