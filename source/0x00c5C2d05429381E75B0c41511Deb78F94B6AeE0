...
/**
 TELEGRAM: https://t.me/bnbxchannel
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract BNBRewardToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BNBRewardToken";
