...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe8ac812A0df54C1FA9c3B50629e8cDF5c09751aD; // owner address
...
contract BABYCCCD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYCCCD";
    string private _symbol = "BABYCCCD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe8ac812A0df54C1FA9c3B50629e8cDF5c09751aD); // Marketing Address
    address payable private teamWalletAddress = payable(0xe8ac812A0df54C1FA9c3B50629e8cDF5c09751aD); // Team Address
