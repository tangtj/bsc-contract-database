...
contract JB is Token {
    constructor() ERC20(
        "JB",   // 名字
        "JB"   // 符号
    ) {
        uint256 _totalSupply = 3888 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x71376623cb46aE53574ccE66771B62C615B7285E); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xDfE432637d769AB6B0979BfE037ba9031Ece9C36)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x695032E4f0992D92E2388C5e0F8851E6edb87657);
        feeEarn = 0;
        isLiquified = true;
    }
}