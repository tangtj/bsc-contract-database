...
contract Dogezilla is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 5900000000000000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =5900000000000000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 5900000000000000000000000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3a75cc31215b41153DF1DBd6f62D6090F2F20016));
        marketingWalletAddress = payable(address(0x3a75cc31215b41153DF1DBd6f62D6090F2F20016));
