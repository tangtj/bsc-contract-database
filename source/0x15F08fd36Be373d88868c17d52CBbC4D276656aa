...
contract GAC is ERC20, Ownable {
    ...
    constructor() ERC20("GAC", "GAC") {
        address recieve = 0x9D0c5b61783E9b03ABab6A42f91b12a13C508D90;
        manager = 0x9D0c5b61783E9b03ABab6A42f91b12a13C508D90;
        market = 0xeF1E93111546d35e77a5e1C10e87443E3c58EC8e;
        ...
        _mint(recieve, 999_9999 * 10 ** decimals());
    }
    ...
    function _transfer(
        ...
        if (_inSwapAndLiquify || isFeeExempt[from] || isFeeExempt[to]) {
            ...
            uint256 every = amount.div(100);
            if (super._burnSafe(from, every * 3)) {
                super._transfer(from, to, amount - every * 3);
            } else {
                super._transfer(from, to, amount - every);
            }
        } else {
