...
🔥Hot Rise🔥 Rebase With LuckyBlock Rewards
☞Fair Launchh
☞ LOCK LP FOR 1 Year At Team Finance TrustSwap
☞Renounce OwnerShip
☞TG Group https://t.me/HotRiseUp 
☞5% Lucky Block Token Rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20BINANCE RWRD = IBEP20BINANCE(0x2cD96e8C3FF6b5E01169F6E3b61D28204E7810Bb);
...
contract HOTRISEUP is IBEP20BINANCE, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HOT RISE";
    string constant _symbol = "HOT RISE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2aBD6e048dE58CA7dc3E7A737b6abe15C61e7801;
        devFeeReceiver = 0xa8E26eb7cD68C861734Bd6a065a745E3Db59183f;
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public onlyOwner returns (bool success) {
        return IBEP20BINANCE(tokenAddress).transfer(msg.sender, tokens);
    }
