...
contract GameTest is ERC20, Ownable { 
    ...
    constructor() ERC20("GameTest", "GTA") { 
        ...
        _gameContract = 0xd8378d3615E9b5848C45b91E42214A715fb146d1;
    ...
    function createPaidAndAddLiqudity(uint256 tokenAmount) external  onlyOwner {
    ...
    function setMarketingWallet(address wallet) external onlyOwner {
      ...
      function setGameContract(address ca) external onlyOwner {
        _gameContract = ca;
    }
