...
contract POOTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "PooMoji";
    string private _seitokensymbol = "POO";
    address public esaaju8;
