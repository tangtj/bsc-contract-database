...
contract TEST12 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TEST 12";
    string private constant _symbol = unicode"TEST12";
    ...
    constructor () {
        _taxWallet = payable(0x506Fe4b1ED895041a58186940844cE0517986d6A);
