...
contract Zhouxinchi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "zhouxingchi";
    string private _symbol = "zhouxingchi";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x370acBdb2C186E7A3aCeEE06AB939EF9Db57094B); // Marketing Address
    address payable private teamWalletAddress = payable(0x370acBdb2C186E7A3aCeEE06AB939EF9Db57094B); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000 * 3 **_decimals; 
