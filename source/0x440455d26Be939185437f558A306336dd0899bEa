...
contract XDswap is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'XDswap';
    string private constant _symbol = 'XDT';
    ...
    address internal constant development_receiver = 0x6EaE8E99Dd86F189Fd8998EAC937a9B485ab6e32; 
    address internal constant marketing_receiver = 0x600Cc65fDbD4098b6064705b56237A7442C07e4A;
    address internal constant liquidity_receiver = 0x7a4aDF548Ef789185E4c89456A2A57ff5e1d5961;
