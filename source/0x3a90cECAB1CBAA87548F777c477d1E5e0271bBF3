/**
This is purely a test for a dapp we are building, liquidity will be added and locked 
amd you can buy and sell as you do on any other token.

for more details telegram link is below

https://t.me/pukkalabs
*/
...
contract  Pukkalabs  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Pukka Labs';
    string private constant _symbol = 'PUKKA';
    ...
    address internal constant development_receiver = 0x1938b3C4d8Ad5b495089d386cBe02d1E164617Ce; 
    address internal constant marketing_receiver = 0x16a915d3E5a9Ed2E80604d3c93eCC0a6102A7c1B;
    address internal constant liquidity_receiver = 0x1938b3C4d8Ad5b495089d386cBe02d1E164617Ce;
