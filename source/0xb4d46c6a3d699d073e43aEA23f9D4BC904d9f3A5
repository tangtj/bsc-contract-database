...
contract FukuShibba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FukuShibba";
    string private _symbol = "FUKU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xF9267aa1f34DA3404208f77D0B289b4470310832);
    address payable public teamWalletAddress =
        payable(0x4361D24Ab3cE194804cb8c61594fA223160d16DA);
