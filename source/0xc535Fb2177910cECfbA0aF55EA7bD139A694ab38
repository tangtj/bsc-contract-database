...
contract SUC is ERC20 {
	...
	address _fundAddress = address(0xD46c79c4cf9CF5d0341d2bFC944362af188C6fA0);
    ...
    constructor(address tokenOwner) ERC20("PIGSY", "PIGSY") {
        ...
        nft = NftWarp(0x66188be47412A8022F6A9Edd73E34d64528D9C51);//Nft Contract
    }
