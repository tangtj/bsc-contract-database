...
contract Sakura  is ERC20, Ownable {
    ...
    constructor() ERC20("Sakura", "Sakura") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 0/4
        ...
        marketingWallet = address(0x71Ba6c266924b985cE6fd75f575808A943bd3E52); // set as marketing wallet
        devWallet = address(0x71Ba6c266924b985cE6fd75f575808A943bd3E52); // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees.div(feeDenominator) <= 0, "Must keep fees at 0% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees.div(feeDenominator) <= 4, "Must keep fees at 4% or less");
    }
