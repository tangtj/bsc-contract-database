    ...
    AccessControlUpgradeable
{
    ...
    uint256 public constant MAX_FEE = 20_00;
    ...
    event OrderSold(address indexed buyer, uint256 orderId, Order orderModel); // order is bought
    ...
    function initialize(
        ...
        setBuyBackAddress(_buybackAddress);
    ...
    function setBuyBackPercent(uint256 _newPercent)
        external
    ...
    function setBuyBackAddress(address _buybackAddress)
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        buyback = _buybackAddress;

        emit SetTreasuryAddress(buyback);
    }
        ...
        onlyWhitelistedNFT(_nftAddress)
    {
        ...
        emit OrderCreated(_msgSender(), newOrderId, orders[newOrderId]);
    }
    ...
    function cancelSellingOrder(uint256 _orderId) external whenNotPaused {
        ...
        emit OrderCancelled(_msgSender(), _orderId, orders[_orderId]);
    }
    ...
    function buyNFT(uint256 _orderId) external whenNotPaused {
        ...
        uint256 feeBuyback = tradingFee.mul(buybackPercent).div(10000);
        uint256 feeTreasury = tradingFee.sub(feeBuyback);
        ...
        emit OrderSold(_msgSender(), _orderId, orders[_orderId]);
    }
