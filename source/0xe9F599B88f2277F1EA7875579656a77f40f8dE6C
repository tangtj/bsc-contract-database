...
contract Token is ERC20, ERC20Burnable, ERC20Permit, Ownable, ContractGuard {
    address public initialOwner;
    bool public rewarded = false;

    constructor(address owner) ERC20("Jake Paul", "JakePaul") ERC20Permit("Jake Paul") {
        initialOwner = owner;
        _mint(_msgSender(), 10000000000 * 10 ** decimals());
    }

    function _transfer(address from, address to, uint256 amount) internal virtual override onlyOneBlock(from, to) {
