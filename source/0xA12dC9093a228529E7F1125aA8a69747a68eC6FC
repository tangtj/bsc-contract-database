...
contract BuyBotPro is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xa8640C72BAAb77168f754e7838C871d5eFdA1A9f;

    string private constant _name = "BuyBot Pro";
    ...
    // Owner cannot transfer out  DogeElonTwitterX from this smart contract
