...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"DogeKing",//Name
        unicode"DogeKing",//Symbol
        9,//Decimals
        10000000000000000,//Supply
        address(0x61589F0335dFc3E399858e7044051CE0fbA13aD2),//FundAddress
        address(0x61589F0335dFc3E399858e7044051CE0fbA13aD2)//ReceiveAddress
    ){
    }
}