...
//https://t.me/toadettecoin
//https://twitter.com/Toadettecoin
...
contract ToadetteCoin  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x842Ac8542bd20F80c69959383c41414D81a89757); 
    address payable public Wallet_Dev = payable(0x842Ac8542bd20F80c69959383c41414D81a89757);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =50 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "Toadette Coin"; 
    string private constant _symbol = unicode"$TOADETTE"; 
    ...
    constructor () {
        _owner =0x842Ac8542bd20F80c69959383c41414D81a89757;
