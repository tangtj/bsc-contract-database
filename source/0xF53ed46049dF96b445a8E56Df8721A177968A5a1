...
//Telegram : https://t.me/memedork
//Twitter : https://twitter.com/MEMEDORKTOKEN
...
contract MemeDork is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb2741Cd2Fe38A3BC7E38669D9a941B73EC8dB35C); 
    address payable private Wallet_Dev = payable(0x3409FBcFe31e4e7e6b1cA76853459EC5f73D01aC);
    ...
    string private constant _name = "MEME DORK"; 
    string private constant _symbol = unicode"$MᗪOᖇK"; 
    ...
    constructor () {
        ...
        _owner = 0x3409FBcFe31e4e7e6b1cA76853459EC5f73D01aC;
