// https://t.me/EberronEBR13
// https://twitter.com/Eberron_EBR13
// https://www.eberron.io/
...
contract Eberron is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Eberron";
    string private constant _symbol = unicode"EBR13";
