...
TOKEN: HarryPotterAlien51ElonXBarbie
TICKER: X

TELEGRAM: https://t.me/HarryPotterAlien51ElonXBarbie
...
contract HarryPotterAlien51ElonXBarbie is ERC20, Ownable {
    ...
    constructor() ERC20("HarryPotterAlien51ElonXBarbie", "X") {
        ...
        devWallet = address(0xb95edCC052aD22b090c74316B436e7B4c67BDcDa) ; 
