...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49FB5c22C14b0DE79C961406D218b4a5aFd6904b; // owner address
...
contract Token8899 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "8899";
    string private _symbol = "8899";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x49FB5c22C14b0DE79C961406D218b4a5aFd6904b); // Marketing Address
    address payable private teamWalletAddress = payable(0x49FB5c22C14b0DE79C961406D218b4a5aFd6904b); // Team Address
