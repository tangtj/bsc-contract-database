...
contract GainersCalls is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 25 * 10**9 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**_decimals;
    string private constant _name = "Gainers Calls";
