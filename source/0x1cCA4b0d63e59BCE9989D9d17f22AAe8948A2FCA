...
contract BlockEarner is Operator {
    ...
    string private _name = "BlockEarner";//#币名
    string private _symbol = "BlockEarner";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x2750DE4B111eB1Fd6E33c9CEB52F313c2D187C6e),true);
    }
