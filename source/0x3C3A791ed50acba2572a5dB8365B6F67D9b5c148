...
contract BabyTitan is IERC20, Ownable {
    ...
    string constant _name = "BabyTitan";
    string constant _symbol = "BABYTITAN";
    ...
    address payable private _marketingWallet = payable(0x988Dbf73D2446542B87C3b8643BEa65Ea12Fd67D);
