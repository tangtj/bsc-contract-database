...
contract XBONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XBONK";
    string private _symbol = "XBK";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xB6888E7FB9a60d4eE1Ad7DFc45f2D14e949cc261); // Marketing Address
    address payable public teamWalletAddress = payable(0xB6888E7FB9a60d4eE1Ad7DFc45f2D14e949cc261); // Team Address
