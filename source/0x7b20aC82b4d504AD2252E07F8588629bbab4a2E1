...
contract Booge is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Booge";
    string constant _symbol = "$Booge";
    ...
    address public devFeeReceiver = 0x1Fef775F5a9a75BeEfc04E48196C8e468f766A54;
    address public buybackFeeReceiver =0x1Fef775F5a9a75BeEfc04E48196C8e468f766A54;
