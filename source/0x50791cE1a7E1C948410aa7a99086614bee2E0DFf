...
contract StationX is ERC20, ERC20Burnable, Pausable, Ownable {
    using SafeMath for uint256;
    uint256 private _maxCap = 500000000 * 10**decimals();
    ...
    constructor( address _feeWallet) ERC20("Station X", "STX") {
