...
contract gameC is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;
    Counters.Counter private _tokenIdCounter;

    string private _baseTokenURI = "https://ipfs.io/ipfs/bafybeifyieluokq6ogdhjfceegzggzo6mjb3gnmveu5g23bv2bbznbk7wq/";
    ...
    address public constant TOKEN_ADDRESS = 0x0d166f32A921b1F2F2338A3dD9f24e7b6D84c929; // Replace with your token's address
    mapping(uint256 => uint256) public claimedTokenAmount; // Amount of ERC20 tokens claimed by each NFT

    constructor() ERC721("cuws", "cuws") {}
