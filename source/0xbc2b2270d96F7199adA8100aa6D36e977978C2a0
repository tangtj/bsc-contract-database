...
interface IDEXRouter {
 ...
 contract Ryoshi2049  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Ryoshi2049";
    string constant _symbol = "RYI2049";
    ...
    address public devFeeReceiver = 0x0A8CF7db127394de66b111694CEd9927Ff56795a;
    address public buybackFeeReceiver = 0x0A8CF7db127394de66b111694CEd9927Ff56795a;
