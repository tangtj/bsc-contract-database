/**
 Join the pack with the links below

 Telegram: https://t.me/Alphacommunity1
 Twitter: https://twitter.com/alphacoin_
*/
...
contract AlphaCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3aa0471B5A7abA02C0F83207785E9F0De2DECD20);
    address payable public Wallet_Dev = payable(0x3aa0471B5A7abA02C0F83207785E9F0De2DECD20);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000 * 10**4* 10**0 * 10**_decimals;
    ...
    constructor  () {
      ...
      function upateFees(uint256 _taxOnBuy, uint256 _taxOnSell, uint256 _percentMarketing, uint256 _percentDev, uint256 _percentBurn, uint256 _percentAutoLp) external onlyOwner{
         _Tax_On_Buy = _taxOnBuy;
         _Tax_On_Sell = _taxOnSell;
         Percent_Marketing = _percentMarketing;
         Percent_Dev = _percentDev;
         Percent_Burn = _percentBurn;
         Percent_AutoLP = _percentAutoLp;
    } 
     

     function updateMaxWallet(uint256 _newMaxWallet) public{
         _previousMaxWalletToken = _maxWalletToken;
         _maxWalletToken = _tTotal * _newMaxWallet / 100;
     }

     function updateMaxTx(uint256 _newMaxTx) public{
         _previousMaxTxAmount = _maxTxAmount;
         _maxTxAmount = _tTotal * _newMaxTx / 100;
     }
