...
contract MinpitKyushu is DateTime,Ownable,AccessControl{
    ...
    constructor() Ownable(){
        ...
        _collect = 0xBa64cb9eF088667780F9Bce21620a4aCB859c314;

        _price_usdt = 1000000000000000000;
        _token_re = 750;
        _multiple = 2;
        ...
        _statics = 20000000000000000;
        _dynamic = 5000000000000000;
        _expand = 10000000000000000;

        _mayorAddr = 0xBa64cb9eF088667780F9Bce21620a4aCB859c314;
        _operateAddr = 0x7812BC346d248a602919B5ADDe6b75345AD2f4A0;
        _terminalAddr = 0x93ED298704f18C5880954c761922b85914840330;
    ...
    */
    ...
    function swapExactTokensForTokens(uint amountIn) public {
        ...
        IERC20(_usdt).transferFrom(msg.sender, address(this), amountIn);
        address[] memory path = new address[](2);
        path[0] = _usdt;
        path[1] = _token; // returns address of Wrapped Ether
        IERC20(_usdt).approve(address(uniswap), amountIn);
        uint256 c = tryDiv(amountIn * 60,100);
