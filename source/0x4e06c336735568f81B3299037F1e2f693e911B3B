...
library Address{
 ...
 contract Pondox is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 256000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 100_000 * 10**9;
    uint256 public maxBuyLimit = 5_120_000 * 10**9;
    uint256 public maxSellLimit = 5_120_000 * 10**9;
    uint256 public maxWalletLimit = 5_120_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xc5b4Caf4EEa1dbcB0B3864a35F24e4abf87a1f4D;
    address public donationWallet = 0xc5b4Caf4EEa1dbcB0B3864a35F24e4abf87a1f4D;

    string private constant _name = "Pondox";
    string private constant _symbol = "PNDC";
    ...
    Taxes public taxes = Taxes(0, 5, 5, 2);
    Taxes public sellTaxes = Taxes(0, 5, 5, 2);
