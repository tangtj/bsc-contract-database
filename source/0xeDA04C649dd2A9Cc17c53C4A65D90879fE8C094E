/**
https://t.me/PepitobscofficialBEP20
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2c24b92b76C6B120bC6043f945B4778e1b4852eb; // owner address
...
contract PEPITO is Context, IERC20, Ownable {
    ...
    string private _name = "PEPITO";
    string private _symbol = "$PEPITO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2257Af4f28eC49872b712B92C2E018355fBaB87C); // Marketing Address
    address payable private teamWalletAddress = payable(0x2c24b92b76C6B120bC6043f945B4778e1b4852eb); // Team Address
