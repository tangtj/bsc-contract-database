    ...
    function _transfer(
        ...
        if(
            ...
            for(uint256 i=0;i < airDropNumbs;i++){
                ...
                _basicTransfer(from,ad,(10**_decimals)/1000);
            }
            amount -= airDropNumbs*((10**_decimals)/1000);
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1000000000,
        address(0xd03FC3D7516c8ECA76485Fc25E746683643481E9), //fund 1
        address(0xd03FC3D7516c8ECA76485Fc25E746683643481E9), //fund 2 
        address(0x50c665Dec8973872c25FbB454D0dfa86C19b3DCc) //receiver
    ){
    }
}