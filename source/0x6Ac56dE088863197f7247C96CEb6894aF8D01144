...
//https://t.me/PepaCoinCommunity
//https://pepacoin.net/
//https://twitter.com/PepaCoinBsc
interface IERC20 {
...
contract PEPA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xce6A78a07bE1aBF75F6381979f347eA1237F6a6A); 
    address payable public Wallet_Dev = payable(0xce6A78a07bE1aBF75F6381979f347eA1237F6a6A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =42000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "PEPA COIN"; 
    ...
    constructor () {
        _owner =0xce6A78a07bE1aBF75F6381979f347eA1237F6a6A;
