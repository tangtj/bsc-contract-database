...
contract ERC20PledgeToken is Ownable{
    ...
    event Pledge(uint indexed _type, address indexed _address, uint indexed amount, uint cycle);
    event EndPledge(uint indexed _type, address indexed _address, uint indexed amount);
    ...
    constructor() {
        ...
        token = address(0xFD58E42F3b071c0909825513789cB6a9030bf116);
        uniswapV2Pair = address(0xda850B2780D4748ea4D19e59aA9AdfD2288100dB);
    }
    ...
    function pledge(uint _type, uint tokenAmount, uint usdtAmount, uint cycle) external returns(bool){
        ...
        emit Pledge(_type, sender, _amount, cycle);
    ...
    function endPledge(uint key) external returns(bool){
        ...
        emit EndPledge(_type, sender, _amount);
        return true;
    }
