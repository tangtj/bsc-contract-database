...
library Address{
 ...
 contract  SLOWMOONINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7A28279820f36d7E464A2b0ccA00bc3e393fbc7f;
    address public donationWallet =0x7A28279820f36d7E464A2b0ccA00bc3e393fbc7f ;
    string private constant _name = "SLOWMOON INU ";
