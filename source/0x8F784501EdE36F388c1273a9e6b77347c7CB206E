...
contract FroggyPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FROGGY PEPE";
    string private _symbol = "FROGGY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdcf18a38Db73C724d53541057605693D061424e9); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xf7c11a62Ad3aafFf26FBD1B0333c8f6e8D78F006); // Development Address
    ...
    uint256 public _walletMax = 8 * 10**9 * 10**9;
