...
contract ElonKittyTheNewElonPet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1a57042776E4475741939a92eC60199177D6050d); 
    ...
    string private _name = "ELON KITTY";
    string private _symbol = "$EKITTY";
    ...
    uint256 private buyBackUpperLimit = 10000000000 * 10**18;
