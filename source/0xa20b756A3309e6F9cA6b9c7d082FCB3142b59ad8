...
contract Elontweet031422 is IERC20, Ownable {
    ...
    string _name = "I SUPPORT THE CURRENT THING";
    string _symbol = "ITCT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);  
    uint256 public _transferLimit = (_totalSupply * 5) / 100;  
