...
contract MBP_NEXA_T3_IDO is Context, Ownable {
    ...
    uint256 private MINIMUM_INVESTMENT = 37 * (10**18);
    uint256 private MAXIMUM_BUY_AMOUNT = 74 * (10**18);
    ...
    uint256 private HARDCAP = 3_404 * (10**18);
