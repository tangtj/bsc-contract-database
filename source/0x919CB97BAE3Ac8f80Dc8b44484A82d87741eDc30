...
contract MafiaPepe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2BB32b223764CdB8FA38C225B57ACF8Fc7b15802); 
    address payable public Wallet_Dev = payable(0x0D2DfD72fD0955522e471EF1e04ECe202e4118eb);
    ...
    string private constant _name = "Mafia Pepe"; 
    ...
    constructor () {
        ...
        _owner = 0x0D2DfD72fD0955522e471EF1e04ECe202e4118eb;
