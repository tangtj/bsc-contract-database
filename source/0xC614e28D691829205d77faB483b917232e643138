...
//https://t.me/DuckCoinBSCcommunity
//https://duckcoin.community
//https://twitter.com/DuckCoin1000x
interface IERC20 {
...
contract DUCK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4C3EBC12BA29B2D5164a71aFd6276C565975aD4F); 
    address payable public Wallet_Dev = payable(0x4C3EBC12BA29B2D5164a71aFd6276C565975aD4F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner =0x4C3EBC12BA29B2D5164a71aFd6276C565975aD4F;
