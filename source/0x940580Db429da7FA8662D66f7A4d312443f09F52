...
contract Solalgo is ERC20, Ownable {
    ...
    address public marketingWallet = 0x58dB14A8247B4bFa88293a2A989BC824a1e3701f;
    ...
    constructor() ERC20("Solalgo", "SLGO") 
    {
        address newOwner = 0xF9e2D0ba5d8c6f95B2883C905DeF0FE91ba328E7;
        ...
        maxWalletAmount       = 100_000 * (10 ** decimals());

        maxTransactionLimitEnabled = true;
        maxTransactionAmountBuy    = 100_000 * (10 ** decimals());
        maxTransactionAmountSell   = 100_000 * (10 ** decimals());
    ...
    function mint(address account, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= 1_000_000_000 * 10**18, "Total supply can not exceed 1B");
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _rewardFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy + _rewardFeeOnBuy <= 10,
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _rewardFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell + _rewardFeeOnSell <= 10,
            "Fees must be less than 10%"
        );
