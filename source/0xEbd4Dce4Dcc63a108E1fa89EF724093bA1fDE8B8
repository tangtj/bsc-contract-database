//Contract made by https://t.me/imtheadmin
...
contract XMM is ERC20, Ownable {
    ...
    //Wallets
    address public marketingWallet = 0x60C343c4282A784E0eeA5EF8d80e07d8Ffc47Ee1;
    ...
    constructor() ERC20("X-MarketMaker", "XMM") {
        address newOwner = 0x183c838a5cb6d338BADe2421C1FD596691A636E7;
    ...
    function setSwapTokensAtAmount(uint256 _newAmount) external onlyOwner {
        require(
            _newAmount > 0 && _newAmount <= (_totalSupply * 2) / 100,
    ...
    function internalSwap(uint256 amountTokens) internal {
        ...
        swapToETHAndSendToMarketing(amountTokens);
    }

    function swapToETHAndSendToMarketing(uint256 _amount) internal {
    ...
    function withdrawStuckTokens(address BEP20_token) external onlyOwner {
        IERC20(BEP20_token).transfer(msg.sender, IERC20(BEP20_token).balanceOf(address(this)));
    }
