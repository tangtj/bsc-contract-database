...
contract BridgeToken is Context, IERC20, Ownable, MinterRole {
    ...
    */
    ...
    event ConvertToNative(uint256 amount, string nativeAddress);
    ...
    function convertTokenWithTransfer(uint256 amount, string memory nativeAddress) public {
        _transfer(_msgSender(), coldWallet, amount);
       emit ConvertToNative(amount, nativeAddress);
     }
    ...
    function convertTokenFromWithTransfer(
        ...
        transferFrom(sender, coldWallet, amount);
        emit ConvertToNative(amount, nativeAddress);
    }
