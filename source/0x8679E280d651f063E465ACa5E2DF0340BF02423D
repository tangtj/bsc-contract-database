...
contract ShibaReflections is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Shiba Reflections";
    string constant _symbol = "$ShibaReflections";
    ...
    uint256 public rewardsFee = 5;//SHIB
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xc084d2eA5BE1a2CFcbCA350EEF27487b2FE3aB8B;
        marketingWallet = 0xc084d2eA5BE1a2CFcbCA350EEF27487b2FE3aB8B;
        devWallet = 0xc084d2eA5BE1a2CFcbCA350EEF27487b2FE3aB8B;
