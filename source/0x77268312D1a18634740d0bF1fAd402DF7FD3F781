/*
🥋Shimazu Ninja 🥋 the new top meme token created for true holders and believers of crypto with an autoburn system ready to pump up the price to ATH , everyone is assured a gain by holding,  get in the team is already pushing hard ! Huge Marketing and partnerships also trending coming at launch
...
✅Slippage: 12%
✅Buy back Mechanism 
✅20% supply burnt to dead address
Tg:  t.me/shimazuninja
*/
...
contract ShimazuNinja is Context, IERC20 {
    string private _name = "Shimazu Ninja";
    ...
    address payable public MarketingWallet = payable(0xDe9298736cce72252A2C0307E3bEF50ea32D188A);
