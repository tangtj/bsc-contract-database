        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x1a020F9d3Cd3E963E9C275510644Cdd1f67c786D), block.timestamp
                );
            }
        }
    }
...
contract XWcoin is AbsToken {
    constructor() AbsToken(
        ...
        address(0x1a020F9d3Cd3E963E9C275510644Cdd1f67c786D)//ReceiveAddress
    ){
    }
}