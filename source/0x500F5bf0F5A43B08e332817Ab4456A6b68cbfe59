...
Telegram : https://t.me/planebotcommunity
Website : https://planebot.tech/
*/
...
contract PlaneBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Plane Bot";
    string private _symbol = "PLANE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9481e5e7da718467eFE1F84452b2319C364e415C);
    address payable public teamWalletAddress = payable(0x4f25456CbCd9943512053bae5d458629059aBB6e);
