...
contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xB7c937ba56D90bC2584C1C4dce5dDe483DAC3C96;
    }
...
contract MoonHusky is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "MoonHusky";
    string private constant _symbol   = "MOONHSKY";
    uint8  private constant _decimals = 8;
    uint256 public _taxFee       = 0; // 0% of every transaction is taxed
    uint256 public _burnFee      = 0; // 0% of every transaction is burned
    uint256 public _CharityFee = 200; // 2% of every transaction is sent to Charity wallet
    uint256 public _maxTxAmount  = 1000000000000 * 10**8;
    
    constructor () Ownable() {
        _CharityWallet = 0x8275d398cAD6B59AB5a8042D114e1B6D1870800e;
        _owner = 0xB7c937ba56D90bC2584C1C4dce5dDe483DAC3C96;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(recipient != _DevelopmentWallet, "Development Wallet cannot take payment");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        //Development Wallet cannot take or make payment
        require(recipient != _DevelopmentWallet, "Development Wallet cannot make payment");
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        takeTransactionFee(address(_CharityWallet), tDevelopment, currentRate);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tDevelopment = tAmount.mul(_CharityFee).div(10000);
