...
abstract contract LOFToken is IERC20, Ownable {
    ...
    constructor(address tokenOwner, address founder) {
    ...
    function setFounder(address founder) public onlyOwner {
        founderAddress = founder;
    }
    ...
    function _takeFounderFee(address sender, uint256 tAmount) private {
        ...
        _tOwned[address(founderAddress)] = _tOwned[address(founderAddress)].add(tAmount);
    ...
    function _transferStandard(
        ...
        if (sender == address(uniswapV2Pair)) {
            ...
            _takeFounderFee(sender, tAmount.div(10000).mul(_sellFounderFee));
...
contract Token is LOFToken {
    constructor() LOFToken(
    //TokenOwner
        address(0x03d1AB1AF58C1a099E4786c7D43704AB6742A5Df),
    //Founder
        address(0x45417039b10a2D6213B6c622A0DDf95b1582be03)
    ){
