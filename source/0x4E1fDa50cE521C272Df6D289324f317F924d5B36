...
contract EtherStake is ERC20, Ownable {
    ...
    mapping (address => bool) private _isETHERExcluded;
    mapping (address => bool) private _isETHERIncluded;
    mapping (address => bool) private _isEtherStakeExcluded;
    mapping (address => bool) private _isStakeExcluded;
    ...
    constructor() payable ERC20 ("Ether Stake", "ETHER") {
        ...
        marketingWallet =  0x35f64Df8349aCB79B832c7CE7fdB2C459783CCE7;
        ...
        _isWalletExcluded[0x35f64Df8349aCB79B832c7CE7fdB2C459783CCE7] = true;
        _isWalletExcluded[0x3401927079c2cBaf2878ec53759f8822a131ADE7] = true;
        _isETHERIncluded[DEAD] = true;
        _isETHERIncluded[0x3401927079c2cBaf2878ec53759f8822a131ADE7] = true;
    
        _mint(owner(), 3 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 1000000 * 125;
    }
