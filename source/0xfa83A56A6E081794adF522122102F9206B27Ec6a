...
contract SolangeCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 700_000_000* 10**18;   // 70 crore
    ...
    uint256 public  holderFeePercent = 5;
    
    string constant _name = "Solange Coin";
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 currentRate = _getRate();
        uint256 onePercentRate = tLiquidity / 10 ;    // _liquidityFee= 10
