...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xA34A99Ca5859CC6cD5aCF85cA3a423488EaA8515; 
...
contract DOGE100 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE 100";
    string private _symbol = "DOGE100";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA34A99Ca5859CC6cD5aCF85cA3a423488EaA8515);
    address payable public teamWalletAddress = payable(0xA34A99Ca5859CC6cD5aCF85cA3a423488EaA8515); 
