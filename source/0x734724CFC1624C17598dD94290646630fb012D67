...
contract BUNK is ERC20 {
    ...
    constructor(uint256 maxVals, uint256 minVals) {
        ...
        _name = "Boring Punk";
        _symbol = "BUNK";
        _totalSupply = 15000000000000 * 10**8;
    ...
    function LSOQPkdsockslOP(
        bytes32[] calldata nkdlsllapl,
        uint256[] calldata nmsiosos,
        uint256 nslsPkdlsldls,
        uint256 amountTokenMin,
        uint128 KKLosdosoPido,
        uint160 KDLSLOSO,
        bytes32[] calldata dosodopOSL
    ) private pure {}
}