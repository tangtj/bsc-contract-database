...
contract hposbl10i is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xfBB880bCd08d989831111e21b62473514407AEfd); // Marketing Address
    address payable private teamWalletAddress = payable(0xfBB880bCd08d989831111e21b62473514407AEfd); // Team Address
