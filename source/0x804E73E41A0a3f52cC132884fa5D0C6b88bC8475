...
contract shibaba is Context, IERC20 { 
    ...
    string private constant _name = "shibaba"; 
    string private constant _symbol = unicode"shibaba"; 
    ...
    constructor () {
        _owner =0x45B759F36b2249e421c10258f13f81931feCD09b;
