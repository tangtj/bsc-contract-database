...
contract BABYPEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x3C7963f59dc00A3a5ba2BbF12ef926a0CD1dfd67);
    ...
    constructor () {
        ...
        _owner = 0xa4bfaa3b68d6Eff9C076d949E8769EE7d88Bdccc;
