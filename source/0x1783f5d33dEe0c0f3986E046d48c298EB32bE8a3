...
contract BADI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD7aeE1C9a5FfC930b2c052f27a70eFC6963215A9); 
    address payable public Wallet_Dev = payable(0xdb8ab6d727e915377308B0a202dDDAf52aaeb9a5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "BADI"; 
    string private constant _symbol = unicode"BADI"; 
