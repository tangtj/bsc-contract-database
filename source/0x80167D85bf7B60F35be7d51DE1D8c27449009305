...
contract Baymax is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x802CeE066641d248DC902139C246e5fF016dADA1);
    address payable private _marketingAddress = payable(0x802CeE066641d248DC902139C246e5fF016dADA1);
