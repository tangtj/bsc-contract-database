...
contract OrkFlame is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    mapping(address => uint256) public walletMints;

    address reserveWallet = payable(0x7AaC4A627e26B571ae6CB2BEdD7F167b10d93E82);
    ...
    ) ERC721A("CHIP OrkFlame", "OrkFlame") {
