/**
TELEGRAM: https://t.me/shebainu0
TWITTER: https://twitter.com/shebainu0
WEB: http://she-ba.lol/
...
contract ShebaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShebaInu";
    string constant _symbol = "SHEB";
