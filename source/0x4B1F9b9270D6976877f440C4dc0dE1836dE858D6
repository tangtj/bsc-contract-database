...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfc60B553aaCD6f45E4e2C4e7b281e2aad172B350;
...
contract Shiba24 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x197B6Df57203cF2005CE9d99516c9254c0B009c5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SHIBA24";
    string private _symbol = "SHIBA24";
