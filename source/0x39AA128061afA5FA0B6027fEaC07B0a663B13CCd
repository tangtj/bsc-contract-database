/**
The newest token, FlokiCat INU, will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power
...
contract FlokiCatInu is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x44e34D4Aa91D2345dB0C0f6380556c8239Ebd213;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x25895AA38b2793005995b1feA3B413E146D08482;
