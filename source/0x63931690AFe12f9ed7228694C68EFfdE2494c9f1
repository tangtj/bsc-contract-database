...
/**
  * Telegram https://t.me/NIOCTIB_TNEMECNUONNA
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f121FB30072697B038b1160809Aa2b5270B333d; // owner address
...
contract NIOCTIB is Context, IERC20, Ownable {
    ...
    string private _symbol = "Uni01cinoSamabOrettoPyrraH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f121FB30072697B038b1160809Aa2b5270B333d); // Marketing Address
    address payable public teamWalletAddress = payable(0x8f121FB30072697B038b1160809Aa2b5270B333d); // Team Address
