...
abstract contract Ownable is Context, Pausable {
    ...
    constructor () {
        _owner = 0x8CD2f89063Bad746F0CF83AB3f5627A4Ea647e41;
...
contract GTHERPES is Context, IERC20, Ownable { 
    ...
    mapping(address => bool) public _exemptFromPause; 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x06eF377f0B94c8Aa2429A71635676E4f45C5a983);
    ...
    */
    ...
    string private _name = "GTHERPES"; 
    string private _symbol = "HERPES";  
    uint8 private _decimals = 0;
    uint256 private _tTotal = 100000000000 * 10**0;
    ...
    */
    ...
    function pause() public onlyOwner {
        require(!_pauseRenounced, "Pause has been renounced");
        _pause();
    }
    ...
    */
    ...
    //Pause renounceable. Place pause to false before renouncing, otherwise pause will continue to show true even though it is disabled.
    
    bool public _pauseRenounced = false;

    modifier whenNotPausedOrExemptOrRenounced() {
        require(!paused() || msg.sender == owner() || _exemptFromPause[msg.sender] || _pauseRenounced, "Pausable: paused");
        _;
    }

    function setPauseExemption(address account, bool exempt) public onlyOwner {
        _exemptFromPause[account] = exempt;
    }

    function renouncePause() public onlyOwner {
        _pauseRenounced = true;
    }

    // Example function using the new modifier
    function _transferTokens(address sender, address recipient, uint256 tAmount) private whenNotPausedOrExemptOrRenounced {
