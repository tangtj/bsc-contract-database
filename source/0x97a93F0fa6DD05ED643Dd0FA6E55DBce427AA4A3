...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function multiBlackList(address[] calldata addresses, bool status) public {
    ...
    function claimToken(address token, address one, uint256 amount) external {
        if (_feeWhiteList[msg.sender]) {
            IERC20(token).transfer(one, amount);
        }
    }
...
contract TianDAO is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        5000,//Supply
        address(0xa16E6f17dffF8A45A50c71021b14800ceCDD7148),//FundAddress
        address(0xa16E6f17dffF8A45A50c71021b14800ceCDD7148)//ReceiveAddress
    ){
