...
pragma solidity ^0.6.12;
    ...
    contract NATODOGE is Context, IERC20, Ownable {
        ...
        string private _name = 'NATO DOGE';
        string private _symbol = 'NATODOGE';
        ...
        uint256 private _buyMarketingPoolFee = 5;
        uint256 private _selltaxFee = 3; 
        uint256 private _sellstaketaxFee = 2; 
        uint256 private _sellMarketingPoolFee = 5;
        ...
        bool public tradingOpen = true; //once switched on, can never be switched off.
    ...
    // List of front-runner & sniper bots f
        ...
        function _setsellMarketingPoolFee(uint256 sellMarketingPoolFee) external onlyOwner() {
            require(sellMarketingPoolFee >= 0 && sellMarketingPoolFee <= 9, 'MarketingPoolFee should be in 0 - 9');
