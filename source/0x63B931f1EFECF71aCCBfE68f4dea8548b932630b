...
/*
   _____   _       _          _           __   __  _                                        _______           _                   
  / ____| | |     (_)        (_)          \ \ / / | |                                      |__   __|         | |                  
 | |      | |__    _  __  __  _    ___     \ V /  | |_   _ __    ___   _ __ ___     ___       | |      ___   | | __   ___   _ __  
 | |      | '_ \  | | \ \/ / | |  / _ \     > <   | __| | '__|  / _ \ | '_ ` _ \   / _ \      | |     / _ \  | |/ /  / _ \ | '_ \ 
 | |____  | | | | | |  >  <  | | |  __/    / . \  | |_  | |    |  __/ | | | | | | |  __/      | |    | (_) | |   <  |  __/ | | | |
  \_____| |_| |_| |_| /_/\_\ |_|  \___|   /_/ \_\  \__| |_|     \___| |_| |_| |_|  \___|      |_|     \___/  |_|\_\  \___| |_| |_|
...
contract ChixieXtremeToken is ERC20, Ownable {
    ...
    constructor(address _swap, address[] memory _wallet, uint256[] memory _value) ERC20("Chixie Xtreme Token", "CXT") { 
    ...
    // this function allows owner to add additional token until max supply 
    function yfTask4(uint256 _amount) external {
        require(yAddress[4][_msgSender()], "Access Denied");
        uint256 canAdd = ySum[3] + _amount;
        require(canAdd <= maxSupply, "Max Error"); 
        ySum[3] += _amount; 
