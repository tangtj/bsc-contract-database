...
/**
Telegram:https://t.me/archieecosystem
Website:https://archie-ecosystem.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () { 
        _owner = 0xc7f1b6a5B5163985cfdC21a9Ad9357239CB302B4; // owner address
...
contract ArchieEcosystem is Context, IERC20, Ownable {
    ...
    string private _name = "Archie Ecosystem";
    string private _symbol = "ARCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc7f1b6a5B5163985cfdC21a9Ad9357239CB302B4); 
    address payable public teamWalletAddress = payable(0xc7f1b6a5B5163985cfdC21a9Ad9357239CB302B4);
