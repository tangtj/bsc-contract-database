...
contract JG is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x468BE9DF45F9CB3D59d1CD11054D6775F439499a);
    ...
    string private constant _name = "DJG"; 
    string private constant _symbol = unicode"DJG"; 
    ...
    constructor () {
        ...
        _owner = 0x270a070C93dbC6F28325355Aa5aed79d9590db06;
