...
contract ERCXTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "ERCX";
    string private _seitokensymbol = "ERCX";
    address public aqbghj34;
