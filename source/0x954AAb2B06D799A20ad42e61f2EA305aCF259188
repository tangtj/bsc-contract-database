// 🎆🗽 Happy and crypto-filled 4th of July from American Pepe! 
// Let's honor our digital sovereignty with memes that shake the blockchain world! 
// Join the excitement  https://t.me/American_pepe 
// 5 BNB LP - FAIR LAUNCH
...
contract AmericanPepe is Context, IERC20, LockToken
{

    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xc9D6A73DD081B3e8991379bCbE5a536fbcD5C287);
    address payable public devAddress = payable(0xc9D6A73DD081B3e8991379bCbE5a536fbcD5C287);
    address public newOwner = 0x47C5F5D49815c87Bf50655Eb9324279fF632A7A5;
    ...
    string private _symbol = "AMEPE";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 42000000000069.0 * 10**_decimals;
    ...
    uint256 private minimumTokensBeforeSwap = 200000000000 * 10**18;
