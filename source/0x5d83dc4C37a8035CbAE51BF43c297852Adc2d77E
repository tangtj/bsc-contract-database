...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XBLUEwebsite = "https://xblue.app/";
    string public XBLUEADDRESS = "0xF787323211D168604332167753070DD7bd189127";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXBLUE;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXBLUE = 0xF787323211D168604332167753070DD7bd189127;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXBLUEwebsite() public view returns (string memory) {
        return XBLUEwebsite;
    } 


               function getXBLUEADDRESS() public view returns (string memory) {
        return XBLUEADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXBLUE);
        _;
    }    
    function _approve(
        address owner,
