...
TG https://t.me/NinjaTurtlesCoinbsc
Web https://www.ninjaturtles.xyz/
Twitter https://twitter.com/NINJATURTLEBSC
...
contract NinjaTurtles is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ninja Turtles";
    string constant _symbol = "$TMNT";
