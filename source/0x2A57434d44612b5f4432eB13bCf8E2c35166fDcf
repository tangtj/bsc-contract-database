...
contract BurnMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xcA6908640FE55716b28261aDbCF36A9Ee6f6E8E9);
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) external {
