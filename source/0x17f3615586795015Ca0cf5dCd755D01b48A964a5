...
contract TwitterX is ERC20, Ownable, ReentrancyGuard {
    ...
    address public marketingWallet = 0xB88C7e1807A2Cb38C398F685E20096cAC6a5A519;
    ...
    constructor() ERC20("Twitter X", "Twitter X") {
        _mint(owner(), 100_000_00000 * (10**18));
