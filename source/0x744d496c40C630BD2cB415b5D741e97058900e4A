...
contract PEPPACOIN is IERC20, Ownable {
    ...
    string _name = "PEPPA PIG";
    string _symbol = "PEPPA";
    ...
    uint256 largeSwapThreshold = _totalSupply * 5 / 1000; 
