...
contract OrderNFT {
    ...
    require(xmmToken.transfer(_owner, amount.mul(20).div(100)));
    require(xmmToken.transfer(0xeFE41Dd5543E56b0e0463a0c077FcF0A3207F57A, amount.mul(80).div(100)));
