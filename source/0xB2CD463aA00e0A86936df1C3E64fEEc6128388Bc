...
contract SmartBOT is ERC20, Ownable {
    ...
    constructor () ERC20("Smart Trade-BOT", "Smart-BOT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xfb5191cdCf2F55458D9eeBe544e546A2E60EE296;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            if(block.timestamp > tradingTime + 3 hours){
                _burnFee = amount * 4 / 100;
            } else if(block.timestamp > tradingTime + 1 hours){
                _totalFees = 5;
            } else {
                _totalFees = 10;
            }
