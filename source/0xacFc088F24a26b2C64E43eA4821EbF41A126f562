...
contract BeAITOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public raakh67;
    ...
    string private _tokenname = "BeNFT AI";
    string private _tokensymbol = "BeAI";
