/**
// https://t.me/DarklordVPepeBSC
// https://twitter.com/DLPEPE
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d5026d868a52c24f17E9B9D643a877f8E410c00; // owner address
...
contract DorkLordvspepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DorkLord V PEPE";
    string private _symbol = "$DVP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8d5026d868a52c24f17E9B9D643a877f8E410c00); // Marketing Address
    address payable private teamWalletAddress = payable(0x8d5026d868a52c24f17E9B9D643a877f8E410c00); // Team Address
