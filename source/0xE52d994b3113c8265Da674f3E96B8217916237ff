...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x882af1Cf32948511d5A8104ab3257d5F9A5edcde; // owner address
...
contract NOBODY is Context, IERC20, Ownable {
    ...
    string private _name = "NOBODY";
    string private _symbol = "NOBODY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x882af1Cf32948511d5A8104ab3257d5F9A5edcde); // Marketing Address
    address payable private teamWalletAddress = payable(0x882af1Cf32948511d5A8104ab3257d5F9A5edcde); // Team Address
