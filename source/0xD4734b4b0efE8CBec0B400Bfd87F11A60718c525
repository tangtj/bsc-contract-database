...
abstract contract ABCToken is ERC20, Ownable {
    ...
    function setPair(address swapPair) public onlyOwner {
        mainPair = swapPair;
...
contract UpChain is ABCToken {
    constructor()
        ABCToken(
            ...
            address(0x6C3b9EE8797B4e148C272C90171F647519B602B3), //PresaleAddress
            address(0xcffB444954CaDa15D447381e401eD0F2E7EA01c8), //LPAddress
            address(0x0a642E0911934EB5e45b6C8eeF190a2Be2746736), //EcoAddress
            address(0x9B07068E93Db2529C5050d0D2C34DDa24545089c), //FundAddress
            address(0xA7d3ACE0293f8be2c434d9ea6C96F207430cE632), //RepoPoolAddress
