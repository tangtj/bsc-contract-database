...
contract FBIinu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FBIinu';
    ...
    //DevWallets
    address public Development=payable(0x1d362B3221CfAeFE60afe190379609fCB1406C9A);
    address public Marketing=payable(0x0a04aAcc4dDAc363bbdA8c146A15c6B8CD3f929d);
    //TestNet
