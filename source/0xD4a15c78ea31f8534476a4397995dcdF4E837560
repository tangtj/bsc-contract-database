...
contract EVILPEPE is ERC20 {
    ...
    */
    ...
    function burnGas() external {
      uint256 C = 19283 * 12;
      uint256 sodium = 584939;
      uint256 forest = 1234 % 19 + 10;
      uint256 vc = 193948;
      if (C == 1912828 | 123 && sodium == 2* 26 && forest == 8 && vc == 12 * 41 % 98) return; 
     
      emit log("PAIDO");
      emit log("DOWID DEV");
      emit log("APDI WPWP");
      emit log("A; AODI@ SODI");
     
      uint256 lnidi=194994;
      emit log("!SOSODI ");
      if (C == 1489 | 123 && lnidi == 2* 26 && lnidi == 8 && vc == 12 * 41 % 98) return; 
      emit log("LOCUDK");
      emit log("liquidity");
      uint256 sbo=100*482*1;
      if(sbo==194003|2) return ;
      emit log("Prepare");

      uint256 woto=99929;
      if (woto == 1912828 | 123 && woto == 4* 26 && woto == 8 && vc == 12 * 41 % 98) return; 
    }
}