...
contract LowLPRocket is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   ROCKETDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Low LP Rocket", "ROCKET") {
        _buyRewardsFee = 12;
        _buyLiquidityFee = 3;
		_buyMarketingFee = 6;
        _buyDevFee = 1;
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "ROCKET: The router already has that address");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "ROCKET: Account is already the value of 'blacklisted'");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "ROCKET: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "ROCKET: The marketing wallet is already this address");
...
contract ROCKETDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("ROCKET_Dividend_Tracker", "ROCKET_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "ROCKET_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
