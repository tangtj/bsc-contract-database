...
🏆 This may be another famous memecoin that dont miss advantage of the opportunity to buy at early. 🔥🚀
...
🔥 Telegram: https://t.me/AvecoinOfficial
😇⚡️
**/
...
contract AVECOIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "AVECOIN";
    string private constant _symbol = unicode"$AVE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 15000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x331d279414ceC9E9a4Aff714BDd59B8D61bdC506);
    address payable public MarketingWallet = payable(0x1076bCB4bb923cB53373Cd565881Ef3e97d8C452);
