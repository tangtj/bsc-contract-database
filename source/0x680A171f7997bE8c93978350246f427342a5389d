...
contract DorklordBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ᗪOᖇK ᒪOᖇᗪ BNB";
    string private constant _symbol = unicode"DORKLBNB";
    ...
    {        
        ...
        marketingWallet = 0xF411931e9e0fB49e2635611439BB0815C37D986E;
