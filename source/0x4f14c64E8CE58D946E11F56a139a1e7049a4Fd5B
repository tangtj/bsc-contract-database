...
contract TheNinja is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"THE NINJA";
    string private _symbol = unicode"THENINJA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x2eb8Cb188587Ef9bA619FD1972C9dDB9f4EA461F);
    address payable private taxWallet2 = payable(0x2eb8Cb188587Ef9bA619FD1972C9dDB9f4EA461F);
