/*
Stack Duo is a fully open source cryptocurrency wallet. It is a fork of Stack Wallet, 
but stripped down to just Bitcoin and Monero. With an easy to use user interface and 
quick and speedy transactions, this wallet is ideal for anyone no matter how much they 
know about the cryptocurrency space. The app is actively maintained to provide new user friendly features.

TG: https://t.me/stackduowallet
*/
