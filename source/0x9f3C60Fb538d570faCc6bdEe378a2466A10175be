...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2A4DE320D133764331c13cA8c58d47C5Cd965478; // owner address
...
contract FrogXCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Frog X Cat";
    string private _symbol = "FXC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2A4DE320D133764331c13cA8c58d47C5Cd965478); // Marketing Address
    address payable private teamWalletAddress = payable(0x2A4DE320D133764331c13cA8c58d47C5Cd965478); // Team Address
