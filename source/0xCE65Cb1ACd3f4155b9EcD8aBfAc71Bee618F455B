//Telegram: https://t.me/dorklordbsc
...
interface IDEXRouter {
 ...
 contract DORKLORD is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "DORKLORD";
    string constant _symbol = "DORKLORD";
