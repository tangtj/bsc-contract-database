...
contract KingJack is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0xKingJack";
    string private constant _symbol = unicode"0xKJ";
    ...
    constructor () {
        _taxWallet = payable(0x7ee10aafdf76998208E92e60d4849fd09Ff32eA2);
