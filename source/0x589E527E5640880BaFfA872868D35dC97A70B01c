/**
 * Safe Asteroid Token - $SAFEASTEROID
 * Telegram : @SafeAsteroidToken
 * 
 * We won't stop before we reach the Moon. Join us in this journey.
 *
 * Taste the feeling of absolute safety with Safe Asteroid while 
 * you earn more tokens just by hodling.
 * 
 * Safe Asteroid has been designed to stabilize market price, increase 
 * supply scarcity, and reward token holders, while providing 100% safety 
 * for your investment with top-class security measures.
 * 
 * 100% Unruggable
 * --------------- 
 * We will lock 100% LP on DxLock right after adding liquidity, and 
 * renounce ownership. You are safe with Safe Asteroid!
 * 
 * Stabilizes Price
 * ---------------- 
 * Safe Asteroid adds 3% of each transaction to the liquidity pool 
 * stabilizing the token price.
 * 
 * Increases Scarcity
 * ------------------
 * Safe Asteroid burns 4% of each transaction to token holders, 
 * incentivizing hodling.
 * 
 * Rewards Holders
 * ---------------
 * Safe Asteroid distributes 5% of each transaction to token holders, 
 * incentivizing hodling.
 * 
 * Tokenomics
 * ----------
...
contract SafeAsteroidToken is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Asteroid Token";
    string private _symbol = "SAFEASTEROID";
    ...
    uint256 private numTokensSellToAddToLiquidity = 150 * 10**3 * 10**9;
