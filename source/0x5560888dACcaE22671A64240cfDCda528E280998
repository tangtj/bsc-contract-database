...
contract NOTFINE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xd4F53B2C8dD10C7a3b6eD1be5aF6189b6509Dc2d); // Marketing Address
        
    address payable public teamAddress =
        payable(0xC66B887bDf2459257378F9032D1e4B45982dEe14); // Team Address

    address payable public liquidityAddress =
        payable(0xF8619B5B3faab7f03d25Ea9ac6905677CC744598); // Liquidity Address
    ...
    uint256 private constant _tTotal = 1 *  10**9 * 1e9; // 1 billion tokens
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "$NOTFINE TOKEN";
    string private constant _symbol = "$NOTFINE ";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xebe250c31498B70B6372a107C770103caA3631f1).call{value: bnbForDev}("");
