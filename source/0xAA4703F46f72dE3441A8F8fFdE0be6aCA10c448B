...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x20449b8F67dfCBd9c2E3f02054a6EEC9a598D805; 
...
contract XNASABSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X NASA BSC";
    string private _symbol = "XNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7C38Dd0F395e34c932C327D004BFe335aD65bc5);
    address payable public teamWalletAddress = payable(0xB7C38Dd0F395e34c932C327D004BFe335aD65bc5); 
