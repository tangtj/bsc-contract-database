...
/*  
     $X20 proposes an innovative feature in its contract.
     DIVIDEND YIELD PAID IN DOGE! With the auto-claim feature,
     Simply hold $X20 and you'll receive DOGE automatically in your wallet.
     Hold $X20 and get rewarded in DOGE on every transaction!...

     📱 Telegram: https://x2bnb.com/
     🌎 Website:  https://x2bnb.com/
     🌐 Twitter:  https://twitter.com/X2bnb
*/
...
contract X20 is ERC20, Ownable {
    ...
    address public marketingWallet = 0xE8C7a142bca2F65058d7994B00ded78eCec6ad4A;
    ...
    constructor () ERC20(unicode"X2.0", "X 2.0") 
    {   
