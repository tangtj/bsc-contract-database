...
contract ShibaViking is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5EAf2E0421c1A837b57C6b7A846c2322D687589F);
    address payable private _twdmkt = payable(0x5EAf2E0421c1A837b57C6b7A846c2322D687589F);
    
    string private constant _name = "Shiba Viking";
    string private constant _symbol = "SHIBAVIKING";
