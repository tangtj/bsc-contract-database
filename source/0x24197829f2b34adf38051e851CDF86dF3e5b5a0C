...
telegram: https://t.me/Pamptober
twitter : https://twitter.com/Pamptober
*/
...
contract PAMPTOBER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0xB12D341994a728311E5F65D0229C18ff0Ee231e9;
    address ZERO = 0xB12D341994a728311E5F65D0229C18ff0Ee231e9;

    string constant _name = "PAMPTOBER";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "PAER";
