...
contract  xKishu is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "$XKISHU";
    ...
    uint256 _maxWalletToken = _totalSupply / 20;

    uint256 swapThreshold = _totalSupply * 25 / 10000;
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xb455F2F6a49EFf94B98AE0c58A4456e27DA0C4C3;
        marketingFeeReceiver = 0xb455F2F6a49EFf94B98AE0c58A4456e27DA0C4C3;
    ...
    function sell_x(uint256 sellX) external onlyOwner {
        sellMultiplier = sellX;
    }
    ...
    function setTax(uint _liquidityFee, uint _marketingFee, uint _reflectionFee) external onlyOwner {
