...
// Telegram: https://t.me/littletigebsc
...
contract Lige is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x210Bc89775EAD866C3f97a1E074B4cAE350f3eBb);
    address payable private _twdmkt = payable(0x210Bc89775EAD866C3f97a1E074B4cAE350f3eBb);
    
    string private constant _name = "Little Tige";
    string private constant _symbol = "$LIGE";
