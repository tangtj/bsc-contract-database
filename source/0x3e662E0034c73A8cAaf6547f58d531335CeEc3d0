...
contract PEPEF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPEF";
    string private _symbol = "PEPEF";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xAa6b335f2A466c920E5d4b6916caaf41CE592802); 
    address payable private teamWalletAddress = payable(0xAa6b335f2A466c920E5d4b6916caaf41CE592802); 
