...
contract TheRealOne is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TheRealOne";
    string constant _symbol = "TRO";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + devFee + sellFee + buyFee;
