...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x5955CcDf16cFB6D36E0ffD881e5d996514a5F435; 
...
contract ERRORPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ERROR PEPE";
    string private _symbol = "$ERROR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5955CcDf16cFB6D36E0ffD881e5d996514a5F435);
    address payable public teamWalletAddress = payable(0x5955CcDf16cFB6D36E0ffD881e5d996514a5F435); 
