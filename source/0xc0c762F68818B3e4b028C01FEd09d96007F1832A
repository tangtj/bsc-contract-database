...
contract AngryNinja is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"ANGRY NINJA";
    string private _symbol = unicode"ANGRYNINJA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x58B0e291e6cA65a5EE053af46c585B48DB788426);
    address payable private taxWallet2 = payable(0x58B0e291e6cA65a5EE053af46c585B48DB788426);
