...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdb8FD33A7afc24E4c8AE69DC5A7789275cBb8674; // owner address
...
contract DYOR is Context, IERC20, Ownable {
    ...
    string private _name = unicode"DYOR";
    string private _symbol = unicode"$DYOR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdb8FD33A7afc24E4c8AE69DC5A7789275cBb8674); 
    address payable public teamWalletAddress = payable(0xdb8FD33A7afc24E4c8AE69DC5A7789275cBb8674);
