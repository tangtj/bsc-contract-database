...
// Lumarium : Layer 2: Elevating Finance Lowering Costs
...
contract Lumarium is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7674ddec0C7bA18a89fF9d7130572daacB38f03E); // Marketing Address
    address payable public teamWalletAddress = payable(0x7bb91b414b26d9652D692788dCaF1f9e8D760A83); // Team Address
