...
contract BSCROCKCOIN is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('BSCROCK COIN', 'BRC') {
        require(
            feeAccount != address(0),
            'BSCROCKCOIN: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'BSCROCKCOIN: incorrect fee percent');
        require(owner != address(0), 'BSCROCKCOIN: incorrect owner address');
        require(mintToAddr != address(0), 'BSCROCKCOIN: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'BSCROCKCOIN: transfer from the zero address');
        require(recipient != address(0), 'BSCROCKCOIN: transfer to the zero address');
