// BinanceDeFi.net is community for crypto investors and traders hunting for new 100x BNB Chain tokens. Best alpha on BSC!
//
//
// Website : https://binancedefi.net 
//
// Twitter : https://twitter.com/BinanceDeFiNet
//
// Telegram : https://t.me/BinanceDeFiNet
//
// This contract is unruggable, buy $BNBDEFI and hold!
//
...
contract BNBDEFI is Context, IERC20, Ownable {
    ...
    string private constant _name = "BinanceDeFi";
    string private constant _symbol = "BNBDEFI";
    ...
    address payable private _twddev = payable(0xf7C08A12f9DFbF0ec42d851F352ea8445fcEfae0);
    address payable private _twdmkt = payable(0xEcC13D35C06E3a02A78D3e98F92A8052728e5208);
