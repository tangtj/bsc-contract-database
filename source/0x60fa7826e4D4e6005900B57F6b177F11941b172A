...
contract Bep20_Token is Context, IERC20, Ownable {
    ...
    string private _name = "Pet House";
    string private _symbol = "PEH";
    uint8 private _decimals = 9;

    uint256 public constant _shareHolderFee = 2;
    ...
    function inBlacklist(address BlackAdr) public view returns (bool) {
        return _Blacklist[BlackAdr];
    }
