...
contract GOLDVENOM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gold Venom";
    string private _symbol = "GVENOM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE52D9a618A8eFC5ce893a1666127BBC830c9366D); // Marketing Address
    address payable public teamWalletAddress = payable(0xE52D9a618A8eFC5ce893a1666127BBC830c9366D); // Team Address
