 ...
 * @dev see https://github.com/binance/EIPs/issues/20
 */
...
// File: contracts/BEP677.sol

pragma solidity 0.4.24;



contract BEP677 is BEP20 {
...
// File: contracts/IBurnableMintableBEP677Token.sol

pragma solidity 0.4.24;



contract IBurnableMintableBEP677Token is BEP677 {
    function mint(address, uint256) public returns (bool);
    function burn(uint256 _value) public;
    function claimTokens(address _token, address _to) public;
}

// File: contracts/BEP677Receiver.sol
...
contract BEP677BridgeToken is
    IBurnableMintableBEP677Token,
    DetailedBEP20,
    BurnableToken,
    MintableToken {
    ...
    constructor(
        ...
        string _symbol,
        uint8 _decimals)
    public DetailedBEP20(_name, _symbol, _decimals) {}
    ...
    function claimTokens(address _token, address _to) public onlyOwner {
        ...
        DetailedBEP20 token = DetailedBEP20(_token);
