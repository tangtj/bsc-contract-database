/**
Introducing X SQUID, the ultimate secure utility-meme token on BNB networks. Our goal is to rise to the top, providing unparalleled security for your investment.
...
website xsquid.vip (under maintenance)
*/
...
contract XSQUID is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "XSQD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x0AD4D9307f43061a7DFb95E5a0Dd95AFDeDc6AbD;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xa299FDCa588b383D6f878B5Dbc73A8c572d802Ae;
