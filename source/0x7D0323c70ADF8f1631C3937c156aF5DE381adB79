...
contract BinanceNova is Context, IERC20, Ownable {
    ...
    string private _name = "PerchCoin";
    string private _symbol = "PERCH";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5f7D5824869FEADaA52acDF18944b439df223B29);
    address payable public liqWalletAddress = payable(0x5f7D5824869FEADaA52acDF18944b439df223B29);
