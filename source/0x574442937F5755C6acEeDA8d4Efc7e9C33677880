...
contract PEPENEW is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 10000 * _decimalFactor; // Supply Token
    ...
    uint256 private limitBurn = 100 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 1000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 250 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 250 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 250 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Pepe New";
    string private _symbol =  "PNW";
    /*=== Modifiers ===*/
