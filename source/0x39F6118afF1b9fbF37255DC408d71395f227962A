...
contract Pepe2 is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xcEBE8020876720A482ECAE38337687e129ef90DE);
    address payable public MarketingWallet = payable(0x15DB34406B8fBAF9E6796143b4673313E6964160);
    address payable private TeamWallet01 = payable(0x2d308EB8d79C19D0013f8462734b381bd914DbA0);
