...
contract TSLNFTMid{
    ...
    address public _bossNFT = 0x759c0b293Cc9Db4f5Ea54C4e8cfeB37007616380;
    ...
    uint256 public _price = 100*10**18;

    uint256 public _bnbPrice = 1*10**15;
    ...
    function userbuyNode(address _player,uint _type,uint _status)public isWhiteLists payable {        
       
        ERC20(_usdt).transferFrom(msg.sender,_collected,_price);
        payable(address(this)).transfer(_bnbPrice);
    ...
    function userbuyNode2(address _player,uint _type,uint _status)public isWhiteLists payable {        
    ...
    function userbuyNode3(address _player,uint _type,uint _status)public isWhiteLists payable {        
