...
contract StepMoonToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Step Moon";
    string private constant _symbol = "STM";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xAC0363F7D185D5c5323a7346C533A73B81d837f4);
    address payable private _marketingAddress = payable(0x4Bc25a13E793Fb76A788d1a6d04fe8b8C89bc6aB);
    address payable private _autoLiquidityReceiver = payable(0x031Ae8B89B2A825bD9f46D9a5094B1e22aE559a9);
