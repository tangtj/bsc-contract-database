...
contract MRKCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public name_ = "MRKCoin";
    string public symbol_ = "MRKC";
    uint256 public totalSupply_ = 1006000;

    address public rewardAddr_ = 0x55d398326f99059fF775485246999027B3197955;
    address public marketingWalletAddr_ = 0x000000000000000000000000000000000000dEaD;
    uint256[4] public  buyFeeSetting_ = [0,0,0,0];
    uint256[4] public  sellFeeSetting_ = [4,3,0,3];
    uint256 public tokenBalanceForReward_ = 0;
