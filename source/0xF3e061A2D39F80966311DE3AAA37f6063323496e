...
contract HERO is ERC20, Ownable {
    ...
    constructor(
        ...
        burnFee = 2;
        marketingFee = 2;
        totalFees = burnFee.add(marketingFee);
        ...
        // require(totalFees <= 4, "Total fee is over 4%");
        swapTokensAtAmount = totalSupply_.mul(1).div(10**8);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(routerAddress);
        // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _priceToken);
    ...
    function updateUniswapV2Router(address newAddress, address priceToken) public onlyOwner {
        require(
    ...
    function _transfer(
        ...
        if(from == address(uniswapV2Pair) || from == address(uniswapV2Router) || to == address(uniswapV2Pair) || to == address(uniswapV2Router)){
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = fees.div(2);
            uint256 marketingAmount = fees.sub(burnAmount);
