...
// telegram     : https://t.me/sadbscplayground
...
contract SocialAnxietyDisorder is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Social Anxiety Disorder";
    string private _symbol = "$SAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B679E8944f94Da7ABe52eC29a670dA07c628677); // Marketing Address
    address payable public teamWalletAddress = payable(0x0B679E8944f94Da7ABe52eC29a670dA07c628677); // Team Address
