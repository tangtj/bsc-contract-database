...
contract JuggerDRAWV2 is ERC1155Tradable {
	constructor() public ERC1155Tradable("JuggerDRAWV2", "DRAWV2") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api/contract/jgn";
	}
}