...
contract USDTPRO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "USDT Pro";
    string constant _symbol = "USDTPRO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
    uint256 public maxWalletTokens =  3000000 * (10**9); // Anti-Whale
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xDca2a4658aE6aA24eBa691807c94bC7d27b15159;
