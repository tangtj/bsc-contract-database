...
contract Uladoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa8Cda0837f67E946Ee4cAa8edD4D99f172A0CbDe); // Marketing Address
    ...
    string private _name = "Uladoge";
    string private _symbol = "Uladoge";
    ...
    uint256 public _buyBackDivisor = 80;
