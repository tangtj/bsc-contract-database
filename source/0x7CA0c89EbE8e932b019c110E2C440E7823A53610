...
contract token is ERC20 {
    ...
    address _marketAddress = address(0x8A0a5f75CFed5e21A3Bc1a82aF812Cd265B88333);
    address payable _bnbFundAddress = payable(address(0x8A0a5f75CFed5e21A3Bc1a82aF812Cd265B88333));
	address payable _tokenFundAddress = payable(address(0xb68069821594a1d1E33b30e5ed28c98B97BE0895));
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
                ...
                super._transfer(from, _destroyAddress, amount.div(1000).mul(0));
				super._transfer(from, _tokenFundAddress, amount.div(1000).mul(0));
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount > 10**21){
            ...
            swapTokensForPAPA(allTokenAmount.div(5).mul(3));
		}
    }
    ...
    IERC20 public PAPA = IERC20(0x4BD46424B82194A2887516eCFeB1599A9531da0D);
    address public _fundPAPA = address(0xe472Ee52AFA464Aa4176079135f6342693A1111A);
    function swapTokensForPAPA(uint256 tokenAmount) private {
        // generate the uniswap pair path of token -> weth
        ...
        uint256 allAmount = PAPA.balanceOf(address(this));
        if(allAmount > 0){
            PAPA.transfer(_destroyAddress, allAmount.div(15).mul(13));
            PAPA.transfer(_fundPAPA, allAmount.div(15).mul(2));
        }
    }
