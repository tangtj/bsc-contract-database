...
contract Unibase is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Unibase";
    string private _symbol = "Unibase";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x02eF42A6DB7bf5DbeC0B961200E5FcAcED36661e); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 10; // 10% BUY TAX
    uint256 public _totalTaxIfSelling = 10; // 10% SELL TAX
    uint256 private _totalDistributionShares = 10;

   uint256 private _totalSupply = 1_000_000_000 * 10**18; //0 Billion Total Supply
    uint256 public _maxTransactionAmount =   30_000_000 * 10**18; // 3% Max Transaction Limit
    uint256 public minimumTokensBeforeSwap = 2000 * 10**18; // 0.05% of the total supply
    ...
    function TurnOnMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   30_000_000 * 10**18;
    }

    function TurnOffMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   1_000_000_000 * 10**18;
    }
