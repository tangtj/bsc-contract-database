...
//Telegram: https://t.me/CarlosInu
//Website: http://carlosinu-bsc.static.app/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA54c68453C291cb6310CCFCFEfa2CCB8876cDd2B; 
...
contract CARLOSINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Carlos Inu";
    string private _symbol = "$CARLOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA54c68453C291cb6310CCFCFEfa2CCB8876cDd2B);
    address payable public teamWalletAddress = payable(0xA54c68453C291cb6310CCFCFEfa2CCB8876cDd2B); 
