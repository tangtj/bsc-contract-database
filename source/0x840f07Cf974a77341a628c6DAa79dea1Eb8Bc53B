...
contract SRAe is ERC20, Ownable {
    ...
    constructor() ERC20("Money", "SRAe") {
        ...
        mktWallet = address(0x5DfbB0aae965B3f3F292Ef80Ffe4f343f701A47b);
        teamWallet = address(0xbbb4749BC711dA5a1f2abdFE879d03C503953DC5);
