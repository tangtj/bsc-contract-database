...
contract MoonSoon is ERC20, Ownable {
    ...
    constructor() ERC20("MoonSoon", "MSN") {
        ...
        maxTransactionAmount = 4 * 1e8 * 1e18; 
        maxWallet = 4 * 1e8 * 1e18; 
        ...
        devWallet = address(0xCb6e55B18AD385a70A6b86a9Aff5FCf0659dAaBc); 
