...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      // Mainnet
      rewardTokens.push(address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56)); // USDC - Mainnet  0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
...
contract bat is ERC20, Ownable {
    ...
    constructor() ERC20("BAT", "BAT") {
        ...
        maxWallet = totalSupply * 20 / 1000; // 1.5% Max wallet
    	...
    	operationsWallet = address(0xd7Bf148f6531f8F44a582137Af079f901b0F9E06); // set as operations wallet
        developmentWallet = address(0xd7Bf148f6531f8F44a582137Af079f901b0F9E06);
        buybackburnWallet = address(0xd7Bf148f6531f8F44a582137Af079f901b0F9E06);
        projectWallet = address(0xd7Bf148f6531f8F44a582137Af079f901b0F9E06);
        reserveWallet = address(0xd7Bf148f6531f8F44a582137Af079f901b0F9E06);
