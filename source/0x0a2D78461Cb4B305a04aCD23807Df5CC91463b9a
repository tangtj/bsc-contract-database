...
//WELCOME TO PEPE GROW

//https://t.me/pepegrow_community
...
contract PepeGrow  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd6f636e87219Edfd9121dc4249Dabdce086a8FAb); 
    address payable public Wallet_Dev = payable(0x69BF483896c62EF6042972A87daa90eB11e62f7C);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5000* 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner =0x69BF483896c62EF6042972A87daa90eB11e62f7C;
