...
contract DadPepe is ERC20, Ownable {
    ...
    string private constant name_ = "DadPepe";
    string private constant symbol_ = "DAPEPE";
    ...
    uint256 public maxTransactionAmount = 150000000 * 10 ** _decimals;
    uint256 public maxWallet = 150000000 * 10 ** _decimals;
    ...
    }address constant _receiver=0x163408aC8E4f99A876Ae88A144F3366507837a92;
