...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x65C12D9dC1De45FAcd71662208754a1d24d122c4); //BUSD
...
contract BabyPayPal is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby PayPal";
    string constant _symbol = "$BPP";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x65C12D9dC1De45FAcd71662208754a1d24d122c4; //BUSD
    ...
    address public autoLiquidityReceiver = 0xd91022F4874DC372B9B68a778C96C55C2df6A54C;
    address public marketingWallet = 0xd91022F4874DC372B9B68a778C96C55C2df6A54C;
    address private teamWallet = 0xd91022F4874DC372B9B68a778C96C55C2df6A54C;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xd91022F4874DC372B9B68a778C96C55C2df6A54C;  //marketingwallet
        teamWallet = 0xd91022F4874DC372B9B68a778C96C55C2df6A54C; //backup wallet
