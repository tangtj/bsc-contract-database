...
/**
telegram: https://t.me/centuriumcoin
...
contract centurium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "centurium";
    string private _symbol = "CENT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3ad7247b2A39cC29809A28EC755865108fA4D29a); // Marketing Address
    address payable public teamWalletAddress = payable(0x1309915C87DB96A6E881531DBE86686355b92c1E); // Team Address
