...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8deFFC8b86a6e44708E01B5884b48714090F3A21; // owner address
...
contract GOLDCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "GOLDCOIN";
    string private _symbol = "GOLDCOIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8deFFC8b86a6e44708E01B5884b48714090F3A21); // Marketing Address
    address payable private teamWalletAddress = payable(0x8deFFC8b86a6e44708E01B5884b48714090F3A21); // Team Address
