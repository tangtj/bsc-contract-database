...
contract WARIO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9a41Ef1C197AE25dA9D20AD3a230D5C3AC283a6D); 
    address payable public Wallet_Dev = payable(0xdA20A5181a254CF6bfd19975C94ce960169c7B3E);
    ...
    constructor () {
        _owner =0xdA20A5181a254CF6bfd19975C94ce960169c7B3E;
