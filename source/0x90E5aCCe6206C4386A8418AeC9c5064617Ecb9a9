...
contract NU is IBEP20, Ownable {
    ...
    mapping (address => bool) public isTimelockExempt; // No Wait Time LOL
    mapping (address => uint) public cooldownTimerBuy; // Buy time LOL
    mapping (address => uint) public cooldownTimerSell; // Sell Time LOL
    /*=== Unitary ===*/
    ...
    uint256 private _tSupply = 100000 * _decimalFactor; // Supply Token LOL
    uint256 public buyFee = 10; // Buy tax
    uint256 private previousBuyFee; // Stores Purchase Fee LOL
    uint256 public sellFee = 10; // Sell Tax LOL
    uint256 private previousSellFee; // Stores Sales Tax
    uint256 private limitBurn = 40000 * _decimalFactor; // Burn 4% BURN BASIC LOL
    uint256 public liquidityPercent = 2; // Liq return 2% BASIC
    uint256 public maxWalletBalance = 20000 * _decimalFactor; // 2% of Supply BASIC
    uint256 public maxBuyAmount = 20000 * _decimalFactor; // 2% of Supply LOL
    uint256 public maxSellAmount = 20000 * _decimalFactor; // 2% of Supply LOL
    uint256 public numberOfTokensToSwapToLiquidity = 10000 * _decimalFactor; // 1% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "NUX";
    string private _symbol =  "NUX";
    /*=== Modifiers ===*/
