...
contract ZPTTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Zpunk";
    string private _seitokensymbol = "ZPT";
    address public tbbfvg56;
