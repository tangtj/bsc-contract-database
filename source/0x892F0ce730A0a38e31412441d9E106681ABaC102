...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7a1B10E34cC2D516824899EaF9644Cb76B2E1266; 
...
contract BINABOX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BINABOX";
    string private _symbol = "BNBX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7a1B10E34cC2D516824899EaF9644Cb76B2E1266); // 
    address payable public teamWalletAddress = payable(0x7a1B10E34cC2D516824899EaF9644Cb76B2E1266); // 
