...
contract OMIKANU is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xe883D52bb97DD82525007145e06BA208aB0eDa91;

    string private constant _name = "OMIKANU";
    string private constant _symbol = "$KANU";
