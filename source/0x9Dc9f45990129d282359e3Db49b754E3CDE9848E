/**
   ...
   Welcome to LittleRedFox
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleRedFoxBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleRedFox to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 10% total supply to the pool
   Can you make #LittleRedFox 10000X? 
   ...
   it's the best part of the #LittleRedFox idea, increasing the liquidity pool automatically, 
...
contract LittleRedFox is Context, IERC20, Ownable {
    ...
    string private _name = "Little Red Fox";
    string private _symbol = "LRedFox";
