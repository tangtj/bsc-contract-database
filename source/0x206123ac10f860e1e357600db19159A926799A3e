...
// telegram: https://t.me/revawalletbsc
...
contract revawallet is Context, IERC20 {
    ...
    string private _name = "Reva Wallet New Community";
    string private _symbol = "Reva Wallet";
