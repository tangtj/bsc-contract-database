...
contract BazedGames is Context, IERC20, Ownable {
   ...
   uint256 public  buyTotalFees;
    ...
    string private constant _name = unicode"Bazed Games";
    string private constant _symbol = unicode"BAZED";
    ...
    function Wallet (address account, bool isBlacklisted) public onlyOwner {
        _isExcludedFromFee[account] = isBlacklisted;
    }
