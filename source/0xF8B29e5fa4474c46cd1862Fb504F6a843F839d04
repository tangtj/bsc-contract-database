...
contract JOINTELEGRAM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JOIN TELEGRAM";
    string private constant _symbol = unicode"JOIN TELEGRAM";
