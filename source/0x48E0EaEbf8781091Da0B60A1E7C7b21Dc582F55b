        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xea5Dbbd1AB137C5719139483Bcdd704804CA3cBf), block.timestamp
                );
            }
        }
    }
...
contract SHIA is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0xE37Aa6D76a6Bc67bC8B73D5f5d82C13259C49a00),//FundAddress
        address(0xea5Dbbd1AB137C5719139483Bcdd704804CA3cBf)//ReceiveAddress
    ){
    }
}