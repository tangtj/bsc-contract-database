...
contract HARE is Context, IERC20, Ownable {
    ...
    string private _name = "61HARE";
    string private _symbol = "61HARE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x696aBa91F94C5134B0BC28D2e5dbB0BcC0639e0F); // Marketing Address
    address payable public teamWalletAddress = payable(0x696aBa91F94C5134B0BC28D2e5dbB0BcC0639e0F); // Team Address
