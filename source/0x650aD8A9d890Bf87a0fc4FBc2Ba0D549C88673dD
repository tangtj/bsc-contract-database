...
contract xtigerinu is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xf15b52110F4d5A16408b1E978028F9c5EC548A85);
    address payable private _twdmkt = payable(0xf15b52110F4d5A16408b1E978028F9c5EC548A85);
    
    string private constant _name = "X TIGER INU";
    string private constant _symbol = "XTG";
