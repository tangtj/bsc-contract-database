...
contract GrimaceShiba is IBEP20, Auth {
    ...
    string constant _name = "GrimaceShiba";
    string constant _symbol = "GSA";
    ...
    address public marketingFeeReceiver = 0x2204938cB10234319CbA22D5a14779Fb29a510c0;
    address public buybackFeeReceiver = 0x51D414A1C3ee54aca904F24e329993b2A82d6Ee0;
