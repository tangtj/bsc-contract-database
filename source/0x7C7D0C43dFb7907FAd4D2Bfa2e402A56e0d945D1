 ...
 * Simply hold ETH to join the journey and experience all of the benefit from BTC Diamond.
 * 
 * 100% Unruggable
 * --------------- 
 * We will lock 100% LP on Unicrypt right after adding liquidity.
 * You are safe with Ethereum Space!
 * 
 * Stabilizes Price
 * ---------------- 
 * Ethereum Space adds 5% of each transaction to the liquidity pool 
 ...
 * Marketing
 * ---------------
 * 1% will be sent to marketing Ethereum Space.
 * 
 * Tokenomics
 * ----------
...
contract EthereumSpace is Context, IERC20, Ownable {
    ...
    string private _name = "EthereumSpace";
    ...
    address public marketingWallet = 0x08e1491d204387B13807f2374784719B30734b80;
