...
contract AIDOTNET is IBEP20, Auth {
    ...
    string constant _name = "Ai.Net";
    string constant _symbol = "$AINET";
    ...
    address private marketingFeeReceiver = 0x532A716df3B97cc5D86c8C07Ae46cC9b58f733Fd;
    address private developmentFeeReceiver = 0x532A716df3B97cc5D86c8C07Ae46cC9b58f733Fd;
