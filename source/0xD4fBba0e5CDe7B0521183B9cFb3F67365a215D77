...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _mainPair = ISwapFactory(_swapRouter.factory()).createPair(address(this), USDTAddress);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                swapFeeAmount = tAmount * (_buyFundFee + _buyBuybackFee) / 10000;
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                swapFeeAmount = tAmount * (_sellFundFee + _sellBuybackFee) / 10000;
            } else {//Transfer
            ...
            if (swapFeeAmount > 0) {
                ...
                if (isSell && !inSwap) {
                    ...
                    uint256 numToSell = 230 * swapFeeAmount / 100;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + buybackFee;
        ...
        fundUsdt = usdtBalance * buybackFee / totalFee;
        if (fundUsdt > 0) {
            path[0] = _usdt;
    ...
    function setBuyFee(
        uint256 buyFundFee, uint256 buybackFee
    ) external onlyOwner {
    ...
    function setSellFee(
        uint256 sellFundFee, uint256 buybackFee
    ) external onlyOwner {
...
contract DiamondPeipei is AbsToken {
    ...
    //pepeKing
        address(0x9bcA7d28e24A4F50C82e2AC05D5136EfCa4F519c),
    //
        "Diamond Peipei",
    //
        "Diamond Peipei",
    ...
    //
        1000000000,
    //
        address(0x53130b8eE60FBb5BdB6D729c49124eA31F0C5523),
    //
        address(0x9bf471C7a06b2d497B0D0e364E2A4b1C007B5839)
    ){
