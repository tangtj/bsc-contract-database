...
contract MEMES is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = _totalkpSupplyll_yu;
    ...
    address public _zntrFeedRecfueatw = 0x9dc1A45598dD949bFD427029f02fbf3c4144071e;
    ...
    function removeLimits() external onlyOwner{
        ...
        _maxWalletSize=_totalkpSupplyll_yu;
        _tfivrdcuiay=false;
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapkPairkTokenkuLf = IUniswapV2Factory(_uniswapikRouterUniswapikFck.factory()).createPair(address(this), _uniswapikRouterUniswapikFck.WETH());
