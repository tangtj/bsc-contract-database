...
contract dogeGod is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x909Ab80E130c8265D63A43D0642cdDF03b95f9fc); // Marketing Address
    address payable public teamWalletAddress = payable(0xA8c007D13f532535250227Bb12dA4fC0f839a5d1); // Team Address
	address public OwnerAddress =0x770355cf46697082344D0cDEdBa6cd039174787d;
