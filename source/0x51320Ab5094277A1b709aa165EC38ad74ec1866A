...
contract SQDAO is IERC20, Ownable {
    ...
    address public inviterAddress = address(0xcA0553Be4AB8D54c1930351dAe183c133cbea202);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair = _destroyAddress;

    address public fund1Address = address(0x1228f1F733f06635d71804bf449c60dF36c57e0d);



    uint256 public _fund1Fee = 10;
    ...
    constructor(address tokenOwner) {
        ...
        uint256 leftAmount = 1000000 * 10**_decimals;
