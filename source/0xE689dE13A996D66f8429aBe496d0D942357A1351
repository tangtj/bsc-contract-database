...
contract KishjiruInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf5EeaCe4b20452D68F3EBB5efB5d72576081477e); 
    address payable public Wallet_Dev = payable(0xf5EeaCe4b20452D68F3EBB5efB5d72576081477e);
    ...
    string private constant _name = "KishjiruInu"; 
    string private constant _symbol = unicode"KISHJIRU"; 
