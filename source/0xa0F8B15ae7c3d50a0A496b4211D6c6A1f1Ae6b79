...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x973D025C6Bf0306fE80f812A64adAA73d8Cc50Da;
        _token = msg.sender;
    }
...
contract Porncake is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x1a9C11D291279d1660a2F4659F3e4A6001B18F39;

    string constant _name = "Porncake";
    string constant _symbol = "Porncake";
