...
contract MBANK is Context, IBEP20, Ownable {
    ...
    address public marketingWallet =  0x4F6c1B9a3786e05EdA1223C38DeF69A627E9189b;

    string private constant _name = "MONEY BANK";
    string private constant _symbol = "MBANK";
