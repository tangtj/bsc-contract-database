...
contract Pikachu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x915a229e5530C799E95f28AE3920990A6502bb9f);
    address payable public teamWalletAddress = payable(0x78d59fBdaF67693a6d45e1CAb350bb75C5853170);
