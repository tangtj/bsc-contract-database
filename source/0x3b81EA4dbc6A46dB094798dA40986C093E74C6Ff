...
contract Partyslut is Ownable, IBEP20 {
    ...
    string constant _name = "Partyslut";
    string constant _symbol = "PARTYSLUT";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xe6Dc2b38352744adF1dF1Ac5F3bf7c15F88df072;
