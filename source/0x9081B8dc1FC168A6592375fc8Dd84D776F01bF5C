...
contract YieldHaven is Context, Ownable {
    ...
    uint256 public numDays = 7;    // withdraw once 7 days
    uint256 public numDays2 = 60;    //60 day before refund
    ...
    constructor() {         
	    dev = payable(0xbA13F842E0a3FdF5ebE464742B8a8CbFCCC8029D);		
    ...
    function Injected(uint256 amount) external {
        require(amount >= 100 ether, "Minimum is 100 USDT!");
        USD.safeTransferFrom(msg.sender, address(this), amount);
        inject += amount;
    }
