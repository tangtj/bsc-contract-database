...
- http://X-dswap.com
- https://t.me/X_Dswap
- XDswap is a community-driven token that inspired by Elon Musk's legendary dogecoin tweet and the twitter X trend!
...
contract XDswap is ERC20, Ownable {
    ...
    address public devWallet = 0x235E86E7567E83E1BF51aFFf301fa0ED0459af57;
    ...
    constructor() ERC20("XDswap", "XDT") {
        ...
        exemptFee[0x600Cc65fDbD4098b6064705b56237A7442C07e4A] = true;
        exemptFee[0x7a4aDF548Ef789185E4c89456A2A57ff5e1d5961] = true;
    }
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 devAmt = unitBalance * 5 * swapTaxes.dev;
            if (devAmt > 0) {
