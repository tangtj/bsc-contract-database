...
contract FXQ  is Context, IERC20, Ownable {
    ...
    address public marketingWallet =  0xaCE7b16A80C34E80C273581bA61D9add64e5695c;

    string private constant _name = "FUX X QUEEN";
    string private constant _symbol = "FXQ";
    ...
    // Owner cannot transfer out  FUX X QUEEN from this smart contract
