...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xac4C2a7EA501b00d0FAe4e6329D4f1B58E9d7d05; // owner address
...
contract CCDGC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDGC";
    string private _symbol = "CCDGC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xac4C2a7EA501b00d0FAe4e6329D4f1B58E9d7d05); // Marketing Address
    address payable private teamWalletAddress = payable(0xac4C2a7EA501b00d0FAe4e6329D4f1B58E9d7d05); // Team Address
