...
contract ILUXYUM  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe37Fa1d93815A4E599CEe23E5a185922699A80D2); 
    address payable public Wallet_Dev = payable(0xe37Fa1d93815A4E599CEe23E5a185922699A80D2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "ILUXYUM"; 
    string private constant _symbol = unicode"ILUXYUM"; 
    ...
    uint256 public Percent_AutoLP = 60; 
    ...
    constructor () {
        _owner =0xe37Fa1d93815A4E599CEe23E5a185922699A80D2;
