...
contract ZILLPROTOCOL is Context, IERC20, Ownable {
    ...
    string private _symbol = "$ZILLP";
    uint8 private _decimals = 18; 

    address payable private marketingWalletAddress = payable(0x9Ce5bDc03C87Ef252625bb7Fa5B5671e113f772c);
    address payable private teamWalletAddress = payable(0x9Ce5bDc03C87Ef252625bb7Fa5B5671e113f772c);
