...
Telegram https://t.me/blockconnector_bsc
Twitter  https://blockconnector.org/
*/
...
contract BConnect is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLOCK CONNECTOR";
    string private _symbol = "$BCONNECT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBe2C586B09fE11A8e71815c86292f5FEDc2Ce9E5); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD0A14FC115E0DE418daF2B7C168073fE52bD4C0a); // BuyBack Address
