...
contract cf is Context, IERC20, Ownable {
    ...
    string private _name = "cf";
    string private _symbol = "CF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2679363F513F88a9dE65859C3734010c8aDBd6d5); // Marketing Address
    address payable public teamWalletAddress = payable(0x2679363F513F88a9dE65859C3734010c8aDBd6d5); // Team Address
