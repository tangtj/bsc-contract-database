...
contract FSC is Context, IERC20, Ownable {
    ...
    function seoBuyFees(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
        _buyLiquidityFee = newLiquidityTax;
        _buyMarketingFee = newMarketingTax;
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee);
    }

    function seoSellFees(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
