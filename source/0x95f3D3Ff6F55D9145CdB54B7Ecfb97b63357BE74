// https://t.me/GodzillaXglobal
// https://twitter.com/GDZX_BSC
// https://godzillax.site/
...
contract GodzillaX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GODZILLA X";
    string private constant _symbol = unicode"GDX";
