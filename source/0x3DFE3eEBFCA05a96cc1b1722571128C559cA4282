...
contract leleeee is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF3b89b023A14CAeFFaFE6cba0cb8756177751EE5); 
    address payable public Wallet_Dev = payable(0xF3b89b023A14CAeFFaFE6cba0cb8756177751EE5);
    ...
    string private constant _symbol = unicode"(U+221E)"; 
    ...
    constructor () {
        ...
        _owner = 0xF3b89b023A14CAeFFaFE6cba0cb8756177751EE5;
