        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x804647F154FcBF053397e4A5327d793e89FB8A9f), block.timestamp
                );
            }
        }
    }
...
contract FISUGAMES is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0xa47510029A818B249B4ef828443366c2ca0F95a9),//FundAddress
        address(0x804647F154FcBF053397e4A5327d793e89FB8A9f)//ReceiveAddress
    ){
    }
}