// Telegram: https://t.me/letitflybsc
...
contract LETITFLY is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUST = 0x330443c01DF00A1e81913B2d5F1c249b039aeD9a;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Let It Fly";
   string constant _symbol = "LETIF";
   ...
   //max wallet holding  
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100; //max wallet base 100
   ...
   // Buy Fees
    ...
    uint256 marketingFeeBuy = 2600; 
    uint256 totalFeeBuy = 2900;

    // Sell fees
    uint256 liquidityFeeSell = 200;
    uint256 buybackFeeSell = 100; 
    uint256 reflectionFeeSell = 0;
    uint256 marketingFeeSell = 3600; 
    uint256 totalFeeSell = 3900;
   ...
   constructor () Auth(msg.sender) {
       ...
       marketingFeeReceiver = 0xdC2Ca9803B07CA21D596227ED43370053Aed2e11; // Marketing Wallet
       buybackFeeReceiver = 0xdC2Ca9803B07CA21D596227ED43370053Aed2e11; // Buyback Wallet
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   // Set the correct fees for buying or selling
    ...
    function SetValueSwap() public onlyOwner { 
