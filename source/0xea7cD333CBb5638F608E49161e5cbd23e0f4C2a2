...
contract ECHOS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ECHOS";
    string private constant _symbol = unicode"$ECHOS";
    ...
    address payable public DevWallet = payable(0x8ab7f95C3214a2e442249A2fF35Fb1f1d55b4376);
    address payable public MarketingWallet = payable(0x484017D5428D5510cF906Abc97FD2b5532a2105b);
