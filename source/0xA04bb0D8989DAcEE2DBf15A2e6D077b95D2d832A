...
*
*
*    Telegram: t.me/Changpump_Zhaoge
*    Website: changpumpzhaoge.serveo.net
*    Twitter: twitter.com/Changpump_Zhao
*
...
contract ChangpumpZhaoge is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 700 * 10**_decimals;
    ...
    address private _marketingWallet = 0xE7E0549c4A6DeE221342E7F6cF788515A678D705;
