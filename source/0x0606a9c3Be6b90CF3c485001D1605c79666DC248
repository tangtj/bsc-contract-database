...
contract fhcq is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000,//Supply
        address(0x9728F77064A08C8bE2675bEa0b9a66a8bD4948C1),//FundAddress
        address(0xeBD20eB3E5f80Bd47210F977e46666dC0ad38805)//ReceiveAddress
    ){
    }
}