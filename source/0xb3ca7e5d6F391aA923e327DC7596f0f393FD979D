...
// telegram : https://t.me/dogeisfineportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa0612B02B9C2e57d2176814dA4141F7f9Ac3Ad2B ; // owner address
...
contract DOGEisFINE  is Context, IERC20, Ownable {
    ...
    string private _name = "DOGEisFINE";
    string private _symbol = "DIF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa0612B02B9C2e57d2176814dA4141F7f9Ac3Ad2B); 
    address payable public teamWalletAddress = payable(0xa0612B02B9C2e57d2176814dA4141F7f9Ac3Ad2B);
