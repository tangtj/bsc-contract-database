...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1Bc89577457412DD5ebA369a9a47Cc4F65916754;
...
contract MemeCoinX is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x196a4eb4a2cCdF3b020e4058b67102b5C9B6dE28);
    ...
    string private _name = "MemeCoinX"; 
    string private _symbol = "MCX";  
