...
contract XDOGGY is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xD84e102F474d244B38564927b5caD29DaAF79CCd);
    address payable private _twdmkt = payable(0xD84e102F474d244B38564927b5caD29DaAF79CCd);
    
    string private constant _name = "X DOGGY";
