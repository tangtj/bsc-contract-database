...
/*
  ...
  NFTulpar NFT Market
  NFTulpar Protocol is a deflationary token that aims to bring the NFT technology.
  
  Token Website : http://www.tulpar.tech
  NFT Website : www.tulpar.store
  Telegram Ch : https://t.me/NFTulparTP
                https://t.me/TanhuLink
                https://t.me/NFTulpar
  Telegram Group : https://t.me/NFTulparTechCoin
  Twitter : https://twitter.com/techNFTulpar
  Medium : https://medium.com/@NFTulparTech
  ...
  Tx Limit : 10.000.000.000 maximum NFTulpar per TX
...
contract NFTulpar is Context, IERC20, Ownable {
    ...
    string private _name = 'NFTulpar Store';
    string private _symbol = 'NFTulpar';
    uint8 private _decimals = 18;

    bool public LimitMode = false;
    uint256 _maxTransactionTokens = 10000000000000 * 10**18;
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256) {
        uint256 tFee = tAmount.div(500).mul(6);
