...
// Website: https://www.tripperpepe.fun/
...
contract TRIPPERPEPE is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x93A0B0eaC526F6Bf4fc9bAd0038500AA69b198ED);
    address payable private _twdmkt = payable(0x93A0B0eaC526F6Bf4fc9bAd0038500AA69b198ED);
    
    string private constant _name = "TRIPPER PEPE";
    string private constant _symbol = "TRIPE";
