...
contract CatPepe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x46e12bF3A8B5CF3CFf959585369a8Dd2c23C9cea); 
    address payable public Wallet_Dev = payable(0x46e12bF3A8B5CF3CFf959585369a8Dd2c23C9cea);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =500 * 10**6* 10**9 * 10**_decimals;
    ...
    constructor () {
        _owner =0x46e12bF3A8B5CF3CFf959585369a8Dd2c23C9cea;
