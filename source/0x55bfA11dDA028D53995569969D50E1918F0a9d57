...
contract phorak is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "phorak";
    string private _symbol = "$pho";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F01d966B1847FC66B1c082d852B039d718E6F8e); // Marketing Address
    address payable public teamWalletAddress = payable(0x6F01d966B1847FC66B1c082d852B039d718E6F8e); // Team Address
