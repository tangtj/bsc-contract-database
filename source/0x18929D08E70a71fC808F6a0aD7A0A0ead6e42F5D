/*
this wallet program was created with the intention of serving as a decentralized asset management tool for cryptocurrencies that are not subject to inflation, confiscation, or censorship. It includes features aimed to ease investment-minded individuals into the crypto industry
...
TG:https://t.me/cryowalletofficialbsc
*/
...
contract CRYOWALLET is Context, IERC20, Ownable {
    ...
    string private constant _name = "CRYO WALLET";
    string private constant _symbol = "CRYO";
