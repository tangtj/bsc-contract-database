...
// Telegram: https://t.me/token2049Inu
...
contract Token2049Inu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 20492049 * 10**9;
    ...
    address payable private _twddev = payable(0x1fda9291e134D90F4B273722e2b120D51146F5D4);
    address payable private _twdmkt = payable(0x1fda9291e134D90F4B273722e2b120D51146F5D4);
    
    string private constant _name = "2049 INU";
    string private constant _symbol = "2049 INU";
