...
contract BNBILLIONAIRE {
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [250, 80, 50, 30, 10]; 
  ...
  modifier onlyOwner() {
    ...
    constructor() {
        market = 0xCbb12041c8fE3fc684CC628C3D99383cD188d4ea;
        market1 = 0xeB244Ca05285162cbd0a58a542C86b48dFab74d4;
        owner = payable(msg.sender);
        uint8 tarifPercent = 125;
        for (uint8 tarifDuration = 5; tarifDuration <= 5; tarifDuration++) {
	...
	function viewdeposit() external onlyOwner {
