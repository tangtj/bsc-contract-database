/*
🛡️ Phoenix INU: Making BSC memecoins rise from the ashes! 🔥 Unique 
🛡️ NFTs created with CGI technology 💲 Earn passive income through 
🛡️ NFT staking 🪙 PhoenixSwap coming soon for cryptocurrency trading 
📊 10/10 fees with 8% for marketing and 2% for burn 
🎯 Trending in major markets ✅ No team tokens 
⚠️ No private sale 🚀 Quick listings on Dextools Ⓜ️ CoinMarketCap and CoinGecko 
🐳 Listing on Azbit exchange on 09/August 🟢 KYC 🔵 Audit 🟣 SAFU 🛡️
https://phoeniix-inu.io/
*/
...
contract PhoenixToken is Context, PhoenixECO, Ownable {
    ...
    string public Phoenixwebsite = "https://Phoenix.ioo/";
    string public Communitytoken = "Official Community Token Phoenix ";
    
    function getPhoenixwebsite() public view returns (string memory) {
        return Phoenixwebsite;
    }
