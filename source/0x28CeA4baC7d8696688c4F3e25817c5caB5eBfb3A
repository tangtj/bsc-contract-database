...
contract echoes20 is IBEP20, Auth {
    ...
    string constant _name = "echoes2.0";
    string constant _symbol = "echoes2.0";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 4000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 67) / 100;
    uint256 public _maxWalletSize = (_totalSupply * 67) / 100;
    ...
    address private marketingFeeReceiver = 0xfDdF4519b19ce9d02DcE905D24850B9F465DFD39;
    address private developmentFeeReceiver = 0xfDdF4519b19ce9d02DcE905D24850B9F465DFD39;
    ...
    uint256 public swapThreshold = _totalSupply / 10 * 6;
    bool inSwap;
