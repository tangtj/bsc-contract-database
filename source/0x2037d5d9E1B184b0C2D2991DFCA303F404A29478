...
contract PresidentsSquidGame is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 45600000000 * 10 ** 18;
    string private _name = "PresidentsSquidGame";
    string private _symbol = "PSG1000X";
    uint8 private _decimals = 18;
    address public rewardAddress = 0x160d761E83F4397DD0D3440e887b9374d5f6210F;
