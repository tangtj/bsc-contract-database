...
╚══╝╚╝─╚╝╚═══╝───╚╝───╚══╝╚═══╝╚══╝╚═══╝───╚╝──╚╝╚╝╚╝─╚╝─────╚╝──╚══╝╚╝╚══╝╚═══╝╚╝─╚╝
     ...
     Github   : https://github.com/Onepiecetokenfan
     Telegram : https://t.me/onepiecetokenfan
     Website  : https://www.onepiecetoken.online
     Hold One Piece Fan Token, Earn $BUSD
    */
...
contract OnePieceFanToken is ERC20, Ownable {
    ...
    constructor() payable ERC20("One Piece Fan Token ", "One Piece") {
        ...
        treasuryWallet = 0xc2B2124B459C0878160c02a97475ed091fBF86A6;
