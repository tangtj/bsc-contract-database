...
contract Pepe2024 is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PEPE 2024";
    string private _symbol = unicode"PEPE2024";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9E10C8B9eDa4820F27f9ffD0eb37aE850fC1a479);
    address payable private taxWallet2 = payable(0x9E10C8B9eDa4820F27f9ffD0eb37aE850fC1a479);
