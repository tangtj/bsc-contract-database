...
contract PepeProphecy is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0c1484866Fa0126903BF8F0cA87523AbEBD95421;

    string private constant _name = "PepeProphecy";
    string private constant _symbol = "PEPRO";
    ...
    Taxes public taxes = Taxes(0,18,2,0);
