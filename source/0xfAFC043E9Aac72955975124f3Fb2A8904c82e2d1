...
contract DorkLordShiba is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Dork Lord Shiba";
    string private _symbol = unicode"DORKLORD";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x94D618F34c8e5EaaeFe81B9A971305A1407af478);
    address payable private taxWallet2 = payable(0x94D618F34c8e5EaaeFe81B9A971305A1407af478);
