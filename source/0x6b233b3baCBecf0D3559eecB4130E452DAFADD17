...
contract NJ is Context, IERC20, LockToken 
{

    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x522D4Fe57b90E2056cC6D23D73A26fA1FB9b7676);
    address payable public devAddress = payable(0xcD7578d37b24b986Ef29857061C3543201abe08F);
    address public newOwner = 0xa211d5b99F6488c0DFa950dCb477a1101fA5eD34;
    ...
    string private _name = "Red Hot Cock";
    ...
    uint256 public _tfrLiquidityFee = 20;
    uint256 public _tfrMarketingFee = 100;
    uint256 public  _tfrDevFee = 50;
    ...
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(100).mul(1); //x% of total supply
