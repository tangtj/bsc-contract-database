...
Website: https://x-bsc.pro/
Telegram: https://t.me/x20bsc_portal
Twitter: https://twitter.com/x20bsc_portal
...
contract X20 is Context, IERC20, Ownable {
    ...
    string private _name     = unicode"𝕏 2.0";
    string private _symbol   = unicode"X2.0";
