...
/**
   ...
   Welcome to LITTLEFOX
   
   This is a community token. If you want to create a telegram I suggest to name it to @LITTLEFOXBSC
   ...
   90% burn to the black hole, with such big black hole and 1% fee, the strong holder will get a valuable reward

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #LITTLEFOX to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LITTLEFOX 10000X? 
   ...
   it's the best part of the #LITTLEFOX idea, increasing the liquidity pool automatically, 
