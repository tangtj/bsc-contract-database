...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09BF324DEd14B78a5491787b27D3BC148Cf11123; // owner address
...
contract HULK2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HULK 2049";
    string private _symbol = "HULK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09BF324DEd14B78a5491787b27D3BC148Cf11123); // Marketing Address
    address payable public teamWalletAddress = payable(0x09BF324DEd14B78a5491787b27D3BC148Cf11123); // Team Address
