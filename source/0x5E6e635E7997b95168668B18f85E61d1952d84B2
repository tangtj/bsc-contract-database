...
contract NEWORION is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1e9 * 10**_decimals;

    uint256 public genesis_block;
    uint256 private deadline = 1;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3D6109A36364cF6cd019d6437533902aE1f6BcA1;
    address private opsWallet = 0x3D6109A36364cF6cd019d6437533902aE1f6BcA1;
    address private devWallet = 0x3D6109A36364cF6cd019d6437533902aE1f6BcA1;

    string private constant _name = "NEW ORION";
    ...
    Taxes public taxes = Taxes(2, 5, 0, 2, 1);
    Taxes public sellTaxes = Taxes(2, 5, 0, 2, 1);
    ...
    constructor(address routerAddress) {
        ...
        //IRouter _router = routerAddress != address(0) ? IRouter(routerAddress) : IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
