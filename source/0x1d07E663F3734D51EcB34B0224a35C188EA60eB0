...
contract FLOKI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb1b4ACCA5F150A63b6Dd0cF50a235c9868620075); 
    address payable public Wallet_Dev = payable(0xb1b4ACCA5F150A63b6Dd0cF50a235c9868620075);
    ...
    string private constant _symbol = unicode"IKO˥Ⅎ"; 
    ...
    constructor () {
        ...
        _owner = 0xb1b4ACCA5F150A63b6Dd0cF50a235c9868620075;
