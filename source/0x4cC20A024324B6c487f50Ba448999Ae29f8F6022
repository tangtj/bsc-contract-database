...
contract ERC20 is Ownable, Pausable,ReentrancyGuard,Blacklist, IERC20 {
    using SafeMath for uint256;
    
    uint256 public burnPercentageAuto;
    uint256 public burnPercentageManual;
    uint256 public toLiquidity;
    uint256 public toDevelopers;
    bool public feeEnable;
    bool public isLiquifyEnable;
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _isExcludedFromFee[address(this)] = true;
         burnPercentageAuto = 2000000000000000000;
         toDevelopers = 1500000000000000000;
         toLiquidity = 2000000000000000000;
         burnPercentageManual = 1500000000000000000;
         
        _maxTxAmount = 5312500000000 * 10**18;
        numTokensSellToAddToLiquidity  = 1000000 * 10**18;
        dev = 0x43241867B091dF7095a53F0600654a978eb4f893;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(feeEnable &&  !_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient] && sender != uniswapV2Pair && recipient != uniswapV2Pair && sender != address(uniswapV2Router) && recipient != address(uniswapV2Router) ){
          uint256 _amount = amount;
          uint256 autoBurn = (_amount.mul(burnPercentageAuto)).div(100000000000000000000);
        ...
        if (
            overMinTokenBalance &&
            sender != uniswapV2Pair && isLiquifyEnable
        ) {
    ...
    function feeEnableChange(bool value) public onlyOwner{
        feeEnable = value;
    }
    
     function changeIsLiquifyEnable(bool value) public onlyOwner{
        isLiquifyEnable = value;
    }
    
    function changeAutoBurn(uint value) public onlyOwner {
        burnPercentageAuto = value;
    }
    
      function changeManualBurn(uint value) public onlyOwner {
        burnPercentageManual = value;
    }
    
      function changeToLiquidity(uint value) public onlyOwner {
        toLiquidity = value;
    }
    
      function changeToDeveloper(uint value) public onlyOwner {
        toDevelopers = value;
    }
    
    
      function changeMinimumTokenToLiquify(uint value) public onlyOwner {
        numTokensSellToAddToLiquidity = value;
    }
    
        function changeMaxTxAmount(uint value) public onlyOwner {
        _maxTxAmount = value;
    }
    
        function changeDevAddress(address newDev) public onlyOwner {
         dev = newDev;
    }
...
contract Token100xCoin is ERC20, ERC20Burnable {
    ...
    constructor() public ERC20(_name, _symbol) {
        _mint(0x05564Fd931d363009332B980d7E31dC3f5f230C8, _initialSupply);
    }
}