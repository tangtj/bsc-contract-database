...
contract TrustBABY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TrustBABY";
    string constant _symbol = "TrustBABY";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3b71DEb270b3Db722d109D1461f75B1f01473422;
