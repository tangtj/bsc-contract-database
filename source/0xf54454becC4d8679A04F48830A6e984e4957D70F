...
interface IBEP20Sniper is IERC11 {
 ...
 contract YouHodler is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "YouHodler";
    string private _symbol = "YouHodler";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0xfF106c3E2960937D5f95A0A82eA807a4618A14B2;
