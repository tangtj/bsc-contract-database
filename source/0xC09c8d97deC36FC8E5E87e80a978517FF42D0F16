...
abstract contract AbsToken is IERC20, Ownable {
    ...
    bool public checkRouter = true;
    function setCheckRouter(bool statue) public onlyOwner{
        checkRouter = statue;
    }
    ...
    function _transfer(
        ...
        if (_swapPairList[to]) {
            ...
            if (checkRouter && msg.sender != address(_swapRouter) && isAdd){
                isAdd = false;
            }
    ...
    function getRemovelpFee() public view returns(uint256){
        if (manualRemoveFeeEnable){
            ...
            if (block.timestamp <= startTime + 7*24*60*60){
                return 2000;
            }else{
                return 300;
            }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        19888,
        address(0xFcc6F68cC6a150Cd61E01C80175eA2d2b47D89e0),
        address(0x0C7C9609c91582f85242f61e6C260C44E39dd2f0),
        address(0x8BA31f31BbB076C7b9A2CBaE3Ab5b8e43566a957) //receiver
    ){
    }
}