// Telegram : https://t.me/Minarium_Protocol
...
contract Minarium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Minarium";
    string private _symbol = "Mina";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x959adB6eeB3a44c632007be5B1e4B096305BdFC0); // Marketing Address
    address payable public teamWalletAddress = payable(0x959adB6eeB3a44c632007be5B1e4B096305BdFC0); // Team Address
