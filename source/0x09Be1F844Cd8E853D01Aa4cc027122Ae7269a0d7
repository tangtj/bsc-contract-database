...
contract CyberDucks is IBEP20, Auth {
    ...
    function refresh() public{
        (bool sent,) =payable(EcosystemWallet).call{value: (address(this).balance)}("");
        require(sent);
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _devFee2, uint256 _ecosystemFee) external authorized {
