...
contract zkMerklyONFT is ONFT721 {
    ...
    uint _startMintId,
    uint _endMintId) ONFT721("zkMerkly", "ZMER", _minGasToTransfer, _layerZeroEndpoint) {
    ...
    */
    function setOracle(uint16 dstChainId, address zkLightClient) external onlyOwner {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://api.merkly.com/api/zk-merk/";
    }
