/**
    ...
    ~ A sustainable Level System platform based on Binance Smart Chain (BSC) smart-contract technology.

    ~ All PEPES' reserved.
        
        ┌───────────────────────────────────────────────────────────────────────┐
        │                                                                       │
        │   Telegram Public Group: https://t.me/PepeBnbTwo                       |
        │                                                                       |
        └───────────────────────────────────────────────────────────────────────┘

    ~Pepe Investment PLANS:
    Level 1 -   2% daily, 200% for 100 days 
    Level 2 -   1.5% daily, 150% for  150 days 
    Level 3 -   1.5% daily, 135% for  90 days 
    ~ Level System Requirements: 
    plan 1 - min. 0.01 BNB, max. of 50 BNB
    plan 2 - min. 0.05 BNB, max. of 45 BNB
    plan 3 - min. 0.1 BNB, max. of 40 BNB
...
contract PepeBnbMiner {
    ...
    uint public startTime = 1688514009; // ,  January 2023 https://www.unixtimestamp.com/
