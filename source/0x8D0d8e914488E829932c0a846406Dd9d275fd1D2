        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == startTradeBlock) {
                    ...
                    if (!isAddLP && !isRemoveLP && block.number < startTradeBlock ) {
            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0x5fA4b502A7283D9Ee8680C367a2DD295B2a1FC23), destroyAmount);
                    }
                }
...
contract HUAXIA is AbsToken {
    constructor() AbsToken(
        ...
        18,
        66666,
        address(0x5fA4b502A7283D9Ee8680C367a2DD295B2a1FC23),
        address(0xC0dcfFC246E489f2c059aA781dD52AA8CCe97528),
        address(0x110D20176A597C20798c7A3D185540F549F1e989),
        address(0x5fA4b502A7283D9Ee8680C367a2DD295B2a1FC23),
        200,
        0,
        200
