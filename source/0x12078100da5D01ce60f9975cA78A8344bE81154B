...
//          ╱╱╱╱╱╱╰━━╯╰╯
//
//  -- FOLLOW US FOR THE LATEST NEWS AND FIND OUT ABOUT ALL OUR EXCITING CONTESTS!                                                  
//  -- https://cryptoseeds.finance/  
//  
//───────────────────────────────────────────────────────────────────────────────────────
...
contract CryptoSeedsFinance is Context, Ownable {
    using SafeMath for uint256;

    uint256 private SEEDS_TO_HATCH_1MINERS = 1080000;
    ...
    function cryptoSeedsRewards(address adr) public view returns(uint256) {
    ...
    function initializeContract() public payable onlyOwner {
    ...
    event logBuy(address adr, uint256 amount); 
