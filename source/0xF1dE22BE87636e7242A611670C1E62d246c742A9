...
Big Eyes Coin ($BIG) is a new cat-themed meme coin that aims to build a community as strong 
as those of the DOGE and SHIB tokens while championing sea-life conservation through a set treasury.

Get in Early, Ride the wave, and Reap the rewards!🚀💰

📲Tg : https://t.me/+IYUDG85uJKdjMzg1
**/
...
contract BIGEYESCOIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BIG EYES COIN";
    ...
    address payable public DevWallet = payable(0xB3cD21f80193C1aA430897998Fa1dBD9dEc96010);
    address payable public MarketingWallet = payable(0x5ee6167baaB52380F1F75ed266d9693B89E1F3c1);
