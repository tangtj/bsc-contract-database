...
contract strike is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 1_000_000 * (10**_decimals);
    string private constant _name         = "strike";
    ...
    uint16 private _taxSharesDevelop = 20;
    ...
    address payable private _walletDevelop = payable(0xcdcc595BbF2eCD11cF6Ccc85879D09D8Cb1ad1aa); 
