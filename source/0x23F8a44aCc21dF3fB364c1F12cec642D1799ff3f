/**
    ...
    BIRNFLEC
    Telegram: https://t.me/ReflecPortal
    Developer: @imcja on Telegram

    This.is the BitBurnReflect token of the Reflec Ecosystem.
    This.tokens marketing will be provided by Reflec.
    This.tokens ecosystem will be evolving, stay in the TG -
    This.ecosystem will keep growing - just watch.
    Each.Reflection token will have a an improved, more evolved contract
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x8B6bF63e2b1C221dC0Fb01AE85868b83dDee1B54);
...
contract BIRNFLEC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BBR Reflec";
    string constant _symbol = "BIRNFLEC";
    ...
    // If this line is here and its not BBRR3f13c someone made this who is not a d3v
