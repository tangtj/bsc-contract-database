...
contract BabyStellar is ERC20, Ownable {
    ...
    mapping (address => bool) private _isXLMExcluded;
    mapping (address => bool) private _isBabyStellarExcluded;
    ...
    constructor() payable ERC20 ("Baby Stellar", "BabyXLM") {

        rewardToken = 0x43C934A845205F0b514417d757d7235B8f53f1B9;
        ...
        marketingWallet =  0xfF5e0bF39249F182B096Fce6A7a87C22687b4f60;
        ...
        _isWalletExcluded[0xfF5e0bF39249F182B096Fce6A7a87C22687b4f60] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 1000000000 * 7777;
    }
