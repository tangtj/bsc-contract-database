...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCd355e3A08843736d1EEC48224aA54988C53100b;
...
contract YoungGuns is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x285d0C039217572a24235D3Cb29a7c02a8F78354;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "YoungGuns";
    string private _symbol = "YoungG";
