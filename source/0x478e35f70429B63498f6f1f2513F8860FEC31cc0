...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xcB64C67AfFB40F3256B758CFC8A1De8F5884C221;
...
contract WZT is AbsToken {
    constructor() AbsToken(
        ...
        address(0x4446148907440004333581CC725DE211153AFbf8),
    
        address(0x128b50CADa07F63F01Cb7e47f56b8cccE9005Fb9)
    ){
