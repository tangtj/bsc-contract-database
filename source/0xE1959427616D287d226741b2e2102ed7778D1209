...
contract PepeFineTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ejjjgf64;
    ...
    string private _tokenname = "PepeFine";
    string private _tokensymbol = "PepeFine";
