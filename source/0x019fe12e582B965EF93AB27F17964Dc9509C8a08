...
contract JinGuBang is ERC20, Ownable {
    ...
    address private  marketingWallets = payable(0x3E9afc33d3Ee735001c3C94d121Ad1433D37D777);
    address private  devWallets = payable(0xe35380A4E5e4D35CFd232f5A09B67DD28Fb3231B);
