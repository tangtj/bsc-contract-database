        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xDc15C16aEC3c4a59f257778fbA6F9E3D806c0A92), block.timestamp
                );
            }
        }
    }
...
contract coin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1888,//Supply
        address(0x839e48711c5E3E820de3658b981664d85795BAce),//FundAddress
        address(0xDc15C16aEC3c4a59f257778fbA6F9E3D806c0A92)//ReceiveAddress
    ){
    }
}