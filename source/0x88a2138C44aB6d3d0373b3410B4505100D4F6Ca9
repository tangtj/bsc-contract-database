// Telegram: https://t.me/declinknetwork
// Website: https://declinknetwork.site/
...
Declink is a one-stop solution for asset exchange on Polkadot, consolidating all the functionalities of parachain DEXes.
...
contract DeclinkNetwork is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DECLINK NETWORK";
    string private constant _symbol = unicode"$DEC";
    ...
    address payable public DevWallet = payable(0xd16d1eA7ceCb822CbDdCeD46529D10fd8b71e02A);
    address payable public MarketingWallet = payable(0x422294C6D6D5f442988c4C6DF1693ee29a865cc5);
