...
pragma solidity ^0.8.0;
contract DaiTorrent is ERC20, Ownable {
    ...
    constructor() ERC20("Dai Torrent", "DTT") {
        _mint(msg.sender, 297000000*10**decimals());
        _mint(address(this), 693000000*10**decimals());
        startSale(block.number, 999999999,0,1000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,900*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
