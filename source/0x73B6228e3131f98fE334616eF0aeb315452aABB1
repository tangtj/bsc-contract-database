/**
    ...
    https://t.me/TomBradyCoin
    
    5% liquidity
    4% DDS tax (devs, do something!)
    3% reflections
...
contract TomBrady is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xFa9a718584d6E333b9490b9c0C5d886Dad22923A;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Tom Brady";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 100;
