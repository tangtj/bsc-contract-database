...
contract TEST9 is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "TEST9";
    string private constant _symbol = "TES9";
    ...
    address payable constant private _marketingAddress = payable(0x55c0c4bC1A05164C687b9Ceb349EC9a15c5565D0);
    address payable constant private _buybackAddress = payable(0x2dCBc7b1765aA09a9CE1Ce3b9C9e3D7F22478165);
    address payable constant private _projectMaintainence = payable(0x98AA92Be818C13476169049D18201c8aE2C32b77);
