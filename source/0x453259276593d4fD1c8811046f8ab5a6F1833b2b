...
✅ Website : https://bluepepe.vip/
✅ Telegram : https://t.me/bluepepepe
✅ Twitter : https://twitter.com/bluepepeof

// tax: 10/10 (3% rewards in XRP)
...
contract bluepepe is ERC20, Ownable {
    ...
    constructor() payable ERC20("Blue Pepe", "BPP") {

        rewardToken = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; // XRP-BEP20
        ...
        treasuryWallet =  0x67377cCDdD42662E2367dc0476FeA581742F6539;

        dividendTracker = new DividendTracker(1e9, rewardToken);
        ...
        _mint(treasuryWallet, 1e12 * (10 ** 9));
