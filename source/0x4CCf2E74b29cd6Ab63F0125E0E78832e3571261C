...
contract Blithe is IERC20 {
    ...
    string constant private _name = "Blithe";
    string constant private _symbol = "BLT";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xf98261C679264EC50143fE38571DCB1477b2b4fB),
        development: payable(0x6904765828Ec970A6f48c08ABa7E5b772a947f2f),
        team: payable(0x6904765828Ec970A6f48c08ABa7E5b772a947f2f)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 development, uint16 marketing, uint16 team) external onlyOwner {
        _ratios.development = development;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.totalSwap = development + marketing + team;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable development, address payable team) external onlyOwner {
        require(marketing != address(0) && development != address(0) && team != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (developmentBalance + teamBalance);
