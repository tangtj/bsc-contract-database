...
contract FARMER is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1e1 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x2Df71983aB18b66A4e825E0107BD193Bf4491463;
