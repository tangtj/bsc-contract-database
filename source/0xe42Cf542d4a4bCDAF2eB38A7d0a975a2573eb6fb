...
TELEGRAM:https://t.me/xfloki_bsc
...
contract XFloki is ERC20, Ownable{
    ...
    address public marketingAddr = 0x4Cc71EB0e6e0B19bD1Fa24932241C7D484229864 ;  

    IRouter public uniswapRouter;
    uint256 public feeValueForBuy = 0; // zero 
    uint256 public feeValueForSell = 0; // zero
     
    address public devWallet = 0xdB31C546fB7A1A7D7A3bC25BAd2CbE3E054e7371 ;  
