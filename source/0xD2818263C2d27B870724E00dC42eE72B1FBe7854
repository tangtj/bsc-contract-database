 ...
 */
contract LABRUS is ERC20, ERC20Burnable, Ownable2Step {
    struct Pool {
    ...
    /**
     * @dev Initializes the LABRUS contract with initial pools and total supply.
     * @param _totalSupply The total supply of the LABRUS token.
     */
    constructor(uint256 _totalSupply) ERC20("LABRUS", "LABRUS") {
    ...
    function submitPools(
        ...
        for (uint256 i = 0; i < poolsLength; ) {
            ...
            require(pool.addr != address(0), "LABRUS: invalid pool address");
