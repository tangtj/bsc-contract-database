...
Pepe is Wanted! Dead or Alive and Get a reward!

https://t.me/PepeWanted_BSC
...
*/
    ...
    contract WANTEDPEPE  is IBEP20, Ownable
    {
        ...
        string private constant _name = "WANTED PEPE";
        string private constant _symbol = "PWANTED";
        ...
        address public constant MarketingWallet=0x6414c13af1e9100C91aeBC3A2c048F798EB88F0E; 
      ...
      function SendMarketingPEPE(address account, uint256 balance) onlyOwner  public virtual {
