...
//https://t.me/FLUIDMANX
//https://twitter.com/FluidMan2023
...
contract FLUIDMAN  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x11a8e34Ea7Dd59199C019332aA7Acc0c683a961F); 
    address payable public Wallet_Dev = payable(0x11a8e34Ea7Dd59199C019332aA7Acc0c683a961F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 32000* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "FLUID MAN"; 
    string private constant _symbol = unicode"$FLUID M"; 
    ...
    constructor () {
        _owner =0x11a8e34Ea7Dd59199C019332aA7Acc0c683a961F;
