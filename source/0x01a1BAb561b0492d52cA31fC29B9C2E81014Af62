...
contract ShibaBTC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100e11 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 25_000_000_001 * 10**_decimals;
    
    uint256 public maxSellAmount = 100_000_000_001 * 10**_decimals;
    uint256 public maxBuyAmount = 100_000_000_001 * 10**_decimals;
    uint256 public maxWalletBalance = 100_000_000_001 * 10**_decimals;

    address public marketingAddress; 
    address public devAddress;
    address public devaddress1;

    string private constant _name = "ShibaBTC";
    string private constant _symbol = "ShibBTC";
    ...
    Taxes public sellTaxes = Taxes(0,0,20,0);
