...
// TELEGRAM : https://t.me/DollariumBSC

// Website : https://www.dollarium.online/

// Dollarium Token: The Future of Digital Currency

Unlocking New Possibilities in the Crypto Universe
...
contract Dollarium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dollarium";
    string private _symbol = "Dollarium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x089103bb2F89a6342E52f1dD5D30e4F0ddE19CfB); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x3391b0190AFD387152D0c3721c535FF6e23F7bb1); // Development Address
