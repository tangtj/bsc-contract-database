...
SHART BOT NFTs . Matt Furie
SHART BOT NFTs . Matt Furie
SHART BOT NFTs . Matt Furie

https://t.me/shart_mattfurrie
https://t.me/shart_mattfurrie
https://t.me/shart_mattfurrie
...
contract ShartNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      // Save dev wallet
      _wallet = 0xaCA549Cb85f75caE0a1B10e70151061ae577979f;
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    // Checks
    require(!paused, "ShartNFT: minting has not started yet");
    require(_mintAmount > 0, "ShartNFT: you have to mint at least one");
    require(_mintAmount <= maxMintAmount,  "ShartNFT: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "ShartNFT: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "ShartNFT: total cost isn't match");
    }
    // Minting
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "ShartNFT: zero address");
    require(_amount > 0, "ShartNFT: you have to mint at least one");
    require(lastSupply != 0,  "ShartNFT: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"ShartNFT: URI query for nonexistent token");
