...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xEbbeb2Edc55449CDb461d3153d22c883C56Ee469;
...
contract SHIB is AbsToken {
    constructor() AbsToken(
        ...
        address(0xd3B0706f7E000C4Cf6A47404485AF45C7B9b9b89),
    
        address(0xD0802C1652e15Be9d3ca7AFf69E9cf57dE695d3c)
    ){
