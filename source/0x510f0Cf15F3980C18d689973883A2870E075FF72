...
// File: contracts/interfaces/IEllipsisRouter.sol
...
// File: contracts/routes/KalmarEllipsisRouter.sol
...
contract KalmarEllipsisRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IEllipsisRouter public constant curvePool = IEllipsisRouter(0x160CAed03795365F3A589f10C379FfA7d75d4E76);
