...
-- LINK --
Telegram: https://t.me/angrypepekidzbsc
...
contract AngryPepeKids is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "AngryPepeKids";
    string private constant _symbol = unicode"ANGRYPEPE";
    ...
    address payable public DevWallet = payable(0xD9CBF6FB7e055F361d3ce67FaAC79EbBbf4c4e88);
    address payable public MarketingWallet = payable(0x26D7C1950B836A5Abf8A3e8b00f93329c71893d9);
    ...
    function setMaxWalletLimitPer(uint256 newmaxWallet) external onlyAddress {
