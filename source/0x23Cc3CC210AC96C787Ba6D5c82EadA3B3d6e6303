...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 30000 * 10**18;
    string private _name = "EC";
    string private _symbol = "EC";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xf9FBC3673b19c25b4CE718D16c09fFd0f0920B87);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 30000 * 10**18;
