...
contract venture is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Venture";
    string private _symbol = "VTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x511491a0B2EaD2ac23E67c43C5e6FB8726a2DB56); // Marketing Address
    address payable public teamWalletAddress = payable(0x511491a0B2EaD2ac23E67c43C5e6FB8726a2DB56); // Team Address
