...
contract RabbitMoonTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public wjjaks8;
    ...
    string private _tokenname = "RabbitMoon";
    string private _tokensymbol = "RabbitMoon";
