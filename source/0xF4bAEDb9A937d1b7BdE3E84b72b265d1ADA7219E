/**
   Welcome to Profit Engine. Hold FUEL tokens 
   to earn rewards on a weekly basis, as well 
   as exponential long-term growth.
  TELEGRAM: https://t.me/ProfitEngineToken
*/
...
contract ProfitEngine is Context, IBEP2022, Ownable {
