...
// TELEGRAM : https://t.me/pepilloportal
...
contract Pepillo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " Pepillo";
    string private _symbol = "PIO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x3E7BdC91c9425dF3b8254Be3d694E0AF4fBb7E54);
    ...
    uint256 public _totalTaxIfBuying = 26;
    ...
    uint256 public _walletMax = 8400000000000 * 10**_decimals;
    ...
    function setTeam(address newAddress) private  onlyOwner {
        Team = payable(newAddress);
    }
...
address payable private Team =
        payable(0xaA2e8d3f96e010FF1d3B0E5af098301201C2cBB5);
