...
// Telegram: https://t.me/dexviewsniper_bot
...
contract DexViewSniperBot is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x10c901e0383F290590eF6Afab7716faeb67253cC);
    address payable private _twdmkt = payable(0x10c901e0383F290590eF6Afab7716faeb67253cC);
    
    string private constant _name = "DexViewSniperBot";
    string private constant _symbol = "DVSB";
