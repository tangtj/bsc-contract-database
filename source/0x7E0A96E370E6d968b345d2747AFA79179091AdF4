...
//TG Community - https://t.me/buildnetworkofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52C4E3f9692307e80D6d0D84BC0703Af8f2ECc1e;
...
contract Buildnetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUILD NETWORK"; // 
    string private constant _symbol = "BUILDNET"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0x52C4E3f9692307e80D6d0D84BC0703Af8f2ECc1e);
