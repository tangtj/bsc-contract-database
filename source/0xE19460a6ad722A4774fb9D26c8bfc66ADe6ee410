...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0799cc7cb9F0efB0492B4E65828Ff5C73A2E4f91 ; // owner address
...
contract DODO  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x162Def6962E21eA81Cb4EF3E0233822ff28f6021); 
    address payable public teamWalletAddress = payable(0x162Def6962E21eA81Cb4EF3E0233822ff28f6021);
