/**
Telegram : https://t.me/OnePieceVerify
Website :https://onepiece.cash
*/
...
contract ONEPIECE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4223282cDD2729397f02263343eB611eFe47f612); 
    address payable private Wallet_Dev = payable(0x4223282cDD2729397f02263343eB611eFe47f612);
    ...
    string private constant _symbol = unicode"One Piece"; 
    ...
    constructor () {
        ...
        _owner = 0x4223282cDD2729397f02263343eB611eFe47f612;
