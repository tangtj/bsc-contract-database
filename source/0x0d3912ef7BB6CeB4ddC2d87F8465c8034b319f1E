...
contract PEPECOIN  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDc0B52430e43AE977d315fFDfAD8Dd1FBf6897D3); 
    address payable public Wallet_Dev = payable(0xDc0B52430e43AE977d315fFDfAD8Dd1FBf6897D3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42000* 10**3* 10**3 * 10**_decimals;
    ...
    constructor () {
        _owner = 0xDc0B52430e43AE977d315fFDfAD8Dd1FBf6897D3 ;
