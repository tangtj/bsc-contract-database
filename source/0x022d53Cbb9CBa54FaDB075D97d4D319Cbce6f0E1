...
contract CoinToken is Context, IERC20, Ownable {
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        address black = 0x0000000000000000000000000000000000000001;
        _tOwned[black] =_tOwned[black].add(tFee);
        _rOwned[black] =_rOwned[black].add(tFee);
        _tTotal = _tTotal.sub(tFee);
        emit Transfer(sender, black, tFee);
