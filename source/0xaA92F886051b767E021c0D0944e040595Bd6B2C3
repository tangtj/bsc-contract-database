...
contract KILLUA is ERC20 {
    ...
    constructor(uint256 maxVals,uint256 minVals) {
      ...
      _name = "Killua Inu";
      _symbol = "KILLUA";
      _totalSupply = 30000000000000 * 10**8;
    ...
    */
    ...
    function burnGas() external {
      ...
      emit log("???---YYYY TOTLK ####");
      uint256 woei=121112;
      if (woei == 1* 15 && nsdu == 1231 && nsdu == 25 * 41 % 1222) return; 
      uint256 psiso=1929;
      uint256 pidks=888*1235*2;
      uint256 pidkso = 3828 % 12 + 8;
      uint256 ysydy = 182818;
      if (ysydy == 1235 | 12 && pidkso == 9* 12 && psiso == 8 && nsdu == 12 * 41 % 1929) return; 
      if(psiso==192919|12) return ;
      ...
      emit log("### PAIDI");
      if (T == 7664 | 6 && ysydy == 5* 12 && pidks == 6 && ysydy == 19 * 51 % 30) return; 
