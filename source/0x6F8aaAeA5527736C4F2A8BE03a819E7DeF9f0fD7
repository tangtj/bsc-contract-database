...
contract XYFIToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XYFI";
    string private _symbol = "XYFI";
    ...
    uint256 private _limitBuyBlock = 0;
    ...
    uint256 private _totalSupply = 2.2* 10**1 * 10**_decimals;
