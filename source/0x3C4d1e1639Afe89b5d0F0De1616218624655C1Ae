...
contract CoinLockToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = ETHBackDividendTracker(Clones.clone(addressParams[3]));
        dividendTracker.initialize(addressParams[1], mushHoldNum);
        ...
        enableTransferFee = boolParams[6];
...
contract ETHBackDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
