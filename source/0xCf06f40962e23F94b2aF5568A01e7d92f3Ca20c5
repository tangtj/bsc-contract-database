...
contract AKFAFarm is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'AKFA Farm';
    string  private constant _SYMBOL = 'AKFA';
    ...
    uint256 private _tTotal = 11000 * _DECIMALFACTOR;
