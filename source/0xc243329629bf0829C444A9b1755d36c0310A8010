...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 2100 * 10**18;
    string private _name = "DFW";
    string private _symbol = "DFW";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xFF3069E4f700bBcE0f8f16cC2df08030CA95e457);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 2100 * 10**18;
