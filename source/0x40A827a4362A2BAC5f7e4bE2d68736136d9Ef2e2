...
contract BoneInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "BONE INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA65823c57FEA3dD18784771729DdcA435A073829); 
    address payable public teamWalletAddress = payable(0xA65823c57FEA3dD18784771729DdcA435A073829);
