...
pragma solidity ^0.6.12;
    ...
    contract BRX is Context, IBEP20, Ownable {
        ...
        string private _name = 'Bartercoin';
        string private _symbol = 'BRX';
        ...
        uint256 private _maxTxAmount = 2500000000e18;
        // We will set a minimum amount of tokens to be swaped => 50K
        uint256 private _numOfTokensToExchangeForCharity = 50000  * 10**18;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 25000000e18 , 'maxTxAmount should be greater than 25000000e18');
