...
contract Poopies is Context, IERC20, Ownable {
    using Address for address;
    //Contract Update Information
    string public constant contractVersion = "3.3";
    string public constant contractDev = "Him";
    string public constant contractEdition = "SAFU";
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x879c4E09d3E261a2D2363aF9A8c55875C2366aEf);
    //adding Safu wallet to send supply and exclude from fees.
    address payable public safuWallet =
        payable(0xB6c2d602278b33449D533B24a7d93646d0Fa2979);
    ...
    //Token Definition.
    string public constant name = "Poopies";
    string public constant symbol = "PPIE";
...
//What is my router and exclude pinksale locker.
        ...
        if (block.chainid == 56) {
            ...
            safuWallet = payable(0xB6c2d602278b33449D533B24a7d93646d0Fa2979);
    ...
    function recoverTokensFromContract(
        ...
        emit AuditLog("We have Enabled Trading and Automatic Swaps:", msg.sender);
    }
