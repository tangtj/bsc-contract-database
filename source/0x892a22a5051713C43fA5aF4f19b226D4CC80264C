...
contract NineDollarLp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"9$ LP";
    string private _symbol = unicode"9$LP";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9340d796C181513167cE51820f5d695c2eeD5657);
    address payable private taxWallet2 = payable(0x9340d796C181513167cE51820f5d695c2eeD5657);
