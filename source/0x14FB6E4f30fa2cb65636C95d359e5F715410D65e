...
contract Rasabot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rasa";
    string private _symbol = "Rasa";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc96A55f7dA4A152D1Be66492a88b280faB7Dbf66); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 8; // 8% BUY TAX
    uint256 public _totalTaxIfSelling = 8; // 8% SELL TAX
