...
// TELEGRAM : https://t.me/boltprotocol
// WEBSITE  : http://www.boltprotocol.live
...
contract BoltProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Bolt Protocol";
    string private _symbol = "BOLT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xb9196d2aff81622dd6773eB97abA02308Df34336);
