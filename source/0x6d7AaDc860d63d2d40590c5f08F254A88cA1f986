...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _walletMax = 5 * 10**17;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isRemove) {
                if (_preLPList[recipient] && _releaseLPStartTime > 0) {
...
contract BFDOGE is AbsToken {
    constructor() AbsToken(
        ...
        18,
        188,
        address(0xEDB65C5F52ac47024342E84d7730D88A683345b2),
        address(0xfb113AA36099c34AD1Bf2374454a1E2e86A6AA4D),
        0
    ){
