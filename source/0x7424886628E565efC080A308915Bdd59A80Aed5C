...
// Telegram: https://t.me/NOBODY_BSCE
...
contract NOBODY is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x06AB0DAf94aD8cAc434A9C6D7d5CFFB773C9ad73);
    address payable private _twdmkt = payable(0x06AB0DAf94aD8cAc434A9C6D7d5CFFB773C9ad73);
