...
contract HEXACHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "HEXACHAIN Coin";
    string private constant _symbol = "HEXACHAIN";
    ...
    constructor () {
        ...
        _isIncludedFromFee[0xb9F0b1bc7A97736D202d88De1D7266b912d3a608] = true;
