...
contract MONEY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE75816a8883a57BA2b8dDD08C60002E5964eDa48); 
    address payable public Wallet_Dev = payable(0xE75816a8883a57BA2b8dDD08C60002E5964eDa48);
    ...
    constructor () {
        _owner =0xE75816a8883a57BA2b8dDD08C60002E5964eDa48;
