...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x56533550E928aB4C4d0052C782077215FBcAF5Bf;//
...
contract TREE is AbsToken {
    constructor() AbsToken(
        ...
        unicode"FC-TREE",//Name
        unicode"FC-TREE",//Symbol
        9,//Decimals
        10000,//Supply
        address(0xA9B0Ba715a6E70791363C9832EBE5f8c34e2B7d8),//FundAddress
