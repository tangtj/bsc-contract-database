...
contract WINNINGDAY is IERC20, Ownable {
    ...
    constructor() {
        ...
        fundAddress = address(0x815300ee1219cC51E10A7989706Bdb2Fefeee64d);
        currency = address(0x55d398326f99059fF775485246999027B3197955);
        ISwapRouter swapRouter = ISwapRouter(address(0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8));
        initialAddress = address(0x815300ee1219cC51E10A7989706Bdb2Fefeee64d);
        ...
        partnerRewardCondition = 1 * 10**17;
        rewardHat = 10**17;
        partnerRewardAmount = 10**16;
        SwapRewardCondition = 1000 * 10**18;
