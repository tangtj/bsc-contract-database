...
Wallet App : https://play.google.com/store/apps/details?id=com.vynksafe.app
...
Website : https://exchange.vynksafe.com/
TG:https://t.me/VYNKSAFEEXCHANGE
*/
...
contract VYNKSAFEEXCHANGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "VYNKSAFE EXCHANGE";
    string private constant _symbol = "VYNK";
