...
contract BNBDRAGON is Context, IERC20, Ownable {
    ...
    string private _name = "BNB Dragon Inu";
    string private _symbol = "BNBDRAGON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3acce389D189fbA44065D31a4703a31Ad34c3fF2); // Marketing Address
    address payable public buybackWalletAddress = payable(0x3acce389D189fbA44065D31a4703a31Ad34c3fF2); // buyback Address
