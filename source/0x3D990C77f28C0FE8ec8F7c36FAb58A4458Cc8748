        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x0586Cd8ac25A5b15F67086f6179f1e1AfeE4d194), block.timestamp
                );
            }
        }
    }
...
contract fistcoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0xb321c0aFd826599f7428c73Ec69339cf61f7350A),//FundAddress
        address(0x0586Cd8ac25A5b15F67086f6179f1e1AfeE4d194)//ReceiveAddress
    ){
    }
}