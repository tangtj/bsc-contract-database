...
contract Xatoshi is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xf5C63290769565B01eE14cBe9A06Be1095b275E3);

    string public _name = unicode"𝕏ATOSHI";
    string public _symbol = unicode"𝕏AI";
