/**	 	
    https://t.me/BALD3ONBSC
    http://www.baldcoinbase.xyz/
    https://twitter.com/http://baldcoinbase.xyz/
*/
...
contract BALD3 is ERC20, Ownable {
    ...
    constructor() ERC20("BALD3.0", "BALD3.0") {
        address router;
        if (block.chainid == 56) {
        ...
        devWallet = address(0x916fDFcBaD3f0fa6709f6E0c2aa6145f59ba8E3A);
        lpWallet = msg.sender;
