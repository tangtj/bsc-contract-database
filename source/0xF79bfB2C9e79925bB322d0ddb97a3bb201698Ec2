...
contract DOGEPAL is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5fE1D166342be438dA79F1548E3CEFb0D96751fd); 
    ...
    uint256 public _maxTransactionAmount = 100000000000000000; 
    uint256 public minimumTokensBeforeSwap = 10000000000; 
    uint256 public _walletMax = 100000000000000000;
