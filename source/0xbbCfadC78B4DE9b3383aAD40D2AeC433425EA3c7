...
contract YES is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"YES2049";
    string private constant _symbol = unicode"YES2049";
    ...
    address payable private _developmentAddress = payable(0x79FC022Db4801fEeADF7d5676dc255a7ED95A9cE);
    address payable private _marketingAddress = payable(0x79FC022Db4801fEeADF7d5676dc255a7ED95A9cE);
