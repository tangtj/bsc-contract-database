/**
INSUREFI is a new type of protocol in blockchain.
*/
...
contract InsureFI is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 address _marketingAdr = 0x67E8Ec830DeaDb6B3eFCb620d455f170A35c4B92;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string constant _name = "Insure Finance";
 string constant _symbol = "INSUREFI";
 uint8 constant _decimals = 7;
 uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
 uint256 public _maxTxAmount = _totalSupply * 1 / 100;
 //max wallet holding of 100000000000% 
