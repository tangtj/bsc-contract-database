...
contract JunInu is Context, IERC20, Ownable {
    ...
    string private _name = "JunInu";
    string private _symbol = "JUN";
    ...
    address payable public marketingWallet = payable(0xa2F58315a0077B77f6455CaA1309D0120E381e1F);
