...
contract PUKTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dnmcav56;
    ...
    string private _tokenname = "Punk Rabbit";
    string private _tokensymbol = "PUK";
