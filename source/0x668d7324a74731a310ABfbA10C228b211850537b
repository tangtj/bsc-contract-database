/**
    Telegram : https://t.me/pepewitchportal
...
contract PepeWitch is ERC20, Ownable {
    ...
    constructor() ERC20("PepeWitch", unicode"PepeWitch") {
        ...
        maxTransactionAmount = 3000 * 1e7 * 1e18; 
        maxWallet = 3000 * 1e7 * 1e18;  
        ...
        devWallet = address(0x78e0a084EBc5Bf29Bfc566Adaf0D4360C4e966a5); 
