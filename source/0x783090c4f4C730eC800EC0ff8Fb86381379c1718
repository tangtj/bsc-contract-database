...
contract FOLDTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tsahhg7;
    ...
    string private _tokenname = "FOLD";
    string private _tokensymbol = "FOLD";
