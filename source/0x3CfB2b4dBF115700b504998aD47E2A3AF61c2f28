...
contract BOBBY is ERC20, Ownable {
    ...
    BOBBYDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BOBBY", "BPY") {
        marketingWallet = payable(0xaFe3488E739c60214664152f17ba2Cb7564A22F0);
        devWallet = payable(0xaFe3488E739c60214664152f17ba2Cb7564A22F0);
        ...
        dividendTracker = new BOBBYDividendTracker(
            payable(this),
            router,
        ...
        swapTokensAtAmount = totalTokenSupply / 200000000; // 0.05%;
...
contract BOBBYDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        BOBBYContract = BOBBY(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BOBBY_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BOBBY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BOBBY contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BOBBYContract);

            uint256 prevBalance = BOBBYContract.balanceOf(address(this));
            ...
            {
                uint256 received = BOBBYContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BOBBYContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
