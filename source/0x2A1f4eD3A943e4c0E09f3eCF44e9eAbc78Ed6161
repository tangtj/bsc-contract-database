...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3880c5762331E5a3f372146637DB2fDe820ad505; // owner address
...
contract OxChain is Context, IERC20, Ownable {
    ...
    string private _name = "0x Chain";
    string private _symbol = "0xC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3880c5762331E5a3f372146637DB2fDe820ad505); // Marketing Address
    address payable private teamWalletAddress = payable(0x3880c5762331E5a3f372146637DB2fDe820ad505); // Team Address
