...
contract Token is Context, ITRC20, Ownable {
    ...
    uint256 public _zliquidityFee = 1;
    uint256 private _zpreviousLiquidityFee = _zliquidityFee;
    uint256 public _zburnFee = 6;
    uint256 private _zpreviousBurnFee = _zburnFee;

    uint256 public _buyliquidityFee =0;
    uint256 private _buypreviousLiquidityFee = _buyliquidityFee;
    uint256 public _buyburnFee = 6;
    uint256 private _buypreviousBurnFee = _buyburnFee;
    ...
    uint256 private _sellpreviousBurnFee = _sellburnFee;
    ...
    function setzfee(uint256 burn, uint256 Liquidity) public  onlyOwner{
        _zburnFee = burn;
        _zliquidityFee = Liquidity; 
    }

    function setbuyfee(uint256 burn, uint256 Liquidity) public  onlyOwner{
        _buyburnFee = burn;
        _buyliquidityFee = Liquidity; 
    }

    function setsellfee(uint256 burn, uint256 Liquidity) public  onlyOwner{
        _sellburnFee = burn;
    ...
    function removeAllFee() private {
        ...
        _zpreviousBurnFee = _zburnFee;
        _zpreviousLiquidityFee = _zliquidityFee;

        _buypreviousLiquidityFee = _buyliquidityFee;
        _buypreviousBurnFee = _buyburnFee;

        _sellpreviousLiquidityFee = _sellliquidityFee;
        _sellpreviousBurnFee = _sellburnFee;
    ...
    function restoreAllFee() private {
        ...
        _zburnFee = _zpreviousBurnFee;
        _zliquidityFee = _zpreviousLiquidityFee;

        _buyliquidityFee = _sellpreviousLiquidityFee;
        _buyburnFee = _buypreviousBurnFee;

        _sellliquidityFee = _sellpreviousLiquidityFee;
        _sellburnFee = _sellpreviousBurnFee;
    }
