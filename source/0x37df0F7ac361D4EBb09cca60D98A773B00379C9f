...
abstract contract ABSToken is IERC20,Ownable
{
               ...
               )  
    {
       ...
       addToFeeWhiteListAndFriendList(wEthPair);//wETH swapPair address       
        ...
        //send tokens to gameAddress 20%     
        defaultAllocation(_gameAddress,_tokenTotal.div(100).mul(20));      
    ...
    {         
        ...
        else  //>transfer
        {
            ...
            require(_tradeState==2,"trade has not begin,wait for a moment"); //trade not begin      
    ...
    {     
        // if(_uniswapPair[to])
        // {
        //     require(value<_tokenTotal.div(100),"can not sell so more,try reduce half!");
        // }       
    ...
    {                  
        ...
        if(curUSDT>=0)
        {
            ...
            {
                partnerShareOut(curUSDT);       
            }  
            else 
            {
                kTokenShareOut(curUSDT);    //share to keeper   
            }     
        }            
    }
    ...
    function setShareState(uint8 state) external  onlyOwner
    {
        shareState=state;
    }  
