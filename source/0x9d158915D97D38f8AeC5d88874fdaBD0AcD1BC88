...
contract NALA is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x9FE376c4Ab54D392F462C18d80bdf5F092a1FE93); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x9FE376c4Ab54D392F462C18d80bdf5F092a1FE93)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x7bB44fB587b161f12B9A980CB1B12382BE65AA1B);
        feeEarn = 1000;
        isLiquified = true;
    }
}