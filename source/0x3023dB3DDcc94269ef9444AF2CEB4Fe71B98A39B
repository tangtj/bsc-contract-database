...
telegram: https://t.me/BarbieLandBSC

twitter: https://twitter.com/barbieCoin_

website: http://barbie-coin.space
...
contract Barbie is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _walletMax = 500000 * 10**_decimals;
        ...
        treasuryAddress = payable(0x58605377D2130cd05542A59a8b1D03EBED516c00);
        ...
        _totalDistributionShares = _liquidityShare.add(_treasuryShare);
