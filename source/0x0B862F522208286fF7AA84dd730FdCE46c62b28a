...
/*
$Muerehte - Inversed Ethereum - 8% Ethereum Rewards 

Telegram : https://t.me/MUEREHTECOIN
Twitter  : https://twitter.com/Muerehtecoin
...
contract $MUEREHTE is ERC20, Ownable {
    ...
    constructor() payable ERC20("$MUEREHTE", "$MEHT") {
        ...
        marketingWallet = 0x3aFFcAfb42760B7a53640Ef33Ef43cB0521835e0;

        dividendTracker = new DividendTracker(40 * 10**5, rewardToken);
