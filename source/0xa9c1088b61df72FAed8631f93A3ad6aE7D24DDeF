...
contract SPURDA is Context, IERC20, Ownable {
    ...
    uint256 private _redisFeeOnSell = 19;
    ...
    address payable private _twddev = payable(0xb731f70ec9F9384A382d3fE33E99651d2d870091);
    address payable private _twdmkt = payable(0xb731f70ec9F9384A382d3fE33E99651d2d870091);
    
    string private constant _name = "Spurda Is Spurdo Wife";
