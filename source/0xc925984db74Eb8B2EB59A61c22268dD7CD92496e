/**
   Welcome to PEPE SAGA. PEGA token is 
   here to rescue you with those wife changing
   gains you missed on memecoin. 
  TELEGRAM: https://t.me/PepeSaga_BSC
*/
...
contract PepeSaga is Context, IBEP2022, Ownable {
