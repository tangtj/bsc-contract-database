...
contract MemeinChina is IBEP20, Auth {
    ...
    string constant _name = "MemeinChina";
    string constant _symbol = "$MemeinChina";
    ...
    address private marketingFeeReceiver = 0x4415a6e80b28a2ecDc704E8533D22D02fF80c3B1;
