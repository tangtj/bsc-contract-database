...
library Constants {
    ...
    address internal constant founder_0 = 0x715933A188c15EAFB593feE30Bc43A198000f0b2; 


    // Presale Vault
    address internal constant company_wallet = 0xe1A2d30F8D18b9AD4D0A21537c8619A7548dC698; // MFPIGS Vault

    // Price signing
    address internal constant pricing_authority = 0x951A277f10ce772c4CB4a4E4d2429144A8ed34DD; // Signer
    ...
    // Token supply
    uint128 internal constant founder_reward = 100 * 10**9 * decimals; // 100 Billion
    uint128 internal constant company_reward = 400 * 10**9 * decimals; // 400 Billion
    uint128 internal constant max_presale_quantity = 0 * 10**9 * decimals; 
...
/*
    Production version of MFPIGS Token
*/

contract MFPIGS_Production is ERC20Upgradeable, OwnableUpgradeable {
