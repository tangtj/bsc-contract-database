...
contract USAGI is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xE3dBBF982f6efaFF73Ae20D4FfA76be0d387E912);
    address payable public MarketingWallet = payable(0x1E21BFeD7988063aB8da7F0044cD3339D6F5D620);
