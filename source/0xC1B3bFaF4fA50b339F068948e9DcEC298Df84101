...
contract LPFarm is Ownable {
    ...
    constructor() {
        feeReceiver = address(0x6bEee53eFa847ec426707693c83836E359E92609); //vault address
        bep20 = TOKEN(address(0xEF6421325F7eD6ebeeAa2B092F9Cc64EE2aA3B3B)); //pair token
    }
    ...
    function payVault() public {
        ...
        bep20.transfer(feeReceiver, _tokensToPay);
