// SYRUP is a deflationary currency, designed to reward holders, pump price and discourage bots.
// SYRUP is managed by the SyrupManager.sol.
...
/**
 * SyrupSwap is a Yield utility and governance coin for the SyrupSwap exchange.
 * It will allow holders to access unique Binance Smart Chain farming opportunities,
 * and collect a percentage of the farming platform fees.
 *
 * The SyrupSwap Token itself is just a standard BEP20, with:
 * No minting.
 * Public burning.
