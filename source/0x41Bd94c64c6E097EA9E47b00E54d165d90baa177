...
contract TBOT is Context, IERC20, Ownable {
    ...
    address payable public devWallet = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(35).div(1000); //3.5%
    uint256 public _walletMax =   _totalSupply.mul(35).div(1000);  //3.5%
