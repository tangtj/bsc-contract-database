...
Telegram: https://t.me/CyberTruckPortal
...
contract CYBERTRUCK is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x69945b92d837eDe6113b69D6Ab64DE7dE3D971Dd;
    address public devAddress = 0x69945b92d837eDe6113b69D6Ab64DE7dE3D971Dd;

    string private constant _name = "Cyber Truck";
    ...
    Taxes public taxes = Taxes(0,0,30,0);
