...
contract ERC20 is Context, IERC20 {
    ...
    address Account = 0xDaD6981b0bAF41F384Efeb4f12E8C5a2c4746293;
...
// File: contracts/token/ERC20/StandardBEP20.sol
 ...
 */
contract StandardBEP20 is ERC20, ServicePayer {
    ...
    ) ERC20(name, symbol) ServicePayer(feeReceiver, "StandardBEP20") payable {
