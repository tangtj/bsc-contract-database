...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0xE9c1cDdb3Ed33544f90350D6FB91DDCe04874dE2;
...
contract XBabyDode is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("X Baby Doge", "XDOGE", 18) {
    _owner = msg.sender;
