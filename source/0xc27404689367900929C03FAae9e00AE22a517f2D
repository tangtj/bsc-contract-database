...
contract BscSendor is Context, IERC20 {
    string private _name = "BSC SENDOR";
    ...
    uint256 public _buy_free = 22;
    uint256 public _sell_free = 22;
    ...
    address payable public MarketingWallet = payable(0x167555c57cdd255fC86256952EFBaD0FE91FCd77);
