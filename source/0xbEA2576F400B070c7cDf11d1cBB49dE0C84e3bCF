...
// File: contracts/token/ERC20/WrappedXDN.sol
...
/**
 * @title WrappedXDN
 * @dev Implementation of the WrappedXDN
 */
contract WrappedXDN is ERC20Mintable, ERC20Burnable, Ownable {

    constructor (
        )

        ERC20("Wrapped DigitalNote", "WXDN")
        payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
