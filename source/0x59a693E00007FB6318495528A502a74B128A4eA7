...
//Telegram: https://t.me/Greed_BSC
//Website: https://www.greedcoinbsc.com/

// $GREED coin has one objective:
//-Hold as much $GREED as you can without scaring away new investors.
// Manipulation will play a big roll in the success of $GREED. 
// HODL too big a bag and you will scare away shrimps.
// HODL too little and the whales will eat it.
// Will the $GREED take over or will generosity prevail!
...
contract GREEDCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Greed Coin";
    string private _symbol = unicode"$GREED";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x960eF465Ca14df4023329fCe6a6B43B58a32018e);
    address payable private taxWallet2 = payable(0x960eF465Ca14df4023329fCe6a6B43B58a32018e);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*1000000/1000000000; 
