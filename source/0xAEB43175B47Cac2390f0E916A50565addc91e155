...
//Telegram    : https://t.me/TokenBananaCN
// Banana Banana
...
contract Banana is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf24C8b9997635085349BeDF67938BF915073EC62); // Marketing Address
    address payable public teamWalletAddress = payable(0xf24C8b9997635085349BeDF67938BF915073EC62); // Team Address
