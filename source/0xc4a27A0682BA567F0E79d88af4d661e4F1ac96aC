...
Telegram: https://t.me/dogeshibaflokipepe
...
contract DogeSibaFlokiPepe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Doge Shiba Floki Pepe";
    string private _symbol = "Meme Coin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xCb734d73349cc2Fa7be4BE437d571E20d5dC5703);
