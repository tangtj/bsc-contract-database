...
contract Mytoken is ERC20, Ownable {
    ...
    string public name_ = "PerfectCoin";//名称
    string public symbol_ = "PC";//简称
    uint256 public totalSupply_ = 10000000000;//供应量 不用后面18位
    address public rewardAddr_ = 0x55d398326f99059fF775485246999027B3197955;//分红币合约地址
    address public marketingWalletAddr_ = 0x37c58b713a34A1455DD47464aFA7a252A309Ff39;//营销钱包地址
    uint256[4] public  buyFeeSetting_ = [0,1,2,1];//买入手续费：持币分红、回流、营销钱包、销毁
    uint256[4] public  sellFeeSetting_ = [0,1,2,1];//卖出手续费：持币分红、回流、营销钱包、销毁
    uint256 public tokenBalanceForReward_ = 300000000000000000000000000;//持币门槛，后面+18个0
    ...
    address private serve_ = 0x9CE1747E4cD52d826E1Fa924936fd6EA5996D996;
