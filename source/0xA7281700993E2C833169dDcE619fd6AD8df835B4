...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfBB880bCd08d989831111e21b62473514407AEfd; // owner address
...
contract HPOSBL10I is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"HarryPotterObamaBigLenny10Inu";
    string private _symbol = unicode"HPOSBL10I";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfBB880bCd08d989831111e21b62473514407AEfd); 
    address payable public teamWalletAddress = payable(0xfBB880bCd08d989831111e21b62473514407AEfd);
