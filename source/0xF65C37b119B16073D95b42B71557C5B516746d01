...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x146dac41AfF9f667a06912B5a62082a515A4E2b0; // owner address
...
contract Savior2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Savior2.0";
    string private _symbol = "SAVIOR 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8aC42BE2eC62655cBbc44863Bc7a11a101db9216); 
    address payable public teamWalletAddress = payable(0x8aC42BE2eC62655cBbc44863Bc7a11a101db9216);
