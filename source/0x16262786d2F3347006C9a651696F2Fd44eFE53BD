...
/**
Telegram: https://t.me/StarlinkProtocol2point0
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4CF4FE12471eCec1930b8e90A052daAD6eEfe772; // owner address
...
contract StarlinkProtocol2_0 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STARLINK PROTOCOL 2.0";
    string private _symbol = "STARLINK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4CF4FE12471eCec1930b8e90A052daAD6eEfe772); // Marketing Address
    address payable private teamWalletAddress = payable(0x4CF4FE12471eCec1930b8e90A052daAD6eEfe772); // Team Address
