...
contract Nipple is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x68C13fb50A678bEAa601a026eFDa98C8BC531f64); // Marketing Address
        
    address payable public teamAddress =
        payable(0x68C13fb50A678bEAa601a026eFDa98C8BC531f64); // Team Address
        
    address payable public liquidityAddress =
        payable(0x68C13fb50A678bEAa601a026eFDa98C8BC531f64); // Liquidity Address
    ...
    string private constant _name = "Nipple";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 10000;
    ...
    function StopCASellForMoon(bool status) external onlyOwner {
