/*
    ...
    \\     Tax - 2/2                                               \\
    \\     Wallet - 5%                                             \\                                 
    \\     Telegram: https://t.me/GTA_X_Portal                     \\
...
contract GTAX is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTxAmount = 500 * 10**_decimals; 
        _walletMax = 500 * 10**_decimals;
        ...
        marketingAddress = payable(0xd1857bBCe2F444bbA09Bda07C55e1216257f4e57);
        treasuryAddress = payable(0xd1857bBCe2F444bbA09Bda07C55e1216257f4e57);

        _buyLiquidityFee = 0; //Max tax 5%
        _buyMarketingFee = 2; //Max tax 5%
        _buyTreasuryFee =  0; //Max tax 5%
    
        _sellLiquidityFee = 0; //Max tax 5%
        _sellMarketingFee = 2; //Max tax 5%
        _sellTreasuryFee = 0; //Max tax 5%
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        _buyLiquidityFee = newLiquidityTax; //Max tax 5%
        _buyMarketingFee = newMarketingTax; //Max tax 5%
        _buyTreasuryFee = newTeamTax; //Max tax 5%

        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyTreasuryFee);
    }

    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        _sellLiquidityFee = newLiquidityTax; //Max tax 5%
        _sellMarketingFee = newMarketingTax; //Max tax 5%
        _sellTreasuryFee = newTeamTax; //Max tax 5%
