...
// █▓▒▒░░░ETH Version Hit Mill , We will do░░░▒▒▓█               

// https://t.me/bitcoin2009coin
...
contract BTC09 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4269 * 10**_decimals; //
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 85 * 10**_decimals; //
    
    uint256 public maxSellAmount = 4269 * 10**_decimals; //
    uint256 public maxBuyAmount = 4269 * 10**_decimals; //
    uint256 public maxWalletBalance = 85 * 10**_decimals; //

    address public marketingAddress = 0x01D5097aE8152AcB41360406b00A830C0650f984; //
    address public devAddress = 0x01D5097aE8152AcB41360406b00A830C0650f984; //
    ...
    // Owner cannot transfer out BTC09 from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out BTC09");
