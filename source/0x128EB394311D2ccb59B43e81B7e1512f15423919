...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 508 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "XJR";
    string private _symbol = "XJR";
    ...
    address public ownerAddres = address(0x29b5fc4AFf686617cE5Fe226c7b0196F85510211);
    address public devAddress = address(0xAbfc139F7E1b39b10D71FD5254996dC8139AD84d);
    ...
    uint256 public _maxTxAmount = 508 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 508 * 10 **18;
