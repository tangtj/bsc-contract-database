...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45ae06781b26149603b66815E6Cc93A98334586A; // owner address
...
contract Carbondioxide is Context, IERC20, Ownable {
    ...
    string private _name = "Carbondioxide";
    string private _symbol = "CO2";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x45ae06781b26149603b66815E6Cc93A98334586A); // Marketing Address
    address payable private teamWalletAddress = payable(0x45ae06781b26149603b66815E6Cc93A98334586A); // Team Address
