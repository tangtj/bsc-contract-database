...
LAUNCH TODAY, 11.00 AM UTC|| LOW MC 
...
Tokenomics:
Supply : 53.000.000.000
Tax : 5/5

📱 Telegram - https://t.me/FALDAXOFC
**/
...
contract FALDAX is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FALDAX";
    string private constant _symbol = unicode"$FDX";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 53000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x5f3e797C09B33FB25bB54D6220C6DE347c2b8Ca3);
    address payable public MarketingWallet = payable(0xf494a31393260f55EdCb5d23b90760DA0A043A9d);
