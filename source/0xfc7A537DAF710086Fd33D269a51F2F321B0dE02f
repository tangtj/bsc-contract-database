// Telegram:   https://t.me/NinjinCoin
...
contract NINJIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "NINJIN";
    string private constant _symbol = "$NINJIN";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xa4bfaa3b68d6Eff9C076d949E8769EE7d88Bdccc);
    address payable private _marketingAddress = payable(0x3C7963f59dc00A3a5ba2BbF12ef926a0CD1dfd67);
