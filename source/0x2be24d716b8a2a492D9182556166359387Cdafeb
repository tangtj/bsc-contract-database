...
contract BLUEDOGECOIN_X is Context, IERC20, Ownable {
    ...
    string private _name     = "BLUEDOGE COIN";
    string private _symbol   = "BLUEDOGE";
    uint8  private _decimals = 0;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 444_000_000_000_000;
    ...
    {        
        ...
        marketingWallet = 0xca25018EDcc253134fD4602f589579C4834577Ef;
