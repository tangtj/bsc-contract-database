...
contract EternityEndGame is ERC20, Ownable {
    ...
    constructor() ERC20("EternityEndGame", "EternityBSC") {
        marketingWallet = payable(0xA19a7bCF1C1C35E9e8DD3B381038D177aDc7BC60);
        CommunityWallet = payable(0x8AefeF3FBFdB85a92d4D1C29199Ddb8274c1B3E7);
        ...
        maxWallet = totalTokenSupply / 5000; // 0.02%
    ...
    function updateFees(
        ...
        require(totalSellFees <= 21 && totalBuyFees <= 31, "total");
