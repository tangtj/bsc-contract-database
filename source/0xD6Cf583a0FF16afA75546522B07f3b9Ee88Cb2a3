...
contract epic is ERC20Detailed, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 50000000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("epic", "epic", DECIMALS) {
        _mint(0x4DaB2a0C3d83a8c042478e610BBe49cB188a04d3,50000000 ether);
