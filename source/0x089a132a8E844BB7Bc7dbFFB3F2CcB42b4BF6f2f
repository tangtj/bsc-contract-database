...
contract AlphanetStaking is ReentrancyGuard, Pausable {
    ...
    uint256 public lockDownDuration = 259200 seconds;
    ...
    address public rewardProvider =0x0d10EC59Fa3Fcc6EE006840BCF145563e7B62423;
    ...
    address public feeCollector =0x0d10EC59Fa3Fcc6EE006840BCF145563e7B62423;
    ...
    function initLevel() internal {
        _ratesLevel[levels[0]] = RateLevel({min:0,max:30000,weight:100});
        _ratesLevel[levels[1]] = RateLevel({min:30000,max:60000,weight:125});
        _ratesLevel[levels[2]] = RateLevel({min:60000,max:100000,weight:150});
        _ratesLevel[levels[3]] = RateLevel({min:100000,max:150000,weight:175});
        _ratesLevel[levels[4]] = RateLevel({min:150000,max:200000,weight:200});
        _ratesLevel[levels[5]] = RateLevel({min:200000,max:250000,weight:225});
        _ratesLevel[levels[6]] = RateLevel({min:250000,max:300000,weight:250});
        _ratesLevel[levels[7]] = RateLevel({min:300000,max:350000,weight:275});
        _ratesLevel[levels[8]] = RateLevel({min:350000,max:400000,weight:300});
        _ratesLevel[levels[9]] = RateLevel({min:400000,max:450000,weight:325});
        _ratesLevel[levels[10]] = RateLevel({min:450000,max:999999999,weight:350});
    }
