...
abstract contract ERC721Stakeable is Ownable{
    ...
    */
    uint256 public RARITY_POINTS_COMMON = 30;
    uint256 public RARITY_POINTS_RARE = 60;
    uint256 public RARITY_POINTS_EPIC = 90;
    uint256 public RARITY_POINTS_LEGENDARY = 120;
    uint256 public RARITY_POINTS_MYTHICAL = 150;
    uint256 public RARITY_POINTS_ULTIMATE = 180; // N/A
