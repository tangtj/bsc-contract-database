...
contract RWHUB is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address MKT  = 0x72D948DF497d972d3B77179566C175442557b40C;
    ...
    uint256 public transferTaxRate        = 15;
    ...
    address public buyBackTokenOne = address(0xc39dc533Ce67603FD059ad6e100c91b7db58D04A); //buyBackTokenOne
    ...
    uint256 public swapThreshold = 1000 * 10 **_decimals; // 1000 TK
    bool inSwap;
    ...
    // Enable BuyBack
    function buyBackStatus(bool _status) public onlyOwner {
        enableBuyBack = _status;
    }
    ...
    function cooldownEnabled(bool _status, uint8 _interval) public onlyOwner {
        ...
        if (totalFee > 0) {
            ...
            if (buyBackFee > 0) {             
                BuybackBurnOne(amountForBuyBack);
            }
            ...
            if (marketingFee > 0) {
                (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 300000 }(""); tmpSuccess = false;
                swapMarketing(amountBNBMarketing);
            }
     ...
     function swapMarketing(uint256 tokens) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    function setBuyBackToken(address _tokenAddressOne) public onlyOwner {
