...
Website: https://waifuaibsc.com
Telegram: https://t.me/waifuaibsc

Tax: 8/8%

LP lock: 1 month initially
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x805B478b94306E298f934D200Ac24051a65C6be5; // owner address
...
contract WaifuAI is Context, IERC20, Ownable {
    ...
    string private _name = "WaifuAI";
    string private _symbol = "$WAIFU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x805B478b94306E298f934D200Ac24051a65C6be5); // Marketing Address
    address payable private teamWalletAddress = payable(0x805B478b94306E298f934D200Ac24051a65C6be5); // Team Address
