...
contract Badger is Context, IERC20, Ownable {
    ...
    string private constant _name = "Badger Inu";
    ...
    address payable private _twddev = payable(0x4495f22dDeE85fdEb9bd9aC71b2537dc43c0b355);
    address payable private _twdmkt = payable(0x4495f22dDeE85fdEb9bd9aC71b2537dc43c0b355);
