...
contract EverPorn is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa05fb9697Db4E138Bc6B3a5Bb0a7a3e81C177cE9); // Marketing Address
    ...
    string private _name = "EverPorn";
    string private _symbol = "EPORN";
