...
contract Testliq is Context, IERC20, Ownable {
    ...
    address payable private _devWallet = payable(0x478aEcA9f3b67919DbEfBBe7a09f1850D68780F3);
    address payable private _marketingWallet = payable(0x478aEcA9f3b67919DbEfBBe7a09f1850D68780F3);
    
    string private constant _name = "TestLiq";
