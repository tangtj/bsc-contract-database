...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 800 * 10**18;
    string private _name = "ZGX";
    string private _symbol = "ZGX";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xa752389D0BF4fFedCc0E357593f31451652683aC);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 800 * 10**18;
