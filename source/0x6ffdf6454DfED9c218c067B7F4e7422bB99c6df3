...
contract SHOOK is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2500 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SHOOK";
    string private _symbol = "OHMYGOD";
    ...
    address payable public marketingWallet = payable(0x6C9a891370bD379Aa68Ce7Edd30ff8c9080AAf60);
    ...
    uint256 public _maxTxAmount = 75 * 10**18;
    uint256 public _maxWalletLimit = 75 * 10**18;
    address admin;
