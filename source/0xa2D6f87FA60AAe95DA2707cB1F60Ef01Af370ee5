...
MMP""MM""YMM `7MMF'   `7MF'`7MM"""Mq.   db       .g8"""bgd 
P'   MM   `7   MM       M    MM   `MM. ;MM:    .dP'     `M 
     MM        MM       M    MM   ,M9 ,V^MM.   dM'       ` 
     MM        MM       M    MMmmdM9 ,M  `MM   MM          
     MM        MM       M    MM      AbmmmqMA  MM.         
     MM        YM.     ,M    MM     A'     VML `Mb.     ,' 
   .JMML.       `bmmmmd"'  .JMML. .AMA.   .AMMA. `"bmmmd'  
...
contract TUPAC is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x80B6de9f474CDE3fe35a6e6c23ab8A15f155766a;

    string constant _name = "TUPAC SHAKUR";
    string constant _symbol = "TUPAC";
