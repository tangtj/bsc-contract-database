/**
Telegram : https://t.me/DiabloIVBsc
Website :https://diabloIV.xyz
*/
...
contract DIABLOIV is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD67c3fCa403b2332C33F8dE8419D5088955eE203); 
    address payable private Wallet_Dev = payable(0xD67c3fCa403b2332C33F8dE8419D5088955eE203);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 4444444444 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0xD67c3fCa403b2332C33F8dE8419D5088955eE203;
