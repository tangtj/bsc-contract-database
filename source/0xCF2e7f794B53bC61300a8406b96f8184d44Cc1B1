...
contract XXX is Context, IERC20, Ownable {
    ...
    string private _name = unicode"XXX";
    string private _symbol = unicode"XXX";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC7bb9e04c29F476ab073fCfA2629e495f90F733b);
    address payable private taxWallet2 = payable(0xC7bb9e04c29F476ab073fCfA2629e495f90F733b);
