...
contract BabyDoge is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x59A45483A9bE45dE9ecD794592ae8f82E78b5FCa); 
    address payable private teamWalletAddress = payable(0x59A45483A9bE45dE9ecD794592ae8f82E78b5FCa); 
