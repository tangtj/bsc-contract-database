...
*/
// Ape Pepe On BSC! $APEPE
// Join The Telegram: https://t.me/APepeBSC
...
contract $APEPE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Ape Pepe";
    string private _symbol = unicode"$APEPE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xb2F39240b4898fbCb91D6e1bf90955B50A9E7506);
    address payable private taxWallet2 = payable(0xb2F39240b4898fbCb91D6e1bf90955B50A9E7506);
    ...
    uint256 public _liquidityShares = 9;
