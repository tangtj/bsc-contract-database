/**
©️ Welcome to the new era of digital finance with COIN CIDE ($CIDE).

FAIR LAUNCH ⏰
September 6th 11.30am UTC

COIN CIDE ($CIDE)
🥇Tax 7/7
💰Supply 71.000.000.000
...
contract COINCIDE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "COIN CIDE";
    string private constant _symbol = unicode"$CIDE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 71000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xf228B1BC281165F5A32af880A1bE25aa342C3BC8);
    address payable public MarketingWallet = payable(0xFf93294dd0472C2B0e2b16C82ce52F2272ceE767);
