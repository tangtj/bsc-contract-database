...
contract Starshipshib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Starship shib";
    string private _symbol = "STARSHIPSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x529b9959A3A895C13064fdDA02A9ffCA2E2EB997); // Marketing Address
    address payable public teamWalletAddress = payable(0x529b9959A3A895C13064fdDA02A9ffCA2E2EB997); // Team Address
