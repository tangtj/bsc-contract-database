...
contract GPTB is Ownable {
    ...
    uint256 public muladj = 100;
    uint256 public divadj = 1;
    ...
    function setMulAdj(uint256 _mulAdj) public onlyOwner {
        muladj = _mulAdj;
    }

    function setDivAdj(uint256 _divAdj) public onlyOwner {
        divadj = _divAdj;
    }
    ...
    function getAmount(uint256 _amountin)  public view  returns (uint256) {
        ...
        uint256 amountout = pancakeRouter.getAmountsOut(_amountin,path)[2]/100*muladj/divadj;
