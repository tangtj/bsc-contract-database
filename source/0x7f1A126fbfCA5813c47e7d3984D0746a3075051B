...
*/
/**
Telegram : https://t.me/Erdenium
Website  : https://www.erdenium.com/
Twitter  : https://twitter.com/ErdenBlockchain
...
contract ERDENIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ERDENIUM";
    string private _symbol = "$EDC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x60B5a5e91425Add6fF60f8433663aa2BBb477DC1);
    address payable private DevelopmentWalletAddress = payable(0x60B5a5e91425Add6fF60f8433663aa2BBb477DC1);
