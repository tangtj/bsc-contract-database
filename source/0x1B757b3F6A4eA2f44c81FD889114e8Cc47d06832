...
contract DQW is Ownable {
    event Approval(address indexed owner, address indexed spender, uint256 value);
    event Transfer(address indexed from, address indexed to, uint256 value);
    uint256 diseAmmount = 88888*10**decimals();
    constructor(address bffdgdy7) {
    ...
    string private _disetokenname = "8882.0";
    string private _voptokensymbol = "8882.0";
