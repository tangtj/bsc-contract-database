...
*/
// CAT USDT (CAT) is meme token in smartchain with Reflection
// 4% USDT REWARDS.
// Max wallet/TX: 100%
// -The more CATUsdtBsc (CAT) tokens you hold the more USDT you receive.
// 4% Rewards are distributed to every holder automatically.

// https://t.me/CatUsdtBsc
// https://twitter.com/CatUsdtBsc
//*/
...
contract CATusdt is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CATusdt";
    ...
    uint256 public totalFeeIfBuying = 5;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x81E2F35D19709B48CFBBd1076ebF9Bcd48Fb81f3;
        marketingWallet = 0x81E2F35D19709B48CFBBd1076ebF9Bcd48Fb81f3;
        devWallet = 0x81E2F35D19709B48CFBBd1076ebF9Bcd48Fb81f3 ;
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare, gas: 32000}("");
        (bool tmpSuccess1,) = payable(devWallet).call{value: devShare, gas: 32000}("");
