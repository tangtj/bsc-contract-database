// SPDX-License-Identifier: MIT
    ...
    contract SpamCoin is ERC20, Ownable {
        ...
        constructor() payable ERC20("SpamCoin", "SPAM") {
            ...
            marketingWallet = 0x819d98dccEb738aD47BB31D8b21939757a378Fb9;

            dividendTracker = new DividendTracker(1000000e9, rewardToken);
