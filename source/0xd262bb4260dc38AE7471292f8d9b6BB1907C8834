...
https://deviscookingbsc.xyz/
https://t.me/DevCooking
*/
...
contract DevisCooking is IBEP20, Ownable {
    ...
    string constant _name = "Dev is Cooking";
    string constant _symbol = "Dev";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 99) / 100;  //100% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 99) / 100;  //100% max wallet
    ...
    address public marketingFeeReceiver = 0xc2508b6C3D7B583CF52e1A80423704C73d720db3;
