...
contract DividendDistributor is IDividendDistributor {
    ...
    ISHI20 RWRD = ISHI20(0x0B842c7b18bef85DAeA11F23E1daBe0d6671c19a);
...
contract ShudokuSwap is ISHI20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x67aFC01D0466C574fCee4e4E096cc109F3DF72F9;

    string constant _name = "ShudokuSwap";
    string constant _symbol = "SHU";
    ...
    constructor () Auth(msg.sender) {
        ...
        dividendBalances[msg.sender] = _balances[msg.sender];
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 senderBalance = dividendBalances[sender];
        senderBalance = senderBalance.sub(amount, "Insufficient Balance");
        dividendBalances[sender] = senderBalance;
    }

        if (!isDividendExempt[recipient]) {
        uint256 recipientBalance = dividendBalances[recipient];
        recipientBalance = recipientBalance.add(amountReceived);
        dividendBalances[recipient] = recipientBalance;
    }
    ...
    uint256 feeAmount = amount.mul(totalFee).div(feeDenominator * 100);
    ...
    // Renounce ownership by setting it to address(0)
