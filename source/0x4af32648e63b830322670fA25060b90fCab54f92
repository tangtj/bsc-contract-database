        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x116B61dD241F681F96cfaBdA0C264c7eE958Da0e), block.timestamp
                );
            }
        }
    }
...
contract AstroPepeX is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xFA3BabEE9EC6f45AD53DcBf2b687b10C0B749bDB),//FundAddress
        address(0x116B61dD241F681F96cfaBdA0C264c7eE958Da0e)//ReceiveAddress
    ){
    }
}