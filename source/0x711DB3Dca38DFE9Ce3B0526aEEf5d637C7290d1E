...
contract BarbieShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Barbie Shiba";
    string private constant _symbol = unicode"BSHB";
