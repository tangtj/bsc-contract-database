...
contract AsicTestToken is ERC20, ERC20Burnable, Ownable, AccessControl, ERC20Permit {
    ...
    function setShares(uint32 newLiquidityShare, uint32 newMarketingShare, uint32 newCharityShare, uint32 newBurnShare) external {
    ...
    function setSwapBackSettings(bool status, uint32 amount) external onlyOwner {
        autoSwap = status;
