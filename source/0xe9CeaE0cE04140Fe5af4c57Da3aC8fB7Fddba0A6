...
// X1000 CAT PEPE ON BSC MEME COIN
...
contract CatPepe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x20563ef39ebe91c36cF0FA48feb588eEC9CEbB82); 
    address payable public Wallet_Dev = payable(0x20563ef39ebe91c36cF0FA48feb588eEC9CEbB82);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =50 * 10**6* 10**9 * 10**_decimals;
    string private constant _name = "CAT PEPE"; 
    string private constant _symbol = unicode"$MEOWG"; 
    ...
    constructor () {
        _owner =0x20563ef39ebe91c36cF0FA48feb588eEC9CEbB82;
