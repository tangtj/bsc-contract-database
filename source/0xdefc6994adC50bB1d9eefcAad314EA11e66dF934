...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe3c2F9748c974f0FcC691AB066f1AE0F5422b451;
...
contract ONESWAP is Context, IERC20, Ownable {
    ...
    string private _name = "ONE SWAP";
    string private _symbol = "ONESWAP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe3c2F9748c974f0FcC691AB066f1AE0F5422b451);
    address payable public teamWalletAddress = payable(0xe3c2F9748c974f0FcC691AB066f1AE0F5422b451);
    ...
    uint256 private minimumTokensBeforeSwap = 90000000 * 10**_decimals; 
