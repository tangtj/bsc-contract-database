...
//You will become a whale!
//https://t.me/babydogeofficial2023
interface IERC20 {
...
contract BabyDogeCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8D2F1A0Bf4Ff90c0739AfC9B814a306c33F0929c); 
    address payable public Wallet_Dev = payable(0x8D2F1A0Bf4Ff90c0739AfC9B814a306c33F0929c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420 * 10**9* 10**9 * 10**_decimals;
    string private constant _name = "BabyDoge Coin"; 
    ...
    constructor () {
        _owner =0x8D2F1A0Bf4Ff90c0739AfC9B814a306c33F0929c;
