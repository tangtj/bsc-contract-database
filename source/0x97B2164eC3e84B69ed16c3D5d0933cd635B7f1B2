...
contract MintReqWojakV1 is Ownable {
    ...
    uint public priceEveryNFT = 1300;
    ...
    function mintReqOptional(uint _femaleCount, uint _maleCount,uint _busd , uint _wusd) public {
        require(mintOptionalEnabled, "Mint Disabled");
        require((_busd + _wusd) >= (priceEveryNFT * (_femaleCount+_maleCount)), "amount wrong");
        ...
        emit NewMintRequest(msg.sender, _busd, _wusd, _maleCount, _femaleCount);
    }
