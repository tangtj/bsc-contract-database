...
contract DLI is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "DORK LORD INU";
string private _symbol = "DLI";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0xd0d8f03123825d2D2690625Ecb26b6772a4626Ae); // Marketing Address
address payable private TeamWallet = payable(0xd0d8f03123825d2D2690625Ecb26b6772a4626Ae); // Buy Back Address
