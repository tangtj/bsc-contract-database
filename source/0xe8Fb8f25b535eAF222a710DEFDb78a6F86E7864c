/*
Telegram: https://t.me/Thisiscrazyfrog_Bsc
Twitter: https://twitter.com/crazyfrogxyz
Website: https://crazyfroggy.com/
*/
...
contract CrazyFrog is Context, IERC20 {
    string private _name = "Crazy Frog";
    string private _symbol = unicode"$лягушка";
    ...
    address payable public MarketingWallet = payable(0x4a39D671Ef08aF7fF7b03fa5370371741e3B5431);
