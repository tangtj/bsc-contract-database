...
contract AngryGorilla is Context, IERC20, Ownable {
    ...
    string private _name = unicode"ANGRY GORILLA";
    string private _symbol = unicode"$AG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xe4F96ffb7855412166C54224A2Dc93d1Fa5A4D72);
    address payable private taxWallet2 = payable(0xe4F96ffb7855412166C54224A2Dc93d1Fa5A4D72);
