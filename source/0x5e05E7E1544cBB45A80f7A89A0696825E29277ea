...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x988CBA6b22C1479146b5cdDaFcaC643FC2fAA1bB; // owner address
...
contract XHERCULES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hercules X";
    string private _symbol = "XHER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x988CBA6b22C1479146b5cdDaFcaC643FC2fAA1bB); // Marketing Address
    address payable public teamWalletAddress = payable(0x988CBA6b22C1479146b5cdDaFcaC643FC2fAA1bB); // Team Address
