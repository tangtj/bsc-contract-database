 ...
 */
contract STREAMN is Context, IERC20, Ownable, IERC20Metadata {
    ...
    string private _name = "Stream2Earn";
    string private _symbol = "STREAMN";
    ...
    address payable private _marketingAddress =
        payable(0xcdF9bf723D9FFEa3abD78D2bC5b483dC0ecA3eC0);
    address payable private _charityAddress =
        payable(0xF802998EF3Cb289eB52807b90cE60797006Ffe44);
    ...
    function sendETHToFee(uint256 amount) private {
        _charityAddress.transfer(amount.mul(50).div(100));
