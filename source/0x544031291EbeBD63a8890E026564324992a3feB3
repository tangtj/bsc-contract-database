...
contract SCToken is ExcludedFromFeeList, LpDividendBNB, BlackList, FirstLaunch, MaxHave {
 uint256 public numTokensSellToAddToLiquidity = 0.001 ether;
    address public lpReceiver = address(0xB5A09CBb8De6c10Babb4C87c33B9085E7829f005);

    address constant marketAddr = address(0xB5A09CBb8De6c10Babb4C87c33B9085E7829f005); //1‰

    uint256 constant marketFee = 1;
    uint256 constant lpFee = 25;
    uint256 constant liqFee = 4;
    uint256 constant burnFee = 9;
    ...
    constructor() payable Owned(msg.sender) ERC20("ATH", "ATH", 18, 3999 ether) {
