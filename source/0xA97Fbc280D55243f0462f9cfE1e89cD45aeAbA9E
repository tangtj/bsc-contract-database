...
contract MetaCateAI is IERC20 {
    ...
    string constant private _name = "MetaCateAI";
    string constant private _symbol = "METACATEAI";
    ...
    address payable public marketingWallet = payable(0x0b83138d93aF1c560d383Ee5106055981d993B78);
