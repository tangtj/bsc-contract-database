...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x27622E5A2a6886Fe0Bbbe95283D3439950c726Ae; // owner address
...
contract SpidermanSnoopDoggSpongeBob10INU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpidermanSnoopDoggSpongeBob10INU";
    string private _symbol = "$CARDANO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x27622E5A2a6886Fe0Bbbe95283D3439950c726Ae); // Marketing Address
    address payable private teamWalletAddress = payable(0x27622E5A2a6886Fe0Bbbe95283D3439950c726Ae); // Team Address
