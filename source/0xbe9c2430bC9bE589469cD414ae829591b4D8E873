/**	
Why moon? when neptune rains diamonds, Welcome to Mission Neptune.
 */	
...
contract MissionNeptune is Context, IERC20, Ownable {	
    ...
    string private constant _name = "MissonNeptune";	
    string private constant _symbol = "Neptune";	
