...
// MemeCoin Of Elon Musk

//Elona Trend + Cats Trend
...
contract ElonaCat is IBEP20, Auth {
    ...
    string constant _name = "ElonaCat";
    string constant _symbol = "ElonaCat";
    ...
    address private marketingFeeReceiver = 0xD55FCDd29B3fABF974Aa1568A3ca3252799C9d5c;
    address private developmentFeeReceiver = 0xD55FCDd29B3fABF974Aa1568A3ca3252799C9d5c;
