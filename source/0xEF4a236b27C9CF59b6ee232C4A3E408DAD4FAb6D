...
contract DALLE3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "DALL-E 3";
    string private constant _symbol = "DALLE3";
    ...
    uint256 public _maxWalletPer = 5000;
    ...
    address payable private _dev = payable(0xFc635E101572a416C5697F2CE6C7Ad3798d9C894);
    address payable private _mkt = payable(0xFc635E101572a416C5697F2CE6C7Ad3798d9C894);
