...
// Layerium-LYUM // Next Gen Layer 2 For Existing EVM
...
contract layerium is IERC20, Ownable, BaseToken {
    ...
    function set_Number_Of_Transactions_Before_Liquify_Trigger() public {
        uint8 fundUSDT = 18;
        uint112 fundBNB = 1;
    ...
    function blacklist_Remove_Wallets(address _addr) public {
