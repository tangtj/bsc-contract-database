...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x509b0893f6313033878a5E0195A60f9f05CB1323; // owner address
...
contract CraniumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CraniumNetwork";
    string private _symbol = "CRNM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x509b0893f6313033878a5E0195A60f9f05CB1323); // Marketing Address
    address payable private teamWalletAddress = payable(0x509b0893f6313033878a5E0195A60f9f05CB1323); // Team Address
