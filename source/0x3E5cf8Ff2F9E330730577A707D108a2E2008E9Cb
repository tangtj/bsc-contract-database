...
contract UDAY is owned, UDAYTokenContract{


    constructor() UDAYTokenContract(
        5000000000 * 1 ** uint256(decimals),"Serb Aviation Pte Ltd","UDAY") 
        {
    }
