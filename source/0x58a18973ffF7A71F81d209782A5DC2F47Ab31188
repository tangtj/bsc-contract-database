...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x435b501E8463D3B47AfDfA5dd7bC7126E7A6FcD9;
...
contract LoopEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Loop Ecosystem";
    string private _symbol = "LECO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x435b501E8463D3B47AfDfA5dd7bC7126E7A6FcD9);
    address payable public teamWalletAddress = payable(0x435b501E8463D3B47AfDfA5dd7bC7126E7A6FcD9);
