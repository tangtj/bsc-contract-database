...
contract Astrofrogx is Context, IERC20, Ownable {
    ...
    string private _name = "ASTROFROGX";
    string private _symbol = "AFX";
    uint8 private _decimals = 18;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x46e2401d0Fa28bFfcd24Bcc0CFA5C099A1CdC545);
    address payable public teamWalletAddress = payable(0x14cb5505DF79CAcd21138B08F4b827fe0539d4B8);
    ...
    uint256 public _marketingShare = 59;
    ...
    uint256 public _maxTxAmount = 1000000000 * 3 * 10**_decimals / 100;
    uint256 public _walletMax = 1000000000 * 3 * 10**_decimals / 100;
    uint256 private minimumTokensBeforeSwap = 1000000000 * 3 * 10**_decimals / 100;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount;
            finalAmount = (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) ?
