// Telegram: https://t.me/G9LABScoin
...
contract G9LABS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "G9LABS";
    string private constant _symbol = unicode"$G9";
    ...
    address payable public DevWallet = payable(0x335B1e3c2759c4027c55D52Be4968e84422154ad);
    address payable public MarketingWallet = payable(0xF75d78aE96E319524810eF38a21dF07a626BeB42);
