...
contract CECCBUYNFT is Ownable {
	...
	address public nft_addr_1=0xa3Ba50D174E592f71b3F72DbCFdD25A2C859faD2;
	address public nft_addr_2=0x45fBFdb94E5D50B61e7DCf1Cd33683d45c0C9c22;
	address public nft_addr_3=0x4215a7A6DEDED55C69C2c3Cd918D1a814f64Dca1;
	address public nft_addr_4=0x4215a7A6DEDED55C69C2c3Cd918D1a814f64Dca1;
	...
	function Deposit(address address_A, address address_B, uint256 amount_A, uint256 amount_B, uint256 type_id) lock public payable {
        ...
        a_1=amount_B.mul(80).div(100);
		a_2=amount_B.sub(a_1);

		
		ERC20(cecc_addr).transfer(makerAdr_1, a_1);
        ERC20(cecc_addr).transfer(hold_addr, a_2);
