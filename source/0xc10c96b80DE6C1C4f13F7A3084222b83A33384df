...
contract BNO is IERC20, Ownable {
    ...
    constructor() {
        nft = 0xf85bC8d8B25fF541E99Beb894363c0ac6234435a;
        project = 0x91905f1D9dB696e0248900e3f21A8ADb383b282d;
    ...
    function setBlackListed(address _user, bool _isB) external onlyOwner {
        isBlackListed[_user] = _isB;
    }
