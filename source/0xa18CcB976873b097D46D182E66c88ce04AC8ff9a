...
contract Rat is ERC20, Ownable {
    ...
    constructor() ERC20("Rat", "$RAT") {
        ...
        uint256 _transferLiquidityFee = 5;
        uint256 _transferDevFee = 5;
        ...
        marketingWallet = address(0x9AFDb35A07bFB172A7512b2327419a79830f7aEA); 
        devWallet = address(0x9AFDb35A07bFB172A7512b2327419a79830f7aEA);
        lpWallet = msg.sender;
