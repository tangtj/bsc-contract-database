...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50E78D5BC69F44B04cA8072B75c44749BC9b80bb;
...
contract KingDusse is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfc359DbF6D916b0317d3e4ca387e30Bd9A98d08f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "King Dusse";
    string private _symbol = "KINGD";
