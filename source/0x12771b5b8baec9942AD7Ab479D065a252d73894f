...
contract NowYouSeeMe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA1A471A9B94caA755F0A23687A1a81D64D3CB6EA); 
    address payable public Wallet_Dev = payable(0xA1A471A9B94caA755F0A23687A1a81D64D3CB6EA);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =4200000 * 10**6* 10**9 * 10**_decimals;
    string private constant _name = "Now You See Me "; 
    ...
    constructor () {
        _owner =0xA1A471A9B94caA755F0A23687A1a81D64D3CB6EA;
