...
Telegram Groups: https://t.me/GummyBear_Inu
...
contract GummyBear is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gummy Bear Inu"; // 
    string private constant _symbol = "Gummy"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x691EC1804d9995b1432921F059B485bd4DDC5Df7;
