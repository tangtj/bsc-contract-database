...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: Mint to the dead address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: Burn from the dead address");
...
contract ChonkyPonk is ERC20, Ownable {
    ...
    constructor () ERC20("ChonkyPonk", "CHONKY") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x46c01313b3c238D5bb3127Ac583c3A3C945410f9;
        ...
        _mint(owner(), 5_000_000 * (10 ** decimals()));
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner{
        ...
        require(_marketingWallet != address(0),"Marketing wallet cannot be the dead address");
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 10, "SwapTokensAtAmount must be greater than 0.0001% of the total supply");
