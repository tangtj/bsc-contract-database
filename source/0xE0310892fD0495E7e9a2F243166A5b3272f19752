...
/**
Telegram:https://t.me/TeritoriumNetwork
Twitter:https://twitter.com/TeritoriumNET
*/
...
abstract contract Ownable is Context {
    ...
    constructor () { 
        _owner = 0x8085808BC3776b9b8A121Da772f70E8A60f92340; // owner address
...
contract TeritoriumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teritorium Network";
    string private _symbol = "TERITORIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8085808BC3776b9b8A121Da772f70E8A60f92340); 
    address payable public teamWalletAddress = payable(0x8085808BC3776b9b8A121Da772f70E8A60f92340);
