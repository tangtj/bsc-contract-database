...
contract shake31 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private constant _name = "shake22";
    string private constant _symbol = unicode"∞";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3b89b023A14CAeFFaFE6cba0cb8756177751EE5); // Marketing Address
    address payable public teamWalletAddress = payable(0xF3b89b023A14CAeFFaFE6cba0cb8756177751EE5); // Team Address
    ...
    function set_Max_Tx_Amount(uint256 maxTxAmount) external onlyOwner() {
        MaxTxAmount = maxTxAmount;
        require(MaxTxAmount >= MaxTxAmount, "Max TX is less than 2%");
    }
