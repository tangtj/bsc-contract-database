...
contract AthensCake is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x402F2a6Fb8A794d105E0d1Be9986A615446a014c;
    ...
    string private _name = "AthensCake";
