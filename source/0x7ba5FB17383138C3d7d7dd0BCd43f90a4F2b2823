...
contract Yeah is Context, IERC20, Ownable {
    ...
    string private _name = "YEAH";
    string private _symbol = "YEAH";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x967De210e306609d06Db7B26eE68B841FA1055aC);
    address payable private DevelopmentWalletAddress = payable(0x019E629ee6eB3c8085879E802b841012AECe135B);
