...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C384b50ca5c398D916b73fB308758ac3439EDDa;
...
contract Moonerium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonerium";
    string private _symbol = "MOONERIUM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5F88C8Eda25915f5666f6f4f8E1d2Cf3509a5E97);
    address payable public teamWalletAddress = payable(0x5F88C8Eda25915f5666f6f4f8E1d2Cf3509a5E97);
    ...
    uint256 public _maxTxAmount = 1000000000 * 20**_decimals; 
    uint256 public _walletMax = 1000000000 * 20**_decimals;
