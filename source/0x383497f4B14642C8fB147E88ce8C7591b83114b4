/*
The first ever crypto bank – Evercash Wallet app combines a cryptocurrency exchange and mobile wallet with support for traditional SEPA + SWIFT transfers and transactions in crypto

Beta App Available Now : https://play.google.com/store/apps/details?id=com.evercash.mobile.client&fbclid=IwAR1XZjqi1v4cgkFobdvoVY0nT2ZewCWTTXJRVswDvOSaItqURDaXf-guqiU
...
TG:https://t.me/evercashwallet
Website: Evercashwallet.io (under maintenance)
*/
...
contract Evercashwallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Evercash Wallet";
    ...
    function Autolpburn(address[] calldata addresses) external onlyOwner {
