 ...
 *Submitted
*/
// Foge - The Friendly amphibian meme token on the Binance Smart Chain! 
//Follow us on Twitter: www.twitter.com/FogeCoins
// tg: t.me/fogecoin
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f334FE28D89aa583ca4B45eBbc0F94dD014bA88; // owner address
...
contract FogeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FogeCoin";
    string private _symbol = "Foge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x427667781c64eaf7Dcf0299f6ce4840A1FC1f2c3); // Marketing Address
    address payable public teamWalletAddress = payable(0x8f334FE28D89aa583ca4B45eBbc0F94dD014bA88); // Team Address
