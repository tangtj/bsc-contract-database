...
contract PIKAMOON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x249DF8f3d732FA209404178bE886409b0Cf559a2); 
    address payable public Wallet_Dev = payable(0x249DF8f3d732FA209404178bE886409b0Cf559a2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =42 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "PIKA MOON!"; 
    string private constant _symbol = unicode"PMOON"; 
