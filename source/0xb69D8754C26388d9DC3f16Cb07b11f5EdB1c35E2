/**
 * 
 DefiXBet is an innovative Peer to Peer Gaming/Casino platform with Defi Features. 
 
 
 DXB relies on Smart Contracts to ensure fairness and transparency for all of its games with no manipulative scripts that put the players at a disadvantage on your typical online casinos. 
*/
