...
contract PONYO is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0x91d932b3F862f37c5138daab988b1A666502b051;

    uint256 public swapTokensAtAmount;
    bool    public swapWithLimit;
    bool    private swapping;

    uint256 public maxBuyAmount = 11000000 * 10**18; //
