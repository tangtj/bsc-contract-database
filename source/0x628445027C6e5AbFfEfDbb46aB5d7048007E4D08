...
/*
   ...
   Welcome to Baby Kishu Cake
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyKishuCake
   ...
   Can you make #BabyKishuCake 10000X? 
...
contract BabyKishuCake is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x85b314540ec8C587935287a3042c83b2a477Ea58); // Marketing Address
    ...
    string private _name = "BabyKishuCake";
    string private _symbol = "BABYKISHUCAKE";
