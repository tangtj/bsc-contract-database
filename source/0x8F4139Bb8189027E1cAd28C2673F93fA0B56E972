...
/**
P A C M O O N  C O I N  T O  T H E M O O N !!
// Lp Burn 100%
// 100% Supply to Liquidity

Telegram https://t.me/pacmooncoin
Website www.pacmooncoin.com
*/
...
contract PACMOONCOIN_TO_THE_MOON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x132E3FDC9A435D679251e85481f2C81Af4FF5F37); 
    address payable public Wallet_Dev = payable(0xb68A96c324d620EB87361b0404D9f69876824d21);
    ...
    string private constant _name = "PACMOON COIN"; 
    string private constant _symbol = unicode"ToTheMoon"; 
    ...
    constructor () {
        ...
        _owner = 0x42120fB92f8cea8667EE0F4d4FF07905128f2B2b;
