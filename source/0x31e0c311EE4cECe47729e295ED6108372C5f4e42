...
contract zsbToken is ERC20("Stabilize Strategy BSC MDO/BDO Token", "zsb-MBDO"), Ownable, ReentrancyGuard {
    ...
    function setupWithdrawTokens() internal {
        // Start with MDO
        IERC20 _token = IERC20(address(0x35e869B7456462b81cdB5e6e42434bD27f3F788c));
        tokenList.push(
            TokenInfo({
                token: _token,
        ...
        // BDO
        _token = IERC20(address(0x190b589cf9Fb8DDEabBFeae36a813FFb2A702454));
        tokenList.push(
            TokenInfo({
                token: _token,
                decimals: _token.decimals()
