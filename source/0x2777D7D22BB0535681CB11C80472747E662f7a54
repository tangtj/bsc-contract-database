...
//MCD TWEET ABOUT cute tiger

//tg : @Defiharecutetiger
...
contract cutetiger is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0x65071664B74Db6a502eE81306E28c8128683F664);

    string private _name = "cute tiger";
    string private _symbol = "cute tiger";
