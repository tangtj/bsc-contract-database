...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0x2f4B665474c69A498fe5B6B6093b60A467eED444),
      "Address is invalid"
    );
...
contract  TOKENDARKB is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("DARKB", "DARKB")
    ERC20Permit("DARKB")
    EmergencyDrainable(address(0x2f4B665474c69A498fe5B6B6093b60A467eED444))
  {
