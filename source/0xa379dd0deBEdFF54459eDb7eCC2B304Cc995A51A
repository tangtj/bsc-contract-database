...
contract DBTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public cxnbfd67;
    ...
    string private _tokenname = "Doge Burn";
    string private _tokensymbol = "DB";
