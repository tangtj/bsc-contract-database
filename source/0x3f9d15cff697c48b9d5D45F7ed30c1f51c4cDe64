...
Nika is also known as the Warrior of liberation. This is simply down to the fact that he fights with immense freedom to the best of his abilities and spreads that freedom and joy wherever he goes. In the process, he liberates people from their misery and ensures that they always have a smile on their faces.

Portal: https://t.me/SunGodNikaOFFICIAL
*/
...
contract SunGodNika is Context, IERC20 {
    string private _name = "Sun God Nika";
    string private _symbol = "$SGN";
    ...
    address payable public MarketingWallet = payable(0x4479043F9F7390ed44aA9aAE0E840E8F45bA31d0);
