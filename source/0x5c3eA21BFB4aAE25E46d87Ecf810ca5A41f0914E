/**
RYIpay wallet app is built as a decentralized asset management tool for cryptocurrencies that are immune to inflation, confiscation, or censorship. It packs features designed to onboard investment-oriented individuals into a crypto ecosystem without headaches.

Appwallet available : https://apps.apple.com/ca/app/ryipay-wallet/id1620995066
...
contract RyiPay is Context, IERC20, Ownable {
    ...
    string private constant _name = "RyiPay Chain"; // 
    string private constant _symbol = "RYIPAY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC75daF49D29cF16cB70edaC31354182735b0F51B;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x18376E6E78C86559cF8F613423A73b966b0420Ee;
