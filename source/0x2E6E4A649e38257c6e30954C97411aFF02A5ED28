...
Are you ready to taste the glorious old days of BSC Meme tokens once more? If yes, then you are in the right project. Join the KongApe Army Troop today!
LFG!!!
...
contract kongape is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xF713AD5800DEAC4A5D2B605B41AC0Cb09c01B5d5);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 8.");
	    require(taxFeeOnSell < 7, "Tax cannot be more than 8.");
