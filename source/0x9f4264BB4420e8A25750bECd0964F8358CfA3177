...
contract Kial is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kial", "KIAL")  {
        rewardToken = 0x55d398326f99059fF775485246999027B3197955;
        _marketingWalletAddress = 0x10e6B07D0e5D9b87c5004D2cCa212662e79C4073;
        ...
        _node = deadWallet;
        dividendTracker = new TokenDividendTracker(rewardToken, 10000 * 10 ** 18);
