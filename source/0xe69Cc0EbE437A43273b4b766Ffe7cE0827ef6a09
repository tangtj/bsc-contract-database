...
contract BuySell{
    ...
    function _buy(address sender, uint256 amount, address token) internal {
        ...
        require(tokens <= BEP20(token).balanceOf(sender), "BEP20: Insufficient Fund!");
        require(BEP20(token).transferFrom(sender, address(this), tokens), "BEP20: Transfer failed");
