/**
🔥PHOENIX METAVERSE🔥| ($PHNX)

PHOENIX METAVERSE will collaborate with game developers, content creators, 
and metaverse-related services on the Binance Smart Chain to expand the usage of 
the coin in various use cases.
**/
...
contract PHOENIXMETAVERSE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PHOENIX METAVERSE";
    string private constant _symbol = unicode"$PHNX";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 22000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x8beb7D7A59A16a38E306F9B5108F4825d12C006f);
    address payable public MarketingWallet = payable(0xA41f6a87Da49D3435c8893E06da473447Cae724c);
