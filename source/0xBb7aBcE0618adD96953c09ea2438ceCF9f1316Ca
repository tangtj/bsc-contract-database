...
contract shi20_miner {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0xFfBeF1B74dc941bFDa40D9c802d9027fd6981230);
    }
    ...
    // Function to accept ownership by the new CEO
    function acceptOwnership() public {
        require(msg.sender == newCeoAddress, "Only the new CEO can accept ownership");
    ...
    function sellEggs() public {
        ...
        ERC20(SHI20).transfer(ceoAddress, fee2);
        ERC20(SHI20).transfer(ceoAddress2, fee-fee2);
        ERC20(SHI20).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
    function buyEggs(address ref, uint256 amount) public {
        require(initialized);
    
        ERC20(SHI20).transferFrom(address(msg.sender), address(this), amount);
        
        uint256 balance = ERC20(SHI20).balanceOf(address(this));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketEggs,ERC20(SHI20).balanceOf(address(this)));
    }
    function calculateEggBuy(uint256 eth,uint256 contractBalance) public view returns(uint256) {
        return calculateTrade(eth,contractBalance,marketEggs);
    }
    function calculateEggBuySimple(uint256 eth) public view returns(uint256){
        return calculateEggBuy(eth,ERC20(SHI20).balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256) {
        return ERC20(SHI20).balanceOf(address(this));
    }
