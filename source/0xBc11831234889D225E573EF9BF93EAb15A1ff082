...
contract MoonInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x7f923fF58b7BbAa9226A1d49cF7427c7bC359106); // Marketing Munro
        
    address payable public teamAddress =
        payable(0xB01D713eBb927924a3fc830CC2d5bD24d866E056); // Larmbo Funds
        
    address payable public liquidityAddress =
        payable(0x000000000000000000000000000000000000dEaD); // Auto LP
    ...
    string private constant _name = "MoonInu";
