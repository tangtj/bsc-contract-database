...
contract SHREDCOIN is ERC20, Ownable {
    ...
    constructor() payable ERC20("Shred Inu", "SHRED") {
        ...
        treasuryWallet = 0x9c8B4cb8D4718C8b1E348F60fb210600165D1dB3;

        dividendTracker = new DividendTracker(1e6, rewardToken);
        ...
        _mint(treasuryWallet, 1e10 * (10 ** 9));
...
// https://t.me/ShredCoin

// https://www.shredinu.com

// https://twitter.com/Shred_Coin