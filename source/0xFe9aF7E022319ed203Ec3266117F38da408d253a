...
****************************
****************************
INSTAFANZ TOKEN CONTRACT
Tax on each Transaction: 6%
rewards for holders : 3%
auto Liquidity : 3%
****************************
****************************
*/
...
contract InstaFanz is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public totalFees = rewardFee.add(liquidityFee);
    ...
    constructor() ERC20("InstaFanz", "IFANZ") {
...
// To exclude from dividends the presale contract address
    function excludeFromDividends(address account) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // token share for liquidity and redistribution
        uint256 tokensForLiquidity = contractTokenBalance.mul(liquidityFee).div(totalFees);
        uint256 tokensForHolders = contractTokenBalance.sub(tokensForLiquidity);
        ...
        swapTokensForEth(tokensForHolders);
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
