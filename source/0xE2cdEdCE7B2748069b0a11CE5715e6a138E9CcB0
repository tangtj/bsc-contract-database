...
contract Hceo is IBEP20, Ownable {
    ...
    uint256 public maxWalletBalance = 100000 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 100000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 100000 * _decimalFactor; // 0.75% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 15000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
