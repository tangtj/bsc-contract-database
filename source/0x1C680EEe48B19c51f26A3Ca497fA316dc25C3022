...
/**
 *twitter:https://twitter.com/pepeworld_bsc
...
contract PEPEWOG is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    mapping(address => uint256) public walletMints;

    address reserveWallet = payable(0x95fc96fcb06b982AbfCCC020F2Dc7B9ccEa219B7);

    string public uriPrefix = "";
    string public uriSuffix = "";

    uint256 public constant maxWalletMint = 2;
