/**
Telegram: https://t.me/XenetBSC
Website: https://xe-net.network/
Twitter: https://x.com/xenetbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x26e2a36860eDD6081488C19A717bf6604394c648; // owner address
...
contract XENET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XENET";
    string private _symbol = "XEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f46D7De552d5F40D39C895b6baa5cbD4c238EE7); // Marketing Address
    address payable public teamWalletAddress = payable(0x8f46D7De552d5F40D39C895b6baa5cbD4c238EE7); // Team Address
