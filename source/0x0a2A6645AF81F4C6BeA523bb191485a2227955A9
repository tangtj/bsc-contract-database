...
contract LEOPARDV2 is Context, IERC20, Ownable {
    ...
    string private _name = "LEOPARDV2";
    string private _symbol = "LEOPARDV2";
    ...
    address private charityWallet = 0x0E90194D7a6A0062ab42C4E03d636C94ccfE0240;
    ...
    uint256 public _maxTxAmount = 45000000000 * 10**9;
