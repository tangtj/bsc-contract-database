...
// Telegram: https://t.me/dorklord20bsc
...
contract DORKL20 is Context, IERC20, Ownable {   
    ...
    address payable private _twddev = payable(0x02e032A222107968FeA54adb21Dc3FEF4DD81cA1);
    address payable private _twdmkt = payable(0x02e032A222107968FeA54adb21Dc3FEF4DD81cA1);
    
    string private constant _name = "Dorklord2.0"; 
    string private constant _symbol = "DORKL2.0";     
