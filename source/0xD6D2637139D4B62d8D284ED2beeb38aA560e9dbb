...
contract SHIBAvsPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "SHIPE";
    string private _symbol = "$SHIPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3e8B16258dC6b28A44Da85773b4EE5b1b8445207);
    address payable private DevelopmentWalletAddress = payable(0x3e8B16258dC6b28A44Da85773b4EE5b1b8445207);
