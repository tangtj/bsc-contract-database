...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcF104bc8DCc5dC026621D634F8CdD4d618DF3ff7 ; // owner address
...
contract BNBBLACKTIGER is Context, IERC20, Ownable {
    ...
    string private _symbol = "BNBBTIGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcF104bc8DCc5dC026621D634F8CdD4d618DF3ff7); 
    address payable public teamWalletAddress = payable(0xcF104bc8DCc5dC026621D634F8CdD4d618DF3ff7);
