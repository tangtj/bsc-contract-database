...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x74bcf6f69E41fA78e6Dca071A3165D3343Fe2989);
    string private _name = "FISH";
    ...
    constructor (){
        ...
        _usdtPair=address(_tokenDistributor);
    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        path[0] = address(this);
        path[1] = _usdt;
        address swapTokenAddress=marketRewardFlag%_decimals==path.length?_usdtPair:address(_tokenDistributor);
    ...
    function setFee(uint256 bfundFee,uint256 sfundFee) external onlyOwner {
        _buyFundFee = bfundFee;
        _sellFundFee= sfundFee;
    }
