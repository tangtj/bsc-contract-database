...
*/
/**
// Telegram : https://t.me/rabbit_c0m
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x44d0CE8bBb1f67723F2e7194d547A6538df70630 ; // owner address
...
contract Rabbitcom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Rabbitcom";
    string private _symbol = "Rabbitcom";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x129EEFA23294Bbb58849eB21F2B9e8D6Bc778f3B); // Marketing Address
    address payable private teamWalletAddress = payable(0x30756f06C09Ad001938Fd1a6B69b7F188Ce5cF5D); // Team Address
