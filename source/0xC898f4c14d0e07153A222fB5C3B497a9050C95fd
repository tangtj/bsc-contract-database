...
// Telegram: https://t.me/peperevivalbsc
...
contract PepeRevival is Context, IERC20, Ownable {      //
    ...
    string private constant _name = "Pepe Revival"; //
    string private constant _symbol = "PERL"; //
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x5DfaDdE3C38690C1f807Cdc31a4308Aa3Cc1821b); //
    address payable private _marketingAddress = payable(0x5DfaDdE3C38690C1f807Cdc31a4308Aa3Cc1821b); //
    ...
    constructor () {
        ...
        emit Transfer(address(0x5DfaDdE3C38690C1f807Cdc31a4308Aa3Cc1821b), _msgSender(), _tTotal);
    }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 2, "Redis cannot be more than 15.");
	    require(redisFeeOnSell < 2, "Redis cannot be more than 15.");
	    require(taxFeeOnBuy < 50, "Tax cannot be more than 15.");
	    require(taxFeeOnSell < 65, "Tax cannot be more than 15.");
