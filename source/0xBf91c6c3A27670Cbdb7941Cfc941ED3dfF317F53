...
contract BabyDSL  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BabyDSL ";
    string private _symbol = "BabyDSL ";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xeedF6e46b963c75F2814a99EAF470B91f69750c7); 
    address payable public teamWalletAddress = payable(0xeedF6e46b963c75F2814a99EAF470B91f69750c7); 
