...
Telegram : https://t.me/FLUFFYUNICORNINU
...
contract $FLUPPYUNICORN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2ef5eD28490B2294f3251e0aC36FaFac82416266;

    string private constant _name = "FluppyUnicornBuy";
    string private constant _symbol = "FluppyUnicorn";
