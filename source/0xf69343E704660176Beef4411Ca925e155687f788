...
contract Pope is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x056E411b5e287aD6deFc7D70DB389Ca142AbF1B4);
    address payable private _twdmkt = payable(0x056E411b5e287aD6deFc7D70DB389Ca142AbF1B4);
