// join the tg and become part ofthe community - https://t.me/ZeroTwoINUBsc
 // total tax 11%
 // 4% reflections
 // 4% auto lp
 // 3% marketing
...
contract ZeroTwoInu is Context, IERC20, Ownable {
    ...
    address private _marketingWallet = 0xEAC6964c5b12fdd47Fe3EEE15bfE10ed250f0814;
    ...
    string private _name = "ZeroTwoInu";
    string private _symbol = "02";
