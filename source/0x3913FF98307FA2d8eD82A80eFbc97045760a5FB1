...
contract Business {
    ...
    if (f1[msg.sender] == address(0)) {
            ...
            if (f1[_referrer] != address(0)) {
                f2[msg.sender] = f1[_referrer]; // F2
                if (f2[_referrer] != address(0)) {
                    f3[msg.sender] = f2[_referrer]; // F3
                    if (f3[_referrer] != address(0)) {
                        f4[msg.sender] = f3[_referrer]; // F4
                        if (f4[_referrer] != address(0)) {
                            f5[msg.sender] = f4[_referrer]; // F5
                            if (f5[_referrer] != address(0)) {
                                f6[msg.sender] = f5[_referrer]; // F6
                            }
                        }
                    }
                }
