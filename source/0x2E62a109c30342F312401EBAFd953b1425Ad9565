...
contract SuperMission is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SUPER MISSION";
    string private _symbol = "SPMN";
    ...
    uint256 private numTokensSellToAddToLiquidity = 400000 * 10**1 * 10**9;
    ...
    function sendBNBToCharityAndMarketing(uint256 amount) private { 
    ...
    function _transfer(
        ...
        if (
            ...
            //add liquidity and take donation and marketing fees
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 halfOfLiquify = contractTokenBalance.mul(6666).div(100000);
        uint256 otherHalfOfLiquify = contractTokenBalance.mul(6666).div(100000);
        
        uint256 portionForFees = contractTokenBalance.sub(halfOfLiquify).sub(otherHalfOfLiquify);
        //uint256 portionForFees = contractTokenBalance.mul(7692).div(10000);
        ...
        sendBNBToCharityAndMarketing(portionForFees);
