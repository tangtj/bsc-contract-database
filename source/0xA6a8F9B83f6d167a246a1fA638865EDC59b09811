...
HYPE IN US TODAY !
Let's join us, pump it to 200 members!
Best Community 🦊
...
Don't forget Join ⬇️
TG : https://t.me/+9JOWdIdtIrFhMWE9
**/
...
contract FOXXUS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FOXXUS";
    ...
    address payable public DevWallet = payable(0x167e7bc1ba737057aDee855d4fcCC17227ec0cFB);
    address payable public MarketingWallet = payable(0x72f1e3ca81261f9a1b325FD96270329af7Bc933F);
