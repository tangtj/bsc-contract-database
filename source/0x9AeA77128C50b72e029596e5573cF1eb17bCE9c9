...
contract CheemsTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Cheems";
    string private _seitokensymbol = "Cheems";
    address public hdxxcv56;
