...
contract XKITTYINU  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8e03dc95afA96ab56f29Fa39551634CB0768C77B); 
    address payable public Wallet_Dev = payable(0x8e03dc95afA96ab56f29Fa39551634CB0768C77B);
    ...
    constructor () {
        _owner = 0x8e03dc95afA96ab56f29Fa39551634CB0768C77B ;
