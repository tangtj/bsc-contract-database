...
contract None is Context, IERC20, Ownable {
    ...
    string private constant _name = "NONE ";
    string private constant _symbol = "$NONE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7331871947030e9ffbc36Dd31a0F65a49e958Ea7);
    address payable private _marketingAddress = payable(0x7331871947030e9ffbc36Dd31a0F65a49e958Ea7);
