...
contract Zoro_inu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xf97Cef5b35f7Fb4d47fB81EfC68c45020e6761DE);
    address payable private _marketingAddress = payable(0x613144edf5c62Aa766f20Ae454F6bF77178F1a4e);
