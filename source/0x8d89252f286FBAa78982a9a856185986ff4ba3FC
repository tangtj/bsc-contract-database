...
HodlTheBagForMoonOrGetRektSellingEarly
...
contract HodlTheBagForMoonOrGetRektSellingEarly is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x58C9A6Db47c3D0e578013D6f5eA3B7A8E478513f); 
    ...
    function Lessgoh() external onlyOwner {
        tradingActive = true;
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 40, "Must keep taxes below 9%");
