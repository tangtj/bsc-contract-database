...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8F46eBa5a6a949AAc4A5D0b7eb51A82eA8206309;
...
contract BOMBSTOPPER is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2f9fd3f4C7Bb28f6C3991CF6E703e949c4876E5C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BOMB STOPPER";
    string private _symbol = "BSTPR";
