...
contract MyToken is Context, IERC20, Ownable {
    ...
    string private  _name = "Bnxzilla";
    string private  _symbol = "Bnxzilla";
    ...
    constructor (uint256 _supply, uint256 _txFee, uint256 _lpFee, uint256 _mFee, uint256 _MAXAMOUNT, uint256 _SELLMAXAMOUNT, address routerAddress, address tokenOwner, address _marketingAddress) public {
        ...
        // exclude owner & this contract & marketing & dead from fee
        _isExcludedFromFee[tokenOwner] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[marketingAddress] = true;
        _isExcludedFromFee[deadAddress] = true;

        // exclude owner & marketing & dead from reward
        _tOwned[tokenOwner] = tokenFromReflection(_rOwned[tokenOwner]);
