...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 10000000000000000000000000000000000 * 10** Decimals;
        maxSellAmount = 100000000000000000000000000000* 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xBFB6D281f7D057B647c1F1f215D571fe01349bd5;//
...
contract BABYTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"YES2049",//Name
        unicode"YES2049",//Symbol
        18,//Decimals
        200000000,//Supply
