...
//Instagram: hhtps://instagram.com/pobittoken
*/
...
contract PoBit is Context, IERC20, Ownable {
    using Address for address;
    //Address Definition for use in the contract during deployment
    address payable public treasureWalletAddress = payable(0xaba5b7B894b3b4770a32256b3D18436aBC7Dd4A7); // treasure Wallet Address
    address payable public marketingWalletAddress= payable (0xaba5b7B894b3b4770a32256b3D18436aBC7Dd4A7); // marketing Wallet Address
    address payable public reserveWalletAddress= payable (0xaba5b7B894b3b4770a32256b3D18436aBC7Dd4A7); // reserve Wallet Address
    address public safuDevWallet = 0x3671c34fBc9c3091Afd4C9C947c4379f62Af5Dfd; //SAFU Dev Wallet for Record.
...
//Constructor for Deployment
    string private constant _safuDEV = "01";
