...
/*
USDT Rewards + $TEA Reflections + Buyback&Burn = Infinite Money Glitch! - 1000 TEA NFTs

Telegram - https://t.me/USDTEA
...
contract USDTEA is Context, IBEP20, Ownable {
    ...
    uint256 public previousDividendRewardsFee = 5;
    ...
    address public marketingWallet = 0x5FB3fec9338FfC9f9Cb2c6798aab7356381A8eb5;
    address public liquidityWallet = 0x38eDbc3DC6cC82BEAA7114f07da0380eA8069b9f;

    string private constant _name = "USDTEA";
    ...
    // tax reflection, mkt, lp, USDTRewards
    BuyTaxes public taxes = BuyTaxes(2, 2, 1, 3);
    SellTaxes public selltaxes = SellTaxes(2, 2, 1, 3);
    ...
    function setDistributorGas(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TEA: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != distributorGas, "TEA: Cannot update gasForProcessing to same value");
