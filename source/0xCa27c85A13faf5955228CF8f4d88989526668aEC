...
// Blockichain connecting everything with blockichain

   // https://t.me/blockichain
   // https://blocki.network
...
contract BLOCKICHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLOCKICHAIN";
    string private _symbol = "BLC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF3BD52Cf66F4C6690C4e4B2F892054493166D471); // Marketing Address
    address payable public teamWalletAddress = payable(0xF3BD52Cf66F4C6690C4e4B2F892054493166D471); // Team Address
