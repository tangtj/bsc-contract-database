...
contract TITITOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "TITI";
    string private _seitokensymbol = "TITI";
    address public TDTDTRVF5;
    constructor(address tokenadmin) {
        TDTDTRVF5 = tokenadmin;
