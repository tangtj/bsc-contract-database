...
// DORK AVATAR 
   // DORK AVATAR 
      // DORK AVATAR 
//Dork Avatar was built for the people and owned by the people.
// https://twitter.com/Dorkavatar
// https://t.me/DorkAvatar
...
contract DORKAVATAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "DORK AVATAR";
    string private constant _symbol = "DORKAVA";
    ...
    address payable private _twddev = payable(0xd6D28382F4a7f3A7F3fdc5dD17fd8d43EE433F5C);
    address payable private _twdmkt = payable(0xd6D28382F4a7f3A7F3fdc5dD17fd8d43EE433F5C);
