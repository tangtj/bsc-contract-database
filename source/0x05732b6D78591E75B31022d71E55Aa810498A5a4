...
contract Shibgotchi is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 1000000000000000000000;
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 90, "Marketing fee cannot be more than 90% of liquidity");
