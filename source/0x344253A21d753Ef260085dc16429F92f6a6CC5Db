...
contract bYooApeTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public dvppou6;
    ...
    string private _tokenname = "Baby YooshiApe";
    string private _tokensymbol = "bYooshiApe";
