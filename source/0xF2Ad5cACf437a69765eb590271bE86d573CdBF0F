// SPDX-License-Identifier: TREEDEFI LTD 13410488
...
library EcoLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'93b1ec6bb20601914a3d214f326d29cc2505a4fef08badf5a81a4a62fb6d8402' // init code hash
            ))));
    }
...
contract EcoRouter is IEcoRouter02 {
    ...
    address public cc_address; // carbon credit token address
    ...
    uint256 public carbonCreditPerGas = 10**10;
    ...
    **/
    function _burnOutCarbonCreditOffSet(
        ...
        if (wantToOffSetTransc == 1){
            ...
            TransferHelper.safeTransfer(cc_address, burnAddress, amounts[amounts.length - 1]);
    ...
    **/
    ...
    /**
     * @dev update CO2 token address which need to burn 
            to offset transaction, One ccOffSetSetter has
            pervilaged to call these function 
     * @param _cc_address CO2 token amount per Gas
    **/
    function setCarbonCreditOffSetPerGas(
        address _cc_address
    ) external {
        require(msg.sender == ccOffSetSetter, 'EcoRouter: FORBIDDEN');
        require(_cc_address != address(0x0), 'EcoRouter: _cc_address should be valid address');

        cc_address = _cc_address;
    }
