...
contract LIFRA is ERC20, Ownable {
    ...
    constructor() ERC20("LIFRA", "LIFRA") {
        ...
        marketingAddress = 0xbf525ebB1f80b081Ec661e04A6B20d009b9EC378;
    ...
    function updateFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _buyBurnFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee, uint256 _sellBurnFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBurnFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBurnFee;
        require(buyTotalFees <= 10,"Total buy fees cannot be greater than 10%");
        require(sellTotalFees <= 10,"Total sell fees cannot be greater than 10%");
    }
    ...
    function transferForeignToken(address _token, address _to) external onlyOwner returns (bool _sent) {
        require(_token != address(this), "Can't withdraw LIFRA tokens");
