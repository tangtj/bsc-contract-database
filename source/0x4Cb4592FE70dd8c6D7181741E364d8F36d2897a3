...
contract ChonkyHamster is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4537Aa2439e2747101983EF5d5a5b9Eeac6c2DC9); 
    address payable private Wallet_Dev = payable(0x4537Aa2439e2747101983EF5d5a5b9Eeac6c2DC9);
    ...
    constructor () {
        ...
        _owner = 0x4537Aa2439e2747101983EF5d5a5b9Eeac6c2DC9;
