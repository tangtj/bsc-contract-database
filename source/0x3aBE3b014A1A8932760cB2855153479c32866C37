...
contract Pcake is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x0F063fc24eE1c8E101035084AD0a26144831325f;
    ...
    string private _name = "Pancake King";
