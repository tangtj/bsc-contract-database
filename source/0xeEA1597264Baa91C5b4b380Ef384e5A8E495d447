...
contract BarbiePepeX is ERC20, Ownable, ReentrancyGuard {
    ...
    address public marketingWallet = 0x03269203258f5b50699F0B47d79693E6f222100A;
    ...
    constructor() ERC20("BarbiePepeX", "BarbiePepeX") {
