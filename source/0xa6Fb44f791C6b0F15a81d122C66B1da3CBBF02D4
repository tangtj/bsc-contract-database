...
Project Name : Blades Of Glory (BOG)

Telegram : https://t.me/BladesOfGlory_Official
...
contract $BOG is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = _tTotal * 10**_decimals;
    uint256 public maxBuyAmount = _tTotal * 10**_decimals;
    uint256 public maxWalletBalance = 20000000 * 10**_decimals;

    address public marketingAddress = 0xCEb67f978B4Db818CFE99f7C23cA843C2c7793c3;
    address public devAddress = 0xE96C8977074d624c3306631B32C4B35Dcd9be0A8;

    string private constant _name = "Blades Of Glory";
    ...
    // Owner cannot transfer out miniPEPE from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out miniPEPE!");
