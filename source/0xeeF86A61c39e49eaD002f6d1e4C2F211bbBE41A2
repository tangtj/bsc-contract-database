...
//TELEGRAM: https://t.me/whitetigeinu_bsc
interface IERC20 {
...
contract WhiteTigeInu is Context, IERC20, Ownable {
    ...
    address public devAddress = 0x27e7459D58DB05e5bEA2bBF7b68543021e266F77;

    string private constant _name = "WhiteTigeInu";
    string private constant _symbol = "Wtinu";
