        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x1eE8cf1c65D48b96f9D7c5C92B52FFb269855fa9), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xb875d51396784C4D15A01375D46A7346e60529B3),//FundAddress
        address(0x1eE8cf1c65D48b96f9D7c5C92B52FFb269855fa9)//ReceiveAddress
    ){
    }
}