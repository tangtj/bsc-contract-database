...
contract ShenronXTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tssxcv36;
    ...
    string private _tokenname = "ShenronX";
    string private _tokensymbol = "ShenronX";
