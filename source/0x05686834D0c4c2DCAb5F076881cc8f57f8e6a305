...
contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _bullNFTFee = 200;
    uint256 public _sellLpFee = 0;
    uint256 public _bullLpFee = 0;
    uint256 public _sellDevFee = 300;
    uint256 public _bullDevFee = 300;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[recipient]) {
                ...
                uint256 devFeeAmount = (tAmount * _sellDevFee) / 10000;
                if (devFeeAmount > 0) {
    ...
    function setFees(
        ...
        require(sellNFTFee + sellLpFee + sellDevFee <= 10000, "100%");
        require(bullNFTFee + bullLpFee + bullDevFee <= 10000, "100%");
        _sellNFTFee = sellNFTFee;
        _sellLpFee = sellLpFee;
        _sellDevFee = sellDevFee;
        _bullNFTFee = bullNFTFee;
        _bullLpFee = bullLpFee;
        _bullDevFee = bullDevFee;
    }
