...
/*
Website: https://helixchain.org
Twitter: https://twitter.com/helixchainofc
Telegram: https://t.me/helixchain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE438C0Bd797514351292E178f33253849c89800e;
...
contract HelixChain  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Helix Chain";
    string public _symbol = "Helix";
    uint8 public _decimals = 18;

    address payable private marketingWalletAddress = payable(0x86Ff648279b73e5d8cC6C9A87e962cecc8Db3332); 
    address payable private developmentWalletAddress = payable(0xff9CB632282393b96f1398c86d751eb0070E2A9a);
