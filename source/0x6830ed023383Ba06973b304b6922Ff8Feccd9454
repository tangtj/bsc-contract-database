...
/**
// "Dexrium: Empowering crypto traders with decentralized excellence."
...
contract Dexrium is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x4E1f60044D4FF7F83950B7db5CF1779b5Edab585; //
    address public devAddress = 0x4E1f60044D4FF7F83950B7db5CF1779b5Edab585; //

    string private constant _name = "Dexrium"; //
    string private constant _symbol = "Dexrium"; //
    ...
    // Owner cannot transfer out Dexrium from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Dexrium");
