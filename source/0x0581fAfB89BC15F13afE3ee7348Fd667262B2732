...
// PetCoinToken
contract PetCoinToken is BEP20, Pausable {
    using SafeMath for uint256;
    ...
    // Wallet Addresses (BSC MAINNET)
    address public PetCoinSafe = 0xe251b3D01966C84E6833056077B2faF411839B86;
    address public LiquidityPoolWalletAddress = 0x9cDc5e4E32B3F6d58b7ED62971b185a67a31DA4c;
    address public PublicSaleWalletAddress = 0x5cc6D2D19912191D589324012b8aCc7337D10380;
    address public ReserveWalletAddress = 0x9d13BD96722A2834638849E8f362785A1d1aD3E1;
    address public TreasuryWalletAddress = 0xbbEbE0F1c36AA937d1474d0C1370fa91F70b820D;
    address public CharityWalletAddress = 0xbc6C5697f205D339Db8F3eA0762125E02f621daB;
	address public FoundersWalletAddress = 0xDDb914BB14406B505638eFa5273552c356B7B85c;
    ...
    uint256 public MAXIMUM_TRANSFER_TAX_RATE = 1000;
    ...
    uint256 public maxSaleAmountRate = 250000;
    ...
    // start Block Swap
    uint256 public startBlockSwap = 1;
    ...
    // Additional tax rate (default is 0%)
    uint256 public additionalTaxRate = 0;
    // Additional tax expired block number(30days 864000)
    uint256 public bigtaxclearperiod = 0;
     ...
     */
    constructor()  BEP20("PetCoin.Love", "PETS") {
        _operator = _msgSender();
        emit OperatorTransferred(address(0), _operator);

        IUniswapV2Router02 _petsSwapRouter = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        ...
        */
        ...
        transferOwnership(PetCoinSafe);
        transferOperator(PetCoinSafe);
     ...
     */
    function _transfer(address sender, address recipient, uint256 amount) internal whenNotPaused virtual override antiWhale(sender, recipient, amount) {
    ...
    function maxSaleAmount() public view returns (uint256) {
        return balanceOf(petsSwapPair).mul(maxSaleAmountRate).div(100000000);
    }
    /**
    ...
    /**
     * Update the Maximum total tax rate
     * Can only be called by the current onlyOperator.
     */
    function setMAXIMUM_TRANSFER_TAX_RATE(uint256 _value) public onlyOperator {
        MAXIMUM_TRANSFER_TAX_RATE = _value;
    }

    /**
     * Update the Max Sale Amount Rate (% of liquidity pool)
     * Can only be called by the current onlyOperator.
     */
    function setmaxSaleAmountRate(uint256 _value) public onlyOperator {
        maxSaleAmountRate = _value;
    }
    ...
    */
    ...
    /**
     * Update petsSwapPair address.
     * Can only be called by the current onlyOperator.
     */
    function setpetsSwapPair(address _lp_pair) external onlyOperator{
        petsSwapPair = _lp_pair;
    }    
