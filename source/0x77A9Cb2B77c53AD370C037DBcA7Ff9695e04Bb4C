...
contract FixLP {
    address payable public feeRecipient = 0x4d11543eb0E38beCDf8c03c8176eF35Def5793Ba;
    uint256 public feeAmount = 0.001 ether;  // 0.001 BNB fee, using the ether unit for simplicity in Solidity.
