...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEc6C45C5275966FFf5e398aCC9D21DCD2fa2b660; 
...
contract WOLFMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WOLF MOON";
    string private _symbol = "WOLFM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE4208B4381A6dA05a843f8BC429EfcbC39A061b0); 
    address payable public teamWalletAddress = payable(0xE4208B4381A6dA05a843f8BC429EfcbC39A061b0); 
