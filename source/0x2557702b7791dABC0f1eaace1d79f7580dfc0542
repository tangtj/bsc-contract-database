...
//TELEGRAM: https://t.me/Xsalepadbsc
interface IERC20 {
...
contract Xsalepad is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x3087EDF436a8A61bcbC92448fdC2C31381413519;
    address public devAddress = 0x8f9D7ce067d48131cEfceef25DE6E56204A5a915;

    string private constant _name = "Xsalepad";
