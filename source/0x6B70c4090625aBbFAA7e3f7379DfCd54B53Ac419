/*
// About Miracle Finance (MINA)

Miracle is a fully composable liquidity transport protocol.
With Miracle, users & dApps can transfer native assets cross-chain
while accessing the protocol’s unified liquidity pools with instant guaranteed finality. 
The universe is infinite with Miracle.

// TG: https://t.me/MiracleFinancePortal
*/
...
contract MiracleFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Miracle Finance";
    string private _symbol = "MINA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdf87f619485fbF660b7ab85537270a63eA5DAdD9); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x70b27e0325f7b21D9427f94C02a84a7BA790F71B); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (3 * 10**6 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
