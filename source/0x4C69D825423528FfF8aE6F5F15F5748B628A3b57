/**
   Welcome to Baby Floki. BABYFLOKI token 
   holders enjoy the privilege of buy, sell 
   and trade meme NFTs directly with dApp.
  TELEGRAM: https://t.me/BabyFlokiLive
*/
...
contract BabyFloki is Context, IBEP2022, Ownable {
