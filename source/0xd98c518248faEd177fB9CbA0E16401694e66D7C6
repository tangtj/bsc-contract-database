...
/**
   ...
   Max Transaction: 2,000,000,000 (2%)
   Max Holding: 2,000,000,000 (2%) ANTI - WHALE
   
   2% Distributed to holders
   3% Added to liquidity
   5% Added to ShortTesla
...
contract STSL is Context, IERC20, Ownable {
    ...
    string private _name = "ShortTesla";
    string private _symbol = "STSL";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 2; //2% Distributed to holders
    ...
    uint256 public _marketingAndDevBudget = 5; //5% Added to ShortTesla
    ...
    uint256 private numTokensSellToAddToLiquidity = 2500000 * 10**3 * 10**18;
