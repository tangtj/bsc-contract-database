/**
WEB: https://pepekingprawn.vip/dog/
TG: https://t.me/PepeKingPrawn
*/
...
contract PEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe King Prawn";
    ...
    address payable private _developmentAddress = payable(0x8409ddBAebEDb0Ed6af89C7f3b3dcF7eCAa53c72);
    address payable private _marketingAddress = payable(0x8409ddBAebEDb0Ed6af89C7f3b3dcF7eCAa53c72);
