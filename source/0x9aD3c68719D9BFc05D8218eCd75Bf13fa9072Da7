...
contract FUTIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUTIGER";
    string private _symbol = "FUHU";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xa4E56A20e95fcac7A0173535CdE8Bb9A77a01C5F);
    address payable public teamWalletAddress = payable(0xa4E56A20e95fcac7A0173535CdE8Bb9A77a01C5F);
