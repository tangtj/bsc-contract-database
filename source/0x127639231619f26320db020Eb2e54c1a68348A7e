...
contract HiddenCakeVillageNFT is Ownable, ERC721, ERC721Enumerable {
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0x1cAe62F55cCA08Fc196289D89612C3Dd7eff2c8B).transfer((p*279)/1000);
        payable(0x092337Aa2C8b5d236f3f790190f06Fd95B26a74c).transfer((p*279)/1000);
        payable(0x092337Aa2C8b5d236f3f790190f06Fd95B26a74c).transfer((p*332)/1000);
