...
contract XONDefi is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20Mintable;

    uint256 public countPlayers = 1;
    address public startAdd = 0xBEC63093EAd279F4E2303D46BeeF359bf6e3517F;
    address public Ownn = 0x3ECD301CD6a786f7043dDB4dd819B3EF7D682709;
    ...
    address mkt = 0x89155184CB07200BBf3D3b26dbb1fc79DF1089BA;
    address pool = 0x96F89d43e5e10280EBBAB756352BB919721D6A74;
    address liqyt = 0x416443Df7d662c1739eE33fe974670e0B9d1E39f;
    address reward = 0xDaA3d0168d1d363CA3c5987266cd9FAF34d469eB;
    address burn = 0x7E4d008f1cb0583C1628b3a4aAcF690258C345Ce;
    ...
    function staking(uint256 amountIp) public returns (bool) {
        ...
        uint8 _pt = 0;
        if (amounts >= 1_000_000 * 10**18 && amounts < 100_000_000 * 10**18) {
            types = 1;
            _pt = 12;
        } else if (
            amounts >= 100_000_000 * 10**18 && amounts < 1_000_000_000 * 10**18
        ) {
            types = 2;
            _pt = 15;
        } else if (amounts > 1_000_000_000 * 10**18) {
            types = 3;
            _pt = 18;
        } else {
            types = 0;
    ...
    function withdraw() public returns (bool) {
        ...
        uint256 profds = 0;
        // uint256 amounts = _stake[msg.sender].amount;
        // if (amounts >= 1_000_000 * 10**18 && amounts < 100_000_000 * 10**18) {
        //     types = 1;
        // } else if (
        //     amounts >= 100_000_000 * 10**18 && amounts < 1_000_000_000 * 10**18
        ...
        profds = (((_stake[msg.sender].amount * times * _stake[msg.sender].pt) / 259200000) -
            _stake[msg.sender].received);
        ...
        address ref3 = addCmmBrand((profds * 10) / 100, ref2);
        address ref4 = addCmmBrand((profds * 10) / 100, ref3);
        address ref5 = addCmmBrand((profds * 5) / 100, ref4);
        address ref6 = addCmmBrand((profds * 5) / 100, ref5);
        address ref7 = addCmmBrand((profds * 5) / 100, ref6);
        address ref8 = addCmmBrand((profds * 5) / 100, ref7);
        address ref9 = addCmmBrand((profds * 5) / 100, ref8);
        addCmmBrand((profds * 5) / 100, ref9);
        return true;
    }
        ...
        if (block.timestamp - _stake[msg.sender].timestamp > 15555552000) {
            ...
            _joinToken.safeTransfer(
                ...
                _stake[msg.sender].amount -
                    ((_stake[msg.sender].amount * 50) / 100)
            );
        }
