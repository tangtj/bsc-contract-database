...
contract APETOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tbffhg9;
    ...
    string private _tokenname = "GreenApe";
    string private _tokensymbol = "APE";
