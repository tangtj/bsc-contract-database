// 4% BURN 4% REDISTRIBUTION

// https://t.me/SkyBornBSC
...
contract skyborn is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SkyBorn'; 
    string private constant _symbol = 'SKYBORN'; 
    uint8 private constant _decimals = 18;

    //Supply and Reflected Supply and other options
    uint256 private constant _decimalFactor = 10**uint256(_decimals);
    uint256 private _tokenTotal = 1000000000000 * _decimalFactor ; // 1 tril supply
    uint256 private constant MAX = ~uint256(0);
    uint256 private _reflectedTotal = (MAX - (MAX % _tokenTotal));
    uint256 private constant _granularity = 100; // this allows 0.5 percentages
