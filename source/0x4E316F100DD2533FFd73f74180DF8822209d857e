...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 220000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x28060E05953A75FdF97928941b1C9A86ba107887;    
...
contract LuckyToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x28060E05953A75FdF97928941b1C9A86ba107887) //开发
    ){
