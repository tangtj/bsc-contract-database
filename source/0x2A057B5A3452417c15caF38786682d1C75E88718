...
// Telegram: https://t.me/CommunityCalciumBSC
...
contract CAL is Context, IERC20, Ownable {   
    ...
    address payable private _twddev = payable(0x89446fb0293608B923aA0e2fb15ecCc4721C5980);
    address payable private _twdmkt = payable(0x89446fb0293608B923aA0e2fb15ecCc4721C5980);
