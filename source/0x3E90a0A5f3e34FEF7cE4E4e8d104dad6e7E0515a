/**
Telegram - https://t.me/Waluigi_Inu
Website - https://www.waluigi-inu.com
Twitter - https://twitter.com/Waluigi_Inu
*/         
...
contract Waluigi is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Waluigi Inu";
    string constant _symbol = "WALUIGI";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x48f517dC4b94a65d8aA1eF7e44214C0da28CA0F2;
