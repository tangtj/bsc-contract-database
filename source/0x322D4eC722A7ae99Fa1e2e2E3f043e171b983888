// https://t.me/GreenCandleStickBSC
// https://twitter.com/greencandle_man
// https://www.green-candlestick-token.com/
...
contract GreenCandle is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Green Candle Token";
    string private constant _symbol = unicode"GCT";
