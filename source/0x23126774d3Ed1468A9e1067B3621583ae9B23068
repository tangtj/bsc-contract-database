...
contract CyronNetwork is Context, IERC20 {
    string private _name = "Cyron Network";
    string private _symbol = "CYRON";
    ...
    address payable public MarketingWallet = payable(0x281D6AC22E9245CBC8c5C5809b0F55c8796a15BF);
