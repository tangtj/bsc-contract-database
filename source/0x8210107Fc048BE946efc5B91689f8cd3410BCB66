...
// StreamToken with Governance.
// ERC20 (name, symbol, decimals, burnrate, initSupply)

contract StreamToken is ERC20("Streamity.fi", "STREAM", 18, 0, 10000000), Ownable, Mintable {
