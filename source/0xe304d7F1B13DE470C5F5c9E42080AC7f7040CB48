...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xF47e8edCE9D3ede001bc9d2261Fd6035849531fc; 
...
contract OldmanDork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oldman Dork";
    string private _symbol = "ODK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4248f9E20Ae0976192f1FEA68bEcd67FEcA8Dc54);
    address payable public teamWalletAddress = payable(0x4248f9E20Ae0976192f1FEA68bEcd67FEcA8Dc54); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 10 / 100000;
