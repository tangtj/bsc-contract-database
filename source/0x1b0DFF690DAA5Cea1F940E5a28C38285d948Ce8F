...
interface IDEXRouter {
    ...
    contract CENTURIUM is IBEP20, Auth {
    ...
    string constant _name = "CENTURIUM";
    ...
    address public marketingFeeReceiver = 0x3ad7247b2A39cC29809A28EC755865108fA4D29a;
    address public devFeeReceiver = 0x1309915C87DB96A6E881531DBE86686355b92c1E;
