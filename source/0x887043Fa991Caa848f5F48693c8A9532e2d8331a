...
👋 Welcome to the KITTEN COIN, our community token.
Ready for 1000x 💥💥💥
...
KITTEN COIN aims to become one of the most recognized and respected cryptocurrencies 
among cat lovers and the general public.
**/
...
contract KITTENCOIN is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x89f9CAA41aEd48112C9B515642038cBB2509807f);
    address payable public MarketingWallet = payable(0x4eC6a487DeA07D2F6633827b74C3FA378176D909);
