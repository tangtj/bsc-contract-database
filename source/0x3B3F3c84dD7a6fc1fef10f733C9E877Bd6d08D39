...
MAX TX     - 1% (100 mil of tokens)
Max Wallet - 1% (100 mil of tokens)
...
/* Token contract */
contract Flokina is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2CE41cD11fC8Be3F1a4cc6Af1991B775dc671F5A;
    ...
    // Name and symbol
    string constant _name = "Flokina Inu";
    string constant _symbol = "FINAINU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% (100 mil)
    ...
    uint256 public marketingFeeSell = 95;
