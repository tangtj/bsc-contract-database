...
contract TTMToken is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 public RATE_DENOMINATOR = 10000;
    uint256 public buyFeeRate = 0;
    uint256 public sellFeeRate = 0;
    address public feeTo=0xf1589Db5DD5b03D465D4d24757c3B5172b69a14a;
    ...
    constructor(address feeTo_) public ERC20('TTZ', 'TTZ')  {
        feeTo = feeTo_;
