// TELEGRAM: https://t.me/theWhaleGame
// WEBSITE : https://whalegame.site/
...
contract WHALEGAME is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "WHALEGAME";
    string private constant _symbol = unicode"$WG";
    ...
    address payable public DevWallet = payable(0xBa085F74a371328d91B6658eC529d195b1Fe1a9A);
    address payable public MarketingWallet = payable(0x1b3D21a036106815580ccabcD383D5524384c3fD);
