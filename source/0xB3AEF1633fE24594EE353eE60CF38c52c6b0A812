// https://t.me/ZiFiBSC
// https://twitter.com/ZiFiToken
// https://dapp.zifitoken.io/
...
contract ZeroInflation is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zero Inflation Finance";
    string private constant _symbol = unicode"ZiFi";
