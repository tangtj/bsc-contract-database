...
contract KYdoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KYdoge";
    string private _symbol = "KYdoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x21d44aC87630FD7Bae2A51bb618C59DD997E97F7); // Marketing Address
    address payable public teamWalletAddress = payable(0x21d44aC87630FD7Bae2A51bb618C59DD997E97F7); // Team Address
