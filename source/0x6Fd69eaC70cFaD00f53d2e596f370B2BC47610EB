...
contract DUGGEETOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 149999888777 * 10**9;
    ...
    address public charityWallet = 0x76Cf0FaEeCDCEeEf1e3A93743B78D8D5e59f3C55;
