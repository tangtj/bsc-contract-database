...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B897f3d593Bb93E858dE083405611E68afE2c33; // owner address
...
contract DOGEPAYPAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge PayPal";
    string private _symbol = "DOGE PAL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x590ea87ACc752d5f41076989B71d60132F03fe16); // Marketing Address
    address payable private teamWalletAddress = payable(0x4B897f3d593Bb93E858dE083405611E68afE2c33); // Team Address
