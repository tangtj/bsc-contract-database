...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xc97770765403b824547EA4665a3Ebd79C1AbBfB4; 
...
contract MEMES is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc97770765403b824547EA4665a3Ebd79C1AbBfB4);
    address payable public teamWalletAddress = payable(0xc97770765403b824547EA4665a3Ebd79C1AbBfB4); 
    ...
    uint256 private _totalSupply = 4900000000* 10**_decimals;
    uint256 public _maxTxAmount = 4900000000* 10**_decimals; 
    uint256 public _walletMax = 4900000000* 10**_decimals;
