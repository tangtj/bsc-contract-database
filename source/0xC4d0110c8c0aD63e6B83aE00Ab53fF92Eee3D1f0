...
// MAIN GROUP : https://t.me/BILLIONAIRECBSC
...
contract BILLIONAIRE is Context, IERC20, Ownable {
    ...
    string private _name = "BILLIONAIRE WITH BSC";
    string private _symbol = "$BILL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x526BD1A0150F071B4405869B12eFA7B917618756); // Marketing Address
    address payable public teamWalletAddress = payable(0x526BD1A0150F071B4405869B12eFA7B917618756); // Team Address
