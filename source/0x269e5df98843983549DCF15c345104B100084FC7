...
contract RedMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5804e039fCDf9b354d7c0bd34C2F3C39c54775Fa); 
    address payable public BurnedWalletAddress = payable(0x5804e039fCDf9b354d7c0bd34C2F3C39c54775Fa); 
