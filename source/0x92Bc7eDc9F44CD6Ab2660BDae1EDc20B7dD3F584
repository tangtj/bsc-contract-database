...
contract test is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3026c89b278b06E642ffBF6Adb3C6E7DFd8d069a); // Marketing Address
    address payable public teamWalletAddress = payable(0x3026c89b278b06E642ffBF6Adb3C6E7DFd8d069a); // Team Address
