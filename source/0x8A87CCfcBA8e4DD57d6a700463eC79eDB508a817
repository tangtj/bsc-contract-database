...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 90;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x13D0B9adf5762a45e8b8aD229B1E39566a623434;
...
contract FTCOIN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x99e3761BeB222488d6c91255bf49e9eF625E7876)
    ){
