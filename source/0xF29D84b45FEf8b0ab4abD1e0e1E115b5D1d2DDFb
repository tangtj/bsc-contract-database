...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 300000 * 10**8;
    ...
    address private fundAddress = address(0x3bD3B797B37AB14583Cf8a5e4C199C2686371B11);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 7 * 10**uint256(_decimals);
