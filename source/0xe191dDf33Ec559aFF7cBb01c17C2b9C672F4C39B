...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe6eD59cdaFc1E2817d588C47303D623A30C09dE6; // owner address
...
contract VanguardProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vanguard Protocol";
    string private _symbol = "VPro";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe6eD59cdaFc1E2817d588C47303D623A30C09dE6); // Marketing Address
    address payable private teamWalletAddress = payable(0xe6eD59cdaFc1E2817d588C47303D623A30C09dE6); // Team Address
