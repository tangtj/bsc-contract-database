...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCe208655df3C471DD63a75cb42E1f54612Be695B; // owner address
...
contract Flokirum is Context, IERC20, Ownable {
    ...
    string private _name = "PayPal Funds";
    string private _symbol = "PayPal";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x675D13Fc712B8022c9c5460bb2A5bee0B164A555); // Marketing Address
    address payable private teamWalletAddress = payable(0xCe208655df3C471DD63a75cb42E1f54612Be695B); // Team Address
