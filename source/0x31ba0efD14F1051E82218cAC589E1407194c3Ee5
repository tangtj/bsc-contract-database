...
db      d888888b d888888b d88888b .d8888. db   d8b   db  .d8b.  d8888b. 
88        `88'   `~~88~~' 88'     88'  YP 88   I8I   88 d8' `8b 88  `8D 
88         88       88    88ooooo `8bo.   88   I8I   88 88ooo88 88oodD' 
88         88       88    88~~~~~   `Y8b. Y8   I8I   88 88~~~88 88~~~   
88booo.   .88.      88    88.     db   8D `8b d8'8b d8' 88   88 88      
Y88888P Y888888P    YP    Y88888P `8888Y'  `8b8' `8d8'  YP   YP 88  
...
======================= Quick Stats ===================
    => Name        : LiteSwap
    => Symbol      : LTS
    => Total supply: 100,000,000 (1 Billion)
    => Decimals    : 8
...
-------------------------------------------------------------------
 ...
 Copyright (c) 2021 LiteSwap ( https://liteswap.finance )
-------------------------------------------------------------------
*/ 
...
contract LiteSwap is Context, IBEP20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        _qTradeRotations = _qTradeRotations.add(amount);
            ...
            if(_qTradeRotations >= (0 * _CORRECTDECIMALS) && _qTradeRotations <= (1999999*_CORRECTDECIMALS)){
                _startBurnLevy(250);
            }   else if(_qTradeRotations >= (2000000 * _CORRECTDECIMALS) && _qTradeRotations <= (4000000 * _CORRECTDECIMALS)){
                _startBurnLevy(350);
            }   else if(_qTradeRotations >= (4000000 * _CORRECTDECIMALS) && _qTradeRotations <= (6000000 * _CORRECTDECIMALS)){
                _startBurnLevy(450);
            }   else if(_qTradeRotations >= (6000000 * _CORRECTDECIMALS) && _qTradeRotations <= (8000000 * _CORRECTDECIMALS)){
                _startBurnLevy(550);
            } else if(_qTradeRotations >= (8000000 * _CORRECTDECIMALS) && _qTradeRotations <= (10000000 * _CORRECTDECIMALS)){
                _startBurnLevy(650);
            }
    ...
    function _burnFloat(uint256 bLevy, uint256 rBurn, uint256 qLevy, uint256 qBurn) private {
        ...
        if(_qBurnRotations >= (450000 * _CORRECTDECIMALS)){
                uint256 _qRebase = 112500 * _CORRECTDECIMALS;
                _qBurnRotations = _qBurnRotations.sub((450000 * _CORRECTDECIMALS));
                _qTradeRotations = 0;
                _startBurnLevy(250);
                _rebase(_qRebase);
            } 
    ...
    function _rebase(uint256 supplyDelta) internal {
        _LiteSwapRotations = _LiteSwapRotations.add(1);
        _qTotal = _qTotal.add(supplyDelta);

        if(_LiteSwapRotations > 192 || _qTotal <= 35200000 * _CORRECTDECIMALS){
            _startEndProcedure();
        }
    }
