/**
    ...
    TG: https://t.me/pepexride
    Twitter: https://twitter.com/pepexride
...
contract PXR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe X Ride";
    string private _symbol = "PXR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0D9C34d32930a95414f0ADA651a6E20252e9C895); // Marketing Address
    address payable private teamWalletAddress = payable(0x0D9C34d32930a95414f0ADA651a6E20252e9C895); // Team Address
