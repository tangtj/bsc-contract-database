// t.me/InternetofEnergyNetwork 
// InternetofEnergyNetwork.com
...
contract InternetofEnergyNetwork is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "InternetofEnergyNetwork";
    string public symbol = "IOEN";
