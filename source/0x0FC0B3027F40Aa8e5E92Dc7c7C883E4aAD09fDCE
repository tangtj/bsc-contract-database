...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x55112c769F4723319b7dfD76D99454c55D7Fbc4F;
...
contract Kashiba is Context, IERC20, Ownable {
    ...
    string private _name = "Kashiba Inu";
    string private _symbol = "KASHIBA";
    ...
    //set to 1 at the start, will be changed post-launch
