...
abstract contract Project {
    address public marketingWallet = 0x29AC0FE3d64f4650178f9600234D832C7a74b02C;
    address public treasuryWallet = 0x29AC0FE3d64f4650178f9600234D832C7a74b02C;

    string constant _name = "Have Rich";
    ...
    uint256 public _maxWalletToken = _maxTxAmount * 10; //
...
contract HAVERICH is Project, IBEP20, Auth {
    using SafeMath for uint256;
