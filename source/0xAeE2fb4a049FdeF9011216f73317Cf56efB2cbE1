...
contract UNCLEPEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x598b6D1E67062bc394C594A862B044d8A7cDdDd5); 
    address payable public Wallet_Dev = payable(0x598b6D1E67062bc394C594A862B044d8A7cDdDd5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "UNCLEPEPE"; 
    string private constant _symbol = unicode"$UNCLEPEPE"; 
    ...
    constructor () {
        _owner =0x598b6D1E67062bc394C594A862B044d8A7cDdDd5;
