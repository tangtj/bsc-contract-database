...
// telegram     : https://t.me/mattandzoobsc
...
contract MattAndZoo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MattAndZooBSC";
    string private _symbol = "MattAndZooBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA3587d1533DAB427C21D8F3FB9CcB87cC31d0126); // Marketing Address
    address payable public teamWalletAddress = payable(0xA3587d1533DAB427C21D8F3FB9CcB87cC31d0126); // Team Address
