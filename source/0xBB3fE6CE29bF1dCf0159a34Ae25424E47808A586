...
contract Fixinfinitum {
    address payable public feeRecipient = 0xF3b89b023A14CAeFFaFE6cba0cb8756177751EE5;
    uint256 public feeAmount = 0.05 ether;  // 0.05 BNB fee for robin
