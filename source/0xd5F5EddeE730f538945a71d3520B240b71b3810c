...
contract layernomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LAYERNOMICS";
    string private _symbol = "$LYOM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf7f333a24E3dB737A5D80642C34D4854ae616D98);
    address payable private DevelopmentWalletAddress = payable(0xf7f333a24E3dB737A5D80642C34D4854ae616D98);
    ...
    uint256 public _walletMax = 20 * 10**9;
