...
interface IDEXRouter {
 ...
 contract CatHulk  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "CatHulk";
    string constant _symbol = "CATHULK";
    ...
    address public devFeeReceiver = 0x252d5a7DE387E9a622ee90fD9c640a56d1cC6191;
    address public buybackFeeReceiver = 0x252d5a7DE387E9a622ee90fD9c640a56d1cC6191;
