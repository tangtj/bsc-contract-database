...
contract HetariumBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "HETARIUM";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x3B81B46650e0baCa34564A0123f87D358a125691);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x3B81B46650e0baCa34564A0123f87D358a125691] = true;
