...
// Website  : https://eden-network.site/
// TG       : https://t.me/EdenNetworkPortal
...
contract EdenNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Eden Network";
    string private _symbol = "$EDEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e03904DC079780670EF0173b388216aaB993054); // Marketing Address
    address payable public teamWalletAddress = payable(0x8e03904DC079780670EF0173b388216aaB993054); // Team Address
