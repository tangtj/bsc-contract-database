/*
Website : https://smurfcatbsc.com/

Twitter : https://x.com/smurfcat_bsc
*/
...
contract SMURF is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 100_000 * 10**decimals();
    uint256 public maxWalletLimit = 1_000_000 * 10**decimals();

    address public marketingWallet = 0x7587330A3806d1D1A4C0Cc6C390E4455795Af967;
    ...
    constructor() ERC20("Real Smurf Cat",unicode"шайлушай") {
        _tokengeneration(_msgSender(), 100_000_000 * 10**decimals());

        IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // uniswap V2
    ...
    function _transfer(
        ...
        if (sender == uniswapV2Pair && block.number < launchedAtBlock + 10) {
