...
contract BabyPepe is Context, IERC20, Ownable {
    ...
    string private _symbol = "BBPP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE69F6eC36d7764C06C4B6872c639954934B0a88F); // Marketing Address
    address payable public teamWalletAddress = payable(0xE69F6eC36d7764C06C4B6872c639954934B0a88F); // Team Address
