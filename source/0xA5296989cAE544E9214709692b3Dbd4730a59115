...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xde6fF1aE0Df77D21b31D2D9cA243b95b1E9373Bb;
...
contract RBNToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd3dE4fADEeBD49fd1693B0C791a7d2B870159942;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 770000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RBN Token";
    ...
    uint256 public _maxTxAmount = 770000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 770000000 * 10**18;
