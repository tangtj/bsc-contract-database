...
Website : http://animesaga.online
Medium  : https://medium.com/@animebsc
Twitter : https://twitter.com/anime_bsc
YouTube : https://youtube.com/@animebsc
Tiktok  : http://tiktok.com/@anime_bsc
telegram : https://t.me/Anime_Bsc
...
contract ANIME is ERC20, Ownable {
    ...
    constructor() payable ERC20("ANIME", "$ANIME") {
        ...
        burnFeeOnBuy        = 5;
        marketingFeeOnBuy   = 85;
        totalBuyFee         = burnFeeOnBuy + marketingFeeOnBuy;

        burnFeeOnSell       = 5;
        marketingFeeOnSell  = 85;
        totalSellFee        = burnFeeOnSell + marketingFeeOnSell;

        totalFees           = totalBuyFee + totalSellFee;

        marketingWallet = 0x58022c4C52bb8E869394aF3C94f2D495f8fEf28B;
        developmentWallet1 = 0x7C0EaeEF74EFE2001aE779d043E6B6CE1debcAb4;
        developmentWallet2 = 0x17D484d2fD02c94F63a2550e22b60724F5b55285;
        developmentWallet3 = 0x388d13849d709aFabd8d88Bee7D8d4E249af69E0;
