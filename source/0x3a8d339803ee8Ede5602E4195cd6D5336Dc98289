/**
  ChineseDogeYear is a token that has a potential to be one of moonshot this year. We have a solid line up before and after launch and Big Marketing Plan ahead! Come and join us.

ChineseDogeYear is a community based meme token,This will be driven by the community itself. Our goal is to provide charity donations to mental health organizations and Animal shelters around the globe. ChineseDogeYear is the Pot-head of the DOGE family and
become the next big thing on BSC. 
...
Max Buy:500000000000000 Around .09 BNB or .1 BNB

Website:https://www.chinesedogeyear.com
Twitter: https://twitter.com/ChineseDogeYear
Telegram:https://t.me/ChineseDogeYear
...
contract ChineseDogeYear is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10_000_000_000_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_000_000_000_000 * 10**9; 

    string private constant _name = "Chinese Doge Year"; 
    string private constant _symbol = "CDOGEY"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 20;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0xc58C3Ee8F362E13D6f23c4B4b5a25F6f2c78521b; 
