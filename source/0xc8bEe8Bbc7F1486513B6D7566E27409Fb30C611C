...
contract LivingForest is ERC20, Ownable {

    constructor() ERC20("Living Forest", "LFC") {
    ...
    function transferWithDecimals(address to, uint256 amount) public {

        require(amount >= 0, "Amount should be more than 0");

        uint256 normalizedAmount = amount * (10 ** decimals());

        _transfer(_msgSender(), to, normalizedAmount);
