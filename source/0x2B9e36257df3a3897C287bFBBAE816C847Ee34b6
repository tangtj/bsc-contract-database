...
contract y8 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        888,//Supply
        address(0x50B16b287DCd0Dfce7aA68D1F1d3D2c064373220),//FundAddress
        address(0x97D6A46f699416d4796D3eFB80765Af02C2A4Af9)//ReceiveAddress
    ){
    }
}