/*
Welcome {USERNAME}
Trivium Chain is developing technology that reduces the gaps between traditional and decentralized finance.
...
TG:https://t.me/Triviumchain
Web: https://explorer.triviumblockchain.live/
*/
...
contract TriviumChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "TRIVIUM CHAIN";
