/**
 ...
 _______   __    __  __       __  _______         __       __  __      __        _______   ______  _______   ________ 
/       \ /  |  /  |/  \     /  |/       \       /  \     /  |/  \    /  |      /       \ /      |/       \ /        |
$$$$$$$  |$$ |  $$ |$$  \   /$$ |$$$$$$$  |      $$  \   /$$ |$$  \  /$$/       $$$$$$$  |$$$$$$/ $$$$$$$  |$$$$$$$$/ 
$$ |__$$ |$$ |  $$ |$$$  \ /$$$ |$$ |__$$ |      $$$  \ /$$$ | $$  \/$$/        $$ |__$$ |  $$ |  $$ |  $$ |$$ |__    
$$    $$/ $$ |  $$ |$$$$  /$$$$ |$$    $$/       $$$$  /$$$$ |  $$  $$/         $$    $$<   $$ |  $$ |  $$ |$$    |   
...
Telegram: http://t.me/PumpMyRidebsc
Website: https://www.pumpmyridebsc.com/
Max buy 2% max, hold 4%
Liquidity burned, Ownership renounced

There's also an anti-dump mechanic so holders get rewarded.

Sell within 30 minute       : 24% burn (18% Back to the Liquidity Pool, 6%  Redistributed to Holders)
Sell within 45 minute      : 16% burn (12% Back to the Liquidity Pool, 4%  Redistributed to Holders)
...
contract TokenOfTheApes is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 200 * 10**6 * 10**9; // 200 million
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 400 * 10**6 * 10**9; // 400 million

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Token Of The Apes";
    string private _symbol = "TOKENAPES";
