...
contract MFI is ERC20 {
    ...
    string public constant name = "Marshmallow Finance";
    ...
    uint256 public constant requestMinimum = 1 ether / 10; // 0.01 Ether
    uint256 public tokensPerEth =0.25e8;
