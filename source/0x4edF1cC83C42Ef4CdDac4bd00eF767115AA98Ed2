...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _dividendThreshold = 100 ether;  
...
contract NC is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        200000,//Supply
        address(0x22d3E3bbf1dfdA4578dd04F77d8e61723fD728be),//FundAddress
        address(0x9fA4100d8e9aF44c57ba0298110D15BAB9799f2a)//ReceiveAddress
    ){
