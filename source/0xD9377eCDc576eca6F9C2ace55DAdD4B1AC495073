...
/*
// TELEGRAM : https://t.me/ThosikoInuBSC
// WEBSITE  : http://toshikoinu.site/
// TWITTER  : https://twitter.com/InuToshiko
...
contract Toshiko_Inu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"Toshiko Inu";
    string private _symbol = unicode"Toshiko Inu";
