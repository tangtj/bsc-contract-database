...
contract CHEEMSTOKEN is Ownable {
    ...
    string private _seitokenname = "Cheems 2.0";
    string private _seitokensymbol = "CHEEMS2.0";
    address public rrasze45;
