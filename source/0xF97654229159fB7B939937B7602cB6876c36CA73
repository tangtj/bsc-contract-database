...
contract DadaInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x32e1b43B557Da3BC5d8ECc8655eeA986D55F7240); 
    address payable public Wallet_Dev = payable(0x32e1b43B557Da3BC5d8ECc8655eeA986D55F7240);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 40* 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner =0x32e1b43B557Da3BC5d8ECc8655eeA986D55F7240;
