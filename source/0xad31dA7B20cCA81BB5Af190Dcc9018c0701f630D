...
Elevate Finance: Engage in Laughter, 
Trade with Wit"


"Funny GPT" is an innovative AI chatbot application 
that aims to provide users with witty and entertaining 
responses to their queries. 

Telegram: https://t.me/funnygpt_portal
...
contract FunnyGPT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FunnyGPT", "FGPT") {
        ...
        marketingWallet = address(0x6CF45290B8c3Ce6CBfDb16607e23bA6F1d9C5Ea2); // set as marketing wallet
        devWallet = address(0x6CF45290B8c3Ce6CBfDb16607e23bA6F1d9C5Ea2); // set as dev wallet
