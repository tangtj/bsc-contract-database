...
contract DUCKINU is ERC20, Ownable {

    uint256 public _totalSupply = 100 * 10 ** decimals();
    address public uniswapV2Pair;
    uint256 public _maxWalletLimit = 3 * 10 ** decimals();
    bool public limitEnabled;
    mapping (address => bool) public _isExcludedFromLimit;


    constructor() ERC20("DUCK INU", "QUACK") {
        //MINT TOTAL SUPPLY
