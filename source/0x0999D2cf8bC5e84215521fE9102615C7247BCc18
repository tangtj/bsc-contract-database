...
contract AAA is CfoTakeableV2, IERC20Metadata {
    using Address for address;
    ...
    ISwapFactory public immutable aaaSwapFactory;
    ...
    constructor(
        ...
        require(_aaaSwapFactory != address(0),"aaa swap factory can not be address 0");
        aaaSwapFactory = ISwapFactory(_aaaSwapFactory);
        usdt = _usdt;
        feeTo = _feeTo;
    ...
    function isSwapPair(address pair) public view returns(bool){
        ...
        return aaaSwapFactory.getPair(address(this), usdt) == pair || pancakeSwapFactory.getPair(address(this), usdt) == pair || isOtherSwapPair[pair];
    }
