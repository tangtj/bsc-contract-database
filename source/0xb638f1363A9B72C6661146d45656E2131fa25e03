...
contract SAITAMAX is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAITAMA X"; // 
    string private constant _symbol = "SATX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0493D10b9F6270A3aFe452d6A7922B63d770Fadd;
