...
contract Memefight is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meme Fight"; // 
    string private constant _symbol = "MF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xF38E753850632D02fC9e7a92E1F1ce972a8b34f4;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x35cbEF0Ab154654056FC605D5a50A141B773b42D;
