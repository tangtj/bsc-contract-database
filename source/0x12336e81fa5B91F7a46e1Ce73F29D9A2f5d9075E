/*
    Telegram: https://t.me/hobbeselonsdogbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3e6e405461a1ad83f0337D462083D0949BaEd12c;
...
contract HOBBES is Context, IERC20, Ownable {
    ...
    string private _name = "HOBBES";
    string private _symbol = "HOBBES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e6e405461a1ad83f0337D462083D0949BaEd12c);
    address payable public teamWalletAddress = payable(0x3e6e405461a1ad83f0337D462083D0949BaEd12c);
    ...
    uint256 public _walletMax = 6900000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 13800000 * 10**_decimals; 
