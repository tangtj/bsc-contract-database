...
// Telegram : https://t.me/ftx2zero_bsc
...
contract FTX20 is Context, IERC20, Ownable {
    ...
    string private _symbol = "FTX2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4f30aB84D5922C2A2057999B0F19825e874AD6f6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4f30aB84D5922C2A2057999B0F19825e874AD6f6); // BuyBack Address
