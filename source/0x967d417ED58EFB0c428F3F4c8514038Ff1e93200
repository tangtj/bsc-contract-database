...
contract LazerEyes is Context, IERC20, Ownable {
    ...
    string private _name = "Lazer Eyes";
    string private _symbol = "LZR";
    ...
    address  public charityAddress = 0x0262Fd5B0966175FD51b5caa4AFd6218A4A5F336;
