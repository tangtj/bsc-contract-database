...
contract EternalFalcon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EternalFalcon"; //token name #4 
    string constant _symbol = "EFalcon"; // token tika #5
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8bf21ca52fb23D56846097D5CeE99430c770c575   ;
