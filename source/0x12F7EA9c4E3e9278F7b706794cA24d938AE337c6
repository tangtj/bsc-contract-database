...
contract APXTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public qnndsg5;
    ...
    string private _tokenname = "APX";
    string private _tokensymbol = "APX";
