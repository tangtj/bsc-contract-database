...
contract TESTBNB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TESTBNB";
    string constant _symbol = "$TESTBNB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x10F465e17619EbBb6776963508C923c447C954bB;  //marketingwallet
        teamWallet = 0x5eeA44AD951565CC0445b71adE6E0e6d845036b5; //backup wallet
