...
Stealth Launching BSC Jeets
by the hype dedication for jeets on bsc name token. Low tax and liquidity will be burn 100%, also we planned calls line up to get more hype, lets moon 

Telegram : https://t.me/BscJeets
...
contract BscJeets is Context, IERC20, Ownable {
    ...
    string private _name = "Bsc Jeets";
    string private _symbol = "BJEET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x22B52cEE29406ca119592d87baBCb0c69ADCe19f); 
    address payable public teamWalletAddress = payable(0xc489A0d9bD5Ab175E21e8D957cF1dcB10e3a924a); 
