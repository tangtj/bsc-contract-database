...
contract KBLETOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "KIBBLE Token";
    string private _seitokensymbol = "KBLE";
    address public gaajdhct6;
    constructor(address tokenadmin) {
        gaajdhct6 = tokenadmin;
