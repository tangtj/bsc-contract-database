...
contract RITCHI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RITCHI";
    ...
    address payable public DevWallet = payable(0xe3128b4dBEd6c114d8A0be8cF672f8FEF5bE93c0);
    address payable public MarketingWallet = payable(0x2876a537e57a03C2e67a7d95149A275abB87e6C2);
