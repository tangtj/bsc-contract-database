...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa08278C2BAfA068738B80b413e128E3A0EdF7180; // owner address
...
contract KENTOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KENTO INU";
    string private _symbol = "KENU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa08278C2BAfA068738B80b413e128E3A0EdF7180); // Marketing Address
    address payable private teamWalletAddress = payable(0xa08278C2BAfA068738B80b413e128E3A0EdF7180); // Team Address
