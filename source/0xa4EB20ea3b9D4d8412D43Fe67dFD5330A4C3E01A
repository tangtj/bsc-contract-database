...
contract RealTimeCoin is ERC20, ERC20Burnable, Pausable, Ownable {
    uint256 private constant _totalSupply = 15000000000 * (10 ** 18);
    ...
    constructor() ERC20("Real Time Coin", "RTC") {
