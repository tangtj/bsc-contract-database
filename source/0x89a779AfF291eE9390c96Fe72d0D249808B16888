/**
       Official TG Group:https://t.me/JNYDAO
       Official QQ Group:460261681
       Official QQ Group:585461963
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 31 * 10** Decimals;
        maxSellAmount = 100 * 10** Decimals;
        walletLimit =  31 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xFF201421BF5cd32A448e395C48B435fA6b213FD6;//
...
contract JNYDAO is AbsToken {
    constructor() AbsToken(
        ...
        unicode"JNYDAO ",//Name
        unicode"JNYDAO ",//Symbol
        9,//Decimals
        8888,//Supply
        address(0x5F151C0d66C38711780685051bAbE371CC3F9D65),//FundAddress
        address(0x5F151C0d66C38711780685051bAbE371CC3F9D65)//ReceiveAddress
    ){
    }
}