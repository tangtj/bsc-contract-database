...
contract HappyPepe is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1e12 * 10**18; // 0.1%

    uint256 public genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x7301B8436F398fddBa7d1E1CF0982186A47A0822;
    ...
    constructor() BEP20("HappyPepe", "Hope") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= 5e14,"Swap threshold amount should be lower or equal to 50% of tokens");
