/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @snitchbsc
   ...
   I will renounce the ownership to burn addresses to transfer #SNITCH to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 50% total supply to the pool
   Can you make #SNITCH 10000X? 

   100,000,000,000,000,000 total supply
   500,000,000,000,000 tokens limitation for trade, which is 0.5% of the total supply
   ...
   it's the best part of the #SNITCH idea, increasing the liquidity pool automatically, 
...
contract SNITCH is Context, IERC20, Ownable {
    ...
    string private _name = "SNITCH";
    string private _symbol = "Snitch";
    ...
    function _setLiquidityFeePercent(uint256 liquidityFeePercent) external onlyOwner() {
