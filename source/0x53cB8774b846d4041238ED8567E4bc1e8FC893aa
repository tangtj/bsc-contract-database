...
// telegram : https://t.me/pepeshibaflokidoge1000x
// website : https://pepeshibaflokidoge1000x.net
// twitter : https://twitter.com/psfd1000x
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5173ad9af35b83010a44687D789b0036Bb5fb126 ; // owner address
...
contract PepeShibaFlokiDoge1000x  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeShibaFlokiDoge1000x";
    string private _symbol = "PSFD1000X";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8BDcA56Eb93A4cBa46805e22D55A5251df319A33); 
    address payable public teamWalletAddress = payable(0x8BDcA56Eb93A4cBa46805e22D55A5251df319A33);
    ...
    uint256 public _walletMax =   _totalSupply / 2;
