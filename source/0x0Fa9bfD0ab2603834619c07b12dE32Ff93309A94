...
contract CZVSPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZ V PEPE"; // 
    string private constant _symbol = "$CZEPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x5C7d4814A43e37195bDd4C0e592D302ba00ad964;
