...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x1eD75b706A06E3439073B27B96539a899A7668FA);
    address private mktAddress;
    string private _name = "1688";
    string private _symbol = "1688";
    ...
    uint256 public maxWalletAmount = 1288 * 10 ** _decimals;
