...
//--- Contract v2 ---//
contract ALCABOT is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xf789aEA8f48b015C19bd78d0A53eC3FDaaf4FA7B);


    IRouter02 public swapRouter;
    string constant private _name = "ALCABOT";
    string constant private _symbol = "ALCABOT";
