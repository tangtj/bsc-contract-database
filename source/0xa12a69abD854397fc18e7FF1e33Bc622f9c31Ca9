/**
   Harry Peper. When the magic of Harry Potter  
   meets the meme power of Pepe! Brace 
   yourselves, a magical spin.
  TELEGRAM: https://t.me/HarryPeper
*/
...
contract HarryPeper is Context, IBEP2022, Ownable {
