...
contract BlockPrime is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Block Prime"; 
    string private _symbol = "$Prime"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f4279B4a2A667505256C9213b75cc69a1c15C37); 
    address payable public teamWalletAddress = payable(0x7f4279B4a2A667505256C9213b75cc69a1c15C37); 
