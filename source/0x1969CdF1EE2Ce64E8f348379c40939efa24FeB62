...
contract XPREMIUM is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "X Premium";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8d35e17515B65aDE0E9caaBFb00637ecB4188eC3;  //marketingwallet
        teamWallet = 0x8d35e17515B65aDE0E9caaBFb00637ecB4188eC3; //backup wallet
