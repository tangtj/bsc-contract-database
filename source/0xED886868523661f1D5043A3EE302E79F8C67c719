/*
________________   ____  __.________ _____.___.  _____   ____  __.___ 
\__    ___/  _  \ |    |/ _|\_____  \\__  |   | /  _  \ |    |/ _|   |
  |    | /  /_\  \|      <   /   |   \/   |   |/  /_\  \|      < |   |
  |    |/    |    \    |  \ /    |    \____   /    |    \    |  \|   |
  |____|\____|__  /____|__ \\_______  / ______\____|__  /____|__ \___|
                \/        \/        \/\/              \/        \/    
*/
...
pragma solidity ^0.6.12;
    ...
    contract TAKOYAKI is Context, IERC20, Ownable {
        ...
        string private _name = 'TAKOYAKI';
        string private _symbol = 'TAKOYAKI';
        ...
        address payable public _Takoyaki_Dream_Wallet;
        ...
        constructor (address payable MarketingWalletAddress) public {
            _Takoyaki_Dream_Wallet = MarketingWalletAddress;
            ...
            _isExcludedFromFee[_Takoyaki_Dream_Wallet] = true;
        ...
        function sendETHToMarketing(uint256 amount) private {
            _Takoyaki_Dream_Wallet.transfer(amount.mul(3).div(8));
