...
contract OKKOK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OKKOK";
    string private _symbol = "OKKOK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa59BAAFeaF817b1bA22aB3daDa8a323EAcA00DC0); // Marketing Address
    address payable public teamWalletAddress = payable(0xa59BAAFeaF817b1bA22aB3daDa8a323EAcA00DC0); // Team Address
