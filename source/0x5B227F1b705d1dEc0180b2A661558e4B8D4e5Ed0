...
contract Monstery is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"MONSTERY";
    string private _symbol = unicode"MONSTERY";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xD2202515b2B16b3BEcd0f87BA230081Af67448e2);
    address payable private taxWallet2 = payable(0xD2202515b2B16b3BEcd0f87BA230081Af67448e2);
    ...
    uint256 public _walletMax = _totalSupply*5000/100000;
