/**
* Telegram: https://t.me/bigblackcorgibsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x544Bf977DC97642b38c61D5a9Be84f9EEaD9c550; // owner address
...
contract bbc is Context, IERC20, Ownable {
    ...
    string private _name = "Big Black Corgi";
    string private _symbol = "$BBC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd2074995d283EAfABcB621eBAf6d7DFA2Cb47014); // Marketing Address
    address payable private teamWalletAddress = payable(0xd2074995d283EAfABcB621eBAf6d7DFA2Cb47014); // Team Address
