// t.me/WrappedStakedTether 
// WrappedStakedTether.com
...
contract WrappedStakedTether is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "WrappedStakedTether";
    string public symbol = "WSTUSDT";
