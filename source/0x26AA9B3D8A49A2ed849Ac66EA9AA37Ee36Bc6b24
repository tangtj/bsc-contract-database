...
contract Blockchain_Superheroes is ONFT721, BasicAccessControl {
    ...
    uint256 constant START_TOKEN = 1000002000;
    uint256 constant MAX_CAP = 100000000000;

    string public _baseTokenURI =
        "https://api.live.chainguardians.io/metadata/bcsh/";
    ...
    function setBaseURI(string memory baseURI) public onlyOwner {
        ...
        emit BatchMetadataUpdate(1, MAX_CAP);
    }
}