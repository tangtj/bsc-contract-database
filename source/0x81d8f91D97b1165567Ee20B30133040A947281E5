...
// Telegram : https://t.me/DATBOICOMMUNITYBSC
...
contract DATBOI is Context, IERC20, Ownable {
    ...
    uint256 private _redisFeeOnBuy = 14;
    uint256 private _taxFeeOnBuy = 1;
    
    uint256 private _redisFeeOnSell = 14;
    ...
    address payable private _twddev = payable(0x1Cc560eAe69AB325594Cf0aCCDa7965752053587);
    address payable private _twdmkt = payable(0x1Cc560eAe69AB325594Cf0aCCDa7965752053587);
