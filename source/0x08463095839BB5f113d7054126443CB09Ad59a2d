...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC4131B1Ffec06F502a01Ee4AbA938d8F807090F0; // owner address
...
contract ShibokiInu is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x84Ae81C635827742DFc63cB6c4aae8b8D6f23E59); // Marketing Address
    address payable private teamWalletAddress = payable(0x84Ae81C635827742DFc63cB6c4aae8b8D6f23E59); // Team Address
