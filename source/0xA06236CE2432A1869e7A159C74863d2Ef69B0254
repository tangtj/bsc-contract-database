...
contract HPEPE1000X is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PEPE 1000X";
    string private constant _symbol = unicode"1000XPEPE";
