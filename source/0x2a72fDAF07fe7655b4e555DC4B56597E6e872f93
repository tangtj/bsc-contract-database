...
contract Supermusk is IERC20 {
    ...
    string constant private _name = "Supermusk";
    string constant private _symbol = "SUPERM";
    ...
    address payable public marketingWallet = payable(0x485fa22C6de98738c6b2B63734C44b0357D0A700);
    bool inSwap;
