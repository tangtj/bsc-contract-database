...
contract BOOLISH is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BOOLISH";
    string private _symbol = unicode"$BOOLISH";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xDDA25017aF32f2A0C2d82597c97F34851FA172db);
    address payable private taxWallet2 = payable(0xDDA25017aF32f2A0C2d82597c97F34851FA172db);
