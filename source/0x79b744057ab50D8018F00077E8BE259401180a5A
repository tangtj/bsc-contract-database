...
contract FLOKIDORK is ERC20, Ownable {
    ...
    constructor() ERC20("FLOKI DORK", "FLODORK") {
        ...
        marketingWallet = address(0xdE420C80A1B5926f2D4E209565A91911c7adb5bA); // set as marketing wallet
        devWallet = address(0xdE420C80A1B5926f2D4E209565A91911c7adb5bA); // set as dev wallet
