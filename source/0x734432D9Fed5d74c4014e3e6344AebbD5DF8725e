...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAeE85442CA9DbD628D639C2a02d224710c26D7c9; 
...
contract ZATANETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zata Network";
    string private _symbol = "ZATA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAeE85442CA9DbD628D639C2a02d224710c26D7c9); 
    address payable public teamWalletAddress = payable(0xAeE85442CA9DbD628D639C2a02d224710c26D7c9); 
