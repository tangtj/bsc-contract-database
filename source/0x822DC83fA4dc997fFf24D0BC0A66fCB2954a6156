...
Website: https://bsocial.pro/
Telegram: https://t.me/bsocialchat
...
contract BinsERC20 is Ownable, ERC20 {
    using SafeMath for uint256;
...
contract BSocial is BinsERC20, ReentrancyGuard {
    using SafeMath for uint256;
