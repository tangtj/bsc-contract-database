/**
The newest token, $XNOMICS, will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power. XNOMICS is prepared to compete our way to the top of Binance Smart Chain's charts!
...
contract Xnomics is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0xDe37Bf92F6B3d2A5ffc404eBF52DC83CD0908799;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x383D702AE519628dC2cB2AEDb91E9Da49aF02db9;
