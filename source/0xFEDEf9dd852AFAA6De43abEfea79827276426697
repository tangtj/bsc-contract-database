...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        fundAddress = address(0x38cBa2BCE7B3Ae457d4a89ae850F647fB6C54C92);
        fundAddress_2 = address(0x87dEA0e59A0A7C5A3d0E054EC101b00C8f16F4eA);
...
contract CL is AbsToken {
    ...
    //Receive
        address(0x09fcB5E7A7b7C669279b1aD620D11fDBC6ED6847)
    ){
