...
// ShochuswapFinance with Governance.
contract SHOCHU is ERC20("Shochuswap.Finance", "SHOCHU"), Ownable {
    uint256 private _cap = 30000e18;
    uint256 private _initial_supply = 30000e18;
...
creation of SHOUCHU pending...
    ...
    // Copied and modified from SHOCHU code:
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "SHOCHU::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SHOCHU::delegateBySig: invalid nonce");
        require(now <= expiry, "SHOCHU::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SHOCHU::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SHOCHU::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn SHOCHU on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
