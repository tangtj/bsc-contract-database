...
// https://t.me/Arcadebot_bsc
// https://t.me/Arcadebot_tgbot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc613C8252785933C5889A9f6cD49814635d4543a; // owner address
...
contract ArcadeBot is Context, IERC20, Ownable {
    ...
    string private _name = "Arcade Bot";
    string private _symbol = "$Arcade";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc613C8252785933C5889A9f6cD49814635d4543a); // Marketing Address
    address payable public teamWalletAddress = payable(0xc613C8252785933C5889A9f6cD49814635d4543a); // Team Address
