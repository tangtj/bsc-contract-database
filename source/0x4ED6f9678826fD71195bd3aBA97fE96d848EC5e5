...
// telegram     : https://t.me/recyclebsc
...
contract RecycleAgregator is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Recycle";
    string private _symbol = "$R";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9921d576f8677D8ea7cCb4b0fb3B9A562fFB2713); // Marketing Address
    address payable public teamWalletAddress = payable(0x9921d576f8677D8ea7cCb4b0fb3B9A562fFB2713); // Team Address
