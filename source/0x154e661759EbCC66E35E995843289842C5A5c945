/**
 PUSSIES MAKE BIG MONEY, DOGE TOO!
 https://t.me/pussycatdogebsc 
*/
...
contract PUSSYCATDOGE is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x2CaD0155a2d8AFc1A24211b970B131D30d052103;

    string constant _name = "PUSSYCAT DOGE";
    string constant _symbol = "$PUSSIES";
