...
// TELEGRAM : https://t.me/Innovium
// WEBSITE  : http://www.innovium.live

Testing LP adding to bypass Epstein. This is not the real contract do not buy
Launch is tomorrow 
...
contract Innovium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Innovium";
    string private _symbol = "INV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x9c6e7e228B04E66E563c856E24AE4BDc9738a9C0);
