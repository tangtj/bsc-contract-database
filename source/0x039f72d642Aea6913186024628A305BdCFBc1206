...
contract Widow is ERC721, Ownable {
    ...
    constructor() ERC721("Cyber AI","Cyber AI")  {
        setBaseURI("https://ipfs.io/ipfs/QmS2fq2mTh3EZ9Cq3gKcgRm3TebkoY7pgAstbjghVTP7Mn");
        for(uint i=1;i<=300;i++)
        {
            _safeMint(address(0x80a429e48741A9C6973853CCb801B4406A4E2218), i);
        }
