...
contract PIPINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 900000000000 * 10**_decimals; //
    ...
    address public marketingWallet = 0x2996266379Cd0d2862966f859aeD2Ee9042Df3d0; //

    string private constant _name = "Pip Inu"; //
