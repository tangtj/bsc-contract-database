...
//**telegram https://t.me/HarryPotterObamaSonicBsc
...
contract Harry_Potter_Obama_Sonic is IERC20, Ownable, LibreMount {
    ...
    string private _name = "HarryPotterObamaSonic";
    string private _symbol = "HPOS";
