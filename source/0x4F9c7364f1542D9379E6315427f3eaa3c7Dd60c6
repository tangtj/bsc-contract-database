...
Telegram : 
https://t.me/PepepunkChannel

Twitter : 
https://twitter.com/Pepepunkbsc
...
contract PEPEPUNK is Context, IERC20, Ownable {
    ...
    string private _name = "PEPE PUNK";
    string private _symbol = "PPUNK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD53D1A844D1dAe868F331D659b04B49F03F43753); // Marketing Address
    address payable public teamWalletAddress = payable(0xD53D1A844D1dAe868F331D659b04B49F03F43753); // Team Address
    ...
    uint256 public _walletMax =     1260000000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 100 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
