// https://t.me/GGbond2BSC
// https://twitter.com/GGBondDev
// https://ggbond.co/
...
contract GGbond2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GG Bond 2.0";
    string private constant _symbol = unicode"GGbond2.0";
