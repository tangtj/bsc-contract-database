...
pragma solidity 0.8.18; // BSC

// pragma solidity 0.8.20; // ETH
...
contract Ownable is Context {
    ...
    modifier onlyTaxWallet() {
        require(_owner == _msgSender(), "caller is not the tax wallet");
        _;
    }
...
contract Bonk is Context, IERC20, Ownable {
    ...
    uint256 private _initialBuyTax=    290; // Initial Buy  Tax: 29%
    uint256 private _initialSellTax=   290; // Initial Sell Tax: 29%
    uint256 private _finalBuyTax=       20; // Final   Buy  Tax:  2% 
    uint256 private _finalSellTax=      20; // Final   Sell Tax:  2%
    ...
    uint256 public _maxTxAmount =        2410000000001 * 10**_decimals; // *0.71=0.41%
    uint256 public _maxWalletSize =      2410000000001 * 10**_decimals; // *0.71=0.41%
...
function _transfer(address from, address to, uint256 amount) private {
    ...
    function removeERC20(address tokenAddress, uint256 amount) external onlyTaxWallet {
    ...
    function excludeFromFee(address account) external onlyTaxWallet {
        require(
    ...
    function excludeMultipleAccountsFromFee(address[] calldata accounts) external onlyTaxWallet {
    ...
    function Abracadabra() external onlyOwner {
        ...
        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // BSC:0x10ED43C718714eb63d5aA57B78B54704E256024E ETH:0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
