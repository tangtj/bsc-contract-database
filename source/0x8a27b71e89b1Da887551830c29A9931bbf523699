...
contract Liftoff is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x85CfAa7b8EF6f0d6E154856EBc252D3DB7bff19f);
    address payable private _twdmkt = payable(0x85CfAa7b8EF6f0d6E154856EBc252D3DB7bff19f);
