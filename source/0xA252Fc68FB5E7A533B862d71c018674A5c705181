...
contract DGMINE is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0x0CeD285a8d8297D80401720dE8C758fF0d7C7efe);
    ...
    //Supply Definition.
    uint256 private _tTotal = 578_000_000_000_000 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "DogeMine";
    string public constant symbol = "DGMINE";
    ...
    function setTransferFee(uint256 _transferFee) external onlyOwner {
        require(_transferFee <= 5, "Sell Fee cannot be more than 5%");
