/**
   The idea behind POM is to harness the 
   power of internet memes and bring together  
   the communities associated with these memes.
  TELEGRAM: https://t.me/PowerOfMeme_BSC
*/
...
contract PowerOfMeme is Context, IBEP2022, Ownable {
