...
// File: contracts/protocols/BSheep.sol
...
contract BSheep is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "BSheep";
    string private _symbol = "BSHEEP";
    ...
    // Innovation for protocol by BSheep Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own BSHEEP to claim reward');
