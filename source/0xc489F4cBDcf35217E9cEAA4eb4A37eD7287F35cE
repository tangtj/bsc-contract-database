...
contract MangalargaToken is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private limitBurn = 5000000 * _decimalFactor;
    ...
    /*=== Strings ===*/
    string private _name = "Mangalarga Token";
    string private _symbol =  "Marchador";
    /*=== Modifiers ===*/
