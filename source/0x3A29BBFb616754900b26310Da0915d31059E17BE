...
~ A TRUE UTILITY TOKEN ~
 MEV TOOLS HOLDERS  will be able to take advantage of the benefits of both the BEP20 and ERC20 tokens,
  such as faster transaction times and improved liquidity, 
  while also allowing them to easily move their funds between the two protocols.
  */

// telegram: t.me/Mev_bot_ai
// website: http://app.mevbotai.pro
...
contract MevToolsToken is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "MEVTOOLS TOKEN";
    string private constant _symbol = unicode"MEVTOOLS";
    ...
    address payable private _marketingAddress = payable(0x8573AC9De7B10dc8774Ea9338Bd6cF99f0E73175);
