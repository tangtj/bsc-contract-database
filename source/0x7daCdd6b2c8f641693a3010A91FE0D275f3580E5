...
/**
   ...
   Welcome to MOONSHIBA
   
   
   
   This is a community token. If you want to create a telegram I suggest to name it to @MOONSHIBABSC
   ...
   I will renounce the ownership to burn addresses to transfer #MOONSHIBA to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MOONSHIBA 10000X? 
   ...
   it's the best part of the #MOONSHIBA idea, increasing the liquidity pool automatically, 
