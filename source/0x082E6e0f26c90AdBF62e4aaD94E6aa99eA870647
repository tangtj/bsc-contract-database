...
contract Sog is Context, IERC20, Ownable {
    ...
    string private _name = unicode"SOG TOKEN";
    string private _symbol = unicode"$SOG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x48350603C50cca1abF7B95B8cA8e223279528f28);
    address payable private taxWallet2 = payable(0x48350603C50cca1abF7B95B8cA8e223279528f28);
    ...
    uint256 public _walletMax = _totalSupply*4000/100000;
