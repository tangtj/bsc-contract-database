...
contract NotFine is ERC20, Ownable {
    ...
    address public devWallet = 0x39848630932956BE578eb9aa770fA177527916a4;
    ...
    constructor() ERC20("FINEBURN", "FINEBURN") {
