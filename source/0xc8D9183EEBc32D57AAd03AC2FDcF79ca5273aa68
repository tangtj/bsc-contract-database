...
// File: contracts/MetisIT.sol


pragma solidity ^0.6.0;

contract MetisIT is ERC20Permit, ERC20Burnable, Ownable {
    constructor(address _owner) public ERC20("Metis investment token", "MetisIT") EIP712("Metis investment token", "56") {
        _mint(_owner, 1e7 ether);
