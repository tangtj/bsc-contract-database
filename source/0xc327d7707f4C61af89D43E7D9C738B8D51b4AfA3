...
contract Pupu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc7923A222a021EAbD2f156202069d140e3aBf8Bb); // Marketing Address
    address payable public teamWalletAddress = payable(0xc7923A222a021EAbD2f156202069d140e3aBf8Bb); // Team Address
