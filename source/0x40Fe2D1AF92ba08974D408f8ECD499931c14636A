...
↪ Website :
https://paychain.online/
↪Twitter :
https://twitter.com/Paychainbsc
↪ Telegram :
https://t.me/Pay_chain

*/

// Unleash the Power of Avarium $AVM: Elevate Your Crypto Experience with Cutting-Edge Layer 1 Blockchain Innovation! 
...
contract Paychain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "paychain";
    string private _symbol = "payc";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8026799ea5183FD5fF4C3a4866BbC8A978DB590b); // Marketing Address
    address payable public teamWalletAddress = payable(0x8026799ea5183FD5fF4C3a4866BbC8A978DB590b); // Team Address
