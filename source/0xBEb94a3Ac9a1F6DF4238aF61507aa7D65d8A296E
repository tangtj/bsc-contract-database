/**
   ...
   Welcome to ImperialMoon
   
   This is a community token. If you want to create a telegram I suggest to name it to @ImperialMoonBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ImperialMoon to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ImperialMoon 10000X? 
   ...
   it's the best part of the #ImperialMoon idea, increasing the liquidity pool automatically, 
...
contract ImperialMoon is Context, IERC20, Ownable {
    ...
    string private _name = "ImperialMoon";
    string private _symbol = "ImpMoon";
