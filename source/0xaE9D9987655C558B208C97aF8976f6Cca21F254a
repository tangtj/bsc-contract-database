/*
📊EPChain Network is an all-in-one decentralized cryptocurrency platform with huge plans! EPChain Network is fairly distributed, eco-friendly and consumes minimal battery power. EPChain Network is fair and valuable to everyone (3 months in the making)

📊Beta App Available : https://play.google.com/store/apps/details?id=com.epcrypto.network
📊Staking
📊Web3 Wallet
📊Swap/Dex
📊Blockchain
