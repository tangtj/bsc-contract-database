/**
CZ PUMP is the hot trend in crypto space powered by endless possibilities to generate money and joy. Now the CZPUMP arrived on the BSC and is ready to claim his throne as the pet of the galaxy🐱

🐹Waive Ownership 
🐹 Pool locked 3 months
🐹 CMC + CG Fast-track
🐹 LOW MC - EASY PUMP!
🐹Marketing = 1
🐹 Buy/Sell = 1%

website xhamster.vip
https://t.me/czpumpbsc
*/
...
contract CZPUMP is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZ PUMP"; // 
    string private constant _symbol = "CZPUMP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x7f5F643D759a1f5A676ADC0E51Ca9910E2994e88;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x1b52f35F762F125C26DFD9BD11f07a5137480054;
