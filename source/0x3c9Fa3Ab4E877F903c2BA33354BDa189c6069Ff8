...
contract CryptoLolis is ERC20, Ownable {
    ...
    bool    private swappingFee;

    bool    public allowFeeSwap;
    ...
    constructor () ERC20("CryptoLolis", "LOLI") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x0d6371702eE15989B94364e014cd019740AA0EDC;
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(marketingFeeOnBuy <= maxFee, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(marketingFeeOnSell <= maxFee, "Total Fees cannot exceed the maximum");
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swappingFee) {
            _totalFees = 0;
    ...
    function setAllowFeeSwap(bool _enabled) external onlyOwner{
        require(allowFeeSwap != _enabled, "allowFeeSwap already at this state.");
        allowFeeSwap = _enabled;
    }
