...
contract LMFAO is ERC20, Pausable, Ownable {

    mapping(address => bool) public distrustList;

    constructor() ERC20("LMFAO", "LOL") {
    ...
    modifier addressValidation(address from, address to){
     ...
     function _beforeTokenTransfer(address from, address to, uint256 amount) internal /*whenNotPaused addressValidation(from, to)*/ override{
