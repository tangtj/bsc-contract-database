...
interface IDEXRouter {
 ...
 contract DorklordVPepe  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "DorklordVPepe";
    string constant _symbol = "DVP";
    ...
    address public devFeeReceiver = 0x29f17cBbF10466F26AeCc69B38467ae3a9e0eb1b;
    address public buybackFeeReceiver = 0x29f17cBbF10466F26AeCc69B38467ae3a9e0eb1b;
