...
Let's Join 
♊️ Telegram : https://t.me/Gemini_Bsc
♊️ Twitter : 
https://twitter.com/Gemini_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7a3967648433B96050059B64bd31b319C6AA677; // owner address
...
contract Gemini is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Gemini";
    string private _symbol = unicode"GMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7a3967648433B96050059B64bd31b319C6AA677); 
    address payable public teamWalletAddress = payable(0xb7a3967648433B96050059B64bd31b319C6AA677);
    ...
    uint256 public _walletMax =   36000000 * 10**_decimals;
