...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25bf0cf2112850b3DF92B9e15031E9f1ADad570B; // owner address
...
contract PAYPALINU is Context, IERC20, Ownable {
    ...
    string private _name = "PAYPAL INU";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25bf0cf2112850b3DF92B9e15031E9f1ADad570B); // 
    address payable public teamWalletAddress = payable(0x25bf0cf2112850b3DF92B9e15031E9f1ADad570B); // 
