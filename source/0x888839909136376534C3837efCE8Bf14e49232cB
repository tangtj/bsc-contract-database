...
contract Mepple is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mepple"; // 
    string private constant _symbol = unicode"MEPPLE";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE9991BF364ded5eBe6bc653b3593559dE4E85588;
