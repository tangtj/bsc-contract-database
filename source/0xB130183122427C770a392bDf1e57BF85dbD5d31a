...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 1850;
...
contract Vdoge is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        2888,//Supply
        address(0x6Ce984EE16d4EA91c8001601C7303000851F53a1 ),//FundAddress
        address(0x196B96D40bc52f9c5C955e22de08EAAef5080Eda)//ReceiveAddress
    ){
    }
}