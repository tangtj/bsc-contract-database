...
* | $$\  $$$| $$      | $$         | $$         | $$  \ $$| $$  | $$| $$    $$| $$\  $$  /$$  \ $$
* | $$ \  $$| $$$$$$$$| $$$$$$$$   | $$         | $$$$$$$/|  $$$$$$/|  $$$$$$/| $$ \  $$|  $$$$$$/
* |__/  \__/|________/|________/   |__/         |_______/  \______/  \______/ |__/  \__/ \______/ 
* 
* 
*/
...
contract NeetBucks is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NEET BUCKS";
    ...
    uint256 marketingFee = 100; // no be greedy
    ...
    function swapBack() internal swapping {
        ...
        // Gibs NEET BUCKS. Don't spend them ALL on tendies ya hear?. Think of poor wagie.
