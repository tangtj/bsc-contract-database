...
contract IBNBATTUTA is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x7d52e0B502fFb570bb5A9CEEf2234E4eD38647bD);
    address payable private _twdmkt = payable(0x277601cB7Cbfab15AC134ADcE4cA3526f9a4194a);
    
    string private constant _name = "IBN BATTUTA";
    string private constant _symbol = "IBN";
