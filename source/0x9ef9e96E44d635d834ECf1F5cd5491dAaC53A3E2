...
// Telegram: https://t.me/DorkVaderBSC
...
contract DorkVader is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x0c3eF5350ac2a1A2de1D4C88ec2Cb5386666ac62);
    address payable private _twdmkt = payable(0x0c3eF5350ac2a1A2de1D4C88ec2Cb5386666ac62);
    
    string private constant _name = "DORK VADER";
    string private constant _symbol = "Dork Vader";
