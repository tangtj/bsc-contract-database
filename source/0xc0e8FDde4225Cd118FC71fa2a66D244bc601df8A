...
contract pepe is Context, IERC20, Ownable {
    ...
    string private _name = unicode"ǝdǝd";
    string private _symbol = unicode"ǝdǝd";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x420a5aD4605bEa21caA4d403a9D4725DC0029555);
    address payable public teamWalletAddress =
        payable(0x220327addDbA62f5522C418a6c06e5b117A831E5);
