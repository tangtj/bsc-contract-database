...
/** TG: https://t.me/+cobAQ5OitWk5OTI8
*/
...
contract  $DORKSHIBA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB5cD83B73cC955E9579fbA6f29Eb950F5Fdcd6A2;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = " $DORK SHIBA";
    string constant _symbol = "$Dshi";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xB5cD83B73cC955E9579fbA6f29Eb950F5Fdcd6A2;
