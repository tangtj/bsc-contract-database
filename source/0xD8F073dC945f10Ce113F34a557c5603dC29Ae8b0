...
TG: https://t.me/babycatecoin2_portal
WEBSITE: https://www.babycatecoin2.com
 */
...
contract BabyCatecoin2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyCatecoin 2";

    string constant _symbol = "BCC2";
    ...
    address public marketingFeeReceiver = 0x9e548e2E5887869A21cd716A37c64C6Bce6dA699;
