...
contract Florkinomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Florkinomics";
    string constant _symbol = "FLORKIN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4966B7b43A540f7FCB8f4F337f62E463316c32E4;
        devFeeReceiver = 0x18911561ba60A8e91e33D557dF17fFd44C4e91d8;
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public onlyOwner returns (bool success) {
        require(tokenAddress != address(this), "cant remove FLORKIN from the contract address");
