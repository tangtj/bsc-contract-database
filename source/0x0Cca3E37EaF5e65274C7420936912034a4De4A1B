...
contract K0killer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "K0killer";
    string private _symbol = "K0killer";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37Bc804B472f8B496aCAf758DA9A25e919c6aA98);
    address payable public teamWalletAddress = payable(0xbbcCEB7De15F064321EAa4C7a7554652E96FC71f);
