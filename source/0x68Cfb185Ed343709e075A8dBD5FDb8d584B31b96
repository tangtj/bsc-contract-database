...
contract BULLRIUM is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "BULLRIUM";
    string private _symbol = "BRM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27a10796a42db5DDaD8232757e489A49a322Df98);
    address payable public teamWalletAddress = payable(0x27a10796a42db5DDaD8232757e489A49a322Df98);
