...
// File: LayerZero/Core/IWrappedERC20.sol
...
abstract contract LzApp is Ownable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function setMinDstGas(uint16 _dstChainId, uint16 _packetType, uint _minGas) external onlyDeveloper {
    ...
    function setPayloadSizeLimit(uint16 _dstChainId, uint _size) external onlyDeveloper {
        require(_size>=DEFAULT_PAYLOAD_SIZE_LIMIT,"Limit less than default");
...
// File: LayerZero/Core/TokenBridgeBase.sol
...
// File: LayerZero/Core/IERC20.sol
...
// File: LayerZero/Core/WrappedTokenBridge.sol
...
contract WrappedTokenBridge is TokenBridgeBase {
    ...
    constructor(address _endpoint,address _dev) TokenBridgeBase(_endpoint,_dev) {}
