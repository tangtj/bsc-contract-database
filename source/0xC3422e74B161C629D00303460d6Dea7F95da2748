/**
Telegram : https://t.me/Dynarium
Website: https://Dynarium.io
Twitter: https://twitter.com/DynariumLabs
*/
...
contract DYNARIUM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string public _name = "Dynarium";
    string public _symbol = "DNRM";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0xBfC58CE0B591266e77a85cc4F201E9E29a42009F);
    ...
    uint256 public _totalSupply = 250000000 * 10**_decimals;
