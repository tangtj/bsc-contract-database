...
contract RyoshiCat is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xCee0240669B6ca789A7CD37f3a6D389da1FD49B1); // Marketing Address
        
    address payable public teamAddress =
        payable(0xCee0240669B6ca789A7CD37f3a6D389da1FD49B1); // Team Address
        
    address payable public liquidityAddress =
        payable(0xCee0240669B6ca789A7CD37f3a6D389da1FD49B1); // Liquidity Address
