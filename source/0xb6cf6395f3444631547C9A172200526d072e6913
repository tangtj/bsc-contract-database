...
contract FEL is Token {
    constructor() ERC20(
        "FEL",   // 名字
        "FEL"   // 符号
    ) {
        uint256 _totalSupply = 200000000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x7C9FbDdBd303484B4fE8975554596E7459926553); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x7C9FbDdBd303484B4fE8975554596E7459926553)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x7C9FbDdBd303484B4fE8975554596E7459926553);
        feeEarn = 0;
        isLiquified = true;
    }
}