...
contract ForeverSquidGame is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = 0x29906c39c5362Ebc11cEA946009a89Bfa0bAef43;
    ...
    string private _name = "ForeverSquidGame";
    string private _symbol = "ForeverSquidGame";
    ...
    uint256 public _maxWalletBalance = 30000000000000 * 10**18; 
    uint256 public _maxTxAmount = 20000000000000 * 10**18;
    uint256 public numTokensSellToAddToLiquidity = 500000000000 * 10**18;
    ...
    function setMinNumOfTokenToLiquidifiy(uint256 minTokens) external onlyOwner() {
        numTokensSellToAddToLiquidity = minTokens * 10**18;
    }
