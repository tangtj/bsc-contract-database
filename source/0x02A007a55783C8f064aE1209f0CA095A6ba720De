...
contract KrastyToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor() ERC20("KrastyTokenBNB", "KRSTBNB") ERC20Permit("KrastyTokenBNB") {
