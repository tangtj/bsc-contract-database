// Telegram:   https://t.me/ShrempinBSC
...
contract SHREMPIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shrempin";
    string private constant _symbol = "$SHREMPIN";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x29776A37E4CD9491Cc5deC97D73f8F337d24D505);
    address payable private _marketingAddress = payable(0xB3F07e64208B1EF23c53B4cE16e2F4004f00a9aF);
