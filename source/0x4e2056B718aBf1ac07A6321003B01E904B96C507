...
contract BNBBot {
    ...
    uint256 private constant RESERVE_RATE = 60;
    uint256 private constant REFERENCE_LEVEL1_RATE = 30;
    ...
    uint256 private constant MAX_DEP = 36000 ether;
    uint256 private constant MAX_DEP_CNT = 365000;
    uint256 private constant REFERRER_CODE = 1000;
    uint256 private constant PLAN_INTEREST = 280;
    uint256 private constant POOL_MAX = 25;
    uint256 private constant PLAN_TERM = 3 days;
    uint256 private constant TIME_STEP = 2 hours;
