//Website: http://gladiatorx.net
//Telegram: https://t.me/GladiatorX_BSC
//Twitter: https://twitter.com/gladiatorxbsc
...
contract GladiatorX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GladiatorX";
    string private constant _symbol = unicode"GladiatorX";
