...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2AC00547d7D1dE4Cd4a0B5001E64B3F8758338EC; // owner address
...
contract QuinixChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Quinix Chain";
    string private _symbol = "QNX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2AC00547d7D1dE4Cd4a0B5001E64B3F8758338EC); // Marketing Address
    address payable private teamWalletAddress = payable(0x2AC00547d7D1dE4Cd4a0B5001E64B3F8758338EC); // Team Address
