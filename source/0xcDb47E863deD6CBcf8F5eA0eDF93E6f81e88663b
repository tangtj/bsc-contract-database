...
contract BNBMD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBMD";
    string private _symbol = "BNBMD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE78b9Fa1C9E1B2d33Ac649127FB9f448065197CE); // Marketing Address
    address payable public teamWalletAddress = payable(0xE78b9Fa1C9E1B2d33Ac649127FB9f448065197CE); // Team Address
