...
contract PepevsShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe vs Shiba";
    string private _symbol = "PESHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBaBE43c37A5DCAF8bD249b76174E6682d166b7C6); // Marketing Address
    address payable public teamWalletAddress = payable(0xBaBE43c37A5DCAF8bD249b76174E6682d166b7C6); // Team Address
