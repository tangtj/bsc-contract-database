...
contract WenCyberTruck is Context, IERC20, Ownable {
    ...
    string private _name = "WenCyberTruck";
    ...
    uint8 public _communityFee = 3;
    uint8 private _previousCommunityFee = _communityFee;
    ...
    constructor() public {
        _marketingWallet = 0xE6FAa6fAF53FA9105a37f829Faed794bB3293F7C;
        _communityWallet = 0xDE7De022cCe4fc652545e8DefAf03EE21a96b234;
    ...
    function setCommunityFeePercent(uint8 communityFee) external onlyOwner() {
        ...
        )
    {
        ...
        return (tTransferAmount, tFee, tLiquidity, tMarketing, tCommunity);
    }
        ...
        )
    {
        ...
        uint256 rTransferAmount =
            rAmount.sub(rFee).sub(rLiquidity).sub(rMarketing).sub(rCommunity);
    ...
    function _takeCommunity(uint256 tCommunity) private {
        ...
        if (_isExcluded[_communityWallet])
            _tOwned[_communityWallet] = _tOwned[_communityWallet].add(
                tCommunity
            );
    }
