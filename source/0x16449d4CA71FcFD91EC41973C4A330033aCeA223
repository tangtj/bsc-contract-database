...
contract Bitcinerate is ERC20, Ownable {
    ...
    uint256 private cooldowntimer = 2; //default cooldown 2
    ...
    constructor() ERC20("Bitcinerate", "Bitcinerate") {
        marketingWallet = payable(0x4ec388cd82EA48af775A261563A04591C6145510);
        CommunityWallet = payable(0xB16f232AdaC0266a2492b36B8Df9F6Bd54628Ca3);
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 1000, "max wallet cannot be set to less than");
        maxWallet = value;
    }
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 80, "Protect");
    ...
    function updateFees(
        ...
        require(totalSellFees <= 4 && totalBuyFees <= 2, "total");
...
contract BitcinerateDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Bitcinerate_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Bitcinerate contract."
        );
    }
