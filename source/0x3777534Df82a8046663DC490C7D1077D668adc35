...
contract FlokiSAGA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "FLOKI SAGA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3e4e40c1e72CA7aF0481BFf612d9bab9EFFe36B5);
    address payable private _marketingAddress = payable(0x3e4e40c1e72CA7aF0481BFf612d9bab9EFFe36B5);
