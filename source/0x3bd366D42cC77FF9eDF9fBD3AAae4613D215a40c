...
buyCooldown = 1 minutes
Supply Total = 1_000_000_000
maxTxAmount  =    50_000_000 
 ...
 This token is a tribute to How two brothers went from nearly jobless to multi-millionaires with a bizarre crypto bet

Please DYOR Before And Only Trade What you can afford to lose.
*/
 ...
 * the owner.
 */
contract OwnableDAO is DAOContext {
...
contract coca is DAOContext, BinanceDeployer, OwnableDAO {
    ...
    string private constant _name = "The Club of Cool Apes"; // 
    string private constant _symbol = "coca"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xeB2BDe34131aD315754Faa1CE71F069E17c21Db5;
