...
contract KUKU is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x407bE1cB9ddCffe900337C49d7D91A54fBbdEd3d);
    address payable private _twdmkt = payable(0xD167fc8cdA530a2CA0DCDE86Dc232FA2884DC833);
    
    string private constant _name = "KUKU";
    string private constant _symbol = "KUKU";
