...
- Website: https://www.turtlexcoin.com/
- Telegram: https://t.me/turtlexcoin
- Twitter:  https://twitter.com/TurtleXbsc
- No Blacklist
...
contract TURTLEX is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xAF2138CFB6c048B3484fBcEdC5Ead0eaE4266A3B;

    string private constant _name = "TURTLEX";
    string private constant _symbol = "TURTLEX";
