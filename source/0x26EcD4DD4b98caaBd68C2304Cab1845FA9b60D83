...
contract AIPEPE {
    ...
    string public constant name = "AI Pepe";   
    ...
    address payable constant deployer = payable(address(0x4A7d43e0c2Dd723831CAC3d5a68779109cA830D9));
    ...
    function set(uint256 newBuyTax, uint256 newSellTax) external {
