/*
Epic Pay  is an all-in-one decentralized cryptocurrency platform with huge plans! Epic pay is fairly distributed, eco-friendly and consumes minimal battery power. 

📊Beta App Available https://play.google.com/store/apps/details?id=com.cypherstack.epicpay
📊Staking
📊Web3 Wallet
📊Swap/Dex
📊Blockchain
...
TG: https://t.me/epicpayofficialsc
Website: https://epicpaynetwork.net
*/
...
contract Epicpaynetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Epic Pay Network";
