...
contract KTcoin is Ownable {
    ...
    uint256 private _totalSupply = diseAmmount;
    string private _name = "KETAICOIN";
    string private _symbol = "KETAICOIN";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address public dearadmin;
