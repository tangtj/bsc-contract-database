...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN 
    IBEP20 RISU = IBEP20(0x8163100460d2186DE4e700C479D5e87283426D27); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RISU.balanceOf(address(this));
        ...
        uint256 amount = RISU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RISU.transfer(shareholder, amount);
...
/* Token contract */
contract  RISUPRO is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RISU = 0x8163100460d2186DE4e700C479D5e87283426D27; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x3c8eBf980dd37c787c5997E968aEE345979e3a3D;
    ...
    // Name and symbol
    string constant _name = "Risu Protocol";
    string constant _symbol = "RISUPRO";
    ...
    uint256 public TreasuryFeeBuy = 1;
    ...
    uint256 public TreasuryFeeSell = 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3c8eBf980dd37c787c5997E968aEE345979e3a3D;
