...
contract Bep20_Token is IBEP20 {
    ...
    modifier canSwap() {
        require(_swapEnabled || msg.sender == _owner, "Swapping is currently disabled");
        _;
    }
    ...
    function state_swap() external view returns (bool) {
        return _swapEnabled;
    }

     function transfer(address recipient, uint256 amount) external override canSwap returns (bool) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override canSwap returns (bool) {
