...
contract ShiaInu is IERC20 {
    ...
    string constant private _name = "Shia Inu";
    string constant private _symbol = "Shia Inu";
    ...
    address payable public marketingWallet = payable(0x00d026b12634d082779B40C8Eb900e42e44d50de);
