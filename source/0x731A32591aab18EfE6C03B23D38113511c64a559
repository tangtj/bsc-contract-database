...
contract QatarFanCup is IERC20 {
    ...
    string constant private _name = "Qatar Fan Cup";
    string constant private _symbol = "QFC";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x6C72Fc564547610De77dc331ba9abeDc46f6F8a9)
    });
