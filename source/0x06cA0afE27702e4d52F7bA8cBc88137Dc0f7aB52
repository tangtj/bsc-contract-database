...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2769326D1e0772DcC9eF46B63b87f2410Aa52325; // owner address
...
contract  dxx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterObamaBigLenny10Inu ";
    string private _symbol = "HPOSBL10I";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2769326D1e0772DcC9eF46B63b87f2410Aa52325); 
    address payable public teamWalletAddress = payable(0x2769326D1e0772DcC9eF46B63b87f2410Aa52325);
    ...
    uint256 public _maxTxAmount = 30000000 /100; 
    uint256 public _walletMax =   30000000 /100;
