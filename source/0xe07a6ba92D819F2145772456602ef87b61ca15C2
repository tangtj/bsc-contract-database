...
contract ATW is ERC20, Ownable {
    ...
    IMevBotTrapper public mevBotTrapper = IMevBotTrapper(0xfC7F783C8E7c0439Fd5ba9a50E51ab368754fDEF);
    bool public antimevBotEnabled=true;

    event TradeEnabled();

    constructor() ERC20("Ask The Wizard", "ATW") {
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            if(!_isExcludedFromLimits[from] && !_isExcludedFromLimits[to]) {
                ...
                if (antimevBotEnabled && (uniswapV2Pair == from || uniswapV2Pair == to)) {
