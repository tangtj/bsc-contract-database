...
contract TRUMPTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public diinf78;
    ...
    string private _tokenname = "BabyTrump";
    string private _tokensymbol = "BABYTRUMP";
