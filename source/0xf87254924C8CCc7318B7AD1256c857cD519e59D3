...
contract PabloCEO is Context, IBEP20, Ownable {
    ...
    address public marketingAddress = 0xD0825472d4a0b3Ec81eA63d4D6bC734c090C86f1;
    address public TeamAddress = 0xEB14EdfaD363A87ED87166aCF283BA317C0432a0;

    string private constant _name = "Pablo CEO";
    ...
    Taxes public Buytaxes = Taxes(2,2,3,3);
    Taxes public sellTaxes = Taxes(2,2,3,3);
