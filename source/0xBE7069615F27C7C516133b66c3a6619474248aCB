...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x44EB5b5170f536E05d82691159aEE02EAc5EB4F7; // owner address
...
contract GNXNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GNX Network";
    string private _symbol = "GNX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x44EB5b5170f536E05d82691159aEE02EAc5EB4F7); // Marketing Address
    address payable private teamWalletAddress = payable(0x44EB5b5170f536E05d82691159aEE02EAc5EB4F7); // Team Address
