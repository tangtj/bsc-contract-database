...
contract BigDogKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BigDogKing";
    string private _symbol = "BigDogKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D78d6e0d6b06A8d0564717Ba751d4248CDE6d6D); // Marketing Address
    address payable public teamWalletAddress = payable(0x2BfD38ADb169b3bF1678238C240B8A23e4965eff); // Team Address
