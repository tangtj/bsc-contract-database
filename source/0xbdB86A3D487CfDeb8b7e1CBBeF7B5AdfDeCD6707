...
contract RY is Context, IERC20, Ownable {
    ...
    string private _name = "RY";
    string private _symbol = "RY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDfdf8976337dCC2DB09C0A3203ed775a056e2180); // Marketing Address
    address payable public teamWalletAddress = payable(0xd673Fbe71840885572384dCaAc6c317C3377933B); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1666 * 10**3; 
