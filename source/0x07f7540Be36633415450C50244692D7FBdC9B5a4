...
// TG : https://t.me/PPPGLOBALORGANIZATION
...
contract PointToPointProtocol is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5d0bE40145121E72707d2244896b4AbC6E839639);
    address payable private _twdmkt = payable(0x5d0bE40145121E72707d2244896b4AbC6E839639);
    
    string private constant _name = "POINT TO POINT PROTOCOL";
