...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x7651C178E34e1Bd4f4F50D247702846bEF4E93c5; // DEPLOYER
...
contract LionKingInu  is Context, IERC20, Ownable {
    ...
    string public _name = "Lion KIng Inu";
    string public _symbol = "LING";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa9fCE303D05469CA6F32ce2ca334394e4e438E5E); 
    address payable private developmentWalletAddress = payable(0xD1992a3e3cd4B36f05Ab7651716Ca4b539318d42);
