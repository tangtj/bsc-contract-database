...
contract FlexibleStakeFETS is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0x0D4f3516A63408FCF56b860799fb467B1a7e6701);
        rewardToken = IERC20(0x0D4f3516A63408FCF56b860799fb467B1a7e6701);
