...
contract CedarToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x88c263D1941984BB5Bd64D4f6cf2060067B81e07;
    ...
    string private _name = "CedarToken";
    string private _symbol = "CEDARS";
