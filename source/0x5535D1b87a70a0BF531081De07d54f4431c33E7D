...
library Address{
 ...
 contract WORST is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 50_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 50_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 50_000_000_000_000 * 10**9;
   
    uint256 public genesis_block;
   
    address public marketingWallet = 0x368EE15b63c362f8a26d5eFC43D571f6D78277fd;
    address public donationWallet = 0x368EE15b63c362f8a26d5eFC43D571f6D78277fd;

    string private constant _name = "The WORST Coin";
    string private constant _symbol = "WORST";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from == pair && to != address(router) && !_isExcludedFromFee[to] && block.number <= genesis_block + 1) {
