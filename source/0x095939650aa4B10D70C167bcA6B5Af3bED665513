...
contract III is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        800000,//Supply
        address(0x29065489Fb7599F5087007c82E8C463a9Ba2B530),//FundAddress
        address(0xaa3F40684aa2D83cd9E1701F1C140C067EDc2279)//ReceiveAddress
    ){
    }
}