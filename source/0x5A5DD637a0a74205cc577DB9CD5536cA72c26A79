...
library Address{
 ...
 contract Spurdo is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x46C8bB5D19F9e93A63b7D0c8C6C0566c5482cE3C;
    address public donationWallet = 0x46C8bB5D19F9e93A63b7D0c8C6C0566c5482cE3C;
