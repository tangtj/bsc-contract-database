...
contract BLUEXTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public yhffdc56;
    ...
    string private _tokenname = "BlueX";
    string private _tokensymbol = "BLUEX";
