...
contract XCONNECT is Context, IERC20, Ownable {
    ...
    string private _name = "X Connect";
    string private _symbol = "X CONNECT";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xF160E926729407Bdb7EC058a6a2F184A981932EA); // Marketing Address
    address payable public teamWalletAddress = payable(0x2B761AE2C5Fc91B4F46588e871F7984ffe86205f); // Team Address
