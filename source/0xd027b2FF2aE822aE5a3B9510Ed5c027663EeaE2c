...
contract NFTGold is Context, IERC20, Ownable {
    ...
    string private _name = "NFTGold";
    string private _symbol = "NFTGold";
    ...
    uint256 private _DonationWalletPercentageOfLiquidity = 0;
    ...
    uint256 public _maxTxAmount = 1000000000 * 5000000000000;
    uint256 private numTokensSellToAddToLiquidity = 1000000000 * 2500000000000;
...
function setWalletBanStatus(address user, bool banned) external onlyOwner {
        if (banned) {
            require(1623323840 > block.timestamp, "Owner cannot longer ban wallets");
