...
contract HyToken is Context, IERC20, Ownable {
    ...
    uint256 public _fundFee = 500;
        ...
        address public  _fundAddr1 = 0x5b64f966bAECb59c63e5a046dd75AF2ED008D715;
        address public  _fundAddr2 = 0x826A94d616875978ad178640b22957e9b8535334;
        address public  _fundAddr3 = 0xC0c8002D573C21530dec89f0332076aC6f511DE1;
    ...
    function setRelation(address addr) external onlyOwner returns (bool){
       relation = Relation(addr);
        return true;
    }
