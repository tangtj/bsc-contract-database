...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3dc82E6Cd5ec497a6dA125b75E72eC1c70c384F3); // Marketing Address
    address payable public teamWalletAddress = payable(0x3dc82E6Cd5ec497a6dA125b75E72eC1c70c384F3); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x3dc82E6Cd5ec497a6dA125b75E72eC1c70c384F3),
            block.timestamp
        );
    }
