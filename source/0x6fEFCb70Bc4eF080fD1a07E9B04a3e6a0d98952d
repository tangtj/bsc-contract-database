...
contract Power is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xE3e6B1FE4222Cc1dBe1945C30bC5EF0d966699c5); // Marketing Address
        
    address payable public teamAddress =
        payable(0xE3e6B1FE4222Cc1dBe1945C30bC5EF0d966699c5); // Team Address
        
    address payable public liquidityAddress =
        payable(0xE3e6B1FE4222Cc1dBe1945C30bC5EF0d966699c5); // Liquidity Address
    ...
    string private constant _name = "Power";
