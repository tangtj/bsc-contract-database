...
contract PunkRabbitNFTs is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public whitelistLimit = 0;
    uint256 public whitelistLimitPerWallet = 10;
    uint256 public overallFreeMintLimit = 0;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Punk Rabbit NFTs", "PR") {
