...
Telegram https://t.me/bostertoken
Website https://bostertoken.xyz/
Twitter https://twitter.com/bostertoken
...
contract Boster is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOSTER";
    string private _symbol = "$BOSTER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90FE89b38b466280046F97F202718BaA356F229C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5B8B422c490d5e04a0629eE344e4F6E8DE4a7aca); // BuyBack Address
