...
contract DORKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "DORKI";
    string private constant _symbol = "DORKI";
    ...
    address payable private _twddev = payable(0x22Ed15080B538aaF885D9F8C32496c2464E1b23b);
    address payable private _twdmkt = payable(0x22Ed15080B538aaF885D9F8C32496c2464E1b23b);
