...
contract LongRui is ERC20, Ownable{
    ...
    uint256 public swapThreshold =  100 ** decimals();

    bool public isLaunch = false;
    
    address public marketingWallet = 0xdc2BE91f0F72C5AEfEF25EB06Bd07943FF7229C8;
    ...
    constructor() ERC20("LongRui", "LongRui") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        require(!botList[sender], "You are bot!");
