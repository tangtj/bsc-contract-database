/**
https://t.me/RoyalNetworkOFC
https://twitter.com/royalnetwork9
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x228a6C1713054F848d2A8C2D34eafBf9CAb2405B; 
...
contract ROYALNETWORK09 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ROYAL NETWORK";
    string private _symbol = "ROYL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x228a6C1713054F848d2A8C2D34eafBf9CAb2405B); 
    address payable public teamWalletAddress = payable(0x228a6C1713054F848d2A8C2D34eafBf9CAb2405B); 
