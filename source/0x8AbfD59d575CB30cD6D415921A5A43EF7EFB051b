/**
   Welcome to DOW. Amidst NYC's financial chaos emerges 
   the "DOGE OF WALL STREET", trading stocks with expert audacity.
  TELEGRAM: https://t.me/DOW_BSC
*/
...
contract DOW is ERC20Burnable, IERC20, Ownable {
    ...
    string private constant _name = "DOGE OF WALL STREET";
