...
contract ABS is Context, IERC20, Ownable {
    ...
    constructor(
        ...
        require(router != address(0x0), "Not BSC / BSC TESTNET");
        ...
        isExcludedFromFee[addLPAddress] = true;
    ...
    function setBuyTaxes(uint256 newMarketingTax) external onlyOwner {
        require(newMarketingTax <= 25, "Tax Too High");
    ...
    function airdropPrivateSale(
        address[] calldata addressList,
        uint256[] calldata amountList
    ) external onlyOwner {
        require(addressList.length == amountList.length, "Length not equal");
...
contract PEPEMOON is ABS {
    constructor()
        ABS(
            "PEPEMOON",
            "PEPEMOON",
            address(0xBC3943BF41584FC77DFc3ECb9Eed6570f8B9CB7a), //Marketing
            address(0xBC3943BF41584FC77DFc3ECb9Eed6570f8B9CB7a), //AddLPAddress
            address(msg.sender)
        )
    {}
}