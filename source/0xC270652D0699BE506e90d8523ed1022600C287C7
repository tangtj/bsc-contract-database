/**
Telegram: https://t.me/sugardaddyportal
*/
...
contract sgdad is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUGARDADDY";
    string private constant _symbol = "SGDAD";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x370bebe0894eC73f362d17Be39BEdBb8682dDFf9);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x370bebe0894eC73f362d17Be39BEdBb8682dDFf9] = true;
