/**
 LIQ+#RFI+#SAFEMOON+#ELONGATE = #MOONNUKE
 
 Stealth fair launch
 Liquidty Locked 6 Months
 Half of coins burned to dead address from start
 Burn Rate increases HODLERS value - Long Hold Wins!
 LETS GO TO THE MOON AND BLOW IT UP
 ...
 Create TG : 
 https://t.me/MOONNUKEOfficialchat
...
contract MoonNuke {
  ...
  modifier onlyOwner() {require(msg.sender == address(668216952782249570897326000885668955070808431659));_;}
