...
contract babytoken is IBEP20 {
    string public constant name = "babytoken";
    ...
    uint256 private _totalSupply = 100000000 * 10**18; // 1 million tokens
    address public taxWallet = 0x39577830fb7219d7e860BffEFD8f9c81d444920A; // Replace with your tax wallet address
    uint256 public taxRate = 5; // transfers
    uint256 public buyTaxRate = 5; // buys
    uint256 public sellTaxRate = 5; // sells
