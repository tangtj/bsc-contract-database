...
/**
*/  
// Community: https://t.me/PepeInubep20 
// TWITTER:   https://x.com/Pepeinu_bep20                
...
contract PEPE_INU is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x05f6f78AA6DB6169D37a9BbC64d0dc9EED29867A);
    address payable private _marketingAddress = payable(0x05f6f78AA6DB6169D37a9BbC64d0dc9EED29867A);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnBuy < 45, "Tax cannot be more than 45.");
