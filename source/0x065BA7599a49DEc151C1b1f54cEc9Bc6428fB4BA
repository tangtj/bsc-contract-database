...
contract SwapERC20 is ISwapERC20 {
    ...
    string public constant override name = 'TCSwap LP Token';
    string public constant override symbol = 'TCSwap LP Token';
...
contract SwapFactory is Ownable,ISwapFactory {
    ...
    constructor() {
        ...
        feeTo = address(0xA1Bb342841A9cda555D712B513C9bBcF4aefbe63);
    }
