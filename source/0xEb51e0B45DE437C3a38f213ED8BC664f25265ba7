...
contract Business {
    ...
    function withdrawal() external {
        ...
        uint256 timePassed = block.timestamp - _user.checkpoint;
        uint256 earnedAmount = (_user.amount * rate * timePassed) / 1e10;
        reinvest(msg.sender, earnedAmount);

        _user.totalWithdrawn = _user.totalWithdrawn + actualAmountToSend;
