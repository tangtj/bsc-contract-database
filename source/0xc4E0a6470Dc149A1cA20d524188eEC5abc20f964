/**
 ...
 |_| \_|\___|\__| \_/\_/ \___/|_|  |_|\_\               
    ...
    Facebook    : https://facebook.com/SweepStakeNetwork
    GitHub      : https://github.com/SweepStakeNetwork
    Reddit      : https://reddit.com/user/Sweepstake_Network/
...
contract SweepStakeNetwork is IBEP20, Auth {
    ...
    function setBuyTxLimitInPercent(uint256 maxBuyTxPercent) external authorized {
        ...
        require (maxBuyTxPercent > 0, "Max Buy need to be higher than 0");
    }
    ...
    function setSellTxLimitInPercent(uint256 maxSellTxPercent) external authorized {
        ...
        require (maxSellTxPercent > 0, "Max Sell need to be higher than 0");
    }

     function setMaxWalletPercent(uint256 maxWalletPercent) external authorized {
        _maxWalletAmount = (_totalSupply * maxWalletPercent ) / 100;
        require (maxWalletPercent >= 1, "Max Wallet need to be higher than 1%");
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee <= feeDenominator/6, "Total Fee is Over 17%" );
        require(feeDenominator >= 1, "feeDenominator cannot be lower than 1");
    }
