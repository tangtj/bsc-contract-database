...
contract Cockdog is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cock dog";
    string private _symbol = "Cock dog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDBCA15b651c2a8E0BfBe2C3165F0262EB735243b); // marketing Address
    address payable public developmentWalletAddress = payable(0xd974d2f15574b54924B1c9f55F364506C2bbd4fa); // development Address
    ...
    uint256 private _totalSupply = 100000000000000 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 4000000000000 * 10**3 * 10**9;
    uint256 public _walletMax = 4000000000000 * 10**3 * 10**9;
