...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x0b0db51398fE95D6Ea5fDb96799b84049bFc7942);
...
contract XTigeInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x2F1DeA098e67FfA76B3E646eAF639FCc428C7D17;

    string constant _name = "X Tige Inu";
    string constant _symbol = "$XTINU";
