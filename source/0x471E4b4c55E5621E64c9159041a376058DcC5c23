...
WEBSITE: https://www.blacklistedtoken.xyz
...
contract BLACKLIST is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Black Listed";
    string constant _symbol = "BLACKLIST";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x90969ae6a8bB389614FDDad689b75343d6eE1500;
        marketingWallet = 0x90969ae6a8bB389614FDDad689b75343d6eE1500;
        devWallet = 0x90969ae6a8bB389614FDDad689b75343d6eE1500;
