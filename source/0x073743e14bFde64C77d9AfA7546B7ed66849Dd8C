...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69A25e13733A84A84A16d1746D8f55289BDF34bB;
...
contract FIBER is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x69A25e13733A84A84A16d1746D8f55289BDF34bB;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "5G FIBER NETWORK";
    string private _symbol = "5G FIBER";
