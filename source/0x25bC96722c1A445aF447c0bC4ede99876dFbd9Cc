...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6237DfFaeDbEE56E659795200Dfc96be8C1df86a;
...
contract DFINE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x618d9Ae9a5e395C8F6e085A565cF4B750d66b500);
    ...
    */
    ...
    string private _name = "Dork is Fine"; 
    string private _symbol = "DFINE";  
