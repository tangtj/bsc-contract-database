...
contract Layerium2 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2523ec42F93665619c955adC86125456F0Ed9891;

    string private constant _name = "Layerium 2.0";
    string private constant _symbol = "Layerium2";
    ...
    // Owner cannot transfer out  Layerium2 from this smart contract
