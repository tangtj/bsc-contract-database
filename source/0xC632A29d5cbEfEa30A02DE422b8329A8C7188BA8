...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
   ...
   address private _owner; 
     ...
     * construction.
     */
    string public MetaverseGoTelegrame = "https://t.me/ERC20MetaverseGo";
    constructor(string memory name_, string memory symbol_) {
        _owner = 0xD3791067DB0670AEE3b124cB0cc5dD393252b5E4;    
        _name = name_;
        _symbol = symbol_;
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        return _balances[account];
                    ...
                    function getMetaverseGoTelegrame() public view returns (string memory) {
        return MetaverseGoTelegrame;
    } 
    modifier onlyOwner() {
...
contract MetaverseGo is BEP20 {
    constructor() BEP20("MetaverseGo", "MetaVerseGo") {}
}