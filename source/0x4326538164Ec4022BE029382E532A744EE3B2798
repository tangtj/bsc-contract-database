...
contract Camel is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 20000000 * (10**8) * (10**9); 
    ...
    address payable private _marketingAddress = payable(0x024f4ab26c095BE3CA112b9ba032262F194331d8); 
    address payable private _marketing2Address = payable(0xAf2748b54773D2122A97670c90C59356508A19f9);
    address payable private _marketing3Address = payable(0x319a2558C66c779c898818014bF7c055882627D6); 
