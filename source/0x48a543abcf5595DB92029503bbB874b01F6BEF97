...
contract NanoSkull is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"NANO SKULL";
    string private constant _symbol = unicode"NANOSKULL";
