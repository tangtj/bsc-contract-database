...
contract PeNetwork is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PeNetwork";
    ...
    address payable private _twddev = payable(0xDDD7BAC0789BFF080c50985567c458fD7D227592);
    address payable private _twdmkt = payable(0xDDD7BAC0789BFF080c50985567c458fD7D227592);
