...
contract BNBsongoku is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc21C0Fcf98EdF77aF5BbffaaA7693EAd7db2E7EA); 
    address payable public Wallet_Dev = payable(0x56379082e89Ef9769bF52A465D88E09279875804);
    ...
    constructor () {
        _owner =0x56379082e89Ef9769bF52A465D88E09279875804;
