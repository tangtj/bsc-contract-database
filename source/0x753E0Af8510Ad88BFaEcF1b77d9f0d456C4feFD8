...
// telegram : https://t.me/ladydorkbsc
...
contract LADYDORK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LAᗪY ᗪOᖇK";
    string private constant _symbol = unicode"LDORK";
    uint256 public _maxtxwlt = _tTotal / 100;
    ...
    event MaxTxAmountUpdated(uint _maxtxwlt);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
                ...
                require(amount <= _maxtxwlt, "Exceeds the _maxtxwlt.");
