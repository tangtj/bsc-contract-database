...
⚡️ ELECTRONEUM ⚡️|| BEP-20

($ELC) is a coin that combines payment efficiency, reward opportunities, 
and access to the DeFi ecosystem in one package. With the goal of becoming a popular 
and trusted payment tool. 

ELECTRONEUM continues to innovate and adapt to technological advancements and user needs🚀.

📱TG: https://t.me/+3njRgt_fIzZmZTg1
...
contract ELECTRONEUM is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ELECTRONEUM";
    string private constant _symbol = unicode"$ELC";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 31000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x89c3D6cB59388D41f7Eec875916d22e11edc0474);
    address payable public MarketingWallet = payable(0x70d788410F62042eEA7db8De95f17db7D7b35e9E);
