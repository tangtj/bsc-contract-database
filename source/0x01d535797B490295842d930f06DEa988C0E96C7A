...
contract TigerMoon is Context, IERC20, Ownable {
    ...
    string private _name = "TigerPEPE";
    ...
    address payable public teamWalletAddress = payable(0x78e0a084EBc5Bf29Bfc566Adaf0D4360C4e966a5); // Team Address
