...
/**
   ...
   Welcome to ROLLERAPE
   
   This is a community token. If you want to create a telegram I suggest to name it to @ROLLERAPEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ROLLERAPE
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ROLLERAPE 10000X? 
   ...
   it's the best part of the #ROLLERAPE idea, increasing the liquidity pool automatically, 
...
contract ROLLERAPE is Context, IERC20, Ownable {
    ...
    string private _name = "ROLLERAPE";
