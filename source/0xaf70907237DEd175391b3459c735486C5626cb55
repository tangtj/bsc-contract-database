...
contract MoonCakeSG is IBEP20, Auth {
    ...
    string constant _name = "MoonCakeSG";
    string constant _symbol = "MCSG";
    ...
    address private marketingFeeReceiver = 0x90da27bCa4e3dA190c6005d3217718947Da1b6bc;
    address private developmentFeeReceiver = 0x49bC292d931Cb52a84cBaDEA04FAfdAeF89D3110;
