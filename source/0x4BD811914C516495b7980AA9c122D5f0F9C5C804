...
contract Sakura  is ERC20, Ownable {
    ...
    constructor() ERC20("Sakura", "Sakura") {
        ...
        marketingWallet = address(0x9Ec6D8f9989Ad88cb779a0d99Ce4003Dc05229Fe); // set as marketing wallet
        devWallet = address(0x9Ec6D8f9989Ad88cb779a0d99Ce4003Dc05229Fe); // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees.div(feeDenominator) <= 4, "Must keep fees at 4% or less");
    }
