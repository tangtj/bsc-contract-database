...
contract LEGO is ERC20, Ownable {
    ...
    constructor() payable ERC20("Lego Token", "LEGO") {
    ...
    totalSellFee = marketingFeeOnSell + rewardsFeeOnSell;
        ...
        marketingWallet = 0x7E72921E5B8a88f993efcB8f1BEe1c9D13136B09;
        ...
        whitelisted[0xEC831fd58c90cD1c6D55D0C57Ad9C4faaD24e65f] = true;
    
        _mint(0xEC831fd58c90cD1c6D55D0C57Ad9C4faaD24e65f, 1_000_000_000 * (10 ** 18));
    ...
    function setwhitelist(address account, bool _whitelisted) external onlyOwner {
        require(whitelisted[account] != _whitelisted, "Account is already set to that state");
        whitelisted[account] = _whitelisted;

        emit Whitelist(account, _whitelisted);
    }
