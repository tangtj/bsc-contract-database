...
contract BEP20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x185194E4594F78A06F53e635d3Bc582aa82A7441); // Marketing Address
        
    address payable public teamAddress =
        payable(0x185194E4594F78A06F53e635d3Bc582aa82A7441); // Team Address
        
    address payable public liquidityAddress =
        payable(0x185194E4594F78A06F53e635d3Bc582aa82A7441); // Liquidity Address
    ...
    uint256 private constant _tTotal = 420069 * 1e9 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "BSCInu";
