...
Website : https://shibonerium.cloud

Twitter : https://twitter.com/shibonerium

Telegram : https://t.me/shibonerium
...
contract zillprotocol is Context, IERC20, Ownable {
    ...
    string private _name = "ZILLPROTOCOL";
    string private _symbol = "$ZPTC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x131D92E0D89ccB003DdB7303FACbFfB62071c542);
    address payable public liqWalletAddress = payable(0x131D92E0D89ccB003DdB7303FACbFfB62071c542);
