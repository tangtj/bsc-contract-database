...
contract RollerSwap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RollerSwap";
    string private _symbol = "ROLS";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xBf3Ab74F293F079742906CE7Bec10A5254A36fEe);
    address payable public teamWalletAddress = payable(0x0c83f2358A84d4bd5BCC79c44E690C087aA3513b);
