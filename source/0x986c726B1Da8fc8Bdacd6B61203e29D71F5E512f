        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xDfE432637d769AB6B0979BfE037ba9031Ece9C36), block.timestamp
                );
            }
        }
    }
...
contract yijiusijiu is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1949,//Supply
        address(0xD9C45cdB93BD281Ef3519fda7f1e95c9A6248D48),//FundAddress
        address(0xDfE432637d769AB6B0979BfE037ba9031Ece9C36)//ReceiveAddress
    ){
    }
}