...
contract DUELTest is ERC20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() ERC20("DUELTest", "DUEL") { 
        marketingWallet = payable(0x7e0a60A014586b23cffCb957513aDc3d7Fc17A07); 
        DevWallet = payable(0xEde5F2554CD91F190d2ACAc8769823f23E087280); 
        _gameContract = 0x311f0764Ecd0de9D50fA3E3Ac8d568C7C9fb3026;
