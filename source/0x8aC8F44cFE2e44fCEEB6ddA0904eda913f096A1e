...
/**
// Telegram : https://t.me/bitcoinbankannc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x361C239147B448db034937970b00697ef55F0FD6 ; // owner address
...
contract BITCOINBANK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BITCOIN BANK";
    string private _symbol = "$BBANK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x361C239147B448db034937970b00697ef55F0FD6); // Marketing Address
    address payable private teamWalletAddress = payable(0x361C239147B448db034937970b00697ef55F0FD6); // Team Address
