// t.me/TopDownSurvivalShooter 
// TopDownSurvivalShooter.com
...
contract TopDownSurvivalShooter is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "TopDownSurvivalShooter";
    string public symbol = "SHOOTER";
