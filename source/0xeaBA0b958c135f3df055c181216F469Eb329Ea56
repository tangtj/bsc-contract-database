...
contract Tokendotcom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tokendotcom";
    string private _symbol = "TDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1f03f72108DCC202AaceC1e116F565320D389B9A); // Marketing Address
    address payable public teamWalletAddress = payable(0x1f03f72108DCC202AaceC1e116F565320D389B9A); // Team Address
