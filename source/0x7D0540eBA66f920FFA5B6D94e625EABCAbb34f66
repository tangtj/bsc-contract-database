...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
		...
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/QmXGttgCfMWUYZZuMXwWqthAZBPYPYVGejsY3BmL2cC8tw");
        return true;
    }
}
...
contract MAGICCASTLENFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("MAGIC CASTLE NFT", "MAGIC CASTLE NFT") {
