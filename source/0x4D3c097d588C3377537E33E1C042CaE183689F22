...
contract RickTheJeets is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xFEBC8486e5fC3DdFDC9d168A4a39c7E88b7868a6;

    string private constant _name = "Rick The Jeets";
    string private constant _symbol = "$RTJ";
    ...
    // Owner cannot transfer out  Rick The Jeets  from this smart contract
