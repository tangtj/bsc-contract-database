        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x32bE63C5a61b00465C53D8699d9BfaA51fCd82Cb), block.timestamp
                );
            }
        }
    }
...
contract b2049 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        20000000,//Supply
        address(0x32bE63C5a61b00465C53D8699d9BfaA51fCd82Cb),//FundAddress
        address(0x32bE63C5a61b00465C53D8699d9BfaA51fCd82Cb)//ReceiveAddress
    ){
    }
}