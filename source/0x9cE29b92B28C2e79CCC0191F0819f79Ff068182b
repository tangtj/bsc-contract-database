...
contract NoTRA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NoTRA";
    string private _symbol = "NoTRA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6a7612E0cB448869192a8e11CAe54Cf7E21ec00B); // Marketing Address
    address payable private teamWalletAddress = payable(0x6a7612E0cB448869192a8e11CAe54Cf7E21ec00B); // Team Address
