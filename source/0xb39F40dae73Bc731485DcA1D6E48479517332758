...
contract FORGLORD2049 is ERC20, Ownable {
    ...
    constructor() payable ERC20("FORG LORD 2049", "FROGLORD2049") {
        uint256 totalSupply_ = 420_000_000_000;
        buyFee = 2;
        sellFee = 2;
        wallet01 = address(0x438Ec64016D3d28c2842E90547e68754D6471a14);
