...
contract UNICORN2049 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "UNICORN 2049";
    string private constant _symbol = unicode"$UNICORN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 62000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x0aB0B26eD1d4353858DFD4651dE31f89F493FBEf);
    address payable public MarketingWallet = payable(0xdA26740Df2b6Cd8293B7cD2C6a22f1D7A268976f);
