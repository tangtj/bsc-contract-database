...
contract DiscountCoin {
    ...
    string public name = "Discount Coin";
    string public symbol = "DC";
    uint256 constant public decimals = 18;
    uint256 internal totalSupply_ = 10000000000*10**18;
	uint256 internal availabletoken=10000000000*10**18;
	uint256 internal tokenSupply_ = 0;
	uint256 internal tokenforReferalIncome_ = 0*10**18;
    ...
    uint256 public buypercent = 5;
	uint256 public sellpercent =5;
	
	uint256 public rateinfluencePercent =0;
    ...
    constructor() 
    {
         TokenVault = payable(msg.sender);
         administrators[TokenVault] = true;
         commissionHolder = TokenVault;
		 owner = TokenVault;	 
		 
		 incomAccount = TokenVault;
         tokenSupply_ = 10000000000*10**18; 
		 tokenforReferalIncome_ = 0*10**18;
         availabletoken=10000000000*10**18;
		 flag_ = 1;
         tokenBalanceLedger_[commissionHolder] = 420000000000*10**18; 
