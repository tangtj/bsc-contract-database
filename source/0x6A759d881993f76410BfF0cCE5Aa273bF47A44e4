...
contract CuteKawaiiInu is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Cute Kawaii Inu', 'CKI') {
        require(
            feeAccount != address(0),
            'CuteKawaiiInu: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'CuteKawaiiInu: incorrect fee percent');
        require(owner != address(0), 'CuteKawaiiInu: incorrect owner address');
        require(mintToAddr != address(0), 'CuteKawaiiInu: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'CuteKawaiiInu: transfer from the zero address');
        require(recipient != address(0), 'CuteKawaiiInu: transfer to the zero address');
