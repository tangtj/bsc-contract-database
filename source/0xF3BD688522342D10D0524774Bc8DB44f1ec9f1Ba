...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xad4Da800a02652A5Fd3146EbC8144e5D895646df; 
...
contract PikaEther is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pika Ether";
    string private _symbol = "PETHER";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xad4Da800a02652A5Fd3146EbC8144e5D895646df); // 
    address payable public teamWalletAddress = payable(0xad4Da800a02652A5Fd3146EbC8144e5D895646df); // 
