...
//TODO
contract EternalKibaInu is IERC20 {
    ...
    string constant _name = "Eternal Kiba Inu"; //TODO
    string constant _symbol = "ETKIBA"; //TODO
    ...
    address payable private _marketingWallet = payable(0x8a98b0e227239afb4f6BCDdf2663D69d6C2c2011); //TODO
    address payable private _buybackWallet = payable(0x27b2203dd63d7C0a96Cbd84F10C1b24550239795); //TODO
