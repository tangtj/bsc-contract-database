...
/**
https://t.me/testchain
https://testchain.xyz/
*/

/**
Welcome To The testChain
...
contract testChain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC48a3Cf36988cb9a2297B3Ccb218F2CC47A98905); // Marketing Address
    address payable public teamWalletAddress = payable(0x6A23170E4946EA098181F3a1372a0CdcC8A10C85); // Team Address
