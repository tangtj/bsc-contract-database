...
contract AssassinateToken is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable {
    constructor() 
    ERC20Detailed("Assassinate Token", "AST", 18) public {
        for(uint i =0 ;i < VALIDATOR_NUMBERS; i++ )
        {
            validators[i] = _msgSender();
        }
        super.mint(_msgSender(), 100000 * 10 ** 18);
    }
