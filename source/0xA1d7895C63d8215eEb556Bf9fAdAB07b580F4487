...
contract MONIRO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb7A75F6ee9D7E8Fbb1185FFEC810Bf54Ae9680BB); 
    address payable public Wallet_Dev = payable(0x4032C2cF79B2c7A289779042539F07DB241d9B12);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =1000000000000 * 10**18;
    string private constant _name = "MONIRO"; 
    string private constant _symbol = unicode"MONIRO"; 
    ...
    constructor () {
        _owner =0xb7A75F6ee9D7E8Fbb1185FFEC810Bf54Ae9680BB;
