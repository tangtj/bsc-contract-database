...
contract CyberPanther is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Cyber Panther', 'CYBERP') {
        require(
            feeAccount != address(0),
            'Cyber Panther: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Cyber Panther: incorrect fee percent');
        require(owner != address(0), 'Cyber Panther: incorrect owner address');
        require(mintToAddr != address(0), 'Cyber Panther: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Cyber Panther: transfer from the zero address');
        require(recipient != address(0), 'Cyber Panther: transfer to the zero address');
