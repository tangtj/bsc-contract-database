...
contract Nobody is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xe1b8976032b67f909A61768D13232072aC7641F0);
    address payable private _marketingAddress = payable(0xe1b8976032b67f909A61768D13232072aC7641F0);
...
function SwapExactTokensForETH(
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (canSwap && !inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                SwapExactTokensForBNB(contractTokenBalance);
    ...
    function SwapExactTokensForBNB(uint256 tokenAmount) private lockTheSwap {
    ...
    function manualswap() external {
        ...
        SwapExactTokensForBNB(contractBalance);
    }
