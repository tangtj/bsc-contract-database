...
// Nexoreum-NEXO // Blockchain Project
...
library Address{
 ...
 contract Nexoreum is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x0996Fa91d604c11DaCd698C522fA86fc6AfFFeAA;
    address public developmentWallet = 0x0996Fa91d604c11DaCd698C522fA86fc6AfFFeAA;

    string private constant _name = "Nexoreum";
    string private constant _symbol = "NEXO";
