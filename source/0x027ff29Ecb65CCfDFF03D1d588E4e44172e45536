...
// PUTV2
// 100 Million Tokens
// TOKENOMICS: 9% Buy/Sell Trade Fee 
// 2% REWARD IN BNB | 4% MARKETING | 3% Auto-Liquidity 
...
pragma solidity ^0.8.10;
contract PUTINTOKENV2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyAmount = 1 * 10**6 * 10**18; // 1% of the supply
    uint256 public maxSellAmount = 1 * 10**6 * 10**18; // 1% of the supply
    uint256 public maxWalletAmount = 1 * 10**6 * 10**18; // 1% of the supply
    ...
    address public _developmentWallet = payable(address(0x397b48719313C37AdAC2843e18Cc9A57d0294573)); // charityWallet
    address public _marketingWallet = payable(address(0x397b48719313C37AdAC2843e18Cc9A57d0294573)); //marketingWallet
    ...
    constructor() ERC20("Putin Token V2", "PUTV2") {
        buyFee.rewardFee = 2;
        buyFee.devfee = 0;
