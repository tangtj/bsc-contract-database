...
contract BEBE2 is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xb99C0FA73C211900e9266F13Fd5826a910E40232;

    uint256 public swapTokensAtAmount;
    bool    public swapWithLimit;
    bool    private swapping;

    uint256 public maxBuyAmount = 10001 * 10**18; //
    ...
    constructor () ERC20("BEBE2", "BEBE2") 
    {   
        address newOwner = 0x71ee443cCB97789f76130FcBA117719531C4391b ;
