...
Telegram https://t.me/darthpepe_bsc
Website 
*/
...
contract DARTHPEPE is Context, IERC20, Ownable {
    ...
    string private _symbol = "DARTH PEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD6Bbb97299853bae621485930C5E93480e1E1206); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF93Cc04044CcE2A9A8b9d0C4cA05A56F98e2327C); // BuyBack Address
