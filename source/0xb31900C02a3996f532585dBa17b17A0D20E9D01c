...
Join new era meme!
TG : https://t.me/+Rsm0JIZV_u4yMTFl
...
contract TAZZXBUNNY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "TAZZ X BUNNY";
    string private constant _symbol = unicode"$TAZZ";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 36000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x586C139cfD10187d5430C65674BCbAE5BEdEf4e7);
    address payable public MarketingWallet = payable(0xf7123d7E67516c533bD584B8cd9dCd270F545Bc3);
