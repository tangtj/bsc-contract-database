// Telegram:   https://t.me/EggPepeBsc
...
contract EGGPEPE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$EGGPEPE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x94ECFCf33f0d9800968490AeC698e369588c86bA);
