...
/*
twitter: https://twitter.com/Chainabcd
*/
...
contract AOCPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ChainABCD";
    string private constant _symbol = unicode"ABCD";
