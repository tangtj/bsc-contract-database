        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x69E084E93A0c458DF15dA747c8cA7E67407772e4), block.timestamp
                );
            }
        }
    }
...
contract ZGLCoin is AbsToken {
    constructor() AbsToken(
        ...
        address(0x69E084E93A0c458DF15dA747c8cA7E67407772e4)//ReceiveAddress
    ){
    }
}