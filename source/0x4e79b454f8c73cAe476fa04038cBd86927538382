...
contract GoldenDog is IERC20, Ownable {
    ...
    constructor() {
        ...
        fundAddress = address(0x4fbdC7c885289aDCBCe23b4BF0A036797Dd9361f);
        _swapRouter = ISwapRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        address ReceiveAddress = address(0xab8810C43cb985b950aC48C364D51e4cd95a6e59);
        _owner = msg.sender;
        ...
        holderRewardCondition = 10 ** IERC20(currency).decimals() / 1000;
