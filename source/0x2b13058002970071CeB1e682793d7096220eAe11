...
TG: https://t.me/Buff_Floki
Website: https://buff-floki.com
TW: https://twitter.com/buffflokicoin
*/
...
contract BuffFlokiCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe59880aB519d805b7c6F605CbBA1929D1033D5F6); // Marketing Address
    ...
    string private _name = "Buff Floki Coin";
    string private _symbol = "BUFlOKI";
