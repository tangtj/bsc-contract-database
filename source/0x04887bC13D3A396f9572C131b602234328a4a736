...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit = 10000000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xE36A2ac15f1141489705C564A9F32ad975A7902f), block.timestamp
                );
            }
        }
    }
...
contract a2049 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x89f258B6e0e948759AA2B7D86aef713Da39382B9),//FundAddress
        address(0x89f258B6e0e948759AA2B7D86aef713Da39382B9)//ReceiveAddress
    ){
    }
}