...
contract CyperFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAe31d909F6d197A6072F68d2Ef01c7DcDF7E3b27); // Marketing Address
    ...
    string private _name = "EDGSquid";
    string private _symbol = "EDGSquid";
