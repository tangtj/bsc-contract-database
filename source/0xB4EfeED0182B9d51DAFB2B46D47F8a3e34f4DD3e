/*
          ...
          XBNB Is a Community Driven  Meme Token Launching On BSC Network Based On  ELON Tweet CHANGING TWITTER NAME TO "X" and CZ Binance tweet Let's X.

        // Telegram:https://t.me/XBnbZ
        // Website: https://xbnb.tech/
        // Twtter:  https://twitter.com/x_bnbcoin
...
contract XBNB is Context, IERC20, Ownable {
    ...
    string private _name     = "XBNB";
    string private _symbol   = "XBNB";
    ...
    {        
        ...
        marketingWallet = 0x13bAa45A22083770AadEd4434B435028fB8e30E7;
