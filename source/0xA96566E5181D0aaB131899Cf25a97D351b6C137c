// telegram     : https://t.me/lunarlolcoinbsc
...
contract lunarlolcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "lunarlolcoin";
    string private _symbol = "$LUNARLOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x009716773c32D082b79c2A013440cBaFe501B834); // Marketing Address
    address payable public teamWalletAddress = payable(0x009716773c32D082b79c2A013440cBaFe501B834); // Team Address
