//   catto inu is the next hype of cat coin
//   catto inu burnable team token 
//   telegram group : https://t.me/Catto_Inu
...
contract CattoInu is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0x24AB00D2c1138A62888F93E4f3eAE6d2862329B9);
    address public DevelopmentWallet =
        0xc38F7bDC54cbe9a236B55564e5084f9E9BAAE245;
    ...
    string private constant _name = "Catto Inu";
    string private constant _symbol = "Catnu";
    ...
    uint256 public _maxTxAmount = 12 * 10**12 * 10**18;
    uint256 public _maxWalletHoldingLimit = 12 * 10**12 * 10**18;
