...
contract BIC is ERC20, Ownable {
    ...
    BICDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BIC", "BIC") {
        marketingWallet = payable(0xF1252B121440877f9Af4E4CbD2695e0E19e9BD7C);
        devWallet = payable(0xF1252B121440877f9Af4E4CbD2695e0E19e9BD7C);
        ...
        dividendTracker = new BICDividendTracker(
            payable(this),
            router,
...
contract BICDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "BIC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BIC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BIC contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BICContract);

            uint256 prevBalance = BICContract.balanceOf(address(this));
            ...
            {
                uint256 received = BICContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BICContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
