...
contract PinksaleMudraUnicryptTrustswap is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PinksaleMudraUnicryptTrustswapDxSaleOnlymoonUniswap","$LPLocker") {
        ...
        swapTokensAtAmount = totalSupply * 200 / 1000;
