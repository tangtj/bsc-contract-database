...
// CANEswapFinance with Governance.
contract CANE is ERC20("Caneswap.finance", "CANE"), Ownable {
    uint256 private _cap = 51300e18;
    uint256 private _initial_supply = 51300e18;
...
creation of CANE pending...
    ...
    // Copied and modified from CANE code:
    // https://github.com/caneswap-finance/caneswap-protocol/blob/master/contracts/token/CANEGovernanceStorage.sol
    // https://github.com/caneswap-finance/caneswap-protocol/blob/master/contracts/token/CANEGovernance.sol
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "CANE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "CANE::delegateBySig: invalid nonce");
        require(now <= expiry, "CANE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "CANE::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "CANE::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn CANE on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
