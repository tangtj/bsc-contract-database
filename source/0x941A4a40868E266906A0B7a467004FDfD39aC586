...
// File: The Davis Legacy Coin.sol
...
contract TDLC is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**12 * (10**12);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x87B5ECb362a918c40183a97EeC6916bF6d2784cB); // Team Wallet
    address public _projectWalletAddress = address(0x2825ecDf8C831D51F38B3454f83c5069Ab81aFc2); //Project Wallet
    ...
    constructor() ERC20("The Davis Legacy Coin", "TDLC") {
        ...
        sellFee.projectFee = 10; // 1% project fee
        sellFee.teamFee = 10;   // 1% team fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "TDLC: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TDLC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TDLC: Automated market maker pair is already set to that value");
