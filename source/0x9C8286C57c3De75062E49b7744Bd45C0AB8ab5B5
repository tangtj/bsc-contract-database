...
contract CornoCoinX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Corno Coin X";
    string constant _symbol = "CX";
    uint8 constant _decimals = 6;
    uint256 _totalSupply = 1000 * (7**_decimals);
    ...
    uint256 marketingTransferFee = 10;
    ...
    address public pair;
    address ts_Project = 0x6DF1D3565Ab86419f643a24e0706ce5F86Ea94E7  ;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0x6DF1D3565Ab86419f643a24e0706ce5F86Ea94E7;
