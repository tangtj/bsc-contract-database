...
Official Watcherium Contract

Telegram : https://t.me/Watcherium
...
contract Watcherium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WATCHERIUM";
    string private _symbol = "WTM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5447441D99BCe6514bc96beb5E6F96353Fc65c00);
    address payable private DevelopmentWalletAddress = payable(0x24A6530878fD336AC4AAf60491c625362336a8B2);
