/**
Telegram: https://t.me/pepejojoBSC
Website: https://pepejojo.xyz/
Twitter: https://twitter.com/PepeJojoBSC            
*/
...
contract PEPEJOJO is Context, IERC20, Ownable {
    ...
    string private _name = "PEPEJOJO";
    string private _symbol = "$PEJO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x983f26c80F1932E9d4eAFf504ca934ac691ab9Ac); // Marketing Address
    address payable public teamWalletAddress = payable(0x983f26c80F1932E9d4eAFf504ca934ac691ab9Ac); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 500 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
