...
//https://t.me/PlaudNetwork

//https://https://x.com/tokenPlaudNetwork
...
contract PlaudNetwork is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9748AaFF22fE0d4a97e0f81F1D19a0C33af489cA); 
    address payable public Wallet_Dev = payable(0x9748AaFF22fE0d4a97e0f81F1D19a0C33af489cA);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "PlaudNetwork"; 
    string private constant _symbol = unicode"$PLDN"; 
    ...
    constructor () {
        _owner =0x9748AaFF22fE0d4a97e0f81F1D19a0C33af489cA;
