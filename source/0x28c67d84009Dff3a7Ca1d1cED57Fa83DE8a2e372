...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4667E63773A449b0a5294497644B60052e930b54; // owner address
...
contract DOLLARDOGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOLLAR DOGE INU";
    string private _symbol = "DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4667E63773A449b0a5294497644B60052e930b54); // Marketing Address
    address payable public teamWalletAddress = payable(0x4667E63773A449b0a5294497644B60052e930b54); // Team Address
