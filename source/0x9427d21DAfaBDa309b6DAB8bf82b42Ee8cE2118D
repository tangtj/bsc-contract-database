...
contract Ownable is Context {
    ...
    constructor () {
        _owner =   0xa9409F9723b3E78142670e6288c8005ccDbd9C83;
...
contract HarryPotterBogdanoffChadWojak999Inu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 120000000000 * 10**9;
    ...
    string private constant _symbol = "HPBCW999I"; //    
    uint8 private constant _decimals = 10; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    uint256 public _reflectionFee = 2;
    address payable public  _marketingWallet = payable(  0xa9409F9723b3E78142670e6288c8005ccDbd9C83 );
