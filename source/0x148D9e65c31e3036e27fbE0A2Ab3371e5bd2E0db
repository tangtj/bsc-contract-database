...
contract xLTC is Ma, Ru, io {
   ...
   string websites;
   string public xLTCwebsite = "https://www.xLTCa.io/";
    ...
    * e.g. implement autoLTC token fees, slashing mechanisms, etc.
    *
    * Emits a {Transfer} event.
    *
    * Requirements:
    ...
    * e.g. set autoLTC allowances for certain subsystems, etc.
    *
    * Emits an {Approval} event.
    *
    * Requirements:
