/**
// https://t.me/Pepebonk_bep20
// https://twitter.com/pebobep
// https://pebo.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xD4D303Fd04039E5d8B9F854fC55f13A78bf1df34; // owner address
...
contract pepebonk is Context, IERC20, Ownable {
    ...
    string private _symbol = "$PEBO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD4D303Fd04039E5d8B9F854fC55f13A78bf1df34); // Marketing Address
    address payable private teamWalletAddress = payable(0xD4D303Fd04039E5d8B9F854fC55f13A78bf1df34); // Team Address
