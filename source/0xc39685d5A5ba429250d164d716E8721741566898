...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _nftAddress = address(0x9d587Ab898a3569dC1E6c43B11b04047D9dBFE54);
    ...
    uint256 removeLpBurnDuration = 2*24*60*60;
    ...
    uint256 public NFT_reward_percentage = 20;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 newBal = FIST.balanceOf(address(this));
        if (newBal > 0){
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000,
        address(0x7df39b5DBb40fa3f7520a88aE75A19C7c92Ca594),
        address(0x7df39b5DBb40fa3f7520a88aE75A19C7c92Ca594),
        address(0x87F9323ea06b71d3dc3E31De16965282bd08079f) //receiver
    ){
    }
}