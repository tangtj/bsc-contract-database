...
contract BinanceNova is Context, IERC20, Ownable {
    ...
    string private _name = "Stemx Coin";
    string private _symbol = "STM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x963437aa9D2517d5bD02A5933365a0eFf05652FF);
    address payable public liqWalletAddress = payable(0x963437aa9D2517d5bD02A5933365a0eFf05652FF);
