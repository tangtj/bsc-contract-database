...
contract Neorium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neorium";
    string private _symbol = "NEO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2Dd6F598A0613acD2f48be0b07Ed7335568D5D6e); // Marketing Address
    address payable public teamWalletAddress = payable(0x79eb0A3de48b5936cBD733dC163f35EB0F11aE61); // Team Address
