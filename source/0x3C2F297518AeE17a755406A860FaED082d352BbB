...
contract POKECOINTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ejjsha23;
    ...
    string private _tokenname = "Poke Coin";
    string private _tokensymbol = "POKECOIN";
