/**
   OpenPay is a decentralized payment solution   
   that redefines transactions with its on 
   blockchain and native currency.
  TELEGRAM: https://t.me/OpenPayToken
*/
...
contract OpenPay is Context, IBEP2022, Ownable {
