...
contract Aive is Context, IERC20, IERC20Metadata, Ownable{
    ...
    address public marketAddress = 0x940792cDa9700116861daE2Cc554A90a6a8Fd422;
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "AIV: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "AIV: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "AIV: transfer from the zero address");
        require(recipient != address(0), "AIV: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "AIV: transfer amount exceeds balance");
        uint _amount = amount;
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "AIV: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "AIV: burn amount exceeds balance");
        unchecked {
