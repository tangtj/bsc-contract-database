...
contract TaxableBEP20 is IBEP20 {
    string public constant name = "saadtoken";
    string public constant symbol = "saadtoken";
    ...
    uint256 public taxRate = 10; // transfers
    uint256 public buyTaxRate = 10; // buys
    uint256 public sellTaxRate = 10; // sells
