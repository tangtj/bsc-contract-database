...
contract BFCToken is ERC20, ReentrancyGuard, Ownable {
    ...
    bool public mark;
    uint256 public numTokensSellToSwap = 100 ether;

    address public fundAddress =
        address(0x397f51d7f2B78182a39126a9e11793C8A5B6e02a); 
    address public mintAddress =
        address(0x38af2780B2176E5696AD16dfb13B6502Ce4B790D); 
    ...
    function _transfer(
        ...
        if (balance >= numTokensSellToSwap) {
            if (
                !swapping &&
