...
contract DAVE  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA6Bf10f1A7B6165686e1CC7B933C78085578ba8F); 
    address payable public Wallet_Dev = payable( 0xA6Bf10f1A7B6165686e1CC7B933C78085578ba8F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 420060* 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Dave Inu"; 
    ...
    constructor () {
        _owner = 0xA6Bf10f1A7B6165686e1CC7B933C78085578ba8F ;
