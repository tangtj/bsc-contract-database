...
/**
Telegram: https://t.me/DorkLordTokenbsc
...
contract DORKLORD is ERC20, Ownable {
    ...
    address private  marketingWallet = 0xe2a8285f1726722EBA10D148dD0FF4f173C90038;
    ...
    constructor() ERC20(unicode"ᗪOᖇK ᒪOᖇᗪ", "DORKL") {
