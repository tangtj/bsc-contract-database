...
contract addLiquidityLP {
    address payable public feeRecipient = 0xE74A1c5d175D33F4951cDECF8Ad4Fd208436Fa7f;
    uint256 public feeAmount = 0.001 ether;  // 0.03 BNB fee, using the ether unit for simplicity in Solidity.
