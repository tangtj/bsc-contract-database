...
// File: contracts/Archive/Arrakis Citadel1155.sol
...
contract ArrakisCitadel1155 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    string public name = "VelhallaArrakisCitadel";
    string public constant symbol = "ArrakisCitadel";
