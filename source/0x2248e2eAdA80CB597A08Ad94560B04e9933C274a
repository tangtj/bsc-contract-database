...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #BullishFLOKI to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ApeHunter   1000X? 
   ...
   it's the best part of the #BullishFLOKI  idea, increasing the liquidity pool automatically, 
...
contract BullishFLOKI  is Context, IERC20, Ownable {
