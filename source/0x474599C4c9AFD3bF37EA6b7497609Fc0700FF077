/*
rADAr - ADA Rewards and More!

Website: https://www.radartoken.finance
...
contract rADAr is IERC20, Ownable {
    ...
    string constant _name = "rADAr";
    string constant _symbol = "RADAR";
