...
contract BOPXT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabypepeOBAMAPETERGRIFFINXINU";
    string private _symbol = "BOH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xebD3d3041b4AbE6eCcF83A88A474D73f2dEcC16d); // Marketing Address
    address payable public teamWalletAddress = payable(0xebD3d3041b4AbE6eCcF83A88A474D73f2dEcC16d); // Team Address
