...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd7C8AcEff65590C28CF4571c4A3d4b5Cb7f443c8;
...
contract mehyar is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE11D7DA569e67B9a36263127908E41006ef7AC84;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "mehyar1";
    string private _symbol = "mhrr";
