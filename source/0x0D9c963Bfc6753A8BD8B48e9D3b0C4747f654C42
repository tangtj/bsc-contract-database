...
contract ERC721NFT is Ownable, ERC721A, ReentrancyGuard {
    ...
    function _mint(uint256 quantity, address _to) external onlyOwner {
        _safeMint(_to, quantity);
    }

    function mint(uint256 quantity, address[] memory _to) external onlyOwner {      
