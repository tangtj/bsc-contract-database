...
contract SnoopyPepe is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "SnoopyPepe";
    string private _symbol = "SPY";
    uint256 private _initSupply = 200000000*10**18;
    
    uint256 public dexTaxFee = 800; //take fee while sell token to dex
    ...
    constructor() {
        ...
        IPancakeRouter _router = IPancakeRouter(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
