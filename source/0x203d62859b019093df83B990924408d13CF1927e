...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3705337440b9D3c301B8A29E650b6b284CA33814; // owner address
...
contract PEPECHAIN is Context, IERC20, Ownable {
    ...
    string private _symbol = "Pepe Chain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3705337440b9D3c301B8A29E650b6b284CA33814); 
    address payable public teamWalletAddress = payable(0x3705337440b9D3c301B8A29E650b6b284CA33814);
