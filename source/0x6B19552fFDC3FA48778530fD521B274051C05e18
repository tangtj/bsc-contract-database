...
contract RadioLife is Context, IERC20, Ownable {
    ...
    string private constant _name = "RadioLife";
    string private constant _symbol = "RDL";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xEC54c0635D302249c797e820B6dD733B711F852e);
    address payable private _marketingAddress = payable(0xCB3617D025123B000A6993DB831B42A680296776);
