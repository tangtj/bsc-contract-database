...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xcDa52f3846CBa7bcF45C89C3536FcEE61fD76Abc; 
...
contract PEPE300 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE 300";
    string private _symbol = "PEPE300";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcDa52f3846CBa7bcF45C89C3536FcEE61fD76Abc);
    address payable public teamWalletAddress = payable(0xcDa52f3846CBa7bcF45C89C3536FcEE61fD76Abc); 
