...
contract FOMOCAKE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FOMOCAKE";
    string constant _symbol = "$FOMOCAKE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8C2c21E5620c83fcFC1F6D28c262c59319D29Bb0;
