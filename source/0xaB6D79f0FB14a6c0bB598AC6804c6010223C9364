...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE03D1E259bbE9202fACed127BC0f3C4dfAc9Db55; // owner address
...
contract  KONNI is Context, IERC20, Ownable {
    ...
    string private _name = "KONNI";
    string private _symbol = "KONNI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCd960E54fD87fe986FdE782EE1d66610106BC326); 
    address payable public teamWalletAddress = payable(0xA013199230D0d7c8AcC5821F383c07A50F22E570);
