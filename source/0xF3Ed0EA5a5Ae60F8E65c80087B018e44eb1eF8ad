...
contract Shiba1996 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba 1996"; // 
    string private constant _symbol = "SB96"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xa2907f922c925Bdd2fED28fAb9E09FfFa3610A88;
