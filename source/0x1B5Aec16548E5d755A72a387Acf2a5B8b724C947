...
contract Web3Finance is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress =
        payable(0x3c95Ce2895ad3c3Cac24f5b6363bf1216Ee32Ff0); // Marketing Wallet Address
    address payable public teamWalletAddress =
        payable(0xA263D092DcAD4B40BDE7A599E0334b0345dD3694); // team Wallet Address
    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;
    address private Web3FinanceDeployer = 0x499284c6a1F308f08c67b5ef69D47eD7c4DDFa1c;
    ...
    string private constant _name = "Web3 Finance";
    ...
    constructor() {
        require(msg.sender == Web3FinanceDeployer, "Your not the deployer of this contract");
