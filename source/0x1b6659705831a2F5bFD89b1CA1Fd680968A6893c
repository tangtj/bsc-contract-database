        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x0498d020D73De980b560A4b514B37a7Dde13C93d), block.timestamp
                );
            }
        }
    }
...
contract COINTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xb3E7B19f5ef718240ee745863901edBB39477EeB),//FundAddress
        address(0x0498d020D73De980b560A4b514B37a7Dde13C93d)//ReceiveAddress
    ){
    }
}