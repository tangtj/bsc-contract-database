...
contract no is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x6a7612E0cB448869192a8e11CAe54Cf7E21ec00B);
    address payable private _twdmkt = payable(0x6a7612E0cB448869192a8e11CAe54Cf7E21ec00B);
    
    string private constant _name = "no no ";
