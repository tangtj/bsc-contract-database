...
contract LittleRabbitRobot   is Context, IERC20, Ownable {
    ...
    string private _name = "LittleRabbitRobot";
    string private _symbol = "LRR";
    ...
    function recoverBNB() external onlyOwner() { address payable wallet = 0x558Ca95E7a66e17a15123fFe7c8346C2894b89FE;
