        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x3da569808Eff93010EFF995Fa64E4180622ca6C4), block.timestamp
                );
            }
        }
    }
...
contract ZGLDao is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        2000,//Supply
        address(0xb522D803ABF70403c21915009eEE387A713b5C02),//FundAddress
        address(0x3da569808Eff93010EFF995Fa64E4180622ca6C4)//ReceiveAddress
    ){
    }
}