...
contract USDTDaily {
	...
	uint private constant REF = 50;
	uint private constant FEE = 80;
	uint private constant DAILY = 30;
	uint private constant NFTBONUS = 10;
	uint private constant MINIMUM = 10 ether;
	...
	uint private constant launch = 1689868800;
	...
	function deposit(uint amount, address ref) public contractOpen {
		require(amount >= MINIMUM, "minimum deposit is 10 usdt !");
