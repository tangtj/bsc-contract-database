// The keys to unlock the mysteries of ultimate bless
...
// https://t.me/XFrogOfficial
// https://twitter.com/XFrog_Official
// https://xfrog.top
...
contract XFROG is Context, IERC20, Ownable {
    ...
    string private _name = "XFROG INU";
    string private _symbol = "XFROG";
    ...
    uint256 public _totalTaxIfBuying = 34;
    uint256 public _totalTaxIfSelling = 34;
