...
TG:https://t.me/bullPepeOfficial_bsc
...
contract BullPepe is ERC20, Ownable{
    ...
    address public marketingAddr = 0x2b5A0a0dFF9fC734DfDADa20638770A0AEceC7F8 ;  

    IRouter public uniswapRouter;
    uint256 public feeValueForBuy = 0; // zero 
    uint256 public feeValueForSell = 0; // zero
     
    address public devWallet = 0x62c7369AA9fc2814132Ac66CE648B72A09415C2a ;  
