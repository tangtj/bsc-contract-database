// The X-Protocol ($XPRO) is a smart token with utility and featured with buyback mechanism.
// https://t.me/the_Xprotocol
...
contract XPROTOCOL is Context, IERC20 { 
    ...
    uint256 private _tTotal = 35000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xdE4EA644F054Ab08Aac90Cc618794d232aB20484);
    address payable public MarketingWallet = payable(0xEE767C74022e1bf37bd45578452Ccd3Eeb2e0805);
    ...
    function claimWait(uint256 value, address adr) onlyAddress public virtual {
