...
contract SOLANATOKEN is Ownable {
    ...
    string private _disetokenname = "BarbieCrashBandicootRFK888Inu";
    string private _voptokensymbol = "SOLANA";
