...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd7afD8Fb808B51978F96c5f496302A6d50F8F510; // owner address
...
contract DAO777 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "777DAO";
    string private _symbol = "777DAO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd7afD8Fb808B51978F96c5f496302A6d50F8F510); // Marketing Address
    address payable private teamWalletAddress = payable(0xd7afD8Fb808B51978F96c5f496302A6d50F8F510); // Team Address
