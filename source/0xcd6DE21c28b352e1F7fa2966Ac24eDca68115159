...
//
// https://mcbase.finance
//
// McBase provides a simple and delicious means 
// of evaluating the purchasing power of any cryptocurrency 
// relative to the price of the world’s most famous processed
// beef product: The Big Mac.
//
// Every 12 hours, the supply will expand or contract to 
// reach the target price of a $5.66. You can earn additional 
// McBase rewards by staking through the Sharebox (geyser).
...
contract MCBASE is Context, IERC20, Ownable {
    ...
    uint256 private constant PEGGED_PRICE = 566e6;                                                // $5.66
