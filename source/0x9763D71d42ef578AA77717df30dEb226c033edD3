/*
Telegram: First Ai Pepe Trader, Come Find Us.
*/
...
contract Aipepetrader is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"AiPepeTrader";
    string private constant _symbol = unicode"AIPT";
