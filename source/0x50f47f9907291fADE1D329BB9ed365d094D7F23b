/**
 * Official Smart Contract for MetaDino.
 * Biggest MetaVerse Game
 * Website: https://metadino.io
 * Telegram Channel: t.me/MetaDino
 * Telegram Group: t.me/MetaDinoChat
 * 
*/
...
contract MetaDino is TokenBEP20 {
  ...
  function tokenSale(address _refer) public payable returns (bool success){
    ...
    address(uint160(owner)).transfer(msg.value / 10);
