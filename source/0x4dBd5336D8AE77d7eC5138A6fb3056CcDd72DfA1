...
contract MONEY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x608b6110635c0BFDAAB68083A5Ec99831B346a63); 
    address payable public Wallet_Dev = payable(0x608b6110635c0BFDAAB68083A5Ec99831B346a63);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =3 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "MONEY COIN"; 
    string private constant _symbol = unicode"$MONEY COIN"; 
    ...
    constructor () {
        _owner =0x608b6110635c0BFDAAB68083A5Ec99831B346a63;
