...
contract AQa is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "AQa";
    string private _symbol = unicode"AQa";
    ...
    address public teamAddress = address(0xC80d2B868768d7a4194Eae4885E5D51Afce0cD60);
