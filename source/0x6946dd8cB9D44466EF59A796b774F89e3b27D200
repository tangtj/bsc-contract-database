// Telegram: https://t.me/oneswapbsc
// Twitter : https://twitter.com/oneswap_bsc
...
contract OneSwap is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xD4Ba2CDCc6d2eD58b9289b87491541c9ac592B35);

    string public _name = "One Swap";
    string public _symbol = "ONESWAP";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 4500000000 * 10 **_decimals;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 2;
     
    uint256 private fee_total = 10;
