...
contract PFFFTTTCHH is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x65dF11eDAd9535D13C03a65FfccBaeBD5aC60d30;

    string private constant _name = "PFFFTTTCHH";
    ...
    // Owner cannot transfer out  PFFFTTTCHH from this smart contract
