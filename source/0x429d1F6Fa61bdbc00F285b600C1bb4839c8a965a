...
contract BOOMM is IERC20, Ownable {
  ...
  /* rOwned = ratio of tokens owned relative to [[circulating]] supply */
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x9dc89169993991eB171162c383ad8F1E5d85f7bC;
        devFeeReceiver = 0x9dc89169993991eB171162c383ad8F1E5d85f7bC;
        marketingFeeReceiver = 0xa26d7085CF9d7B54569EbFDbaA86C673f3125738;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=99,"Cannot set buy fees above 10%"); // Max Buy Fee possible to set
        require(totalFeeSell <=99,"Cannot set sell fees above 20%"); // Max Fee Sell possible to set
