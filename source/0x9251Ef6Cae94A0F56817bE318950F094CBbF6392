...
// Telegram:   https://t.me/ZuckvMuskBEP
...
contract ZuckVMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZuckvMusk";
    string private constant _symbol = "ZUCKVMUSK";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xE25BA68C7F176393DF132C8C86940df885D5E65F);
    address payable private _marketingAddress = payable(0xA33983a760465b9D685733cA04588b5ba88AA5d5);
