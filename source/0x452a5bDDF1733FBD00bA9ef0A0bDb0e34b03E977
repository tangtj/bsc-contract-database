...
/*
            Bitrium: The Next Level Bitcoin 💹

        "Enhancing Blockchain Usability and Efficiency"

Telegram : https://t.me/BitriumGlobal
Website  : https://www.bitrium-ecosystem.com/
...
contract Bitrium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"Bitrium";
    string private _symbol = unicode"BIM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x9755EdBF15b675136376dce5a533C2Eb449D4DE3);
    ...
    uint256 private _totalSupply = 5 * 10 ** 8 * 10 ** _decimals;
