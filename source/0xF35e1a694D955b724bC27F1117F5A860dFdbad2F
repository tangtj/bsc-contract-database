...
// Telegram: https://t.me/NiteProtocol

// Website: https://niteprotocol.org/

// Twitter: https://twitter.com/NiteProtocol
...
contract NITE is Context, IERC20, Ownable {
    ...
    string private _name = "Nite Protocol";
    string private _symbol = "NITE";
    ...
    uint256 private _totalSupply = 273 * 10**6 * 1**1 * 10**_decimals;
    uint256 public _walletMax = 819 * 10**4 * 1**1 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 273 * 10**3 * 1**1 * 10**_decimals;
