...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0c07a9bce753B7d62CA533C6cC1d15fFc728a19F;
...
contract Arkhamoon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x93ba5B7a81512d577E5a4Cf6c8ab92eF353a6090;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Arkham Moon";
    string private _symbol = "ARKHM";
