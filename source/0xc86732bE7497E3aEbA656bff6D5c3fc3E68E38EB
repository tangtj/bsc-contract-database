...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89bC334ABA3096d3A5E8FA09d7B8746C49021e0d; // owner address
...
contract XWHALES is Context, IERC20, Ownable {
    ...
    string private _name = "XWhales";
    string private _symbol = "XWhales";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89bC334ABA3096d3A5E8FA09d7B8746C49021e0d); 
    address payable public teamWalletAddress = payable(0x89bC334ABA3096d3A5E8FA09d7B8746C49021e0d);
