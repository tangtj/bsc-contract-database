...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0xd6CE266a2573D752e4318dAfFA4Aa36A862bA4F6;
...
contract Token2047 is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("2047", "$2047", 9) {
    _owner = msg.sender;
