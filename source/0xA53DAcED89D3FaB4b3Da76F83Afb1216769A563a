/**
TrustPoW is Layer-1 Blockchain with the latest Proof-of-Work consensus mechanism that implements a privacy-enabled, 
low gas fee, highly secure network, around 500TPS, and support EVM. We will implement ETHash and ETHMiner as our mining script.


Telegram https://t.me/TrustPowGlobal
**/
...
contract TrustPoW is Context, IBEP20, Ownable {
    ...
    address public marketingAddress = 0x6A8A8efB57c6206135e432008abd596Ba75bf7cD;
    address public devAddress = 0x4BE4E23881B724C3062280562915e6678039ed81;

    string private constant _name = "TrustPoW Blockchain";
    string private constant _symbol = "$TPOW";
    ...
    Taxes public buytaxes = Taxes(0,15,5,0);
    ...
    function setBuyTaxes(uint256 _rfi, uint256 _marketing, uint256 _dev, uint256 _liquidity) public onlyOwner {
        buytaxes.rfi = _rfi;
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out to Fake/Wrong Token!");
