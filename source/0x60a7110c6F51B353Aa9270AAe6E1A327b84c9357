...
contract HZYYHCOIN is IBEP20 {
    string private _name = "HZYYH COIN";
    string private _symbol = "YYH";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 2023092317 * 10**uint256(_decimals);
    address private _owner;
    address private _marketingWallet = 0x11CcE2f18495E1F8e6340c1d1565602e8b5799E5;
