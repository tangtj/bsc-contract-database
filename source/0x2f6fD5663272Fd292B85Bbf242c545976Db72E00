...
contract MOMOCOIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd2c8a2d566d3dAaC7578e1017619714296a5036A); 
    address payable public Wallet_Dev = payable(0xd2c8a2d566d3dAaC7578e1017619714296a5036A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "MOMO COIN"; 
    ...
    constructor () {
        _owner =0xd2c8a2d566d3dAaC7578e1017619714296a5036A;
