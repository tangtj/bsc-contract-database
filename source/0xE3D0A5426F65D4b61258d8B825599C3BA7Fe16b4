...
abstract contract XYYToken is IERC20, Ownable {
...
contract TOKEN is XYYToken {
    constructor() XYYToken(
        ...
        9,//Decimals
        5555,//Supply
        address(0xa497737d8Ce77FBa4B23C13b31699eC2f37e7e92),//FundAddress
        address(0xa497737d8Ce77FBa4B23C13b31699eC2f37e7e92)//ReceiveAddress
    ){
    }
}