...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_buyFundFee + _sellFundFee) * 5 / swapFee;
        uint firstfundamount = fundAmount / 5;
        uint secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0x651814D3A7707DC9FC67026B67b7a38b3D05B69e;
...
contract HFHToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x2132396aBaF1aF8dcF427aC1D437e2cC7d54ADAE),
    
        address(0x0Cb0aa81b7e9703F2F083FE68CAF6B193Ad3e120)
    ){
