...
contract HAPICAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5e88c8fA129C4995e2B7a838d85D5007af5c63Bc); 
    address payable public Wallet_Dev = payable(0x5e88c8fA129C4995e2B7a838d85D5007af5c63Bc);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "HAPICAT"; 
    ...
    constructor () {
        _owner = 0x4B44D0d582dAA5D44d9e0F1aC0e6d63Ae6De9a9A;
