...
contract POWTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public fkkmcn51;
    ...
    string private _tokenname = "Pepe Of Wallstreet";
    string private _tokensymbol = "POW";
