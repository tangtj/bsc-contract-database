/**
The newest token, $XSONIC, will send all holders to t
he moon, where they rightfully belong. With genuine utility, 
community, and meme power. XSONIC is prepared to compete our way to the top of Binance Smart Chain's charts!
...
contract XSONIC is Context, IERC20, Ownable {
    ...
    string private constant _name = "X SONIC"; // 
    string private constant _symbol = "XSONIC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x140372Eba31b08Bc112D1bDfc8A633a0baae479E;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x63baced523660795016669B458c491c5BA1AB0D2;
