...
https://t.me/EmoticoinBSC : Join The Community
...
With a total of 168 captivating supply cuts, EmotiCoin is changing the game.
*/
...
contract Emoticoin is ERC20Detailed, Ownable {
    ...
    uint256 private partsSwapThreshold = (TOTAL_PARTS / 10000000 * 25);
    ...
    constructor() ERC20Detailed(block.chainid==56 ? "EmotiCoin" : "ETEST", block.chainid==56 ? "Emoti" : "ETEST", DECIMALS) {
        address dexAddress;
        if(block.chainid == 1){
        ...
        _1_x = "x.com/EmoticoinBSC";
        _2_telegram = "t.me/EmoticoinBSC";
