...
📄 | Contract: At Launch
⚠️ | No Team Tokens 
🛡 | Renounce Contract on launch 
🎯 | Trending in 3K MCap

TOKENOMIC
🏦 | Supply 39.000.000.000
💸 | Tax 4% buy / 6% sell
📈 | Max 4% / 1.560.000.000

TG: https://t.me/AetheriumBinance
**/
...
contract AETHERIUMBINANCE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "AETHERIUM BINANCE";
    string private constant _symbol = unicode"$AETH";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 39000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x687A133FcF3Aba1ee3BCdB6D108df7000A881095);
    address payable public MarketingWallet = payable(0x2D7b6bD3920Accd75488EaCC5064342DaC12Da63);
