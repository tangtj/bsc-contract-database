...
contract BaseToken is Ownable {
    ...
    string constant public name = 'CandyClub';

    string constant public symbol = 'Club';
    ...
    uint256 private _taxfiie = 0;
    uint256 private _burnfiie = 2;
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 FIE =  value.muli(_taxfiie).div(100);
        uint256 burn =  value.muli(_burnfiie).div(100);
