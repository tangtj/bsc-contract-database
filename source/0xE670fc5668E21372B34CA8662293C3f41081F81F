...
contract Wallstreetshiba is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xDBEE68F851dD7bf83646cF33Bfb904a19E9A9373;

    string private constant _name = "WALL STREET SHIBA";
    string private constant _symbol = "$WSS";
