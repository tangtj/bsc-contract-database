...
contract PEPECOIN  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeF5d434A0643ddD6785C1877941671e3c7667A7c); 
    address payable public Wallet_Dev = payable(0xeF5d434A0643ddD6785C1877941671e3c7667A7c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 32000* 10**3* 10**3 * 10**_decimals;
    ...
    constructor () {
        _owner = 0xeF5d434A0643ddD6785C1877941671e3c7667A7c ;
