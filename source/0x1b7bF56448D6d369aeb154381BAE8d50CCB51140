...
// File: contracts/ChickenKebab.sol
...
// ChickenKebab with Governance.
contract Lemon is ERC20("LemonSwap", "LEMON"), Ownable {
...
creation of Lemon pending...
    ...
    */
    ...
    // In some circumstance, we should not burn LEMON on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
