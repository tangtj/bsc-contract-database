...
contract QUANTUMFUEL is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Quantum Fuel";
    string public _symbol= "QFUEL";
     bool balances1 = true;

    address payable public charityAddress = payable(0x5F6852d27730D7f3b1f341F16Ec4c07F66e0d71C); // Marketing Address
