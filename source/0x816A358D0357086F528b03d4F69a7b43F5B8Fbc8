// Telegram : https://t.me/StarGirlBsc
...
contract StarGirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarGirl";
    string private _symbol = "GRats";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x30528c56c9A2Fca7f588d9F3183cbCbBBc6773B4); // Marketing Address
    address payable public teamWalletAddress = payable(0x30528c56c9A2Fca7f588d9F3183cbCbBBc6773B4); // Team Address
