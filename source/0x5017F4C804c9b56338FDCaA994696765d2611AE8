...
contract SASHI2 is ERC20, Ownable {
    ...
    constructor() payable ERC20("Satoshi 2.0", "SASHI 2.0") {
        ...
        treasuryWallet = 0x3953EcF7D936875432339e5ea17CDc40D351bf82;
        treasuryWallet2 = 0xd6b834C2b729D84fB5719915b85b6a7f59B922dc;
        treasuryWallet3 = 0x23C6f526257152E3E70699190cf3c1e85353cFb8;
    ...
    function updateBuyFees(uint256 _treasuryFeeOnBuy, uint256 _rewardsFeeOnBuy) external onlyOwner {
        treasuryFeeOnBuy    = _treasuryFeeOnBuy;
        rewardsFeeOnBuy     = _rewardsFeeOnBuy;

        totalBuyFee = liquidityFeeOnBuy + _treasuryFeeOnBuy + _rewardsFeeOnBuy;
    ...
    function updateSellFees(uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell) external onlyOwner {
        treasuryFeeOnSell    = _treasuryFeeOnSell;
        rewardsFeeOnSell     = _rewardsFeeOnSell;

        totalSellFee = liquidityFeeOnSell + _treasuryFeeOnSell + _rewardsFeeOnSell;
