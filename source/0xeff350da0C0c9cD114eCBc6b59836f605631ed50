...
/**
       ...
       Welcome to ONFIREAPE
   
   This is a community token. If you want to create a telegram I suggest to name it to @ONFIREAPEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ONFIREAPE
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #ONFIREAPE 10000X? 
   ...
   it's the best part of the #ONFIREAPE idea, increasing the liquidity pool automatically, 
...
contract ONFIREAPE is Context, IERC20, Ownable {
    ...
    string private _name = "ONFIREAPE";
    string private _symbol = "OnFire";
