...
//https://t.me/SecretLifeOfPetsBSC
...
contract SECRETLIFEPETS  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe97eD93A7C12cd601a38d32704D0A7710e3a77fc); 
    address payable public Wallet_Dev = payable(0xe97eD93A7C12cd601a38d32704D0A7710e3a77fc);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000000 * 10 ** 9;
    string private constant _name = "SECRETLIFEOFPETS"; 
    string private constant _symbol = unicode"$RABBITS"; 
    ...
    constructor () {
        _owner =0xe97eD93A7C12cd601a38d32704D0A7710e3a77fc;
