...
contract JG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFB12912C82220c7Db1EbCbDB5343126FD2a5BB0E); 
    address payable public Wallet_Dev = payable(0x270a070C93dbC6F28325355Aa5aed79d9590db06);
    ...
    string private constant _name = "Envo"; 
    string private constant _symbol = unicode"Envo"; 
    ...
    constructor () {
        ...
        _owner = 0xb78396a1E459138521bA276657d92A5A8ec05ab0;
