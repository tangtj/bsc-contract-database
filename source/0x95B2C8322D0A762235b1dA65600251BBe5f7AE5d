/*
DORK KISHU | BSC
Dork Kishu Token where holders will earn passive Income in our Token Just by holding! Based on Dork Hypes! 
...
contract DorkKishu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dork Kishu";
    string private constant _symbol = "DorkKU";
