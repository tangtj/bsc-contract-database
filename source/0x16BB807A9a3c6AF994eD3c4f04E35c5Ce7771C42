...
*/
/**
telegram: https://t.me/killerofmeme
*/
...
contract killerofmeme is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "killer of meme ";
    string private _symbol = "john";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xe495E3f7EA5Fd6379c80ce5D4A414a2C9b494160); // Marketing Address
    address payable public teamWalletAddress = payable(0x83b5D06e9578dc91EeeB0E999Ec65029CA826324); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**_decimals;IUniswapV2Router02 public uniswapV2Router;
