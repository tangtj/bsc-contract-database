...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53d7478BcedF62e2863F3C41717f94125A66B718; // owner address
...
contract CCCDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCDS";
    string private _symbol = "CCCDS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x53d7478BcedF62e2863F3C41717f94125A66B718); // Marketing Address
    address payable private teamWalletAddress = payable(0x53d7478BcedF62e2863F3C41717f94125A66B718); // Team Address
