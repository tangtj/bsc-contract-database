...
// https://twitter.com/caturnium
// https://caturnium.space/
...
contract Caturnium is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Caturnium";
    string private constant _symbol = unicode"CATURN";
