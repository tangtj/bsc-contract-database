...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7184eAC82c0C3F6bcdFD1c28A508dC4a18120b1e;
...
contract BTCSHIBA is Context, BEP20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe5Ab8BD351560b5766086ceE001BDD2339b5DeeE;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 9000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BTC SHIBA INU";
    string private _symbol = "BTCSHIBA";
    ...
    uint256 public _maxTxAmount = 9000000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 9000000000000000000 * 10**18;
