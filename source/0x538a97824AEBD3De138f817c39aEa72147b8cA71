...
contract MicroX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Micro X";
    string private _symbol = "MicroX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99F88a0BAE516D0B8E23375599f54ad2eB1b18b8); // Marketing Address
    address payable public teamWalletAddress = payable(0x99F88a0BAE516D0B8E23375599f54ad2eB1b18b8); // Team Address
