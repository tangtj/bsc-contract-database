...
contract MacaronfinanceVvipStaking is ReentrancyGuard, Ownable {
    ...
    uint256 public MIN_REWARD_TIME; //in sec
    ...
    constructor(
        ...
        token = IERC20(_token);
        started = _started;
        MIN_REWARD_AMOUNT = reward_amount;
        MIN_REWARD_TIME = reward_time;
    ...
    function setMinRewardClaimTime(uint256 _sec) external onlyOwner{
        MIN_REWARD_TIME = _sec;
    }
