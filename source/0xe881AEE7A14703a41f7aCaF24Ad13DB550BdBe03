...
contract Presale {
    ...
    constructor(address tokenAddress, address devAddress, address ownerAddress) {
    ...
    payable(_dev).transfer(BNB.mul(20).div(100));
    payable(_owner).transfer(BNB.mul(80).div(100));
    ...
    require(USDT.transferFrom(msg.sender, _dev, _amount.mul(20).div(100)));
    require(USDT.transferFrom(msg.sender, _owner, _amount.mul(80).div(100)));
    ...
    require(block.timestamp > saleEndTime + 604800 seconds, "Unlocking is not allowed yet"); // 604800 seconds = 7 days
