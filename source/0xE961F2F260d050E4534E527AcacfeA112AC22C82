...
contract ELTORO is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 55000000 * 10**9;
    uint256 public genesis_block;
    uint256 private deadline = 1;
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xd95FD33fcf6427358c88A45B4Cb5eFCF590C3eB5;
    address private opsWallet = 0xBf2a74cf5318E46d656374FB07034Ec2e84AC70b;
    address private devWallet = 0xBf2a74cf5318E46d656374FB07034Ec2e84AC70b;

    string private constant _name = "EL TORO";
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0xd95FD33fcf6427358c88A45B4Cb5eFCF590C3eB5] = true;
    ...
    function EnableTrading() external onlyOwner {
        require(!tradingEnabled, "Can't re-enable trading");
        tradingEnabled = true;
        swapEnabled = true;
    ...
    function _transfer(
        ...
        require(from != address(0), "BEP20:Transfer from the dead address");
        require(to != address(0), "BEP20:Transfer to the dead address");
