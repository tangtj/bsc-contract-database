...
contract BEP20GWCT is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        no1Address = address(0x5CdC35d1ad6d1D099CAA31665371a674FA8a9A78);
        no2Address = address(0x05c57CeF12F9617fB8d724Bbd0B9E6943F8c69BB);
        no3Address = address(0x7430f75522A6De776cbBeCaD02c01C8Ded5f888B);
        no4Address = address(0x9Db51CFEfae64a56faa7F94037053ff15cA45c18);
        no5Address = address(0x3C0FD35E71B894C99D8BbeD9Ea574dcC575938Ee);
        no6Address = address(0x97a5B918Ba15cee5eB663Eb225A2391b302bbbB5);
        ...
        _balances[no1Address] = 1000000 * weiToEther;
        _balances[no2Address] = 15000000 * weiToEther;
        _balances[no3Address] = 1000000 * weiToEther;
        _balances[no4Address] = 2000000 * weiToEther;
        _balances[no5Address] = 1000000 * weiToEther;
        _balances[no6Address] = 1000000 * weiToEther;

        emit Transfer(address(0), no1Address, 1000000 * weiToEther);
        emit Transfer(address(0), no2Address, 15000000 * weiToEther);
        emit Transfer(address(0), no3Address, 1000000 * weiToEther);
        emit Transfer(address(0), no4Address, 2000000 * weiToEther);
        emit Transfer(address(0), no5Address, 1000000 * weiToEther);
        emit Transfer(address(0), no6Address, 1000000 * weiToEther);
    }
