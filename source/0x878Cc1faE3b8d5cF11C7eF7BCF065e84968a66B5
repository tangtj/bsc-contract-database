...
abstract contract Ownable {
    ...
    function symbol() external pure override returns (string memory){return "FLASH 2.0";}
    function name() external pure override returns (string memory){return "Flash 2.0";}
