...
contract Pyro is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PYRO";
    string private _symbol = unicode"$PYRO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xEaBdb7cE74FD303F175ed38221E47d11126B3DB0);
    address payable private taxWallet2 = payable(0xEaBdb7cE74FD303F175ed38221E47d11126B3DB0);
    ...
    uint256 public _walletMax = _totalSupply*10000/100000;
