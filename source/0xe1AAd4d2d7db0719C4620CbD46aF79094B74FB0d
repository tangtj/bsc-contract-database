/**
// https://t.me/DorkQueenBSC
// https://twitter.com/Dqueen
// https://Dorkqueen.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb64A045D345C3Aa4241CB2761193ffAb0F12a92; // owner address
...
contract DorkQueenBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dork Queen";
    string private _symbol = "$DORKQUEEN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfb64A045D345C3Aa4241CB2761193ffAb0F12a92); // Marketing Address
    address payable private teamWalletAddress = payable(0xfb64A045D345C3Aa4241CB2761193ffAb0F12a92); // Team Address
