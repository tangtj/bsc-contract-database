...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06448c603E6a7B1700b35E795154d68EDED64A8a; 
...
contract CHESSCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chess Coin";
    string private _symbol = "$CHESS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06448c603E6a7B1700b35E795154d68EDED64A8a); 
    address payable public teamWalletAddress = payable(0x06448c603E6a7B1700b35E795154d68EDED64A8a); 
