...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51530eDe038fF742d35329241A081E4E5437b2f9; // owner address
...
contract CaliciumInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Calcium Inu";
    string private _symbol = "$CALI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5cCA0A294De26b914acFD999B5A2929dDd321834); // Marketing Address
    address payable private teamWalletAddress = payable(0x51530eDe038fF742d35329241A081E4E5437b2f9); // Team Address
