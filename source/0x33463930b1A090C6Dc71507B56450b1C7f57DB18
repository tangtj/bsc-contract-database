...
//https://t.me/bnbbot_pro
//https://twitter.com/probnbbot
interface IERC20 {
...
contract BnbBot is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02FCd29b414d57979BEb8096F619D57bE9453a0c); 
    address payable public Wallet_Dev = payable(0x02FCd29b414d57979BEb8096F619D57bE9453a0c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =490000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "BNBBOT COIN"; 
    string private constant _symbol = unicode"BNBBOT"; 
    ...
    constructor () {
        _owner =0x02FCd29b414d57979BEb8096F619D57bE9453a0c;
