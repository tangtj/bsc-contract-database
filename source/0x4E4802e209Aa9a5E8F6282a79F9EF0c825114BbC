...
// Telegram : https://t.me/dPARROTBSC     
 
// Twitter :  https://twitter.com/dPARROTBSC
...
contract dPARROT is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "dPARROT";
    string private _symbol = "PARROT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe703246f8f3d4bEf677d1c95B7D9e5e0610C43Fd); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe703246f8f3d4bEf677d1c95B7D9e5e0610C43Fd); // BuyBack Address
