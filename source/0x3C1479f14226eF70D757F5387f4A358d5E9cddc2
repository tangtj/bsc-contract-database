...
abstract contract ABSToken is IERC20,Ownable
{
    ...
    function setFee(uint256 fundFee,uint256 partnerFee,uint256 kTokenFee,uint256 burnFee,uint256 liquidityFee) external  onlyOwner
    {        
        _fundFee=fundFee;
        _partnerFee=partnerFee;
        _keepTokenFee=kTokenFee;
        _destoryFee=burnFee;
        _liqiudityFee=liquidityFee;
    ...
    function addBreaker(address addr) external  onlyOwner
    {
     ...
     function isBreaker(address addr) external  view  returns(bool)
    {      
        return  _breakerList[addr]==true;        
    }    
    ...
    function setAutoAddLiquidityMinTokenLimitNum(uint256 value)external  onlyOwner
    {
...
{    
    address[]  private  partnersList=
        [                      
            ...
            0x70a1B5aAE2bfB22E40Fe2FDa0eeFd9b788353EB0
        ];         
    ...
    address[] private whiteList=
        [
            0x63fF93bf25f95EC5e7924cBfE92b5F5630041E4d  
        ];
    address[] private feeWhiteList=
        [
            ...
            0xe48a166751d9cAE8cD28920a129a143870e69192,
            0x2385834F13fB400029d62cF7FA3E26d793D21dEc,
            0xA550cE49164A0D71596eC72D9915d4024DF620c4 
        ];
    uint256[] shareData=
    [      
        20000,     //min limit num  keep token can be share
        50000      //share usdt min limit cached token num     
    ];
