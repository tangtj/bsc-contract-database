...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4FE1471c9C0f2928CEEF82362334Be55e709940B; // owner address
...
contract  DXT is Context, IERC20, Ownable {
    ...
    string private _name = "DXT";
    string private _symbol = "DXT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6626961900B62B01C46136A3bcFD669E4995E9cB); 
    address payable public teamWalletAddress = payable(0x407D6CDe0c8A1f68145F2e577D55A890e5292eb1);
