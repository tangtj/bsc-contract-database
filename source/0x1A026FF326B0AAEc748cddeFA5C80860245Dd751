...
contract ALVIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alvium Chain";
    string private _symbol = "$ALC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDaD92A899FaA1B61D9E3f4177790025e58d26e67);
    address payable private DevelopmentWalletAddress = payable(0xDaD92A899FaA1B61D9E3f4177790025e58d26e67);
