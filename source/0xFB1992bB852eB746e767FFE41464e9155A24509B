...
Rescue BNB is a token that aims to bring back the old glory of BSC, with high volume and low fees.

Our tokenomics are designed to create a sustainable and rewarding ecosystem for our holders and community. We allocate 65% of the tax to marketing and buyback, ensuring constant exposure and demand for our token. We also burn 10% of the tax, reducing the supply and increasing the scarcity and value of our token. The team receives 10% of the tax as an incentive to keep working hard and delivering quality products and services. Finally, we add 15% of the tax to the liquidity pool, creating a stable and healthy market for our token.

Rescue BNB is a community-driven project that supports the development and adoption of BSC projects. By holding Rescue BNB, you are helping to rescue BSC from the competition and make it the best blockchain for smart contracts and dApps.

https://t.me/RescueBNB
...
contract RescueBNB is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0x985bdFFa95ced90C7B0A960Ba4FF8144fbbBC851);
    address payable public Wallet_Dev = payable(0x2580417Ffc7c08fe4c0d31d0fcAeB228dBa2094a);
    address payable public constant Wallet_Burn =
        payable(0x000000000000000000000000000000000000dEaD);
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10 ** 11 * 10 ** _decimals;
    string private constant _name = "Rescue BNB";
    string private constant _symbol = unicode"RBNB";
