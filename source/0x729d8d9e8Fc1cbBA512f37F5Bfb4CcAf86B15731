...
contract X_Protocol is Context, IERC20, Ownable {
    ...
    address payable public _devAddr = payable(0x89097b31A875F489B1Bd409FeD715aeD6694F480);
    address payable public _marketingAddr = payable(0xd8Cc5CEc4332E667F1046AbaDdAB96d16C19087d);
