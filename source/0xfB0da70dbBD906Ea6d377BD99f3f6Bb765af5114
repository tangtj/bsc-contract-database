...
contract ShibKing is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x146b9be4A9661B8676380809a2D5cE1861ab25b6); 
    address payable private teamWalletAddress = payable(0x146b9be4A9661B8676380809a2D5cE1861ab25b6); 
