...
contract XCH is ERC20, Ownable {
    ...
    uint256 private supply = 420690000000 * 1e9;

    uint256 public rewardSell = 15;
    uint256 public rewardBuy = 3;
    mapping(address => bool) public isExcludedFromFee;
    mapping(address => bool) public whitelistBuySell;
    bool private tradingActive = false;

    constructor() ERC20("X Chihuahua", "XCH") {
    ...
    function changeReward() external onlyOwner {
        rewardSell = 3;
    }
    ...
    function _transfer(
        ...
        require(isNotLockBuySell(from), "XCG: Lock");
