...
contract SigmaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sigma Network";
    string private _symbol = "SIGMA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0994B1C01BDadaF670607Dad8B66A3c849B91101); // Marketing Address
    address payable public teamWalletAddress = payable(0x36aaC19B1253480A19F8f6DC704c3Bc396D33738); // Team Address
