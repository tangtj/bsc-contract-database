...
contract DOGEMONEY is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x410abc5381a9Cc8bAE24048C0a2d281660B0f068);
    address payable private _marketingAddress = payable(0x42b659602e8AD2E78B0d85567c818cC1b44b2593);
