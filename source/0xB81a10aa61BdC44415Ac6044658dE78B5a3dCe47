        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xc4B79f476cf62a54096301547BF13dCde699D0Da), block.timestamp
                );
            }
        }
    }
...
contract DB is AbsToken {
    constructor() AbsToken(
        ...
        address(0x1476f1b2584dB6fbB03e4B6f9821B1078031A038)//ReceiveAddress
    ){
    }
}