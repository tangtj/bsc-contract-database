...
Take note
* You can’t buy more than 0.50% of the total supply in a single transaction.
* You can’t sell more than 0.50% of the total supply in a single transaction.

Staking
* Award ← awarded shitcoins.
* Amount ← 2%. 1% bonus if you own the common NFT.
* 69 days ← length of stake. 50% time reduction if you are the proud owner of the “Diamond Hand” Nft.
* Early withdrawal ← staking award forfeited and sent back to award pool.
