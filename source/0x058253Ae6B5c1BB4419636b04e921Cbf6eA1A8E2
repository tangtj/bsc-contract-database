...
// Telegram https://t.me/gems_hunters_chat
...
contract One is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x65d2049F5dF54A21290248E21fE0CB8Fda3E7DD2); 
    ...
    uint256 private _marketingShare = 9;
    ...
    uint256 public _maxTransactionAmount =   100000000000000000000000000000; 
    uint256 public minimumTokensBeforeSwap = 100000000000000000; 
    uint256 public _walletMax = 100000000000000000000000000000;
