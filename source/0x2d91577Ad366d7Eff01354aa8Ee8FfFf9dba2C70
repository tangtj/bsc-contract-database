...
// File contracts/BatchTokenTransfer.sol
...
contract BatchTokenTransfer is Ownable {
    ...
    function batchTransfer(IERC20 token, address[] memory recipients, uint256[] memory amounts) public onlyOwner {
    ...
    function withdrawExcessTokens(IERC20 token) public onlyOwner {
