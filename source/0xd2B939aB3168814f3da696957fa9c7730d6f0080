/**
https://t.me/HPOP8inuofficialbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b88fe2c021c4D2acc2ab7C9c35dFC3d4aC5a524; // owner address
...
contract HarryPotterObamaPacMan8Inu is Context, IERC20, Ownable {
    ...
    string private _name = "HarryPotterObamaPacMan8Inu";
    string private _symbol = "$HPOP8inu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE651bb537d9F296948aBc52e0d28d5190518C286); // Marketing Address
    address payable private teamWalletAddress = payable(0x7b88fe2c021c4D2acc2ab7C9c35dFC3d4aC5a524); // Team Address
