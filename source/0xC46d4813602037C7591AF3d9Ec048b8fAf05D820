...
contract PEPEDORKLORD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE DORK LORD ";
    ...
    address payable public teamWalletAddress = payable(0x56b7069d0d9FC6DA1EF8A77f72B4a8dE74f5d4F6);
