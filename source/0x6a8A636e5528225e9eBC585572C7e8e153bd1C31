...
contract DoggieInu is IBEP20, Auth {
    ...
    string constant _name = "DoggieInu";
    string constant _symbol = "$DOGGIEINU";
    ...
    address private marketingFeeReceiver = 0x94700d0492F269D0cDe1547d4fF97e8acBC54b9D;
    address private developmentFeeReceiver = 0x94700d0492F269D0cDe1547d4fF97e8acBC54b9D;
