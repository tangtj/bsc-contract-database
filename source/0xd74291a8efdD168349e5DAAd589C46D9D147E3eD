/*
First ever platform to integrate AI into Bitcoin Ordinals Wrapped with ETH 
🧬 Generate Bitcoin Ordinals with AI on our Beta DAPP 
🌀 Mint Ordinals 🌀 Team connected to UFO / DAOMaker 🌀 KYC AUDIT DOXX 
🌀 Pinksale SAFU Dev 🌀 0% Buy and Sell Tax 🌀 LP Tokens Locked 
 Contract Renounced After Launch 🔥 Aggressive Marketing 🔥 CMC & CG Fast-Track 
 🚀 The First ever truly AI generated Digital Artifacts on the Bitcoin Network 🌀

https://t.me/btseaofficial
...
contract BTSEAoToken  is Ma, Ru, io {
    ...
    string telegram;
    string public BTSEAowebsite = "https://BTSEAo.io";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        telegram = "https://t.me/BTSEAo";  
        _name = "btsea.xyz";
        _symbol = unicode"BTSEAo";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        return owner();
                ...
                function getBTSEAowebsite() public view returns (string memory) {
        return BTSEAowebsite;
    } 
    /**
    * @dev Returns the token symbol.
    */
