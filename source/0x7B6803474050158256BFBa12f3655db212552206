...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x35bfD6e6e2E158A21CE6c2A8B8314F2A2DEE2f4f);
    address public devAddress = address(0x35bfD6e6e2E158A21CE6c2A8B8314F2A2DEE2f4f);
    string private _name = "XiaoQiang";
