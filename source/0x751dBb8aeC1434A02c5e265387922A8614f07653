...
contract OKXinu is Context, IERC20, Ownable {
    ...
    string private _name = "OKX inu";
    string private _symbol = "OKX inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe36336FA0a5a473b844881eed02704C4be41C360); // Marketing Address
