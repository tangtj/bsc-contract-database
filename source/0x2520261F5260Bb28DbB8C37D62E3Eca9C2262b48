...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCBFdBFf56259144045E1201D0233089DCCA993Ee; // owner address
...
contract APE is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xCBFdBFf56259144045E1201D0233089DCCA993Ee); // Marketing Address
    address payable private teamWalletAddress = payable(0xCBFdBFf56259144045E1201D0233089DCCA993Ee); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 80;  // original 12
    uint256 public _totalTaxIfSelling = 80;  // original 12
