/**
Telegram: https://t.me/MoonBunnyBSC
*/
...
contract MoonBunny is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingWallet = payable(0x8868ED5D5a36D848C962676082aFe591e513b3e1);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x8868ED5D5a36D848C962676082aFe591e513b3e1] = true;
