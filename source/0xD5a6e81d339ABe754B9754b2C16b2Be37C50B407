...
contract Centralium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CENTRALIUM";
    string private _symbol = "$CTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x388f257B9cD6529F986FC7Cd923B3B7A3874688A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xeC648cac0AF19A66A489f5e1DB638555104b8cf7); // BuyBack Address
