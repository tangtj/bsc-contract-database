...
contract NanoPlay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Nano Play";
    string private _symbol = unicode"NANOPLAY";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xB1F811f02b6607c5f5e882D6ddAc48E84c8Db24c);
    address payable private taxWallet2 = payable(0xB1F811f02b6607c5f5e882D6ddAc48E84c8Db24c);
    ...
    uint256 public _walletMax = _totalSupply*200/10000;
