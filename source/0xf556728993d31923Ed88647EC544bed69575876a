...
// File: contracts/YuBox-BinanceTest.sol


pragma solidity ^0.8.0;
contract YuBox is Ownable, ERC1155, Pausable {
    string public name;
    ...
    constructor(string memory url_) ERC1155(url_) {
        name = "XX Capital (TEST)";
        symbol = "YuBOX";
        baseURL = url_;
        minters[_msgSender()] = true;
        _mint(msg.sender, 0, 10**8, "");
    }
    ...
    function boxURL(uint boxID_) public view returns (string memory) {
        ...
        return string(
            //abi.encodePacked(baseURL, boxID_)
            abi.encodePacked(
                baseURL,
                Strings.toString(boxID_),".json"
            )
        );
    }
    ...
    function uri(uint boxID_) override public view returns (string memory) {
        return string(
            abi.encodePacked(
                baseURL,
                Strings.toString(boxID_),".json"
