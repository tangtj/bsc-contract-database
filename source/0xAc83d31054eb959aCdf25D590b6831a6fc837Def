/**
telegram: https://t.me/Layerium2

website: https://Layerium2.live/
...
contract Layerium2 is Context, IERC20, Ownable {
    ...
    string private _name = "Layerium 2.0";
    string private _symbol = "LYUM2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x92a55C67bC2D610B9A9A8aeA4E143Ea619905B56); // Marketing Address
    address payable public teamWalletAddress = payable(0x92a55C67bC2D610B9A9A8aeA4E143Ea619905B56); // Team Address
