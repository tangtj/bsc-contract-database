...
contract Cyber is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x30c7F4E293a715ddEC2F855EfDCeCEAE6E5A591A);
    address payable private _twdmkt = payable(0x30c7F4E293a715ddEC2F855EfDCeCEAE6E5A591A);
