...
https://multisniperbot.com
https://crypto-scammer.com
https://crypto-scammer.io

Twitter:
https://twitter.com/MultisniperB
https://twitter.com/ScanCryptoScam

Telegram:
https://t.me/multisniperbots

Note: this is a snipetest token.
*/
...
contract MSP is BEP20, Auth {
    ...
    string public constant name = "Multisniper";
    string public constant symbol = "MSP";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 10 * 10**2 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 1000;
    uint256 public _maxWalletToken = totalSupply / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x20f5A01C77bBEf1111026faC05EBFF9Fab0880E8;
        marketerFeeReceiver = 0x20f5A01C77bBEf1111026faC05EBFF9Fab0880E8;
        teamFeeReceiver = 0x20f5A01C77bBEf1111026faC05EBFF9Fab0880E8;
        devFeeReceiver = 0x20f5A01C77bBEf1111026faC05EBFF9Fab0880E8;
