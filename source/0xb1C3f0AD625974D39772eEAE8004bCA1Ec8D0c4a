...
contract TenDollarLP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"10$ LP";
    string private _symbol = unicode"10$LP";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC011ec29F5a7226a0B43d32D2D856cEDC6A598d2);
    address payable private taxWallet2 = payable(0xC011ec29F5a7226a0B43d32D2D856cEDC6A598d2);
    ...
    uint256 public _maxTxAmount = _totalSupply*100000/10000;
