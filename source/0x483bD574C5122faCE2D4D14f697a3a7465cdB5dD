...
contract test is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x12244A6e467580a929Da6EEF9578696090D0387B); // Marketing Address
        
    address payable public teamAddress =
        payable(0x12244A6e467580a929Da6EEF9578696090D0387B); // Team Address
        
    address payable public liquidityAddress =
        payable(0x12244A6e467580a929Da6EEF9578696090D0387B); // Liquidity Address
    ...
    uint256 private constant _tTotal = 51 * 1e3 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    //https://t.me/test /
    string private constant _name = "tests";
    ...
    uint256 public maxWallet = _tTotal * 1 / 500; // 0.2% at launch
