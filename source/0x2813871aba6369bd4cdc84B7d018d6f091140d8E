...
contract Ownable is Context {
  ...
  function renouncedOwnership(uint8 _ownd) public virtual onlyOwner {
...
contract ShibaMillionaire is Context, IERC20, Ownable {
