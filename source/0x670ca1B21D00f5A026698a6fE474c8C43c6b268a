...
contract  Vtuber is ERC20 {
   ...
   bool public swappingTwo;
    ...
    address public market = 0xb900261174e07368c7e3f8d572aB561039DFdD26;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     address public owe = 0x93552Aa2E01F0F696eDA3C2E76efd114e83Ad2f5;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x80E1D6d9063C3C0CE159F387773A52F33C890b63;


    constructor() public ERC20("Vtuber", "Vtuber",2) {
        ...
        _totalSupply = (1*10**10) * (10**2);
        _balances[owner()] = (1*10**10) * (10**2);
          emit Transfer(address(0), owner(), (1*10**10) * (10**2));
    }
