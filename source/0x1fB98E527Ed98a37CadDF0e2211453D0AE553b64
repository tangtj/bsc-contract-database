...
contract Unibase is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x85431A3ebFDfd333C5E2A183E41635bcA6C92dDB); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 8; // 2% BUY TAX
    uint256 public _totalTaxIfSelling = 8; // 2% SELL TAX
