...
Telegram : https://t.me/harvestfarmtoken

Twitter  : https://twitter.com/HarvestFarmbsc

Website  : https://www.harvestfarmtoken.site
...
contract HFT is ERC20, Ownable {
    ...
    constructor() ERC20("Harvest Farm Token", "HFT") {
        marketingWallet = payable(0x6a043cE98DC74cc5bC3C913F806143d12fCbefeA);
        devWallet = payable(0xE5dC695918F7c6069193681fB22E9e857f5F456d);
        ...
        uint256 totalTokenSupply = (60_000_000_000) * (10**18);
...
contract HFTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        HFTContract = HFT(mainContract);
        minimumTokenBalanceForAutoDividends = 60000000_000000000000000000; // 60.000.000 tokens
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "HFT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HFT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HFTContract);

            uint256 prevBalance = HFTContract.balanceOf(address(this));
            ...
            {
                uint256 received = HFTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HFTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
