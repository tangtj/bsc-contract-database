...
contract PEPEPOWER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Power"; // 
    string private constant _symbol = unicode"$PEPEPOWER";  //    
