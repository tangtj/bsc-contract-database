...
contract GBCLPDividend is Ownable {
    ...
    constructor() {
        fundAddress = address(0x15FC9E702DF568902DCF6eB8336B700de89f8d3a);
    ...
    uint256 private rewardCondition = 5 * 10**18;
    ...
    function processLPReward(uint256 gas) external onlyMaster {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (tokenBalance > minLPForReward && !excludeHolder[shareHolder]) {
