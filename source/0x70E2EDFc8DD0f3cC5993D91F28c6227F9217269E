...
contract GIG is IBEP20, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "GIG";
    string private _symbol = "w3g";
    uint8 private _decimals = 18;

    uint256 private _totalSupply;
    uint256 private _maxSupply = 300000000* 10**_decimals;
    uint256 private _initialSupply = 300000000 * 10**_decimals;
