...
TELEGRAM : https://t.me/hertzchain

TESTNET IS LIVE

Network Name: Bitdrops Testnet
RPC: https://testnet.bitdrops.org
ChainId: 200200
Ticker/Symbol: Bitdrops
Explorer: https://testnetscan.bitdrops.org
*/
...
contract BitdropsChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bitdrops Chain";
    string private _symbol = "Drops";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4D57A719eAcB263f7ea79CC847DaD438edAdFAeB); // Marketing Address
    address payable private DevelopmentWalletAddress = payable(0x061a2fb29852AB87029f4E2B2C3b2a8f7201BD50); // Development Address
