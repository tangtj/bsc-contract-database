...
// File: contracts/Archive/Thorsun1155.sol
...
contract Thorsun1155 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    string public name = "VelhallaThorSun";
    string public constant symbol = "ThorSun";
