...
//With Eye Crypto, the future of finance is clear and accessible to all. It's a cryptocurrency that watches over your financial interests, providing a new vision for decentralized finance.
...
contract NowYouSeeMe  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9874D9dF22028bCf56a92Be1ddd88ba50058a7C0); 
    address payable public Wallet_Dev = payable(0x9874D9dF22028bCf56a92Be1ddd88ba50058a7C0);
    address payable public constant Wallet_Burn = payable(0x9874D9dF22028bCf56a92Be1ddd88ba50058a7C0); 
    ...
    constructor () {
        _owner =0x9874D9dF22028bCf56a92Be1ddd88ba50058a7C0;
