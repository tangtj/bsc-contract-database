...
contract X9 is Token {
    constructor() ERC20(
        "X9",   // 名字
        "X9"   // 符号
    ) {
        uint256 _totalSupply = 1852 ether; 
        address _marketing = address(0x3d38DA57196501726eaEDC151AAef317fB98261E); // 
        address _receive = address(0x3d38DA57196501726eaEDC151AAef317fB98261E);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x3d38DA57196501726eaEDC151AAef317fB98261E)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0x3d38DA57196501726eaEDC151AAef317fB98261E);   
        feeEarn = 1500; 
    }
}