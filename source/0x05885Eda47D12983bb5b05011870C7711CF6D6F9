...
// File: contracts/ABZ_Update.sol

/**
 *  
 * AstroBirdz
    TOTAL 3% tax:
    0% Auto add to Liquidity Pool .
    2% Auto added to marketing.
...
contract ABZ_Update is Context, IERC20 {
    ...
    constructor(){
        ...
        _marketingAddress = payable(0x29A25D6E75013d05609c83596d7Daa3d573b0C0c);
        _teamAddress = payable(0x34ED0F528ee4A23296b3B1e38DE7AA2A55b85B0F);
        _Owner = 0x7d9F9B5C9BfacAacA6dDB095e3E09E514A112199;
        
        
        pancakeRouter = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //Pancake Testnet Router Address:0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        ...
        _mint(_Owner, (1000 * (10**6)) * 10 ** 18);
        feeExcludedAddress[_Owner] = true;
        paused = true;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 totalFees = liquidityFee + marketingFee + teamFee ;
