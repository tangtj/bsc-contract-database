...
contract LemonGO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lemon GO";
    ...
    address payable private _twddev = payable(0xC308176b84d85E509851D4085241B53bc18953a5);
    address payable private _twdmkt = payable(0xC308176b84d85E509851D4085241B53bc18953a5);
