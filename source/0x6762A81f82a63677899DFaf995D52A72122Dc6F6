...
contract BITENETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BITE NETWORK";
    string private _symbol = "BITE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF4e92311Cf8Ff7f1d07509dB48b106C5875d5cB1); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xd1044cF2497692bbBDb7a607d7bf1E0c021B215D); // Development Address
