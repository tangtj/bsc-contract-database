...
contract GoldRushCasino is ERC20, Ownable {
    ...
    constructor() ERC20("Gold Rush Casino", "GRC") {
        ...
        charityWallet = payable(0x4A7Ccd75a4cE2F7BD39547e33a7E6584f5542557);
        ...
        swapTokensAtAmount = totalTokenSupply / 5000; 
...
contract GoldRushCasinoDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        minimumTokenBalanceForAutoDividends = 1_000_000_000_000000000000000000; 
    ...
    function _transfer(
        ...
        require(false, "GoldRushCasinoCasino_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GoldRushCasinoCasino_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GoldRushCasinoCasino contract."
        );
    }
