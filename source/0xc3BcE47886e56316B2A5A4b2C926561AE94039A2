...
contract PureWallet is IERC20 {
    ...
    string constant private _name = "Pure Wallet";
    string constant private _symbol = "PURE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xd02FE450AebE26c43DA6DEB7a3E2Fb15F2Cd2446),
        team: payable(0x60186EB352DC7A16735687c57eec4122430BB2f2),
        staking: 0xd02FE450AebE26c43DA6DEB7a3E2Fb15F2Cd2446
    });
...
//================================================ BLACKLIST
    ...
    function setRatios(uint16 staking, uint16 liquidity, uint16 marketing, uint16 team) external onlyOwner {
