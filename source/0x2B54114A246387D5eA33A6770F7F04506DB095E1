...
contract ECI is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 1000000000000 * 10**_decimals; //
    uint256 public maxWalletBalance = 1000000000000 * 10**_decimals; //

    address public marketingAddress = 0x06CDd9e97eA8f949B5C0Ef7417a1887b8aB5dfBc; //
    address public devAddress = 0x06CDd9e97eA8f949B5C0Ef7417a1887b8aB5dfBc; //
    ...
    Taxes public taxes = Taxes(4,0,6,0); //
    Taxes public sellTaxes = Taxes(4,0,6,0); //
