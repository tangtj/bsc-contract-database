...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        8888,
        address(0xF3568C373B5e12466056fA1935cE88ef347bb751), //fund 1
        address(0x45Ae8d5a3b7b2BFb4E5AdD109E8F25FBC03353D2), //fund 2 
        address(0x196D11851b5E4e65e20094Ee6cd43f1AB8C28B40) //receiver 
    ){
    }
}