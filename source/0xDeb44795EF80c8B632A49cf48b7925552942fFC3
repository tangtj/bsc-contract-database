...
contract BULLRIUM is IBEP20, Auth {
    ...
    string constant _name = "BULLRIUM";
    string constant _symbol = "$BULLRIUM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200000000 * (8 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x0b5a0651406d581CC6235dc31768db34a43779A1;
    address public devFeeReceiver = 0xDD21D367daF3e030555Eb8182B55680BC3D37E86;
