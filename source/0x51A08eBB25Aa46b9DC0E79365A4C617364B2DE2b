...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 1 ** 2;

    uint256 public minPeriod = 5 minutes;
    uint256 public minDistribution = 1 * (2 ** 2);
...
contract StreamFlix is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = _totalSupply * 5 / 1000000000;
    uint256 public _walletMax = _totalSupply * 5 / 1000000000;
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 4;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[address(0xcCCe1814a831E1fD10442DEFB1262E04a2d36fD8)] = true;
        ...
        marketingWallet = 0xcCCe1814a831E1fD10442DEFB1262E04a2d36fD8;  //marketingwallet
        teamWallet = 0xcCCe1814a831E1fD10442DEFB1262E04a2d36fD8; //backup wallet
