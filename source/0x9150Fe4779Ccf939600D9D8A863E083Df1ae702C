...
contract HEF is Context, IERC20, Ownable {
    ...
    string private _name = "Shibarbie Token";
    string private _symbol = "SHIBARBIE";
    ...
    address payable public marketingWallet =
        payable(0x1DB9aC8CbDBC30e192777Be4FBc2D8C16cCAc6d2);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        if (
            contractTokenBalance == 0 || (_liquidityFee.add(_marketingFee)) == 0
        ) {
            return;
        }
    ...
    function setNumTokensSellToAddToLiquidity(
        ...
        require(
            newAmount >= totalSupply() / 10000,
            "Can't set swap threshold to less than 0.01% of supply"
        );
