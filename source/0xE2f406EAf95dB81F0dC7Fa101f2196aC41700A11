...
contract CaptainSimpson is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 3000 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 3000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 150 * _decimalFactor; // 0.75% do Supply
    ...
    /*=== Strings ===*/
    string private _name = "Captain Simpson";
