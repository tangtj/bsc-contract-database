...
contract TOrbTokenSale is Ownable, Pausable, ReentrancyGuard {
    ITOrbs public tOrb;
    ...
    function buyWithBNB() public payable whenNotPaused nonReentrant {
        ...
        uint256 gamesShare = (msg.value * 80) / 100;
        uint256 operationsShare = msg.value - gamesShare;

        payable(redeemContract).transfer(gamesShare);
