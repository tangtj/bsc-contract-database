...
contract LuffyGear5Bit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luffy Gear 5 Bit";
    string private _symbol = "LuffyGear5Bit";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x32d7424F4206BDe698E0B005dc6ECAff2F000Eb0);
    address payable private DevelopmentWalletAddress = payable(0x32d7424F4206BDe698E0B005dc6ECAff2F000Eb0);
