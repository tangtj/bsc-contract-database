...
contract SCToken is ExcludedFromFeeList, LpDividendBNB, BlackList, FirstLaunch, MaxHave {
    ...
    address public lpReceiver = address(0xF5FcDA9aC8685757211cCDb3715ddd5Ed9911Fb9);

    address constant marketAddr = address(0xeFf34b6261eff2d1ACD34C32cc0B3C7A5250A48A); //1‰
