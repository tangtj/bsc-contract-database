...
contract CollationNetwork is IERC20, Ownable {
    ...
    string _name = "Collation Network";
    string _symbol = "COLL";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x79354bB68A14F527aAa36282C1d93d668395B9d3;
        marketingFeeReceiver = 0x79354bB68A14F527aAa36282C1d93d668395B9d3;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=15,"Cannot set buy fees above 15%"); // set max fees you can set to here
        require(totalFeeSell <=35,"Cannot set sell fees above 35%"); // set max fees you can set to here
