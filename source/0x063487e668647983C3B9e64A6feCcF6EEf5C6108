// https://t.me/XJESUSOFFICIAL
// https://twitter.com/xjesusofficial
...
contract XJESUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-JESUS";
    string private _symbol = "X-JESUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80305c7Db361aB6B98f233b85fB0A49f113b6Afb); // Marketing Address
    address payable public teamWalletAddress = payable(0x80305c7Db361aB6B98f233b85fB0A49f113b6Afb); // Team Address
