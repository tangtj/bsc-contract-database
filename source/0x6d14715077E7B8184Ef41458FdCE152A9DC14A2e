...
contract HOMERSIMP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Homer Simpson";
    string private _symbol = "$HMS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x43454F01316D446BC6DC431e6D19E9B8bAeAC505);
    address payable public teamWalletAddress = payable(0x43454F01316D446BC6DC431e6D19E9B8bAeAC505);
