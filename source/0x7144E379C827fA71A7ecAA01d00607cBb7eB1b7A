...
contract MyCoinToken is Ownable {
    ...
    address private termAddress = 0xb4a9193D9Badcd9C22e22870eCA791EA0822f6C3;
    ...
    uint256 eachPiece = 100000000000 * 10 ** uint256(decimals());
    uint256 minBounsJoin = eachPiece;
    
    uint256 tTotal = 1000000000000000 * 10 ** uint256(decimals());
