...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22A673E009cA4DBb328c386b5b5B52Ab3e5296e6; // owner address
...
contract PonziCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ponzi Coin";
    string private _symbol = "Ponzi";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x22A673E009cA4DBb328c386b5b5B52Ab3e5296e6); // Marketing Address
    address payable private teamWalletAddress = payable(0x22A673E009cA4DBb328c386b5b5B52Ab3e5296e6); // Team Address
    ...
    uint256 public _walletMax = 18 * 10**_decimals;
