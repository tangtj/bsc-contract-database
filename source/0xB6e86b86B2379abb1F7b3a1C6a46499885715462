...
contract binanceX is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5629b67D1e5eeD157f38707A2114e04b325A3DCB);
    address payable private _twdmkt = payable(0x5629b67D1e5eeD157f38707A2114e04b325A3DCB);
    
    string private constant _name = "BINANCE X";
