// https://t.me/WebGlideBSC
// https://x.com/webglidetoken
// https://webglide.org/
...
contract WebGlide is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WebGlide";
    string private constant _symbol = unicode"WEBG";
