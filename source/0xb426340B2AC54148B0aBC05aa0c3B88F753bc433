/**
Telegram: https://t.me/getrichbsc
*/
...
contract GetRich is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$holdit";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x3C0CE5c3807993Cbb85f8011CA1579F8b3e6b32e);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x3C0CE5c3807993Cbb85f8011CA1579F8b3e6b32e] = true;
