...
contract BTCUSDT is IERC20, Auth {
    ...
    uint8 private initialBuyTax = 3;
    uint8 private initialSellTax = 3;
    ...
    address payable private _walletMarketing = payable(0xcdcc595BbF2eCD11cF6Ccc85879D09D8Cb1ad1aa); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = 1_000;
    uint256 private _taxSwapMax = 87_000;
    uint256 private _swapLimit = 6_000_000;
