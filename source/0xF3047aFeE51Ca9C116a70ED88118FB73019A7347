...
contract PUPSTRONAUT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PUPSTRONAUTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PUPSTRONAUT", "PUPX") {
        marketingWallet = payable(0x1396A82C3593bC7948F8c642add031cE187Af663);
        devWallet = payable(0x1396A82C3593bC7948F8c642add031cE187Af663);
        ...
        dividendTracker = new PUPSTRONAUTDividendTracker(
            payable(this),
            router,
...
contract PUPSTRONAUTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PUPSTRONAUT public PUPSTRONAUTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PUPSTRONAUTContract = PUPSTRONAUT(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PUPSTRONAUT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PUPSTRONAUT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PUPSTRONAUT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PUPSTRONAUTContract);

            uint256 prevBalance = PUPSTRONAUTContract.balanceOf(address(this));
            ...
            {
                uint256 received = PUPSTRONAUTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PUPSTRONAUTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
