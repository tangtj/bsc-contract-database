        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x4422186Be0D8753C4034cD33Bd5e73dF5AB4d42b), block.timestamp
                );
            }
        }
    }
...
contract ZGT is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1888,//Supply
        address(0xa2775C4c86A687c0cb531e1F10F6183653D11079),//FundAddress
        address(0x4422186Be0D8753C4034cD33Bd5e73dF5AB4d42b)//ReceiveAddress
    ){
    }
}