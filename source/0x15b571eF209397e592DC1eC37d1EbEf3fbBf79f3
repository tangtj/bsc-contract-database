...
contract TRASH is ERC20, Ownable {
    ...
    constructor () ERC20("DumpsterFire", "$TRASH") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x86e357e75203ff2f1a966bD5Ba536c731D91d0A4;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            _burnFee = burnFeeOnSell * amount / 100;
        } else {
            _totalFees = 0;
        }
