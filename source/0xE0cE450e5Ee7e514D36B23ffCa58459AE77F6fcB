...
//When the magic of Harry Potter meets the meme power of Pepe!🔮 🐸
//Brace yourselves, a magical spin awaits let's conquer BSC space... 🎰 🪄✨

//Telegram - https://t.me/HarryPepeLegacy
//Twitter -  https://twitter.com/HarryPepeBsc
//Website -  https://www.harrypepelegacy.online
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbf716fc6Fc886aa7f881a7c4884d5851A8CB37ae;
...
contract HarryPepeLegacy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Harry Pepe Legacy"; // 
    string private constant _symbol = "$HARRYPEPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xbf716fc6Fc886aa7f881a7c4884d5851A8CB37ae);
