...
contract FANG is Context, IERC20, Ownable {
    ...
    string private constant _name = "FANG INU";
    ...
    address payable private _twddev = payable(0x98D56637BF956F5B92cff3C4cbf6555A9e70FE06);
    address payable private _twdmkt = payable(0x98D56637BF956F5B92cff3C4cbf6555A9e70FE06);
