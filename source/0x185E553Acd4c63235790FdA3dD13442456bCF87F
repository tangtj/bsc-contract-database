...
contract Gunz is Context, IERC20, Ownable {
    ...
    string private _name = "Gunz";
    string private _symbol = "GNZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4a571392CCBEcee398fff03f43f2D8aFf8fbA178); // Marketing Address
    address payable public teamWalletAddress = payable(0x4a571392CCBEcee398fff03f43f2D8aFf8fbA178); // Team Address
