...
contract ChiliPepper is Context, IERC20, Ownable {
    ...
    string private constant _name = "   CHILI PEPPER";
    string private constant _symbol = "CHILIPEPPER";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xe4d11557047C80F5A582C96b5393E4d9D3e9B7a0);
    address payable private _marketingAddress = payable(0xe4d11557047C80F5A582C96b5393E4d9D3e9B7a0);
