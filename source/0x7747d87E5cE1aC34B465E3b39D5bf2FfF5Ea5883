...
contract Meditite is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Meditite"; // 
    string private constant _symbol = unicode"MDT";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE412cdE847E901C10933964A3D7aEeEb648cdD8b;
