...
contract MOON_BEAM is Context, IERC20, Ownable {
    ...
    string private _name = "MOON BEAM";
    string private _symbol = "MOONBEAM";
    ...
    address public marketingWallet = 0x8e567a6346c1AC50e9466c20C1b6454027c9442D;
