...
contract VenmoCoin is Context, IERC20, Ownable {      //
    ...
    string private constant _name = "Venmo Coin"; //
    string private constant _symbol = "VCN"; //
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x304dD4c3DD88D8c76C102f97f3e951a31a6F96f4); //
    address payable private _marketingAddress = payable(0x304dD4c3DD88D8c76C102f97f3e951a31a6F96f4); //
    ...
    constructor () {
        ...
        emit Transfer(address(0x304dD4c3DD88D8c76C102f97f3e951a31a6F96f4), _msgSender(), _tTotal);
    }
