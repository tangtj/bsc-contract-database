...
contract KishuX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x26F7E6F1810Ba9fa23866Dd00b4C5Db9d30E18b3); 
    address payable private Wallet_Dev = payable(0x26F7E6F1810Ba9fa23866Dd00b4C5Db9d30E18b3);
    ...
    string private constant _name = "KishuX"; 
    string private constant _symbol = unicode"KishuX"; 
    ...
    constructor () {
        ...
        _owner = 0x7aA76893F4A71e8DA95d82d2C381F2fC6d9b9eFe;
