...
contract BoggieCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = 0xB1b9239E6Ce20a4E977F38e343d9ec2ff064Ade1; // Marketing Address
    ...
    string private _name = "BoggieCoin";
