...
contract ChimpInu is ERC20, Ownable {
    ...
    constructor () ERC20("Chimp Inu", "CHIMP") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xC58D1200B81c901e5D9d445E2d3D4f4672BF5ED2;
        ...
        _mint(owner(), 520_000_000_000_000_000 * (10 ** decimals()));
