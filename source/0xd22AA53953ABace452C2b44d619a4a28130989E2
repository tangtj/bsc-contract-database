...
contract HULA is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xb462B165f2247D3008b11a4db13ddA4617094DCb;

    string private constant _name = "HULA";
    string private constant _symbol = "HULA";
