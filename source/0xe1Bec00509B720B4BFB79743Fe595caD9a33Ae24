...
Inspired by other recent Little coins, I present to you BabyMoose
...
contract BabyMoose is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "BabyMoose";
    string private _symbol = "BMOOSE";
