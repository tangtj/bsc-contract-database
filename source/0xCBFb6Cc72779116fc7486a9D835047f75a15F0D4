/**
 * World Money Token - WMT
 * Made with code by SmartCrypt Tech™ for WMT Smart Finance Solutions™. All rights reserved
 * ERC20 Token on Binance Smart Chain (BSC) network.
 * Website: www.WMT.finance | Email: support@wmt.finance
 * © 2021 WMT Smart Finance Solutions™. All rights reserved.
*/
...
contract WMTSFS is Context, IBEP20, Ownable {
