/**
TRUST COIN is a BSC-based cryptocurrency that focuses on building an ecosystem prioritizing trust, 
security, and efficiency. Leveraging the capabilities of Binance Smart Chain (BSC), 
this coin enables users to navigate the crypto world swiftly, securely, 
and efficiently while upholding principles of transparency and community participation. 
TRUST COIN represents a step towards a more inclusive and trustworthy digital economy in the future.

TOKENOMICS🤝

Token : TRUST COIN ($TRUST)
Tax Code : 6/6
Max : 4% / 2.800.000.000
...
contract TRUSTCOIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "TRUST COIN";
    ...
    address payable public DevWallet = payable(0xf5a3fcBaa87CBc74639897C23CdBd1096abc3E6b);
    address payable public MarketingWallet = payable(0x9189666FbF525C69AEE679766Eba0Ee82C0eaa41);
