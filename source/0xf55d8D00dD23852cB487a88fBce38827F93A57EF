...
contract MafiaDog is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Mafia Dog";
    string private constant _symbol = unicode"$MAFIADOG";
