...
contract AE86 is IBEP20, Auth {
    ...
    string constant _name = "AE 86";
    string constant _symbol = "AE86";
    ...
    address public marketingFeeReceiver = 0xE8ED26324fF8ff18b2c717667Ee456118D538eaE;
    address public devFeeReceiver = 0xE8ED26324fF8ff18b2c717667Ee456118D538eaE;
