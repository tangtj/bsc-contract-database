...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xBc6BCaaa17111a741BB11753AB3cE5027595Dd44;
...
contract Token2049 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x1f7CEa988f3231505ac2618892ca84973Fb4Df27),
    
        address(0x9C493A7c9664C74c7958856c5160072fA66dd7Eb)
    ){
