...
contract PITHER is ERC20, Ownable {
    ...
    constructor() payable ERC20("PIHER", "PITHER") {
        ...
        marketingWallet = 0x61f92dc6e0CF32C47Aa0AD4f2bBD6de631c72fd0;
