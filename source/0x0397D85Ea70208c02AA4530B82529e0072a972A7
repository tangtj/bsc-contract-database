...
BIG ROUND WILL START
*/

//https://t.me/babypepevspepebsc
...
contract BabyPepeVsPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BABY PEPE VS PEPE";
    string private _symbol = unicode"BPVPP";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9dce1f103fAad2a78970C0612B70CDA5aB928340);
    address payable private taxWallet2 = payable(0x9dce1f103fAad2a78970C0612B70CDA5aB928340);
