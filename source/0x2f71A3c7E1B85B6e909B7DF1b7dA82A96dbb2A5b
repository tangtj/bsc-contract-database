...
contract MiniDogeFwiw is IBEP20, Auth {
    ...
    string constant _name = "MiniDogeFwiw";
    string constant _symbol = "MiniDogeFwiw";
    ...
    address public marketingFeeReceiver = 0x75565A9cAFD2ffDcb613Fc3d1D31Ca63E70D3337;
    address public buybackFeeReceiver = 0x5798aa40477f8bBdC55067f090D2216B1a58F22F;
