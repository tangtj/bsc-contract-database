...
TELEGRAM: https://t.me/greeenbitcoin
*/
...
contract GreenBitcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Bitcoin"; // 
    string private constant _symbol = "GBTC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x7dDcf6C43bF4ee71f5B199e1A49Ea2b1242Beb37;
