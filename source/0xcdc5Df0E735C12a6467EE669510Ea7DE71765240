...
contract fire is Token {
    constructor() ERC20(
        "fire",   // 名字
        "fire"   // 符号
    ) {
        uint256 _totalSupply = 1000000000000000 ether;
        address _marketing = address(0xD33B7d762D0c2b8da244DA51EEC3C97a6f9965fc); //
        address _receive = address(0xD33B7d762D0c2b8da244DA51EEC3C97a6f9965fc);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xD33B7d762D0c2b8da244DA51EEC3C97a6f9965fc)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0xD33B7d762D0c2b8da244DA51EEC3C97a6f9965fc);
        feeEarn = 0;
    }
}