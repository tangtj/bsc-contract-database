...
contract LayerConnect is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xF2223827ba6aE907D431DBa6649A7420dc9F73db);
    address payable private _mkt = payable(0xF2223827ba6aE907D431DBa6649A7420dc9F73db);
    
    string private constant _name = "LayerConnect";
