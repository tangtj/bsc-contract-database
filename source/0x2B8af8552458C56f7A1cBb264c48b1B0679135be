...
Twitter : https://twitter.com/XBlockium
*/
...
contract XB is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 10000 * 10**_decimals; //
    uint256 public maxWalletBalance = 10000 * 10**_decimals; //

    address public marketingAddress = 0xC28516408D1935c41C4866e1B57799545F97bdf7; //
    address public devAddress = 0x951B5cC5018fA58957c6bDCC88264C528ed86330; //
