...
contract SpaceCake is ERC20, Ownable {
    ...
    constructor() ERC20("Space Cake", "SpaceC") {
        ...
        marketingWallet = address(0x7167e27948e86e5959A204b92086e39E0D144b1D); // set as marketing wallet
        devWallet = address(0x795854b94B42776ADfD01a72E4b3c5b1882A5816); // set as dev wallet
