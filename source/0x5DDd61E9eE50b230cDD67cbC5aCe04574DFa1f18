...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50ca632fA92b9c4EF347c0965c9D6796A751F114; // owner address
...
contract  dxx is Context, IERC20, Ownable {
    ...
    string private _symbol = "PACMAN BNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50ca632fA92b9c4EF347c0965c9D6796A751F114); 
    address payable public teamWalletAddress = payable(0x50ca632fA92b9c4EF347c0965c9D6796A751F114);
