...
contract fire is Token {
    constructor() ERC20(
        ...
        address _marketing = address(0x177f2cB229C059e01bDE77b00f4E40Ebe6e3b875); //
        address _receive = address(0x177f2cB229C059e01bDE77b00f4E40Ebe6e3b875);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x177f2cB229C059e01bDE77b00f4E40Ebe6e3b875)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0x177f2cB229C059e01bDE77b00f4E40Ebe6e3b875);
        feeEarn = 0;
    }
}