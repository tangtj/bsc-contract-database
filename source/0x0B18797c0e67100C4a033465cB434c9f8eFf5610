...
/*
 ⚡️ Website  : https://Wazu.fun/
 ✉️ Telegram : https://t.me/WazuToken
 ✖️ Twitter  : https://twitter.com/WAZUBep
*/
...
contract Wazu is Context, ERC20, Ownable {
    ...
    string private constant _name = "Wazu Inu";
    string private constant _symbol = "WAZUI";
    uint256 public _maxtxperwallet = _tTotal;
    uint256 public _maxtxwalletsize = _tTotal;
