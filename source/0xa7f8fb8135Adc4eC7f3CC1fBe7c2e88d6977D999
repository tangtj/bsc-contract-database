...
contract NicMeta is ERC721Enumerable, Ownable {
    ...
    uint256 public maxBalance = 10000000;
    uint256 public maxMint = 10000000;
    ...
    constructor()
        // ERC721("chuangshilong2 NFT", "chuangshilong2")
        ERC721("GD Dragon NFT", "GD Dragon NFT")
    {
        setown(msg.sender);
    ...
    function mintLDMeta(uint256 tokenQuantity,address to) public  {
        require(
            msg.sender == own,
            "need own"
        );
    ...
    function _mintNicMeta(uint256 tokenQuantity,address to) internal {
