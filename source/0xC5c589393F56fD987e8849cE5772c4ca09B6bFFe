...
/*
   https://t.me/ShaveToken

   https://shavetoken.com/

   https://twitter.com/ShaveToken

   https://medium.com/@ShaveToken
...
contract SHAVE is ERC20, Ownable {
    ...
    constructor() ERC20("SHAVE", "SHAVE") {
        ...
        devWallet = address(0xb9735F0571aA4258EF1C286635485Bdedcd8cA93); 
