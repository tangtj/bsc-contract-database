...
// File: contracts/Archive/Valkeera.sol
...
contract Valkeera1155 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    string public name = "VelhallaValkeera";
    string public constant symbol = "Valkeera";
