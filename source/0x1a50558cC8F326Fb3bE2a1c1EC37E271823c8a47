...
contract GrowersCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Growers Coin ";
    string private _symbol = "CG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC2d9f800e824fe49a33A480725Ba5ffE47975B04); // Marketing Address
    address payable public teamWalletAddress = payable(0xC2d9f800e824fe49a33A480725Ba5ffE47975B04); // Team Address
