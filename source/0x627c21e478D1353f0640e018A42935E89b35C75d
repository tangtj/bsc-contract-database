...
contract TokyoX is Context, IERC20, Ownable {
    ...
    string private _name = unicode"TokyoX";
    string private _symbol ="TokyoX";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x37bd0CD3Bb1E393238E6cfB0faA77F61268F3C4B

);
    address payable public lpWallet = payable(0x37bd0CD3Bb1E393238E6cfB0faA77F61268F3C4B
