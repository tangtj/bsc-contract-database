...
contract DOGBEAR is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = "DOGBEAR";
        _decimals = 18;
        _owner = 0x93F1dbD735e830a9FD472Ac9505a0373419F2E5A;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 210 * 10**_decimals;
        marketingWalletAddress = payable(0x407e1d7B4ca5Abef7d89258e9d2aA7b1dD5b691e);
        teamWalletAddress = payable(0x0C920CEF68e98Dd9156bc486866ACCAcA45BE865);
