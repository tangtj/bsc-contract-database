...
*
 _____         _  _                            
/  ___|       (_)| |                           
\ `--.   __ _  _ | |_   __ _  _ __ ___    __ _ 
 `--. \ / _` || || __| / _` || '_ ` _ \  / _` |
/\__/ /| (_| || || |_ | (_| || | | | | || (_| |
\____/  \__,_||_| \__| \__,_||_| |_| |_| \__,_|
                                               
       Binance Smart Chain Version

    🎉 https://saitamatoken.com/

New in BSC, Built on Ethereum infrastructure (ERC-20),
SAITAMA INU is a medium for traders, crypto enthusiasts,
and ordinary people in general to be able to transact as
currency, payment and monetary system as whole.
...
contract SAITAMABSC is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address DogeReward = 0xFf3Ce1bce88338146127436ac49a6ECF5b77de5B;
