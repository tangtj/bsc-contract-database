...
// Community: https://t.me/Community_Calcium                 
...
contract CALCIUM is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x39309121f07C8fCbC61C204762E9Fde6773f566A);
    address payable private _marketingAddress = payable(0x39309121f07C8fCbC61C204762E9Fde6773f566A);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnSell < 9, "Tax cannot be more than 9.");
