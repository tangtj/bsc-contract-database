...
contract NudesCat  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nudes Cat", "NCat") {
        ...
        marketingWallet = address(0xa650103F7991D55B57876f3d22D9d2b93EC3B15C); // set as marketing wallet
        devWallet = address(0xa650103F7991D55B57876f3d22D9d2b93EC3B15C); // set as dev wallet
