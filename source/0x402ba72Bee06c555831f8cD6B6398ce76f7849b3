/**
 *  
 *  ___________    ____  ___          _______   ______   ___   ___ 
 * |   ____\   \  /   / /   \        |   ____| /  __  \  \  \ /  / 
 * |  |__   \   \/   / /  ^  \       |  |__   |  |  |  |  \  V  /  
 * |   __|   \      / /  /_\  \      |   __|  |  |  |  |   >   <   
 * |  |____   \    / /  _____  \     |  |     |  `--'  |  /  .  \  
...
contract EvaFox is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2A0f43Fb26400115B4C69939D59C43383A6269d0);
    address payable public teamWalletAddress = payable(0x2A0f43Fb26400115B4C69939D59C43383A6269d0);
    ...
    string private _name = "EvaFox";
    string private _symbol = "EvaFox";
