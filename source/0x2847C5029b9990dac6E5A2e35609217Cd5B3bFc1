...
contract BitcoinBunny is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BitcoinBunnyDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BitcoinBunny", "$BitBunny") {
        marketingWallet = payable(0x97F599cf212eeEd1D8b00f986ebFad4a79EA758a);
        ...
        dividendTracker = new BitcoinBunnyDividendTracker(
            payable(this),
            router,
...
contract BitcoinBunnyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BitcoinBunny public BitcoinBunnyContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitcoinBunnyContract = BitcoinBunny(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BitcoinBunny_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BitcoinBunny_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BitcoinBunny contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BitcoinBunnyContract);

            uint256 prevBalance = BitcoinBunnyContract.balanceOf(address(this));
            ...
            {
                uint256 received = BitcoinBunnyContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BitcoinBunnyContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
