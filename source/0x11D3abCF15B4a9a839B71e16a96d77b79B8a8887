...
contract Uranium is ERC20, Ownable {
    ...
    UraniumDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Uranium", "URA") {
        marketingWallet = payable(0x9c7f669C80693b451C5B5A1d09C03f5F113D8a5c);
        devWallet = payable(0x8ce7d45Ab45EeE136f342f9FCbA84ABFF1C8D915);
        ...
        dividendTracker = new UraniumDividendTracker(
            payable(this),
            router,
...
contract UraniumDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Uranium public UraniumContract;
    ...
    constructor(
        ...
        defaultToken = token;
        UraniumContract = Uranium(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Uranium_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Uranium_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Uranium contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(UraniumContract);

            uint256 prevBalance = UraniumContract.balanceOf(address(this));
            ...
            {
                uint256 received = UraniumContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    UraniumContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
