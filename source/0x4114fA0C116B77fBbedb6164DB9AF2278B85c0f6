...
Twitter: https://twitter.com/Floki_Fireman 

Telegram: https://t.me/flokifireman
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public REWARD = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
...
contract FlokiFireman2 is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; //XRP
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Floki Fireman 2.0";
    string constant _symbol = "FKF2";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1000000000000000 * (10**_decimals);
    uint256 _maxTxLimit =  10000000000000 * (10**_decimals);
    uint256 _maxWalletLimit = 10000000000000 * (10**_decimals);
    ...
    address public pair;
    address ts_Project = 0x02387c283a347E31A1BC6C222247C54d84F99608; 
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0xFf0Daa10cAF87aa2929C3E8700049e060624bfE9; 
