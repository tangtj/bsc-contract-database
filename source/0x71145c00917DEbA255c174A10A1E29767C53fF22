...
contract BLUEY  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE507150F2c371A9EA12EDd1c50Bb7926a3Ae98db); 
    address payable public Wallet_Dev = payable(0x7ef383F9C2464C33FfB27652E331345029f7e319);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42000* 10**3* 10**3 * 7**_decimals;
    string private constant _name = "BLUEY COIN"; 
    string private constant _symbol = unicode"$BLU"; 
    ...
    constructor () {
        _owner = 0x7ef383F9C2464C33FfB27652E331345029f7e319 ;
