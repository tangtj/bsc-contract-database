...
contract LHC is ERC20 {
	...
	address private _destroyAddress = address(0x357c4C7BC3FEDC8EF1d0e690aEF0c19543e937Fe);
	address public  uniswapV2Pair;
	address _baseToken = address(0x55d398326f99059fF775485246999027B3197955);
    address _fundAddress = address(0x1cAa742869a2efC430591bA575D4d4e6018fca4A);
    ...
    constructor(address tokenOwner) ERC20("LHC", "LHC") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
                ...
                ldxAmount = ldxAmount.add(amount.div(10000).mul(75));
                amount = amount.div(10000).mul(9700);
			}else if(_isPairs[to]){
				require(startTime < block.timestamp,"startTime");
                _splitUsdtLdxToken();
