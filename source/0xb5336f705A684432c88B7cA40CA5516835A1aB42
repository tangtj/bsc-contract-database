/**
    ...
    NFTs, MemeCoin And More
    Beep Coin is better than Pepe Coin. 
    Our aggressive marketing will make the project go far.

    We built a platform to earn Rewards from various projects.

    https://beepcoin.finance
    https://t.me/beepbeepinuu
    https://twitter.com/beepcoin6
...
contract BeepCoin is ERC20, Ownable {
    ...
    constructor() payable ERC20("Beep Coin", "BEEP") {

        webSite     = "https://beepcoin.finance/";
        telegram    = "https://t.me/beepbeepinuu";
        twitter     = "https://twitter.com/beepcoin6";
        ...
        marketingWallet = 0x34fA97cEFDFBEdBD58ba00e1448520cd22c8b250;
        developmentWallet1 = 0x7014694Ff34a303d4962aAa46128b2e9d33ed968;
        developmentWallet2 = 0x2bFD2A44Db85129084F7Aae938F0E70251a6563B;
        developmentWallet3 = 0x61462Acff1816907Fc28C1978A034a59D802a8ab;
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            payable(marketingWallet).transfer(newBalance * 3000 / 10000);
            payable(developmentWallet1).transfer(newBalance * 3255 / 10000);
            payable(developmentWallet2).transfer(newBalance * 490 / 10000);
