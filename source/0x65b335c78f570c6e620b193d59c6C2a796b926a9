/**
Telegram : https://t.me/DedeXPORTAL
Website :https://dedex.pro
*/
...
contract DEDEX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7A35048704a92DC80ef303c823fE37566865ceEF); 
    address payable private Wallet_Dev = payable(0x7A35048704a92DC80ef303c823fE37566865ceEF);
    ...
    string private constant _symbol = unicode"Dede X"; 
    ...
    constructor () {
        ...
        _owner = 0x7A35048704a92DC80ef303c823fE37566865ceEF;
