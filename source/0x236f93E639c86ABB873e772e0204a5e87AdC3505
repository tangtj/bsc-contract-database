...
contract DOLLARPEPEMONSTER  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x68C27A85A6a04626dA867e51c25d2a96a3AAb2D4); 
    address payable public Wallet_Dev = payable(0x68C27A85A6a04626dA867e51c25d2a96a3AAb2D4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000* 10**3* 10**3 * 10**_decimals;
    string private constant _name = "DOLLAR PEPE MONSTER"; 
    string private constant _symbol = unicode"$DPEPEMONSTER"; 
    ...
    uint256 public Percent_Reflection = 0;
    ...
    constructor () {
        _owner = 0x68C27A85A6a04626dA867e51c25d2a96a3AAb2D4 ;
