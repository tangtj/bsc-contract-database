...
contract PANDA is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Panda Token - https://pandatoken.fun';
    ...
    uint256 private _tTotal = 5000000000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 10000000000000000 * _DECIMALFACTOR;
