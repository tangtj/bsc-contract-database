...
contract ELONXPLATFORM is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON X PLATFORM";
    string private constant _symbol = "EXP";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0xd85987FcCdd5A59F8B7C82d2f4fA1460F3bEB7b6); //3
    address payable private _marketingAddress = payable(0xd85987FcCdd5A59F8B7C82d2f4fA1460F3bEB7b6); //3
    address payable private _buybackAddress = payable(0xd85987FcCdd5A59F8B7C82d2f4fA1460F3bEB7b6); //2
    address payable private _burnAddress = payable(0xd85987FcCdd5A59F8B7C82d2f4fA1460F3bEB7b6); //2
