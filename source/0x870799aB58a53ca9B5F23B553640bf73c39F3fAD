...
contract SaleTOKEN {
    ...
    uint256 tokensToTransfer = bnbForUser * 10; // 10 TOKEN per 1 BNB
    uint256 referralTokens = bnbForUser; // 1 TOKEN per 1 BNB for referral
    ...
    // Transfer 10% of the received BNB to the referral
    payable(_Referral).transfer(bnbForReferral);
    }
