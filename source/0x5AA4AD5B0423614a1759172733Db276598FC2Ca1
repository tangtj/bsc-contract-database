...
contract FixLP {
    address payable public feeRecipient = 0x68aeFf2Dd2C803aE1b2Dd573378f2E7284200d40;
    uint256 public feeAmount = 0.0 ether;  // 0.05 BNB fee, using the ether unit for simplicity in Solidity.
