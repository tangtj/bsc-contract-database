...
contract Sale_Contract {
    ...
    uint256 public f1BonusRate = 100; // 10% bonus for f1
    uint256 public f2BonusRate = 80;  // 8% bonus for f2
...
function _processPurchase(address _buyer, address _referrer, uint256 _tokenAmount, uint256 _referralBonus) internal {
    ...
    uint256 f1Bonus = _referralBonus.mul(f1BonusRate).div(10000); // 10% bonus for f1
    uint256 f2Bonus = _referralBonus.mul(f2BonusRate).div(10000); // 8% bonus for f2
