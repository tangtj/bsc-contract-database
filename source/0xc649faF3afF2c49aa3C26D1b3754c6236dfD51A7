// https://t.me/ChookyInuBSC
// https://twitter.com/Chookyinu
// https://chooky-inu.com/
...
contract ChookyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chooky Inu";
    string private constant _symbol = unicode"$CHOO";
