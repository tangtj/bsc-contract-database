...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function goAddLP() external onlyOwner {
        require(1 == goAddLPBlock, "startedAddLP");
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        3000000,//Supply
        address(0x5210d43583f853C4260A404E19dEF8A9eC451915),//FundAddress
        address(0x5210d43583f853C4260A404E19dEF8A9eC451915)//ReceiveAddress
    ){
    }
}