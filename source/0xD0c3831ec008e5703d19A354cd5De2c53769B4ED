...
// File: contracts/KSPC.sol

pragma solidity 0.5.17;

contract KSPC is ERC20 {
    string public constant name = "KONA SUMMIT PLATFORM COIN";
    string public constant symbol = "KSPC";
    uint256 public constant initialSupply = 1 * (10 ** 9) * (10 ** uint256(decimals));
    uint256 private constant UNIX_DAY_TIME = 86400;
    uint8 public constant decimals = 18;

    constructor() public {
        address _owner = 0xed0B0BC8E38097dF3bD366c0647D340dE8bb4647;        
