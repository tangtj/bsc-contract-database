...
contract BullShiba is BEP20 {
    ...
    string public constant name = "BULLSHIBA";
    ...
    uint256 public constant requestMinimum = 1 ether / 100; // 0.01 BSC
    uint256 public tokensPerBsc = 10e18;
    
    uint public target0drop = 0;
    uint public progress0drop = 0;
    
    address multisig = 0xBdf6305999BD79B3d9d65E5a99D876C81A0360D7;
    ...
    constructor() public {
        uint256 teamFund = 1000000000000000e18;
        owner = msg.sender;
