...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50A75dDa46f118D5DD91B1bB122BC05F3E039550; // owner address
...
contract XAPE2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XAPE2 ";
    string private _symbol = "XAPE2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02bb339D69A87AAACAF359E8Bc51f046f3CC51e6); 
    address payable public teamWalletAddress = payable(0xFe226a1d328ade31C5b09b38089EDb8B89D46488);
