...
contract DorkLord20Token is ERC20, Ownable {
    ...
    address public vault; // This address holds the Dorkl2.0 tokens for staking
    ...
    uint public totalStaking; // total Dorkl2.0 tokens sent to staking vault
    uint public totalMarketing; // total ETH sent to marketing wallet

    // Taxes are: Marketing, Liquidity, Staking
    uint8[3] public buyTaxes = [1, 1, 0];
    uint8[3] public sellTaxes = [2, 2, 0];

    IUniswapV2Router02 public router; // PancakeSwap Router
    IUniswapV2Pair public mainPair; // Main pair for the token DORKL / BNB
    ...
    function takeFees(
        ...
        // The total amount of Dorkl2.0 that has been added to staking
    ...
    function burnFrom(address account, uint256 amount) external {
        ...
        require(amount <= allowed, "DORKL2.0: Not enough allowance");
    ...
    function setTaxExempt(address account, bool exempt) external onlyOwner {
        require(account != address(0), "DORKL2.0: zero address");
