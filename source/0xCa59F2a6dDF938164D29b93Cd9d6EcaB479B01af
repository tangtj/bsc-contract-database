...
contract XFINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X FINANCE"; 
    string private _symbol = "XFINANCE"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7338411d9E68BdC9FcC6C25037139A8B586F1C4f); 
    address payable public teamWalletAddress = payable(0x7338411d9E68BdC9FcC6C25037139A8B586F1C4f); 
