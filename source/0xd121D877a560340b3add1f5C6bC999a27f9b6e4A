...
Telegram: https://t.me/COOLAPEBSC


   5% fee liquidity pool
   1% fee reflection to holders
   1% fee burnt
   5% COOLAPE FUNDS 
*/
...
contract FIGHTERAPE is Context, IERC20, Ownable {
    ...
    string private _name = "COOLAPE";
    string private _symbol = "COLAPE";
    ...
    address public marketingWallet = 0x0d1a3d02519e8097fBF80b010030D8Fe7120a82e;
