...
TG https://t.me/BabyWhalmartOfficial
Welcome to Baby Whalmart! We are the baby version of Daddy Whalmart! 
Our goal is to get Whalmart attention and moon with Daddy Whalmart! 
Hodl this gem for real and be a real chad for once! 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xb6c25FeDC58fA52774608058c1751cF3d6B852ed);
...
contract BabyWhalmart is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyWhalmart";
    string constant _symbol = "BABYWMART";
