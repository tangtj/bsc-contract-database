...
contract Xtron is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAe01830dd176638AE116a54DE9b365a3304a97E8); // Marketing Address
    address payable public teamWalletAddress = payable(0xDD1D586384967f3cb675EBEea50Ff5ebf29CAFC4); // Team Address
