...
contract OniToken is BEP20('ONI', 'ONI') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ONI::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ONI::delegateBySig: invalid nonce");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ONI::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying ONIs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ONI::_writeCheckpoint: block number exceeds 32 bits");
