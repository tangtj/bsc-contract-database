...
contract BTC20 is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"BTC20";
    string private constant _symbol = unicode"BTC20";
