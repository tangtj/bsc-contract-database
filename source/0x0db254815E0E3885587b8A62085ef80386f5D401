...
contract $SHIB is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0x6C75118712fbe185912B6Ddfc90482CEf562b9f1);
    address payable private _mkt = payable(0x6C75118712fbe185912B6Ddfc90482CEf562b9f1);
    
    string private constant _name = "Shiba Inu Community";
