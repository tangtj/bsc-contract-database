...
contract leeks is ERC20 {
	...
	address payable _fundAddress = payable(address(0x9A2fcB85C3a14f13412D94051eaB015939BA86CC));
    ...
    constructor(address tokenOwner) ERC20("leeks", "leeks") {
