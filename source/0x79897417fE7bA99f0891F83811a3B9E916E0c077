...
contract AV is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        3000,//Supply
        address(0x1C9f6630a835CC4cda5c077EDe65aB8215211F0A),//FundAddress       
        address(0x4a13CBBB27F02637ecc763280AE9cE9845Df6Fab)//ReceiveAddress
