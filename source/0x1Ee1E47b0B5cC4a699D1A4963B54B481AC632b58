...
contract Test is IERC20, Ownable {
    ...
    function setSwapTokensatThreshold(uint256 _swapThreshold) public onlyOwner {
        uint256 newswapthreshold = (totalSupply() * _swapThreshold) / 100;
        swapThreshold = _swapThreshold;
        require(newswapthreshold <= totalSupply().mul(2).div(100), "swapthreshold can't be set higher than 2%");
        require(newswapthreshold <= totalSupply().mul(1).div(10000), "swapthreshold can't be set lower than 0.01%");
