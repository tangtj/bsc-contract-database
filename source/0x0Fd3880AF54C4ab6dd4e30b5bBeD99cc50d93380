        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x0eA1a305a68Ca3341b0E10e9dFFb85f9166F7E10), block.timestamp
                );
            }
        }
    }
...
contract f1 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000,//Supply
        address(0xD5b5b5c4A12aedcf22d117946DABC901195EEBF4),//FundAddress
        address(0xD5b5b5c4A12aedcf22d117946DABC901195EEBF4)//ReceiveAddress
    ){
    }
}