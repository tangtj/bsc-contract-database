...
SPACE GAME Token is a project running on Binance Smart Chain that will offer crypto trading and NFT services in the future. SPACE GAME Token is backed by a BEP20 token called $PACE.

✅ Verified Contract
✅ Life changing Prizes!
✅ Your gift by holding $PACE
✅ Website realized at launch
✅ 100% Liquidity Pool Lock
✅ Fair launch with 0 holders!

🔥🚀 Let's win and get big profits with SPACE GAME TOKEN $PACE 🎮
TG : https://t.me/SpaceGameToken
**/
...
contract SPACEGAMETOKEN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SPACE GAME TOKEN";
    ...
    address payable public DevWallet = payable(0x382C08D4d18A02e3D51525722A807d0b32264460);
    address payable public MarketingWallet = payable(0xE4FC0C86C675A5422A89c163575Bf9E48DDf38df);
