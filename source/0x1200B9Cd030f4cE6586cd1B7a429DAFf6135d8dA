// telegram     : https://t.me/muiclacbsc
...
contract Muiclac is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muiclac";
    string private _symbol = "$LAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x001540d5c5197568d679C02CEF0de7b208d08e37); // Marketing Address
    address payable public teamWalletAddress = payable(0x001540d5c5197568d679C02CEF0de7b208d08e37); // Team Address
    ...
    uint256 public _walletMax =  21034500 * 10**_decimals;
