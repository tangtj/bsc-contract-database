/**
telegram: https://t.me/volcanocash 
...
contract VOLCANOCASH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VOLCANO CASH";
    string private _symbol = "Vcash";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4d937A25c457afF99DDa4f8239F31C0d705F2781); // Marketing Address
    address payable public teamWalletAddress = payable(0xD2dB713eE6Ae7379ED9dE5049b6759777B848825); // Team Address
