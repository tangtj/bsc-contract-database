...
contract ArubaChain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2665aAB81a7C190516e6435e102FaB2eD9171d25); // Marketing Address
    address payable public teamWalletAddress = payable(0x800EaE4382B6BB265fAec200c97b8430d202E8a8); // Team Address
