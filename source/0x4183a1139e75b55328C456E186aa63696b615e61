...
contract CYGG is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0x30c0Ca76eCC028aCc1975ABee0195984b91179be;
        _usdt = 0x55d398326f99059fF775485246999027B3197955;
        _whites[_dead] = true;
        _whites[_main] = true;
        _whites[address(this)] = true;
        _mint(_main, 21000000 * 10 ** decimals());
    }
    ...
    function _swap1() private {
        ...
        if (_maxsell > 0 && balances >= _maxsell) {
            ...
            uint256 fistval2 = IERC20(_fist).balanceOf(address(this));
                IERC20(address(this)).transfer(_dead, (balances)*2 / 8);
                if ((balances)/8 > 0 && (fistval2)/5 > 0) {
                addLiquidity2((balances)/8, (fistval2)/5);
            _swapTokenForFist1((fistval2)*4/5);
    ...
    function pair1(address addr) public onlyOwner {
            _pair = addr;
    }
