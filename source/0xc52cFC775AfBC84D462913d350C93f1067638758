...
contract SHIBASE is ERC20, Ownable {
    ...
    constructor() payable ERC20("SHIBASE", "$SHIBE") {
        ...
        marketingWallet = 0x67270AAA09BAbc2ad05e98576F1d558FA09C0b65;

        dividendTracker = new DividendTracker(32 * 10**5, rewardToken);
