/*
WEB : https://lastapeoffer.com/
TG : https://t.me/LastApeOffer

This is the FORK contract of the LastApeStanding token. This token
WILL implement an innovative jackpot mechanism.
...
contract LASTAPEOFFER is Context, IERC20, Ownable {
    ...
    // At any given time, buy and sell fees can NOT exceed 100% each
    uint256 private constant TOTAL_FEES_LIMIT = 10000;
    ...
    string private constant _name = "LASTAPEOFFER";
