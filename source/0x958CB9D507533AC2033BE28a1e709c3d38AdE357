...
contract MileiToken is Context, IERC20, Ownable {
    ...
    string private _name     = "MileiToken";
    string private _symbol   = "MILEI";
    ...
    { 
        ...
        marketingWallet = 0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be;
        ...
        _isExcludedFromFees[address(0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be)] = true;
        _isExcludedFromFees[address(0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be)] = true; //pinklock

        _isExcluded[address(this)] = true;
        _isExcluded[address(0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be)] = true; //pinklock
        _isExcluded[address(DEAD)] = true;
        _isExcluded[address(uniswapV2Pair)] = true;

        _rOwned[address(0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be)] = _rTotal;
        _tOwned[address(0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be)] = _tTotal;

        emit Transfer(address(0), address(0x0f4b13Beb0036C5BE265a1c5298887bD9bbd65be), _tTotal);
    }
