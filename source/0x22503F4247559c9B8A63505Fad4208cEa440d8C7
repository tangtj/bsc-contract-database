...
// https://t.me/HarryPotterOsamaXanaxInu
...
contract HarryPotterOsamaXanaxInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HarryPotterOsamaXanaxInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Harry Potter Osama Xanax Inu", "HPOXI") {
        marketingWallet = payable(0x839348118e36D70FDeD0499294e406fF3aB24C2a);
        devWallet = payable(0x839348118e36D70FDeD0499294e406fF3aB24C2a);
        ...
        dividendTracker = new HarryPotterOsamaXanaxInuDividendTracker(
            payable(this),
            router,
            0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c,
            "HarryPotterOsamaXanaxInuTRACKER",
            "HPOXITRACKER"
        );
...
contract HarryPotterOsamaXanaxInuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HarryPotterOsamaXanaxInu public HarryPotterOsamaXanaxInuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HarryPotterOsamaXanaxInuContract = HarryPotterOsamaXanaxInu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HarryPotterOsamaXanaxInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HarryPotterOsamaXanaxInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HarryPotterOsamaXanaxInu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HarryPotterOsamaXanaxInuContract);

            uint256 prevBalance = HarryPotterOsamaXanaxInuContract.balanceOf(address(this));
            ...
            {
                uint256 received = HarryPotterOsamaXanaxInuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HarryPotterOsamaXanaxInuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
