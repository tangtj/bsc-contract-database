...
contract CECCBUYNFT is Ownable {
    ...
    uint256 public nft_num_1=5000;
	uint256 public nft_num_2=2500;
	uint256 public nft_num_3=500;
	uint256 public nft_num_4=250;
	uint256 public nft_num_5=100;
	
	uint256 public is_box=1;
	...
	function is_is_box(uint256 addr) public onlyOwner {
        is_box = addr;
    }
	...
	function Deposit(address address_A, address address_B, uint256 amount_A, uint256 amount_B, uint256 type_id) lock public payable {
		...
		if(amount_A==nft_num_1*10**18 || amount_A==nft_num_2*10**18){
