...
/**
    ...
    4% of each transaction to the marketing wallet
...
contract BEUROP is Context, IBEP20, Ownable {
    ...
    string private _name     = "BEUROP";
    string private _symbol   = "BEPR";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        if (marketingFee > 0) {
            payable(0x4478D372B53F4F4B17a583145b859093faAE60AE).transfer(marketingFee);
            emit MarketingFeeSent(0x4478D372B53F4F4B17a583145b859093faAE60AE, marketingFee);
        }
