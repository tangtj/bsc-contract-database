...
// launch 2022-10-22 trending soccer worldcup 🇶🇦🇶🇦🇶🇦

// telegram : https://t.me/ZoroQatar
...
contract ZoroQatar is Context, IERC20 { 
    ...
    string private constant _name = "Zoro Qatar"; 
    string private constant _symbol = unicode"ZRQatar"; 
