...
contract TonyTheTiger is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TonyTheTigerDividendTracker public dividendTracker;
    ...
    constructor() ERC20("TonyTheTiger", "TTT") {
        marketingWallet = payable(0x621Fa547d2E022E93a9d6b0C058Db4F4024B18Db);
        devWallet = payable(0x621Fa547d2E022E93a9d6b0C058Db4F4024B18Db);
        ...
        dividendTracker = new TonyTheTigerDividendTracker(
            payable(this),
            router,
...
contract TonyTheTigerDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TonyTheTiger public TonyTheTigerContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TonyTheTigerContract = TonyTheTiger(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TonyTheTiger_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TonyTheTiger_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TonyTheTiger contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TonyTheTigerContract);

            uint256 prevBalance = TonyTheTigerContract.balanceOf(address(this));
            ...
            {
                uint256 received = TonyTheTigerContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TonyTheTigerContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
