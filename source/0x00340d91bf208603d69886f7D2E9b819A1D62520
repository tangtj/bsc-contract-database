...
contract LBOY is IERC20, Ownable {
    ...
    address private _destroyAddress =
        address(0xeF1Ca35974f4CB39167169BDEA04120DCd028073);
    //质押池
    address private _pledgeAddress =
        address(0x218a67C18E708d3f3a7386a7c55ADD525E3B595a);

    uint256 public _inviterFee = 30;
    address public inviterAddress = address(0x21533Baf09d5b1B3C48057445fd85D8337c6aB93);
