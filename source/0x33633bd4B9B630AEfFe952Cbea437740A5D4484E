...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC82039b4c7eed45A29846ca8B39BAdeFD1A61a07 ; // owner address
...
contract killerofmeme is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xe495E3f7EA5Fd6379c80ce5D4A414a2C9b494160); // Marketing Address
    address payable private teamWalletAddress = payable(0x83b5D06e9578dc91EeeB0E999Ec65029CA826324); // Team Address
