...
//--- Contract v2 ---//
contract GenTok is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xf45D047bA6f519f7eEE478133b5fa0Bd24b7C27d);


    IRouter02 public swapRouter;
    string constant private _name = "GenTok";
    string constant private _symbol = "GTK";
