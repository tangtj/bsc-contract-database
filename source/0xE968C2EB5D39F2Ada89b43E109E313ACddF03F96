...
// OxFinance with Governance.
contract OxFinance is ERC20("Ox Finance", "OX"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "OX::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "OX::delegateBySig: invalid nonce");
        require(now <= expiry, "OX::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "OX::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "OX::_writeCheckpoint: block number exceeds 32 bits");
