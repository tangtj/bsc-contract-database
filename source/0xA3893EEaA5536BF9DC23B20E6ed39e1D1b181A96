...
contract XSQUID is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x310748b512080F0da58DA44A84467A472A460cdb;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x5ADe41872bB96a346d471f291b5e2cD149d9686B;
