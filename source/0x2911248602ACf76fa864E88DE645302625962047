...
contract Claws is SafeMath {
    string public name = "ShibariumBSC";
    string public symbol = "Shiba bsc";
    ...
    function approveAndCall(address spender, uint256 amount, bytes memory data) public returns (bool) {
        ...
        (bool success, ) = spender.call(abi.encodeWithSignature("receiveApproval(address,uint256,address,bytes)", msg.sender, amount, address(this), data));
