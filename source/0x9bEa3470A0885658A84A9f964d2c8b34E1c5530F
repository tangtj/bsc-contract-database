...
contract Mytoken is ERC20, Ownable {
    ...
    string public name_ = "PerfectPIGCoin";
    string public symbol_ = "PG";
    uint256 public totalSupply_ = 999;
    address public rewardAddr_ = 0x55d398326f99059fF775485246999027B3197955;
    address public marketingWalletAddr_ = 0x37c58b713a34A1455DD47464aFA7a252A309Ff39;
    uint256[4] public  buyFeeSetting_ = [0,0,2,0];
    uint256[4] public  sellFeeSetting_ = [0,0,2,0];
    uint256 public tokenBalanceForReward_ = 900000000000000000000;
