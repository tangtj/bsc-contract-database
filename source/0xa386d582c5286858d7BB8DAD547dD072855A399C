...
contract SigmaNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xD0C67Aa13B3A79865c1A42AA221CB612e9ee158b); // Marketing Address
    address payable public teamWalletAddress = payable(0xF74016655a8f09D858C0699d9Ebba178c3cE6F1F); // Team Address
