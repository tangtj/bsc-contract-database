...
contract SimpsonV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "SIMPSON 2.0";
    string private constant _symbol = "SIMPSON2.0";
    ...
    constructor () {
        ...
        _isIncludedFromFee[0xDBB569664cAf0CE50358B5bB5E105CAd6D42fa25] = true;
