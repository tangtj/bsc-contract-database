...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1CD6Fa6460B1CD95Be09ae918DBDcdaAa0fe69f0; // owner address
...
contract xmultichain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X Multi Chain";
    string private _symbol = "xmultichain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1CD6Fa6460B1CD95Be09ae918DBDcdaAa0fe69f0); // Marketing Address
    address payable public teamWalletAddress = payable(0x1CD6Fa6460B1CD95Be09ae918DBDcdaAa0fe69f0); // Team Address
