// Tg : https://t.me/xsonicxbsc
// Twitter : https://twitter.com/Sonicxbsc
...
contract SonicX is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Sonic 𝕏";
    string private constant _symbol = unicode"SONIC𝕏";
