...
Telegram https://t.me/ScissorsTechnologyChannel
Website https://scissorstechnology.link
*/
...
contract SCISSORS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SCISSORS TECHNOLOGY";
    string private _symbol = "SCR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb72C381724094fACBe5619d940c92aBD86deA759); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe4A3b024a12A2fC68D41E846C151186E662fb89b); // BuyBack Address
