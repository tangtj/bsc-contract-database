...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public lpFee = 350;
    uint256 public destoryLpFee = 100;
    uint256 public destoryFFLpFee = 100;
    uint256 public _swapFee = 550;
    ...
    constructor (
        ...
        holderRewardCondition = 800 * 10 ** IERC20(_token).decimals();
    ...
    function addFFLp(uint256 lpAmount, uint256 usdtAmount) private {
        if(lpAmount > 0 && usdtAmount > 0){
             _swapRouter.addLiquidity(
                address(this), _token, lpAmount, usdtAmount, 0, 0, _blackAddress, block.timestamp
            );  
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x9756B9DA0Ec60119e50465BE9A2670eadb38667c),
        "Round The World",
        "RTW",
        18,
        100000000,
