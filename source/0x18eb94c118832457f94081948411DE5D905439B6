...
contract AAstarl20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "starl2.0";
    string private _symbol = "starl2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4Ae59a4Bb8362e26b5f53886C828A40a04Bc78d);
    address payable public teamWalletAddress = payable(0x5E2B4DA6531889Bc6Cb20b11aCE197a266B7c044);
