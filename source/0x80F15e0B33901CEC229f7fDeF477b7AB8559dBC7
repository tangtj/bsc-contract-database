/**
   We make this #Richsoon to hand over to the community after we get it pump by our own fund.
   ...
   .
   We will renounce the ownership to burn addresses to transfer #Richsoon to the community, make sure it's 100% safe.

   We will add 2 BNB and all the left 49% total supply to the pool
   Can you make  10000X? 
   ...
   it's the best part of the #Richsoon idea, increasing the liquidity pool automatically, 
...
contract RichSoon is Context, IERC20, Ownable {
    ...
    string private _name = "RichSoon";
    string private _symbol = "RICHSOON";
