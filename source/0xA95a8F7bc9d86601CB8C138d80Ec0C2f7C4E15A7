...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x4F2F193ec9cE1e4D25D0aBE10B89d0a23f2ACf56);
    string private _name = "ETL";
    string private _symbol = "ETL";
    ...
    uint256 public _buyInviteFee1=0;
    ...
    uint256 public _sellInviteFee1=0;
