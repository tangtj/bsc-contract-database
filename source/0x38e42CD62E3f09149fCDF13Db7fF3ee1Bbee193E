...
TELEGRAM: https://t.me/Shinbibsc
TWITTER:  https://twitter.com/Shinbibsc
...
contract SHINBI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinbi"; // 
    string private constant _symbol = "SHIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x85848211078d4DEFD384ac09C6C805041d5B005d;
