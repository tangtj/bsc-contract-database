...
contract KOC is IERC20, Ownable {
    ...
    string private _name = "KOC";
    string private _symbol = "KOC";
    ...
    constructor() {
        ...
        project = 0x1D3602e159115314c5cB9ff8DeF3FD9627Ea80BD;
    ...
    function _tokenTransfer(
        ...
        uint256 recipientAmount = amount.sub(burnFee + projectFee);
    ...
    function _takeBurn(
        ...
        uint256 tFee = amount.mul(50).div(baseRate);
    ...
    function setAddr(address _project, address _burnAddress) external onlyOwner {
        project = _project;
