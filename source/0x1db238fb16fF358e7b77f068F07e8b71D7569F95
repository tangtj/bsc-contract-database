...
library Address{
 ...
 contract  SOLANA20 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD82ace9Ab07BD31fE5D2BeC4C03d1dfe33591696;
    address public donationWallet =0xD82ace9Ab07BD31fE5D2BeC4C03d1dfe33591696 ;
    string private constant _name = "SOLANA2.0 ";
    string private constant _symbol = "S2.0";
