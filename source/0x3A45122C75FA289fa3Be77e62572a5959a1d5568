...
Telegram: https://t.me/crazybullbsc
...
contract CrazyBull is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CRAZY BULL";
    string private _symbol = "$BULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x0EB199266987D00bd8ac1F70d8A765c62963663A);
