...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6bBaEf492652f7764f8b2C55Ad0102f2D6c2de3B; // owner address
...
contract XDARK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"𝕏 Ðark";
    string private _symbol = unicode"𝕏Ð";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF011338e3A0FdFE6AA94b5D3cd358abCb6960210); 
    address payable public teamWalletAddress = payable(0xF011338e3A0FdFE6AA94b5D3cd358abCb6960210);
    ...
    uint256 private minimumTokensBeforeSwap = 42000000 * 10**3; 
