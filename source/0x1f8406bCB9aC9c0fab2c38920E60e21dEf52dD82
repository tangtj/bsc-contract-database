...
contract HappyFarming is ERC20, Ownable {
    ...
    constructor () ERC20("Happy Farming", "$Farmer")
    {  
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x736103CA1eaa61f8542e22547653d0A61DC13310;
        marketingWallet =0xB34B4bCc42b5F4FF5CF5e895E019C7901ce356F3;  
