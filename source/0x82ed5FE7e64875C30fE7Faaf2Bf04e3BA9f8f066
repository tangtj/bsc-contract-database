/*
  ...
  ____                   ____       _       _        
 |  _ \  ___   __ _  ___|  _ \ _ __(_)_ __ | | _____ 
 | | | |/ _ \ / _` |/ _ \ | | | '__| | '_ \| |/ / __|
 | |_| | (_) | (_| |  __/ |_| | |  | | | | |   <\__ \
 |____/ \___/ \__, |\___|____/|_|  |_|_| |_|_|\_\___/
              |___/                                  

ELIXIRS FOR THE MODERN AGE

Doge Drinks is a reflection token that gives members more with the auto-boost and has a hyper deflation system in place.

Doge Drinks is crypto-backed brand of premium functional Soft drinks. Built for modern lifestyle based on organic and superfood ingredients.

Doge Drinks core values are supporting the healthy lifestyle and achieving better help through drinks. 
...
contract DogeDrinks is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0xC322991dB9eFb57b4D550A3281bf3649D21Ee54D); // Marketing Address
    ...
    string private _name = "DogeDrinks";
    string private _symbol = "DOGEDRINKS";
