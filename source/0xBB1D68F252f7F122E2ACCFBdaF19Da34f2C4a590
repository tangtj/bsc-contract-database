...
/**
*/  
// Community: https://t.me/Bladesofglory_Bsc 
// TWITTER:   https://twitter.com/_Bladesofglory_                
...
contract BLADES_OF_GLORY is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x37Bfd17658997Eb7dc7679764998ACBD1423B32d);
    address payable private _marketingAddress = payable(0x37Bfd17658997Eb7dc7679764998ACBD1423B32d);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnBuy < 29, "Tax cannot be more than 29.");
	    require(taxFeeOnSell < 92, "Tax cannot be more than 92.");
