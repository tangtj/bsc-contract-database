...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0x30c8Fb96d8875cb8Fb354496E35B9cb986C33f6f),
      "Address is invalid"
    );
...
contract  PAPAHERO is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("PAPAHERO", "PAPAHERO")
    ERC20Permit("PAPAHERO")
    EmergencyDrainable(address(0x30c8Fb96d8875cb8Fb354496E35B9cb986C33f6f))
  {
