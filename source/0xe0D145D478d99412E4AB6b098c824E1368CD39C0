...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x7a4FcE1896a14F0B926609D758F4c473d77D396b; // owner address
...
contract XShibaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XShibaInu";
    string private _symbol = "XSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a4FcE1896a14F0B926609D758F4c473d77D396b);
    address payable public teamWalletAddress = payable(0x7a4FcE1896a14F0B926609D758F4c473d77D396b);
