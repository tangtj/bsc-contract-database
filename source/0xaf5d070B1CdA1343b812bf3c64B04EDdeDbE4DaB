...
contract PEPEBRAIN is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x9e413C146F9E0e2008C3D989994EB1CC2f386e17;
    address public devAddress = 0x9e413C146F9E0e2008C3D989994EB1CC2f386e17;

    string private constant _name = "Pepe Brain";
    string private constant _symbol = "PEPEBRAIN";
