...
contract Jerry is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x460d56cFCc9e087d35d054a056d1DF96B2e112eb);
    address payable private _twdmkt = payable(0x460d56cFCc9e087d35d054a056d1DF96B2e112eb);
    
    string private constant _name = "Jerry 2.0";
    string private constant _symbol = "JERRYTWO";
