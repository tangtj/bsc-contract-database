...
///_____/\     #/__/\ /__/\    #/_______/\     #/_______/\    #/__/\ /__/\    #
//\:::__\/     #\::\ \\  \ \   #\::: _  \ \    #\__.::._\/    #\::\_\\  \ \   #
// \:\ \  __   # \::\/_\ .\ \  # \::(_)  \ \   #   \::\ \     # \:. `-\  \ \  #
//  \:\ \/_/\  #  \:: ___::\ \ #  \:: __  \ \  #   _\::\ \__  #  \:. _    \ \ #
//   \:\_\ \ \ #   \: \ \\::\ \#   \:.\ \  \ \ #  /__\::\__/\ #   \. \`-\  \ \#
//    \_____\/ #    \__\/ \::\/#    \__\/\__\/ #  \________\/ #    \__\/ \__\/#
//             ##               ##               ##              ##               ##

  
//   website:https://chihuahua-chain.vip
//   TG https://t.me/chihuahuachainof
...
contract ChihuahuaChain is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private limitBurn = 1500000 * _decimalFactor;
    ...
    uint256 public numberOfTokensToSwapToLiquidity = 10000000 * _decimalFactor; // 1% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Chiahuahua Chain";
    ...
    constructor() {
        ...
        _excludeFromFee[address(0x27531dC330B07E335971851479361b38C03068ba)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x2cEffc8A7E1132F424a7E8A57B8930c988F30cA5)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0xC8e1b8367519fE4863C77Ffbc4290af1F7977e8c)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x451A603a2cC3eF3606acFafB392B9a1B0ebd53ff)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x1fa717f75274149A1B472Eac0ad87B47e5335b33)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x548e55D4c49c897e2Fa6b0537E4C2985625841bf)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x06e78c45ED2D9cb074626381b2962146dAdd1df8)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0xf310280d171fa1E278BA0E6f219179C6707cD875)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x48980ADdD8460342e7Eda01DDB91183738608348)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x94aD8936450A06515B015558A56fE782a315307c)] = true; // Define Contrato como True para não pagar Taxas
