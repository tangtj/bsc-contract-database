...
contract GDC is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xAeE7DF1dfacD42568e339903029578074E6cC5D0;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2233881900000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Global Digital Coin";
    ...
    uint256 public maxWalletToken = 111694095000  * (10**18);
    ...
    uint256 public _maxTxAmount = 44677638000 * 10**18;
