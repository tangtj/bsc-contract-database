...
contract BITCOINER is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21_000_000_000_000 * (10 ** _decimals);
    ...
    address public marketingWallet = 0xC542570C023fc8bC3C02617b89a152FF03D56B04;
    address public devWallet = 0x789b5AF37be52573879da8556398EF6D71E549a0;

    address public newOwner = 0x97d689b091136cc0274cc5C1fD27B657Eae88e8C;
