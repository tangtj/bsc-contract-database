// https://t.me/BitminerBSC
// https://twitter.com/BitminerBTC
// https://bitminerfinancial.com/
...
contract Bitminer is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bitminer Financial";
