...
contract BABYROSE is Context, IERC20, Ownable {
    ...
    string private _name = "BABY ROSE";
    string private _symbol = "$BROSE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDab3c14774a4e010FC8919b3dB4647b02723959a); // Marketing Address
    address payable public teamWalletAddress = payable(0xDab3c14774a4e010FC8919b3dB4647b02723959a); // Team Address
