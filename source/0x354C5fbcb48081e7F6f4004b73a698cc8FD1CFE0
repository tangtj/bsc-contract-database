...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public numTokensSellToFund = 100000;
    ...
    constructor (
        ...
        holderRewardCondition = 100 * 10 ** IERC20(TradeAddress).decimals();
    ...
    function setNumTokenSellToFund(uint256 amount) external onlyOwner {
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x36954781c8789DA17633334Cdf14b550F2a05ccA)
    ){
