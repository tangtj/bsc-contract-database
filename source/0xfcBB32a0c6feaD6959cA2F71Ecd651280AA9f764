...
contract WildDuck is Context, IERC20, Ownable {
    ...
    address payable private taxWallet1 = payable(0x67f0835d59fE8CB073803Eb3b1921801a08C77b3);
    address payable private taxWallet2 = payable(0x67f0835d59fE8CB073803Eb3b1921801a08C77b3);
