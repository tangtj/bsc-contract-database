...
contract NBF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NBF";
    string private _symbol = "NBF";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc15Abdea6CBF76f05D8a57e6a3F9176FF488f95f); //做市商地址
    address payable public BurnedWalletAddress = payable(0xc15Abdea6CBF76f05D8a57e6a3F9176FF488f95f); //手续费奖励地址
    address payable public PayWalletAddress = payable(0xc6A9EBE6C0d879A175189516F623720Dc9bFE550); //项目回流分红发放地址
    address public immutable deadAddress = 0x0000000000000000000000000000000000000000;//销毁地址
    address RewardToken = address(IERC20(0x55d398326f99059fF775485246999027B3197955));//bsc-USDT合约地址
    
    address payable public toAddress1 = payable(0xc6A9EBE6C0d879A175189516F623720Dc9bFE550); //发行到哪里
    ...
    uint256 private minimumTokensBeforeSwap = 10000 * 10**4 * 10**_decimals;
