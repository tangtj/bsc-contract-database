/*
 *In the velvety darkness of a moonlit night, a legend was born—the Supermoon Pirate, a mysterious and elusive figure 
  that emerges only when the celestial stage is set for its grand entrance. 
  
 *The "Supermoon Pirate" in Binance is not a drink machine but rather a term or nickname used informally by some traders 
  or enthusiasts to refer to a situation where cryptocurrency prices, particularly those listed on the Binance exchange, 
  experience significant and rapid price increases, akin to the striking visual impact of a supermoon in the night sky. 
  This term is not an official feature or service on the Binance platform but rather a colloquial expression used to 
  describe market conditions when cryptocurrencies surge in value.

 🏴‍☠️ We will start from 0. 
 🏴‍☠️ With super low MC. 
 🏴‍☠️ 1% sell taxes (as liquidity).
 🏴‍☠️ 0% TEAM TOKEN. 
 🏴‍☠️ LP Burned.
 ⚓️ Max Wallets and Max Tx added. 
 NEW GAME WILL START !

 *Tokenomics 
 Supply 100,000 SMOONPIRATE
 No buy Tax. No Team Token.

 Community  : https://t.me/supermoonpirates
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x47eea7d9522d2EA31BfB6f87EBf93dF98DaBFdFb;
...
contract SUPERMOONPIRATE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xf00D112a546A3385502D209d89B07121d0b0283D);
    ...
    */
    ...
    string private _name = "SUPERMOON X PIRATES"; 
    string private _symbol = "$SMP";  
    uint8 private _decimals = 5;
    uint256 private _tTotal = 100000 * 10**5;
