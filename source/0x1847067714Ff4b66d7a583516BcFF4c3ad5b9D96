...
contract CarbonCCLPFarm is Ownable{
    using SafeMath for uint256;
    using Address for address;
    ...
    address public sponsorRewardAddress = 0xD53595e54A4E3656D8dca2c978979a12d0154f07;
    address public treasuryAddress = 0xFBC44E6a83b057848dE43118551dF47036326D36;
    address public rewardProgramAddress = 0xF784d1a5dB429A5ae405EA0253dA318c21AA5aaB;
    ...
    function Deposit(uint256 amount) public updateReward(msg.sender) checkStart { 
        ...
        totalSupply = totalSupply.add(remainingAmount);	
    ...
    function Exit() public {
        ...
        CarbonCCLP.transfer(msg.sender, amount);
        Claim();
    ...
    function Claim() public updateReward(msg.sender) checkStart {
        ...
        require(reward > 0 || pendingReward > 0, "No reward");
        if (reward > 0) {
