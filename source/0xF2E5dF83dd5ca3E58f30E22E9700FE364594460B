...
contract SPANKCHAIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SPANK CHAIN";
    string private constant _symbol = unicode"$PANK";
    ...
    address payable public DevWallet = payable(0x9E1Ab0a2d2Fe2d56d0bb0d231AA64D41d5F9Da57);
    address payable public MarketingWallet = payable(0xa5aA99aE33Caa1B3D82f8489678477BD6dcc0830);
