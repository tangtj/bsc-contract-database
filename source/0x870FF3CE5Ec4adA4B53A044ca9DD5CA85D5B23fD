...
This Token Build by Cryptopreneur Labs.
(Crete to Helping People From Developers Who Leave Their Communities)  

$ Coin Basically BNB SMARTCHAIN Technology
Name of Token : Defisme (DSME)
(www.defisme.com)
...
contract DefiSME is ERC20, Ownable {
