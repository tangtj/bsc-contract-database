...
contract GOKUSUKE is Context, IERC20, Ownable {
    ...
    string private _name = "GOKUSUKE";
    string private _symbol = "GSUKE";
    ...
    address payable public marketingWallet = payable(0x3F1D30A965070346135d7C344dd9c18C36d2d4Ee);
