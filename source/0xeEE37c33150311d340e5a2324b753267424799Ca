...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89e7bfd5E2B3ca162fBD18AFb5F2422F61A61E41; // owner address
...
contract Shiba2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba 2049";
    string private _symbol = "Shib2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x89e7bfd5E2B3ca162fBD18AFb5F2422F61A61E41); // Marketing Address
    address payable private teamWalletAddress = payable(0x89e7bfd5E2B3ca162fBD18AFb5F2422F61A61E41); // Team Address
