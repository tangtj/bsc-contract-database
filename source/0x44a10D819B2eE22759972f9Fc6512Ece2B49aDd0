...
contract QuixLink is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "QuixLink";
    string private constant _symbol = unicode"$QUIX";
    ...
    address payable public DevWallet = payable(0x19C33202Ba4FBB75617428b284443cf895e7A0D1);
    address payable public MarketingWallet = payable(0x9bc0dd588418c222464A52400f1C0d95d21FebDa);
