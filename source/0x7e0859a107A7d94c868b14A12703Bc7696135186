...
contract XW is Token {
    constructor() ERC20(
        "XW",   // 名字
        "XW"   // 符号
    ) {
        uint256 _totalSupply = 1500 ether;
        address _marketing = address(0xA840FB8a75C7122F0F9c65368E013E9ff2362D21); //
        address _receive = address(0xDC454340C96815324aa952C67aDD1754c319dbdD);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xA840FB8a75C7122F0F9c65368E013E9ff2362D21)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xA0641672E701128a762D73132534EE3da5BBF58e);
        feeEarn = 0;
    }
}