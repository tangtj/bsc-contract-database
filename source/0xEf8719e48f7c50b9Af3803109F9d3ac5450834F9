/**
 *Submitted for verification at testnetstage.bscscan.com on 2023-04-05
*/
...
contract EAToken is owned {
    ...
    uint256 private _totalSupply = 100000000000000 * (10**_decimals);         //800 million tokens
    uint256 constant public maxSupply = 100000000000000 * (10**_decimals);    //80000 million tokens
