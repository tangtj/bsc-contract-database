...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD1B7108c3F79E21bcB6c2749e0F0A12d290D3253; // owner address
...
contract FUTUREWHALECOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUTURE WHALE";
    string private _symbol = "FWC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD1B7108c3F79E21bcB6c2749e0F0A12d290D3253); // Marketing Address
    address payable private teamWalletAddress = payable(0xD1B7108c3F79E21bcB6c2749e0F0A12d290D3253); // Team Address
