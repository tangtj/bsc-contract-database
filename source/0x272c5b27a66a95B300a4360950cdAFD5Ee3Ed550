/**
 * FORWARD FINANCE GOVERNANCE TOKEN
 *                                                           
 * Forward Finance Governance Contract
 * FWD will be used to vote and govern the Forward Finance Ecosystem
 * 
 * 
 * Made with love by fataL^
 * 
 * 
 * Freezable for % of transactions upon release
 * Fair Distrbution on PCS
 * 
 * 
 * 
 * 
...
contract ForwardFinance {
	...
	string constant public name = "ForwardFinance";
	string constant public symbol = "FWD";
