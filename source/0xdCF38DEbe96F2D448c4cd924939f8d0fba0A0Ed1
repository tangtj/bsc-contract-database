...
contract layeriuminu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Layerium INU";
    string private _symbol = "LyumInu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6f4080F103130Ab6409279F7d3aBd8068bd0057B);
    address payable private DevelopmentWalletAddress = payable(0x6f4080F103130Ab6409279F7d3aBd8068bd0057B);
    ...
    uint256 private _totalSupply = 300000000 * 10**9;
    uint256 public _maxTxAmount = 1500000 * 10**9;
    uint256 public _walletMax = 6000000 * 10**9;
