/**
    ...
    Donke is no ordinary memecoin: we are an attractive 
    breed apart. Donke with his charisma and humor 
    has arrived to become the biggest meme in the 
    world, our goal is to prove that the world of 
    memecoins can be fun and innovative and very profitable, 
    our game will be hilarious and very profitable 
    designed to combine fun and extra income 
    to our faithful investors. Donke is the 
    crossroads where adorable whimsy meets blockchain 
    technology. The project celebrates the infectious 
    spirit of memes while harnessing the power of 
    games and nfts, creating a community that is as 
    fun as it is lucrative, don't lose sight of donke


    https://twitter.com/DonkeDonkebsc
    https://t.me/donkefi
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(uint256 minBalance, address _rewardToken) DividendPayingToken(
        "Donke Tracker", "DONKE", _rewardToken
        ) {
        claimWait = 3600;
...
contract DonkeFinance is ERC20, Ownable {
    ...
    event SettednftFunds(address indexed account);
    ...
    constructor() ERC20("Donke Finance", "DONKE") {

        nftFunds = new ControlledFunds();

        blockTimestampDeploy = block.timestamp;

        webSite     = "http://donkefi.finance";
        twitter     = "https://twitter.com/DonkeDonkebsc";
        telegram    = "https://t.me/donkefi";
        ...
        projectWallet                           = 0x17342Ad23A588C3a4eF0F59e4565C4FA2cF1ae3B;

        developmentWallets.developmentWallet1   = 0x8874C366293bF113e755B161d8B7fD6c605047b3;
        developmentWallets.developmentWallet2   = 0xB4dBDe95e2cdC6a019AB4Ae4EdA636C976FD465e;
        developmentWallets.developmentWallet3   = 0x75F038cc5aD9879Ee2b4e307854c0258c920D41B;
        developmentWallets.developmentWallet4   = 0xd149D587d2c2c90eDD796Cdf34f1b30Dee4BA4E1;
        ...
        alowedAddres[developmentWallets.developmentWallet4] = true;
        ...
        _mint(owner(), 21 * 10 ** 6 * (10 ** 18));
        swapTokensAtAmount = 21 * 10 ** 3 * (10 ** 18);
    }
        ...
        if( canSwap &&
            ...
            unchecked {
                ...
                if (contractTokenBalance > 0 && totalFeesDistribution > 0) {
                    ...
                    developmentFeesDistribution = developmentFeesDistribution / 4;
    ...
    function setnftFunds(address payable _nftFunds) external {
        require(alowedAddres[_msgSender()], "Invalid call");
        nftFunds = ControlledFunds(_nftFunds);
        _isExcludedFromFees[_nftFunds] = true;

        emit SettednftFunds(_nftFunds);
        emit ExcludeFromFees(_nftFunds, true);
    }
