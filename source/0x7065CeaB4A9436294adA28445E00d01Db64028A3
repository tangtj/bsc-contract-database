...
contract FlokiXRP is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDivsExcluded;
    mapping (address => bool) private _isFlokiXRPExcluded;
    mapping (address => bool) private _isFlokiExcluded;
    ...
    constructor() payable ERC20 ("FlokiXRP", "FlokiXRP") {
        ...
        marketingWallet =  0xab125a85B82F322717FB2034e4dE03b62104D1c5;

        dividendTracker = new DividendTracker(10 * 10**5, rewardToken);
        ...
        _isWalletExcluded[0xab125a85B82F322717FB2034e4dE03b62104D1c5] = true;
    
        _mint(owner(), 10 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000000 * 1069;
    }
