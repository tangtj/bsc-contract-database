...
contract Bulltober is ERC20, Ownable {
    ...
    constructor() ERC20("Bulltober", "BULL") {
        ...
        marketingWallet = address(0x6311BC02ff68a4bD2d81468EdD0DC9ba247f523C); // set as marketing wallet
        devWallet = address(0x6311BC02ff68a4bD2d81468EdD0DC9ba247f523C); // set as dev wallet
