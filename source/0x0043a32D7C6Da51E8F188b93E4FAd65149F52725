/**
    ___   __    _  _______  ___   __    _  ___   _______  __   __ 
    |   | |  |  | ||       ||   | |  |  | ||   | |       ||  | |  |
    |   | |   |_| ||    ___||   | |   |_| ||   | |_     _||  |_|  |
____|___|_|_______||___|___ |___|_|_______||___|___|___|__|_______|____
    |   | |  _    ||    ___||   | |  _    ||   |   |   |  |_     _|
    |   | | | |   ||   |    |   | | | |   ||   |   |   |    |   |  
...
contract Infinity {
    address payable public feeRecipient = 0xdF892cdB240040940BF3441A9c308cCc2Aa25d14;
    uint256 public feeAmount = 0.01 ether;  
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 
    constructor() public {}
 
    function infinityNoMore(address _tokenA, uint256 _amountTokenA) external payable {
