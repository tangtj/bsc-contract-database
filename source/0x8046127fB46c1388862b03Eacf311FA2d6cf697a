/**
🚀🐱 Flokitty is the hot trend in crypto space powered by endless possibilities to generate money and joy. Now the Flokitty arrived on the BSC and is ready to claim his throne as the pet of the galaxy🐱

📊Buy/Sell tax: 2%
📊Burn 90% of Total Supply
✅Based Dev
✅Contract Renounce
✅LP Locked 100%
...
contract Flokitty is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x961b87E5138Bf203DeeC15530782023f6E30E521;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x85791cB8f9d4B69b3fb17687C82403F369227E33;
