...
contract LADYRONININU is IBEP20, Auth {
    ...
    string constant _name = "LADY RONIN INU";
    string constant _symbol = "LARI";
    ...
    address public marketingFeeReceiver =0x837f84Af9cf72F96DE50518359838fB543178c87 ;
    address public devFeeReceiver =0x1Fb1DCCdfdc0FCd6C6194EC8812D1663F467451b ;
