...
//Telegram : https://t.me/thisisfinebsctoken
...
contract Thisisfinebsc is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFCC57882b20Bf8E12Cd61849fd62F181a2C965A6); 
    address payable private Wallet_Dev = payable(0xa1E3abA29c8A15c816A1A4015beb625CDB9347A9);
    ...
    string private constant _name = "THISISFINEBSC"; 
    string private constant _symbol = unicode"$FINEBSC"; 
    ...
    constructor () {
        ...
        _owner = 0xa1E3abA29c8A15c816A1A4015beb625CDB9347A9;
