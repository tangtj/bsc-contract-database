...
contract Mog is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7C80AfA43E67adA4D77D4a50FCdf170e5F0a481F); 
    address payable public Wallet_Dev = payable(0x506F5a9a213c815E77Fc7662403200801735899e);
    ...
    string private constant _name = "Mog Coin"; 
    ...
    constructor () {
        ...
        _owner = 0x506F5a9a213c815E77Fc7662403200801735899e;
