/**
 PAYX
 PayX
Are you ready to embark on an exciting journey into the world of digital currency? Look no further than PayX, your passport to a seamless fusion of the best of PayPal and the limitless potential of the X-factor from Twitter.
*/
...
interface Ru {
  ...
  */
   ...
   * PayXNFTOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract PayXDOLR is Ma, Ru, io {
   ...
   address private PayXNFTOwner; 
   string public PayXNFTwebsite = "https://payxx.gold/";
   string public ownerAddress = "0xA0911b5A354e8F76cD25ACABbD57051351cf8C72";  
    constructor() {
        PayXNFTOwner = 0xA0911b5A354e8F76cD25ACABbD57051351cf8C72;    
        _name = "PayX";
        _symbol = "PAYX";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getPayXNFTwebsite() public view returns (string memory) {
        return PayXNFTwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(PayXNFTOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
