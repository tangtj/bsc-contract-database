...
contract FL is Token {
    constructor() ERC20(
        ...
        uint256 _totalSupply = 35000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0xEa91c4A6C61C3A4062240E3b896Fbb049d3f4eD1); //
        ...
        feeMarketingTo2 = address(0xD0999c14baB44a4e2fd23FfDf3f67df3ac8AC1f3);
        feeEarn = 0;
        isLiquified = true;
    }
}