...
contract XGrimaceBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XGrimace";
    string private _symbol = "$XGRIMACE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5BE4C7Fd919798bcBEa4f9f959Ea263E0344bd4F); // Marketing Address
    address payable private teamWalletAddress = payable(0x5BE4C7Fd919798bcBEa4f9f959Ea263E0344bd4F); // Team Address
