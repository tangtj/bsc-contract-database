...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCeb01C9319E9ba3C74D3DCdbb3dEdE35c58aF05C; // owner address
...
contract ApedThanksMeLater is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aped Thanks Me Later";
    string private _symbol = "APED";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCeb01C9319E9ba3C74D3DCdbb3dEdE35c58aF05C); // Marketing Address
    address payable private teamWalletAddress = payable(0xCeb01C9319E9ba3C74D3DCdbb3dEdE35c58aF05C); // Team Address
