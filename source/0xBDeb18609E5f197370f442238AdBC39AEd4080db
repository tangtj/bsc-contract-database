...
contract PAWTOKEN is Ownable, ERC20 {
    ...
    address constant DEV = 0xdF21C1998eF26f101c90132320DF5707B9FFC975;
    

    string constant _name = "PAWTOKEN";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xedDC09e2c74c2212818eBEb4C575f63209bDa7b4;
        devFeeReceiver = DEV;
