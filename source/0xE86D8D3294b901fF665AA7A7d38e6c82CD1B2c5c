...
contract Xtige is Context, IERC20, Ownable {      //
    ...
    string private constant _name = "X tige"; //
    string private constant _symbol = "$XIGE"; //
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x48D352A0b6399BCEE2064E8E87b25BB17277019d); //
    address payable private _marketingAddress = payable(0x48D352A0b6399BCEE2064E8E87b25BB17277019d); //
    ...
    constructor () {
        ...
        emit Transfer(address(0x48D352A0b6399BCEE2064E8E87b25BB17277019d), _msgSender(), _tTotal);
    }
