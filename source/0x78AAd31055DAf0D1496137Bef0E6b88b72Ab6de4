...
contract Hexarium is Context, IERC20 {
    string private _name = "HEXARIUM";
    ...
    address payable public MarketingWallet = payable(0x5c16477dC5bD29f3073448673Cca190b259375D5);
