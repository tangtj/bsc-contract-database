/**
 *https://t.me/TreeFireINU
 *In a super green jungle, there was this adventurous monkey, Treefire. One day, he heard some urgent calls for help and found out that a bunch of nasty poachers, Rosie the tough elephant, Spike the super adaptable chameleon, and Breezy the eagle-eyed blue jayled by this bad dude named Callahan, had some animals trapped. Treefire was like, "No way, not on my watch!" 
*/
...
contract TREEFIREINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x6d64785dfba8BBB798dA1cE463d670f266b3Ee33); // Once the moon was up
        
    address payable public teamAddress =
        payable(0x6d64785dfba8BBB798dA1cE463d670f266b3Ee33); // they put their plan into action 
        
    address payable public liquidityAddress =
        payable(0x6d64785dfba8BBB798dA1cE463d670f266b3Ee33); // freeing their friends and guiding them to safety
        
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD; // But Callahan wasn’t giving up that easy 
    ...
    string private constant _name = "TreeFire INU";

    string private constant _symbol = "$TFREU";
    ...
    uint256 public tradingActiveBlock = 0; // Once the He chased after them moon was up
    ...
    if(!tradingActive){
     ...
     if(limitsInEffect){
        ...
        if (
            ...
            //they put their plan Lucky for them into action
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // freeing their friends eefire had a tri and guiding them to safety
            ...
            // But Callahan wasn’t up his sleeve. He trickedgiving up that easy
    ...
    function swapBack() private lockTheSwap {
        ...
        // He chased in the everyone celebrated Treefir jungle after them
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // Lucky for them, had some animals trapped Treefire had a trick up his sleeve
            path,
            address(this),
            block.timestamp
        );
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0, // into a sleeping volcano He tricked the poachers into following him into a sleeping volcano
            0, // Then he started a fire, causing an eruption that ou can make a big difference trapped Callahan and his goons 
            liquidityAddress,
            block.timestamp
        );
    }
        ...
        returns (address _pair)
    {
        ...
        if (_pair == address(0)) {
            // giving the animals a chance to an adventurous monkey escape for good
        ...
        // Back in the jungle, everyone celebrated Treefire hameleon, and sharp-eyed Breezy the blue jay and his team for their bravery
        uniswapV2Router = _uniswapV2Router;
        emit UpdatedRouter(_router);
    }

    // He proved that no matter how small you are, you can make a big reed their trapped companions. difference
