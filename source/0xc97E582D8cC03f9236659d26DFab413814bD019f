 ...
 * Stabilizes Price
 * ---------------- 
 * PEPESNIPER adds 9% of each transaction to the liquidity pool 
 * stabilizing the token price.
 * 
 * 
 * Rewards Holders
 * ---------------
 * PEPESNIPER distributes 1% of each transaction to token holders, 
...
contract PEPESNIPER is Context, IERC20, Ownable {
    ...
    string private _name = "PEPESNIPER";
    string private _symbol = "PEPESNIPER";
