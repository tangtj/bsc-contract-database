...
contract FLAMINGOBINANCE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FLAMINGO BINANCE";
    string private constant _symbol = unicode"$FLM";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 65000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xb1b502510dbD1061A2D011A38611E36f57E7E0Ba);
    address payable public MarketingWallet = payable(0x6e8a516cea2bD7EEeD2C5eE9F0aB3aca92534fDF);
