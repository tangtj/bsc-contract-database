...
contract DiabloIV is Context, IERC20, Ownable {
    ...
    string private _name = "Diablo IV"; 
    string private _symbol = "DIABLO"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf65b0828aD7dc10B1FfD2FccaC5b61cd35b53d18); 
    address payable public teamWalletAddress = payable(0xf65b0828aD7dc10B1FfD2FccaC5b61cd35b53d18); 
