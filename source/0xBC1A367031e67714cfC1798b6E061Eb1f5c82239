...
contract NBNBTOKEN is Ownable {
    address public daxxaz15;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "NBNB";
    string private _cctokensymbol = "NBNB";
