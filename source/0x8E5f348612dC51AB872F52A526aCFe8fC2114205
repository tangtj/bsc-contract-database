...
contract MONEY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x54eaA8b4A6DA8De4352855C28BC0884C10ACf599); 
    address payable public Wallet_Dev = payable(0x54eaA8b4A6DA8De4352855C28BC0884C10ACf599);
    ...
    constructor () {
        _owner =0x54eaA8b4A6DA8De4352855C28BC0884C10ACf599;
