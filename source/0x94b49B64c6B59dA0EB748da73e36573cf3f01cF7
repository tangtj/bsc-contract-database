//𝕏 PEPE  https://t.me/+0FUT6ubHT7Q5Yjgx 🐸
...
contract XPEPE is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"𝕏 PEPE", "xPEPE") {
        ...
        uint256 totalSupply = 1_000_000_000 * 1e18; // 1.000.000.000 Total Supply

        maxTransactionAmount = 15_000_000 * 1e18; // 
        maxWallet = 15_000_000 * 1e18; // 2% 
        ...
        marketingWallet = address(0x5A91f5159B6EcE42340D8F08A7e735429d8671d2); // set as marketing wallet
        devWallet = address(0x5A91f5159B6EcE42340D8F08A7e735429d8671d2); // set as dev wallet
