...
contract SHUINEKO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SHUINEKO";
    string private constant _symbol = unicode"$NEKO";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 9000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x95cb39a421c912cAa3fb9003Cd540A33620FAaCa);
    address payable public MarketingWallet = payable(0xe5141AeEEade87F116dC0A3b3448b1Fc166BEBcD);
