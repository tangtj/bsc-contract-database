...
contract PEPEUFO is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "PEPEUFO";
    string private _symbol = "PUFO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3E2777968a47E4990268779e8D25cE5Acd75643E);
    address payable public liqWalletAddress = payable(0xCB71Be8092ec9cc3Ea937AFB4f85A54Dbe46Ca82);
