...
//TELEGRAM: https://t.me/tigeriumchain
...
contract Tigerium is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 210000 * 10**_decimals;
    uint256 public maxBuyAmount = 210000 * 10**_decimals;
    uint256 public maxWalletBalance = 210000 * 10**_decimals;

    address public marketingAddress = 0x837a94D099cAb81DeF45881291Be98bED7F776f1;
    address public devAddress = 0x837a94D099cAb81DeF45881291Be98bED7F776f1;
    ...
    Taxes public sellTaxes = Taxes(0,25,5,0);
