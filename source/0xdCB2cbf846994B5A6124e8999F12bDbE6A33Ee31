...
contract ShibariumKingX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ShibariumKingX";
    string private _symbol = "SKINGX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x5fc86AD0B0821892A7b81B9ec117119bc6E53a71);
