...
contract SPCToken is ERC20, CheckOper {
    ...
    uint256 constant public MAX_SUPPLY = 9e8 * 1e18; // the total supply

    EnumerableSet.AddressSet private _minters;

    constructor(address _operCon) ERC20('Sheep Swap Token v2', 'SPC') CheckOper(_operCon) {
        _mint(msg.sender, MAX_SUPPLY.mul(36).div(100));
    }
