...
💨 Welcome to the extraordinary world of APE EXHALATION - $APEX 

Prepare yourself for a wild adventure, following the footsteps of a clever, brave, 
and smoking monkey on its journey to success.
...
💨 Telegram : https://t.me/ApeExhalationOFC
...
contract APEEXHALATION is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "APE EXHALATION";
    ...
    address payable public DevWallet = payable(0x2199058a45B61f0Db20dcd5104d08BCc8815591c);
    address payable public MarketingWallet = payable(0xE1656F342F47C1f4A11ae5eE98Facb1c13e6fBfc);
