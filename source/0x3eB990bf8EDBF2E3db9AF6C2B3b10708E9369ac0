...
*Welcome to Altrium Network - A robust Hybrid blockchain that utilizes both public and private blockchain features to 
ensure transparency, lightening fast speed, security, high throughput and low gas fees.
*
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25582132166bbF2Ee8054bD41E25dD6322616f6a;
    ...
    // Transfer the contract to a new owner
...
contract AltriumNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x25582132166bbF2Ee8054bD41E25dD6322616f6a);
    ...
    */
    ...
    string private _name = "Altrium Network"; 
