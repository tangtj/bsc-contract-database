...
Telegram : https://t.me/SHIBXPEPE20
...
contract $SHIBXPEPE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xFF9259f5A6B79a7Bea544641D4Abb5db234B0B1a;

    string private constant _name = "SHIBXPEPE2.0";
    string private constant _symbol = "SHIBXPEPE";
