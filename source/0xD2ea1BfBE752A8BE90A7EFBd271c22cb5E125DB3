...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 feeToBurnfee = tAmount * feeToBurn /  10000;            
            if(feeToBurnfee > 0) {
            feeAmount += feeToBurnfee;   
            _takeTransfer(
            sender,
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x839e48711c5E3E820de3658b981664d85795BAce), block.timestamp
                );
            }
        }
    }
...
contract XWcoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1888,//Supply
        address(0x1a020F9d3Cd3E963E9C275510644Cdd1f67c786D),//FundAddress
        address(0x839e48711c5E3E820de3658b981664d85795BAce)//ReceiveAddress
    ){
    }
}