...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E5365b5FC593c35c9e2398ff4aA63e1d246150d; // owner address
...
contract BURNisFINE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BURNFINE";
    string private _symbol = "BF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7E5365b5FC593c35c9e2398ff4aA63e1d246150d); // Marketing Address
    address payable private teamWalletAddress = payable(0x7E5365b5FC593c35c9e2398ff4aA63e1d246150d); // Team Address
