/*
Telegram : https://t.me/AiTraderbsc
Website : https://ai-trader.cc
*/
...
contract AITRADER is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfB77456C8F6415BCe0e6006C9ae0dBaB4D59B770); 
    address payable public Wallet_Dev = payable(0x42958C52297999beE8fFeFCf4850115a5D2a9430);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "AI TRADER"; 
    ...
    constructor () {
        _owner =0x42958C52297999beE8fFeFCf4850115a5D2a9430;
