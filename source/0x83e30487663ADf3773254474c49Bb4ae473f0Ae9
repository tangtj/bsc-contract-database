...
contract Foxx is Context, IERC20, Ownable {
    ...
    string private constant _name = "FOXX";
    string private constant _symbol = "FOXX";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xa8d9Ebf53FcB609bB7A1DcF0D23FF79d8d66C78A);
    address payable private _marketingAddress = payable(0xa8d9Ebf53FcB609bB7A1DcF0D23FF79d8d66C78A);
