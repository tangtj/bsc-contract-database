...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x79922e567Cf45B5deACF06A6374d331771e1e4a7; // owner address
...
contract CCCDDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCDDS";
    string private _symbol = "CCCDDS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x79922e567Cf45B5deACF06A6374d331771e1e4a7); // Marketing Address
    address payable private teamWalletAddress = payable(0x79922e567Cf45B5deACF06A6374d331771e1e4a7); // Team Address
