...
contract CMOONREF is Context, IERC20, Ownable {
    ...
    string private _name     = "CryptoMoonShots Referral";
    string private _symbol   = "$CMOONREF";
    ...
    {        
        ...
        marketingWallet = 0xF3FB36a722F5c50D79A38D3164A7254F013678E9;
...
function _transfer(
    ...
    // Only the owner can initiate transfers from one wallet to another
    if (msg.sender == owner()) {
