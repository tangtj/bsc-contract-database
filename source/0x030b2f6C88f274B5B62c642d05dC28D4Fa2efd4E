...
contract MoJo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02c33B9704666BE798b2C5B9e7965090051803B9); 
    address payable public Wallet_Dev = payable(0xa20A9ceF3dB2f26531cfb7E5524eE586b96D206b);
    ...
    constructor () {
        _owner =0xa20A9ceF3dB2f26531cfb7E5524eE586b96D206b;
