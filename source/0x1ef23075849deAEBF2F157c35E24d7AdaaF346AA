        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x73d4f52C22deF1B270Add456ee8D3E6F354fb186), block.timestamp
                );
            }
        }
    }
...
contract BinanceCatCoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0x88A89DCd89B4a2600d7e8Df08de7981eC272E278),//FundAddress
        address(0x73d4f52C22deF1B270Add456ee8D3E6F354fb186)//ReceiveAddress
    ){
    }
}