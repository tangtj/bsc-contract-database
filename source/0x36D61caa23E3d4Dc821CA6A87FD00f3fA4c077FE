...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95dC1DB55271eFF6EDD4C4c4f21AF157AB173DC3; // owner address
...
contract CCDSS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDSS";
    string private _symbol = "CCDSS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x95dC1DB55271eFF6EDD4C4c4f21AF157AB173DC3); // Marketing Address
    address payable private teamWalletAddress = payable(0x95dC1DB55271eFF6EDD4C4c4f21AF157AB173DC3); // Team Address
