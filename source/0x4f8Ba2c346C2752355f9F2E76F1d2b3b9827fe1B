...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "POLYGON") {
        marketingWallet = payable(0x178392331eAB22834B22Ab8C5E0B278404959459);
...
contract TestDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Test_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Testcontract."
        );
    }
