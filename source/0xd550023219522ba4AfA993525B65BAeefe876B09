...
contract DB is Context, IERC20, Ownable {
    ...
    { 
        ...
        totalBuyFees = taxFeeonBuy + liquidityFeeonBuy + marketingFeeonBuy + buybackFeeonBuy;
        totalSellFees = taxFeeonSell + liquidityFeeonSell + marketingFeeonSell + buybackFeeonSell;

        marketingWallet = 0xFb2e366FB37C70Cd4C63a42056DE2B119C8C1A6d;
        buybackWallet = 0x12b2C5f097A548f99297d8Ef42d8dEffd8e26F29;
        ...
        _isExcludedFromFees[address(0x8e43038EC16fe875f6a6dCE321D0e6B8ce7de442)] = true;
        ...
        _rOwned[address(0x8e43038EC16fe875f6a6dCE321D0e6B8ce7de442)] = _rTotal;
        _tOwned[address(0x8e43038EC16fe875f6a6dCE321D0e6B8ce7de442)] = _tTotal;

        emit Transfer(address(0), address(0x8e43038EC16fe875f6a6dCE321D0e6B8ce7de442), _tTotal);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 totalShare = marketingShare + liquidityShare + buybackShare;
            if(totalShare > 0) {
                if(liquidityShare > 0) {
    ...
    function swapAndSendBuyBack(uint256 tokenAmount) private {
        ...
        payable(buybackWallet).sendValue(newBalance);
