 ...
 *   Telegram:
 *   https://t.me/MemeMMGAPortal
 *   
 *   Twitter:
 *   https://twitter.com/thememeMMGA
 *   
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public token = address(0x76ebFACa030ede799C7cCBc3F22910392Ef13A49); // Clown Coin
...
contract MMGA is ERC20, Ownable {
    ...
    constructor() ERC20("MemeLeon", "MMGA") {
        
        address newOwner = address(0xdeB1c16bb2675dB000B978aB7E4647057ea44660);
    
        uint256 totalSupply = 1000000000000 * 10**18;
        
        maxTransactionAmount = totalSupply * 2 / 100; // 1% max transaction in the first 24hours
    	...
    	marketingWallet = address(0xd8d4921e355B8A2F2A829AD35fE2a6178937E631);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 10, "Must keep fees at 20% or less");
    }
    ...
    function updateRewardToken(address newReward) external onlyOwner {
        dividendTracker.updateRewardToken(newReward);
        token = newReward;
    }   
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xdeB1c16bb2675dB000B978aB7E4647057ea44660),
            block.timestamp
        );
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 1 * (10**16); //must hold 0,01% tokens
    }
