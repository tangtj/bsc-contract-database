/**
   ...
   Welcome to PitMunchkin
   
   This is a community token. If you want to create a telegram I suggest to name it to @PitMunchkinBSC
   ...
   I will renounce the ownership to burn addresses to transfer #PitMunchkin to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #PitMunchkin 10000X? 
   ...
   it's the best part of the #APELAMBO idea, increasing the liquidity pool automatically, 
...
contract PitMunchkin is Context, IERC20, Ownable {
    ...
    string private _name = "PitMunchkin";
    string private _symbol = "Munchkin";
