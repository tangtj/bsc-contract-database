...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0xE046B1AA4281ccc58b1c1e741D79fb3332eBde05;
...
contract Nvidia is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Nvidia", "NVIDIA", 9) {
    _owner = msg.sender;
    _totalSupply = 3333 * (10**9);
