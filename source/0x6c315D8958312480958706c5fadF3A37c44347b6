...
contract Bitcinerate is ERC20, Ownable {
    ...
    constructor() ERC20("Bitcinerate", "Bitcinerate") {
        marketingWallet = payable(0x4a7d38491aeD1C42BbcE89584faE3f84D921Bf99);
        CommunityWallet = payable(0xD94327781921194E5dd722DE51e88e0417656356);
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 80, "Protection");
...
contract BitcinerateDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        minimumTokenBalanceForAutoDividends = 21000000_000000000000000000; // 21000000 tokens
