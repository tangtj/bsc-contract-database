...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1080382D5eEFE156936349444e5506Ea3D801f11; // owner address
...
contract XBEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"xBear";
    string private _symbol = unicode"xBEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1080382D5eEFE156936349444e5506Ea3D801f11); 
    address payable public teamWalletAddress = payable(0x58d41f69F30Afe8F89797A9ddFE1eAB57b798876);
