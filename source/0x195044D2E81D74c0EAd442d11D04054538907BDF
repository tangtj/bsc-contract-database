...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x957c977be73aC939427c32d219f866097daec48c;
...
contract PepeFire is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Pepe Fire", "PEPEFIRE", 9) {
    _owner = msg.sender;
