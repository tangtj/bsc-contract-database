// t.me/PrimeNumbersEcosystem 
// PrimeNumbersEcosystem.com
...
contract PrimeNumbersEcosystem is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "PrimeNumbersEcosystem";
    string public symbol = "PRNT";
