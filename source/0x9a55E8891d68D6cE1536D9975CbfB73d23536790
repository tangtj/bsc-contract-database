...
//   ✅website:https://bnb-tiger.xyz
//   ✅TG https://t.me/bnbtigerx2
//   ✅launch Today 08/08 23:00 UTC
...
contract BnbTigerX is IBEP20, Ownable {
    /*=== SafeMath ===*/
    using SafeMath for uint256;
    using Address for address;
    /*=== Endereços ===*/
    address private burnAddress = address(0xa8c36c06377A4401eA6fBd83c4993fBeB653E98d); // Endereço de Queima
    ...
    uint256 private _tSupply = 700000000 * _decimalFactor; // Supply Token
    ...
    uint256 private limitBurn = 1000000 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 28000000 * _decimalFactor; // 4% do Supply
    uint256 public maxBuyAmount = 28000000 * _decimalFactor; // 4% do Supply
    uint256 public maxSellAmount = 7000000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 7000000 * _decimalFactor; // 1% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Bnb Tiger  X";
    ...
    constructor() {
        ...
        _excludeFromFee[address(0xb06F86A7f39C4ce34754120FE14016C92A2EEAd9)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0xE4E376529EC53752EA07baf02C1D79DBE8489b0D)] = true; // Define Contrato como True para não pagar Taxas
        _excludeFromFee[address(0x6b60A528B9E7C7dECFc67Aec6BF837478883Bc88)] = true; // Define Contrato como True para não pagar Taxas
