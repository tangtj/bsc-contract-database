...
contract BscCallerisScam is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB7C38Dd0F395e34c932C327D004BFe335aD65bc5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BSC Caller Is Scam";
    string private _symbol = "BSC Caller Is Scam";
