        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xf983fF928F61c2c1832b09Bfb39a1Ee62b24748C), block.timestamp
                );
            }
        }
    }
...
contract DORKLORD is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0x64D834147eDe575B97Ac1AE487877dE936A9Fae6),//FundAddress
        address(0xf983fF928F61c2c1832b09Bfb39a1Ee62b24748C)//ReceiveAddress
    ){
    }
}