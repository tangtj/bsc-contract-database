...
contract BNCS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal =88880000 * 10 ** _decimals;
    string private constant _name = "BNCS";
    string private constant _symbol = "BNCS";
