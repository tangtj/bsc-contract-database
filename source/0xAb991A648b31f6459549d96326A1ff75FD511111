/**
 *Undertake token development (various model mechanisms)
 *TP, AVE wallet logo submission will be processed on the same day. Generation airdrop, high-definition poster video production, project official website construction, Dapp development, NFT casting
 *Telegram attracting people, attracting fans at Tencent conferences, writing white papers, audit reports, publishing domestic and overseas media newsletters... For more details, please contact us
 *Currency circle one-stop service
 * **Safe and reliable **24 hours online **Business WeChat: XDTG00 (A Brother Technology)
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 1699 * 10** Decimals;
        walletLimit =  1699 * 10** Decimals;
        ...
        holderRewardCondition = 3000 * 10 ** IERC20(FISTAddress).decimals();
...
contract Zero is AbsToken {
    constructor() AbsToken(
        ...
        address(0xC563c2A281da3C37366756D8a1EddE4eBc79De6c)//ReceiveAddress
    ){
