...
contract Heroic is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"HEROIC NANO";
    string private _symbol = unicode"$HEROIC";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x53878c21BFD1aC2fE540C65122EBA12a4634b66a);
    address payable private taxWallet2 = payable(0x53878c21BFD1aC2fE540C65122EBA12a4634b66a);
