...
contract ReverseBabyShibaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Reverse Baby Shiba Inu";
    string private _symbol = "Shiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x36712617a48Ca465BC5f67ce4D6051B486fE6C9a);
    address payable public teamWalletAddress =
        payable(0x66864efb00B79C28611E55221C124cFd6C4c3B82);
