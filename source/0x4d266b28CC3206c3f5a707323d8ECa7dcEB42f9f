...
contract DigitalGem is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2Ef6c920d64539de34303DdB5d9E7e27B2D90040;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "DIGITAL GEM";
    string constant _symbol = "$DIGIGEM";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xd4e9a73fe98Bf0Bbecce6765d908cf4F921f2949;
