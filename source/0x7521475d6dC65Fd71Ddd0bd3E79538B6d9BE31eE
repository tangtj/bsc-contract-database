...
contract Token is Governance, IERC20 {
    ...
    string private _name = "Hashverse"; 
    string private _symbol = "HVE"; 
    ...
    uint256[2] public _burnRate = [0,10];
    uint256[2] public _fomoRate = [0,0];
    uint256[2] public _operateRate = [0,0];
    uint256[2] public _marketRate = [0,0];
    ...
    //todo reward pool!
    address public _fomoPool = 0x000000000000000000000000000000000000dEaD;
    //todo burn pool!
    address public _burnPool = 0x000000000000000000000000000000000000dEaD;

    address public _operatePool = 0x000000000000000000000000000000000000dEaD;

    address public _marketPool = 0x000000000000000000000000000000000000dEaD;
