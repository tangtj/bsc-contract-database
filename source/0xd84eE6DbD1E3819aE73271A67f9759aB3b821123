...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #LittleP3gasus to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #LittleP3gasus 10000X? 
...
contract LittleP3gasus is Context, IERC20, Ownable {
    ...
    string private _name = "LittleP3gasus";
