...
contract Token is ERC20,Ownable,AccessControl {
    ...
    constructor()ERC20("Loser's Counterattack", "DS") {
        admin=msg.sender;
        fundAddrA=0x872fB48a688De36bb714c914a752e951f66378BE;
    ...
    function setFee(uint256 _buyfee,uint256 _sellfee)public onlyRole(MANAGER_ROLE){
        buyfee = _buyfee;
        sellfee = _sellfee;
    }
