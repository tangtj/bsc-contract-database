...
contract LionDance is Context, IERC20, Ownable {
    ...
    string private _name = "LionDance";
    string private _symbol = "LionDance";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8177C3f2d047c550C4a0D3C81a2bEF93E1A37eA1); // Marketing Address
    address payable public teamWalletAddress = payable(0xf54cd1d2271DC1657689De288B249725E0da095A); // Team Address
