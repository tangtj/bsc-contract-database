//Telegram: https://t.me/kintabit
//Website: https://kintabit.net/
//Twitter: https://twitter.com/KINTABIT_net
...
contract KINTABIT is ERC20, Ownable {
    ...
    constructor() ERC20("KINTABIT NETWORK", unicode"$KBIT") {
        ...
        maxTransactionAmount = 52 * 1e4 * 1e18; 
        maxWallet = 104 * 1e4 * 1e18; 
        ...
        devWallet = address(0x9070eaea529Dc0142Ae36E943991e9906cced770); 
