...
contract MrX is ERC20, Ownable {
    ...
    constructor() ERC20("Mr. X", "MrX") {
        ...
        marketingWallet = address(0x1380455F925c57c39599319f4a91aECAA1ddbECe); // set as marketing wallet
        devWallet = address(0x1380455F925c57c39599319f4a91aECAA1ddbECe); // set as dev wallet
