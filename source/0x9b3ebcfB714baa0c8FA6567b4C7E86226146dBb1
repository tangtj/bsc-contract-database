...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 500000 * 10000000** Decimals;
        walletLimit =  500000 * 10000000** Decimals;
...
contract ChongMingNiao is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        6666,//Supply
        address(0xe8f0B7676C45DB80f6A73b2614AfDBB464E00240),//FundAddress
        address(0xE5507BE9859BE4e1c63C09F5D197ACEbB7b1cB9F)//ReceiveAddress
    ){
