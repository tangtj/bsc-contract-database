...
contract MBP_NEXA_T4_IDO is Context, Ownable {
    ...
    uint256 private MINIMUM_MBP_HOLDING = 25_000 * (10**18);
    uint256 private MINIMUM_DKS_HOLDING = 300_000_000 * (10**18);
    uint64 private MINIMUM_STAKE_DAYS = 0;

    uint256 private MINIMUM_INVESTMENT = 13 * (10**18);
    uint256 private MAXIMUM_BUY_AMOUNT = 25 * (10**18);
    ...
    uint256 private HARDCAP = 75 * (10**18);
    ...
    uint256 private sale_start = 1695123600;
    uint256 private sale_end = 1695124500;
