...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2879a2cdf28C8e5b9cF005aE284B58feA65595f9; // owner address
...
contract iPhone15 is Context, IERC20, Ownable {
    ...
    string private _name = "iPhone 15";
    string private _symbol = "IOS15";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2879a2cdf28C8e5b9cF005aE284B58feA65595f9); // Marketing Address
    address payable private teamWalletAddress = payable(0x2879a2cdf28C8e5b9cF005aE284B58feA65595f9); // Team Address
