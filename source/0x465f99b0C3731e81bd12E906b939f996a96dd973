...
contract FINE2049 is ERC20, Ownable {
    ...
    string private constant _name = "FINE 2049";
    string private constant _symbol = "FINE2049";
    uint8 private constant _decimals = 9;

    bool private swapping;
    bool public tradingActive = false;

    address public marketingWallet = (0xd2cF54ac9Cbc349f887E38650fe5F58F6D94818e);
    ...
    constructor() ERC20(_name, _symbol, _decimals) {
        ...
        uint256 totalSupply = 2049000000000 * 10**decimals();
    ...
    function updateBuyFees(uint256 _marketing, uint256 _liquidity) external onlyOwner {
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee;
        require(buyTotalFees <= 25, "Must keep buy total fees at 25% or less.");
    }
