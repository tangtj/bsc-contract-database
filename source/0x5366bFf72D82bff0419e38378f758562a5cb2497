...
/**
Website:  https://whitetigerking.com/
Twitter:  https://twitter.com/WHTTGRKING
Telegram: https://t.me/WhiteTigerKingEN
*/
...
contract WHTTGRKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "White Tiger King";
    string private _symbol = "WHTTGRKING";
