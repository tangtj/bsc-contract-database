...
// https://twitter.com/DripMaxiCoin

// http://t.me/dripmaxicoin
...
contract MAXI is Ownable, ERC20 {
    ...
    string constant _name = "DRIP MAXI";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x3FfDFD772c16443C7C5B947C9cc5d182fF97cFEF;
