...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Initializes the contract setting the deployer as an initial owner.
     */
    constructor() {
    ...
    /**
     * @dev Returns true if the given address is an owner.
     */
     ...
     * Can only be called by an existing owner.
     */
    function addOwner(address newOwner) public virtual onlyOwner {
        require(_owners.length < 7, "Can't add more than 7");
        require(newOwner != address(0), "Ownable: new owner is the zero address");
        require(!_isOwner[newOwner], "Ownable: address is already an owner");
        _addOwner(newOwner);
    }
...
contract AIMatrix is ERC20, ERC20Burnable, Ownable {
