...
// ZAV the next gen layer1 on the blockhain

   // https://t.me/Zavelinnetwork
   // https://www.Zavelinchain.com
...
contract zavelin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Zavelin network";
    string private _symbol = "ZAV";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x51931f369845101323AA81fF54FDB55cd909Bbee); // Marketing Address
    address payable private teamWalletAddress = payable(0x51931f369845101323AA81fF54FDB55cd909Bbee); // Team Address
