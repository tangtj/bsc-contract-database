...
contract EPSTEINOID is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EPSTEIN REKT";
    string private constant _symbol = unicode"EPSTEINOID";
