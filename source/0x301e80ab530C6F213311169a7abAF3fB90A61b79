...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x458ed622140959fD5eBFdfe9F10f1fEE68eA53e4; // owner address
...
contract CCCGDSToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCGDS";
    string private _symbol = "CCCGDS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x458ed622140959fD5eBFdfe9F10f1fEE68eA53e4); // Marketing Address
    address payable private teamWalletAddress = payable(0x458ed622140959fD5eBFdfe9F10f1fEE68eA53e4); // Team Address
