...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit = 20490000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xD343F9779baf6E57617151ca4b4B500dc24e0c08), block.timestamp
                );
            }
        }
    }
...
contract a2049 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        20490000,//Supply
        address(0xD343F9779baf6E57617151ca4b4B500dc24e0c08),//FundAddress
        address(0xD343F9779baf6E57617151ca4b4B500dc24e0c08)//ReceiveAddress
    ){
    }
}