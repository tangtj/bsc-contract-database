...
contract VitaminBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"VITAMIN";
    string private _symbol = unicode"$VITAMIN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC5A6ebf324d333f9c561163d56eCF377a3B9f62e);
    address payable private taxWallet2 = payable(0xC5A6ebf324d333f9c561163d56eCF377a3B9f62e);
