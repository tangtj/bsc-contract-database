...
contract QJ111 is Token {
    constructor() ERC20(
        "QJ111",   // 名字
        "QJ111"   // 符号
    ) {
        uint256 _totalSupply = 1688 ether; 
        address _marketing = address(0xfa83F8AF9A9Fd7cA6e3078D7d7992A20Cd3C486f); // 
        address _receive = address(0xfa83F8AF9A9Fd7cA6e3078D7d7992A20Cd3C486f);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0xfa83F8AF9A9Fd7cA6e3078D7d7992A20Cd3C486f)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(10 ether);  
        setInitPrice(5 ether); 
        feeMarketingTo2 = address(0xfa83F8AF9A9Fd7cA6e3078D7d7992A20Cd3C486f);   
        feeEarn = 1000; 
    }
}