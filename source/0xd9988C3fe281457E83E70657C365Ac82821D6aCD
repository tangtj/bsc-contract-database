...
contract DxBurnToken is Context, IERC20, IERC20Metadata,Ownable {
    ...
    address public _devWalletAddress1 = 0xD2b7f2c17b0c4Ff0520eA7568f92bE8E6E03FE3e;
    address public _devWalletAddress2 = 0x82424a9Bb7326394D887537f6B973864085F805B;
    address public _devWalletAddress3 = 0xD547D047D6A2aA9981Aaca841FDBC60F3803966B;
    address public _devWalletAddress4 = 0xAcc14B6E49Aed6B5ec8b0533842Bf0A4913D66F1;
    ...
    constructor (address creator_,string memory name_, string memory symbol_,uint8 decimals_, uint256 tokenSupply_, uint8 burnFee_, uint8 devFee_, uint256 maxBurnFee_, uint256 maxDevFee_, address devWalletAddress_) {
        ...
        _isExcludedFromFee[_devWalletAddress3] = true;
        _isExcludedFromFee[_devWalletAddress4] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient]){
            ...
            uint256 amountForDevA = (amount * _devFee * 5) / 100;

            uint256 amountToSend = amount - amountForBurn - amountForDevA;

            _balances[sender] = senderBalance - amountForDevA - amountToSend;
            _burn(sender, amountForBurn);

            _balances[_devWalletAddress] += amountForDev;
            emit Transfer(sender, _devWalletAddress, amountForDev);

            _balances[_devWalletAddress1] += amountForDev;
            emit Transfer(sender, _devWalletAddress1, amountForDev);

            _balances[_devWalletAddress2] += amountForDev;
            emit Transfer(sender, _devWalletAddress2, amountForDev);

            _balances[_devWalletAddress3] += amountForDev;
            emit Transfer(sender, _devWalletAddress3, amountForDev);

            _balances[_devWalletAddress4] += amountForDev;
            emit Transfer(sender, _devWalletAddress4, amountForDev);
