//Project: Crypto Warz (WARZ)
//Web: https://cryptowarz.io/
...
contract WARZ is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x2C1F81A85AD5f10CA4C9D1D22D7cF19a0804DADA);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 5000 * 10**18;
    ...
    constructor () BEP20Detailed("Crypto Warz", "WARZ", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 1000 * 10**18 && _numTokensSellToFee <= 500000 * 10**18, "Threshold must be set within 1,000 to 500,000 tokens");
