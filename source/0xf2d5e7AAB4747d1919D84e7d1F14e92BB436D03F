...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x01095Aa45e68F004Babb55845313646323DE7B8F;
    }
}
...
contract BTCATM is Context, IBEP20, Ownable {
    ...
    string private _name     = "Bitcoin Secure ATM";
    string private _symbol   = "BTCATM";
