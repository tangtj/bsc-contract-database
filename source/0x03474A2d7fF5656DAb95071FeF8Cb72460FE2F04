...
// SPDX-License-Identifier: Unlicensed
 ...
 // Telegram : https://t.me/Quadrillionusdt
...
contract QUADRILLIONUSDT is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUADRILLION USDT";
    string private _symbol = "QUSDT";
