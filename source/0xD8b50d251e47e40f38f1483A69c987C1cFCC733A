/**
Telegram : https://t.me/morgannetwork
Website :https://morgannetwork.org
*/
...
contract MORGANNETWORK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBe1FD8ac7Beae6a22e76F6BD42912020a4ea880A); 
    address payable private Wallet_Dev = payable(0xBe1FD8ac7Beae6a22e76F6BD42912020a4ea880A);
    ...
    string private constant _name = "Morgan Network "; 
    string private constant _symbol = unicode"MORGAN"; 
    ...
    constructor () {
        ...
        _owner = 0xBe1FD8ac7Beae6a22e76F6BD42912020a4ea880A;
