...
FOLLOWING THE 2.0 TREND
LAUNCHING ON THE BINANCE SMART CHAIN
SUPPLY SHOCK
AI UTILITIES
$STAKING
*/

//https://bitshiba20.netlify.app/

//https://t.me/BitShiba20

//https://twitter.com/BitShiba20

//https://discord.com/invite/zAXSzJU8Ev
...
contract BitShiba20 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA4057009328B7E9674a1C0915CEd5be400383C44); 
    address payable public Wallet_Dev = payable(0xA4057009328B7E9674a1C0915CEd5be400383C44);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "BitShiba2.0"; 
    ...
    constructor () {
        _owner =0xA4057009328B7E9674a1C0915CEd5be400383C44;
