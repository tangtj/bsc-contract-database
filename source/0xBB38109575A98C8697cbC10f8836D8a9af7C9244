...
contract APEBOTTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "APEBOT";
    string private _seitokensymbol = "APEBOT";
    address public faazj8;
