/*  
AI Hoshino Token ($AIHOSH): Embark on a Journey with Hoshino, Your Virtual Companion on the Binance Smart Chain

Introducing AI Hoshino Token: Where Imagination Meets Blockchain. Experience the enchantment inspired 
by our beloved cartoon character, brought to life on the blockchain. Join us as we merge creativity, 
innovation, and the magic of technology to create a unique and captivating world. Unveil the story 
of AI Hoshino, where your journey becomes a part of the legend.


Website  :https://aihoshino.online
Twitter  :https://twitter.com/AIHOSHBSC
Telegram :https://t.me/HoshinoBSC                                                                                                                                                     
 */
...
contract Hoshino is Context, IERC20, Ownable {
    ...
    string private _name     = "AI Hoshino Token";
    string private _symbol   = "AIHOSH";
    ...
    {        
        ...
        marketingWallet = 0x003F6407050605aA42049D53bC58051bF92fe046;
