...
contract ChatGPTisDopeToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChatGPTisDope";
    string private _symbol = "DOPE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x26061e9EC39EE89E8441696368340Eae5d8B26ca); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8ECBFc524631e3628a19be92cb343fA599A39912); // BuyBack Address
