...
contract SHIBADORK is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBA DORK";
    string private constant _symbol = "SHIDORK";
    ...
    address payable private _twdmkt = payable(0xCD90Ccc6526bc3A4Ee6ea0C2dBd1977A003BE1E4);
    address payable private _twddev = payable(0xCD90Ccc6526bc3A4Ee6ea0C2dBd1977A003BE1E4);
