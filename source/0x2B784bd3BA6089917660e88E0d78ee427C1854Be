...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _limitAmount = LimitAmount * 1000 ** Decimals;
        _txLimitAmount = TxLimitAmount * 1000 ** Decimals;
            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0x78852bd1bd545f865330dF4A544D38a51F918CFd), destroyAmount);
                    }
                }
...
contract  ABCD is AbsToken {
    constructor() AbsToken(
        ...
        address(0x78852bd1bd545f865330dF4A544D38a51F918CFd),
        address(0x78852bd1bd545f865330dF4A544D38a51F918CFd),
