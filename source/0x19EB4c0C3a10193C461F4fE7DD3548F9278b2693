...
contract SpacePunks is Context, IERC20, Ownable { 
    ...
    string private _name = " SpacePunks"; 
    string private _symbol = "SpacePunks"; 
    ...
    address public devWallet = 0xF8C30fBF117b46De4EB17CfeB265676A105ee118; 
