...
contract BOOKZILLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "BOOKZILLA"; 
    string private constant _symbol = "BKZLL"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 20;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0x400bbB20Ff8086aB444C0e140D7158c1231ddba9; 
