/**
https://t.me/harrypepebsc
https://x.com/Harrypepetoken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa6b5D375bde6Ef681c315e06967fDF9cA3Ca75A2; 
...
contract HarryPepe is Context, IERC20, Ownable {
    ...
    string private _name = "Harry Pepe";
    string private _symbol = "HAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa6b5D375bde6Ef681c315e06967fDF9cA3Ca75A2); 
    address payable public teamWalletAddress = payable(0xa6b5D375bde6Ef681c315e06967fDF9cA3Ca75A2); 
