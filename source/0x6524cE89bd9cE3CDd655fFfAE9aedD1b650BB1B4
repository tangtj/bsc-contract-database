/*
Telegram      : https://t.me/Zephyriumswap
Website     : https://zephyriumswap.online/
...
contract ZephyriumSwap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zephyrium Swap";
    string private _symbol = "$ZPRUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd577799555e5289417089526697bCF4E9Caad6c); // Marketing Address
    address payable public teamWalletAddress = payable(0xcd577799555e5289417089526697bCF4E9Caad6c); // Team Address
