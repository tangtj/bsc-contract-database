...
contract FixLP {
    address payable public feeRecipient = 0x136f64157724Fe9AA9696a12a4873C110aB26A98;
    uint256 public feeAmount = 0.02 ether;  // 0.02 BNB fee, using the ether unit for simplicity in Solidity.
