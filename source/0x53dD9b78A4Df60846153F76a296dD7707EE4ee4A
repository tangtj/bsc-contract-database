...
Telegram : https://t.me/NIMMI_TOKEN
Website : Website will be announced in the community

Nimmi, a revered warrior cat from Feliya, defeated the invading Shadowclaw Clan singlehandedly, solidifying her legacy.
Now, she trains new warriors, bolstering Feliya's defenses. Her extraordinary tale continues to inspire.
...
contract NIMMI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xfbF1fF44ca0A7f4cEaf49c96747D9F7dEDc3D8AC); // In Feliya, the warrior cat Nimmi was known for her bravery and hunting skills
        
    address payable public teamAddress =
        payable(0xfbF1fF44ca0A7f4cEaf49c96747D9F7dEDc3D8AC); // So, in Feliya, there was this badass warrior cat named Nimmi, right?
        
    address payable public liquidityAddress =
        payable(0xfbF1fF44ca0A7f4cEaf49c96747D9F7dEDc3D8AC); // She was a total boss, known for her crazy bravery and sick hunting skills.
        
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD; // She got her training from Aspenclaw
    ...
    string private constant _name = "NIMMI";

    string private constant _symbol = "$NIMMI";
    ...
    uint256 public tradingActiveBlock = 0; // the big cheese of the Silverheart Clan
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 7 / 10000; // and she got really good
    ...
    if(!tradingActive){
     ...
     if(limitsInEffect){
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // her nosiness got her into a scrap with the Shadowclaw Clan
    ...
    function swapBack() private lockTheSwap {
        ...
        // a bunch of greedy cats who wanted to take over Feliya. 
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // Even though she was totally outnumbered
            path,
            address(this),
            block.timestamp
        );
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0, // Nimmi’s guts flipped the script
            0, // and won the fight for the Silverheart Clan
            liquidityAddress,
            block.timestamp
        );
    }
        ...
        returns (address _pair)
    {
        ...
        if (_pair == address(0)) {
            // After that, she was a total rockstar
        ...
        // inspiring other cats with her courage
        uniswapV2Router = _uniswapV2Router;
        emit UpdatedRouter(_router);
    }

    // Nimmi trained up the next generation of warriors and beefed up Feliya's defenses, making sure it was safe
    // Her epic story became a source of motivation and inspiration.
