...
contract HarryPepe  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x38251777ffe59Da5bD3bbEb469660F8558748ca2); 
    address payable public Wallet_Dev = payable(0x38251777ffe59Da5bD3bbEb469660F8558748ca2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5200* 10**9* 9**10 * 10**_decimals;
    string private constant _name = "Harry Pepe"; 
    string private constant _symbol = unicode"HarryPepe"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 80 / 80;
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal * 80 / 80; 
    ...
    constructor () {
        _owner = 0x38251777ffe59Da5bD3bbEb469660F8558748ca2 ;
