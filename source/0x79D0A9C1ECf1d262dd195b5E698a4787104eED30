/**
https://t.me/XHIBARIUMOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEc23BcCBeed687B11b9aa8E438F599eBCfA4449F; // owner address
...
contract XHIBARIUMOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XSHIBARIUM";
    string private _symbol = "$XRIUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcCAa2D74eF65fB305e9eD5FDCf98141EF5CB4dea); // Marketing Address
    address payable private teamWalletAddress = payable(0xEc23BcCBeed687B11b9aa8E438F599eBCfA4449F); // Team Address
