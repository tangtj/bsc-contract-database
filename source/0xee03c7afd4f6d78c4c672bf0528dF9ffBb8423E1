...
interface IDEXRouter {
 ...
 contract   XCRYPTO  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "XCRYPTO";
    string constant _symbol = "XC";
    ...
    address public devFeeReceiver = 0x69dE9902Eb60AD4dCc9A9cfe9649162439538c82;
    address public buybackFeeReceiver = 0x69dE9902Eb60AD4dCc9A9cfe9649162439538c82;
