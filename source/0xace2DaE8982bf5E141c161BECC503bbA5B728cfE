...
contract SeiCloud is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SeiCloud", "SeiCloud") {
        ...
        marketingWallet = address(0x2CF3612fF0De93CbeeACB4B05A0d2Fb249A0e622); // set as marketing wallet
