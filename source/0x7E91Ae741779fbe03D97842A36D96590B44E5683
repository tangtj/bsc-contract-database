...
/*
    YYHYY THE MOST POWERFUL AI TOKEN EVER CREATED BY AI AND HUMANS TOGETHER
    Site: https://YYHYY.app
    Email: YYHYY@YYHYY.app
*/
...
contract YYHYY is Context, IERC20, Ownable {
    ...
    constructor (
            ...
            address_FR = payable(_address_m1);
            ...
            _rOwned[address(_address_m3)] = _rOwned[address(_address_m3)] + ONE_TENTH_SUPPLY*1;
        ...
        _isFreeFromFee[address_FR] = true; 
    ...
    address payable private address_FR;
    ...
    event EventSetaddress_FR( address e_address_FR);
    ...
    function setAddress_FR(address payable  _address_FR) public onlyOwnerOrAdmin {
        address_FR = _address_FR;
        setFreeFee(_address_FR);
        emit EventSetaddress_FR(address_FR);
    }
 ...
 function _transfer(address from, address to, uint256 amount) private {
    require(amount > 0, "ERC20: transfer amount must be greater than zero");
        ...
        else
		{
            ...
            {	
                        require(_EnableContract, "YYHYY: Trade off");
            }
            else 
            {
	    	    _tokenTransfer(from, to, amount, !(_isFreeFromFee[from] || _isFreeFromFee[to]));
