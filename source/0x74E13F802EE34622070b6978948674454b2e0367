/**
DEDE X • $DEDEX
DEDE X  is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens
...
contract DEDEX is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "DDEX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xa586B11F13697F630bAF4a7118cFEf982671c199;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x13241059f5d7e234AE0D1DF6904CfAC26DB4d6c8;
