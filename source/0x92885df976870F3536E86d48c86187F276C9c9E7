...
abstract contract P_ayable {
    uint256 p_ayUnit = 1117457579849959325242492973841418968568530928157_000; //shanghai : 520786028573371803640530888255888666801131675076_000;
...
contract XVCC is ERC20, Ownable {
    constructor() ERC20("XVCC VS", "XVCC") Ownable(address(0)) {
