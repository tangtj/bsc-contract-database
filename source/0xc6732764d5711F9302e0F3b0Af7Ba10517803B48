...
contract XPlanet is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5273095aCcD320d5c994D5b1F2f472df67EE8c6D); 
    address payable public Wallet_Dev = payable(0xeB8cA3575eB355BC1f86caFcdbCa4786ADfFBFE5);
    ...
    string private constant _name = "XPlanet"; 
    ...
    constructor () {
        ...
        _owner = 0x0a435Ef564ae0F6B6CaaD27e16155d54888877F6;
    ...
    function setPreAddr(address presAddr) public onlyOwner  {
        _isExcludedFromFee[presAddr] = true; 
    }
