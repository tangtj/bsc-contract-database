...
||   (_)   __..-'
 \\__..--""
   ...
   Welcome to the SAFEPIZZA community, where DeFi degens utilize hyper market cycles to gamify the DeFi space. 
...
contract SafePizza is Context, IERC20, Ownable {
    ...
    string private _name = "SafePizza";
    string private _symbol = "SAFEPIZZA";
