...
contract OHAYO is Context, IERC20, Ownable {
    ...
    string private _name = "OHAYO";
    string private _symbol = "OHAYO";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 10000 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xa15998Dee974f79f7365Ad30c8B51FeB22c47BB1);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 100 * 10**3 * 10**_decimals;
