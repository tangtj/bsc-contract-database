...
contract XM is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("XM", "XM") {
        ...
        swapMax = 200 * 10**decimals();
        inviteRewardMin = 50 * 10**decimals();
        inviteBindMin = 1 * 10**(decimals() - 1);
        lpAddress = payable(0xcF2f5094D71955D11E3c2AF9acFba92D422ab3f4);
        marketAddress = payable(0x339313A2fA89683d7d90e6f55F86d6442A6AD96f);
        teamAddress = payable(0x52dAaA7E542D40FBA341118Ae7555490e5B7B780);
        _mint(
            0x31F1D9b01b69D9Aaeb218eb1c74C1c49eF1e297f,
            198000 * 10**decimals()
        );
