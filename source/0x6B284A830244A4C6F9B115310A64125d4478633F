...
// Telegram : https://t.me/GOOFYBEP20
// Twitter : https://twitter.com/GOOFYBEP20
...
contract GOOFY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 75_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 800_000_000 * 10**_decimals;
    uint256 public maxTxAmount = 75_000_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 75_000_000_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x2555615e12eAfBa4fB7aDf14651f5523b5658126;
