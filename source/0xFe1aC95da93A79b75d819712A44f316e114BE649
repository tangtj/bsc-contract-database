...
// Telegram : https://t.me/OxchainPortal
// X        : https://x.com/Oxchain_
// Website  : https://oxchain.net/
...
contract Oxchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oxchain";
    string private _symbol = "OXC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAcAa96878ECe26dAe96FE2Ca9D665b673e93f0B4); // Marketing Address
    address payable public teamWalletAddress = payable(0xed97e3C11AEf7192DCDc1e0DE7e5c5f78e7575Af); // Team Address
