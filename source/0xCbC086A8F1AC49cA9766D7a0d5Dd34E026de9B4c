...
//https://t.me/comingsoon
//https://twitter.com/comingsoon
interface IERC20 {
...
contract pixelpenny is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb7604Cf57f0E712A2399DcdF19E3652151AE85c4); 
    address payable public Wallet_Dev = payable(0xb7604Cf57f0E712A2399DcdF19E3652151AE85c4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "pixelpenny"; 
    string private constant _symbol = unicode"pipeny"; 
    ...
    constructor () {
        _owner =0x8F7513daa6a0c36577D88DD71D7c7E7113C443D7;
