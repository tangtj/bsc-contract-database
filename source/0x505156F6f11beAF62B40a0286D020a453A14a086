...
/**
   ...
   Welcome to BabyWhaleBSC
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyWhaleBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BabyWhale to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BabyWhale 10000X? 
   ...
   it's the best part of the #BabyWhale idea, increasing the liquidity pool automatically, 
...
contract BabyWhale is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = 'BAWH';
    _decimals = 9;
    _totalSupply = 1*10**14 * 10**9; //100m
