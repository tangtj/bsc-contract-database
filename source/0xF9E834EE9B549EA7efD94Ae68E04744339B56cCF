...
/**
   #StarCA$H
   7% fee auto moved to Liquidity Pool
   3% fee auto moved to Marketing Wallet
   We have the best Liquidity protocol
 */
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x9B62249e1eFF946B628685D7AF7Af1d83E76A5fE;
...
contract StarCash is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x9A6341B4a3D6B72CF8a9eEe2094fCBDa3E601379;
    ...
    string private _name = "StarCash";
    string private _symbol = "StarCash";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x9B62249e1eFF946B628685D7AF7Af1d83E76A5fE, 'We can not exclude Uniswap router.');
