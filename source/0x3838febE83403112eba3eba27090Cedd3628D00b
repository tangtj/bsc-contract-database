...
contract Round is BEP20, Ownable {
    ...
    address public marketingWallet = 0x46E15fBE560a0230073D95d090CD36703946bC2e;
    address public opsWallet = 0x6fad014fEBd8C0b6523b17eD4Dd5dc81f0D0B1d6;
    address public devWallet = 0xDDF66E3200Da6430C7A01d61C1c4e3263C7914aF;
    address public treasuryWallet = 0xCB32E80F1Abb72a4Fb067A9af5F500038326C142;
    ...
    Taxes public taxes = Taxes(4, 1, 1, 1, 1);
    Taxes public sellTaxes = Taxes(4, 1, 1, 1, 1);
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 1_000_000, "Swap threshold amount should be lower or equal to 1% of tokens");
