...
contract TiggerInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0xaC03b51d19ba3A220AdCEe0755D1aA90b485fB30;
    ...
    // Supply 1 trillion
    constructor() ERC20("Tigger INU", "Tigger") {
        ...
        // supply 1 katrillion
        uint256 _supply = 100_000_000 * 10**18;
        // 0.5% MaxTx amount
        ...
        address _toBeOwner = 0x66598Cfd03CE704104Ff745A0391f5d654664390;
