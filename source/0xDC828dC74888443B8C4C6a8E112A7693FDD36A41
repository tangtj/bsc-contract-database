...
Telegram : https://t.me/EclypsiumOS
Website :  The Eclypsium OS 
💠Come and Explore The
💠 The Eclypsium OS |
💠Programming language for money 
*/
...
contract EclypsiumOS is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Eclypsium OS";
    string constant _symbol = "EOS";
