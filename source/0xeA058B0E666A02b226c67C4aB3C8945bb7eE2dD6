...
contract DevilDragon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"DEVIL DRAGON";
    string private _symbol = unicode"DRAGON";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xA20Ce80280Cda643e3B95947CC8D2F20083a7571);
    address payable private taxWallet2 = payable(0xA20Ce80280Cda643e3B95947CC8D2F20083a7571);
