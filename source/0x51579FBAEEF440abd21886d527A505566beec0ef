/**
 *Submitted for verification at BscScan.com on 2023-09-203
*/

/**
// telegram: https://t.me/tritaniumbsc
...
contract TRITANIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TRITANIUM L1 MULTICHAIN";
    string private _symbol = "$TRITANL1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34Ee09A774101cAE8E3e410036B0F2DE2e55845c); // Marketing Address
    address payable public teamWalletAddress = payable(0x34Ee09A774101cAE8E3e410036B0F2DE2e55845c); // Team Address
