...
Missed Everise? Missed EverMars ? Don't miss EverSpace !
...
contract EverSpace is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x201D9CF9fe9114A7e79bf7A33b72cE50979AFE92); // Marketing Address
    ...
    string private _name = "EverSpace";
