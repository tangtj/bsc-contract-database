...
//TELEGRAM: https://t.me/charmanderinu
interface IERC20 {
...
contract charmanderinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "charmanderinu";
    string private constant _symbol = "$charmanderinu";
    ...
    Taxes public taxes = Taxes(0,0,22,3);
    Taxes public sellTaxes = Taxes(0,0,22,4);
