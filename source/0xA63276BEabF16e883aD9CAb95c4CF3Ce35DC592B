...
contract SHITTYTOK is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x45a474F628842FB52552B7499e65690E9f557009;

    string private constant _name = "the shitty token";
    string private constant _symbol = "$shitty_token_bullish_chart_no_jeet_trust_it";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 1% reflection, 8% mkt
