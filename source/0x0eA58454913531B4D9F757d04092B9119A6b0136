// File: contracts/newContracts/Pancakeswap.sol
...
// File: contracts/newContracts/MandYoda.sol


/// Coded By Asic Services
///
///// MandYoda
...
contract TestYoda is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    ...
    constructor(address marketing) ERC20("TestMnd", "TMNYD") ERC20Permit("TMNYD") {
    ...
    function initializeProject() external onlyOwner {
        ...
        _approve(address(this), address(PancakeSwapV2Pair), type(uint256).max);
    ...
    function _getTotalTax(address sender, address recipient) internal returns (uint256) {
        ...
        if (isCEX[sender]) { return cexTransfer; }
