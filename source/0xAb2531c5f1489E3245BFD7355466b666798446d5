...
contract DEDEX is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x060aD835cd2339A0b733591560bB2B9BA99F46D8;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xAB69188532812dFBFC2D687009d5f24504C2E16c;
