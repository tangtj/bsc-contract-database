...
contract XDogeSei is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XDogeSei";
    string private _symbol = "XDS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xff4a13cF3fB2b30e75d2485e1903aD1C7b63Ee6B); // Marketing Address
    address payable public teamWalletAddress = payable(0xff4a13cF3fB2b30e75d2485e1903aD1C7b63Ee6B); // Team Address
