...
contract RUGPURE is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 1000 * _decimalFactor; // Supply Token
    uint256 public buyFee = 2; // Taxa de Compra
    uint256 private previousBuyFee; // Armazena Taxa de Compra
    uint256 public sellFee = 2; // Taxa de Venda
    ...
    uint256 public maxWalletBalance = 500 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 500 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 300 * _decimalFactor; // 0.75% do Supply
    ...
    /*=== Strings ===*/
    string private _name = "Rug x frog";
    string private _symbol =  "PURERUG";
    /*=== Modifiers ===*/
