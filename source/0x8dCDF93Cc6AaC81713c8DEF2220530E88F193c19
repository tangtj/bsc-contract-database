...
contract TEST5 is Context, IERC20, Ownable {
    ...
    uint256 private _maxWalletAmount = 1000000000000 * 10**18;
    ...
    // Check if the recipient is not the owner or development address
    if (to != owner() && to != _developmentWalletAddress) {
        // Check if the transfer amount exceeds the max wallet limit
