...
contract CATkiller is Context, IERC20, Ownable {
    ...
    string private _name = "312";
    string private _symbol = "312";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7697c1C79d9d6B4a00a01cf825a5069f8Fc9F369);
    address payable public teamWalletAddress = payable(0xA5085e724889c0E4825A6a88a069F57F2681C6E7);
