...
interface IDEXRouter {
 ...
 contract Dorkoge  is IBEP20, Auth { using SafeMath for uint256;
    ...
    address public devFeeReceiver = 0x216DFaaf2eaabd58dB5738Dc0d268F01809C917f;
    address public buybackFeeReceiver = 0x216DFaaf2eaabd58dB5738Dc0d268F01809C917f;
