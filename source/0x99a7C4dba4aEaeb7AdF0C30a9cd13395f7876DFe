...
contract BABYBNB is IERC20, Ownable {
    ...
    string _name = "BABY BNB";
    string _symbol = "$BABY BNB";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x211c1180d3C0914987c0782165fdbD7f1C0efAaf;
        marketingFeeReceiver = 0x211c1180d3C0914987c0782165fdbD7f1C0efAaf;
