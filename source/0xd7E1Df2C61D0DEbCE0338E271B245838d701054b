...
contract PEPEINU is IToken, Ownable {
    ...
    string private constant _name = "PEPEINU";
    ...
    uint256 public _maxTransactionAmount = 100 * 10**6 * 10**9;
    uint256 private _tokensToAddToLiquidity = 10 * 10**6 * 10**9;
