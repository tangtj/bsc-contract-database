...
contract LUMISHARE is Context, IERC20, Ownable {
    ...
    string private _name = "Lumi Share";
    string private _symbol = "$Lumi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62C3cDC851950774Ee11A94cf7Dd30194579b0A6); // Marketing Address
    address payable public teamWalletAddress = payable(0x62C3cDC851950774Ee11A94cf7Dd30194579b0A6); // Team Address
