...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 50; // 营销
    uint256 public _buyLPFee = 25; //回流
    uint256 public _buyLPDividendFee = 50; //lp分红
    uint256 public _buy_BackFee = 25; // 回购

    uint256 public _sellFundFee = 50; // 营销
    uint256 public _sellLPFee = 25;// 回流
    uint256 public _sellLPDividendFee = 50; // lp分红
    uint256 public _sell_BackFee = 25; // 回购
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xeE61e6215F0ee95eD76c35E9800833Ce760edbda;
...
contract QF is AbsToken {
    constructor() AbsToken(
        ...
        address(0x5Cd8af0859d234a030f8B592e6882579B16bCA52), // 营销钱包
    
        address(0xFb6E98d6145fc427A1fdDd934331a1DAc6E7064e), // 收币钱包

        address(0xEdF1aaB786F75398DfDC0734a5f064C24C4F1DE1), //回购代币合约
