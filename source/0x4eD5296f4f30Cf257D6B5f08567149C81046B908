...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buy_BackFee = 90; // 回购

    uint256 public _sellFundFee = 100; // 营销
    uint256 public _sellLPFee = 10;// 回流
    uint256 public _sellLPDividendFee = 90; // lp分红
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xe6f4BB13150ef9E03ba9150a07E9e8DBa144E490;
...
contract DiaoMao is AbsToken {
    constructor() AbsToken(
        ...
        address(0xa95Ecf63601532E024C379770fb83dC222057b89), // 营销钱包
    
        address(0xd6e749654Acb0B588a657549BdC76cd9B2174759), // 收币钱包
