...
// File contracts/RamenLPStrategy.sol

pragma solidity ^0.6.0;

/**
 * @dev Implementation of a strategy to get yields from farmingPools
 *
 * This strategy simply deposits whatever funds it receives from the vault into the selected MasterChef pool.
 * Rewards are farmed every few minutes
 ...
 */
contract RamenLPStrategy is Ownable, Pausable {
     ...
     * {wbnbToRamenRoute} - Route we take to get from {wbnb} into {ramen}.
