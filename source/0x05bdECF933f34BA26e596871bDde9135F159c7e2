...
contract Ajna is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ajna"; // 
    string private constant _symbol = unicode"AJNA";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1A2039D880b8EF2EC95f2024627146557d7df31e;
