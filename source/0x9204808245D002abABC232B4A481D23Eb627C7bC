...
contract BNBDragon is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNBDragon";
    string private constant _symbol = "BNBDragon";
    uint8 private constant _decimals = 9;

    address payable private _developmentAddress =
        payable(0x8FC85c864B420F5A4Ac3811861aBdFA556fa62E8);
    address payable private _marketingAddress =
        payable(0x9d2F1bDfFaDAA486B87Cb098e3EAC8529f46f661);
