...
contract XentralBlocX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x94b3f46692c8262b3C88575931b5757BF3bAACd0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4f798bCd6A8720fE1a8B87eC2B2bC11BCc4bA245); // BuyBack Address
    ...
    uint256 private _totalSupply = 500 * 10**5 * 10**9;
