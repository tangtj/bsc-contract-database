/**
// https://t.me/DOGVCATOFFICIALBSC
// https://twitter.com/DocatBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07bB0938b1FCF7347D756BC7166E468cb7151673; // owner address
...
contract DOGVCATOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogVsCat";
    string private _symbol = "$DOCA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCD696047f75F967c4919Bae97328EBD2812e5Ae7); // Marketing Address
    address payable private teamWalletAddress = payable(0x07bB0938b1FCF7347D756BC7166E468cb7151673); // Team Address
