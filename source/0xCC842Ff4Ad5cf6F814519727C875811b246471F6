...
contract PACO is Context, IERC20, Ownable {
    ...
    uint public presale = (_tTotal * 5) / 100;
    uint public mining = (_tTotal * 50) / 100;
    uint public loquidity_pool = (_tTotal * 5) / 100;
    uint public team = (_tTotal * 10) / 100;
    uint public marketing_and_development = (_tTotal * 10) / 100;
    uint public referral = (_tTotal * 5) / 100;
    uint public reserve = (_tTotal * 5) / 100;
    uint public bonus = (_tTotal * 5) / 100;
    uint public partnership = (_tTotal * 5) / 100;
    ...
    function withdrawMining(address _receiver) external onlyOwner {
        uint _mining = mining;
        mining = 0;
        _transfer(address(this), _receiver, _mining);
    }
    ...
    function withdrawReferral(address _receiver) external onlyOwner {
        uint _referral = referral;
        referral = 0;
        _transfer(address(this), _receiver, _referral);
    }
