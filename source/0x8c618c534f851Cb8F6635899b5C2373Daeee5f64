...
contract ABidC is ERC20, Ownable {
    ...
    address public teamWallet =
        address(0x251177e4626C45A1e8567E8dA6A946e26BA73E54);

    address public marketingWallet =
        address(0x8B2837fcaFAdD80d24C159dD910C201F06eC45Ce);
    address public Admin;

    uint256 _totalSupply = 1000000000 * 1e18;
    uint256 public maxTransactionAmount = (_totalSupply * 300) / 10000; // 3% from total supply maxTransactionAmountTxn;
    uint256 public swapTokensAtAmount = (_totalSupply * 1) / 10000; // 0.01% swap tokens at this amount. (1_000_000_000 * 1e18 * 1) / 10000 = 0.01%(100000 tokens) of the total supply
    uint256 public maxWallet = (_totalSupply * 300) / 10000; // 3% from total supply maxWallet

    bool public limitsInEffect = true;
    bool public tradingActive = true;
    bool public swapEnabled = true;

    uint256 public teamFees = 100;
    uint256 public marketingFees = 200;
    ...
    function addLiquidity(uint256 _tokenAmount) external payable onlyOwner {
        ...
        //Pancake Router Address BSC Mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        //Pancake Router Address on Polygon Testnet: 0x7a54bbb93d7982d7c4810e60dbf16974231E6130
        //Pancake Router Address on BSC Testnet: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function changeTeamMarketingFee(
        uint256 _teamFee,
        uint256 _marketingFee
    ) public onlyOwner {
        teamFees = _teamFee * 100;
        marketingFees = _marketingFee  * 100;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                fees = amount.mul(marketingFees).div(10000) + amount.mul(teamFees).div(10000);
            }
            // on buy
    ...
    function swapBack() private {
        ...
        if (contractBalance >= swapTokensAtAmount) {
            ...
            uint256 amountToTeam = amountEthToSend
                .div(3);
            ...
            revert NotEnoughTokensBeforeSwap();
        }
    }
}