...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x181986792d9346e1fa287e36F0fee1B105ea0DAA; // owner address
...
contract HOT is Context, IERC20, Ownable {
    ...
    string private _name = "HOT";
    string private _symbol = "HOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x181986792d9346e1fa287e36F0fee1B105ea0DAA); 
    address payable public teamWalletAddress = payable(0x181986792d9346e1fa287e36F0fee1B105ea0DAA);
