...
contract AlveXium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlveXium";
    string private _symbol = "$ALX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x08890c8607D4fcb98b48Dc2541430cF1a2Ab3e8f);
    address payable private DevelopmentWalletAddress = payable(0x08890c8607D4fcb98b48Dc2541430cF1a2Ab3e8f);
