...
contract KUKU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x783291025EF995dBF95B622cD26e6a529FD78674); // Marketing Address
    address payable public teamWalletAddress = payable(0xF65bBAe5cdF55688945dc4C4F5f539a4827eA8d2); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x5c05e9DBeA7f28e20419F2C945561cA9Ed391894),
            block.timestamp
        );
    }
