/**
  X   X   PPPP   L       OOO    RRRR   EEEE   RRRR  
   X X    P   P  L      O   O   R   R  E      R   R 
    X     PPPP   L      O   O   RRRR   EEE    RRRR  
   X X    P      L      O   O   R  R   E      R  R  
  X   X   P      LLLLL   OOO    R   R  EEEE   R   R 
*/

//Telegram: https://t.me/xplorer_announcement
...
contract Xplorer is ERC20, Ownable {
    ...
    constructor() ERC20("Xplorer", unicode"$Xbot") {
