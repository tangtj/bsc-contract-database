...
// TELEGRAM : https://t.me/bitblocknetwork
// WEBSITE  : http://www.bitblocknetwork.live

Testnet & Facuet live. Long term utility project
...
contract Bitblocknetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Bitblock Network";
    string private _symbol = "BIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x1E825B797004cEC30555A5D5920856a5727Bedc0);
    address payable public teamWalletAddress =
        payable(0x07D0eA01eFE8e79e10f6Cf0C64d3C5922159Cbf3);
