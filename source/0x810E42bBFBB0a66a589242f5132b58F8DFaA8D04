...
/**
Telegram: https://t.me/thoriumblockchain
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73218616403841EDF49e2269D650E0be65C6096D; // owner address
...
contract ThoriumBlockchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "THORIUM BLOCKCHAIN";
    string private _symbol = "THORIUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x73218616403841EDF49e2269D650E0be65C6096D); // Marketing Address
    address payable private teamWalletAddress = payable(0x73218616403841EDF49e2269D650E0be65C6096D); // Team Address
