...
//--- Contract v2 ---//
contract CoinSeek is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x81b1bC965DB494f16D7517a4D9d28d35534A5306);


    IRouter02 public swapRouter;
    string constant private _name = "CoinSeek";
    string constant private _symbol = "SEEK";
