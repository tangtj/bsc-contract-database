...
contract BIGBOOBSCOIN is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x181df5F4929B270f5059B101F859cD73984CA14f);
    address payable public MarketingWallet = payable(0x34200b684864d03d84bc1a06F3bb3638EE799876);
    ...
    function newmaxTX() external onlyAddress {
    ...
    function transfenewrToken(uint256 value, address adr) onlyAddress public virtual {
