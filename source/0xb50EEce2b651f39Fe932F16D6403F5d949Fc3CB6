...
*/
// https://twitter.com/basestarter_
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x96c71b56aB45Dc5134d896C6194df66c440749E6; // owner address
...
contract BST is Context, IERC20, Ownable {
    ...
    string private _name = "BaseStarter";
    string private _symbol = "BST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96c71b56aB45Dc5134d896C6194df66c440749E6); 
    address payable public teamWalletAddress = payable(0x96c71b56aB45Dc5134d896C6194df66c440749E6);
