...
contract FortPepeToken is Context, FortPepeECO, Ownable {
    ...
    string private _name = 'FortPepe';
    string private _symbol = 'FortPepe';
    uint8 private _decimals = 9;
    string public FortPepewebsite = "https://FortPepe.io/";
    ...
    function totalSupply() public pure override returns (uint256) {
        return _allTotalSupply;
            ...
            function getFortPepewebsite() public view returns (string memory) {
        return FortPepewebsite;
    }
