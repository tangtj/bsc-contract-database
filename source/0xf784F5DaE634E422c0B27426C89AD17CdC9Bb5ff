...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD5e88f61d3e311fE35e591D7D7BE35FBA0E4d221;
...
contract Circus is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x05376a8e3241306ca2bc6E183aC5E7Fbd14f49a3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Circus";
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**18; // -> 100% of Total supply (1000000000000000)
    uint256 private numTokensSellToAddToLiquidity = 1000000000000 * 10**18; // -> 0.1% of Total supply (1000000000000)
