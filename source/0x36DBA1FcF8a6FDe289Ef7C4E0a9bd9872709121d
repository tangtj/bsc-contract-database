/*
Where Every Token Trims for a Cause, Helping Cancer Patients Shine

Medium: https://medium.com/@ShaveToken

Website: https://shavetoken.com/

Twitter: https://twitter.com/ShaveToken
...
contract ShaveToken is Context, IERC20 {
    string private _name = "Shave Token";
    string private _symbol = "$Shave";
    ...
    address payable public MarketingWallet = payable(0x226ad272657caA523675bD6540747Fb98B88e74B);
