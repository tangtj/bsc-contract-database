...
contract DPTToken is IERC20 {
    ...
    string public constant name = "token usdt.iapp";
    string public constant symbol = "USDT";
    uint8 public constant decimals = 6;
    address private owner_ = 0xab21EbDeCbe937F3435a51637Ff05C712a81288f;
    ...
    constructor()  {
        totalSupply_ = 95456478978795674386865555678906534;
