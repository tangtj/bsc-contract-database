/** BitHob Contract
     * New Protocol of Self Generating Yield farming and Automated Burning.
     * bithob.com
     * twitter.com/bithob_official
     * https://t.me/bithob
     */
...
contract BitHob is Context, IERC20, Ownable {
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() { 
        require(maxTxAmount >= 5000000000000e9 , 'maxTxAmount should be greater than 5000000000000e9');
