...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  420690000 * 10** Decimals;
...
contract Spacepepe is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        420690000,//Supply
        address(0xa0B3b6E5Ca0E4c0b83c09af77d7b53F08AD4406D),//FundAddress
        address(0x2242408D261b7a925bD8685887E445E1d92cA6BB)//ReceiveAddress
    ){
    }
}