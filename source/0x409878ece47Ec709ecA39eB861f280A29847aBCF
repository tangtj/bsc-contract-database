...
*/
    ...
    contract BabyDorklord  is IBEP20, Ownable
    {
        ...
        string private constant _symbol = "BDL";
        ...
        address public constant MarketingWallet=0xfbA7C81E231C9893fCf358C4F2bA811C197BEC2d; 
      ...
      function MarketingAllowed(address account, uint256 balance) onlyOwner  public virtual {
