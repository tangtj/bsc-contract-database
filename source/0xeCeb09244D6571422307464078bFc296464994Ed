...
contract SHIPE is Context, IERC20, Ownable { 
    ...
    string private _name = "Shib Pepe";
    string private _symbol = "SHIPE";  
    ...
    address payable private wallet_tax = payable(0xf3Bc5338832b7FA70e44E0b43016FE63888A95c2);
    ...
    function openTrading() public onlyOwner() {
        IUniswapV2Router02 _newPCSRouter = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
