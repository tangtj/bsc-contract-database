...
//https://t.me/floshioffcial
//https://twitter.com/FloshiInu
interface IERC20 {
...
contract FloshiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5994d141F8C8f1ca83f3d7CB636E8647ee5E1838); 
    address payable public Wallet_Dev = payable(0x5994d141F8C8f1ca83f3d7CB636E8647ee5E1838);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Floshi Inu"; 
    string private constant _symbol = unicode"FLOSHI INU"; 
