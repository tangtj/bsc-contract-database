...
contract BabyLionCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyLionCoin";
    string constant _symbol = "BabyLion";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x9B11419EFC36aa326e0e307Ba912B57c5155495e;
