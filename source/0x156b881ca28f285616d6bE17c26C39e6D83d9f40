...
contract Olympicrings is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x1EFf2e6d84dE09996504690853998321C7bE704d);
    ...
    */
    ...
    string private _name = "Olympic rings"; 
    string private _symbol = "Olympic rings";  
