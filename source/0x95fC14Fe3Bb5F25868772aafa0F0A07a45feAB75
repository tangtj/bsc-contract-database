...
contract Flying is IERC20Metadata, Ownable {
    ...
    string private constant _name = "Fly Inu";
    ...
    uint256 public maxTransactionTax = 25;

    uint256 public marketingPct = 50;
    uint256 public devPct = 30;
    uint256 public lpPct = 20;
    uint256 public maxPct = 100;

    uint256 public maxWalletSize = (_tTotal * 100) / maxPct;
