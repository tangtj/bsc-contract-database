...
contract TehBag is IBEP20, Auth {
    ...
    address DEV = 0x3dE9907bCe7AbED9EBC7Bf720CE0D58EdDfF0776;
    ...
    // Name and symbol
    string constant _name = "TEHBAG";
    string constant _symbol = "THG";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7D2797f4e9370Afa31f39637cE62d10105c91bDc;
