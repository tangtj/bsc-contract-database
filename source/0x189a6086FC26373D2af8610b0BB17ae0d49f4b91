// t.me/FantomLiberoFinancial 
// FantomLiberoFinancial.com
...
contract FantomLiberoFinancial is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "FantomLiberoFinancial";
    string public symbol = "FLIBERO";
