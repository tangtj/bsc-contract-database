...
TELEGRAM: https://t.me/StarShipPepeMemeToken1000x
...
contract StarShipPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "StarShip Pepe"; // 
    string private constant _symbol = "SSP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xcccfbe4063868Ebc1ec7BB4d909ec5fF026E7BEC;
