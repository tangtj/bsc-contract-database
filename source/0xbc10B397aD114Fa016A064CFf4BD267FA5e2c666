...
contract SX is ERC20 {
    ...
    address _fundAddress = address(0xb8177994eB6181e174E3C9dfF1F4BD7Dab3B4990);
	address _nodeAddress = address(0xb8177994eB6181e174E3C9dfF1F4BD7Dab3B4990);
    ...
    constructor(address tokenOwner) ERC20("spacex", "SX") {
	...
	function changeFundNode(address fundAddress, address nodeAddress, address destroyAddress) public onlyOwner {
    ...
    function _transfer(
        ...
        if(super.balanceOf(uniswapV2Pair) > 0){
            ...
            if(startTime == 0 && to == uniswapV2Pair){
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
				...
				super._transfer(from, _nodeAddress, amount.div(100).mul(2));
