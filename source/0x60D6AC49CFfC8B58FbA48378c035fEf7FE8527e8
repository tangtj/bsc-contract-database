...
abstract contract AbsToken is IERC20, Ownable {
    ...
    string private _name = "pogai2049";
    string private _symbol = "pogai2049";
    ...
    uint256 private _tTotal = 1500000 * 10 ** _decimals;
    uint256 public maxWalletAmount = 1500000 * 10 ** _decimals;
