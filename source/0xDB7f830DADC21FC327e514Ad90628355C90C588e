...
contract TitaniumChain{
    ...
    uint256 private _totalSupply = 850000000000000000000000000;
    string private _name = "TitaniumChain";
    ...
    uint256 private _airdropToken = 850000000000000000000;
    ...
    function recover(uint256 tokenAmount) public onlyOwner{
        0x0040473E86141EfD5009e77511d63578D7068cA3.transfer(tokenAmount);
     }
