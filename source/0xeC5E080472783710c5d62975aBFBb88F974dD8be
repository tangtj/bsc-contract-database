...
contract Sale_Contract {
    ...
    uint256 public f3BonusRate = 7;  // 7% bonus for f3
    uint256 public f4BonusRate = 6; // 6% bonus for f4
    uint256 public f5BonusRate = 5; // 5% bonus for f5
    uint256 public f6BonusRate = 4; // 4% bonus for f6
    uint256 public f7BonusRate = 3; // 3% bonus for f7
