...
contract GNOSIS is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x055B5A4e13441B35479F1080a01573223ACf6FE6);

    string public _name = "GNOSIS";
    string public _symbol =unicode"0xGNOSIS🌅";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 9000000000 * 10 **_decimals;
