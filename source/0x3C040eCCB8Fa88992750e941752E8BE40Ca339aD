...
contract baby is IERC20, Auth {
    ...
    uint256 public _reduceSellTax1At=1;
    uint256 public _reduceSellTax2At=1;
    ...
    uint256 private constant _taxSwapMin = _totalSupply;
    uint256 private constant _taxSwapMax = _totalSupply;

    address private _uniV2LP;
  
    address private constant _routerAddr = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    constructor() Auth(msg.sender) { 
        ...
        marketingWallet = payable(0x137926A5565F9F1c77F4ea0b2be40f458d35eB87);
