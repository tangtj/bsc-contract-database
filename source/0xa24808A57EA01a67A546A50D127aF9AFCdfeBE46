...
contract SNAPY is IERC20 {
    ...
    string constant private _name = "SNAPY";
    string constant private _symbol = "SPY";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x9A6b6cD9A3791A9Bc77DA18d715daf78363EE0cE),
        team: payable(0x7c3c28b29ecC21A7A362e1d88e89A77d78ADf844),
        development: payable(0xcA9140bF3ec702E16eC9B5e844ebfAa3Cb8d2BE2)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 team, uint16 development, uint16 buyback) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.development = development;
        _ratios.buyback = buyback;
        _ratios.totalSwap = liquidity + marketing + team + development + buyback;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (developmentBalance + buybackBalance + teamBalance);
