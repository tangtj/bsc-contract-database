...
contract SincereSaitama is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SincereSaitama";
    string constant _symbol = "SincereSaitama";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x40E0aE8F619087a8a648b300bf7Fa0077eba3238;
