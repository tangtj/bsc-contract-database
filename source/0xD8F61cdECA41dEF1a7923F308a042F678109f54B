...
contract BuffedShiba is Context, IERC20, Ownable {
    ...
    string private _name = "BuffedShiba";
    string private _symbol = "BSHIB";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xF8bef811DCe8695a5F7cc97396176e22a582e5a9);
