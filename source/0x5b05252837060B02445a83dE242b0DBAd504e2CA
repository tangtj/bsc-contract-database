...
contract Ownable is Context {
    ...
    constructor () {
        _owner =   0x733eF80dcCDFD05bA80F1116A01C8A93F6FF0f66;
...
contract HarryPotterBogdanoffChadWojak999Inu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 580000000000 * 10**9;
    uint256 public _maxTxAmount = _tTotal * 100 / 100; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100 * 10**9; //
    string private constant _name = "HarryPotterBogdanoffChadWojak999Inu BSC"; // 
    string private constant _symbol = "HPBCW999INU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    uint256 public _reflectionFee = 2;
    address payable public  _marketingWallet = payable(  0x733eF80dcCDFD05bA80F1116A01C8A93F6FF0f66 );
