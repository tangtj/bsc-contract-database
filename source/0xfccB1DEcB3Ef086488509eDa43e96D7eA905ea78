...
contract RipPepe is Context, IERC20, Ownable {
    ...
    string private _name = unicode"RIP PEPE";
    string private _symbol = unicode"$RIP";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC9a69A7542806372E6a94176e76E44130DD4f2A9);
    address payable private taxWallet2 = payable(0xC9a69A7542806372E6a94176e76E44130DD4f2A9);
