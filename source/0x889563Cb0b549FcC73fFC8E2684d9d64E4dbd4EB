...
contract ElvishMagic2 is ERC20, Ownable {
    ...
    event BuyFeeRemoved(uint256 buyFee);
    event SellFeeRemoved(uint256 sellFee);
    ...
    constructor () ERC20("ElvishMagic 2.0", "EMAGIC") 
    {   
        address newOwner = 0x0509b2aa597C2b407Fcb70d1E0f70B2a0f8c287c;
        ...
        marketingWallet = 0xdb2a1bF7Bfd8Ce68AF0185d6100cc4b70fE23B3e;
    ...
    function removeBuyFee() external onlyOwner {               
        buyFee = 0;
        emit BuyFeeRemoved(buyFee);

    }

    function removeSellFee() external onlyOwner {        
        sellFee = 0;
        emit SellFeeRemoved(sellFee);
    }
