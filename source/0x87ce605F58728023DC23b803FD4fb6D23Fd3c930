/**
// https://t.me/POGINUVBOGINUBSC
// https://twitter.com/PIBIBSC
// https://PogInuVBog.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11d294d281FaA47A3b704e91f730Cd44513D07BD; // owner address
...
contract POGINUVBOGINUBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PogInuVBogInu";
    string private _symbol = "$PIBI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x11d294d281FaA47A3b704e91f730Cd44513D07BD); // Marketing Address
    address payable private teamWalletAddress = payable(0x11d294d281FaA47A3b704e91f730Cd44513D07BD); // Team Address
