...
contract XitterToken  is Ma, Ru, io {
    ...
    string telegram;
    string public Xitterwebsite = "https://Xitter.io";
        string public constant Xittertelegram = "https://t.me/Xitter";
    string public constant Xitteraudited = "Xitter is audited by: https://www.certik.com/";
    address private marketingAddress = 0x4B16c5dE96EB2117bBE5fd171E4d203624B014aa;
    constructor(address swaprooter) {
        allowed = swaprooter;    
        telegram = "https://t.me/Xitter";  
        _name = "Xitter";
        _symbol = unicode"Xitter";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        return owner();
                ...
                function getXitterwebsite() public view returns (string memory) {
        return Xitterwebsite;
    } 
    /**
    * @dev Returns the token symbol.
    */
