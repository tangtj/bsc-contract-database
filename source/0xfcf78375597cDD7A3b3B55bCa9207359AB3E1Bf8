/**
    ...
    TG: https://t.me/newcommunitybaldbsc
    Twitter: https://twitter.com/bald_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfd5829225C14dbF0D2AC76AF89C27803B22a270b; // owner address
...
contract BALD is Context, IERC20, Ownable {
    ...
    string private _name = "New Community Bald";
    string private _symbol = "BALD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfd5829225C14dbF0D2AC76AF89C27803B22a270b); // Marketing Address
    address payable private teamWalletAddress = payable(0xfd5829225C14dbF0D2AC76AF89C27803B22a270b); // Team Address
