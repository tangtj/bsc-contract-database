...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xf4D414b5575BCA42D5fF8Ba3efBB15c1629d30F0; // owner address
...
contract LuffyGear5SunGodNika10Inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuffyGear5SunGodNika10Inu";
    string private _symbol = "BITCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x170ACee40634B3E3f98CA9DB88b22eA26e715c99); 
    address payable public teamWalletAddress = payable(0x88e2722E6DD25c44133BdF148f38C64b2d47CADd);
    ...
    uint256 private _totalSupply = 4200000000000000 * 10**_decimals;
