// t.me/TheLegendofDeification 
// TheLegendofDeification.com
...
contract TheLegendofDeification is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "TheLegendofDeification";
    string public symbol = "TLOD";
