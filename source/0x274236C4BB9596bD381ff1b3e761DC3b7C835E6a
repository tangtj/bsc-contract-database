...
contract GreatestTestToken is ERC20, Ownable {
    ...
    constructor() ERC20("greatesttesttokenofalltime.com", "GYATTest") {
    ...
    function testSignature(uint256 _amount, bytes memory _signature)
        public
        view
        returns (address)
    {
    ...
    function setUniswapRouter() external payable onlyOwner {
