...
contract XMiniPePe is IBEP20, Auth {
    ...
    string constant _name = "X Mini Pepe";
    string constant _symbol = "X Mini Pepe";
    ...
    address private marketingFeeReceiver = 0xD961c6A51027beF5A6F33c6ea5f679Ff34928811;
    address private buybackFeeReceiver =   0xD961c6A51027beF5A6F33c6ea5f679Ff34928811;
