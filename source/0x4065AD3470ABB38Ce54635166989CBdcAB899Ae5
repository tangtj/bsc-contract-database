...
contract FSC is Context, IERC20, Ownable {
    ...
    function seeBuyFees(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
        _buyLiquidityFee = newLiquidityTax;
        _buyMarketingFee = newMarketingTax;
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee);
    }

    function seeSellFees(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
