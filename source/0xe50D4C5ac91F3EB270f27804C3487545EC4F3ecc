...
contract PirateMoon is IBEP20, Ownable {
    ...
    string private _name = "PirateMoon";
    string private _symbol = "PirateMoon";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 69000000000000000000000000000000000000000000000000 * 10**_decimals;
