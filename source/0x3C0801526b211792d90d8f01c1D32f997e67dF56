...
contract Grmno is ERC20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() ERC20("Grmno", "Gr") { 
        marketingWallet = payable(0xCeeeBdEbc7290F4553D781eaab4615AA4a7428DB); 
        DevWallet = payable(0x629c0f1b7C1fb00AF8671376E5b324eEED19E645); 
        _gameContract = 0x6D31f40cdC807BD998F096432De433B2382F917c;
    ...
    function createPaidAndAddLiqudity(uint256 tokenAmount) payable external  onlyOwner {
    ...
    function setDevWallet(address wallet) external onlyOwner {
     ...
     function NewgameContract(address _newAddress ) external onlyOwner {
        ...
        emit UpdateUniswapV2Router(_newAddress, oldAddress);
    }
