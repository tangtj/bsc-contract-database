...
contract PEPECA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xc104b2F9878F9Ba4ED11765d7776CCE524Ff51d2); // Marketing Address
    ...
    string private constant _name = "Pepe calsium";

    string private constant _symbol = "PEPECA";
