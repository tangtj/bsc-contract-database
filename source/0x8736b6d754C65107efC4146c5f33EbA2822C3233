...
// "Toadly: Beyond Memes, a Cryptocurrency with a Mysterious Twist!"

// Telegram : https://t.me/toadly_official
// Twitter : https://twitter.com/Toadlyofficial
// Website : https://toadlyofficial.com/
// Youtube : https://www.youtube.com/@Toadlyofficial
// Mystery BOT : https://t.me/ToAdlYsv_bot
...
contract TOADLY is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 8400000000000 * 10**_decimals; //
    
    uint256 public maxSellAmount = 420000000000000 * 10**_decimals; //
    uint256 public maxBuyAmount = 420000000000000 * 10**_decimals; //
    uint256 public maxWalletBalance = 2100000000000 * 10**_decimals; //

    address public marketingAddress = 0x661d9351DcDe99E2d21DaD0c942d19571A28508A; //
    address public devAddress = 0x661d9351DcDe99E2d21DaD0c942d19571A28508A; //

    string private constant _name = "TOADLY"; //
    string private constant _symbol = "TOADLY"; //
    ...
    Taxes public taxes = Taxes(1,9,20,0); //
    Taxes public sellTaxes = Taxes(1,9,20,0); //
    ...
    // Owner cannot transfer out TOADLY from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out TOADLY");
