...
// Fatsale是一个专业的预售与一键发币网站
// 本群是Fatsale唯一交流群
// 官网: https://fatsale.finance/
...
contract token9402 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 94029402 * 10**9;
    ...
    address payable private _twddev = payable(0xd38C9AE19639b7b1082d518d0DDB1590ba463Aa5);
    address payable private _twdmkt = payable(0xd38C9AE19639b7b1082d518d0DDB1590ba463Aa5);
    
    string private constant _name = "9402";
    string private constant _symbol = "9402";
