...
contract TOTOTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public djkkn74;
    ...
    string private _tokenname = "MY_TOTO";
    string private _tokensymbol = "TOTO";
