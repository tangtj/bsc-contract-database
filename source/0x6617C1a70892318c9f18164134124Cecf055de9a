...
contract UDAOToken is ERC20, Ownable {
    ...
    constructor(
        ...
        minInviterAmount = minInviterAmount_ * 10**18;
        ...
        require(tokenRewardsFee.add(liquidityFee).add(marketingFee).add(fundFee).add(inviterFee) <= 25, "Total fee is over 25%");
        ...
        dividendTracker = new TokenDividendTracker(rewardTokenAddress_, tokenBalanceForReward_);
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            fees = LFee.add(RFee).add(MFee).add(FFee);
            ...
            super._transfer(from, address(this), fees.sub(MFee).sub(FFee).add(IFeeCurrent));
        }
