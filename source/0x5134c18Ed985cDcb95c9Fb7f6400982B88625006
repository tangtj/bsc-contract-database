...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "BTCETHBNBXRPADALTCSOLUSDTBUSDUSDCDOTSHIBADOGEAVAXLINKARBCROAXSSANDAPE";
    ...
    uint256 public _maxWalletAmount = 690000000000 * 10**_decimals;
