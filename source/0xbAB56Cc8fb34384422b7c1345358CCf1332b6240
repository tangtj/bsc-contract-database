...
contract bitcoin is ERC20, Ownable {
    ...
    address public marketingWalletAddress =
        0x229a888F1dEF6578cAAD3ec594929579088E590C;
    ...
    uint256 private buyRewardsFee = 9;
    uint256 private sellRewardsFee = 9;
    ...
    constructor() ERC20("bitcoin2.0", "bitcoin2.0") {
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            newValue >= 200000 && newValue <= 900000,
            "d: gasForProcessing must be between 200,000 and 900,000"
        );
        require(
...
contract dDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 21600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold tokens for dividen
    }
