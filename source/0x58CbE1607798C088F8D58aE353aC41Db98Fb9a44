...
contract TESTING is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"$TESTING";
    ...
    address payable public DevWallet = payable(0x78913f15045a5159d4E34F3cb45adD2Aa39B9D4F);
    address payable public MarketingWallet = payable(0x46e729CD5aD253A1c677A83d4514f81A12C585AB);
