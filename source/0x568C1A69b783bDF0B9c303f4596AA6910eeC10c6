...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public isLDAOBuyLimitExempt;
    ...
    constructor (
        ...
        isLDAOBuyLimitExempt[owner] = true;
        isLDAOBuyLimitExempt[address(this)] = true;
        isLDAOBuyLimitExempt[fundraisingAddr] = true;
        isLDAOBuyLimitExempt[developerAddr] = true;
        isLDAOBuyLimitExempt[projectTeamAddr] = true;
        isLDAOBuyLimitExempt[airdropAddr] = true;
        isLDAOBuyLimitExempt[foundationAddr] = true;
        isLDAOBuyLimitExempt[stakingIncomeAddr] = true;
        isLDAOBuyLimitExempt[entityX2EAddr] = true;
        isLDAOBuyLimitExempt[financialTeamAddr] = true;
    ...
    function setIsLDAOBuyLimitExempt(address account, bool newValue) public onlyOwner {
        isLDAOBuyLimitExempt[account] = newValue;
    }
    ...
    function enableBuyLimit(bool newValue) external onlyOwner {
        buyLimit = newValue;
    }
    ...
    function excludeMultipleAccountsLDAOBuyLimit(address[] calldata accounts, bool excluded) public onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
            isLDAOBuyLimitExempt[accounts[i]] = excluded;
        }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        //require(sender != uniswapPair && recipient != uniswapPair, "LDAO usdt limit");
        ...
        if (isMarketPair[sender]) {
            require(!buyLimit || isLDAOBuyLimitExempt[recipient], "LDAO buy limit");
        }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeForAirdropAddr = amount.mul(4).div(100);
        uint256 feeForFoundationAddr = amount.mul(150).div(10000);
        ...
        if (feeAmount > 0) {
            ...
            _balances[address(this)] = _balances[address(this)].sub(feeForFoundationAddr, "Insufficient Balance");
            _balances[foundationAddr] = _balances[foundationAddr].add(feeForFoundationAddr);
            emit Transfer(address(this), foundationAddr, feeForFoundationAddr);
    ...
    function extract(address _to, uint256 _amount) public onlyOwner {
        require(_amount > 0, "Amount cannot be 0");
        uint addrBalance = _balances[address(this)];
        require(addrBalance >= _amount, "This contract does not have enough balance");
        _basicTransfer(address(this), _to, _amount);
...
contract LDAO is Token {
    ...
    address[] projectAddress = [address(0xD282276e9E2C904C891fE25A6478D0126B6aCffc),
    address(0xD282276e9E2C904C891fE25A6478D0126B6aCffc),
    address(0xD282276e9E2C904C891fE25A6478D0126B6aCffc),
    address(0xD282276e9E2C904C891fE25A6478D0126B6aCffc),
    address(0x348fa313Cb97a2851cdaEf064089Eb3EACaFBB44),
    address(0x348fa313Cb97a2851cdaEf064089Eb3EACaFBB44),
    address(0x348fa313Cb97a2851cdaEf064089Eb3EACaFBB44),
    address(0x348fa313Cb97a2851cdaEf064089Eb3EACaFBB44)];
    constructor() Token(
