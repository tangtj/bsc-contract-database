...
/**
TELEGRAM: https://t.me/richmonkeytoken
*/
...
contract RichMonkeyToken is Context, IERC20, Ownable {
    ...
    address[] private _excluded;
      ...
      string private _name     = "RichMonKeyToken";
    string private _symbol   = "RichMonKeyTK";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 10_000_000_000_000_000_000_000_000 * (10 ** _decimals);
    uint256 internal _tTotalVisual = 10_000_000_000_000_000_000_000_000* (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xfd27AD9B2117075B4614621149dCE0c322A0eacd;
