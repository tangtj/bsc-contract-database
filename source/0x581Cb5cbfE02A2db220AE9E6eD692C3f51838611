...
contract pandameme is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x670f4Bb2166364438458ae1fa3e2C9C864C94dDe); // Marketing Address
    ...
    uint256 public _totalTaxIfBuying = 0; // 8% BUY TAX
    uint256 public _totalTaxIfSelling = 0; // 8% SELL TAX
    uint256 private _totalDistributionShares = 2;

   uint256 private _totalSupply = 1_000_000 * 10**18; //1m Total Supply
    uint256 public _maxTransactionAmount =   150_000 * 10**18; // 3% Max Transaction Limit
    uint256 public minimumTokensBeforeSwap = 20 * 10**18; // 0.05% of the total supply
    ...
    function TurnOnMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   150_000 * 10**18;
    }

    function TurnOffMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   1_000_000 * 10**18;
    }
