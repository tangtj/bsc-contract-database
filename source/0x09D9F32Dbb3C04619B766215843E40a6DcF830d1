...
contract StakingToken is Ownable {
    ...
    constructor () {
        ...
        rewardPercent = 100 ; //when for Annually 100% Then for 12  month we pay 100% 
        withdrawTimestamp =  31536000  ; //12 month in seconds
        limitStack = 3000000 ether ; // Staking Limit Token  
        totalStakAmount = 0; 
        Pause = false;
    }
