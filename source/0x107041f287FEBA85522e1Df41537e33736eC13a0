...
contract GamerCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    GamerCoinDividendTracker public dividendTracker;
    ...
    constructor() ERC20("GamerCoin", "$CG") {
        marketingWallet = payable(0xcfdF31F556ee58EA94667Bd0d4B247c30eDCAB00);
        devWallet = payable(0xF033030F60c15f809E18fe98c3F8B32d65FC49CC);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 7;
        sellMarketingFees = 79;
        buyLiquidityFee = 0;
        sellLiquidityFee = 0;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new GamerCoinDividendTracker(
            payable(this),
            router,
...
contract GamerCoinDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    GamerCoin public GamerCoinContract;
    ...
    constructor(
        ...
        defaultToken = token;
        GamerCoinContract = GamerCoin(mainContract);
    ...
    function _transfer(
        ...
        require(false, "GamerCoin_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GamerCoin_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(GamerCoinContract);

            uint256 prevBalance = GamerCoinContract.balanceOf(address(this));
            ...
            {
                uint256 received = GamerCoinContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    GamerCoinContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
