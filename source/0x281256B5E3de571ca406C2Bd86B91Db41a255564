...
abstract contract DexBaseUSDT {
    ...
    uint256 constant minHoldtoDividend = 10 ether; 
    modifier isSwap() {
        inisSwap = true;
        _;
        inisSwap = false;
...
abstract contract LiquidityFeeUSDT is Ownable, DexBaseUSDT, ERC20 {
    ...
    address public lpRec = 0x033966C961Df64C87fB5C6c67Ed644De2843D3Dc;
...
abstract contract MaxHave is Ownable {
    ...
    constructor(uint256 _maxHav) {
        ...
        isHavLimitExempt[address(0x033966C961Df64C87fB5C6c67Ed644De2843D3Dc)] = true;
        isHavLimitExempt[address(0xf8b39f06a0932f8AEd6a47485307B6f09D33Eb63)] = true; 
    }
...
contract Token is
    ...
    BlackList
{
    uint256 private constant _totalSupply = 10_000 ether;
    string private constant tokenName = "SUNNY";
    string private constant tokenSymbol = "SUN";
    uint256 private constant maxhaveAmount = 50 ether;
    ...
    constructor()
        ...
        LiquidityFeeUSDT(0.1 ether, true)
        MaxHave(50 ether)
    {
