...
//
// https://t.me/blacksquarebsc

// https://twitter.com/BlackSquareBSC
...
contract BlackSquare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlackSquare";
    string private _symbol = "BlackSquare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE895ec04166AfB05e963A86a6d6107260bb17BFa); // Marketing Address
    address payable public buybackWalletAddress = payable(0x6A51d89cCCE3019ec60ca9c72d6137746eF11B89); // Buyback Address
