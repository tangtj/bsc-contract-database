...
contract ZYK is ERC20 {
    ...
    constructor(address tokenOwner,address _fund1,address _fund2,address _fund3,address _fund4,address _fund5,address _fund6,address Inviter1Address,address Inviter2Address,address reciver50Address) ERC20("ZYK", "ZYK") {
        require(_baseToken < address(this),"ZYK small");
