/** 
                                 ...
                                 .dMMMb dMMMMMMP .aMMMb  dMP dMP dMMMMMP dMMMMb 
                                dMP" VP   dMP   dMP"dMP dMP.dMP dMP     dMP.dMP 
                                VMMMb    dMP   dMMMMMP dMMMMK" dMMMP   dMMMMK"  
                              dP .dMP   dMP   dMP dMP dMP"AMF dMP     dMP"AMF   
                              VMMMP"   dMP   dMP dMP dMP dMP dMMMMMP dMP dMP    
...
contract Staker is Ownable {
    ...
    constructor() {
        stakedToken = IBEP20(0xD9979e2479AEa29751D31AE512a61297B98Fbbf4); // TORII
        rewardToken = IBEP20(0x1369c0aF33e1e0cEe1A9f952b3FA86f8c013d74b); // STEM 
    ...
    function setRewardTokensPerSecond(uint256 _tokensPerSecond) external onlyOwner {
        ...
        require(_tokensPerSecond >= minTokensPerSecond, "Staker setTokensPerSecond: too low tokens, see minTokensPerSecond!");
