...
// https://twitter.com/fgman
// https://feelsgoodmanbsc.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcabAdE5453402DF38F1756Fd3A63e7f887Bee606; // owner address
...
contract feelsgoodmanBSCofficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FeelsGoodMan";
    string private _symbol = "$FGM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcabAdE5453402DF38F1756Fd3A63e7f887Bee606); // Marketing Address
    address payable private teamWalletAddress = payable(0xcabAdE5453402DF38F1756Fd3A63e7f887Bee606); // Team Address
