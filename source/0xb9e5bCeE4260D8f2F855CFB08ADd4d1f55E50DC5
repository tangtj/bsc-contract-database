...
contract BabyPepeOG is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BABY PEPE OG";
    string private _symbol = unicode"$BPOG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x4A22559b8d1077639953C272718CDc444D2C770C);
    address payable private taxWallet2 = payable(0x4A22559b8d1077639953C272718CDc444D2C770C);
