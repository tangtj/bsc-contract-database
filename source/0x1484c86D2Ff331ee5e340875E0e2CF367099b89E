...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE7f313D5064A3e23EcB749A2CA3aeaC9B48c5dFB;
...
contract TrinityMetaverse is Context, IERC20, Ownable {
    ...
    string private _name = "TRINITY METAVERSE";
    string private _symbol = "TRIMETA";
