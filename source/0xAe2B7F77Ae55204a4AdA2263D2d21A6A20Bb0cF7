...
contract AXE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xaBc3D8D556e04C89eF89856f39bBc83515FBaAEf); // Marketing Address
        
    address payable public teamAddress =
        payable(0xaBc3D8D556e04C89eF89856f39bBc83515FBaAEf); // Team Address

    address payable public liquidityAddress =
        payable(0xaBc3D8D556e04C89eF89856f39bBc83515FBaAEf); // Liquidity Address
    ...
    string private constant _name = "AXE";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xaBc3D8D556e04C89eF89856f39bBc83515FBaAEf).call{value: bnbForDev}("");
