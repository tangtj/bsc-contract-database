...
contract NEPOWERGLOBAL is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "NE POWER GLOBAL";
    string private constant _symbol = unicode"$POWER";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 18000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x9C27B3660A82c0849f77aA60EF50b42193F42729);
    address payable public MarketingWallet = payable(0x2E9A366424A1121480F6c002Fe90dD856028314C);
