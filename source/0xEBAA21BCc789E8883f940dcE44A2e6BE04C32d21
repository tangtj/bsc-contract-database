...
contract Sylvania is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sylvania";
    string private _symbol = "SYL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4311787E9434E173236953b2c4Eeb54c6c40D5B5);
    address payable public teamWalletAddress = payable(0x55241F239602D729571B9fbd70fc86848a0A4311);
