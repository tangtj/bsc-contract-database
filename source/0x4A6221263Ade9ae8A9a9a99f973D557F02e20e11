...
Welcome to the world of Oppenheimer Token, 
a revolutionary cryptocurrency paying tribute to the iconic movie “Oppenheimer.” 
Embodying the spirit of innovation and imagination, our token is built on the 
BNB blockchain, ensuring seamless and secure transactions. 
With a total supply of 100 million tokens and a nominal 2% tax on both buying and selling, 
Oppenheimer Token promises to be the catalyst for an exciting and dynamic crypto experience. 
Join us on this extraordinary journey as we redefine the landscape of decentralized finance.
*/
...
contract Oppenheimer is Ma, Ru, io {
   ...
   string websites;
   string public Oppenheimerwebsite = "https://www.oppenheimermovie.com/";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "OppenheimerToken"; 
        _name = "Oppenheimer";
        _symbol = "OPHM";
        _decimals = 9;
