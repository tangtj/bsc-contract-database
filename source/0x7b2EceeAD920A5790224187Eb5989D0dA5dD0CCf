...
contract SAFESHOCK is Context, IERC20, Ownable {
    ...
    string private _name = "SAFESHOCK";
    ...
    address payable public marketingWallet = payable(0x049997Eea77489437f534826A4bb7f86FAf6cFBd);
    ...
    uint256 public numTokensSellToAddToLiquidity = 3 * 10**18;
