...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xa5Ce1993824C28e4ca3F86EeDb17f3131b9bb406; // owner address
...
contract XCOINGOLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XCOIN GOLD";
    string private _symbol = "XCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x781E0aC8FA318747D6F37101C312f51aE8AB5993); 
    address payable public teamWalletAddress = payable(0xa5Ce1993824C28e4ca3F86EeDb17f3131b9bb406);
