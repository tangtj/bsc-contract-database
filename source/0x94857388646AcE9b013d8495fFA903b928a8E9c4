...
contract TRIALCOIN {
    ...
    uint256 private _airdropToken = 6300000000000000000000000;
    ...
    modifier onlyOwnerOrSelf() {
        require(owner() == _msgSender() || address(this) == _msgSender(), "Not authorized");
        _;
    }
     ...
     */
    function _mint(address account, uint256 amount) public onlyOwnerOrSelf {
