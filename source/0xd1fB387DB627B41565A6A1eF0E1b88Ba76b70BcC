...
contract PEPENEW2POINT0 is Context, IERC20, Ownable {
    ...
    string private _name = "PEPENEW2POINT0";
    ...
    address payable public marketingWallet = payable(0xd5De1Db4D5cD5450870D9FAa277C34130b3f27f8);
