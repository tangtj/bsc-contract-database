...
contract BurnCN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address; 
    
    string private _name = " BurnCN ";
    string private _symbol = " BurnCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb80Af983dd65D185D15af7514ac8bC97A1234a33); // Marketing Address
    address payable public teamWalletAddress = payable(0xb80Af983dd65D185D15af7514ac8bC97A1234a33); // Team Address
