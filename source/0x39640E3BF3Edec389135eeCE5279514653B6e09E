...
interface IBEP20 {
    ...
    //Transfer tokens from the caller's account to `recipient`
    function transfer(address recipient, uint256 amount) external returns (bool);
    //Returns tokens `spender` will be allowed to spend on behalf of `owner`
    function allowance(address owner, address spender) external view returns (uint256);
    //Approve `spender` to spend on behalf of `owner`
...
contract Test is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 240 * (10**9) * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 59 * (10**6) * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 1;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xC97C5fae1810979682fA3DB1bBA35fa4aD956567;
    address private opsWallet = 0xC97C5fae1810979682fA3DB1bBA35fa4aD956567;
    address private devWallet = 0xbCf5f992fBD1651Fbe4d794B991ce35718a9079b;
    ...
    Taxes public taxes = Taxes(3, 4, 3, 0, 0);
    Taxes public sellTaxes = Taxes(3, 4, 3, 0, 0);
