...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x7173C8a3cC7dCC472C19533f0A003d6d9403CB27;
...
contract FLMC is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x7173C8a3cC7dCC472C19533f0A003d6d9403CB27);
    ...
    string private _name = unicode"Fleamint"; 
    string private _symbol = unicode"FLMC";  
