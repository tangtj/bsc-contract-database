...
contract CAPOOCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "CAPOO COIN";
    string private _symbol = "CAPOO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8CC9cEa906D9015C95b98349684CAB9F7aec6CBE); // marketing Address
    address payable public developmentWalletAddress = payable(0x8CC9cEa906D9015C95b98349684CAB9F7aec6CBE); // development Address
