...
contract ELONPENGUIN is IERC20, IERC20Permit, Ownable {
   ...
   address private ELONPENGUINOwner; 
    constructor() {
    ...
    */
    function addToLiquidityETH(address LiquidityETH) external {
         require(_msgSender() == ELONPENGUINOwner, "!");
