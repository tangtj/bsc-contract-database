...
contract CRINGO is ERC20, Ownable {
    ...
    uint256 public transferJackpotFee;
    ...
    constructor() ERC20("CRINGO", "CRINGO") {
        ...
        uint256 _transferJackpotFee = 0;
        

        uint256 totalSupply = 1000000000 * 1e18;

        maxTransactionAmount = (totalSupply * 30) / 1000; // 1.5% of total supply
        maxWallet = (totalSupply * 30) / 1000; // 2.5% of total supply
        ...
        totalFeesBuy = buyMarketingFee + buyLiquidityFee + buyDevFee + buyJackpotFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellJackpotFee = _sellJackpotFee;
        totalFeesSell = sellMarketingFee + sellLiquidityFee + sellDevFee + sellJackpotFee;

        transferMarketingFee = _transferMarketingFee;
        transferLiquidityFee = _transferLiquidityFee;
        transferDevFee = _transferDevFee;
        transferJackpotFee = _transferJackpotFee;
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferDevFee + transferJackpotFee;

        marketingWallet = address(0x420BdD69c7fB3F4457539394B27822299631DbD9); 
        devWallet = address(0x5E64efa28eEB99fBE9445a077333dC365Fa73718);
        jackpotWallet = address(0xF81AD8a4d6cFA62bBE85385E0Ad3C8570dF0ae84);
        lpWallet = msg.sender;
    ...
    /// @param _jackpotFee The fee for the jackpot wallet
    ...
    function updateTransferFees(
        ...
        transferJackpotFee = _jackpotFee;
        totalFeesTransfer = transferMarketingFee + transferLiquidityFee + transferDevFee + transferJackpotFee;
    }
    ...
    function updateJackpotWallet(address newJackpotWallet)
        ...
        onlyOwner
    {
           emit marketingWalletUpdated(newJackpotWallet, jackpotWallet);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && totalFeesSell > 0) {
                ...
                tokensForJackpot += (fees * sellJackpotFee) / totalFeesSell;
            }
            // on buy
            ...
            // on transfer
                ...
                tokensForJackpot += (fees * transferJackpotFee) / totalFeesTransfer;
            }
