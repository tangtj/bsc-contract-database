...
contract XMarioAI is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public percentForLPBurn = 20; // 25 = .25%
    ...
    constructor() ERC20("XMario.AI", "XM.AI") {
        ...
        //tTotal = x * 1e9;
        tTotal = 1000000000000000 * 1e9;
        _rTotal = (MAX - (MAX % tTotal));

        maxTransactionAmount = (tTotal * 10) / 1000; // 1% maxTransactionAmountTxn
        maxWallet = (tTotal * 20) / 1000; // 1% maxWallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 50) / 1000) / 1e9,
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 90) / 1000) / 1e9,
