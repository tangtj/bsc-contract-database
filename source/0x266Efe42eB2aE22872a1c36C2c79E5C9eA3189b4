...
contract PurpleLambo is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x232077FD0cE9235731Fb4363301d9d0711C1Ddbf); // Marketing Address
        
    address payable public teamAddress =
        payable(0x232077FD0cE9235731Fb4363301d9d0711C1Ddbf); // Team Address
        
    address payable public liquidityAddress =
        payable(0x232077FD0cE9235731Fb4363301d9d0711C1Ddbf); // Liquidity Address
    ...
    string private constant _name = "Purple Lambo";

    string private constant _symbol = "PurpleLambo";
