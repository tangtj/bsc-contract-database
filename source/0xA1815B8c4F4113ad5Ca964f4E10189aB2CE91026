...
TELEGRAM: https://t.me/SallyBep20Portal
TWITTER: https://x.com/SallyBep20
...
contract SALAMANDER_INU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SALAMANDER INU"; // 
    string private constant _symbol = "SALLY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x54a31eba5Af1fbbd86731FDEfFb2e4E23D26AF2d;
