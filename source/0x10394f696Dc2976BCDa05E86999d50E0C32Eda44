...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4Fa5acDD885836E647E6a7CeA2E4F5E0a975c39a; // owner address
...
contract PAYPALX is Context, IERC20, Ownable {
    ...
    string private _name = "PAYPALX";
    string private _symbol = "$PX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4Fa5acDD885836E647E6a7CeA2E4F5E0a975c39a); // Marketing Address
    address payable private teamWalletAddress = payable(0x4Fa5acDD885836E647E6a7CeA2E4F5E0a975c39a); // Team Address
