...
contract SHIBTIGER is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBTIGER"; // 
    string private constant _symbol = "SHTIGER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xd87C9B384BA64d47794632D23eE168db0ab174CA;
