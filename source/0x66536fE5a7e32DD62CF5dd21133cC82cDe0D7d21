...
contract Pocoyo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pocoyo"; // 
    string private constant _symbol = unicode"POCOYO";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1EFD96284d8a56DAE8b243C514f389Db718e313f;
