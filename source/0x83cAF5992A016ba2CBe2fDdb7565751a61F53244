...
contract spax is Token {
    constructor() ERC20(
        ...
        address _marketing = address(0xF6d60870Fb3075781e3550038b6C631a0498625a); //
        address _receive = address(0xF6d60870Fb3075781e3550038b6C631a0498625a);   //
        ...
        super.setSurprise(
            90,
            3,
            address(0xF6d60870Fb3075781e3550038b6C631a0498625a)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0xF6d60870Fb3075781e3550038b6C631a0498625a);
        feeEarn = 0;
    }
}