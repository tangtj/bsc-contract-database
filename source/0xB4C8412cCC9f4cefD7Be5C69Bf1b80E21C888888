...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 65 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x2c0821F8207Ead44EA9aF6C4f1d05dDc2a45c296;
...
contract PC is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE0e18221c8fc9505b07D08DD1d1e3e8C7E1a42A7), // 营销钱包
    
        address(0xa43FFd3d9090408c516C7824ba750962978b92f9), // 收币钱包

        address(0x883C9bB191BFe7717CcC908995279eba68888888), //回购代币合约
