/**
 * 
ADACASH is a hyper-deflationary currency, THAT is used to buy CASH products and fees payment, which rewards investors for holding their tokens in ADA, while also incorporating the Buy Back and burn approach. ADACASH is ONE OF THE FIRST cryptocurrencies to include manual systematic Buy Backs with real use case of PLAY2earN AND sports Bets.

💰 Project Features: 💰

✨ 5% ADA auto rewards from daily volume to your wallet
‍🔥 Occasional Supply Burn Events 🔥
✅ Ownership Renounced
✅ Contract Verified via BSC
✨ Fair Launched
🔒 LP Locked ( +2 year ):
✅ Whitepaper:
https://docdro.id/sXk5f8u
...
contract ADACASH is Context, IERC20, Ownable {
