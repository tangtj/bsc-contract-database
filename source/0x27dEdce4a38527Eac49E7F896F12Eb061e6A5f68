...
contract BoringDoggy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Boring Doggy";
    string private constant _symbol = "BoringDoggy";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xaC7D43c011fb3cd364c77147dAe9987a81C8aa42);
    address payable private _marketingAddress = payable(0xaC7D43c011fb3cd364c77147dAe9987a81C8aa42);
