// TELEGRAM : https://t.me/nodnodportal
// TWITTER : https://twitter.com/NodNodBsc
...
contract NODNOD is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "NODNOD";
    string private constant _symbol = unicode"$NOD";
    ...
    address payable public DevWallet = payable(0xf091eE166bBbd77d61c15927dc9e529cE9904ec6);
    address payable public MarketingWallet = payable(0xb326757Ea33AFc43A0fAa8DF3ea16dCFdfDca1CC);
