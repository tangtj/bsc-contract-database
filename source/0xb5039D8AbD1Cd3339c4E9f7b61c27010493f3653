/**
  ...
  * 
  * Lucky HAMSTER
  * http://luckyhamster.finance/
  *
  * INITIAL TOKENOMICS:
  * EVERY TRX HAS %11 FEE,
  * 
  * %2: LOTTERY POT
...
contract LuckyHamster is Context, IBEP20, Ownable {
    ...
    address private constant _marketingWallet = 0x0ea43973B08aa1fA24815f2968168872D46C0EE7;
    ...
    address private constant _potAddress = 0x55CF266a506fc226095F23A0471fD9318CA77B6c;
    ...
    string private _name     = "Lucky Hamster";
    string private _symbol   = "LHM";
    uint8 private  _decimals = 9;

    uint256 public  _taxFee       = 3; // redistributed to holders
