// $BabyFlokiZilla - joining the ZIlla hype! Zilla coin with REWARDS in BUSD 
// Official Telegram community: https://t.me/BabyFlokiZillaBSC
...
contract BabyFlokiZilla is IBEP20, Auth {
    ...
    string constant _symbol = "BabyFlokiZilla";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xaDAEeD99C52C005C1d33004e985657751E9B9dD3;
