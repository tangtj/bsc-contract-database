...
contract BitcoinPerks is ERC20, Ownable {
    ...
    constructor() payable ERC20("BITCOIN PERKS", "BITPERKS") {
        ...
        marketingWallet = 0x94802F50580a5B4675D6Edeab00d92eb480A7bE1;
