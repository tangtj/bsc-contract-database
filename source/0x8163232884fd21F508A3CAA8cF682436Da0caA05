...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3Ee4399440Eaa9aD9C173CCB2FBbbC8FBAaCca78; // owner address
...
contract Pepe is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x67AEc6f99517Ae6Da6f805Ca37fB1657044E1F3c); // Marketing Address
    address payable private teamWalletAddress = payable(0x67AEc6f99517Ae6Da6f805Ca37fB1657044E1F3c); // Team Address
