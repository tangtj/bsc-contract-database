...
contract WCP is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        3000,//Supply
        address(0x0c797Ff312fA26fc94C5fCcd2b385404dF22dae5),//FundAddress
        address(0x3304D0703Dd5F795025465E5B7fF0A56e73E37AC)//ReceiveAddress
    ){
