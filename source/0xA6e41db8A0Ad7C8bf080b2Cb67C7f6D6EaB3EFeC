...
contract WWE is Context, IERC20, Ownable {   
    ...
    address payable private _twddev = payable(0x501D2d8C4aaD1EEA114D19CED64f538B102a35B9);
    address payable private _twdmkt = payable(0x501D2d8C4aaD1EEA114D19CED64f538B102a35B9);
    
    string private constant _name = "WWE"; 
