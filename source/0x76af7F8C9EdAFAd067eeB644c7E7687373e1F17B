...
// Dependency file: contracts/baby/BadgerInuDividendTracker.sol
...
contract BadgerInuDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BadgerInu contract."
        );
    }
...
// Root file: contracts/baby/BadgerInu.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/BadgerInuDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract BadgerInu is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    using Address for address;
    ...
    BadgerInuDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = BadgerInuDividendTracker(
