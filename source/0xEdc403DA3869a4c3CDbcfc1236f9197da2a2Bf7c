...
🐤 Welcome to Uncle Crooge 🧐

🧐 $CROOGE is a 100% meme based and decentralized community token based on an exchange.

📈 $CROOGE - The Safest and Fastest Growing Decentralized MEME Coin.
🗓️To Be Launched On BSC Network August 10 12:30 UTC

💬 TG Community : https://t.me/unclecrooge
...
contract UNCLECROOGE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "UNCLE CROOGE";
    ...
    address payable public DevWallet = payable(0xE34721b1200CD56C2CD7180bF63A179438a3af0d);
    address payable public MarketingWallet = payable(0x2875F1b42E9a34FcCe47Bf4CA9B9467Bca40bfBF);
    ...
    function maxWalletLimitPercent(uint256 newmaxWallet) external onlyAddress {
