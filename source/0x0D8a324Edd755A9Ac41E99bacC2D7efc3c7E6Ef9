...
If you aren't drinking a truly, go grab your favorite alcoholic beverage! If you don't drink, then go roll up a fatty, if you don't smoke then go get laid by one ;)

Telegram: https://t.me/Truly_IN_U
Website: Truly.app
*******************************&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
contract TRULY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Truly IN U";
    string private constant _symbol = "TRULY";
