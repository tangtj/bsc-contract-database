/*
DOGE TOSHI  the most profitable token for Whales & future whales

With Doge Toshi investors have found a safe utility, meme & community token on the market…
...
contract DogeToshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Toshi";
