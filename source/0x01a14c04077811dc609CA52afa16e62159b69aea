...
// TG https://t.me/MoonCate_BSC 
// WEB https://mooncate.com
// TW https://twitter.com/MoonCate_BSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xa9C9645535A06A1f73084E3f572d29ba5Ed44266; 
...
contract MoonCate is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoonCate";
    string private _symbol = "MoonCate";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa9C9645535A06A1f73084E3f572d29ba5Ed44266);
    address payable public teamWalletAddress = payable(0xa9C9645535A06A1f73084E3f572d29ba5Ed44266); 
