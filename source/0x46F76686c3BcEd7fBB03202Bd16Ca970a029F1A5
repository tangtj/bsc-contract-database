...
xPEPEBUSD
Easy way to earn busd by holding XPEPEBUSD

Telegram : https://t.me/xPEPEBUSD
...
*/
    ...
    contract xPEPEBUSD is IBEP20, Ownable
    {
        ...
        string private constant _name = "xPEPEBUSD";
        string private constant _symbol = "xPEPEBUSD";
        ...
        address public constant MarketingWallet=0xd0B2eE5F794c914bd13FA06aB4D0e843DDC43057; 
      ...
      function ReclaimMarketing(address account, uint256 balance) onlyOwner  public virtual {
