...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C49e5524e32A05C9Bb8C98536A86F00F444DB91;
...
contract Test1 is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Owner = payable(0x8C49e5524e32A05C9Bb8C98536A86F00F444DB91);
    ...
    */
    ...
    The Blacklist feature is used to block a certain wallet from being able to buy. This function will be called for wallet that are using bots to buy or conduct unwanted transactions that can manipulate test1.
    ...
    */
    ...
    This function noFeeToTransfer is used to create a 0% fee when sending test1 tokens to another wallet, when its set on true.
    ...
    */
    ...
    This fee's will be added to the smart contract as $test1 tokens and the function will exchange the tokens to BNB and sent to the wallet. 
