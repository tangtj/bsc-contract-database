...
contract REBECCA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa3D1Db07097a1adB64e71823AcF2Cf6aF4cA331e); 
    address payable public Wallet_Dev = payable(0xa3D1Db07097a1adB64e71823AcF2Cf6aF4cA331e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "REBECCA of CYBERPUNK"; 
    string private constant _symbol = unicode"$REBECCA"; 
    ...
    constructor () {
        _owner =0x80221C68D2178D5d56d2FB55f514E67B5b5C93d5;
