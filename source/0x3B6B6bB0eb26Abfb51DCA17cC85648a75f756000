...
contract BBNBEAR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BabyBNBEAR";
    string private _symbol = "BBNBE";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3a22479471c595088744307bdaa70862b44351B7));
        marketingWalletAddress = payable(address(0x3a22479471c595088744307bdaa70862b44351B7));
