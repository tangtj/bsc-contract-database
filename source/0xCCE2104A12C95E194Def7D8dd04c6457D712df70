...
contract BeanBase is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed(block.chainid==1 ? "BeanBase" : "BeanBase", block.chainid==1 ? "BBase" : "BeanBase", DECIMALS) {
        address dexAddress;
        if(block.chainid == 1){
       ...
       _1_x = "x.com"; // @dev update
        _2_telegram = "https://t.me/BeanBase";
        _3_website = "";
