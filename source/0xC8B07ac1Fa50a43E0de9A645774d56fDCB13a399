...
contract DogeBucks is Context, IERC20 { 
    ...
    string private constant _name = "DogeBucks"; 
    string private constant _symbol = unicode"DOGBX"; 
    ...
    constructor () {
        _owner =0xc3B1c027BBC01b063b41d340546Ee9Ce3455dC77;
