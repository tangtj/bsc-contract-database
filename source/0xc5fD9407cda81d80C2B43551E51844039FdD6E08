...
contract BabyBbx is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyBbxDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyBbx", "BBbx") {
        marketingWallet = payable(0x3f38f058c005AcF2C948c47a9f8c89A5Ac55fa2A);
        devWallet = payable(0x3f38f058c005AcF2C948c47a9f8c89A5Ac55fa2A);
        ...
        dividendTracker = new BabyBbxDividendTracker(
            payable(this),
            router,
            0x8c9BfCaeacD5535D51A76Df27e5dB5D1d2efD74E,
            "BabyBbxTRACKER",
            "BBbxTRACKER"
        );
...
contract BabyBbxDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyBbx public BabyBbxContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyBbxContract = BabyBbx(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabyBbx_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabyBbx_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyBbx contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyBbxContract);

            uint256 prevBalance = BabyBbxContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyBbxContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyBbxContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
