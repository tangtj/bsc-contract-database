/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat DaikonToken designed.
    
    I make this #DaikonToken to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/DaikonBSC
   ...
   I will renounce the ownership to burn addresses to transfer #DaikonToken to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 50% total supply to the pool
   Can you make #DaikonToken 100000X? 
   ...
   it's the best part of the #DaikonToken idea, increasing the liquidity pool automatically, 
...
contract DaikonToken is Context, IERC20, Ownable {
    ...
    string private _name = "Daikon Token";
    string private _symbol = "Daikon";
