...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf044633284a132Eb2363E080643376583eBBA6C3;
...
contract NyanMoon is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xEee3111f23f006D3d89ecD7051D41620FA9C02D5;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 112358132134 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NyanMoon";
    string private _symbol = "NyanMoon";
    ...
    uint256 public maxBuyAmount = 1 * 10**3 * 10**18;
    uint256 public maxSellAmount = 2 * 10**3 * 10**18;
    ...
    require(recipients.length == amounts.length, "Invalid input: array lengths must match");
