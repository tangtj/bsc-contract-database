...
contract AEDARTNetwork {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 250000e18; //available supply
	...
	string constant public name = "AEDART Network";
	string constant public symbol = "AEDART";
