...
contract BabySpurdoInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Spurdo Inu";
    string private _symbol = "BSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32722038e3ADeaA10e4Aec1fb71FE521f76CDaa1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x32722038e3ADeaA10e4Aec1fb71FE521f76CDaa1); // BuyBack Address
