...
contract ThunderRacer is Context, IERC20, Ownable {
    ...
    string private _name = "ThunderRacer";
    string private _symbol = "RACERR";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x9bA956e1C9417cA7223DE8684619414D5dFFD9e2);
