...
contract MotoMoto is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 350 * 10**6 * 10**18;
    ...
    address payable private _developmentAddress = payable(0x0Fe6c4528E1763595b5084A902bfea21EF6f49dC);
    address payable private _marketingAddress = payable(0x6f3FDA2AD8eF421E06458dd4F217aC7a0485230c);
