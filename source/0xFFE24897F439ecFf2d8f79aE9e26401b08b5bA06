...
contract IXBTC is Context, IERC20, Ownable {
    ...
    address public  rewardAddress = 0x13D6C6424CEf421F3BB37757A31Fecb7F1A6A41c;
    ...
    uint256 public buyLiquidityFees = 5;
    uint256 public sellLiquidityFees = 5;
    uint256 public buyDeadFee = 0;
    uint256 public sellDeadFee = 0;
    uint256 public getNumberOfDividendTokenHolders = 500;
