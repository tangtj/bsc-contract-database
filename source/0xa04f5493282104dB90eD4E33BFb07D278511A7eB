...
contract OLYMPICGAMESDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbf5B340D69e06be6AE8Df2C31e08d1e69fD2995B); 
    address payable public Wallet_Dev = payable(0x326352e17427069D30B4263Da2Cd89E598192538);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "OLYMPIC GAMES DOGE"; 
    string private constant _symbol = unicode"OGD"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 9;
    uint256 public _Tax_On_Sell = 9;
    uint256 public Percent_Marketing = 93;
    uint256 public Percent_Dev = 0;
    uint256 public Percent_Burn = 6;
    ...
    constructor () {
        _owner =0x326352e17427069D30B4263Da2Cd89E598192538;
