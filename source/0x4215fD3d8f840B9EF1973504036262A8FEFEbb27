...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 10000 * 10 ** IERC20(DividendToken).decimals();
        
        holderCondition = 110000000 * tokenDecimals;

        addLpProvider(ReceiveAddress);
       
        _limitAmount = 50000 * tokenDecimals;
        
        _numToSell = 20000000 * tokenDecimals;
    }
...
contract CCDSNB is AbsToken {
    ...
    //总量
        200000000,
    //
        address(0x2eE98A355439FB34F2b77374468d0A5d07F1aaC0),
    //
        address(0x5Ffaf377385A608536CB6Ac9Eced90e0F35d8CeF)
    ){
