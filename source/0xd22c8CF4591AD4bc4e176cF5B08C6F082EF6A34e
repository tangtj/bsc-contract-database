/**
https://t.me/LibraTwoPointZeroBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D8ECb769FCc9c615ae8C1E6E53DBD2012e8a95F; // owner address
...
contract Libra2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Libra 2.0";
    string private _symbol = "$LIB2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC89F57Eb26d60CbcB86bb6Bd85156e0B3Fd7eaf5); // Marketing Address
    address payable private teamWalletAddress = payable(0x1D8ECb769FCc9c615ae8C1E6E53DBD2012e8a95F); // Team Address
