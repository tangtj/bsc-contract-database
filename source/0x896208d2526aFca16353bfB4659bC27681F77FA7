...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    string private _name = "SHIDAO";
    string private _symbol = "SHIDAO";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xb3503C93fE8194a8cBd827fb9C440453906aAA41);
    address public pointAddress = address(0xb3503C93fE8194a8cBd827fb9C440453906aAA41);
