...
contract SonOfBTC is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SonOfBTC";
   string constant _symbol = "SNOFBTC";
...
uint256 reflectionFee = 200;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x81089Ed7fA92390F1a74400718fB8d916c10d082;
