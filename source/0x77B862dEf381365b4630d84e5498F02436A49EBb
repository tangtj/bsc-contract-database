...
contract anubisinu is Context, IERC20, Ownable {
    ...
    string private _symbol = "AnuInu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF186aE40D4d89C1891aA16ea2C2b3Ef8C1298e76);
    address payable private DevelopmentWalletAddress = payable(0xF186aE40D4d89C1891aA16ea2C2b3Ef8C1298e76);
