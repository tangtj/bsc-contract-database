...
contract Metarium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Metarium";
    string private _symbol = "Meta";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x604B17D8737BFD9021A7104827C3C8aeC650E9b9); // Marketing Address
    address payable public teamWalletAddress = payable(0xf41Bd043044269C76848bE35f5D25C43dbf81c1B); // Team Address
