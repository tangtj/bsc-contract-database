...
contract PEPEROB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Rob";
    string private constant _symbol = unicode"PEPEROB";
