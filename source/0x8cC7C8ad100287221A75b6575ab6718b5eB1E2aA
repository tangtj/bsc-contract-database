...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe02D6738175b1CC64F13a8e850e2079771d2A84F; // owner address
...
contract PIG6699 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "6699";
    string private _symbol = "6699";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe02D6738175b1CC64F13a8e850e2079771d2A84F); // Marketing Address
    address payable private teamWalletAddress = payable(0xe02D6738175b1CC64F13a8e850e2079771d2A84F); // Team Address
    ...
    uint256 public _walletMax = 90 * 10**_decimals;
