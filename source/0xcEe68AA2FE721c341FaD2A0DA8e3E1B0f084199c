/*
Xiroverse is airdropping 5 XIRO tokens to participants for completing listed tasks.
Earn an additional 10 XIRO tokens for each referral.
...
Step by step guide
1
Visit Xiroverse's Airdrop Page
2 https://www.xiroverse.com/xiro-app?kid=2FH93E
Join the waitlist and earn 5 XIRO tokens
3
Follow Xiroverse's Twitter Page
4https://twitter.com/xiroverse
Share your referral link to earn 10 XIRO tokens for each referral
*/
...
contract Xiroverse  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Xiroverse';
    string private _symbol = 'Xiroverse';
