...
contract ETHTigerTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public dbvjg67;
    ...
    string private _tokenname = "ETHTiger";
    string private _tokensymbol = "ETHTiger";
