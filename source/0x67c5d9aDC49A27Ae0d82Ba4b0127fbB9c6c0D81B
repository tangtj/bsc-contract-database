...
contract DockToken is ERC20, Ownable {
    ...
    address public walletAddress = 0xCC0538B7222c2B7EC1DF6f2e8aD554872489Fbbd;
    ...
    event FeesUpdated(uint256 feeBuy, uint256 feeSell);
    ...
    constructor () ERC20("Dock Token", "DCT") 
    {   
    ...
    function setFees(uint256 _feeBuy, uint256 _feeSell) external onlyOwner {
        require(_feeBuy <= 20, "Marketing fee on buy cannot be more than 20%");
        require(_feeSell <= 20, "Marketing fee on sell cannot be more than 20%");
        feeBuy  = _feeBuy;
        feeSell = _feeSell;
  ...
  if (
        ...
        if(takeFee) {
            ...
            if(from == uniswapV2Pair) {
                fees = amount * feeBuy / 100;
            } else if (to == uniswapV2Pair) {
                fees = amount * feeSell / 100;
            } else {
                fees = 0;
            }
            amount -= fees;
