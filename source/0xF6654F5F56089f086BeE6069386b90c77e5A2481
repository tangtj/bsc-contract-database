...
//--- Contract v2 ---//
contract SHIBX is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xc9e9d17345F0f7F74Ca62624733498712902bb7D);
    address payable private marketingAddress2 = payable(0x91C7b741994EEAcDc23d2758318020CaCE21Dd9d);


    IRouter02 public swapRouter;
    string constant private _name = "ShibElonMuskX";
    string constant private _symbol = "SHIBX";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 onefifth = address(this).balance / 5;


        if(onefifth > 0) {(success,) = marketingAddress2.call{value: onefifth, gas: 35000}("");}
