...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x581c20f1Bee6af9692fF92E3bf7bA275CbC35E8C);
    address public ownerAddress = address(0xeAf34290088B73E71e37A3D2B0232a99f44fD68d);
    string private _name = "ZYQ";
    string private _symbol = "ZYQ";
    ...
    uint256 private _tTotal = 18888 * 10 ** _decimals;
    ...
    uint256 public _sellFundFee = 1650;
