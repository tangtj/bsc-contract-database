...
TELEGRAM:  https://t.me/shibainuclassic_bep20
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38E5bB70327D8918c778Be729F2d1b2d9126594A; // owner address
...
contract ShibaInuClassic is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHINUC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x38E5bB70327D8918c778Be729F2d1b2d9126594A); // Marketing Address
    address payable private teamWalletAddress = payable(0x38E5bB70327D8918c778Be729F2d1b2d9126594A); // Team Address
