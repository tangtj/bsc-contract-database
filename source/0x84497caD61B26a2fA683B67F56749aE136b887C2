...
contract RacerX is ERC20, Ownable { 
    ...
    constructor() ERC20("Racer X", "RACERX") { 
        marketingWallet = payable(0x1A09946bfb54E74D49a74d7CE6EB9ba1B0ec1C2A); 
        devWallet = payable(0xc81A27c9eAEe376F07278689218A09e0DCcee016); 
