...
contract layertech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LAYER TECH";
    string private _symbol = "$LTECH";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x66f6Af7c98a8Da9A99F3AF8518C03BeD5DbDe299);
    address payable private DevelopmentWalletAddress = payable(0x66f6Af7c98a8Da9A99F3AF8518C03BeD5DbDe299);
