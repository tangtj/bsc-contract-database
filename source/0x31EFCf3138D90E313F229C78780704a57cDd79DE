...
contract UATWinAccessControl {
    ...
    constructor() public {
        ...
        ownerWallet1 = 0xcE2d3B9CF07eDf9Cb631ca7A53317B2FE51d4BB8;
        ownerWallet2 = 0xd108671B3Ab1D10d92c8a575525F42fBd5219065;
        ownerWallet3 = 0x49BE591E03D39DBF6285F62226F2c3018E983869;
...
contract UATWin is UATWinAccessControl {
    ...
    function play(address _ref,uint256 value) public {
        tokenTransfer(0xa1C818A7141F5a28E7933c80954f9616e3A4062e).transferFrom(msg.sender,address(address(this)),value*1000000000000000000);
    ...
    function getPrize(uint _blockNum) public {
        ...
        t.executed = true;
        tokenTransfer(0xa1C818A7141F5a28E7933c80954f9616e3A4062e).transfer(msg.sender,winValue*1000000000000000000);
