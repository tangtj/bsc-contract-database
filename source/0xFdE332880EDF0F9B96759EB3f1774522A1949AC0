...
contract NewbornCakemoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NewbornCakemoonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Newborn Cakemoon", "NBCM") {
        marketingWallet = payable(0x5E64efa28eEB99fBE9445a077333dC365Fa73718);
        devWallet = payable(0x5E64efa28eEB99fBE9445a077333dC365Fa73718);
        ...
        dividendTracker = new NewbornCakemoonDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "Newborn CakemoonTRACKER",
            "NBCMTRACKER"
        );
...
contract NewbornCakemoonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    NewbornCakemoon public NewbornCakemoonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        NewbornCakemoonContract = NewbornCakemoon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Newborn Cakemoon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Newborn Cakemoon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Newborn Cakemoon contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(NewbornCakemoonContract);

            uint256 prevBalance = NewbornCakemoonContract.balanceOf(address(this));
            ...
            {
                uint256 received = NewbornCakemoonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    NewbornCakemoonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
