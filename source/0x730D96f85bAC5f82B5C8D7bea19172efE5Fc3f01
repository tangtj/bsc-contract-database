...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18837D11A1fE357a3e4ad8F4Ad1B4d01e8011f87; // owner address
...
contract NanoDorkLord is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nano DorkLord";
    string private _symbol = "NDL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x18837D11A1fE357a3e4ad8F4Ad1B4d01e8011f87); // Marketing Address
    address payable private teamWalletAddress = payable(0x18837D11A1fE357a3e4ad8F4Ad1B4d01e8011f87); // Team Address
