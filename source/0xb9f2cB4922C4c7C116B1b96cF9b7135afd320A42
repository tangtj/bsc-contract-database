...
contract Mevbotai is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x8cd0f2b68875D854Bb016E7C1233c928D5677ee5;

    string private constant _name = "Mev Bot Ai";
    string private constant _symbol = "MEVBOTAI";
