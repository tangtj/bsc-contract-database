...
contract DevToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev";
    string private _symbol = "Dev";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2fB1D610744e648B5bdF41e8f1ADfD87be8F57d6); 
    address payable public BurnedWalletAddress = payable(0x2fB1D610744e648B5bdF41e8f1ADfD87be8F57d6); 
