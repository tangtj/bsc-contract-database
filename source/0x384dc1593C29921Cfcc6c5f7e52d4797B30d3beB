...
Stellarium-STELLA // L1 Blockchain Project 
*/
...
library Address{
 ...
 contract Stellarium is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2A7E83712Fd93c9C42b9d97e37ACDB09bEDbA5dA;
    address public developmentWallet = 0x2A7E83712Fd93c9C42b9d97e37ACDB09bEDbA5dA;

    string private constant _name = "Stellarium";
