...
*/
/**
Telegram: https://t.me/Ninja_frog_Portal
✉ Commited
✉ MEME
✉ SAFE
✉ FROGGY
...
contract NinjaFROG is Context, IERC20, Ownable {
    ...
    string private constant _name = "NinjaFROG"; //
    string private constant _symbol = "NINJAFROG"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0xeC1d8dA80666A197c1677Ccd3b67432C885F7674 ;
