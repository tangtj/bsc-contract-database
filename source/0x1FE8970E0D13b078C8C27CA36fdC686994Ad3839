...
https://www.imdb.com/title/tt5627370/
*/
...
contract RABBITGIRL is Ma, Ru, io {
   ...
   string websites;
   string public RABBITGIRLwebsite = "https://www.imdb.com/title/tt5627370/";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "https://www.pinterest.com/queenofcoloring/rabbit-girl/"; 
        _name = "RABBIT GIRL";
        _symbol = "RABBIT";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        return owner();
                ...
                function getRABBITGIRLwebsite() public view returns (string memory) {
        return RABBITGIRLwebsite;
    } 
    /**
    * @dev Returns the token symbol.
    */
