...
BENDER CASH - BITCOIN CASH 

Telegram : https://twitter.com/BendercashBsc
twitter  : https://twitter.com/BendercashBsc
...
contract BENDERCASH is ERC20, Ownable {
    ...
    constructor() payable ERC20("BENDER CASH", "$BCH") {

        rewardToken = 0x8fF795a6F4D97E7887C79beA79aba5cc76444aDf;
        ...
        marketingWallet = 0x06f429C1cedB8A05B11dAE009DA4B8bB2bED7A82;

        dividendTracker = new DividendTracker(400 * 10**2, rewardToken);
