...
contract UtopiaDoge  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UtopiaDoge ";
    string private _symbol = "UtopiaDoge ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xa61455f054Bed31a8387800dB015C034A46630fF);
    address payable public teamWalletAddress = payable(0xa373d91762a7F66296Bc0070Efa45E42fc6b4F9a);
