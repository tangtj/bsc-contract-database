...
contract BUYNEWWIFES is Context, IERC20, Ownable {
    ...
    string private constant _name = "Buy New Wifes"; // 
    string private constant _symbol = "BNW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x489285EFDe925aD3047F45735efFD59E6D9c32da;
