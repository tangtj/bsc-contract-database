...
contract ZGL is Token {
    constructor() ERC20(
        "ZGL",   // 名字
        "ZGL"   // 符号
    ) {
        uint256 _totalSupply = 1588 ether;
        address _marketing = address(0x4201152C635BaaB05bc6692c9B35371B99111111); //
        address _receive = address(0xCc2591f49F651fb077aaEBAe9bFBBf53D6fb21d3);   //
        ...
        feeMarketingTo2 = address(0x4201152C635BaaB05bc6692c9B35371B99111111);
        feeEarn = 0;
    }
}