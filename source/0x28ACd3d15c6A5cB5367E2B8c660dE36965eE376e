...
//TELEGRAM: https://t.me/titanofinance2
interface IERC20 {
...
contract titano2 is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x4bd082544917b88a73fC58cAAF33338b4b29f58a;
    address public devAddress = 0xDCe61e447430fA97CFD1df7DC5EC92070d83512f;

    string private constant _name = "titano2.0";
    string private constant _symbol = "titano2.0";
    ...
    Taxes public taxes = Taxes(1,0,24,4);
    Taxes public sellTaxes = Taxes(2,0,28,4);
