...
Telegram : https://t.me/dashuoffcial
...
contract dashu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    dashuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("dashu", "dashu") {
        marketingWallet = payable(0x9edFE326AB47C150ffF084F848CE6f73d81A3Bd6);
        devWallet = payable(0x2665740C6722Cf4aD3F481A452563739a95BCC51);
        ...
        dividendTracker = new dashuDividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(totalSellFees <= 25 && totalBuyFees <= 25, "total");
...
contract dashuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        dashuContract = dashu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "dashu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "dashu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dashu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(dashuContract);

            uint256 prevBalance = dashuContract.balanceOf(address(this));
            ...
            {
                uint256 received = dashuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    dashuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
