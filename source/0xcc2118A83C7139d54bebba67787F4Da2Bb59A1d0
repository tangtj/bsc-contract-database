 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://ceresglobal.io                                     │
 *   |   E-mail: support@ceresglobal.io                                     |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 */
...
contract TokenCRSTK is ERC20 {
    using SafeMath for uint256;

    uint256 public maxSupply = 98 * 10**6 * 10**18;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public uniswapV2Pair;

    constructor() {
        _initialize("CERES GLOBAL INVESTMENTS TOKEN", "CRSTK", 18, maxSupply);
