/*
TG: https://t.me/bscglorylaunch
X: https://twitter.com/BSCGLORY
Website: www.bscglory.online
*/
...
contract BSCGlory is Context, IBEP20, Ownable {
    ...
    string private _name = "B.S.C. Glory";
    string private _symbol = "BSCGLORY";
