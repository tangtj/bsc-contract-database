...
// File: contracts/token/BEP20/AdvancedBEP20.sol

pragma solidity ^0.8.0;

/**
 * @title AdvancedBEP20
 * @dev Implementation of the AdvancedBEP20
 */
...
contract AdvancedBEP20 is BEP20Burnable, BEP20Mintable, ServicePayer {
    constructor(
        string memory name_,
        ...
        payable
        BEP20(name_, symbol_)
        ServicePayer(feeReceiver_, "AdvancedBEP20")
    {
        require(initialBalance_ > 0, "AdvancedBEP20: supply cannot be zero");
