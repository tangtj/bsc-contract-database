...
contract XBOT is IBEP20, Auth {
    ...
    string constant _name = "XBOT TOKEN";
    ...
    address public marketingFeeReceiver = 0xB9A4d1e2bEb5A855e01dEB6005643B060E0D4F1f;
    address public devFeeReceiver = 0x8E8d2D62BA8C8F0E9f05CC2051bfB75f6E528DfA;
