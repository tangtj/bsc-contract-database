...
contract FREEROSSAUGUST2023 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " FREE ROSS AUGUST 2023";
    string private _symbol = "$FRS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x768422865FB4be09cf3593A6Be096eeF95b0A945);
    address payable public teamWalletAddress =
        payable(0xF4876EF5C3E034Ff5ee55613aCB79A17AAE8b183);
