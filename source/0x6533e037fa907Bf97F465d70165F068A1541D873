/**
    ...
    I make this #Little Dog to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/LittleDogBSC
   ...
   I will renounce the ownership to burn addresses to transfer #Little Dog to the community, make sure it's 100% safe.
	...
	contract LittleDog is Context, IERC20, Ownable {
		...
		uint256 private _tTotal = 1 * 10**26 * 10**9;
		uint256 private _rTotal = (MAX - (MAX % _tTotal));
		uint256 private _tFeeTotal;
		uint256 private _tBurnTotal;

		string private _name = "Little Dog";
		...
		uint256 public _maxTxAmount = 5 * 10**21 * 10**9;
