...
function openTrading() external onlyOwner() {
    ...
    uint256 liquidityAmount = _tTotal.mul(9000).div(10000); // Transfers 95% of total supply to the Uniswap pair
    _transfer(address(this), uniswapV2Pair, liquidityAmount);
