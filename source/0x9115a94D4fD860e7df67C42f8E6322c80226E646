...
contract KANJI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2049 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KANJI";
    ...
    address payable public marketingWallet = payable(0x75AAB7e2aEBA03821e324833441aD8D09BF8B8c7);
    ...
    uint256 public numTokensSellToAddToLiquidity = 21 * 10**18;
    uint256 public _maxTxAmount = 2049 * 10**18;
    uint256 public _maxWalletLimit = 2049 * 10**18;
    address admin;
