// Telegram     : https://t.me/RealioNetworkOfficial
// Twitter      : TBA
// Website      : TBA

// Realio Network: Layer-1 multi-chain Web3 ecosystem focused on the issuance and management of digitally native real-world assets (RWAs).
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x107EaE32FD43b4dDF23023588A82Fca3A370EDfd;
...
contract RealioNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x107EaE32FD43b4dDF23023588A82Fca3A370EDfd);
    address payable public teamWalletAddress = payable(0x107EaE32FD43b4dDF23023588A82Fca3A370EDfd);
