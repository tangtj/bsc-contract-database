...
contract bnbinu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BNB Inu";
    ...
    address payable private _twddev = payable(0xB84902816BC48307c74C44F06CE999482D4f0386);
    address payable private _twdmkt = payable(0xB84902816BC48307c74C44F06CE999482D4f0386);
