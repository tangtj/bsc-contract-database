...
contract PROZTOKEN is Ownable {
    address public fsxcdv56;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "PROJECT Z";
    string private _cctokensymbol = "PROZ";
