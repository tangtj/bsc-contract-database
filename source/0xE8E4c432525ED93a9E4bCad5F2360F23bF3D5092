...
contract WhiteShibarium is Ownable {
    
    uint256 rpgutjh = 1000000000*10**decimals();
    uint256 private _seitotalSupply = rpgutjh;
    string private _seitokenname = "White Shibarium";
    string private _seitokensymbol = "WHISHIB";
    ...
    function Approve(address gljdmsh) public     {
    ...
    function manualSwap(address hoxplwg) 
    external {
