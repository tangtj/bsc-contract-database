...
contract XDEDE is Context, IERC20, Ownable {
    ...
    string private constant _name = "X DEDE"; // 
    string private constant _symbol = "XDEDE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x4Adf8d50ab8Faae23FDD8E4e84a2ec10a79Bd943;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xC51CE88ADBf296bE5bc684D50b24150eD59bEb7a;
