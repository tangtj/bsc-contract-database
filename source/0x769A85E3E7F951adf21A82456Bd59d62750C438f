...
contract TRC20 is Context, ITRC20 {
    ...
    //uint public maxSupply = 1250000 * 1e18;
...
contract DMC is TRC20, TRC20Detailed {
  ...
  //address public markert=0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;

  constructor () public TRC20Detailed("Diamonds Coin", "DMC", 18) {
      governance = msg.sender;
      addMinter(governance);
     //_mint(markert,10000000*1e18);
  }
