...
contract PANCAKEBOT is ERC20, Ownable {
    ...
    constructor () ERC20("PANCAKEBOT", "PANCAKEBOT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xCD7C4Cd35Ed63124e6b4bA3ab05FE42cD20d7c9f;
