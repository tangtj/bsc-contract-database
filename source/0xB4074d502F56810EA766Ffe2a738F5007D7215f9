...
contract Firephoenix is Token {
    constructor() ERC20(
        "Firephoenix",   // 名字
        "Firephoenix"   // 符号
    ) {
        uint256 _totalSupply = 2100000000000000 ether;
        address _marketing = address(0x967eAcd56c6d0c9dE475D351f5Cd0Dfd4E073772); //
        address _receive = address(0x0D5022E3170eE22187783Eb4d1bD04C79D17E7F9);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x967eAcd56c6d0c9dE475D351f5Cd0Dfd4E073772)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x59aadCAF7A83F5Fb429940dB47f057C0ed37757b);
        feeEarn = 0;
    }
}