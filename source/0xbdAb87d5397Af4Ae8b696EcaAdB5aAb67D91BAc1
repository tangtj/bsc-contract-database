...
contract SPH is SPHDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SPHTeam;
    address private CharitySPH;
    ...
    string public override name = "Spearhead";
    string public override symbol = "SPH";
    ...
    constructor(uint totalSupplyValue, address SPHTeamAddress, address CharitySPHAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SPHTeam = SPHTeamAddress;
        CharitySPH = CharitySPHAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SPHTeam] =  totalSupply * 4 / 100;
        balances[CharitySPH] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SPHTeam pot
