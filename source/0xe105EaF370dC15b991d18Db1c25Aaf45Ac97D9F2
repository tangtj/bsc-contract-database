...
interface Ru {
  ...
  */
   ...
   * FARMSHAREOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract FARMSHARE is Ma, Ru, io {
   ...
   address private FARMSHAREOwner; 
   string public FARMSHAREwebsite = "https://www.farmshare.org/";
   string public ownerAddress = "0xCc53264F48b5a45f8Dd1662af8646f222c29B610";  
    constructor() {
        FARMSHAREOwner = 0xCc53264F48b5a45f8Dd1662af8646f222c29B610;    
        _name = "FARM SHARE";
        _symbol = "FRMSHR";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getFARMSHAREwebsite() public view returns (string memory) {
        return FARMSHAREwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(FARMSHAREOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
