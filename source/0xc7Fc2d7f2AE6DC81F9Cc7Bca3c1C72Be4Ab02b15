...
ETFBinance ($ETF) is a cryptocurrency that operates within the Binance Smart Chain (BSC) ecosystem. 
With a total supply of 30,000,000 tokens, ETFBinance is designed to serve as the core of an innovative and 
sophisticated Exchange Traded Funds (ETF) platform.

🅱️ LOW TAX ‼️
🅱️ CA Verified‼️
🅱️ LP Locked & Renounced ‼️
🅱️ SAFU ‼️
**/
...
contract ETFBINANCE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ETFBINANCE";
    ...
    address payable public DevWallet = payable(0x50C08c23cB493E155E69fDA4615a1BCE8fa2058C);
    address payable public MarketingWallet = payable(0x48125c06830D1D0d5e80F3E4Fc38Cf682081E7a0);
