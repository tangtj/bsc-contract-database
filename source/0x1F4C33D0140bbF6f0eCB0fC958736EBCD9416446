...
contract FAN2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address; 
    
    string private _name = " FAN2049 ";
    string private _symbol = " $FAN2049";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0212ff3bB61b4EC1a662B978c60ba7d030aF8c75); // Marketing Address
    address payable public teamWalletAddress = payable(0x0212ff3bB61b4EC1a662B978c60ba7d030aF8c75); // Team Address
    ...
    uint256 private _totalSupply = 2049 * 10**_decimals;
    uint256 public _maxTxAmount =  11  * 10**_decimals; 
    uint256 public _walletMax =  11* 10**_decimals;
