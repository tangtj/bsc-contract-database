/**
"Unlocking New Horizons: Imagine the Boundless 
Potential of a Crypto Token Backed by Your Vision, Elon. 
Join the Evolution, Shape the Future with Token 'X'."

https://t.me/projectsxcoin
...
contract PROJECTSX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Project's X", "X") {
        ...
        marketingWallet = address(0x2458f7112C2c6967AfF5422c417C65e13b043CF6); // set as marketing wallet
        devWallet = address(0x2458f7112C2c6967AfF5422c417C65e13b043CF6); // set as dev wallet
