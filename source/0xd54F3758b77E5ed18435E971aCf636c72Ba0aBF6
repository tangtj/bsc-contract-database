...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9fC79182C98a6F9471495AFe777e1646DB7CDe66; // owner address
...
contract PegeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE TIGE INU";
    string private _symbol = "$PEGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9fC79182C98a6F9471495AFe777e1646DB7CDe66); // Marketing Address
    address payable private teamWalletAddress = payable(0x9fC79182C98a6F9471495AFe777e1646DB7CDe66); // Team Address
