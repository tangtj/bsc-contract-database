...
contract DIN is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x9605d933F670e37949d8D9432b4d79fA7346DE37);
    address payable public devWallet = payable(0x87FC7437e0fea9d3AA5fAdb3E5FB29fC31f1976D);
    address payable public charityWallet = payable(0xA9d72A39aD8A272140d8A02A6CFB40689baddDde);
    ...
    constructor() ERC20("Dragon Inu", "DIN") {
        ...
        */
        _mint(owner(), 2000000000000 * (10**18));
    }
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DIN: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DIN: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DIN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DIN: Automated market maker pair is already set to that value");
