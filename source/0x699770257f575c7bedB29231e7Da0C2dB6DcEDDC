/**
https://t.me/jumptokenbsc
http://twitter.com/jumptokenbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E9154B7200a8532082e09312e210C71A2Ddf137; 
...
contract JUMP_TOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JUMP";
    string private _symbol = "JUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7E9154B7200a8532082e09312e210C71A2Ddf137); 
    address payable public teamWalletAddress = payable(0x7E9154B7200a8532082e09312e210C71A2Ddf137); 
