/*
    This is the contract for launch "Eden Bull (BED)" 
    Website: https://frenchbulldog.fun/
    Telegram Author: @Th3nD
*/
...
contract EdenBull is ERC20, Ownable {
    ...
    address public marketingWallet = 0x81BaD2eb2A20d8172A9759de9f60E4D8b176c060;
    address public devWallet = 0x7a3aca7BF5330a15aE23cBe9d44182f57CD8Daa4;
    ...
    constructor() ERC20("EdenBull", "BED") {
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity +  _developer) <= 5, "Must keep fees at 15% or less");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _developer) <= 5, "Must keep fees at 99% or less");
    }
