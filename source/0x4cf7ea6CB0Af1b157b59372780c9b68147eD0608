...
contract IslandBoyz is Context, IERC20, Ownable {
    ...
    string private _name = "Island Boyz";
    string private _symbol = "$ISLBYZ";
    ...
    address payable public marketingWallet = payable(0x5cc0C6Bc29d7FFE87340718B5983F54af795cAcb);
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public _teamFee = 4;
    address payable public teamWallet = payable(0x4BC88B6984c788ca6F149eD23faEf5973D390D0B);
