...
library Data_Structures {
    ...
    struct Global {
        ...
        // The total amount of MFPIGS minted
...
library Constants {
    ...
    // Founder Wallets
    address internal constant founder_0 = 0xfd71cf2880F763655372b5C217e84B7dFb249954; // S
    address internal constant founder_1 = 0x951A277f10ce772c4CB4a4E4d2429144A8ed34DD; // P


    // Company
    address internal constant company_wallet = 0xC406e96A99dD0fb3efc3C3176cc558040DD461BF; // Owner

    // Price signing
    address internal constant pricing_authority = 0xADecd2ef134ce2974715CbC2F670BFB91647aFb9; // Signer
    ...
    // Token supply
    uint128 internal constant founder_reward = 50 * 10**9 * decimals; // 2x 50 Billion
    uint128 internal constant max_presale_quantity = 400 * 10**9 * decimals; // 400 Billion
    uint128 internal constant maximum_subsidy = 500 * 10**9 * decimals; // 500 Billion
...
contract MFPIGS is ERC20Upgradeable, OwnableUpgradeable {

    // ------- Events -------
    event _claim_mfpigs(address recipient_address, uint128 amount_minted, uint32 timestamp);
    event _mint_mfpigs(address indexed recipient_address, uint128 amount_minted, uint128 amount_paid, uint32 timestamp, uint8 currency_index);
    ...
    function initialize() public initializer {
        ...
        // Describe the token
        __ERC20_init("TheMemeFarm Pigs", "MFPIGS");
        __Ownable_init();
        ...
        public
    {
        ...
        require(
            ...
            "This function is only available to The Meme Farm admins"
        );
        ...
        // Emit event
        emit _claim_mfpigs(recipient, quantity, uint32(block.timestamp));
    }

    /*
    function mint_mfpigs(
        address recipient,
        ...
        public payable
    {
        ...
        // Emit event
        emit _mint_mfpigs(recipient, quantity, amount_payable, uint32(block.timestamp), currency_index);
    ...
    */
    ...
    modifier only_address_owner(address contract_address, address owner_address) {
        ...
        // Check if the sender is the owner of MFPIGS contract
