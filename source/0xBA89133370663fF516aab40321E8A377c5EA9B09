/**
 *https://t.me/BLURSTORM
 *In a lush forest lived a fast and beautiful bird, Blurstorm. One day, the central forest lake dried up, threatening the animals' survival.   
*/
...
contract BLURSTORM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xFa4B4D7559DF5526012D5bF3da9ac04FabE4ff54); // Driven to help, Blurstorm embarked on a mission to find the lost water. 
        
    address payable public teamAddress =
        payable(0xFa4B4D7559DF5526012D5bF3da9ac04FabE4ff54); // Seeing a dark cloud over the tallest mountain, she flew towards it.
        
    address payable public liquidityAddress =
        payable(0xFa4B4D7559DF5526012D5bF3da9ac04FabE4ff54); // She was welcomed by a voice demanding she solve three riddles to get the water back
        
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD; // Blurstorm correctly answered "Water! Fire! Time!" to the riddles... 
    ...
    string private constant _name = "BLURSTORM";

    string private constant _symbol = "$BLRM";
    ...
    uint256 public tradingActiveBlock = 0; // Upon her correct answers
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 7 / 10000; // a majestic fountain appeared
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // Blurstorm, hailed as a forest hero
            path,
            address(this),
            block.timestamp
        );
