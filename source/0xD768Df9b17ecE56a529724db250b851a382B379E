...
contract FootbalMetaverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "Football Metaverse"; //
    string private constant _symbol = "FMS"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0xD6b3E0f0172c9971426B91Be408b0938Ef644AF9;
