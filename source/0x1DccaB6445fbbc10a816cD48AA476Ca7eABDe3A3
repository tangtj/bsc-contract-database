...
contract Test9 is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x0e9AB76b6a106554CD978248C95A074b460Ecd71;
        ...
        maxTransactionAmountBuy     = totalSupply() * 1000000000 / 1000;
        maxTransactionAmountSell    = totalSupply() * 1000000000 / 1000;
