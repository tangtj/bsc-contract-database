...
contract SALAMANDER2049 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " SALAMANDER2049";
    string private _symbol = "SALLY2049";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x8B742586BC3987C948ce36BbeBDd16a4332167c6);
...
address payable private Team =
        payable(0x474ae9C34deAf663e28CD3e0aBa7bE24175bed76);
