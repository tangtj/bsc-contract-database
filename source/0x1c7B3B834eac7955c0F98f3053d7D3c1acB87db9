...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9cD9Bc1561fB4B00521726Dbdc760532d33eCd96; // owner address
...
contract  Catboy2K23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Catboy 2K23";
    string private _symbol = "Catboy2K23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x610Dec8cBfEAdb871F5D644F91820f3811295818); 
    address payable public teamWalletAddress = payable(0x610Dec8cBfEAdb871F5D644F91820f3811295818);
