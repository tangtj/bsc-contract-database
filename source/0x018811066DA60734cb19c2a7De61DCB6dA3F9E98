...
contract ASB is Token {
    ...
    address[] projectAddress = [address(0x12498235829e06DCF6978314f1e1caA540900240),
    address(0x735782beB970A39B81341C1A3A6d9b75fC246E36),
    address(0x16A76aB3b96611D5f3C1131cEb4fe1CacDC9a46e),
    address(0xf1b4eBE8A01B4E38dEf4E42F5A27CCb601206A96),
    address(0xD74f1A8F3BA6F0836e7de3438593c6E98D80872c),
    address(0xc5Db180A1847687eb3Efe943Cc5E5bcD59B90c06),
    address(0xD41Ad5C0631142F13D431a8cC63Da9E635A0e2e1),
    address(0x34e57B2FB5206aBc0eee8eC2e5e9510cADF81712)];
    constructor() Token(
        "ASB_test9527",
        "ASB_test9527",
        18,
        ...
        address(0x39B8472693B75035b54c70B0CC77888F069C2D9E)  //LDAO
    ){
    }
}