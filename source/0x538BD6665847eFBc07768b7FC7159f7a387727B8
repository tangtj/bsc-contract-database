...
contract RWT is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    uint256 totalSupply_ = 6400000000 * 10 ** 18;
    constructor(
        string memory name_,
        ...
        //营销钱包地址
        _marketingWalletAddress = 0xc2d1C19A30Cb699aFc8C736E15380cbF39bD0bE8;
        require(
        ...
        swapTokensAtAmount = totalSupply_.div(10**7); 
        ...
        _mint(_marketingWalletAddress, totalSupply_);

        emit TokenCreated(_marketingWalletAddress, address(this), TokenType.baby, VERSION);
    }
