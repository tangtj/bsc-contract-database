/**
* RexMoon employs 3 simple functions: Reflection + LP acquisition + Burn In each trade, the transaction is taxed a 10% fee, which is split 2 ways.
* 2% fee auto redistributed to all existing holders
* 4% fee add to the liquidity pool and burned
* Telegram: https://t.me/rexmoon_rexm
* Website: https://rexmoon.space
*/
...
contract RexMoonToken is Context, IBIP20, Ownable {
    ...
    string private _name = 'RexMoon.Space';
    string private _symbol = 'REXM';
