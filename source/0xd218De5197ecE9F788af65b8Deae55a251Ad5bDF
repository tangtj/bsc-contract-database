...
Telegram: https://t.me/FairyTaleBSC

Twitter: https://twitter.com/fairytalebsc

Website: https://fairytalebsc.live

Tiktok: www.tiktok.com/@fairytalebsc
*/
...
contract FairyTale is Context, IBEP20, Ownable {
    ...
    string private _name = "Fairy Tale";
    string private _symbol = "FTALE";
