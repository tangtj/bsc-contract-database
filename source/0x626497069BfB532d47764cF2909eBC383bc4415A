...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90B7FA89B538fee1551e316ACaffF1Ab055E2e16; // owner address
...
contract XenodeChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xenode Chain";
    string private _symbol = "XND";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x90B7FA89B538fee1551e316ACaffF1Ab055E2e16); // Marketing Address
    address payable private teamWalletAddress = payable(0x90B7FA89B538fee1551e316ACaffF1Ab055E2e16); // Team Address
