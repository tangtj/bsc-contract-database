...
contract OniBoyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "OniBoy Inu"; // 
    string private constant _symbol = "OniBoy"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xbD6AA327C8c0375034fe05D6d501458dd5575ea5;
