/**
 $METAGAMBIT - Metagambit Coin

Bet Beyond Boundaries, Unleash Your MetaGambit

Socials
Telegram Ann: https://t.me/metagambit
Twitter: https://twitter.com/MetaGambitOfc
Website: https://metagambil.fun/
...
contract METAGAMBIT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("METAGAMBIT", "METAGAMBIT") {
        ...
        uint256 totalSupply = 101_101_101 * 1e18;
        ...
        marketingWallet = address(0x3B607BF34dbcD4D627031588aC7fd72ae8a8f982); // set as marketing wallet
        devWallet = address(0x3B607BF34dbcD4D627031588aC7fd72ae8a8f982); // set as dev wallet
