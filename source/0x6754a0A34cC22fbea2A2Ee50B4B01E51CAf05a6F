...
contract DONTBUY is ERC20, Ownable {
    ...
    constructor() ERC20("DONTBUY", "DONTBUYMFKAZ") {
        marketingWallet = payable(0xfd6E60E3C8D023869ddf7058d2E3cFBd908607EF);
        devWallet = payable(0xfd6E60E3C8D023869ddf7058d2E3cFBd908607EF);
...
contract DONTBUYDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    DONTBUY public DONTBUYContract;
    ...
    constructor(
        ...
        defaultToken = token;
        DONTBUYContract = DONTBUY(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DONTBUY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DONTBUY contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DONTBUYContract);

            uint256 prevBalance = DONTBUYContract.balanceOf(address(this));
            ...
            {
                uint256 received = DONTBUYContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DONTBUYContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
