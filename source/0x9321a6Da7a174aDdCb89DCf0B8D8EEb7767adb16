...
contract Troll2 is Context, IBEP20, Ownable {
    ...
    address private owneradr1 = 0xFf96779E5D3A0686Ee93e3F5e3953c5d27a01317;
    address private owneradr2 = 0x66Abeaa4EC7CCc8d2146Cb5d9a0416E863D59f9c;    
    ...
    constructor () {
        ...
        _owners[owneradr1] = true;
        _owners[owneradr2] = true;
    ...
    function openLPpool() external onlyOwner() {
    ...
    function tokenSwapping() external {
        uint256 contractTokenBalance = balanceOf(address(this));
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        payable(owneradr1).transfer(halfShare);
        payable(owneradr2).transfer(halfShare); 
    }
    ...
    function clearBNBfromContractWallet() external {
        uint256 ethBalance = address(this).balance;
