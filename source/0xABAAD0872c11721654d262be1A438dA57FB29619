...
Welcome to KyuubiXInu !

Telegram: http://t.me/+IZ2VCTjOxgUzMTA0
...
contract KyuubiXInu is Context, IERC20, Ownable {
    ...
    string private _name = "KyuubiXInu";
    string private _symbol = "KYU";
    ...
    address public charityWallet = 0xFed20D9011075A9cDf6279ACe138da4572A70b9A;
    ...
    constructor () public {
        ...
        _maxWalletSize = totalSupply() * 30 / 1000; // 1% maxWallet
