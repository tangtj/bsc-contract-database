...
contract MuskRat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MuskRat";
    string constant _symbol = "$MRaT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0435648bFBB4c49BBE146E6D29CDc75C9037830d;
        ecosystemfeeReceiver = 0x72864f52a7D9086846b64BB6779ac00d3E47B341;
