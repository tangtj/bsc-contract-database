...
contract ABS is Context, IERC20, Ownable {
    ...
    function changeParams(uint256[] calldata _params)
        external
        onlyOwner
    {
        params[0] = _params[0];
...
contract KirinChip is ABS {
    constructor()
        ABS(
            "KirinChip",
            "Kirin",
            address(0xd8055E36076098b101B6963fcd7375101ED91f82), //Marketing
