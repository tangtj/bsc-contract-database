/**
Telegram : https://t.me/calciumbscportal
*/
...
contract calcium is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5c9E92b668F69C47aC66c13A76eF70d09c57Be18;

    string constant _name = "calcium";
    string constant _symbol = "CLC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = 3 * 10**6 * 10**_decimals;
    uint256 public _maxWalletToken = 3 * 10**6 * 10**_decimals;
