...
🟢XRPT is the XRP currency that embodies Technological innovation (XRPTechnology)

🟢 Website : https://xrpt.pro
🟢 Telegram : 
https://t.me/XRPTPORTAL
🟢 Twitter : 
https://twitter.com/xrptechnology
...
contract XRPT is ERC20, Ownable {
    ...
    constructor() payable ERC20("XRPT", "$XRPT") {
        ...
        marketingWallet = 0x11157ffb332ee1dCa32358a44bafcd2129FE15cf;

        dividendTracker = new DividendTracker(300 * 10**2, rewardToken);
