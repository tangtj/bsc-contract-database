// Telegram: https://t.me/rockstarinubsc_official 
...
contract ROCKSTARINUBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ROCKSTAR INU";
    ...
    address payable private _marketingWallet = payable(0x91d7906B28DC5Ecdb741B8286a5b4AA6Ee24D6D3);
    ...
    // Liquify when 1 billion tokens are stored
