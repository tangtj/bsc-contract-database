...
contract SafemoonSir is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safemoon Sir"; // 
    string private constant _symbol = "sSir"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x07C891CD924DeC2196a3619Ca610251bA2432bDC;
