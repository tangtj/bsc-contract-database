...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19bCF0D2DB97e2586066f0a0fCC7E4d1dfE69dC0; // owner address
...
contract BINANCEDORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BINANCE DORK";
    string private _symbol = "Bidork";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x19bCF0D2DB97e2586066f0a0fCC7E4d1dfE69dC0); // Marketing Address
    address payable private teamWalletAddress = payable(0x19bCF0D2DB97e2586066f0a0fCC7E4d1dfE69dC0); // Team Address
