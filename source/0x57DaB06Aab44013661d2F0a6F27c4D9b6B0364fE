...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81b1bC965DB494f16D7517a4D9d28d35534A5306;
...
contract tokenname is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x81b1bC965DB494f16D7517a4D9d28d35534A5306);
    address payable private Wallet_Burn = payable(0x81b1bC965DB494f16D7517a4D9d28d35534A5306); 
    address payable private Wallet_zero = payable(0x81b1bC965DB494f16D7517a4D9d28d35534A5306); 
