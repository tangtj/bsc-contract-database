...
contract FOOMTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public smmncb67;
    ...
    string private _tokenname = "FOOM";
    string private _tokensymbol = "FOOM";
