...
contract RakshasaCoin is Ownable, IBEP20 {
    ...
    uint256 public buyFeeToWallet4 = 0;
    ...
    uint256 public sellFeeToWallet3 = 2;
    uint256 public sellFeeToWallet4 = 0;
    ...
    uint256 public feeToWallet4;
    uint256 public feeToLpDifidend;
    uint256 public feeToHolders;
    uint256 public feeToPool;

    uint256 public minAmountToSwapForWallet1 = 1;
    uint256 public minAmountToSwapForWallet2 = 1;
    uint256 public minAmountToSwapForWallet3 = 1;
    uint256 public minAmountToSwapForWallet4 = 1;
    uint256 public minAmountToLpDifidend = 1;
    uint256 public minAmountToHolders = 1;
    uint256 public minAmountToHoldersDifidend = 1;
    uint256 public minAmountToPool = 1;

    bool private isLiquidityAdded;
    address private pancakeRouterAddr = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address private usdt = 0x55d398326f99059fF775485246999027B3197955;
    address public wallet1 = 0x1d5bcA50e0a438709Ddcd8E2eaf73b46F6888888;
    address public wallet2 = 0x1d5bcA50e0a438709Ddcd8E2eaf73b46F6888888;
    address public wallet3 = 0x1d5bcA50e0a438709Ddcd8E2eaf73b46F6888888;
    address public wallet4 = 0x000000000000000000000000000000000000dEaD;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(sender != pair && unlocked == 1 && feeToWallet4.mul(price).div(1e18) > minAmountToSwapForWallet4*(1e18)) {
            swapUSDTForWallet(wallet4);
        }
        ...
        if(!exemptFee[sender] && !exemptFee[recipient]) {
            ...
            if(sender == pair) { // buy
                ...
                //营销4
                if(buyFeeToWallet4 > 0) {
                    uint256 feeWallet4 = amount.div(100).mul(buyFeeToWallet4);
                    fixFee = fixFee.add(feeWallet4);
                    feeToWallet4 = feeToWallet4.add(feeWallet4);
                }
                ...
                if(sellFeeToWallet4 > 0) {
                    uint256 feeWallet4 = amount.div(100).mul(sellFeeToWallet4);
                    fixFee = fixFee.add(feeWallet4);
                    feeToWallet4 = feeToWallet4.add(feeWallet4);
                }
    ...
    function setMinAmountToSwapForWallet4(uint256 value) external onlyOwner() {
        minAmountToSwapForWallet4 = value;
    }
    ...
    function setNewWallet4(address account) external onlyOwner() {
        wallet4 = account;
    }
    ...
    function setBuyFeeToWallet4(uint256 value) external onlyOwner() {
        buyFeeToWallet4 = value;
    }
    ...
    function setSellFeeToWallet4(uint256 value) external onlyOwner() {
        sellFeeToWallet4 = value;
    }
