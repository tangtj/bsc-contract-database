...
contract OkamiV2 is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x8B310D4EEe993372e38845a847DFebA6d0E204aa),
        partner: payable(0xa90f8f17E95dba939Ae81cE52E3e380272eC8A17)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable partner) external onlyOwner {
        require(marketing != address(0) && partner != address(0), "Cannot be zero address.");
        _taxWallets.marketing = payable(marketing);
        _taxWallets.partner = payable(partner);
    }
    ...
    function setRatios(uint16 rewards, uint16 partner, uint16 marketing) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.partner = partner;
        _ratios.marketing = marketing;
        _ratios.total = rewards + partner + marketing;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 partnerBalance = (amtBalance * ratios.partner) / ratios.total;
        uint256 marketingBalance = amtBalance - (rewardsBalance + partnerBalance);
        ...
        if (ratios.partner > 0){
            (success,) = _taxWallets.partner.call{value: partnerBalance, gas: 55000}("");
        }
    }
