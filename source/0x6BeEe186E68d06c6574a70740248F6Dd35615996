...
// File contracts/WagieCopyTest.sol
...
contract TestBotTokenV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public developmentAddress =
    payable(0x2A8845074ccDA7AFc0eb64418e77D7004D0b2Cf2);
    ...
    uint256 public maxWallet = 20 * 10 ** 9;
    ...
    function initContract() external onlyOwner {
        ...
        developmentAddress = payable(
            0x2A8845074ccDA7AFc0eb64418e77D7004D0b2Cf2
        );
    }
    ...
    function _removeSniper(address account) external onlyOwner {
        require(
            account != 0x10ED43C718714eb63d5aA57B78B54704E256024E && account != 0x13f4EA83D0bd40E75C8222255bc855a974568Dd4,
            "We cannot blacklist PancakeSwap"
        );
