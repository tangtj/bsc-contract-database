...
contract Analyzer is IBEP20, Auth {
    ...
    string constant _name = "Analyzer Token";
    string constant _symbol = "Analyzer";
    ...
    address private marketingFeeReceiver = 0x679C4AbeE871495D9acdf8Ce7c79De0111413858;
    address private buybackFeeReceiver = 0x700638aAb1f88ead0Fd1E1691F2E4DA8f851ef3D;
