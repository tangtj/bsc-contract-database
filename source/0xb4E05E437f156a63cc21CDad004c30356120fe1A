...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3aAc40D002c89C856d064669459F30D2bd47AF52; // owner address
...
contract POPE is Context, IERC20, Ownable {
    ...
    string private _name = "HOLY PEPE";
    string private _symbol = "POPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3aAc40D002c89C856d064669459F30D2bd47AF52); // Marketing Address
    address payable private teamWalletAddress = payable(0x3aAc40D002c89C856d064669459F30D2bd47AF52); // Team Address
