// telegram     : https://t.me/SymbolicNetwork
// Website      : https://symbolicnetwork.net
// Twitter      : https://twitter.com/SymbolicNetwork
...
contract Symbolic is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Symbolic";
    string private _symbol = "SYB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9509b0c83c3936bab690B6e8636036e700A7C238); // Marketing Address
    address payable public teamWalletAddress = payable(0x9509b0c83c3936bab690B6e8636036e700A7C238); // Team Address
