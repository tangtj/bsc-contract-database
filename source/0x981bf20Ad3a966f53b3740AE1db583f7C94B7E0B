// https://t.me/BabyKobasu
// https://twitter.com/Baby_Kabosu
// https://babykabosu.io/
...
contract BabyKobasu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Kobasu";
    string private constant _symbol = unicode"BabyKobasu";
