// TG: https://t.me/Inuneumchain_global
...
contract INUNEUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "INUNEUM"; 
    string private _symbol = "INUNEUM"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9cB4ADfd8e2ED5dD985685386d9ca9E787469C65); 
    address payable public teamWalletAddress = payable(0x9cB4ADfd8e2ED5dD985685386d9ca9E787469C65); 
