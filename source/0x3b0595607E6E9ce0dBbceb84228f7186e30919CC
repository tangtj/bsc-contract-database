/**
   ...
   Welcome to LittlePanda
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittlePandaCommunity
   ...
   I will renounce the ownership to burn addresses to transfer #LittlePanda to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittlePanda idea, increasing the liquidity pool automatically, 
...
contract LittlePanda is Context, IERC20, Ownable {
    ...
    string private _name = "Little Panda";
    string private _symbol = "LTPANDA";
