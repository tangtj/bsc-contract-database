...
contract ARMYTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "ARMY";
    string private _seitokensymbol = "ARMY";
    address public xxchauu4;
