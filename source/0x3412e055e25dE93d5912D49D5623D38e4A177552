...
contract DOGG is Context, IERC20, Ownable {
    ...
    uint256 private constant _totalsSupplys = 100000000000 * 10**_decimals;
    string private constant _name = unicode"DOGG";
    ...
    constructor () {
        _marketingFeeReceiver = payable(0xE4F6f42d0076cc4131612D5d0b714bEaa9587161);
