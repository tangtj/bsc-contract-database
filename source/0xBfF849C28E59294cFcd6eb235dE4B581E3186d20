...
contract MiniFlokiFrunkPuppy is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Floki FrunkPuppy";
    string private _symbol = "MFFP";
    ...
    address public marketingWallet = 0xEf1A1aDc435814eD7181b940cF741195c512acdC;
