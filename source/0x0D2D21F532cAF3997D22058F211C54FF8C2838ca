...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function _mintAdminWithTokenURI(address user, uint256 nft_id) public onlyMinter returns (bool) {
        _mint(user, nft_id);
        _setTokenURI(nft_id, "https://bafkreibqqokkq2d3eut2clisv65yzkhuxg425htrglk66rwvuy2ceemtrm.ipfs.nftstorage.link");
        return true;
    }
...
contract QQQNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("QQQ NFT", "QQQ NFT") {
