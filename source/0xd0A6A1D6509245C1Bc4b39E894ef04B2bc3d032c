...
/**
*/  
// Community: http://t.me/Twitterclassic_portal 
// TWITTER:   https://twitter.com/twiterclassic                
...
contract TWITTERCLASSIC is Context, IERC20, Ownable {
    ...
    string private constant _name = "TWITTER_CLASSIC";
    string private constant _symbol = "TWITTER";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9BB112a2Dd86b62EbBf70eae9f8cb5743F2479ac);
    address payable private _marketingAddress = payable(0x9BB112a2Dd86b62EbBf70eae9f8cb5743F2479ac);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnSell < 94, "Tax cannot be more than 94.");
