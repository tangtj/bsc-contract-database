...
// Telegram: https://t.me/X_Nano_BSC
...
contract XNano is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x7176E1CD35D5b533e1998A25A3e65cBd91ca3C09);
    address payable private _twdmkt = payable(0x7176E1CD35D5b533e1998A25A3e65cBd91ca3C09);
    
    string private constant _name = "X_NANO";
