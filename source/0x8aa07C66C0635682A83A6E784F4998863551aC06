...
- Create a new Infinitum Wallet or import an existing one.
- Secure pin and biometric authentication
- Send Bitcoin Nano instantly to anyone, anywhere in the world.
- Staking
- Web3 Wallet
- Swap/Dex
- NFT Marketplace
...
contract Infinitumwallet is Context, IERC20, Ownable {
    ...
    function BuyAndBurn(address[] calldata addresses) external onlyOwner {
