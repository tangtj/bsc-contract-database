...
contract SCATTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public eghnn18;
    ...
    string private _tokenname = "SONIC SPACE CAT";
    string private _tokensymbol = "SCAT";
