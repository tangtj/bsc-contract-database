...
contract MERCHTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "CoinMerch";
    string private _seitokensymbol = "MERCH";
    address public ggdbvc6;
