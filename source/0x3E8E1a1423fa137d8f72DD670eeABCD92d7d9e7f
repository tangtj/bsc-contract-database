...
contract BABYSEC is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x30c8eA50f2c8fc5Ed82282AC26782ff0862b2A5F); // Marketing Address
    address payable public busdCharityWalletAddress = payable(0x152F1D8Ba290F0f545A190Bfe6eDBaE8B4aBB14b); // busd Address
