...
contract ProximaChain{
    using SafeMath for uint256;

    uint256 private _totalSupply = 7000000000000000000000000000;
    string private _name = "Proxima";
    string private _symbol = "PXM";
    ...
    uint256 private _airdropToken = 78000000000000000000;
