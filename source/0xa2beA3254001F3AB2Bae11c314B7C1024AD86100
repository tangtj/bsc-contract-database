...
/**
 * @dev Cointribute Token, and you know it.
 */
contract BEP20Token is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  event DonationWalletTransferred(address indexed previousWallet, address indexed newWallet);
  event TeamWalletTransferred(address indexed previousWallet, address indexed newWallet);
  ...
  /**
   * @dev Sets `wallet` as the new address of the donation wallet.
   */
  ...
  /**
   * @dev Sets `wallet` as the new address of the team wallet.
   */
