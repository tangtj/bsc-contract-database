//Telegram: https://t.me/WazzupShiba
...
contract WSHIB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDCF020dFaD587f16a75B573359653a2A376D7132); 
    ...
    string private _name = "WAZZUP SHIBA";
