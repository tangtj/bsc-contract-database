...
contract BFCToken is ERC20, ReentrancyGuard, Ownable {
    ...
    uint256 public constant MAX_MINT = 2090 * 10 ** 22;
    ...
    address public fundAddress =
        address(0x5107E3e6EC7769c0E81DE275deA1Dd6bA98af695); 
    address public mintAddress =
        address(0xB01581464D2271a3637d2161c0cb0B8956A8143D); 
    ...
    function setMark(bool _mark) external onlyOwner {
        mark = _mark;
    }
    ...
    function _transfer(
        ...
        if (ammPairs[to]) {
            ...
            if (isDelLdx) {
                require(mark,"Cannot del Liquidity");
