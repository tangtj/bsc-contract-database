...
contract BullStep is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        m2e: 0xA23799aA3d549e770e95de89255d66Cf9cDEA2b9,
        marketing: payable(0xdC4E7319da1349b9192532f19dDaf9732AEcb689),
        development: payable(0x377A214e3b40e1CC0Cba0494B40B9A03822c4DA0)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 m2e, uint16 marketing, uint16 development) external onlyOwner {
        _ratios.m2e = m2e;
        _ratios.marketing = marketing;
        _ratios.development = development;
        _ratios.totalSwap = marketing + development;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap + _ratios.m2e <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address  m2e, address payable marketing, address payable development) external onlyOwner {
        _taxWallets.m2e = m2e;
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        uint256 m2eAmount = (feeAmount * ratios.m2e) / (ratios.m2e + ratios.totalSwap);
        uint256 swpAmt = feeAmount - m2eAmount;
        if (ratios.m2e > 0) {
            address destination = _taxWallets.m2e;
            _tOwned[destination] += m2eAmount;
            emit Transfer(from, destination, m2eAmount);
        }
