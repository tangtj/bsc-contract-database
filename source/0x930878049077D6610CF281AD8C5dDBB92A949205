...
//**telegram https://t.me/Blaze_Ur_Glory
...
contract Blaze_Your_Glory is IERC20, Ownable, LibreMount {
    ...
    uint256 private _totalSupply =  100000000000000000000000000000; //Wei

    string private _name = "Blaze_Your_Glory";
