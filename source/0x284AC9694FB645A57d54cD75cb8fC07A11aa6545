...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6649Cf455E665a8D4268D9cCDdBdf3F55b1303b9; // owner address
...
contract PenguinEdition is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Penguin Edition";
    string private _symbol = "ODYSSEY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x485Ab7A2e064Fd75E5FdaAc76c013eBEb26ef009); // Marketing Address
    address payable private teamWalletAddress = payable(0x485Ab7A2e064Fd75E5FdaAc76c013eBEb26ef009); // Team Address
