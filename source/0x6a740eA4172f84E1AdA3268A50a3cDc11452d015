...
contract Gladiator is Context, IBEP20, Ownable {
    ...
    function ManuallyProvideLP() external {
    ...
    function swapCoinForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        BNBCoinNeeded = 42; // Initialization
    ...
    function clearcoinsInContract() external {
        uint256 ethBalance = address(this).balance;
