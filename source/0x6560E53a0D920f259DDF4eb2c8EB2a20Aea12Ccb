/**
Telegram : https://t.me/potabeebsc
...
contract PotaBee is ERC20, Ownable {
    ...
    constructor(address[] memory addresses) ERC20("PotaBee", "POBE") {
        ...
        devWallet = address(0x60B825811e9fB599Cc830354ADCA0B49107bA900); 
