...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDbDAb47735f04B5537145a04691D2a8d6526B8e9; 
...
contract MOONCAT is Context, IERC20, Ownable {
    ...
    string private _name = "MOONCAT TOKEN";
    string private _symbol = "MOONC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDbDAb47735f04B5537145a04691D2a8d6526B8e9); 
    address payable public teamWalletAddress = payable(0xDbDAb47735f04B5537145a04691D2a8d6526B8e9); 
