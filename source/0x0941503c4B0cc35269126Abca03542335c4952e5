...
contract WAZtoken is ERC20, Ownable {
    ...
    constructor () ERC20("WAZ Token", "WAZ") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x2b08544ee9651059b0460Fd00e870710f3A51376;
        donationsWallet = 0xb8A6d6825f1D0e1C69C212fdc4c7AF403F52d15d;

        maxTransactionLimitEnabled = true;

        transferOwnership(0xEB2875A21f16822A8D990D68a867a16118af6A02);
        ...
        _mint(owner(), 69000000000 * (10 ** decimals()));
