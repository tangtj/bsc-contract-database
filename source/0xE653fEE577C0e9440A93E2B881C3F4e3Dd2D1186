...
contract XMEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"𝕏-MEN";
    string private _symbol = unicode"$𝕏MEN";
    ...
    uint256 public _walletMax = 8 * 10**7 * 1**1 * 10**_decimals;
    ...
    function setFee(uint256[] calldata customs) external onlyOwner {
        _totalTaxIfBuying = customs[5]; 
        _totalTaxIfSelling = customs[6]; 
    }
