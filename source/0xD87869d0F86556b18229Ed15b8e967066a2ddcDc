...
contract Control7XY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Control7XYDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Control7XY", "Ctrl7XY") {
        marketingWallet = payable(0x7B700397129936b1e0178E97E8b6dA6d80381168);
        devWallet = payable(0x7B700397129936b1e0178E97E8b6dA6d80381168);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 3;
        sellDeadFees = 3;
        buyMarketingFees = 15;
        sellMarketingFees = 35;
        buyLiquidityFee = 2;
        sellLiquidityFee = 2;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new Control7XYDividendTracker(
            payable(this),
            router,
...
contract Control7XYDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Control7XY public Control7XYContract;
    ...
    constructor(
        ...
        defaultToken = token;
        Control7XYContract = Control7XY(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Control7XY_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Control7XY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Control7XY contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(Control7XYContract);

            uint256 prevBalance = Control7XYContract.balanceOf(address(this));
            ...
            {
                uint256 received = Control7XYContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    Control7XYContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
