// Telegram : https://t.me/ProtoBlockChain
// Website  : https://protoblockchain.net/
// Twitter  : https://twitter.com/Proto_block
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE468AC8A25eF7e17841994cc13608Ac0E0c26386;
...
contract ProtoBlockChain is Context, IERC20, Ownable { 
    ...
    string private _name = "Proto Block Chain"; 
    ...
    */
    ...
    address payable public Wallet_Marketing = payable(0xdD251B59958e933173306e602e48337A66E7fAf8);
    ...
    function SetFees(uint256 tax_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    function ChangeWalletMW(address payable wallet) public onlyOwner() {
    ...
    function blacklistBotWallets(address[] calldata addresses) external onlyOwner {
    ...
    function blacklistRemove(address[] calldata addresses) external onlyOwner {
    ...
    function setMaxTransaction(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/20000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function setMaxWallet(uint256 maxWallPercent_x100) external onlyOwner() {
