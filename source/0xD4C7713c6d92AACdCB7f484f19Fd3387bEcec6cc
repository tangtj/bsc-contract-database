...
contract Bomby is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bomby";
    string private constant _symbol = "BOMBY";
    ...
    address payable private _twddev = payable(0xD065FFbBDE81A3cd627934e683cde3cA7b747BF0);
    address payable private _twdmkt = payable(0xD065FFbBDE81A3cd627934e683cde3cA7b747BF0);
