//TG: https://t.me/XCoin_BSC_portal
...
// main contract
contract XCOIN is IERC20Extended, Ownable {
    using SafeMath for uint256;
    ...
    uint256 _marketingBuyFee = 19_00;

    uint256 _reflectionSellFee = 0;
    uint256 _liquiditySellFee = 1_00;
    uint256 _marketingSellFee = 29_00;
    ...
    uint256 public totalSellFee = 30_00;
    ...
    uint256 public snipingTime = 71 seconds;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0x446DB16c27053E828bc73FF192dd1E814D6e6C12;
    ...
    function setBuyFees(
        ...
        require(
            totalBuyFee <= feeDenominator.div(20),
    ...
    function setSellFees(
        ...
        require(
            totalSellFee <= feeDenominator.div(30),
