...
/**
* Website - https://RexCash.network
* Telegram - https://t.me/RexCashBSC
* 
*/
...
contract RexCash is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xe8A70F4B9f34a10020BB81cF4cfCEF2C882680AF;
    ...
    string private _name = "RexCash";
    string private _symbol = "RexCash";
