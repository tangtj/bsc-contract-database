...
contract TestApe is Context, IERC20, Ownable {
    ...
    string private _name = "Test Ape";
    string private _symbol = "test-Ape";
    ...
    uint256 private _maxTransactionAmount = _totalSupply.div(100); // 1%
    uint256 private _maxWalletBalance = _totalSupply.div(50); // 2%
    ...
    function updateMaxTransactionAmount(uint256 newMaxTransactionAmount) external onlyOwner {
        _maxTransactionAmount = newMaxTransactionAmount;
    }
