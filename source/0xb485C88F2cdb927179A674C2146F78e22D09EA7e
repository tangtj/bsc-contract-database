...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x254DA1eb379c4605b36701B04043183b261FD0A0; // owner address
...
contract XIBARIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xibarium";
    string private _symbol = "Xibarium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x254DA1eb379c4605b36701B04043183b261FD0A0); 
    address payable public teamWalletAddress = payable(0x254DA1eb379c4605b36701B04043183b261FD0A0);
