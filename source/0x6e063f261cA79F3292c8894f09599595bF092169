...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc01E076A129CBa13399377AA1BEa73a3E63f7863; // owner address
...
contract BitcoinOG is Context, IERC20, Ownable {
    ...
    string private _name = "BitcoinOG";
    string private _symbol = "BOG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xc01E076A129CBa13399377AA1BEa73a3E63f7863); // Marketing Address
    address payable private teamWalletAddress = payable(0xc01E076A129CBa13399377AA1BEa73a3E63f7863); // Team Address
