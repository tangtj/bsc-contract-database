...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD3B0017A5A8BE77DcF71e3EB322163C2503920CF; 
...
contract SWATKATS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SWAT KATS";
    string private _symbol = "SKS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD3B0017A5A8BE77DcF71e3EB322163C2503920CF); // 
    address payable public teamWalletAddress = payable(0xD3B0017A5A8BE77DcF71e3EB322163C2503920CF); // 
