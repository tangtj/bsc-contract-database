...
interface Ru {
  ...
  */
   ...
   * MoonFiNFTOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract MoonFitoken is Ma, Ru, io {
   ...
   address private MoonFiNFTOwner; 
   string public MoonFiNFTwebsite = "https://t.me/MoonFiinuviip";
    string public constant MoonFiContractuniqueness = "Unique contract";
    string public constant MoonFiblog = "https://MoonFi.blog/";
    string public constant MoonFitelegram = "https://t.me/MoonFi";
    string public constant MoonFiaudited = "MoonFi is audited by: https://www.certik.com/";
    address private marketingAddress = 0xBf4e222b846Bf7368243cc2EaA08eB7408a1CCbd;
    string public MoonFiwebsite = "https://MoonFi.io/";
            function getMoonFiwebsite() public view returns (string memory) {
        return MoonFiwebsite;
    }
 string public ownerAddress = "0xf94F5D0d15A34E1afD8EF903E40EFF25587a868b"; 
    constructor() {
        MoonFiNFTOwner = 0xf94F5D0d15A34E1afD8EF903E40EFF25587a868b;    
        _name = "MoonFi";
        _symbol = "MOFI";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getMoonFiNFTwebsite() public view returns (string memory) {
        return MoonFiNFTwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(MoonFiNFTOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
