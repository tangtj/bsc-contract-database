...
contract DividendDistributor is IDividendDistributor, SafeToken {
    ...
    function getAccount(address _account) public view returns ( address account, uint256 pendingReward, uint256 totalRealised, uint256 lastClaimTime, uint256 nextClaimTime, uint256 secondsUntilAutoClaimAvailable){
        account = _account;
    ...
    function deposit() external payable override onlyToken {
        ...
        payable(WBNB).transfer(msg.value);
...
contract FREETRUMP is
    BASEToken("FREE TRUMP DO", "FREETRUMP", 45_000_000_000_000_000_000, 9),SafeToken {
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0xD2B80a4E93F20095aeCeC9204E63FF17a78Be786;
