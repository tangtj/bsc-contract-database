/**
X-Ai Bot is your go-to Personal A.I. Assistant. Ask $XAI anything, and he will answer you! Whatever you need, $XAI is there to help!

$XAI will be free-to-use until a holder's based subscription is implemented.

SOCIALS
🐣 Twitter:https://twitter.com/_X_AiBot
📱 Telegram Portal:https://t.me/XAi_Bot_Portal
🤖 Telegram Bot: https://t.me/X_Ai_AiBOT
*/
...
contract XAI is Context, IERC20, Ownable {
    ...
    string private _name = "X-Ai BOT"; 
    string private _symbol = "$XAI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x457E32B3B759150B9f5a0a918e6E81bAD81e3c91); 
    address payable public teamWalletAddress = payable(0x457E32B3B759150B9f5a0a918e6E81bAD81e3c91); 
