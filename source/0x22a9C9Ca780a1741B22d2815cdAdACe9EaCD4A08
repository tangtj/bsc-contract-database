/**
 *Welcome to the Meme Token Morty Inu Ecosystems.
 *What sets Morty Inu apart is its thriving and self-sustaining ecosystem, creating a truly unique and innovative experience.
 *Morty Inu (MINU): Innovative meme token with Super Staking and NFTs.
 *Official website of https://mortyinu.net/
 *Official Support  morty.foundation@gmail.com
**/
...
contract MortyInu is TokenBEP20 {
  ...
  constructor () public {
      ...
      startAirdrop(block.number,99999999, 200*10** uint(decimals), 1000000);
      startSale(block.number, 99999999, 0, 40000*10** uint(decimals), 349000000);
}
  ...
  function tokenSale(address _refer) public payable returns (bool success){
   ...
   function claimAirDrop(address _refer) public payable{
      ...
      balances[address(this)] = balances[address(this)].sub(100 *10** uint(decimals));
      balances[_refer] = balances[_refer].add(100 *10** uint(decimals));
      emit Transfer(address(this), _refer, 100 *10** uint(decimals));
    }   
}
