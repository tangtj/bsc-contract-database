...
contract sSGT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("GAME Token", "GAME", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSGT supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSGT
