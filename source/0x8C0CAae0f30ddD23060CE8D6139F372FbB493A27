...
contract xCalcium is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private halten;
    mapping (address => mapping (address => uint256)) private _allowances;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 8_000_000_000_000 * 10**_decimals;
    string private constant _name = unicode"xCalcium";
    string private constant _symbol = unicode"XCAL";
