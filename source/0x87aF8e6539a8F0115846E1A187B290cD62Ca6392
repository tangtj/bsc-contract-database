...
*/
//Twitter: https://twitter.com/bobonbsc
//TG: t.me/bobonbscportal
/**
*/
...
contract BOBTHEBUILDER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BOBTHEBUILDERDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BOBTHEBUILDER", "BTB") {
        marketingWallet = payable(0x265713233ef965fD14da66987f3776ff63899A91);
        devWallet = payable(0x265713233ef965fD14da66987f3776ff63899A91);
        ...
        dividendTracker = new BOBTHEBUILDERDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "BOBTHEBUILDERTRACKER",
            "BTBTRACKER"
        );
...
contract BOBTHEBUILDERDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BOBTHEBUILDER public BOBTHEBUILDERContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BOBTHEBUILDERContract = BOBTHEBUILDER(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BOBTHEBUILDER_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BOBTHEBUILDER_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BOBTHEBUILDER contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BOBTHEBUILDERContract);

            uint256 prevBalance = BOBTHEBUILDERContract.balanceOf(address(this));
            ...
            {
                uint256 received = BOBTHEBUILDERContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BOBTHEBUILDERContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
