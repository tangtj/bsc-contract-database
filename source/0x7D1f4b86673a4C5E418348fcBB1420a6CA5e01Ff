/**
Telegram    :https://t.me/demonsmurf
Twitter     :https://twitter.com/DemonSmurf_News
Website     :https://demonsmurf.site
**/
...
contract DemonSmurf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DemonSmurf";
    string private _symbol = "DSMURF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x22AdF863475E87AfC89e49E831AcD5df0f683b9A); // Marketing Address
    address payable public teamWalletAddress = payable(0x22AdF863475E87AfC89e49E831AcD5df0f683b9A); // Team Address
