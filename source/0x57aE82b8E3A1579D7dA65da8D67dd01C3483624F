...
contract XKITTYINU  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6512c2906CcD0cc25aEe0513FDb4b584063c1aD2); 
    address payable public Wallet_Dev = payable(0x6512c2906CcD0cc25aEe0513FDb4b584063c1aD2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100* 10**9* 9**10 * 10**_decimals;
    string private constant _name = "XKITTYINU"; 
    string private constant _symbol = unicode"XKITTY INU"; 
    ...
    constructor () {
        _owner = 0x6512c2906CcD0cc25aEe0513FDb4b584063c1aD2 ;
