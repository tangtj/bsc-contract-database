/**
https://t.me/atomchain_portal
https://atomchain.network
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe40497fB7Acf96f0bB6990cA2a1aa0a1A845Bd64; // owner address
...
contract AtomchainNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " ATOMCHAIN COIN ";
    string private _symbol = " $ATM ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe40497fB7Acf96f0bB6990cA2a1aa0a1A845Bd64); // 
    address payable public teamWalletAddress = payable(0xe40497fB7Acf96f0bB6990cA2a1aa0a1A845Bd64); // 
