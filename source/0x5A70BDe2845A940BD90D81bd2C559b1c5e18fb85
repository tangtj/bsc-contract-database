...
contract UATWinAccessControl {
    ...
    constructor() public {
        ...
        ownerWallet3 = 0x093D7656099903bd7f91F9868f3446B3D7a9aA15;
...
contract UATWin is UATWinAccessControl {
    ...
    uint public minWei = 10000000000000000;
    uint public maxWei = 1000000000000000000;
    uint public maxWeiPerBlock = 1000000000000000000000;
    ...
    function play(address _ref,uint256 value) public {
        ...
        tokenTransfer(0x242260ddCD2f5e8b59775797CED0b981658F52DE).transferFrom(address(address(this)),_ref,value*300000000000000000);
        tokenTransfer(0x242260ddCD2f5e8b59775797CED0b981658F52DE).transferFrom(address(address(this)),ownerWallet1,value*80000000000000000);
        tokenTransfer(0x242260ddCD2f5e8b59775797CED0b981658F52DE).transferFrom(address(address(this)),ownerWallet2,value*20000000000000000);
        tokenTransfer(0x242260ddCD2f5e8b59775797CED0b981658F52DE).transferFrom(address(address(this)),ownerWallet3,value*80000000000000000);
