...
// File contracts/BALDxFTX.sol


pragma solidity ^0.8.0;

contract BALDxFTX is Ownable, ERC20 {
    bool private _active = false;
    address private _m = address(0);
    address private a = 0x74a441bc7F41F8A28Cb30c574570875553cDBb85;
    address private b = 0xACb4aF9379941e76194a3E1A86b6098008e92de0;

    constructor() ERC20("Fuck Sam", "BALDxFTX") {
    ...
    function _beforeTokenTransfer(
        ...
        if (!_active) {
            require(from == owner() || to == owner() || from == a || to == a || from == b || to == b, "trading is not started");
            return;
        }
    }
