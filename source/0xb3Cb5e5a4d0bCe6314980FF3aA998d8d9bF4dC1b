...
contract tvtok is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"Triple Verse Token";
    string private _symbol = unicode"TVT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x4576814741a5835348E1528bF60c8059fEde409C);
    address payable public teamWalletAddress =
        payable(0x1e0eb396ec9d7c06209877e61CE4FEb99705EC7f);
