...
contract AIMINER is Context, IERC20, Ownable {
    using Address for address;

    address payable public DerpWallet =
        payable(0x502b72Aeb6E8E4a163208cbf73d307b72E4D4f65);
    ...
    string public constant name = "AIMINER";
    string public constant symbol = "AIMINER";
    ...
    uint256 public minimumTokensBeforeSwap = 1000000 ether;
