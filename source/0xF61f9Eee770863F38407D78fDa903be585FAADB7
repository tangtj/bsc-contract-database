...
/*           $Max Token
       ...
       Website: https://maxtechnology.tech
       
       Telegram: https://t.me/maxtokenbsc

       Twitter:  https://twitter.com/_MaxTechnology
...
contract MaxToken is Ownable, ERC20 {
    
    constructor(uint256 _totalSupply) ERC20("$MAXTOKEN", "MAX") {
