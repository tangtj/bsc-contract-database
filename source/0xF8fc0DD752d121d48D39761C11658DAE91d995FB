/**
  ...
  Telegram : https://t.me/pepeneww
 Website https://pepenew.xyz/
 
 Twitter https://twitter.com/Pepe_new1
*/
...
contract PEPENEW is ERC20, Ownable {
    ...
    PEPENEWDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PEPE NEW", " PPN") {
        marketingWallet = payable(0x41bF65C39e9516c89Ee06D23E70079043d3CbB86);
        devWallet = payable(0x4757F1bF7d12895402BB841eBfEE0204985Ae1FE);
        ...
        dividendTracker = new PEPENEWDividendTracker(
            payable(this),
            router,
...
contract PEPENEWDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PEPENEW public PEPENEWContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PEPENEWContract = PEPENEW(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PEPENEW_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PEPENEW_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PEPENEW contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PEPENEWContract);

            uint256 prevBalance = PEPENEWContract.balanceOf(address(this));
            ...
            {
                uint256 received = PEPENEWContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PEPENEWContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
