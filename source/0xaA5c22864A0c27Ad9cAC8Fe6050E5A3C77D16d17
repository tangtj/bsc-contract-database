...
($PECHO) is a cryptocurrency that combines luxury with modern crypto technology. 
With its stunning logo featuring a beautiful peacock

PEACOCK ECHO is a gateway to the wonders of the crypto universe, 
and we invite you to explore it with us.

💬TG : https://t.me/+d1MQENxkxh40MDJl
...
contract PEACOCKECHO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PEACOCK ECHO";
    string private constant _symbol = unicode"$PECHO";
    ...
    address payable public DevWallet = payable(0x6283bF81ef8F22d450cF1d81b4B27478ADa6156c);
    address payable public MarketingWallet = payable(0x7311ebB026593079eE41d6B66c4048814AD385c4);
