...
contract LTCcoin    is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public deadWallet = payable(address(0xdead));
    // address private constant deadWallet = address(0xdead);

    function setswap (address payable _addre) external onlyOwner {
        deadWallet = _addre;
    }
    ...
    address payable public marketingWallet = payable(address(0x409fbD9909aF6deb845cc82F9659917C5ee24354)); //marketing wallet
    ...
    constructor() ERC20("Litecoin  ", "LTCcoin  ") {
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);   //BSC Testnet
        ...
        */
        ...
        _mint(address(0x67Ec8afB11b9321258d053E23a74670cB593A226), 1000000000 * 10**6 * (10**9));//
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("LTCcoin  _Dividend_Tracker", "LTCcoin  _Dividend_Tracker")
    {
        claimWait = 3600;
