/**
// https://t.me/BloodboyDorksBfBSC
// https://twitter.com/Bloodyboy
// https://Bloodboy.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x581a9E7A9AC954380b2c7f6961E5358E8C247BA5; // owner address
...
contract BloodboyDorksBfBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BloodBoy";
    string private _symbol = "$DORK'S BESTFRIEND";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x581a9E7A9AC954380b2c7f6961E5358E8C247BA5); // Marketing Address
    address payable private teamWalletAddress = payable(0x581a9E7A9AC954380b2c7f6961E5358E8C247BA5); // Team Address
