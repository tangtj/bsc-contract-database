...
contract MST is ERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 100000000 * (10**18); // 1.5% of total supply
    ...
    uint256 public charityFee = 3; //development
    uint256 public buyBackFee = 3; //development 
    ...
    uint256 public buyCharityFee = 3; //development 
    uint256 public buyBuyBackFee = 3; //development 
    ...
    uint256 public sellCharityFee = 3; //development 
    uint256 public sellBuyBackFee = 3; //development 
    ...
    uint256 public tradingEnabledTimestamp = 1626399139;
