...
//https://t.me/extraterrorestrialbnb
interface IERC20 {
...
contract EXTRATERRORESTIALBSC  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8F484AEcEcd1E9b2c3F962512a7c5AD34A4fc3F7); 
    address payable public Wallet_Dev = payable(0x8F484AEcEcd1E9b2c3F962512a7c5AD34A4fc3F7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42000* 10**3* 10**3 * 7**_decimals;
    string private constant _name = "EXTRATERRORESTIAL BABY"; 
    string private constant _symbol = unicode"$UFOBABY"; 
    ...
    constructor () {
        _owner = 0x8F484AEcEcd1E9b2c3F962512a7c5AD34A4fc3F7 ;
