...
contract Peggy is IBEP20, Auth {
    ...
    string constant _name = "Peggy";
    string constant _symbol = "Peggy";
    ...
    address private marketingFeeReceiver = 0x5f5Ff5a33a88a2d4db0fd788f7EBE6E1171e5d5F;
