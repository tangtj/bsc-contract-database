        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x09c9057d43F88054665f39855787d6F3d69Adeee), block.timestamp
                );
            }
        }
    }
...
contract COINTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xa054fB7c960f994a8687236B8d3F5E7948480943),//FundAddress
        address(0x09c9057d43F88054665f39855787d6F3d69Adeee)//ReceiveAddress
    ){
    }
}