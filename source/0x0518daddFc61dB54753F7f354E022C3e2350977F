...
contract BabyShibFrog {
    string public name = "BabyShibFrog";
    string public symbol = "BabyShibFrog";
    uint256 public totalSupply = 300000000000000000000000000; // 1 million tokens
