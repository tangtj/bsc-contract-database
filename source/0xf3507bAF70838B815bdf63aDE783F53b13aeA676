...
contract BNBdoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3Ac35C2FA68fB8D47900EA060f563Bf52424e7B9); 
    address payable public Wallet_Dev = payable(0x526FfE31F9C7dD5DAC87a7eFDe476978458815d3);
    ...
    string private constant _symbol = unicode"BNBdoge"; 
    ...
    constructor () {
        _owner =0x526FfE31F9C7dD5DAC87a7eFDe476978458815d3;
