...
contract XBabyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "XBabyDoge";
    string private _symbol = "XBabyDoge";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x1EcD73842700e5ACCbF39942E4C98a5e28CAE0BB); 
    address payable private teamWalletAddress = payable(0x1EcD73842700e5ACCbF39942E4C98a5e28CAE0BB); 
