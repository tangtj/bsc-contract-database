...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9dEA9FF22F576961A2728dc7d5f5e9CF5e7Fc1A5; // owner address
...
contract HowieDewit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HowieDewit";
    string private _symbol = "DOIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9dEA9FF22F576961A2728dc7d5f5e9CF5e7Fc1A5); 
    address payable public teamWalletAddress = payable(0x9dEA9FF22F576961A2728dc7d5f5e9CF5e7Fc1A5);
