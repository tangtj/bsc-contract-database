...
contract PepeFine is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PEPE FINE";
    string private _symbol = unicode"PEPEFINE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x49a442737F4E9d40c8D03CF00320f6a53e9e6791);
    address payable private taxWallet2 = payable(0x49a442737F4E9d40c8D03CF00320f6a53e9e6791);
