...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAeC6f0a9Ab7C40485d1Fdf4332F942254daCF25a; // owner address
...
contract NEWPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "NEW PEPE2 ";
    string private _symbol = "NPP2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50Fbc608637279A610e85a9b768Da43444A9f48b); 
    address payable public teamWalletAddress = payable(0x50Fbc608637279A610e85a9b768Da43444A9f48b);
