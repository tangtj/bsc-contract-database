...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa948d4e59A8ba22C2772CE214E7B6e5D176258E3; // owner address
...
contract XFLOKICEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-FLOKICEO";
    string private _symbol = "$X-FLOKICEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa948d4e59A8ba22C2772CE214E7B6e5D176258E3); // Marketing Address
    address payable public teamWalletAddress = payable(0xa948d4e59A8ba22C2772CE214E7B6e5D176258E3); // Team Address
