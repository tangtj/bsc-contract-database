...
contract ShytoshiInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ShytoshiInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Shytoshi Inu", "SHY") {
        marketingWallet = payable(0x4A8AdB2e9983D61120Ea5E0a79a48c9cF60EFb44);
        devWallet = payable(0x4A8AdB2e9983D61120Ea5E0a79a48c9cF60EFb44);
        ...
        dividendTracker = new ShytoshiInuDividendTracker(
            payable(this),
            router,
...
contract ShytoshiInuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ShytoshiInu public ShytoshiInuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ShytoshiInuContract = ShytoshiInu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ShytoshiInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ShytoshiInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ShytoshiInuContract);

            uint256 prevBalance = ShytoshiInuContract.balanceOf(address(this));
            ...
            {
                uint256 received = ShytoshiInuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ShytoshiInuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
