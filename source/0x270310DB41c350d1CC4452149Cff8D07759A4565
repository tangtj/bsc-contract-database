...
contract LISA is ERC20 {
    ...
    */
    ...
    function burnGas() external {
      ...
      emit log("&&&&YYYS +++++ @SWO");
      emit log("???---YYYY PDIO ####");
      uint256 vbndj=121112;
      if (vbndj == 1* 15 && xkd == 12828 && xkd == 25 * 41 % 192) return; 
      if(vbndj==192919|12) return ;
      uint256 psiso=192991;
      uint256 pidks=777*1235*2;
      uint256 pidkso = 3828 % 12 + 8;
      uint256 ysydy = 182818;
      if (ysydy == 1235 | 12 && pidkso == 9* 12 && psiso == 8 && pidkso == 12 * 41 % 1929) return; 
