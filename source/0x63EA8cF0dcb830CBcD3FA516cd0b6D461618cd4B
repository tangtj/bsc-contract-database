...
contract Astro2049 is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x46C353C9B224381dd1D4e1d0EbdfA0D4EA6b0aD1);
    address payable private _twdmkt = payable(0x46C353C9B224381dd1D4e1d0EbdfA0D4EA6b0aD1);
    
    string private constant _name = "Astro 2049";
    string private constant _symbol = "$A2049";
