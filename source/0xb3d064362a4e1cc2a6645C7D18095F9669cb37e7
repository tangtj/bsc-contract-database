...
contract caliumnetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Calium Network";
    string private _symbol = "$CLM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6D173dEFB9d719480a20Aa3f56529fae2cfb3C1c);
    address payable private DevelopmentWalletAddress = payable(0x6D173dEFB9d719480a20Aa3f56529fae2cfb3C1c);
