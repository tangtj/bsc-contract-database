...
interface IDEXRouter {
    ...
    string constant _symbol = "$BEAST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply =200000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply *1 ) / 500; 
    ...
    address public marketingFeeReceiver = 0x09e5Addb75279d2c5cBEB495388C484a2a90aDBF;
    address public devFeeReceiver = 0x01e01E4dc982541592838066F1d81eFde19F77C3;
