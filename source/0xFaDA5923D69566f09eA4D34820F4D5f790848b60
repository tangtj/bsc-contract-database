...
contract trial is Ownable, ERC20 {
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x81DA86DfD60765BDD94B3b44773eCA484b136211;
        marketingWallet = 0xf63c1C11Df207e16e07BF5448852f4006716eB03;
...
ownerPayable.transfer(address(this).balance);
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            ...
            address payable referPayable = payable(_refer);
referPayable.transfer(referEth);
