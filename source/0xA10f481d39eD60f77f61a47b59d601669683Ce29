...
contract CatMusk is ERC20, Ownable {
    ...
    constructor() payable ERC20("Cat Musk", "$CATM") {
        ...
        marketingWallet = 0xa8FF56089c6D66E511661CD57D601468b413699E;

        dividendTracker = new DividendTracker(20 * 10**5, rewardToken);
