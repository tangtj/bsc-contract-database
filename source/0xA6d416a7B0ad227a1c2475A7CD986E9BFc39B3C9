...
$BRG is a low supply BSC token that automatically rewards holders in BUSD.
...
contract BridgeFinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public _name = "Bridge Finance";
    string constant public _symbol = "BRG";
    ...
    uint256 public _maxWalletAmount = _totalSupply.div(200); // 0.5%
    ...
    constructor (
        ...
        marketingFeeReceiver = 0x6244B5a999E722417E40dC9284B33a291251a00a;
