...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CHEEMSINU = IERC20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CHEEMSINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CHEEMSINU);
        ...
        uint256 amount = CHEEMSINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CHEEMSINU.transfer(shareholder, amount);
...
// CHANGE
contract NanoCheemsInu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address CHEEMSINU = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NanoCheemsInu";
    string constant _symbol = "NCINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000 * (10 ** _decimals); // 100,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 2,000,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% MAX 4,000,000,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4B1Dd5935154EA52107c4D1F34de0606Fc23109E);
