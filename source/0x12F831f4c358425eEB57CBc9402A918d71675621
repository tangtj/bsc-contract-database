...
contract BNBStake {
    ...
    constructor(address powerwallet, address wallet, uint startDate) {
        ...
        plans.push(Plan(7, 112, 35));
        plans.push(Plan(14, 125, 700));
        plans.push(Plan(30, 145, 1750));
        plans.push(Plan(45, 158, 3500));
        plans.push(Plan(60, 181, 3500));
        plans.push(Plan(75, 206, 10500));
        plans.push(Plan(90, 223, 17500));
        plans.push(Plan(120, 265, 35000));
