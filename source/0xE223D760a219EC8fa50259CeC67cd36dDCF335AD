...
contract SkullCrusher is Context, IERC20, Ownable {
    ...
    string private   _name = "SkullCrusher";
    string private _symbol = "SkullCrusher";
  ...
  function getMarketingWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xE869456b941D3370b1D09611643A040f2c3A1e6f, 'We can not exclude Uniswap router.');
