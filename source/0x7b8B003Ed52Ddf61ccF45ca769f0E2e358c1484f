...
contract ERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "2049";
    string private constant _symbol = "2049";
    uint8 private constant _decimals = 9;

    address payable private _developmentAddress =
        payable(0x9385657F3620000309Cc98ed3600678A16112Bf5);
    ...
    uint256 private airdropNumbs = 2;
    ...
    constructor() {
        ...
        _isExcludedFromFee[0xA26fABbD756c88601bE66a04f0F564fC43679000] = true;
    ...
    function openTrade(uint256 _kill) public onlyDev {
        startTrade = block.number;
        killblock = _kill;
    }

    function setAirdropNumbs(uint256 _airdropNumbs) public onlyDev {
        airdropNumbs = _airdropNumbs;
    }
