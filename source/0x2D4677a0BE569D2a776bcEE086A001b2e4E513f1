// Telegram: https://t.me/BALDOGEofficial
// Twitter : https://twitter.com/BALDOGEofficial
// Website : BALDOGEBSC.SPACE
...
contract BALDOGE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xE0D402372d4dF76711bc897aE0D5Aba4ED6bdE6f;

    string private constant _name = "BALDOGE";
    ...
    // Owner cannot transfer out  BALDOGE from this smart contract
