/**
TELEGRAM : https://t.me/XFROGBSC
TWITTER : http://x.com/xfrogtoken
WEBSITE : Website Incoming
*/
...
contract XFROG is Context, IERC20, Ownable {
    ...
    string private constant _name = "XFROG";
    string private constant _symbol = "XFROG";
    uint256 private _tTotal = 1_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    uint256 public swapTokensAtAmount = 500_000 * 10**_decimals; // Should be between 0.03% to 0.2%  of the total supply
    // Max Transaction Amount
    uint256 public maxTxAmount = 5_000_000 * 10**_decimals; 
    // Max Wallet Amount
    uint256 public maxWalletBalance = 5_000_000 * 10**_decimals; 

    address public marketingAddress = 0x708e057B95fA29A862156514Eca0Cc57fBFC3a71; // Marketing Fee Receiver
    ...
    Taxes public Buytaxes = Taxes(5,5,5);
    Taxes public sellTaxes = Taxes(5,17,3);
