...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x126EaF938928e34697C55D6E2b9002D6D01f9Bca; // owner address
...
contract PIRB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pirb";
    string private _symbol = "PIRB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x126EaF938928e34697C55D6E2b9002D6D01f9Bca); // Marketing Address
    address payable private teamWalletAddress = payable(0x126EaF938928e34697C55D6E2b9002D6D01f9Bca); // Team Address
