...
contract CloudChuckler is IBEP20, Auth {
    ...
    string constant _name = "CloudChuckler";
    ...
    address private marketingFeeReceiver = 0xD616D5207E492f545C96304D1463959bB21F7F59;
