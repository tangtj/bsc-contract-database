...
// TG https://t.me/Nobeliumbsc
// Website https://nobelium.site
...
contract Nobelium is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nobelium";
    string private constant _symbol = unicode"NOBE";
