...
/*
In the second game you need only buy to win.   Welcome.

Telegram:
https://t.me/SquidGameXToken
*/
...
contract SQUIDX is ERC20, Ownable {
    ...
    constructor() ERC20("Squid Game X", "SQUIDX") {
        ...
        devWallet = address(0x1027b200c58840921db33f4e633b628a938a10a5); 
