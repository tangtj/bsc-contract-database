...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfEFEEE8FFE536487c8b0016A693BeBA5eED0BD64;
...
contract JPD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfEFEEE8FFE536487c8b0016A693BeBA5eED0BD64;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000913 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "JPEX Decentral";
    string private _symbol = "JPD";
