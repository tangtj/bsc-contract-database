...
contract KISSAN_TOKEN_LOCK_V3 is ReentrancyGuard, Ownable {
    ...
    function withdrawLostTokens(address tokenAddress, address _receiver) public nonReentrant onlyLockAdmin(msg.sender) {
