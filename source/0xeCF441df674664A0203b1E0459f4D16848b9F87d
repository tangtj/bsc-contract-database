            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xbdea6Be7A1e465320bC71DE3D74C2cC7D0130564), destroyAmount);
                    }
                }
...
contract BOBO is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0xbdea6Be7A1e465320bC71DE3D74C2cC7D0130564),
        address(0x93CCBDC9025Ad55EE8C5887400f99AE6EbD6bC09),
        address(0x9C22B3Cd4020019b0Bc7A5F2B27da9bb42bAaDd4),
        address(0xbdea6Be7A1e465320bC71DE3D74C2cC7D0130564),
        1000000,
        0,
        1000000
