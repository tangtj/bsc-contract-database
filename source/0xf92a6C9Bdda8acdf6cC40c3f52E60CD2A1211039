...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7624f005BD0e581cfd24314224248cB7b32452Ed; // owner address
...
contract TOKYOX is Context, IERC20, Ownable {
    ...
    string private _name = "TOKYO X";
    string private _symbol = "TOKYOX";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable( 0x7624f005BD0e581cfd24314224248cB7b32452Ed); // Marketing Address
    address payable public teamWalletAddress = payable(0x7624f005BD0e581cfd24314224248cB7b32452Ed); // Team Address
