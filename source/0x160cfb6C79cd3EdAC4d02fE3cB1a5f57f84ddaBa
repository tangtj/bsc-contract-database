/**
Neo Yokio
Welcome to Neoyokio, the cutting-edge cryptocurrency 
project that seamlessly 
blends the captivating world of anime with groundbreaking blockchain technology. 
https://t.me/NeoYokioToken
███╗░░██╗███████╗░█████╗░██╗░░░██╗░█████╗░██╗░░██╗██╗░█████╗░
████╗░██║██╔════╝██╔══██╗╚██╗░██╔╝██╔══██╗██║░██╔╝██║██╔══██╗
██╔██╗██║█████╗░░██║░░██║░╚████╔╝░██║░░██║█████═╝░██║██║░░██║
██║╚████║██╔══╝░░██║░░██║░░╚██╔╝░░██║░░██║██╔═██╗░██║██║░░██║
...
interface Ru {
  ...
  */
   ...
   * XKIBAOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract NeoYokio is Ma, Ru, io {
   ...
   address private XKIBAOwner; 
   string public XKIBAwebsite = "https://t.me/NeoYokioToken";
   string public ownerAddress = "0xf2e22d1D4C03c0b53d22F953f5D0898F69269f62";  
    constructor() {
        XKIBAOwner = 0xf2e22d1D4C03c0b53d22F953f5D0898F69269f62;    
        _name = "Neo Yokio";
        _symbol = "NEO";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getXKIBAwebsite() public view returns (string memory) {
        return XKIBAwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(XKIBAOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
