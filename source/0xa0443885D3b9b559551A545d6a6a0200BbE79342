...
//https://t.me/BscBullOfficialGroup
//https://bscbull.org
interface IERC20 {
...
contract BSCBULL is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x719434989ADaD65b79F688dF8Eb85bEd096a653A); 
    address payable public Wallet_Dev = payable(0x719434989ADaD65b79F688dF8Eb85bEd096a653A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "BSC BULL"; 
    string private constant _symbol = unicode"$BSCBULL"; 
    ...
    constructor () {
        _owner =0x719434989ADaD65b79F688dF8Eb85bEd096a653A;
