/**
// Telegram : https://t.me/ScaneriumNetwork
// website  : https://scanerium.network
*/
...
contract ScaneriumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Scanerium Network";
    string private _symbol = "SCR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC30F72AEEe27Ce4fa7E2D58260BbcdbcF1Cc4c2B); // Marketing Address
    address payable private teamWalletAddress = payable(0x0d121F04482e8cEB8c72D8e81aaBd15011FcCa92); // Team Address
