...
contract BREPE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"The Dog Killer";
    uint256 public _maxtxam = 690000 * 10**_decimals;
    uint256 public _maxwallets = 690000 * 10**_decimals;
    ...
    event MaxTxAmountUpdated(uint _maxtxam);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
                ...
                require(amount <= _maxtxam, "Exceeds the _maxtxam.");
                require(balanceOf(to) + amount <= _maxwallets, "Exceeds the maxWalletSize.");
            }
