...
TAX 5/5 ! No blacklist . renounce . lplock . DOGE REWARDS
2% DOGE REWARDS
...
contract DOGEX is ERC20, Ownable {
    ...
    DOGEXDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DOGEX . 2% Doge rewards", "DOGEX") {
        marketingWallet = payable(0xaCA549Cb85f75caE0a1B10e70151061ae577979f);
        devWallet = payable(0xaCA549Cb85f75caE0a1B10e70151061ae577979f);
        ...
        dividendTracker = new DOGEXDividendTracker(
            payable(this),
            router,
...
contract DOGEXDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        DOGEXContract = DOGEX(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DOGEX_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DOGEX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DOGEXContract);

            uint256 prevBalance = DOGEXContract.balanceOf(address(this));
            ...
            {
                uint256 received = DOGEXContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DOGEXContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
