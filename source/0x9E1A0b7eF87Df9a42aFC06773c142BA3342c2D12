...
contract NUDES is Context, IERC20, Ownable {   
    ...
    address payable private _twddev = payable(0x8a5F7e3d250d0C00e5E817111132A6Ea26511035);
    address payable private _twdmkt = payable(0x8a5F7e3d250d0C00e5E817111132A6Ea26511035);
