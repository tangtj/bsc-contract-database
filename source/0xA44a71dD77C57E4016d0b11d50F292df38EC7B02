...
/**
   ...
   6% fee auto add to the liquidity pool and holder
   2% fee auto moved to dev wallet
   7% lotto fee
...
contract luckyJAV is Context, IERC20, Ownable {
    ...
    address public _lottoWalletAddress = address(0x67770FD9f041AEeF530f178d9b53f1038872ce8C);

    uint256 private _minLottoBalance = 100000000;

    string private _name = "luckyJAV";
    ...
    address public ownerAddress = address(0x67770FD9f041AEeF530f178d9b53f1038872ce8C);
