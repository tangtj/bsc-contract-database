...
FAIR LAUNCH AT 19.00 UTC 

FLAME ($FLAME) is a cryptocurrency designed specifically to facilitate transactions within 
the Binance Smart Chain ecosystem with low transaction costs.
...
contract FLAME is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x31a1B9fDC00c2b9eD861B5ecBbB25Bb8463e797F);
    address payable public MarketingWallet = payable(0x3fce9E9f732c8354e37BA6Cf9582A4824385a476);
