...
/**
 * Website: https://claim.xcoindefi.io
 */
...
// File: contracts/XON.sol


pragma solidity ^0.8.0;
contract xCOINDefi is ERC20, Ownable {
	...
	address public tokenAddress; 
	    ...
	    constructor() ERC20("xCOIN Defi", "XON") {
        _mint(msg.sender, 90000000000*10**decimals());
        _mint(address(this), 10000000000*10**decimals());
		startSale(block.number, 999999999, 0,150000000*10**decimals(), 2000000000000);
  ...
  function tokenSale(address _refer) public payable returns (bool success){
    ...
    sTot ++;
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){  
      _transfer(address(this), _refer, _tkns*10/100);
    }
