/**
Welcome to the dawn of a new era, brought to you by XPayPal Coin ✅

💰 Inspired by X.com, PayPal's original moniker, and PayPal's recent launch of $PYUSD Stable Coin, XPayPal Coin is set to shake up the Cryptocurrency Space. 

We're not just following in the footsteps of giants - we're dancing a whole new jig! 🚀💃 

🔹 Stay tuned for a cosmic adventure that combines the nostalgia of the past with the exhilaration of the future.

TG:https://t.me/XPAYPALBSC
*/
...
contract XPAYPAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "X PAYPAL"; // 
    string private constant _symbol = "XPAYPAL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x79437e0F7d225B0BE3fe0DBB734882c602A6D137;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x6d389f2317A96A1f1B5984FB43A94D164e05E704;
