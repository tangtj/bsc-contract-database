...
library Address{
 ...
 contract ScamToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42*1e7 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 420_000 * 10**9;
    uint256 public maxBuyLimit = 8_400_000 * 10**9;
    uint256 public maxSellLimit = 8_400_000 * 10**9;
    uint256 public maxWalletLimit = 8_400_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x5466f18C55729BC8Ff8bE2F3451119A9aD2922d2;
    address public donationWallet = 0x5466f18C55729BC8Ff8bE2F3451119A9aD2922d2;
    ...
    Taxes public taxes = Taxes(0, 5, 5, 1);
    Taxes public sellTaxes = Taxes(0, 5, 5, 1);
