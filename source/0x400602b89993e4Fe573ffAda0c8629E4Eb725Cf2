...
contract KalmarEllipsis4PRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    IEllipsisRouter public constant curvePool = IEllipsisRouter(0x556ea0b4c06D043806859c9490072FaadC104b63);
    ...
    IERC20 public constant otherToken = IERC20(0x049d68029688eAbF473097a2fC38ef61633A3C7A); // 0
