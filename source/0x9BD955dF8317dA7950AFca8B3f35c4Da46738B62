/**
TG: https://t.me/GPTXCOINOFFICIAL
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDFDC42c189213fb57515C4956792159CA738bC5c; // owner address
...
contract GPTXCOINOFFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GPT - X";
    string private _symbol = "$GPTX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9c8a01659F8522d1862A9461A61Ff33800819F3b); // Marketing Address
    address payable private teamWalletAddress = payable(0xDFDC42c189213fb57515C4956792159CA738bC5c); // Team Address
