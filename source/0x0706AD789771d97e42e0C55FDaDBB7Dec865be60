...
contract CyberDucky is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Cyber Ducky', 'CYBERD') {
        require(
            feeAccount != address(0),
            'Cyber Ducky: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Cyber Ducky: incorrect fee percent');
        require(owner != address(0), 'Cyber Ducky: incorrect owner address');
        require(mintToAddr != address(0), 'Cyber Ducky: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Cyber Ducky: transfer from the zero address');
        require(recipient != address(0), 'Cyber Ducky: transfer to the zero address');
