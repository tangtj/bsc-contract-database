...
contract WarNFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("War God Magic Card", "War God Magic Card"){
        //
        _baseUri = "";
        _suffix = "";

        //
        _sameUri = "https://15065ae3c21e0bff07eaf80b713a6ef0.ipfscdn.io/ipfs/bafybeif7aggziqdj3g47cojcssvl4lbc343rfhbxuh7glfeyn7f7iwc444/WarNFT.json";
    }
}