...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1500,
        address(0x99978124F0aF642789EcF42C7f7DD75b81DA1F35), //fund 1
        address(0xB15c713DF25883cF77F36B1067593734Bf9B4E59), //fund 2 
        address(0x467FC1d33C624B319944a8CD34a88cE0d2B4F4a2) //receiver 
    ){
    }
}