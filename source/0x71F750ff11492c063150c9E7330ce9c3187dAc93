...
contract confidence is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6Eecdc4A84a9B022ACFffE1aA60470437AF31a86; //

    string private constant _name = "ScarfaceTateIbrahimovic42069AbraCadabra"; //
    string private constant _symbol = "CONFIDENCE"; //
