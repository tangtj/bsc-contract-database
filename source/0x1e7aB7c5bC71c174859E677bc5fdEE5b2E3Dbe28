...
contract MelonBNB is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDExcluded;
    ...
    constructor() payable ERC20 ("Melon", unicode"🍉") {
        ...
        marketingWallet =  0xE206558eBE5e949E26f74DaE2E2bA4eFf27f20f0;
        ...
        _isWalletExcluded[0xE206558eBE5e949E26f74DaE2E2bA4eFf27f20f0] = true;
        _isWalletExcluded[0xddEBf4C9e9b5D339F60cc7480C8528610Fa823a5] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 100000 * 7;
    }
