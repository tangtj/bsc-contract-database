...
// File: contracts/JETFUEL/interfaces/fortress/IVBNB.sol
...
contract StrategyFortressBNB is Ownable, Pausable {
    ...
    address public constant fortress = address(
        0x4437743ac02957068995c48E08465E0EE1769fBE
    );
    address public constant fbnb = address(
    ...
    address public constant unitroller = address(
    ...
    function _chargeFees() internal {
        uint256 toWbnb = IERC20(fortress).balanceOf(address(this)).mul(6).div(100);
