...
// https://t.me/XTwoCoin
// https://twitter.com/xtwocoin
// https://www.x2token.com
...
contract ql2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x29fF1E0A0D8dd6e710E6477215B1De18aC028C6D); 
    address payable public Wallet_Dev = payable(0xd43ADCA9ed809D76B7705d21B6478F51F2C2E72D);
    ...
    string private constant _name = "QL2.0"; 
    string private constant _symbol = unicode"QL2.0"; 
    ...
    constructor () {
        ...
        _owner = 0x6fE7E5653E6842e4858de36e10C8747dD09054bd;
