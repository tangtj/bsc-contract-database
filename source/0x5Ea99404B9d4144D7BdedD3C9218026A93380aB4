...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state muta=lity warning without generating bytecode - see https://github.com/ethereum/solidity/issues/2691
        return msg.data;
    }
}
...
contract SPACECLOUD is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x81424b78B0560A1F9f06aA6B1dBCaA49eEaB9d56;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address Marketing = 0x81424b78B0560A1F9f06aA6B1dBCaA49eEaB9d56;
