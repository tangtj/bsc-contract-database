...
contract FIFAPP is IERC20 {
    ...
    string constant private _name = "FIFAPP";
    string constant private _symbol = "FIFAPP";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xbd46aacd8c953a7405A840Cf42Eb5be9223c2fe4),
        charity: payable(0x6EA4aE55Aa2Bcf39E95fe0Bd7f9b97F9875ABE63),
        development: payable(0x433850464bDEa0dDA4ca4F11cD4C07245E4d22bD),
        reserve: payable(0xcAC052757c2299612402D39f70459E49d5F040Ae)
    });
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        require(!taxesAreLocked, "Taxes are locked forever.");
    ...
    function setWallets(address payable marketing, address payable development, address payable charity, address payable reserve) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.development = payable(development);
        _taxWallets.charity = payable(charity);
        _taxWallets.reserve = payable(reserve);
    }

    function setRatios(uint16 reflection, uint16 charity, uint16 marketing, uint16 development, uint16 reserve) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.charity = charity;
        _ratios.marketing = marketing;
        _ratios.development = development;
        _ratios.reserve = reserve;
        _ratios.totalSwap = charity + marketing + development + reserve;
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 reserveBalance = (amtBalance * ratios.reserve) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (developmentBalance + charityBalance + reserveBalance);
        ...
        if (ratios.reserve > 0) {
            (success,) = _taxWallets.reserve.call{value: reserveBalance, gas: 35000}("");
        }
    }
