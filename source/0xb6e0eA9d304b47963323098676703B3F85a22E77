...
contract FQC is Context, IBEP20, Ownable {
  ...
  */
  ...
  function burn(uint256 amount) public returns (bool) {
    ...
    function setLpToken(IBEP20 _lpToken) onlyOwner public returns (bool) {
