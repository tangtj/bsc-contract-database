...
interface IDEXRouter {
 ...
 contract AstroFinex  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "AstroFinex";
    ...
    address public devFeeReceiver = 0x1A79b61BFfaD51f25254DD6E640523a0CaaF171F;
    address public buybackFeeReceiver = 0x1A79b61BFfaD51f25254DD6E640523a0CaaF171F;
