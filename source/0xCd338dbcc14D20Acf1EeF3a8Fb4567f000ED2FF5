...
contract QuantumProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUANTUM PROTOCOL";
    string private _symbol = "QPRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7854097Db0F9485ee81a5Bd10D27E7A63D1984C1);
    address payable private DevelopmentWalletAddress = payable(0x7854097Db0F9485ee81a5Bd10D27E7A63D1984C1);
