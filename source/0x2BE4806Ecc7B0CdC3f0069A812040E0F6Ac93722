...
Telegram : https://t.me/PEPEPROPHECYPORTAL
...
contract $PEPEPROPHECYBSC is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x992efBb375ACF1943A0b4FFa2eF050e486AD5b62;

    string private constant _name = "PEPEPROPHECYBSC";
    string private constant _symbol = "PEPEPROPHECY";
