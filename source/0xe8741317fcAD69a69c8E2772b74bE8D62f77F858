// Telegram: https://t.me/Solidariumbsc
...
contract Solidarium is Context, IERC20, Ownable {
    ...
    address payable private _team = payable(0x4235951A455373e81d1ceEf3189f9f240417Da38);
    address payable private _marketing = payable(0x4235951A455373e81d1ceEf3189f9f240417Da38);
    
    string private constant _name = "Solidarium";
    string private constant _symbol = "SLDR";
