...
contract TENDOLLARMC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TEN DOLLAR MC";
    string private _symbol = "$10MC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x91eFC7E40aF8a53f308458eFa26D9a489393AfF4); // Marketing Address
