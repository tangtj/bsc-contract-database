...
// https://t.me/VitalikBiterinChangpengZhao
...
contract VitalikBiterinChangpengZhao is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("VitalikBiterinChangpengZhao","VitalikBiterinChangpengZhao") {
