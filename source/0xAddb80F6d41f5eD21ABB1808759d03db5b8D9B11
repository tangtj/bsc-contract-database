...
contract SolidarUK is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "SolidarUK Token";
    string private constant _symbol = "SUK";
    ...
    uint256 private _AirdropTime = 0; 
    uint256 private _AirdropCount = 0;
    ...
    function addAirdropRecipients(address[] memory recipients_, uint256 amount, uint256 time, uint256 count)
        public
        onlyOwner
    {
