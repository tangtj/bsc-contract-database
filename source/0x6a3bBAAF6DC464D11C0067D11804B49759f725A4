...
contract YANSHI is Context, IERC20, Ownable {
    ...
    string private _name = "YANSHI";
    string private _symbol = "YANSHI";
    ...
    address payable public marketingWallet = payable(0x190ddde9765baA4c668e08851cd4e4B201827427);
    ...
    uint256 public _maxWalletLimit = 2500000 * 10**18;
    address admin;
