...
contract DONTBUY is ERC20, Ownable {
    ...
    constructor() ERC20("DONTBUY", unicode"DONTBUY") {
        ...
        maxTransactionAmount = 100000 * 1e7 * 1e18; 
        maxWallet = 100000 * 1e7 * 1e18;
        ...
        devWallet = address(0x0e9AB76b6a106554CD978248C95A074b460Ecd71); 
