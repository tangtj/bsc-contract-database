...
contract BALDCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "BALD CLUB";
    string private constant _symbol = "BaldClub";
