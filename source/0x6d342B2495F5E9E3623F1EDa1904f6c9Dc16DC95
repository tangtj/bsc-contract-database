...
TG: https://t.me/MonthlyMoonshotBSC
...
contract MonthlyMoonshot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monthly Moonshot";
    ...
    address payable public marketingWalletAddress = payable(0x9F3bDe1CD5780FB75dfE3E4169FBdD87104a1A06);
    address payable public teamWalletAddress = payable(0x9F3bDe1CD5780FB75dfE3E4169FBdD87104a1A06);
