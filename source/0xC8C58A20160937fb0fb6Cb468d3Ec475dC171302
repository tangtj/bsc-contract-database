// t.me/GoogleTokenizedStockDefichain 
// GoogleTokenizedStockDefichain.com
...
contract GoogleTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "GoogleTokenizedStockDefichain";
    string public symbol = "DGOOGL";
