...
contract NAKACHU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd1823C4A50DC2c484088015cee08eEA75a62f925);
    address payable public liquidityWalletAddress = payable(0xd1823C4A50DC2c484088015cee08eEA75a62f925);
