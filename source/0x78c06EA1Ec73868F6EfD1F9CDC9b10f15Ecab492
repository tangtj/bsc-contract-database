...
//https://t.me/peppatobercommunity
...
contract Peppatober is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5e3a72bd499aAB87D09D73ECc2aD331B03b043ED); 
    address payable public Wallet_Dev = payable(0x5e3a72bd499aAB87D09D73ECc2aD331B03b043ED);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Peppatober Coin"; 
    string private constant _symbol = unicode"PEPPATOBER"; 
    ...
    constructor () {
        _owner = 0x5e3a72bd499aAB87D09D73ECc2aD331B03b043ED;
