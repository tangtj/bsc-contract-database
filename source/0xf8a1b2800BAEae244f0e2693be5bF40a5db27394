...
// telegram     : https://t.me/metaauditbsc
...
contract MetaAudit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta Audit";
    string private _symbol = "$METAAUDIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC02a927eaBe1c44Cc877d4EE13D3c3bf8D6f922D); // Marketing Address
    address payable public teamWalletAddress = payable(0xC02a927eaBe1c44Cc877d4EE13D3c3bf8D6f922D); // Team Address
