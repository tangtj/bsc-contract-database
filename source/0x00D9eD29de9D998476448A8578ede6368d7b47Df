...
contract BEBE is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0x7675100045d1B4F6E5386a7d2A8E31E4725C024b;
    ...
    constructor () ERC20("BEBE TIGER", "BEBE") 
    {   
        address newOwner = 0xF641Fa920C7075f567A62C638a0A0980b8e1C513;
