...
contract litepepe6941 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lithium Pepe 6.941";
    string private _symbol = "LiPepe6.941";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11aCAEe13045F505549e5DE7f76d16a5aD673b86);
    address payable public teamWalletAddress = payable(0x11aCAEe13045F505549e5DE7f76d16a5aD673b86);
    ...
    uint256 private _totalSupply =  69410000000 * 10**_decimals;
    uint256 public _maxTxAmount =   69410000000 * 10**_decimals;     
    uint256 public _walletMax =     69410000000 * 10**_decimals;      
