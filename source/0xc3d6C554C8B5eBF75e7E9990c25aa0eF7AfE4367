/*  
         ...
         web: https://chapulintoken.com/
         telegram: https://t.me/chapulintoken
         contract address: 0xc3d6C554C8B5eBF75e7E9990c25aa0eF7AfE4367
...
pragma solidity 0.8.10;
contract ChapulinToken is Ownable, ERC20 {

    //Initial Definition of variables and events
    mapping(address => bool) public poolAddress;

    address public taxWallet = 0x48F2ebD19903B985F92Ab3AF67A52A2730e082A8;
    ...
    uint private constant MAXTAX = 9; //establishes a maximun tax of 9%
    uint public sellTax = 3; //Initial 3% tax
    uint public buyTax = 3; //Initial 3% tax
    ...
    constructor() ERC20("Chapulin Colorado Token", "Chapu") {
