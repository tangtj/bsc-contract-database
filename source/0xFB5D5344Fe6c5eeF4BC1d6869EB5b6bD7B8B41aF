...
contract PappyInu is ERC20, Ownable {
    ...
    constructor() ERC20("Pappy Inu", "PANU") {
        ...
        marketingWallet = address(0x91A7be4e88A784d02EaF6160238BCA0726660881); // set as marketing wallet
        devWallet = address(0x91A7be4e88A784d02EaF6160238BCA0726660881); // set as dev wallet
