...
contract X_DOGELON is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x1364F593Fa79b3E41298566aFcA390cf57C38F47);
    address payable private _marketingAddress = payable(0x1364F593Fa79b3E41298566aFcA390cf57C38F47);
