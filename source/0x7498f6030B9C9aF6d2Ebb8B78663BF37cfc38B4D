...
contract WJT is Context, IERC20, Ownable {
    ...
    string private _name = "WILD JUNGLE";
    string private _symbol = "WJT";
    ...
    address payable public marketingWallet = payable(0x92323DB03e1506DB6f124cf9F60DD99868487B58);
