...
contract QOM is QOMDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private QOMTeam;
    address private CharityQOM;
    ...
    string public override name = "Shiba Predator";
    string public override symbol = "QOM";
    ...
    constructor(uint totalSupplyValue, address QOMTeamAddress, address CharityQOMAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        QOMTeam = QOMTeamAddress;
        CharityQOM = CharityQOMAddress;
       
        // split the tokens according to agreed upon percentages
        balances[QOMTeam] =  totalSupply * 4 / 100;
        balances[CharityQOM] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's QOMTeam pot
