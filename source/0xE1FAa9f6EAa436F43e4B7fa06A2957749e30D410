...
// telegram : https://t.me/vikingpepebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9f01208D89e11DF56D6268792c4148bf2Ef7c4f7 ; // owner address
...
contract VikingPepe  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VikingPepe";
    string private _symbol = "VKGPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47D762Ad5C85750FC677AaCAFBd4697B036f7b51); 
    address payable public teamWalletAddress = payable(0x47D762Ad5C85750FC677AaCAFBd4697B036f7b51);
