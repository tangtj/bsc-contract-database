...
contract MADRABBIT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x29127B80c59D229f08D9Cb4681Bf91379df2Be96); // Marketing Address
    ...
    string private _name = "MAD RABBIT";
    string private _symbol = "MADR";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x29127B80c59D229f08D9Cb4681Bf91379df2Be96);
    }
