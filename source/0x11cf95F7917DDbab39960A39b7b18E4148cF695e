...
contract LexusChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lexus";
    string private _symbol = "LXC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7d01Fad789B2C18607eF415d68E8F58c05c74D6f); // Marketing Address
    address payable public teamWalletAddress = payable(0xC9623295DEEf7d391e49B4BD172368021acB20AE); // Team Address
