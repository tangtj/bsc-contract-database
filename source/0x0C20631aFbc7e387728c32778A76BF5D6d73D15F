...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A836C6BDf14A7BE1e02733C7CC00b7EFb2C6595; // owner address
...
contract HarryPotterTrumpPikachu10Inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterTrumpPikachu10Inu";
    string private _symbol = "BNB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x912039cf417f5e98478992D1b133EcEdc12e443D); // Marketing Address
    address payable private teamWalletAddress = payable(0x912039cf417f5e98478992D1b133EcEdc12e443D); // Team Address
