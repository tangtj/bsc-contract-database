/**
‼️ Hold your horses! 
No presale, no empty promises, 
and absolutely no BULLSHIT! 
The HoneyBun ARMY shall savor 
the delightful unveiling of our product! ‼️ 
HoneyBun is here to make memecoins great again! 
Launched stealthily with no presale, minimal taxes, LP Lock, 
$HONEYBB is a token for the people, forever. Visit our website at: 
https://honeybb.io/
...
contract HoneyBB is Ma, Ru, io {
   ...
   string websites;
   string public HoneyBBwebsite = "https://HoneyBB.com/";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "HoneyBBToken"; 
        _name = "HoneyBB";
        _symbol = "HoneyBB";
        _decimals = 9;
