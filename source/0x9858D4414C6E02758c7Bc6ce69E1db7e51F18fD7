...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe39Ee21dCa35d37B1c7391208aE1911428DF7F63; // owner address
...
contract CCCDGS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCDGS";
    string private _symbol = "CCCDGS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe39Ee21dCa35d37B1c7391208aE1911428DF7F63); // Marketing Address
    address payable private teamWalletAddress = payable(0xe39Ee21dCa35d37B1c7391208aE1911428DF7F63); // Team Address
