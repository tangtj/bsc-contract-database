...
contract Koshi is ERC20, Ownable {
    ...
    constructor() ERC20("Koshi Inu", "KOSHI") {
        ...
        marketingWallet = address(0xaA697a8E8A1C4Cb9629DCe9Ef32b272815Cb26D1); // set as marketing wallet
        devWallet = address(0xaA697a8E8A1C4Cb9629DCe9Ef32b272815Cb26D1); // set as dev wallet
