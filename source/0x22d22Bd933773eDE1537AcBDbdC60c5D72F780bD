/*
Telegram: https://t.me/o_OBSC
Twitter: https://twitter.com/o_OBSC
*/
...
contract $o_O is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xe5AA581a34c841d276Ec5668c4E4BeFA6d05F6E8;

    string private constant _name = "o_O";
    string private constant _symbol = "o_O";
    ...
    // Owner cannot transfer out o_O from this smart contract
