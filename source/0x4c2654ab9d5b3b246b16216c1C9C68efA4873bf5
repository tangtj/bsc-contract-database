        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x198aecEb4985B67cF6EC633d1708d6CA160907dB), block.timestamp
                );
            }
        }
    }
...
contract Pi1 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0x198aecEb4985B67cF6EC633d1708d6CA160907dB),//FundAddress
        address(0x198aecEb4985B67cF6EC633d1708d6CA160907dB)//ReceiveAddress
    ){
    }
}