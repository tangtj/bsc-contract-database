...
contract penguininvest is Context, IERC20, Ownable {
    ...
    string private _name = "penguin invest";
    ...
    address payable public marketingWallet = payable(0x8bEFb5fB7fA2Db92A1E043559486d31C24bB648A);
