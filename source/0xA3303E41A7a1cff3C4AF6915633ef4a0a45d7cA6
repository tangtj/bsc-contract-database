// Telegram: https://t.me/LightningBotOfficial
...
contract LIGHTNINGBOT is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x37e2170B2Fd7D101BE63614BDC7D593A94b3d025;

    string private constant _name = "Lightning Bot";
    ...
    // Owner cannot transfer out  LandWolf Inu from this smart contract
