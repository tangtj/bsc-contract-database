...
*/
	function stake(uint256 _stakeAmt) public {
		...
		ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).transferFrom(msg.sender, address(this), _stakeAmt);
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).balanceOf(address(this)) >= ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).transfer(msg.sender, ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)));
		require((ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).balanceOf(address(this)) >= ((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).transfer(msg.sender, ((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)));
...
*/
	function deposit(uint256 _depositAmt) public {
		ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).transferFrom(msg.sender, address(this), _depositAmt);
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt) external {
		...
		require((ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).balanceOf(address(this)) >= ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).transfer(msg.sender, ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)));
...
*/
	function withdrawPrincipalTax() public onlyOwner {
		require((ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).balanceOf(address(this)) >= principalTaxBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).transfer(msg.sender, principalTaxBank);
...
*/
	function withdrawInterestTax() public onlyOwner {
		require((ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).balanceOf(address(this)) >= interestTaxBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).transfer(msg.sender, interestTaxBank);
...
*/
	function withdrawToken(uint256 _amt) public onlyOwner {
		require((ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).balanceOf(address(this)) >= _amt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153).transfer(msg.sender, _amt);
	}
}