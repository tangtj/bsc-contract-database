...
contract SHIBADAO is ERC20, Ownable {
    ...
    constructor() ERC20("SHIBA DAO", "SHID") {
        _mint(msg.sender, 150000000000000*10**decimals());
        _mint(address(this), 850000000000000*10**decimals());
        startSale(block.number, 999999999,0,27500000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,8*5000000**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 9;
    }
