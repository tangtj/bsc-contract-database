...
contract ETHERMOON is ERC20, Ownable {
    ...
    constructor() ERC20("ETHERMOON", "ETHERMOON") {
    	...
    	operationsWallet = address(0xd281bb0Cb8fB144685F38c80c4BB2d35161F5053); // set as operations wallet
        ...
        _createInitialSupply(address(0xa88420025C517885F675bfF0130129a19592CF1D), (totalSupply * 20) / 100);        
        _createInitialSupply(address(0x294C7EC80ac007B42678DdA1ca1d0240351d18f0), (totalSupply * 1) / 100);        
    }
