        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x01F7990E2E40Df5b44799a2bC85256a6Bd0a9483), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000,//Supply
        address(0xB6AB50CAC5aaCd9cfcE3b9b2904652322Fb92030),//FundAddress
        address(0x01F7990E2E40Df5b44799a2bC85256a6Bd0a9483)//ReceiveAddress
    ){
    }
}