...
// telegram : https://t.me/pepetober11
...
contract PEPETOBER is ERC20, Ownable {
    ...
    constructor () ERC20("PEPETOBER", "PPO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingFeeOnTransfer = 25;

        marketingWallet = 0x38daE31238800dFE7449b016Fe5f35DF771B3fAa;
