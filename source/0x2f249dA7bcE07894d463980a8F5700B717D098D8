...
DID YOU EVER THINK THAT MAYBE THERE'S MORE TO LIFE THAN BEING REALLY, REALLY....REALLY GOOD LOOKING?

https://t.me/BITCOIN_BSC1
...
contract BITCOIN is ERC20, Ownable{
    ...
    address public marketingWallet = 0xEf4d216111D06D3ae2155F8f5EfB5241f55771F1;
    ...
    Taxes public sellTaxes = Taxes(39,1,0);
    ...
    constructor() ERC20("BITCOIN", "BITCOIN") {
        _mint(msg.sender, 690e15 * 10 ** decimals());
