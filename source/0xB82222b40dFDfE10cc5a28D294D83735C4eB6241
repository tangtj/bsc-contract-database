...
/**
   ...
   #PlanetAPES - #LIQ+#RFI+#SAFEMOON, combine together to #PlanetAPES. 
   ...
   I make this #PlanetAPES to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/PlanetAPESBSC
   ...
   I will renounce the ownership to burn addresses to transfer #PlanetAPES to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 50% total supply to the pool
   Can you make #PlanetAPES 1000X? 

   1,000,000,000,000,000 total supply
   
   5,000,000,000,000 tokens limitation for trade, which is 0.3% of the total supply
   ...
   it's the best part of the #PlanetAPES idea, increasing the liquidity pool automatically, 
...
contract PlanetAPES is Context, IERC20, Ownable {
    ...
    string private _name = "PlanetAPES";
    string private _symbol = "PlanetAPES";
