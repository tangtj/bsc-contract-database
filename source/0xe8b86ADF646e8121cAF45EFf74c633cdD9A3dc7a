/**
// https://t.me/DoDoTwoPointZeroBEP20
// https://twitter.com/dodo2
// https://dodotwo.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x3F0083c0fb03814d9F524eEdb187496A288206e2; // owner address
...
contract DoDoTwoPointZeroBEP20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DODO2.0";
    string private _symbol = "$DODO2";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3F0083c0fb03814d9F524eEdb187496A288206e2); // Marketing Address
    address payable private teamWalletAddress = payable(0x3F0083c0fb03814d9F524eEdb187496A288206e2); // Team Address
