...
contract BookDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Book Doge"; // 
    string private constant _symbol = "Book Doge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x33714A841aA999b65638758CF52f1306Da4Fe454;
