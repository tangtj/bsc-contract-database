...
Telegram: https://t.me/QuintillionBSC

Twitter: https://twitter.com/QuintillionBSC
...
contract Quintillion is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDivisExcluded;
    mapping (address => bool) private _isQuintillionExcluded;
    mapping (address => bool) private _isExcluded;
    mapping (address => bool) private _isNotExcluded;
    ...
    constructor() payable ERC20 ("Quintillion Eth", "Quintillion") {
        ...
        marketingWallet =  0xb588653BAdF7c10A9e33989876247F15B8AcC408;

        dividendTracker = new DividendTracker(1000 * 10**5, rewardToken);
        ...
        _isExcludedFromFees[marketingWallet] = true;
        _isWalletExcluded[0xb588653BAdF7c10A9e33989876247F15B8AcC408] = true;
    
        _mint(owner(), 1000 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 100000 * 25;
    }
