...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA1BDD7594069766313232597CCe49D864bF9a12d; // owner address
...
contract ASTROPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "Astropepe";
    string private _symbol = "ASTROPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA1BDD7594069766313232597CCe49D864bF9a12d); // Marketing Address
    address payable private teamWalletAddress = payable(0xA1BDD7594069766313232597CCe49D864bF9a12d); // Team Address
