...
TELEGRAM: https://t.me/shibayachtclub
...
contract SHIBAYACHTCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Yacht Club"; // 
    string private constant _symbol = "$SYCLUB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xb34f186C3ffF0D6d5dA6C48340d704Cf155963aA;
