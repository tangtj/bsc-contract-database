...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82512e9E574918a7e368c7Cf150B609b46404b44; // owner address
...
contract DRAGON2049 is Context, IERC20, Ownable {
    ...
    string private _symbol = "D2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x82512e9E574918a7e368c7Cf150B609b46404b44); // Marketing Address
    address payable private teamWalletAddress = payable(0x82512e9E574918a7e368c7Cf150B609b46404b44); // Team Address
