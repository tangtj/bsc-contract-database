...
contract DGWPreSalev2Test is Ownable {
  ...
  address private Funds_Wallet = 0x9784Ca49e40da05Ea7220EDE6FA235CF90eD53A4;
...
if(uplineAddress == address(0)){
  ...
  function claimTokensS1() public {
    ...
    sale.claimedDate = initialVestingDate + (300 * (claims+1));
