...
contract TheMillionDollarCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x258Af91C64e4C46AF0b58d59BA1797a135D5D3b3;

    string constant _name = "The Million Dollar Coin";
    string constant _symbol = "TMDC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**6 * 10**_decimals; //1 Trillion
