...
contract MiningV8 is Ownable, ReentrancyGuard {
    ...
    uint256 public canRatio = 120;         // account can deposit one issue is ratio. default 250%%.
    ...
    uint256 public userPoolRatio = 1;                   // user pool ratio, remaining is card pool.
    ...
    constructor(
        ...
        oneIssueTime = _dayTime * 7;  // default is 7 day.
        ...
        _startIssue(turn, issue[turn], 25000*(10**18));
    }
