...
contract DRAGONLIQUIDITYADDER {
    address payable public feeRecipient = 0xF44EaF51D568b743e6EDD00c57eAF0b16BAAB174;
    uint256 public feeAmount = 0.035 ether;  // 0.035 BNB fee, using the ether unit for simplicity in Solidity.
