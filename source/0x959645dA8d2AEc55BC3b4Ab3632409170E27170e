...
/*
https://t.me/maskmarkaction

We are based on Elon's Tweet and Team gonna send hard this one
...
contract MUSKMARKACTION is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MUSK MARK ACTION";
    string constant _symbol = "$MMA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8C5e59ea1E4E7ee62bcE108e0162808C6c3Bb51A;  //marketingwallet
        teamWallet = 0x8C5e59ea1E4E7ee62bcE108e0162808C6c3Bb51A; //backup wallet
