...
Telegram: https://t.me/FinePepeChat
...
contract FINEPEPE is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x2DCEA8682f86B7b48DaF8F11E0692C4A957C197b;
    address public devAddress = 0x2DCEA8682f86B7b48DaF8F11E0692C4A957C197b;

    string private constant _name = "Fine Pepe";
    string private constant _symbol = "FIPE";
    ...
    Taxes public taxes = Taxes(0,0,40,0);
    Taxes public sellTaxes = Taxes(0,0,40,0);
