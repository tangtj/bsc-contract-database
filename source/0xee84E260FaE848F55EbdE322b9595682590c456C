...
contract Thunderstorm is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Thunderstorm';
    ...
    constructor () public {
        _rOwned[0x5272C431d2358bC0D666fA01a8C7a7a051EE9947] = _rTotal;
        emit Transfer(address(0), 0x5272C431d2358bC0D666fA01a8C7a7a051EE9947, _tTotal);
    }
