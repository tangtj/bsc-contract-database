...
Wild Gem has partnered with Optimus Deployer to create Wild Gems $GEMS (BSC)
project to provide a safe space for investing, trading, and earning rewards.

Links:
https://t.me/WildGemsToken
https://t.me/ODLAUNCHPAD
https://twitter.com/WildGemsToken
https://t.me/OptimusDeployer

Launch date
11/AUG/2023 02:00PM CST / 07:00PM UTC

Tax distribution 10/10
Marketing + dev 4/4
Rewards 4/4
OD Launchpad 2/2


Type of launch: stealth
...
WG Marketing Wallet Address:
0xA76B5C3A6dD3bA3A5d2356275DeDdE2a9e3f2c2f
*/
...
contract GEMS is ERC20, Ownable {
    ...
    GEMSDividendTracker public dividendTracker;
    ...
    constructor() ERC20("WILD GEMS", "GEMS") {
        marketingWallet = payable(0xA76B5C3A6dD3bA3A5d2356275DeDdE2a9e3f2c2f);
        ...
        dividendTracker = new GEMSDividendTracker(
            payable(this),
            router,
...
contract GEMSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        GEMSContract = GEMS(mainContract);
    ...
    function _transfer(
        ...
        require(false, "GEMS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GEMS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GEMS contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(GEMSContract);

            uint256 prevBalance = GEMSContract.balanceOf(address(this));
            ...
            {
                uint256 received = GEMSContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    GEMSContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
