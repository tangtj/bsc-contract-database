...
contract MarkVSElon is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0x13AdD9bF8f578647432925e4f449aee7D81Fadfc;
    ...
    constructor () ERC20("MarkVSElon", "MVSE") 
    {   
        address newOwner = 0x13AdD9bF8f578647432925e4f449aee7D81Fadfc;
