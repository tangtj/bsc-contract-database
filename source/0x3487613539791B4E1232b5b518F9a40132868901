// https://t.me/CPbsc
// https://twitter.com/CordelioPower
// https://cordeliopower.com/
...
contract CordelioPower is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cordelio Power";
