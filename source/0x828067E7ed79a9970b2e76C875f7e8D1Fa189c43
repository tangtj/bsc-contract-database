/**
 *https://t.me/TreeFireCN
 *In a super green jungle, there was this adventurous monkey, Treefire. One day, he heard some urgent calls for help and found out that a bunch of nasty poachers, led by this bad dude named Callahan, had some animals trapped. Treefire was like, "No way, not on my watch!" 
*/
...
contract TREEFIRE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x6d64785dfba8BBB798dA1cE463d670f266b3Ee33); // So, he put together a team of cool animal pals
        
    address payable public teamAddress =
        payable(0x6d64785dfba8BBB798dA1cE463d670f266b3Ee33); // Rosie the tough elephant, Spike the super adaptable chameleon, and Breezy the eagle-eyed blue jay. 
        
    address payable public liquidityAddress =
        payable(0x6d64785dfba8BBB798dA1cE463d670f266b3Ee33); // They hatched a rescue plan that was all about
        
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD; // sneaky distractions and moving around without being noticed. 
    ...
    string private constant _name = "TreeFire";

    string private constant _symbol = "$TFRE";
    ...
    uint256 public tradingActiveBlock = 0; // Once the moon was up
    ...
    if(!tradingActive){
     ...
     if(limitsInEffect){
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // freeing their friends and guiding them to safety
            ...
            // But Callahan wasn’t giving up that easy
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // Lucky for them, Treefire had a trick up his sleeve
            path,
            address(this),
            block.timestamp
        );
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0, // He tricked the poachers into following him into a sleeping volcano
            0, // Then he started a fire, causing an eruption that trapped Callahan and his goons 
            liquidityAddress,
            block.timestamp
        );
    }
        ...
        returns (address _pair)
    {
        ...
        if (_pair == address(0)) {
            // giving the animals a chance to escape for good
        ...
        // Back in the jungle, everyone celebrated Treefire and his team for their bravery
        uniswapV2Router = _uniswapV2Router;
        emit UpdatedRouter(_router);
    }

    // He proved that no matter how small you are, you can make a big difference
