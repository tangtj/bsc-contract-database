...
We're a force of mutant heroes born with crypto superpowers.
Created by visionaries Stan Lee and Jack Kirby, we soar high like Marvel's finest!
With our BSC token, we're set to MOON and beyond! 
Join us now, and let's conquer the crypto universe together! 

TG: https://t.me/xmenbscx
*/
...
contract XMen is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x6D906640D6ccD9E3D921d2c448AefF0aF42C2aF0);
    address payable private _marketingAddress = payable(0x6D906640D6ccD9E3D921d2c448AefF0aF42C2aF0);
