...
contract MetaZombieverse is IERC20 {
    ...
    string constant private _name = "MetaZombieverse";
    string constant private _symbol = "ZOMBIEVERSE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x10a07C7a01214CA90d22Ce972D51f092CD6bE18a)
    });
