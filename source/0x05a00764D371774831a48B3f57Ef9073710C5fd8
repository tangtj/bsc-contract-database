...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Beer Money";
    string public constant TOKEN_SYMBOL = "BEER";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x8a71366b82B4a98Cdd4B2745a15A0FAdACaEf079;
    ...
    
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x8a71366b82b4a98cdd4b2745a15a0fadacaef079)];
        uint[1] memory amounts = [uint(40000000000000)];
