//https://t.me/babyfinebscliqburnt
...
contract BabyFine is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BABY FINE";
    string private _symbol = unicode"$BABYFINE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x8Ae640B9f194c4F66B81AbCA2CDE3f4E1E8A284B);
    address payable private taxWallet2 = payable(0x8Ae640B9f194c4F66B81AbCA2CDE3f4E1E8A284B);
