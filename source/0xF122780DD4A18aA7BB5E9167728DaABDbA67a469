...
contract VetusBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vetus Bsc";
    string private _symbol = "VBSC";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xfb3C8722B0b9159fD64c9Ba21D1146dD6Aaa5c39);
    address payable public teamWalletAddress = payable(0x45402a86838d5af7C92A6F4C8632A26CBDe1147E);
