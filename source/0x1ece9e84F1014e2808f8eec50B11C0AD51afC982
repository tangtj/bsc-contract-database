// t.me/RealAliensEnjoyingLiquidity 
// RealAliensEnjoyingLiquidity.com
...
contract RealAliensEnjoyingLiquidity is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "RealAliensEnjoyingLiquidity";
    string public symbol = "RAEL";
