...
contract TOSHU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "TOSHU";
    ...
    address payable public DevWallet = payable(0x5e2b5F0227540443678Bc06961c5d2baD30bAad2);
    address payable public MarketingWallet = payable(0x5e2b5F0227540443678Bc06961c5d2baD30bAad2);
