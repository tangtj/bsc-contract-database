...
contract TOKEN is ERC20, Ownable {
    ...
    uint8 public rewardsFee = 5;
    uint8 public liquidityFee = 5;
    uint8 public marketingFee = 5;
    uint16 public totalFees = rewardsFee + liquidityFee + marketingFee;
    uint256 public maxWalletLimit = 2 * 10**7 * (10**18); // 20 Million tokens

    address public _marketingWalletAddress = address(0x43616Bb32918bfe14416D77765f9beB9A04a41a1);
    ...
    constructor() ERC20("SHELBY Token", "SBY") {
        ...
        */
        _mint(owner(), 88 * 10**7 * (10**18));
        _mint(_marketingWalletAddress, 5 * 10**7 * (10**18)); //Marketing wallet
        _mint(address(0xF2cE60A69C88dC04B750dB25fEfb8707438AE857), 5 * 10**7 * (10**18)); //Team wallet
        _mint(address(0x609814A28FFB6322CCcEE7FAfF3A010212724396), 2 * 10**7 * (10**18)); //Airdrop wallet
    }
...
if (!automatedMarketMakerPairs[to]) {
                require(
                    ...
                    "Token: Transfer amount exceeds hold limit"
                );
            }
