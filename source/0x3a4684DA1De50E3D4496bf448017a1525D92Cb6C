...
contract PedalCycle is Context, IERC20, Ownable {
    ...
    string private _name = "PedalCycle";
    string private _symbol = "PEDAL";
    ...
    address public marketingWallet = 0x977Cb920bE2fAA4a533ca06f0b20cA7bb3E16BBc;
