...
Telegram https://t.me/technicalium
twitter https://x.com/technicaliumofc
*/
...
contract Technicalium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TECHNICALIUM";
    string private _symbol = "$TCLM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f43F82720696d82755E3F402CF01FBeB441C44C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4AA2e16493385120d6B7E5602B2D3F2B9286e9Fc); // BuyBack Address
    ...
    uint256 public _walletMax = 100 * 10**5 * 10**9;
