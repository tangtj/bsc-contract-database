...
contract OLYMPICGAMESDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x9B8702B7D21290365df5db8C18e58Bb9485067fe);
    ...
    uint256 public Percent_Marketing = 83;
    ...
    constructor () {
        _owner =0x9B8702B7D21290365df5db8C18e58Bb9485067fe;
