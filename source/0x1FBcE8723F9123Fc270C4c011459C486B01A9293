...
/*
https://t.me/paypalgrow

We are based on PayPal Hype and Team gonna send hard this one
...
contract PAYPALGROW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PayPal Grow";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x67525c1d92C3d89C3626443639b64C5cA0E1588a;  //marketingwallet
        teamWallet = 0x67525c1d92C3d89C3626443639b64C5cA0E1588a; //backup wallet
