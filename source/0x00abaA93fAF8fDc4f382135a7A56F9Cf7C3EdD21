...
/**
 * @title WrappedMUE
 * @dev Implementation of the WrappedMUE
 */
contract WrappedMUE is ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover {
    ...
    constructor (
     ...
     // address payable feeReceiver
        ...
        ERC1363("Wrapped MonetaryUnit", "WMUE")
        //ServicePayer(feeReceiver, "WrappedMUE")
        payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
