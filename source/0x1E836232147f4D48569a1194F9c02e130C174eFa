...
contract WildDuck is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"WILD DUCK";
    string private _symbol = unicode"WILDDUCK";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x42A17B2b8CD78E9a3aC2f066433AC5A59767f4eB);
    address payable private taxWallet2 = payable(0x42A17B2b8CD78E9a3aC2f066433AC5A59767f4eB);
