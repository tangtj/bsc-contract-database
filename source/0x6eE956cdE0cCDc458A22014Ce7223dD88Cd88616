...
contract Token is ERC20,Ownable {
    ...
    constructor()ERC20("FLOKI2.0", "FLOKI2.0") {
        admin = 0x6683968268fB2a9C31FE43af9C2c3b079a015cB7;
    ...
    function _transfer(
        ...
        pancakeV2Pair = ISwapFactory(pancakeV2Router.factory()).getPair(address(this), pancakeV2Router.WETH());
