...
contract HamsterCeo is Context, IERC20, Ownable {
    ...
    address public marketingWallet =  0x632886c16D0F13D706e4aaD27637836C9328Ca58;

    string private constant _name = "Stormy";
    ...
    // Owner cannot transfer out  Hamster Ceo from this smart contract
