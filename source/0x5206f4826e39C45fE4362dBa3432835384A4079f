...
contract KAELOO is ERC20, Ownable {
    ...
    constructor () ERC20("Kaeloo", "KAELOO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x6F1B29d86065e2D786fD8F8582aa42910bE54541;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;

        _mint(owner(), 9e11 * (10 ** decimals()));
