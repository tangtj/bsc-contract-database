/*
AI Smart Contract Generator (AISMART)
Ai smart contract generator
https://aismartcode.net/
https://t.me/aismartportal
*/
...
contract AISMARTToken is BEP20Official {
    ...
    string public override name = unicode"AISMART";
    string public override symbol = unicode"AISMART";
