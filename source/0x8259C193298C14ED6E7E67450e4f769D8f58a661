...
/**
TG: https://t.me/UltraXbep20
Twitter: https://t.me/UltraXbep20
*/
...
Ultra X was a multi-rewarding token in 2022
It is a token that gave reward to holders in any token they want.
 Holders were able to choose any token on the bsc network through the use of a customized dashboard.

All holders that didn't choose any token as their reward got BNB as the default reward.

We are happy to introduce a token with the same name as ULTRA X.
 As X is currently trending. This will definitely shoot the moon.

Welcome to Ultra X ⭐️

https://t.me/UltraXbep20
...
contract UltraX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x36d9C0B8B5B83ad3289a214d306914C5B0827Be4;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "UltraX";
    string constant _symbol = "$UTX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 350 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; 
    uint256 public _maxWalletToken = ( _totalSupply * 350 ) / 10000;  
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x36d9C0B8B5B83ad3289a214d306914C5B0827Be4;
