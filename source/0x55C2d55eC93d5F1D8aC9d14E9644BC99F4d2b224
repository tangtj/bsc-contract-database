/*
Come and join $JeetSimpson the next 1000x in Binance
...
🟢 CMC + CG Fast-track
🟢 LOW MC - EASY PUMP!
🟢BUY/SELL = 2 (Marketing And USDT REWARDS)

TG: https://t.me/jeetsimpson
*/
...
contract JeetSimpson is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jeet Simpson";
    string private constant _symbol = "Jeetsimp";
