...
contract Symbolic is Context, IERC20, Ownable {
    ...
    string public _name = "Symbolic";
    string public _symbol = "SYB";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9509b0c83c3936bab690B6e8636036e700A7C238); // Marketing/Development Address
    address payable private DevelopmentWalletAddress = payable(0x9509b0c83c3936bab690B6e8636036e700A7C238); // Address
