...
contract Zero is Context, IERC20, Ownable {
    ...
    string private _name = unicode"ZERO";
    string private _symbol = unicode"ZERO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x0874cE8E1869881481542696AED1A05cA197eFAc);
    address payable private taxWallet2 = payable(0x0874cE8E1869881481542696AED1A05cA197eFAc);
    ...
    uint256 public _walletMax = _totalSupply*3000/10000;
