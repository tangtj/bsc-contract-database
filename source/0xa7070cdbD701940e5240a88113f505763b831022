...
abstract contract BEP20Mintable is Context, BEP20, Ownable {
    ...
    function mint(uint256 amount) public virtual onlyOwner{
        require((totalSupply()+ amount)<= 110000000 * (10 ** uint256(18)), 'Maximum Supply can be only upto 11,00,00,000 Token');
        _mint(_msgSender(), amount);
    } 
}

contract  DONO_Token is BEP20,Ownable,BEP20Burnable,BEP20Mintable {
    constructor()
         BEP20("DONO", "DONO", 18) {
            _mint(msg.sender, 110000000 * (10 ** uint256(18)));
        }
