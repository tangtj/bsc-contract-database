...
WAWA BEAR
电报：https://t.me/WaWabearlabs
推特：https://twitter.com/WAWABEARLABS
            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0x376B5556745d2C2C8dBFAdA856E19439f76e6db7), destroyAmount);
                    }
                }
...
contract WAWABEAR is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0x376B5556745d2C2C8dBFAdA856E19439f76e6db7),
        address(0x278151D423cC4C76A3abee48BB26a9F36999013D),
        address(0x71eEf46bA9DD344dbd2B461cBB186BA10cf1b40f),
        address(0xb35b5907931369511f2f66A8Ce6c64BDF7081977),
        1000000,
        0,
        1000000
    ){
