...
contract BUNNYDEFI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x50297c1f485357AA37c615E187AF8867f21f840a;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Bunny Defi";
    string constant _symbol = "BUNNY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20000000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x50297c1f485357AA37c615E187AF8867f21f840a;
