...
contract SEMPTEST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SempTEST";
    string private _symbol = "SAITEST";
    ...
    uint256 public _totalSupply = 420 * 10**13 * 10**9;
    uint256 public _maxTxAmount = 84 * 10**12 * 10**9;
    uint256 public _walletMax = 84 * 10**12 * 10**9;
