...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "TITDAO";
    string private _symbol = "TITDAO";
    ...
    address public ownerAddres = address(0x72BF49fa164B3Fd427284b4035CA9c3f3E2c5A65);
    address public devAddress = address(0x3fB09C72A79A4293bd27d70d2d5d94061623dCBC);
