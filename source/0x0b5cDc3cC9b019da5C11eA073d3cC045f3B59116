...
/**
   #Shivansh(SHIVANSH)
   4% fee auto add to the liquidity pool to locked forever when sellin
   3% fee auto distribute to all holders
   3% fee auto moved to charity & marketing wallet
*/
...
contract Shivansh is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x04C5c7c31b77FA0E19153A3C5C5093e31C77fCFF ;
    ...
    string private _name = "Shivansh";
    string private _symbol = "SHIVANSH";
