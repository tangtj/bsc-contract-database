...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBBF8B9c4dA6EA43bAD6827f6Abd3F45e366070A3; // owner address
...
contract  Babydoge2K23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Babydoge 2K23";
    string private _symbol = "BABYDOGE2023";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1E2f9b206d8bb55C8BB0D18B0a67Da6aD525D13c); 
    address payable private teamWalletAddress = payable(0x1E2f9b206d8bb55C8BB0D18B0a67Da6aD525D13c);
    ...
    uint256 public _maxTxAmount = _totalSupply /10000000000000; 
    uint256 public _walletMax =   _totalSupply /100000000000000;
