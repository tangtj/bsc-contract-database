...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8993974D07554B22D4970fbAeB8f0756803e97a1;
...
contract SIALL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd276a79953BC4C4ef8D51bCc7dFedc69F4E5da6f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SIALL";
    string private _symbol = "SIALL";
    ...
    uint256 private numTokensSellToAddToLiquidity = 600000 * 10**18;
