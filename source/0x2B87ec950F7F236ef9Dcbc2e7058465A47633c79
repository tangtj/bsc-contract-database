...
contract Scarab is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x092B38161818C5e68e81CfFB03d335A4f94C8702);
    address payable private _twdmkt = payable(0x092B38161818C5e68e81CfFB03d335A4f94C8702);
