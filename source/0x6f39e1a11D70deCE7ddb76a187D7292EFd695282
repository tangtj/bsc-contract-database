...
contract Mesmerise is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 address _marketingAdr = 0x2bAA808B44737Cf6078C03902f83A364e9599319;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string constant _name = "MESMERISE";
 string constant _symbol = "MES";
