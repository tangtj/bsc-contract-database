...
contract DorkLord20 is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   DorkLord20DividendTracker public dividendTracker;
    ...
    constructor() ERC20("Dork Lord 2.0", "DorkLord20") {
        marketingWallet = payable(0xbc4e147d7CFd0DaA20F62Fadac76faBD203f618c);
        devWallet = payable(0xD60BC640dFd42D0bC800f1a7FB12C15Fb641Ee06);
        ...
        totalSellFees = sellRewardsFee
            ...
            .add(sellDevFee); 
        dividendTracker = new DorkLord20DividendTracker(
            payable(this),
            router,
...
contract DorkLord20DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    address public defaultToken; // TRIAS
   ...
   DorkLord20 public DorkLord20Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        DorkLord20Contract =DorkLord20 (mainContract);
    ...
    function _transfer(
        ...
        require(false, "DogeBender_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DogeBender_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DogeBender contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DorkLord20Contract);

            uint256 prevBalance = DorkLord20Contract.balanceOf(address(this));
            ...
            {
                uint256 received = DorkLord20Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DorkLord20Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
