...
//contract KuraiInu is Context, IERC20 {
    ...
    string constant private _name = "Kurai Inu";
    string constant private _symbol = "KURAI";
    ...
    address payable private _marketingWallet = payable(0xBd3629D0d77528eD85f4e9fF63dc1B57C9D6f4Bd);
    address payable private _buybackWallet = payable(0x2756560C496fa9a9083d5cc509b617646Bc13f87);
