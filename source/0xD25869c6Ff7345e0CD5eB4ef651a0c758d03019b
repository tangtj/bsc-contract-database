...
https://t.me/PepeOfWallstreet_Portal
...
contract PepeOfWallstreet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Pepe Of Wallstreet";
    string private _symbol = "POW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xFe91d2882aff024A7887A8A36285490E24a65A3D);
    address payable public teamWalletAddress =
        payable(0xd184A0a53193C458611709043AB0816ea590D8Fd);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply / 100;
