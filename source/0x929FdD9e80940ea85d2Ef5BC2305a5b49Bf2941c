// A new inu movement, they have started a movement in ETH, then, let us start this Inu movement belonging to bsc!

//TG:https://t.me/GAIYAINU  Join us and start a new Inu campaign!

//In order to maintain a good development, we will start the repurchase before the liquidity exceeds 100BNB, and repurchase 2BNB in ​​10 minutes.
...
contract GaiYaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GaiYa Inu";
    ...
    address payable public marketingWalletAddress = payable(0x1e618ce717D6f739f9781826e5F18131b046Ee7d); // Marketing Address
    address payable public teamWalletAddress = payable(0x737Dc1137F58a2dBf35a6b818E24628012246677); // Team Address
    address payable public liquidityAddress = payable(0x9c2eE131A60e663273417d4B1763305DdA503c3E); // Team Address
