/**                                                                                     
   ...
   it's the best part of the #$PePe idea, increasing the liquidity pool automatically, 
...
contract $PePe is Context, IBEP20, Ownable {
    ...
    address private _marketingWalletAddress = 0x9367E3b804c01Eca67Aa2e40b7C41DAf2d9D74aC;
