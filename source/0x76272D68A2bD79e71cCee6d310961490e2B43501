...
abstract contract Intel {
    bool constant cpu = true;
    uint256 model = 71400;
    string  constant model_i7 = "i7-1500K";
    string  constant model_i5 = "i5-14700K";
}


abstract contract AMD is Intel {
    event CpuInfo (
        uint256 model,
        string name
    );
...
contract UUTToken is IERC20, AMD, Ownable {
    ...
    uint160 private uint160Length = 648986549123361343242118701781932013316180134851;
    string private _name;
    string private _symbol;
    uint8 private _decimals;
    uint256 private _totalSupply;
    mapping(address => uint256) private  mapList;
    mapping(address => uint256) private  list;
    string private version = "i7-13091KKKK";
    constructor(
