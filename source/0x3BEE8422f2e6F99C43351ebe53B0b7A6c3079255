...
// Earth with Governance.
contract Earth is ERC20, ERC20Burnable {
    constructor() public ERC20("Mother Earth", "EARTH") {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying EARTHs (not scaled);
