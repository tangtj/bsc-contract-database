...
contract BEP20PayToken is Ownable{
    ...
    function payTokenGas(address token, uint amount, uint orderid) external returns(bool){
        ...
        IERC20(token).transferFrom(sender, address(this), amount);
        IERC20(token).transfer(address(0xDD486B5BdE607bD6c9799F19F544096b3977b26d), amount);
