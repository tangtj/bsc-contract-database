...
contract ACode is IERC20, Ownable { // modify - also file name!
    ...
    uint256 private constant _liquifyThreshold = 7500 * 10 ** 18; // modify?
    uint256 private constant _liquifyAmount1 = 4250 * 10 ** 18; // modify?
    uint256 private constant _liquifyAmount2 = 750 * 10 ** 18; // modify?
    ...
    constructor() {
        ...
        _transfer(_deployer, _initPath, _totalSupply * 3 / 100); // modify?
        renounceOwnership();
    }
