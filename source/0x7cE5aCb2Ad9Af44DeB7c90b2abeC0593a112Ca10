// OKAYGUY Token, All credits due to his owners
// Everything is going to be OKAY!! 
// https://okayguy.xyz
// Audit Comments incorporated
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81B2cCda2111C99dAC5F50eA02349854D7C61A64;
...
contract OKAYGUY is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1B53C48DB591D8BFB1eb63035F422028E082c20E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OKAYGUY";
    string private _symbol = "OKAYGUY";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require (taxFee < 20,'tax too high');
        _taxFee = taxFee;
    }
    function setDevelopmentFeePercent(uint256 developmentFee) external onlyOwner() {
        require (developmentFee < 20,'development fee too high');
        _developmentFee = developmentFee;
    }
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require (liquidityFee < 20,'liquidity fee too high');
