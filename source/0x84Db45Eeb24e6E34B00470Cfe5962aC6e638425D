...
contract ALIENINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4F654F65ae9fc299537a29E467D0a1586C5F9d43); 
    ...
    string private constant _symbol = unicode"$AlienInu"; 
