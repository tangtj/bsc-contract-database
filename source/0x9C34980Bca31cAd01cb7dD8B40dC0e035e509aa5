        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xbc1ec7dFB5c3c6a9CeF5Afdf440746BfF73F9c0C), block.timestamp
                );
            }
        }
    }
...
contract RHCTOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xbc1ec7dFB5c3c6a9CeF5Afdf440746BfF73F9c0C)//ReceiveAddress
    ){
    }
}