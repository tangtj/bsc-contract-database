...
contract CSTEP is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'COMMUNITYSTEP';
    string private constant _symbol = 'CSTEP';
    ...
    address public walletTwo=payable(0x6ac644012e1999913F3D35c8b3c143022D2f214F);
    //Testnet
