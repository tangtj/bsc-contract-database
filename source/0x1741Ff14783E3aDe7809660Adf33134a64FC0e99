...
contract BabyNeuralink is IBEP20, Auth {
    ...
    string constant _name = "BabyNeuralink";
    string constant _symbol = "NEURA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xA00B4B4B7753a5bcA98EA43dad17622049dd5cb9;
