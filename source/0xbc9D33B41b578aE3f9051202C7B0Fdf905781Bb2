...
Telegram: https://t.me/XElonofficial
...
contract XELON  is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xb5bd1D17760ECb72c249a3b664Ed7FeF477322e2;
    address public devAddress = 0xb5bd1D17760ECb72c249a3b664Ed7FeF477322e2;

    string private constant _name = "X ELON";
    string private constant _symbol = "XELON";
    ...
    Taxes public sellTaxes = Taxes(0,0,8,2);
