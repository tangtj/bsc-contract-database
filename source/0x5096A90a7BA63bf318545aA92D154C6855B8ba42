...
contract CaptainCheems is IBEP20, Auth {
    ...
    string constant _name = "CaptainCheems";
    string constant _symbol = "CAPTC";
    ...
    address private marketingFeeReceiver = 0x32A54fcA6Cf983aea10C87f0249e6FB2BC4F9C34;
    address private buybackFeeReceiver = 0x481ae3598EfAF102a532f7c10c7f96488F74fa95;
