...
/**
Telegram: https://t.me/arnoldcoinbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x975696629e54eEe2773037FE69fcB8f05FeEbbf7; // owner address
...
contract ArnoldCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arnold Coin";
    string private _symbol = "Arnold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x975696629e54eEe2773037FE69fcB8f05FeEbbf7); 
    address payable public teamWalletAddress = payable(0x975696629e54eEe2773037FE69fcB8f05FeEbbf7);
