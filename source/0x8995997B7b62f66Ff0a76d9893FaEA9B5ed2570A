...
contract VaultGuardContract is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 5000000 * 18**decimals();
    uint256 public maxWalletLimit = 25000000 * 18**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0x0305775610b90161E6Ba222B100bFdE8B242F803;
    address private devWallet = 0x7F0BA4F96413d7451895dA34f9948719b275a9Be;
    ...
    Taxes public sellTaxes = Taxes(4, 2, 5);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("VaultGuard", "VaultG") payable {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 500000, "Cannot set max wallet amount lower than 0.1%");
