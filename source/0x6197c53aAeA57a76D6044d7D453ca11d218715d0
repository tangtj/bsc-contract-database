...
/*
// TELEGRAM : https://t.me/ShibariumXbsc
...
contract ShibariumX is Context, IERC20, Ownable {
    ...
    string private _name = unicode"ShibariumX";
    string private _symbol = unicode"ShibariumX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xCC8898E834807ED2C55B7a114cdDD692E40C0762);
