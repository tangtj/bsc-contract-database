...
contract CumInFace is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CUM IN FACE";
    string private constant _symbol = unicode"$CIF";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 44000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x809CA57550c5b0236c7Fc28C9B98039Ee0d0ad52);
    address payable public MarketingWallet = payable(0x93ff0B91C69b811B9a66124Ad82E6b6824Ec211B);
