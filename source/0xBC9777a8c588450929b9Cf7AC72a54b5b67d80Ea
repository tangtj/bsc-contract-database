...
contract aarmAUSD is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("AARMA-USD", "AUSD") ERC20Permit("AARMA-USD") {
        _mint(msg.sender, 21150000 * 10 ** decimals());
    }
