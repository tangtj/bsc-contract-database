// Telegram: https://t.me/atomchain_portal
...
contract ATOMCHAIN is Ownable, IERC20 {
    ...
    string constant private _name = "ATOMCHAIN";
    string constant private _symbol = "ATOM";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xdF6846328765A13944042873f51251b82f9bA3ff;
        devWallet = 0xdF6846328765A13944042873f51251b82f9bA3ff;
