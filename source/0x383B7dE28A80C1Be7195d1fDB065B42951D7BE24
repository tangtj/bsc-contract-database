...
// X : https://twitter.com/diabloiv_bsc?s=21
...
contract DiabloIV is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x886F908602bbd2E3A3fA5Ce65C4f2E7BAa30F25b);
    address payable private _twdmkt = payable(0x8f5195D7Efa8554b69d145263e3dDDEE4573A5e3);
    
    string private constant _name = "DiabloIV";
    string private constant _symbol = "DBLIV";
