/**
TELEGRAM -- https://t.me/DOMOKUN_PORTAL -- TELEGRAM
WEBSITE -- ON GROUP -- WEBSITE
**/
...
contract DOMOKUN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DOMOKUN";
    ...
    address payable public DevWallet = payable(0xDcB7F52Af2122582AF1891CaE57208CE66754b82);
    address payable public MarketingWallet = payable(0x6adC00405D0e73031A5F9B1730fDbF4162799230);
