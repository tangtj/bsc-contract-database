...
contract pepe is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF5e8fb48f3F1e8e9e9875F9816a1A1a638096cB3); 
    address payable public teamWalletAddress = payable(0x153D2118a02306aA09D3a1ecAD271FfeA2dC1c40);
