...
contract yisheng is Token {
    constructor() ERC20(
        "1314",   // 名字
        "1314"   // 符号
    ) {
        uint256 _totalSupply = 520 ether;
        address _marketing = address(0xfe4484869e6dDbACa9Df5468B80C2f16734d7Ce1); //
        address _receive = address(0xfe4484869e6dDbACa9Df5468B80C2f16734d7Ce1);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xfe4484869e6dDbACa9Df5468B80C2f16734d7Ce1)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xfe4484869e6dDbACa9Df5468B80C2f16734d7Ce1);
        feeEarn = 0;
    }
}