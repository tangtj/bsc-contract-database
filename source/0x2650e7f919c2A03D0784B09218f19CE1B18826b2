...
contract SulfurSwap is Context, IERC20, Ownable {
    ...
    string private _name = "Sulfur Swap"; 
    string private _symbol = "SULFUR"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77ae8A62F8C842C34F50bc6bD000d3A7f5911af3); 
    address payable public teamWalletAddress = payable(0x62414e6d6d47bB211d43f6293fEe191eAf99003a); 
