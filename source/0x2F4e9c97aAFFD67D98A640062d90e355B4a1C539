...
contract CoinToken is Context, IERC20, Ownable {
    ...
    uint256 public minimumTokensBeforeSwap = _tTotal.div(100000); 
    ...
    uint public liquifyFeeBuy = 0; // percent
    uint public liquifyFeeSell = 2; // percent
    uint public marketingFee = 6; // percent
    uint public buyBackFee = 2; // percent
    ...
    uint public botKillerLimitMinutes = 1;
    uint presaleDate;
    ...
    uint256 public dailySellLimit = 2 * 10 ** 12 * 10 ** _decimals;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        buyLimit = 1000000000 * 10**6 * 10**_decimals;
        sellLimit = 0;
    }
