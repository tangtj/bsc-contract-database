...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    constructor(){
            ...
            _intervalSecondsForSwap =  3*30*86400;
            _lpTime = 12 * 3600;
            _minPeriod = 86400;
            _setGas = 5000000000;
            if(block.chainid == 97) {
                admin = 0x7d1b5a54b17a4D2bC2CEA69ae29d1A441020bbE1;
                _token = 0x89614e3d77C00710C8D87aD5cdace32fEd6177Bd;
                router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
                _intervalSecondsForSwap = 20 minutes;
                _lpTime = 1 minutes;
                _minPeriod = 2 minutes;
                _time = 5 minutes;
                _bbtime = 15;
                _setGas = 10000000000;
            }
    ...
    function setMaxGas(uint256 value) public onlyOwner {
