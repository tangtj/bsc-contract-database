...
/**
   ...
   Welcome to KawaiSHIBA
   
   This is a community token. If you want to create a telegram I suggest to name it to @KawaiSHIBA
   ...
   I will renounce the ownership to burn addresses to transfer #KawaiSHIBA to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #KawaiSHIBA   1000X? 
   ...
   it's the best part of the #KawaiSHIBA  idea, increasing the liquidity pool automatically, 
...
contract KawaiSHIBA  is Context, IERC20, Ownable {
    ...
    string private _name = "KawaiSHIBA";
    string private _symbol = "KawaiSHIBA";
