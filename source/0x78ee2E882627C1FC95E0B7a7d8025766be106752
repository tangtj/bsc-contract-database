...
contract SNPTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public diinf8;
    ...
    string private _tokenname = "Swan Swap";
    string private _tokensymbol = "SNP";
