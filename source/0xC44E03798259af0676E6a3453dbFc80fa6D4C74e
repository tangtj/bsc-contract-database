...
// Telegram: https://t.me/XDOGELON_BSC
...
contract XDOGELON is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xB9a584277Ad15F7C946E40Aec64A8915E8FE1C48);
    address payable private _twdmkt = payable(0xB9a584277Ad15F7C946E40Aec64A8915E8FE1C48);
    
    string private constant _name = "X DOGELON";
    string private constant _symbol = "XDOGELON";
