...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xffEc3BF5dDBd8e34c57cD1F592A167b66d94e523;
...
contract Ellah is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xffEc3BF5dDBd8e34c57cD1F592A167b66d94e523); //add marketing wallet
    ...
    string private _name = "Ellah";  //set name
    string private _symbol = "Ellah";  // set symbol
    uint8 private _decimals = 9;
    uint256 private _tTotal = 5000000000 * 10 ** decimals(); //total supply 
