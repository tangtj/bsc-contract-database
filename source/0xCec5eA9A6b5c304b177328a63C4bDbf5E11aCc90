...
contract JQB is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xE7F7DD50bCEE081165ac07E6dc1c7C94b8E03f77;
    address public _suiWalletAddress = 0x6eBf6a95E1760209B5642af1BE4116676960CbA3;
    ...
    uint256 public times = 1991063170;
    uint256 distributorGas = 500000;
    uint256 public _maxTxAmount = 10 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("JQB", "JQB") {
        ...
        excludeFromFees(_suiWalletAddress, true);
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(15)){
                ...
                super._transfer(from, _suiWalletAddress, lpfees);
                isSw = true;
            }
