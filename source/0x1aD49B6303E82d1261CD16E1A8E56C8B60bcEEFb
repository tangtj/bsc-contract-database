...
contract ZOROTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public whhhbn34;
    ...
    string private _tokenname = "Zoro Inu";
    string private _tokensymbol = "ZORO";
