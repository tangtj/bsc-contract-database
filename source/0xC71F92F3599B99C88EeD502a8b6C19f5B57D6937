/* 
 ...
 XTOSHI is a new page of BSC!

TG - https://t.me/xtoshiofficialbsc
Twitter - http://www.twitter.com/xtoshibsc
...
contract ToshiX is ERC20, Ownable {
    ...
    constructor () ERC20("ToshiX", "ToshiX") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x92e57F6cD84Df34fc7d7a56560a82A84B937835d;
