...
contract BURNINGSAUSAGE is Context, IERC20, Ownable {
    ...
    string private _name = "BURNINGSAUSAGE";
    string private _symbol = "SMELLIT";
    ...
    address payable public marketingWallet = payable(0xe2857e24d648893F752fB2761bCA903010B0AE7B);
    ...
    uint256 public numTokensSellToAddToLiquidity = 13 * 10**18;
    uint256 public _maxTxAmount = 3 * 10**18;
    uint256 public _maxWalletLimit = 3 * 10 ** 18;
