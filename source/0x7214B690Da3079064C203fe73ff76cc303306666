...
contract HL is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x1E4cA828da611f5124fCa23279EE11052DFEaFD9); //
        ...
        super.setSurprise(
            900,
            3,
            address(0x1E4cA828da611f5124fCa23279EE11052DFEaFD9)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(8 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x9786DA9C4d12407b65680eCDa0b641C59b3112e1);
        feeEarn = 1000;
        isLiquified = true;
    }
}