...
contract TTT is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0x57b26832532d3Cfb5F2c29BfF95E22c6032365df);
    address public ownerAddres = address(0xc814f827369C985A492Be22Dd64A40882d023478);
    address public devAddress = address(0x0C34BD40f02E91B1A4F8ADff07e47C81E6777d90);
