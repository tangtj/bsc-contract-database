...
contract ZRL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZRL";
    string private _symbol = "ZRL";
    ...
    address payable private marketingWalletAddress = payable(0x044E4d441415916fD8399228053793a915EcCb8b); // Marketing Address
    address payable private teamWalletAddress = payable(0x771933F2bC2646F93BD6dbb7f2772D00B49BA009); // Team Address
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 lastAmount = amount.sub(feeAmount);
        return lastAmount.mul(99).div(100);
    }
