...
contract MinpitKyushu is DateTime,Ownable,AccessControl{
    ...
    constructor() Ownable(){
        ...
        uniswapV2Pair = 0xc69229640EB3330e38F525CA774FDc7CEB4AfD01;
    ...
    */
    ...
    function getTokenPrice() public view returns (uint256 tokenPrice){
        ...
        inreq[0] = _token;
        inreq[1] = _usdt;
        return IUniswapV2Router01(uniswapV2Pair).getAmountsOut(1000000000000000000,inreq)[1];
    }
    ...
    function swapExactTokensForTokens(uint256 usdtAmount) public{
        ...
        inreq[0] = _usdt;
        inreq[1] = _token;
        IUniswapV2Router02(uniswapV2Pair).swapExactTokensForTokensSupportingFeeOnTransferTokens(usdtAmount,c,inreq,address(this),block.timestamp + 120);
    }
