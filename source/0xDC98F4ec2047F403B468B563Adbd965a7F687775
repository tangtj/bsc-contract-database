...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2b8e2DF7BAdd32c826F7e14e155b411A89246DA1);
...
contract Mochi is IBEP20, Auth {
    ...
    address DEV  =  0x5ed45Ef8512B2558C330992D54C036326C72f545;

    string constant _name = "Mochi Inu";
    ...
    address public autoLiquidityReceiver = (0x5ed45Ef8512B2558C330992D54C036326C72f545);
    address public marketingFeeReceiver = (0x4902308bFbd8B192898e329890710C37FC9f1Ca5);
    address public devFeeReceiver = (0x5ed45Ef8512B2558C330992D54C036326C72f545);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/3, "Fees cannot be more than 15%");
    }
    ...
    uint256 public sellMarketingFees = 5;
