...
abstract contract DexBaseUSDT {
    ...
    uint256 constant minHoldtoDividend = 1 * 1e28 ether; 
    modifier isSwap() {
        inisSwap = true;
        _;
        inisSwap = false;
    ...
    BlackList
{
    ...
    string private constant tokenName = "MOONY";
    string private constant tokenSymbol = "MOON";
    uint256 private constant maxhaveAmount = 10 * 1e32 ether;

    bool public trading = false;
    
    constructor()
        ERC20("MOONY", "MOON", 18)
        DividendFee(1*1e28 ether, true)
        LiquidityFeeUSDT(1*1e28 ether, true)
        MaxHave(10*1e32 ether)
    {
