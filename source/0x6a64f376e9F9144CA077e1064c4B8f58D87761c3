...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD99DC7A047a72eA989Ce713C0698FB689B8EC64e; // owner address
...
contract TRENDX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TREND X";
    string private _symbol = "TRENDX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc2289089dd9B8608E365AD19790cD70e806d19c5); 
    address payable public teamWalletAddress = payable(0x58c2B1937aB159d1c5a8D88e35857B08F35D5cea);
