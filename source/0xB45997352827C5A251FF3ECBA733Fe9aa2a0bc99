...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDe78E8C552929E4D9E3A87c183A148e3E49bF485; // owner address
...
contract Pepeinu is Context, IERC20, Ownable {
    ...
    string private _name = "PepeInu Classic";
    string private _symbol = "PEPEINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDe78E8C552929E4D9E3A87c183A148e3E49bF485); // Marketing Address
    address payable private teamWalletAddress = payable(0xDe78E8C552929E4D9E3A87c183A148e3E49bF485); // Team Address
