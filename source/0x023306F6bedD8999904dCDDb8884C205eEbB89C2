...
contract apton is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APTON NETWORK";
    string private _symbol = "$APN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCeceFa8F9d6Bc715369ACFb2956a5c8D843B3B75);
    address payable private DevelopmentWalletAddress = payable(0xCeceFa8F9d6Bc715369ACFb2956a5c8D843B3B75);
    ...
    uint256 public _maxTxAmount = 2300000000 * 10**9;
    uint256 public _walletMax = 2300000000 * 10**9;
