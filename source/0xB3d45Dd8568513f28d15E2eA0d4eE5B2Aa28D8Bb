...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 public minimumTokensBeforeSwap = 1000000000000 ether;
    ...
    uint256 public presaleStartedTime;
    uint256 public taxDropPeriod = 5 minutes;
