...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 NEKOS = IERC20(0x43ce64A4FBa3c30C0164E935B0095862a67dc0c9);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = NEKOS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(NEKOS);
        ...
        uint256 amount = NEKOS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            NEKOS.transfer(shareholder, amount);
...
contract BabyNekos is IERC20, Ownable {
    using SafeMath for uint256;

    
    address NEKOS = 0x43ce64A4FBa3c30C0164E935B0095862a67dc0c9;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Nekocoin";
    string constant _symbol = "BABYNEKOS";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x1cc717b4b383147004C3dd2a6D1b8bA877b126A3);
        marketingFeeReceiver = address(0x1cc717b4b383147004C3dd2a6D1b8bA877b126A3);
