...
contract BIGDOG is Context, IERC20, Ownable {
    ...
    string private _name = "BIG DOG";
    string private _symbol = "BIG DOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7FF09C1E84B119de4ce264e9AA1eb277dEB627c1);
    address payable public teamWalletAddress = payable(0x642b4CB02Ccc2C92379025A51DA7a5aFFBe304B0);
