/**
   Welcome to Doge Coin Pay. The first project 
   in the world with Doge coin network and BSC 
   network. DCP payment system ready.
  TELEGRAM: https://t.me/DogeCoinPay_BSC
*/
...
contract DogeCoinPay is Context, IBEP2022, Ownable {
