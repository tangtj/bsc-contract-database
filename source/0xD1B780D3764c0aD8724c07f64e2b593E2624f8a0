...
contract TOKENS is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x443357fCFFFC2Fc48aBb37F7d92787875Fe1a0b5);
    address payable private teamWalletAddress = payable(0x443357fCFFFC2Fc48aBb37F7d92787875Fe1a0b5);
