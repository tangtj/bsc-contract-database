...
https://t.me/redchartofficial

Total Tax 8% - 2% reflections - 3% marketing - 3% auto LP
*/
...
contract RedChart is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Red Chart";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // of BNB and RedChart into the LP
