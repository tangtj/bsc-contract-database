...
//--- Contract v2 ---//
contract SCAI is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x8F7478042d15059Aa15E325F85E2992AAeCcB5ef);


    IRouter02 public swapRouter;
    string constant private _name = "SecureChain AI";
    string constant private _symbol = "SCAI";
