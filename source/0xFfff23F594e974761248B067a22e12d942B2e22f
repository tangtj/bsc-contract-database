...
contract BABYELON is ERC20 {
    ...
    address _marketAddress = address(0x09C1D1BCAB08E0717dA22D06e67dB38BbB1d4238);
    address payable _bnbFundAddress = payable(address(0x09C1D1BCAB08E0717dA22D06e67dB38BbB1d4238));
	address payable _tokenFundAddress = payable(address(0x09C1D1BCAB08E0717dA22D06e67dB38BbB1d4238));
    ...
    constructor(address tokenOwner) ERC20("BABYELON", "BABYELON") {
		require(_baseToken<address(this),"BABYELON token small");
    ...
    address public _fundBABYPEPE = address(0x09C1D1BCAB08E0717dA22D06e67dB38BbB1d4238);
