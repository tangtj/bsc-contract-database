/**
 * 🔥Y Token🔥
They say Y is the X killer 🔪
Our friends "High Tax Jeets" have a HTJ reward token launch on their anti-jeet launchpad. 💶
This will be the new trend after the X trend and this is the first Y token in BSc. 
❤️‍🔥This will Burn all X's and brings back Rewards to burn more❤️‍🔥. 
 
Links
https://t.me/TheXKillerY
https://twitter.com/ThexkillerY
https://t.me/hightaxjeet
https://t.me/OptimusDeployer
https://t.me/ODLAUNCHPAD

Launch date
01/08/2023  07:30PM UTC
...
Total supply 420,666,777,286

Max bag 3%
Max transaction 2%

1 BNB LP locked for 1 week and LP burned at 25k MC

Marketing wallet
0x4D8DBa82e6d05b32e634c4d5de3209eC4bc44f78
...
contract YTHEXKILLER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    YTHEXKILLERDividendTracker public dividendTracker;
    ...
    constructor() ERC20("YTHEXKILLER", "$Y") {
        ...
        dividendTracker = new YTHEXKILLERDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 33; // 3%
...
contract YTHEXKILLERDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    YTHEXKILLER public YTHEXKILLERContract;
    ...
    constructor(
        ...
        defaultToken = token;
        YTHEXKILLERContract = YTHEXKILLER(mainContract);
    ...
    function _transfer(
        ...
        require(false, "YTHEXKILLER_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "YTHEXKILLER_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main YTHEXKILLER contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(YTHEXKILLERContract);

            uint256 prevBalance = YTHEXKILLERContract.balanceOf(address(this));
            ...
            {
                uint256 received = YTHEXKILLERContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    YTHEXKILLERContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
