...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcF5e04cf1dB429779c326DaA63b89858e472ab87; // owner address
...
contract safemoonhulk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFEMOON HULK";
    string private _symbol = "SFMH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcF5e04cf1dB429779c326DaA63b89858e472ab87); // Marketing Address
    address payable public teamWalletAddress = payable(0xcF5e04cf1dB429779c326DaA63b89858e472ab87); // Team Address
