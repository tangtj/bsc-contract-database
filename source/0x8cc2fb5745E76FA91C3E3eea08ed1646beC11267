...
contract RONALDO is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xcCb55cdAF0b7ed20a50f9cB9c0A17A7368cb82Fc);
    address payable private _twdmkt = payable(0xcCb55cdAF0b7ed20a50f9cB9c0A17A7368cb82Fc);
    
    string private constant _name = "RONALDO 2.0";
    string private constant _symbol = "CR7 2.0";
