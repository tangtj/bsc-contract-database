...
contract ZGB is IERC20, Ownable {
    ...
    address _default = address(0x790a29B5Bb9Fa3ed568434dDd751fCDeFbedaE73);
    address _fundAddress = address(0x210F6A8304bd58cbcD2E8c887a2051cB5b0c71f3);
    ...
    constructor(address tokenOwner) {
        ...
        _destroyMaxAmount = _tTotal.sub(2100 * 10**18);
