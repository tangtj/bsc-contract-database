...
contract CDISEMM is Context, IERC20, Ownable {
    ...
    string private _name = "CateDogeInuSafeElonMoonMars";
    string private _symbol = "CDISEMM";
    ...
    uint256 public minimumTokensBeforeSwap = 1000000000000 * 10**9;
    uint256 public _maxBuyTxAmount = 2500000000000 * 10**9;
    uint256 public _maxSellTxAmount = 2500000000000 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        {
            setAllFees(_saleTaxFee, _saleLiquidityFee);
        }
    ...
    function setAllFees(uint256 taxFee, uint256 liquidityFee) private {
        _taxFee = taxFee;
        _liquidityFee = liquidityFee;
    }
    
    function setFees(uint256 taxFee, uint256 liquidityFee) 
    external onlyOwner() {
        setAllFees(taxFee, liquidityFee);
        _previousTaxFee = taxFee;
        _previousLiquidityFee = liquidityFee;
    }
    
    function setSaleFees(uint256 taxFee, uint256 liquidityFee) 
    external onlyOwner() {
        _saleTaxFee = taxFee;
