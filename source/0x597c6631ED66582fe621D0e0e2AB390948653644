 ...
 *  | |   | | | | '_ \ / _` | |/ _ \| |/ / _ \ '_ \ 
 *  | |___| |_| | | | | (_| | | (_) |   <  __/ | | |
 *  |______\__,_|_| |_|\__,_|_|\___/|_|\_\___|_| |_|
 *                                                  
 * 
 * LunaPrime is a beautiful charity project, this consists of:
 * 
 * - LunaPrime Foundation -
 * LunaPrime Foundation's objective is to help people in need around the world. 
 * As of releasing this token we are helping Venezuela, by creating activities to support them. 
 * Little by little we will expand to other countries and reach our mission goal. 
 * 
 * - LunaPrime Academy -
 * LunaPrime Academy's objective is to TEACH, this is a 
 * complement of first, We will help people to start in 
 * the criptoworld,  give them the knowledge and tools, 
 * starting at basic content to advanced providing everything
 * our community needs.
 * 
 * - LunaPrime Market -
 * This is another complement of all this Lunaprime World, 
 * you can enjoy original LunaPrime items/merch and the best 
 * part is you will be contributing to the LunaPrime foundation.
 * 
 * We have a powerful team and powerful support, 
 * the LunaPrime world is extended and All this is tied to 
 * 
 * - LUNAPRIME TOKEN -
 * Luna Prime works around its own token that will be a 
 * utility token for everything at this organization. 
 * For every buy and sell you will contribute directly to 
 * the charity wallet to help us do our mission and bring 
 * smiles around the world.
 * 
 * Remember it, LunaPrime: the beautiful fusion between blockchain and the gratification of charity. 
 * 
 * LUNA TO THE MOON.                                                 
 * 
 * Total Supply 350,000,000
 * 
 * Luna Charity Token fees:
 * Buy:
 *   5%  liquidity pool 
 *   3%  Donation Wallet
 *   1%  Autoburn
...
contract LunaPrimeFoundation is Context, IBEP20, Ownable {
    ...
    string private _name = "Luna Prime Foundation - lunaprime.com";
    ...
    address donationAddress=0xC5746B355132AACC74aEbE23953B56B02117E31f;
    address marketingAddress=0xDb6ab0673AF62a28505AdA53C64568E095c7e70F;
