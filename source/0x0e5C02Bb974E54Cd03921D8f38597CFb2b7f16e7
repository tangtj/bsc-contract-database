        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7a72Db4F94c1E76f47809d9bD5d1BaB0675Ed531), block.timestamp
                );
            }
        }
    }
...
contract X is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        41300000,//Supply
        address(0xEDd91d63a21EAb0d262e7759d0968F38ec595a82),//FundAddress
        address(0x3456344bA6071c47f6D4d3842D8B87e6F7dBe1B3)//ReceiveAddress
    ){
    }
}