...
contract WOJAKPEPE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "WOJAKPEPE";
    ...
    address payable public DevWallet = payable(0xD0dC53c9B3c7A588f516Aca460469d7Cf1b4bd23);
    address payable public MarketingWallet = payable(0x3C747Ace30332ACA235D560C6768BdC0A4a06550);
