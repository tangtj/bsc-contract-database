...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77ab84DfbEc370Ab054D48eB5f41c742181eE98F; // owner address
...
contract Notfine is Context, IERC20, Ownable {
    ...
    string private _name = "THIS IS NOT FINE";
    string private _symbol = "NOTFINE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x800a66E7025E6A14FEde27f05A478FD96fcFb0bE); // Marketing Address
    address payable private teamWalletAddress = payable(0x800a66E7025E6A14FEde27f05A478FD96fcFb0bE); // Team Address
