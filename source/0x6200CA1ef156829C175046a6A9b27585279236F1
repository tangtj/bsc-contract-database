...
// Telegram: https://t.me/cyronetwork
...
contract CyronNetwork is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xED0c35Eb502660BD1d580C9d7eddB13B656A086E);
    address payable private _twdmkt = payable(0xED0c35Eb502660BD1d580C9d7eddB13B656A086E);
    
    string private constant _name = "CyronNetwork";
    string private constant _symbol = "$CYRON";
