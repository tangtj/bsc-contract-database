...
//                   https://t.me/Thing_X_Portal
//                   https://www.netflix.shop/collections/wednesday 
//                   P.S. Buy merch
...
contract ThingX is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTxAmount = 600000 * 10**_decimals; 
        ...
        marketingAddress = payable(0xB7e226427db4107e0A1417B62baE50347fD4c08b);
        treasuryAddress = payable(0xB7e226427db4107e0A1417B62baE50347fD4c08b);

        _buyLiquidityFee = 0; //Max tax 5%
        _buyMarketingFee = 1; //Max tax 5%
        _buyTreasuryFee = 0; //Max tax 5%
    
        _sellLiquidityFee = 0; //Max tax 5%
        _sellMarketingFee = 1; //Max tax 5%
