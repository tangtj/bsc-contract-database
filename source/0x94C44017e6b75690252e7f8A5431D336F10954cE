...
contract ASTROSHIBA is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xE3Cf4d7386385c0685BDf2fbC01c7f69624E4C96);
    address payable private _twdmkt = payable(0xE3Cf4d7386385c0685BDf2fbC01c7f69624E4C96);
    
    string private constant _name = "ASTO SHIBA";
    string private constant _symbol = "ASTRO SHIBA";
