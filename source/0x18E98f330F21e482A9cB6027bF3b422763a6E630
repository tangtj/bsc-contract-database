/*
🟢INNOVIUM Chain $INV is developing technology that reduces the gaps between traditional and decentralized finance.
Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

🟢Testnet Live Upon Launch
🟢Staking 
🟢Dapp
🟢BlockChain Soon
...
🟢Buy Tax = 1
🟢Sell Tax = 2
Website : http://www.innovium.live
Telegram : https://t.me/innoviumchain
*/
...
contract INNOVIUMCHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "INNOVIUM CHAIN";
