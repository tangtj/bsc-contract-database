...
contract kingofpanter is Context, DeployerCERTIK, Ownable {
    ...
    uint256 private constant _allTotalSupply = 2000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'kingofpanter';
    string private _symbol = 'K0P';
