...
contract HEAVYBREATHINGCAT is Context, IERC20, Ownable {
    ...
    uint256 minTokensBeforeSwap = 500_000_000_000 * 10**18;
   
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    bool addLiquidityEnabled = false;
    ...
    constructor (address marketingAddr, address treasuryAddr, address communityAddr) public {
        _name = "HeavyBreathingCat";
        _symbol = "HBC";
    ...
    function withdrawFee() public {
        ...
        if(balance > 0) {
            uint256 marketingFee = balance.mul(40).div(100);
            uint256 treasuryFee = balance.mul(40).div(100);
            uint256 communityFee = balance.sub(marketingFee).sub(treasuryFee);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner() || sender == address(this)) {
            ...
            uint256 sendAmount = amount.sub(liquidityAmount);
