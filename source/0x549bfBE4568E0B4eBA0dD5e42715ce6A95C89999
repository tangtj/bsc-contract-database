...
contract TL is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0xDb0Ea0df481c542942Ed1488120977E0500CAF36); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xDb0Ea0df481c542942Ed1488120977E0500CAF36)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0xDb0Ea0df481c542942Ed1488120977E0500CAF36);
        feeEarn = 0;
        isLiquified = true;
    }
}