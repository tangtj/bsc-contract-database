...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28EB54249069Fd1a25549f1fB4CE9544621919e5; // owner address
...
contract ProofOfFine is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Proof Of Fine";
    string private _symbol = "$POF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28EB54249069Fd1a25549f1fB4CE9544621919e5);
    address payable public teamWalletAddress = payable(0x28EB54249069Fd1a25549f1fB4CE9544621919e5);
