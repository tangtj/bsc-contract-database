...
contract Coin is Operator {
    ...
    string private _name = "Virtually Human Studio";
    string private _symbol = "VHS";
    uint8 private _decimals = 18;
    
    uint256 public constant maxSupply = 10000000000000000000000000000;
    ...
    constructor () public {
        ...
        setWhiteList(address(0x801f2Bb44662092cF1Ed2C30C6Af0B44ad025962),true);
    }
