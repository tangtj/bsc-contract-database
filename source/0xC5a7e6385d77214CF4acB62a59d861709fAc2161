...
contract Artivas is ERC20Detailed, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 2100000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("Artivas", "ARTS", DECIMALS) {
        _mint(0xE476230a45311cBe716072fbc3b93FeEa308a934, 735000 ether);
        _mint(0x452F38B2b2ffE0BA88979561a2c80CcA8EC326c2, 1050000 ether);
        _mint(0x6C1F297A4547774603045f9eCFE5d5C278651F8F, 315000 ether);
    }
