...
###    ###                  ###     ########## ########  ########## ###     ###                                                             
*/
// TELEGRAM BRAZIL: https://t.me/XteslaBrasil
// TELEGRAM GLOBAL: https://t.me/XTeslaFaToken
// WEBSITE: https://www.teslacoinbsc.xyz/
// TWITTER: https://twitter.com/TeslaFanT

// Buy and sell tax: 10
// liquidity locked 6 months

// CHECK LINKTREE: https://linktr.ee/teslacoin

// LAUNCH TODAY 10AT | 22:00UTC 
// DEV BASSED
...
contract XTESLATOKEN is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 30000 * 10**_decimals;
    uint256 public maxTxAmount = _tTotal * 10**_decimals;
    uint256 public maxWalletAmount = 30000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet =  0xB97eBe185ae0Ea5597ed63E63fc6E74580251563;

    string private constant _name = "XTESLA TOKEN";
    string private constant _symbol = "XTESLA";
    ...
    // Owner cannot transfer out  BLEPE from this smart contract
