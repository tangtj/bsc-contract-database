...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE651502FBaB5EF2d9e8c2E2442566e60Cc97220b; // owner address
...
contract FLOKI is Context, IERC20, Ownable {
    ...
    string private _name = unicode"弗洛基";
    string private _symbol = unicode"FLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE651502FBaB5EF2d9e8c2E2442566e60Cc97220b); 
    address payable public teamWalletAddress = payable(0xE651502FBaB5EF2d9e8c2E2442566e60Cc97220b);
