...
contract BattleSealSOON is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
  
    address payable public marketingAddress = payable(0xd4a912b1c681164A856dF00b41C7a8e751C06237); // Marketing Address $$$ changed this to alternative wallet
    ...
    string private _name = "BattleSEALSoon";
    string private _symbol = "WenSEAL";
