...
contract STICK is Context, IERC20, Ownable {
    ...
    string private constant _name = "STICK";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xcD20901A50D3cCd3829d937358CD837d1693cE5c);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xbDc7da051EB45F239C3119a0AF44fEB6fD19Ab81] = true;
