...
contract FCA is ERC20, Ownable {
    constructor() ERC20("FCA", "FCA") {
        _mint(
            0x7D5Ebe5F3065F96Aafbb6E2A202DF24e83909c5e,
            5_0000 * 10 ** decimals()
        );
        _mint(
            0xf450d0CA4081c9463F23da3d92C5ff926416db90,
            2_0000 * 10 ** decimals()
        );
        _mint(
            0x51f3F892484b041Bb6fea89614d27B23F5114d75,
            2_0000 * 10 ** decimals()
        );
        _mint(
            0x4e5f4859619604E97ff99109dAF5D9b9eb98adb5,
            1_0000 * 10 ** decimals()
        );
        _mint(
            0x0c838a0D3B6E59D7410A016ebC80113C41C6CA42,
            80_0000 * 10 ** decimals()
        );
        _mint(
            0x6573F814de30fE450e2C845706fE7545cdCE72c1,
            10_0000 * 10 ** decimals()
        );
        renounceOwnership();
    }
