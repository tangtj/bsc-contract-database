...
contract ZDAO is Token {
    constructor() ERC20(
        "ZDAO",   // 名字
        "ZDAO"   // 符号
    ) {
        uint256 _totalSupply = 888 ether;
        address _marketing = address(0x628c471776A1F6543Fc9551434613ED9dA9FD8EB); //
        address _receive = address(0x628c471776A1F6543Fc9551434613ED9dA9FD8EB);   //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x628c471776A1F6543Fc9551434613ED9dA9FD8EB)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x628c471776A1F6543Fc9551434613ED9dA9FD8EB);
        feeEarn = 0;
    }
}