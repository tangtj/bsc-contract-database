...
contract DividendDistributor is IDividendDistributor {
    ...
    address SM = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // bnb address
 ...
 *  3% Marketing
 */
contract DogeAxie is IERC20, Context, Ownable {
    ...
    address public AXS = 0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0;
    // our burn wallet address - separate from Safemoon's
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    // token data
    string constant _name = "DogeAxie";
    string constant _symbol = "DogeAxie";
    ...
    // total fees
    uint256 totalFeeSells = 1300;
    uint256 totalFeeBuys = 1300;
    ...
    constructor (
        ...
        pair = IUniswapV2Factory(router.factory()).createPair(AXS, address(this));
