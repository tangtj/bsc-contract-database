...
Dogo Coin aims to offer a blockchain-based farm, betting, mining and gaming platform on the BEP20 network, which is completely decentralized and operates on smart contracts.
...
contract Dogo is ERC20, Ownable {
    ...
    address public marketingWallet = 0xbC9aA00ed68dCea6566e4Ea875F50e395220a607;
    ...
    constructor () ERC20("Dogo Coin", "Dogo") 
    {   
