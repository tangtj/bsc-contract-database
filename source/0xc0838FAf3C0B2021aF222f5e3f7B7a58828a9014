/**
 ...
 DOGE's biggest problem is that it is an INFLATION token.
 Doge's community is exceptionally strong, but the foundation it builds on is weak.
 TMDoge (Tibetan Mastiff Doge) is a DEFLATIONARY token.

Tele Channel : https://t.me/TibetanMastiffDoge_V2channel
Tele chat : https://t.me/TibetanMastiffDoge_V2
TW : https://twitter.com/doge_ve?s=09
Web : https://tmdogev2.com
...
contract Tibetan_Mastiff_Doge_V2 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Tibetan Mastiff Doge V2";
    string private _symbol = "TMDoge_V2";
