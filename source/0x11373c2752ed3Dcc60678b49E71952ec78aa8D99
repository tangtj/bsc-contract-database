...
// Telegram: https://t.me/Hexarium_BSC
...
contract Hexarium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xa2d90707312F19e27a45E9CcC4A0d5743207A7cF);
    address payable private _twdmkt = payable(0xa2d90707312F19e27a45E9CcC4A0d5743207A7cF);
    
    string private constant _name = "Hexarium";
    string private constant _symbol = "$HEUM";
