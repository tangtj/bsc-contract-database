...
contract BIXBY is IBEP20, Auth {
    ...
    address DEV =  0xFeE6827Bcd4857F8fbccE63d6D78BcBa5e9dC1A3;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "BixBy";
    string constant _symbol = "Bix";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xFeE6827Bcd4857F8fbccE63d6D78BcBa5e9dC1A3;
