...
contract CUTUSNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, WhiteList {
    ...
    string public uri = "https://bafybeicdezscx5nio52lzy76islts6yyhy4anygqukuvlimpr4hayueihy.ipfs.nftstorage.link/metadata/";
    constructor() ERC721("MetaElfLandV2 Profit NFT", "MPN") {
    ...
    function safeMint(address to) public isWhiteListed returns(uint256){
        ...
        require(tokenId <= 200,"NFT has been cast!");
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
