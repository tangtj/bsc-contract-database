...
abstract contract Ownable is Context {
    ...
    constructor() {
        _setOwner(0x3C88BeF2Ba7362710F3682681C0B3c95Fe54d4Af);
    }
...
contract MrBeanToken is ERC20, Ownable {
    ...
    address public marketingWalletAddress =
        0xa8cB5E8B3633D588AD2A63C9193eDD64Dc075959;
    ...
    constructor() payable ERC20("MrBean Token", "MRBEANT", 18) {
        uint256 totalSupply_ = 1e12 * 10 ** 18;
