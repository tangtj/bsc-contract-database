...
*/
/**
// Telegram : https://t.me/Xbattlebsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Ac0a23547A7FB479bd0AC765De566856E2bd977 ; // owner address
...
contract XBattle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "X Battle";
    string private _symbol = "X Battle";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb7FC05A9110D08f7813FCc539975068113110839); // Marketing Address
    address payable private teamWalletAddress = payable(0xeE04d2C53D1993efDf4c2ddc889CDE8A23327Aff); // Team Address
