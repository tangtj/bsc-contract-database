/**
  ...
  Telegram : https://t.me/PumpItUpTokens

  Twitter :  https://twitter.com/ClownDeveloper
...
contract PumpItUpTokens is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PumpItUpTokensDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Pump It Up Tokens", "Pump It 1.0") {
        marketingWallet = payable(0x2663d76d275b93CB9b70F06ED8d723a7Bb6944F4);
        CommunityWallet = payable(0xECA21b5D1aaaef11EAA43D6Cc311961988bD3334);
        ...
        dividendTracker = new PumpItUpTokensDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "PumpItUpTokensTRACKER",
            "PumpItUpTokensTRACKER"
        );
    ...
    function updateFees(
        ...
        require(totalSellFees <= 31 && totalBuyFees <= 16, "total");
...
contract PumpItUpTokensDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PumpItUpTokens public PumpItUpTokensContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PumpItUpTokensContract = PumpItUpTokens(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PumpItUpTokens_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PumpItUpTokens_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PumpItUpTokens contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PumpItUpTokensContract);

            uint256 prevBalance = PumpItUpTokensContract.balanceOf(address(this));
            ...
            {
                uint256 received = PumpItUpTokensContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PumpItUpTokensContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
