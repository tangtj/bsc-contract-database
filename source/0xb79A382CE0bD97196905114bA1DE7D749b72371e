...
contract GMETOKEN is IERC20, Ownable {
    ...
    string public _name = "GMEDAO";
    string public _symbol = "GME";
    ...
    uint256 public _sellSkillFee = 0;
    uint256 public _sellLiquidityFee;
    uint256 private _tTotal = 21000000 * (10 ** 18);
    uint256 public burnEndAmount = 21000000 * (10 ** 18);
    uint256 public burnTotal;
    address public _uniswapV2Pair;
    address public _lpAddr = 0x8f97E4ef959D90cC0233Cb44734e2EEaf8ACCF6f; // 9%
    address public _marketAddr = 0x26909942b5232AD9DBE751122a243a79838d2b78; // 1%
    address public _fundAddr = 0x2bE18A7b9982120758F53c398372802631cB24A6; // 4%
    ...
    constructor() {
        address admin = 0x26909942b5232AD9DBE751122a243a79838d2b78;
