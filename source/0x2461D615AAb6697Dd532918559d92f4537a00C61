...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82Ff930ce560d45508c640B7777c500dc13Fd7f7; // owner address
...
contract QatarProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qatar Protocol";
    string private _symbol = "QP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x82Ff930ce560d45508c640B7777c500dc13Fd7f7); // Marketing Address
    address payable public teamWalletAddress = payable(0x82Ff930ce560d45508c640B7777c500dc13Fd7f7); // Team Address
