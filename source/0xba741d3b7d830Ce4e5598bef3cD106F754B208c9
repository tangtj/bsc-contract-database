...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5Dbe68d635165f35b6CEf15b9e95B16D126748E7; // owner address
...
contract CCDDSCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDDS";
    string private _symbol = "CCDDS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5Dbe68d635165f35b6CEf15b9e95B16D126748E7); // Marketing Address
    address payable private teamWalletAddress = payable(0x5Dbe68d635165f35b6CEf15b9e95B16D126748E7); // Team Address
