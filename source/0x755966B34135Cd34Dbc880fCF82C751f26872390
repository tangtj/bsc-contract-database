...
contract zsbToken is ERC20("Stabilize Strategy BSC Multi-BTC Token", "zsb-BTC"), Ownable, ReentrancyGuard {
    ...
    // Token information
    // This wrapped token accepts multiple btc coins
    // BTCB, renBTC, dBTC
    struct TokenInfo {
    ...
    function setupWithdrawTokens() internal {
        // Start with BTCB
        IERC20 _token = IERC20(address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c));
        tokenList.push(
            TokenInfo({
                token: _token,
        ...
        // renBTC
        _token = IERC20(address(0xfCe146bF3146100cfe5dB4129cf6C82b0eF4Ad8c));
        tokenList.push(
            TokenInfo({
                token: _token,
                decimals: _token.decimals()
        ...
        // dBTC
        _token = IERC20(address(0x6b77F51d4C474EFB15b72B829e6a0806bbc33724));
        tokenList.push(
            TokenInfo({
                token: _token,
                decimals: _token.decimals()
