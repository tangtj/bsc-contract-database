...
contract Panda is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x23043aB579c2520a64151C6852cB9349dA469914); // Marketing Address
    address payable public teamWalletAddress = payable(0x23043aB579c2520a64151C6852cB9349dA469914); // Team Address
    ...
    uint256 private _totalSupply = 100000000000 * 10**6* 1**1 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000000 * 10**6* 1**1 * 10**_decimals; 
    uint256 public _walletMax = 1000000000 * 10**6* 1**1 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100000000000 * 1**1* 10**_decimals; 
