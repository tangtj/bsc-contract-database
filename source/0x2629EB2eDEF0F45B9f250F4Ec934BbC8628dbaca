...
// File: contracts/ShibElonVerse.sol
...
contract ShibaElonVerse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = address(0x49555b5eb3B1D63f7557517d44898d489af0708d);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "SHIBEV: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "SHIBEV: The new dividend tracker must be owned by the TOKEN token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "SHIBEV: The router already has that address"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "SHIBEV: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "SHIBEV: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "SHIBEV: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SHIBEV: Cannot update gasForProcessing to same value"
        );
...
// Function to claim other tokens and BNB from contract
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 newBalance = (IERC20(ADA).balanceOf(address(this))).sub(
            initialADABalance
        );
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("SHIBEV_Dividend_Tracker", "SHIBEV_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "SHIBEV_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SHIBEV_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TOKEN contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "SHIBEV_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "SHIBEV_Dividend_Tracker: Cannot update claimWait to same value"
        );
