/**
Shibarmy, after $SHIB's letdowns, $CAL emerges: our chance for a true community-driven token. Let's unite, reclaim, and revolutionize. — The revol
https://calciumfinance.com
https://t.me/calciumarmy
- Calcium $CAL Coin Team
*/
...
contract CAL is ERC20, Ownable {
    ...
    constructor () ERC20("Calcium Coin", "CAL") 
    {   
