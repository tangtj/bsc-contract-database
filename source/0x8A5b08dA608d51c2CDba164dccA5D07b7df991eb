...
contract XGCTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "XPLORE";
    string private _seitokensymbol = "XGC";
    address public daafh71;
