/**
   Welcome to On-Chain Dynamics. The most 
   advanced, acessible and affordable all-in-one  
   trading platform on the market.
  TELEGRAM: https://t.me/OnChainDynamics_BSC
*/
...
contract OCD is Context, IBEP2022, Ownable {
