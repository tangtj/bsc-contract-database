...
/**
 *Submitted for verification at polygonscan.com on 2023-08-28
*/
...
contract ICC is Ownable {
    using SafeMath for uint256;

    string public name = "CRICKET WORLD CUP";
    uint256 public decimals = 18;
    string public symbol = "CRIC";
    uint256 public totalSupply;
    uint256 public maxSupply = 99e25;
    ...
    function redeem(uint256 value, address redeemToEthAccount) external {
        require(balances[msg.sender] >= value, "CRICK: NOT_ENOUGH");
    ...
    function mint(address user, uint256 value) external onlyOwner {
        require(maxSupply >= totalSupply.add(value), "CRICK: MINT_OVERLOAD");
