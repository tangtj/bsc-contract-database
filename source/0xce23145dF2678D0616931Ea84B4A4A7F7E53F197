...
contract Ekek is IERC20, Ownable {
    ...
    uint256 public minAmounttoSwap = ( INITIAL_FRAGMENTS_SUPPLY * 10 ) / 10000000000000;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal liquidityReceiver = 0x18912eDB58dB0DF62C4b1b0727E7d556d45E8c84;
    address internal marketingReceiver = 0x18912eDB58dB0DF62C4b1b0727E7d556d45E8c84;
    address internal utilityReceiver = 0x18912eDB58dB0DF62C4b1b0727E7d556d45E8c84;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _utility, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        liquidityFee = _liquidity; marketingFee = _marketing; utilityFee = _utility; totalFee = _total; sellFee = _sell; transferFee = _trans;
    ...
    function setReceivers(address _liquidityReceiver, address _marketingReceiver, address _utilityReceiver) external onlyOwner {
