/**
// Telegram : https://t.me/Ufo2049_official
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3958f24E52709F48f8140285B2Ed27f65e896726 ; // owner address
...
contract UFO2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "UFO2049";
    string private _symbol = "UFO2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x04eEb843Bd23C8DB3A49DA75e15af43c68916EE9); // Marketing Address
    address payable private teamWalletAddress = payable(0x3958f24E52709F48f8140285B2Ed27f65e896726); // Team Address
