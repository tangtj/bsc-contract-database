/**
SHIBNOBI is a token that generates passive income on
the Ethereum, Binance Smart Chain, and Polygon
Networks. It’s primary use case is to develop an easy to
use token swap across all 3 chains.

SHIBNOBI Swap will be a cross-chain token swap that will allow you to trade between ETH, BSC, and Polygon.
Now you know why we are launching on all 3 networks!

Who is ready to take this project to the moon and beyond! Now you know why SHIBNOBI is the deadliest Shiba in the Cryptoverse.

Come join our hoard of SHIBNOBI warriors and let your inner Ninja out! 
*/
