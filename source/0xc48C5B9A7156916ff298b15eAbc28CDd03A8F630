...
contract TESTINGDUA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "TESTING DUA";
    string private constant _symbol = unicode"$TDUA";
    ...
    address payable public DevWallet = payable(0x5b723B642bA0d2D7A6b97144B5482053DB10C1E1);
    address payable public MarketingWallet = payable(0x477331Aa8B144F919b04dfE7F311dE9a465046a5);
