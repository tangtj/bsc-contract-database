...
contract JiangNanYi is Context, IERC20, Ownable {
    ...
    string private constant _name = "JiangNanYi";
    string private constant _symbol = "JiangNanYi";
    ...
    uint256 public _maxWalletAmount = 1000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        _isIncludedFromFee[0x16c21c28FED3e3B545493e111dB87842D11281AD] = true;
        _isIncludedFromFee[0xFe899B34D1A3133D0f650A845836910A8Cf61023] = true;
