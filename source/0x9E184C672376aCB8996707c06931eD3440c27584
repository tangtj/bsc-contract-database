...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0A0c972E1457032dbdc15c3d6E96123164d54b2d; // owner address
...
contract ThisIsAGems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "This Is A Gems";
    string private _symbol = "GEMS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0A0c972E1457032dbdc15c3d6E96123164d54b2d); // Marketing Address
    address payable private teamWalletAddress = payable(0x0A0c972E1457032dbdc15c3d6E96123164d54b2d); // Team Address
