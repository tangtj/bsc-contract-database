...
contract AH is ERC20 ,Ownable{
    ...
    TaxRates public defaultTax = TaxRates(200, 100);
    ...
    constructor() ERC20("Arctic Hare", "AH") {
        marketingWallet = 0x7392A8A1A3B6B17CC7368072C8a2b2834E0Ee666;
