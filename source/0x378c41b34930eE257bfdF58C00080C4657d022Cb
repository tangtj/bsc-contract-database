...
/*0x0bFD580a07a6f0F8ef8F9010D827d136c1ec6e43
...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    uint256 public totalAmountUntillLastLottery;
    ...
    struct Lottery {
        ...
        uint32 finalNumber;
        // uint256 amountCollectedInCakeUptoLastLottery;
        ...
        nonReentrant
    {
        ...
        totalAmountUntillLastLottery= amountToShareToWinners;
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                if (_lotteries[_lotteryId].rewardsBreakdown[j] != 0) {
                    ...
                    totalAmountUntillLastLottery=totalAmountUntillLastLottery-_lotteries[_lotteryId].cakePerBracket[j];
                }
    ...
    function getPottedPrice(uint256 _lotteryId) external view returns(uint256){
        return (_lotteries[_lotteryId].amountCollectedInCake);
    }
}