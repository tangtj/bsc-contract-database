...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd9c9114EfaeF7599139717B4d976D88F8FEbff80; // owner address
...
contract CCDDGS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDDGS";
    string private _symbol = "CCDDGS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd9c9114EfaeF7599139717B4d976D88F8FEbff80); // Marketing Address
    address payable private teamWalletAddress = payable(0xd9c9114EfaeF7599139717B4d976D88F8FEbff80); // Team Address
