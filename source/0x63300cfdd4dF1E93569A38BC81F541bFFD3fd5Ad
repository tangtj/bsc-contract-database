...
contract HeIsAi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3c489c061F216bBe33BbCA0d1c8b7F288377b7Af); 
    address payable public Wallet_Dev = payable(0xc6C2aeb112e3EcC11D51E9FBC16B2BB4B9ab2071);
    address payable public W_Deployer = payable(0xc6C2aeb112e3EcC11D51E9FBC16B2BB4B9ab2071);
    ...
    string private constant _symbol = unicode"HEISAI"; 
    ...
    constructor () {
        ...
        _owner = 0xc6C2aeb112e3EcC11D51E9FBC16B2BB4B9ab2071;
