...
contract Hunz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hunz";
    string private _symbol = "HNZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21cb44F18Ff2C2387bB11fF906586b6E8e70615d); // Marketing Address
    address payable public teamWalletAddress = payable(0x21cb44F18Ff2C2387bB11fF906586b6E8e70615d); // Team Address
