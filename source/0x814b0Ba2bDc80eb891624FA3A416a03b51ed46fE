...
contract Token is ERC20, Ownable {
    ...
    //Swapping
    uint256 public swapTokensAtAmount = (_totalSupply * 5) / 1000000; //after 0.001% of total supply, swap them
    ...
    //Wallets
    address public DevelopmentWallet = 0xB5ece513CEe5B4C4E1799f1307aD5d33d8a99C9C;
