...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdf01bC20E03230D9125D29c03219d02baAfBAD95; // owner address
...
contract CDCC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CDCC";
    string private _symbol = "CDCC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xdf01bC20E03230D9125D29c03219d02baAfBAD95); // Marketing Address
    address payable private teamWalletAddress = payable(0xdf01bC20E03230D9125D29c03219d02baAfBAD95); // Team Address
    ...
    uint256 public _walletMax = 1600 * 10**_decimals;
