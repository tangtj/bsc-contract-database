...
contract a2 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0xE36A2ac15f1141489705C564A9F32ad975A7902f),//FundAddress
        address(0xE36A2ac15f1141489705C564A9F32ad975A7902f)//ReceiveAddress
    ){
    }
}