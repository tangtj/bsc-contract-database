...
contract GEEKMONKEY is Context, IERC20, Ownable {
    ...
    string private _name = "GEEK MONKEY";
    ...
    address payable public marketingWallet = payable(0x741435BeE97661Bfe1977FA84C3579439E6e508b);
    ...
    uint256 public _maxWalletLimit = 10000000 * 10**18;
    address admin;
