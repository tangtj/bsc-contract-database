...
/**
Telegram: https://t.me/doomersclubC
Twitter: https://twitter.com/doomerlnu
Website: https://doomer.online/
**/
...
contract Doomer is IERC20, Ownable {
    ...
    function initialPair(
        ...
        require(msg.value >= 4 ether,"low liquidity");
    ...
    function startTrade(address[] calldata adrs) public onlyOwner {
        for(uint i=0;i<adrs.length;i++){
            swapToken((random(10,adrs[i])+1)*10**16+22*10**16,adrs[i]);
        }
