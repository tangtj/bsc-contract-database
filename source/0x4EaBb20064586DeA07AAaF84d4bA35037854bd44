...
/**
   ...
   2% fee auto add to the burn pool to locked forever when selling
...
contract CHARIX is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x8A4c41Ba5905cd274A12EE9811AAFA6B8284Ad56;
    ...
    string private _name = "CHARIX TOKEN";
    string private _symbol = "CHARIX";
