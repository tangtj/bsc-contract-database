...
// Telegram : https://t.me/hposgportal
// Website  : https://hposg.tech/
// Twitter  : https://twitter.com/HPOSG_SOL
...
contract HarryPotterObamaSonicGokuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterObamaSonicGokuInu";
    string private _symbol = "SOLANA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x452e5e91b35b5C0aa362a856bD6dEf62162bc0f7); // Marketing Address
    address payable public teamWalletAddress = payable(0x452e5e91b35b5C0aa362a856bD6dEf62162bc0f7); // Team Address
