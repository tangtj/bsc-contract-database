...
contract NOBODY is ERC20, Ownable {
    ...
    constructor() ERC20("NOBODY", "NOBODY") {
        ...
        marketingWallet = address(0x45f1F8Aa35F603A9abd283b36c7f1d3F9900440d); // set as marketing wallet
        devWallet = address(0x45f1F8Aa35F603A9abd283b36c7f1d3F9900440d); // set as dev wallet
