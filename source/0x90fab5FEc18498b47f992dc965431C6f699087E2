...
// Oh my god we're all gonna make it i cant believe it OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO

contract WAGMIT {
   
    string public constant name = "WeAreAllGonnaMakeit Token";

    
    string public constant symbol = "WAGMIT";
    ...
    constructor() public {
        ...
        treasury = address(0xBc4701d28bbEf8fd43C8C7Ff946C8652b4cF618b);  

        
        totalSupply = 55420 * 10**uint(decimals);
