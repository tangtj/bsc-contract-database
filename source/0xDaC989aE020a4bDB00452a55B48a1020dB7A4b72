...
contract MDNToken is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        iEDBF[address(0xfc49E4D016f7481897C5D4d2BeC5B5de748C7064)] = true;
        ...
        iEDFF[address(0xfc49E4D016f7481897C5D4d2BeC5B5de748C7064)] = true;
...
contract MDN is MDNToken {
    constructor() MDNToken(
        ...
        address(0xDeaE7f87c03079D3137b5D4c50830592Bd1e472C), // _holder
