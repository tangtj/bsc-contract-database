...
contract PsyX is IERC20, Ownable {
    ...
    constructor () {
        ...
        devFeeReceiver = 0x02A693eBB312Bd78e2d191DeF6AF9e6e34aB02bF;
        marketingFeeReceiver = 0x02A693eBB312Bd78e2d191DeF6AF9e6e34aB02bF;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeSell <=80,"Cannot set sell fees above 25%"); // set max fees you can set to here
