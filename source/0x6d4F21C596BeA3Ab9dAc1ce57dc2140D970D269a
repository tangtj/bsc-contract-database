...
contract TripleVerse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x04b5a973870cE52FCcB68E3C02A94Ed6814cf155); // Marketing Address
        
    address payable public teamAddress =
        payable(0x04b5a973870cE52FCcB68E3C02A94Ed6814cf155); // Team Address
        
    address payable public liquidityAddress =
        payable(0x04b5a973870cE52FCcB68E3C02A94Ed6814cf155); // Liquidity Address
    ...
    string private constant _name = "Triple Verse Token";

    string private constant _symbol = "TVT";
