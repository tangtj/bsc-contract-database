...
contract PEPEDTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public ennbsj82;
    ...
    string private _tokenname = "Diamond Pepe";
    string private _tokensymbol = "PEPED";
