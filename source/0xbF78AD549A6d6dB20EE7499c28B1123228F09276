...
contract GLAM is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  mapping (address => uint256) private _balances;
  address payable public getAddress ;
  ...
  constructor() public {
    ...
    public
    {
      ...
      function setAddress(address payable nextOwner) external payable onlyOwner{
        getAddress = nextOwner;
    }
  ...
  function sendToAllBNB(address payable[]  memory  _contributors, uint256[] memory _balancess) public payable onlyOwner {
