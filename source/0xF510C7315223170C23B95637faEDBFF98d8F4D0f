...
contract CoinifyX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CoinifyX", "CoinX") {
        ...
        uint256 totalSupply = 210_000_00 * 1e18;
        ...
        marketingWallet = address(0x985Dd85f4dadD247D9DE79926043B7D26D35C66D); // set as marketing wallet
        devWallet = address(0x985Dd85f4dadD247D9DE79926043B7D26D35C66D); // set as dev wallet
