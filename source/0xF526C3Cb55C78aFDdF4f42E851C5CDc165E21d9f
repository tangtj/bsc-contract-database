// t.me/SpritzMoonCryptoToken 
// SpritzMoonCryptoToken.com
...
contract SpritzMoonCryptoToken is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "SpritzMoonCryptoToken";
    string public symbol = "SPRITZMOON";
