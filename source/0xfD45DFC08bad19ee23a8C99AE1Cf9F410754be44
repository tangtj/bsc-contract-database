...
contract MBP_LIQUIYIELD_T2_IDO is Context, Ownable {
    ...
    uint256 private MINIMUM_INVESTMENT = 27 * (10**18);
    uint256 private MAXIMUM_BUY_AMOUNT = 54 * (10**18);
    ...
    uint256 private HARDCAP = 4_860 * (10**18);
