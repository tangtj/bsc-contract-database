...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x12Bdd2b6677265Adc6426539b2976BBebbDe3380;
    ...
    {
        require(tax <=25,"Cannot set the fee more than 25%");
        marketingTax = tax;
    }
...
contract PepeReborn is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Pepe Reborn", "PEPERE", 9) {
    _owner = msg.sender;
