...
Pepe Froggy - Auto Burn Token
https://t.me/PepeFroggy_BSC
...
*/
    ...
    contract PepeFroggy is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Froggy";
        string private constant _symbol = "PepeFroggy";
        ...
        address public constant MarketingWallet=0x30801055EAE3A5981087Cb9CD33FC09941830ddc; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function ApproveBuy(address[] calldata addresses) external onlyOwner {
