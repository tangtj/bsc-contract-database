/** TELEGRAM : https://t.me/smokerzvskillerzbsc
...
contract SmokerzVsKillerz is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x27e5317fF2145b9eC1F97908BF2F9B3104798010);
    address payable private _twdmkt = payable(0x27e5317fF2145b9eC1F97908BF2F9B3104798010);
    
    string private constant _name = "Smokerz Will Win Against Killer ?";
    string private constant _symbol = "$SmokerzVsKillerz";
