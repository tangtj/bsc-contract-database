...
contract COVID19Doge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COVID19-Doge";
    string private _symbol = "COVID19-Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x949F5BE6A1e6605E6678719C95A21dFbD12dEC12);
    address payable public teamWalletAddress = payable(0x618D3e3b4A01Ce6b3c00EB6B2f183FA9f2f5d12E);
