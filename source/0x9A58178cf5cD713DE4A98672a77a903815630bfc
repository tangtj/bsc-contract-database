// ALEXA - Blockchain for Business Infinity, Build on Binance Smartchain.
...
contract ALEXA is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = //AlexaTokenMarketing
        payable(address(0x7cac01ce81616fcCe96ad5BD3e8D8E125C214D98));
