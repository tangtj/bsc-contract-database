...
contract Miner is Owned{
    ...
    event MinershipTransferred(address indexed from, address indexed to);
    ...
    modifier onlyMiner {
        require(miner[msg.sender] == true || msg.sender == owner);
        _;
    }
...
contract SeedBToken is Miner {
    using SafeMath for uint;

    bool public running = true;
    string public constant symbol = "SEED_B";
    string public constant name = "Crypto Seed";
