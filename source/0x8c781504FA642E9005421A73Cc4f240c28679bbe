...
contract ProblemGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Problem Grow"; // 
    string private constant _symbol = unicode"$PG";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xcC10a615347Cca2D0201Ac0D3cEb57839a345Cd9;
