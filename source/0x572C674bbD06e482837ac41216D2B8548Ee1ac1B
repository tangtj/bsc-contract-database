...
TELEGRAM:  https://t.me/ughmemecoin
...
contract UGH is Context, IERC20, Ownable {
    ...
    string private constant _name = "UGH"; // 
    string private constant _symbol = "$UGH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xD4E757a8B64C13e32b957752ac63392DE8EDdcA9);
