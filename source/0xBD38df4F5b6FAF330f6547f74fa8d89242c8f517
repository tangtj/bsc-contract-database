...
contract ShibaSimulator is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Simulator", "SHIBSIM") {
        ...
        marketingWallet = address(0x536B0Be113F1f4126505A372f3B65F1C25eEc695); // set as marketing wallet
        devWallet = address(0x536B0Be113F1f4126505A372f3B65F1C25eEc695); // set as dev wallet
