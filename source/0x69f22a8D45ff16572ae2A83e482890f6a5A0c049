...
一，上线前2万枚对2万U添加底池。（若有撤池子，币直接打入黑洞消毁，U不销毁）

二，上线后3万枚通过挖矿形式获得。
上线时池子外没有一枚代币，任何人手里没币。
...
contract QL is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"青龙", "QL") {
        ...
        uint256 totalSupply = 50_000 * 1e18; // 50.000 總供應量

        maxTransactionAmount = 50_000 * 1e18;  
        maxWallet = 50_000 * 1e18;  
        swapTokensAtAmount = 5 * 1e18; 
        ...
        marketingWallet = address(0x02bf7cA5AC9De8BeC736d13076F94AE0B5826e52); 
        devWallet = address(0x539dAA84512ab7ce75a4B56eA7C891F67515a06f); 
