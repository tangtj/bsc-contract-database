...
/*
tg : https://t.me/easterdogeportal
website : https://blobbsc.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xb7685277530Ca2Dc188f96cdd4b2f06d08f13fB5; // owner address
...
contract BLOB is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x09b53a832CC340f897ACe8b292b7F9175B9bd1B0); 
    address payable public teamWalletAddress = payable(0x09b53a832CC340f897ACe8b292b7F9175B9bd1B0);
    ...
    uint256 private _totalSupply = 6942000000000000 * 10**_decimals;
