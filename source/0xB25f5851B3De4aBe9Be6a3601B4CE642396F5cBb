/**
   ...
   Welcome Meta DayQuil NyQuil
   
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @MetaDayQuilNyQuil
   ...
   50% burn to the black hole, with such big black hole and 7% fee, the strong holder will get a valuable reward

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #MetaDayQuilNyQuill to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 50% total supply to the pool
   Can you make #MetaDayQuilNyQuil 10000X? 
...
contract MetaDayQuilNyQuil is Context, IERC20, Ownable {
    ...
    string private _name = "Meta DayQuil NyQuil";
    string private _symbol = "METADAYNY";
