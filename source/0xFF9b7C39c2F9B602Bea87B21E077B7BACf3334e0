...
contract JACKPOT is ERC20, Ownable {
    ...
    event UpdatedJackpotAddress(address indexed newWallet);
    ...
    constructor() ERC20("JACKPOT", "JACKPOT") {
        ...
        if(block.chainid == 56){
            _dexRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // ETH: Uniswap V2
        } else {
        ...
        buyJackpotFee = 2;
        buyLiquidityFee = 1;
        buyTotalFees = buymarketingFee +  buyJackpotFee + buyLiquidityFee;

        sellmarketingFee = 2;
        sellJackpotFee = 2;
        sellLiquidityFee = 1;
        sellTotalFees = sellmarketingFee + sellJackpotFee + sellLiquidityFee;
        ...
        jackpotAddress = address(newOwner);
    ...
    function setJackpotAddress(address _jackpotAddress) external onlyOwner {
        require(_jackpotAddress != address(0), "_jackpotAddress address cannot be 0");
        jackpotAddress = payable(_jackpotAddress);
    }
