...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x2314746c007c9b76143c903493a0ad3F3bf00a26; // owner address
...
contract HarryPotterObamamario10Inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterObamamario10Inu";
    string private _symbol = "BINANCE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28012d770A738346FA9292eA5150d5400006B877); 
    address payable public teamWalletAddress = payable(0x28012d770A738346FA9292eA5150d5400006B877);
