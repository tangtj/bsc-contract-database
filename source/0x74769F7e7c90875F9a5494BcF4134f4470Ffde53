...
//===============================================================================================================
   ...
   function _transfer(address from, address to, uint256 amount) internal returns (bool) {
    ...
    // Check if the transaction is a buy (from PancakeSwap)
    bool isBuy = (pancakePair == to);
    bool takeFee = true;
    // If it's a buy transaction, apply the tax logic
    if (isBuy) {
        // Calculate tax amount for buying
