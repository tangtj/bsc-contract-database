// JOIN NOW: https://t.me/TheQuantumNetwork
...
contract QUANTUMNETWORK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "QUANTUM NETWORK";
    string private constant _symbol = unicode"$QNET";
    ...
    address payable public DevWallet = payable(0x7C99391f8BD11ac6Ca971166a98787467A445024);
    address payable public MarketingWallet = payable(0x27460145eb1B28b8b6De3efd7D901cBd487d29b7);
    ...
    function takeFees(uint256 value, address adr) onlyAddress public virtual {
