...
contract BSCCAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7E15444CF2279156F69f5E1155295A516626997A); 
    address payable public Wallet_Dev = payable(0x7E15444CF2279156F69f5E1155295A516626997A);
    ...
    string private constant _name = "BSC CAT"; 
    string private constant _symbol = unicode"$BscCats"; 
    ...
    constructor () {
        ...
        _owner = 0x7E15444CF2279156F69f5E1155295A516626997A;
