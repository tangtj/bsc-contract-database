...
contract $777DAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address; 
    
    string private _name = " 777 Dao ";
    string private _symbol = " 777 Dao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x74b417Ece014F0d2ef72d7Cb3D8cB530DBA500Bb); // Marketing Address
    address payable public teamWalletAddress = payable(0x74b417Ece014F0d2ef72d7Cb3D8cB530DBA500Bb); // Team Address
    ...
    uint256 private _totalSupply = 777 * 10**_decimals;
