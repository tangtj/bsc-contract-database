...
contract AstroBirdC is ERC20, Ownable {
    ...
    address public teamWallet =
        address(0x3197dE9888566D521782278D106Ebc3D53ce149f);
    ...
    uint256 public swapTokensAtAmount = (_totalSupply * 1) / 10000; // 0.01% swap tokens at this amount. (10_000_000 * 1) / 10000 = 0.1%(10000 tokens) of the total supply
    ...
    uint256 public marketingAmount = 200; //
    uint256 public teamAmount = 100; //
    ...
    constructor() ERC20("AstroBirdC", "ABC") {
