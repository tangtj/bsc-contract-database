...
*/
/**
Telegram : https://t.me/OxDuckPirates
Website  : https://0xduckpirates.xyz/
Twitter  : https://twitter.com/0xDuckPirates
...
contract oxDuck is Context, IERC20, Ownable {
    ...
    string private _name = "0XDUCK PIRATES";
    string private _symbol = "$DUCK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x200Cdf694104548A76B92bc79407Bb3d84891B25);
    address payable private DevelopmentWalletAddress = payable(0x200Cdf694104548A76B92bc79407Bb3d84891B25);
    ...
    uint256 public _DevelopmentShare = 30;
