// https://t.me/AltCryptoBSC
// https://twitter.com/ALTcrypto01
// https://altcryptonet.com/
...
contract AltCrypto is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Alt Crypto";
    string private constant _symbol = unicode"ALTC";
