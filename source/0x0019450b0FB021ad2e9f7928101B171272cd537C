...
contract Stelia is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6000*1e4* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
 
    string private _name = "Stelia";
    string private _symbol = "STELIA";
    ...
    address public  advertisementWallet = 0x2DCAC963206159FcA3d0B56DEE55fE491A1cF0A4;
    ...
    uint256 public _maxTxAmount = 60*1e6  * 10**18;
