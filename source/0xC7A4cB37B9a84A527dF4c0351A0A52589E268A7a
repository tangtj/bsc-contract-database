...
contract Pepecoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x411b77C93294eA139C3198A8fb85b839036D1516); // Marketing Address
        
    address payable public teamAddress =
        payable(0x27B273a2BdB36d4E1C4F241BbA465A4eF5F154CA); // Team Address
        
    address payable public liquidityAddress =
        payable(0x27B273a2BdB36d4E1C4F241BbA465A4eF5F154CA); // Liquidity Address
