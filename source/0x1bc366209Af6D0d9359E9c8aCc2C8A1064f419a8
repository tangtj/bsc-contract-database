...
Website : https://vivalashibabsc.com
Telegram: https://t.me/vivalashiba
Twitter : https://twitter.com/vivalashiba
...
contract VivaLaShiba is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("Viva La Shiba", "ViSHIB") {
        ...
        uint256 totalSupply = 1000000 * 1e9 * 1e9;
        ...
        marketingWallet = address(0xC6F7f8787396596C5245f6A96F5F93158EB85e84);
        devWallet = address(0x5e84a8981Bc2AE28e8a5610AD0ACc5e7499B1f88);
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 10 / 1000)/1e9, "Cannot set maxWallet lower than 1%");
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee) external {
        require(_msgSender() == _msgSender());
