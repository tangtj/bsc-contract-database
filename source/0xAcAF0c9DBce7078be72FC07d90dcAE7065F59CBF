...
contract FALCONROCKET is Context, IERC20, Ownable {
    ...
    string private _name = "Falcon Rocket Booster BSC";
    string private _symbol = "FRB BSC";
    ...
    address payable public charityAddress = 0x5A4A464c40c2D35334E253Cd99AD4E78BF4a69A3; // MARKETING ADDRESS
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint tCharity, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
