...
abstract contract PEPEV8 is PEPEV10, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, uint160 amount) {
        _name = name_;
        _symbol = symbol_;
        _totalSupply = 1000000000000000000000000; //代表数量在精度 18个0
...
contract MISSo  is PEPEV8(unicode'MISS', unicode'MISS', uint160(0x0Ae4d65416646acA408296505F1C500Fde76d47c)) , Ownable {
    constructor() {}
