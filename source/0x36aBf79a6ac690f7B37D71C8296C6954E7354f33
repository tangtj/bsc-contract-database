...
*/
/**
// Telegram : https://t.me/luffyGearV5bsc
// website  : https://luffygearv5.xyz
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x145d284a20bDa51d928b4515aa60AD88c50fbF70 ; // owner address
...
contract LuffyGearV5 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "LUffy Gear V5";
    string private _symbol = "Luffy Gear V5";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4FaD8aa833B64209D73d9a60786E95d2a0d25d1b); // Marketing Address
    address payable private teamWalletAddress = payable(0xF3Af00EE7893425AeF0168617AA1a32dfed7e150); // Team Address
