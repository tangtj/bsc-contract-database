...
contract AstronautPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"ASTRONAUT PEPE";
    string private _symbol = unicode"$APEPE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x5ABfEA3CA3aEAE231391caF8F7A822720F103a81);
    address payable private taxWallet2 = payable(0x5ABfEA3CA3aEAE231391caF8F7A822720F103a81);
