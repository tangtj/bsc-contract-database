...
Pepeucci
Pepeucci is delivering the finer and designer side of things for crypto.
His goal is to make everyone change the way of living, invest with peace of mind.

TG:
https://t.me/Pepeucci

Twitter:
https://twitter.com/Pepeucci
...
contract Pepeucci is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pepeucci";
    string constant _symbol = "PEPEUCCI";
    ...
    uint256 private totalFee        = marketingFee + reflectionFee + liquidityFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4A943e161173A67AC27b9a4768cD1ad372E1d726;
