...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3935f49de3577652150D1E1bA9BEDD0689f633cd; // DEPLOYER
...
contract GomuGomuNoFusenOnePiece is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = unicode"GomuGomuNoFusenOnePiece";
    string public _symbol = unicode"GGNFOP";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3935f49de3577652150D1E1bA9BEDD0689f633cd); 
    address payable private developmentWalletAddress = payable(0x3935f49de3577652150D1E1bA9BEDD0689f633cd);
