...
contract BakiHanma is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x1837D1Db258bc316b477E81468C1c6766F378e3D;

    string private constant _name = "Baki Hanma";
