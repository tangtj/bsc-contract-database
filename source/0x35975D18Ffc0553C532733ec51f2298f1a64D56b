...
contract IAMWEASEL is Ownable, ERC20 {
    ...
    constructor() ERC20("I AM $WEASEL", "WEASEL") {
        _transferOwnership(0x2C9c55c6AF521724f748A340946a8844b01040e3);
        _mint(owner(), 420_000_000_000 * (10 ** 18));

        marketingTaxBuy = 30;
        marketingTaxSell = 30;
        marketingTaxTransfer = 30;

        denominator = 10_000;

        marketingWallet = 0x2C9c55c6AF521724f748A340946a8844b01040e3;
