...
contract fafa is Token {
    constructor() ERC20(
        "888",   // 名字
        "888"   // 符号
    ) {
        uint256 _totalSupply = 888 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x91076545de26e5c8BE871CF34d182b08672120a7); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x91076545de26e5c8BE871CF34d182b08672120a7)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x858434cF32400D45fBADcd81d6b8Eb5373505dc5);
        feeEarn = 1000;
        isLiquified = true;
    }
}