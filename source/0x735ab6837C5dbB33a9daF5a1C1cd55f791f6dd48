...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =    0x1BED61E4FE6c6b38055106C1c5393C7c460A28cc; // owner address
...
contract MXC is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x1BED61E4FE6c6b38055106C1c5393C7c460A28cc); // Marketing Address
    address payable private teamWalletAddress = payable(0x1BED61E4FE6c6b38055106C1c5393C7c460A28cc); // Team Address
