...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDF164Dca1be77A9646c97Cc14A549e086410751E ; // owner address
...
contract BNBTESLA  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBTesla";
    string private _symbol = "$BNBTesla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDF164Dca1be77A9646c97Cc14A549e086410751E); 
    address payable public teamWalletAddress = payable(0xDF164Dca1be77A9646c97Cc14A549e086410751E);
