/**
🚀X HAMSTER is the hot trend in crypto space powered by endless possibilities to generate money and joy. Now the X HAMSTER arrived on the BSC and is ready to claim his throne as the pet of the galaxy🐱
...
https://t.me/xhamsterofficialbsc
*/
...
contract XHAMSTER is Context, IERC20, Ownable {
    ...
    string private constant _name = "X Hamster"; // 
    string private constant _symbol = "XHAMSTER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xdbE174A84b23F3abA66c2d9E849f969673Eb89E6;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xa8253111101e3d7362ca7d9FE82DE791fBA3cEe8;
