...
/**TG: https://t.me/AtlantisBUSD
Website: https://atlantisbusd.tax
*/
...
contract Atlantis is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4Fa7d3f1101692EE9622a7F76806BABF30c79947;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Atlantis";
    string constant _symbol = "ATLANTIS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2000000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x4Fa7d3f1101692EE9622a7F76806BABF30c79947;
