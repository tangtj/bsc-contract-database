/**
 🌐ExaTech is Proof Of Artificial Intelligence (PoAI) algorithm based blockchain with own Ecosystem on Blockchain.
working system chart of the POAI blockchain on the EXA_TECH blockchain network:
Data Collection, Validation, Storage,Analysis,Collaboration,Token-Based Incentive System,Low Gas Fees,And Immutable Audit Trail.
// TELEGRAM: https://t.me/EXATechOfficialEN
// WEBSITE: https://exatecth.com
*/
...
contract ExaTech is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ExaTech";
    string private _symbol = "EXT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0x628C3589945E4Ef230AFED2e2A13ff903B32C18e);
