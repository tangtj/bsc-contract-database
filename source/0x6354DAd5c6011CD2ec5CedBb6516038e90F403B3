...
*/
	function stake(uint256 _stakeAmt) public {
		...
		ERC20(address(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6)).transferFrom(msg.sender, address(this), _stakeAmt);
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(address(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6)).balanceOf(address(this)) >= ((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6)).transfer(msg.sender, ((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)));
		}
...
*/
	function principalTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6)).balanceOf(address(this)) >= principalAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((principalAmtInBank > uint256(0))){
			ERC20(address(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6)).transfer(msg.sender, principalAmtInBank);
		}
 ...
 * The function takes in 1 variable, (zero or a positive integer) _amt. It can be called by functions both inside and outside of this contract. It does the following :
 * checks that the function is called by the owner of the contract
 * checks that (ERC20(Address 0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to ((_amt) + (totalUnclaimedRewards) + (interestAmtInBank) + (totalAccumulatedInterest))
 * if _amt is strictly greater than 0 then (calls ERC20(Address 0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153)'s at transfer function  with variable recipient as (the address that called this function), variable amount as _amt)
*/
	function withdrawToken(uint256 _amt) public onlyOwner {
		require((ERC20(address(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153)).balanceOf(address(this)) >= (_amt + totalUnclaimedRewards + interestAmtInBank + totalAccumulatedInterest())), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((_amt > uint256(0))){
			ERC20(address(0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153)).transfer(msg.sender, _amt);
		}
	}
...
*/
    ...
    function withdraw_coin_SFIL(uint256 _amount) public onlyOwner {
		require((ERC20(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6).balanceOf(address(this)) >= _amount), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xD6Dd6624efcD5cdE0d614A8cEE6e211fDE9aD0c6).transfer(msg.sender, _amount);
	}
