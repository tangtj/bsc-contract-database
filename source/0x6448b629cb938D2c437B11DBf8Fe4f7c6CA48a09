...
contract xpenguin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xD203DF2c6a4b46a8f3E68BbFC619667E493a5d74); // Marketing Address
        
    address payable public teamAddress =
        payable(0xD203DF2c6a4b46a8f3E68BbFC619667E493a5d74); // Team Address
        
    address payable public liquidityAddress =
        payable(0xD203DF2c6a4b46a8f3E68BbFC619667E493a5d74); // Liquidity Address
    ...
    uint256 private constant _tTotal = 420690 * 1e9 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    string private constant _name = "Xpenguin";

    string private constant _symbol = "Xpenguin";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 100 ; // 1 %
    ...
    function setmaxWallet(uint256 _walletMax) external onlyOwner {
      ...
      require(_walletMax >= _tTotal * 1 / 100 , "Must keep above 1%");
        }
