...
// Telegram: https://t.me/Greatest_PepeBSC
...
contract GPEPE is Context, IERC20, Ownable {   
    ...
    address payable private _twddev = payable(0xC0773bEa530001324EE9828491938de21Ec6fc90);
    address payable private _twdmkt = payable(0xC0773bEa530001324EE9828491938de21Ec6fc90);
    
    string private constant _name = "GREATEST PEPE"; 
