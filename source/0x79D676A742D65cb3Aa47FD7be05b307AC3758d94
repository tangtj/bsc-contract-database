//https://t.me/https://t.me/babybullrun
...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x98eb3CEDF1A4FaBF17672d13103852a5D9C79049;
...
contract BabyBullRun is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Baby Bull Run", "BABYBULL", 9) {
    _owner = msg.sender;
