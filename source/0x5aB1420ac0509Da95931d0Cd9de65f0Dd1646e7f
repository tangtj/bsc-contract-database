...
contract BAEMTEST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BAEMTEST";
    string private _symbol = "BAEM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7Fac39690c70C98011c7304Aa73d13953bE8c7A1); // Marketing Address
    address payable public teamWalletAddress = payable(0x7Fac39690c70C98011c7304Aa73d13953bE8c7A1); // Team Address
