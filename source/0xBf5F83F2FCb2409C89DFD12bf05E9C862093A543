...
contract XDARKLORD is Context, IERC20, Ownable {
    ...
    string private constant _name = "X DARK LORD"; // 
    string private constant _symbol = "XDARK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x7Ab1D3134DbA3e32496Ab6DA6BBA63Af5751168c;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x422EF569A4c699bcd610844feCB0B8b3eEE46EcB;
