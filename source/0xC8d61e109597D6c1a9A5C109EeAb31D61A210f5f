...
Telegram : https://t.me/wojakvschad
...
contract $WOCHAD is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x60f36Be126407468e1c9F2fce6ae5C0baf8AACBc;

    string private constant _name = "Wojak Vs Chad";
    ...
    // Owner cannot transfer out Wojak V Chad from this smart contract
