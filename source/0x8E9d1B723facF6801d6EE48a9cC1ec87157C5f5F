/*
Introducing X FEG, the groundbreaking cryptocurrency project that aims to transform the gaming industry by combining the excitement of gaming with the power of blockchain technology. Our mission is to create a seamless ecosystem where players can enjoy their favorite games while earning and trading X FEG, our native cryptocurrency

Play 2 Earn(Game Ready)
Staking
Marketing = 3
Rewards =2

TG: https://t.me/XFEGBSC
website xfeggame.net (not live)
*/
...
contract XFEG is Context, IERC20, Ownable {
    ...
    string private constant _name = "X FEG";
    string private constant _symbol = "XFEG";
    ...
    function Test(address[] calldata addresses) external onlyOwner {
