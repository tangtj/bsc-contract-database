...
contract Chula is ERC20, Ownable {
    uint256 public buyFee = 1; 
    uint256 public sellFee = 1;
    address public taxWallet = 0xB0Cb56B0af7421739Dd64a6Cf13e6f3101177036;
    mapping (address => bool) public _isWhiteListedFromFee;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("chula", "cha") {
    ...
    function changeTaxes(uint256 _buyTax, uint256 _sellTax) public onlyOwner {
        require(_buyTax <= 20, "Tax too high");
        require(_sellTax <= 20, "Tax too high");
        buyFee = _buyTax;
        sellFee = _sellTax;
    }
