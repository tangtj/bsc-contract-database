...
contract BALDYBSC is Context, IERC20, Ownable {
    ...
    string private _name = "BALDYBSC";
    string private _symbol = "BALDY";
    ...
    address payable public marketingWallet = payable(0x19B5A47755C15fC6B76f8bF62497DAeeA18a6e57);
