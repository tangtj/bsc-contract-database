...
contract GALAXC is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000 * 10**9; // 1 Quadrillion Total Supply
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**9; // Total Transaction Amount: 10 Trillion
    uint256 public _numTokensSellToAddToLiquidity = 30000000000 * 10**9;
    uint256 public _maxWalletToken = 10000000000000 * 10**9; // Total Wallet Amount: 10 Trillion

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'GALAXC';
    string private _symbol = 'GALAXC';
