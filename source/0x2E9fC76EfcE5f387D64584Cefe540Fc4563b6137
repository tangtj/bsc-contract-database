...
contract  $BABYBUSD20 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7019b96f4a9262bc37b0553A78C5E8DF6768E5E9;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = " $BABY BUSD2.0";
    string constant _symbol = "$BUS2.0";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 10 / 10000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x7019b96f4a9262bc37b0553A78C5E8DF6768E5E9;
