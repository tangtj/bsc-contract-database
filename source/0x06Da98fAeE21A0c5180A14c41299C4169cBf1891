// t.me/ChampignonsofArborethia 
// ChampignonsofArborethia.com
...
contract ChampignonsofArborethia is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "ChampignonsofArborethia";
    string public symbol = "CHAMPZ";
