...
contract JinZhuan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JinZhuan";
    string private _symbol = "JinZhuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17cac38Dc2c324d90D304FE4FCefA7a3Ffb16A80); // Marketing Address
    address payable public teamWalletAddress = payable(0x17cac38Dc2c324d90D304FE4FCefA7a3Ffb16A80); // Team Address
