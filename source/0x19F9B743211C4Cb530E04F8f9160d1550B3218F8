...
contract LexusChain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x71d744a25E79b980980E1E943b6E4e8d4FDe12c0); // Marketing Address
    address payable public teamWalletAddress = payable(0x6Cb808AE9d42EF7d630B6a323FfCD2696Da161c9); // Team Address
