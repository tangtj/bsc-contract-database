...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b9bDe48175F6177BB2D4868CaF7Df1aD61EB1B5; // owner address
...
contract CCCGDC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCGDC";
    string private _symbol = "CCCGDC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7b9bDe48175F6177BB2D4868CaF7Df1aD61EB1B5); // Marketing Address
    address payable private teamWalletAddress = payable(0x7b9bDe48175F6177BB2D4868CaF7Df1aD61EB1B5); // Team Address
