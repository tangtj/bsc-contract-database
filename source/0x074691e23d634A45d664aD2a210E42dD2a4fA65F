...
// Telegram: https://t.me/Supperbananaa
...
contract SupperBanana is Context, IERC20, Ownable {
    ...
    string private constant _name = "SupperBanana";
    string private constant _symbol = "SBanana";
