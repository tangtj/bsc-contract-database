...
contract FLOKIDEX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x00e11d92B123f504045d2b92f2832bf8752D16CF); 
    address payable public Wallet_Development = payable(0x8f76b63DB8a78e751138BdAFf21094910Fe0329b);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x768fDdB8917A48dE07e538B6DaD799cFf303abbE); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;
    string private constant _name = "FLOKI DEX"; 
    string private constant _symbol = unicode"FLOKIDEX"; 
    ...
    constructor () {
        ...
        _owner = 0x768fDdB8917A48dE07e538B6DaD799cFf303abbE;
