...
💳 XCARD - BEP20 - OFFICIAL 

• LAUNCH 17.00 UTC!!! •

💳 XCARD introduces a utility token, that fuels the whole Platform that is the most liquid token in the XCARD Wallet.
...
⚡🔥 Be ready new fitur in crypto,join now! 🎯

💬Telegram : https://t.me/XCardBep20
🌏 Website : Xcard.io ( While in development )
...
contract XCARD is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "XCARD";
    string private constant _symbol = unicode"$CARD";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 640000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x2eD0781cB038b06f3d052069b197B9ca6fC442D2);
    address payable public MarketingWallet = payable(0xA23B1bD0921F3d5D973c55425152b305920FD789);
