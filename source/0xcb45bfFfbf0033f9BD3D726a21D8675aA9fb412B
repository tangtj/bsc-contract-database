...
/*
    ...
    Total Fees: 14%
    2% fee is added to the CALLGODS developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the CALLGODS marketing wallet as BNB *Note the team will not be selling tokens*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    contract CALLGODS is Context, IERC20, Ownable {
    ...
    string private _name = "CALLGODS";
    string private _symbol = "CALLGODS";
    ...
    uint256 public _maxWallet = 10000000000000 * 10**9; //1.5% of TS
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x2420D15BB559aDba5cBf3AA780981bfE25551CaC;
        _developerAddress = 0x31ef8307E6cC8B7c5D17cfB7c113f33F92a98c7A;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "CALLGODS: cannot burn from zero address");
    require(_balances[account] >= amount, "CALLGODS: Cannot burn more than the account owns");
