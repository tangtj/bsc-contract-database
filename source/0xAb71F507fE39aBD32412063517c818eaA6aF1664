...
The Real BlowUp + BUSD = Moon!

TG: https://t.me/BlowUp
Website: http://www.BlowUp.Finance
TW: https://twitter.com/BlowUpToken
...
contract BlowUp is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BlowUp";
    string constant _symbol = "BlowUp";
