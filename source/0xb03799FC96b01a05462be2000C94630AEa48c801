...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  function init() public onlyOwner {
    ...
    initContracts(0x74aD2882626a169e97DfC64fA48a87ce410fFCCC, 0x4f34E19eA0582262165a265D64e5a9670757c8B3, 0x4f34E19eA0582262165a265D64e5a9670757c8B3);
    lastUpdate = now;
    ma = getCurrentPrice();  
    ma2 = getCurrentPrice();  
    excluded[address(0x0)] = true;
    manager[msg.sender] = true;
    address oldLbtc = 0x09Afc85Ed27b077912800b64Fac38D23111BEaD7;
    convertible[oldLbtc] = true;
    convertibleTokens.push(oldLbtc);    
