/**
Shikoku KAKI ( $Shikaki ) is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community.

Shikoku Kaki Ecosystem : 
Shikaki DEX
Shikaki NFT
Shikaki STAKING
Shikaki AI
...
contract Shikokukaki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shikoku Kaki"; // 
    string private constant _symbol = "Shikaki"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x2346668500EC60b0dCeF382c7b51F573e8B6c671;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xCA97697406b400112d08B1b8f635AfB4306A9f20;
