/**
  ...
  Telegram : https://t.me/Xfactortoken
 Website https://xfactoreth.xyz/
 
 Twitter https://twitter.com/eth_xfactor
*/
...
contract XFACTORETH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    XFACTORETHDividendTracker public dividendTracker;
    ...
    constructor() ERC20("XFACTORETH", " XFE") {
        marketingWallet = payable(0x00C3665ce8a0E0a36FcaB52CD4EeB9F0e864AB81);
        devWallet = payable(0x00C3665ce8a0E0a36FcaB52CD4EeB9F0e864AB81);
        ...
        dividendTracker = new XFACTORETHDividendTracker(
            payable(this),
            router,
...
contract XFACTORETHDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    XFACTORETH public XFACTORETHContract;
    ...
    constructor(
        ...
        defaultToken = token;
        XFACTORETHContract = XFACTORETH(mainContract);
    ...
    function _transfer(
        ...
        require(false, "XFACTORETH_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "XFACTORETH_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main XFACTORETH contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XFACTORETHContract);

            uint256 prevBalance = XFACTORETHContract.balanceOf(address(this));
            ...
            {
                uint256 received = XFACTORETHContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XFACTORETHContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
