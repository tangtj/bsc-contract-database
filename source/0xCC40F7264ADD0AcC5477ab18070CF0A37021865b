...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8Fa5FE4dE79Dc115cB0c87D391F0013a88c34051;
...
contract KuKu is AbsToken {
    constructor() AbsToken(
        ...
        address(0xe64B7cD2cC235eC55e6A3810F41fE31bE1206C1B),
    
        address(0xd6Cf0988D78E704Cfc3f260917881f757F4E732a)
    ){
