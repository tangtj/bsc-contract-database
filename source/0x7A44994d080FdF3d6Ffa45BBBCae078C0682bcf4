...
contract BANANADUMP is IERC20, Ownable {
    ...
    string private constant _name = unicode"BDUMP";
    ...
    address internal marketingReceiver = 0xc9E0e07C5Fc32CFA47d9F2b3C5915aB237915904;
    address internal lpReceiver = 0x92bAdc3De60d6975dc84b772c002773018D45bd8;
