...
contract BTCQ is Token {
    constructor() ERC20(
        "BTCQ",   // 名字
        "BTCQ"   // 符号
    ) {
        uint256 _totalSupply = 100 ether; 
        address _marketing = address(0x3D1e9dF971C775b9271b8AB4184E89c32911E9f9); // 
        address _receive = address(0x35bfD6e6e2E158A21CE6c2A8B8314F2A2DEE2f4f);   //
        address _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   // 
        address _usdt = 0x55d398326f99059fF775485246999027B3197955;     // 
        address _pair = super.__SwapPool_init(_router, _usdt);
        // 
        feeMarketingBuy = 600;  
        feeLiquidityBuy = 2000;  
        feeDividendBuy = 0;  
        feeBurnBuy = 0;         
      
        feeMarketingSell = 600; 
        feeLiquiditySell = 2000; 
        feeDividendSell = 200; 
        feeBurnSell = 0;       
        // 转账费用
        feeTransferAll = 9900;   // 
        ...
        setFeeRemoveLiquidity(
            9900,       // 
            address(0xE272dF43C28415ac1DDF650c2B96f46029430F62)  
        );
        // 限购
        bool _isLimit = true;// 
        ...
        feeMarketingTo2 = address(0xE272dF43C28415ac1DDF650c2B96f46029430F62);   
        feeEarn = 1000; 
    }
}