...
contract Babywikicat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabywikicatDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Baby Wikicat", "BWKC") {
        marketingWallet = payable(0xaF3Ed116Ab607977d1A56b2Ef65A702B6Af3BeDE);
        devWallet = payable(0xaF3Ed116Ab607977d1A56b2Ef65A702B6Af3BeDE);
        ...
        dividendTracker = new BabywikicatDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 1000000000; 
        swapTokensAtAmount = totalTokenSupply / 1000000000;
...
contract BabywikicatDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Babywikicat public BabywikicatContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabywikicatContract = Babywikicat(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Babywikicat_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Babywikicat_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Babywikicat contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabywikicatContract);

            uint256 prevBalance = BabywikicatContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabywikicatContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabywikicatContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
