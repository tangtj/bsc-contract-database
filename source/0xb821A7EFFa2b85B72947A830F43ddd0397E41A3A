...
contract SATURNV is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 10000000e9;
    ...
    uint256 public _sellHoldersFee = 100; // sells: 1% to holders
    uint256 public _buySplitFee = 200; // buys: 2% split into 1% buyback + 1% liquidity
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (isBuy && tradingEnabledAt + 120 minutes > now && amount > 100_000e9) {
            revert("For the first 120 minutes, only buys of max 100.000 tokens are allowed");
        }
