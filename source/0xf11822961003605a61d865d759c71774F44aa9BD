...
contract XrpConnect is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 3333000 * 10**9;
    ...
    address payable private _dev = payable(0x9B402c9b1444BCdaC35518B01876f3E1eE7141De);
    address payable private _mkt = payable(0x58a206e9c65fB9D3E9360309a441C87DE1B419C4);
    
    string private constant _name = "XrpConnect";
