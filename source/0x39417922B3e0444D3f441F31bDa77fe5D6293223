...
contract STFUHP is IERC20, Ownable {
    ...
    string _name = "STFU HARRY POTTER";
    string _symbol = "STFUHP";
    ...
    constructor () {
        ...
        devFeeReceiver = 0xcE95bC6aCB17eFbc457Ff2774084075C99239b59;
        marketingFeeReceiver = 0x309F7B8AE97Cd20871229B73b33d7c06649740D0;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=30,"Cannot set buy fees above 30%"); // set max fees you can set to here
        require(totalFeeSell <=30,"Cannot set sell fees above 30%"); // set max fees you can set to here
        
     }

   function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        require(maxWallPercent_base1000 >= _totalSupply / 100, "cannot set max wallet below .1%");
        _maxWalletSize = (_totalSupply * maxWallPercent_base1000 ) / 100;
    }

    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        require(maxTXPercentage_base1000 >=_totalSupply.mul(2).div(100),"cannot set max TX below .2%");
