// Good Boy - 3% Bitcoin Rewards 
// Telegram : t.me/GoodBoyBSC
...
uint256 amount;
    ...
    IBEP20 RewardToken = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c) ; //Bitcoin
...
contract GoodBoy is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Good Boy";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x5631951E3e0C014796DF274e8E0d157725f243a2; // liquidity
        marketingWallet = 0x5631951E3e0C014796DF274e8E0d157725f243a2;  // marketing
