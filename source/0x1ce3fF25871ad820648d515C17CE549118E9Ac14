...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 999 * 10**18;
    string private _name = "99";
    string private _symbol = "99";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xc90C36f5E4Ec8E9A4bA8920ceEb0cDdF05F29eE5);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 999 * 10**18;
