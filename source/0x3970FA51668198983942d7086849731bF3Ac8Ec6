...
// TG : https://t.me/superpoowerbsc
// X : https://twitter.com/SUPERPOOWERBSC
...
contract SUPERPOOWER is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x6e7181b3d3145E5990AA3F493c87ce02f0c6f209);
    address payable private _twdmkt = payable(0x7e675835b49515AFdf639d1A29b13ED6FEC83faa);
    
    string private constant _name = "SUPER POOWER";
    string private constant _symbol = "SPOOR";
