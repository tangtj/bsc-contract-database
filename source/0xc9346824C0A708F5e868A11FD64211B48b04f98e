...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B3775f4CFC58a0de7B2370827C1b3f3001bA118; // DEPLOYER
...
contract DorkCheems  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "DorkCheems";
    string public _symbol = "DORK";
    uint8 public _decimals = 18;

    address payable private marketingWalletAddress = payable(0x7B3775f4CFC58a0de7B2370827C1b3f3001bA118); 
    address payable private developmentWalletAddress = payable(0x7B3775f4CFC58a0de7B2370827C1b3f3001bA118);
    ...
    uint256 private minimumTokensBeforeSwap = 1565 * 10**3; 
