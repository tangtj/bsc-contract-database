...
contract DONATELLO is Context, IERC20, Ownable {
    ...
    string private _name = unicode"DONATELLO";
    string private _symbol = unicode"DONATELLO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x193F1a9a8A27735a56438d7Ba43688614a56C077);
    address payable private taxWallet2 = payable(0x193F1a9a8A27735a56438d7Ba43688614a56C077);
