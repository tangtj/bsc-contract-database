/**
https://t.me/xshibasagabsc
https://twitter.com/xshibasagabsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCa53a1Ce8066561AEfC818991f1a58ACbaa1896A; // owner address
...
contract XSHIA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " X SHIBA SAGA ";
    string private _symbol = " X$HIA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCa53a1Ce8066561AEfC818991f1a58ACbaa1896A); // 
    address payable public teamWalletAddress = payable(0xCa53a1Ce8066561AEfC818991f1a58ACbaa1896A); // 
