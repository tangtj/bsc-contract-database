...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceSuczilla";
    string private _symbol = "SpaceSuczilla";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8b660fe0b5C4b622d2029Cf0441f230f4f8e3315); // Marketing Address
    ...
    address payable private IUniswapV2Address = payable(0x8b660fe0b5C4b622d2029Cf0441f230f4f8e3315); 
