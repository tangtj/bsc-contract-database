...
contract FixLP {
    address payable public feeRecipient = 0x0925aeA5e22E2ef97AC32571C6adC0f92C5eb0b4;
    uint256 public feeAmount = 0.005 ether;  // 0.005 BNB fee, using the ether unit for simplicity in Solidity.
