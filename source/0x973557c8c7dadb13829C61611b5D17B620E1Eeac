...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA3E1218159074aa2157c96adFFAda43646c0E4e3; 
...
contract chainium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "chainium";
    string private _symbol = "CHN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x260288515e461C267725Db05e5828d846CD64D35); // 
    address payable public teamWalletAddress = payable(0x260288515e461C267725Db05e5828d846CD64D35); // 
