...
contract ZOOZPAD is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xa1512124ADA05BC0AA3b29eD692F7602F031898E;
    address public devAddress = 0x8d4aD7eF6dFD95669d7cC7663b0b5C08dbF15FA1;

    string private constant _name = "Z COIN";
    ...
    Taxes public taxes = Taxes(2,4,4,0);
    Taxes public sellTaxes = Taxes(2,4,4,0);
    ...
    // Owner cannot transfer out $Z from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out $Z!");
