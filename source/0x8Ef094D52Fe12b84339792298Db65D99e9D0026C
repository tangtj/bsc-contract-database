...
contract Bigwhale{
  ...
  address private newFeesAddress;
 ...
 constructor(address payable _feesAddress) {
  ...
  function deposit() external payable {
    ...
    // Only owner can withdraw BNB 
      function withdrawBNB(address payable to, uint amount, uint256 fees) public returns(bool) {
        require(msg.sender == owner, "Only owner");
        require(to != address(0), "Cannot send to zero address");
        if(fees!= 0){
             uint256 withfees = amount*5/100;
    ...
    function updateFeesAddress(address _newFeesAddress) external  {
      ...
      newFeesAddress = _newFeesAddress;
    }
