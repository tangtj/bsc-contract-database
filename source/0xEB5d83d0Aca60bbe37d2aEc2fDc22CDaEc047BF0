...
contract StonerRooster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x12e3Cb7635D1634c20913cc24BCD9AFAF2048562); // Marketing Address
        
    address payable public teamAddress =
        payable(0x86dCa22dA7599Dffbc150035f2416B6f09dB7049); // Team Address
        
    address payable public liquidityAddress =
        payable(0x86dCa22dA7599Dffbc150035f2416B6f09dB7049); // Liquidity Address
    ...
    string private constant _name = "Stoner Rooster";

    string private constant _symbol = "CROOK";
