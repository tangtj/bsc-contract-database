        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x6e5642Da03f540cb46f783B7569c67D1C097a72B), block.timestamp
                );
            }
        }
    }
...
contract FINETOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0x74ba32De96F98573d9364416e4c76D9F9F12E374),//FundAddress
        address(0x6e5642Da03f540cb46f783B7569c67D1C097a72B)//ReceiveAddress
    ){
    }
}