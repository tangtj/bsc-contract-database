...
contract APPO is Token {
    constructor() ERC20(
        "APPO",   // 名字
        "APPO"   // 符号
    ) {
        uint256 _totalSupply = 2000 ether; 
        address _marketing = address(0xa14F507DBfC99894F43b2433B23A1F81009B8311); // 
        address _receive = address(0xF27af91AAd45B2F3eDb99b94763fEb224E124C9c);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0xa14F507DBfC99894F43b2433B23A1F81009B8311)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(15 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0xd6f1750FcDAF748198EcA89c61F046Fe4e93229B);   
        feeEarn = 1500; 
    }
}