...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xff507E8592D6EF89b0aEc10B844EA65A98f7A36d; // owner address
...
contract PePayPal is Context, IERC20, Ownable {
    ...
    string private _name = "PePayPal";
    string private _symbol = "PPP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDfe94213478cbED7cb0e7d375F2997853137c34d); // Marketing Address
    address payable private teamWalletAddress = payable(0xDfe94213478cbED7cb0e7d375F2997853137c34d); // Team Address
