...
contract SoonMoonY is Context, IERC20, Ownable {
    ...
    address private _donationWalletAddress = 0x8A60A77193ffc7917e9772Af5095BE90323D3148;
    ...
    string private _name = "SoonMoonY";
