/**
// https://t.me/PEPEVSDEDEBSC
// https://twitter.com/PEDE
*/
...
contract PEPEVSDEDEBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"P三P三 VS D三D三";
    string private _symbol = unicode"P三D三";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x51d7Ec39137f0a13b99E82539eC662E594b47827); // Marketing Address
    address payable private teamWalletAddress = payable(0x51d7Ec39137f0a13b99E82539eC662E594b47827); // Team Address
