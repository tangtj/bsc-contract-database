...
contract XenonProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "XenonProtocol";
    string private constant _symbol = unicode"XENON";
    ...
    address payable private _marketingAddress = payable(0xA333e92853b8c75073B8178ef7D5b3E5CCAe53B7);
