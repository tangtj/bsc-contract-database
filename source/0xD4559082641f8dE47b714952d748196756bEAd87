        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x6CdA674434fFfF6150cBdceBFdd187D3ce2F7938), block.timestamp
                );
            }
        }
    }
...
contract BTCW is AbsToken {
    constructor() AbsToken(
        ...
        address(0x6CdA674434fFfF6150cBdceBFdd187D3ce2F7938)//ReceiveAddress
    ){
    }
}