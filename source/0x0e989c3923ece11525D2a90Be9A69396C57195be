...
/**
TELEGRAM: https://t.me/+pvCiMVaMCOY0NDFl
*/
...
contract Bitfrog is IERC20, Ownable {
    ...
    string _name = "BitFrog";
    string _symbol = "$BITFROG";
    ...
    constructor () {
        ...
        devFeeReceiver =  0xF0f79BA8EBDBf329e0Fd49F45a7BF6e39c5e94AD;
        marketingFeeReceiver = 0x43e83f261C1620f80C0CD47f8209b741384fE7F4;
