...
TELEGRAM:  https://t.me/BookMartBSC
...
contract bookMart is Context, IERC20, Ownable {
    ...
    string private constant _name = "BookMart"; // 
    string private constant _symbol = "Bmart"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x903eef04f43aFdFcfa3c8b1F64f3226e4b6e78de;
