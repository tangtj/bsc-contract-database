 ...
 * https://t.me/nusubi
 * 
 * NUSUBI is a meme token with a twist!  
 * NUSUBI has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 * 
 * TOKENOMICS:
 ...
 * 
 * ~ ALL CREDIT TO MUSUBI DEVS FOR CODE ~
...
contract NUSUBI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nusubi";
    string private constant _symbol = unicode"NUSUBI";
