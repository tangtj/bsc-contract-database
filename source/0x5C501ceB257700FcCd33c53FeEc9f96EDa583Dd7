...
contract TravelCare is Context, IBEP20, Ownable {
    ...
    address private _marketingWalletAddress = 0x592b302DC9d764cF12Ad15ef0E8E73e5FCc6B75B;
    ...
    string private _name = "Travel Care";
    string private _symbol = "TRAVEL";
