...
contract DJOTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Dojochip";
    string private _seitokensymbol = "DJO";
    address public raadjn72;
