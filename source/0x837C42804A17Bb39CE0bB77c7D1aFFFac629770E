/**
TELEGRAM: https://t.me/xmenreborn
*/
...
contract XMENReborn is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 300000 * 10**_decimals;
    ...
    address public marketingAddress = 0x80b96bF4852B72B2cD5a5c7BD808a5a69Dbf8536;
    address public devAddress = 0x80b96bF4852B72B2cD5a5c7BD808a5a69Dbf8536;

    string private constant _name = "XMEN Reborn";
    string private constant _symbol = "$XRB";
    ...
    Taxes public taxes = Taxes(0,2,6,0);
    Taxes public sellTaxes = Taxes(0,2,6,0);
