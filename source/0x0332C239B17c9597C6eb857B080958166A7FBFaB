...
contract DefiX is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5d3EC80D9Fe8b494f43D69fc3469db41EB00490c);
    address payable private _twdmkt = payable(0x5d3EC80D9Fe8b494f43D69fc3469db41EB00490c);
    
    string private constant _name = "DefiX";
    string private constant _symbol = "DefiX";
