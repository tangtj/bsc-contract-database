...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"MemeStar",//Name
        unicode"MemeStar",//Symbol
        9,//Decimals
        3000000,//Supply
        address(0xf313c1bc73667F0150B7Bf8a90C3b887dd9E0bFD),//FundAddress
        address(0xee889f7C6d3c29c5Fde409612B1B609547BE7097)//ReceiveAddress
    ){
    }
}