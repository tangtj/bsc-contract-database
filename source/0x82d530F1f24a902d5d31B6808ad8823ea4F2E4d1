...
// twitter @RelianceToken
// Website: RelianceToken.org 
// Telegram: @RelianceToken
...
contract Reliance is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Reliance Token';
    string  private constant _SYMBOL = 'Rely';
