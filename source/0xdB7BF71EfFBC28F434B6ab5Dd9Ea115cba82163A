...
contract TokenTimelock is Ownable {
    ...
    constructor(address[] memory _addr, uint256[] memory _amount) public {
    ...
    function release() public {
        ...
        uint256 amount = numberOfToken[msg.sender].mul(cliff).div(184);
        if (countRelease[msg.sender] + cliff >= 184){
