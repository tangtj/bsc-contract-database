/**
 ...
 Telegram channel   https://t.me/PepeItUp

 Total supply 100,000
 Taxes 3% 
 Max wallet 1% or 1,000
*/
...
contract PepeItUp  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PepeItUpDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 2; //default cooldown 2s
    ...
    constructor() ERC20("Pepe It Up ", "Pepe It Up") {
        marketingWallet = payable(0xfF6a856c9166Da6991c9429Cd8edbcd0743Ff6C1);
        devWallet = payable(0x5B8779907cacbe0e18b773FEf36607c8DC76C6CC);
        ...
        dividendTracker = new PepeItUpDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 400; // 0.25%
    ...
    function setcooldowntimer(uint256 value) external onlyOwner {
        require(value <= 3000, "cooldown timer ");
        cooldowntimer = value;
    }
...
contract PepeItUpDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PepeItUp public PepeItUpContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PepeItUpContract = PepeItUp(mainContract);
        minimumTokenBalanceForAutoDividends = 100000_000000000000000000;
    ...
    function _transfer(
        ...
        require(false, "PepeItUp_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PepeItUp_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PepeItUp contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PepeItUpContract);

            uint256 prevBalance = PepeItUpContract.balanceOf(address(this));
            ...
            {
                uint256 received = PepeItUpContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PepeItUpContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
