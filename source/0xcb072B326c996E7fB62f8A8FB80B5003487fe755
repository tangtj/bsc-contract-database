...
// Welcome to BabyElonDay. This is a community token. If you want to create a telegram I suggest to name it to @babyelonday. 
...
//I will renounce the ownership to burn addresses to transfer #BABYELONDAY to the community, make sure it's 100% safe.
...
contract BabyElonDay is Context, IBEP20, Ownable {
    ...
    string private _name = "BabyElonDay";
    string private _symbol = "BABYELONDAY";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap = 0x1c5423D88f54Dbb6393eA518cC18b4F4be570C75;
