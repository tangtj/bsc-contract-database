...
contract BabyShib is ERC20, Ownable {
    ...
    constructor() payable ERC20 ("Baby Shiba Inu", "BabyShib") {
        ...
        marketingWallet =  0xa7fCED0c964D93fAD00fFe7cE3FDF2f97275560a;

        dividendTracker = new DividendTracker(6900 * 10**5, rewardToken);
        ...
        _isWalletExcluded[0xa7fCED0c964D93fAD00fFe7cE3FDF2f97275560a] = true;
    
        _mint(owner(), 6900 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 100000000 * 1069;
    }
