...
Telegram: @AiBoyBotBSC

Telegrams first digital companion.
...
contract AiBoyBot is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xa883A48110C89B4927eCf94b6321D453377Ca207); // Marketing Address
        
    address payable public teamAddress =
        payable(0xa883A48110C89B4927eCf94b6321D453377Ca207); // Team Address
    ...
    string private constant _name = "AiBoyBot";
