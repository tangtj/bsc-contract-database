...
Telegram https://t.me/Twinnetwork
website https://twin-network.org/
...
contract TwinNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Twin Network";
    string private _symbol = "TWN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x682585803412b96f595a68B878819c358f27737A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5c897beF4887E705dA2F060CC70C991a48A5083B); // BuyBack Address
