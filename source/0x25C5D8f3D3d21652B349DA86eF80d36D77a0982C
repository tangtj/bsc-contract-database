...
contract AOG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"AOG";
    string private _symbol = unicode"$AOG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9dBafCacEd13F14001B7e506F02257dDcA38F194);
    address payable private taxWallet2 = payable(0x9dBafCacEd13F14001B7e506F02257dDcA38F194);
