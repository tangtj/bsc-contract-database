...
contract Cheems is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42000000 * 10 ** uint256(_decimals);
    ...
    uint256 private _taxFee = 280;
    uint256 private _burnFee = 280;
    uint private _max_tx_size = 420000 * 10 ** uint256(_decimals);
