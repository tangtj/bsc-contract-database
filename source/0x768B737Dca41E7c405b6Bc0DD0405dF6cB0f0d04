// 比特币
// Web:     https://bitcoincnbnb.xyz/
// Tg:      https://t.me/bitcoincnbnb
// X:       https://twitter.com/bitcoincnbnb
...
contract BITCOIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFB1165650870eb7ba69685f83bDDa1FcDee11026); 
    address payable public Wallet_Dev = payable(0xFB1165650870eb7ba69685f83bDDa1FcDee11026);
    ...
    string private constant _name = "BITCOIN";  // 比特币
    string private constant _symbol = unicode"BITCOIN"; // 比特币
    ...
    constructor () {
        ...
        _owner = 0xFB1165650870eb7ba69685f83bDDa1FcDee11026;
