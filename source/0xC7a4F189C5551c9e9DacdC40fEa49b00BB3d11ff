...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9E25d10Fb70aaE629391021102101bBb0B51aB86; // owner address
...
contract BonieInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonie Inu";
    string private _symbol = "Bonie";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9E25d10Fb70aaE629391021102101bBb0B51aB86); // Marketing Address
    address payable private teamWalletAddress = payable(0x9E25d10Fb70aaE629391021102101bBb0B51aB86); // Team Address
