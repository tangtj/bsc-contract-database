...
/*
Telegram: https://t.me/SmurfCatBSC
*/
...
contract SmurfCat  is ERC20, Ownable {
    ...
    constructor() ERC20("Smurf Cat", "SMCAT") {
        ...
        marketingWallet = address(0xa5158BD22886b8eFdB06640Abb6C303d3f357Bee); // set as marketing wallet
        devWallet = address(0xa5158BD22886b8eFdB06640Abb6C303d3f357Bee); // set as dev wallet
