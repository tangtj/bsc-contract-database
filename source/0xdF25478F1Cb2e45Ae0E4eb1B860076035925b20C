/**
Telegram https://t.me/XYZCHAINCHANNEL
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa31178Cf990f6EBF009dA66C558d26c84aD1d049; // owner address
...
contract XYZHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XYZ Chain";
    string private _symbol = "XYZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa31178Cf990f6EBF009dA66C558d26c84aD1d049); // Marketing Address
    address payable public teamWalletAddress = payable(0xa31178Cf990f6EBF009dA66C558d26c84aD1d049); // Team Address
    ...
    uint256 public _marketingShare = 49;
