...
interface IDEXRouter {
 ...
 contract Harry  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Harry";
    string constant _symbol = "HARRY";
    ...
    address public devFeeReceiver = 0x9fd7cfb9B9B41ACFf3571529B6BD9a02A0eb9501;
    address public buybackFeeReceiver = 0x9fd7cfb9B9B41ACFf3571529B6BD9a02A0eb9501;
