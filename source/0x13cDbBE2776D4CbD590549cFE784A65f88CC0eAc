/*
Telegram Group : https://t.me/DogeObamaflokishibainu
*/
...
contract $DogeObamaFlokiShibaInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA042eCB590a54D640054cb00eB93ed60c540Aa9a;

    string private constant _name = "DogeObamaFlokiShibaInu";
    string private constant _symbol = "$DOFSI";
    ...
    // Owner cannot transfer out $DogeObamaflokishibainu from this smart contract
