...
contract AsicToken is ERC20, ERC20Burnable, Ownable, AccessControl, ERC20Permit {
    ...
    uint96 public swapThreshold = 50*10**18;
    ...
    uint32 public developerShare = 0;
    ...
    constructor() ERC20("MandYoda Token", "MNYD") ERC20Permit("MandYoda Token") {
    ...
    function _swapBack() internal swapping {
        ...
        uint256 amountBNBdeveloper = amountBNB * developerShare / totalBNBShares;
    ...
    function setShares(uint32 newLiquidityShare, uint32 newMarketingShare, uint32 newdeveloperShare, uint32 newBurnShare) external onlyManager {
        liquidityShare = newLiquidityShare;
        marketingShare = newMarketingShare;
        developerShare = newdeveloperShare;
        burnShare = newBurnShare;
        require(newLiquidityShare + newMarketingShare + newdeveloperShare + newBurnShare == DENOMINATOR, "Incorrect Values");
