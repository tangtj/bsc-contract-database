...
contract LCTExchange is Ownable {
    ...
    function withdrawStake(uint256 index) public {
        ...
        if (timeDiffrence >= 52 weeks) {
            ...
            countIntrest = (unstakeAmount * LCTApyPercent12M) / 100;
