...
contract XPARODI is Context, IERC20, Ownable {
    ...
    string private constant _name = "X PARODI"; // 
    string private constant _symbol = "$XPARODI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xd065c3cC220198496b9d53f76673f6F3b7bb6dAd;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xB2C2F5C92381E2eEde80F2c3BdA9A7e0779774fF;
