...
abstract contract CubMaximiserPCSv2 is Ownable, ReentrancyGuard, Pausable {
    // Maximises yields in pancakeswap, fork of Autofarm
...
contract CubMaximiserPCS_v2 is CubMaximiserPCSv2 {
    constructor(
