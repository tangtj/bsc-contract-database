...
contract Calcium is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x81181922af2ab08087a0A8dd01faFc721DC66Dfa); // Marketing Address
    address payable public buybackWalletAddress = payable(0x81181922af2ab08087a0A8dd01faFc721DC66Dfa); // Buyback Address
