...
contract MultiStake_ADA {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; // ADA
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 8 ether; // 8 ADA
