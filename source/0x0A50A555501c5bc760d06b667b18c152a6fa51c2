...
contract sale is Ownable {
    ...
    function buyToken(uint256 _amount) public payable {
        require(presaleActive, "IDO is not active!");
        ...
        require(_start <= block.timestamp, "IDO comming soon!");
        require(_end >= block.timestamp, "IDO end!");
    ...
    // Withdraw all funds (ETH) function
