...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyLPDividendFee = 198;
    ...
    constructor (
        ...
        maxBuyAmount = 1000 * 10**_decimals;
        maxWalletAmount = 2000 * 10 ** _decimals;
...
contract YD is AbsToken {
    constructor() AbsToken(
        "YD",
        "YD",
        18,
        2888,
        address(0x9c94F6A2BBC5d611CEd4Fb03bc2a7CDcb458cC3f), //fund 1
        address(0x9c94F6A2BBC5d611CEd4Fb03bc2a7CDcb458cC3f), //fund 2 
        address(0xC3076AAa42E6c28D5189856E14f04aAd5103f373) //receiver
    ){
    }
}