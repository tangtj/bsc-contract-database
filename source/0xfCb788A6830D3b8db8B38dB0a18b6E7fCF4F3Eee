...
contract BinanceNova is Context, IERC20, Ownable {
    ...
    string private _name = "lowrisk";
    string private _symbol = "low";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD1a99BD05D19C3943B3549e1187Db69e80fBDC4a);
    address payable public liqWalletAddress = payable(0xD1a99BD05D19C3943B3549e1187Db69e80fBDC4a);
