...
https://t.me/DoggoCoin_BSC
https://twitter.com/DoggoBsc
...
contract DoggoCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Doggo Coin";
    string private _symbol = "Doggo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xc1Aa412010E88d58A5E48d987F96DcD2aa29Cf13);
    address payable public teamWalletAddress =
        payable(0x7905e314b49C63873B6258F9854Fb7bC84BC04AB);
