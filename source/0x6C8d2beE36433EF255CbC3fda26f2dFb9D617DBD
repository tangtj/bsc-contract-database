...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa6184C5c50BeAC8B51b0f59D0E12B705a50ef24C;
...
contract ZXCOIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd868B1fD5d0bC248b8D71eE1A1a95A16F706b997;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZXCOIN";
    string private _symbol = "ZXZX";
