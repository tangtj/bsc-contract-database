...
contract XJBGToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "XJBG";
    string private _symbol = "XJBG";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xCb0922a5556072C3801A934F7b940FDCd9D0f12E));
