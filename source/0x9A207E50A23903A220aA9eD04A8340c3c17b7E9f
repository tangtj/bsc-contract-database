...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcCcE5a764F06B2DC8570dc86cd050fF58D8572ad; // owner address
...
contract PEPE2049 is Context, IERC20, Ownable {
    ...
    string private _symbol = "PEPE2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xcCcE5a764F06B2DC8570dc86cd050fF58D8572ad); // Marketing Address
    address payable private teamWalletAddress = payable(0xcCcE5a764F06B2DC8570dc86cd050fF58D8572ad); // Team Address
