// https://t.me/CatalystEagleBSC
// https://twitter.com/EagleCatalyst
// https://catalyst-eagle.net/
...
contract Eagle is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Catalyst Eagle";
    string private constant _symbol = unicode"$CTE";
