...
Telegram: https://t.me/SquidGameInuOfficial
...
contract SQUIDGAME is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Game Inu"; // 
    string private constant _symbol = "Squid Game"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 9;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x3932F1f2AfED9C1C2cfdD411aa5Eb530307e7D28;
