...
contract Carthanas is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Carthanas';
    string  private constant _SYMBOL = 'CART';
    ...
    uint256 private _CHARITY_FEE = 1000; // 10% TO CHARITY WALLET
