/**
    ...
    Website: cakebot.pro
    Twitter: twitter.com/cakebotpro
    Telegram: t.me/Cakebotportal
    Tutorials: learn.cakebot.pro/
**/
...
contract CakebotV2 is ERC20, Ownable {
    ...
    constructor() ERC20("Cakebot", "Cakebot") {
        ...
        revShareWallet = address(0xD9a2d8686138B8db9883B41516f860293E1f79d8); // set as revShare wallet
