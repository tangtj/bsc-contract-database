...
/**
Telegram:https://t.me/ELDENIUM
Twitter:https://twitter.com/EldeniumLabs
*/
...
abstract contract Ownable is Context {
    ...
    constructor () { 
        _owner = 0x17316Ecc253A2Ed284882AA119dc93Bba687BA0E; // owner address
...
contract ELDENIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eldenium Labs";
    string private _symbol = "ELDENIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17316Ecc253A2Ed284882AA119dc93Bba687BA0E); 
    address payable public teamWalletAddress = payable(0x17316Ecc253A2Ed284882AA119dc93Bba687BA0E);
