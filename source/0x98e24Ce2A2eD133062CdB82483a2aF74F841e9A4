/**
      ...
      DOGE SAGA TOKEN $DOGA
      

      TG =   https://www.t.me/DogeSagaBSC
...
contract DOGA is Context, IBEP20, Ownable {
    ...
    address public marketingWallet =  0xabc38Af4A1B5b986F350C08C79bf63ea981b6992;
