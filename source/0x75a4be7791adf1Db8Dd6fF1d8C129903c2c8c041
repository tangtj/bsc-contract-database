...
/* Heroes Earn Binance launch Pad- BNB Reward Token

website: heroesearn.com
...
contract Hero is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x591B1B26B1B194b63D26Bc10daE40A90dE043019); // Marketing Address
    address payable public charityAddress = payable(0x591B1B26B1B194b63D26Bc10daE40A90dE043019); // Charity/Dev Address
    ...
    string private _name = "Heroes Earn";
    ...
    uint256 public _maxTxAmount = 500000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 500000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 260000000000000000000; // 260; token will be given on airdrop
    ...
    uint256 private salePrice = 500000;// 0.01*5000 token for 0.01 bnb (set as per requirements)
