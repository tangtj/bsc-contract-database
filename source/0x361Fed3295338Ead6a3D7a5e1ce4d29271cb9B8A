...
contract AEuroCatToken is Context, IBEP20, Ownable {
    ...
    address public marketingAddress = 0xf017fa81DBa57982bb78c71e014EEf5d6746Bb93;
    address public TeamAddress = 0xC120d4E70276e80217A41A72A0aff8aDbe5052EE;

    string private constant _name = "Euro Cat";
    string private constant _symbol = "EUCAT";
    ...
    Taxes public Buytaxes = Taxes(1,4,4,0);
    Taxes public sellTaxes = Taxes(1,4,4,0);
    ...
    uint256 public swapTokensAtAmount = 5_400 * 10**_decimals; //Should be 0.1% or lower
    uint256 private maxSellAmount = 1_000_000 * 10**_decimals;
    uint256 private maxBuyAmount = 1_000_000 * 10**_decimals;
    uint256 private maxWalletBalance = 1_000_000 * 10**_decimals;
