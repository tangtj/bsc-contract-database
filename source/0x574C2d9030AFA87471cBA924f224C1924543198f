...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd5475cF91bf9ea9fbA6c94D4635c9eaA832ABB8a; // owner address
...
contract CCGCDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCGC DAO";
    string private _symbol = "CCGC DAO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd5475cF91bf9ea9fbA6c94D4635c9eaA832ABB8a); // Marketing Address
    address payable private teamWalletAddress = payable(0xd5475cF91bf9ea9fbA6c94D4635c9eaA832ABB8a); // Team Address
