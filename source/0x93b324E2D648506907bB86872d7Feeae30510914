...
contract ELONJEET is Context, IERC20, Ownable {
    ...
    string private _symbol = "ELONJEET"; // 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x685DD73bbcBc90a651A295a2D7F17619Bd407EA7); // 
    address payable public teamWalletAddress = payable(0x685DD73bbcBc90a651A295a2D7F17619Bd407EA7); // 
