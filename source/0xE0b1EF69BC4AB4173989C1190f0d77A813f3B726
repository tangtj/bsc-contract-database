...
contract FatCatKiller is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xD501A5D62a4bb4bA01964A3F7CE968Fdc2f13098),
        charity: payable(0x4b15d3E9826B05eD7E4602846494B554c096714B),
        operations: payable(0xB533eFEdc3FE01478B8E9a98EDC6d352b6D4Bc98)
        });
    ...
    uint256 private _maxWalletSize = (_tTotal * 2) / 1000;
