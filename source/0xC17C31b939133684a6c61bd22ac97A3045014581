...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfa8A264cb2286c4bb0a200e373e55a159eD1C408; // owner address
...
contract BarcodeToken is Context, IERC20, Ownable {
    ...
    string private _name = "01010110011100101";
    string private _symbol = "BARCODE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfa8A264cb2286c4bb0a200e373e55a159eD1C408); // Marketing Address
    address payable private teamWalletAddress = payable(0xfa8A264cb2286c4bb0a200e373e55a159eD1C408); // Team Address
