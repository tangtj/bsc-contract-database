...
contract LazyGrimace is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Lazy Grimace";
    string constant _symbol = "LAZYGRIMACE";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xc48C1F29F75d80DA464852dee3b7BD6F471345bf);
        marketingFeeReceiver = address(0x051C25EAB101134e3bae54D8886A32B06817F51c);
