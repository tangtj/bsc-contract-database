...
contract Unibase is Context, IERC20, Ownable {
    ...
    uint256 public _totalTaxIfBuying = 2; // 10% BUY TAX
    uint256 public _totalTaxIfSelling = 100; // 10% SELL TAX
    uint256 private _totalDistributionShares = 2;

   uint256 private _totalSupply = 1_000_000_000 * 10**18; //0 Billion Total Supply
    uint256 public _maxTransactionAmount =   90_000_000 * 10**18; // 3% Max Transaction Limit
    ...
    function TurnOnMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   90_000_000 * 10**18;
    }
