...
//Telegram:https://t.me/tomcoinofficial

//Twitter:https://twitter.com/TomCoin
interface IERC20 {
...
contract TomCoin is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"TOM COIN"; 
