...
contract ElonBlades is Context, IERC20, Ownable {
    ...
    string private _name = "ElonBlades";
    ...
    address payable public marketingWallet = payable(0x5706FF2C3A9Ee7BAbcb77D9FE5a728A482520540);
    ...
    uint256 public numTokensSellToAddToLiquidity = 1500 * 10**18;
