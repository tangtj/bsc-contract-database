...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xCB5EE29aeDb13f533B0e35b9e0EEF016f23C2F5D;
...
contract WeedzToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Weedz Token";
    string private _symbol = "weedz";
    ...
    uint256 internal _tokenTotal = 420_000_000_000_000e9;
    ...
    uint256 public communityFee=1; //100 means 1% will send to charity
    
    
    address communityAddress=0x97e7d698Ee1D69bFe0A3b82B4521C159224c4c21; //
    ...
    uint256 roundValue = value.ceil(communityFee);
    uint256 onePercent = roundValue.mul(communityFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        //Owner fee
        _reflectionBalance[communityAddress] = _reflectionBalance[communityAddress].add(tokensToBurn.mul(rate));
        ...
        emit Transfer(sender, communityAddress, tokensToBurn);
    }
