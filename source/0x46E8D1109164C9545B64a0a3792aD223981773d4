...
StarLABS
StarMEX
StarWALLET : https://play.google.com/store/apps/details?id=com.starworksglobal.starwallet
StarTOKENS
StarCHAIN
StarWORLD
...
contract STARNETWORK is Context, IERC20, Ownable {
    ...
    string private constant _name = "STAR NETWORK";
