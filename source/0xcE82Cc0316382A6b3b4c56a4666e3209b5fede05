...
// Telegram https://t.me/babymemesbsc 
...
contract BabyMemes is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5222b9427993dC040964B21ba04bBa14f403648d);
    address payable private _twdmkt = payable(0x5222b9427993dC040964B21ba04bBa14f403648d);
    
    string private constant _name = "Baby Memes BSC";
    string private constant _symbol = "$BabyMemes";
