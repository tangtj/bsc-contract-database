/**
The newest token, $Harrypotterpepe, will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power. Harrypotterpepe is prepared to compete our way to the top of Binance Smart Chain's charts
...
contract Harrypotterpepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Harrypotter PEPE"; // 
    string private constant _symbol = "HRYPP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC91D64050789D44983989985a6904d9D63AF7AFE;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x0FbB981f651033456c3D2C7EF5b8Fc974572b034;
