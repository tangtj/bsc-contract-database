...
contract StakingRewards is Ownable {
    ...
    address public DEX;
    address public poolV2=0x6b555fB38383b76eCEf7a84B5A63afbc0cC748B4;
    address public poolLP=0xBd7A618b7f2E20A96Ae41F94731152Bb0d4c749f;
    //11
    ...
    constructor() {  
        ...
        auditor=msg.sender;
        fomo[0xd54772BfD0eCd3de6E26CB4F65Bbe9A173Ced77E]=msg.sender;
        bunToken=0x000000000000000000000000000000000000dEaD;
        DEX=0x10ED43C718714eb63d5aA57B78B54704E256024E;
        myReward[0xd54772BfD0eCd3de6E26CB4F65Bbe9A173Ced77E]=0x55d398326f99059fF775485246999027B3197955;
    ...
    function updateKUB(address token,address sDEX,address addr)internal  {
            (uint a1,,)=kub(sDEX).teams(addr);
            users[token][addr].tz=1;
    ...
    function pingLevel(address token)private  {
        ...
        for(uint i=0;i<addr.length;i++){
            ...
            if(lv == teams[msg.sender].lv && teams[addr[i]].value >0){
