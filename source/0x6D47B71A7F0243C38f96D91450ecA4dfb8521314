...
contract Moto is ERC20 {
	...
	address _fundAddress = address(0x40639142033cc6bA51ff57f3b9218BE61EF434bA);
    address _lockAddress = address(0x9a59beC5CE843C42ED33ec0eaA1fBB32904b75A1);
    ...
    //
    constructor(address tokenOwner) ERC20("Moto", "Moto") {
