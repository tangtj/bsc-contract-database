...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD617584B722F4B27FBCb2C6e867e35D6E806D5d5;
...
contract CLACKERS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x85205769f39c49c9531c05080312A6b5e5ce84c0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CLACKERS";
    string private _symbol = "CLACK";
