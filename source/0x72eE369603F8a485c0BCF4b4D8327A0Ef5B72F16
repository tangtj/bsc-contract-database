...
contract FixLP {
    address payable public feeRecipient = 0xd19522B2b17b14BD0C86a2588Cb87d159924b9E5;
    uint256 public feeAmount = 0.001 ether;  // 0.05 BNB fee, using the ether unit for simplicity in Solidity.
