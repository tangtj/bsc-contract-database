 ...
 * Symbol : MGS
 * Telegram : @megaswipe
 * EARN WITH HOLDING TOKEN
 * 4% TO HOLDER / 4% BURNED 
 * --------------- 
 * 50 % OF TOKEN WERE BURNED AT LAUNCH!
*/
...
contract MegaSwipeHoldToken is Context, IERC20, Ownable {
    ...
    string private _name = "Mega Swipe";
