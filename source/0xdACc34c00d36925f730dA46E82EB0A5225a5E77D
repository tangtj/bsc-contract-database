/**
ConnectApp
A Token Unlike Any Other. Forget about flashy video and lengthy white paper. To truly understand and profit it's early stages
https://t.me/ConnectApp
https://ConnectApp.com
*/
...
contract ConnectAppToken is ibep20, Ownable, BaseToken {
    ...
    string public ConnectAppwebsite = "https://ConnectApp.io/";
            function getConnectAppwebsite() public view returns (string memory) {
        return ConnectAppwebsite;
    }
