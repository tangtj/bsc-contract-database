...
contract SpaceAgent is IERC20 {
    ...
    string constant private _name = "SpaceAgent";
    string constant private _symbol = "SpaceAgent";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xC0C47f85310c39714063A807054cA1410a9292aB),
        team: payable(0x8350f564055e0C6a4cd9893A2C5F379b8Ef09B2d)
    });
