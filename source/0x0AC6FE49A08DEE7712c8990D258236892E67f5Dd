...
contract OYOLPDividend is Ownable {
    ...
    constructor() {
        fundAddress = address(0x71dE427bFa137E0715Ab326AE182Ea352EB7b460);
    ...
    uint256 private rewardCondition = 500 * 10**18;
