...
/*
   _____                      ____   ____                 
  / ___/____  ____     ____  / __/  / __ \____  ____ ____ 
  \__ \/ __ \/ __ \   / __ \/ /_   / / / / __ \/ __ `/ _ \
 ___/ / /_/ / / / /  / /_/ / __/  / /_/ / /_/ / /_/ /  __/
/____/\____/_/ /_/   \____/_/    /_____/\____/\__, /\___/ 
  
*/

// Project name: SON OF DOGE - THE FINAL CHAPTER
// TG: https://t.me/sodfinalchapter
// Dev: @seanking52
...
contract SonOfDogeFinal is Context, IERC20, Ownable {
    ...
    string private constant _name = "Son of Doge Final";
    string private constant _symbol = "SODTFC";
    ...
    uint256 private constant _originalBuyTaxFee = 200;
    uint256 private constant _originalBuyLiquidityFee = 0;
    uint256 private constant _originalBuyMarketingFee = 400;
    uint256 private constant _originalBuyDevFee = 300;    
    ...
    uint256 private constant _originalSellTaxFee = 200;
    uint256 private constant _originalSellLiquidityFee = 0;
    uint256 private constant _originalSellMarketingFee = 400;
    uint256 private constant _originalSellDevFee = 300;

    uint256 public _sellTaxFee = 0;
    uint256 public _sellLiquidityFee = 600;
    uint256 public _sellMarketingFee = 600;
    uint256 public _sellDevFee = 600;
    ...
    constructor() {
        ...
        marketingAddress = payable(0x74D8a1bC7dd77a1A429c13A011204fE797feDEc7); // Marketing Address
        liquidityAddress = payable(address(owner())); // Liquidity Address
        devAddress = payable(0x38119574D509C111856cDD6cC94DcB2AF16695dc); // Dev Address
        ...
        _isExcludedFromFee[
            address(0x6814e1b378188fbc333Ac3f6096FF02B35A34CE8)
        ] = true; // Wallet for bridge
    ...
    function setMaxTransaction() external onlyOwner returns (bool) {
        limitsInEffect = true;
        gasLimitActive = false;
        transferDelayEnabled = false;
        return true;
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev = ethBalance.mul(_devTokensToSwap).div(
            totalTokensToSwap
        );
    ...
    function setBuyFee(
        ...
        require(
            _buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyDevFee <=
                1000,
    ...
    function setSellFee(
        ...
        require(
            _sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellDevFee <=
                2000,
    ...
    function restoreBuyTax() external onlyOwner {
        _buyTaxFee = _originalBuyTaxFee;
        _buyLiquidityFee = _originalBuyLiquidityFee;
        _buyMarketingFee = _originalBuyMarketingFee;
        _buyDevFee = _originalBuyDevFee;
    }    

    function restoreSellTax() external onlyOwner {
        _sellTaxFee = _originalSellTaxFee;
        _sellLiquidityFee = _originalSellLiquidityFee;
        _sellMarketingFee = _originalSellMarketingFee;
        _sellDevFee = _originalSellDevFee;
    }
