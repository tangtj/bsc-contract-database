...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf219bE0aD238c255592520ff7aE696d56b9898d1;
...
contract OPPAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf219bE0aD238c255592520ff7aE696d56b9898d1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OPPAI";
    string private _symbol = "OPP";
