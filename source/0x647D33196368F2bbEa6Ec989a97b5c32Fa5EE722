...
contract Cypherium is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDivyExcluded;
    ...
    constructor() payable ERC20 ("Cypherium", "Cyph") {
        ...
        marketingWallet =  0xFE48a179ae917d63309756E9784e69e7cd2fB832;
        ...
        _isWalletExcluded[0xFE48a179ae917d63309756E9784e69e7cd2fB832] = true;
    
        _mint(owner(), 1000000 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000 * 2;
    }
