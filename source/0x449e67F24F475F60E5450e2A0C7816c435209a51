...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6268039923e0aaec593cD10007Cc955A988C62Bd; // owner address
...
contract CCDGS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDGS";
    string private _symbol = "CCDGS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6268039923e0aaec593cD10007Cc955A988C62Bd); // Marketing Address
    address payable private teamWalletAddress = payable(0x6268039923e0aaec593cD10007Cc955A988C62Bd); // Team Address
