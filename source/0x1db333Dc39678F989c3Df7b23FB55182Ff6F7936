/*
Jujiao 豬腳飯
物慾橫流的世界，只有豬腳飯在乎你飽不飽。 男人的加油站，隆江豬腳飯！
...
contract Jujiao is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Jujiao";
    string private _symbol = "Jujiao";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd91E0F182fa31a18E0F43A26e470DCBa173b8DD4);
    address payable public liqWalletAddress = payable(0xd91E0F182fa31a18E0F43A26e470DCBa173b8DD4);
