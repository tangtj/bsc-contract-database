...
// This token is intended for use by private investors and internal producers only.
// Barbie Movies Fund

// All taxes will be used to fund the next Barbie movie.
// $145 million invested in the first movie.
// Partners: Greta Gerwig, Margot Robbie, Tom Ackerley, Robbie Brenner, David Heyman, Amy Pascal.
// All profits from the next movie will be used to buy/burn this loan token.
...
contract BarbieFund is Context, ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 public constant MAX = ~uint256(0);

    address payable public _fundAddress = payable(0xfb79D81d483c4a80F61181C5eF191996E8Ae7D40);
    address public _currency;
    address public _creatorAddress;

    uint256 public _buyFee = 1000; // 10%
    ...
    constructor() ERC20("Barbie Movies Fund", "BARB34") payable  {
        _mint(msg.sender, 145000000 * 10 ** decimals());
