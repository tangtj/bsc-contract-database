...
https://t.me/BackrubPortal

https://twitter.com/BackrubOffical

JOIN BACKRUB OLD GOOGLE NAME. EASY PUMP
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC44A1a710544763603efdd7f74432C388f7f63ba;
...
contract $BackRubToken is Context, IERC20, Ownable {
...
//create a mapping to keep track of who is blacklist
    ...
    address private _developmentWalletAddress = 0xC44A1a710544763603efdd7f74432C388f7f63ba;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Back Rub Token";
    ...
    function _transfer(
        ...
        //Blacklisted address can not buy or sell or transfer! if you have ever use a bot, or scammed anybody, then your wallet address will probably be Blacklisted.   
