...
contract Xrp20 is ERC20, Ownable {
    ...
    mapping (address => bool) private _isXrp20Excluded;
    mapping (address => bool) private _isXrp20Included;
    mapping (address => bool) private _isDiviExcluded;
    ...
    constructor() payable ERC20 ("Xrp20", "Xrp20") {
        ...
        marketingWallet =  0x11100B95c5FE6294ff9387eAFB442b23d4F32842;
        ...
        _isWalletExcluded[0x11100B95c5FE6294ff9387eAFB442b23d4F32842] = true;
        _isWalletExcluded[0xb92719B5DB323AfDd797C7a3b5a322904DBdA33B] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000 * 3;
    }
