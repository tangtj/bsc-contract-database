...
contract DragonKingTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public evcbdg12;
    ...
    string private _tokenname = "DragonKing";
    string private _tokensymbol = "DragonKing";
