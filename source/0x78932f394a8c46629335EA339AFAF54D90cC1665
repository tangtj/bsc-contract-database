        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xcaA45dbDf0e857668fB79FC4f6aAd5db855408aE), block.timestamp
                );
            }
        }
    }
...
contract DanDeLion is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        16800,//Supply
        address(0x2c8878Ab1de8617E109B6064F214A9F7ee7c4b9F),//FundAddress
        address(0xcaA45dbDf0e857668fB79FC4f6aAd5db855408aE)//ReceiveAddress
    ){
    }
}