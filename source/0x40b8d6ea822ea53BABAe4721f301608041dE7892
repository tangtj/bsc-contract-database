...
contract WAGMI is Context, IERC20, Ownable {
    ...
    string private _name = "WAGMI BSC";
    string private _symbol = "$WAGMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdc594551B9fd30ace66f9B965dBC90072700f057); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa65701ac68A313db67F8C64AA874De91bB81619e); // Buyback Address
