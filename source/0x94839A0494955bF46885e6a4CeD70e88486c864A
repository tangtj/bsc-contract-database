/**
    ...
    10% Tax Fee: 7% to LP, 3% to Holders
    LIQ + RFI
    
    Total Supply: 1 Quad.
    Supply Burn: 500 Trill. (50%)
    
    Telegram: t.me/WokeDoge
    Twitter: twitter.com/WokeDogeBSC
...
contract WokeDoge is Context, IERC20, Ownable {
