...
contract yuankaka is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "yuankaka";
    string private _symbol = "yuankaka";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0bA90FA6e948dd7d285692FECaeA4F1426151d51); 
    address payable public teamWalletAddress = payable(0x06AcdD23283C66B2d50940615e550F9206276B66); 
