...
8GHT is a fast growing community place and discover the incredible potential of this up and coming project.
...
contract EIGHT is Context, IERC20 { 
    ...
    string private constant _name = "8GHT";
    string private constant _symbol = unicode"$8GHT";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 8000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x5dD70E81ACBEf36852CB2826ee50430baAC7E31A);
    address payable public MarketingWallet = payable(0xdeFB93ABCB0e8253898294D5b68E181102023173);
