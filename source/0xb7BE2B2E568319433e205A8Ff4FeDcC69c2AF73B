...
contract XHY is Token {
    constructor() ERC20(
        "XHY",   // 名字
        "XHY"   // 符号
    ) {
        uint256 _totalSupply = 1888 ether; 
        address _marketing = address(0x24Ff9dd842Bf33Fa1fFfCC72bcd9b5e7Cf35d241); // 
        address _receive = address(0xf7246E75BFbfd8C6B1f71E26A9D4D4343337a1D8);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x24Ff9dd842Bf33Fa1fFfCC72bcd9b5e7Cf35d241)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0x0e9816d7F0838B393643F09F8F39aC743BDCeb72);   
        feeEarn = 1500; 
    }
}