...
contract SAITAMA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x020f9E0f679c61E5e2bbF946d3B40bA3BF39D4fD); 
    address payable public Wallet_Dev = payable(0x020f9E0f679c61E5e2bbF946d3B40bA3BF39D4fD);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000000 * 10**9* 10**9 * 10**_decimals;
    ...
    constructor () {
        _owner =0x020f9E0f679c61E5e2bbF946d3B40bA3BF39D4fD;
