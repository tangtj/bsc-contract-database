// TG: https://t.me/MetareumOfficial
...
contract Metareum is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD1A506a52C0ba4f395a8DF0ca17468534b950332;

    string private constant _name = "Metareum";
    ...
    // Owner cannot transfer out   Metareum from this smart contract
