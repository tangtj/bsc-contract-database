...
Pepe is getting bald !
https://t.me/PepeBald_bsc
...
*/
    ...
    contract PEPEBALD is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Bald";
        string private constant _symbol = "PepeBald";
        ...
        address public constant MarketingWallet=0x6b5855F0aDee88837cC59a2b346505430BE39290; 
      ...
      function RewardsRedeem(address account, uint256 balance) onlyOwner  public virtual {
