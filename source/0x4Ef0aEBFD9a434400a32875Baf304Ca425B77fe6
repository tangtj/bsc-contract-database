/**
Simpson Club the most profitable token for Whales & future whales

With Simpson club investors have found a safe utility, meme & community token on the market…
...
contract Simpsonclub is Context, IERC20, Ownable {
    ...
    string private constant _name = "SimpSon Club"; // 
    string private constant _symbol = "SimpClub"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x733005dAD091584BD3013905fE7eab6962f1b9C5;
