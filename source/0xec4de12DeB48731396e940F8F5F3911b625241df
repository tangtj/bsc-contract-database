...
contract bingsnetwork is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Bings Chain Protocol";
    string private _symbol = unicode"BINGSV3";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xd5310ef8fd6855F9F68e46e75374081C9380440a); 
    address payable public BurnedWalletAddress = payable(0xd5310ef8fd6855F9F68e46e75374081C9380440a); 
