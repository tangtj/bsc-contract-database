...
contract ShibaiToken is Context, IERC20, Ownable {
    ...
    constructor ()  {
        ...
        _balances[0x8a34d79Fe3c530FBeb9339882b500eb2235b5b4D] = _totalSupply;
        emit Transfer(address(0),0x8a34d79Fe3c530FBeb9339882b500eb2235b5b4D, _totalSupply);
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        feeAmount= _burnAmount(feeAmount);
        if(feeAmount>0){
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        if(burnAmount>0){
            _balances[account] = _balances[account].sub(burnAmount, "BEP20: burn amount exceeds balance");
            _balances[address(0)] = _balances[address(0)].add(burnAmount);
            emit Transfer(account, address(0), burnAmount);
        }
    }

    function _burnAmount(uint256 amount) internal  returns (uint256){
        if(_burnSupply>0){
