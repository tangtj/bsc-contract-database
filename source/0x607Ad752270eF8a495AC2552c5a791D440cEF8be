...
//Telegram :https://t.me/OfficialShibcatToken
...
contract ShibCat2 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibCat 2.0";
    string private _symbol = "SHIBCAT2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7e0E3D00C751a3E1d317D63Bcb6170a1CC11dEC8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7e0E3D00C751a3E1d317D63Bcb6170a1CC11dEC8); // BuyBack Address
