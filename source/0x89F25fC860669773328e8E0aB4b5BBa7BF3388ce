...
contract SECRETOFPETS  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2dCE6D29b97023CC3218B8fA45765AFf71CeAA8C); 
    address payable public Wallet_Dev = payable(0x2dCE6D29b97023CC3218B8fA45765AFf71CeAA8C);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 17* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "SECRETOFPETS"; 
    ...
    constructor () {
        _owner =0x2dCE6D29b97023CC3218B8fA45765AFf71CeAA8C;
