/*
Introducing X SAITAMA, the groundbreaking cryptocurrency project that aims 
to transform the gaming industry by combining the excitement of gaming with the power of 
blockchain technology. Our mission is to create a seamless ecosystem where players can enjoy their 
favorite games while earning and trading X SAITAMA, our native cryptocurrency
...
TG: https://t.me/xsaitamabsc
Website:xsaitama.net (not live)
*/
...
contract XSAITAMA is Context, IERC20, Ownable {
    ...
    string private constant _name = "X SAITAMA";
