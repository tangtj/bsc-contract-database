...
contract StevedoreX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Stevedore X";
    string private _symbol = "STVDX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x277B196AA1E7DFF981514ee8179C6Cc80dF05D35); // Marketing Address
    address payable public teamWalletAddress = payable(0x15994861b4977C46485cFf92092Ef56f69381085); // Team Address
