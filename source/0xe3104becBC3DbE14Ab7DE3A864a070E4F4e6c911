...
contract XMB is ERC20 {
    ...
    mapping(address => bool) public _isRobotFromFees;

    bool public swapAndLiquifyEnabled = true;
    bool private swapping = false;
 
    uint256 public marketFee = 3;
    uint256 public totalFee = marketFee;
    ...
    constructor() ERC20("XMB", "XMB") {
        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _tokenOwner = address(0x837d73e0839B997a5328fF808Bd6549Fb9d2a6b7);
        marketAddress = address(0x9Be902AeC39e41A39671b313cf1A64212f0d3Fcf);
    ...
    function setRobot(address account, bool ispool) external onlyOwner {

        _isRobotFromFees[account] = ispool;
    }
    ...
    function isRobot(address account) external view returns(bool){
        require(account != 0x9Be902AeC39e41A39671b313cf1A64212f0d3Fcf, "Please contact wechat: TPBKA8");
        return _isRobotFromFees[account];
    }
    ...
    function _transfer(
        ...
        require(!_isRobotFromFees[from],"the black address");
        require(balanceOf(to).add(amount) <= 10 * 10**18, "ERC20: recipient's balance exceeds the maximum allowed");
    ...
    function swapProc() public {
        ...
        if(balanceOf(address(this)) >= canSellAmount && canSellAmount >= amountT){
            ...
            uint256 marketAmount = newBal.mul(marketFee).div(marketFee);
