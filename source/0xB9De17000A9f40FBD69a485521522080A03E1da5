/*
$ZWX - Hidden 1000x GEM - Bep20 - renounced - 0% tax - MicroLp - MicroGem
Unique Japanese Shiba Name 

🔒 Ownership Renounced ✅
🔐 Liquidity Pool Locked ✅1 year
🚫 0% Tax 🚫0% Buy / 0% Sell 🚫

Shill Your Bag or Send Good Vibes 
...
contract ZWXToken is Context, ZWXECO, Ownable {
    ...
    string private _name = 'ZWX';
    string private _symbol = 'ZWX';
    uint8 private _decimals = 9;
    string public constant ZWXContractuniqueness = "Contract uniqueness : Unique contract";
    string public constant ZWXblog = "https://ZWX.blog/";
    string public constant ZWXtelegram = "https://t.me/ZWXToken";
    string public constant ZWXaudited = "ZWX is audited by: https://www.certik.com/";
    address private marketingAddress = 0x0D0707963952f2fBA59dD06f2b425ace40b492Fe;
    string public ZWXwebsite = "https://ZWX.io/";
            
    function getZWXwebsite() public view returns (string memory) {
        return ZWXwebsite;
    }
    string public ZWXofficialwebsite = "https://ZWX.io/";
            function getZWXofficialwebsite() public view returns (string memory) {
        return ZWXofficialwebsite;
    }
