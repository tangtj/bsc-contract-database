...
// https://t.me/shiba_twopoint
// https://twitter.com/Shiba_Twopoint
// https://www.youtube.com/channel/UC9Avf8R9i8Jophs-4MvE3-Q
// Website :
...
contract SHIB20 is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 8400000000000 * 10**_decimals; //

    address public marketingAddress = 0x07c372Ca37Ef1623C704a3bBa3590A22C6bcf0c1; //
    address public devAddress = 0x07c372Ca37Ef1623C704a3bBa3590A22C6bcf0c1; //
    ...
    Taxes public taxes = Taxes(0,10,20,0); //
    ...
    // Owner cannot transfer out SHIB 2.0 from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SHIB 2.0");
