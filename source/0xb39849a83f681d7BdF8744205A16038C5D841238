...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (_swapPairList[sender] && !isRemoveLP) {
            _buyAmount[recipient] += tAmount * _sellRate / 10000;
        ...
        if (takeFee) {
            if (isRemoveLP) {
                ...
                require(_buyAmount[sender] >= tAmount);
                _buyAmount[sender] -= tAmount;
                isSell = true;
...
contract TiP is AbsToken {
    ...
    //SwapRouter
        ...
        18,
        10000,
        address(0xc81B8014B1fBde1D18A4e3416e046AcdC2B7415b),
        address(0xc81B8014B1fBde1D18A4e3416e046AcdC2B7415b),
        address(0x7bdDBE77435c812342C9E7e507966C0A1E0A1369),
        0,
        0,
        0
    ){
