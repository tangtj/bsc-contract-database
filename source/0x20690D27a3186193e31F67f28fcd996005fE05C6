...
contract Hceo is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private limitBurn = 100000 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 10000 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 10000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 10000 * _decimalFactor; // 0.75% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 1500 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "HolderCeo";
    string private _symbol =  "Hceo";
    /*=== Modifiers ===*/
    ...
    constructor() {
        ...
        _excludeFromFee[address(0x281Ab5943b44F4824006F691c451be43e5e9a167)] = true; // Define Contrato como True para não pagar Taxas
