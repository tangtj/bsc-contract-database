...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private teamAddress = address(0x43a074978a8AFC1006405c1cDa30b3b05D475dCE);
    ...
    uint256 public _walletMax = 2 * 10**18;    
    ...
    uint256 private _marketShare = 25;
        ...
        if (takeFee) {
            ...
            if (isRemove) {
                ...
                if (block.timestamp <=  _startTradeTime + _removeLPFeeDuration) {
                    ...
                    uint removeFeeAmount = tAmount * 10000 / 10000;
                    if (removeFeeAmount > 0) {
                        feeAmount += removeFeeAmount;
                        _takeTransfer(sender, fundAddress, removeFeeAmount);
                    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount.mul(6).div(10));
        USDT.transferFrom(address(_tokenDistributor), teamAddress, fundAmount.mul(4).div(10));
...
contract MODADAO is AbsToken {
    constructor() AbsToken(
        ...
        18,
        5500,
        address(0x43a074978a8AFC1006405c1cDa30b3b05D475dCE),
        address(0x43a074978a8AFC1006405c1cDa30b3b05D475dCE)
    ){
