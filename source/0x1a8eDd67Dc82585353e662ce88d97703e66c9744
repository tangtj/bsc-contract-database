...
TG: https://t.me/TogeInumakiPortal
...
contract TogeInumaki is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Toge Inumaki';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x4189202d65CeC417ea7ffdDFCAff93E1E7826647);
    address public Development=payable(0x155A30Bc55b3ecc0c2261b15F1784cAce4616722);
    //TestNet
