// https://t.me/CaTrump
// https://twitter.com/CATRUMP_TOKEN
// https://catrump.online/
...
contract CatTrump is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cat Trump Token";
    string private constant _symbol = unicode"CATRUMP";
