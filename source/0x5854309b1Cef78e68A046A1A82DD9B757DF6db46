...
contract ZAZA is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0x5E05dd2FC34F6473cCC22a3B764854CC448B5732);
    address payable private _mkt = payable(0x5E05dd2FC34F6473cCC22a3B764854CC448B5732);
