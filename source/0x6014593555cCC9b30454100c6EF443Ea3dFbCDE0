...
contract UUDT is Context, IERC20, Ownable {
    ...
    string private _name = "Universal Utility Decentralized Token";
    string private _symbol = "UUDT";
    uint8 private _decimals = 8;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tSupply = 210000000 * 10**8; // 21Cr
    ...
    address public _ownerAddress = 0x5bb73C5a53A24D09d42406E60c448DD8ABCcF614;
    address public _liquidityAddress = 0x5bb73C5a53A24D09d42406E60c448DD8ABCcF614;
    ...
    function burn(uint256 tBurn) external {
       ...
       require(sender != address(_deadAdderess), "BEP20: burn from the burn address");

       uint256 balance = balanceOf(sender);
       require(balance >= tBurn, "BEP20: burn amount exceeds balance");
