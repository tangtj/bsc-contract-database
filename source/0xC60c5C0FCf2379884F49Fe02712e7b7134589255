...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private fund1Address = 0x614d488b02aB07D48F9B7F7aceE44F2f20e92C42;  
    ...
    uint256 public numTokensSellToFund = 10000000000000000000;  
    ...
    constructor (
        ...
        holderRewardCondition = 5 * 10 ** IERC20(TradeAddress).decimals();//  
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _tradeAddress, lpAmount, lpFist, 0, 0, fund1Address, block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x614d488b02aB07D48F9B7F7aceE44F2f20e92C42),
    
        address(0x7C3a6156E3aDC7851543788809bF74054c891888)
    ){
