...
contract PegeInu is Context, IERC20 {
    string private _name = "PEGE INU";
    ...
    address payable public MarketingWallet = payable(0x9997251f0b1Ae6f75f27FbD1955fe97462bC034c);
