...
Telegram https://t.me/electronovaofficial
Website https://electronova.id
*/
...
contract Electronova is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELECTRONOVA";
    string private _symbol = "$TROV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57b5D310e2285814bC87CF7f2a51528A84d0cD50); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xeb8fF9150364C3AD33306A8b3086a93A8EEE8935); // BuyBack Address
