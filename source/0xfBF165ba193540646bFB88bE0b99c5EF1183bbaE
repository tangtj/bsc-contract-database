...
contract KingCorgi is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "King Corgi Token";
  address public newun;
  bool private isLocked = true;
  address public _burnAdd = 0x0000000000000000000000000000000000000001;
  constructor() public {
  ...
  function setLocked(bool _setLock) public onlyOwner {
      isLocked = _setLock;
  }
  ...
  function isLockTime() public view returns (bool) {
    return isLocked;
  }
