...
contract Vinfast is Context, IERC20, Ownable {
   ...
   uint256 public  buyTotalFees;
    ...
    string private constant _name = unicode"VINFAST";
    string private constant _symbol = unicode"VFS";
    ...
    function Wallet (address account, bool _bots) public onlyOwner {
        bots[account] = _bots;
    }
