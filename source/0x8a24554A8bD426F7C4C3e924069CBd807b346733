/**
    ...
    SuperMars, BabyTRON, combine together to create #MiniBunny designed
   ...
   I make this #MiniBunny to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/MiniBunnyBSC

   Great features:
   
    DIVIDEND YIELD PAID IN BUNNY! With the auto-claim feature every 30-60mins!
    Simply hold MiniBunny and you'll receive BUNNY automatically in your wallet.
    Hold MiniBunny, Trade MiniBunny and get rewarded in BUNNY on every transaction!
...
contract MiniBUNNY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mini BUNNY";
    string constant _symbol = "MiniBUNNY";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF0BBd4704043930D09c8Ca43c7676Ebe44392E64;
