...
contract MiningReconcile is Pausable, Ownable {
    ...
    function claim(address _user_, uint _tkn_, uint _version_) public payable whenNotPaused returns (uint _version, address _user, uint _tkn,uint _totalShares,uint _totalDays, uint _totalRatio){
