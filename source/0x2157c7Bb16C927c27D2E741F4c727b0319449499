/**
// https://t.me/DorkDogeOfficialBSC
// https://twitter.com/DorkDoge
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe948e4c58c4194c917C5eDb4b22Bf974c4e4BAB5; // owner address
...
contract DorkDogeOfficialBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DorkDorge";
    string private _symbol = "$DORGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe948e4c58c4194c917C5eDb4b22Bf974c4e4BAB5); // Marketing Address
    address payable private teamWalletAddress = payable(0xe948e4c58c4194c917C5eDb4b22Bf974c4e4BAB5); // Team Address
