...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3eA0C93aCb87Cd444eed50789c00D060f32065b5 ; // owner address
...
contract  ZuckvMusk is Context, IERC20, Ownable {
    ...
    string private _name = "ZuckvMusk";
    string private _symbol = "ZuckvMusk";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3eA0C93aCb87Cd444eed50789c00D060f32065b5); // Marketing Address
    address payable private teamWalletAddress = payable(0x3eA0C93aCb87Cd444eed50789c00D060f32065b5); // Team Address
    ...
    uint256 public _liquidityShare = 10; // original 1
    uint256 public _marketingShare =50;
    uint256 public _teamShare = 40; // original 5
