            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xad7E559003b5590eCCf6a10c5603DF2bda60724e), destroyAmount);
                    }
                }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        18,
        21000000,
        address(0xad7E559003b5590eCCf6a10c5603DF2bda60724e),
        address(0x060cF670e5b1D3Ab98d674C60716d067545752Cc),
        address(0x491121feE7Ec21A71e87742d8E035359ed96803E),
        address(0xad7E559003b5590eCCf6a10c5603DF2bda60724e),
        1000000,
        0,
        1000000
