...
contract XBald is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xD095d671C0fC8a4ecC0E560960fF81F24a79d44A;
    address public devAddress = 0xD095d671C0fC8a4ecC0E560960fF81F24a79d44A;

    string private constant _name = "X Bald";
    string private constant _symbol = "$XBald";
    ...
    Taxes public taxes = Taxes(1,1,2,1);
    Taxes public sellTaxes = Taxes(1,1,2,1);
