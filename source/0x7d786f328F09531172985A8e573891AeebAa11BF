...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x566085b46Ec182AFC4cFEbA8a3fFDbb86DAf0A91; // owner address
...
contract YYDSS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YYDSS";
    string private _symbol = "YYDSS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x566085b46Ec182AFC4cFEbA8a3fFDbb86DAf0A91); // Marketing Address
    address payable private teamWalletAddress = payable(0x566085b46Ec182AFC4cFEbA8a3fFDbb86DAf0A91); // Team Address
