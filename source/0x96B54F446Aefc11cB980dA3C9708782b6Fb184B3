...
contract FomoBonk is Context, IBEP20, Ownable {
    ...
    string private _name = "FomoBonk";
    string private _symbol = "FOMOBONK";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap =0x5918F9dF3B7D9BF74B7Ae4045dCC237767DDF74E;
