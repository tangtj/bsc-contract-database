...
contract MBP_NEXA_T1_IDO is Context, Ownable {
    ...
    uint256 private MINIMUM_INVESTMENT = 300 * (10**18);
    uint256 private MAXIMUM_BUY_AMOUNT = 600 * (10**18);
    ...
    uint256 private HARDCAP = 73_200 * (10**18);
