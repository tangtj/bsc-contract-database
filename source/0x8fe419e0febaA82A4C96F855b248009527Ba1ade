...
contract PEPEXK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPEXK";
    string private _symbol = "PEPEXK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x652b9c29d8403bfF83F64891940776BCAEdD00A2);
    address payable public teamWalletAddress = payable(0x652b9c29d8403bfF83F64891940776BCAEdD00A2);
    address public immutable deadAddress = 0x652b9c29d8403bfF83F64891940776BCAEdD00A2;
