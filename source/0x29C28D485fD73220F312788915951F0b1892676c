...
contract DoraemonX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DoraemonX";
    string private _symbol = "DoraemonX";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x971c6b7BA63e5A39cF94D155b83943E85E8646b3); 
    address payable private teamWalletAddress = payable(0x971c6b7BA63e5A39cF94D155b83943E85E8646b3); 
