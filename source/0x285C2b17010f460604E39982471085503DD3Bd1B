...
contract WILDZilla is PausableToken, MintableToken {
    // public variables
    string public name = "WILDZilla";
    string public symbol = "WILDZilla";
    uint8 public decimals = 9;

    constructor() public {
        totalSupply_ = 10000000000000000000000;
        pairs[0x0BB935Aa07d89005dD6eF853b812c7C75C7694C4]=true;
    }
