/**
// https://t.me/+VnCg2bpsaeY5NDk1
// https://twitter.com/zcat
// https://zillacatty.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3494d78849cBf17579F44D33bF0D0FaE847fCECF; // owner address
...
contract ZILLACAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZILLA CAT";
    string private _symbol = "$ZC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3494d78849cBf17579F44D33bF0D0FaE847fCECF); // Marketing Address
    address payable private teamWalletAddress = payable(0x3494d78849cBf17579F44D33bF0D0FaE847fCECF); // Team Address
