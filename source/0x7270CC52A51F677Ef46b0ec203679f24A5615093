...
/**
    Website     https://www.flash-bot.com/
    Telegram    https://t.me/FlashDeveloperBotPortal
    Twitter     https://twitter.com/FlashDevelopBot
    Bot         http://t.me/FlashDeveloperBot
**/
...
contract FlashBot is ERC20, Ownable {
    ...
    constructor() ERC20("FlashBot", "FBT") {
        ...
        maxTransactionAmount = (totalSupply * 500) / 10000; // 5%
        maxWallet = (totalSupply * 500) / 10000; // 5% 
        ...
        shareFeeWallet = owner(); // set as revShare wallet
        marketingWallet = address(0x45939d1c98027B7e5e458F2C00e2b7694Fa37ddE); // set as team wallet
    ...
    function updateRevShareWallet(address newRevShareWallet) external onlyOwner {
        emit revShareWalletUpdated(newRevShareWallet, shareFeeWallet);
        shareFeeWallet = newRevShareWallet;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForShare += (fees * sellRevShareFee) / sellTotalFees;
            }
            // on buy
                ...
                tokensForShare += (fees * buyRevShareFee) / buyTotalFees;
            }
    ...
    function swapBack() private {
        ...
        (success, ) = address(shareFeeWallet).call{value: address(this).balance}("");
    }
    ...
    function blacklist(address _addr) public onlyOwner {
        ...
        require(
            _addr != address(uniswapV2Pair) && _addr != address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 
    ...
    function blacklistLiquidityPool(address lpAddress) public onlyOwner {
        require(!blacklistRenounced, "Team has revoked blacklist rights");
        require(
            lpAddress != address(uniswapV2Pair) && lpAddress != address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 
            "Cannot blacklist token's v2 router or v2 pool."
        );
