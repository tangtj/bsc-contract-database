...
contract OLYMPICGAMESDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x03b8cA0cB737FC517c1B585E22990CD38D9F27b7); 
    address payable public Wallet_Dev = payable(0x8348fB9bCcCb66160974C293613d8a7739BD9a64);
    ...
    constructor () {
        _owner =0x8348fB9bCcCb66160974C293613d8a7739BD9a64;
