...
contract TwoDollarLP is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x4B7Fe1EB77FA60461BBb302081FbDE7C55567EFe);
    address payable private _twdmkt = payable(0x4B7Fe1EB77FA60461BBb302081FbDE7C55567EFe);
    
    string private constant _name = "Two Dollar Lp";
