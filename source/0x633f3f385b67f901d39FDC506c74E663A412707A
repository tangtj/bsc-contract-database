...
contract Zentic_Staking {
    using SafeMath for uint256;

    address public signer;
    
    BEP20 Zentic = BEP20(0xff5C5B0Ed2099f6B821E1fA5bd4BF64eEc172355);
    ...
    function deposit(uint256 _amount) public security{
        require(Zentic.transferFrom(msg.sender,address(this),_amount));
