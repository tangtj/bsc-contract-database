...
contract METACOURSE is Context, IERC20, Ownable {
    ...
    address public devWallet = 0xAC03CC9b72c2754A8fdF56195C81cF7DdDBc0DFf;
    address public marketingWallet = 0x0Da912bFbBA86766AF34a0B4b84e8F8A4F5bE779;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000000 * 10**17;
    uint256 public _maxTxAmount = 10000000000000000 * 10 **17;
