...
TW https://twitter.com/FuCoinTTM
TG https://t.me/+5kTVa6-fXhA5OTMx
#FUCOIN features:
   2% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   2% fee auto send to marketing
...
contract FuCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FuCoin";
    string constant _symbol = "FUCN";
