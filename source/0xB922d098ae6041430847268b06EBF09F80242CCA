/**
https://t.me/flokitwoportal
https://floki2.is-best.net
...
contract Floki20 is Context, IERC20, Ownable {
    ...
    string private _name = "Floki20";
    string private _symbol = "FLOKI20";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xb06Bc2219215f1A92fEF3c1Ef8bde9784c3b9313); // Marketing Address
    address payable public teamWalletAddress = payable(0xb06Bc2219215f1A92fEF3c1Ef8bde9784c3b9313); // Team Address
