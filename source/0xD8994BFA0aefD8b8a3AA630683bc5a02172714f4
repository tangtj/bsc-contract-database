...
// Telegram: https://t.me/Line_Protocol
...
contract LINEProtocol is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x1db9fea2AFefcD41979c55fcB34b8a2CDF99EDD0);
    address payable private _twdmkt = payable(0x1db9fea2AFefcD41979c55fcB34b8a2CDF99EDD0);
    
    string private constant _name = "LINE PROTOCOL";
    string private constant _symbol = "LINE";
