...
contract GEAR5 is Context, IERC20, Ownable {
    ...
    string private _name = "Luffy Son God Nika";
    string private _symbol = "GEAR5";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCaF5B268DD38346b79dC5497211457D105B1929E); // Marketing Address
    address payable public teamWalletAddress = payable(0xCaF5B268DD38346b79dC5497211457D105B1929E); // Team Address
