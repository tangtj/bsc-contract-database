/**
Telegram: https://t.me/babypepenewBSC
*/
...
contract babypepe is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingWallet = payable(0xAF2361769897852a2499424ca16bc3729A032953);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xAF2361769897852a2499424ca16bc3729A032953] = true;
