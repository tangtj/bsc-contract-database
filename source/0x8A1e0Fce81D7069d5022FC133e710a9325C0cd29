...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a3a42981A52a91bC2e11aC52bdf96796175D8f6; // owner address
...
contract killerofmeme is Context, IERC20, Ownable {
    ...
    string private _symbol = "killer of meme";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x16266236b2047205B4312f3FAbBfef8022B07a6f); // Marketing Address
    address payable private teamWalletAddress = payable(0x4dF0b0C65E6095991f7C5E1e7E0CD600DfFcFb16); // Team Address
