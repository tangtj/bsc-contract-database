...
// File: contracts/upgradeability/ImperiumStorage.sol

pragma solidity 0.4.24;

/**
 * @title ImperiumStorage
 * @dev This contract holds all the necessary state variables to carry out the storage of any contract.
 */
contract ImperiumStorage {
...
// File: contracts/upgradeability/ImperiumStorageProxy.sol
...
/**
 * @title ImperiumStorageProxy
 * @dev This proxy holds the storage of the token contract and delegates every call to the current implementation set.
 * Besides, it allows to upgrade the token's behaviour towards further implementations, and provides basic
 * authorization control functionalities
 */
// solhint-disable-next-line no-empty-blocks
contract ImperiumStorageProxy is ImperiumStorage, OwnedUpgradeabilityProxy {}