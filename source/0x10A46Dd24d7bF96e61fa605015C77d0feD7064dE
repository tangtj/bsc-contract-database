...
contract Mochi is ERC20, Ownable {
    ...
    MochiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Mochi Inu", "Mochi") {
        marketingWallet = payable(0x4902308bFbd8B192898e329890710C37FC9f1Ca5);
        devWallet = payable(0xaA8bF9888B86C09102CFDc23759DFCB45593b2FF);
        ...
        dividendTracker = new MochiDividendTracker(
            payable(this),
            router,
            0x2b8e2DF7BAdd32c826F7e14e155b411A89246DA1,
            "MochiTRACKER",
            "MochiTRACKER"
        );
...
contract MochiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        MochiContract = Mochi(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Mochi_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Mochi_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MochiContract);

            uint256 prevBalance = MochiContract.balanceOf(address(this));
            ...
            {
                uint256 received = MochiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MochiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
