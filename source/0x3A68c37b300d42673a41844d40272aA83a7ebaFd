 ...
 * @@@@@@@@@@@@@@@@@@@@////////@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//////////@@@@@@
 * 
 * Proof Of Yeet Genesis
 * 
 * This is the genesis pass to the Proof Of Yeet (POY) ecosystem and Yeetinals og access.
 * 
 * As the rarest NFT we have released this is our POY Genesis debut collection, with full access of membership benefits and utilities.
 * 
 * Proof Of Yeet genesis grand burning further into the POY access membership continues the journey.
 *
 * Keep Calm and YEET POY.
 * 
 * The way to Proof Of Yeet genesis airdrop minting is via the yeetoshi minting machina.
 * 
 * Yeetoshi
 *
...
// File: contracts/IERC721Upgradeable.sol
...
// File: contracts/IERC721Standard.sol
...
// File: contracts/ERC721Standard.sol
...
contract ProofOFYeetGenesis is Context, AccessControl, ERC721Enumerable, ERC721Burnable {
