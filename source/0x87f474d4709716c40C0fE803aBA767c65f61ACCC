/**
Little Dork Lord is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens.

Little Dork Lord Utilities : 
Staking 
Meme Generator
Lottery
Marketing = 3
...
Portal : https://t.me/littledorklord
*/
...
contract LittleDorkLord is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Dork Lord"; // 
    string private constant _symbol = "LDORK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xe73DdD5CfF5AAf1Ce24891c3bAAd0A688651d038;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xC33B56393851BBcB268B535A84B12416Ab10FEa1;
