// telegram : https://t.me/tigeinu8bit
...
contract tigeinu8bit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tige Inu 8Bit";
    string private _symbol = "TINU8Bit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49E685c87b5C326C552fAB757C9d3ff729FeB49d); // Marketing Address
    address payable public teamWalletAddress = payable(0x49E685c87b5C326C552fAB757C9d3ff729FeB49d); // Team Address
