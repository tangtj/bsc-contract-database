...
contract REFLECTIONAI is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1111 * 10**_decimals;
    ...
    address public marketingAddress = 0xc7E2dC3094Bb056124C3B3d2e81056531EC9c76C;
    address public devAddress = 0xc7E2dC3094Bb056124C3B3d2e81056531EC9c76C;
