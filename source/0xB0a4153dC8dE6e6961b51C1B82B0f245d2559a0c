...
contract OnlyMoon is Context, IERC20, Ownable {
    ...
    string private _name = " OnlyMoon ";
    string private _symbol = " OnlyMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9BAbD6B46FC0A1b1E4875d894Ed1cbE5Ac4c6782); // Marketing Address
    address payable public teamWalletAddress = payable(0x9BAbD6B46FC0A1b1E4875d894Ed1cbE5Ac4c6782); // Team Address
