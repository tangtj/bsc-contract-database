...
contract tigeinu2k23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TIGE INU 2K23";
    string private _symbol = "TIGE2K23";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x204303B3564013b950d9fb80779A8A927c8E533c);
    address payable private DevelopmentWalletAddress = payable(0x204303B3564013b950d9fb80779A8A927c8E533c);
