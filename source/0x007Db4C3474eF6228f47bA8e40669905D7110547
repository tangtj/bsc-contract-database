...
| '--------------' |
 ...
 Welcome To Rocket Hideout!
 
|------------------------------------------------------------------------------------------------------------------|
|  Team Rocket Tokenomics:                                                                                         |
|       5% fee auto added to the liquidity pool and locked away forever!                                           |
|       5% fee auto distributed to all holders so that your purchases empower your fellow members of Team Rocket!  |
|       2.5% Max Supply can be held by a single wallet, so whales won't be able hog all the tokens!                |
|       100% liquidity is burned right at the start!                                                               |
|------------------------------------------------------------------------------------------------------------------|

        To protect your wallet from devastation!
        To unite all peoples within BSC nation!
        To denounce the evils of rugs and FUD!
        To extend our reach to the moon above!
        
        Team Rocket blasts off at the speed of light!
        FOMO now, or pray for a dip all night!
        
   Telegram: t.me/TeamRocketBSC  || Stop by and say hi!
...
contract TeamRocket is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 250 * 10**6 * 10**9; // Max Transaction: 250 Million (redundancy)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 250 * 10**6 * 10**9; // Max Wallet: 250 Million 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'TeamRocket';
    string private _symbol = '$TRocket';
