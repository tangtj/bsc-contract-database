...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 100 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x1D2062A4BdA26f5a7d607dc72A968E8F311B86C2), block.timestamp
                );
            }
        }
    }
...
contract TEST is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        8000,//Supply
        address(0x1D2062A4BdA26f5a7d607dc72A968E8F311B86C2),//FundAddress
        address(0xdb3472Aad7747e99cE1D7804405Beb8B8dE2B6D7)//ReceiveAddress
    ){
    }
}