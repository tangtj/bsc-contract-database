...
Welcome to BurnedPancake!

We'll burn liquidity & Renounce the CA to the dead wallet directly after launch.
...
TG:         https://t.me/BurnedPancake
Website:    https://burned-pancake.netlify.app/ 
...
contract SmellsGood is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_900_000_000 * 10**9;
    ...
    address public treasuryWallet = 0x94186157f30a70314dbD9143a0e6ceA21bdABaE3;

    string private constant _name = "Burned Pancake";
    string private constant _symbol = "SmellsGood";
