...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10200,
        address(0x4D43F0bb7C2E9FF1B11BBe3966D8fA3DdCF9056E),
        address(0xB18c075a2F6770D3416Ff491EfdE65d9eF2a4c3F),
        address(0xdBEb1eE6bbd745A9DA76599c7b05C341cb138Ced) //receiver
    ){
    }
}