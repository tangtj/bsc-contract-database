...
contract SCCS is ERC20, Ownable {
    address public pair;
    uint public immutable burnFee = 10;

    constructor() ERC20("Success Kid","SCCS") {
        uint tSuppl = 100_000_000_000 * 10 ** decimals();
        super._mint(msg.sender, tSuppl);
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        if (to == pair && pair != address(0)) {
            uint burnPart = amount * burnFee / 100;
            amount -= burnPart;
