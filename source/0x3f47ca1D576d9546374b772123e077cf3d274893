...
contract RollsRoyce is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf5759171356D05f89caB0f1781996E2322d40dde); // Marketing Address
    address payable public teamWalletAddress = payable(0xf5759171356D05f89caB0f1781996E2322d40dde); // Team Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
      
    uint256 public genesisBlock;
    uint256 public coolBlock = 4;
    ...
    uint256 private _totalSupply = 1906 * 10**_decimals;
    uint256 public _maxTxAmount = 2 *10**_decimals; 
    uint256 public _walletMax = 6 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1906 * 10**_decimals; 
