...
AISync is an AI LAUNCHPAD that chooses and recommends projects by evaluating all the information available on the web.

Let's Join with us

Website  : aisync.lol
Twitter  : https://twitter.com/AISynchronize
Telegràm : https://t.me/AISynchronize
...
contract AISync is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AISYNC";
    string private _symbol = "$AISYNC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7aC88939975Cfb2B2cbCe0215E80217811d7781B); // Marketing Address
    address payable public teamWalletAddress = payable(0x7aC88939975Cfb2B2cbCe0215E80217811d7781B); // Team Address
