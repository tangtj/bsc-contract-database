...
contract ZILIA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZILIA"; 
    string private _symbol = "Zilia"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1e1138F0bAAfA40a5E3E2D7357E9a804F59a5012); 
    address payable public teamWalletAddress = payable(0x36B87625F28acEDdE2dCa3872f43c6a343753511); 
