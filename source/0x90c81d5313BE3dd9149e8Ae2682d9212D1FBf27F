...
We are a low tax cryptocurrency token that is tradable on the Binance Smart Chain network; with multiple innovative utilities that will potentially focus on “Manipulating” the metaverse & Game+fi (Play To Earn) cryptocurrency verse.

We are not here to sugar coat sh*t or make any unachievable promises. We know that not every play will be a success in this "casino" (cryptocurrency world), but hey, everything comes to an end at some point and that's life.

Here's a suggestion (take it or leave it), 
learn how to read a chart, 
learn how to read a contract,
learn how to support higher lows,
learn how to "work for your bags",
STOP aping tops
and most importantly STOP blaming anyone else for your own failed trades.

Try to remember on a low market cap token it’s not only up to a Dev, the community is a key to success!  if you also put in some effort and work hard for a project that you genuinely believe in, it can reap rewards!  If you all choose to sit back and do nothing to help moon your bags that is NOT a scam!

Nothing is guaranteed in cryptocurrency even with a dedicated team and supportive community, but if a low cap project ends up "dumping" hard and you were not there until after it dumped hard, that is NOT a scam!

Take some time to DYOR and if you choose not to invest, that’s ok, there will be other projects out there for you.  And if you choose to ride this journey with us let’s have some fun and make it worth it!

Even with the best intentions, hopes and dreams for a project, it can still fail despite who is behind it.  Please stop “trolling" the people that are trying to make this project successful.

COMMUNITY = SUCCESS 

If you do not understand or like how our team is playing the crypto game, then Manipulate ($X) is probably NOT the game for you to play.

It's time for people to lighten up, have some fun and start making the most out of these times because cryptocurrency will not be unregulated forever. 

Here's to hoping people see the value of working together as a community and bringing back the good old BSC days. Let's do our best to rock the Binance Smart Chain network with $X!

The whole space is a manipulation, but that's the whole point! There are good and there are bad people, find your circle or be a silent investor and make your profits.  MOON OR GTFO.

We look forward to playing the cryptocurrency market (game) and hopefully making some decent X's (profits) with any genuine people and and all print together!

Buy Low Sell High, Manipulate your opponents, multiply your funds.


Twitter: https://twitter.com/manipulatecoins

Website: 
TBA 

Community: https://t.me/ManipulateCrypto


操纵 ($X)

我们是一种低税加密货币代币，可在币安智能链网络上进行交易；拥有多个创新实用程序，这些实用程序可能会专注于“操纵”元宇宙和游戏+fi（玩赚钱）加密货币领域。

我们来这里不是为了粉饰或做出任何无法实现的承诺。我们知道，在这个“赌场”（加密货币世界）中，并不是每场比赛都会成功，但是，嘿，一切都会在某个时刻结束，这就是生活。
...
学习如何“为你的包工作”，
停止模仿上衣
最重要的是，不要再将自己的失败交易归咎于任何人。

请记住，对于低市值代币，这不仅取决于开发人员，社区也是成功的关键！如果你也为自己真正相信的项目付出一些努力和努力，就能获得回报！如果你们都选择袖手旁观，不做任何事情来帮助保管您的行李，那么这不是一个骗局！

即使有专门的团队和支持性社区，加密货币也没有任何保证，但如果一个低上限项目最终猛烈“倾销”，而你直到它猛烈倾销之后才出现，那不是骗局！

花一些时间到 DYOR，如果您选择不投资，也没关系，还有其他项目适合您。如果您选择与我们一起踏上这段旅程，让我们享受一些乐趣，让一切变得值得！

即使一个项目有最好的意图、希望和梦想，无论背后是谁，它仍然可能会失败。请停止“恶搞”那些试图让这个项目成功的人。

社区=成功

如果您不了解或不喜欢我们团队如何玩加密游戏，那么 Manipulate ($X) 可能不适合您玩。

现在是人们放松一下、享受一些乐趣并开始充分利用这些时间的时候了，因为加密货币不会永远不受监管。

希望人们能够看到作为一个社区共同努力的价值，并带回 BSC 的美好时光。让我们尽最大努力用$X震撼币安智能链网络！

整个空间都是一种操纵，但这就是重点！人有好人，也有坏人，找到你的圈子，或者做一个沉默的投资者，赚取你的利润。月球或GTFO。

我们期待着参与加密货币市场（游戏），并希望与任何真诚的人一起创造一些体面的 X（利润），并一起印刷！

低买高卖，操纵你的对手，增加你的资金。

社区：https://t.me/ManipulateCrypto
...
contract Manipulate is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"Manipulate";
    string constant _symbol = unicode"X";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 8, // development fee in %
            Marketing: 8, // Marketing fee in %
            lp: 1, // lp rate in %
            toSwap: 17 // Marketing + dev + lp
        });

    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 20, // development fee in %
            Marketing: 30, // Marketing fee in %
            lp: 5, // lp rate in %
            toSwap: 55 // Marketing + dev + lp
        });
