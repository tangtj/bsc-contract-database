...
//https://t.me/safemoonnewofficial
interface IERC20 {
...
contract Safemoon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x72aA30b5891bD0C40554AA6FA9bC831bf7fA2C09); 
    address payable public Wallet_Dev = payable(0x72aA30b5891bD0C40554AA6FA9bC831bf7fA2C09);
    ...
    constructor () {
        _owner =0x72aA30b5891bD0C40554AA6FA9bC831bf7fA2C09;
