...
contract QUACKQUACK is ERC20, Ownable {
    ...
    constructor() payable ERC20("QUACK QUACK", "QUACKIN") {
        uint256 totalSupply_ = 1_000_000_000_000;
        buyFee = 5;
        sellFee = 5;
        wallet01 = address(0xd81D0a7c37356b20da0830f4AC14A0eaBF64C8A6);
        address router_ = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        autoSwapEnable = true;
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 5 && _sellFee <= 5, "Fees must be less than 5%");
        buyFee = _buyFee;
        sellFee = _sellFee;
    }

    function changeWallet(address _wallet01) external {
