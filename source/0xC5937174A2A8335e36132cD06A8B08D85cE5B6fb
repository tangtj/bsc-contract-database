...
contract DORKFINETOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public sjngdh8;
    ...
    string private _tokenname = "Dork Fine";
    string private _tokensymbol = "DORKFINE";
