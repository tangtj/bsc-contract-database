...
// File: contracts/supra/interfaces/soak/IShareRewardPool.sol
...
// File: contracts/supra/strategies/soak/StrategysoakLP.sol
 ...
 * soak rewards from providing liquidity are farmed every few minutes, sold and split 50/50.
 ...
 */
contract StrategysoakLPV2 is Ownable, Pausable {
     ...
     * It deposits {lpPair} in the shareRewardPool to farm {soak}
     */
