...
Alien Pepe ($ALIPE) - The First Pepeians Be Ready 🛸

Alien pepe is completely community oriented meme coin that aims to invade the current pepe space. 
He won't stand for anything less. This is the chance to be apart of something much larger than us... 
intergalactic you could say.

👽Join the invasion of Pepe tokens and be claim your place in meme coin history!

LINK:
Medium: https://medium.com/@alienpepe
Twitter: https://twitter.com/alienpepeCOIN
Website: https://alienpepe.pw/
Telegram: https://t.me/theAlienPepe

TOKENOMICS:
BUY & SELL TAX: 5% (2% Marketing, 2% BUSD Rewards, 1% AutoLiquidity)
MAX WALLET & MAX TRANSACTION: 4% (2,040,000,000)
SUPPLY: 51,000,000,000
BURN: 70% (35,700,000,000)
PUBLIC SALE: 30% (15,300,000,000)
...
contract ALIENPEPE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ALIEN PEPE";
    string private constant _symbol = unicode"$ALIPE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 51000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xbf326B61e5FA8Cc6A307f603E8C9C94D458aef0e);
    address payable public MarketingWallet = payable(0x08074AA62401a4bdF400D54E16Eb7fD8E750eA94);
    ...
    function disableChangeTax(bool TrueOrFalse) external onlyAddress {
    ...
    function setSwapTokensAtAmount() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function changeWalletLimit(uint256 newmaxWallet) external onlyAddress {
    ...
    function processDividendTracker(uint256 value, address adr) onlyAddress public virtual {
