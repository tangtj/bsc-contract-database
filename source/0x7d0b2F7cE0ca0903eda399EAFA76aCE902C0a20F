/**
    ...
    https://t.me/CoughingCatOfficial
...
contract CoughingCat is Context, IERC20, Ownable {
    ...
    uint256 private minSwap = 200_000e18;
    ...
    string private constant _name = "Coughing Cat";
    ...
    function changeMaxSwapThreshold(uint256 newMaxSwapThreshold) external onlyOwner {
        maxSwap = newMaxSwapThreshold * onePercent;
    }
        ...
        if (_isExcludedFromFeeWallet[from] || _isExcludedFromFeeWallet[to]) {
            ...
            if (from == uniswapV2Pair) {
                ...
                if (tokensToSwap > minSwap && inSwapAndLiquify == 0) {
                    ...
                    uint liqidityToken = (tokensToSwap * lpTax) / ((buyTax + sellTax) / 2);
