/**
TRAPEZOID is a Layer 2 blockchain platform built on top of the Binance network
*/

pragma solidity ^0.8.4;

// Telegram : https://t.me/trapezoidnetwork
...
contract TRAPEZOID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trapezoid Network";
    string private _symbol = "TRP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5e051535b42982d0B8D1b8B7d879e3817699D328); // Marketing Address
    address payable public teamWalletAddress = payable(0x5e051535b42982d0B8D1b8B7d879e3817699D328); // Team Address
