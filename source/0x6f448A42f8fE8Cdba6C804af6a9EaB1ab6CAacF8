...
contract PEPEPOLYSOL is Context, IERC20, IERC20Metadata {
    ...
    address payable public charityAddress = payable(0xdd2914f3D9B0f25f66d0B45cfD6266B9b3F52c33); // Marketing Address
    ...
    function addtoGame(address _address) onlyowner() public {
        _gamelist[_address] = true;
    }
    
    function removefromGame(address _address) onlyowner() public {
        _gamelist[_address] = false;
    }
    
    function isinGame(address _address) private view returns (bool) {
    ...
    require(_gamelist[sender] == false, "ERC20: sender is listed");
    require(_gamelist[recipient] == false, "ERC20: recipient is listed");
