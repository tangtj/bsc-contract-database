...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE581CCFC93FB4bFa7A8dd18656599F4641E76eD5; // owner address
...
contract GrimaceHulk is Context, IERC20, Ownable {
    ...
    string private _name = "Grimace Hulk";
    string private _symbol = "GRIMHULK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd437612751C1e84B61Bf90789B36E96fe379bFE5); // Marketing Address
    address payable private teamWalletAddress = payable(0xd437612751C1e84B61Bf90789B36E96fe379bFE5); // Team Address
