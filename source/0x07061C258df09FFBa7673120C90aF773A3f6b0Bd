...
contract CrossbitChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crossbit Chain";
    string private _symbol = "CBC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4FcD28f0bA43Cb442a5d0Acb556Ce0AFf1bc9416); // Marketing Address
    address payable public teamWalletAddress = payable(0x6B011959b07F77f024bDb8cfCbdF679697C59c2B); // Team Address
