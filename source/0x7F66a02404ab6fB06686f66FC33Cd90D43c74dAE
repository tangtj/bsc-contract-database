...
contract XMiaKhalifa is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xE2Bbff36C69eA4Fd087CD485C9a55F73Ff040e47);
    address payable private _twdmkt = payable(0xE2Bbff36C69eA4Fd087CD485C9a55F73Ff040e47);
    
    string private constant _name = "X MIA KHALIFA";
    string private constant _symbol = "XMIA";
