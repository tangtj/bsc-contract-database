...
contract PepeakyBlinders is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x8ac002c3b818621e4Faf831ECB210F5B7280d88c);
    address payable private _twdmkt = payable(0x8ac002c3b818621e4Faf831ECB210F5B7280d88c);
    
    string private constant _name = "PEPEaky Blinders";
    string private constant _symbol = "PEPEKBLND";
