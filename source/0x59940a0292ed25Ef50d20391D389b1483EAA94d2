...
contract MBP_LIQUIYIELD_T1_IDO is Context, Ownable {
    ...
    address private IDO_TOKEN_ADDRESS = 0x14004310BB4ecEE69A965131836650EBBA3CeD6B;
    ...
    uint256 private MINIMUM_MBP_HOLDING = 300_000 * (10**18);
    uint256 private MINIMUM_DKS_HOLDING = 300_000_000 * (10**18);
    uint64 private MINIMUM_STAKE_DAYS = 2;

    uint256 private MINIMUM_INVESTMENT = 56 * (10**18);
    uint256 private MAXIMUM_BUY_AMOUNT = 111 * (10**18);
    ...
    uint256 private HARDCAP = 14_097 * (10**18);

    uint256 private RATE = 7_142 * (10**18);
    uint256 private RATE_BARE = 7_142;
    ...
    uint256 private sale_start = 1695729600;
    uint256 private sale_end = 1695735000;
    ...
    uint256 private vesting_2 = 0;
    uint256 private vesting_3 = 0;
    uint256 private vesting_4 = 0;
