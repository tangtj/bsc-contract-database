...
contract XLTC is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5040459 * (10**8) * (10**9);
    ...
    string private constant _name = "X-LTC";
    string private constant _symbol = "X-LTC";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0x181B7a73BF5a138eDfd1af8CE418e7e46E31E04e);
    address payable private _marketing2Address = payable(0x85B11E9be0144C33649a1F1319A47370093086c1);
    address payable private _marketing3Address = payable(0xB45a4ECcA8DB892325e2b07CA079A0Bf9E0d5f89);
