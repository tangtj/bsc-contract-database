...
contract BOOMMStake is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        mainToken = IBEP20(0x2c6A4566003A9fDD1aD2eF0BAFfdc82665f23911);
        stakingToken = IBEP20(0x2c6A4566003A9fDD1aD2eF0BAFfdc82665f23911);
