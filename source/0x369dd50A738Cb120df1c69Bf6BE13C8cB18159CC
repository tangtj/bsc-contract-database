...
contract BARBIEDOGETOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public cnnbf75;
    ...
    string private _tokenname = "Barbie Doge";
    string private _tokensymbol = "BARBIEDOGE";
