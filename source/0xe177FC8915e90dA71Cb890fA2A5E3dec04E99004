...
contract TESTCLOVER is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "TEST CLOVER";
    string private constant _symbol = unicode"$TCLOVER";
    ...
    address payable public DevWallet = payable(0x5DfFEC102A8aACfBD30d40FDF4CbCda45f8Eae87);
    address payable public MarketingWallet = payable(0x330ABb0d44c023597961239D85F81506e81a22F8);
