...
contract CarbonCCReward is Ownable{
    using Address for address;
    
    bool public Pause = false;
    mapping(string => bool) public SwapKey;
    
    address private signerAddress = 0xf637Fd289Fd2a617d132d6aF50337009F82D388d;
    IERC20 public token = IERC20(0xD03811a88bf40db9C246E7BD20f0E6c50eE95B38);
