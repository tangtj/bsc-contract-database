/**
 _    _     __          __     _____  ______ _    _ __  __ 
 | |  | |   /\ \        / /\   |  __ \|  ____| |  | |  \/  |
 | |__| |  /  \ \  /\  / /  \  | |__) | |__  | |  | | \  / |
 |  __  | / /\ \ \/  \/ / /\ \ |  _  /|  __| | |  | | |\/| |
 | |  | |/ ____ \  /\  / ____ \| | \ \| |____| |__| | |  | |
...
// contract verify by HawaReum dev 
*/
//  Telegram : https://t.me/Hawareum
//  Website  : https://hawareum.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4614B4b1C521f053297ca858e2aFDd0B2555a67E ; // owner address
...
contract HawaReum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Hawa Reum";
    string private _symbol = "HWR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x44d980abD1B4704e0e1159366399D6C2021eF72e); // Marketing Address
    address payable private teamWalletAddress = payable(0x629bfBF540226334403ADaE6bF5F3fDf6FD74561); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 9000000 * 10**3; 
