...
contract Sagirium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xa23d7768281df507f502Bb25b64372E354a8942B);
    address payable private _twdmkt = payable(0xa23d7768281df507f502Bb25b64372E354a8942B);
