...
contract ManualDividendDistributor is IDividendDistributor {
    ...
    function getUnpaidEarningsInTokens(address shareholder) public view returns (uint256[2] memory tokenAmounts) {
        ...
        retVal[0] = getEstimatedNativeTokenForBNB(share * rewardTokenDiv)[1];
        retVal[1] = getEstimatedRewardTokenForBNB(share * nativeTokenDiv)[1];
        return retVal;
    }
...
contract BTCBullDogBSC is Context, IBEP20, Ownable {
    ...
    string private constant _name = "BTCBullDog BSC";
    string private constant _symbol = "BitDog BSC";
