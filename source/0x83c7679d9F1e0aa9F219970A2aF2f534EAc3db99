/**
🔸GAW20 is a revolutionary Layer 2 blockchain platform that aims to reshape the landscape of digital art, 
music, and virtual experiences in the metaverse.

🔸The platform provides innovative features such as low fees, fast transactions, NFT staking, NFT minting, and the GAW20 Explorer, 
empowering users to participate in the next era of digital creativity.

- Scalability
- Interoperability
- Fast Transactions

// TELEGRAM: https://t.me/Layer2GAW20
// WEBSITE: https://gaw20.com/
// WHITEPAPER: https://gaw20-nft-and-metaverse-blockcha.gitbook.io
*/
...
contract GAW20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string public _name = "Genesis Art Work";
    string public _symbol = "GAW20";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0xF37D8d931dff6715dDACF41B35f7238390Df92dD);
