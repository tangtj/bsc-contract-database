...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17160109307c7Cf177aD441A1fcAf8305651E662; // owner address
...
contract PEGE is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x4846632287C28b3218492b4b4eD5f482FBD76C0B); // Marketing Address
    address payable private teamWalletAddress = payable(0x17160109307c7Cf177aD441A1fcAf8305651E662); // Team Address
