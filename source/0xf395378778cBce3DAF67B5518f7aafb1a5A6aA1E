...
// Shared Pool MEV Bot ($SPMEV)
    /*  

    > Telegram Chat: 
        https://t.me/SharedPoolMEV

    > Telegram Bot:
        https://t.me/spmev_bot
...
contract SPMEV is ERC20, Ownable {
    ...
    constructor() ERC20("Shared Pool MEV", "SPMEV") {
        ...
        marketingWallet = address(0x5771855CDC205DC3BE2D1D9D587bdf7C4AE26c49); 
        affiliateWallet = address(0x54724b3cDDD1226A7ECE230d6d911320f693c500);
        lpWallet = msg.sender;
