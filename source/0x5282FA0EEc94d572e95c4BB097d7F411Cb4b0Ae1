...
// SPDX-License-Identifier: Unlicensed
 ...
 // Telegram : https://t.me/HPOK9i_bsc
...
contract HarryPotterObamaKnuckles9Inu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterObamaKnuckles9Inu";
    string private _symbol = "ETHEREUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08381EC8650f60ED067C148C467cABC34cCd31CD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8015B2F99B1Db301001F8563c40199AAA4d5187A); // BuyBack Address
