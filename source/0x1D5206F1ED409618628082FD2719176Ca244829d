...
//Telegram : https://t.me/hamstersbsccoin
...
contract Hamsters is Context, IERC20, Ownable {
    ...
    string private _name = "Hamsters";
    string private _symbol = "HAMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaFbc7c02b58Dd0285A48768502f8CF6A143aAA05); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xaFbc7c02b58Dd0285A48768502f8CF6A143aAA05); // BuyBack Address
