...
contract MCGOBLINZ is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150e15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 250_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 150_000_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 150_000_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 150_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x910A402940080Fc4e623d2c71E03FdcBC336033A;
    address public devAddress = 0x910A402940080Fc4e623d2c71E03FdcBC336033A;

    string private constant _name = "McGoblinz";
    string private constant _symbol = "GOBLINZ";
