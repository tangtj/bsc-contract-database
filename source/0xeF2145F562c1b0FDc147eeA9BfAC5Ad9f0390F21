...
contract HarryPotterPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "HarryPotterPepe";
    ...
    address payable private _developmentAddress = payable(0x4b2d85BEC3D8F5E59AD18762cc6457619C87c976);
    address payable private _marketingAddress = payable(0x4b2d85BEC3D8F5E59AD18762cc6457619C87c976);
