...
contract ROYALSHIBA is ERC20, Ownable {
    ...
    constructor() payable ERC20("ROYAL SHIBA", "ROYALSHIBA") {
        ...
        marketingWallet = 0x2C83f9bb6Ec52892B1A39f95Ab31E83E66efb8dF;
    ...
    function setAutomatedMarketMakerPair() external onlyOwner {
        address _uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(address(this), uniswapV2Router.WETH());
