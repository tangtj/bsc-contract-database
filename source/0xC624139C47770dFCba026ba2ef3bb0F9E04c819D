...
2% Rewards are distributed to every holder automatically.


*/

// ~~~~~~~~~~~~~~~~~~~~~~~~
// BABY YOSHI INU - $BYOSHI
// https://babyyoshi.renderforestsites.com/
// https://t.me/babyyoshiinu
// https://twitter.com/Babyoshinu
// ~~~~~~~~~~~~~~~~~~~~~~~~
...
contract BABYYOSHI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABY YOSHI";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x4664c2De33BCf1Af3BEA25F2ea079ccfAB2cA287;
        marketingWallet = 0x4664c2De33BCf1Af3BEA25F2ea079ccfAB2cA287;
        devWallet = 0x4664c2De33BCf1Af3BEA25F2ea079ccfAB2cA287;
