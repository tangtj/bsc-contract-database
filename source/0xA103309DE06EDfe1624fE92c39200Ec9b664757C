...
contract SupplyShock is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x94047BA6a0761eA787D8508A2434c7cc0580acCF); // Marketing Address
        
    address payable public teamAddress =
        payable(0x94047BA6a0761eA787D8508A2434c7cc0580acCF); // Team Address
        
    address payable public liquidityAddress =
        payable(0x94047BA6a0761eA787D8508A2434c7cc0580acCF); // Liquidity Address
    ...
    string private constant _name = "Supply Shock";

    string private constant _symbol = "SHOCK";
