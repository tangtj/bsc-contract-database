...
contract BITCOIN15 is ERC20, Ownable {
    ...
    address private  marketingWallet = payable(0x45939d1c98027B7e5e458F2C00e2b7694Fa37ddE);
    address private  devWallet = payable(0x45939d1c98027B7e5e458F2C00e2b7694Fa37ddE);
    ...
    constructor() ERC20("BITCOIN 1.5", "BTC1.5") {
