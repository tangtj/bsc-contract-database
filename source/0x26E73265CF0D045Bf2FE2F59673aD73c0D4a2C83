...
contract AIGod is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AIGod";
    string private _symbol = "AIGod";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf313c1bc73667F0150B7Bf8a90C3b887dd9E0bFD); 
