...
contract TwitterPepe is IERC20, Ownable {
    ...
    string _name = "Twitter Pepe";
    string _symbol = "TWEPE";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x6031c9B32616493B3311818c47Ec35529085a519;
        marketingFeeReceiver = 0x6031c9B32616493B3311818c47Ec35529085a519;
