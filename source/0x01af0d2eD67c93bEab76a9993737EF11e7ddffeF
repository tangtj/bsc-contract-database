...
contract Empress is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1200 * 10**9;

    string private _name = "Empress";
    string private _symbol = "Empress";
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x6Ad5ae922AAFc2E39acB4313E6d223fe910Ef9f6),
            _msgSender(),
            _tTotal
        );
    }
