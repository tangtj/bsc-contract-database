...
contract PEPETWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe2";
    string private constant _symbol = "PEPE2";
    uint256 private constant _Totalst = 100000000 * 10 **_decimals;
    ...
    uint256 private _BuyTaxinitial=6;
    uint256 private _SellTaxinitial=12;
    ...
    constructor () {
        ...
        _xrqFaRceiverp = payable(0xc9E0e07C5Fc32CFA47d9F2b3C5915aB237915904);
    ...
    function openTrading( ) external onlyOwner( ) {
        require( ! _vylkjh);
        _uisapRautet   =  _xnisapRauts (0x10ED43C718714eb63d5aA57B78B54704E256024E) ;
