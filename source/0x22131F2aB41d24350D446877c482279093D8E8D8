...
contract BabyCaketwo is Context, IERC20, Ownable {
    ...
    string public constant _name = "BabyCake 2.0"; // 
    string private constant _symbol = "BabyCakeTwo"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 private _liquidityFee = 0;

    address private  _marketingWallet = 0x450ffCCe0C6079A2EECb4e8a083f75E08CC1d928;
