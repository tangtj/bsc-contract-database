...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80C2893FCb08c360A3F2A0B3eEa21f431f437E3f; // owner address
...
contract MULTIVERSETOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Multiverse Token ";
    string private _symbol = "MVT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56b7069d0d9FC6DA1EF8A77f72B4a8dE74f5d4F6); 
    address payable public teamWalletAddress = payable(0xd1c9BcB6C9b31f2924445e5BE6744ff4D94fB30d);
    ...
    function setWalletFeesExempt(address wallet, bool exempt) external onlyOwner {
    isExcludedFromFee[wallet] = exempt;
