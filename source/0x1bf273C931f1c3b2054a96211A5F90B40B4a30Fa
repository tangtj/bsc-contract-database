 ...
 *t.me/JadaSmithInu
 ...
 Welcome everyone. Thankyou for joining us on our mission : ) - Dev
*/
...
contract JadaSmithInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jada Smith Inu"; // 
    string private constant _symbol = "SLAP"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 3;
    address public _marketingWallet = 0xD51e865e32590355adE1403051c2017a8D29008b;
