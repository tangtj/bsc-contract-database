...
TG: https://t.me/+1g8SMYeguKtmYzM1
...
contract GREENBINANCE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GREEN BINANCE";
    string private constant _symbol = unicode"$GREEN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 88000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x7f01954733681C7f3F11C99E8972e34E7e458683);
    address payable public MarketingWallet = payable(0x70147E313Cf33eCCB20D82cc5F0E9be28E7CC41B);
