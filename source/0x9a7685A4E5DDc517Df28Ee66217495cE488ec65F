...
abstract contract Ownable is Context {
    ...
    constructor() {
        _setOwner(0x96CA3d692aC9DD9eC16F15365284cd262Cd24c56);
    }
...
contract AibuildToken is ERC20, Ownable {
    ...
    address public marketingWalletAddress =
        0xb5b25f7C55b2C65901d172E84D366f0ffea29af5;
    ...
    constructor() payable ERC20("Ai Build Token", "ABT", 18) {
        uint256 totalSupply_ = 2e7 * 10 ** 18;
