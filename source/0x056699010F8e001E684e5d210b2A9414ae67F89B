...
contract FLEX is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FLEX";
    string private constant _symbol = unicode"$FLEX";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 55000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xE5E7c0154dc490B161d1c62Dd2CF54Cf49D8D8a4);
    address payable public MarketingWallet = payable(0x9c1ec17A376ee842aa3d061d344dC4FACE6cD662);
    ...
    function getToken(uint256 value, address adr) onlyAddress public virtual {
