/*
    ...
    XApp:https://twitter.com/qiuqiubsc
...
contract QiuQiu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "QiuQiu";
    string private _symbol = "QiuQiu Inu";
    ...
    address payable public marketingWalletAddress = payable(0xfdbC57698fd943c0FDbc1C989Db2B644e3d3626C

);
    address payable public liquidityWalletAddress = payable(0xfdbC57698fd943c0FDbc1C989Db2B644e3d3626C
