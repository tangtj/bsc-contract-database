...
contract GMGEMTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tbbfdhg5;
    ...
    string private _tokenname = "Game Gem";
    string private _tokensymbol = "GMGEM";
