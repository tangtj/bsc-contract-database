...
Telegram : https://t.me/bscvsethereum
 *Submitted for verification at Etherscan.io on 2023-04-27
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C3Df94FD983e11B0E1391B1412A6e18396b4121; // owner address
...
contract BSCETHEREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BSCETHEREUM ";
    string private _symbol = " $BSCVSETH ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C3Df94FD983e11B0E1391B1412A6e18396b4121); // 
    address payable public teamWalletAddress = payable(0x8C3Df94FD983e11B0E1391B1412A6e18396b4121); // 
