...
contract ZU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Ch";
    ...
    address payable private _marketingAddress = payable(0x52F737502A3668539a361642465fbc84ebc7E582);
