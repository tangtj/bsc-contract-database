...
contract Cryptube is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Cryptube", "CTB") ERC20Permit("Cryptube") {
