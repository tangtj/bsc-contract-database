...
contract letsgo is Context, IERC20, Ownable {
    ...
    string private _name = "legooo";
    string private _symbol = "$leeegs";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD49418557DC40b916d52f0B7B1D4A17B2245a1ef); // Marketing Address
    address payable public teamWalletAddress = payable(0xD49418557DC40b916d52f0B7B1D4A17B2245a1ef); // Team Address
