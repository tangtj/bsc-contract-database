/**
 %3 MAX
 7 TAX
 RENOUNCED for 1 year
 AGRESSIVE MARKETING
 MOON?
*/

//https://t.me/pepefamilybsc
...
contract PepeFamily is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Pepe Family";
    string private _symbol = unicode"PEPEFAMILY";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xd3A669b33c570C5D6655E922cC5829b7Be7aD3f8);
    address payable private taxWallet2 = payable(0xd3A669b33c570C5D6655E922cC5829b7Be7aD3f8);
