...
contract DeepReef is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public _marketingAndDev = address(0x6FF943281CB037169815d1D7904Ee47526D808cc);
    ...
    string private _name = "Deep Reef token";
