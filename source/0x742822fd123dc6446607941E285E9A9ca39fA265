...
contract Uranium is Context, IERC20, Ownable {
    ...
    string private _symbol = "URN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16766659613Eb90d6a3372FCc42c73A1E9374DF3); // Marketing Address
    address payable public teamWalletAddress = payable(0x16766659613Eb90d6a3372FCc42c73A1E9374DF3); // Team Address
