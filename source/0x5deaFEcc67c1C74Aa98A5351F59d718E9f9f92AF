...
contract ShibaAI is ERC20, Ownable {
    ...
    address public developmentWallet = 0x932446e3E1B2EA25470F10f9d82bAf8576628595 ;
    ...
    constructor() ERC20("ShibaAI Energy Renewable", "ShibaAI") {
        _mint(msg.sender, 500000000000000000 ether);
