/*
X BALD COIN is a Decentralized meme token launched on the Binance Blockchain with the aim of creating a community token to keep up with Cryptocurrency developments in meme tokens
...
contract XBALDCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "X BALD COIN";
    string private constant _symbol = "XBC";
