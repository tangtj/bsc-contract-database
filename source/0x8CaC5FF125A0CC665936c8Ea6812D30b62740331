...
contract CHIKUN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3700000000 * 10**9;
    uint256 public _maxTxAmount = 3700000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3700000000 * 10**9; //
    string private constant _name = "CHIKUN"; // 
    string private constant _symbol = "CHIKUN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xeFe833C8A5B1FB6266637B12a2D2EDcf1981e75e;
