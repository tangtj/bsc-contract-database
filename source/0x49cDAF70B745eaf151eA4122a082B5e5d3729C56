...
contract Just4Fud is Context, IERC20, Ownable {
    ...
    string private _name = "Just For FUD";
    string private _symbol = "Just4Fud";
    ...
    address public marketingWallet = 0x653F68DDB5f2EAF244Df3beEBdeEa8fDc41294DE;
