...
contract BabyPokemonGame is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x855005dFCF7CCb246Cd89467ad21A8628CB2E2C1); // Marketing Address
    ...
    uint256 private _maxWalletTotal = 21000000* 10**9;
    uint256 private _tFeeTotal;

    string private _name = "BabyPokemonGame";
