...
contract GsjToken is ERC20, Ownable {
    ...
    constructor( 
        ...
        _mint(_managerAddress, 1000000 * 10 ** 18);
    }

    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeRouter), "GsjToken: The router already has that address");
