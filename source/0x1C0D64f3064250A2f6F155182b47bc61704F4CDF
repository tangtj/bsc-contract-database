...
// If you find this then well, lucky you. Shhhhhhhhhh!! OMERTA! - Don't know what this is? Well, then figure it out.
// 90% of cypto community don't read code, this is your reward. Hold and wait. We prove this by burning LP. 
// dorgDAO is a Governance token
// Website: dorg.tech
// Twitter: @dOrg_tech
// Private TG: t.me/joinchat/4MylKc7-cvxhoDA1
...
contract dorgDAO is SafeERC20 {

    constructor() SafeERC20("dorgDAO", "API") {
