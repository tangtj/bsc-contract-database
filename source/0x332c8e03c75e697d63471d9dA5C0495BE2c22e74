...
// ONLY CONTACT REAL DEV TEAM (https://sportydoge.net/)
...
contract SportyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Sporty Doge";
    ...
    uint256 public _sellMarketingAndPumpFee = 30;

    uint256 public _maxTxAmount = 1 * 10**12 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**11 * 10**9;

    address payable public pumpAndMarketing = 0x5dA094498dAD1ba306Dc0cc5255E23ac154Ff6e8;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferPumpBNB(pumpAndMarketing, address(this).balance);
    }
    ...
    function TransferPumpBNB(address payable recipient, uint256 amount) private {
