...
contract MoonRocketCoin is Context, IERC20, Ownable {
    ...
    function setFeeRates(uint256 _rfi, uint256 _development, uint256 _charity, uint256 _liquidity, uint256 _buyback) external onlyOwner {
        feeRates.rfi = _rfi;
    ...
    function setSellFeeRates(uint256 _rfi, uint256 _development, uint256 _charity, uint256 _liquidity, uint256 _buyback) external onlyOwner{
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
        ...
        uint256 denominator= (feeRates.liquidity + feeRates.buyback + feeRates.development + feeRates.charity) * 2;
