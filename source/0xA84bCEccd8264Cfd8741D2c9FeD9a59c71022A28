...
Website    : https://dochi.site
Twitter    : https://twitter.com/Dochibsc
Telegram   : https://t.me/Dochibsc
Reddit     : https://www.reddit.com/user/Dochibsc
Whitepaper : https://dochi.gitbook.io/whitepaper/
...
contract DOCHI is ERC20, Ownable {
    ...
    constructor() payable ERC20("DOCHI", "DOCHI") {
        ...
        burnFeeOnBuy        = 5;
        marketingFeeOnBuy   = 55;
        totalBuyFee         = burnFeeOnBuy + marketingFeeOnBuy;

        burnFeeOnSell       = 5;
        marketingFeeOnSell  = 75;
        totalSellFee        = burnFeeOnSell + marketingFeeOnSell;

        totalFees           = totalBuyFee + totalSellFee;

        marketingWallet = 0x6a2F5813F561B91e324f54faD4A0cE91d4b16047;
        developmentWallet1 = 0x7e9975EAcCd812dFba0d3607A3b2D0b53e2aD26C;
        developmentWallet2 = 0x65c43bC1F06C74ef6Fb029ea618Cd1f6d815844A;
        developmentWallet3 = 0x2b141615a8a8671c40942cbAAF1612c18fAEE481;
