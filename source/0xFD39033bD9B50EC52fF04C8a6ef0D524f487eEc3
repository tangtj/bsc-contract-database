/**                   
 *   Telegram:
 *   https://t.me/MemeLeonPortal
 *   
 *   Twitter:
 *   https://twitter.com/thememeleon
 *   
 *   Linktree:
 *   https://linktr.ee/memeleon
*/         
...
contract LEON is ERC20, Ownable {
    ...
    constructor() ERC20("MemeLeon", "MMGA") {
        ...
        address newOwner = address(0x9C5cF82c9d47A4E394A2df34597d7e45605E56bC);
    	...
    	marketingWallet = address(0x55d187AA3DE2150065087eB4a743088aefD0Ba8A);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x9C5cF82c9d47A4E394A2df34597d7e45605E56bC),
            block.timestamp
        );
