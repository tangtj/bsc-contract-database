...
contract JuggerDRAWV3 is ERC1155Tradable {
	constructor() public ERC1155Tradable("JuggerDRAWV3", "DRAWV3") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api5/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api5/contract/jgn";
	}
}