/*
Tg: https://t.me/pumpagainbsc
Twitter : https://twitter.com/pumpagainbsc
*/
...
contract PumpAgain is Context, IERC20 {
    string private _name = "Pump Again";
    string private _symbol = unicode"再次泵压";
    ...
    address payable public MarketingWallet = payable(0xEd445cf43924ACfAb9fC789A8fB2c8023A604CbB);
