...
contract Lunomics is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x086FBc21da44994F41C4065fe7410D3600071De7); 
    address payable public Wallet_Dev = payable(0x086FBc21da44994F41C4065fe7410D3600071De7);
    ...
    string private constant _name = "Lunomics"; 
    string private constant _symbol = unicode"LU-NOMIC"; 
    ...
    constructor () {
        ...
        _owner = 0xb90Dd25407BdE9770A13b8a14D98F9417d1b21E8;
