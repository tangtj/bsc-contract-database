...
contract HappyCoin is ERC20, Pausable, ERC20Detailed {
    
    address mainWallet = 0xBDBFAAb2fce3B0223F83a574DEC343A829E8a50b;
	address teamWallet = 0x1109acbc81cF29F35B083ce882F81843a4D932B0;
    address partnerWallet = 0x8A3e343f6b38E6776B404dDeB031248B4D38B4c0;
    address saleWallet = 0x6E0D0103e8dBf713336e790Ab738dC89A4E00D70;
	...
	constructor() public ERC20Detailed("Happy Coin", "Happy", 6) {  

        quarterMap[1]=1632096000;//=Mon, 20 Sep 2021 00:00:00 GMT
        quarterMap[2]=1639958400;//=Mon, 20 Dec 2021 00:00:00 GMT
        quarterMap[3]=1647734400;//=Sun, 20 Mar 2022 00:00:00 GMT
        quarterMap[4]=1655683200;//=Mon, 20 Jun 2022 00:00:00 GMT
        quarterMap[5]=1663632000;//=Tue, 20 Sep 2022 00:00:00 GMT
        quarterMap[6]=1671494400;//=Tue, 20 Dec 2022 00:00:00 GMT
        quarterMap[7]=1679270400;//=Mon, 20 Mar 2023 00:00:00 GMT
        quarterMap[8]=1687219200;//=Tue, 20 Jun 2023 00:00:00 GMT
        quarterMap[9]=1695168000;//=Wed, 20 Sep 2023 00:00:00 GMT
        quarterMap[10]=1703030400;//=Wed, 20 Dec 2023 00:00:00 GMT
        quarterMap[11]=1710892800;//=Wed, 20 Mar 2024 00:00:00 GMT
        quarterMap[12]=1718841600;//=Thu, 20 Jun 2024 00:00:00 GMT
        quarterMap[13]=1726790400;//=Fri, 20 Sep 2024 00:00:00 GMT
        quarterMap[14]=1734652800;//=Fri, 20 Dec 2024 00:00:00 GMT
        quarterMap[15]=1742428800;//=Thu, 20 Mar 2025 00:00:00 GMT
        quarterMap[16]=1750377600;//=Fri, 20 Jun 2025 00:00:00 GMT
        quarterMap[17]=1758326400;//=Sat, 20 Sep 2025 00:00:00 GMT
        quarterMap[18]=1766188800;//=Sat, 20 Dec 2025 00:00:00 GMT
        quarterMap[19]=1773964800;//=Fri, 20 Mar 2026 00:00:00 GMT
        quarterMap[20]=1781913600;//=Sat, 20 Jun 2026 00:00:00 GMT
        
        totalCoins = 500000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 500 million coins

        transferAndLock(mainWallet, 2500000 * 10 ** uint256(decimals()), quarterMap[1]);
        transferAndLock(teamWallet, 6250000 * 10 ** uint256(decimals()), quarterMap[1]);
        transferAndLock(partnerWallet, 2083337 * 10 ** uint256(decimals()), quarterMap[1]);
        transferAndLock(saleWallet, 350000000 * 10 ** uint256(decimals()), quarterMap[1]);
        
        for(uint i = 2; i<= 20; i++) {
            transferAndLock(mainWallet, 2500000 * 10 ** uint256(decimals()), quarterMap[i]);
        }
        
        for(uint i = 2; i<= 12; i++) {
            transferAndLock(teamWallet, 6250000 * 10 ** uint256(decimals()), quarterMap[i]);
            transferAndLock(partnerWallet, 2083333 * 10 ** uint256(decimals()), quarterMap[i]);
        }
    }
	...
	function transferAndLock(address _receiver, uint256 _amount, uint256 _releaseDate) public whenNotPaused returns (bool success) {
	    require(msg.sender == mainWallet || msg.sender == teamWallet || msg.sender == partnerWallet || msg.sender == saleWallet || msg.sender == owner());
