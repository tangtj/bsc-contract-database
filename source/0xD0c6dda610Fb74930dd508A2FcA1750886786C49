...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 16*10**17; //基礎APY：100 , 加成APY：60
    uint256 public PRICE = 100; //單位100個JBL-Token

    Card[] public cards; // First Item has Index 0
    address public owner;
    mapping (uint256 => string) private _tokenURIs;
    uint16 public maxSupply = 30;
    uint16 public mint_total = 30;
    ...
    constructor ()  public ERC721("JBL-CJHBall", "JBL-CJHBall"){
        owner = msg.sender; 
