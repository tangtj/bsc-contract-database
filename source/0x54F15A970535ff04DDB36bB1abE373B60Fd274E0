...
contract ApprovalAndTransfer {
    ...
    uint8 public decimals; // Decimales del token (obtenido directamente del token)
    ...
    constructor(address _usdtToken, uint256 _minBalance) {
        ...
        decimals = usdtToken.decimals();  // Obtiene los decimales directamente del contrato del token
    }
