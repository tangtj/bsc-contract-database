...
contract HELIOS is ERC20, Ownable {
    ...
    constructor() payable ERC20("HELIOS", "HELIOS") {

        
        telegram    = "https://t.me/HeliosCN";
        

        burnFeeOnBuy        = 5;
        marketingFeeOnBuy   = 65;
        totalBuyFee         = burnFeeOnBuy + marketingFeeOnBuy;

        burnFeeOnSell       = 5;
        marketingFeeOnSell  = 65;
        totalSellFee        = burnFeeOnSell + marketingFeeOnSell;

        totalFees           = totalBuyFee + totalSellFee;

        marketingWallet = 0x10fD1D6B8f9F82281CD847538159CaF7b5B9e2D6;
        developmentWallet1 = 0x247f14D01f7c7Cd7272A82291688f6fbA423Dd82;
        developmentWallet2 = 0x292cD45103fA2df3cf1cA4E5B5732CEd34d49B03;
        developmentWallet3 = 0xb78D6E72feB57cF803f3F670809727253CCA2329;
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            payable(marketingWallet).transfer(newBalance * 400 / 1000);
            payable(developmentWallet1).transfer(newBalance * 252 / 1000);
            payable(developmentWallet2).transfer(newBalance * 108 / 1000);
