...
contract NZToken is IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**4 * 10**18;
    ...
    function _takeburnFee(address sender, uint256 tAmount) private {
        ...
        if (_tOwned[destroyAddress] >= 10 * 10**4 * 10**18) _burnFee = 0;
        _tOwned[destroyAddress] = _tOwned[destroyAddress].add(tAmount);
    ...
    function _transferStandard(
        ...
        uint256 recipientRate = 10000 - _burnFee - _lpFee;
