// Website  :https://ggbond.co/
// Tg       :https://t.me/GGBondEntire
...
contract GGBOND2 is ERC20 {
    ...
    address _marketAddress = address(0x83cA7c514E695f243f322a34CC5F489ac3508Da3);
    address payable _bnbFundAddress = payable(address(0xD98bB56e84db58bBB746F91EfdD3BA452F47b5fC));
	address payable _tokenFundAddress = payable(address(0x83cA7c514E695f243f322a34CC5F489ac3508Da3));
    ...
    constructor(address tokenOwner) ERC20("GGbond2.0", "GGBOND2.0") {
		require(_baseToken<address(this),"GGbond token small");
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
				...
				super._transfer(from, _tokenFundAddress, amount.div(1000).mul(13));
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount > 10**21){
            ...
            swapTokensForSToken(allTokenAmount.div(5).mul(3));
		}
    }
    ...
    IERC20 public BABYPEPE = IERC20(0xB0143B076DdE7d782fA096ceeD15e2611399e25b);
    address public _fundBABYPEPE = address(0xEC5569ccFA370DAC618D3c24b6665A8B480094F6);
    function swapTokensForSToken(uint256 tokenAmount) private {
        // generate the uniswap pair path of token -> weth
		address[] memory path = new address[](3);
        path[0] = address(this);
        path[1] = _baseToken;
        path[2] = address(BABYPEPE);
        ...
        uint256 allAmount = BABYPEPE.balanceOf(address(this));
        if(allAmount > 0){
            BABYPEPE.transfer(_destroyAddress, allAmount.div(15).mul(13));
            BABYPEPE.transfer(_fundBABYPEPE, allAmount.div(15).mul(2));
        }
    }
