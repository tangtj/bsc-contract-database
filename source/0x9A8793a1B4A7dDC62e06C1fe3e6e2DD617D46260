...
contract TRASH is Context, IERC20, Ownable {
    ...
    string private _name = "TRASH";
    string private _symbol = "TRASH";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2302BB22853f938515fBB9b727e389A185891bA1); 
    address payable private DevelopmentWalletAddress = payable(0x2302BB22853f938515fBB9b727e389A185891bA1); 
    ...
    uint256 public _maxTxAmount = 600 * 10**5 * 10**9;
    uint256 public _walletMax = 600 * 10**5 * 10**9;
