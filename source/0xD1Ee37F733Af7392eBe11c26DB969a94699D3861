// telegram     : https://t.me/novo_protocol
// Website      : https://novoprotocol.online/
...
contract NovoProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Novo Protocol";
    string private _symbol = "$NOVO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B4dEB96d5FcaA49930bEB7A3E6a0eC627DA717D); // Marketing Address
    address payable public teamWalletAddress = payable(0x1B4dEB96d5FcaA49930bEB7A3E6a0eC627DA717D); // Team Address
