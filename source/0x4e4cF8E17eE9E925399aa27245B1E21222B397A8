...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35aeB5a320Ecb6B65bEb39F4cF98910F2fBd4eBE; // owner address
...
contract XBOX is Context, IERC20, Ownable {
    ...
    string private _name = "X-BOX";
    string private _symbol = "$X-BOX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x35aeB5a320Ecb6B65bEb39F4cF98910F2fBd4eBE); // Marketing Address
    address payable private teamWalletAddress = payable(0x35aeB5a320Ecb6B65bEb39F4cF98910F2fBd4eBE); // Team Address
