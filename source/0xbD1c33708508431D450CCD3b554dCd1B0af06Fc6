...
contract BigMoon is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Big Moon";
    string private _symbol = unicode"BIGMOON";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x8d73E00eA1D36d34A093AC944B189E310fe00aeD);
    address payable private taxWallet2 = payable(0x8d73E00eA1D36d34A093AC944B189E310fe00aeD);
