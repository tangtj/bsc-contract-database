...
contract BNBkingMiner {
    using SafeMath for uint256;

    /** base parameters **/
    uint256 public EGGS_TO_HIRE_1MINERS = 1728000; // 5%
    uint256 public EGGS_TO_HIRE_1MINERS_COMPOUND = 1728000;  //5%
    uint256 public REFERRAL = 100; //10%
    uint256 public PERCENTS_DIVIDER = 1000; 
    uint256 public PROJECT = 50; //5% Dev Fees for marketing
    ...
    uint256 public LOTTERY_TICKET_PRICE = 1 * 1e16; /** 0.01 bnb **/
...
event Claimed(address user, uint amount);
   ...
   /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
    ...
    function min(uint256 a, uint256 b) private pure returns (uint256) {
        ...
        function ENABLE_REWARD(uint256 amount) public  
    {
