...
Telegram: https://t.me/buffpepeentryportal
...
contract BUFFPEPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BUFF PEPE", "BUFPE") {
        ...
        uint256 _buyLiquidity = 1;
        uint256 _buyDev = 1;
 
        uint256 _sellMarketing = 2;
        uint256 _sellLiquidity = 1;
        uint256 _sellDev = 1;
        ...
        marketingWallet = 0x8e43A192875f520d569afb871D126272f4b9Bf5b;
        devWallet = 0x8e43A192875f520d569afb871D126272f4b9Bf5b;
    ...
    function _transfer(
        ...
        // if any account belongs to _isExcludeFeeFromFee account then remove the fee
