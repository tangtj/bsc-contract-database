...
contract odochain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ODO CHAIN";
    string private _symbol = "ODO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xda3cF72F90C38e3F006b02eB630113EBd7626182); // Marketing Address
    address payable private teamWalletAddress = payable(0xda3cF72F90C38e3F006b02eB630113EBd7626182); // Team Address
