...
contract MoonCatcher is Context, IERC20, Ownable {
    ...
    string private constant _name = "Moon Catcher"; // 
    string private constant _symbol = "MOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x212128765b056AE6C98a99fde73739812bB34a9E;
