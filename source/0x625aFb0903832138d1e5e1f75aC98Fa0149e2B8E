...
contract PAYLPDividend is Ownable {
    ...
    constructor() {
        ...
        fundAddress = address(0x86050FB2b49CE6F927bD6A6Dfad0a6d0701844FF);
    ...
    uint256 private rewardCondition = 300 * 10**18;
