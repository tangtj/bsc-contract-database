/*
X BALDCOIN is a community token whose goal is to unite all cryptocurrency enthusiasts by providing never-before-seen community building. The plan is to have a massive marketing and aggressive buyback and burn strategies.
...
🚀 2% Buy and Sell Tax
🚀 100% Max Transaction and Max Wallet

Join our telegram group for more info
Telegram Group: https://t.me/Xbaldcoin
Website: Coming Soon
*/
...
contract XBALDCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "X BALDCOIN";
