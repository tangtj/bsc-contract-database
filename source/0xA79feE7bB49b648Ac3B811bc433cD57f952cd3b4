...
contract PEPOSHINAKAMOTO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 499000000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PEPOSHINAKAMOTO";
    string private _symbol = "PEPOSHI";
    ...
    address payable public marketingWallet = payable(0x662ab087A07A42371377390069B3A3A410Da56a2);
    ...
    uint256 public numTokensSellToAddToLiquidity = 9980000000 * 10**18;
    uint256 public _maxTxAmount = 9980000000 * 10**18;
    uint256 public _maxWalletLimit = 9980000000 * 10 ** 18;
