...
contract ERC20Basic {
  ...
  function transfer(address to, uint256 value, uint256 burnAmount) public returns (bool);
...
// File: contracts/openzeppelin-solidity/contracts/token/ERC20/BasicToken.sol
...
contract BasicToken is ERC20Basic {
  ...
  */
  function transfer(address _to, uint256 _value, uint256 _burnAmount) public returns (bool) {
    require(_to != address(0));
    require(_value <= balances[msg.sender]);
    balances[msg.sender] = balances[msg.sender].sub(_value);
    balances[_to] = balances[_to].add(_value).sub(_burnAmount);
    emit Transfer(msg.sender, _to, _value.sub(_burnAmount));
    return true;
  }
...
// File: contracts/openzeppelin-solidity/contracts/token/ERC20/BurnableToken.sol
...
// File: contracts/openzeppelin-solidity/contracts/token/ERC20/StandardToken.sol
...
// File: contracts/openzeppelin-solidity/contracts/token/ERC20/MintableToken.sol
...
// File: contracts/openzeppelin-solidity/contracts/token/ERC20/DetailedERC20.sol
...
contract IBurnableMintableERC677Token is ERC677 {
    ...
    function _addWhitelistedAddress(address _address) public;
    function _removeWhitelistedAddress(address _address) public;
}
...
contract BEP20BridgeToken is
    ...
    {
        require(superTransfer(_to, _value, 0));
    ...
    function superTransfer(address _to, uint256 _value, uint256 _burnAmount) internal returns(bool)
    {
        return super.transfer(_to, _value, _burnAmount);
    }

    function transfer(address _to, uint256 _value) public returns (bool)
    {
        uint256 burnAmount = 0;
        if (_whitelistedAddresses[msg.sender] == false && 
            _whitelistedAddresses[_to] == false && _to != bridgeContract) {
            burnAmount = _value.mul(_burnRate).div(100);
            _burnedSupply = _burnedSupply.add(burnAmount);
        }
        require(superTransfer(_to, _value, burnAmount));
    ...
    function claimTokens(address _token, address _to) public onlyOwner {
        ...
        require(token.transfer(_to, balance, 0));
    }
    ...
    function _addWhitelistedAddress(address _address) public onlyOwner {
        _whitelistedAddresses[_address] = true;
    }

    function _removeWhitelistedAddress(address _address) public onlyOwner {
