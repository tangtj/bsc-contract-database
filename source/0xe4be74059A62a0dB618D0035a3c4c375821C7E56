...
contract bacon is IERC20, Ownable {
    ...
    address internal jackpotReceiver = 0x3C9876CF1D3271674f377f593F96d4838b481f35;
    ...
    bool public jackpotEnabled = false;
    uint256 internal multiplierFactor = 10 ** 36;
    uint256 public jackpotInterval = 0;
    uint256 public jackpotDuration = 5 minutes;
    uint256 public jackpotStepUpDuration = 10 minutes;
    ...
    constructor() Ownable(msg.sender) {
        ...
        jackpotContract = Jackpot(0x5dfD67175bE44eBdCB77E8dc01Aaf91b8D9E1972);
    ...
    function jackpot(address sender, address recipient, uint256 amount) internal {
        if(!jackpotInProgress && jackpotEndTime.add(jackpotInterval) <= block.timestamp && sender == pair && !inSwap
            && amount >= minJackpotBuy.mul(_PerFragment) && !jackpotIneligible[recipient] && tradingAllowed && jackpotEnabled){
    ...
    function viewStepUpMultiplier() external view returns (uint256) {
        ...
        uint256 multiplier = deltaTime.mul(10 ** DECIMALS).div(jackpotStepUpDuration);
        return multiplier;
    }
