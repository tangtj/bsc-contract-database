...
/**TG: https://t.me/babyfouriumportal
Website: 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  FRM = IBEP20(0x6FdCE1382566BAa7f7e35CFA4005C677D649e375);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FRM .balanceOf(address(this));
        ...
        uint256 amount = FRM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FRM.transfer(shareholder, amount);
...
contract BabyFourium is IBEP20, Auth {
    using SafeMath for uint256;

    address FRM = 0x6FdCE1382566BAa7f7e35CFA4005C677D649e375; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5Ae9e26d32d4b5a072ba846A8Ec5E66C2decf981;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Baby Fourium";
    string constant _symbol = "BABYFRM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200000000 * 10**0 * (10 ** _decimals);
    ...
    uint256 public reflectionFeeSell = 15;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x5Ae9e26d32d4b5a072ba846A8Ec5E66C2decf981;
