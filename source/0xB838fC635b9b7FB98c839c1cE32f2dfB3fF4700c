...
contract MOMO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3a162f7B74e485A9e71C9E5256ca8583fC1500dc); 
    address payable public teamWalletAddress = payable(0x3a162f7B74e485A9e71C9E5256ca8583fC1500dc);
