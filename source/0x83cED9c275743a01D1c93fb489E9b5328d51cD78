...
contract NCR is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 20; // totalsupply divided with 200
    ...
    string private constant _name = "NoCROmo";
