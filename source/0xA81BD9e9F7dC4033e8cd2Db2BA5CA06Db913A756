...
$MOON & DOGE is on the hype today and being brought out on the social media news.

If you missed out $MoonDogeCoin in their first hype this is the chance for you to 
be first and get the x1000 potential on his New version. #MOOGE INU 🚀

              🌔 MOON x DOGE 🐶

        ☎️TG: https://t.me/moogeinu
 
        🌍WEB:hppts://www.mooginu.online/ (not yet live)

        🐤TWITTER: https://twitter.com/moogeinu
...
contract MOOGEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mooge Inu"; 
    string private constant _symbol = "Mooge"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 1;
    address private _promoWallet = 0x09f97f07b8e075325d36ac82E982772Cb976Cbfe
