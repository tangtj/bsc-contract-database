...
contract Xetaverse is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Xetaverse";
    string private constant _symbol = unicode"Xetaverse";
