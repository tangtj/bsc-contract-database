...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _tTotal = total;
        swapAtAmount = Supply * 10 ** Decimals;   //
        ...
        holderRewardCondition = 30 ** IERC20(USDTAddress).decimals();//
                ...
                if (_swapPairList[to]) {
                    if (!inSwap && !isAdd) {
                        ...
                        if (contractTokenBalance > swapAtAmount) {
                            ...
                            uint256 numTokensSellToFund = amount * swapFee/10000000000000000000;
    ...
    uint256 public addLiquidityFee = 0;//加持子税        
    uint256 public removeLiquidityFee = 10000;//撤池子税
