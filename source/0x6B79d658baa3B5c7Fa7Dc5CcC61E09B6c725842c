...
contract CareCoin is Context, IERC20, Ownable {
    ...
    function setBuyFee(
        ...
        buyFee.burnFee = burn;
        _totalBuyFee = liq + market + tax + donation + burn;
        require (_totalBuyFee < 130, "total buy fees must be less than 13%");
    ...
    function setSellFee(
        ...
        _totalSellFee = liq + market + tax + donation + burn;
        require (_totalSellFee < 130, "total sell fees must be less than 13%");
    }
