...
contract Catboy is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x5D70DFB6aedB75969BEe6C2d8A6CB530586c1520);
    address payable private _twdmkt = payable(0x5D70DFB6aedB75969BEe6C2d8A6CB530586c1520);
