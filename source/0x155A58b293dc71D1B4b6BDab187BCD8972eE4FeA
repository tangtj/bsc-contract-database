...
contract Defi is Ownable {
    ...
    function staking(uint256 amountIp) public returns (bool) {
        ...
        require(
            amounts >= 50 * 10**18 && amountIp >= 1 * 10**18,
        ...
        uint8 _pt = 0;
        if (amounts >= 50 * 10**18 && amounts < 3000 * 10**18) {
            types = 1;
            _pt = 7;
        } else if (
            amounts >= 3000 * 10**18 && amounts < 30000 * 10**18
        ) {
            types = 2;
            _pt = 10;
        } else if (amounts >= 30000 * 10**18) {
            types = 3;
            _pt = 13;
        } else {
            types = 0;
    ...
    function withdraw() public returns (bool) {
        ...
        address ref = _users[msg.sender].ref;
        address ref1 = addCmmBrand((profds * 15) / 100, ref);
        ...
        address ref5 = addCmmBrand((profds * 3) / 100, ref4);
        address ref6 = addCmmBrand((profds * 3) / 100, ref5);
        address ref7 = addCmmBrand((profds * 3) / 100, ref6);
        address ref8 = addCmmBrand((profds * 3) / 100, ref7);
        address ref9 = addCmmBrand((profds * 3) / 100, ref8);
        addCmmBrand((profds * 3) / 100, ref9);
        return true;
    }
