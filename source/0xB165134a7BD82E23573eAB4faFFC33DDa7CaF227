...
contract BOOINU is Ownable, IBEP20 {
    ...
    string public constant _name = "BOO!INU";
    string public constant _symbol = "$BOO!";
    ...
    constructor() {
        ...
        marketingWallet = 0x285Ff560637CaED555FdDb2C697E5448FEDf3687;
