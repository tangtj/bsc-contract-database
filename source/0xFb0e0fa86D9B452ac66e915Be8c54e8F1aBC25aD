...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29a1f9D257F473788B53Cdc8546f3B87313B95fc; // owner address
...
contract Token711 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "711";
    string private _symbol = "711";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x29a1f9D257F473788B53Cdc8546f3B87313B95fc); // Marketing Address
    address payable private teamWalletAddress = payable(0x29a1f9D257F473788B53Cdc8546f3B87313B95fc); // Team Address
    ...
    uint256 public _maxTxAmount = 80 * 10**_decimals; 
    uint256 public _walletMax = 240 * 10**_decimals;
