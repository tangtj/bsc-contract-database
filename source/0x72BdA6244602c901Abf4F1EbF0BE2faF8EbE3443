...
contract Sagirium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xDE1cb44559Fe2C106ab0E1AA271d8e444af34A56);
    address payable private _twdmkt = payable(0xDE1cb44559Fe2C106ab0E1AA271d8e444af34A56);
    
    string private constant _name = "Sagirium";
    string private constant _symbol = "$SAGI";
