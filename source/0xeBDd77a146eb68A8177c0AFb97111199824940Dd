...
contract EtherETF is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xA27aBEF4E38E95342CaA3D7f5C307F12BecfDf03);
    address payable private _mkt = payable(0xA27aBEF4E38E95342CaA3D7f5C307F12BecfDf03);
    
    string private constant _name = "Ether ETF";
