...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8070d4592f44Fa0aE2DccCc17E646E0240d0EBcB; // owner address
...
contract GEKE is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0x8070d4592f44Fa0aE2DccCc17E646E0240d0EBcB);
