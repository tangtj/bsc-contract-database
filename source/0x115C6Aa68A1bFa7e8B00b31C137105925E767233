...
/*
        Yearn Finance Global is the abbreviation of  YFIG https://yfig.finance/
        Yearn Finance Global (YFIG) success is due to the core technology from YFI.
...
contract YFIG is ERC20Interface {
