...
contract DragonLiToken is IERC20, Ownable {
    ...
    constructor( 
        ...
        fundAddress = 0xf35Ef2945344308bF92283CD230Cf9CD5277C492;
        ...
        address ReceiveAddress = 0xf35Ef2945344308bF92283CD230Cf9CD5277C492;
        ETH = 0x55d398326f99059fF775485246999027B3197955;

        maxBuyAmount = 10000000000 * 10 ** 18;
        maxSellAmount = 100000000000 * 10 ** 18;
        require(
