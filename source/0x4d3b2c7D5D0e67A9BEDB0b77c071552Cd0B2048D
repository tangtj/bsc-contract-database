...
Telegram: https://t.me/satoshiclaus
...
contract satoshiclaus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Satoshi Claus";
    string constant _symbol = "SCLAUS";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1f70575086aCDb50af5C366b5F3989361D8dDa2A;
