...
contract OSOCOIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbe310F125A848809a8Aa710157161f37034774b7); 
    address payable public Wallet_Dev = payable(0xbe310F125A848809a8Aa710157161f37034774b7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =30 * 10**3* 10**3 * 6**_decimals;
    string private constant _name = "Oso Coin"; 
    string private constant _symbol = unicode"OSO COIN"; 
    ...
    constructor () {
        _owner =0xbe310F125A848809a8Aa710157161f37034774b7;
