...
// ----------------------------------------------------------------------------
// 'Space Whale' token contract
//
// Deployed to : 0xc11c53F93c58Db68C8f09FF58F308031543eAB7e
// Symbol      : Space Whale
// Name        : MUSK
...
contract Space_whale is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Space whale";
  string constant tokenSymbol = "MUSK";
