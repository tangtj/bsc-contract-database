...
*/
/**
 🌐Sentrix Network is a groundbreaking blockchain 
 ecosystem designed to redefine the way we interact with digital assets, data, 
 and decentralized applications, all powered by the integration of advanced AI technology
// TELEGRAM: https:https://t.me/sentrixnetwork
// WEBSITE:https://sentrixnetwork.com
*/
...
contract SentrixNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SentrixNetwork";
    string private _symbol = "SNX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0x3D30148De5B60839fD5C6439bE156B067280c8CA);
