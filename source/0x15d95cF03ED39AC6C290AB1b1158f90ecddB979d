...
contract Bitlayer is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf1a68A1D48cF87DC9A4aE3c5c48Da57cfbCd3678);
    address payable public teamWalletAddress = payable(0x689B6A02BA989D699819De522075Ff0A7073617d);
