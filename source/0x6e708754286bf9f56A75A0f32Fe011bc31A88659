...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _transferBurnFee= 750;
    ...
    function setMaxAmount(uint256 _maxBuyAmount,uint256 _maxSellAmount,uint256 _walletLimit,uint256 _transferBurn) public onlyOwner{
        maxBuyAmount = _maxBuyAmount;
        maxSellAmount = _maxSellAmount;
        walletLimit = _walletLimit;
       transferBurn = _transferBurn;
    }
    ...
    function _funTransfer(
     ...
     function _burnTransfer(
        ...
        _balances[sender] = _balances[sender] - tAmount;
        uint256 feeAmount = tAmount * _transferBurnFee / 10000;
        _takeTransfer(
            sender,
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[recipient]) {
               ...
               require(tAmount <= transferBurn,"over max transfer amount");
            }
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x44Fa08D7324f20941c4bA2c09877AB034dfee771), block.timestamp
                );
            }
        }
    }
  ...
  function settransferBurnFee(uint256 BurnFee ) external onlyOwner {
...
contract DScoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0xDCC8BE549Ef32e5B98CACBf7f81874852FF3eE5B),//FundAddress
        address(0x44Fa08D7324f20941c4bA2c09877AB034dfee771)//ReceiveAddress
    ){
    }
}