...
contract VisionNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vision Network";
    string private _symbol = "VSN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd896D1FF64D34F585EF941A0983C8B266696C859); // Marketing Address
    address payable public teamWalletAddress = payable(0xd896D1FF64D34F585EF941A0983C8B266696C859); // Team Address
