...
TG Community - https://t.me/SuperMarioBrosBSC
...
contract aaaa is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "huseyin";
    string private constant _symbol = "huseyin";
    uint8 private constant _decimals = 18;
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    uint256 private constant _tTotal = 57 * 10**18;
    ...
    address payable private _marketingAddress = payable(0x3A56B69f980DD5cbBAAafccF51b28eC60963f93e);
    address payable private _teamAddress = payable(0x3A56B69f980DD5cbBAAafccF51b28eC60963f93e);
    address payable private _ecosystemAddress = payable(0x3A56B69f980DD5cbBAAafccF51b28eC60963f93e);
    address payable private _lpRecipient = payable(0x3A56B69f980DD5cbBAAafccF51b28eC60963f93e);
