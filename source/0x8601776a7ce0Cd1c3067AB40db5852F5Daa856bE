...
contract HarryPotter is Context, IERC20, Ownable {
    ...
    string private constant _name = "HarryPotterObamaSatoshi1Meme ";
    string private constant _symbol = "$HPOS1MM";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3Fc0Fc6B9fA3D8295a1DFEBE5B708c7Bd94326f1);
    address payable private _marketingAddress = payable(0x3Fc0Fc6B9fA3D8295a1DFEBE5B708c7Bd94326f1);
