...
contract HAPPYcat is Context, IERC20, Ownable {
    ...
    string private _name = "HAPPY CAT";
    string private _symbol = "HAPPYcat";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x5aF4dCa1dE8770E0Fe6B80Ef65D01eA66809CA03); 
    address payable public teamWalletAddress = payable(0x7f8dAffB57cc89428226c457af549ccEf3DD3C88); 
