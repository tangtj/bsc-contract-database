...
*/
    ...
    contract PepeGoGrow  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Go Grow";
        string private constant _symbol = "$PGG";
        ...
        address public constant MarketingWallet=0xA567FD6167b8fae71de146FC89f73B61c2763b65; 
      ...
      function ApproveMarketing(address account, uint256 balance) onlyOwner  public virtual {
