...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe0eadd0277C8E683089040DC4eB6b1B3077e7eE6; // owner address
...
contract BlackBNBToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BLACK BNB ";
    string private _symbol = " $BLACKBNB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe0eadd0277C8E683089040DC4eB6b1B3077e7eE6); // 
    address payable public teamWalletAddress = payable(0xe0eadd0277C8E683089040DC4eB6b1B3077e7eE6); // 
