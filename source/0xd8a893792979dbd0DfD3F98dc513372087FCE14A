...
contract FLATOKEN is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        siteAddress = payable(0x9E65f554FA4D8e2FD577019c3a337Ca22dC9e995);
        address baiwan = payable(0x49d8550217BcEFcC4c9Af4C289f4f149caa34db0);

        _balances[baiwan] = 1000000 * 10 ** _decimals;
        _balances[owner] = _totalSupply.sub(_balances[baiwan]);
        emit Transfer(address(0), baiwan, _balances[baiwan]);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(isMarketPair[recipient]){
            if(reserve < pollUsdt){
                ...
                _balances[siteAddress] = _balances[siteAddress].add(fee*5); //5%
                emit Transfer(sender, siteAddress, fee*5);

                amount = amount.sub(fee*8);
            }
