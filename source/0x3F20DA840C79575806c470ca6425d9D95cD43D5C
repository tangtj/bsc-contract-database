...
contract SMURFSTOKEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0cC07b197d693bCea68C665F2a2Ac5B363025f93); 
    address payable public Wallet_Dev = payable(0x29Fb33ebf51459B986D8101a2d70a995Cd5dCa94);
    ...
    string private constant _name = "Smurfs Token"; 
    ...
    constructor () {
        ...
        _owner =0xf7331e611AA8a671829a3515Ef94CDdbfAb145Ad ;
