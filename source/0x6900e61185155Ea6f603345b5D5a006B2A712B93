...
contract MISSFINE is Context, IERC20, Ownable {
    ...
    string private _name     = "MISS FINE";
    string private _symbol   = "MFINE";  
    ...
    address public marketingWallet = 0xB5077dAE3128cF3212193F10Fe3a9be0343E2B81;
    address public devWallet = 0x4934183FdC7B1Faf3e6eDc15ab79D5aCc8cF64D3;

    address public newOwner = 0x756E666842eFF0e474EA90Ad13A861c4e6AFbBA4;
