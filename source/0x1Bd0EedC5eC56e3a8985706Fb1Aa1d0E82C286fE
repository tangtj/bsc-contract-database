...
contract ALFATHER is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALFATHER";
    string private constant _symbol = "$AFT";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 30, "Buy fee can't go higher than 10");
        buyFee.liquidity = newLiquidityBuyFee;
        buyFee.marketing= newMarketingBuyFee;

        require(newLiquiditySellFee.add(newMarketingSellFee) <= 30, "Sell fee can't go higher than 8");
