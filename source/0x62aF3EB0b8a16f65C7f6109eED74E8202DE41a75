...
contract GymCat is ERC20 ,Ownable{
    using SafeMath for uint256;
    ...
    address payable private _marketingAddress = payable(0xF0e533AC949AfD844ad2a76ee13001eC806F39f5);//  Wallet of marketing
    address private _deadAdress = 0x000000000000000000000000000000000000dEaD;
    address private _devAddress = 0xF0e533AC949AfD844ad2a76ee13001eC806F39f5;
