...
SKYLAB with its mission to support space-related projects and technological advances, 
makes it a unique and forward-thinking cryptocurrency within the Binance Smart Chain ecosystem.
...
contract SKYLAB is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SKYLAB";
    string private constant _symbol = unicode"$SKYLAB";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 77000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x2AD9addf86e7bd35d89b0Daa27c489DD3C56267e);
    address payable public MarketingWallet = payable(0x8f8c515B58B80088759a1f2a862834fBbf82E6c9);
