...
contract BABYBEAR is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xd18e42652C531482150De4eA6D83E3b82b21bFCD;
    address private opsWallet = 0x671AEFBD2B0302E0CA1ad8b47390EB253b5aBC8D;
    address private devWallet = 0x520059bBDA3a2f9C49C8F27eA69C4cf6A3821dbD;

    string private constant _name = "BABY BEAR";
    ...
    Taxes public taxes = Taxes(0, 2, 1, 0, 0);
    Taxes public sellTaxes = Taxes(0, 2, 1, 0, 0);
