...
contract DOGNEYTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public unnfdj81;
    ...
    string private _tokenname = "DOGE MONEY";
    string private _tokensymbol = "DOGEMONEY";
