// https://t.me/MKFtoken
// https://twitter.com/MasterKey_Fin
// https://masterkey.finance/
...
contract MasterKey is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MasterKey Finance";
    string private constant _symbol = unicode"MKF";
