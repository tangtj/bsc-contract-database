...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB20730c6eabf3Bfec5b7169CbBD8cC7371d7780b; // owner address
...
contract RONS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RonWeasleyDonaldTrumpTails30Inu ";
    string private _symbol = "RWDTT30INU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC7795F0d6E5974DEF6a6981E136d80eefC2B4037); // Marketing Address
    address payable private teamWalletAddress = payable(0xB20730c6eabf3Bfec5b7169CbBD8cC7371d7780b); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 50;  // original 12
