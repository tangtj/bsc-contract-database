...
contract HPOS1M is ERC20, Ownable {
    ...
    constructor() ERC20("HarryPotterObamaSatoshi1Meme", unicode"$BTC") {
        ...
        maxTransactionAmount = 30 * 1e9 * 1e18; 
        ...
        devWallet = address(0xBb6814BB11c3D7b34c52e1117d03c27dC0D26454); 
