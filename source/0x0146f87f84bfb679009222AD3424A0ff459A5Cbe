...
/* Token contract */
contract HOLDITFOR1000x is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x86659A39c5C20af2Ad308E91FD553c1859db751B;
    ...
    // Name and symbol
    string constant _name = "HOLD IT FOR 1000X";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launch or 2B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 1B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% or 2B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x86659A39c5C20af2Ad308E91FD553c1859db751B;
