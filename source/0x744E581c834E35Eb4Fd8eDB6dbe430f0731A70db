...
contract HarryPotterTrumpMaskDogeXInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xacC423723eF5e64767f188192412bfe1806771dc); 
    address payable private Wallet_Dev = payable(0xacC423723eF5e64767f188192412bfe1806771dc);
    ...
    string private constant _name = "HarryPotterTrumpMaskDogeXInu"; 
    string private constant _symbol = unicode"XDOGEinu"; 
    ...
    constructor () {
        ...
        _owner = 0xacC423723eF5e64767f188192412bfe1806771dc;
