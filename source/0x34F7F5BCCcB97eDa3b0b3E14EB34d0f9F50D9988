...
Hamster Race
🐹Hamster Race - 
betting platform is available 
where users can place bets on live-streamed races featuring real hamsters. 
The hamsters run on a track, and the hamster that crosses the finish line first is the winner. 
Users can place real bets on these races.
🥇Cyberscope Audit is done, this company was provided audits for the famous projects 
✅Renounce Ownership after Launch💫BASED 
🔥DexTools/Ave Trending 
✅ No Unlock Token - No Private Sale
✅CMC,CG Fast track
✅Previous project did 40x
✅️Huge marketing strategy
...
contract HamsterRace is Ma, Ru, io {
   ...
   string websites;
   string public HamsterRacewebsite = "https://hamsterraace.space/";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "HamsterRaceToken"; 
        _name = "Hamster Race";
        _symbol = "HamsRace";
        _decimals = 9;
