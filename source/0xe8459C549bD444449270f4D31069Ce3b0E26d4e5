...
contract AIR101 is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "AIRevolution";
    string public _symbol= "AIR";
     bool balances1 = true;

    address payable public charityAddress = payable(0x5C684f04d0210110B97835f057ba5059248BE622); // Marketing Address
