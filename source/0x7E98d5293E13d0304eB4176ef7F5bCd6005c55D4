...
// Telegram - https://t.me/DONALD_PEPE_BSC
// Twitter - https://twitter.com/DONALDPEPE_BSC
...
contract DONALDPEPE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8ECc633C9F589bCD52A67AC24520Ee69eCBc62D4;

    string private constant _name = "DONALD PEPE";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        emit Transfer(sender, marketingWallet, s.tLiquidity + s.tMarketing);
