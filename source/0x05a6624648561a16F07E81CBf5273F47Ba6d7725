...
contract PEPA is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PEPA";
    string private _symbol = unicode"PEPA";
    ...
    address public teamAddress = address(0x570a24Ab60666a454B5cBD09cd892f77cd53307E);

    uint256 private _totalSupply = 100000000 * 10**_decimals;

    uint256 public _maxTxAmount =  _totalSupply.mul(38).div(1000);
    uint256 public _walletMax = _totalSupply.mul(38).div(1000);
