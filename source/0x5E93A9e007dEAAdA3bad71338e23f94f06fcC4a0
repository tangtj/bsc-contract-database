/**
   #Shikuma
    Shikuma INU
    Making this #Shu to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ShikumaInu
    ...
    will burn liquidity LPs to burn addresses to lock the pool forever.
    will renounce the ownership to burn addresses to transfer to the community, make sure it's 100% safe.
    The Future Of Smart Chain
   ...
   it's the best part of the #ShikumaInu idea, increasing the liquidity pool automatically, 
...
contract ShikumaInuToken is Context, IERC20, Ownable {
    ...
    string private _name = "Shikuma Inu";
