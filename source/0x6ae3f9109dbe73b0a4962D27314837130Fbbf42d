...
contract CC is ERC20 {
    ...
    address _fundAddress = address(0x0a575Ebe545C23ccb19bd8ECe73693cf108F6696);
    address _buyAddress = address(0x3339e322144088D499CAa222890B2097610b4204);
    ...
    constructor(address tokenOwner) ERC20("CC", "CCOIN") {
