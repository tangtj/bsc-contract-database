...
contract DOGEPI is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 200000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9a2dB4F470afCECc8E99F52928bF29e9953063bB));
        marketingWalletAddress = payable(address(0x16ED4AB9C7F71aa8dAd2d67a715a3f3393989673));
