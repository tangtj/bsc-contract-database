...
contract Coinmetabank is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xAc01e26a62B1AcEf508a03A5e2002bc4b0F2ce62); // Marketing Address
    ...
    string private constant _name = "Coinmetabank";
    string private constant _symbol = "CMB";
    ...
    constructor() {
        address newOwner = address(0x40C99728E53Fe58F23EBb0a72A85ADef8dFd7299);
