...
contract JabbaDesilijicTiure is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Jabba";
    ...
    uint256 public _maxTaxSwap=8408408400 * 10**_decimals;
