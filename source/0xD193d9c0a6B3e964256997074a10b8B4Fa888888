...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 130;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xd3E8877a16c7523533Db44A49655AF7dB2b96b7e;
...
contract SB is AbsToken {
    constructor() AbsToken(
        ...
        address(0xFa0865F1c76Ac7D417748E2e1212c06b457936F5),
    
        address(0x386C238D0eC85543273EF409113f5F82130A0FAd)
    ){
