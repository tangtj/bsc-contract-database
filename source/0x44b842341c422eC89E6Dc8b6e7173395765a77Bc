...
contract DogeBase is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Base";
    string private constant _symbol = "DOSE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x43e2061198F8ACEA15A16b5987311f8927918C5E);
    address payable private _marketingAddress = payable(0x43e2061198F8ACEA15A16b5987311f8927918C5E);
