/**
Telegram : https://t.me/TigeInuTwo
Website :https://tige-inu.art
*/
...
contract TIGEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdA93856cE962251c5cAD4A278c2E972f79317BA6); 
    address payable private Wallet_Dev = payable(0xdA93856cE962251c5cAD4A278c2E972f79317BA6);
    ...
    string private constant _name = "TIGEINU 2.0"; 
    string private constant _symbol = unicode"TINU2.0"; 
    ...
    constructor () {
        ...
        _owner = 0xdA93856cE962251c5cAD4A278c2E972f79317BA6;
