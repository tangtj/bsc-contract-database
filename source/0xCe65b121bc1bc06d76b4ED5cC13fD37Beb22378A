...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf5fd3A75dBAE736af856c83fa30A1BFCf7d2c562; // owner address
...
contract BLACKBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BLACKBNB ";
    string private _symbol = " $BLACKBNB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf5fd3A75dBAE736af856c83fa30A1BFCf7d2c562); // 
    address payable public teamWalletAddress = payable(0xf5fd3A75dBAE736af856c83fa30A1BFCf7d2c562); // 
