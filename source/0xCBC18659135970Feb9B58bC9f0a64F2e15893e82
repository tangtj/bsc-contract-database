...
/**TG: https://t.me/HarryPotterTrumpbsc
*/
...
contract HarryPotterTrumpHomerSimpson777Inu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xE9412C82E2Af96f2bC68e2760A88F622f2cDA801;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "HarryPotterTrumpHomerSimpson777Inu";
    string constant _symbol = "$HARRYPTS7INU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xee55B1BDC0f9ABE7c022a781654D65AB2cAF0a30;
