...
Telegram : https://t.me/rhinocoin_BSC
Twitter : https://twitter.com/rhino_coinBSC
...
contract RHINO is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xDA5cD3e4e63ca8Dcca405bEeaf86E2044f8e9f45;

    string private constant _name = "Rhino Coin";
    ...
    // Owner cannot transfer out RHINO COIN from this smart contract
