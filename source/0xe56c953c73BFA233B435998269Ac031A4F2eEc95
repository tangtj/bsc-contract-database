...
contract XDOGE is Ownable, ERC20 {
    ...
    string constant _name = "XDoge Test";
    string constant _symbol = "testXD";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x57f3C24596656978Ddf6Cf99031d8D8Cd472c884;
