...
contract HarveyBeaks is Context, IERC20, Ownable {
    ...
    string private constant _name = "Harvey Beaks";
    string private constant _symbol = "$HARVEY";
