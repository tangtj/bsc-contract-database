...
// Telegram: https://t.me/NOVARIUMBSC
...
contract Novarium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x8614EdF7BE01dd671a2Fa2c407e4e46eAf697090);
    address payable private _twdmkt = payable(0x8614EdF7BE01dd671a2Fa2c407e4e46eAf697090);
