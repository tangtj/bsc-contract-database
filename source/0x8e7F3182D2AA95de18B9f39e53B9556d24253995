...
contract KRAV is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0xc55DD7Aec23abF8EcdbF99073603DAB641181B85;
    address public _liquidWalletAddress = 0x6C910926C7FD5B8d6f5eF6F6192223A0d9A78EE3;

    uint256 _totalSupply = 1000000000000000 * 10**9;
    uint256 public maxWalletToken = 1000000000000000 * (10**9) ; //100%
