// Website: https://cybercluck.com/
// Twitter: https://twitter.com/cybercluck
// Telegram: https://t.me/cybercluck
...
contract EggToken is BEP20('Egg', 'EGG') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying EGG (not scaled);
