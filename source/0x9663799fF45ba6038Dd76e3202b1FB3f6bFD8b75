/**
   ...
   Welcome to MoonSafeTeslaSocksLamboApeElonCZJetRocketCoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @MSTSLAECZJRCBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MoonSafeTeslaSocksLamboApeElonCZJetRocketCoin to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MoonSafeTeslaSocksLamboApeElonCZJetRocketCoin 10000X? 
   ...
   it's the best part of the #MoonSafeTeslaSocksLamboApeElonCZJetRocketCoin idea, increasing the liquidity pool automatically, 
...
contract MSTSLAECZJRC is Context, IERC20, Ownable {
    ...
    string private _name = "MSTSLAECZJRC";
    string private _symbol = "MSTSLAECZJRC";
