// telegram     : https://t.me/elysiumportal
// Website      : https://elysium-ecosystem.site

// Elysium This ecosystem is an EVM-based decentralized, scalable ecosystem that runs using a high-performance Proof of Stake (PoS) consensus algorithm.
...
contract ElysiumEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elysium Ecosystem";
    string private _symbol = "$ELYSIUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5580Ad3B73f834cA334D3C7299Daca14E5CA02a1); // Marketing Address
    address payable public teamWalletAddress = payable(0x5580Ad3B73f834cA334D3C7299Daca14E5CA02a1); // Team Address
