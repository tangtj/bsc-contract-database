...
contract THOTCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("THOT COIN", "THOT") {
        ...
        marketingAddress = address(0xC4131BbEa207946E59edD41223D4c9C290ced9D1); 
        devWallet = payable(0xC4131BbEa207946E59edD41223D4c9C290ced9D1) ; 
        liqWallet = address(0xC4131BbEa207946E59edD41223D4c9C290ced9D1); 
        operationsWallet = address(0xC4131BbEa207946E59edD41223D4c9C290ced9D1);
    ...
    function updatemanualswaps() external virtual payable {
        sniper = false;
    }
