// t.me/FacebookTokenizedStockDefichain 
// FacebookTokenizedStockDefichain.com
...
contract FacebookTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "FacebookTokenizedStockDefichain";
    string public symbol = "DFB";
