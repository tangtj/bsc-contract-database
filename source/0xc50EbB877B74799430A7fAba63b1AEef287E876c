...
contract PEGY_Staking {
    using SafeMath for uint256;

    address public signer;
    
    BEP20 PEGY = BEP20(0xa1576d8CB98586332a49b669e58EBFEf28985B7c);
    ...
    function deposit(uint256 _amount) public security{
        require(PEGY.transferFrom(msg.sender,address(this),_amount));
