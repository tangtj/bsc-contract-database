...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x61A607FA127da4d61F28FE39D371Db8F2c06ca4C);
...
contract Pandoge is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0x61A607FA127da4d61F28FE39D371Db8F2c06ca4C;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Pandoge Coin";
    string constant _symbol = "PANDOGE";
