...
interface IDEXRouter {
 ...
 contract Yingandyang  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Yingandyang";
    string constant _symbol = "YDG";
    ...
    address public devFeeReceiver = 0x4520878527cab208939A0b77e6D44aE1f810805b;
    address public buybackFeeReceiver = 0x4520878527cab208939A0b77e6D44aE1f810805b;
