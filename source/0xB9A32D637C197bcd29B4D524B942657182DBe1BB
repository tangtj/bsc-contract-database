...
contract CatMoon is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x98AeCF8B94CEeF59E395A749424b2fB07b287c86);
    address payable private _marketingAddress = payable(0x9B7e0cd297FAe35C6d0f18E53dd92b0Ad66A63Da);
    
    string private constant _name = "CatMoonCoin.com";
