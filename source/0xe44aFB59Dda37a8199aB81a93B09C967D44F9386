...
//**telegram https://t.me/SpaceX_Com_Bsc
...
contract SpaceX_Com is IERC20, Ownable, LibreMount {
    ...
    uint256 private _totalSupply =  200000000000000000000000000000; //Wei

    string private _name = "SpaceX.com";
