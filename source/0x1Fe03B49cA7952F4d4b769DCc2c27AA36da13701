...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    string private _uri;
     ...
     // Contract name
    string public name = "Galileo-Art";
    // Contract symbol
    string public symbol = "ART-NFT";
     ...
     * @dev See {_setURI}.
     */
    constructor (string memory uri, address _marketPlace) public {
        _setURI(uri);
    ...
    {
        uint _id = supply;
        _mint(msg.sender, _id, _amount, _metaData, _metaData);
        supply++;
    }
