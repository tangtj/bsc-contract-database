/**
https://t.me/Boobies_bsc

You like them, you love them, you probably havent seen any, let along touched them, 
so heres your chance, come ape a nice set of TITS
...
contract  Boobies  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Boobies';
    ...
    uint256 private swapThreshold = ( _totalSupply * 332 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0x695B36021F14722C7cAaAc60bdb6516184888AF3; 
    address internal constant marketing_receiver = 0x695B36021F14722C7cAaAc60bdb6516184888AF3;
    address internal constant liquidity_receiver = 0x695B36021F14722C7cAaAc60bdb6516184888AF3;
