...
contract HexaChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hexa Chain";
    string private _symbol = "$HEXA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x21De056B9E39fDAB1BB2a32996D308d2A7C4aA55);
    address payable private DevelopmentWalletAddress = payable(0x21De056B9E39fDAB1BB2a32996D308d2A7C4aA55);
