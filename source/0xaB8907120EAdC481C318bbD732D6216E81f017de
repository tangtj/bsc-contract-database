...
contract azadotiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "azadotiger";
    string private _symbol = "azadotiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa00f04cdE28A6df7E6F87f7726132DF7A21C3ffB); // Marketing Address
