...
contract PuffyDogCoin is Context, IERC20, Ownable {
    ...
    string private _name = "PuffyDogCoin";
    string private _symbol = "PUFFY";
    ...
    address public CharityWallet = 0xcBCF413b0b73e48C50047EB8fA5Ad0359a36Fd50;
