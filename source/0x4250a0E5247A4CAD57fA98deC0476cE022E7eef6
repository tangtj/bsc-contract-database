// TG:  https://t.me/PoopOfficial
// Website: https://PoopBsc.Org
// TWITTER: https://twitter.com/PoopBsc
...
contract POOP is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x08510c4d97ED8E2001DE63CE65D1DFC0b12bA24e;

    string private constant _name = "POOP";
    string private constant _symbol = "POOPCOIN";
    ...
    // Owner cannot transfer out  POOP from this smart contract
