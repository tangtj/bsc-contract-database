...
contract BigSwede is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4D1B4A9BDED1FD41F0C2c665DCd38e4dDBE16d23); // Marketing Address
    ...
    string private _name = "BigSwede";
    string private _symbol = "BGSWEDE";
    ...
    uint256 public _sellLiquidityFee = 33;
    ...
    uint256 public marketingDivisor = 50; // marketing percentage
    
    uint256 private maxTxPercent = 20; // MAX transaction is 2%
    ...
    // MAX Wallet amount to purchase and hold is 4% of the total supply, except for deadAddress
