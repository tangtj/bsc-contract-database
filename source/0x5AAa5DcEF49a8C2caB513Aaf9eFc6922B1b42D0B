...
contract ETAISwap is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "E.T AI Swap";
    string constant _symbol = "ETAI";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 42000000000000 * (10**_decimals);
    ...
    address public pair;
    address ts_Project = 0xDAe7bF15Ce6FDd30879c9d23A5e4D3444FB61CEE;
    ...
    constructor() Auth(msg.sender) {
        ...
        dividendcontract = address(distributor);
        
        address owner_ = 0xDAe7bF15Ce6FDd30879c9d23A5e4D3444FB61CEE;
