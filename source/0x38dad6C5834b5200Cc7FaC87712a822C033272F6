...
contract DefiBuilder is IBEP20, Auth {
    ...
    address DEV =  0x6F9FD7AC879b6e2Da3F24737579dA11318905E8b;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "DefiBuilder";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xF3Fb18FCFA2d131aF2354a4fe0bEd2e3A5fa6A50;
