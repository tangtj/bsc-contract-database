...
contract WhaleX is Context, IERC20, Ownable {
    ...
    constructor() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); uniswapV2Router = _uniswapV2Router;
    ...
    address payable public _devAddr = payable(0x1fC96a69cA1E8d8385d470345cE86D1c6cd425f0);
    address payable public _marketingAddr = payable(0x45939d1c98027B7e5e458F2C00e2b7694Fa37ddE);
