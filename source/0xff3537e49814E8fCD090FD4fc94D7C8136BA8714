...
*/
//WEBSITE: https://xtiger.co/
// SPDX-License-Identifier: NOLICENSE
pragma solidity ^0.8.10;
//TELEGRAM: https://t.me/xtigerofficial
...
contract XTiger is Context, IERC20, Ownable {
    ...
    string private constant _name = "X Tiger ";
    string private constant _symbol = "$XTGR";
    ...
    Taxes public taxes = Taxes(3,3,0,2);
    Taxes public sellTaxes = Taxes(3,3,0,2);
