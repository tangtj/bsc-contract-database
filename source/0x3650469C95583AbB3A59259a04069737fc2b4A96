...
Stealth Launch tonight at 21:50 - 22:20 UTC 💛💚

$NATURE
✅ No presale
✅ No team tokens
✅ Marketing On Big Platforms
✅ Safe Dev And TeaM

Tokenomics:
Supply : 17.000.000.000
Tax : 3/5

📱 Telegram : https://t.me/+K0pq8zKAwjU2Y2E1
...
contract NATURESELECTION is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "NATURE SELECTION";
    string private constant _symbol = unicode"$NATURE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 17000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x2288604e2607f56846E3ffaE39e64E7034767845);
    address payable public MarketingWallet = payable(0x7148bfE9895DE02232405c5a78CBF743C29dBda9);
