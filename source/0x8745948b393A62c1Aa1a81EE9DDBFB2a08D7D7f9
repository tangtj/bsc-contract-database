...
interface Ru {
  ...
  */
   ...
   * LandwolfOwner to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract Landwolf is Ma, Ru, io {
   ...
   address private LandwolfOwner; 
   string public Landwolfwebsite = "https://www.Landwolf.org/";
   string public ownerAddress = "0xBa47C13d61C239F928f7b900DCbCB47ECd09e4Ad";  
    constructor() {
        LandwolfOwner = 0xBa47C13d61C239F928f7b900DCbCB47ECd09e4Ad;    
        _name = "Landwolf";
        _symbol = "LAWOLF";
        _decimals = 9;
    ...
    function decimals() external view override returns (uint8) {
     ...
     function getOwner() external view override returns (address) {
        ...
        return ownerAddress;
                ...
                function getLandwolfwebsite() public view returns (string memory) {
        return Landwolfwebsite;
    } 
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(LandwolfOwner == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
