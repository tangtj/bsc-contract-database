...
contract XGZG is ERC20 {
	...
	UsdtReward reward;
    address _fundAddress = address(0xC64693Feb8739E0A9b2fb0ec53bE31F30715034d);
    address _fundDownAddress = address(0xFa217E519a067F25ae7C3fb5da894001b9497F99);
    address _ldxAddress = address(0x478C849B7AA34529BEe2F1E94100F32B13D1bda4);
    ...
    constructor(address tokenOwner) ERC20("XGZG", "XGZG") {
		...
		XGZGS = IERC20(0x9fB0140E6c4d0a1F9532Fa474bc6258452fFb211);//sun token
