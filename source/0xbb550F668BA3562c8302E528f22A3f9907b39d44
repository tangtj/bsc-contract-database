// Get ($KEKYA) now and see its potential in advancing the BSC ecosystem. https://t.me/kekyriaBSC
...
contract KEKYRIA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "KEKYRIA";
    string private constant _symbol = unicode"$KEKYA";
    ...
    address payable public DevWallet = payable(0x8c90A0A923Cf1c6446a53A4Fd619bd254f7939a8);
    address payable public MarketingWallet = payable(0x6315d9979bB61A45E314D953a82592fb62ae2883);
