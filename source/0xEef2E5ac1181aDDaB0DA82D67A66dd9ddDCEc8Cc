/** TELEGRAM : https://t.me/charlotteparkesbsc
...
contract CharlotteParkes is Context, IERC20, Ownable {
    ...
    string private constant _name = "Charlotte Parkes Spicy Content";
    string private constant _symbol = "$CharParkPorn";
