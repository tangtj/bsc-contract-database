...
contract MoonLion is IBEP20, Ownable
{
    ...
    string private constant _name = "MoonLion";
    string private constant _symbol = "MOONLION";
    ...
    address public constant TeamWallet=0xCF0F48777A1899D26c5a44e2124779Df2A987F3E;
