...
Introducing RELAX BUNNY ($RELAX), the coin that will provide you with a sense of tranquility 
and relaxation on your journey towards financial freedom.

Experience Blissful Prosperity with $RELAX - The Tranquil Crypto! 💰🐰

TG : https://t.me/RelaxBunnyBSC
...
contract RELAXBUNNY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "RELAX BUNNY";
    string private constant _symbol = unicode"$RELAX";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 71900000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x6fd7ea17A42B6cbD3A5f10222B1d766a197dF3E3);
    address payable public MarketingWallet = payable(0xb771f0C2DB5ed6ad43638b5fE14e96F2b7ecCBe0);
