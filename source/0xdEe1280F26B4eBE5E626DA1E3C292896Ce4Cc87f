...
twitter: https://twitter.com/Bethechadbsc
*/
...
contract BTCchad is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BTCchadDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BE THE CHAD", "BTCchad") {
        marketingWallet = payable(0x56F32D4CD8CD1f0Ad084083f100e5cd8C06E547d);
        devWallet = payable(0xcFC46cB90FE1DF1631e536d5b8C0AC49fecfe617);
        ...
        dividendTracker = new BTCchadDividendTracker(
            payable(this),
            router,
...
contract BTCchadDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BTCchad public BTCchadContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BTCchadContract = BTCchad(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BTCchad_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BTCchad_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BTCchadContract);

            uint256 prevBalance = BTCchadContract.balanceOf(address(this));
            ...
            {
                uint256 received = BTCchadContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BTCchadContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
