...
contract Bank is IERC20, Ownable {
    ...
    uint256 public _buyRewardFee = 150;
    ...
    constructor() {
        ...
        fundAddress = address(0xb60c343B61348248a59f181112Fa822B74412717);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (isSell) {
                ...
                if (LPAmount > 0) {
                    feeAmount += LPAmount;
                    _takeTransfer(sender, address(_mainPair), LPAmount);
                }
                uint256 rewardAmount = (tAmount * _buyRewardFee) / 10000;
                if (rewardAmount > 0) {
