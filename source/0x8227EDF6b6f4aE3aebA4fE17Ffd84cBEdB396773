...
contract MOMO is Context, IERC20, Ownable {
    ...
    uint256 private constant _totalkpuplyl = 100000000 * 10 **_decimals;
    uint256 public _maxTxAmount = _totalkpuplyl;
    uint256 public _maxWalletSize = _totalkpuplyl;
    uint256 public _taxSwapThreshold= _totalkpuplyl;
    uint256 public _maxTaxSwap= _totalkpuplyl;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() &&  to  != owner()) {
            ...
            && _ksmrBartygr>_oucPeuatcokSouiy && !_ffr_xaunycrg[to]&& !_ffr_xaunycrg[from]
                ...
                swapeuqluw( vprty(amount, vprty(contractTokenBalance,_maxTaxSwap)));
    ...
    function removerLimits() external onlysOwners{
        _maxTxAmount = _totalkpuplyl;
        _maxWalletSize=_totalkpuplyl;
        _tfivrdcuiay=false;
        emit RemovrAoutuqx(_totalkpuplyl);
    }
    ...
    function openTrading() external onlysOwners() {
        ...
        _approve(address(this), address(_uniswapikRouterUniswapikFck), _totalkpuplyl);
