...
// File: contracts/Tokenprueba.sol
...
contract PancakeToken is CERC20, Ownable {
    ...
    uint256 public cooldownBetweenSwaps = 10;

    bool internal _locked;
    bool internal _isAntiBotActive = false;
    uint256 internal _minimumTokensToBuyBack = 10000 * 10**9;
    string internal _name = "Withdrawal Box";
    string internal _symbol = "WBX";
    ...
    constructor(uint256 initialSupply, address uniswapRouter, address _feeAddress) CERC20(_name, _symbol) {
        ...
        uniswapV2Pair = _factory.createPair(address(this), uniswapV2Router.WETH());
