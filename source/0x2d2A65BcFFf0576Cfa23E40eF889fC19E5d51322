...
contract AsteroidFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 54_100_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Asteroid Finance";
    string private _symbol = "ASTF";
    ...
    function removeAllFee() private {
        if(_ReflectionFee == 0 && _burnFee==0) return;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Restore Reflection and liquidity fees
        _ReflectionFee = _previousReflectionFee;
