...
Telegram: https://t.me/PepeTwoPortal
Twitter: https://twitter.com/Pepe__Two
...
contract PEPETWO is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe II";
    string private _symbol = "PEPETWO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x16c38f9f38aE90E0a803109a3f079aCC3Dd5214C);
    address payable public teamWalletAddress =
        payable(0xb4C09C609DE875AD439B004BAEf95a07a9b6E824);
    ...
    function addMoreLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        // approve token transfer to cover all possible scenarios
        _approve(address(this), address(uniswapV2Router), tokenAmount);
