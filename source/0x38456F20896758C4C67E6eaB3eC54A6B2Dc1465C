...
contract SPXTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ejjfg79;
    ...
    string private _tokenname = "SPX";
    string private _tokensymbol = "SPX";
