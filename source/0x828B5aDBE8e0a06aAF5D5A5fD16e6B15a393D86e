...
// File: contracts/libraries/NarUtil.sol
...
// File: contracts/NarCardToken.sol
...
contract NarCardToken is ERC721, Governance {
    // for minters
    mapping(address => bool) public _minters;

    constructor() public ERC721("nar.card", "NARCARD") {
    }
    ...
    function mint(address to, uint256 tokenId) external returns (bool) {
        ...
        _mint(to, tokenId);
        _setTokenURI(tokenId, NarUtil.uintToString(tokenId));
        return true;
    }
