...
contract FriendFi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FriendFi", "FFI") {
        ...
        marketingWallet = address(0xA3Fb72eAEB41c88DEb7473Aa7aEe536eb647010E); // set as marketing wallet
