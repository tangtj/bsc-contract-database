...
// Website : https://loomxnetwork.com/
   Telegram : https://t.me/LoomOfficial
   Twitter : https://twitter.com/loomnetwork_
...
contract LoomNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " LoomNetwork";
    string private _symbol = "LoomX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xAa6693e7b80b7457663C1D5601A7F5c6A7822c9E);
...
address payable private Team =
        payable(0x62c31CBe71687a6c1A190548D1026504624312d6);
