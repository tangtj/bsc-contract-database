...
contract SUPERX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x62C482b3515AdE4A697F4Dbde4DF64a4Bb46C064); 
    address payable public Wallet_Dev = payable(0x62C482b3515AdE4A697F4Dbde4DF64a4Bb46C064);
    ...
    string private constant _name = "SUPERX"; 
    string private constant _symbol = unicode"SUPERX"; 
    ...
    constructor () {
        ...
        _owner = 0x62C482b3515AdE4A697F4Dbde4DF64a4Bb46C064;
