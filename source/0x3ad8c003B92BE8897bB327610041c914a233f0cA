...
contract BSG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSG";
    ...
    address payable public marketingWalletAddress = payable(0x2cc6e2f3C5d823C8A37a907C8A0f6FeBf9c4F9fE
);
    address payable public liquidityWalletAddress = payable(0x2cc6e2f3C5d823C8A37a907C8A0f6FeBf9c4F9fE
);
