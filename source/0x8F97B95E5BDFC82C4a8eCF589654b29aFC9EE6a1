...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x486c25d19302524e27ebfa2817D22288fB9bDf9c; // owner address
...
contract MARIOX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MARIO X";
    string private _symbol = "$MARIOX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x486c25d19302524e27ebfa2817D22288fB9bDf9c); // Marketing Address
    address payable private teamWalletAddress = payable(0x486c25d19302524e27ebfa2817D22288fB9bDf9c); // Team Address
