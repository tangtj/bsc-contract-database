...
contract SiSi is ERC20, Ownable {
    ...
    constructor() ERC20("SiSi", "SiSi") {
        ...
        marketingWallet = address(0x5a6CcdFbeB63D9e4FE560118641129338a5910fb); 
        productsWallet = address(0x5a6CcdFbeB63D9e4FE560118641129338a5910fb);
        lpWallet = msg.sender;
