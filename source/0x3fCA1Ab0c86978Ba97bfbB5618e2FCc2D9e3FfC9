...
Pepe now has a canvas to unleash his creativity and play with the weirdest and most degenerate art. 
With this powerful AI-powered image suite, he can bring his wildest and most unconventional artistic visions to 
life and stand out from the rest. The possibilities are endless and the art can be as weird as Pepe wants it to be.
Make the most of this incredible opportunity and let Pepe unleash his inner artist with CANVAS AI. Empower your brand with a 
personalized and cutting-edge solution that sets you apart from the competition and embrace the weirdness in your art.
...
contract CANVASTOKEB  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'CANVAS AI';
    string private _symbol = 'CANVAS';
