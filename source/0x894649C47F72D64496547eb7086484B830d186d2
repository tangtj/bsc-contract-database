...
contract Tails is ERC20, Ownable {
    ...
    constructor() payable ERC20("Tails Inu", "TAILS") {
        ...
        marketingWallet = 0x2852E2C43611Bbc5940179c75a24dC24A02C6ddC;

        dividendTracker = new DividendTracker(5 * 10**5, rewardToken);
        ...
        _mint(owner(), 5 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000 * 10;
    }
