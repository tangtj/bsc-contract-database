...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfE9cA78Fb24ab82ec522c0128b1e6675EBD5514C;
...
contract Test is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xfE9cA78Fb24ab82ec522c0128b1e6675EBD5514C);
    ...
    */
    ...
    function setMaxTransactionPercent(uint256 maxTxPercent_x100) external authorized() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/500;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function setMaxWalletPercent(uint256 maxWallPercent_x100) external authorized() {
