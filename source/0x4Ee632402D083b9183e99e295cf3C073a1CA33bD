// t.me/LeveragedrETHStakingYield 
// LeveragedrETHStakingYield.com
...
contract LeveragedrETHStakingYield is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "LeveragedrETHStakingYield";
    string public symbol = "ICRETH";
