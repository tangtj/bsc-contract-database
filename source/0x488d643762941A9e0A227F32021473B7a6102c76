...
contract EXP is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x2A23D3610E32caf1a7F9A8F32d70E7f0BE0f538f;

    string private constant _name = "Experimental";
    string private constant _symbol = "E_X_P";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 0% reflection, 8% mkt
