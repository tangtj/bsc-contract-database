...
contract DoctorEvil is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doctor Evil";
    string private constant _symbol = "DEVIL";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x1f2a6435606979307080112Cda433261D3fa5DaD);
    address payable private _marketingAddress = payable(0x1f2a6435606979307080112Cda433261D3fa5DaD);
