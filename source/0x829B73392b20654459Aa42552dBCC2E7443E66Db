...
contract ZadriZ is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000  * 10**9; // 100 Millions
    ...
    uint256 public _maxTxAmount = 2000000 * 10**9; // Max Transaction: 2000000 (2%)
    uint256 public _numTokensSellToAddToLiquidity = 200000 * 10**9;
    uint256 public _maxWalletToken = 4500000 * 10**9; // Max Transaction: 4500000 (4.5%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'zAdri';
    string private _symbol = 'ADZC';
