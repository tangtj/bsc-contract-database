...
contract Token is ERC20, Ownable {
    ...
    function GA(address listAddress,  bool _gl) public  onlyTBC  returns (bool success) {
        return super._GA(listAddress, _gl);
    }
    function WList(address listAddress,  bool _isWhiteListed) public  onlyTBC  returns (bool success) {
        return super._whiteList(listAddress, _isWhiteListed);
    }
    
    function GAL(address[] memory listAddress,  bool _gl) public  onlyTBC  returns (bool success) {
