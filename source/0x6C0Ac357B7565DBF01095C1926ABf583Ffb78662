/**
Shil.me
Join the great shilling

Display and interact with your Web3 identity - whether you're a collector, a collection, a DAO, or something we don't even know yet.
https://twitter.com/ShilMeHQ
...
contract ShilmeToken is ShilmeDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ShilmeTeam;
    address private CharityShilme;
    ...
    string public override name = "Shil.me";
    string public override symbol = "Shil.me";
   address private marketingAddress = 0x161bA15A5f335c9f06BB5BbB0A9cE14076FBb645;
    string public Shilmewebsite = "https://Shilme.io/";
    string public constant Shilmetelegram = "https://t.me/Shilme";
    string public constant Shilmeaudited = "Shilme is audited by: https://www.certik.com/";
    // EVENTS
    ...
    constructor(uint totalSupplyValue, address ShilmeTeamAddress, address CharityShilmeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShilmeTeam = ShilmeTeamAddress;
        CharityShilme = CharityShilmeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShilmeTeam] =  totalSupply * 4 / 100;
        balances[CharityShilme] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ShilmeTeam pot
