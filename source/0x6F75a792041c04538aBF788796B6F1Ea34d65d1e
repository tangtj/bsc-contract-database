...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x868BBE54507A2108537B9d42537DFA08D41B299d; // owner address
...
contract MongPepe is Context, IERC20, Ownable {
    ...
    string private _name = "Mong Pepe";
    string private _symbol = "MONGPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6AC3245ac44D6A7f0F1B3c465f217ABc2927Fb8A); // Marketing Address
    address payable private teamWalletAddress = payable(0x6AC3245ac44D6A7f0F1B3c465f217ABc2927Fb8A); // Team Address
