...
//https://t.me/PibaCoinCommunity
//https://twitter.com/PibaCoinBsc
interface IERC20 {
...
contract Piba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc35361db3656E77E4ef6c2E82E9F57951A6B58Cb); 
    address payable public Wallet_Dev = payable(0xc35361db3656E77E4ef6c2E82E9F57951A6B58Cb);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "PIBA COIN"; 
    string private constant _symbol = unicode"$PIBA"; 
    ...
    constructor () {
        _owner =0xc35361db3656E77E4ef6c2E82E9F57951A6B58Cb;
