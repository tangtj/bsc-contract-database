...
/*
    ...
    constructor(address busd){
        ...
        plans.push(Plan(5000000 ether, 150));
        plans.push(Plan(10000000 ether, 155));
        plans.push(Plan(50000000 ether, 160));
        //VIP BUSD plans
        plans.push(Plan(100000000 ether, 170));
        plans.push(Plan(250000000 ether, 180));
        plans.push(Plan(500000000 ether, 190));
        plans.push(Plan(750000000 ether, 200));
        plans.push(Plan(1250000000 ether, 220));
    ...
    function checkVIPBUSD(uint8 plan_id) view internal {
        ...
        require(plan_id < 8 && limit >  250000000000 ether, error);
        require(plan_id < 9 && limit >  350000000000 ether, error);
        require(plan_id < 10 && limit > 500000000000 ether, error);
    }
