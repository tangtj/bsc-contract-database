...
contract DOGESTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "DOGES FARM TOKEN";
    string private _seitokensymbol = "DOGES";
    address public DAAZJuy2;
