...
contract FineAsPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Fine As Pepe";
    string private _symbol = unicode"$FAP";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xCF209332c9F39A9B4E320550c6fe8924fb304303);
    address payable private taxWallet2 = payable(0xCF209332c9F39A9B4E320550c6fe8924fb304303);
