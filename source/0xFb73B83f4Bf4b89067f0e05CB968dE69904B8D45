...
contract SRBC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SRBC";
    string private _symbol = "SRBC";
    ...
    address payable public marketingWalletAddress = payable(0xD7375b701535edB940cAEC9EC7D7b5576CB721eF
);
    address payable public liquidityWalletAddress = payable(0xD7375b701535edB940cAEC9EC7D7b5576CB721eF
);
    ...
    uint256 private _totalSupply = 125000 * 10**_decimals;
