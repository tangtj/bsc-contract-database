...
contract FlashCat  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF9b8945f7BC93b1157D09D8041640A9e7FE97219); 
    address payable public Wallet_Dev = payable(0xF9b8945f7BC93b1157D09D8041640A9e7FE97219);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42000* 10**3* 10**3 * 10**_decimals;
    string private constant _name = "FLASH CAT"; 
    string private constant _symbol = unicode"$FLASHCAT"; 
    ...
    constructor () {
        _owner = 0xF9b8945f7BC93b1157D09D8041640A9e7FE97219 ;
