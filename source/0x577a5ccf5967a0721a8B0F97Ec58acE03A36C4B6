...
contract ProBets is Main {
    ...
    constructor() Main (
        ...
        "PBT",        // Symbol
        9,                  // Decimal
        0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,     // Reward 1 / BUSD
...
contract DIVIDENDTracker1 is DividendPayingToken {
    ...
    function withdrawDividend() pure public override {require(false, "withdrawDividend disabled. Use the 'claim' function on the main contract.");}
