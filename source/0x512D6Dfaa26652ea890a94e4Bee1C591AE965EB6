...
contract SafeMoneyExchangeV3 is ReentrancyGuard, Ownable {
    address public tokenAddress = 0xa5522ae272B74B014Bc20eF7eF2E2b87aF0787d8;
    IERC20 public token = IERC20(tokenAddress);
    uint256 public feePercentage = 20; 
    bool public paused;
    uint256 public constant TRANSACTION_PERCENTAGE_LIMIT = 10; 
