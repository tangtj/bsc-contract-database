...
SimpZilla! Tax
—  4% on Buy Transactions—
— 4% on Sell transactions —
🦖 1% USDT Rewards
🦖 1% Buyback and Burn
🦖 1% Auto LP
...
contract SIMPSONZILLA is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x5726b8530b78A25a4CC0eEECa8F2D673773092d7;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x8Db7c929F240ECbcb613c96AaB81ed5153070a20;
