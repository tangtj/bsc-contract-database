...
contract WoRLDW4R is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WoRLDW4RDividendTracker public dividendTracker;
    ...
    constructor() ERC20("WoRLD W4R", "WoRLD W4R") {
        marketingWallet = payable(0x8B28036804EE1A812A4A9cf21EE559BB9874A74f);
        CommunityWallet = payable(0x1985208D9a43324d91C8aE53B2Ea015BFa6cD66E);
        ...
        dividendTracker = new WoRLDW4RDividendTracker(
            payable(this),
            router,
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 80, "Don't 2");
...
contract WoRLDW4RDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WoRLDW4R public WoRLDW4RContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WoRLDW4RContract = WoRLDW4R(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WoRLDW4R_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WoRLDW4R_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WoRLDW4R contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WoRLDW4RContract);

            uint256 prevBalance = WoRLDW4RContract.balanceOf(address(this));
            ...
            {
                uint256 received = WoRLDW4RContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WoRLDW4RContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
