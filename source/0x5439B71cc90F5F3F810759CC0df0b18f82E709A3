...
contract COIN2049 is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xd91e745c9949CAF68e8D3f377bA20e28e0d906fD;

    string private constant _name = "COIN2049";
    string private constant _symbol = "COIN2049";
