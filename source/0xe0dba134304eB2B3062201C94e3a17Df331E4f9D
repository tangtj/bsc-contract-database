...
*/
//WEBSITE: https://t.me/tommyjerry2
...
contract tomjerry2 is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x8f9D7ce067d48131cEfceef25DE6E56204A5a915;
    address public devAddress = 0x3087EDF436a8A61bcbC92448fdC2C31381413519;

    string private constant _name = "tom&jerry2";
    string private constant _symbol = "t&j2";
    ...
    Taxes public taxes = Taxes(0,0,24,4);
    Taxes public sellTaxes = Taxes(0,0,28,4);
