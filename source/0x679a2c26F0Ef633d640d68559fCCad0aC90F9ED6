...
contract XBTC is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDivysExcluded;
    ...
    constructor() payable ERC20 ("X-BTC", "XBTC") {
        ...
        marketingWallet =  0x227284D0BB5aFe65E8a3a924D7c2f25c6653E35f;

        dividendTracker = new DividendTracker(21000000, rewardToken);
        ...
        _isWalletExcluded[0x227284D0BB5aFe65E8a3a924D7c2f25c6653E35f] = true;
    
        _mint(owner(), 21000000 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 100000 * 40;
    }
