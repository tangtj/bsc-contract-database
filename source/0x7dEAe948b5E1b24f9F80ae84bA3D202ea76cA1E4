...
contract ShinjiruInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0314F0C1e69a71bD769B4a68F09DDd861612f373); 
    address payable public Wallet_Dev = payable(0x0314F0C1e69a71bD769B4a68F09DDd861612f373);
    ...
    constructor () {
        ...
        _owner = 0x0314F0C1e69a71bD769B4a68F09DDd861612f373;
