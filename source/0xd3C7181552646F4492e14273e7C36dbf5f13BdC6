// https://t.me/NetxusProtocolBSC
// https://twitter.com/netxusprotocol
// https://netxusprotocol.com/
...
contract Netxus is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Netxus Protocol";
    string private constant _symbol = unicode"NETX";
