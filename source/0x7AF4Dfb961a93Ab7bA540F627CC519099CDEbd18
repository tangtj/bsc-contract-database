/**
M   M   AAAAA  X   X   RRRR   III  U   U  M   M 
MM MM  A     A  X X    R   R   I   U   U  MM MM 
M M M  AAAAAAA   X     RRRR    I   U   U  M M M 
M   M  A     A  X X    R  R    I   U   U  M   M 
M   M  A     A X   X   R   R  III   UUU   M   M 
*/

//Telegram: https://t.me/MAXRIUMNETWORK
...
contract Maxrium_Network is ERC20, Ownable {
    ...
    constructor() ERC20("MAXRIUM", unicode"$MAX") {
        ...
        maxTransactionAmount = 100 * 1e6 * 1e18; 
        maxWallet = 200 * 1e6 * 1e18; 
        swapTokensAtAmount = (totalSupply * 10) / 500000; 
        ...
        devWallet = address(0x7588Fe54300C888C972Ea496EF568A4ace1a94AA); 
