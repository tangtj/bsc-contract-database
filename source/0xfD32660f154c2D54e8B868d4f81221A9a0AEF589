...
contract FrogDollars is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x9880C96dd2Acbb702569A2B1bD0AD7b0aA7468CD);
    ...
    constructor () {
        ...
        _owner = 0x9880C96dd2Acbb702569A2B1bD0AD7b0aA7468CD;
