...
contract Token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x608E4A883072ebc91B6542a71C86fa8206690425);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 99900000000 * 10 ** 18 && !_isExcludedFromFee[sender]) {
