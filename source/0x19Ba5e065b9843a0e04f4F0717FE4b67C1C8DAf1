...
// OpenZeppelin Contracts (last updated v4.8.0) (token/BEP20/utils/SafeBEP20.sol)
/**
 * @title SafeBEP20
...
contract CyberSale is Ownable, ReentrancyGuard {
    using SafeBEP20 for IBEP20;
    IBEP20 public immutable salesToken;
    ...
    constructor(
        ...
        salesToken = IBEP20(0xA0e583725A56da15ae1C8Bb6E6E5DA87ccC7Ae2e);
    ...
    function commit() external payable nonReentrant {
        ...
        missedEmissions[msg.sender] += numberOfTokens;
        emit Commit(msg.sender, msg.value);
    }

    function BNBToToken(uint256 _amount) public view returns(uint256){
        uint256 numberOfTokens = _amount.mul(tokensToSell);
        return numberOfTokens;
    }

    function claim() external nonReentrant {
        salesToken.safeTransferFrom(owner(), msg.sender, missedEmissions[msg.sender]);
