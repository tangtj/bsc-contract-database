...
*
Telegram: https://t.me/bringbackdoge
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71eB76A9Aa6B18d4696B76DFbB97611c6B4c7B3e; // owner address
...
contract BringBackDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bring Back DOGE";
    string private _symbol = "BBD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71eB76A9Aa6B18d4696B76DFbB97611c6B4c7B3e); // Marketing Address
    address payable public teamWalletAddress = payable(0x71eB76A9Aa6B18d4696B76DFbB97611c6B4c7B3e); // Team Address
