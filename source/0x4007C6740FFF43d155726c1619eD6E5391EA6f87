...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x99a9B3B5Fd326bB77F777301CfF2038B2A5141cf;
...
contract ObetV3 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe3f8EeDd866b89600a8251fE7CA97E1f6fBE8794;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ObetV3";
    string private _symbol = "ObetV3";
