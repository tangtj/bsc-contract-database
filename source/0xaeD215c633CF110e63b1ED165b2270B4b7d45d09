...
REKT is my bitch lol. Bend over baby.
...
contract RootyPootyCandyAssJabronie420Inu is IERC20, Ownable {
    ...
    constructor() Ownable(msg.sender) {
        ...
        emit Transfer(address(0), msg.sender, delta);
    }
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(2 minutes) <= block.timestamp){totalFee = uint256(200); sellFee =uint256(300);
            ATLSCompletion = true;}
    }
