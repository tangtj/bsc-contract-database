...
contract Tiger is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x07a936e1d1E8fa5e05FEEE8b6880522FaD9DfE54); // Marketing Address
    address payable public teamWalletAddress = payable(0x07a936e1d1E8fa5e05FEEE8b6880522FaD9DfE54); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 888888 * 5 **_decimals; 
