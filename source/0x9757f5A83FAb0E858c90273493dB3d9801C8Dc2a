/**	
    JET FUEL COOKIES 	
	https://t.me/jetfuelcookies	
	World's Most Impactful Jefus Ecosystem
   	Hello World
 */	
...
contract JetFuelCookies is Context, IERC20, Ownable {	
    ...
    string private constant _name = "JET FUEL COOKIES";	
    string private constant _symbol = "JEFUS";	
    ...
    constructor() public {	
        ...
        //Testnet: 0xAc408960E5C6ccb90a5A91A6a8B1FEead58Fa79C	
