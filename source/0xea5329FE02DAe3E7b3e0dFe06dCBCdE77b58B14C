...
contract SHIUToken is IERC20 {
    using SafeMath for uint256;

    string private _name = "Ten U God of War";
    string private _symbol = "SHIU";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 2800000 * 10**18;
    ...
    uint256 private _feeLiquidity = 1;
