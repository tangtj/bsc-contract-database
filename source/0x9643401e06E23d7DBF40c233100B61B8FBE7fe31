...
contract BLUEMOON is IERC20, Ownable {
    ...
    string _name = "BLUEMOON";
    string _symbol = "$BMOON";
    ...
    constructor () {
        ...
        devFeeReceiver = 0xD20cDC93B253647300eAbA5D5B90A43e7eF2829a;
        marketingFeeReceiver = 0x466c9dbb1B467FDaBDF65CdbD6420b5d43f0C43D;
