...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x496A4a4eB239e0b48A559a8900Fc5706f2AcD86C; // owner address
...
contract BNBSmurfInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBSmurfInu";
    string private _symbol = "BSI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x496A4a4eB239e0b48A559a8900Fc5706f2AcD86C); // Marketing Address
    address payable private teamWalletAddress = payable(0x496A4a4eB239e0b48A559a8900Fc5706f2AcD86C); // Team Address
