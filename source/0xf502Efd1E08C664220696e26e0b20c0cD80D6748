...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC9689bf5A0b53f503A3dfDBF1D39AE7e7DD409C2; // owner address
...
contract CCCGSS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCGSS";
    string private _symbol = "CCCGSS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC9689bf5A0b53f503A3dfDBF1D39AE7e7DD409C2); // Marketing Address
    address payable private teamWalletAddress = payable(0xC9689bf5A0b53f503A3dfDBF1D39AE7e7DD409C2); // Team Address
