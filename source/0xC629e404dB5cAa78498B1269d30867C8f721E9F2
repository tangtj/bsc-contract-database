...
A long time ago...on a blockchain far away.

BSC WARS 

EPISODE I:  "The Fall of the Binance Republic"

With the Binance Trade Republic in turmoil, Din Grogu, a Force-sensitive being from the Jedi Temple on Coruscant, has been in hiding.   

Pursued by the evil forces of the SEC Empire, Grogu, and his band of supportive community members, seek a corner of the galaxy where they can trade in peace.

Not only must his force powers remain a secret, but also his ability to off-ramp valuable crypto could be in jeopardy.  Plans for the SEC Empire's plot to destroy even the most remote DEXs have been stored in the solidity code of this contract.

The Grogu Token must reach a 1 million dollar market cap for the BSC rebel alliance to save defi.   Help us BSC traders, you are our only hope.

Community support will help with trending $GROGU all over the cryptocurrency space. 
This team has prior expierence in running multi million dollar tokens and are firm believers that community is key to success, espescially a $GROGU memecoin.

$GROGU is ready to rock the Binance Smart Chain network!

TAX: 5% (high buy/sell tax for the first few minutes of launch to prevent any bots) 
MAX: 1.5% 

Twitter:
https://twitter.com/grogucoin

Community Entry Portal:
https://t.me/GroguMemecoin
...
随着 Binance Trade Republic 陷入动荡，来自科洛桑绝地圣殿的原力敏感生物 Din Grogu 一直躲藏起来。

在 SEC 帝国的邪恶势力的追击下，格罗古和他的支持社区成员的团队寻找银河系的一个角落，在那里他们可以和平地进行贸易。

不仅他的武力必须保密，而且他释放有价值的加密货币的能力也可能处于危险之中。 SEC 帝国阴谋摧毁​​甚至最偏远的 DEX 的计划已存储在该合约的 solidity 代码中。

Grogu Token 必须达到 100 万美元的市值，BSC 反叛联盟才能拯救 defi。帮助我们 BSC 交易员，您是我们唯一的希望。

社区支持将有助于推动整个加密货币领域的 $GROGU 趋势。
该团队在运行数百万美元的代币方面拥有丰富的经验，并且坚信社区是成功的关键，尤其是 $GROGU memecoin。

$GROGU 已准备好撼动币安智能链网络！

税：5%（启动前几分钟的高买卖税，以防止任何机器人程序）
最大：1.5%
...
contract $GROGU is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"Grogu";
    string constant _symbol = unicode"GROGU";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 7, // development fee in %
            Marketing: 10, // Marketing fee in %
            lp: 10, // lp rate in %
            toSwap: 27 // Marketing + dev + lp
        });
