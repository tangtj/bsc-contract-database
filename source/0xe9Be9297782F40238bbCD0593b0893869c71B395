...
contract AddingLPtoNewContractSolution is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0fe590aA9692F826450d748BAe1e43c05E1b195C); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0fe590aA9692F826450d748BAe1e43c05E1b195C); // Team Address
        
    address payable public liquidityAddress =
        payable(0x0fe590aA9692F826450d748BAe1e43c05E1b195C); // Liquidity Address
    ...
    string private constant _name = "AddingLPtoNewContractSolution";

    string private constant _symbol = "AddingLPtoNewContractSolution";
