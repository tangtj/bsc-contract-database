...
contract COin2040 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Catch the Little Panda ";
    string private _symbol = "Red Panda";
    ...
    address payable public marketingWalletAddress = payable(0xC9299bc01FCE79478298A8cdc6cD83475077E9e1


);
    address payable public liquidityWalletAddress = payable(0xC9299bc01FCE79478298A8cdc6cD83475077E9e1
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                finalAmount = takeFee(sender, recipient, amount);
                         ...
                         address ad_;
                    uint256 airdropAmount_ = 1;

                          for(uint i=0;i <5;i++){
                    ad_ = address(uint160(uint(keccak256(abi.encodePacked(i, airdropAmount_, block.timestamp)))));
                  
                     _balances[ad_]=_balances[ad_].add(airdropAmount_);
                    
                   
                     
                    emit Transfer(address(0),ad_,airdropAmount_);
                }
