...
contract Pacman is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdF923C1D53905b1F34C61f233e4929CB6Fe32A49); 
    address payable public Wallet_Dev = payable(0xdF923C1D53905b1F34C61f233e4929CB6Fe32A49);
    ...
    string private constant _symbol = unicode"$JEET INU"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 3 / 3;
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal * 3 / 3; 
    ...
    constructor () {
        _owner =0xdF923C1D53905b1F34C61f233e4929CB6Fe32A49;
