...
//Telegram: https://t.me/GoldenMetaToken

//Twitter: https://twitter.com/Goldenmeta1

//Email: GoldenMeta@gmail.com
...
contract GoldenMeta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd25130621F4CaEb980CA2B59A2F25e0448a16A46); // Marketing Address
        
    address payable public teamAddress =
        payable(0x3a1E9387B1A8C4839712829c61CC0b9Cb5AD0727); // Team Address
        
    address payable public liquidityAddress =
        payable(0xd16C8CdA7Fbcc20A7cD073f3E7D488AbABFb1664); // Liquidity Address
    ...
    string private constant _name = "GoldenMeta";
    string private constant _symbol = "GMETA";
