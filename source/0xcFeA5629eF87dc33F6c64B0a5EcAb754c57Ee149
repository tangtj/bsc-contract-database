...
contract BigDogeBear is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BigDogeBear";
    string private _symbol = "BigDogeBear";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xEFFF5d226362E7CbD818d3BE5c784A4f055cffd2);
