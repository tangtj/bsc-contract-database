...
contract Circleum is ERC20, Ownable {
    ...
    mapping (address => bool) private _isDividendsExcluded;
    mapping (address => bool) private _isCircleumExcluded;
    ...
    constructor() payable ERC20 ("Circleum", "CIRCLE") {
        ...
        marketingWallet =  0x45296F8D4ad849e5e70e21FE0fF8646E4335DaC5;
        ...
        _isWalletExcluded[0x45296F8D4ad849e5e70e21FE0fF8646E4335DaC5] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 1000000 * 1125;
    }
