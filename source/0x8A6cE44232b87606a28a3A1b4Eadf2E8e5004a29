...
contract BABYSHIBTOKEN is Ownable {
    ...
    string private _seitokenname = "Baby Shiba Inu";
    string private _seitokensymbol = "BABYSHIB";
    address public hggnvj87;
