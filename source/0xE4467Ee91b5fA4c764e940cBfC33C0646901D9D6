...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB8f21898e49ec95cA4A27c8758da89A9CBfdF193; // owner address
...
contract FLOXIINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "Floxi Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB8f21898e49ec95cA4A27c8758da89A9CBfdF193); 
    address payable public teamWalletAddress = payable(0xd1a4d6437D385cf144d4F34FB1D3B764EFfcafCd);
