...
contract TOP is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEADBDeb7556b6C1b1351e48E75B31cAdEe9B79B5);
    address payable public Wallet_Dev = payable(0x7C1eE973A53D58f4b9a6881Ec8ab488e4F5365a7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =500000 * 10**3* 10**0 * 10**_decimals;
    string private constant _name = "TOP Token"; 
    ...
    require(_tOwned[msg.sender] >= amount, "Insufficient balance for burning");
