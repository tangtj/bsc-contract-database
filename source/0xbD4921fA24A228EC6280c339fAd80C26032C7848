...
contract ThisisFine is Context, IERC20, Ownable {
    ...
    string private _name = unicode"This is Fine 2.0";
    string private _symbol = unicode"$FINE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xc07fe2184758d37185bD128ED7DD99802725D35D);
    address payable private taxWallet2 = payable(0xc07fe2184758d37185bD128ED7DD99802725D35D);
