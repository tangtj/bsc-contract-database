...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    string private _name = "DGD";
    string private _symbol = "DGD";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x7DdCBE09743d1f0edD2135d7F6A6a56E61701789);
    address public pointAddress = address(0x7DdCBE09743d1f0edD2135d7F6A6a56E61701789);
