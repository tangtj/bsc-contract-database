...
LANDWOLF tokenized assets allow rights holders to hold securely, 
transfer, sell and collateralize their possessions without opening 
their lives to security. 

Tg: https://t.me/BSC_landwolf
Twitter: https://twitter.com/BSC_landwolf
Website: TBA ON TELEGRAM GROUP
...
contract LANDWOLF is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "LWOLF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x25B576c7F9d3f6E92cB6D21379ED45E94F57281e;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x098b4D2545Fe39b5DC5E218e56A8B982F65D4139;
