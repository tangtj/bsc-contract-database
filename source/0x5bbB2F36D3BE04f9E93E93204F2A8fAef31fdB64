...
contract BNBNOGOOD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBNOGOOD";
    string private _symbol = "BNBNOGOOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1F4C182da790a11144b88C26E6723259313C048C); // Marketing Address
    address payable public teamWalletAddress = payable(0x1F4C182da790a11144b88C26E6723259313C048C); // Team Address
