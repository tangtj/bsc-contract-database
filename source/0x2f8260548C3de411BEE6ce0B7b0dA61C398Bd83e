...
// Telegram https://t.me/memeplanetbsc
...
contract MemePlanet is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x13a2d69cEF2937160377cb3AFf1324DE9E04AbEB);
    address payable private _twdmkt = payable(0x13a2d69cEF2937160377cb3AFf1324DE9E04AbEB);
    
    string private constant _name = "Meme Planet Nano Bsc";
    string private constant _symbol = "$MemePlanet";
