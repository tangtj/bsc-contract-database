// t.me/LightbeamCourierCoin 
// LightbeamCourierCoin.com
...
contract LightbeamCourierCoin is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "LightbeamCourierCoin";
    string public symbol = "LBCC";
