...
contract GoshaCoin is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Gosha coin", "gCOIN") ERC20Permit("Gosha coin") {
