/**
BIGCOIN has finally arrived on Binance Smart Chain to gather the community of champions, change-makers, and winners!

Telegram:https://t.me/BIGCOIN_BSC
Twitter: https://twitter.com/Bigcoin_BSC
Website: https://www.bigcoin.online/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x045A2f4358fC38ba08F8BE7990C4736957990F60; // owner address
...
contract Bigcoin is Context, IERC20, Ownable {
    ...
    string private _name = "BIGCOIN";
    string private _symbol = "BGC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x469e407DcFb25f76a2e9F19381A013E3cC14e2fE); // Marketing Address
    address payable private teamWalletAddress = payable(0x045A2f4358fC38ba08F8BE7990C4736957990F60); // Team Address
