...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x495d527E381b4920B9aa569403b5622A25b299d4;
...
contract Animeme is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0fD184e73110f6F64a2f93C2F0D9F6f71B305Fb5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Animeme";
    string private _symbol = "Ameme";
