...
contract AIMFOX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AIM FOX";
    string private _symbol = "$aFOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF20FDf13FD4e72286A9696D46e16A0826d80492f); // Marketing Address
    address payable public teamWalletAddress = payable(0xF20FDf13FD4e72286A9696D46e16A0826d80492f); // Team Address
