...
contract BIDENELONLAWSUIT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BIDENELONLAWSUITDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BIDENELONLAWSUIT", "ROFLMAO") {
        marketingWallet = payable(0x17F85B8EFBC248850bF44C0f30CE9ff9384BCF15);
        devWallet = payable(0x17F85B8EFBC248850bF44C0f30CE9ff9384BCF15);
        ...
        dividendTracker = new BIDENELONLAWSUITDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "BIDENELONLAWSUITTRACKER",
            "ROFLMAOTRACKER"
        );
...
contract BIDENELONLAWSUITDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BIDENELONLAWSUIT public BIDENELONLAWSUITContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BIDENELONLAWSUITContract = BIDENELONLAWSUIT(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BIDENELONLAWSUIT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BIDENELONLAWSUIT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BIDENELONLAWSUIT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BIDENELONLAWSUITContract);

            uint256 prevBalance = BIDENELONLAWSUITContract.balanceOf(address(this));
            ...
            {
                uint256 received = BIDENELONLAWSUITContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BIDENELONLAWSUITContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
