/*
BNP Network builds a payment system in which cryptocurrency is used as a payment method in the real economy, based on our own developed blockchain technology. We are developing several platforms that we will link in the BNP -Network with BNP as payment system
...
contract BNPMINERNETWORK is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BNP";
