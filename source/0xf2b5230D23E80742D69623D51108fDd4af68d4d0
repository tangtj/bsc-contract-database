...
contract ElevenGrowthVault is ERC20, Ownable {
     ...
     */
    constructor () public ERC20("11 Waultswap TWIN-BNB", "11TWINBNB") {
        token = IERC20(0xF6D7a6504A56c0c81608340429fC9Ec2b6Bc943b);
    }
    
    bool onlyOnce = true;
     
    function setStrategy(address _add) onlyOwner external{
        require(onlyOnce, "already done");
        strategy = _add;
        onlyOnce = false;
    }
