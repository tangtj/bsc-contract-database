/*
[ Album ]
This app is the digital version of your wallet. Collect attestations, certificates, membership cards, permits, identity passes, loyalty cards, payment cards, tickets and diplomas issued by institutions, companies, universities and associations. These signed electronic documents prove your identity and your rights to third parties
...
Website : https://talaowallet.net
TG:https://t.me/Talaowallet
*/
...
contract TALAOWALLET is Context, IERC20, Ownable {
    ...
    string private constant _name = "TALAO WALLET";
    string private constant _symbol = "TALAO";
