...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF7f5CdAf8c1F28A049aDCB118C1033D93E2d07b5; // owner address
...
contract DorkShib is Context, IERC20, Ownable {
    ...
    string private _symbol = "DORKS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD95b818822eDE5a03dc247b32562B6cd14fa22C0); // Marketing Address
    address payable private teamWalletAddress = payable(0xD95b818822eDE5a03dc247b32562B6cd14fa22C0); // Team Address
