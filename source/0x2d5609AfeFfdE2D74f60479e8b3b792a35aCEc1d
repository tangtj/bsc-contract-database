...
contract TWITTERCEO is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 10 *10**10 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e14 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xf46b2fd7585843e663297d41f4BE18961E160497;

    string private constant _name = "Twitter CEO";
    string private constant _symbol = "TCEO";
