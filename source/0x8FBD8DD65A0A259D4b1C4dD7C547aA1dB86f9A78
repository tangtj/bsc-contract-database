...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x632886c16D0F13D706e4aaD27637836C9328Ca58; // owner address
...
contract Stormy is Context, IERC20, Ownable {
    ...
    string private _name = "Stormy";
    string private _symbol = "$STORMY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd496942F8502fDF71695F4fc7449e2701df137F); 
    address payable public teamWalletAddress = payable(0x632886c16D0F13D706e4aaD27637836C9328Ca58);
