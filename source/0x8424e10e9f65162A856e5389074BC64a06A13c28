...
contract Emoticoin is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed(block.chainid==1 ? "EmotiCoin" : "Emoti", block.chainid==1 ? "Emoti" : "Emoti", DECIMALS) {
        address dexAddress;
        if(block.chainid == 1){
       ...
       _1_x = "t.me/Emoti_BSC"; // @dev update
        _2_telegram = "t.me/Emoti_BSC";
        _3_website = "Emoticoin";
    ...
    function enableTrading() external onlyOwner {
        ...
        _bots[0xe81e4F53F18c8f4fC0308FDa032565451aCbE499] = true;
        tradingIsLive = true;
    }
