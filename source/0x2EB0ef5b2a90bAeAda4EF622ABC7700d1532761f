...
// Telegram: https://t.me/Layenomy

// Website: https://layenomy.org/

// Twitter: https://x.com/Layenomy
...
contract LAYENOMY is Context, IERC20, Ownable {
    ...
    string private _name = "Layenomy";
    string private _symbol = "LAYE";
    ...
    uint256 public _totalBuyFee = 6;
    uint256 public _totalSellFee = 6;

    // 'Previous fees' are used to keep track of fee settings when removing and restoring fees
    uint256 private _previousTotalFee = _TotalFee;
    uint256 private _previousBuyFee = _totalBuyFee;
    uint256 private _previousSellFee = _totalSellFee;
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner {
        ...
        _TotalFee = _totalBuyFee + _totalSellFee;
    }
    ...
    function removeAllFee() private {
        if (_TotalFee == 0 && _totalBuyFee == 0 && _totalSellFee == 0) return;

        _previousBuyFee = _totalBuyFee;
        _previousSellFee = _totalSellFee;
    ...
    function restoreAllFee() private {
        ...
        _totalBuyFee = _previousBuyFee;
        _totalSellFee = _previousSellFee;
    }
    ...
    */
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 tDev = (tAmount * (_totalSellFee + _totalBuyFee) ) / 100;
