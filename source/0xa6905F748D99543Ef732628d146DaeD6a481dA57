...
Telegram: https://t.me/pepebrobsc
...
contract PepeBro is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "PEPE BRO";
    string private _symbol = "PEPEBRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xAB091eeFA79324D44E21f42d867D831c31052724);
    ...
    uint256 public _buyFloorFee = 20;
