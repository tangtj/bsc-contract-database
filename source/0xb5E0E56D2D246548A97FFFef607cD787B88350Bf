// telegram     : https://t.me/cryptosickbsc

// twitter      : https://twitter.com/cryptosickbsc
...
contract cryptosick is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto SICK";
    string private _symbol = "$SICK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2cdd7Ce0eEBcca7CF075Fa0985bBFC2FeaD069E); // Marketing Address
    address payable public teamWalletAddress = payable(0xF2cdd7Ce0eEBcca7CF075Fa0985bBFC2FeaD069E); // Team Address
