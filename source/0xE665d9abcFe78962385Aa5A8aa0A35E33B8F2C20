...
Tranasaction limited to 1 000 000 000 NextMoon
Thanks to Neo and Angel for the help in preparing and testing the NextMoon contract
*/
...
contract NextMoonToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "NextMoon";
  string constant tokenSymbol = "NextMoon";
