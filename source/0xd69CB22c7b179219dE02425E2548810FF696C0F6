...
contract YEYE  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6e840F90bd131704B04275Df29f87F1edDe165B4); 
    address payable public Wallet_Dev = payable( 0x6e840F90bd131704B04275Df29f87F1edDe165B4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42* 10**5* 10**5 * 3**_decimals;
    string private constant _name = "Yeye Coin"; 
    ...
    constructor () {
        _owner = 0x6e840F90bd131704B04275Df29f87F1edDe165B4 ;
