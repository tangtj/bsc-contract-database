// 📱Telegram: https://t.me/drcportal (PORTAL)
// 📱Telegram: https://t.me/+0KOw9gZe5ycyMGU1
...
contract DRACHMANETWORK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DRACHMA NETWORK";
    ...
    address payable public DevWallet = payable(0x11BB4283A73EF4d6B5A6429b2105329dd961f5cF);
    address payable public MarketingWallet = payable(0x8C9dFb72A919Dbd487c34B2C1bb88D0348e75002);
