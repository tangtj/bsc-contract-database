/**
 First 10 min tax 10/10 then will change 1/1 tax and will make renounce!
...
contract RichPepe is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x47d477afae06ffD567E2B1Fbc264ccF8834FaFe1);
    address payable private _marketingAddress = payable(0x47d477afae06ffD567E2B1Fbc264ccF8834FaFe1);
