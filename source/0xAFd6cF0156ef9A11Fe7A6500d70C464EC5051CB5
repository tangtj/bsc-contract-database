...
/**
 ...
 https:///www.revivaldefi.com
 https://https://rvl.finance
...
contract RVLX is ERC20, Ownable {
   ...
   tradingEnabled = _enabled;
    ...
    function getUserForeignReflectionRewards(address _who)
        external
        view
        returns (uint256)
    {
        (, , uint256 totalRealised) = distributor.shares(_who);
        return totalRealised;
    }

    function getTotalForeignReflectionRewards()
        external
        view
        returns (uint256)
    {
