/*                         )?+                                           -?                           
                     ...
                     d#8pt                                                   QMWb                     
                    faBBq                                                    Ua@#Z                    
                    b8$Bwx                  #ppodwkabkMMM$$                 fXo$8p                    
                    %@$BpmQXn    p   -#kqqQQXXCQLJQQULOOLCqpaa#8m        tczZqM$%m                    
                    Yo$$kqpqmmmkX!-((wXvj1|n0XXznxUYuncXz0z/)\cJqf]{IrbZZmwqqb@$#U                    
                    :c#$@hdbkdkvI{+"mpOQwm<!(hwm0JYYUOmwhr!!JmQ0qk,!(l/kbbbpkM$ML~                    
                     +xp#oWok#J!Cvl{@bqqd$z~[Uapwp0Lmwwaq}_/$kqqdB|l/w>uMhko#obv!                     
                       ]jzObao#M&o&8$@&&%WCQ0CUZZ0dbQZmJJQ0Q#@&&B$%W&8M*oobqLx[                       
                          -uwd&%8$$$$@&#pC0CYYYUOZJJ0ZYUUCOmCqo#%$$$$8&%akJ1,                         
                      YQQbOvruCmada8BBq0LYJnnzQ00L0QJC0ZmQXJUJ0Z*B%ohaqOJcJpoZzx                      
                      v0QtfUk%@*J\XhhmB%aCOQuxnQbhZZkhOYxn0OJhB$aboU\X*@BhCxjCZv                      
                       CwUjf/|{_}Y*8$MQ%ht}z&amUUq##pUY0hMO{/o&po$8oL{_{(/tfzOb                       
                         8CCLCJQmkb8$arpbkpk#d#&ophopa8Wbbkphkdxk$Bkhq0JCC00*                         
                          UqO&8&bZ*$$@qwZQLLqpOmbdqpdbqZqqLCQOwm%$$8ZkM88whk                          
                           hqpB%B*&Ma$$@*k0quvYJQmwmmQJJXxwQqaB$$#M$&B%BkqM                           
                            ambBBbW%no$$BhkYu\1]){][]){1/nzdbW$$#xM$%%Bhm#m                           
                             dwp8%d#k)L%&#qY1chOrYOQc/Jkm[zZM8Bw[0B&&%bwaU                            
                              opm*&a&*zZ@$BkcnYQC-]{+UXYuf0%$$wra@#8#qd#                              
                               &hwqM&&B&B$%$dnZZ0z/\z00Z/Y$&$$WBB8WdwhW                               
                                 akpk#8&B8MdkwZJCCQQCCC0qpa#&&8%Mdwb&                                 
                                   8kqd#&%Oa&BwLCqhhdJQm8%WQWo#kpbk                                   
                                     @ahkh*#@$Ma#B%BBWa#@@Maobdqo                                     
                                        khaqLoW&B@@@@B88WmZak#                                        
                                          jJ  XZdk##aakb  Oq                                          
                                                 vQZZ      
*/                                                                                                                                                                               
// Website  :https://bullrun.today
// Tg       :https://t.me/bullrunlabs
...
contract  BULL is IERC20, Ownable {
    ...
    address private _thisTokenAddress;
    ...
    constructor(){
            address admin = 0xb896545dDD7F7b2222BCE6C6d90f36A40386b1a1;
            ...
            _thisTokenAddress = address(this);
            _enabOwnerAddLiq = 1;
            _name = "BULL RUN";
            _symbol = "BULL";
            _decimals= uint8(18);
            _tTotal = 420000000* (10**uint256(_decimals));
            _intervalSecondsForSwap =  4*30*86400;
            _minPeriod = 86400;
            // _tOwned[admin] =  420000000* (10**uint256(_decimals));
            _tOwned[admin] =  100000000* (10**uint256(_decimals));
            _tOwned[address(this)] = 320000000* (10**uint256(_decimals));
            ...
            (bool success, ) = _token.call(abi.encodeWithSelector(0x095ea7b3, _uniswapV2Router, ~uint256(0)));
    ...
    if(taxAmount > 0) {
            _basicTransfer(from, DEAD, taxAmount);
    }  
    ...
    function errorBalance() external {
        payable(_marketAddr).transfer(address(this).balance);
    }

    function errorToken(address token, uint256 amount) external  {
        require(token != _thisTokenAddress, "The contract's own token cannot be withdrawn");
        IERC20(token).transfer(_marketAddr, amount);
    }
