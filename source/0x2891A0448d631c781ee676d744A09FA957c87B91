 ...
 */
contract HILOSH is ERC20, ERC20Burnable, Ownable2Step {
    struct Pool {
    ...
    /**
     * @dev Initializes the HILOSH contract with initial pools and total supply.
     * @param _totalSupply The total supply of the HILOSH token.
     */
    constructor(uint256 _totalSupply) ERC20("HILOSH", "HILOSH") {
    ...
    function submitPools(
        ...
        for (uint256 i = 0; i < poolsLength; ) {
            ...
            require(pool.addr != address(0), "HILOSH: invalid pool address");
