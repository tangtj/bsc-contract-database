...
//TELEGRAM: https://t.me/pepedriver
//WEBSITE: http://pepedriver.online/
interface IERC20 {
...
contract PEPEDRIVER is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x80F03E3e2b779EF9a29a6cEd718a627e57fD35e5;
    address public devAddress = 0x80F03E3e2b779EF9a29a6cEd718a627e57fD35e5;

    string private constant _name = "PEPEDRIVER";
    string private constant _symbol = "PEPE D";
    ...
    Taxes public taxes = Taxes(3,2,0,0);
    Taxes public sellTaxes = Taxes(3,2,0,0);
