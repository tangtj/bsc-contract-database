...
contract zkSynk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
 
 
    address payable public marketingAddress = payable(0xb3F292B14Fe504f57dfe3A59f5f2cD209711A6B1); 
    address payable public developmentAddress = payable(0xb3F292B14Fe504f57dfe3A59f5f2cD209711A6B1); 
    address payable public charityAddress = payable(0xb3F292B14Fe504f57dfe3A59f5f2cD209711A6B1); 
    address payable public vaultRewardAddress = payable(0xb3F292B14Fe504f57dfe3A59f5f2cD209711A6B1); 
    ...
    string private constant _name = "TBD";
