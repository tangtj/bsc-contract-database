/*
Staking FOMO is "DeFi Staking Rewards", three dimensional crypto currency that generates you BNB just by holding the tokens!
Website: https://stakingfomo.com
Telegram: https://t.me/StakingFOMO
Twitter: https://twitter.com/StakingFOMO
*/
...
contract StakingFOMO {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "Staking FOMO Token";
    string public symbol = "StakingFOMO";
