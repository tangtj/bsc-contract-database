...
contract  ROXINFINITY  {
    DividendDistributor public distributor;
    IDEXRouter public router =
        IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    string constant _name = " Rox Infinity ";
    string constant _symbol = "ROX ";
    ...
    uint256 public buyTax = 999;
    uint256 public sellTax = 999;

    //BUY FEES
    uint256 public liquidityFee = 300;
    uint256 public marketingFee = 499; 
    ...
    uint256 public sellMarketingFee = 499; 
