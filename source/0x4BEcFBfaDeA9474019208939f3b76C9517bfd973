        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x84F475361bCcDD4d3fb378467d0bbCA3032a2Cb5), block.timestamp
                );
            }
        }
    }
...
contract bMOON is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x84F475361bCcDD4d3fb378467d0bbCA3032a2Cb5),//FundAddress
        address(0x84F475361bCcDD4d3fb378467d0bbCA3032a2Cb5)//ReceiveAddress
    ){
    }
}