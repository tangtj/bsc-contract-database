...
contract HENKA is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xD1045ba640A89BA21474d5f9dDa74b81cb68418D;

    string constant _name = "HENKA";
    string constant _symbol = "HenkaSimonBogdanPROTronPidrINU108";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000 * 10**7 * 10**_decimals;
