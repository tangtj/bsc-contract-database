...
contract locus is IERC20, Ownable {
    ...
    uint256 _totalSupply = 3 * 10**5 * 10**_decimals;
    ...
    constructor () {
        ...
        devFeeReceiver = 0x3A07685BAfDE178F2E9F098049d86e312341A297;
        marketingFeeReceiver = 0x404C35417b8d16127C0E6db6A3E6193E3a1FA822;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=10,"Cannot set buy fees above 25%"); // set max fees you can set to here
        require(totalFeeSell <=10,"Cannot set sell fees above 25%"); // set max fees you can set to here
