...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82cC79De4304110Bb64d8B179a00b6CE2DCAEd0F; // owner address
...
contract NiHao is Context, IERC20, Ownable {
    ...
    string private _name = "NiHao";
    string private _symbol = "NIHAO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE520DB00ba65c033a882533a3933B614248509d6); // Marketing Address
    address payable private teamWalletAddress = payable(0xE520DB00ba65c033a882533a3933B614248509d6); // Team Address
