...
contract Dumbledore is Context, IERC20, Ownable {
    ...
    string private constant _name = "DUMBLEDORE";
    string private constant _symbol = "DUMBLEDORE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x90623Fc58B0eC0951126e692f5B0e3FD02b82C79);
    address payable private _marketingAddress = payable(0x90623Fc58B0eC0951126e692f5B0e3FD02b82C79);
