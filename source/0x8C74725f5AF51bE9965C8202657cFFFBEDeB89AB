/**
 Telegram: https://t.me/aperise_official
...
contract ARISE is IBEP20, Auth {
    ...
    string constant _name = "APE RISE";
    string constant _symbol = "ARISE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;  //3% max tx
    ...
    address private marketingFeeReceiver =0x78c750dbeF001Ffd5ddee28Ce2a6f8bA12193b1D;
    address private teamFeeReceiver =0x78c750dbeF001Ffd5ddee28Ce2a6f8bA12193b1D;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x5Cc7bcB67296D75CC1c04295467D3DaFc7fF1315;
