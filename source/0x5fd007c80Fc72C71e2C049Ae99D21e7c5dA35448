...
contract XPAYPALCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "X PAYPAL COIN"; // 
    string private constant _symbol = "XPC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x6E51E069272f5929410417D9b773564D67ac5308;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x65eC81750f5d29851691d3d4953Ada1E2940B076;
