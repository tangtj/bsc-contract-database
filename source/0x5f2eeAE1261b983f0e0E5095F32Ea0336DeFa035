...
Tax explained:
✅ 3% going to BUSD rewards.
✅ 2% going to liquidity.
...
contract BUBUSDT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BUBUSDT";
    string constant _symbol = "BUBUSDT";
    ...
    uint256 public marketingFee = 26;
    uint256 public rewardsFee = 3;
    uint256 public extraFeeOnSell = 10;

    uint256 public totalFee = 34;
    uint256 public totalFeeIfSelling = 44;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x114D843D9fcA168Ad8e283faf2a8Bcef576D4d75;
        marketingWallet = 0x0f04174d49aFECC5957F32d1FBf0E12bbF7c6df9;
        devWallet = 0x114D843D9fcA168Ad8e283faf2a8Bcef576D4d75;
