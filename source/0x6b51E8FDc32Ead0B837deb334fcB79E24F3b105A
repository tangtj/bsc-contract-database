// File: contracts/pancake-swap-lib/token/BEP20/IBEP20.sol
...
// File: contracts/pancake-swap-lib/math/SafeMath.sol
...
// File: contracts/pancake-swap-lib/utils/Address.sol
...
// File: contracts/pancake-swap-lib/token/BEP20/SafeBEP20.sol
...
// File: contracts/pancake-swap-lib/GSN/Context.sol
...
// File: contracts/pancake-swap-lib/access/Ownable.sol
...
// File: contracts/pancake-swap-lib/token/BEP20/BEP20.sol
...
contract FinixToken is BEP20('Definix Token', 'FINIX') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying FINIXs (not scaled);
...
// File: contracts/FlameKeeper.sol
