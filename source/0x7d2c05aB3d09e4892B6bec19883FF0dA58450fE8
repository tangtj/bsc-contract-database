/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Liq combine together to creat MoonDragon designed
    
    I make this #MoonDragon to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/MoonDragoncom
   ...
   I will renounce the ownership to burn addresses to transfer #MoonDragon to the community, make sure it's 100% safe.

   I will add 0.15 BNB and all the left 50% total supply to the pool
   Can you make #MoonDragon 100000X? 
   
  100% SAFE NO RUG.

   100,000,000,000,000,000 total supply
   500,000,000,000,000 MoonDragon max limit for per trade
   ...
   it's the best part of the #MoonDragon idea, increasing the liquidity pool automatically, 
...
contract MoonDragon is Context, IERC20, Ownable {
    ...
    string private _name = "MoonDragon";
