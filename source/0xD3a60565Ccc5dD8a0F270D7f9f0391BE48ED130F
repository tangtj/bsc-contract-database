// https://t.me/NBabyDogeBSC
// https://twitter.com/NewBabyDogeBSC
// https://newbabydoge.club/
...
contract NewBabyDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"New Baby Doge";
    string private constant _symbol = unicode"NBABYDOGE";
