...
contract WWDTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "WorldWarDoge";
    string private _seitokensymbol = "WWD";
    address public dahnnf67;
