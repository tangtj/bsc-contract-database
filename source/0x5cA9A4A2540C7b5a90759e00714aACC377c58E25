        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7d067787CAb202c3Cec2adc2410A2CCF108c0FcD), block.timestamp
                );
            }
        }
    }
...
contract ETCSDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        8888,//Supply
        address(0xb318991a35A5e765838f845245CdfA02facbdB9f),//FundAddress
        address(0x7d067787CAb202c3Cec2adc2410A2CCF108c0FcD)//ReceiveAddress
    ){
    }
}