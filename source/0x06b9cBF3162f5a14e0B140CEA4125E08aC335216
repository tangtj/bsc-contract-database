/**
https://t.me/PepeGrowOfficialBsc1
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74695706e3e7aD878CeB24C6c25174db3C9315F0; // owner address
...
contract PepeGrowOfficialBsc1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE GROW";
    string private _symbol = "$PG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa82Dc6d9873804d994D94b7B2543e41546dA12Ea); // Marketing Address
    address payable private teamWalletAddress = payable(0x74695706e3e7aD878CeB24C6c25174db3C9315F0); // Team Address
