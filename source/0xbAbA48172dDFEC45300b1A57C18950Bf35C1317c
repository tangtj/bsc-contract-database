...
//https://t.me/ShibaInuCoinInverse
...
contract ShibaInverse is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"nuI ɐqıɥS"; // 
    string private constant _symbol = unicode"BIHS";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x5345249AbBC3Da45C25cD0EF335767BF4D74c139;
