...
contract Zeus is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420690000000000000 * 10**9;
    ...
    address payable private _dev = payable(0x4CaAF5E208D58e13585DAA7a031325c356A70a11);
    address payable private _mkt = payable(0x4CaAF5E208D58e13585DAA7a031325c356A70a11);
