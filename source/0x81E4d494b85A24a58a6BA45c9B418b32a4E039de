/**
   #MOONTOKEN - #LIQ+#RFI+#SAFEMOON, combine together to #MOONTOKEN. 
   ...
   it's the best part of the #MOONTOKEN idea, increasing the liquidity pool automatically, 
...
contract MoonToken is Context, IERC20, Ownable {
    ...
    string private _symbol = "MOONTOKEN";
