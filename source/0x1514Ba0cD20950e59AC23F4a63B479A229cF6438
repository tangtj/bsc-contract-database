...
contract TDE is IERC20, Ownable {
    ...
    address private fundAddress = address(0x8DfEc13e6e7858AfCa9Cd27A0f7ffcacAAd4090c);
    address private fundAddress2 = address(0x8DfEc13e6e7858AfCa9Cd27A0f7ffcacAAd4090c);
