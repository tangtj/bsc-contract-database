...
Telegram https://t.me/BlockAiSociety
Website 
*/
...
contract BlockAiSociety is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLOCK AI SOCIETY";
    string private _symbol = "$BAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x151ff12e5B81677587664a760860c2B8E7572Db4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xC190794Fc2ec98F773DAbE5CE917A5868Cd03a3A); // BuyBack Address
