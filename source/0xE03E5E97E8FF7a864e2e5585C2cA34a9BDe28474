// https://t.me/DisneyTokenOfficial
// https://twitter.com/disneytokenbsc
// https://disneytokenbsc.com/
...
contract Disney is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Disney Token";
    string private constant _symbol = unicode"DI$NEY";
