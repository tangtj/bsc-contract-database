...
/**
   ...
   Welcome to EL'Cartel
   
   This is a community token. If you want to create a telegram I suggest to name it to @EL'CartelBSC
   ...
   I will renounce the ownership to burn addresses to transfer #EL'Cartel to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #EL'Cartel 10000X? 
   ...
   it's the best part of the #EL'Cartel idea, increasing the liquidity pool automatically, 
...
contract ELCartel is Context, IERC20, Ownable {
    ...
    string private _name = "EL'Cartel";
    string private _symbol = "EL'Cartel";
