...
contract Diamond_LP_Staking is Ownable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint256 amount);
    
    address public tokenAddress = 0x3e8cfdd483c5818c5A4A799CBAae324002d086AD; // native token contract address
    address public LPtokenAddress = 0x196D5D3976E79bF697c94f47795298939995099d; // LP token contract address
    uint256 public rewardRate = 4380; // reward rate /100 % per year
    uint256 public rewardInterval = 365 days;
    uint256 public stakingFeeRate = 0; // staking fee 0%
    uint256 public unstakingFeeRate = 0; // unstaking fee 0%  
    uint256 public cliffTime = 0 days; // unstaking possible after 0 days
