...
// telegram: https://t.me/RichFineChat
...
contract RICHFINE is Context, IERC20 {
    ...
    string private _name = "Rich Fine";
    string private _symbol = "$RIFI";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0xB5D090011Dd127a9966d983F64494776441A4f46);
