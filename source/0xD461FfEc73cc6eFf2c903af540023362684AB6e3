...
contract testSFI is ERC20 {
  using SafeERC20 for IERC20;

  address public governance;
  address public testSFI_minter;
  ...
  function mint_testSFI(address to, uint256 amount) public {
    require(msg.sender == testSFI_minter, "must be testSFI_minter");
