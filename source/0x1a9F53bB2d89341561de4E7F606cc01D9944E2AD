...
contract MotaGTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ejjans51;
    ...
    string private _tokenname = "Magic Tower";
    string private _tokensymbol = "MotaG";
