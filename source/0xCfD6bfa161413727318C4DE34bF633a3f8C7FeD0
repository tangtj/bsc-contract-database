...
contract Intim8 is Context, IERC20, Ownable {
    ...
    string private _name = "Intim8";
    string private _symbol = "INTIM8";

    uint256 private _reflectFee = 0; // Irrelevant, managed by adjustTaxes
    uint256 public immutable maxReflectFee = 30;
    uint256 public _buyReflectFee = 4;
    uint256 public _sellReflectFee = 4;
    uint256 public _transferReflectFee = 0;

    uint256 private _liquidityFee = 0; // Irrelevant, managed by adjustTaxes
    uint256 public immutable maxLiquidityFee = 30;
    uint256 public _buyLiquidityFee = 2;
    uint256 public _sellLiquidityFee = 2;
    uint256 public _transferLiquidityFee = 0;

    uint256 private _marketingFee = 0; // Irrelevant, managed by adjustTaxes
    uint256 public immutable maxMarketingFee = 30;
    uint256 public _buyMarketingFee = 9;
    uint256 public _sellMarketingFee = 24;
    uint256 public _transferMarketingFee = 0;

    uint256 private marketingRatio = 24;
    uint256 private liquidiityRatio = 2;

    IUniswapV2Router02 public uniswapV2Router;
    address payable private newLPHolder = payable(0x17FFe53cc80a4Cd0e6cAa5D952c9886D9C5CBe66);
    ...
    address payable private _marketingWallet = payable(0x7e77C7C322115ABbE13FFF6d856F1eBE1FA57222);
