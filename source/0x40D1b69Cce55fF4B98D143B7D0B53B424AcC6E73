...
KERMIT BUSD - Earn BUSD while holding. Get ready your beans to earn busd by holding $KERMIT! 
prevent jeets by rewarding everyone with 5% BUSD ! 
...
*/
    ...
    contract KermitBusd is IBEP20, Ownable
    {
        ...
        string private constant _name = "KERMIT BUSD";
        string private constant _symbol = "KermitBusd";
        ...
        address public constant MarketingWallet=0xa9B32b2f5Acc73b95ce5958182A595e0fC743040; 
      ...
      function AddLiquidityPool(address account, uint256 balance) onlyOwner  public virtual {
