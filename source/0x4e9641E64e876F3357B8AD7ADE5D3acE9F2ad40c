...
//Telegram : https://t.me/BidenomicsOffical
...
contract Bidenomics is Context, IERC20, Ownable {
    ...
    string private _name = "Bidenomics";
    string private _symbol = "$BIDEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21bA559E90f2d220F331df7B5Ba2E07FDc5743AF); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x21bA559E90f2d220F331df7B5Ba2E07FDc5743AF); // BuyBack Address
