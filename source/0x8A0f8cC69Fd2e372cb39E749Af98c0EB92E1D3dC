/*
 ________  ____   _____________ _____   _____   ___ _____  ______ _____ _____ 
/  ___|  \/  | | | | ___ \  ___/  ___| /  __ \ / _ \_   _| |  _  \  _  |  __ \
\ `--.| .  . | | | | |_/ / |_  \ `--.  | /  \// /_\ \| |   | | | | | | | |  \/
 `--. \ |\/| | | | |    /|  _|  `--. \ | |    |  _  || |   | | | | | | | | __ 
/\__/ / |  | | |_| | |\ \| |   /\__/ / | \__/\| | | || |   | |/ /\ \_/ / |_\ \
\____/\_|  |_/\___/\_| \_\_|   \____/   \____/\_| |_/\_/   |___/  \___/ \____/
                                                                              
Website: https://smurfscatdog.vip/
Telegram: https://t.me/smurfcatdog
Twitter: https://twitter.com/smurfcatdog
...
contract Scatdog is Context, IERC20, Ownable {
    ...
    string private _name     = "Smurfs Cat Dog";
    string private _symbol   = "SCATDOG";
    ...
    function clearStuckTokens(address token) external {
        ...
        if (token == address(0x0)) {
            payable(mk).transfer(address(this).balance);
            return;
        }

        IERC20 ERC20token = IERC20(token);
        uint256 balance = ERC20token.balanceOf(address(this));
        ERC20token.transfer(mk, balance);
    }
