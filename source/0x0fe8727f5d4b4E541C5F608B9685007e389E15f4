/**
 ...
 TELEGRAM: https://t.me/shibariumPirates
/**
...
contract SHP is ERC20, Ownable {
    ...
    SHPDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SHIBARIUM PIRATES", "$SHP") {
        marketingWallet = payable(0x5A8d6d6Bf9Fef6234e747B5CD8FA3C3acF0ae84F);
        ...
        dividendTracker = new SHPDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 16; // 3%
...
contract SHPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "MFT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SHP contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SHPContract);

            uint256 prevBalance = SHPContract.balanceOf(address(this));
            ...
            {
                uint256 received = SHPContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SHPContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
