...
contract McPika is Context, IERC20, Ownable {
    ...
    string private constant _name = "McPika";
    string private constant _symbol = "MCP";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x335a3c08a589d7A1e4e4559fafd8DA60070c7849);
    address payable private _marketingAddress = payable(0xA9C93f8601B7D72b92B8A74A6762EFdf640a8402);
