...
contract GC20 is IERC20, Ownable {
    ...
    constructor() {
        ...
        _symbol = "GC2.0";
        _decimals = 18;
        address ReceiveAddress = 0x5cC648dC0C7C900d875Eeea8B86bFE3A3aD0eE12;
        address FundAddress = 0x70fF5621605FC0d7fA53769F66Eb0a8C3DdeB2d5;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == goMoonBlock || goMoonBlock>block.number) {
