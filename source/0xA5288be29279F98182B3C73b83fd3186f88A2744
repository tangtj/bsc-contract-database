...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address[] marketingAddress=[0x321A582955Bb1cFeE42c49e2aFfB25fa31e7aB3c];
...
contract HM is AbsToken {
    constructor() AbsToken(
        ...
        address(0x40ffC0d8221FE73DBCd37cf08a7827a7a6759583),
    
        address(0xF1Ed20373fD31C40d95636626a75fAa8E475A0c6
)
    ){
