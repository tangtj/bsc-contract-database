...
contract test is ERC20, Ownable {
    ...
    address private  marketingWallet = payable(0x68451B0D05C957Cebd23333F458EA19979a000D1);
    address private  devWallet = payable(0x68451B0D05C957Cebd23333F458EA19979a000D1);
