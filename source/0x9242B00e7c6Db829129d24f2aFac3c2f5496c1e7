/** TELEGRAM : https://t.me/pepefineportal
...
contract PepeIsFine is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x13d7808eaD4a7377A829528369acbC43Bd0b2957);
    address payable private _twdmkt = payable(0x13d7808eaD4a7377A829528369acbC43Bd0b2957);
    
    string private constant _name = "Pepe Always Fine Even Got Hacked";
    string private constant _symbol = "$PogFine";
