...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02efB7bc598584179e675eCFb8BC813Dd9C50C21; // owner address
...
contract BABY2049 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY2049";
    string private _symbol = "BABY2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x02efB7bc598584179e675eCFb8BC813Dd9C50C21); // Marketing Address
    address payable private teamWalletAddress = payable(0x02efB7bc598584179e675eCFb8BC813Dd9C50C21); // Team Address
