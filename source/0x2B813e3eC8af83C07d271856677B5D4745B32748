        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x27a0959998745D8097E8b62C7b2df25bE60d0A0c), block.timestamp
                );
            }
        }
    }
...
contract PLcoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000,//Supply
        address(0x86a0899401D49Faa0294d91d17B08e57e400d657),//FundAddress
        address(0x27a0959998745D8097E8b62C7b2df25bE60d0A0c)//ReceiveAddress
    ){
    }
}