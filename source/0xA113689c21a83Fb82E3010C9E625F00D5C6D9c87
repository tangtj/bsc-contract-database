...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x7077c00f556663D6f31d994DF433d8Dc508749bB;
...
contract FamilyToken is Context, IERC20, Ownable {
    ...
    constructor() public {
        _rOwned[0x7077c00f556663D6f31d994DF433d8Dc508749bB] = _rTotal;
        BUSD = IERC20(_busd);
        ...
        emit Transfer(
            address(0),
            0x7077c00f556663D6f31d994DF433d8Dc508749bB,
            _tTotal
        );
    }
    ...
    function _getBuyFee() private pure returns (uint256) {
