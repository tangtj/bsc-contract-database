...
contract XDragon is Context, IERC20, Ownable {
    ...
    string private _name = unicode"X Dragon";
    string private _symbol = unicode"XDRAGON";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x343059c986C74eFE30945A254dA711e7191b92a6);
    address payable private taxWallet2 = payable(0x343059c986C74eFE30945A254dA711e7191b92a6);
