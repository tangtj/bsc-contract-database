...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "BTCQ";
    string private _symbol = "BTCQ";
    ...
    address public _market = 0x3D1e9dF971C775b9271b8AB4184E89c32911E9f9;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x35bfD6e6e2E158A21CE6c2A8B8314F2A2DEE2f4f),
            _msgSender(),
            _tTotal
        );
    }
