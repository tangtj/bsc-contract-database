...
contract DEXTFTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ydcxffv3;
    ...
    string private _tokenname = "DEXTF";
    string private _tokensymbol = "DEXTF";
