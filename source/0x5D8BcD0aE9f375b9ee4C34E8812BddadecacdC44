...
contract Rabiki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rabiki";
    ...
    address payable private _twddev = payable(0x45F7ad69be342a2A9BF959Ed5130b1BC2368383a);
    address payable private _twdmkt = payable(0x45F7ad69be342a2A9BF959Ed5130b1BC2368383a);
