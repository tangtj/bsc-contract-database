...
contract SPACE is Token {
    constructor() ERC20(
        "SPACE2049",   // 名字
        "SPACE2049"   // 符号
    ) {
        uint256 _totalSupply = 20490 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x6d4aeA39f8c70a1C6Cc69989b8F3Ac389724ff98); //
        ...
        super.setSurprise(
            0,
            0,
            address(0x6d4aeA39f8c70a1C6Cc69989b8F3Ac389724ff98)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x6d4aeA39f8c70a1C6Cc69989b8F3Ac389724ff98);
        feeEarn = 0;
        isLiquified = true;
    }
}