...
contract Borcelle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BORCELLE";
    string private _symbol = unicode"BORCELLE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xc12DE2415fec78E76452A3c630F8F83933Bcde16);
    address payable private taxWallet2 = payable(0xc12DE2415fec78E76452A3c630F8F83933Bcde16);
