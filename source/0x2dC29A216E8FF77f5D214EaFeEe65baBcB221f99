...
/**
KurumaInu BSC Token - Stealth Launch
Telegram: @KurumaInu
*/
...
contract KurumaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KurumaInu";
    string constant _symbol = "KURUMAINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF9F6bFCEd7Bc92989c6f242b346c10Cb75C3c9A9;
