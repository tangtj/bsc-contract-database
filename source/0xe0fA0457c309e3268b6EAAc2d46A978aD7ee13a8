...
contract DORKLTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dkkgnt74;
    ...
    string private _tokenname = "DORKL";
    string private _tokensymbol = "DORKL";
