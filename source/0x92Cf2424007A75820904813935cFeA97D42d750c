...
contract EGOD is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 40000 * 10**_decimals; //

    address public marketingAddress = 0xB46DE30c8dcB382D959FEd9E5e704944077140ae; //
    address public devAddress = 0x579DB81D7E6977A835F8Ddb0175Fe419cF28CC8E; //
    ...
    Taxes public taxes = Taxes(0,4,6,0); //
    Taxes public sellTaxes = Taxes(0,4,6,0); //
