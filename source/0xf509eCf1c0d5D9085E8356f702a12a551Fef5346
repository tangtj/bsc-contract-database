...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7354416B1742682288fD6C7D69e9d01A58900d2; // owner address
...
contract XUCHICHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XuxhiChain";
    string private _symbol = "XuxhiChain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7354416B1742682288fD6C7D69e9d01A58900d2); 
    address payable public teamWalletAddress = payable(0x533AF45150DB9f560fC3238e3DA6cd059D0470f4);
