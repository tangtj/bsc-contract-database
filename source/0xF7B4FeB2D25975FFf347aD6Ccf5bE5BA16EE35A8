...
contract GIRLTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dcnfh83;
    ...
    string private _tokenname = "Moongirl";
    string private _tokensymbol = "GIRL";
