...
contract PLUTORIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PLUTO CHAIN";
    string private _symbol = "PLUTO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x89a65e721ce467eA0c456E6DE2a75a338d2d602C); // Marketing Address
    address payable public teamWalletAddress = payable(0x89a65e721ce467eA0c456E6DE2a75a338d2d602C); // Team Address
