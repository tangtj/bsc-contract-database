/**
TG: https://t.me/BIRDXOFFICIALBSC
Twitte: https://twitter.com/Official_BirdX
TAYOR AND DYOR
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81eB19068031868FeAac36D2FD4fdAe13C49374a; // owner address
...
contract BIRDXOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIRD X";
    string private _symbol = "$BIRDX";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7CfA5B96f3c6D7a2124558f2dd0a2d899305abd4); // Marketing Address
    address payable private teamWalletAddress = payable(0x81eB19068031868FeAac36D2FD4fdAe13C49374a); // Team Address
