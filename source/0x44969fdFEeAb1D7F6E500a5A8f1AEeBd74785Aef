...
// File: contracts\lib\BEP20Mintable.sol
...
// File: contracts\wrappedBitcash.sol

pragma solidity ^0.7.0;


/**
 * @title Wrapped BitCash
 * @dev Implementation of the Wrapped BitCash
 */
contract WrappedBitCash is BEP20Mintable, BEP20Burnable {

    constructor ()

      BEP20("Wrapped BitCash", "wBITC")
      payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
