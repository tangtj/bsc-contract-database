#https://github.com/curvefi/curve-contract/blob/e240a4c96cf94e717b39b51ecf50a30decdc95ac/contracts/pool-templates/meta/SwapTemplateMeta.vy
...
def withdraw_admin_fees():
    ...
    for i in range(N_COINS):
        ...
        if value > 0:
            assert ERC20(c).transfer(self.admin_fee_address, value)
