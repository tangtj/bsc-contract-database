        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x179785dC3154aF3FF1deB6eB2eCB4B8E6b2f70c1), block.timestamp
                );
            }
        }
    }
...
contract MAMABEAR is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0x47055Ab7bAeAebb6800D7802a3E83DB7E6c19f34),//FundAddress
        address(0x179785dC3154aF3FF1deB6eB2eCB4B8E6b2f70c1)//ReceiveAddress
    ){
    }
}