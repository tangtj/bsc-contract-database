...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buy_BackFee = 0; // 回购

    uint256 public _sellFundFee = 200; // 营销
    uint256 public _sellLPFee = 0;// 回流
    uint256 public _sellLPDividendFee = 0; // lp分红
    uint256 public _sell_BackFee = 0; // 回购
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 20 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x0950fe69E512EB46CCA0425e79159e207953B184;
...
contract ZZ is AbsToken {
    constructor() AbsToken(
        ...
        address(0x52bFDE494af4AFB90C2218eFCED609bc9305C267), // 营销钱包
        address(0x52bFDE494af4AFB90C2218eFCED609bc9305C267), // 收币钱包

        address(0xbC8c4e61896b444Cb5511874A94589FdcB499999), //回购代币合约
        address(0x596cf55902BF2Fd1d3d7cedC603420dAf9aA4F04) //回购到账地址
    ){
