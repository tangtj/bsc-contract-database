...
contract BITXCOIN is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xc0a47315dF93Afa909bF1F7d7e06dc89f4240df7);
    address payable private _twdmkt = payable(0x3b514fbF5d3596fAedD352BFDCb2E8Bc0eC85e72);
    
    string private constant _name = "BITXCOIN";
    string private constant _symbol = "BXC";
