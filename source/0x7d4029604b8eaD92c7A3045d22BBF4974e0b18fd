...
contract ArutKaput is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingAddress = payable(0x42762100757b40c4c6A30c56AF63429fD0a77c0f);
        treasuryAddress = payable(0x42762100757b40c4c6A30c56AF63429fD0a77c0f);
