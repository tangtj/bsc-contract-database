...
contract LF is Token {
    constructor() ERC20(
        "LF",   // 名字
        "LF"   // 符号
    ) {
        uint256 _totalSupply = 1030 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x41b9fE0e152453C02F440A8015d977A94a90dc47); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x41b9fE0e152453C02F440A8015d977A94a90dc47)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(10 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x1E7C28E9790adA8BE3247F0FedF51B5f342A7918);
        feeEarn = 0;
        isLiquified = true;
    }
}