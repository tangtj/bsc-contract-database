...
//X: https://twitter.com/BSCInfinitum
...
contract Ownable is Context {
   ...
   constructor () {
        _owner = 0xbFc8462244225c5f7e406782f4e694c50Af150Ed;
...
contract Infinitum is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB70D64d9E0CeD15175D0118E43a82E6f7bf741bE); // Marketing
    address payable public teamWalletAddress = payable(0xbFc8462244225c5f7e406782f4e694c50Af150Ed); // Team
