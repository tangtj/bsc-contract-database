...
contract MetaCashWallet  is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Cash Wallet";
    ...
    address public marketingWallet = 0xC1FFa29E55DC19835c10D0aAe611Fc68CEd43462;
