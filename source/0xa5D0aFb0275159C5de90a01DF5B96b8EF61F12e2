...
//https://twitter.com/UnderDogBsc
//https://t.me/underdogofficialbsc
...
contract UNDERDOG  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4ef4d7Cba87302900600020c70A98227EB4786e0); 
    address payable public Wallet_Dev = payable(0x4ef4d7Cba87302900600020c70A98227EB4786e0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 17* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "UNDERDOG"; 
    string private constant _symbol = unicode"$UNDERDOG"; 
    ...
    constructor () {
        _owner =0x4ef4d7Cba87302900600020c70A98227EB4786e0;
