...
contract INU is Context, IERC20, Ownable {
    ...
    string private _name = "2024 Inu";
    string private _symbol = "24INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A6B63d4ccaA0BfE39450A8b8B70887E38c462D5); 
    address payable public teamWalletAddress = payable(0x1A6B63d4ccaA0BfE39450A8b8B70887E38c462D5);
    ...
    uint256 public _maxTxAmount = 150000000000 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 150000000000 * 10**6 * 10**6* 10**_decimals;
