...
contract RSCS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Righteous spirit Cloud Sky";
    string private _symbol = "RSCS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0898D05E89C3EB30bFa61C6d0b0C3B1AC8888888); // Marketing Address
    address payable public teamWalletAddress = payable(0x0515f0a5C18418A38cCad2E6BD49a8a339999999); // Team Address
