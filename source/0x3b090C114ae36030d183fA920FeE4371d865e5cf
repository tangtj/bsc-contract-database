...
contract ElonFootball is Context, IERC20, Ownable {
    ...
    string public constant _name = "Elon Football"; // 
    string private constant _symbol = "ElonFootball"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 private _liquidityFee = 0;

    address private  _marketingWallet = 0xC5C8273230eC832EEfEfe7F3898bB449f5345e83;
