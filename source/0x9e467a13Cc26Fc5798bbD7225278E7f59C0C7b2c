...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43E0dFd43b8D4D8D27afA36769b87bCddfC151CE;
...
contract BSCTester3 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3df1EDDD8a3e7cAb1bD14cAFbd6EC8f22693aE60;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BSCTester3";
    string private _symbol = "BSCT3";
    ...
    uint256 public _maxWalletSize = 40;
