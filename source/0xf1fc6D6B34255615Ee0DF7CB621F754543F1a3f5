...
interface IDEXRouter {
 ...
 contract MemessiToken is IBEP20, Auth { using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // MAINNET
    string constant _name = "MEMESSI TOKEN";
    string constant _symbol = "LIO";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10100000000 * (10 ** _decimals);
    ...
    address public devFeeReceiver = 0x050E4e124898e4B1D2Fd4D98FA98a391184Ab393;
    address public buybackFeeReceiver = 0x050E4e124898e4B1D2Fd4D98FA98a391184Ab393;
