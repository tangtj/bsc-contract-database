...
contract SAFELOOT is Context, IERC20, Ownable {
    ...
    string private _name = "SAFELOOT";
    string private _symbol = "SAFELOOT";
    ...
    address public charityWallet = 0x8cf83933d1B74A05cF05580E89839Ce80d5C7D5a;
