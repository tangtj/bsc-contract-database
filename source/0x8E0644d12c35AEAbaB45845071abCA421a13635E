...
contract $PEPE is Context, IERC20, Ownable {
    ...
    address payable private taxWallet1 = payable(0x4B6afd15d4Eb9C85D834A7a9E814c7c93EA0a1d0);
    address payable private taxWallet2 = payable(0x4B6afd15d4Eb9C85D834A7a9E814c7c93EA0a1d0);
    ...
    uint256 public _maxTxAmount = _totalSupply*6942000000/6942000000;
    uint256 public _walletMax = _totalSupply*6942000000/6942000000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*6942000/6942000000; 
