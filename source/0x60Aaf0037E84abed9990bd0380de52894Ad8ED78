        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xA44637A9FF4F2Ce904db8aD6C73da8C3a1c2E8ea), block.timestamp
                );
            }
        }
    }
...
contract w1888 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1888,//Supply
        address(0xA44637A9FF4F2Ce904db8aD6C73da8C3a1c2E8ea),//FundAddress
        address(0xA44637A9FF4F2Ce904db8aD6C73da8C3a1c2E8ea)//ReceiveAddress
    ){
    }
}