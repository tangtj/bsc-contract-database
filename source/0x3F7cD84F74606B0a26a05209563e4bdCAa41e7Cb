...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b0cC0a74215a9781ec271f60B22810fEF5aa9Cc; // owner address
...
contract DogePal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE PAYPAL";
    string private _symbol = "DOGEPAL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7b0cC0a74215a9781ec271f60B22810fEF5aa9Cc); // Marketing Address
    address payable private teamWalletAddress = payable(0x7b0cC0a74215a9781ec271f60B22810fEF5aa9Cc); // Team Address
