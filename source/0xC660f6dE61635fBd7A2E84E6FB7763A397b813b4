...
contract PepeOfWallstreet is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Of Wallstreet", "POW") {
        ...
        marketingWallet = address(0xDe14FF865eb055E0971C66808393507BDb7A2893);
        devWallet = address(0xDe14FF865eb055E0971C66808393507BDb7A2893);
