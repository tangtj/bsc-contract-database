/**
   TELEGRAM : https://t.me/ECIbep20
   WEBSITE : https://eciecosystem.com/
*/
...
contract ECI is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x06CDd9e97eA8f949B5C0Ef7417a1887b8aB5dfBc;

    string private constant _name = "ECI";
