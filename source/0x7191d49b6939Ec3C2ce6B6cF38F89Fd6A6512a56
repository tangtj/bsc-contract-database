...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x967eAcd56c6d0c9dE475D351f5Cd0Dfd4E073772);
    string private _name = "Firephoenix";
    string private _symbol = "Firephoenix";
    ...
    uint256 public maxWalletAmount = 210000000000 * 10 ** _decimals;
