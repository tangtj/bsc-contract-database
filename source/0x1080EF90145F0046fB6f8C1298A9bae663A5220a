/*
TAX: 3/3
TG: https://t.me/LakersToken
TWITTER: https://twitter.com/coinlakers
*/
...
contract LakersToken is Context, IERC20 {
    string private _name = "Lakers Token";
    ...
    address payable public MarketingWallet = payable(0xcABaC370e7b05E0B2f8E9B0D5cBCbEb4E67C7B1B);
