...
contract MFPIGSpresale is ReentrancyGuard {
    ...
    address payable private payment_wallet = 0x8C13FA4F589c3d0521c210beb0E716EC4Fcb1A46;
    ...
    constructor() public {
        ...
        tokens_for_presale = 200000000000000000000000000000;
        tokens_for_presale_left = tokens_for_presale;
        ratePresale = 10000000000000;
