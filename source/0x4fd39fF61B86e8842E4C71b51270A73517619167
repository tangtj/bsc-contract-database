...
contract APaypalToken is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Paypal 2.0";
    string private constant _symbol = "PYPL2";
    ...
    uint256 public swapTokensAtAmount = 1_000_000_000_000 * 10**_decimals; //Should be 0.1% or lower
