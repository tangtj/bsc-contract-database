...
contract NekoAtsume is Context, IERC20, Ownable {
    ...
    string private constant _name = "Neko Atsume";
    string private constant _symbol = "NKA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x23C74f566446ca53F4270C0595dC39BC67CB1092);
    address payable private _marketingAddress = payable(0x23C74f566446ca53F4270C0595dC39BC67CB1092);
