...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28cc5e93b9C3b68E46BBf823ef34421C9b6fd75f; // owner address
...
contract BscFunds is Context, IERC20, Ownable {
    ...
    string private _name = "BSCFUNDS";
    string private _symbol = "BscFunds";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x28cc5e93b9C3b68E46BBf823ef34421C9b6fd75f); // Marketing Address
    address payable private teamWalletAddress = payable(0x28cc5e93b9C3b68E46BBf823ef34421C9b6fd75f); // Team Address
