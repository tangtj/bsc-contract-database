...
contract OPBRpay is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 12000 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "OPBRpay";
    string private _symbol = "OPBRpay";
    ...
    address public charityWallet = 0x1F2e5000ad41d0BD5134a87b6e51b32281Ca2861;//project *OPBR INVESTMENT - OPBRpay Shares Group* CNPJ: 30.277.475/0001-90
