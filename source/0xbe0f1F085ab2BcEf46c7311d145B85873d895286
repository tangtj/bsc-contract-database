...
/**
 * Generated by : Moss protocol
 * Moss : We make technology accessible.
 * Contract Type : Staking
 * Referral Scheme : 0.12, 0.04, 0.04
*/
 ...
 * Notes for _maxStakeAmt : 1 Coin BEP20USDT is represented by 10^18.
 ...
 * updates referralRecordMap (Element referringAddress) (Entity unclaimedRewards) as (referralRecordMap with element referringAddress with element unclaimedRewards) + (((12) * (_amt)) / (100))
 * updates referralsAllocated as (referralsAllocated) + (((12) * (_amt)) / (100))
 ...
 * creates an internal variable newAccum with initial value (thisRecord with element accumulatedInterestToUpdateTime) + (((thisRecord with element stakeAmt) * ((minimum of current time, ((thisRecord with element stakeTime) + ((30000) * (864)))) - (thisRecord with element lastUpdateTime)) * (dailyInterestRate)) / (86400000000))
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		uint256 newAccum = (thisRecord.accumulatedInterestToUpdateTime + ((thisRecord.stakeAmt * (minUIntPair(block.timestamp, (thisRecord.stakeTime + (uint256(30000) * uint256(864)))) - thisRecord.lastUpdateTime) * dailyInterestRate) / uint256(86400000000)));
		...
		require((ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).balanceOf(address(this)) >= (((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if (((((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))) > uint256(0))){
			ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).transfer(msg.sender, (((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) + ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))));
		}
 ...
 * returns (thisRecord with element accumulatedInterestToUpdateTime) + (((thisRecord with element stakeAmt) * ((minimum of current time, ((thisRecord with element stakeTime) + ((30000) * (864)))) - (thisRecord with element lastUpdateTime)) * (dailyInterestRate)) / (86400000000)) as output
*/
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt) public {
		...
		require((ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).balanceOf(address(this)) >= ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).transfer(msg.sender, ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)));
		}
...
*/
	function interestTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).balanceOf(address(this)) >= interestAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((interestAmtInBank > uint256(0))){
			ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).transfer(msg.sender, interestAmtInBank);
		}
 ...
 * The function takes in 1 variable, (zero or a positive integer) _amt. It can be called by functions both inside and outside of this contract. It does the following :
 * checks that the function is called by the owner of the contract
 * checks that (ERC20(Address 0x55d398326f99059fF775485246999027B3197955)'s at balanceOf function  with variable recipient as (the address of this contract)) is greater than or equals to ((_amt) + (totalUnclaimedRewards) + (interestAmtInBank) + (totalAccumulatedInterest) + (principalAmtInBank) + (totalStakedAmount))
 * if _amt is strictly greater than 0 then (calls ERC20(Address 0x55d398326f99059fF775485246999027B3197955)'s at transfer function  with variable recipient as (the address that called this function), variable amount as _amt)
*/
