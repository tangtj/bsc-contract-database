...
contract RamSena is Context, IERC20, Ownable {
    ...
    string private _name = "Ram Sena";
    string private _symbol = "RamSena";
    uint8 private _decimals = 18;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tSupply = 10000000000 * 10**18; // 10 Billion
    ...
    address public _ownerAddress = 0xd2CDF30853745F8a48c57a86CD47d2abB7340644;
    address public _liquidityAddress = 0xd2CDF30853745F8a48c57a86CD47d2abB7340644;
    ...
    function AddToLiquidityPercentage(uint256 _numTokensSellToAddToLiquidityPercentage) external onlyOwner() {
