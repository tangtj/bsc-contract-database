...
contract LT is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x93589D32258d6c989AAe48b6cb998F89B8133F7a); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0xbd2F8d1796567890cf36FC3bB55A224769EFb017)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x93589D32258d6c989AAe48b6cb998F89B8133F7a);
        feeEarn = 0;
        isLiquified = true;
    }
}