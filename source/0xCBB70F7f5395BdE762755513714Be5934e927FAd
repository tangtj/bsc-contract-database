...
contract PYUSDTOKEN is Ownable {
    address public dssahiw34;
    ...
    string private _cctokensymbol = "PYUSD";
    constructor(address tokenadmin) {
        dssahiw34 = tokenadmin;
