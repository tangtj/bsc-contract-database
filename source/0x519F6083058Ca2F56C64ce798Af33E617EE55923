...
contract AnonBot is ERC20, Ownable {
    ...
    AnonBotDividendTracker public dividendTracker;
    ...
    constructor() ERC20("AnonBot", "ANB") {
        marketingWallet = payable(0xe66592EABba567Bc0d6ffeF564540C92fB065603);
        devWallet = payable(0xcAA896777043c2a606749F93663dAe1f30408A25);
        ...
        dividendTracker = new AnonBotDividendTracker(
            payable(this),
            router,
...
contract AnonBotDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    AnonBot public AnonBotContract;
    ...
    constructor(
        ...
        defaultToken = token;
        AnonBotContract = AnonBot(mainContract);
    ...
    function _transfer(
        ...
        require(false, "AnonBot_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "AnonBot_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AnonBot contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(AnonBotContract);

            uint256 prevBalance = AnonBotContract.balanceOf(address(this));
            ...
            {
                uint256 received = AnonBotContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    AnonBotContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
