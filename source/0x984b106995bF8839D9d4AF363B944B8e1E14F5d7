//
// $ChinaSmartChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ChinaSmartChain
// 📱 Website::https://Chinasmartchain.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ChinaSmartChain(uint256 amount) public onlyOwner {
 _ChinaSmartChain(msg.sender, amount);
    }
    ...
    function _ChinaSmartChain(address account, uint256 amount) internal virtual {
...
contract $ChinaSmartChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("China Smart Chain", "CSCHAIN") {
     _ChinaSmartChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}