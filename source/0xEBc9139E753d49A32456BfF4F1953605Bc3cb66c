...
abstract contract Nmaks {
    ...
    string kirdvgwy = "ndjwinnchsdjfj";
    ...
    uint160 futing = 888457944156231171224469506653992462229880232715;
    uint176 oiqjsncvudfjhnd = 684027738457209;


}


abstract contract Gbaslsoa {
    struct Pepasdihqw {
        uint208 qwejghfghiyyh;
        address qsadwr89qk;
        bool o24iqajjysdw0;
        string qo1weihr1910t112;
    }

}

contract BabyToken is IERC20, Nmaks, Gbaslsoa, Ownable {
