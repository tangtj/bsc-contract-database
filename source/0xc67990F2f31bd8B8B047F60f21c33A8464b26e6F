/**
   ...
   telegram : https://t.me/BadBitchToken
   twitter:   https://twitter.com/BadBitchToken
...
contract BadBitch is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB7Dce6BECe875b6595aa96f80b378e3e250ba689); 
    address payable public Wallet_Dev = payable(0x3FA2C8191B0bAA31FBFdfA1CCb6bd9F28eddA8A2);
    ...
    string private constant _name = "Bad Bitch Token "; 
    string private constant _symbol = unicode"BadBitch"; 
    ...
    constructor () {
        ...
        _owner = 0x1319AC699BF6749921283aC0468d5f77861D6351;
