...
contract TestingToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100e3 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 1_800 * 10**_decimals;
    
    uint256 public maxSellAmount = 2_000 * 10**_decimals;
    uint256 public maxBuyAmount = 2_000 * 10**_decimals;
    uint256 public maxWalletBalance = 2_000 * 10**_decimals;

    address public marketingAddress; 
    address public devAddress;
    address public devaddress1;

    string private constant _name = "TestingToken";
