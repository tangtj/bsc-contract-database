// Blockchain Project
// Meshchain is a decentralized application 
// Mesh is a blockchain application platform. We make blockchain accessible by creating a world in which everyone benefits from this technology.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Mesh Blockchain Network';
    string constant public symbol = 'MCHAIN';
    ...
    function xvalidationmesh(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function meshapplication(address account) public view returns (bool) {
...
contract MeshNavigate is BaseToken {
