...
contract LITECOIN is ERC20, Ownable {
    ...
    mapping (address => bool) private _isLitecoinExcluded;
    ...
    constructor() payable ERC20 ("LITECOIN", unicode"Ł") {
        ...
        marketingWallet =  0xF5f5F66e3e5A655CC72dB5c954864D3697f124c7;
        ...
        swapTokensAtAmount = totalSupply() / 100000 * 35;
    }
