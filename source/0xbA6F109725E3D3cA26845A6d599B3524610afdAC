...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x731F2804C4564C6040610EA93b4546382d303905;
...
contract TRP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x731F2804C4564C6040610EA93b4546382d303905;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 32668000000000 * 10**18;
    ...
    uint256 public _maxTxAmount = 32668000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 3266000000000 * 10**18;
