...
interface IDEXRouter {
 ...
 contract AstroPepe  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "AstroPepe";
    string constant _symbol = "ASTPEPE";
    ...
    address public devFeeReceiver = 0x5B82c0765D38d9f966FBe06812eB18EB28787777;
    address public buybackFeeReceiver = 0x5B82c0765D38d9f966FBe06812eB18EB28787777;
