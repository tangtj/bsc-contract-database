...
contract Ownable is Context {
    address private _owner = 0xb0f0a6D16bBdffE6B4167624c4469b2e7185E2FD;
...
contract BlueTasteNFT is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xabCD3dc3C20B96A125D6aF7800b8bd6A33b6a7e9); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "BlueTaste"; // token name
    string private _symbol = "BlueTasteNFT"; // token symbol
