...
contract ShibaSaga is Context, IERC20, Ownable {
    ...
    string private _name = unicode"SHIBA SAGA";
    string private _symbol = unicode"$SHIAOG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x0956cEc9B718B39CB6EB67D8372E32bA64A25aAb);
    address payable private taxWallet2 = payable(0x0956cEc9B718B39CB6EB67D8372E32bA64A25aAb);
