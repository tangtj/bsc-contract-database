// t.me/DeFiKingdomsCrystal 
// DeFiKingdomsCrystal.com
...
contract DeFiKingdomsCrystal is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "DeFiKingdomsCrystal";
    string public symbol = "CRYSTAL";
