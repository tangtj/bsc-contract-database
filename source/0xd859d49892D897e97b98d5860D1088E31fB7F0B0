...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x76F78d4821D293814770C8a2A0f84c27Ea1221F1;
...
contract Token2049 is AbsToken {
    constructor() AbsToken(
        ...
        address(0xC07069ad78331E0320eF1B3E7B435f35396760c2),
    
        address(0xd83648304339C123b279cE0684e1154a24734389)
    ){
