...
contract CZPEPE is Context, IERC20, Ownable {
    ...
    string private _name     = "CZPEPE";
    string private _symbol   = "CZPEPE";
    ...
    { 
        ...
        marketingWallet = 0x1a62E29a971DDc2DC77294E960aa17C32a70558B;
        ...
        _isExcludedFromFees[address(0x1a62E29a971DDc2DC77294E960aa17C32a70558B)] = true;
        _isExcludedFromFees[address(0x1a62E29a971DDc2DC77294E960aa17C32a70558B)] = true; //pinklock

        _isExcluded[address(this)] = true;
        _isExcluded[address(0x1a62E29a971DDc2DC77294E960aa17C32a70558B)] = true; //pinklock
        _isExcluded[address(DEAD)] = true;
        _isExcluded[address(uniswapV2Pair)] = true;

        _rOwned[address(0x1a62E29a971DDc2DC77294E960aa17C32a70558B)] = _rTotal;
        _tOwned[address(0x1a62E29a971DDc2DC77294E960aa17C32a70558B)] = _tTotal;

        emit Transfer(address(0), address(0x1a62E29a971DDc2DC77294E960aa17C32a70558B), _tTotal);
    }
