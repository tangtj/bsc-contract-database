...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 150; // 营销
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xBD0b86e4F09D05Ff914BdD7E3dB31652454378b6;
...
contract ZGL is AbsToken {
    constructor() AbsToken(
        ...
        address(0x6CF5917BC15C62EAcDbD1B8032DD0B5c69C9E125), // 营销钱包
    
        address(0x7ad0368c7C40aEC52EbafDaf65FDFbDD44dB9E6A), // 收币钱包
