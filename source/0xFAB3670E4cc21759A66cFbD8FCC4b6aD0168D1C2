...
/*
/**
Telegram group https://t.me/XBTCOINCN
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9212E1F5C1f4643b8B3a681a65c9DbD130dC13A3;
...
contract xbt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XBT";
    string private _symbol = "XBT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9212E1F5C1f4643b8B3a681a65c9DbD130dC13A3);
    address payable public teamWalletAddress = payable(0x9212E1F5C1f4643b8B3a681a65c9DbD130dC13A3);
    ...
    uint256 public _maxTxAmount = 10000000 * 10**_decimals; //2%
    uint256 public _walletMax = 10000000 * 10**_decimals; //2%
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Router mainet
        // (0xD99D1c33F9fC3444f8101754aBC46c52416550D1) Router testnet
