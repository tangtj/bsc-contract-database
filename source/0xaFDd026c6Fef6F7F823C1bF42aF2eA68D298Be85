/**
Telegram : https://t.me/ZeriumPortal
Website :https://zerium.co
*/
...
contract ZERIUM is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2952E7D895C69DB96Fe67f4e0e9Ab0BB286cE438); 
    address payable private Wallet_Dev = payable(0x2952E7D895C69DB96Fe67f4e0e9Ab0BB286cE438);
    ...
    string private constant _name = "Zerium "; 
    string private constant _symbol = unicode"ZERIUM"; 
    ...
    constructor () {
        ...
        _owner = 0x2952E7D895C69DB96Fe67f4e0e9Ab0BB286cE438;
