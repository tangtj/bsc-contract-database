...
contract Televerse is Context, IERC20, Ownable {
    ...
    uint256 private maxTxAmountBuy = _tTotal / 50; // 2% of supply
    uint256 private maxTxAmountSell = _tTotal / 50; // 2% of supply
    uint256 private maxWalletAmount = _tTotal / 50; // 2% of supply
    ...
    string private constant _name = "Televerse";
