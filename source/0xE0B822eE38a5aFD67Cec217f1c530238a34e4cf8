...
contract LAYERFTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public dmmvbb7;
    ...
    string private _tokenname = "LayerFlow";
    string private _tokensymbol = "LAYERF";
