...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1ada56704ba5760EBF118B44364BE1b0807D4c9a; // owner address
...
contract DX is Context, IERC20, Ownable {
    ...
    string private _name = "DATA-X";
    string private _symbol = "DX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb88440f25c6e987D596432b5572754eB98AEd4C9); 
    address payable public teamWalletAddress = payable(0xb88440f25c6e987D596432b5572754eB98AEd4C9);
