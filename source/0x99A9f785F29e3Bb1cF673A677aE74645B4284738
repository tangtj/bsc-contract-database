/**
⭐️Introducing STARSHIP PEPE, the revolutionary meme coin that defies boundaries and takes you on an interstellar journey! Experience unmatched utility with staking, yield farming, vaults, contact creation, shill to earn opportunities and charity initiatives. 💰
...
contract StarshipPepe is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x8c69daE51Ca629a4A5178E002e604D34392F0350;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x670d6Eb4007FCA0FdC95674ff05586EEfef6DADC;
