...
contract NIOCTIB is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x3D5F3eE54cD0A0396c48C99afF38718923F17d74);
    address payable private DevelopmentWalletAddress = payable(0x3D5F3eE54cD0A0396c48C99afF38718923F17d74);
    ...
    uint256 private _totalSupply = 260000000 * 10**9;
    uint256 public _maxTxAmount = 5200000 * 10**9;
    uint256 public _walletMax = 5200000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 260000 * 10**9; 
