// TG:  https://t.me/BURNXOFFICIAL
// Website: https://BurnXbsc.Space
// TWITTER: https://twitter.com/BURNXbsc
...
contract BURNX is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x92e643518f5F5b9789db3040f60b941695c343D9;

    string private constant _name = "BURN X";
    string private constant _symbol = "$BURNX";
    ...
    // Owner cannot transfer out  BURNX from this smart contract
