...
contract FUCEK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUCEK";
    string private _symbol = "$FUCEK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6cAdb370dBa5862035280e916aa86CC14798Dc90);
    address payable private DevelopmentWalletAddress = payable(0x6cAdb370dBa5862035280e916aa86CC14798Dc90);
