...
interface IDEXRouter {
    ...
    contract ShillX is IBEP20, Auth {
    ...
    string constant _name = "ShillX";
    string constant _symbol = "ShillX";
    ...
    address public marketingFeeReceiver = 0x0cD63F20b68DbcBaD5B427Cf8E837dFC55Eeeeff;
    address public devFeeReceiver = 0x43e9A5Cb6e17f96A4696426113d54B0d0abB1665;
