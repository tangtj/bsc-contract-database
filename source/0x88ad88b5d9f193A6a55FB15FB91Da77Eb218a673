/**
https://t.me/FineSmurf
https://twitter.com/finesmurfbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA5230C6C423a0E2586AbD3a0F9d69e1B7d5A86d0; 
...
contract FINESMURF is Context, IERC20, Ownable {
    ...
    string private _name = "FINE SMURF";
    string private _symbol = "FINESMURF";
