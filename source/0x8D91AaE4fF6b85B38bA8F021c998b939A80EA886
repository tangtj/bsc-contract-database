...
contract PepeChina is Context, IBEP20, Ownable {
    ...
    address public TeamAddress = 0xabC42496a9917aF71C76cc9deCEaB7c935799651;

    string private constant _name = "Pepe China";
    string private constant _symbol = "$PeChi";
