...
*/
/**
// Telegram : https://t.me/Paypaldogebsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35a883A2211c0c08b8C879555B3cB67567552b09 ; // owner address
...
contract PaypalDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "PaypalDoge";
    string private _symbol = "PaypalDoge";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6709647a4049E3984295c3E4F247c7CeB0a872e8); // Marketing Address
    address payable private teamWalletAddress = payable(0x190A27628FD31403E0Ded36989f93bc6182f265f); // Team Address
