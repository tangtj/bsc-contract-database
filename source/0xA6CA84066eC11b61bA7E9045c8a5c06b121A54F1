...
contract PiNetworkcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PiNetworkcoin";
    string private _symbol = "PiNetworkcoin";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xA23e1D36E603d216BcE081e3911E2920C008BFE0); // Marketing Address
    address payable public teamWalletAddress = payable(0xA23e1D36E603d216BcE081e3911E2920C008BFE0); // Team Address
