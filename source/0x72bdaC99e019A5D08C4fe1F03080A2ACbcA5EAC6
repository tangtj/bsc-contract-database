...
contract ATC is ERC20 {
    ...
    address _KOLAddress = address(0xa12323C94DFb5BFc5F23C44ab22F1A4Ac5e45e92);
    address _fundAddress = address(0xA870224AA82478028E9D65cE028E131A2459e54A);
    ...
    constructor(address tokenOwner) ERC20("ATC", "ATC") {
        require(_baseToken < address(this),"ATC small");
