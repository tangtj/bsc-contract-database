...
contract TheKeyGame is Context, IERC20, Ownable {
    ...
    string private constant _name = "TheKeyGame"; // 
    string private constant _symbol = "TKG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x8476D7Cc9b74593cFc79Caf449EBC2A2EbbA2337;
