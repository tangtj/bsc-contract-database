...
https://t.me/SafeMoon0X

https://twitter.com/0XSFM
...
contract SFMX is ERC20, Ownable {
    ...
    constructor() payable ERC20 ("SafeMoon X", "SFMX") {
        ...
        marketingWallet =  0x93AA8C8f6Ab32C39AF14c2acfDc20BF5D85Ab258;

        dividendTracker = new DividendTracker(1000000000000, rewardToken);
        ...
        _isWalletExcluded[0x93AA8C8f6Ab32C39AF14c2acfDc20BF5D85Ab258] = true;
        _isWalletExcluded[0xC452B670B360F969Cd9B76792312CdF4acC81327] = true;
    
        _mint(owner(), 1000000000000 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000000 * 369;
    }
