...
contract turkiyekriptoprotokolu is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = unicode"türkiye kripto protokolü🇹🇷";
    string constant _symbol = unicode"kripto protokolü🇹🇷"; 
    ...
    uint256 private buyTotalFee = buyDevFee + buyFee + buyLiqFee;

    //Sell Fees Variables
    uint256 private DevFee = 0;
    uint256 private MarktFee = 3;
    uint256 private LiqFee = 0;
    uint256 private Total = DevFee + MarktFee + LiqFee;
    ...
    // Fees Receivers
    address public developerFeeReceiver = 0x7454979457F56b16BF14DCFF692c0fA187710a34;
    address public marketingFeeReceiver = 0x7454979457F56b16BF14DCFF692c0fA187710a34;
    address public liquidityFeeReceiver = 0x7454979457F56b16BF14DCFF692c0fA187710a34;
    ...
    function buyFees() internal {
        ...
        marketingFee = buyFee;
        liquidityFee = buyLiqFee;
        totalFee = buyTotalFee;
    }

    function sellFees() internal{
        developerFee = DevFee;
        marketingFee = MarktFee;
        liquidityFee = LiqFee;
        totalFee = Total;
    }
    ...
    function takeFee(uint256 amount) internal view returns (uint256) {        
        uint256 feeAmount = block.number <= (genBlock + deadline) ?  amount / 100 * 99 : amount / 100 * totalFee;
    ...
    function setBuyFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        buyTotalFee = buyDevFee + buyFee + buyFee;
    ...
    function setSellFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        DevFee = _devFee;
        MarktFee = _marketingFee;
        LiqFee = _liquidityFee;
        Total = DevFee + MarktFee + LiqFee;
