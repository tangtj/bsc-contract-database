...
https://t.me/XwitterCoinOfficial
*/
...
contract XWITTER  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("XWITTER COIN", "XWITTER") {
        ...
        marketingWallet = address(0x8c637A4E512C13D6435D8b49907eD40292c2a982); // set as marketing wallet
        devWallet = address(0x8c637A4E512C13D6435D8b49907eD40292c2a982); // set as dev wallet
