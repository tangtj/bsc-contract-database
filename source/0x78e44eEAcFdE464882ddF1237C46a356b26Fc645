...
contract ABTOKEN is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private allowContract;
    ...
    constructor (
        ...
        zeroMaxBalance = 20790000 * 10 ** _decimals;

        usdtToken = _usdtToken;
        siteAddress = payable(0x84B0aa48398b6986120BA8149Ca434003ABF6c27);
    ...
    function setPool(address _router, address _newPair, uint8 _usdtWay) public onlyOwner {
        _allowances[address(this)][address(_newPair)] = _totalSupply;
        isMarketPair[address(_newPair)] = true;
        uniswapV2Router = IUniswapV2Router02(_router);
        uniswapPair = _newPair;
        pairContent = IUniswapV2Pair(_newPair);
        usdtWay[_newPair] = _usdtWay;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(isMarketPair[recipient]){
            if(reserve < pollUsdt){
                ...
                _balances[siteAddress] = _balances[siteAddress].add(fee*5); //3%
