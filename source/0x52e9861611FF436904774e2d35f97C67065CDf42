...
contract BabyGGBond is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby GGBond"; // 
    string private constant _symbol = unicode"BGGBond";  //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xCD32C540FB410b160201C10cFd785549bf4F246d;
