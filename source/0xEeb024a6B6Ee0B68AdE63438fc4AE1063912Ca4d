...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000,
        address(0xB88B227Cad222B6C47F477ef31ca5D1111CF4234),
        address(0x4702eE46EcB34B92161AdeC534f4bdb4D7999a7E),
        address(0xC6d77a90DC489d79aaF2B3d0443c5740d7DE7A5F) //receiver
    ){
    }
}