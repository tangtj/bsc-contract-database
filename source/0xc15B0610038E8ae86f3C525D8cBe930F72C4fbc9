...
contract SpongeBaby is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 10000000000000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 10000000000000000 * 10 ** 9;
    ...
    constructor() ERC20("SpongeBaby", "SpongeBaby") {
        addressForMarketing =address(0x5D867FbAEeFEeF57d54B3c6ACDBDb89F6a9A5E90);
