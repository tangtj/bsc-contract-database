...
//Telegram: https://t.me/SatoshiFrogomoto
//Website: https://satoshifrogomoto.static.domains/

// In a curious experiment, Satoshi Nakamoto, the mysterious creator of Bitcoin,
// decided to explore the realms of LSD, seeking enlightenment
// As the psychedelic trip unfolded, reality melted away,
// and he found himself transforming into a frog.
...
contract $PEPE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Satoshi Frogomoto";
    string private _symbol = unicode"$PEPE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x1A543f5d117729884BAD34E125F6090f3bCe0009);
    address payable private taxWallet2 = payable(0x1A543f5d117729884BAD34E125F6090f3bCe0009);
    ...
    uint256 private _totalSupply = 69_420_000_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*69420000000/69420000000;
    uint256 public _walletMax = _totalSupply*69420000000/69420000000;
    uint256 private minimumTokensBeforeSwap = _totalSupply*69420000/69420000000; 
