...
//Contract
contract NanoBinanceDog is IBEP20, Ownable {
    ...
    string private constant _name = 'Nano Binance Dog';  
    string private constant _symbol = 'NBINANCEDOG';    
