...
contract MiniYooshi is IERC20, Auth {
    ...
    string private constant  _name = "MiniYooshi";
    string private constant _symbol = "MiniYooshi";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 1000000000000 * (10 ** _decimals);
    //max wallet holding of 0.5% 
    uint256 public _maxTokenPerWallet = ( _totalSupply * 5 ) / 1000;
    ...
    uint256 public addLiquidPercent = 33;
    uint256 public buyFeeRate = 8;
    uint256 public sellFeeRate = 10;

    uint256 private feeDenominator = 100;

    address payable public marketingWallet = payable(0x50857465C9E19e40A6e711Bc667FF52FB519d9b1);
    address payable public devWallet = payable(0x58C989AcF7c404261b1F5162fE70B9C23a9AA126);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(enableSwapFee){
            ...
            uint256 _tokensForLP = numTokensSellToAddToLiquidity * addLiquidPercent / 100;
            ...
            if(shouldSwapBack){ 
                ...
                swapBack(numTokensSellToAddToLiquidity, address(this));
                uint256 _ethSwapped = address(this).balance - _ethPreSwap;
                if ( enableAddLiquid && addLiquidPercent > 0 ) {
                    uint256 _ethWeiAmount = _ethSwapped * addLiquidPercent / 100;
    ...
    function setFee (uint256 _sellFeeRate, uint256 _buyFeeRate, uint256 _addLiquidPercent) external onlyOwner {
        require (_sellFeeRate <= 25, "Fee can't exceed 25%");
        sellFeeRate = _sellFeeRate;
        buyFeeRate = _buyFeeRate;
        addLiquidPercent = _addLiquidPercent;
    }
