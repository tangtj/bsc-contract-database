...
contract XMSS is Operator {
    ...
    string private _name = "XMSS";//#币名
    string private _symbol = "XMSS";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x7EE6c8a4c4f22C1cA0001f1afdb016e893CC060C),true);
    }
