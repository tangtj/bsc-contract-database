...
contract MashiroInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MashiroInu";
    string private _symbol = "MASHINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0494F2cB148C7cD9C5b2BDDc79416ae27E8D9705); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7688841408b8708c88BB08f61F5CC9544EaC5167); // BuyBack Address
