...
contract Nami is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 100000000000000 * 10**_decimals;

    address public marketingAddress = 0xdb8FD33A7afc24E4c8AE69DC5A7789275cBb8674;
    address public devAddress = 0xdb8FD33A7afc24E4c8AE69DC5A7789275cBb8674;

    string private constant _name = "NAMi";
    ...
    Taxes public taxes = Taxes(3,0,6,1);
    Taxes public sellTaxes = Taxes(3,1,6,1);
