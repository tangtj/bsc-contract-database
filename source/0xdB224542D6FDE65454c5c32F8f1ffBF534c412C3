...
contract Viraltoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Viral token";
    string private constant _symbol = "VIRAL";
    ...
    address payable private _twddev = payable(0x630941a3dbD83a630466B20F23F262f7Bb96Fb47);
    address payable private _twdmkt = payable(0x630941a3dbD83a630466B20F23F262f7Bb96Fb47);
