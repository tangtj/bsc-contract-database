...
Telegram Chat: https://t.me/Billionaireheist
...
contract Billionaireheist is Context, IERC20, Ownable {
    ...
    string private constant _name = "BILLIONAIRE HEIST"; //
    string private constant _symbol = "$BH "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x0619658Ea85a51cDb2C3C63BdC9bFd93c4AB0a3a ;
