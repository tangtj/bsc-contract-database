// https://t.me/CaspervsPepeBSC
// https://twitter.com/caspervspepe
// https://caspervspepe.online/
...
contract Casper is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Casper VS PEPE";
    string private constant _symbol = unicode"$CvsP";
