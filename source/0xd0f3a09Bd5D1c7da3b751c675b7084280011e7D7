...
contract ROCK is Context, IERC20, Ownable {
    ...
    string private _name = "Rock";
    string private _symbol = "Rk";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5ED50FAc849D6Dc3EDbABE5CE59357417a1A2a71);
    address payable public teamWalletAddress = payable(0x5ED50FAc849D6Dc3EDbABE5CE59357417a1A2a71);
