/**
// https://t.me/BANANATWOPOINTZERO
// https://twitter.com/Ban2
// https://Bananatwozero.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1bf07Dcc6850F7ED22841F05e92e53D87e530B75; // owner address
...
contract BANANATWOPOINTZERO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Banana 2.0";
    string private _symbol = "$BANANA2";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1bf07Dcc6850F7ED22841F05e92e53D87e530B75); // Marketing Address
    address payable private teamWalletAddress = payable(0x1bf07Dcc6850F7ED22841F05e92e53D87e530B75); // Team Address
