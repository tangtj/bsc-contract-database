...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x23fe50428EC6A9685798fE723148FAd0E074c9D0);
    address public fundAddress1 = address(0x0475eAF53898a30e498F93da642e6C26bEBc6173);
    string private _name = "1111";
    string private _symbol = "1111";
    ...
    uint256 private _tTotal = 1111 * 10 ** _decimals;
    uint256 public maxWalletAmount = 1 * 1 ** _decimals;
