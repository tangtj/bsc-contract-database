...
// Telegram: https://t.me/whyiwinuoylose
...
contract Whyulose is Context, IERC20, Ownable {
    ...
    string private constant _name = "WIN WHY LOSE";
    string private constant _symbol = "WWL";
