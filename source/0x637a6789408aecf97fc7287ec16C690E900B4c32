...
contract Relitefinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Relite Finance";
    string private _symbol = "$RELI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x204cFD337BD8Dd9f168C694f6b25BaB9D8e7cF63); // Marketing Address
    address payable public teamWalletAddress = payable(0x204cFD337BD8Dd9f168C694f6b25BaB9D8e7cF63); // Team Address
