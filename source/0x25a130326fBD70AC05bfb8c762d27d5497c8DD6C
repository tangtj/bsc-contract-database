...
contract NfitiGaleriaMetaToken is IERC20 {
    ...
    uint256 constant private startingSupply = 90_000_000;
    string constant private _name = "Nfiti Galeria Meta Token";
    string constant private _symbol = "NGMT";
    ...
    address public marketingWallet = payable(0xEABDeA0c78d5FbF71F5fb6d85805BE04774dfEAc);
...
//===============================================================================================================
    ...
    function setTaxes(uint16 sellFee, uint16 transferFee) external onlyOwner {
