/**
 *8% BUSD Rewards
 *Community Driven + Renounce Ownership
 *Telegram : https://t.me/AestroidBonk
*/
...
contract AesteroidBonk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xc11cEbFA26F1c75413169eDAc2c3BCf0D6f8A4aD;
 
    string constant _name = "AesteroidBonk";
