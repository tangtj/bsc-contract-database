...
/**
https://t.me/arubachainxyz
https://arubachain.xyz/
*/
...
contract ArubaChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArubaChain";
    string private _symbol = "ARC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x108b8fB56EC0f09955e2B9e9AAc8a11f824B31b7); // Marketing Address
    address payable public teamWalletAddress = payable(0x4fcdce1742E5B741d8F32acd54A037458f37b178); // Team Address
