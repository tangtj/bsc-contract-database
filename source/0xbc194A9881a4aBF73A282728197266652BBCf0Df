/**
ULXFwc
NEW COMMUNITY BSC OLD SCHOOL 💩    


Make ULXFwc and Hay work as One.
✅ Low Marketcap Gem
❇️ NFA DYOR
...
🗺 Clear Roadmap
💯 SAFU
📄Contract Address : BSC SOON 0xbc194a9881a4abf73a282728197266652bbcf0df
...
contract ULXFwc is ULXFwcDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ULXFwcTeam;
    address private CharityULXFwc;
    ...
    string public override name = "ULXFwc";
    string public override symbol = "ULXFwc";
    ...
    constructor(uint totalSupplyValue, address ULXFwcTeamAddress, address CharityULXFwcAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ULXFwcTeam = ULXFwcTeamAddress;
        CharityULXFwc = CharityULXFwcAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ULXFwcTeam] =  totalSupply * 4 / 100;
        balances[CharityULXFwc] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ULXFwcTeam pot
