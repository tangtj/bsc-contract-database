...
contract Bird is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8a1eaa8aeedDEff16A107C51e341948BA3d1d621);
    address payable public teamWalletAddress = payable(0x3f6958d962Db67a1EE5E2699B22c7DB49A3Dd769);
    ...
    uint256 private _totalSupply =  35000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   35000000000000 * 10**_decimals;     
    uint256 public _walletMax =     1500000000000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 2000000000000 * 10**_decimals; 
