...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC08C874388671CE80E2e9899b5c8fa388d4F7279;
...
contract Sei is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2a5CCeF430f657349bFC9dC4D7409a01c8f97147;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Sei New Launch";
    string private _symbol = "Sei";
