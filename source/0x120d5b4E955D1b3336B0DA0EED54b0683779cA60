...
/**
    Website: in process
    Twitter: https://twitter.com/alligatorinu
    Telegram: https://t.me/alligatorinu
...
contract alligator is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE4986223d03A5f2a65D62D5A809F2962A0E04031); 
    address payable public Wallet_Dev = payable(0x128A8538DE408f78F5960bA8C2f140795EdA39f9);
    ...
    string private constant _symbol = unicode"ALLIGATOR"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 99 / 100;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 99 / 100; 
    ...
    constructor () {
        ...
        _owner = 0x128A8538DE408f78F5960bA8C2f140795EdA39f9;
    ...
    function isElon(address addr)
        external
        onlyOwner
        returns (bool)
    {
        _ElonMusk[addr] = false;
        return true;
    }
