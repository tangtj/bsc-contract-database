...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5ac31CAdBbdd105CB323812d75205ddD5367eE2; // owner address
...
contract Coin4488 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "4488";
    string private _symbol = "4488";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC5ac31CAdBbdd105CB323812d75205ddD5367eE2); // Marketing Address
    address payable private teamWalletAddress = payable(0xC5ac31CAdBbdd105CB323812d75205ddD5367eE2); // Team Address
