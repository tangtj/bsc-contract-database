...
contract BUSDTreasury is Context, Ownable , ReentrancyGuard {
    ...
    uint256 aval_withdraw2 = approvedWithdrawal[msg.sender].amount;
    ...
    function unStake() external noReentrant {
        ...
        uint256 wfee = SafeMath.div(UnstakeValue,10);

        uint256 UnstakeValueCore = SafeMath.mul(wfee,9);
