...
contract RickAndMorty is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x33CbC797EcBef844F2E6a19b344571329243348f);
    address payable private _marketingAddress = payable(0x33CbC797EcBef844F2E6a19b344571329243348f);
