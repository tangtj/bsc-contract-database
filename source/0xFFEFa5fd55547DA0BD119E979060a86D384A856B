...
contract Eternitybabygame is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x56e0B5B5758AeDa2e2116b5fabb39ed7F4C9DB64;

    string private constant _name = "Eternitybabygame";
    string private constant _symbol = "Eternitybaby";
    ...
    Taxes public taxes = Taxes(2,16,5,2);
