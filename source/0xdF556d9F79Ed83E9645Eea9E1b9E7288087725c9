...
contract Moneywhales is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MoneywhalesDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Moneywhales", "Mws") {
        marketingWallet = payable(0x0a37927908ab330EBD8E7c9721c979Aa20B15E75);
        devWallet = payable(0x0b547576f9F0d4DB7B8e09d1871237CAacE30E61);
        ...
        dividendTracker = new MoneywhalesDividendTracker(
            payable(this),
            router,
...
contract MoneywhalesDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Moneywhales public MoneywhalesContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MoneywhalesContract = Moneywhales(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Moneywhales_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Moneywhales_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Fish contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MoneywhalesContract);

            uint256 prevBalance = MoneywhalesContract.balanceOf(address(this));
            ...
            {
                uint256 received = MoneywhalesContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MoneywhalesContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
