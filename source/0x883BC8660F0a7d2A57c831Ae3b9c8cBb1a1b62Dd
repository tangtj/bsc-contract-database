...
contract MUSKvsZUCK is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x019fCF6D577a51F3E9B6Ac9a94cAe770FDec42dC); 
    address payable private teamWalletAddress = payable(0x019fCF6D577a51F3E9B6Ac9a94cAe770FDec42dC); 
