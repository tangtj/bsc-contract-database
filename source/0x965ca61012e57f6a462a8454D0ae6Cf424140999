...
contract BullAi is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2d31E0b29F24958120ec5eAf1442878135BcB8e1; //
  ...
  _approve(_msgSender(), spender, currentAllowance - subtractedValue);
    ...
    function _getTValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory s) {
        ...
        s.tMarketing = tAmount*taxes.marketing/500;
        s.tLiquidity = tAmount*taxes.liquidity/200;
