...
//Telegram:https://t.me/PepeDanceBsc

//Twitter:https://twitter.com/NewPepeDance
interface IERC20 {
...
contract PEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x28961a85B0BdC8b7f715D140946Da0f4522d6E64); 
    address payable public Wallet_Dev = payable(0x28961a85B0BdC8b7f715D140946Da0f4522d6E64);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =4200000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "PEPE DANCE"; 
