...
contract Farm {
    ...
    uint256 constant public XMM_DOGE_RATE = 69; // 1,000,000 XMM paying interest 69 DOGE per day
    uint256 constant public XMM_SHIB_RATE = 500000;
    uint256 constant public XMM_FLOKI_RATE = 200000;
    ...
    function depositTokens(uint256 _amount) external {
        ...
        userLastDepositTime[msg.sender] = block.timestamp; // Reset last deposit time
    ...
    function withdrawTokens(uint256 _amount) external {
        ...
        userDeposits[msg.sender] -= _amount;
        userLastClaimTime[msg.sender] = block.timestamp; // Reset last claim time
    ...
    function claimEarnings() public {
        ...
        userLastEarningAmount[msg.sender] = 0; // Reset earning amount
   ...
   function getTokenAddressByFarm(FarmType _farmType) internal view returns (address) {
    ...
    // View user's running profit per second
