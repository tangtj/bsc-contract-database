...
contract BOBOTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ekkajjh3;
    ...
    string private _tokenname = "Bobo Inu";
    string private _tokensymbol = "BOBO";
