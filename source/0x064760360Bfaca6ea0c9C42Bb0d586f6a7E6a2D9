...
contract KNOWN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x845aD8b66F9750e322fD82265DB950C03c641D20); 
    address payable public Wallet_Dev = payable(0x845aD8b66F9750e322fD82265DB950C03c641D20);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1 * 9**5* 9**5 * 9**_decimals;
    string private constant _name = "KNOWN"; 
    string private constant _symbol = unicode"KNWT"; 
    ...
    constructor () {
        _owner =0x1880e474b8BFc47AE8d359CF897C63dBf7065caC;
