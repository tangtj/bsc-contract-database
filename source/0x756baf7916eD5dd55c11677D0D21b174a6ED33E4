...
contract cEshi is Context, IERC20 { 
    ...
    string private constant _name = "ceshi2.0"; 
    string private constant _symbol = unicode"ceshi2.0"; 
    ...
    constructor () {
        ...
        _owner = 0x2D0F11a31fd41b9C39DE5313980f8d2a91D1D19a;
