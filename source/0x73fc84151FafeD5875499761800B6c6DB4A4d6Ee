...
//Reward Token :0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c (wbnb)
...
contract bnbxpro is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "bnbxpro";
    string constant _symbol = "bnbxpro";
    ...
    uint256 public marketingFee = 22;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xDCe61e447430fA97CFD1df7DC5EC92070d83512f; //LP wallet
        marketingWallet = 0x4bd082544917b88a73fC58cAAF33338b4b29f58a;  //marketingwallet
