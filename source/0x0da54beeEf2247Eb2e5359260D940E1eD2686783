...
contract Shitarium is Context, IERC20, Ownable {
    ...
    string private _symbol = "Shitarium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a1295C136d3051da0581752Cd8f8DE627703169); 
    address payable public teamWalletAddress = payable(0x905d875f1A904c379cF0547e0702c8Fb17Ea6Ee5);
