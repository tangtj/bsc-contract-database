...
contract BABYRevalinkWalletToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY Revalink Wallet Token";
    string private _symbol = "BABYREVA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x55Ba49e9D14d01487edC6327fAb33Ba193CE9D39);
    address payable private DevelopmentWalletAddress = payable(0x55Ba49e9D14d01487edC6327fAb33Ba193CE9D39);
    ...
    uint256 public _walletMax = 500000 * 10**9;
