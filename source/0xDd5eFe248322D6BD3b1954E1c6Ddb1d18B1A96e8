...
contract ArtOfWar is Context, IERC20, Ownable {
    ...
    string private _name = "Art of War";
    string private _symbol = "$AOW";
    ...
    address public _marketingAndTeam = 0x77D02641e52584926f44cc1bc18b17DF2B08A5b2;
    address public _gameFundAddress = 0x4371ABAc98bAC44Eeb71f5d56211DB70c083b99c;
