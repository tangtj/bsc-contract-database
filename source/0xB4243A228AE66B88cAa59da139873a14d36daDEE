...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59838A7916D0e8e678Db542E7085fdCc1a89FC7C; // owner address
...
contract Exoreum is Context, IERC20, Ownable {
    ...
    string private _name = "Exoreum";
    string private _symbol = "Exo";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x59838A7916D0e8e678Db542E7085fdCc1a89FC7C); // Marketing Address
    address payable private teamWalletAddress = payable(0x59838A7916D0e8e678Db542E7085fdCc1a89FC7C); // Team Address
