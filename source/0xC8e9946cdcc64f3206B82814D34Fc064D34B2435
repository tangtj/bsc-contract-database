...
contract  TokenSalePlatform  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = unicode"TokenSalePlatform";
    string private _symbol = unicode"$TSP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33cD1b190d172d827090DFb3FA24e8207A8E84F5); 
    address payable public teamWalletAddress = payable(0x62a5511bCA8117d064951d8D4643fE84747d2C39); 
