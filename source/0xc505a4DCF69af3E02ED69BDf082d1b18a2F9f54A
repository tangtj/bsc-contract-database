/**
// Telegram : https://t.me/friendtechinu
*/
...
contract Friendtechinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "friend Tech inu";
    string private _symbol = "Ftinu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x54Fd2cB5D23EAf7a823D31Fc8e586425Fe2988A4); // Marketing Address
    address payable private teamWalletAddress = payable(0x868C20493C0cB38f59A3eE72537dcE3cdD5c9e9e); // Team Address
