...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x6A19ee40677FebA044DA14b20dac1dc639653858;
...
contract Sonik is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Sonik", "SONIK", 9) {
    _owner = msg.sender;
