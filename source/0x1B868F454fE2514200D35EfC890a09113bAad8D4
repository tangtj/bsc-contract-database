...
contract TMNT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x86475419506590a14bD7362372E6DeB849e45c7d); // Marketing Address
        
    address payable public teamAddress =
        payable(0x86475419506590a14bD7362372E6DeB849e45c7d); // Team Address
        
    address payable public liquidityAddress =
        payable(0x86475419506590a14bD7362372E6DeB849e45c7d); // Liquidity Address
    ...
    string private constant _name = "TMNT";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 70 / 1000; 
        maxWallet = _tTotal * 70 / 1000; 
