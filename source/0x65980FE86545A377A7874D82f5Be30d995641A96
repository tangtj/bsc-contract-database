...
contract SpaceMan is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Space Man";
    string private _symbol = unicode"$SPACEMAN";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xF1B9264Ec077A36Ab76e60F0007c514157428a08);
    address payable private taxWallet2 = payable(0xF1B9264Ec077A36Ab76e60F0007c514157428a08);
