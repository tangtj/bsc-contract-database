...
contract Paranium is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb5E188c363EeA78923436c2c8a5bddeCd20b32B3); // Marketing Address
    address payable public teamWalletAddress = payable(0xb5E188c363EeA78923436c2c8a5bddeCd20b32B3); // Team Address
