...
// Telegram https://t.me/FRIEDTECHBSC 
...
contract FriedTECH is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x97F3753f52B1CdD8FAbB85d2382170c2aB6C307C);
    address payable private _twdmkt = payable(0x97F3753f52B1CdD8FAbB85d2382170c2aB6C307C);
    
    string private constant _name = "FRIED RICE TECH BSC";
    string private constant _symbol = "$FriedTech";
