...
contract McDonalds is Context, IBEP20, Ownable {
    ...
    address public marketingAddress = 0xB9281fDF869AbDD486a113179E778e33847A32AC;
    address public TeamAddress = 0x13eECc36642bFE8CE3F85f65420B0cd6D155a021;
    ...
    Taxes public Buytaxes = Taxes(1,1,1,2);
    Taxes public sellTaxes = Taxes(1,1,1,2);
