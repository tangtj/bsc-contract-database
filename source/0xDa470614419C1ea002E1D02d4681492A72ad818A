...
interface IERC20 {
     ...
     * Initial supply 42,000,000 : 21,000,000 total supply. 21,000,000 was inmedaitly burned for safety.
     ...
     * it's the best part of the #SZL idea, increasing the liquidity pool automatically when you're foolish enough to step out., 
...
contract SchnitZeLcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "SchnitZeLcoin";
