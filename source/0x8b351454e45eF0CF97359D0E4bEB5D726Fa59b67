...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCd5918aEd0e89e9871005cf376c609B9afC9d79B; // owner address
...
contract ONEPIECE is Context, IERC20, Ownable {
    ...
    string private _symbol = "GOMU GOMU NO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6A56913Da0850602B39611E5C52ac4CECe04B5a9); // Marketing Address
    address payable private teamWalletAddress = payable(0x6A56913Da0850602B39611E5C52ac4CECe04B5a9); // Team Address
