...
contract test is IBEP20, Ownable {
    ...
    uint256 public maxWalletBalance = 30000 * _decimalFactor; // 3% of Supply
    uint256 public maxBuyAmount = 30000 * _decimalFactor; // 3% of Supply
    uint256 public maxSellAmount = 30000 * _decimalFactor; // 3% of Supply
