...
contract HexagonToken is Context, IBEP20, Ownable {
  ...
  constructor()  {
        ...
        _symbol = 'HGT';   
        _decimals = 18;
		_totalSupply = 49000 * 10 ** _decimals;
        _maxBurning = 4000 * 10 ** _decimals; 
        maxBuyLimit = 5000 * 10 ** _decimals; 
        maxSellLimit = 5000 * 10 ** _decimals; 
        maxWalletLimit = 5000 * 10 ** _decimals; 
