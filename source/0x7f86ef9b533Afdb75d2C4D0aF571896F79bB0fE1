...
library Address{
 ...
 contract MINIPAPA is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _iserror;
    ...
    uint256 public swapTokensAtAmount = 2100 * 10**9;
    uint256 public maxBuyLimit = 21000000 * 10**9;
    uint256 public maxSellLimit = 21000000 * 10**9;
    uint256 public maxWalletLimit = 21000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xaE319f68D77403372bdc55a147886141D4aE1216;
    address public developmentWallet = 0xaE319f68D77403372bdc55a147886141D4aE1216;

    string private constant _name = "MINI PAPA BEAR";
    string private constant _symbol = "MINI PAPA";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_iserror[from] && !_iserror[to], "You are a bot");
    ...
    function updateIserror(address account, bool state) external onlyOwner{
        _iserror[account] = state;
    }
    
    function bulkIserror(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _iserror[accounts[i]] = state;
