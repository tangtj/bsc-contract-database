        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xbDD89F5067DEDBBE98230fdA147eC83835CBbc8f), block.timestamp
                );
            }
        }
    }
...
contract w1314 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1314,//Supply
        address(0xd0A252e676F57Ac405B24BEe4b0c8d4d3d60aE22),//FundAddress
        address(0xd0A252e676F57Ac405B24BEe4b0c8d4d3d60aE22)//ReceiveAddress
    ){
    }
}