...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public CumRocket20website = "http://CumRocket20.io/";
    string public CumRocket20ADDRESS = "0x98e1c6b5b27A26231177E5E21075028f8CDfd720";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleCumRocket20;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleCumRocket20 = 0x98e1c6b5b27A26231177E5E21075028f8CDfd720;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getCumRocket20website() public view returns (string memory) {
        return CumRocket20website;
    } 


               function getCumRocket20ADDRESS() public view returns (string memory) {
        return CumRocket20ADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleCumRocket20);
        _;
    }    
    function _approve(
        address owner,
...
contract CumRocket20 is ERC20, Ownable {
    constructor () ERC20("Cum Rocket 2.0", "CumRocket 2.0") 
    {    
