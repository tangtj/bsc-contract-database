// https://t.me/SquidBetOfficial

// https://squidbet.wtf

// https://twitter.com/TheSquidBet
...
contract SquidBet is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfCf8675B1fB7Af083dEdD6dd0Fc9e64AB19670e1); 
    address payable public Wallet_Buyback = payable(0x60Ec49c712A7E8B312eD84f1B900f25d298827b8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x6E6310735eB2708bf9A47eaD29d4f4CAB22f8E49); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**_decimals;
    string private constant _name = "SquidBet"; 
    ...
    constructor () {
        ...
        _owner = 0x6E6310735eB2708bf9A47eaD29d4f4CAB22f8E49;
