...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0xd7f3Dbcae22D927BFb2F3EB6B4Bd71C63fDd9df6),
      "Address is invalid"
    );
...
contract  FYMOON is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("FYMOON", "FYMOON")
    ERC20Permit("FYMOON")
    EmergencyDrainable(address(0xd7f3Dbcae22D927BFb2F3EB6B4Bd71C63fDd9df6))
  {
