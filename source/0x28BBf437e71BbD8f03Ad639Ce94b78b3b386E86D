/**
    ...
    TG: https://t.me/akinoburn
    Twitter: https://twitter.com/akinoinuburn
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0xA6F26d53FdB44030b1429252fC1e406c97c89E67; // owner address
...
contract AKIBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AKINO INU BURN";
    string private _symbol = "AKIBURN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1C415368574B040691a21DdABD4f9Ad2Ad4A9c49); // Marketing Address
    address payable private teamWalletAddress = payable(0xA6F26d53FdB44030b1429252fC1e406c97c89E67); // Team Address
