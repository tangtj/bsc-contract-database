/**
CashRulesEverythingAroundMe - CREAM

CREAM is more than just a token; it's a symbol of your financial sovereignty. 
In a world where the financial landscape is evolving rapidly, we empower you to take control of your wealth and destiny. 
Our token is your ticket to a brighter financial future.

Get some CREAM and share it with your friends! A powerful and united community means only one thing: EVERYONE WILL WIN.

Thank you for being with us, enjoy your CREAM!

Join our telegram group chat:
https://t.me/CreamBSC

Also don't forget to follow our twitter:
https://twitter.com/BSC_Cream
...
contract CREAM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CashRulesEverythingAroundMe";
    string private constant _symbol = "CREAM";
    uint8 private constant _decimals = 9;
    
    address public _deadWallet = 0x000000000000000000000000000000000000dEaD;

    address payable private _developmentAddress = payable(0x901d456bc9DED8ff58BFDf776b078009137e5A98);
    address payable private _marketingAddress = payable(0xa90dcDB7965Ff480DE94dcf52d89eA697fb3b479);
