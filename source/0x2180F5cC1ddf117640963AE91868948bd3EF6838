...
contract AscensionArcade is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x86635CA510bEabCF962eCF3c9e7319b0c35eBa0E);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xb40cF23f385e40837E34190c0Bb148598f7414D4); 
