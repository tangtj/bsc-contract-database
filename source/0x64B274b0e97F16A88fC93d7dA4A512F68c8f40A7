...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0x62a69190630ED2B4473210F864473Ec42A27DE68),
      "Address is invalid"
    );
...
contract  TOKENAPEPE is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("APEPE", "APEPE")
    ERC20Permit("APEPE")
    EmergencyDrainable(address(0x62a69190630ED2B4473210F864473Ec42A27DE68))
  {
