...
contract Cryptodays is IBEP20, Auth {
    ...
    string constant _name = "Cryptodays";
    string constant _symbol = "CRYPT";
    uint8 constant _decimals = 9;

    uint256 _tTotal = 100000000 * (10 ** _decimals);
    ...
    address public MarketingWallet = 0xC84dA957F8F70456a1bf9dFd503fDDaF2570D7fa;
    address public devFeeReceiver = 0x33613DE3dfa16C8B4eC8360928984cd63E37dA6c;
