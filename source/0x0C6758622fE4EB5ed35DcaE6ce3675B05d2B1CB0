...
contract Shez is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xffEc3BF5dDBd8e34c57cD1F592A167b66d94e523);
    ...
    string private _name = "Shez"; 
    string private _symbol = "Shez";  
    uint8 private _decimals = 9;
     uint256 private _tTotal = 5000000000 * 10 ** decimals(); 
