...
contract Dinozoo is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x03EfFb7ccBcE85f9a9F823269494618a11C3983a);
    address payable private _twdmkt = payable(0x03EfFb7ccBcE85f9a9F823269494618a11C3983a);
    
    string private constant _name = "DINOZOO";
    string private constant _symbol = "DINOZOO";
