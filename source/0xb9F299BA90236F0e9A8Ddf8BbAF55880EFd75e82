...
contract PomPom is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEA06Ede03eEE04C955686b96991443965eeCab74); 
    address payable public Wallet_Dev = payable(0xEA06Ede03eEE04C955686b96991443965eeCab74);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Pom Pom"; 
    string private constant _symbol = unicode"$POMPOM"; 
    ...
    constructor () {
        _owner =0xec8A87BdFaf592b0BcFe3f8106A5A38B71829513;
