...
contract OG20TOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 1000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "OG2.0";
    string private _seitokensymbol = "OG2.0";
    address public OG20;
