...
https://twitter.com/Baby_SafePal
11% SafePal / CA Reward: 0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb
*/
...
contract BabySafePal is ERC20, Ownable {
    ...
    mapping (address => bool) private _isBabySafePalExcluded;
    ...
    constructor() payable ERC20 ("Baby SafePal", "BabySFP") {

        rewardToken = 0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb;
        ...
        marketingWallet =  0xaE897792076d35Ed1FCDC52B33DBc8FE4111cFdd;
        ...
        _isWalletExcluded[0xaE897792076d35Ed1FCDC52B33DBc8FE4111cFdd] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 100000 * 11;
    }
