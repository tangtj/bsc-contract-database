...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Eth = IBEP20(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
...
contract ZooshiCash is IBEP20, Auth {
    using SafeMath for uint256;

    address Eth = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "_ZooshiCash";
    string constant _symbol = "ZOOSHICASH";
	...
	uint256 public _maxWalletSize = (_totalSupply * 1) / 100; // 3% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        address _zooshicash = 0x9857a1aC106C953AA05a3491AB304135a38fC32A;
        isFeeExempt[_zooshicash] = true;
        isTxLimitExempt[_zooshicash] = true;
        ...
        _balances[_zooshicash] = _totalSupply;
        emit Transfer(address(0), _zooshicash, _totalSupply);
    }
