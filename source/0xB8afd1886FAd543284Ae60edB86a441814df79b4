/**
Join BigCoin today and become a part of The New Movement for Everyone Past Present and Future.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB3813bda8b9E368fB9Fd9384059560ce6d8231bB; // owner address
...
contract BIGCOIN is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x90E933f33790E3591af7550f67FbFaBBeeB4B900); // Marketing Address
    address payable private teamWalletAddress = payable(0xB3813bda8b9E368fB9Fd9384059560ce6d8231bB); // Team Address
