...
/// @custom:security-contact trumpcoindapp@gmail.com
contract TrumpCoin is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Trump Coin", "TRM") ERC20Permit("Trump Coin") {
