...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x5B244dfd8c108131C54ac2a98a92ce8AfF9aA28d;
...
contract KeTaiCoin is AbsToken {
    constructor() AbsToken(
        ...
        address(0x81B7D544E9354933a7ee852f4CB2daC1024D661f),
    
        address(0x6d0F5a5d9E811924817b82C530FBd4791dD8ae52)
    ){
