/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat FairSatoshi designed.
    
    I make this #FairSatoshi to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/FairSatoshiBSC
   ...
   I will renounce the ownership to burn addresses to transfer #FairSatoshi to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 50% total supply to the pool
   Can you make #FairSatoshi 100000X? 
   
  100% SAFE NO RUG.

   100,000,000,000,000,000 total supply
   500,000,000,000,000 FairSatoshi max limit for per trade
   ...
   it's the best part of the #FairSatoshi idea, increasing the liquidity pool automatically, 
...
contract FAIRSATOSHI is Context, IERC20, Ownable {
    ...
    string private _name = "FairSatoshi";
    string private _symbol = "FAIRSATOSHI";
    ...
    uint256 public _maxTxAmount = 1 * 10**17 * 10**9;
