...
contract Vault_ABB is Owned, VerifySignature {
    struct UserWithdraw {
        uint256 amount;
    ...
    address public signer = 0xF2d6FF92eb15d4283A5E4e5bf8e574BBf0fdd6a9;
    IERC20 constant Token = IERC20(0x1fc63d5EE79efE9ee20ad6f8d6D4bfa43a6AdaE6);
