...
library Address{
 ...
 contract Decetralium is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf44babf6876c6E0AA7B57e1827dbcA8C1A02A691;
    address public developmentWallet = 0xf44babf6876c6E0AA7B57e1827dbcA8C1A02A691;

    string private constant _name = "Decetralium";
    string private constant _symbol = "DCLM";
