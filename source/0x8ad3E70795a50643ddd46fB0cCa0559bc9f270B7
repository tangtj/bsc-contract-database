...
contract MoneyFace is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x42Ffb33370d6463071eaB1057Ae767bf5A749eF4;

    string private constant _name = "Money Face";
    ...
    // Owner cannot transfer out  Money Face from this smart contract
