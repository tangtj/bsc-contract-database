...
contract Problem is Context, IERC20, Ownable {
    ...
    string private _name = "Problem";
    string private _symbol = "Problem";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD944637eF6a7198B05530Bda1fd36a7Ac16010B7); // Marketing Address
    address payable public teamWalletAddress = payable(0x3B2cb12b74108c7226c1e2f59c3f057d7AE1df24); // Team Address
