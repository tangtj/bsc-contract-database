...
contract TakeHiro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"TAKE HIRO";
    string private _symbol = unicode"TAKEHIRO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x5E31002F1D36c2f9f158b0e8a4d11e8f9a2c8c5F);
    address payable private taxWallet2 = payable(0x5E31002F1D36c2f9f158b0e8a4d11e8f9a2c8c5F);
