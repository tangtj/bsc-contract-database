...
contract SOLORIUM is Context, IERC20, Ownable {
    ...
    string private _name = "Solorium X Fun Token ";
    string private _symbol = "Solo X";
    uint8 private _decimals = 9;

    address public marketingWallet =0xB94115aB34168d367e22f2B0987b7eAAaDB33850;
    address public developerWallet = 0xB94115aB34168d367e22f2B0987b7eAAaDB33850;
    ...
    uint256 private _totalSupply = 82_000_000 * 10**_decimals;   
