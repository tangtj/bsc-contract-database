/*
[ Album ]
XSwap Network $Xswap is developing technology that reduces the gaps between traditional and decentralized finance.
Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

Ecosystem : 
Xswap Wallet - https://play.google.com/store/apps/details?id=com.finance.xspswap
Xswap Staking
Xswap DEX
Xswap Farm
Xswap Governance
Buy = 2 | Sell = 2 |Marketing and Development

Website : https://xswapnetwork.com
TG: https://t.me/xswapnetwork
*/
...
contract XswapNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Xswap Network";
