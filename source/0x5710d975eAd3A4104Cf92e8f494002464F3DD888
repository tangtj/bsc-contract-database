...
contract UltimateBet is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UltimateBet";
    string constant _symbol = "$UBET";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 10; // 500k
    uint256 public _maxWalletToken = _totalSupply / 1; // 10kk;
    ...
    uint256 public swapThreshold = _totalSupply / 100; //100K
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x893Bd92014CB09605D2314B1c49Ee9298E3fdF4c;
