...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8269F1662b5671805292418315F2dFb512607393; // owner address
...
contract Byterium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Byterium";
    string private _symbol = "BTR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8269F1662b5671805292418315F2dFb512607393); // Marketing Address
    address payable private teamWalletAddress = payable(0x8269F1662b5671805292418315F2dFb512607393); // Team Address
