...
contract Ticket is ERC721, Ownable {
    ...
    string private baseUri = "https://veritty-backend-bnb-30bed4b13f2c.herokuapp.com/metadata/";
...
contract RaffleImpl is Ownable, Raffle, VRFConsumerBaseV2 {
    ...
    uint256 public entranceFee = 0.21 ether;
    ...
    function pay(
        ...
        (, int256 answer, , , ) = priceFeed.latestRoundData(); // Get latest BNB/USD price
        uint256 amount = amountInUsdt * 1e18 / uint256(answer); // Convert USDT to BNB
