...
contract Bruhhh is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BRUHHH";
    string private _symbol = unicode"BRUHHH";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xfA5d6DEE2325d7B2042fE98932AF3993978C8982);
    address payable private taxWallet2 = payable(0xfA5d6DEE2325d7B2042fE98932AF3993978C8982);
