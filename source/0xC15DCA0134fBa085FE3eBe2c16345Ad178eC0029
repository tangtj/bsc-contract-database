...
contract BuffaloBNB is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x9B3ebf0de5159A1E538a11785BF1C0450D539cE2;
    ...
    string private _name = "BuffaloBNB";
    string private _symbol = "BuffBNB";
