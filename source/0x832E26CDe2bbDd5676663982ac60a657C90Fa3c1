...
contract Moonerium is IERC20, Ownable {
    ...
    string _name = "Moonerium";
    string _symbol = "Moonerium";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x5F88C8Eda25915f5666f6f4f8E1d2Cf3509a5E97;
        marketingFeeReceiver = 0x5F88C8Eda25915f5666f6f4f8E1d2Cf3509a5E97;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeSell <=50,"Cannot set sell fees above 50%"); // set max fees you can set to here
