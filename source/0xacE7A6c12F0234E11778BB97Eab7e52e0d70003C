...
contract GAINCOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GAINCOIN", "GAINCOIN") {
        ...
        marketingWallet = address(0x7E6496833be006a15BC55Ee4dcE69b82f770838c); // set as marketing wallet
    ...
    function updateTransferFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        transferTotalFees = transferMarketingFee + transferLiquidityFee ;
        require(transferTotalFees <= 40, "Must keep fees at 10% or less");
    }
