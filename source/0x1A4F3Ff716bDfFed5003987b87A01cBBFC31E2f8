...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x701773aEd7B4D459c2219026a0bfF4dfA535E48c; // owner address
...
contract X20 is Context, IERC20, Ownable {
    ...
    string private _name = "X2point0";
    string private _symbol = "$X20";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x701773aEd7B4D459c2219026a0bfF4dfA535E48c); 
    address payable public teamWalletAddress = payable(0x701773aEd7B4D459c2219026a0bfF4dfA535E48c);
    ...
    uint256 public _walletMax =   _totalSupply / 300;
