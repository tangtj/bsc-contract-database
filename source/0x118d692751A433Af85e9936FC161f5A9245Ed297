...
- Discover infinite possibilities with XShibarium! 
- XShibarium is the bridge token for BSC and Shibarium chain.
- XShibarium is Designed for the community!
- www.XShibariumToken.com
- TAX 2/2
...
contract XSHIBARIUM is ERC20, Ownable {
    ...
    address public devWallet = 0x376c88598C0E3b39Bb262b3b7f475d1401A334fB;
    ...
    constructor() ERC20("XShibarium", "XSHIBARIUM") {
