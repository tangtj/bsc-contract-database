...
contract Evolution is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint; 
    MktCap public mkt;
    ...
    function getTokenPrice() view private  returns(uint){
           ...
           uint kubUSDT=IERC20(address(this)).balanceOf(fistLP) * kubPrice / 1 ether;//KUB
