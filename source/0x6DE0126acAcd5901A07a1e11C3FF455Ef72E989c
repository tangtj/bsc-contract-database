...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 snofbtc = IBEP20(0xD52FAE4cCB1FE28293e49CAaa41Fa2cF10d3E7D6);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = snofbtc.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(snofbtc);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = snofbtc.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           snofbtc.transfer(shareholder, amount);
...
contract soflottery is IBEP20, Auth {
   using SafeMath for uint256;
 
   address snofbtc = 0xD52FAE4cCB1FE28293e49CAaa41Fa2cF10d3E7D6;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "soflottery";
   string constant _symbol = "sofltry";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 50; // 0.5%
...
uint256 reflectionFee = 100;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x0c8437E44100423c255Cda8d3881629961A4eB32;
