...
contract Huhushengwei is ERC20 {
    using SafeMath for uint256;
	...
	address payable _receive = payable(address(0xBB9Aa937C347d963bb3878de4ACd1c978C2a7455));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("Huhushengwei", "Huhushengwei") {
