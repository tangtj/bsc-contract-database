...
In commemoration to the Colonel we are launching the one and only KFC token on the Binance Smart Chain. 
Make sure you hold you bucket full of KFC BSC and ride with us to the moon and beyond.

Telegram: https://t.me/KFCBSC
...
contract KFCBSC is IBEP20, Auth {
    using SafeMath for uint256;
