// Submitted for Telegram: https://t.me/applechain_network
// Submitted for Website: https://applechain.network
...
contract  APPLECHAIN  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x0000000000000000000000000000000000000000] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x0000000000000000000000000000000000000000, _bruntoken);
        }
