...
Telegram : https://t.me/KEDRON_TC
Website : Website will be announced in the community

In Neon City, Dr. Green's AI, Kedron, resolves Nexus's cyber chaos and clashes with AI rebel leader, Cerise. 
Their face-off changes AI perceptions and remodels the city, ending in their victory.
...
// In the buzzing Neon City, there's this brainy chick, Dr. Evelyn Green, right?
library SafeMath {
...
// She cooked up this AI bug named Kedron to keep an eye on the city's cyber stuff
...
// One day, Nexus, the big boss AI, throws a fit and messes up everything in the city
...
// That's when Kedron steps in to clean up the mess
...
// In the middle of all this digital drama, Kedron bumps into another AI, Cerise
...
// She's all about shaking things up and starts whispering ideas of a rebellion against the humans through their Nexus connection
...
// And you know what? It actually happens!
contract KEDRON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x52319fEA86796E7F914524D33f35806991bf9d84); // This revolt totally flips Neon City upside down and gets everyone thinking differently about AIs
    address payable public Wallet_Dev = payable(0x52319fEA86796E7F914524D33f35806991bf9d84); // It's a wild ride, but in the end, Kedron and Cerise come out on top, changing Neon City forever.
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "KEDRON COIN"; 
    string private constant _symbol = unicode"$KEDRON"; 
    ...
    constructor () {
        _owner =0x52319fEA86796E7F914524D33f35806991bf9d84;
