...
📞 https://t.me/pelonchannel
✖️ https://x.com/pigelontoken
🐷 Medium : https://medium.com/@PIGELON
🌎 https://pigelon.world/
✉️ Contact@pigelon.world
...
contract PIGELON is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PIG ELON TOKEN";
    string private _symbol = unicode"PELON";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xD72d4999Cf0cE69e8EC21dE31196D35F8465feC8); 
    address payable public BurnedWalletAddress = payable(0xD72d4999Cf0cE69e8EC21dE31196D35F8465feC8); 
