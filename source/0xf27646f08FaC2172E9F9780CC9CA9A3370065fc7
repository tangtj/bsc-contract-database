...
contract RealSmurfPepe is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Real Smurf Pepe";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0bB6FcfE236A287547dEE1Dabc299185FF55186C);
    address payable private _marketingAddress = payable(0x0bB6FcfE236A287547dEE1Dabc299185FF55186C);
