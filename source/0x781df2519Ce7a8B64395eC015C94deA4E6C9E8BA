...
contract PayPal is ERC20, Ownable {
    ...
    PayPalDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PayPal USD", "PUSD") {
        marketingWallet = payable(0x6808e8cA85a393d31A243e2417EBe2dFd28859fc);
        devWallet = payable(0x6808e8cA85a393d31A243e2417EBe2dFd28859fc);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;   
        buyMarketingFees = 19;
        sellMarketingFees = 29;
        buyLiquidityFee = 0;
        sellLiquidityFee = 10;
        buyRewardsFee = 1;
        sellRewardsFee = 1;
        ...
        dividendTracker = new PayPalDividendTracker(
            payable(this),
            router,
        ...
        swapTokensAtAmount = totalTokenSupply / 10000; // 
...
contract PayPalDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        PayPalContract = PayPal(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PayPal_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PayPal_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PayPal contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PayPalContract);

            uint256 prevBalance = PayPalContract.balanceOf(address(this));
            ...
            {
                uint256 received = PayPalContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PayPalContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
