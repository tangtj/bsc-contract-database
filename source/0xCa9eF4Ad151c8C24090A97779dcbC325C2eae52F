// TG https://t.me/shiba2049
// x.com https://twitter.com/shiba2049bsc
// website https://shiba2049.xyz/ 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF979F805e6127beBA2A5Ca09F144C6720f83A4D9;
...
contract SHIBA2049  is Context, IERC20, Ownable {
    ...
    string public _name = "SHIBA 2049";
    string public _symbol = "2049";
    uint8 public _decimals = 18;

    address payable private marketingWalletAddress = payable(0x894934632a168E6511419ad668c2D85992aA5F52); 
    address payable private developmentWalletAddress = payable(0x894934632a168E6511419ad668c2D85992aA5F52);
    ...
    uint256 private _totalSupply = 20490000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 409800000000 * 10**_decimals; 
    uint256 public _walletMax =   409800000000 * 10**_decimals;
