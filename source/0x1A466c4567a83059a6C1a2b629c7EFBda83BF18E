...
| |    | '__|| | | | / _` | / _ \ / _ \ | || |
| \__/\| |   | |_| || (_| ||  __/| (_) || || |
 \____/|_|    \__,_| \__,_| \___| \___/ |_||_|

// https://crudeoil.finance/

Making #Crudeoil Finance great again!
...
the Crudeoil Finance footprint. The organizations will be voted by the community.

   #BEE
   
   #LIQ+#RFI+#SHIB+#DOGE = #Crudeoil Finance
...
contract Crudeoil is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Crudeoil Finance";
    string private _symbol = "CRUDE";
