...
contract Monix is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Monix100";
    string private constant _symbol = unicode"MNX";
