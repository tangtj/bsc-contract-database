...
contract KamenRider is IERC20, Ownable {
    ...
    string _name = "KamenRider";
    string _symbol = "HENSHIN!";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x77beC21F5D7E7e1A61B91544d7877B9097cFe0aA;
        marketingFeeReceiver = 0x77beC21F5D7E7e1A61B91544d7877B9097cFe0aA;
