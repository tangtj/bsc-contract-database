...
contract TUNTANKHAM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TUNTANKHAM";
    string private constant _symbol = unicode"TUH";
