...
contract DecBiz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dec Biz";
    string private _symbol = "DECBIZ";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x3693bF28d79B57cE23C25F580a200b097d76e390);
    address payable public DevelopmentWallet = payable(0x3693bF28d79B57cE23C25F580a200b097d76e390);
    ...
    uint256 public _totalSupply = 10 * 10**9 * 10**9;
