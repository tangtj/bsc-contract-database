...
contract BitminerGovernance is ERC20, Ownable {

    mapping(address => bool) public liquidityPool;


    address public rewardsPool;
    address public developmentWallet = 0x718A7136B06822db52dBF83646FDe83714B5A251;
    ...
    constructor() ERC20("BitminerGovernance", "BIT2") {
