...
contract FCG is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100,//Supply
        address(0x3D1e9dF971C775b9271b8AB4184E89c32911E9f9),//FundAddress       
        address(0x35bfD6e6e2E158A21CE6c2A8B8314F2A2DEE2f4f)//ReceiveAddress
