/**
 * Join the excitement of Mega Friday! 

Experience the unity of diverse communities through MEGA FRIDAY TOKEN.

Communities will battle it out in a poll the victorious community will unlock a MEGA 18% reward for all Mega Friday holders , in their community token. 

Launch date
18/AUG/2023 07:00PM UTC

Tax distribution 12/12
Rewards 9/9
Marketing 3/3
...
Initial LP
2 BNB
TELEGRAM: https://t.me/MEGAFRIDAYTOKEN
*/
...
contract MFT is ERC20, Ownable {
    ...
    constructor() ERC20("MEGA FRIDAY", "MFT") {
        marketingWallet = payable(0x87750EbfCFd8adBa58b898e3f9a36E300776377F);
