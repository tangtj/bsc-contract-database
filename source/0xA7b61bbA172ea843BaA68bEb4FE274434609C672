...
// Telegram: https://t.me/LuffyG5_BSC
// Twitter:  https://twitter.com/bsc_luffy
...
contract LUFFYINU is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x548Bfa6841ee1cC09d3239385D9C7AEAd52FB88E);
    address payable private _twdmkt = payable(0x548Bfa6841ee1cC09d3239385D9C7AEAd52FB88E);
    
    string private constant _name = "LUFFY INU";
    string private constant _symbol = "LUFFYINU";
