...
contract DORKLIZARD is Context, IERC20, Ownable {
    ...
    string private constant _name = "DORK LIZARD";
    string private constant _symbol = "D-Z";
    ...
    address payable private _twddev = payable(0xFdc24BD858E36eD44d049c53855e2311402c392d);
    address payable private _twdmkt = payable(0xFdc24BD858E36eD44d049c53855e2311402c392d);
