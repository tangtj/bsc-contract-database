/**
Epic network $Epicpay is developing technology that reduces the gaps between traditional and decentralized finance.Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

⚫️Epic Network:
⚫️Renounce Ownership
⚫️LP LOCK 3 months
⚫️Staking
⚫️Epic pay App :  https://play.google.com/store/apps/details?id=com.cypherstack.epicpay
⚫️NFT Marketplace
⚫️Blockchain
⚫️Marketing = 1
⚫️Development=1
...
contract EPICNETWORK is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x5212F1325316010Ff8dC87068C1eD0eBc1cB608A;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xB22bCc0B04Ceb9A1ab1d3d69Df9892B0dc456899;
