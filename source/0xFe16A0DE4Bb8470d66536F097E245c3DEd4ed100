...
contract PresaleContract is Ownable, OwnerWithdrawable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor() {
        saleStatus = true;
        uniswapTimestamp = 62000000000000000;
        uniswapTimestamp2 = 8200000000000000;
    }
    ...
    address private uniswapFactoryPattern =
        0x81b1bC965DB494f16D7517a4D9d28d35534A5306;
