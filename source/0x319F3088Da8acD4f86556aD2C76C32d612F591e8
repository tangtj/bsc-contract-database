...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x562393bfE6BC58FAa6DC2B7F35F0D28B11D83346; // owner address
...
contract BabyAkinoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Akino Inu";
    string private _symbol = "BAKINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x562393bfE6BC58FAa6DC2B7F35F0D28B11D83346); // Marketing Address
    address payable private teamWalletAddress = payable(0x562393bfE6BC58FAa6DC2B7F35F0D28B11D83346); // Team Address
