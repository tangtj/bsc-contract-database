...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) private _bWList;
    ...
    constructor (
        ...
        _limitAmount = LimitAmount * 20 ** Decimals;
        _txLimitAmount = TxLimitAmount * 20 ** Decimals;
            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0xaa3F40684aa2D83cd9E1701F1C140C067EDc2279), destroyAmount);
                    }
                }
    ...
    function getHolderLength() private view returns (uint256){
    ...
    uint256 private progressRewardBlockDebt = 1;
