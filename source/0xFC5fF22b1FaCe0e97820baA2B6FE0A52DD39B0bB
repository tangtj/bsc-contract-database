...
contract OggyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ODOGE";
    string private _symbol = "ODOGE";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x8f48fD35C50B51496450FaaD592DEBB270592950); 
    address payable private teamWalletAddress = payable(0x8f48fD35C50B51496450FaaD592DEBB270592950); 
