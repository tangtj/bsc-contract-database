// website : https://caturnium.com
// twitter(X) : Twitter.com/caturnium
// telegram : https://t.me/caturnium
...
contract Caturn is Context, IERC20, Ownable {
    ...
    string private _name     = "Caturnium";
    string private _symbol   = "CATURN";
