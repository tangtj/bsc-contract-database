 ...
 * ShibaMoonShot
 * Symbol : $ShibaMoonShot$
 * Telegram : @ShibaMoonShot
 * Website : Shibamoonshot.com
 * 
 * We won't stop before we reach the Moon. Join us in this journey.
 *
 * Built for the community. 
 * Simply hold ShibaMoonShot to join the journey and experience all of the benefit from ShibaMoonShot.
 * 
 * 100% Unruggable
 * --------------- 
 * We will lock 100% LP on DXsale.app right after adding liquidity.
 * You are safe with ShibaMoonShot!
 * ShibaMoonShot adds 5% of each transaction to the liquidity pool 
 ...
 * Marketing
 * ---------------
 * 1% will be sent to marketing ShibaMoonShot.
...
contract ShibaMoonShot is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaMoonShot";
    string private _symbol = "$SHIBAMOONSHOT$";
    ...
    address public marketingWallet = 0x110474f2d7354F0f6a636A735A03F50913ef8f7B;
