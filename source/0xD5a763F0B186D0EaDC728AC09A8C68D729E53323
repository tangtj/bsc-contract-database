...
contract OLYMPICGAMESDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x26B180DEBEdF97f1b915109324742090ec231ca4); 
    address payable public Wallet_Dev = payable(0x4a0425E006EbA82d4A6c51d5DC5cEA43D7bf996d);
    ...
    constructor () {
        _owner =0x4a0425E006EbA82d4A6c51d5DC5cEA43D7bf996d;
