...
contract TOKYOX is Context, IERC20, Ownable {
    ...
    string private _symbol = "TOKYO X";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7624f005BD0e581cfd24314224248cB7b32452Ed);
    address payable public liqWalletAddress = payable(0x7624f005BD0e581cfd24314224248cB7b32452Ed);
