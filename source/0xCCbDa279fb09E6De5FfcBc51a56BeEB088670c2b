...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x827a872aDF15DaE59a1e4e4F6Ee31a52c08b2027; // owner address
...
contract BDSM is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xF242faa4899A24bEa956606BBe57b61D622396B2); // Marketing Address
    address payable private teamWalletAddress = payable(0xF242faa4899A24bEa956606BBe57b61D622396B2); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 69000000 * 10**3; 
