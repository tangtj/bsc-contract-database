/**
 *COINSTO FINANCE CONTRACT
 * 4% fee on all transactions
   2% to holders
   2% to burn
   website: https://coinsto.finance
*/
...
contract Coinsto is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Coinsto Finance';
    string  private constant _SYMBOL = 'CSO';
