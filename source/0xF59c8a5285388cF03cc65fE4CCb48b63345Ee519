...
/**
 * Develop by StarsDEV
 * @ Esse contrato Foi desenvolvido por https://t.me/jonhdeveloper
...
contract alface is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 100000 * _decimalFactor; // Supply Token
    ...
    uint256 public maxWalletBalance = 15000 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 15000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 7500 * _decimalFactor; // 0.75% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 2500 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Alface Coin";
    string private _symbol =  "Alface";
    /*=== Modifiers ===*/
