...
contract TheMagicShiba is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xadAfb9516Ee3e3033f5e1e6e545B95BD50888014;

    string private constant _name = "Magic Shiba";
    ...
    Taxes public taxes = Taxes(0,16,2,2);
