...
contract FloshinCage is ERC20 {
    ...
    constructor () ERC20("FloshinCAGE Migration Token", "FloshinCage") 
    {    
        address newOwner = msg.sender;
        transferOwnership(newOwner);
        _whitelist[newOwner] = true;

        _mint(newOwner, 1e8 * (10 ** 18));
    }
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual override {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
        require(tradingOpen || _whitelist[sender] || _whitelist[recipient], "Trading is not enabled yet");
