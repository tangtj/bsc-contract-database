...
contract FrogDollars is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x840644f641C3357c1c8899E1b765F6dcd503f4B0); 
    address payable public Wallet_Dev = payable(0x02d2817763d21aCE4e48b3e8C16Ce130001835a6);
    ...
    string private constant _symbol = unicode"FrogDollars"; 
    ...
    constructor () {
        ...
        _owner = 0x02d2817763d21aCE4e48b3e8C16Ce130001835a6;
