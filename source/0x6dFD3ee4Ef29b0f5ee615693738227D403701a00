...
Fefe - $FEFE
Massive buzz around $FEFE going live today.

FEFE is to PEPE what SHIB is to DOGE. The PEPE killer! 🦂

Launching on BSC via Pancakeswap.

Telegram: https://t.me/fefe_bsc
...
contract FEFE is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x008698441E35c5557fCCaB191335D65efc35E99b);
    address payable public MarketingWallet = payable(0xa4DD8da0F6EC4dF36c6EBB3564D78158BA6af987);
    ...
    function setMaxTxLimit() external onlyAddress {
