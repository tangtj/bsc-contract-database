...
contract BTC is Context, IERC20, Ownable {
    ...
    address payable public developmentWallet = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    address payable public marketingWallet = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
