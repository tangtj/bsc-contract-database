// t.me/JarvisSyntheticSwissFranc 
// JarvisSyntheticSwissFranc.com
...
contract JarvisSyntheticSwissFranc is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "JarvisSyntheticSwissFranc";
    string public symbol = "JCHF";
