...
contract PEPEKiller is Context, IERC20, Ownable {
    ...
    string private _name = "PEPE Killer";
    string private _symbol = "PEPE Killer";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xec168892E0fe87C8D8E8201dFbdc744281413e14); 
    address payable private teamWalletAddress = payable(0xec168892E0fe87C8D8E8201dFbdc744281413e14); 
