...
contract kamechain is IBEP20, Ownable {
    ...
    string constant _name = "KAME CHAIN";
    string constant _symbol = "KMC";
    ...
    address public marketingFeeReceiver = 0x4020E2692C39846fDEeF1B2f9fB28CA0F49FF799;
    ...
    uint256 public swapThreshold = _totalSupply / 2000000 * 3; // .3%
    bool inSwap;
