...
// Note that this pool has no minter key of BpEUR (rewards).
// Instead, the governance will call BpEUR distributeReward method and send reward to this pool at the beginning.
contract bpEURRewardPool {
    ...
    IERC20 public bpeur = IERC20(0xC66087b151E5de3a414a22d442f073c0E19f17F2);
    ...
    uint256[4] public epochBpEURPerBlock;
    ...
    constructor(address _bpEUR, uint256 _startBlock) public {
        require(block.number < _startBlock, "late");
        if (_bpEUR != address(0)) bpeur = IERC20(_bpEUR);
        startBlock = _startBlock; // supposed to be 6330300 (Tue Apr 06 2021 12:00:00 GMT+0)
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: _lastRewardBlock, accBpEurPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
