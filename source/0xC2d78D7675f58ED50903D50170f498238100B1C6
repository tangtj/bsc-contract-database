...
contract PandaX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 320690e9 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xdE34cDcEfAc9c4BC5822D7F24845b7867db90F62;
        ...
        _isExcluded[address(0xdE34cDcEfAc9c4BC5822D7F24845b7867db90F62)] = true; //marketing wallet
