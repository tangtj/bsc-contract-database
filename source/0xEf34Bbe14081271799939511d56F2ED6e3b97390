...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor () public {
        address tokenOwner = 0xb64e7A6C1EdB0c11472E26B0AE6727D1F77C9623;
        _name = "christmasdog";
        _symbol = "Dogc";
        _decimals = 9;
        ...
        _maxTxAmount = 420000000000000000 * 10 ** _decimals;
        numTokensSellToAddToLiquidity = 210000000000000 * 10 ** _decimals;
