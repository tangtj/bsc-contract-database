...
contract Tazz is Context, IERC20, Ownable {
    ...
    string private _name     = "Tazz";
    string private _symbol   = "Tazz";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 440000000000000 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0xE251778CaC144696C52DC7d903a6D532B804F316;
        ...
        _isExcluded[address(0xE251778CaC144696C52DC7d903a6D532B804F316)] = true; //marketing wallet
