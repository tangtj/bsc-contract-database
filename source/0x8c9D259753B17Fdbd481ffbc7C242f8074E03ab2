...
contract xforcebsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =0x17c1e1846ac2920Ec0C1530740aF6a4Dabd4247b;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "x-forcebsc";
    string constant _symbol = "x-fbsc";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x17c1e1846ac2920Ec0C1530740aF6a4Dabd4247b;
