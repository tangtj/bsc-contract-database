...
contract HyperonChain is IERC20 {
    ...
    string constant private _name = "HyperonChain";
    string constant private _symbol = "HPN";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x96420A08Da353bD6e9c572bCCD7C5cb0eAE2E1d5)
    });
