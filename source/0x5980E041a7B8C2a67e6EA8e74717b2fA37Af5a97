...
contract MXCToken is ERC20, Ownable{
    ...
    uint256 public initSupply = 8888000000e18;
    ...
    constructor()ERC20("MXC","MXC"){
       
        
        uniswapV2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        usdtAddress = 0x55d398326f99059fF775485246999027B3197955;
        marketingAddress = 0x32ce4A8E33f41BdA9eA45890293668Ffa30aFE07;
        _mint(0x165cA27562c67C5Fc01393A649b1A9943fEBEd05, initSupply);
        whitelist[0x165cA27562c67C5Fc01393A649b1A9943fEBEd05] = true;
        mainAddress = 0x24e54369238c3323CD91acF1d7e77817fb91b042;
    ...
    event BuyNF(address indexed account,uint256 amountU);
    ...
    function buy(uint256 amountU) public returns(uint256){
        ...
        uint256 beforeS = IERC20(address(this)).balanceOf(msg.sender);
        buySwap(amountU * 3 / 9,msg.sender);
        uint256 afterS = IERC20(address(this)).balanceOf(msg.sender);
        uint256 outS =  afterS - beforeS;
    ...
    function sell(uint256 amount) public returns(uint256){
        ...
        removeLiquidity(needLiquidity,amount,0);
        ...
        IERC20(usdtAddress).safeTransfer(mainAddress,outU * sellUsdtFee / 100);
        emit SellNF(msg.sender,amount,outU);
        return outU * sellFee / 100;  
    }

    event DividendNF(address indexed account,uint256 indexed amount,uint256 indexed amountU);

    function dividend(uint256 amount) public returns(uint256){
        super._transfer(msg.sender, address(0xdead), amount);
        uint256 balanceNF = this.balanceOf(uniswapV2Pair);
        uint256 pairTotalSupply = IERC20(uniswapV2Pair).totalSupply();
        uint256 needLiquidity = amount * pairTotalSupply / balanceNF;
        ...
        uint256 afterU = IERC20(usdtAddress).balanceOf(address(this));
        uint256 outU =  afterU - beforeU;
        IERC20(address(this)).safeTransfer(address(0xdead), amount);
        IERC20(usdtAddress).safeTransfer(msg.sender, outU);
