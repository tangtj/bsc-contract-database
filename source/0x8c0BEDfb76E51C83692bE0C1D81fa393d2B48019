/**
$𝕏!!! Project is an Elon-inspired crypto, community-driven, buyback and burn mechanics. 
https://t.me/xexclamation
...
contract XCLAMATION is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XCLAMATION";
    string private _symbol = unicode"𝕏!!!";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x86DBFCAea5b5D38145B36dBe4A16fd2E125Cc47b);
    address payable private DevelopmentWalletAddress = payable(0x86DBFCAea5b5D38145B36dBe4A16fd2E125Cc47b);
