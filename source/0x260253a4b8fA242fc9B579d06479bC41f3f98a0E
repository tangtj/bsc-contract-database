...
contract TurtlesNinja is ERC20, Ownable {
    ...
    constructor () ERC20("TurtlesNinja", "TMNT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xBe0cDf1C3167A034EA471D876ad6F0247541cB27;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 1_000_000, "SwapTokensAtAmount must be greater than 0.0001% of the total supply");
