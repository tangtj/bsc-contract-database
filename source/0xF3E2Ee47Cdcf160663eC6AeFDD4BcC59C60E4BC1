...
/**
*/
// Tg: https://t.me/makebscgreatagaintrumpx
/**
...
contract MakeBscGreatAgain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MakeBscGreatAgainDividendTracker public dividendTracker;
    ...
    constructor() ERC20("MakeBscGreatAgain", "TRUMPX") {
        marketingWallet = payable(0xA5AADf5582669cee9a8Dbd69Fc049725b53c589e);
        devWallet = payable(0xA5AADf5582669cee9a8Dbd69Fc049725b53c589e);
        ...
        dividendTracker = new MakeBscGreatAgainDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "MakeBscGreatAgainTRACKER",
            "TRUMPXTRACKER"
        );
...
contract MakeBscGreatAgainDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MakeBscGreatAgain public MakeBscGreatAgainContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MakeBscGreatAgainContract = MakeBscGreatAgain(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MakeBscGreatAgain_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MakeBscGreatAgain_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MakeBscGreatAgain contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MakeBscGreatAgainContract);

            uint256 prevBalance = MakeBscGreatAgainContract.balanceOf(address(this));
            ...
            {
                uint256 received = MakeBscGreatAgainContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MakeBscGreatAgainContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
