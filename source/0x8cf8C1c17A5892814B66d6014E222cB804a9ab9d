...
contract UniLayer is ERC20, Ownable {
    ...
    constructor() ERC20("Uni Layer", "UNILA") {
        ...
        marketingWallet = address(0x773Ddd465BDFC1f348ec021b72813e892BA7bD07); // set as marketing wallet
        devWallet = address(0x773Ddd465BDFC1f348ec021b72813e892BA7bD07); // set as dev wallet
