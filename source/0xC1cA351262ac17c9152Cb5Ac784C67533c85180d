...
contract EternalDoge is Context, IERC20 {
    ...
    string private constant TOKEN_NAME = "EternalDoge";
    string private constant TOKEN_TICKER = "EternalDoge";
    ...
    address payable private _marketingWallet = payable(0x8CAF6EBF1F71b90e3686a115Ec69Ad538eCce3F6);
    address payable private _devWallet = payable(0x1F9E110BaC37AD21e2321D3920eBdD68386eE90d);
