...
// Citizen Conflict is a free-to-play, team-based shooter game set in the dystopian world of Ether Islands, where every match is fought for survival and valuable loot.
// Citizen Conflict Token sale CCASH
...
contract CCASH is Context, IERC20, IERC20Metadata, Ownable {   
