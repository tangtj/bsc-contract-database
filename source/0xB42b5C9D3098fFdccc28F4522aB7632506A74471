// https://t.me/SecureConnectBSC
// https://twitter.com/SecureTraverse
// https://securetraverse.org/
...
contract SecureConnect is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SecureConnect";
    string private constant _symbol = unicode"SCO";
