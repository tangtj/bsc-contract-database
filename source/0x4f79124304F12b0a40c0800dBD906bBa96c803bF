...
| |_| | |  __/ | (_| | | |_) | |__| | |____| |____ 
 \__, |_|\___|_|\__,_| |____/ \____/|______|______|
  __/ |                                            
 |___/                                             
...
contract YieldBullToken is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'YieldBull.finance';
    string  private constant _SYMBOL = 'yBULL';
