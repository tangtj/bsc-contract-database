...
Telegram https://t.me/Elliotchainchannels
Website https://elliotchain.org/
*/
...
contract ELLIOTCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELLIOT CHAIN";
    string private _symbol = "$ELC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeCE0C5f0a290b63c2Efed3cFc779b1C72D3Ef09e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8277a0e54a7D2D41C32035BfA042b2403B8dc5cf); // BuyBack Address
