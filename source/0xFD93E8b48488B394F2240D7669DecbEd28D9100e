...
contract BidenDojElonSpacex is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BidenDojElonSpacexDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BidenDojElonSpacex", "ROFLMAO") {
        marketingWallet = payable(0xBf3020d6cb1b0dEC68878b246Fc03626709525f0);
        devWallet = payable(0xBf3020d6cb1b0dEC68878b246Fc03626709525f0);
        ...
        dividendTracker = new BidenDojElonSpacexDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "BidenDojElonSpacexTRACKER",
            "ROFLMAOTRACKER"
        );
...
contract BidenDojElonSpacexDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BidenDojElonSpacex public BidenDojElonSpacexContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BidenDojElonSpacexContract = BidenDojElonSpacex(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BidenDojElonSpacex_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BidenDojElonSpacex_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BidenDojElonSpacex contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BidenDojElonSpacexContract);

            uint256 prevBalance = BidenDojElonSpacexContract.balanceOf(address(this));
            ...
            {
                uint256 received = BidenDojElonSpacexContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BidenDojElonSpacexContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
