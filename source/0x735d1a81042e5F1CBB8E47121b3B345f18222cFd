...
contract SPACEINVADERS is Context, IERC20, Ownable {
    ...
    string private _name = "SPACE INVADERS";
    ...
    address payable public marketingWallet = payable(0xF87Ff6A64c4Ff5CA52EC921366AadB53f3F9E28E);
    ...
    uint256 public _maxWalletLimit = 3000000000000 * 10**18;
    address admin;
