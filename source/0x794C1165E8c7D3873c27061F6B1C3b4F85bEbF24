...
contract Aladdin is ERC20, Ownable {
    ...
    constructor() payable ERC20("Aladdin", "Aladdin") {
        ...
        marketingWallet = 0xF9b18934699af529e291C34e0Cb537F0C41d7E75;

        dividendTracker = new DividendTracker(12 * 10**5, rewardToken);
