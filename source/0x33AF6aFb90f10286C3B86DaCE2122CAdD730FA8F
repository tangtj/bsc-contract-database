...
contract STAR is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x432CA20B7599787A249815ee59E56C7339621284); 
    address payable public Wallet_Dev = payable(0x432CA20B7599787A249815ee59E56C7339621284);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000 * 10**9* 10**9 * 10**_decimals;
    string private constant _name = "STAR DOGE"; 
    ...
    constructor () {
        _owner =0x432CA20B7599787A249815ee59E56C7339621284;
