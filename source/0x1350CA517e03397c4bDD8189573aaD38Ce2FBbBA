...
is more than just a community-driven coin, the smart contract is designed combined with various strategies to reward the holders without even selling any tokens.

The latest bullish Squid Grow on the BSC blockchain. 
It rewards its holders with 1% passive SquidVenomGrow income on every transaction💸.
This set-up creates an ecosystem that encourages investors to hoddle.
...
pragma solidity ^0.6.12;
    ...
    contract SQUIDVENOMGROW is Context, IERC20, Ownable {
        ...
        string private _name = 'SQUIDVENOMGROW';
