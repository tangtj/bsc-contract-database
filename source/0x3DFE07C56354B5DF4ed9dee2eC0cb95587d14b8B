...
contract DONKETOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public skmngh48;
    ...
    string private _tokenname = "Donke Finance";
    string private _tokensymbol = "DONKE";
