/**
DorkLord Grow FOR COMMUNITY (POC) the most profitable token for Whales & future whales

With Dorklord Grow for community investors have found a safe utility, meme & community token on the market…

~Safe dev with insane previous launched anon

~locked & renounced

~Marketing : 2 |Reflection = 2

~Community token with utility & bullish plans 

Join our whale community & become a whale yourself

TG: https://t.me/DorklordGrowbsc
*/
...
contract DorklordGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "DorkLord Grow"; // 
    string private constant _symbol = "DORKLG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x81A3D42A1Cf31a9FEC726358DC60ac1820d13D12;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x8d7ab0FA13705510E5e448416B17200C860dC7fd;
