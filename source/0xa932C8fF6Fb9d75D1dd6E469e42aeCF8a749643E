...
abstract contract ERC20Burnable is Context, ERC20 {
    ...
    uint256[4] public  buyFeeSetting_ = [0,1,1,0];
    uint256[4] public  sellFeeSetting_ = [0,1,1,0];
...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0x7089602C573A816d818780c1Bb111Ae820A0A0dc),
      "Address is invalid"
    );
...
contract  TOKENDOGEXXX is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("DOGEXXX", "DOGEXXX")
    ERC20Permit("DOGEXXX")
    EmergencyDrainable(address(0x7089602C573A816d818780c1Bb111Ae820A0A0dc))
  {
