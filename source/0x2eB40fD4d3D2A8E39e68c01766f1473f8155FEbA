...
ORITO is a blockchain project that has been designed to harness the power of AI to create a more efficient, secure, and user-friendly blockchain network.
With its strong transaction power, advanced security features, and cutting-edge AI-powered functionalities, ORITO is set to become one of the most reliable and trustworthy blockchain networks in the world.
With further developments and innovations planned for the future, Orito is a network that is set to revolutionize the blockchain industry for years to come.
Telegram : https://t.me/Oritonetwork
Website : https://oritonetwork.com
...
contract ORT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orito Network";
    string private _symbol = "ORT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B6E587EaA19d8a2b34b78ED0A29Cb5d7FA234eb); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x0B6E587EaA19d8a2b34b78ED0A29Cb5d7FA234eb); // Development Address
