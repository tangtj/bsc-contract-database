// Telegram: https://t.me/hoppiumBSC
...
contract HOPPIUM is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HOPPIUM";
    ...
    address payable public DevWallet = payable(0x3A263042FB7CD2c8107f19Ea42db0D0A515d9a89);
    address payable public MarketingWallet = payable(0x91Efd898d8DE240cbCB8d5bb527575AE6D375E85);
    ...
    function maxTxLimitPercent() external onlyAddress {
