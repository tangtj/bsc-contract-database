...
contract TIPTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dnncb57;
    ...
    string private _tokenname = "TIP";
    string private _tokensymbol = "TIP";
