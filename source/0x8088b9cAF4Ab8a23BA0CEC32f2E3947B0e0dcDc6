// t.me/YearnCompoundingveCRVyVault 
// YearnCompoundingveCRVyVault.com
...
contract YearnCompoundingveCRVyVault is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "YearnCompoundingveCRVyVault";
    string public symbol = "YVBOOST";
