...
// Mini Shiba Inu is built by a strong team of crypto experts that aim to build a sustainable, long term token bringing innovative ideas into the crypto space.

//https://t.me/minishibainucommunity
interface IERC20 {
...
contract MiniShibaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8D863d2A14Bea462f75C1aBC045d8E517d1E2F19); 
    address payable public Wallet_Dev = payable(0x8D863d2A14Bea462f75C1aBC045d8E517d1E2F19);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420060 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "Mini Shiba Inu"; 
    string private constant _symbol = unicode"MINI SHIBA"; 
    ...
    constructor () {
        _owner =0x8D863d2A14Bea462f75C1aBC045d8E517d1E2F19;
...
// https://t.me/minishibainucommunity
// https://twitter.com/minishiba2023
// Are u ready for a moonshot!!