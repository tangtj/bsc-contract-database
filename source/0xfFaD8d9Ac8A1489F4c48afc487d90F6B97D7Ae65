...
contract CarbonCCLPFarm is Ownable{
    ...
    IERC20 public CarbonCCLP = IERC20(0x328761e984dF79C3244Af734Ea00cBF981Fd7857);
    address public lpFeeAddress = 0x1E1ae44D4Fb8d45D8ac7064716e718E4F91312eD;
    address public sponsorRewardAddress = 0xaD4D481277c3F4543880B7392E143bB44FdE3ABD;
    ...
    function Deposit(uint256 amount) public updateReward(msg.sender) checkStart { 
        ...
        emit sponsorReward(msg.sender, taxAmount + feeAmount);
