// FOLLOW THIS PUMP ON TELEGRAM: https://t.me/AntiShibariumJapaneseWhale
...
contract AntiShibariumJapaneseWhaleBEPDump69 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AntiShibariumJapaneseWhaleBEPDump69";
    string private _symbol = "AntiShibarium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04C21D5440eeEdC0Ab5A6DEB61B10638044189AD); // Marketing Address
    address payable public teamWalletAddress = payable(0x04C21D5440eeEdC0Ab5A6DEB61B10638044189AD); // Team Address
