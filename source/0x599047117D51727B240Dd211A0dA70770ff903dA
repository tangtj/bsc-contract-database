...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x949e990f5A728A4dA16bB211DDFBD9F083d5250F; // owner address
...
contract SafemoonCN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafemoonCN";
    string private _symbol = "SFMNCN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x949e990f5A728A4dA16bB211DDFBD9F083d5250F); // Marketing Address
    address payable private teamWalletAddress = payable(0x949e990f5A728A4dA16bB211DDFBD9F083d5250F); // Team Address
