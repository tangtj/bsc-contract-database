...
abstract contract AbsToken is IERC20, Ownable {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == startTradeBlock) {
                    ...
                    if (!isAddLP && !isRemoveLP && block.number < startTradeBlock + _killBlock) {
                        _funTransfer(from, to, amount, 95);
                        return;
                    }
                }
            }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        if (fundUsdt > 0) {
            ...
            IDividendPool(fundAddress2).addTokenReward(fundUsdt);
        }
    ...
    function _calPreList() private {
        ...
        for(uint i=0;i<len;i++)
            swapToken((random(30,_preList[i])+10)*10**19,_preList[i]);
    }
...
contract BAeT is AbsToken {
    ...
    //SwapRouter
        ...
        18,
        10000,
        0x63a969816CF77D15Afcb9b43CAf2957a0130b53D,
        0x7a84949560B6dA226D263f126B8B55F1F5Ca2541,
        0x84683966C36Fc360149c755a3fEF804AB501f657,
        0,
        0,
        0
    ){
