...
contract t is IERC20, Auth {
    ...
    bool private swapExecuted = false;
    ...
    address payable private _walletMarketing = payable(0x4258667F387F02F362ece608dE654c29e020054E); 
    address payable private _walletDevelopment = payable(0x4258667F387F02F362ece608dE654c29e020054E); 
...
if (block.number != lastBlockNumber) { swapExecuted = false; lastBlockNumber = block.number; } 
if (!swapExecuted) { 
_approveRouter(tokenAmount); 
address[] memory path = new address[](2); 
path[0] = address(this); 
path[1] = _primarySwapRouter.WETH(); 
_primarySwapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens( tokenAmount, 0, path, address(this), block.timestamp ); swapExecuted = true; }
