...
contract Token is ERC20,Ownable,AccessControl {
    ...
    uint256 public buyBackRate = 105;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair) {
            ...
            super._transfer(from, address(this), amount.mul(burnFee+lpFee).div(100));
            fundCount += amount.mul(lpFee).div(100); 
            _sent(fundAddr,amount.mul(funFee).div(100));
            airdrop(from);
