...
contract SellToken is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("TD-silver","TD-silver", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;//QmXgJoQxbQyXbR9RiJREiYFh9YoJF2pqHwQxsAqXLE633e
        sethiddenBaseURI("https://ipfs.io/ipfs/QmSde8JUUZPHoTDX7PVXZDKZoeUEwxGgJdssPdNRLAV1CR?filename=yinka.jpg");
    }
