...
contract SUC is ERC20 {
	...
	address _fundAddress = address(0xf82837435f827165e02d66a8E4a7fCCBA365245c);
    ...
    constructor(address tokenOwner) ERC20("SUC", "SUC") {
        ...
        nft = NftWarp(0x4660b34253FCAfc67F251DB376Cf86F726983448);//Nft Contract
    }
