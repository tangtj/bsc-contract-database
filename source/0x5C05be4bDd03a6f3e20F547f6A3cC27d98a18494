...
contract VernyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Verny Doge";
    string private _symbol = "Verny Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC891A7e15A390Ff855eE976E579F711681a2e72F);
    address payable public teamWalletAddress = payable(0xEB932173385B242C8F016d64C320085617502A9A);
