...
contract FOURTYFOURFORTYFOUR is ERC20, Ownable {
    ...
    constructor() ERC20("4444", "4") {
        ...
        uint256 totalSupply = 444_400_000 * 1e18; // 

        maxTransactionAmount = 4_444_000 * 1e18; // 
        maxWallet = 4_444_000 * 1e18; // 1% 
        swapTokensAtAmount = 44_000 * 1e18; // 
        ...
        marketingWallet = address(0xA685Fec4C53e25D8Ecb65133C264e9Fd1Ce7EfBB); // set as marketing wallet
        devWallet = address(0x0717791D882dAd0F723DD2f5865EF41e9aD3CF26); // set as dev wallet
