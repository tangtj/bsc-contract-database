...
contract Minarium is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5AA38f259963E2bbd5a3F275641008106c6a0612); // Marketing Address
    address payable public teamWalletAddress = payable(0x5AA38f259963E2bbd5a3F275641008106c6a0612); // Team Address
