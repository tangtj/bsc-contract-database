// https://t.me/ChenchenBSC
// https://twitter.com/rociocolman5
// https://chenbtc.com
...
contract Chenchen is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chenchen";
    string private constant _symbol = unicode"Chenchen";
