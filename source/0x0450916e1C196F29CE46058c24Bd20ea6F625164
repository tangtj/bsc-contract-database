...
/**
TELEGRAM: https://t.me/thanospepebsc
WEBSITE: https://thanospepe.online/
**/
library SafeMath {
...
contract THANOSPEPE is IBEP20, Ownable {
    ...
    string constant _name = "THANOSPEPE";
    string constant _symbol = "THAPE";
    ...
    address public marketingFeeReceiver = 0xEFD7828Cb566558bCb9CfD1850612cbF1D7312df;
