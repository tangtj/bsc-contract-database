// TELEGRAM : https://t.me/impicklerickbsc
...
contract IMPICKLERICK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "IMPICKLERICK";
    string private constant _symbol = unicode"$PICKLE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 450000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xAe00A6B179E6b1aeA0048e5983c3281fc1AC04b5);
    address payable public MarketingWallet = payable(0x699aEa339D276c3CF84997EA0f9eC29523438d4b);
