...
contract laeabchain is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7D7bccB6EbA5b611213f59f813Fe68DFDE7974cF); 
    address payable public Wallet_Dev = payable(0x63852D292373bC164E79EC5F82807712fCa12aee);
    ...
    string private constant _name = "Laeab Chain"; 
    string private constant _symbol = unicode"LC"; 
    ...
    constructor () {
        ...
        _owner = 0x63852D292373bC164E79EC5F82807712fCa12aee;
