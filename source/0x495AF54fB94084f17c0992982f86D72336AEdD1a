/**
   ...
   Shiba,Rfi,Feg combine together to creat Veg designed.
    
    I make this #Veg to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/venusgate
   ...
   I will renounce the ownership to burn addresses to transfer #Veg to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 50% total supply to the pool
   Can you make #Veg 100000X? 
   
  100% SAFE NO RUG.

   100,000,000,000,000,000 total supply
   500,000,000,000,000 Veg max limit for per trade
   ...
   it's the best part of the #Veg idea, increasing the liquidity pool automatically, 
...
contract VenusGate is Context, IERC20, Ownable {
    ...
    string private _name = "VenusGate";
    string private _symbol = "Veg";
