/*
BNP  Miner Network builds a payment system in which cryptocurrency is used as a payment method in the real economy, based on our own developed blockchain technology. ( 4 months in the making )
...
contract BNPMINERNETWORK is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BNPNETWORK";
