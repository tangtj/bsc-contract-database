...
contract Nike is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd998cD40AbAfbF3273e15b3f8F6ADE156a6eFd12); // Marketing Address
    address payable public teamWalletAddress = payable(0xd998cD40AbAfbF3273e15b3f8F6ADE156a6eFd12); // Team Address
