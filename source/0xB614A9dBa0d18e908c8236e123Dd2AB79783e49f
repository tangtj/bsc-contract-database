...
contract BEBE is ERC20 {
	...
	address private _fundAddress = address(0x2c6A3bF3599a1Ba1d4cA6E1B2Cca5d7a3E2A43B8);
	address private _maketAddress = address(0x2c6A3bF3599a1Ba1d4cA6E1B2Cca5d7a3E2A43B8);
    ...
    constructor(address tokenOwner) ERC20("BEBE", "BEBE") {
