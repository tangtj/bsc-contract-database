...
contract Banana is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BNA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x01E686927e9c2EFB6aBCE216C778b25042305844);
    address payable private _marketingAddress = payable(0x01E686927e9c2EFB6aBCE216C778b25042305844);
