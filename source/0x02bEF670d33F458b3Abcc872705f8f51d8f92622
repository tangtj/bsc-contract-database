/*
    Telegram : https://t.me/Luffy_tokens
    Twitter  : https://twitter.com/luffy_coins
*/
...
contract LuffyCoins is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 690e9 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 69e9 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 1;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xD342265963Ed574C249fe506A4238bDd984ab677;
    address private opsWallet = 0xD342265963Ed574C249fe506A4238bDd984ab677;
    address private devWallet = 0xD342265963Ed574C249fe506A4238bDd984ab677;

    string private constant _name = "Luffy Coins";
    ...
    Taxes private launchtax = Taxes(0, 20, 0, 0, 0);
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0xD342265963Ed574C249fe506A4238bDd984ab677] = true;
        _isExcludedFromFee[0xD342265963Ed574C249fe506A4238bDd984ab677] = true;
