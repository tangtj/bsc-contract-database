...
contract RippleBurnReflect is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ripple Burn Reflect";
    string private _symbol = "RBR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63a2bECE230b22EcfEeC56716f8B4B3bB7a8c69B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x63a2bECE230b22EcfEeC56716f8B4B3bB7a8c69B); // BuyBack Address
