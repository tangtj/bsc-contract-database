// TG https://t.me/writechain_channel
// WB https://Writechain.net
...
contract Writechain is Context, IERC20 {
    ...
    string private constant _name = "WRITECHAIN";
    string private constant _symbol = unicode"WTC";
    ...
    uint256 public _Wtc_maxWallet = (_tTotal * 6) / 100;
    uint256 private _previousMaxWalletToken = _Wtc_maxWallet;

    uint256 public _Wtc_maxTx = (_tTotal * 3) / 100;
    uint256 private _previousMaxTxAmount = _Wtc_maxTx;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    address payable public _Wtc_Own__Wallet =
        payable(0xcb215dbfc96Ee9c4247492374A010f52E4B5E982);
    address payable public constant __Burn__Wallet =
        payable(0x000000000000000000000000000000000000dEaD);
    address payable public _Wtc_Open__Wallet =
        payable(0xcb215dbfc96Ee9c4247492374A010f52E4B5E982);
    ...
    constructor() {
        _owner = 0xcb215dbfc96Ee9c4247492374A010f52E4B5E982;
        ...
        _isExcludedFromFee[_Wtc_Open__Wallet] = true;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                (heldTokens + amount) <= _Wtc_maxWallet,
                "Over wallet limit."
            );
        }

        if (from != owner())
            require(amount <= _Wtc_maxTx, "Over transaction limit.");
        ...
        if (
            ...
            if (contractTokenBalance > _Wtc_maxTx) {
                contractTokenBalance = _Wtc_maxTx;
            }
            txCount = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(_Wtc_Open__Wallet, BNB_M);

        BNB_Total = address(this).balance;
        sendToWallet(_Wtc_Own__Wallet, BNB_Total);
    }
