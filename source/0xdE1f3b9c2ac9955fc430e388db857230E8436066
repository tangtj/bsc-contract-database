// Website: https://safebnb.xyz/
// Telegram: https://t.me/safe_bnb
...
contract SAFEBNB is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SAFEBNB";
    string private constant _symbol = unicode"$SAFEBNB";
    ...
    address payable public DevWallet = payable(0x687531A3521554516E4FABE57b273738233b0A4D);
    address payable public MarketingWallet = payable(0x11243fCA8ab9a024dc7D9e86f824653227Fa74Be);
