// t.me/StakedEthosReserveNote 
// StakedEthosReserveNote.com
...
contract StakedEthosReserveNote is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "StakedEthosReserveNote";
    string public symbol = "STERN";
