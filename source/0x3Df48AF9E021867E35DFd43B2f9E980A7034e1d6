...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "FOOTKING";
    string private _symbol = "FOTK";
    ...
    address public ownerAddres = address(0xd82F7Bdd75C8Dc84a6F0D378Ff7d2015Ac67c4a3);
    address public devAddress = address(0xd4A5d2BF9fdE15c4D2C84AF9ce7012B82FA20224);
