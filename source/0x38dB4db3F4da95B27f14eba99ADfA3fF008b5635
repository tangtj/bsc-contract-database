/**
 *Submitted for verification at testnetstage.bscscan.com on 2023-08-25
*/
...
contract ERC20Base is Context, ERC20, Ownable, Lockable {
    ...
    function updateUserVestings(address to) public {
...
contract Pick is ERC20Base, ReentrancyGuard {
    uint256 maxSupply = 3000000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted 1,000,000,000

    constructor() payable ERC20Base("Play Pick", "Pick") {
