...
contract OLIVIA is Context, Ownable, IERC20 {
    ...
    uint256 constant private buyfee = 0;
    uint256 constant private sellfee = 90;
    uint256 constant private transferfee = 100;
    uint256 constant public fee_denominator = 1_000;
    bool private canSwapFees = true;
    address constant public marketingAddress = payable(0x792B2967B912f051847e685DFE8e3f2C5FA1e15a); // build: 0x792B2967B912f051847e685DFE8e3f2C5FA1e15a


    IRouter02 public swapRouter;
    string constant private _name = "Olivia Inu";
    string constant private _symbol = "OLIVIA";
    string constant public copyright = "analytixaudit.com";
    string constant public version = "SAFU";
    ...
    function toggleCanSwapFees(bool yesno) external onlyOwner {
        require(canSwapFees != yesno,"Freddy: Bool is the same");
        canSwapFees = yesno;
    ...
    function _transfer(address from, address to, uint256 amount) internal returns  (bool) {
        ...
        if(is_sell(from, to) &&  !inSwap && canSwap(from, to)) {
            ...
            if(contractTokenBalance >= swapThreshold) {
                ...
                if(address(this).balance > 0) {buyBackAndBurn(address(this).balance);}
             }
        }
    ...
    function buyBackAndBurn(uint256 amount) internal inSwapFlag {
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 toSendMarketing = address(this).balance * 8 / 9;

        if(toSendMarketing > 0) (success,) = marketingAddress.call{value: toSendMarketing, gas: 35000}("");
        
        }
    

        function setPresaleAddress(address presale, bool yesno) external onlyOwner {
            require(presale != address(0), "Freddy: Zero Address");
        ...
        function enableTrading() external onlyOwner {
            require(!isTradingEnabled, "Freddy: Trading already enabled");
