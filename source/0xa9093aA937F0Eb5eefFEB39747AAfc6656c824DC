...
contract MXC is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x0CD847638CFc7B2f835bc964c3168F59f0C661C2); // Marketing Address
    address payable private teamWalletAddress = payable(0x0CD847638CFc7B2f835bc964c3168F59f0C661C2); // Team Address
