...
contract VOLCANO is IBEP20, Auth {
    ...
    address DEV =  0x4f2dB60327cB3bDcc2D8a9cE14641745972CD91C;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Volcano";
    string constant _symbol = "VCASH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x4f2dB60327cB3bDcc2D8a9cE14641745972CD91C;
