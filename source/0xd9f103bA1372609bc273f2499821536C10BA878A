...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x8D02E0C7F1a3E9F96ba82EAD5502c14e1FeDA410; // owner address
...
contract REDHOTCOCK is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB9496040757bDBBDc821C6cCf0af90a8b08933B2); 
    address payable public teamWalletAddress = payable(0xB9496040757bDBBDc821C6cCf0af90a8b08933B2);
