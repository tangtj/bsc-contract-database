...
contract OGPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("OG PEPE", "OGPEPE") {
        ...
        maxTransactionAmount = 1_100_000_000 * 1e18; // 
        maxWallet = 2_200_000_000 * 1e18; // 2.2% 
        ...
        marketingWallet = address(0xe614285aC11688Faec38CB9de0b6b3eA191De2d7); // set as marketing wallet
        devWallet = address(0xe614285aC11688Faec38CB9de0b6b3eA191De2d7); // set as dev wallet
