/*
Telegram: https://t.me/ShredCoin
Twitter: https://twitter.com/Shred_Coin
Website: https://www.shredinu.com
*/
...
contract ShredInu is Context, IERC20 {
    string private _name = "SHRED INU";
    string private _symbol = "$SHRED";
    ...
    uint256 public _maxTransactionAmt = _tTotal * 100 / 100;
    uint256 public _maxWalletToken = _tTotal * 100 / 100;

    uint256 public _buy_free = 19;
    uint256 public _sell_free = 19;
    ...
    address payable public MarketingWallet = payable(0x9F8b46d42E0947F6A533e643ad32886C403dE22a);
