...
contract AToken is ERC20, Ownable {
    ...
    uint256 public divBuyRate = 50;
    uint256 public divSellRate = 50;
    uint256 public lowLimit = 0.0001 ether;

    uint256 public swapMax = 1000 ether;
    ...
    constructor() ERC20("DAOCO", "DAOCO") {
        address main = msg.sender;
        _mint(main, 2100000000 * 1e18);
        ...
        fund1Wallet = 0xfbe558Ea19Ff2AC12e415cf5bEdb0f865c3CE36A;

        _isExcludedFromFees[main] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[msg.sender] = true;
        _isExcludedFromFees[fund1Wallet] = true;
        _isExcludedFromFees[0xcF6B213dC2eBC2Cbb1F8cEFeCfB60A9D60AAee9b] = true;
        _isExcludedFromFees[0x7293d8700a2b7D06D47bB27dD4a62364A1769593] = true;
    ...
    function setFundWallet(address addr) public onlyOwner {fund1Wallet = addr;}
    ...
    function setSwapMax(uint256 amount) external onlyOwner {
        swapMax = amount;
    }

    function setLowLimit(uint256 amount) external onlyOwner {
        lowLimit = amount;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            // 
                ...
                if (to == address(uniswapV2Pair)) { // sell
                    fundFee = amount.mul(divSellRate).div(1000);
                    super._transfer(from, address(this), fundFee);
                }else{
                    fundFee = amount.mul(divBuyRate).div(1000);
                    super._transfer(from, fund1Wallet, fundFee);
                }
        ...
        require(_isExcludedFromFees[from] || balanceOf(from)>=lowLimit,"require balance");
    }
    ...
    function swapU() private lockTheSwap{
        ...
        if (balanceToken>0) {
            balanceToken = balanceToken > swapMax ? swapMax : balanceToken;
