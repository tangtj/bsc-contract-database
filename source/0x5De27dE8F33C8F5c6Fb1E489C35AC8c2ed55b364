...
contract XJ is ERC20 {
    ...
    address _fund1Address = address(0x5d7cd4122638B5b689F2A7c588f0e87eb2c3bFBb);
	address _fund2Address = address(0x32cD7a5bc4B256dCbef877deE497Bf57CCaE1417);
    address _reciverLPAddress = address(0xbC6C1E252418F52f5BCBb5eD04455750e7216bE4);
    ...
    constructor(address tokenOwner) ERC20("XJ", "XJ") {
        require(_baseToken < address(this),"XJ small");
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(300) > block.timestamp){amount = amount.div(100);}
                _splitUsdtLdxToken();
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount >= 10**17){
            ...
            if(afterAmount > beforeAmount){
                ...
                USDT.transfer(_fund1Address, newAmount.div(575).mul(100));
                USDT.transfer(_fund2Address, newAmount.div(575).mul(100));
