...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0xf72A89092387dCafdD5BD5A27D368e3cdd02752B),
      "Address is invalid"
    );
...
contract  FLB is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("FLB", "FLB")
    ERC20Permit("FLB")
    EmergencyDrainable(address(0xf72A89092387dCafdD5BD5A27D368e3cdd02752B))
  {
