/**
💰Introducing Bags of BNB - Your Ticket to Token Wealth! 💰

Bags of BNB is not just another token - it's a lifestyle! Our community-driven project aims to 
reward holders with incredible benefits, all while having fun and participating in unique events. 
We believe in transparency, security, and creating lasting value for our holders.


Be part of the greatest revival in $BOB history! 💰
📱: https://t.me/bagsofbnb
**/
...
contract BAGSOFBNB is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BAGS OF BNB";
    ...
    address payable public DevWallet = payable(0x4C7196876b635CcdC12935d6158ccfb3710e8140);
    address payable public MarketingWallet = payable(0x8c7689BA58dB30808c32af7B154fe6Bbbd14bB96);
