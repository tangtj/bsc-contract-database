...
contract NAC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NAC COIN";
    string private _symbol = "NAC";
    ...
    address payable private marketingWalletAddress = payable(0xc95d92192B28555f020bBf6A24fd1A197eb157a6);
