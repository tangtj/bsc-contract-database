...
/**
TELEGRAM : https://t.me/peerstep
WEBSITE : https://twitter.com/PeerStep
*/
...
contract PEERSTEP is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 30000000000 * 10**_decimals; //
    uint256 public maxBuyAmount = 30000000000 * 10**_decimals; //
    uint256 public maxWalletBalance = 50000000000 * 10**_decimals; //

    address public marketingAddress = 0x07C076852e24a31df49d95E6B02E2e9a575D6E07; //
    address public devAddress = 0x07C076852e24a31df49d95E6B02E2e9a575D6E07; //

    string private constant _name = "PEERSTEP"; //
    ...
    Taxes public sellTaxes = Taxes(4,0,5,1); //
