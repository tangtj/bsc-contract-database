...
Website: https://www.kryptopuppy.com
Twitter: https://twitter.com/kryptodogcoin
Telegram: https://t.me/kryptodogcoin

Every buy and sell will feed the jackpot (4%/6%). If for 10 minutes, no buys are
recorded, the last buyer will receive a portion of the jackpot. This will drive
a consistent buy pressure.

The jackpot has a hard limit ($100K) that, if reached, will trigger the big bang event.
*/
...
contract KryptoPuppy is Context, IERC20, Ownable {
    ...
    // We don't add to liquidity unless we have at least 1 Krypto token
    ...
    string private constant _name = "Krypto Puppy";
        ...
        )
    {
        ...
        // Either 0 or 1+ Krypto to prevent PCS errors on liq swap
