...
Everyone here is like Family & Family comes first.

Our main focus here is to form an army, a family, syndicate, a Arion of shillers and holders that will support the dev team and each other in creating the next massive moonshot token. 

Let's be the next massive moonshot Arion!🚀🌓

TG: https://t.me/arionbsc
**/
...
contract ARIONBSC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ARIONBSC";
    string private constant _symbol = unicode"$ARION";
    ...
    address payable public DevWallet = payable(0xc27adF33F7bFC8635579E8680475a353d5D8B635);
    address payable public MarketingWallet = payable(0xDfe29162a4Cb4122D314cC99c33427bA76483638);
