...
contract BNSHIB2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNSHIB2.0";
    string private _symbol = "BNSHIB2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34a19891dC1f9F577b38cE4E54f5f39b6a0ab885);
    address payable public teamWalletAddress = payable(0x34a19891dC1f9F577b38cE4E54f5f39b6a0ab885);
    address public immutable deadAddress = 0x34a19891dC1f9F577b38cE4E54f5f39b6a0ab885;
