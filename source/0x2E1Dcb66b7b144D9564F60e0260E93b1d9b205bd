...
interface Cashier {
    ...
    function _setToken(address token) external;
}

contract SPORTSBETTING is IERC20 {
    ...
    string constant private _name = "SPORTSBETTING";
    string constant private _symbol = "SPB";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xC6aFaC4e631449E908F286510C4cf00537a70dA7)
    });
