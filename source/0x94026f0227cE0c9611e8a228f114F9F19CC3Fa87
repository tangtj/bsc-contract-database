...
contract NeonToken is ERC20("Neonic", "NEON"), Ownable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "Neon::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "Neon::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "Neon::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber =
            safe32(
                block.number,
                "Neon::_writeCheckpoint: block number exceeds 32 bits"
            );
