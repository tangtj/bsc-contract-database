...
/**
Welcome To ArubaChain

We build Blockchain Project Ecosystem with PoS ( Proof of Stake ) algorithm.

ArubaChain  Ecosystem :
⏺ ArubaChain Website
⏺ ArubaChain White paper
⏺ ArubaChain Swap
⏺ ArubaChain Wallet
⏺ ArubaChain Staking
⏺ ArubaChain Bridge
⏺ ArubaChain Blockchain
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95ca17431C1f2Eb9c9092e9Cf5a63452d7d6049D; // owner address
...
contract ArubaChain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB5847AaAE2e166c3CFbF29fEb007af12290706A0); // Marketing Address
    address payable public teamWalletAddress = payable(0x9dcc5F3bde9e5CDa5E18142fE4998bA9eaa16f81); // Team Address
