...
contract DadaInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x065042b772bcAfE166f1C42CBAcDE2C664fd7267); 
    address payable public Wallet_Dev = payable(0x065042b772bcAfE166f1C42CBAcDE2C664fd7267);
    ...
    constructor () {
        _owner =0x065042b772bcAfE166f1C42CBAcDE2C664fd7267;
