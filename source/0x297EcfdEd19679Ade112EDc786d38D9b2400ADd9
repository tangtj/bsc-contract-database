...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2708567b6dfF9e6225FB6B0995eA17571fDB4c9B; // owner address
...
contract Wushu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WUSHU";
    string private _symbol = "Wushu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2708567b6dfF9e6225FB6B0995eA17571fDB4c9B); // Marketing Address
    address payable private teamWalletAddress = payable(0x2708567b6dfF9e6225FB6B0995eA17571fDB4c9B); // Team Address
