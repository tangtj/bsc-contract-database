...
// TG : https://t.me/XBlockiumofficial
...
contract XB is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x6d254C189bF734EB75302dd18AdA2D3F21494A16);
    address payable private _twdmkt = payable(0xC28516408D1935c41C4866e1B57799545F97bdf7);
    
    string private constant _name = "X BLOCKIUM";
    string private constant _symbol = "XB";
