...
// Calico Cats😺😸😸 will sweeping the whole bsc space of meme coins.#catstrends😸

//Telegram:https://t.me/calicocatsofficial
//Twitter:https://twitter.com/calicocats2023
interface IERC20 {
...
contract CALICOCATS  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCF9D34Fbd579e07f21CFD8637Bd4387c6CF15ADE); 
    address payable public Wallet_Dev = payable(0xCF9D34Fbd579e07f21CFD8637Bd4387c6CF15ADE);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 16* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "CALICO CATS"; 
    string private constant _symbol = unicode"$CALICO"; 
