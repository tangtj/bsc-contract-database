...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe7e970Ecc7fa51b7C7De09607CC9a1F98d2De36E; // owner address
...
contract MEMEUTILITY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MEME X UTTILITY";
    string private _symbol = "MEMETILITY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5c3d0999c7B06E9cb3a334532e9a91Bc57278D05); 
    address payable public teamWalletAddress = payable(0x5c3d0999c7B06E9cb3a334532e9a91Bc57278D05);
