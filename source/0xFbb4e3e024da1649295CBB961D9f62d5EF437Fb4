...
contract Dawn is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("Dawn", "Dawn") {
	...
	IERC20 TM20;
	function changeTm20Address(address tm20Address) public onlyOwner {
        _tm20Address = tm20Address;
		_isExcludedFromFeesVip[tm20Address] = true;
		TM20 = IERC20(tm20Address);
		TM20.approve(address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**64);
    }
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount >= 10**17){
			...
			if(_tm20Address != address(0)){
				swapTokensForTm20(allTokenAmount.div(8));
                if(TM20.balanceOf(address(this)) > 10**10){
                    addLiquidityUsdt(USDT.balanceOf(address(this)), TM20.balanceOf(address(this)));
                }
			}
		}
    }
	...
	function swapTokensForTm20(uint256 tokenAmount) private {
        // generate the uniswap pair path of token -> weth
	...
	function addLiquidityUsdt(uint256 usdtAmount, uint256 tm20Amount) private {
