...
contract TLODC is IERC20, Ownable {
    ...
    address private fundAddress = address(0x1635Eec29B3eBfB7677415ac32804c609Ed8C625);
    address private fundAddress2 = address(0x1635Eec29B3eBfB7677415ac32804c609Ed8C625);
    ...
    address public oaddr = 0x8e663Ab1328E10823e2B4bB8E032a2d8699C0B3a;
    ...
    constructor() {
        ...
        _rOwned[oaddr] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[oaddr] = true;
        ...
        _owner = msg.sender;
        emit Transfer(address(0), oaddr, _tTotal);
    }
