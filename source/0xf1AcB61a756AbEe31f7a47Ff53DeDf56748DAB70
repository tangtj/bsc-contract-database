...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public addLiquidityFee =500;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000,
        address(0xCA43C44973D486DEf0E1704f408e5A4e3F5b8681),
        address(0x000000000000000000000000000000000000dEaD),
        address(0x09daE693fDbC3570CD9d6233a9ec63B87bfd13C3)
    ){
    }
}