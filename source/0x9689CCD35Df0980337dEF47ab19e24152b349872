...
contract MCB is ERC20 {
    ...
    address _fundAddress = address(0x14d6091624720d410644620dd744e2166D0a9075);
    ...
    constructor(address tokenOwner) ERC20("MCB", "MCB") {
        require(_baseToken < address(this),"MCB small");
        ...
        nft = IERC20(0x7D0540eBA66f920FFA5B6D94e625EABCAbb34f66);
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                if(startTime.add(60) > block.timestamp){amount = amount.div(10000000000);}
                _splitUsdtLdxToken();
                _splitUsdtNftToken();
