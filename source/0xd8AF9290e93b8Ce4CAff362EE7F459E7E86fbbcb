...
// https://t.me/ManekiNekoBSC

// https://twitter.com/ManekiNekooffical

// https://manekineko.pro/
...
contract ManekiNekoBSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Maneki Neko 招き猫","MANEKINEKO") {
