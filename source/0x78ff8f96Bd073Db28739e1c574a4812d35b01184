...
contract DUG is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xbb34eF782384c4120611A0B59611cE3B8a79DD56;

    string private constant _name = "Dug Coin";
    string private constant _symbol = "$DUG";
    ...
    // Owner cannot transfer out  DUG from this smart contract
