...
contract BitcoinBSC is Context, IERC20, Ownable {
    ...
    string private  _symbol = "BTCBSC";
    uint8 private _decimals = 9;
    
    uint256 public                _taxFee = 3; // 3% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 5; // 3% of transactions will be kept for liquidity
    uint256 public               _burnFee = 2; // 4% of transactions will be burned
