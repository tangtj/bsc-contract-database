...
contract MOMOCOIN  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x05FdDac8E076D9304db57429BA54467974e3a1E8); 
    address payable public Wallet_Dev = payable(0x05FdDac8E076D9304db57429BA54467974e3a1E8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 430* 10**5* 10**5 * 10**_decimals;
    ...
    constructor () {
        _owner =0x05FdDac8E076D9304db57429BA54467974e3a1E8;
