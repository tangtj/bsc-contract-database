...
contract Xtrarium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x0BcFDBCBa263Dd31b855EaE6c3f56D78ACF357a4);
    address payable private _twdmkt = payable(0x0BcFDBCBa263Dd31b855EaE6c3f56D78ACF357a4);
    
    string private constant _name = "Xtrarium";
