...
//FluidMan In the vibrant world of Impossibles, Fluid Man springs into action as a heroic token on Binance Smart Chain. As the launch approaches, investors brace for a fluidic adventure. With his shape-shifting prowess, Fluid Man seeks to revolutionize the crypto landscape, thrilling enthusiasts with limitless potential.  #FluidMan #Impossibles #BSC #crypto #launch

//https:t.me/FluidManCommunity
//https://twitter.com/FluidManGlobal
...
contract FLUIDMAN  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA718211a668668Ab3d3D7696D7f9f7EC30B9d87a); 
    address payable public Wallet_Dev = payable(0xA718211a668668Ab3d3D7696D7f9f7EC30B9d87a);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 42* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "FLUID MAN"; 
    ...
    constructor () {
        _owner =0xA718211a668668Ab3d3D7696D7f9f7EC30B9d87a;
