        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xd5BF4654A2Ab10Ad7D9ec57ea155068e7d6f6CED), block.timestamp
                );
            }
        }
    }
...
contract E is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000,//Supply
        address(0x7A91b9642DC0D063Ed790c9bbeB80e64a6Af7626),//FundAddress
        address(0xd5BF4654A2Ab10Ad7D9ec57ea155068e7d6f6CED)//ReceiveAddress
    ){
    }
}