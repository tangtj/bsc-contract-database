...
contract BabyBurnJaguar {
    ...
    uint256 public constant sellFee = 5; // 5% de taxa para vendas
    uint256 public constant buyFee = 5; // 5% de taxa para compras
    uint256 public reserve = totalSupply.mul(30).div(100); // 30% do totalSupply como reserva
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        uint256 taxedAmount = _value.mul(100 - fee).div(100);

        balanceOf[msg.sender] = balanceOf[msg.sender].sub(_value);
        balanceOf[address(this)] = balanceOf[address(this)].add(_value.sub(taxedAmount));
        balanceOf[_to] = balanceOf[_to].add(taxedAmount);

        emit Transfer(msg.sender, _to, taxedAmount);
        emit Transfer(msg.sender, address(this), _value.sub(taxedAmount));
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        require(allowance[_from][msg.sender] >= _value, "Without permission");
        ...
        emit Transfer(_from, address(this), _value.sub(taxedAmount));
...
function deposit() public payable {
    // O contrato aceita depósitos em BNB
}
