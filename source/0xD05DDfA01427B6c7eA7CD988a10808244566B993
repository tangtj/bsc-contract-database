...
contract MoriaUniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6408f2e1b001b3F38c29a7901E9F1407e3338077); // Marketing Address
    ...
    string private _name = "MoriaUniverse";
    string private _symbol = "MORIA";
