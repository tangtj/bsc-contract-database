// https://t.me/DexterLabsBSC
// https://twitter.com/dexterlabs_bsc
// https://www.dexter-labs.net/
...
contract DexterLabs is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DexterLabs";
    string private constant _symbol = unicode"Dexlabs";
