// telegram: t.me/Marspepe
// website: http://Marspepe.network
...
contract MarsPepe is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "MarsPepe";
    string private constant _symbol = unicode"MarsPepe";
    ...
    address payable private _marketingAddress = payable(0xE7f7bFD0F3595841cE6bc140B7a047E3ceCa492f);
