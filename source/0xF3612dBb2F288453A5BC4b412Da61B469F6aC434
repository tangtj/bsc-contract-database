...
/**
 * @title IndexxS&P500Stock token
 * @notice Asset backed BEP20 Token with pausable, mintable and burn features
 * @notice IndexxS&P500Stock Pegged to Meta Stock
 */
contract IndexxSNP500 is ERC20, ERC20Burnable, Pausable, AccessControl {
     ...
     */
    constructor() ERC20("IndexxS&P500Stock", "S&P500") {
