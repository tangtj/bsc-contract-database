...
contract RabbitKing is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2933107FB71891309bB215551CcE7002bcAb5218); // Marketing Address
    address payable public buybackWalletAddress = payable(0x2933107FB71891309bB215551CcE7002bcAb5218); // buyback Address
