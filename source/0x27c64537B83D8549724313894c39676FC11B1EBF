...
contract BEP20Token is IBEP20, Auth {
  ...
  //acc5
  address private marketingFeeReceiver = 0xDe47d06Af6465c7e7A9C0aa418e1EaF8052F6113;
  address private developmentFeeReceiver = 0xDe47d06Af6465c7e7A9C0aa418e1EaF8052F6113;
  ...
  event LogFactoryAddress(address factoryAddress);
  event LogPairCreated(address pair);
  ...
  constructor() Auth(msg.sender) {
    ...
    emit LogFactoryAddress(factoryAddress);

    pair = IDEXFactory(factoryAddress).createPair(WBNB, address(this));
    emit LogPairCreated(pair);
