...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24dB32Dc5aD1d2F391c8D3D2f2Fa24514941dD3b; // owner address
...
contract OxLuffy is Context, IERC20, Ownable {
    ...
    string private _name = "0xLuffy";
    string private _symbol = "0xLuffy";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x24dB32Dc5aD1d2F391c8D3D2f2Fa24514941dD3b); // Marketing Address
    address payable private teamWalletAddress = payable(0x24dB32Dc5aD1d2F391c8D3D2f2Fa24514941dD3b); // Team Address
