...
contract EXOFROG is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4b2cffCBf7BC3f8B9377174f6085135D1371C51B;

    string private constant _name = "EXODUS FROG";
    string private constant _symbol = "eXofrog";
