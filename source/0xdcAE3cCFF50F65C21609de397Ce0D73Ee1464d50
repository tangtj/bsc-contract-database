/**
    HEXAGONIUM IS UTILITY TOKEN IN SMARTCHAIN WITH BLOCKCHAIN EXPLORER (TESTNET AND EXTEND LOCKED LP),
    ...
    ******HEXAGONIUM******
    ...
    TAX 10/10
    LOCKED LIQUIDITY
    TELEGRAM : t.me/Hexagonium
    TWITTER  : https://twitter.com/hexagonium20
    WEBSITE  : https://hexagonium20.tech    
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x42E8854f411638BE659c4f85c9A1997FC4e52e30; // owner address
...
contract HEXAGONIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HEXAGONIUM";
    string private _symbol = "HEXA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =payable(0x7A97FB450BE3273Af54DE449a02E8c4D3D141DB0); 
    address payable public teamWalletAddress =payable(0x42E8854f411638BE659c4f85c9A1997FC4e52e30);
