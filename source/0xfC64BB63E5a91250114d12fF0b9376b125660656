...
contract RabbitAI is IERC20 {
    ...
    string constant private _name = "RabbitAI";
    ...
    address payable public marketingWallet = payable(0x7AC66e1bfB6c329Ada22F1F8d33dF043306A8C92);
