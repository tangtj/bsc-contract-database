...
contract MUSKINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1718C32c35ADdf5dc7B8ff6f32F212EE0efe63Ce); 
    address payable public Wallet_Dev = payable(0xd06a652cB60A2ebcFbFbe2cF697f8bc9c18611a6);
    ...
    string private constant _symbol = unicode"MUSKINU"; 
    ...
    constructor () {
        _owner =0xd06a652cB60A2ebcFbFbe2cF697f8bc9c18611a6;
