...
Telegram : https://t.me/QuadrillionEth

Twitter  : https://twitter.com/QuadrillionEth

Website  : https://www.quadrillioneth.com/
...
contract QuadrillionEth is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    QuadrillionEthDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Quadrillion Eth", "Quadrillion") {
        marketingWallet = payable(0x2116203EC82A5d2a05dAA4bCCCcf9d181F5dCa14);
        devWallet = payable(0xFB8B3d45B9325A326b24868cA9d41fB0e1dA4a75);
        ...
        dividendTracker = new QuadrillionEthDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "QuadrillionEthTRACKER",
            "QuadrillionEthTRACKER"
        );
    ...
    function updateFees(
        ...
        require(totalSellFees <= 15 && totalBuyFees <= 5, "total");
...
contract QuadrillionEthDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    QuadrillionEth public QuadrillionEthContract;
    ...
    constructor(
        ...
        defaultToken = token;
        QuadrillionEthContract = QuadrillionEth(mainContract);
        minimumTokenBalanceForAutoDividends = 1250000000000_000000000000000000; // 1.250.000.000.000 tokens
    ...
    function _transfer(
        ...
        require(false, "QuadrillionEth_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "QuadrillionEth_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main QuadrillionEth contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(QuadrillionEthContract);

            uint256 prevBalance = QuadrillionEthContract.balanceOf(address(this));
            ...
            {
                uint256 received = QuadrillionEthContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    QuadrillionEthContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
