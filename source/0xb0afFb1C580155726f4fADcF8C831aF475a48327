/**
   TREX is an active predator and a scavenger.
   Through staking, users can earn passive 
   income. Accelerate your journey to financial freedom.
  TELEGRAM: https://t.me/TREX_BSC
*/
...
contract TREX is Context, IBEP2022, Ownable {
