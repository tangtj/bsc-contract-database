...
// TELEGRAM : https://t.me/xTigeInuOfficial
...
contract XtigeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " XTigeInu";
    string private _symbol = "XTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xef50f084869e0c6c64C9AE59C2968D531C5b8F71);
...
address payable private Team =
        payable(0x66E375d21D212b5AcC3E06D42a153839Ad380a8E);
