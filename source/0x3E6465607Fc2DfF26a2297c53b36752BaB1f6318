...
contract BatchBuy is Ownable, Managers {
    ...
    constructor() {
        ...
        listingTime = 1692449441;

        _managers[0x2084c27880Af53f7dc95855Bf1C106f456ec4d55] = true;
        _managers[0xbDB73A9CBC8ae7B36BA1a444539b65F8C34db02f] = true;
    }

    function batchBuy(address[] memory tos) external onlyManager {
        require((block.timestamp - listingTime) >= oneDay, "not the time");
        _batchBuy(tos);
    }
