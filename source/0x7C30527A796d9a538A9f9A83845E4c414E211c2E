...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xF704c9668CcFB877B1cCdb4f80c3CC1CBaCD7731; 
...
contract LiteXNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF704c9668CcFB877B1cCdb4f80c3CC1CBaCD7731);
    address payable public teamWalletAddress = payable(0xF704c9668CcFB877B1cCdb4f80c3CC1CBaCD7731); 
    ...
    uint256 private _totalSupply = 480000000* 10**_decimals;
    uint256 public _maxTxAmount = 480000000* 10**_decimals; 
    uint256 public _walletMax = 480000000* 10**_decimals;
