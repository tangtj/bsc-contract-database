...
contract FuCoin is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x199FA3598E11F1f40B66282FB8515197111d38d0);
    address payable private _marketingAddress = payable(0x199FA3598E11F1f40B66282FB8515197111d38d0);
