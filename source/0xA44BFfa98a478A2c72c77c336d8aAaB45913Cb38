...
//UniverseGirl -  Justlaunched.
//Low Mcap
//Lp Locked
//OwnershibRenounced
//Telegram : t.me/UniverseGirl
...
contract UniverseGirl is Context, IERC20, Ownable {
    ...
    string private _name = "Universe Girl";
    string private _symbol = "UniverseGirl";
    ...
    uint256 private minimumTokensBeforeSwap = 5092741 * 10**6 * 10**9; 
