...
contract SOCIALMCOIN is ERC20, ERC20Detailed, Pausable {
    ...
    constructor() ERC20Detailed("SOCIAL M COIN", "SMC",18)
    {
        deployTime = block.timestamp;
        RemainingReward = 25228800*(10**18);
        _isExcluded[msg.sender] = true;
        _isExcluded[address(this)] = true;
        _mint(address(this), 25228800*(10**18));
        tokenBalance = balanceOf(address(this));
        Duration= Duration.div(60);
        maxSupply = 25228800*(10**18);
    }
