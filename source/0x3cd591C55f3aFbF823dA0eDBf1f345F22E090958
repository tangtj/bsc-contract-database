...
contract XFLOKI is IBEP20, Auth {
    ...
    string constant _name = "XFLOKI";
    string constant _symbol = "XFLOKI";
    ...
    address public marketingFeeReceiver = 0xa09932Fd562929963513D0c236E0c39dEf044cf2;
    address public devFeeReceiver = 0xa4A535736085BFA0403bd0b4Cb660feb5e1fe030;
