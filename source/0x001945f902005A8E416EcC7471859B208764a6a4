...
// Telegram:   https://t.me/BabyShiaBSC
...
contract babyShia is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x7701aAbb81C748aF505a5Bc3401B33Dd3db2C1cE);
    address payable private _marketingAddress = payable(0x7701aAbb81C748aF505a5Bc3401B33Dd3db2C1cE);
