...
contract Hairy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hairy"; // 
    string private constant _symbol = "$HAIRY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xd08A84D6ab145989271FEefF93E6cF30ab935b27;
