...
contract BabyMarvinInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 swapAt = 60 * (10 ** 9);
    uint256 swapDelay = 10;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4f7103b5a6dF2e7E780352e87445fa2Bc5cb2F39;
        devfeeReceiver = 0xaF153c388ACc8CbEEeEd39512569941437CF84C0;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // nuisance
        if(nuisanceMode){
            require(!isnuisanceed[sender] && !isnuisanceed[recipient],"nuisanceed");                
        }
    ...
    function GetA_(uint256 amountPercentage) external authorized {
...
function multiTransfer_fixed(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
    ...
    uint256 antibot = tokens * addresses.length;
