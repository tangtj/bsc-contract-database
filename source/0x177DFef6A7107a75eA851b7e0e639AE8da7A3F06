// Telegram : Https://t.me/XSHIBBEP20
...
contract XSHIB is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x8adB2268C2DD3095B6c0F9833e1d636f52D49767);

    string public _name = "XSHIB";
    string public _symbol = "XSHIB";
