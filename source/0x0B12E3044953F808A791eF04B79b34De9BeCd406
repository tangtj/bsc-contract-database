...
contract ethernal is ERC20, Ownable {
    ...
    mapping (address => bool) private _isEthernalExcluded;
    ...
    constructor() payable ERC20 ("ethernal", "ETHER") {
        ...
        marketingWallet =  0x7Be8ff679478d1617d8627904C81632cd86f7c70;
        ...
        _isWalletExcluded[0x7Be8ff679478d1617d8627904C81632cd86f7c70] = true;
    
        _mint(owner(), 1 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000000 * 888;
    }
