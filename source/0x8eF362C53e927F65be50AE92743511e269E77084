/**
Arabian Rabbit  $ARBBIT is developing technology that reduces the gaps between traditional and decentralized finance.
...
contract ArabianRabbit is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "ARBBIT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x1c3C8b944e46fd7354c4998a5016ae9c397f8A48;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xF0d9Ae2dF3a9Fa4C83dF02c7994aaeFb712d9c34;
