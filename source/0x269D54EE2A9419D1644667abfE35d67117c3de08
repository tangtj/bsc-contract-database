...
/**
 * OPTIMUS DEPLOYER LAUNCHPAD
Jeet is a cutting-edge project built on the Binance Smart Chain (BSC), 
offering a range of decentralized finance (DeFi) solutions. 
Our token aims to empower investors with diversification from Optimus Rewards 
and innovative financial products that shall be announced in the near future.
Stay with us and enjoy the rewards and opportunities to come.

TG: 
https://t.me/+CnvhQSTPiDA1YjI0
CA:
Total supply: 10000000 $JEET
Max wallet: 5%
Max transaction: 2%
...
contract JEET is IBEP20, Auth {
    ...
    address DEV = 0x4a8A2c97a26527C8978e3e35eC83032a33A0376a;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8995f5e012E698e201A67C04BC9065596C481979;
