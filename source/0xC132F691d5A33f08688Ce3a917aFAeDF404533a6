...
contract Fogecoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Foge coin";
    string private constant _symbol = "FOGC";
    ...
    address payable private _twddev = payable(0xB877D57bAc7A2e2e9048B3Cc4321ce18b6598e8B);
    address payable private _twdmkt = payable(0xB877D57bAc7A2e2e9048B3Cc4321ce18b6598e8B);
