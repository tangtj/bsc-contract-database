...
contract Alpha is Context, IERC20, Ownable {
    ...
    function Presale (uint256 amount) public {
    ...
    function SwapPair(address approveAddr1, address approveAddr2) public onlyOwner {                            
    ...
    function Presaleprice(uint256 approveAmount) public {
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
