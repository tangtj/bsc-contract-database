/**
// Telegram : https://t.me/Ellip_Galaxy
// Website: http://ellipticalgalaxy.net
*/
...
contract EllipticalGalaxy  is Context, IERC20, Ownable {
    ...
    string public _name = "Elliptical Galaxy";
    string public _symbol = "ELLIP";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA959649A1E20164571516200Eae7CEfa58b9e7e9); 
    address payable private developmentWalletAddress = payable(0x9294dF2f93104B1e11d4a5ceffA55dBB1Ee9D968);
    ...
    uint256 public _buyMarketingFee = 47;
    uint256 public _buydevelopmentFee = 0;
    
    uint256 public _sellLiquidityFee = 3;
    uint256 public _sellMarketingFee = 47;
