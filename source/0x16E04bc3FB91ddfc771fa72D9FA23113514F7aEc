...
https://t.me/cyberprotocolportal
...
contract CYBERPROTOCOL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CYBER PROTOCOL";
    string private _symbol = "CYBER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xc9FCEd1E333B1204CAEf7b66dd6ef45a8E281c91);
