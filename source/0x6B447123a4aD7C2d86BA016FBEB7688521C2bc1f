...
//TELEGRAM: https://t.me/KittyPuppyBNB
interface IERC20 {
...
contract KITTYPUPPY is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x4d67158C04a6af7EeD8a440824038610677eA9A0;
    address public devAddress = 0x44339BdEEe79A759c7a5417d226bD978BAEEF395;

    string private constant _name = unicode"🐱🐶 KITTY PUPPY ";
    ...
    Taxes public taxes = Taxes(1,7,1,1);
    Taxes public sellTaxes = Taxes(0,10,1,1);
