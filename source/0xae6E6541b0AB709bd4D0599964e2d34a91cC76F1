// t.me/InternetComputerTechnology 
// InternetComputerTechnology.com
...
contract InternetComputerTechnology is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "InternetComputerTechnology";
