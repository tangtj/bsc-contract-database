...
ApeCasino ($APEC) is a smart token with utility and featured with new buyback mechanism, supported by our platform as our casino. 

--Automatic Buy-Back Mechanism 
50% of all losses will be automatically used to buyback $APEC.

--Reflection System
Enjoy $APEC reflections on every buy and sell transaction, including every automatic buyback, by just holding the token.

--Smart Ecosystem
We developed an independent smart contract for each game, each of which supports our automatic buyback mechanism in order to sustain $APEC and to obtain a versatile and easily updatable DApp.

Our mission is to develop a strong and unique token backed by an entertaining and easily updatable platform, while providing our community with multiple ways to generate value. Read more on our website and stay tuned for more information!

**/

// LINK GROUP: https://t.me/apecasinoBSC
...
contract APECASINO is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "APECASINO";
    string private constant _symbol = unicode"$APEC";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 25000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x80C432A1b4EA33c35eD6FaE69dbc1C015860DE27);
    address payable public MarketingWallet = payable(0x5f34488C04B9B3e9262aeE8458845bB468396174);
