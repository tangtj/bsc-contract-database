/**
Telegram: https://t.me/nobody_bsc
*/
...
contract nobody is Context, IERC20, Ownable {
    ...
    string private constant _name = "THATSMYNAME";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x6c5A1A2b5458f44679d32F64b3a558d280C5DdCC);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x6c5A1A2b5458f44679d32F64b3a558d280C5DdCC] = true;
