// Welcome to CRIQ - https://critiquereviewapp.com
...
contract Critique is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Critique';
    string private constant _symbol = 'CRIQ';
    ...
    constructor() Auth(msg.sender) {
        // IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // testnet
        IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainnet
