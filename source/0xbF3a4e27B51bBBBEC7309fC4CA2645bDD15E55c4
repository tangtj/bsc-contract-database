...
/*
Baked Weed.club - The BNB pool with the finest daily return and highest referral reward
*/
...
contract BakedWeed{
    ...
    function rebakeWeed(address ref) public{
        require(initialized);
    ...
    function bakeWeed(address ref) public payable{
        require(initialized);
