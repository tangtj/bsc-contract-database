...
contract SuperTesla_Inu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Super Tesla Inu"; // 
    string private constant _symbol = "STI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x676817918F1e36Dafe638A69307F86c8e08479F9;
