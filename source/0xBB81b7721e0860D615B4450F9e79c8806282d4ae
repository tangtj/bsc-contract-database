...
// telegram : https://t.me/pepethebossportal
// x : https://x.com/pepethebossbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4e72a5190c82A77DF68320899E9c6DeAbA76b177 ; // owner address
...
contract PepeTheBoss  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeTheBoss";
    string private _symbol = "PTB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6FCBC914dB3B42891fa9F922b4E5aB1752615027); 
    address payable public teamWalletAddress = payable(0x6FCBC914dB3B42891fa9F922b4E5aB1752615027);
