...
// Telegram: https://t.me/reverseshibabsc
...
contract abihs is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x059Bb1261CD2100Da08a142db87fD21638881488);
    address payable private _twdmkt = payable(0x059Bb1261CD2100Da08a142db87fD21638881488);
    
    string private constant _name = "abihs";
    string private constant _symbol = "$abihs";
