...
contract Saveme is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xEC586B113Cfed29db70B4e4994D38eB682Ac85B5;
    address public devAddress = 0xEC586B113Cfed29db70B4e4994D38eB682Ac85B5;

    string private constant _name = "Save Me";
