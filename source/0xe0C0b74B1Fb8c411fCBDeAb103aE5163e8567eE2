...
/**
    ...
    *Max wallet : 2,000,000,000 (2.5%)
    *Max buy : 2,000,000,000 (2.5%)
    *Max sell : 2,000,000,000 (2.5%)
    

    There is a tax on every transaction, it consists of 2 components
    *10% Rewards as $SKILL to the holders
    *10% Liquidity

    https://t.me/EarnSkillBsc
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable DividendsToken = address(0x154A9F9cbd3449AD22FDaE23044319D6eF2a1Fab);
...
contract EarnSkill is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyTranscationAmount = 2500000000 * (10**18);
    uint256 public maxSellTransactionAmount = 2500000000 * (10**18);
    uint256 public swapTokensAtAmount = 1000 * (10**18);
    uint256 public _maxWalletToken = 2500000000 * (10**18); 
    ...
    constructor() public ERC20("EarkSkill", "ESKILL") {
