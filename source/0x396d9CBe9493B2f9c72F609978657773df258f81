...
contract PCM is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 44_444_444_444 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = _tTotal / 5_00;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = address(0xDA858c107a82A8E4ad1bc0D3192a780865A03C6d);

    string private constant _name = "PEPE CREATOR MATT FURIE";
