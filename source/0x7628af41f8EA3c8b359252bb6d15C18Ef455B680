...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x803c3038EE461f5c182d8a442DCfded046fD24dD; 
...
contract ELONPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "ELON PEPE";
    string private _symbol = "ELPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x803c3038EE461f5c182d8a442DCfded046fD24dD);
    address payable public teamWalletAddress = payable(0x803c3038EE461f5c182d8a442DCfded046fD24dD); 
