...
contract InfinityRIZE is Context, IERC20, Ownable {
    ...
    string private _name = "InfinityRIZE | InfinityRize.com";
    ...
    uint256 public maxTxAmount = (_tokenTotal * 1) / 1000;

    uint256 public minTokensBeforeSwap = 500000 * 10**18;
    ...
    function setMaxTxAmount(uint256 _txNumerator, uint256 _divisor) external onlyOwner() {
        ...
        maxTxAmount = (_tokenTotal * _txNumerator) / _divisor;
    }
