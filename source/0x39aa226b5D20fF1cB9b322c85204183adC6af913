...
contract BTC is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxLimitSize = _tTotal; 
    uint256 public _maxWalletLimitSize = _tTotal; 
    ...
    address payable public developmentWallet = payable(0x30E09c140667d686bB288723f22606D30EBcAB57);
    address payable public marketingWallet = payable(0x30E09c140667d686bB288723f22606D30EBcAB57);
    ...
    function openTrading() external payable onlyOwner {
        require(!_active_trading,"trading is already open");
