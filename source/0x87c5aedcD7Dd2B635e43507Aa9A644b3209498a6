...
Telegram : https://t.me/darkbscchatofficial
...
contract $DARKBSC is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6418E4772055F5dDb214B0c247585F82e2B1F153;

    string private constant _name = "DARK BSC CHAT";
    string private constant _symbol = "DARK BSC";
