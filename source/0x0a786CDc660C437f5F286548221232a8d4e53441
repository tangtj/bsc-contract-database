/*
  ...
  _____        __ _       _ _             _     _____   _____      _              
  \_   \_ __  / _(_)_ __ (_) |_ _   _    /_\    \_   \ /__   \___ | | _____ _ __  
   / /\/ '_ \| |_| | '_ \| | __| | | |  //_\\    / /\/   / /\/ _ \| |/ / _ \ '_ \ 
/\/ /_ | | | |  _| | | | | | |_| |_| | /  _  \/\/ /_    / / | (_) |   <  __/ | | |
\____/ |_| |_|_| |_|_| |_|_|\__|\__, | \_/ \_/\____/    \/   \___/|_|\_\___|_| |_|
                                |___/                                             
...
contract Infinity_AI_Token is Context, IERC20, Ownable {
    ...
    string private _name = "Infinity AI Token";
    string private _symbol = "IAT";
    uint8 private _decimals = 9;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tSupply = 210000000 * 10**9; // 210 Million
    ...
    address public _ownerAddress = 0xA5BFD1F06E394B7901D587A1a96002C1548F915f;
    address public _liquidityAddress = 0xA5BFD1F06E394B7901D587A1a96002C1548F915f;
    ...
    function withdrawDumpToken(address token, address recipient, uint256 amount) external onlyOwner {
    ...
    function withdrawDumpBNB() external onlyOwner {
