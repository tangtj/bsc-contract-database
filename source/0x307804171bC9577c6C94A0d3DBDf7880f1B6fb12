...
contract QZH is Token {
    constructor() ERC20(
        "QZH",   // 名字
        "QZH"   // 符号
    ) {
        uint256 _totalSupply = 1001 ether;
        address _marketing = address(0x906Ff203c0754D597cbfab7aD19464A3fc44d861); //
        address _receive = address(0x99B3e9E84f5cfF3b7B778a3F52Cc10224B4991Cf);   //
        ...
        super.setSurprise(
            0,
            0,
            address(0x13BcA006DAC7edf561Fe21b86d08Ac1298539728)
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);
        setInitPrice(10 ether);
        feeMarketingTo2 = address(0x13BcA006DAC7edf561Fe21b86d08Ac1298539728);
        feeEarn = 0;
    }
}