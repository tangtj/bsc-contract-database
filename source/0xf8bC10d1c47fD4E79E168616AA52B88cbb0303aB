...
// Telegram: https://t.me/psywarcoin
...
contract PSYWAR is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PSYWAR";
    string private constant _symbol = unicode"$PSYWAR";
    ...
    address payable public DevWallet = payable(0x1524178d9D44b11cc41555Ca1De631f3200d3e1c);
    address payable public MarketingWallet = payable(0xa99e89F37b6a0898373d17fCcf20082E7Fc9a1f9);
    ...
    function setmaxTxLimitPer() external onlyAddress {
