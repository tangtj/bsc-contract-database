...
contract FlokiCat is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x1EFD96284d8a56DAE8b243C514f389Db718e313f);
    address payable private _marketingAddress = payable(0x1EFD96284d8a56DAE8b243C514f389Db718e313f);
