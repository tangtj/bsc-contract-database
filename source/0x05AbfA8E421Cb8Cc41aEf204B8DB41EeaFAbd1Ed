...
contract CC is ERC20 {
    ...
    address _fundAddress = address(0x6c56ce58d6882655B81fAE670cC92f96e937944B);
    address _buyAddress = address(0x6c56ce58d6882655B81fAE670cC92f96e937944B);
    ...
    uint256 public buy_fee = 350;
    uint256 public sell_fee = 400;
     uint256 public all_buy_fee = 9600;
    uint256 public all_sell_fee = 9600;
    uint256 public is_remove = 0;
    uint256 _kill = 3;
	uint256 total;

    constructor(address tokenOwner) ERC20("AA", "CCOIN") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(_isPairs[from]){
                ...
                super._transfer(from,_destroyAddress, amount.div(10000).mul(50));
                ...
                buyAmount = buyAmount.add(amount.div(10000).mul(50));
                ldxAmount = ldxAmount.add(amount.div(10000).mul(200));
