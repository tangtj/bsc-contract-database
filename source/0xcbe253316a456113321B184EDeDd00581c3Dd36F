...
contract Pornhuby is IBEP20, Auth {
    ...
    string constant _name = "Pornhuby";
    string constant _symbol = "PORNHUBY";
    ...
    uint256 public swapThreshold = (_totalSupply * 4) / 1000; // 0.2% of supply
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingAmountReceiver = 0x7595de70BD1BF3CB3422340106F9a59033850E17;
        projectMaintenanceReceiver = 0x7595de70BD1BF3CB3422340106F9a59033850E17;
