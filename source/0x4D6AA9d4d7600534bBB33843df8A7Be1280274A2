/**
Telegram: https://t.me/Rocket2049
*/
...
contract Rocket2049 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ROCKET2049";
    string private constant _symbol = "$ROCK2049";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xf5eEE244bcd47c3cA4d4fa6A5E96Cd6B6fbD8000);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xfdD237b834c9b70598B10EBcDB6d892B16A46297] = true;
