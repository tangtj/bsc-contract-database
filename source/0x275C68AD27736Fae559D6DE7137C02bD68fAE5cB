 ...
 * Powered By BlazeX Contract Creator - This Contract is safe has no hidden malfunctions - Create your own Contract with blazex.org 
  ...
  *——————————————————
  *
  * Description: This crypto is for people who want to spread love. 2% taxes half reflection half burning
  * Website: N/A
  * Twitter: N/A
  * Telegram: N/A
  *
...
contract CustomToken is Context, IERC20, Ownable {
    ...
    string private _name="Ale BlazeX FanClub";
    string private _symbol="ALE";
    uint8  private _decimals=18;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 6900000000000 * (10 ** _decimals);
    uint256 private _tTotalSupply = 6900000000000 * (10 ** _decimals);
    ...
    uint256 public maxTransactionAmountBuy=276000000000.000000000000000000 * (10 ** decimals());
    uint256 public maxTransactionAmountSell=276000000000.000000000000000000 * (10 ** decimals());

    
    uint256 public maxWalletAmount=276000000000.000000000000000000 * (10 ** decimals());
    ...
    uint256 public swapTokensAtAmount=621000000.000000000000000000 * (10 ** decimals());
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        if(liquidityFeeonBuy > 0 || liquidityFeeonBuy > 0 || burnFeeOnBuy > 0 || burnFeeOnSell > 0){
