...
contract TRUMPXTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Trump Army";
    string private _seitokensymbol = "TRUMPX";
    address public edaaka18;
