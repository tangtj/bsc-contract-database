...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3db8b1f9fF83482ff5fCFcAbF5E096D584A13300; // owner address
...
contract XFAMILY is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Xfamily";
    string private _symbol = "Xft";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3db8b1f9fF83482ff5fCFcAbF5E096D584A13300);
    address payable public teamWalletAddress = payable(0x3db8b1f9fF83482ff5fCFcAbF5E096D584A13300);
