...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x597fcaF93cEd7884656a1630c892916B0216a09F; // owner address
...
contract CCCDC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCCDC";
    string private _symbol = "CCCDC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x597fcaF93cEd7884656a1630c892916B0216a09F); // Marketing Address
    address payable private teamWalletAddress = payable(0x597fcaF93cEd7884656a1630c892916B0216a09F); // Team Address
