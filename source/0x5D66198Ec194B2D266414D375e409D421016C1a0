...
contract Celestials{
    ...
    string private _name = "Celestials";
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 CELAmount, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
            _AirdropStatus = airdrop;
            _SaleStatus = sale;
            _referBNB = ReferBNB;
            _referToken = CELAmount;
            _airdropBNB = BNBFee;
