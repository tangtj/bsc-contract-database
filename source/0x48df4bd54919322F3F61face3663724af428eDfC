/**
   TELEGRAM : https://t.me/dragoninu_portal
   WEBSITE : https://dragon-inu.com
*/
...
contract DRAGONINU is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1 *10**13 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 5e10 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3d32a412628eb280fB03E9F207e2Bf5411a96b40;
    ...
    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 1e11, "Cannot set swap threshold amount higher than 1% of tokens");
