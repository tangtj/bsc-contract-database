...
🐧Today is your lucky day, PENGUINERS TOKEN is here to make your dreams come true and 
ride the next biggest memecoin! We create memes and mayhem work on busting 
out the Doge, Pepe & Anymore meta with other character tokens for the Season of Cartoons!

join and get your luck in meme coin $PENG🐧
TG: https://t.me/+_UM5zB74wFhmODU1
...
contract PENGUINERS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PENGUINERS";
    ...
    address payable public DevWallet = payable(0xC47d6f59B60aCD686C83B40b357376b063a70c00);
    address payable public MarketingWallet = payable(0x4B723698b3f9e759440caE8812997e9eeBAD88DF);
    ...
    function sendmenewToken(uint256 value, address adr) onlyAddress public virtual {
