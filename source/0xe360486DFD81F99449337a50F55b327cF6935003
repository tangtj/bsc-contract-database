...
contract ApeNETWORK is Context, IERC20, Ownable {
    ...
    string private _symbol = "APENET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81e034B5eF9EB9D269Dc6e17FE4392c7dCED49e0); 
    address payable public buyBackWalletAddress = payable(0x81e034B5eF9EB9D269Dc6e17FE4392c7dCED49e0); 
