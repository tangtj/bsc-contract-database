...
contract SHIBAFEG is IBEP20, Ownable
{
    ...
    string private constant _name = 'SHIBAFEG';
    ...
    uint256 public  balanceLimit = 350000000 * 10**_decimals;
    uint256 public  sellLimit = 20000000 * 10**_decimals;
    uint256 public  buyLimit = 250000000 * 10**_decimals;
