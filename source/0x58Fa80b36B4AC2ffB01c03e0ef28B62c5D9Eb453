...
contract SpaceButterfly is ERC20,Ownable {
    ...
    address public nftAddr =0xb5F9F74C1bc9AEB793927922FB818F8368588d68;
    address public market = 0x996b0Fc29350F77aBb9D9052BbBf3f2635c06EA8;
    ...
    constructor() ERC20("Space Butterfly", "SPB") {
        ...
        ssrDividends = new NftDividendDistributor(USDT, address(this), nftAddr, 1, 17500e18);
        srDividends  = new NftDividendDistributor(USDT, address(this), nftAddr, 2, 8750e18);
        rDividends   = new NftDividendDistributor(USDT, address(this), nftAddr, 3, 3500e18);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (sender == uniswapV2Pair || recipient == uniswapV2Pair) {
            ...
            if(launchBlock + 600 > block.number){
                ...
                super._transfer(sender, market, _tax);
...
contract LPRewardProcessor is Ownable {
    ...
    uint256 public holderRewardCondition = 200 * 1e18/1000;
