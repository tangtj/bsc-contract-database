...
// TELEGRAM : https://t.me/ELONKILLZUCK
...
contract ELONKILLZUCK is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON KILL ZUCK"; 
    string private constant _symbol = "KILL";     
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xfc4231371e43A1e31430D161cFcb9bd1Ba5eb75B;
