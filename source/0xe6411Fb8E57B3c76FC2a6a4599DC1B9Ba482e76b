...
contract NoneBNB is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf598F45F5A3d75Fd2A2BBE451be0eF56DC5f28D1); 
    address payable public Wallet_Dev = payable(0xf598F45F5A3d75Fd2A2BBE451be0eF56DC5f28D1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "NONE BNB"; 
    string private constant _symbol = unicode"$NONE"; 
    ...
    constructor () {
        _owner =0xf598F45F5A3d75Fd2A2BBE451be0eF56DC5f28D1;
