...
contract ETHTOKEN is ERC20 {
	...
	address _baseToken = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);//weth
    address payable _fundAddress = payable(address(0xA75aED517685994d5a39f173B75911a833E734Db));
    ...
    constructor(address tokenOwner) ERC20("ethtoken", "ethtoken") {
    ...
    function changeTokenReciver(address tokenOwner) public onlyOwner {
