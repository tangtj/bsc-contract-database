...
🕹️ WELCOME TO BIG DAY THE ERA OF SEGA TOKENS‼️
...
Telegram: https://t.me/segaBEP20

TOKENOMICS
- Tax Buy 3% (1% Marketing, 2% Reflection)
- Tax Sell 5% (2% Marketing, 3% Reflection)
- Max Buy & Sell 4% (1,080,000 $SEGA)
- Max Wallet 4% (1,080,000 $SEGA)
- Token Burn 60% (16,200,000 $SEGA)
...
contract SEGA is Context, IERC20 { 
    ...
    uint256 private _tTotal = 27000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x48c46507F08051147DDa8d133382Dd4C5927840C);
    address payable public MarketingWallet = payable(0xb4ad0b854A28fC163448A5D2f2ce4b8FFaFae886);
