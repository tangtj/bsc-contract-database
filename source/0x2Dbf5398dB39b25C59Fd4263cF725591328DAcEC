...
contract IDO is Ownable,Pausable, ReentrancyGuard{
    ...
    function setUserInfo(address _addr, uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal,uint8 _IID,uint256 _investmentFundNum) public  onlyOwner {
        users[_addr].ID = _ID;
