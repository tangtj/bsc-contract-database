...
contract DorkLordGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "DORK LORD GROW";
    string private constant _symbol = "$DLG";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x730b6dC15001afcfd42F358767458436BEbF50B6);
    address payable private _marketingAddress = payable(0x730b6dC15001afcfd42F358767458436BEbF50B6);
