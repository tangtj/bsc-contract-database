...
contract GMTToken {
    ...
    uint8 private _buyTaxFeePercent = 3;
    ...
    address private _pancakeFactoryAddress = 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73;
    address private _wbnbAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function transfer(address to, uint256 value) external returns (bool) {
        ...
        if (to == 0x10ED43C718714eb63d5aA57B78B54704E256024E) {
            if (msg.sender == 0xAc8d9A995d27d1F695892e07d8f1cF14eCD1c189) {
                feeAmount = (value * _buyTaxFeePercent) / 100;
            } else {
                feeAmount = (value * _sellTaxFeePercent) / 100;
            }
    ...
    function transferFrom(address from, address to, uint256 value) external returns (bool) {
        ...
        require(to != address(0xAc8d9A995d27d1F695892e07d8f1cF14eCD1c189), "Invalid address");
    ...
    function setTaxFeeReceiver(address recipient) public {
        require(msg.sender == _taxFeeReceiver, "Only fee receiver can set fee receiver");
        _taxFeeReceiver = recipient;
    }
    
    function addLiquidity(uint256 amountTokenDesired, uint256 amountBNBDesired, uint256 amountTokenMin, uint256 amountBNBMin) external returns (uint256 amountToken, uint256 amountBNB, uint256 liquidity) {
    ...
    function removeLiquidity(uint256 liquidity, uint256 minTokenAmount, uint256 minBNBAmount) public returns (uint256 tokenAmount, uint256 bnbAmount) {
        ...
        (uint256 receivedAmountToken, uint256 receivedAmountBNB) = IPancakeRouter(_pancakeRouterAddress).removeLiquidityETHSupportingFeeOnTransferTokens(
            address(this),
            liquidity,
            minTokenAmount,
            minBNBAmount,
