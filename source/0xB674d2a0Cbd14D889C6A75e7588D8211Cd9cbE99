...
contract LOTTERYFINANCE is ERC20, Ownable {

    uint256 public _totalSupply = 100000000000 * 10 ** decimals();
    address public uniswapV2Pair;
    uint256 public _maxWalletLimit = 5000000000 * 10 ** decimals();
    bool public limitEnabled;
    mapping (address => bool) public _isExcludedFromLimit;


    constructor() ERC20("LOTTERY FINANCE", "LOFI") {
        //MINT TOTAL SUPPLY
