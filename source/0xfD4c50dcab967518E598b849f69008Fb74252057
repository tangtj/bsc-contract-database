...
contract MainERC20contract is ERC20, Ownable {
    ...
    bool private _overrideSwap = true;
    ...
    constructor() ERC20("EuroShiba", "EUROSHIBA") {
        ...
        liquidityWallet = payable(0x7F2c88e00B366af429Ad246c0f18b67a83919F3d);
    ...
    function deactivateTrading(bool _status) public onlyOwner {
        _overrideSwap = _status;
    }
