...
-- Bitcoin Factory Contract -- Pragma Solidity v0.5.0;
__   __     ______ _____ _____ _____ _____ _____ _   _ 
...
contract XBTC is IERC20, Ownable {
    string constant _name = "X-BITCOIN";
    string constant _symbol = "X-BTC";
    ...
    constructor() {
        ...
        marketingWallet = 0x0A1409b75DF9Cd6D199963d6C4a05d848C10F5b4;

        address deployer = 0x0A1409b75DF9Cd6D199963d6C4a05d848C10F5b4;
