// Tg: https://t.me/thecokeproject
// Twitter: https://x.com/thecokeproject/
// Web: https://www.thecokeproject.site/
...
contract THECOKE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "THECOKE";
    string private constant _symbol = unicode"$COKE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 51000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xDB1bbbdad89D5C242DAE7180C03A2d275dE6b306);
    address payable public MarketingWallet = payable(0x4918832638c2ABa11CC959035D024eC3f0290728);
