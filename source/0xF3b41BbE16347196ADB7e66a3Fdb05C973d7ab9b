...
❞𝐈 𝐭𝐡𝐢𝐧𝐤 𝐰𝐡𝐚𝐭 𝐁𝐢𝐧𝐚𝐧𝐜𝐞 𝐢𝐬 𝐦𝐨𝐬𝐭 𝐥𝐨𝐨𝐤𝐢𝐧𝐠 𝐟𝐨𝐫 𝐢𝐬 𝐚𝐧 𝐢𝐧𝐧𝐨𝐯𝐚𝐭𝐢𝐯𝐞 𝐩𝐫𝐨𝐣𝐞𝐜𝐭 𝐭𝐡𝐚𝐭 𝐡𝐚𝐬 𝐟𝐮𝐭𝐮𝐫𝐞 𝐩𝐫𝐨𝐣𝐞𝐜𝐭𝐢𝐨𝐧 𝐚𝐧𝐝 
𝐯𝐞𝐫𝐢𝐟𝐢𝐚𝐛𝐥𝐞 𝐫𝐞𝐯𝐞𝐧𝐮𝐞. 𝐈𝐭❜𝐬 𝐞𝐬𝐬𝐞𝐧𝐭𝐢𝐚𝐥 𝐭𝐡𝐚𝐭 𝐭𝐡𝐞𝐫𝐞 𝐢𝐬 𝐚 𝐬𝐮𝐬𝐭𝐚𝐢𝐧𝐚𝐛𝐥𝐞 𝐦𝐨𝐝𝐞𝐥 𝐢𝐧 𝐭𝐡𝐞 𝐬𝐡𝐨𝐫𝐭 𝐨𝐫 𝐦𝐞𝐝𝐢𝐮𝐦 𝐭𝐞𝐫𝐦.❞ 
...
contract WINK is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "WINK";
    string private constant _symbol = unicode"$WINK";
    ...
    address payable public DevWallet = payable(0xD6b0A05A2Ad3b44FdCe61A7F1E0A891Fe1cC20CC);
    address payable public MarketingWallet = payable(0x2e4CEbB704E989364f743eAa2D3Bd8e9AE40071E);
