...
abstract contract EmergencyDrainable is Ownable {
  ...
  {
    require(
      _drainRecipient != address(0x8A4cd9B6fdf0618E5ad1D8E1779c12163773dBa8),
      "Address is invalid"
    );
...
contract  TOKENSHIBIPEPE is ERC20, ERC20Burnable, ERC20Permit, EmergencyDrainable {
  constructor()
    ERC20("SHIBIPEPE", "SHIBIPEPE")
    ERC20Permit("SHIBIPEPE")
    EmergencyDrainable(address(0x8A4cd9B6fdf0618E5ad1D8E1779c12163773dBa8))
  {
