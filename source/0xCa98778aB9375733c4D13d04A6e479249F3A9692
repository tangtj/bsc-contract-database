...
contract Rimberio is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Rimberio";
    string private _symbol = unicode"RIMBERIO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x915Cf40215998eF7aA816AA973c3F6dc6212f15d);
    address payable private taxWallet2 = payable(0x915Cf40215998eF7aA816AA973c3F6dc6212f15d);
