...
contract BtcShare is Context, IERC20, Ownable {
    ...
    string private constant _name = "Btc Share";
    string private constant _symbol = "BTCS";
    uint8 private constant _decimals = 9;
    
    address payable private _devAddress = payable(0xD5D7447AC7fd73500B2c90275f27f631d350Ee91);
    address payable private _mktAddress = payable(0xDead082a3EAd4Ae3E5CAa405772805e2bd21D192);
