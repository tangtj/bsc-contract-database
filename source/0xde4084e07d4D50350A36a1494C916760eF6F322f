...
contract RealSmurfCat is Context, IERC20, Ownable {
    ...
    string private _name = "Real Smurf Cat";
    string private _symbol = unicode"шайлушай";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcA1EBb2F4fD6C8C80e228465979DCd96c79e2D35); // Marketing Address
    address payable public buybackWalletAddress = payable(0xcA1EBb2F4fD6C8C80e228465979DCd96c79e2D35); // Buyback Address
