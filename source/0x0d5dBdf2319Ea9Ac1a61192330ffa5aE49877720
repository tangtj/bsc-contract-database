...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x844218B2E451408120C6f8DaDA5b2Fc9180a83EE; // owner address
...
contract Token2044 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "2044";
    string private _symbol = "2044";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x844218B2E451408120C6f8DaDA5b2Fc9180a83EE); // Marketing Address
    address payable private teamWalletAddress = payable(0x844218B2E451408120C6f8DaDA5b2Fc9180a83EE); // Team Address
    ...
    uint256 public _walletMax = 160 * 10**_decimals;
