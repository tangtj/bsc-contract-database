...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 10 * 1e6 * 1e18; //must hold 10,000,000+ tokens
    }
...
contract CongregoBNB is ERC20, Ownable {
    ...
    constructor() ERC20("CongregoBNB", "CGO"){
        address newOwner = address(0x5d75595d9E68622c345293B346F1692eDE1543a7); // update to 0x5d75595d9E68622c345293B346F1692eDE1543a7
    	...
    	marketingWallet = address(0x04f0229d5E297f928944A23a52229D030Cf5ee57); // set as marketing wallet
        charityWallet = address(0x87b640695F5F2e63E4904061d22e7d1de6EC1ba4); // set as charity wallet
        liquidityWallet = address(0xbd1ebA43856b50Fee16Cb9cE79BeA1af9dA3F574); // set as liquidity wallet
