/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Liq combine together to creat LightGate designed
    
    I make this #LightGate to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/lightgatebsc
  ...
  100% SAFE NO RUG.
   ...
   500,000,000,000,000 LightGate max limit for per trade
...
contract LightGate is Context, IERC20, Ownable {
    ...
    string private _name = "LightGate";
