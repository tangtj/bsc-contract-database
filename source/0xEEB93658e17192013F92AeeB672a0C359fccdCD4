...
interface IERC20 {
    ...
    /**
     * @dev Moves `amount` tokens from the caller's accoun t to `recipient`.
     *
...
contract Relfecto is IERC20, Ownable {
    ...
    constructor () {
        ...
        devFeeReceiver = 0x312B4d627b803067AFDc520ce9329e9B3C21f22b;
        marketingFeeReceiver = 0x312B4d627b803067AFDc520ce9329e9B3C21f22b;
