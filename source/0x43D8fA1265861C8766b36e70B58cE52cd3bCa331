...
contract SuperBunny is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SUPER BUNNY";
    ...
    address payable public DevWallet = payable(0xAFb0D21179cE24bBfEaA570d72BC6dcd098067C5);
    address payable public MarketingWallet = payable(0xe28636d44fCC7e882Ddb7e781Abc6CB64C2684fC);
