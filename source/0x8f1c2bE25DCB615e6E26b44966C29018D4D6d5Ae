/**
 *Telegram : https://t.me/cheemspepeinuportal
 *Website  : https://cheemspepeinu.com
 *Twitter  : https://twitter.com/cheemspepeinu
 *Official Email : developers@cheemspepeinu.com
 *Minting Our V1 Nft : https://cheemspepenft.netlify.app/
*/
...
contract CheemsPepeInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CheemsPepeInu";
    ...
    uint256 public NFTJackpotFee   = 2;
    uint256 public burnFee         = 0;
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + burnFee + NFTJackpotFee;
    ...
    address public NFTJackpotFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9B6CD8d55e26aC9ED05060B2dcD181F035Ee26Da;
        teamFeeReceiver = 0x59A8B317323421ab375E619e16a98b6Df1c07eC7;
        NFTJackpotFeeReceiver = 0xE2b47A566Db9FE6C7AB7fC713D9c7B8635992d25;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBNFTJackpot = amountBNB.mul(NFTJackpotFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
        (tmpSuccess,) = payable(NFTJackpotFeeReceiver).call{value: amountBNBNFTJackpot, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _NFTJackpotFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        NFTJackpotFee = _NFTJackpotFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _burnFee + _NFTJackpotFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _NFTJackpotFeeReceiver ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        burnFeeReceiver = _burnFeeReceiver;
        NFTJackpotFeeReceiver = _NFTJackpotFeeReceiver;
    }
