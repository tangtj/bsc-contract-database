...
- 100% liquidity was burned 4ever.
- 50% total supply was burned 4ever.
- 2% of each transaction distributed to tokenholders.
- 50% of every transaction is burned 4ever.
- 100% decentralized and community owned.
...
contract CAPS is Context, IERC20, Ownable {
    ...
    string private _name = 'Binacaps';
    string private _symbol = 'bCAPS';
