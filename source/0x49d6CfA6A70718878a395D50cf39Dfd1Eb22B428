...
contract PEPE is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public sellMarketingFee = 8;//4% Marketing, 2% Dev, %2 Buyback and Burn
    uint256 public buyMarketingFee = 8;//4% Marketing, 2% Dev, %2 Buyback and Burn
    uint256 private marketingFee;
  

    address payable public marketingaddress = payable(0x3c15dEC2132195cE990E19010e53271E7613b0CC);
    ...
    constructor () BEP20Detailed("PEPE", "PEPE", 18) {
      _owner = msg.sender ;
    ...
    function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee) external onlyOwner {
        require(updatedBuyMarketingFee <= 12, "Buy fee should be less than 12%");
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 12, "Sell fee should be less than 12%");
