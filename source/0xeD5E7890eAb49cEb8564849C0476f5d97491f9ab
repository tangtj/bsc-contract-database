...
/**
   ...
   Welcome to Hyper Safu
   
   This is a community token. If you want to create a telegram I suggest to name it to @HyperSafu
   ...
   I will renounce the ownership to burn addresses to transfer #HyperSafu to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #HyperSafu 10000X? 
   ...
   it's the best part of the #HyperSafu idea, increasing the liquidity pool automatically, 
...
contract HyperSafu is Context, IERC20, Ownable {
    ...
    string private _name = "HyperSafu";
    string private _symbol = "HyperSafu";
