...
/*
tg : https://t.me/PepeVsPepeBSC
twitter : https://twitter.com/PepeVsPepeBSC
website : https://pepevspepebsc.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x9E07f1EB6cf2463e6fBaA9Ca42209DaD6985b40c; // owner address
...
contract PePe is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe Vs Pepe";
    string private _symbol = "PePe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x44434a3e73819Bfb1EDB0680B9B24fACD8Ec7980); 
    address payable public teamWalletAddress = payable(0xEDe209Aea0d79Fd3934799580BFA1fc994863D9D);
    ...
    uint256 public _maxTxAmount = _totalSupply / 49; 
    uint256 public _walletMax =   _totalSupply / 25;
