// https://pawtokenbsc.com/

// https://t.me/pawtokenbsc

// https://twitter.com/pawtokenbsc
...
contract PAWTOKEN is Ownable, ERC20 {
    ...
    address constant DEV = 0x987bf640a1B595b4f3defD45C93cb00c2FDF42ea;
    

    string constant _name = "PAW TOKEN";
    string constant _symbol = "PAWTKN";
    ...
    // max tx is 10,000,000 pawtoken
    uint256 public _maxTxAmount = _totalSupply.mul(1).div(100);
    // max token holding per wallet is 20,000,000 pawtoken
    ...
    uint256 private burnFee         = 2; // 2% goes to dead wallet and burns forever 
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xaD632EE01fB0DdA69A3fB7e55fA4cDA69FC8B3e9; // marketing wallet
        devFeeReceiver = DEV;
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function setWalletExcemptFee(address _wallet, bool Excempt) external onlyOwner {
        isexemptfromfees[_wallet] = Excempt;
        emit user_exemptfromfees(_wallet, Excempt);
    }
