// https://t.me/GoldGirlToken
// https://twitter.com/yourichforever
// https://wowthing.fun/game-web/index.html
...
contract GoldGirlToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gold Girl Token";
    string private constant _symbol = unicode"GGTK";
