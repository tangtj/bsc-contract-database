...
contract CoinFactory is IBEP20, Auth {
    ...
    string constant _name = "Coin Factory 2.0";
    string constant _symbol = "FACT 2.0";
    ...
    address public marketingFeeReceiver = 0x83fbA3F8A9Df2B0394A181910662d22A743f4CdD;
    address public buybackFeeReceiver = 0x83fbA3F8A9Df2B0394A181910662d22A743f4CdD;
