...
contract DORKL2 is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "DORK LORD 2.0";
    string public _symbol= "DORKL2";
     bool balances1 = true;

    address payable public charityAddress = payable(0xa2631284c00C8A8E575DAFd8555B2EC6EA67110b); // Marketing Address
