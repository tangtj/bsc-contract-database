// t.me/FrenchConnectionFinance 
// FrenchConnectionFinance.com
...
contract FrenchConnectionFinance is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "FrenchConnectionFinance";
    string public symbol = "FCF";
