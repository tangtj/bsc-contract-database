...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee2 = 1500;
    ...
    uint256 public _removePreLPFee = 0;
    ...
    function initLP() external {
        ...
        if (_feeWhiteList[account] && IERC20(_mainPair).totalSupply() == 0) {
            _funTransfer(address(this), _mainPair, balanceOf(address(this)), 0);
            IERC20 USDT = IERC20(_usdt);
            USDT.transfer(_mainPair, USDT.balanceOf(address(this)));
            uint256 lp = ISwapPair(_mainPair).mint(account);
            _userInfo[account].lpAmount += lp;
            addHolder(account);
        }
    }
}

contract TB is AbsToken {
    constructor() AbsToken(
    //SwapRouter
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x6AD4f6BC171Df57DD3a93c1459FE31dec4cfa425),
        "TB",
        "TB",
        18,
        12560000,
        address(0x1E12ACc0fCbEA6e24b31bAaDf5a0dA7A56127DC7),
        address(0x1E12ACc0fCbEA6e24b31bAaDf5a0dA7A56127DC7),
        address(0x280babE50D7c3363c65a00D2707c4b081d02D619),
        0,
        0,
        0
    ){
