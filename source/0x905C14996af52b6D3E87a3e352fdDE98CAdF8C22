...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF4bAF8B7509756b65c22E7baCaEE556f78d68f02; // owner address
...
contract CalPep is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CalciumPepe";
    string private _symbol = "CALPEP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC51a1a463A739b568efC5A3046c1C90557Fab13A); // Marketing Address
    address payable private teamWalletAddress = payable(0xC51a1a463A739b568efC5A3046c1C90557Fab13A); // Team Address
