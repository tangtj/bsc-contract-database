...
contract Flokixbscc is IBEP20, Auth {
    ...
    string constant _name = "Floki X";
    string constant _symbol = "Floki X";
    ...
    address private marketingFeeReceiver = 0x160aC5723626549eEAf8Ca49FF1cA718177a49b2;
    address private buybackFeeReceiver =   0x160aC5723626549eEAf8Ca49FF1cA718177a49b2;
