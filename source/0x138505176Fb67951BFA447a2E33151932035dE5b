...
contract $LUNAW is ERC20, Ownable {
    ...
    address public marketingWallet = 0xfF8F224f5213403015aab9a6e72AdC4c8C08D613;
    address public devWallet = 0x041B605B74164df2586D261b5D7F60f9bE4f3C14;
    address private gamedevWallet = 0x041B605B74164df2586D261b5D7F60f9bE4f3C14;
    ...
    Taxes public taxes = Taxes(3, 1, 0, 2);
    Taxes public sellTaxes = Taxes(3, 1, 0, 2);
    ...
    constructor(address routerAdd) ERC20("Luna Warrior", "$LUNAW") {
