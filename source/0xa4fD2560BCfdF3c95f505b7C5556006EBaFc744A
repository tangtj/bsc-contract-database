...
// File @openzeppelin/contracts/access/IAccessControlEnumerable.sol@v4.3.1
...
// File @openzeppelin/contracts/access/AccessControlEnumerable.sol@v4.3.1
...
// File contracts/pool/ETHSTPoolV2.sol
...
/**
 * @title ETHST Pool V2 Contract
 * @author ETHST-TEAM
 * @notice This Contract Stake ETHST to Harvest ET and ETH
 */
contract ETHSTPoolV2 is AccessControlEnumerable {
    using EnumerableSet for EnumerableSet.AddressSet;

    IERC20 public ethstToken;
    IET public etToken;
    ...
    uint256 public ethReleaseSpeed = 9722222222222;
    uint256 public releasedETH;
    uint256 public harvestedETH;
    uint256 public airdropedETH;
    uint256 public lastAirdropedETH;
    ...
    /**
     * @param ethstAddr Initialize ETHST Token Address
     * @param etAddr Initialize ET Token Address
     * @param ethAddr Initialize ETH Token Address
    ...
    constructor(
        ...
        ethstToken = IERC20(ethstAddr);
        etToken = IET(etAddr);
        ethToken = IERC20(ethAddr);
    ...
    /**
     * @dev Set ETH Release Speed
     */
    function setETHReleaseSpeed(uint256 _ethReleaseSpeed)
        external
        onlyRole(MANAGER_ROLE)
    {
        ethReleaseSpeed = _ethReleaseSpeed;
    }
     ...
     * @dev Airdrop ETH
     */
    function airdropETH(uint256 amount, uint256 releaseSeconds)
        external
        onlyRole(MANAGER_ROLE)
    {
        ...
        ethReleaseSpeed = amount / releaseSeconds;

        airdropedETH += amount;
        lastAirdropedETH = amount;
