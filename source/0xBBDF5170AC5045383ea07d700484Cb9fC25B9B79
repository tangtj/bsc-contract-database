...
//WELCOME! LET'S MAKE BSC MEME GOOD AGAIN 
//https://t.me/HPBCW999INU
//IF YOU ARE PEANUT SELLER BETTER NOT BUY BECAUSE WE WILL MOON THIS TO 100K MC
...
contract HarryPotterBogdanoffChadWojak999Inu  is Context, IERC20 { 
    ...
    string private constant _name = "HarryPotterBogdanoffChadWojak999INU"; 
    string private constant _symbol = unicode"HBCW999I"; 
