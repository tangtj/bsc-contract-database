...
contract SuperMarioPorsche911Inu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SuperMarioPorsche911InuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SuperMarioPorsche911Inu", "SILKROAD") {
        marketingWallet = payable(0x8eed3D4e4C6B62A17282b90C6401C8fc6A48eC63);
        devWallet = payable(0x8eed3D4e4C6B62A17282b90C6401C8fc6A48eC63);
        ...
        dividendTracker = new SuperMarioPorsche911InuDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "SuperMarioPorsche911InuTRACKER",
            "SILKROADTRACKER"
        );
...
contract SuperMarioPorsche911InuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SuperMarioPorsche911Inu public SuperMarioPorsche911InuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SuperMarioPorsche911InuContract = SuperMarioPorsche911Inu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SuperMarioPorsche911Inu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SuperMarioPorsche911Inu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SuperMarioPorsche911Inu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SuperMarioPorsche911InuContract);

            uint256 prevBalance = SuperMarioPorsche911InuContract.balanceOf(address(this));
            ...
            {
                uint256 received = SuperMarioPorsche911InuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SuperMarioPorsche911InuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
