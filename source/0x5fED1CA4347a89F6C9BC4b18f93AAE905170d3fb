// t.me/GameStopTokenizedStockDefichain 
// GameStopTokenizedStockDefichain.com
...
contract GameStopTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "GameStopTokenizedStockDefichain";
    string public symbol = "DGME";
