/*
While the popularity of Rage Face memes has waned over the years, they are still considered an iconic part of internet culture and history. THE RAGE FACE COIN WITH THE GUIDANCE OF LORD KEK WILL TRULY MAKE MEMES GREAT AGAIN
...
TG: https://t.me/ragefaecoin
Website : https://rageface.vip/
*/
...
contract RageFaceCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "RageFace Coin";
