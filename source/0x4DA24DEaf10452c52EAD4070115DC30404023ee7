...
contract BEP20 is Context, IBEP20, IBEP20Metadata,Ownable {
    ...
    uint256 public _burnFee = 1000; // 1%
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]){
            ...
            _balances[recipient] += _remainingAmount;
...
contract LinerPowerPoint is BEP20,BEP20Burnable {
    constructor()
        BEP20("Liner Power Point", "LPP", 18) {
            _mint(msg.sender, 2100000000 * (10 ** uint256(18)));
        }
