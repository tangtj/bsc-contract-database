...
contract SupplyShock420StonedDevInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SupplyShock420StonedDevInu";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 1 / 10000; // 0.07%
