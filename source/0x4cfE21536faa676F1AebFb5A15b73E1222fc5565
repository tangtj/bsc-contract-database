...
abstract contract Ownable is Context {
    ...
    address private _feesetter = msg.sender;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0x5BC2de40af4390C141931110edd586B51308F8c4;
        _feesetter = 0x942cD6ee04e09AcFB5131b1cfbeBdb48E56c7c2C;
...
contract PEPEV420 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5BC2de40af4390C141931110edd586B51308F8c4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PEPE 4.20";
    string private _symbol = "PEPE420";
    ...
    function Swapen(bool _enabled) public onlyOwner {
