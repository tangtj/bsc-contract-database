 ...
 ******************    BSCTest 7        xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
contract BSCTest7 is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // BinanceSmartChain Router Compatible CONFIRMED 
    ...
    constructor() ERC20("BSCTest7", "BSCT7") {
        ...
        _mint(address(this), (totalSupply / 100) * 0);
