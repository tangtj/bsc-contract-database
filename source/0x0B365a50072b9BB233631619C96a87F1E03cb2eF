...
contract BronzeCoin is ERC20, Ownable {
    ...
    constructor() ERC20("BronzeCoin", "BRZ") {
        ...
        marketingWallet = address(0xb427993B9E62C65e2aC5AfE33a4EFCF23A4E6b83); // set as marketing wallet
        devWallet = address(0xb427993B9E62C65e2aC5AfE33a4EFCF23A4E6b83); // set as dev wallet
