...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0xb155953d25E8D0Dc1b9c9C6d263cE58a4cc9ef56;
    ...
    {
        require(tax <=4,"Cannot set the fee more than 4%");
        marketingTax = tax;
    }
...
contract DogeBull is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("Doge Bull", "DOGEBULL", 9) {
    _owner = msg.sender;
