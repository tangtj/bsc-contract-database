...
contract ELECTRONEUM is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x627C3aFc42673d282624Be3566cdF8969342feA0;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 111000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Electroneum Token";
    string private _symbol = "ELECTRONEUM";
    ...
    uint256 public _maxTxAmount = 111000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 61000000 * 10**6 * 10**9;
