...
contract jiuliu is Token {
    constructor() ERC20(
        "96",   // 名字
        "96"   // 符号
    ) {
        uint256 _totalSupply = 96000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x819ADD9518eE1e0895aBD204312221E3e7C838AE); //
        ...
        feeMarketingTo2 = address(0x819ADD9518eE1e0895aBD204312221E3e7C838AE);
        feeEarn = 0;
        isLiquified = true;
    }
}