        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xC06ae624856Cd2aC15E014f7a94fE58104151540), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0xD8c654a72dc5aE7294421f2a9f672147B22B9700),//FundAddress
        address(0xC06ae624856Cd2aC15E014f7a94fE58104151540)//ReceiveAddress
    ){
    }
}