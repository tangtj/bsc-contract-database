...
contract nosnetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nos Network";
    string private _symbol = "NNT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x16abe5606C3C4339eBBC1dd3dd1641193bA745E1); // Marketing Address
    address payable public teamWalletAddress = payable(0x8736df6685B03E8970DE59d501213270cA493e78); // Team Address
