...
contract TL is Token {
    constructor() ERC20(
        "TL",   // 名字
        "TL"   // 符号
    ) {
        uint256 _totalSupply = 300000 ether;
        super._mint(_msgSender(), _totalSupply);
    }
    function init() public onlyOwner {
        require(!isLiquified, "already Liquified");
        address _marketing = address(0x716313c88aaE6d5431F14481e1711b0B6C77E6d1); //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x716313c88aaE6d5431F14481e1711b0B6C77E6d1)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x716313c88aaE6d5431F14481e1711b0B6C77E6d1);
        feeEarn = 0;
        isLiquified = true;
    }
}