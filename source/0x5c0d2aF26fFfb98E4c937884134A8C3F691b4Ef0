...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private teamAddress = address(0x99C4E9E2E94a589e61ff91B2FAb1eE19214b56B1);
    ...
    constructor (
        ...
        excludeHolder[0x9DF9FDA7a66733e32e6bba752528d12816770f05] = true;//Pancake ADDRESS
        excludeHolder[0xa36234A163664b54D962a4F06823AA12faa97f3F] = true;//PINKlock ADDRESS
...
contract NUWA is AbsToken {
    constructor() AbsToken(
        ...
        18,
        1000000000,
        address(0xc1bd95387b80693c767F3a3F832cD8CA03B444a2),
        address(0xc1bd95387b80693c767F3a3F832cD8CA03B444a2),
        0
    ){
