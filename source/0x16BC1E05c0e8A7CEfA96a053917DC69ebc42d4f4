...
contract FROGGY is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 21e13 * 10**18; // 0.05%

    uint256 public genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x90F19C711C81F0B8C6cB83529d2a5244028A7B01;
    ...
    constructor() BEP20("Froggy", "FROGGY") {
        _tokengeneration(msg.sender, 420000000000000000 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount <= 210e15,"Swap threshold amount should be lower or equal to 50% of tokens");
    ...
    function updateMarketingWallet(address newWallet) external onlyOwner {
        ...
        require(!isContract(newWallet), "Address cannot be contract");
