...
/**
    After the success of $BHIBA on ETH, we believe that:
    
                   ＢＡＢＹ ＳＵＮ
    
              Needs to be born on BSC! 🚀🚀🚀
              
           １００ ＬＰ ＬＯＣＫ ＦＯＲ ＥＶＥＲ
...
contract Token is IBEP20 {
    ...
    string public override name = "BABY SUN";
    string public override symbol = "BSUN";
