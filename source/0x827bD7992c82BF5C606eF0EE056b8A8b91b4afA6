...
contract WLD20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "WLD2.0";
    string private constant _symbol = "WLD2.0";
    uint8 private constant _decimals = 3;
    
    address payable private _developmentAddress = payable(0x4Ab93B269D74A6e4D19feDa7Ca72a15cE6420d4b);
    address payable private _marketingAddress = payable(0x4Ab93B269D74A6e4D19feDa7Ca72a15cE6420d4b);
