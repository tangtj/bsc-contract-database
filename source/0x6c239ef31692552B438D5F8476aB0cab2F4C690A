/**
Telegram : https://t.me/WatchDogVERIFY
Website :https://watchdog.name
*/
...
contract WATCHDOG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x00e1a44f6616F8b9b544FCF78F0fB389DD732111); 
    address payable private Wallet_Dev = payable(0x00e1a44f6616F8b9b544FCF78F0fB389DD732111);
    ...
    string private constant _name = "Watch Dog"; 
    string private constant _symbol = unicode"WD"; 
    ...
    constructor () {
        ...
        _owner = 0x00e1a44f6616F8b9b544FCF78F0fB389DD732111;
