...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25D9054D0dd9Af0663F7dCF52DBE243380b5A252; // owner address
...
contract NanoisFine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nano Fine";
    string private _symbol = "NanoFine";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x25D9054D0dd9Af0663F7dCF52DBE243380b5A252); // Marketing Address
    address payable private teamWalletAddress = payable(0x25D9054D0dd9Af0663F7dCF52DBE243380b5A252); // Team Address
