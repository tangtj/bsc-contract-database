...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5aEa38DCdff00b0736175A16233d05bD509a5BA9;
...
contract THEXSIGN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6B2c7e9B74F394386810C219267a0CB8Fd5c3796;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "The X Sign";
    string private _symbol = "XSIGN";
