...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD9dF81d25EAcc07C4C4E2aA5682dC6006D135211; // owner address
...
contract Memes is Context, IERC20, Ownable {
    ...
    string private _name = "Meme Land";
    string private _symbol = "MEMES";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2F78eA14aE39387aBf53A4fF6f8d7346838Fb20d); // Marketing Address
    address payable private teamWalletAddress = payable(0x2F78eA14aE39387aBf53A4fF6f8d7346838Fb20d); // Team Address
