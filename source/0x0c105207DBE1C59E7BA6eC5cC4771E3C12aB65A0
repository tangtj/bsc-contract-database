...
contract BURNEUM  is Context, IERC20, Ownable {
    ...
    string private constant _name = "BURNEUM";
    string private constant _symbol = "$BURNEUM";
    ...
    // Owner cannot transfer out  BURNEUM from this smart contract
