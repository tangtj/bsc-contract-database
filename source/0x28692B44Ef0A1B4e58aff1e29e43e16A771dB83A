...
contract Megarium is Context, IERC20, Ownable {
    ...
    string private constant _name = "Megarium";
    string private constant _symbol = "MEGARIUM";
    
    
    uint256 private _taxFeeOnBuy = 50;
    uint256 private _redisFeeOnBuy = 49;
    ...
    address payable private _twddev = payable(0x7A2370601aE16610e372F848506338675441426d);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable private _twdmkt = payable(0x7A2370601aE16610e372F848506338675441426d);
