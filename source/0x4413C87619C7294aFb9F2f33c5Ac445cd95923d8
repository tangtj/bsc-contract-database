...
contract BullCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = 'BullCoin';
    string private constant _symbol = 'BULLCOIN';

    uint256 private _taxFee = 250;
    uint256 private _burnFee = 250;
    uint private _max_tx_size = 75000 * 10 ** uint256(_decimals);
