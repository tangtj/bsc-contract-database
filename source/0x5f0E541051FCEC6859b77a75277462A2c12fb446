...
contract bbdgTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dkkmgn17;
    ...
    string private _tokenname = "baby doge";
    string private _tokensymbol = "bbdg";
