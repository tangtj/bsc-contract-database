...
contract EpaidLaunchpads is Context, IERC20, Ownable {
    using SafeMath for uint256;
    // consts of dev EpaidLaunchpads
    string private constant _name = "Epaid LaunchpadS";
    string private constant _symbol = "EPAIDS";
