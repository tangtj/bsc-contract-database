/**
Telegram : https://t.me/BushiPortal
Website :https://burnshiba.ink
*/
...
contract BURNSHIBA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1607f41eDaF351eFE8BE428a678Feb3B2fD19501); 
    address payable private Wallet_Dev = payable(0x1607f41eDaF351eFE8BE428a678Feb3B2fD19501);
    ...
    string private constant _name = "Burn Shiba"; 
    string private constant _symbol = unicode"BUSHI"; 
    ...
    constructor () {
        ...
        _owner = 0x1607f41eDaF351eFE8BE428a678Feb3B2fD19501;
