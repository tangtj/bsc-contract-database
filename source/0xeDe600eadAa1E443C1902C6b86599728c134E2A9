...
contract AIBTC is ERC20 {
    ...
    address _fund1Address = address(0x358a04D210101A361Ec10E51C37E1Bc604cf7735);
    address _fund2Address = address(0x9e8E291Ddbe20d38d5c715c009A9E1C00608519F);
    ...
    function changeFundAddress(address fund1Address) public {
        require(fund1Address != address(0), "can not set the zero address");
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair){
			...
			if(isDelLdx){
                ...
                if(startTime.add(3 * 3600) > block.timestamp){
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {} else {
			if(_isPairs[from]){
                ...
                super._transfer(from, _fund1Address, amount.div(100).mul(40));
                amount = amount.div(100).mul(60);}else{
                _splitUsdtLdxToken();
    ...
    function swapAndLiquify() private {
		...
		if(allTokenAmount >= 10**15){
            ...
            if(afterAmount > beforeAmount){
                ...
                USDT.transfer(_fund1Address, newAmount.div(55).mul(10));
                USDT.transfer(_fund2Address, newAmount.div(55).mul(10));
                addLiquidityUsdt(newAmount.div(55).mul(25), allTokenAmount.div(55).mul(25));
            }
		}
    }
