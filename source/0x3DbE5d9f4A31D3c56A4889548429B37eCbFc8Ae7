...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0x2f3b3400427C359F9E4559C4F41C6e6e2D254ACa);
...
/* Token contract */
contract BabySuperPancake is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CC =0x2f3b3400427C359F9E4559C4F41C6e6e2D254ACa ; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =0x3e539C693B2D7e249C939614654A2EA16b4DDcb0 ;

    // These are owner by default
    address private autoLiquidityReceiver=0x3e539C693B2D7e249C939614654A2EA16b4DDcb0;
    address private marketingFeeReceiver=0x3e539C693B2D7e249C939614654A2EA16b4DDcb0;

    // Name and symbol
    string constant _name = "Baby SuperPancake";
    string constant _symbol = "SUPERCAKE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launchtokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% tokens
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1%  tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x3e539C693B2D7e249C939614654A2EA16b4DDcb0;
