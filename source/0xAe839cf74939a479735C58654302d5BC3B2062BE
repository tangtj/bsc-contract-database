...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x4768D33cD82fB4a6BCdD84CBC57C8046307E7eb8;
    ...
    {
        require(tax <=2,"Cannot set the fee more than 2%");
        marketingTax = tax;
    }
...
contract OneDoge is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("One Doge", "ONEDOGE", 9) {
    _owner = msg.sender;
