...
/**
Telegram:https://t.me/Barbieinu_portal
*/
...
contract BarbieInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Barbie inu";
    ...
    uint256 public _walletMax =   2070000 * 10**_decimals;
