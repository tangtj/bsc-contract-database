// Welcome to Waverium, the groundbreaking layer 2 blockchain project that rides the waves of innovation.

// Community     : https://t.me/OfficialWaverium
// Website      : https://Waverium.org/
// Twitter      : https://twitter.com/Waverium
...
contract WAVERIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Waverium";
    string public _symbol = "WVRIUM";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa02b0b849048e877E9815BE0C6cA62FafCB445a4); // Marketing/Development Address
    address payable private DevelopmentWalletAddress = payable(0xa02b0b849048e877E9815BE0C6cA62FafCB445a4); // Address
    ...
    uint256 public _walletMax =  5250000 * 10**_decimals;
