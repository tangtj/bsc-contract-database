...
contract ZGL20TOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "ZGL2.0";
    string private _seitokensymbol = "ZGL2.0";
    address public ZLG20;
