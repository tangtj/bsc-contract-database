...
AI.com now redirects to Elon Musk's project "xAI" which used to be referred to as "ChatGPT".

Introducing AI.com to the Binance Smart Chain network:
https://t.me/AIdotcomBinance


AI.com 现在重定向到埃隆·马斯克的项目“xAI”，该项目曾被称为“ChatGPT”。
...
contract xAI is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"AI.com";
    string constant _symbol = unicode"xAI";
