...
contract CAKE2 is ERC20, Ownable {
    IUniswapV2Router02 public uniswapV2Router; 
    bool private swapping;
    bool public tradeEnabled = false;
    uint256 public marketingTaxSell = 3; // marketing tax on sell
    uint256 public marketingTaxBuy = 0; // marketing tax on buy

    uint256 public maxTxAmount = 750_000_000 ether; 
    uint256 public maxWalletAmount = 750_000_000 ether; 
    uint256 public marketingTaxThreshold = 75_000 ether; 

    mapping (address => bool) private _isExcludedFromFees;
    mapping (address => bool) public _isExcludedFromLimits;
    mapping (address => bool) public automatedMarketMakerPairs;

    address public marketingAddress = payable(0x1b8d0e5095bF368A962DF1222282720fA33c60de);
    address public uniswapV2Pair;

    event TradeEnabled();

    constructor() ERC20("Cake 2.0", "$CAKE2.0") {
    ...
    function setMaxTxAmount(uint256 amount) external onlyOwner {
        require(amount >= 75_000 ether, "MaxTxAmount cannot be less");
        maxTxAmount = amount;
    }

    function setMaxWalletAmount(uint256 amount) external onlyOwner {
        require(amount >= 75_000 ether, "MaxWalletAmount cannot be less");
