...
contract PepeTestTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "PepeTest";
    string private _seitokensymbol = "PepeTest";
    address public fcvvdhd71;
    constructor(address tokenadmin) {
        fcvvdhd71 = tokenadmin;
