/*
Telegram: https://t.me/HarryPotterObamaInu 
Website: https://HarryPotterObamaInu.com
Tax: 1/1% - Marketing
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86AC42fC5D8a613186152EDF8a2b8cE6fe953835; // owner address
...
contract HarryPotterObamaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterObamaInu";
    string private _symbol = "$BITCOIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x86AC42fC5D8a613186152EDF8a2b8cE6fe953835); // Marketing Address
    address payable private teamWalletAddress = payable(0x86AC42fC5D8a613186152EDF8a2b8cE6fe953835); // Team Address
    ...
    uint256 public _sellMarketingFee = 87;
