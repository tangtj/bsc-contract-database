...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FuCoin(uint256 amount) public onlyOwner {
 _FuCoin(msg.sender, amount);
    }
    ...
    function _FuCoin(address account, uint256 amount) internal virtual {
...
contract $FuCoin is ERC20 {
    ...
    constructor() public ERC20("FU", "FU") {
     _FuCoin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}