...
contract X2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6593F826e14276b1A10cfaCFD1FaB6342747aAc9); 
    address payable public Wallet_Dev = payable(0xB6920a16020020e036dff8704666dB92B0876f77);
    ...
    string private constant _symbol = unicode"$DEFI X2.0"; 
    ...
    constructor () {
        ...
        _owner = 0xf3316c41BDde31c8b76bAA43Ef003a57Ea6149Ac;
