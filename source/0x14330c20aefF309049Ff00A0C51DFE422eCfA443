...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71); //Binance-Peg BUSD Token (BUSD)
...
contract InfinityCheems is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Infinity Cheems';
    string private constant _symbol = 'ICheems';
