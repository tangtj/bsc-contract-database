/*
Cryo Network is created to suit the expectations of all individuals in crypto space looking for a decentralized wallet. If you're searching for a simple solution to store Ethereum, Binance, Avalanche, Polygon, Heco, Fantom Opera, Optimistic, Arbitrum One, Palm, ARTIS sigma1, POA, Ethereum Classic, xDai and many more cryptocurrency, this app is for you

🟤Cyro Network Ecosystem:
🟤Beta app  : https://play.google.com/store/apps/details?id=com.cryo.wallet
...
Website : https://cryonetwork.org (under maintenance)
*/
...
contract CryoNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cryo Network";
