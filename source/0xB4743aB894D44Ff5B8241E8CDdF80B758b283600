...
contract FlokiSquid is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiSquid";
    string private _symbol = "FlokiSquid";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x2D7142aA9a46cb6306f66855FC066e1B2DeA2ed6); 
    address payable private teamWalletAddress = payable(0x2D7142aA9a46cb6306f66855FC066e1B2DeA2ed6); 
