...
contract Surya12 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string public _name = "Surya 12 pro";
    string public _symbol = "SURYA";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress =
        payable(0x6fE595466fDEB4eb5b82d1053805eB8ee34223E0);
