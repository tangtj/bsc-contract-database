...
contract SHIBV2 is Context, IERC20, Ownable {
    ...
    address payable private _dev = payable(0xdDCaf66778Eae3A7DB7193Fbf170DF1cd9601bbd);
    address payable private _mkt = payable(0xdDCaf66778Eae3A7DB7193Fbf170DF1cd9601bbd);
    
    string private constant _name = "SHIB V2";
