...
contract SHIB3 is Context, IERC20, Ownable {
    ...
    string private _name = "SHIB 3.0";
    string private _symbol = "$SHIB3.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe643447d0A28297082981c9f18Cccf87a1FA0440);
    address payable public teamWalletAddress = payable(0xe643447d0A28297082981c9f18Cccf87a1FA0440);
