...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75aAa5941EdA53BE9530aF66EfE76538B5699a36;
...
contract BEP20_Token is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x62D51f7DeBFB413199dEf046Ef32E4c547ddF729;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Token Gcoach";
    string private _symbol = "GCOACH";
