...
contract Bshiba is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x95b202DfEaC9D5576bf8C868d4533Dd309D394f6;
    ...
    string private _name = "Babylittleshiba";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xB4Ac3d255ab9C3d769F9C51b95B66Df63453b21D, 'We can not exclude Uniswap router.');
