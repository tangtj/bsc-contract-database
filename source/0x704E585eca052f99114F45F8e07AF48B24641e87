...
contract YIELDTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public ennbf74;
    ...
    string private _tokenname = "Yielding Protocol";
    string private _tokensymbol = "YIELD";
