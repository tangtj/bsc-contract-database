...
contract  NebulaChain  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Nebula Chain";
    string private _symbol = "Nebularium";
    uint256 private _decimals = 9;
    uint256 private _supply = 100000000 * 10 ** _decimals;
    IDEXRouter private router;
    constructor() {
        _rOwned[msg.sender] = _supply;
