...
//  ☑️ TELEGRAM: https://t.me/pgbbwolf
//  ☑️ WEBSITE: https://pgbw.club/
//  ☑️ twitter: https://twitter.com/goatwolftoken


//  Buy and sell tax: 10

// 🐑🐺 LAUNCH today 24AT | in 7 hours(23:00 UTC)🐑🐺
...
contract pleasantgoat is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 40000000 * _decimalFactor; // 4% do Supply
    uint256 public maxBuyAmount = 20000000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 10000000* _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 25000000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "pleasant goat big wolf";
    string private _symbol =  "PGBW";
    /*=== Modifiers ===*/
