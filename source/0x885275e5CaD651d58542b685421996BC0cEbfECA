/**   
   ...
   Welcome to MyTurn Token
   
   This is a community token. If you want to create a telegram I suggest to name it to @MyTurn
   ...
   I will renounce the ownership to burn addresses to transfer #MyTurn to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #MyTurn 10000000X? 
   ...
   it's the best part of the #MyTurn idea, increasing the liquidity pool automatically, 
...
contract MyTurn is Context, IERC20, Ownable {
    ...
    string private _name = "MyTurn";
    string private _symbol = "MyTurn";
