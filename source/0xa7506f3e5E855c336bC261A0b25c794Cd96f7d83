...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x845F8Cf63C2DC3Dea2e2eEC3A260Af4884a5B21d; // owner address
...
contract OxEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "0x Ecosystem";
    string private _symbol = "0xco";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x845F8Cf63C2DC3Dea2e2eEC3A260Af4884a5B21d); // Marketing Address
    address payable private teamWalletAddress = payable(0x845F8Cf63C2DC3Dea2e2eEC3A260Af4884a5B21d); // Team Address
