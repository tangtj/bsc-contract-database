...
contract SendorAI is IBEP20, Auth {
    ...
    string constant _name = "Sendor.Ai";
    string constant _symbol = "Sendor.Ai";
    ...
    address private marketingFeeReceiver = 0xF6758B9591770A43Ef99d50272B53ECe2F8d4b8D;
