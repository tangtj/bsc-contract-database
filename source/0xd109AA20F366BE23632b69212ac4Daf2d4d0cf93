...
// OdoToken with Governance.
contract OdoToken is BEP20('Odo Token', 'ODO') {
...
// MasterChef is the master of Odo. He can make Odo and he is a fair guy.
//
