...
contract BooInu is ERC20, Ownable {
    ...
    mapping (address => bool) private _isBOOExcluded;
    mapping (address => bool) private _isUSDTExcluded;
    ...
    constructor() payable ERC20 ("Boo Inu", "BOO") {
        ...
        marketingWallet =  0xE4baF516357Da3268bD4432920cC87603ace7414;
        ...
        _isWalletExcluded[0xE4baF516357Da3268bD4432920cC87603ace7414] = true;
    
        _mint(owner(), 100 * 10 ** 15 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 10000000000 * 77777;
    }
