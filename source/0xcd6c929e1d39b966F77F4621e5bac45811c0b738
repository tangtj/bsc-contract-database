...
library Address {
    ...
    contract IGTCOIN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xdC12807AA64785Bf42189A77C535635a9588Ec18;
   

    string private constant _name = "IGT COIN";
    string private constant _symbol = "IGTC";
