...
contract BurnMoon is ERC20, Ownable {

    uint256 public transactionFeeRate = 5; // 5% transaction fee on buy and sell
    uint256 public _maxTxAmount = 1000000 * 10 ** 18;
    address public marketingWallet = 0x33C2feB589d92e459B415c63790a956d97b9bD73; 
    address admin;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("BurnMoon", "BOON") {
