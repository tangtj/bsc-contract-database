...
contract Token is IERC20, Ownable {
    ...
    uint256 public _totalBuyFee = 3;
    uint256 public _totalSellFee = 3;
    ...
    constructor() {
        ...
        uint256 total = 2000000000 * 10 ** _decimals;
        maxTXAmount = 2000000000 * 10 ** _decimals;
        maxWalletAmount = 2000000000 * 10 ** _decimals;
        ...
        MarketingAddress = 0x32511Cb8031B71A686743EE70459dCFd2d22222E;
  ...
  function open() external onlyOwner {
        ...
        ISwapRouter swapRouter = ISwapRouter(uniswapV2Router);
       ...
       swapRouter.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,owner(),block.timestamp);
        IERC20(swapPair).approve(address(uniswapV2Router), type(uint).max);
        _mainPair = swapPair;
