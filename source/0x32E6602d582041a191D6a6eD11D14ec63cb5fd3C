...
/**
Tg: https://t.me/mutantninjaturtles1
Tw : https://twitter.com/NinjaTurtle0726
*/
...
contract TMNT is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 30000 * 10**_decimals; //
    uint256 public maxBuyAmount = 30000 * 10**_decimals; //
    uint256 public maxWalletBalance = 30000 * 10**_decimals; //

    address public marketingAddress = 0xe66592EABba567Bc0d6ffeF564540C92fB065603; //
    address public devAddress = 0xA43C723b9338D598eFEF86e552d0f0ddbf8797d1; //
    ...
    Taxes public taxes = Taxes(0,12,8,0); //
    Taxes public sellTaxes = Taxes(0,12,8,0); //
