...
🟣 http://dogepurplebsc.atwebpages.com/
...
contract doge is IBEP20, Auth {
    ...
    address DEV = 0x5488228e68132866ba77bEe19AFa2d19bf1deDD0;

    string constant _name = unicode"ⒹⓄⒼⒺ 🟣 5% rewards";
    string constant _symbol = unicode"ÐOGΞ🟣";
    ...
    address public marketingFeeReceiver = 0x5dd1855FF9DdFA99FCdbd3d5C986936E3Bc19bAA;
