...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe2783F5027C7949a5652f51743E0366BcD10A1bd; // owner address
...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "BITCOINCN";
    string private _symbol = "BITCOINCN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe2783F5027C7949a5652f51743E0366BcD10A1bd); // Marketing Address
    address payable private teamWalletAddress = payable(0xe2783F5027C7949a5652f51743E0366BcD10A1bd); // Team Address
