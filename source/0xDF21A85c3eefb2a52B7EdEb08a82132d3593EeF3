...
contract MadaraInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x152fbf8799a1f0d54208267BB398C3cd0180b99A);
    address payable private _marketingAddress = payable(0x152fbf8799a1f0d54208267BB398C3cd0180b99A);
