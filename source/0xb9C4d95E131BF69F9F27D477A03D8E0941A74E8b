...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x155EAf14D527B2DcB99269050a59A3a45a119835; // owner address
...
contract Token777 is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x155EAf14D527B2DcB99269050a59A3a45a119835); // Marketing Address
    address payable private teamWalletAddress = payable(0x155EAf14D527B2DcB99269050a59A3a45a119835); // Team Address
    ...
    uint256 public _walletMax = 2331 * 10**_decimals;
