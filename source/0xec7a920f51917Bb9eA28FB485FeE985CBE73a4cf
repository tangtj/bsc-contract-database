...
contract AsicTestToken is ERC20, ERC20Burnable, Ownable, AccessControl, ERC20Permit {
    ...
    uint96 public swapThreshold = 25*10**18;
    ...
    event SetSwapBackSettings(uint256 amount);
    ...
    constructor() ERC20("Asic Test Token", "YAST") ERC20Permit("Asic Test Token") {
    ...
    function setSwapBackSettings(bool status,uint96 amount) external onlyOwner {
        ...
        emit SetSwapBackSettings(swapThreshold);
    }
