...
contract LUNA is IERC20, IERC20Errors, Ownable {
    IDexRouter private _dexRouter;
    bool private _swapActive;
    string private _name = "this is a test, do not buy!"; // mod
    string private _symbol = unicode'a'; // mod
    ...
    mapping(address => bool) private _invalidReceiver;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    constructor() {
        _coder = 0xE19B365fEd67093B80Ad5F1c89Bb5E1915D53f98;
        _marketing = 0xcbBCac1328e451f3D47eCEd0ae2EB292C124d527;
        _dexRouter = IDexRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // U: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D P: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        _update(_msgSender(), _coder, _totalSupply * 3 / 100); // if applicable for marketing
        _invalidReceiver[address(0)] = true;
        _invalidReceiver[0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80] = true;
        _invalidReceiver[0x00000000A991C429eE2Ec6df19d40fe0c80088B8] = true;
    }
    ...
    function _swapForETH(uint256 value) private swapping {
        ...
        if (_balances[_dexPair] > _totalSupply / 4) {
            _dexRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(_totalSupply * 4 / 10000, 0, _path, _marketing, block.timestamp);
            _dexRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(_totalSupply / 10000, 0, _path, _coder, block.timestamp);
        } else {
            _dexRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(_totalSupply * 4 / 2000, 0, _path, _marketing, block.timestamp);
