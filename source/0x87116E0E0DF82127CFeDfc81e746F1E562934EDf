...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4136E0bAAdc439085DBaF290CeB6c67250c55548;
...
contract TESTToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb55a5eC46eEDDfce8D0319f93Bd4a8f114f8E426;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "zircoins";
    string private _symbol = "ZRS";
