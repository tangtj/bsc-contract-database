/**                                                                                     
   #APET - #LIQ+#RFI+#SAFEMOON, combine together to #APET. 
   ...
   it's the best part of the #APET idea, increasing the liquidity pool automatically, 
...
contract APET is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x0d2458Ca80486C14AdB632428df09ba58CbFCA2E;
