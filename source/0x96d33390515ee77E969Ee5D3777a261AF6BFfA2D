...
contract ImFineCoin is Context, IERC20 {
    string private _name = "IM FINE COIN";
    string private _symbol = "IFC";
    ...
    address payable public MarketingWallet = payable(0x13055e4595293475D5040050B210365531Cbad49);
