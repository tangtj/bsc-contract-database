...
Website: https://xdoge.tools 
Telegram: https://t.me/xdogebotportal
Twitter: https://twitter.com/xdogebsc
...
contract xDoge is Context, IERC20, Ownable {
    ...
    string private _name     = unicode"𝕏Ðoge Bot";
    string private _symbol   = unicode"𝕏ÐBOT";
