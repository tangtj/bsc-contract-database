...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _isExcludeFromFee[_Fund_2] = true;
    ...
    uint256 public removeLiquidityFee = 9900;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        7200,
        address(0x5de25744c0C3c10E32e574Bd7b336e877572B4C9), //fund 1
        address(0xc10F261Fbe40f644A466D32370238A4235740ef8), //fund 2 
        address(0xecC9197d163adB52D2fB3d4BD230264Cd3053722) //receiver
    ){
    }
}