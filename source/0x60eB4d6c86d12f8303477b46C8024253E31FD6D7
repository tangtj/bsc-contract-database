...
abstract contract Ownable is Context {
    ...
    constructor () { 
        _owner = 0x99cA14a9E7c643F46955dCee6E261543C1c2A074; // owner address
...
contract Evorium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Evorium Network";
    string private _symbol = "EvoNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99cA14a9E7c643F46955dCee6E261543C1c2A074); 
    address payable public teamWalletAddress = payable(0x99cA14a9E7c643F46955dCee6E261543C1c2A074);
