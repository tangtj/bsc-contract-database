...
contract IpmanPepe is ERC20, Ownable {
    ...
    address public devWallet = 0x0c4643950d94CD25Db7E6c4c237d205501bD9DB7;
    ...
    constructor() ERC20("IpmanPepe", "IPMANPEPE") {
