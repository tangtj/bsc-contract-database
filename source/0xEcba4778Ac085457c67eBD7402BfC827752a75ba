...
contract BabyAndromeda is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Andromeda", "BabyM31") {
    ...
    function _transfer(
        ...
        if(takeFee){
            if(tradingActiveBlock >= block.number && (automatedMarketMakerPairs[to] || automatedMarketMakerPairs[from])){ // Only Block Sniper Bough on the same block
