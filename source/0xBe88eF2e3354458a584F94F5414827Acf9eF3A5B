...
contract NoneTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public akknhs67;
    ...
    string private _tokenname = "NotFine";
    string private _tokensymbol = "NotFine";
