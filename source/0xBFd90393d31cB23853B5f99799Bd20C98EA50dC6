...
contract Anonymous20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7800000000 * 10**9;
    uint256 public _maxTxAmount = 7800000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7800000000 * 10**9; //
    string private constant _name = "Anonymous 2.0"; // 
    string private constant _symbol = "ANONYMOUS 2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xa8D9a51e875Bd36C26757ED6EB6715382e9A34be;
