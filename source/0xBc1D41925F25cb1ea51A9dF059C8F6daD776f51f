...
contract HKRabbit is Context, IERC20, Ownable {
    ...
    string private _name     = "HKRabbit TOKEN";
    string private _symbol   = "HKRabbit";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    // uint256 private _tTotal = 420_690_000_000_000 * (10 ** _decimals);
    uint256 private _tTotal = 520131400000000 * (10 ** _decimals);
