...
contract XCONSPIRACY is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 66666 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint8 private constant _decimals = 9;
    string private constant _name = "X-CONSPIRACY";
    string private constant _symbol = "X-X";
    ...
    address payable private _twddev = payable(0x93630e5c50829E10cD016d19aF7a7A16065dcF20);
    address payable private _twdmkt = payable(0x93630e5c50829E10cD016d19aF7a7A16065dcF20);
