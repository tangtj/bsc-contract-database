...
contract HappyHour is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xbcc085d5dc659C6f7bD01B72dD2C62Fb45D18DC7);
    address payable private _twdmkt = payable(0xbcc085d5dc659C6f7bD01B72dD2C62Fb45D18DC7);
    
    string private constant _name = "HAPPY HOUR";
