...
contract MogTOKEN is Ownable {
    address public czsad5;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Mog Coin";
    string private _cctokensymbol = "Mog";
