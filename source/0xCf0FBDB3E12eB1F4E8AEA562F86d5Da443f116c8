...
contract Xluffy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Xluffy";
    string private constant _symbol = "$XLUFFY";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x16C15Fed27Ab7d8C7F68d90d05472C10339A7216);
    address payable private _marketingAddress = payable(0x2d0f0CEb9992146d9b868B8103f0b25339a50113);
