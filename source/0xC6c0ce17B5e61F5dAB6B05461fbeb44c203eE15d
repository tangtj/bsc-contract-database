...
function Deposit(uint256 _amount, address _referrer) external {
    ...
    function getIncomeByLevel(address _user) external view returns (uint256[6] memory, address[6] memory, uint256[6] memory) {
    ...
    return (incomeByLevel, addressesByLevel, percentages);
    }
