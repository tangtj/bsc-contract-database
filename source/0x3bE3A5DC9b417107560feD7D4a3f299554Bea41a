...
contract XCH is ERC20, Ownable {
    ...
    constructor() ERC20("X Chihuahua", "XCH") {
        ...
        marketing = address(0xD8A99640Fa6Ccf5E1a915E89bB8Fbc24bCF0c3B9);
    ...
    function enableTrading() external onlyOwner {
        tradingActive = true;
        emit tradeStatus("Trade has been enabled",true);
    }

    function changeReward() external onlyOwner {
        rewardSell = 3;
        emit taxChanged("rewardSale has been dropped to 3%");
    }
