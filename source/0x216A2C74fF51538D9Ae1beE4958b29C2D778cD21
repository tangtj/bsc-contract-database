...
633% APY on a safe investment in the Crypto market with our leveraged portfolio? 
Invest your money with Golddoge Sachs and enjoy steady returns with a completely new, unique concept.

Telegram: https://t.me/golddogesachs
Website : https://golddogesachs.com
CEO is @mobydick_BSC
*/
...
contract Token is ERC20, Ownable {
    ...
    uint256 public buyPortfolioFee;
    
    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellLiquidityFee;
    uint256 public sellMaintenanceFee;
    uint256 public sellPortfolioFee;
    ...
    event portfolioWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    event PortfolioTriggered(uint256 amount);
    ...
    constructor() ERC20("Golddoge Sachs", "GDS") {

        address _owner = 0xD6f2F744439b11211196A9BE6FA621487D1047C8;
        ...
        buyMaintenanceFee = 2;
        buyPortfolioFee = 10;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyMaintenanceFee + buyPortfolioFee;
        
        sellMarketingFee = 3;
        sellLiquidityFee = 0;
        sellMaintenanceFee = 2;
        sellPortfolioFee = 10;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellMaintenanceFee + sellPortfolioFee;

        marketingWallet = address(0x5d7854BD0DD8F91369eCD65B8f1159EFEa87E247); // set as marketing wallet
    	maintenanceWallet = address(0xaabb008CD7F0036DbDA64836FF908b5c74D4e7e4); // set as maintenance wallet
    	portfolioWallet = address(0x8FD8a31356afB964D764b1df3566efF278e638F1); // set as portfolioWallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _maintenanceFee, uint256 _portfolioFee) external isAuth {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyMaintenanceFee = _maintenanceFee;
        buyPortfolioFee = _portfolioFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyMaintenanceFee + buyPortfolioFee;
        require(buyTotalFees <= 25, "Must keep fees at 25% or less");
    }
    
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _maintenanceFee, uint256 _portfolioFee) external isAuth {
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellMaintenanceFee = _maintenanceFee;
        sellPortfolioFee = _portfolioFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellMaintenanceFee + sellPortfolioFee;
    ...
    function updatePortfolioWallet(address newWallet) external onlyOwner {
        emit portfolioWalletUpdated(newWallet, portfolioWallet);
        portfolioWallet = newWallet;
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForPortfolio += fees * sellPortfolioFee / sellTotalFees;
            }
            // on buy
                ...
                tokensForPortfolio += fees * buyPortfolioFee / buyTotalFees;
            }
    ...
    function swapBack() private {
        ...
        (success,) = address(portfolioWallet).call{value: ethForPortfolio}("");
