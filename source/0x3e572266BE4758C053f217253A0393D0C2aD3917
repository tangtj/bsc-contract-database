...
// Telegram: https://t.me/Hobbes_bsc
...
contract Hobbes is Context, IERC20, Ownable {   
    ...
    address payable private _twddev = payable(0x9014754afc1b99FB92220244527022b93E9C3F37);
    address payable private _twdmkt = payable(0x9014754afc1b99FB92220244527022b93E9C3F37);
