...
contract MoonBreakerToken is Context, IERC20, Ownable {
    ...
    string private _name = "MoonBreaker Token";
    ...
    address payable public devAddress = 0x24eEB755BA0b5F28689Ff9FBee4dFa56e86b1Da0; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferDevETH(devAddress, address(this).balance);
    }
