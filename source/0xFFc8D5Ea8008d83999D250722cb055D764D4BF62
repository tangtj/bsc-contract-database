...
contract token is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 8180 * (10**9); 

    uint256 public _BuyLiquidityFee = 0;
    uint256 public _BuyMarketingFee = 2;
    uint256 public _BuyTotalFees = _BuyMarketingFee.add(_BuyLiquidityFee);

    uint256 public _SellLiquidityFee = 0;
    uint256 public _SellMarketingFee = 2;
    uint256 public _SellTotalFees = _SellMarketingFee.add(_SellLiquidityFee);

    uint256 public _MarketingFeeShare = 9;
    uint256 public _TotalShare = 10;

    address public _marketingWalletAddress = 0x6C910926C7FD5B8d6f5eF6F6192223A0d9A78EE3;
    address public _liquidWalletAddress = 0x6E1360946ba154b37C1A3f06a3B88f9737BCbb0e;

    uint256 _totalSupply = 81800000000 * 10**9;
    uint256 public maxWalletToken = 8180000000 * (10**9) ; //10%
    ...
    function setBuyFees(uint256 buyLiquidityFee, uint256 buyMarketingFee ) external onlyOwner
    {
        _BuyLiquidityFee = buyLiquidityFee;
        _BuyMarketingFee = buyMarketingFee;
        _BuyTotalFees = _BuyLiquidityFee.add(_BuyMarketingFee);
    }
   ...
   function setSellFees(uint256 LiquidityFee, uint256 MarketingFee ) external onlyOwner
    {
        ...
        _SellTotalFees = _SellLiquidityFee.add(_SellMarketingFee);
    }
