...
contract BNBcat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA589066f7082B86e2666634E7313C74e38D94036); 
    address payable public Wallet_Dev = payable(0x327ec428c95b1f1b4C2f897C8135578CE096c076);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "BNBcat"; 
    string private constant _symbol = unicode"BNBcat"; 
    ...
    constructor () {
        _owner =0x327ec428c95b1f1b4C2f897C8135578CE096c076;
