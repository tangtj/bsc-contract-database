...
contract BSCMIXER is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x7e8f951911663cEB4EF992dC1237Dd6e3E0a780A);
    address payable private _twdmkt = payable(0x7e8f951911663cEB4EF992dC1237Dd6e3E0a780A);
