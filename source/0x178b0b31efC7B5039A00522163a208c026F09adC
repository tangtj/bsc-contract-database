...
contract WAGIE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000000000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 2000000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 2000000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 2000000000000 * 10**_decimals;

    address public marketingAddress = 0x441c873a13f17960be58A2e9DF10D29F474F2a1E;
    address public devAddress = 0x441c873a13f17960be58A2e9DF10D29F474F2a1E;
    ...
    Taxes public taxes = Taxes(0,0,29,4);
    Taxes public sellTaxes = Taxes(0,0,29,4);
