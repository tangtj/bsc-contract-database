...
KPOP Next-gen community driven NFT DeFi and Decentralize IDO for Community fork Lightning Protocol based Deflationary Token functions in cycles 
...
-Burn Start with 2%
-Rebase Holder get 50% Of Total Burn

Deflationary Stop when Cycle 148 or 5,650,000 Supply Reach 

Telegram: https://t.me/kpopdefi
Website: https://k-pop.finance
...
contract KPOPToken is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'KPOP Token';
    string  private constant _SYMBOL = 'KPOP';
