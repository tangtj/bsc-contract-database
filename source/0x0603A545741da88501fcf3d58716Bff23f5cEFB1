...
contract DOFTOKEN is Ownable {
    address public fxscd65;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "Doofy";
    string private _cctokensymbol = "DOF";
