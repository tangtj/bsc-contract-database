...
contract JADETOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public ekkfns83;
    ...
    string private _tokenname = "JADE";
    string private _tokensymbol = "JADE";
