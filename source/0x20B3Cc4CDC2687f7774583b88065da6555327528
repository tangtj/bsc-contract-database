...
// File: contracts/InfinityFactory.sol
...
contract InfinityFactory is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("INFINITY", "INFINITY");
        __Ownable_init();
