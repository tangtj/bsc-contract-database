...
contract X6 is Token {
    constructor() ERC20(
        "X6",   // 名字
        "X6"   // 符号
    ) {
        uint256 _totalSupply = 6888 ether; 
        address _marketing = address(0x1130c0Cb61585cf3ae93fFCEcE6E0456c9f17937); // 
        address _receive = address(0x0537e95dF1540c62445c18116b0988B4Db3B6c5C);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0x1130c0Cb61585cf3ae93fFCEcE6E0456c9f17937)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);  
        setInitPrice(1 ether); 
        feeMarketingTo2 = address(0x884859737756c2A895DF33e69603cb23b45a5bCc);   
        feeEarn = 500; 
    }
}