...
contract PEDOINU is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xCD72eF12EaaAf4ca6ACeaC865B951F84C33a56C1);
    address payable private _twdmkt = payable(0xCD72eF12EaaAf4ca6ACeaC865B951F84C33a56C1);
    
    string private constant _name = "PEDO INU";
