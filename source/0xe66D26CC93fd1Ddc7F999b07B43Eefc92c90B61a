...
/**
   ...
   Welcome to QUEENOFAPE
   
   This is a community token. If you want to create a telegram I suggest to name it to @QUEENOFAPEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #QUEENOFAPE
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #QUEENOFAPE 10000X? 
   ...
   it's the best part of the #QUEENOFAPE idea, increasing the liquidity pool automatically, 
...
contract QUEENOFAPE is Context, IERC20, Ownable {
    ...
    string private _name = "QUEENOFAPE";
