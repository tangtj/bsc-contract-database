/**
// Telegram : https://t.me/official_2049x
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9C0C40BAb16982339FE53ef491C179Da0122C22A ; // owner address
...
contract _2049X is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "2049X";
    string private _symbol = "2049X";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x78E48E90a191Ac8c2CD7e325469f0cC31D3ce5F4); // Marketing Address
    address payable private teamWalletAddress = payable(0x9C0C40BAb16982339FE53ef491C179Da0122C22A); // Team Address
