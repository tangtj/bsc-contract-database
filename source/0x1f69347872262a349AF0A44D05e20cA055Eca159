...
contract BEP20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply= 5000000000000000 * 10 **18;

    string private _name= "AI BULL BEAR 2";
    string private _symbol= "AIBB2";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount, "BRP20: burn amount exceeds balance");
        unchecked {
...
contract AIBB2 is BEP20, BEP20Burnable, Ownable {
    uint256 private constant INITIAL_SUPPLY = 5000000000000000 * 10**18;

    constructor() BEP20("AI BULL BEAR 2", "AIBB2") {
