/**
X RABBIT is a community token whose goal is to unite all cryptocurrency enthusiasts by providing never-before-seen community building. The plan is to have a massive marketing and aggressive buyback and burn strategies
...
contract XRABBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = "X RABBIT"; // 
    string private constant _symbol = "XRBIT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x40ad07bEC07A69239B53b88A1ac140b7aCE876D2;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xac8c2650B429efc8ad5c050393416771F1a31F55;
