...
contract ARBY is Context, IERC20, Ownable {
    ...
    string private _name = "Arby Coin";
    string private _symbol = "ARBY";
    ...
    address payable public marketingWallet = payable(0x731dBBF0aedBadA15AFADa1Ca527B32F0b067Fe8);
    ...
    uint256 public numTokensSellToAddToLiquidity = 777777 * 10**18;
