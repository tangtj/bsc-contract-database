...
// TG : https://t.me/Ibnbattutabsc
// X : https://twitter.com/ibnbattutabsc
...
contract IBNBATTUTA is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x1Ebf8d1d2794d6127C7F03C6060a4F2d07B4A173);
    address payable private _twdmkt = payable(0xbaeca6B8C240A153D1797A57515b3C21d15DeD60);
    
    string private constant _name = "IBN BATTUTA";
    string private constant _symbol = "IBNBTTA";
