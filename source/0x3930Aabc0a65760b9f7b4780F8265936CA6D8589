...
Telegram https://t.me/patronnetworkChannel
Website https://.Patronnetwork.org/
*/
...
contract PATRON_NETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PATRON NETWORK";
    string private _symbol = "$PATRON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc0870f9B7Fcf4969AfE5A94779D9A223359F42f2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1d80B72F1Bb391f06Cb44Bf13862416692cEB34b); // BuyBack Address
