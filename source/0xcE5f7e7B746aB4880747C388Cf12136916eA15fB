...
contract YooshiApeOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public dmmng87;
    ...
    string private _tokenname = "YooshiApe";
    string private _tokensymbol = "YooshiApe";
