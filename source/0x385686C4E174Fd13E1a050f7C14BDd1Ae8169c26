/*
Trivium Network $TRIVIUM is developing technology that reduces the gaps between traditional and decentralized finance.
Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

 🟢Testnet Live at launch
 🟢Swap
🟢Staking
 🟢Dapps
🟢 Wallet
...
TG: https://t.me/triviumnetworkofficial
Website : https://explorer.triviumblockchain.live/
*/
...
contract TriviumNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trivium Network";
    ...
    function TrivTestnet(address[] calldata addresses) external onlyOwner {
