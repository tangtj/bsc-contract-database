// https://t.me/PiglidoxInu
// https://twitter.com/pig_lido
// https://piglido.com/
...
contract Piglidox is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PiglidoX";
    string private constant _symbol = unicode"PIGO";
