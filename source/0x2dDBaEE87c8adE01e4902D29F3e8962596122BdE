// t.me/CryptoNeurNetworkfoundation 
// CryptoNeurNetworkfoundation.com
...
contract CryptoNeurNetworkfoundation is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "CryptoNeurNetworkfoundation";
