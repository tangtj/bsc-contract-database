...
/*
TG : https://t.me/GrandTheftPepeBSC
*/
...
contract GRANDTHEFTPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Grand Theft Pepe", "GTP") {
        ...
        marketingWallet = address(0x877D7712b85377c0b6bdA2aE9Bd903007EF2c8aD); 
        devWallet = address(0x877D7712b85377c0b6bdA2aE9Bd903007EF2c8aD);
        lpWallet = msg.sender;
