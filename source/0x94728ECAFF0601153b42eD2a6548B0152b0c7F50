...
contract  $XPHYSICS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xFE4bed65fC1816652996bA76010aF3B59f70D360;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = " $XPHYSICS";
    string constant _symbol = "$XPY";
