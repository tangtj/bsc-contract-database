...
Welcome to BEONIX TOKEN, $BNX  is meme coin running on bsc network.
...
🔥 🚀 join early and earn big on $BNX 💰

TG : https://t.me/BeonixOfficial
...
contract BEONIXTOKEN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BEONIX TOKEN";
    string private constant _symbol = unicode"$BNX";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 75000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xEeAb1398a5f398ACca55120ea92Ba4d546D3C540);
    address payable public MarketingWallet = payable(0x8d607415a627f2a6B964eA188E70B29e97A99fb5);
