...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5C0bd0405a833c830c0Db13333BFEFea8BAe08f2; // owner address
...
contract XCHAIN is Context, IERC20, Ownable {
    ...
    string private _name = "X CHAIN";
    string private _symbol = "XCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdE92b2275DE38D4D615F18d83d49C433c939A8cA); // 
    address payable public teamWalletAddress = payable(0xA7F3c30c126eA12B255195620A30F49d9854C73a); // 
    ...
    uint256 public _totalTaxIfSelling =65;  
    uint256 public _totalDistributionShares = 90;  
    uint256 private _totalSupply = 9000 * 10**_decimals;
    uint256 public _maxTxAmount = 270 * 10**_decimals; 
    uint256 public _walletMax = 270 * 10**_decimals;
