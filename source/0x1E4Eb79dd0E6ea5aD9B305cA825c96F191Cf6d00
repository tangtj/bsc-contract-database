...
contract SCNTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "SChain";
    string private _seitokensymbol = "SCN";
    address public SCSCNN13;
