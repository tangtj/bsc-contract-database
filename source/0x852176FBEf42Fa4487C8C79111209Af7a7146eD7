...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 550;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7ce282Ae68B1a5FD553840be08C0b2496670431F), block.timestamp
                );
            }
        }
    }
...
contract MC is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        21000000,//Supply
        address(0x7ce282Ae68B1a5FD553840be08C0b2496670431F),//FundAddress
        address(0x7ce282Ae68B1a5FD553840be08C0b2496670431F)//ReceiveAddress
    ){
    }
}