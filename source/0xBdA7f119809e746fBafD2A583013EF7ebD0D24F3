...
interface lotteryInterface {
    ...
    function viewWalletData(address user) external view returns (uint256 currentEventtickets, uint256 previousEventtickets, uint256 totalWallettickets, uint256 totalwinningsETH, uint256 totalwinningsToken, uint256 lastPurchasetime);
...
contract lotteryInterfaceContract is Auth {
    ...
    constructor() Auth(msg.sender) {
        lotteryContract = lotteryInterface(0xf0DAe6F0D31769E79CE2684Da1b1B3d5eD5aa52F);
    }
    ...
    function viewWalletData(address user) external view returns (uint256 currentEventtickets, uint256 previousEventtickets, uint256 totalWallettickets, 
        uint256 totalwinningsETH, uint256 totalwinningsToken, uint256 lastPurchasetime) {
