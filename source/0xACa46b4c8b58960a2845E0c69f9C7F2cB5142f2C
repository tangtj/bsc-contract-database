...
contract Dinofarm is Token {
    
    uint private startTime = 1691107200; 
    ...
    uint private constant INITIAL_TOKENS    = 70000 ether;    
    ...
    uint public TOKEN_DAILYPROFIT = 50;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                 
        DES_1 = 0xEc227f2b29f0bc50c7a06ed08882a1367bA4aF48;  
        ADM_1 = 0x68357b21a0024881e6D3Dafa3fA0D824e4715048;          
        VID_1 = 0x3a09b86EcA49bd8A0a4EBC5D4Ab903815EaB9777;
        INF_1 = 0x215C1fE067a39F71367B640901899D4647Ecb82d;        
        MAR_1 = 0x0Df34E20a06D937AB3E94441aDF26039Bc771f78;  
    ...
    function Buyegg(address referrer,  uint256 _amount) public payable {
    ...
    function Evolve(uint tokenAmount) public {
        require (block.timestamp > startTime);       
        User storage user = users[msg.sender];
