...
// Website: https://DogelontwitterX
// TWITTER: https://twitter.com/DogelontwitterXBSC
...
contract DETX is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x33E84dd33ad7a2b098E2bFc51cF19842B6c9Dd48;

    string private constant _name = "DogelonTwitterX";
    string private constant _symbol = "$DETX";
