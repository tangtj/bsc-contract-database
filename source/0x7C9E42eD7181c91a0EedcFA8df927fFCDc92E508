 ...
 */
 ...
 contract PEPE2POINT2 is IBEP20, Auth {

 using SafeMath for uint256;

 string constant _name = "PEPE2POINT2";
 string constant _symbol = "PEPE2.2";
 ...
 // NAIS!
 autoLiquidityReceiver = 0x2527284E3588fB192F3F01718E99deA7439e51Cd; // liquidity
