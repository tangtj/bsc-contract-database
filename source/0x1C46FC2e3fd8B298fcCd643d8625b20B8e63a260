...
contract PEPITOCOIN is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('PEPITO COIN', 'PEPC') {
        require(
            feeAccount != address(0),
            'PEPITOCOIN: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'PEPITOCOIN: incorrect fee percent');
        require(owner != address(0), 'PEPITOCOIN: incorrect owner address');
        require(mintToAddr != address(0), 'PEPITOCOIN: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'PEPITOCOIN: transfer from the zero address');
        require(recipient != address(0), 'PEPITOCOIN: transfer to the zero address');
