...
contract ChonkyPonk is ERC20, Ownable {
    ...
    uint256 public _totalFeesOnBuy = 5;
    uint256 public _totalFeesOnSell = 10;

    address public  marketingWallet = 0x46c01313b3c238D5bb3127Ac583c3A3C945410f9;
