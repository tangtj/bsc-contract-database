...
contract WTF is IBEP20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Way To Financial Freedom";
    string constant _symbol = "WTFF";
    ...
    uint256 public marketingBuyFee    = 90; // for handling bots at start
