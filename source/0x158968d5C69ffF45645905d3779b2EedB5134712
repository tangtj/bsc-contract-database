...
contract XBOO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD64B547E12E30FacdD146cDA583b0e388A0B5f67); 
    address payable public Wallet_Dev = payable(0xA2fB1Aa8943625190EfF1Bad6DDD7cC9D3605184);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "xBOO The Ghost"; 
    string private constant _symbol = unicode"XBOO"; 
    ...
    constructor () {
        _owner =0xA2fB1Aa8943625190EfF1Bad6DDD7cC9D3605184;
