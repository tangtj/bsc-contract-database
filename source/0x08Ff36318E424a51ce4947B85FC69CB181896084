...
Metatime
https://metatime.com/
Metatime is a main company of its ecosystem, whose main product is the MetaChain blockchain and all the applications built and designed on this chain.
...
contract MetatimeToken is Context, MetatimeECO, Ownable {
    ...
    string private _name = 'Metatime';
    string private _symbol = 'Metatime';
    uint8 private _decimals = 9;
    string public Metatimewebsite = "https://metatime.com/";

    function getMetatimewebsite() public view returns (string memory) {
        return Metatimewebsite;
    }
