        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x2D9A33305Eb88B62aC2E902545B3438f93848cAF), block.timestamp
                );
            }
        }
    }
...
contract X2W is AbsToken {
    constructor() AbsToken(
        ...
        address(0x2D9A33305Eb88B62aC2E902545B3438f93848cAF)//ReceiveAddress
    ){
    }
}