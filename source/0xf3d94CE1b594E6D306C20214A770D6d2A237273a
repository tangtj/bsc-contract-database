...
// Dependency file: contracts/HARRYPOTTERTRUMPHOMERSIMPSON777/IterableMapping.sol
...
// Dependency file: contracts/HARRYPOTTERTRUMPHOMERSIMPSON777/HARRYPOTTERTRUMPHOMERSIMPSON777TokenDividendTracker.sol
...
// import "contracts/HARRYPOTTERTRUMPHOMERSIMPSON777/IterableMapping.sol";
...
contract HARRYPOTTERTRUMPHOMERSIMPSON777TOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN contract."
        );
    }
...
enum TokenType {
    ...
    HARRYPOTTERTRUMPHOMERSIMPSON777,
    antiBotHARRYPOTTERTRUMPHOMERSIMPSON777,
    buybackHARRYPOTTERTRUMPHOMERSIMPSON777,
    antiBotBuybackHARRYPOTTERTRUMPHOMERSIMPSON777
}
...
// Root file: contracts/HARRYPOTTERTRUMPHOMERSIMPSON777/HARRYPOTTERTRUMPHOMERSIMPSON777Token.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/HARRYPOTTERTRUMPHOMERSIMPSON777/HARRYPOTTERTRUMPHOMERSIMPSON777TokenDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    HARRYPOTTERTRUMPHOMERSIMPSON777TOKENDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = HARRYPOTTERTRUMPHOMERSIMPSON777TOKENDividendTracker(
        ...
        */
        ...
        emit TokenCreated(owner(), address(this), TokenType.HARRYPOTTERTRUMPHOMERSIMPSON777, VERSION);
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(
            ...
            "HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN: Amount must be greater than 0.001% of total supply"
        );
    ...
    function excludeFromFees(address account) external onlyOwner {
        require(
            ...
            "HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN: Account is already excluded"
        );
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner {
        require(
            wallet != address(0),
            "HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN: The marketing wallet cannot be the value of zero"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "HARRYPOTTERTRUMPHOMERSIMPSON777TOKEN: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialETHBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );
