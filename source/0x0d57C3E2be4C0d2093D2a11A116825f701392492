...
Welcome to KingDogeCake
   
   This is a community token. If you want to create a telegram I suggest to name it to @KingDogeCake
   ...
   I will renounce the ownership to burn addresses to transfer #KingDogeCake to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #KingDogeCake 10000X? 
...
contract KingDogeCake is Context, IERC20, Ownable {
    ...
    string private _name = "KingDogeCake";
    string private _symbol = "KDCAKE";
