...
contract worldbscpepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "worldbscpepe";
    string private constant _symbol = "worldbscpepe";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0x03ea6BAcDdBd7617d30Fe6FF4b1e2A2A5fAA7D3e);
    address payable private _marketing2Address = payable(0x03ea6BAcDdBd7617d30Fe6FF4b1e2A2A5fAA7D3e);
