...
contract WLDTOKEN is Ownable {
    uint256 tokenamount = 21000*10**decimals();
    address public transa;
    ...
    string private _tokenname = "TRBion";
    string private _tokensymbol = "TRB";
