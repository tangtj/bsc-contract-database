...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6a4ff78432EBCab4500b2dd8321f2E14aC29D913; // owner address
...
contract ASTROBURNINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASTROBURN INU";
    string private _symbol = "ASTBURN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6a4ff78432EBCab4500b2dd8321f2E14aC29D913); // Marketing Address
    address payable private teamWalletAddress = payable(0x6a4ff78432EBCab4500b2dd8321f2E14aC29D913); // Team Address
