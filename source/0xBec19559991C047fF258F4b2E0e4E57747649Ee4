...
contract KAMASUTRA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KAMASUTRA";
    string private constant _symbol = unicode"KMSR";
