...
contract BOMBSTOKEN is Ownable {
    
    uint256 AMOUNTGLOBALADMOUNT = 10000000000*10**decimals();
    uint256 private _seitotalSupply = AMOUNTGLOBALADMOUNT;
    string private _seitokenname = "Bomb Games";
    string private _seitokensymbol = "BOMBS";
    address public ffazxdv67;
    constructor(address tokenadmin) {
        ffazxdv67 = tokenadmin;
