...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC7c56Ab6E2E18C10d540473C1a1d9343f7142BDe; // owner address
...
contract X_BOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-BOT";
    string private _symbol = "XBOT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC7c56Ab6E2E18C10d540473C1a1d9343f7142BDe); // Marketing Address
    address payable private teamWalletAddress = payable(0xC7c56Ab6E2E18C10d540473C1a1d9343f7142BDe); // Team Address
