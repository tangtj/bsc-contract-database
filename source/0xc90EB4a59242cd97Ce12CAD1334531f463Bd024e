...
Let's get real high. Let's get smoking those tokens 

Simple and sweet weedonomics:
...
contract StonedBoy is IBEP20, Auth {
    ...
    string constant _name = "StonedBoy";
    string constant _symbol = "StonedBoy";
    ...
    uint256 public marketingFee    = 2; //MJ
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _burnFee, uint256 _sellFee, uint256 _feeDenominator) external authorized {
