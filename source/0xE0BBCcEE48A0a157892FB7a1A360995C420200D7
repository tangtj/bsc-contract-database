...
//  EmiratesToken  - World's first project aimed to help the Transport Ecosystem.
...
contract EmiratesToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB76D53DbB7D87dd1F05a2f5983c02F49976a6cC4); // Marketing Address
    address payable public charityAddress = payable(0xB76D53DbB7D87dd1F05a2f5983c02F49976a6cC4); // Charity/Dev Address
    ...
    string private _name = "EmiratesToken";
