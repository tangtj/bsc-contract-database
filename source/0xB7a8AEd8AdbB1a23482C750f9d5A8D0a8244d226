...
contract Ownable is Context {
   ...
   constructor () {
        _owner = 0x43Eee9879a85E22da5CCbAbba5F2a92Cf155E799;
...
contract PEPEGOBLIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private  _name = "PEPE GOBLIN";
    string private  _symbol = "OPG";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43Eee9879a85E22da5CCbAbba5F2a92Cf155E799); // Marketing
    address payable public teamWalletAddress = payable(0x43Eee9879a85E22da5CCbAbba5F2a92Cf155E799); // Team
