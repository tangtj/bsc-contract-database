...
//TG Global - https://t.me/Shaggycoinbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x567dCbbB3b56FDF754559aEA21c755DE3BA75767;
...
contract Shaggy is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable(0x7385B89FD868741EBE9f8710e0D29D5Af0a9B0bF);
