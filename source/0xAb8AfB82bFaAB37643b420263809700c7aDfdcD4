...
uint public totalSupply = 111000000 * 10 ** 8;

string public name ='KUROMI';
string public symbol ='KUROMI';

uint public decimals = 8;
bool takeFee = true;
uint256 public tax =3;

address public marketing = 0xB7e9c7C2030F6Fc91d4Eac1FB372036AAaaB4dbc;
