...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("DOT", "DOT") {
        ...
        address mainCol = 0x6EA593A7147C904b5a8a08618b98bE0BEC922D29;
        _mint(mainCol, 3680000 * 1e18);
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address uAddr = 0x55d398326f99059fF775485246999027B3197955;     
        
        fundWallet = 0xCc73FD601a08b280136F06dAA3d13f3a76DAa059;
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (from == address(uniswapV2Pair) && to == _router){
                ...
                if (to == address(uniswapV2Pair)) {
                    if (sellRate>0) {
                        uint256 fundFee = amount.mul(sellRate).div(1000);
                        super._transfer(from, fundWallet, fundFee);
                        amount = amount  - fundFee;
                    }
                }else{
                    if (buyRate>0) {
                        uint256 fundFee = amount.mul(buyRate).div(1000);
                        super._transfer(from, fundWallet, fundFee);
                        amount = amount  - fundFee;
                    }
                }
