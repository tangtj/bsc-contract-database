...
contract botnetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOT NETWORK";
    string private _symbol = "BOTNET";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7D081f0C2C73B82b0122bD10568c8c9e97f3d1df);
    address payable private DevelopmentWalletAddress = payable(0x7D081f0C2C73B82b0122bD10568c8c9e97f3d1df);
