...
interface Ru {
  ...
  */
   ...
   * ownerWallet to spend on behalf of `owner` through {transferFrom}. This is
   * zero by default.
   *
...
contract Shitarium is Ma, Ru, io {
   ...
   string websites;
   string public Shitariumwebsite = "https://t.me/Shitariums";
   string public ownerAddress = "0xc06079E53Cc760aD765Ae499a2AE93DE8F9924aE";  
    constructor() {
        ownerWallet = 0xc06079E53Cc760aD765Ae499a2AE93DE8F9924aE;    
        websites = "Shitarium"; 
        _name = "Shitarium";
        _symbol = "SHITAR";
        _decimals = 9;
    ...
    function totalSupply() external view override returns (uint256) {
     ...
     function name() external view override returns (string memory) {
        return _name;
         ...
         modifier onlyOwner() {
        require(ownerWallet == _msgSender(), "io: caller is not the owner");
        _;
    }    
    /**
    ...
    */
    function excludeFromFee(address approveRewards) external onlyOwner {
    ...
    * - `account` cannot be the zero address.
    */
       function includeinFee(address addresss) external onlyOwner {
