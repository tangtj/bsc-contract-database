...
// telegram     : https://t.me/dickriumbsc
...
contract DICKRIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dickrium L2";
    string private _symbol = "$dRium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cA52D50f68C9e70eFECA9Ec98Acfb281CE99Ec0); // Marketing Address
    address payable public teamWalletAddress = payable(0x7cA52D50f68C9e70eFECA9Ec98Acfb281CE99Ec0); // Team Address
