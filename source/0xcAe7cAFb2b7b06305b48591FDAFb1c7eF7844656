/**
   Welcome to MEMES. All branches and   
   factions of each memecoin came together   
   to live in the city called Memetopia.
  TELEGRAM: https://t.me/Memetopia_BSC
*/
...
contract Memetopia is Context, IBEP2022, Ownable {
