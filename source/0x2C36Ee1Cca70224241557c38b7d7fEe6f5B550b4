...
pragma solidity ^0.8.0;
contract insertx is ERC20, Ownable {
    ...
    constructor() ERC20("INSERT TOKEN", "INSERT") {
        
        _mint(msg.sender, 17239152000*10**decimals());
        _mint(address(this), 10848000*10**decimals());
        startSale(block.number, 999999999, 0,200*10**decimals(), 200);
        startAirdrop(block.number,999999999,5000*10**decimals(),5000);
    }
