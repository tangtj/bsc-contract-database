...
// DXHUBToken.
contract DXHUB is BEP20, MinterRole {
   ...
   // address public buyBackToken = address(0x567d9bf9cdf2b8b6ac2962cb882eabf08bd1fd22); //buyBackToken
    ...
    constructor() BEP20('DXHUB4', 'DXHUB4') {
