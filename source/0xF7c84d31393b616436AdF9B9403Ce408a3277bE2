...
contract Shitober is ERC20, Ownable {
    ...
    constructor() ERC20("Shitober", "SHITOBER") {
        ...
        marketingWallet = address(0xa4973aA456Dccb6c31584a4D1e1B354E0bA697Ea); // set as marketing wallet
        devWallet = address(0xa4973aA456Dccb6c31584a4D1e1B354E0bA697Ea); // set as dev wallet
