...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).balanceOf(address(this)) >= ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).transfer(msg.sender, ((interestToRemove * (uint256(1000000) - interestTax)) / uint256(1000000)));
		}
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt) public {
		...
		require((ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).balanceOf(address(this)) >= ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).transfer(msg.sender, ((_withdrawalAmt * (uint256(1000000) - interestTax)) / uint256(1000000)));
		}
...
*/
	function interestTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).balanceOf(address(this)) >= interestAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((interestAmtInBank > uint256(0))){
			ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).transfer(msg.sender, interestAmtInBank);
		}
...
*/
	function withdrawToken(uint256 _amt) public onlyOwner {
		require((ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).balanceOf(address(this)) >= (_amt + totalUnclaimedRewards + interestAmtInBank + totalAccumulatedInterest())), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((_amt > uint256(0))){
			ERC20(address(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7)).transfer(msg.sender, _amt);
		}
	}
