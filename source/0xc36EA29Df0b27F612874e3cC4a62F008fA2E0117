/**
1️⃣ ONE PERCENT INU $OPI 1️⃣

A HIGHLY SECURE, COMMUNITY DRIVEN TOKEN.

$OPI is a community-driven token designed to optimize liquidity through a 
six percent tax and an auto-burn feature.

🆃🅾🅺🅴🅽🅾🅼🅸🅲

🅧 TOKEN NAME: ONE PERCENT INU
🅧 TOKEN SYMBOL: $OPI
...
🅞 TAX BUY & SELL: 6%
    ▬ 2% AUTO LIQUIDITY
    ▬ 2% REFLECTION (NATIVE TOKEN)
    ▬ 2% MARKETING
🅞 MAX WALLET: 4%
🅞 MAX BUY & SELL: 4%

🅥 SUPPLY: 500,000,000 $OPI
🅥 TOKEN BURN: 150,000,000 $OPI (30%)
🅥 TOKEN PUBLIC: 350,000,000 $OPI (70%)

Group Chat: https://t.me/opibsc
Official Twitter: https://twitter.com/OpiTokenBsc
Official Website: https://onepercentinu.site/
**/
...
contract OnePercentInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ONEPERCENTINU";
    string private constant _symbol = unicode"$OPI";
    ...
    address payable public DevWallet = payable(0x7946E294105acC62f7426aFb06a7029CC05Cd692);
    address payable public MarketingWallet = payable(0xEb43cad1801FE384821824abd552b49b1b66fe05);
    ...
    function maxTxUpdate() external onlyAddress {
