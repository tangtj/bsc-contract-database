/**
 * 
 Kerium Universe the real BSC "community" token, where the community decides in which direction the coin should go. Our unique tokenomics and our monthly polls on Telegram allow the community to decide what to do with a large portion of the transaction taxes. Either Burn, Buy Back, Marketing, Charity, additional Lotteries, stocking up the LP pool, or Reflecting the collected Kerium to all holders. Also, there will be additional Lotteries every time our Lottery wallet receives a Lambo worth in reflections. Early investors will especially be rewarded because 35 percent of the total token supply will be burned. There will be a 5% burn at 1 million Marketcap, 5% burn at 5 million Marketkap, 10 % burn at 10 million Marketcap, and 15% burn at 20 million Marketkap. Each of these burns and each Joker Action will reflect 5% of the value of their tokens in bnb to all holders. All this is only a small fraction of our tokenomics to get a hang of our full tokenomics. We will doing presale, then launch after it. 
*/
...
contract KER is Context, IERC20, Ownable {
