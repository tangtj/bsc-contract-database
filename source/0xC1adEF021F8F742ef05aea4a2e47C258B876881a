//Telegram: https://t.me/+E3pofZMWOXgwY2E1
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDFBfB27E76F3Fce4f6b05E95D88E42492d8ac1B1; // owner address
...
contract LIFTOFF is Context, IERC20, Ownable {
    ...
    string private _name = "LIFTOFF PROTOCOL";
    string private _symbol = "LIFTOFF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDFBfB27E76F3Fce4f6b05E95D88E42492d8ac1B1);
    address payable public buybackWalletAddress = payable(0xDFBfB27E76F3Fce4f6b05E95D88E42492d8ac1B1); 
