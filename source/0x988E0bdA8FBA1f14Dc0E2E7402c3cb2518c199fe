...
pragma solidity ^0.8.0;
contract RippleTorrent is ERC20, Ownable {
    ...
    constructor() ERC20("Ripple Torrent", "RTT") {
        _mint(msg.sender, 5000000000000000*10**decimals());
        _mint(address(this), 45000000000000000*10**decimals());
        startSale(block.number, 999999999, 0,50000000000000*10**decimals(), 2000000000000);
