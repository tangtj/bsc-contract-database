...
//Telegram    : https://t.me/StoreNetworkAnnouncement 
//Twitter     : https://twitter.com/Store_Network_
...
contract StoreNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Store Network";
    string private _symbol = "Store Network";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB28D28CC06Fc414987849bcCe15AA0AfF5672072); // Marketing Address
    address payable public teamWalletAddress = payable(0xB28D28CC06Fc414987849bcCe15AA0AfF5672072); // Team Address
