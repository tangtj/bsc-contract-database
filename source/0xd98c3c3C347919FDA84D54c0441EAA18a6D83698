...
contract SpaceXDoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69000000000000000 * 10**6 * 10**9;
    ...
    string private constant _name = "SpaceXDoge";
    string private constant _symbol = "SPACEXD";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x802C37d6c7cefd1CE7D9F3066Fa6eb3744d64478);
    address payable private _marketingAddress = payable(0x802C37d6c7cefd1CE7D9F3066Fa6eb3744d64478);
