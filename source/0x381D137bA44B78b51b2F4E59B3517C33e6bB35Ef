...
contract NGENI2 is Context,IERC20, Ownable {
    ...
    string private constant _name = unicode"NgeniHigh";
    string private constant _symbol = unicode"$NGH";
