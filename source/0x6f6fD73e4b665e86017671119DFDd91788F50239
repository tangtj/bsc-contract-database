...
contract t996 is Token {
    ...
    function init() public onlyOwner {
        ...
        address _marketing = address(0x42dE7C756336f60F39FAB9CC3B24C98AcB968778); //
        address _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   //
        address _usdt = 0x55d398326f99059fF775485246999027B3197955;     //
        address _pair = super.__SwapPool_init(_router, _usdt);
        //
        feeMarketingBuy = 100;  //买入
        feeLiquidityBuy = 0;    //回流
        feeDividendBuy = 300;   //股息
        feeBurnBuy = 0;         //燃烧

        feeMarketingSell = 100; //卖入
        feeLiquiditySell = 50;  //回流
        feeDividendSell = 300;  //股息
        feeBurnSell = 0;        //燃烧
        //
        feeTransferAll = 5000;   //
        //
        ...
        super.setSurprise(
            9000,
            3,
            address(0x42dE7C756336f60F39FAB9CC3B24C98AcB968778)
        );
        super.__Token_init(_marketing, _usdt, _isDividend);
        setSwapTokensAt(1 ether);
        setInitPrice(0.1 ether);
        feeMarketingTo2 = address(0x77Dc4b4F8967AA76f3f5d0335b4DaEb45a8ba1Bb);
        feeEarn = 1000;
        isLiquified = true;
    }
}