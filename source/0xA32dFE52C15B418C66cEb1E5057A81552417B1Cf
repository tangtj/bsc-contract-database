...
contract CC is ERC20 {
    ...
    address _fundAddress = address(0x9297150c1925F6D05e94e940B44980655b948eB5);
    address _buyAddress = address(0x1af98a87e71f233Ece9a5f496D845bD4D61124CE);
    ...
    constructor(address tokenOwner) ERC20("CCOIN", "CC") {
