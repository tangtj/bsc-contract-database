...
Telegram https://t.me/ProSoftChain
Website https://prosoftchain.org
*/
...
contract ProSoftChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PROSOFT CHAIN";
    string private _symbol = "$PRCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB2f88d9d9D2F7dFA14C51747F8AB672ca38c146c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xEa646FB94007353ff346C39c47a1142Ba0ffeDe5); // BuyBack Address
