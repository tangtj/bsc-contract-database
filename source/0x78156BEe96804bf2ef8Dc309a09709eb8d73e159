...
contract Symbolic is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x44580D54c8eeE95806369fb79F3901871d326833); // Marketing Address
    address payable public teamWalletAddress = payable(0x44580D54c8eeE95806369fb79F3901871d326833); // Team Address
