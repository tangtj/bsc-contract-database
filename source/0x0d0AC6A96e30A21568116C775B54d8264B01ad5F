/**
   ShibVader is poised to wield it's power to  
   revolutizebthe world of decentralized  
   finance and meme culture.
  TELEGRAM: https://t.me/ShibVaderToken
*/
...
contract SHIBVADER is IERC20, Ownable, BaseToken {
