...
contract LaVidaStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // LA VIDA Token Contract Address
    address public constant tokenAddress = 0x70C748Ae56687fDe25b4251c4190f04e930F6Be4;
    ...
    // unstaking possible after 27 Days
    uint public constant cliffTime = 27 days;   
    ...
    uint private constant stakingAndDaoTokens = 1000e18;   // 1,000 LA VIDA Token will be staked by owner
