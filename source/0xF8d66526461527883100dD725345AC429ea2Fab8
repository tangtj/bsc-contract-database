...
//Telegram : https://t.me/ocislybep20
//Twitter : https://twitter.com/ocislyBEP20
...
contract OCILSY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2d1Bf8572af6557C6D5803b931789DdAd26e6Dc6); 
    address payable private Wallet_Dev = payable(0x743424ecd2Dbaa7a74E7ED4014d80318389145C2);
    ...
    string private constant _symbol = unicode"$OCILSY"; 
    ...
    constructor () {
        ...
        _owner = 0x743424ecd2Dbaa7a74E7ED4014d80318389145C2;
