/**
 ...
 // Vyperium - VYUM // Multichain Layer-2 network with Hybrid Compute.
...
library Address{
 ...
 contract Vyperium is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 200000000 * 10**9;
    uint256 public maxSellLimit = 200000000 * 10**9;
    uint256 public maxWalletLimit = 200000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xC424B9AeaCC148dA2839f45BDC56EFe48cC72D81;
    address public developmentWallet = 0xC424B9AeaCC148dA2839f45BDC56EFe48cC72D81;

    string private constant _name = "Vyperium";
    string private constant _symbol = "VYUM";
