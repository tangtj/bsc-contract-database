...
contract YAKINUXXX is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yak Inu XXX ***"; // 
    string private constant _symbol = "YAK INU xxx ***"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x9d1D0ac6977C81bf81749BE8DB4D7004D3f4404E;
