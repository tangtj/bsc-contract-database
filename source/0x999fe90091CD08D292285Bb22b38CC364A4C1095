...
contract Future is ERC20, Ownable {
    ...
    address private constant USDT = 0x111e7A5420D8c1F9e15392DB966AbBd7F31fD869;

    address public marketingWallet = 0x657a71fAf796880d828697Ae810fCDEfcB97142d;
    address public tokenOwner = 0x9C1ECc525c5FC126723c0b204c53aD53Db7Dc328;
    ...
    uint256 public maxAmountLimit = 2000000 * 1e18;
    ...
    function updateFees() private {
        ...
        if (current - startTime >= 20 days && removeLpFee != 0) {
            removeLpFee = 0;
            return;
        }
