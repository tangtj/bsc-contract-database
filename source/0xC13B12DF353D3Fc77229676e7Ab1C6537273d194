...
contract BALDCOIN is Context, IERC20, Ownable {
    ...
    address payable public _developmentWL = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    address payable public _marketingWL = payable(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
