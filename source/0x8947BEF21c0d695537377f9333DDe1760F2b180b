...
contract MOGHTTOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public aknfhg7;
    ...
    string private _tokenname = "Moonlight Token";
    string private _tokensymbol = "MOONLIGHT";
