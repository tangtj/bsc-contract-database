/**
    ...
    TG: https://t.me/multixchain
    Twitter: https://twitter.com/multixchain
    Website : https://multixchain.tech
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x0D9C34d32930a95414f0ADA651a6E20252e9C895; // owner address
...
contract MXC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Multi X Chain";
    string private _symbol = "MXC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xBF5d76de8789A9B0F8eAc67207DADeb910Cfc6e8); // Marketing Address
    address payable private teamWalletAddress = payable(0xBF5d76de8789A9B0F8eAc67207DADeb910Cfc6e8); // Team Address
