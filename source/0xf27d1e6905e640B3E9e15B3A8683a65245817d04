/**
telegram: https://t.me/xzeronetwork
...
contract X0Network is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XZero Network";
    string private _symbol = "X0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBefB8A2E05ba6b9331D8f83721D51cFED9e5e7b5); // Marketing Address
    address payable public teamWalletAddress = payable(0xBefB8A2E05ba6b9331D8f83721D51cFED9e5e7b5); // Team Address
