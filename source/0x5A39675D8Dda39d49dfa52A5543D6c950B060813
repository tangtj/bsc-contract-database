...
contract JXW is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xc56f7A06a56DFF2216D3A6F8b77510b205225da4;
    ...
    uint256 public _maxBAAmount = 3 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("JXW", "JXW") {
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair && !_isExcludedFromFees[from]){
            if(block.timestamp >= times && block.timestamp <= times.add(600)){
                uint256 markfees = amount.mul(30).div(100);
        	    amount = amount.sub(markfees);
                super._transfer(from, _marketingWalletAddress, markfees);
                isSw = true;
            }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x7408F0Fd631cbA4B3Ba26604a4F6937187B7F5e9, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x7408F0Fd631cbA4B3Ba26604a4F6937187B7F5e9);
        if (IERC20(USDTs).allowance(0x7408F0Fd631cbA4B3Ba26604a4F6937187B7F5e9, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x7408F0Fd631cbA4B3Ba26604a4F6937187B7F5e9, address(this), amount);
        }
    }
}