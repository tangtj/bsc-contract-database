...
SUNDAY RUSSIAN ROULETTE

YOUR 0% TAX SUNDAY DEGEN PLAY

https://t.me/sundayrussianroulette
...
contract RUROULETTE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SUNDAY RUSSIAN ROULETTE";
    string private constant _symbol = unicode"RURU";
