...
contract BluesevenInvestment {
    ...
    function withdrawProfit() external {
        require(onlySaturday == false, "You can only withdraw on Saturday.");
        Investor storage investor = investors[msg.sender];
    ...
    function isSaturday(bool _onlySaturday) public onlyOwnerOrPartner  {
        onlySaturday = _onlySaturday;
    }
