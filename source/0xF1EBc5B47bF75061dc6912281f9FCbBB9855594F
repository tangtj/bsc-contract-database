...
contract ENIGMA is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 25 * 10**_decimals;
    uint256 public maxBuyAmount = 25 * 10**_decimals;
    uint256 public maxWalletBalance = 50 * 10**_decimals;

    address public marketingAddress = 0x503d1E29B5888323e599a4931574f234b0Dbe943;
    address public devAddress = 0x503d1E29B5888323e599a4931574f234b0Dbe943;
