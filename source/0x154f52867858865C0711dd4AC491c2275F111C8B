...
contract Pelosi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6B20Fe3F7B3d0264bd9188162909fED204966856);
    address payable public teamWalletAddress = payable(0x6B20Fe3F7B3d0264bd9188162909fED204966856);
