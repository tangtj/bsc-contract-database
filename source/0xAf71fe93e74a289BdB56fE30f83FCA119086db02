/**
 ...
 Telegram : https://t.me/babystakemoon
...
contract BabyStakeMoon is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "BabyStakeMoon";
    string constant _symbol = "BSMOON";
    ...
    uint256 public _walletMax = 3000000 * (10 ** _decimals); //0.3%
