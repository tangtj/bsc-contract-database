/*
BNP Network builds a payment system in which cryptocurrency is used as a payment method in the real economy, based on our own developed blockchain technology. We are developing several platforms that we will link in the BNP -Network with BNP as payment system (3 MONTHS IN THE MAKING)
...
🔵Blockchain
🔵Buy/Sell :1/2
🔵BNP Mobile app : https://play.google.com/store/apps/details?id=com.bnpnetwork.bnpapp 
🔵Twitter: TBA
🔵Website : https://bnp-miner.com/
🔵TG:https://t.me/bnpnetworkofficial
*/
...
contract BNPMINERNETWORK is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNP MINER NETWORK";
    string private constant _symbol = "BNPMINER";
