...
contract XPHINK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xphink";
    string private _symbol = "XPHINK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x291B8e9b7D528A69Ec9578bf056ce6d16b7a4b1B); 
    address payable public teamWalletAddress = payable(0x291B8e9b7D528A69Ec9578bf056ce6d16b7a4b1B);
