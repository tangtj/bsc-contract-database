...
contract LEOBNB is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xcB913cD443Bc9057325203749ce0493C59Dcb693); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "LEO BNB"; // token name
    string private _symbol = "LEOBNB"; // token symbol
    ...
    uint256 public _maxTokensPerAddress          = _tTotal.div(2000); // Max number of tokens that an address can hold 5% of total supply
