...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1FD49B775cc6CA65f55a5ad71DCfF02A2a092BD7; // owner address
...
contract SHIA is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Saga";
    string private _symbol = "SHIA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1FD49B775cc6CA65f55a5ad71DCfF02A2a092BD7); 
    address payable public teamWalletAddress = payable(0x1FD49B775cc6CA65f55a5ad71DCfF02A2a092BD7);
