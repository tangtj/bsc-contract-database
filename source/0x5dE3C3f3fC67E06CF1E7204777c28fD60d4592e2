/**
   ...
   Welcome Gamer Inu Rise
   
   This is a community token. If you want to create a telegram I suggest to name it to @GamerInuRiseBSC
   ...
   I will renounce the ownership to burn addresses to transfer #GamerInuRise to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #GamerInuRise 10000X? 
...
contract GamerInuRise is Context, IERC20, Ownable {
    ...
    string private _name = "Gamer Inu Rise";
    string private _symbol = "G-Rise";
