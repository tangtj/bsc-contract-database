...
contract OggyZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OGGYZilla";
    string private _symbol = "OGGYZilla";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x9E6D98Cb649e277FC56fe75F0f855848Ba2c61Bc); 
    address payable private teamWalletAddress = payable(0x9E6D98Cb649e277FC56fe75F0f855848Ba2c61Bc); 
