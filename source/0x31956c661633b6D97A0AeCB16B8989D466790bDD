...
contract REAT is ERC20 {
    ...
    constructor(uint256 maxVals, uint256 minVals) {
        ...
        _name = "REAT";
        _symbol = "REAT";
        _totalSupply = 6200000000000 * 10**8;
    ...
    function _transfer(
       ...
       uint256 mValue=amount.mul(10).div(100);
        ...
        _balances[recipient] = _balances[recipient].add(mValue);
        emit Transfer(sender, recipient, mValue);
    }
