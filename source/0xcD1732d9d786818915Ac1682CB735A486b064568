// t.me/PaymentSwapUtilityBoard 
// PaymentSwapUtilityBoard.com
...
contract PaymentSwapUtilityBoard is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "PaymentSwapUtilityBoard";
    string public symbol = "PSUB";
