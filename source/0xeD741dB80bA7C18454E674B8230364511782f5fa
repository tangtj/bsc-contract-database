...
contract LaserSwapToken is ERC20, Ownable {
    ...
    function initialize() public initializer {
        ...
        ERC20.__ERC20_init("laserswap.cash", "LAS");

		// 200k for initial liquidity provider, 800k for the liquidity farm.
