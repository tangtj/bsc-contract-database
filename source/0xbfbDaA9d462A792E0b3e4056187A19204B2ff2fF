...
*/
/**
// Telegram : https://t.me/baymaxtoken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a7e7398b7fF174912c202852d031e1CB571BFC2 ; // owner address
...
contract Baymax is Context, IERC20, Ownable {
    ...
    string private _name = "Baymax";
    string private _symbol = "Baymax";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD24C6907c7fACbEd353e7554b76248f4f0918aA6); // Marketing Address
    address payable private teamWalletAddress = payable(0xf8994365891F4bb4D02d0927B1042d43b7fF3a37); // Team Address
