...
contract DOLLARSHIBAINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa2AD468FF2e2c2309b06B5835217d23b08DA4670); 
    address payable public Wallet_Dev = payable(0x408a7AEA1ad11E77296Bcf4b6dB3AC6881dBBbE6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "DOLLAR SHIBA INU"; 
    ...
    constructor () {
        _owner =0x408a7AEA1ad11E77296Bcf4b6dB3AC6881dBBbE6;
