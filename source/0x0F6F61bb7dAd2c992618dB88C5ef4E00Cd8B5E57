...
contract Gardenia is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gardenia", "GDA") {
        ...
        address newOwner = address(0x5B91465b7994Cef119c7B38eD97fBF0d03A4e5A4);
    	...
    	marketingWallet = address(0x5B91465b7994Cef119c7B38eD97fBF0d03A4e5A4);
