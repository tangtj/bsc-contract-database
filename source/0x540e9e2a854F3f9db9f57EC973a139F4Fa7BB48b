 ...
 ******************  BSC TEST 9    xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
 ******************  BLANK CHANGABLE    xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
 ******************* TEST CONTRACT      xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
 ******************* DO NOT ATTEMPT TO PURCHASE THIS TOKEN IF SEEN LIVE xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
contract BSCTest9 is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //  BSC MAIN
    ...
    constructor() ERC20("BSCTest9", "BSCT9") {
        ...
        devWallet = address(0x43E0dFd43b8D4D8D27afA36769b87bCddfC151CE);
        liqWallet = address(0x43E0dFd43b8D4D8D27afA36769b87bCddfC151CE);
        operationsWallet = address(0x43E0dFd43b8D4D8D27afA36769b87bCddfC151CE);
        daoWallet = address(0x43E0dFd43b8D4D8D27afA36769b87bCddfC151CE);
        ...
        _mint(
            address(0x43E0dFd43b8D4D8D27afA36769b87bCddfC151CE),
            (totalSupply / 100) * 50
        );
