...
contract FoxAI is ERC20, Ownable {
    ...
    address private _marketingWalletN = address(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
    address private _devWalletW = address(0xDD18c4b15FF6f22D6D5fE91d52f1Bbb794139E86);
