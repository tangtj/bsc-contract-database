...
contract HZH is Context, IERC20, Ownable {
    ...
    string private constant _name = "HZH coin";
    string private constant _symbol = "HZH";

    
    address payable private _developmentAddress = payable(0xF7326BA9DF4cc5979198309ab102d7Fb1507F9A2);
    address payable private _marketingAddress = payable(0xfeB5F309F3965D3f2654CCF00Bc38f47e42d11b6);
