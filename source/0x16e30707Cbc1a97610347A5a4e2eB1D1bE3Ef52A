...
contract BinanceNova is Context, IERC20, Ownable {
    ...
    string private _name = "Synesis One";
    string private _symbol = "SNS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xdBa8301bE144fD3Dd93C1344312289B85b6C480d);
    address payable public liqWalletAddress = payable(0xdBa8301bE144fD3Dd93C1344312289B85b6C480d);
