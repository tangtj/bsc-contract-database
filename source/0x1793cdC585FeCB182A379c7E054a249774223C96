...
contract CRAZYDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb5f5e230DaB517016668901551E4532f5d0F02CE); 
    address payable public Wallet_Dev = payable(0x17c6678aB1E3383140340Bd898c1C7257C88E35a);
    ...
    constructor () {
        _owner =0x17c6678aB1E3383140340Bd898c1C7257C88E35a;
