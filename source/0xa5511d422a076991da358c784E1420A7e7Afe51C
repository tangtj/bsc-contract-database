...
contract FanSubsV3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x383E405C2501aE0dd094bA5e86d7BA75385d6A04); // Marketing Address
    ...
    string private _name = "FanSubs V3"; 
    string private _symbol = "FSTV3";
    ...
    uint256 private constant numTokensSellToAddToBuyback = 100000*10**18;
