...
contract SIXTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public tvdxcd4;
    ...
    string private _tokenname = "Shiba Inu X";
    string private _tokensymbol = "SIX";
