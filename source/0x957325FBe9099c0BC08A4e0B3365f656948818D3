...
contract HCHNFT is ERC721Enumerable, Ownable {
    ...
    function setMaxTotal(uint256 maxTotal) external onlyOwner {
        _maxTotal = maxTotal;
    }
    ...
    constructor() ERC721("HCH NFT", "HCH NFT") {
        _uris[
            1
        ] = "https://gateway.pinata.cloud/ipfs/QmfVu7eHETXZC8tADjdc6P4UMhcuQxtHt8vnWe23yVhCaE";
    }
}