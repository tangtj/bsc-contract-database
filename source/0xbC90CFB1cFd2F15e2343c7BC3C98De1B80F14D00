...
contract CCDSCCGDS is ERC20, Ownable {
    ...
    constructor() ERC20("CCDSCCGDS", "CCDSCCGDS") {
        ...
        maxWallet = 600_000_000 * 1e18; // 0.6% 
        ...
        marketingWallet = address(0xC453c94D67AF5a6cf932783c4Bf3F40044F1AE34); // set as marketing wallet
        devWallet = address(0xC453c94D67AF5a6cf932783c4Bf3F40044F1AE34); // set as dev wallet
