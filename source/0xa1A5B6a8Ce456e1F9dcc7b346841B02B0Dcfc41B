...
TELEGRAM: https://t.me/shiba_monkey
...
contract  ShibaMonkey is Context, IERC20, Ownable {
    ...
    string private constant _name = " Shiba Monkey"; // 
    string private constant _symbol = "$SHIMON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x8E3765c7c48c1D50d0D7EE9a52a6097dc3E071f7;
