...
Who is the Girl?
The Eternal Girl 夢限少女 , a buxom beauty with porcelain skin, 
who uses the Ethereum to reward all souls who embark on the journey with her. 
Her stories will be told for an eternity. 
Throughout pages of rich history, steeped in tradition. 
Our girl begins as any other young girl with a dream. 
Her home is not that of great means, as a humble pauper's daughter The Girl will overcome 
over all odds and share her triumph with all of the people of The Ether.

4% Ethereum rewards.
4% for Marketing.

No tax change / trading disable functions.

eternalgirl.io / t.me/EternalGirlBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 0.0005 * (10**18);
...
contract EternalGirl is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EternalGirl";
    string constant _symbol = "ETGL";
    ...
    uint256 public swapThreshold = (_totalSupply * 2) / 1000; // 0.02% of supply
    // anything above swapThreshold is burned
    uint256 public maxContractRewardHold = swapThreshold.div(2);
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6974B89B9eB9e0C3B8b304a330ce6Eadb92e4693;
