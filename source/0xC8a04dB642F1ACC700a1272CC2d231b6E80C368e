...
/*
Website: https://www.orcaproject.vip 

Twitter: https://twitter.com/Orcaprojectvip
*/
...
contract OrcaToken is ERC20, Ownable {
    ...
    OrcaDividendTrackerV2 public dividendTracker;
    ...
    constructor(address _developerwallet) ERC20("ORCA Token", "ORCA") {
        dividendTracker = new OrcaDividendTrackerV2();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        OrcaDividendTrackerV2 newDividendTracker = OrcaDividendTrackerV2(
            payable(newAddress)
        );
...
contract OrcaDividendTrackerV2 is Ownable, DividendPayingToken {
    struct AccountInfo {
        address account;
    ...
    constructor()
        DividendPayingToken("Orca_Dividend_Tracker_V2", "Orca_Dividend_Tracker_V2")
    {}
