...
contract TtToken is Context, IERC20, Ownable {
    ...
    address public _feeAddress = 0x9fF2ac45355767b1e19aeB7044720EFD6089bbdE;
    ...
    constructor () {
        ...
        _balances[0xc862EBa1Ae130CE84e41985a8ce7f33cf8a091fA] = _totalSupply;
        emit Transfer(address(0), 0xc862EBa1Ae130CE84e41985a8ce7f33cf8a091fA, _totalSupply);
    }
    ...
    function changeFeeAddress(address _f) public onlyOwner {
        _feeAddress=_f;
    }
