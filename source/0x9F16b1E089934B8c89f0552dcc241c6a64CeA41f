...
With the abbreviation $DINO, this coin is a new symbol within the blockchain ecosystem dedicated 
to rekindling interest in dinosaurs, making it more captivating and interactive with crypto technology.

🌙Join early and earn big in $DINO🦖
TG : https://t.me/DinoHypeBSC
**/
...
contract DINOHYPE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DINO HYPE";
    ...
    address payable public DevWallet = payable(0x980E91be397937B792B32058fFD3149e5A986d09);
    address payable public MarketingWallet = payable(0x05348ddf778799C5Fe46f3eB0584C025AF5d122c);
