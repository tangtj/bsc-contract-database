...
library SafeMath {
     ...
     * reverts when dividing by zero.
     */
    function mod1(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b != 0);
        return a % b;
    }
}
...
contract Payconnect  is BEP20Detailed,BEP20,Ownable,BEP20Burnable {


    constructor()
        public
         BEP20Detailed ("Payconnect", "Payconnect", 8) {
            _mint(msg.sender, 20000000 * (10 ** uint256(8)));
        }
