...
https://t.me/frunk_puppy

Let's Do ELon's Tweets.... SAFELY!
...
Adjusting to 3% when teh price increases, then the contract will be remounced.
The max transaction and max holding will then be locked at 3%
...
The liquidity will be burned and the contract will be renounced shortly after launch

There is an 'OnlyFloki' modifier that will allow for fees to be adjusted after renouncing ownership
This allows the contract to be micro-managed by adjust the auto-liquidity levels for optimum growth

The only thing that this modifier can do is adjust fees (Within the hard-coded limits!) After renouncing all other funcitons are locked
The HARD-CODED limits prevent the OnlyFloki modifier from being abused - Fees can never be set above 12%!

Contract code was created by GenTokens. 
...
contract Floki_FrunkPuppy is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x1CE303A8c02Ddd30f84DD93Fbd7FF4f0EE6a4529); 
    address payable private Wallet_Floki = payable(0xf9631AA0eb8b36d64d9b452C5eC743E84A7c16b0); 
    address payable private Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    
    modifier onlyFloki() {
        require(Wallet_Floki == _msgSender(), "Only FLoki can do this!");
        _;
    }
    ...
    string private _symbol = "FFPuppy";  
    ...
    constructor () {
        ...
        _isExcludedFromFee[Wallet_Floki] = true;
    ...
    */
    ...
    function _set_Fees(uint256 Liquidity, uint256 Marketing, uint256 Reflection, uint256 Developer) external onlyFloki() {
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       uint256 totalBNB;
        ...
        sendToWallet(Wallet_Floki, (totalBNB-marketingBNB));
