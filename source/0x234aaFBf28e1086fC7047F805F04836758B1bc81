...
contract LOPE is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0xf04Ed9fd821fFA77A52Ce26953bbDF7C8B4D1E58); // Team Wallet
    address public _projectWalletAddress = address(0xf04Ed9fd821fFA77A52Ce26953bbDF7C8B4D1E58); //Project Wallet
    ...
    constructor() ERC20("JACKALOPE COIN", "LOPE") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // DEX ROUTER
        ...
        buyFee.projectFee = 10; // 10% Project fee
        buyFee.teamFee = 0;  // 0% team fee
        totalBuyFee = buyFee.projectFee + buyFee.teamFee;

        sellFee.projectFee = 12; // 12% project fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "LOPE: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LOPE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LOPE: Automated market maker pair is already set to that value");
