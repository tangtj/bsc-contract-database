...
contract RS is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0xEC586B113Cfed29db70B4e4994D38eB682Ac85B5;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountUSDTLiquidity = amountUSDT.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        uint256 amountUSDTReflection = amountUSDT.mul(reflectionFee).div(totalBNBFee);
        uint256 amountUSDTMarketing = amountUSDT.mul(marketingFee).div(totalBNBFee);
