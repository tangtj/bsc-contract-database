 ...
 *    https://t.me/Gladiator_Token_Official
      https://twitter.com/GladiatorTokenX
*/         
...
contract GladiatorToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Gladiator";
...
uint256 public extraFeeOnSell = 0;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xb7039Ba8ea0b36538019f5633BED3772f6D4AC5F;
