...
contract CYBERXT  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8b5443c3f9966FC213Ced2f40B55cc9e596Af2e3); 
    address payable public Wallet_Dev = payable(0x82a0Dd8Eaa2d202b841D441bD1ED280Fd1d0573d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 17* 10**5* 10**5 * 10**_decimals;
    string private constant _name = "CYBER X TOKEN"; 
    string private constant _symbol = unicode"$CYBER X"; 
    ...
    constructor () {
        _owner =0x82a0Dd8Eaa2d202b841D441bD1ED280Fd1d0573d;
