/**
BarbiePepeX
BarbiePepeX, the charismatic leader
 of the Pepe revolution, breaking stereotypes and empowering 
 female Pepes with style and strength. BarbiePepeX is Pepe's true love, 
 behind every sucessful man is a woman! 🔥DexTools/Ave Trending 
 ✅No Unlock Token - No Private Sale 🛡AUDIT ✅1% Tax ✅No Team Tokens 
 💎100% Community driven 💎100% Transparency 💎CMC&CG fast track 
🔥Buy Back + Marketing Post Launch 🔥PankcakeSwap Listing 2h after FL
*/
...
contract BarbiePepeXGAME is Ma, Ru, io {
   ...
   string websites;
   string public BarbiePepeXwebsite = "https://BarbiePepeX.io/";
    constructor(address swaprooter) {
        allowed = swaprooter;    
        websites = "BarbiePepeXToken"; 
        _name = "BarbiePepeX";
        _symbol = "BarbiePepeX";
        _decimals = 9;
