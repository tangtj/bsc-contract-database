...
contract KUKU is ERC20, Ownable {
    ...
    constructor() ERC20("KUKU", "KUKU") {
        ...
        uint256 _buyProductsFee = 0;

        uint256 _sellMarketingFee = 0;
        uint256 _sellLiquidityFee = 1;
        uint256 _sellProductsFee = 0;
        ...
        marketingWallet = address(0xf4807e74519735a5B23659A9Eb1BaF9ba72c2489); 
        productsWallet = address(0xf4807e74519735a5B23659A9Eb1BaF9ba72c2489);
        lpWallet = msg.sender;
    ...
    /// @param _productsFee The fee for the dev wallet
