...
contract xxx is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        marketingWallet = payable(0xbc7FE88fa7406B6E6C0e93b9390E42d25f6DD6E2);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xbc7FE88fa7406B6E6C0e93b9390E42d25f6DD6E2] = true;
