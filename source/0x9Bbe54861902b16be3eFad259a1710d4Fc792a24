...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E81f557B0BcF6E368f3A2ED38E0c067B974b630; // owner address
...
contract Pepe69 is Context, IERC20, Ownable {
    ...
    string private _symbol = "P69";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7E81f557B0BcF6E368f3A2ED38E0c067B974b630); // Marketing Address
    address payable public teamWalletAddress = payable(0x7E81f557B0BcF6E368f3A2ED38E0c067B974b630); // Team Address
