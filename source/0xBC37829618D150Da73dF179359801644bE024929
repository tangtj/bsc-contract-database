//Magnet Protocol is a deflationary and rewarding token. 2% burn 3% reward,use 5% slippage
//Join telegram https://t.me/magnetprotocol
...
contract MagnetProtocol is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Magnet Protocol';
    string  private constant _SYMBOL = 'MGN';
    ...
    uint256 private constant _MAX_TX_SIZE = 20000000 * _DECIMALFACTOR;
