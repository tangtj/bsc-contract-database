// telegram: https://t.me/metacakeversetoken 

// 3% LP 3% Marketing 1% Buyback 8% Rewards
...
contract METACAKEVERSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METACAKEVERSE";
    string private _symbol = "METACAKEVERSE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x299E1f14fF322f661D4af7a3FF4F84E62E6AE6C9); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x299E1f14fF322f661D4af7a3FF4F84E62E6AE6C9); // Buyback Wallet Address
    ...
    uint256 public _maxTxAmount = 70000000 * 10**9; // 2%
    uint256 public _walletMax = 100000000 * 10**9; // 3%
