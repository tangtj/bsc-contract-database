...
*/
	function stake(uint256 _stakeAmt) public {
		...
		ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).transferFrom(msg.sender, address(this), _stakeAmt);
...
*/
	function unstake(uint256 _unstakeAmt) public {
		...
		require((ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).balanceOf(address(this)) >= ((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)) > uint256(0))){
			ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).transfer(msg.sender, ((_unstakeAmt * (uint256(1000000) - principalWithdrawalTax)) / uint256(1000000)));
		}
...
*/
	function principalTaxWithdrawAmt() public onlyOwner {
		require((ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).balanceOf(address(this)) >= principalAmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		if ((principalAmtInBank > uint256(0))){
			ERC20(address(0xC9098A06039725d97BB40481595Ec62537d6209F)).transfer(msg.sender, principalAmtInBank);
		}
...
*/
    ...
    function withdraw_coin_SFIL(uint256 _amount) public onlyOwner {
		require((ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).balanceOf(address(this)) >= _amount), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0xC9098A06039725d97BB40481595Ec62537d6209F).transfer(msg.sender, _amount);
	}
