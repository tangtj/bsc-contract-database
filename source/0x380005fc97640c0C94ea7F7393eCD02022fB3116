...
contract Simpsoninu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SIPS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xfC2F70DAebE37bdA9aB551Ff81446eeFB5BFC747);
    address payable private _marketingAddress = payable(0x2b3C6ECD24e102c57daB4e5310154Ae8f66ceC37);
