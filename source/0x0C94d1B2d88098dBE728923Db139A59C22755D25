...
contract XXX is Context, IERC20, Ownable {
    ...
    string private _name = "XXX2.0";
    string private _symbol = "XXX2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2db5072E361485D4CE92cbC1EfD4C79230545180);
    address payable public teamWalletAddress = payable(0x2db5072E361485D4CE92cbC1EfD4C79230545180);
    address public immutable deadAddress = 0x2db5072E361485D4CE92cbC1EfD4C79230545180;
