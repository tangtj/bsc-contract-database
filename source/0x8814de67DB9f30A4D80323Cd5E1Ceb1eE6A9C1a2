...
contract TCAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x225a433A89ccb1249a2c1fe56962aad5bc292d1e); 
    address payable public Wallet_Dev = payable(0x225a433A89ccb1249a2c1fe56962aad5bc292d1e);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =420060 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "TIGERCAT COIN"; 
    ...
    constructor () {
        _owner =0x225a433A89ccb1249a2c1fe56962aad5bc292d1e;
