...
contract RivenInu is Context, IBEP20, Ownable {
    ...
    address private DevWallet = 0xfFEa158C817F2232C07464c8Be5cD08b99464BAe;
    address private MarketingWallet = 0xbaabc513c16f9512594EE2003ED7B8d08354f39C;     
    ...
    uint256 public constant buyFee = 9;
    uint256 public constant sellFee = 9;
