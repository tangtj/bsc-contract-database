...
contract Ownable is Context {
    ...
    constructor () {
        _owner =   0xC0aA09343FDDF96c902183A0B3f66fCCe66b3538;
...
contract ReflecSHAWN is Context, IERC20, Ownable {
    ...
    string private constant _name = "ReflecSHAWN"; // 
    string private constant _symbol = "$RFLS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    uint256 public _reflectionFee = 3;
    address payable public  _marketingWallet = payable(  0xC0aA09343FDDF96c902183A0B3f66fCCe66b3538 );
