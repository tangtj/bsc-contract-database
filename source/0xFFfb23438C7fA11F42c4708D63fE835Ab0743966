...
contract Chenchen is ERC20 {
    ...
    address _fundAddress = address(0xE6A9445983702cF14FFa209708990fc72855fe3a);
    ...
    constructor(address tokenOwner) ERC20("Chenchen", "Chenchen") {
    ...
    function _transfer(
		...
		if(startTime == 0 && to == uniswapV2Pair && super.balanceOf(uniswapV2Pair) == 0){
			startTime = block.timestamp;
			require(_isExcludedFromFeesVip[from] || _isExcludedFromFees[from],"add ldx");
		}
