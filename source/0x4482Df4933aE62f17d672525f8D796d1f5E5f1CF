...
contract DorkAlien is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x68ebbB98a0d5217F16DD6E9C58464eb1bbdc3e84;

    string private constant _name = "Dork Alien";
    string private constant _symbol = "$DorkA";
    ...
    // Owner cannot transfer out  Dork Alien from this smart contract
