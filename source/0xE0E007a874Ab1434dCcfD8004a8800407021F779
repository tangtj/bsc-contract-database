// https://t.me/PepeLukeBSC
// https://twitter.com/PepeLuke_bsc
// https://pepeluke.com/
...
contract PepeLuke is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PePe Luke";
    string private constant _symbol = unicode"PPLuke";
