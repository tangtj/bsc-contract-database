...
contract Starbucks is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6B7e14F3bb691d6BbA9d0c9C6204eaa2626226c6); // Marketing Address
    address payable public teamWalletAddress = payable(0x6B7e14F3bb691d6BbA9d0c9C6204eaa2626226c6); // Team Address
