...
contract BNET is Context, IBEP20, Ownable {
    ...
    address public marketingWallet =  0x8a2B5aF423ce230B8dD66481064131D1094f5C00;

    string private constant _name = "BNB VS ETH";
    string private constant _symbol = "BNET";
