...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x4139E99bF0DA654940faAF598ce479a125D3A031; // owner address
...
contract NUTS is Context, IERC20, Ownable {
    ...
    string private _name = "Nuts";
    string private _symbol = "NUTS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4139E99bF0DA654940faAF598ce479a125D3A031); 
    address payable public teamWalletAddress = payable(0x4139E99bF0DA654940faAF598ce479a125D3A031);
