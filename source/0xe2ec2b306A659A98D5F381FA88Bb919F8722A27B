...
contract Pepe2049 is Ownable, IERC20, IERC20Metadata {
    ...
    uint256 private constant _marketFee = 5;
    uint256 private constant basePercent = 100;
    uint256 private constant base = 10000;

    address private marketWallet = 0x074b84BBE54173b3595cDD43128aCA17097e4268;
