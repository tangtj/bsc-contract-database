...
contract COMPOUND20 is IToken, Ownable {
    ...
    uint256 private constant _totalSupply = 1 * 10**6 * 10**9;
    uint256 private _reflectionTotal = (MAX - (MAX % _totalSupply));
    uint256 private _takeFeeTotal;

    string private constant _name = "COMPOUND2.0";
    string private constant _symbol = "COMP2.0";
