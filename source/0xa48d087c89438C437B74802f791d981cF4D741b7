...
contract FINEInuTOKEN is Ownable {
    uint256 tokenamount = 10000000000*10**decimals();
    address public esjang7;
    ...
    string private _tokenname = "FINE Inu";
    string private _tokensymbol = "FINE Inu";
