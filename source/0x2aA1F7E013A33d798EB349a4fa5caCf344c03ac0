...
contract RealSmurfCat is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x087Bc2EeBFFA468E4beA7D71525566Fb8CA9F55d); // Marketing Address
    address payable public buybackWalletAddress = payable(0x087Bc2EeBFFA468E4beA7D71525566Fb8CA9F55d); // Buyback Address
