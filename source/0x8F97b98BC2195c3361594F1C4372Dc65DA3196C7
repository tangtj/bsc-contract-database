/**
BestFriend Doge ( $BFFDOGE ) is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community. Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future
...
contract BestfriendDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "BestFriend DOGE"; // 
    string private constant _symbol = "BFFDOGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xB798D85b9Ff76Eb97B719C51Bd3fbaC75Fc3F5cA;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xCE7d5e8b5F10B99E8008FD710432b036FbF44E7e;
