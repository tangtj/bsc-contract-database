...
contract XB is Context, IERC20, Ownable {
    ...
    string public _name = "X Blockium";
    string public _symbol = "XB";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC28516408D1935c41C4866e1B57799545F97bdf7); // Marketing/Development Address
    address payable private DevelopmentWalletAddress = payable(0x6d254C189bF734EB75302dd18AdA2D3F21494A16); // Address
