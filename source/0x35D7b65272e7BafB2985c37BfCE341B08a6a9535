...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0D09bf6e4873025F3bA4Cf075096B0695db412F3; 
...
contract ENOB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ENOB";
    string private _symbol = "$ENOB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0D09bf6e4873025F3bA4Cf075096B0695db412F3); // 
    address payable public teamWalletAddress = payable(0x0D09bf6e4873025F3bA4Cf075096B0695db412F3); // 
