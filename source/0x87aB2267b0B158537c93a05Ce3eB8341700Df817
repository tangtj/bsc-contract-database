...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBa19eB9884D5F88bE80D8f02F935aC94D5946D49; // owner address
...
contract Flokirum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flokirium";
    string private _symbol = "$FRIUM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4845E4feE3069dB4Ff6882F7550584B2D492Df40); // Marketing Address
    address payable private teamWalletAddress = payable(0xBa19eB9884D5F88bE80D8f02F935aC94D5946D49); // Team Address
