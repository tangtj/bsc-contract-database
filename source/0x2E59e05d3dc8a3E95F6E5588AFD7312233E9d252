...
contract HAPPY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1bE6F4060ddE75F032fFF603a47750f3a0Fbcc79); 
    address payable public Wallet_Dev = payable(0x1bE6F4060ddE75F032fFF603a47750f3a0Fbcc79);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =42000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "HAPPY PIG"; 
    string private constant _symbol = unicode"HAPPY PIG"; 
