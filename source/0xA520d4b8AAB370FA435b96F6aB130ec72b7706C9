...
contract GCB is AbsToken {
    ...
    //Total，总量
        500000,
    //Receive，接收地址
        address(0x5168a05a5ee4Eea2Ffa62A4A9866AAb86C456DAb),
    //Fund，营销钱包
        address(0x9119fee042F18aB3Bf3C3c4F408085b28FA0DA66),
    //NodeFee，节点分红
        address(0x1149ECBe3719daF3D9722f1054544Ff0F66644d4),
    //WTBFee，公羊钱包
        address(0x08fD63c7fe01C172BDAA49ea9700b2be0872b20D)
    ){
