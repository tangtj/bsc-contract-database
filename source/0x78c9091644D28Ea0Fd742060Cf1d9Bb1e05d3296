...
abstract contract MilkTeaToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _maxTxAmount = 9999999 * 10 ** Decimals;
...
contract BitoPro is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0xB86C7149f0528aE4E5A148D86E84DEb3fa857fa8),
    
        address(0x9C4c629C275b64eBc5c5B01f285Ea6522378d178)
    ){
