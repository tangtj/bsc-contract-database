...
contract GEAR5 is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x02357f2470DF4f8570af241aE08D35aA094b94DC);
    address payable public MarketingWallet = payable(0x84a58F5cF784563A73C25253324F9FA35E8016B1);
    ...
    function changeTaxFees(uint256 buytax, uint256 selltax) external onlyAddress {
        _tax_On_Buy = buytax;
