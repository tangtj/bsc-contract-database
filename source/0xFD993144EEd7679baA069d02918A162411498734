/**
Paypal Cash builds a payment system in which cryptocurrency is used as a payment method in the real economy, based on our own developed blockchain technology
...
contract PaypalCash is Context, IERC20, Ownable {
    ...
    string private constant _name = "Paypal Cash"; // 
    string private constant _symbol = "PayCash"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x53f6f8355d93937215b7ddeE4B5a9F6C47A710CF;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x380A84bebCF7CA0A05AB06fE2b11e35f0BCD9217;
