...
contract XRP is IERC20, Ownable {
    ...
    address internal develimentAddress = 0xF12b1Bbdc1c616573c1EbCa3Cf9bA15FDF23235C; 
    address internal marketAddress = 0xc9E0e07C5Fc32CFA47d9F2b3C5915aB237915904;
    ...
    constructor() Ownable(msg.sender) {
        _isFeeExclud[develimentAddress] = true;
    ...
    function swapAndLiquify(uint256 threadHold) private lockTheSwap {
        ...
        if(contractBalance > uint256(0)){payable(develimentAddress).transfer(contractBalance);}
    }
