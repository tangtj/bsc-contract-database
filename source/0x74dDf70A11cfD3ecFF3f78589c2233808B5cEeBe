...
contract CBEX is Context, IERC20, Ownable {
    ...
    string private _name     = "CryptoBank Hybrid Exchange";
    string private _symbol   = "CBEX";
    ...
    {        
        ...
        marketingWallet = 0x2fa453395BA14EadABEa22419b80221Ae51828b9;
