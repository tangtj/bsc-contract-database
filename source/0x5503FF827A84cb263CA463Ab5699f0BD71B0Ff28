...
⚛️ BIG BANG 2049 ⚛️ || BSC

($BIGBANG) aims to become one of the most sustainable cryptocurrencies 
that contribute to the growth of the blockchain ecosystem while celebrating 
the legendary courage respected by several communities.

⚛️Join our comunity
Tg: https://t.me/+-Yigy1DyZuBlMzFl
...
contract BIGBANG2049 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BIG BANG 2049";
    string private constant _symbol = unicode"$BIGBANG";
    ...
    address payable public DevWallet = payable(0xf9deA7357CF254086C3A4B6a581cD3A48e3712eB);
    address payable public MarketingWallet = payable(0x3764Da8da3e2afb149E955970AC39B7b0A3F35CD);
