...
https://t.me/PayxCredit
https://twitter.com/PayxCredit
https://payx.credit/
...
contract PAYX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PayX";
    string private constant _symbol = unicode"PAYX";
