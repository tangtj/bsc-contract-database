...
The Voltron way is that the project functions like the robotic lions that 
combine to form the mighty super-robot. In this case, the investors, traders, 
and holders of Voltron tokens are the robotic lions that come together to 
create a powerful DeFi ecosystem. Each investor plays a crucial role in the 
ecosystem, just like each lion has its own unique strengths and abilities that 
contribute to the formation of Voltron.

        Tokenomics (Main tax structure that may vary)
        - 2% Marketing
        - 2% Development

https://t.me/VoltronOfficial

https://twitter.com/Voltron_BSC

https://voltronbnb.com/
...
contract VOLTRONTOKEN is ERC20, Ownable {
    ...
    constructor () ERC20("Voltron", "VOLTN") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x7bB931e99008DaFaB7f6Be3b7511F0D608FD4772;
        marketingWallet =0x3dad2B0eBcdFe16e2aAc284D62bDEBAEE19d0DFf;   
