...
// Chad0x1 is a crypto community based currency that aims to spread information of the newly detected Monkeypox virus. 
// Chads Unite. We cannot afford another COVID-19.

// LP will be burnt, CA will be renounced. It's not about the token. It's about the information.

// 5% Taxes on each transaction
// - 2% Marketing (1% Monkeypox Patient Support, 1% to Other Marketing such as Information Rewards & Calls)
// - 2% LP
// - 1% Dev

// We believe in maximal distribution of Chad0x1 tokens, and have implemented strict rules around maximum holdings per Chad.
// - 1% max transaction
// - 2% max wallet

// Telegram Community: https://t.me/chad0x1
...
contract Chad0x1 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MonkeyPox", "Chad0x1") {
