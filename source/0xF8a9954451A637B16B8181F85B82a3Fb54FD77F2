//Telegram: https://t.me/glyph_ai
//Website: https://glyph.green/
//Twitter: https://twitter.com/Glyph_AI
...
contract Glyph is ERC20, Ownable {
    ...
    constructor() ERC20("GlyphAi", unicode"$GAI") {
        ...
        maxTransactionAmount = 200 * 1e6 * 1e18; 
        maxWallet = 400 * 1e6 * 1e18; 
        ...
        devWallet = address(0x43136Cd33b33063447752D14FfBe0D61e406a120); 
