...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa01B85DC147220D6cAa6254283B09BbEdF82Fc15; // owner address
...
contract PAYCHAIN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"PAYCHAIN";
    string private _symbol = unicode"PAYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x852dBbED9470eC75B48ED4E91D6EcC53F8B1cB82); 
    address payable public teamWalletAddress = payable(0xa01B85DC147220D6cAa6254283B09BbEdF82Fc15);
