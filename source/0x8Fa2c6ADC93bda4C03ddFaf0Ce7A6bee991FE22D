...
contract AddLiquidity {
    address payable public feeRecipient = 0xa3738988c86aD78B589a13c5a4A6e05471b17C08;
    uint256 public feeAmount = 0.01 ether; 
    address public constant ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 
    constructor() public {}
 
    function BNBTiguLP (address _tokenA, uint256 _amountTokenA) external payable {
