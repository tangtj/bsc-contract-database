...
Twitter: https://twitter.com/Croshib001?s=20

 website: https://croshib.fun/

 TG: https://t.me/CROSHIBBSC
...
contract croshib is Context, IERC20, Ownable {
    ...
    string private _symbol = "CRSB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x0885C7521178E9eC0dcD904F46dd3a3ad3A58bd4);
    address payable public teamWalletAddress =
        payable(0x20207d27E8e1C957A481019e0022f67Ec508b122);
