// https://t.me/BigCoinOfficialChat
// https://twitter.com/bigcoin_bsc
// https://bigcoin.online
...
contract BigCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BIGCOIN";
    string private constant _symbol = unicode"$BGC";
