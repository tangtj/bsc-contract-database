...
contract LittleBull is Context, IERC20, Ownable {
    ...
    string private _name = "LittleBull";
    string private _symbol = "LB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF34eBC18aEFbC6feAa2e50DC680686bd505Bb097); // Marketing Address
    ...
    uint256 private _totalSupply = 100_000_000_000 * 10**18; //420 Billion Total Supply
    uint256 public _maxTransactionAmount =   1_000_000_000 * 10**18; // 1% Max Transaction Limit
    ...
    function TurnOnMaxTransaction() external onlyOwner() {
        _maxTransactionAmount =   4_200_000_000 * 10**18;
    }
