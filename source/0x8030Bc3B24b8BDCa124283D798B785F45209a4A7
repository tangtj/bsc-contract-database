...
contract Meowth is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xC206D447aEf3401555827C993eF58A22b9D057C9);
    address payable private _marketingAddress = payable(0xC206D447aEf3401555827C993eF58A22b9D057C9);
