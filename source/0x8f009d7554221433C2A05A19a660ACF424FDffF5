// https://www.McDollarADA.com
// https://www.twitter.com/McDollarADA
// https://t.me/McDollarADABSC
...
contract McDollarADA is IBEP20, Ownable {
    ...
    string private _name = "McDollarADA";
    string private _symbol = "MCADA";
    uint256 private constant INITIAL_SUPPLY = 100000000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 private constant INITIAL_MAX_WALLET = 8; //4%
    uint8 private constant INITIAL_MAX_SELL = 4; //2%
    uint8 private constant INITIAL_MAX_BUY = 4; //2%    
