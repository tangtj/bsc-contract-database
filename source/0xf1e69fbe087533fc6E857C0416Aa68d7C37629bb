...
contract AXESLABS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xCF10eE129314E6B7967aa2Fa059EE2E985A4D0DD;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Axes Labs";
    string constant _symbol = "AXS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xCF10eE129314E6B7967aa2Fa059EE2E985A4D0DD;
