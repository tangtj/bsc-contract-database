...
contract $XMEN is Context, IERC20, Ownable {
    ...
    string private _name = "$XMEN";
    string private _symbol = "$XMEN";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xB07e622f68F05D07B503BF6d3564d1E5Dc112Abc); 
    ...
    uint256 private _totalSupply = 30 *  10**8 * 10**_decimals;
