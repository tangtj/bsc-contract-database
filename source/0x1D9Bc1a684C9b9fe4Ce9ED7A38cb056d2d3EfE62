...
contract IRONMUSKWIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "IRON MUSK WIN";
    string private _symbol = "MuskW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x357b9052C7c2B234B87327c4e12caaD5640aD4B7);
    address payable public BurnedWalletAddress =
        payable(0x68b802800f75bb6014D9168a7A266CD9bC32Ce38);
