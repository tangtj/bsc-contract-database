...
//   ✅website:https://czai.space
//   ✅TG https://t.me/xczai100x
//   ✅launch Today 08/07 23:00 UTC
...
contract CzAiX is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 5000000 * _decimalFactor; // 3% do Supply
    uint256 public maxBuyAmount = 3000000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 1500000 * _decimalFactor; // 0.75% do Supply
