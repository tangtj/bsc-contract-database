...
contract Xi15 is ERC20, Ownable {
   ...
   //Contract Update Information
    ...
    address public marketingWallet = 0x7F372FBdB194f88F9466c8AAaA9d8551C16DAc43;
    address public developmentWallet = 0x58F01C69a865981Ed7105CCdABb0b7B8Cd58149E;
   ...
   mapping(address => bool) public exemptFee;
    ...
    function setLiquidityProvide(bool state) external onlyOwner {
    ...
    function setLiquidityTreshhold(uint256 new_amount) external onlyOwner {
     ...
     function SetBuyTaxes(uint256 _marketing,uint256 _liquidity,uint256 _development) external onlyOwner{
        ...
        require((_marketing + _liquidity + _development) <= 10, "Must keep fees at 10% or less");
    }
