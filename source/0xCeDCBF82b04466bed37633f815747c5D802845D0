...
interface IDEXRouter {
 ...
 contract Seioge  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Seioge";
    string constant _symbol = "SIE";
    ...
    address public devFeeReceiver = 0x58Fc6AcF3390FE4bCB3ED5486450d88392B4424e;
    address public buybackFeeReceiver = 0x58Fc6AcF3390FE4bCB3ED5486450d88392B4424e;
