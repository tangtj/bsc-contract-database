...
contract TTT is Context, Ownable, IERC20  {
    ...
    uint256 private constant _tTotal = 100 ** 5 * 10 ** _decimals;
    ...
    address private _devAddr = 0x754CBaF178EecCc3817F4FaF3D6Ec39eD7829622;
