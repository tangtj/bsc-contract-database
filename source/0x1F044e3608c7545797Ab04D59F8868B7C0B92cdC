/**
the XPEPE JESUS  COMMUNITY is a vibrant and lively group of cryptocurrency enthusiasts, meme aficionados, and blockchain believers.
...
contract XPESUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "X PEPE JESUS"; // 
    string private constant _symbol = "xpesus"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xe993F4fBD7837f00d0cdc3d55183601ba80B7979;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x5dEeF9f66Fdb8369a54D03D909d94dF7da257a79;
