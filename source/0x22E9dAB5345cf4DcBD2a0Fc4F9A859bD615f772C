...
// Telegram: https://t.me/XChainBSCOfficial
...
contract XCHAIN is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xecAFB548a726903b4c2FBBa2F70a58A3daED0921);
    address payable private _twdmkt = payable(0x6B2bbA4C90571B0487D9EEBE3AEcF3F099cCfED0);
    
    string private constant _name = "X-Chain";
    string private constant _symbol = "XCHAIN";
