...
contract WoofWoofWoof is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WOOF WOOF WOOF";
    string private _symbol = "WOOF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4AFd9841E310F76D8cbd1a2520cb9db712db8803);
    address payable private DevelopmentWalletAddress = payable(0x4AFd9841E310F76D8cbd1a2520cb9db712db8803);
