...
contract TeaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tea Inu";
    string private _symbol = "TeaInu";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC5162675dA86478a7EFAC4Eb0D12495052574cB0); 
    address payable public BurnedWalletAddress = payable(0xC5162675dA86478a7EFAC4Eb0D12495052574cB0); 
