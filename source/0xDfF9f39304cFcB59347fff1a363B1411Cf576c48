...
//--- Contract v2 ---//
contract XPayPal is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x18B20699ebE9F6dE46bEe08d59161c54Db6a8f4F);


    IRouter02 public swapRouter;
    string constant private _name = "XPayPal";
    string constant private _symbol = "PYUSD";
