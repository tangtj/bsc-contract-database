...
contract PKPK is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PKPK";
    ...
    IuniswapV2Router private uniswapXRouters;
    ...
    function openTrading() external onlyOwner() {
        require(!ejvwkjqre,"trading is already open");
        uniswapXRouters = IuniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _approve(address(this), address(uniswapXRouters), _tTotal);
        uniswapXPairs = IUniswapV2Factory(uniswapXRouters.factory()).createPair(address(this), uniswapXRouters.WETH());
