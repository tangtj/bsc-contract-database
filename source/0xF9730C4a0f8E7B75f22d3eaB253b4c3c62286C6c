...
contract PEPEMARS is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x06A8790DFb9EFbCbA8eDfaa56FAE27Cad40D62DE;

    string private constant _name = "PEPE MARS";
    string private constant _symbol = "PEPEMARS";
