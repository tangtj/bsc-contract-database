...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92A0f8A83dF83B2de59F70Af386E0790001E9363; // owner address
...
contract PEPEVsDORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE Vs DORK";
    string private _symbol = "PEDORK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x92A0f8A83dF83B2de59F70Af386E0790001E9363); // Marketing Address
    address payable private teamWalletAddress = payable(0x92A0f8A83dF83B2de59F70Af386E0790001E9363); // Team Address
