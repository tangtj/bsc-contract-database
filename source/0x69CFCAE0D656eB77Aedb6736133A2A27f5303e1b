...
contract CharlesMansonAlexJonesBeetlejuice1776Pitbull is ERC20, Ownable {
    ...
    constructor() ERC20("CharlesMansonAlexJonesBeetlejuice1776Pitbull", "ORORO") {
        ...
        devWallet = address(0xaa2e4C470a6714C84CD3E926790a1115474e651a); 
