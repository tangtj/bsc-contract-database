...
contract GLS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GLS COIN";
    ...
    address payable private marketingWalletAddress = payable(0xA3729a9b4d1E6F11da7750113Ae0e7C86614EE0F);
