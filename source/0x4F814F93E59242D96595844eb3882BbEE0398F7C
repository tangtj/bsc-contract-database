...
contract MetaKombat is Context, IERC20 {
    ...
    string constant private _name = "MetaKombat";
    string constant private _symbol = "Kombat";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x8403ec5cC17F095f8562C0b84354Ae10a1bD5178),
        development: payable(0x8403ec5cC17F095f8562C0b84354Ae10a1bD5178),
        liquidity: 0x8403ec5cC17F095f8562C0b84354Ae10a1bD5178
        });
...
//===============================================================================================================
    ...
    function setMaxTxPercent(uint256 percent) external onlyOwner {
        require(percent >= 10, "Max Transaction amt must be above 1% of circulating supply.");
        _maxTxAmountPercent = percent;
    }

    function setMaxWalletSize(uint256 percent) external onlyOwner {
        require(percent >= 10, "Max Wallet amt must be above 1% of total supply.");
