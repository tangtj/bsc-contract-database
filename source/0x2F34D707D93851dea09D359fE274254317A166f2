...
contract BabyBUSD is ERC20, Ownable {
    ...
    constructor() ERC20("BabyBUSD", "BBUSD") {
        marketingWallet = payable(0x85A7C9eFD01d78Ff801B5A280AF7218496d9b415);
        devWallet = payable(0x85A7C9eFD01d78Ff801B5A280AF7218496d9b415);
        ...
        maxWallet = totalTokenSupply /2 ; // 
        swapTokensAtAmount = totalTokenSupply / 20000; // 
...
contract BabyBUSDDividendTracker is DividendPayingToken, Ownable {
    ...
    BabyBUSD public BabyBUSDContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyBUSDContract = BabyBUSD(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "BabyBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyBUSD contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyBUSDContract);

            uint256 prevBalance = BabyBUSDContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyBUSDContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyBUSDContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
