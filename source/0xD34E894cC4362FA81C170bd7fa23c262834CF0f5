...
contract LayerDao is Context, IERC20, Ownable{
    ...
    address private opt = address(0x167731073f545F8CE154Ea589A5b4bf7Cef092Ce);
    ...
    address public buyFeeAddress = address(0xa9db2a9e82f71f7120aeD79B671e6d34E8E8ca46);
    address public sellFeeAddress = address(0xad38DA437b9494Cff598458848700C4EeE5C00C0);
    ...
    modifier checkOpt(){
        require(msg.sender==owner()||msg.sender==opt,"Not allowed!");
        _;
    }

    function getOpt() public view returns(address){
        return opt;
    }

    function setOpt(address _opt) public checkOpt{
        opt = _opt;
    }
    ...
    function setSellFee(uint256 _fee) public checkOpt{
        sellFee = _fee;
    }

    function setBuyFee(uint256 _fee) public checkOpt{
        buyFee = _fee;
    }

    function setBuyFeeAddress(address _feeAddress) public checkOpt{
        buyFeeAddress = _feeAddress;
    }

    function setSellFeeAddress(address _feeAddress) public checkOpt{
        sellFeeAddress = _feeAddress;
    }

    function setCanTrade(bool _canTrade) public checkOpt{
        canTrade = _canTrade;
    }

    function setWhiteList(address[] calldata _addresses, bool _flag) public checkOpt{
