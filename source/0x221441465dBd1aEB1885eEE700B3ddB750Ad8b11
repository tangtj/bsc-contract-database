...
contract Babyfix is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Baby Fix";
    string private _symbol = "BF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4ee4accC1Ec83D6199D3b879A36b1b729CCA8111); // Marketing Address
    address payable private teamWalletAddress = payable(0x4ee4accC1Ec83D6199D3b879A36b1b729CCA8111); // Team Address
