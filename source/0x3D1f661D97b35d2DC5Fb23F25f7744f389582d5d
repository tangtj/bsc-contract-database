...
contract BMWGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "BMW GROW"; // 
    string private constant _symbol = "BMWGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x493A0A3D6475Fce13BeBf3B04323dF2372873F62;
