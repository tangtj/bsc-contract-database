...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4906bb418082c01774039a16a6fCB8d9ce0c8b4E; // owner address
...
contract TOKEN1044 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1044";
    string private _symbol = "1044";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4906bb418082c01774039a16a6fCB8d9ce0c8b4E); // Marketing Address
    address payable private teamWalletAddress = payable(0x4906bb418082c01774039a16a6fCB8d9ce0c8b4E); // Team Address
