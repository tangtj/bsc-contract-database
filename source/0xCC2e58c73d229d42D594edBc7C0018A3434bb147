/**
   ...
   I make this #PUCCA to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #PUCCA to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #PUCCA 10000X? 
   ...
   it's the best part of the #PUCCA idea, increasing the liquidity pool automatically, 
