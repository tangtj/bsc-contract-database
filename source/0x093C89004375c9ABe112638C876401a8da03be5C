...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to https://t.me/MultiPlanetBSC
   ...
   I will renounce the ownership to burn addresses to transfer #MultiPlanet to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 20% total supply to the pool
   Can you make #MultiPlanet 10000X? 
   ...
   it's the best part of the #MultiPlanet idea, increasing the liquidity pool automatically, 
...
contract MultiPlanet is Context, IERC20, Ownable {
    ...
    string private _name = "MultiPlanet";
    string private _symbol = "MultiPlanet";
