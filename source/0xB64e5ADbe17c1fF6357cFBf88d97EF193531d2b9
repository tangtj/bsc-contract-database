...
contract PEPESMOKING is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xA31Ca78Ca45e9258eF603D580eFC08520EB44B2f);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        else  
        {
            ...
            if(recipient != uniswapV2Pair) {
                require(balanceOf(recipient) + amount <= _maxWalletLimit, "Exceeds the maxWalletSize.");
            }
