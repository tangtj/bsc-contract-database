...
interface IBEP20Sniper is IERC11 {
 ...
 contract BeaverFever is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "BeaverFever";
    string private _symbol = "BEFE";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xD5BEDE4D98C1C3fF2318Bf996BD05623002e3280;
    address private _water4Africa = 0xD5BEDE4D98C1C3fF2318Bf996BD05623002e3280;
