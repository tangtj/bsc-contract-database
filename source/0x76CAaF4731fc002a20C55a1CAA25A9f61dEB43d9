...
Group  : https://t.me/dickdickdickdickdickbsc
...
contract BIGDICK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBC07229a0240e3D9443292701Ff58e3e2BB3Fd35); 
    address payable public Wallet_Dev = payable(0xBC07229a0240e3D9443292701Ff58e3e2BB3Fd35);
    ...
    string private constant _name = "(__)(__)========D"; 
    string private constant _symbol = unicode"$DICKCOCKDICKCOCKDICKCOCK"; 
