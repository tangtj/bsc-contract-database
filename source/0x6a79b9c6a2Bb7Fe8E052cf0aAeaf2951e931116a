...
contract InvestroAI is IERC20 {
    ...
    string constant private _name = "InvestroAI";
    string constant private _symbol = "InAI";
    ...
    address payable public marketingWallet = payable(0x5d642374352ea7d42C7e12c9773a786cfc062FFc);
