...
// Telegram: https://t.me/Cyberiumlayer2
...
contract Cyberium is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x144C28FA9341d5b9Bf42f89A47697A9C333605A4);
    address payable private _twdmkt = payable(0x144C28FA9341d5b9Bf42f89A47697A9C333605A4);
    
    string private constant _name = "Cyberium";
    string private constant _symbol = "$CYUM";
