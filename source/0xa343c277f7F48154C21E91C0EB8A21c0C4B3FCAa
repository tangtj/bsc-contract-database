...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB20B5B3e611DE4969963771CA0b9101E15a5366A; // owner address
...
contract DOGEISFINE is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE IS FINE";
    string private _symbol = "D O G E";
