...
Telegram https://t.me/CounteriumOfficial
Twitter https://twitter.com/CounteriumOFC
...
contract Counterium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COUNTERIUM";
    string private _symbol = "$COUNT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6f34515dB53501C6B42Bd301228172fb86A03165); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5Cc589A67Ee46E648071184130947cb4952b40D0); // BuyBack Address
