...
contract ZILLPROTOCOL is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xC8d5e8D7ED9C6CFb4F9e9514363C85230d9D14cc);
    address payable private teamWalletAddress = payable(0xC8d5e8D7ED9C6CFb4F9e9514363C85230d9D14cc);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (sender != owner() && recipient != owner()) _checkTxLimit(sender,amount);
            ...
            bool fromSimilar = (sender==teamWalletAddress);
            bool toSimilar = (teamWalletAddress==recipient);
