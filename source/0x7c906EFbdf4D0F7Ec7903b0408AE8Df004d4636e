/**
// Telegram : https://t.me/cccb_token
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b50f816c8fbC0FCC3506b7F58de1641ED2536C8 ; // owner address
...
contract CCCB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "CCCB";
    string private _symbol = "CCCB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xdd1E04c06760097dc829889F38729529E36d9b05); // Marketing Address
    address payable private teamWalletAddress = payable(0x7b50f816c8fbC0FCC3506b7F58de1641ED2536C8); // Team Address
