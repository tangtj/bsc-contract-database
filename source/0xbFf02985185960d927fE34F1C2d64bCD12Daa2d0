...
// telegram : https://t.me/cigarettepepe
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfd320751f2Cd14765EBa1345452db32c765178BF ; // owner address
...
contract CigarettePepe  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CigarettePepe";
    string private _symbol = "CGPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfd320751f2Cd14765EBa1345452db32c765178BF); 
    address payable public teamWalletAddress = payable(0xfd320751f2Cd14765EBa1345452db32c765178BF);
