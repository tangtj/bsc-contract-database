...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9E2ce41fd57C4F524Dc79FcFEE07F72B4257EaAa; // owner address
...
contract Wapple is Context, IERC20, Ownable {
    ...
    string private _name = "Wapple";
    string private _symbol = "WAPPLE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x27448469F890d32e9bCE13840684F9a59C518133); // Marketing Address
    address payable private teamWalletAddress = payable(0x27448469F890d32e9bCE13840684F9a59C518133); // Team Address
