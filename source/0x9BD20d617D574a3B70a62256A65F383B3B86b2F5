...
contract LK99 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LK99 Token";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x3E52E0BFaDC7AF125a394b7ACF7DAe3F020FA0c2;  // marketingwallet
        lotteryWallet = 0x7D6FadB984A48433D15Fb26652D56f002Cdcd844;  // no tax for lotterywallet
