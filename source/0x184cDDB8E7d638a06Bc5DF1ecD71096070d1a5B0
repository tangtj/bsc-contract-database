...
contract BirdX is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BirdX"; 
    string private _symbol = unicode"BirdX";
    ...
    uint256 private _totalSupply = 888888 * 10**9;
    uint256 public _maxTxAmount = 8888 * 10**9;
    uint256 public _walletMax = 8888 * 10**9;
