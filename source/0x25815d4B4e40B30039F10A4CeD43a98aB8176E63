...
Telegram:   https://t.me/metadoctorcoin
...
contract MetaDoctorCoin is Context, IERC20, Ownable {
    ...
    string private _name = "MetaDoctor";
    string private _symbol = "MEDOC";
    ...
    address public marketingWallet = 0xfd979662118C954b8143935DD290D5418711B392;
    address public devWallet = 0xC2070a8D628d1b4185D0c31ADE40eDDB6B488E77;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000000 * 10**12;
    uint256 public _maxTxAmount = 1000000000000 * 10 **12;
   ...
   function takeDev(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private
    ...
    function prepareFoePresale() external onlyOwner() {
       ...
       _maxTxAmount = 1000000000000 * 10**12;
