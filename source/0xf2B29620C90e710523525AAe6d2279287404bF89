...
/**
*/  
// Community: https://t.me/PepeTiger_BEP20 
// TWITTER:                   
...
contract PEPE_TIGER is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x4aa936D612398Ef2F1a5C66d748E3C744936b9eB);
    address payable private _marketingAddress = payable(0x4aa936D612398Ef2F1a5C66d748E3C744936b9eB);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnSell < 75, "Tax cannot be more than 75.");
