...
contract LYC is ERC20 {
	...
	address payable _fundAddress = payable(address(0x68dc048a5AAc120795b329b78e29CA4644C9f9cc));
    address payable _marketAddress = payable(address(0x8eD1bd0f4f277C65d24C8419b555C98BCA1dc668));
    ...
    constructor(address tokenOwner) ERC20("LYC", "LYC") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            if(from == uniswapV2Pair){
                ...
                super._transfer(from, _marketAddress, amount.div(100).mul(marketFee));
                super._transfer(from, address(this), amount.div(100).mul(8));
                amount = amount.div(100).mul(92-marketFee);
            }
        }
        super._transfer(from, to, amount);
    }
