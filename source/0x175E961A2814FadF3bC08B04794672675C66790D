...
contract Reldexcoin is ERC20, ERC20Detailed, Pausable {
    ...
    constructor()
    ERC20Detailed("Reldex coin", "RDX COIN",18)
    {
        deployTime = block.timestamp;
        RemainingReward = 10600000*(10**18);
        _isExcluded[msg.sender] = true;
        _isExcluded[address(this)] = true;
        _mint(owner(),10500000*(10**18));
        _mint(address(this), 10600000*(10**18));
        tokenBalance = balanceOf(address(this));
        Duration= Duration.div(60);
        maxSupply =  21100000 *(10**18);
    }
