...
contract PEPEMOON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBd41a228d8383bC94a6F7E8b38ea770F8b5fF45A); 
    address payable public Wallet_Dev = payable(0xBd41a228d8383bC94a6F7E8b38ea770F8b5fF45A);
    ...
    string private constant _symbol = unicode"PEPE MOON"; 
    ...
    constructor () {
        _owner =0xBd41a228d8383bC94a6F7E8b38ea770F8b5fF45A;
