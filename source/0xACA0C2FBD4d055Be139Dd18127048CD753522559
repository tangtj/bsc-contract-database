...
contract sheikhshiba is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x09425493f039f1F58480E4536688212FF7754B4f;

    string private constant _name = "Sheikh Shiba";
    string private constant _symbol = "SHkB";
