/**
    ...
    TG: https://t.me/apeboxer
    Twitter: https://twitter.com/apeboxer
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x229f9a5EA830bAE392fE06DDb887b04D903f50e1; // owner address
...
contract APEBOXER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APE BOXER";
    string private _symbol = "APEBOXER";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x229f9a5EA830bAE392fE06DDb887b04D903f50e1); // Marketing Address
    address payable private teamWalletAddress = payable(0x229f9a5EA830bAE392fE06DDb887b04D903f50e1); // Team Address
