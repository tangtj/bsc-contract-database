...
// File: contracts/JETFUEL/interfaces/jetfuel/IFortressStrategy.sol
...
// File: contracts/JETFUEL/vaults/JetfuelFortressVaultBNB.sol

pragma solidity ^0.6.0;

/**
 * @title JetfuelVaultBNB
 * @author smart cookie
 * @dev Implementation of a custom vault to deposit exclusively BNB and WBNB on
 * the Fortress lending platform for yield optimizing.
 * This is the contract that receives funds and that users interface with.
 * The yield optimizing strategy itself is implemented in a separate contract.
 */
contract JetfuelFortressVaultBNB is ERC20, Ownable {
    ...
    IWBNB public constant wbnb = IWBNB(
    ...
    function balance() public view returns (uint256) {
        return available().add(IFortressStrategy(strategy).balanceOf());
    }
