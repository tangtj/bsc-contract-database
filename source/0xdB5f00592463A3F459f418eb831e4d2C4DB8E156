//Project: Token Runner (TKRN)
//Web: https://tokenrunner.net/
//Twitter: https://twitter.com/tokenrunner_net
//Telegram: http://t.me/tokenrunner
//Buy Tax: 1% Sell Tax: 2%
//Contract achieved "SAFU Validation" by InterFi
...
contract TKRN is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xEA14f20448ab358658d4951f2324dd671F0500d6);
    ...
    constructor () BEP20Detailed("Token Runner", "TKRN", 18) {
      _owner = msg.sender ;
