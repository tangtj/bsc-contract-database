// t.me/PalantirTokenizedStockDefichain 
// PalantirTokenizedStockDefichain.com
...
contract PalantirTokenizedStockDefichain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "PalantirTokenizedStockDefichain";
    string public symbol = "DPLTR";
