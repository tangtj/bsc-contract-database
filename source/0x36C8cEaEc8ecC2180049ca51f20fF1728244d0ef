// Telegram: https://t.me/trumpreturnscoin
//
...
contract TrumpR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trump Returns";
    string private _symbol = "Trump";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9514A142178461472fA1464dc72dC93A19cFcBd5); // Marketing Address
    address payable public developmentWalletAddress = payable(0x9514A142178461472fA1464dc72dC93A19cFcBd5); // Development Address
