/*
TG: https://t.me/+_WFCUgZKdWY2M2U0
*/
...
contract FineInu is Context, IERC20 {
    string private _name = "FINE INU";
    string private _symbol = "$FINEINU";
    ...
    address payable public MarketingWallet = payable(0x402C86a97F3b52eDDF53358C76750015cE1A9367);
