...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x731E83716689c3ca506Bae09c7BCE3E18770E3ca; // owner address
...
contract SucculentNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Succulent.Net";
    string private _symbol = "SCL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x731E83716689c3ca506Bae09c7BCE3E18770E3ca); // Marketing Address
    address payable private teamWalletAddress = payable(0x731E83716689c3ca506Bae09c7BCE3E18770E3ca); // Team Address
