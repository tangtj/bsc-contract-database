...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x99E7DcB65E807a4266cb35ff94d9059307b9A855; // owner address
...
contract SAFEMOON2049 is Context, IERC20, Ownable {
    ...
    string private _name = "SAFEMOON2049";
    string private _symbol = "SFM2049";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x99E7DcB65E807a4266cb35ff94d9059307b9A855); // Marketing Address
    address payable private teamWalletAddress = payable(0x99E7DcB65E807a4266cb35ff94d9059307b9A855); // Team Address
