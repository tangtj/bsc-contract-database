...
contract KINGDINO is ERC20, Ownable {
    ...
    constructor() ERC20("KINGDINO", "KINGDINO") {
        ...
        swapTokensAtAmount = totalSupply * 100 / 100; // 0.1% swap amount
        ...
        marketingAddress = 0x6670a1a7b48D0B8443157dfFA8e5eE2b249CE274;
