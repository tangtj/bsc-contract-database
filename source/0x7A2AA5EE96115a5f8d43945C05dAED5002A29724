...
contract SJB is ERC20, Ownable {
    ...
    constructor
    (
         address payable mAddress,  address payable pAddress
    ) payable ERC20("SJB","SJB")  {
        rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        _mAddress = payable(mAddress);
        _AddressP=payable(pAddress);
        SJBTracker=0x642B97BCe05bB766f1119A6Ca1F80F9a8318F7DA;
        ...
        dividendTracker = BABYTOKENDividendTracker(
            payable(Clones.clone(SJBTracker))
        );
        ...
        dividendTracker.excludeFromDividends(_AddressP);
        dividendTracker.excludeFromDividends(_mAddress);
        dividendTracker.excludeFromDividends(address(_uniswapV2Router));

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(_mAddress, true);
        excludeFromFees(_AddressP, true);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        _mAddress.transfer(transferredBalance);
