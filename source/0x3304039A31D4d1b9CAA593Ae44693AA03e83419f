...
// [Telegram]   https://t.me/dopaminexyzbsc
// [CertiK]     https://skynet.certik.com/projects
// [Website]    Dopamine.io
// [Twitter]    https://twitter.com/dopaminexyz_?utm_source=certik
...
contract Dopamine is Context, IERC20, Ownable {
    ...
    string private _name = "DOPADRUGSMINE";
    string private _symbol = "$dopamine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8cD0B45d2841EbE3D74583F03a179eBBF3925F5b); // Marketing Address
    address payable public teamWalletAddress = payable(0x8cD0B45d2841EbE3D74583F03a179eBBF3925F5b); // Team Address
