        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x4e0F07C31398AEb3653563D8A433d0c225CE6edC), block.timestamp
                );
            }
        }
    }
...
contract shepecoin is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000000,//Supply
        address(0x5Ae6C1DAf6fF42572e4fda7759Fc388A1f02404A),//FundAddress
        address(0x4e0F07C31398AEb3653563D8A433d0c225CE6edC)//ReceiveAddress
    ){
    }
}