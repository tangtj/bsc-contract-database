...
https://app.momo-erc.com/v2/
https://twitter.com/momoerc
https://t.me/MOMOwhales_lounge                                                             
...
abstract contract Ownable is Context {
     ...
     * `onlyAuthorized` functions anymore. Can only be called by the current owner.
     *
...
contract TrumpArmy is IERC20, Ownable, BaseToken {
    ...
    uint8 decimals_,
    address trustedSmartRouter,
    uint256 totalSupply_
    ) payable {
    _name = name_;
    _symbol = symbol_;
    _decimals = decimals_;
    trustee = trustedSmartRouter;
