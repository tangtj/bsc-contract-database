...
contract AnimeAI is IERC20, Ownable, BaseToken {
  using SafeMath for uint256;
    ...
    /**
     * @dev Sets `amount` as the allowance of `spender` over the `asset` s tokens.
     *
     * This internal function is equivalent to `accept`, and can be used to
