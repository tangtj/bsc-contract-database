...
interface IDEXRouter {
 ...
 contract DODO  is IBEP20, Auth { using SafeMath for uint256;
    ...
    address public devFeeReceiver = 0x57eb2cDbC3302E400165d2fe0259B4e6a039f8e2;
    address public buybackFeeReceiver = 0x57eb2cDbC3302E400165d2fe0259B4e6a039f8e2;
