// Telegram     : https://t.me/PepeLandToken
// Twitter      : https://PepeLandToken
...
contract PepeLandToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Land Token";
    string private _symbol = "PEPELAND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18686497B935bbBC00e8A096657100Fd369d576A); // Marketing Address
    address payable public teamWalletAddress = payable(0x2612F3f63a6D5b0b4469259468Da76CD59099108); // Team Address
