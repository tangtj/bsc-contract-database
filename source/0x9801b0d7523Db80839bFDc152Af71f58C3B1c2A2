...
contract Solidar is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Solidar Token";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            require(
                airdropRecipients[from] || airdropRecipients[to],
                "Transfer allowed only for airdrop recipients"
            );
