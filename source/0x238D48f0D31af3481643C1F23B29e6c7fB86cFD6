...
contract SToken is ExcludedFromFeeList, LpDividendBNB, BlackList, FirstLaunch, MaxHave {
    ...
    address public lpReceiver = address(0xeFA789e00DbBe556B146f86aB9e64524EEf4Ad4C);

    address constant marketAddr = address(0x807c82d0283b9fe5D2519a76E47CEc56F15cb2B1); //5‰
    ...
    function swapTokensForBNB(uint256 tokenAmount) internal {
        ...
        uint256 amountBNB = address(this).balance;
        uint256 marketBNB = marketFee / toSwap;
        uint256 lpBNB = lpFee / toSwap;
    ...
    address constant _receiver = address(0x4EbE3eED5323fac9D2cec4A5B2Ab5f859B7D8ee3);

    constructor() Owned(msg.sender) ERC20("MOON", "MOON", 18, total) {
