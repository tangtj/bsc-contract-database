...
contract LuckyBabyOkx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyBabyOkx";
    string private _symbol = "LuckyBabyOkx";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCffE177009Ae6f93442878d51d685E62Fe540C0B); // Marketing Address
    address payable public teamWalletAddress = payable(0xBC15B4548f26643be57f6B82eA2639704457b42f); // Team Address
