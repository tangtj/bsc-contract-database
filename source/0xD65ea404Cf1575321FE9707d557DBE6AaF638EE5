...
contract SHITTY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x45a474F628842FB52552B7499e65690E9f557009); 
    address payable public Wallet_Dev = payable(0x45a474F628842FB52552B7499e65690E9f557009);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100 * 10**3* 10**3 * 10**_decimals;
    string private constant _name = "the shitty token"; 
    string private constant _symbol = unicode"$shitty_token_bullish_chart_no_jeet_trust_it"; 
    ...
    constructor () {
        _owner =0x95BdCA4Ad3A7043663F3dbC7E495D33d7B8a20d6;
