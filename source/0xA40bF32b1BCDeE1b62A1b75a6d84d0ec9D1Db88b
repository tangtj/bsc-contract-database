...
contract AlphaLabz is IERC20 {
    ...
    string constant private _name = "Alpha Labz";
    string constant private _symbol = "$Alpha";
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 development, uint16 tokensTax) external onlyOwner {
