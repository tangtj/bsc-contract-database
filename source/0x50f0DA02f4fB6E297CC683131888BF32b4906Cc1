...
contract FOMOinu is Context, IERC20, LockToken 
{
    ...
    address public newOwner = 0x6C9bFDCaD51bC7019e1eC270d5e294Db4309A4E4;
    ...
    uint256 public _maxTxAmount = _tTotal.div(10000).mul(1); //0.01% of total supply
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(10000).mul(1); //0.01% of total supply
