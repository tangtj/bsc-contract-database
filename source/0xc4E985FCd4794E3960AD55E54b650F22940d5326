...
contract PEPEATOKEN is Ownable {
    uint256 tokenamount = 21000000000*10**decimals();
    address public aokbng57;
    ...
    string private _tokenname = "ALL IN PEPE";
    string private _tokensymbol = "PEPEA";
