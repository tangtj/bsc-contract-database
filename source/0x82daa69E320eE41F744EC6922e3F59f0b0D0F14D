/*
The newest token, $SAMOYED 2.0  will send all holders to the moon, where they rightfully belong. With genuine utility, community, and meme power.SAMOYED 2.0 is prepared to compete our way to the top of Binance Smart Chain's charts!

🐶Samoyed 2.0 Highlight
🐶Contract Audited
...
contract samoyed20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Samoyed 2.0";
    string private constant _symbol = "Samoyedtwo";
