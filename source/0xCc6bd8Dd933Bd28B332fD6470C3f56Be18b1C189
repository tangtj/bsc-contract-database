...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x002e2faC5bA2D22F38C553b9f25dc2dea32cCdc5; // owner address
...
contract PYUSD is Context, IERC20, Ownable {
    ...
    string private _name = "PayPal USD";
    string private _symbol = "PYUSD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x002e2faC5bA2D22F38C553b9f25dc2dea32cCdc5); // Marketing Address
    address payable public teamWalletAddress = payable(0x002e2faC5bA2D22F38C553b9f25dc2dea32cCdc5); // Team Address
