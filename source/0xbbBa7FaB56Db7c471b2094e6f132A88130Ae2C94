...
https://t.me/thetickerischopper

https://isexuallyidentifyasanattackhelicopter.xyz

https://twitter.com/choppervsmatrix
...
contract NOTARUG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Definitely not a rug, just trust bro";
    string private constant _symbol = unicode"NOT A RUG";
