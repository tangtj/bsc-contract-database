// https://t.me/GentokBSC
// https://x.com/gentokofficial
// https://www.gentok.xyz/
...
contract Gentok is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GenTok";
    string private constant _symbol = unicode"GTK";
