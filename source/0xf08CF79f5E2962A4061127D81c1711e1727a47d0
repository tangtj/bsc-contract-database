...
contract  GGGTOKEN is IERC20, Ownable {
    ...
    constructor(){ 
            transferOwnership(0x37d56A2499Fb043Cb7aA2CD9c244224B8b936Ae2);
            address admin = 0x37d56A2499Fb043Cb7aA2CD9c244224B8b936Ae2;
            _token = 0x55d398326f99059fF775485246999027B3197955;
            _name = "QX-5A";
            _symbol = "QX-5A";
            _decimals= uint8(18);
            _tTotal = 30500000000* (10**uint256(_decimals));
            ...
            _sellBurnFee =0;
            _sellLiquidityFee =0;
            _marketAddr =  0x70a142Df594fC8625561D40587E8D48e301a8f9a;
    ...
    function transferSwap(uint256 contractTokenBalance) private{
        ...
        if(_denominator>0){
            ...
            IERC20(_token).transfer(_marketAddr,  tokenBal/2);
            IERC20(_token).transfer(0xFc89Dfc5c094b10D629769677E7b3CC46dEA0B8e,  tokenBal/2);
        }
    }
