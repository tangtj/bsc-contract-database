...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5E9245c7e4f3F62Fc38fa890F7F882b01e094Edd;
...
contract FRMG is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3263f20Fb7d20924C66259f212Ab0d2d9eD47bF5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Omelette du Fromage";
    string private _symbol = "FRMG";
