...
Coco Network-COCO // L1 Blockchain Project 

Telegram: https://t.me/CoCo_Network
Website: https://coconetwork.io
*/
...
library Address{
 ...
 contract CocoNetwork is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8A71704f93270E9E36Db5Dfbb22C1fd5B317F53e;
    address public developmentWallet = 0x8A71704f93270E9E36Db5Dfbb22C1fd5B317F53e;

    string private constant _name = "Coco Network";
    ...
    Taxes public taxes = Taxes(0, 18, 0, 2);
    Taxes public sellTaxes = Taxes(0, 18, 0, 2);
