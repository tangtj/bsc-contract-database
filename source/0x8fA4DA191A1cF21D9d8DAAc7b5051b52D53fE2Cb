...
contract SpotPlayArena is ERC20, Ownable {
    ...
    constructor () ERC20("SpotPlayArena Games", "SPAG") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x5829E968ff6A923Cd4B37f69e72452227B97cb56; 
