...
/**
Telegram: https://t.me/cheemsxtoken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3386821cdb33B4786274d804CaC26F13A70EE9B7; // owner address
...
contract CheemsX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"CheemsX";
    string private _symbol = unicode"CheemsX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3386821cdb33B4786274d804CaC26F13A70EE9B7); 
    address payable public teamWalletAddress = payable(0x3386821cdb33B4786274d804CaC26F13A70EE9B7);
