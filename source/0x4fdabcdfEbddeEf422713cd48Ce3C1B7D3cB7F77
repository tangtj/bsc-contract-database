...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf2EC9977c364774b8b1F2b3a51503fe8cEE2B006;
...
contract daddypepe  is Context, IERC20, Ownable {
    ...
    address private  _marketingWalletAddress = 0x3D3b73DCEE091FaF852EAdE119349e5351E77527;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420690000 * 1**6 * 10**9;
