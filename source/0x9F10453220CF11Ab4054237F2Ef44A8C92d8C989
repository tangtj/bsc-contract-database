...
https://twitter.com/BinanceCatOFC
https://binancecat.fun
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD0983bf944604efBBB9a5fF4E7362537008f0654; 
...
contract BinanceCat is Context, IERC20, Ownable {
    ...
    string private _name = "Binance Cat";
    string private _symbol = "BCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD0983bf944604efBBB9a5fF4E7362537008f0654); 
    address payable public teamWalletAddress = payable(0xD0983bf944604efBBB9a5fF4E7362537008f0654); 
