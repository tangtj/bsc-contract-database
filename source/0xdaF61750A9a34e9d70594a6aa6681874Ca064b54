...
contract MetaETH is IERC20 {
    ...
    string constant private _name = "Meta ETH";
    string constant private _symbol = "METAETH";
    ...
    // ETH MAINNET TOKEN CONTRACT ADDRESS
    address public ETH = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x974Fbea399154a9071CA3E678C505CeeA6a918DE),
        development: payable(0x974Fbea399154a9071CA3E678C505CeeA6a918DE)
    });
...
//===============================================================================================================
    ...
    function setOperator(address newOperator) external {
        require(_owner != address(0), "Cannot call after renouncement.");
