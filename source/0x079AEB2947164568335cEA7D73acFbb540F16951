...
contract quadrilliondollar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUADRILLION DOLLAR";
    string private _symbol = "QUADDOLAR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCAaD1Ce6585619B823B06fbDd7bAdc851784964B);
    address payable private DevelopmentWalletAddress = payable(0xCAaD1Ce6585619B823B06fbDd7bAdc851784964B);
