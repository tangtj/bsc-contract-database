/**
   Embark on a crypto adventure like no other 
   with Baby Bitcoin Token. It´s a fun way to 
   introduce the world of blockchain.
  TELEGRAM: https://t.me/BabyBitcoin_BSC
*/
...
contract BABYBITCOIN is Context, IBEP2022, Ownable {
