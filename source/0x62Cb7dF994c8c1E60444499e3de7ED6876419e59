/**
Telegram: https://t.me/FINEbsc

Twitter: https://twitter.com/thisisFINE_BNB

Website: https://www.thisisFINEbnb.com
*/
...
contract FINE is IBEP20, Auth {
    ...
    address DEV = 0xFff9F871f47553Ef2AcDC1Adac712eC6E2C61DDf;

    string constant _name = "FINE";
    string constant _symbol = "FINE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 42069 * 10**6 * 10**_decimals;
