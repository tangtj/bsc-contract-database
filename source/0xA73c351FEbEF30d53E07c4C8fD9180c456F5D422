...
contract gameF is ERC721Enumerable, Ownable, Pausable {
    using SafeMath for uint256;
    using Strings for uint256;

    string private constant _baseTokenURI = "https://ipfs.io/ipfs/QmTTNkVoo7hhhvFHbbDoei8orEDgqDYoFPG2HY1j3EMNYv/"; 
    IERC20 public constant paymentToken = IERC20(0x0d166f32A921b1F2F2338A3dD9f24e7b6D84c929);
    address public constant LOST_REWARDS_ADDRESS = 0xB669502Fd92D1b12B64e3A65bc5F8F2fC6c0767E;
    ...
    uint256 public constant REWARD_RATE = 400; 
    uint256 public constant REWARD_RATE_PER_SECOND = REWARD_RATE * 10**9 / SECONDS_IN_A_DAY;
    ...
    function getPendingReward(address account) public view returns (uint256) {
        ...
        return stakedDurationInSeconds.mul(REWARD_RATE_PER_SECOND);
    }
