...
contract Shiborium is Context, IERC20, Ownable {
    ...
    //https://t.me/ShiboriumChain /
    string private constant _name = "SHIBORIUM";

    string private constant _symbol = "SHIBORIUM";
