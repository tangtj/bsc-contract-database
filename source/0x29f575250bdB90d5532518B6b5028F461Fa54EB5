...
/**
 *SNIPE Bulk sender contract
 *Website: snipers.snipefinance.com
 *Team: www.snipefinance.com
*/
...
// File: snipeFinance.sol


pragma solidity 0.8.13;


contract SnipeFinanceMultisender is Ownable {
    ...
    function SNIPETOKENmultisender(
        //ICustomERC20 REPLACED WITH ERC20
        IERC20 token,
        address[] memory recipients,
        uint256[] memory values
    ) external payable tokenChecker {
