...
/**
    WEBSITE: http://zillprotocol.web.app

    TWITTER: https://twitter.com/zillprotocol

    TELEGRAM: https://t.me/Zillprotocol
*/
...
/**
    TG: https://t.me/homersimpsonportalmain
*/
...
contract zillprotocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zill Protocol";
    string private _symbol = "$ZLPTCL";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9Ce5bDc03C87Ef252625bb7Fa5B5671e113f772c);
    address payable public teamWalletAddress = payable(0x9Ce5bDc03C87Ef252625bb7Fa5B5671e113f772c);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
      ...
      function ExcludeInFee( mapping(
        ...
        _feefree[address(teamWalletAddress)] = t;
    }
