...
*/
/**
https://t.me/Layer_Protocol_Portal
https://twitter.com/LayerProtocol1
...
contract LayerProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Layer Protocol";
    string private _symbol = "$LPRO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFf4A7Bc2C76265BBfdf078baFcFC5b9fd855Ed18);
    address payable private DevelopmentWalletAddress = payable(0xFf4A7Bc2C76265BBfdf078baFcFC5b9fd855Ed18);
