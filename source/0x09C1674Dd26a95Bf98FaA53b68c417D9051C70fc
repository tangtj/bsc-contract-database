...
contract GANAR is GANARDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GANARTeam;
    address private CharityGANAR;
    ...
    string public override name = "GANAR";
    string public override symbol = "GANAR";
    ...
    constructor(uint totalSupplyValue, address GANARTeamAddress, address CharityGANARAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GANARTeam = GANARTeamAddress;
        CharityGANAR = CharityGANARAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GANARTeam] =  totalSupply * 4 / 100;
        balances[CharityGANAR] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GANARTeam pot
