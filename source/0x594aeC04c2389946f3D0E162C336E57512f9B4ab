...
contract DiziGoldCoin is ERC20Burnable, Ownable {
    ...
    constructor() ERC20('Dizi Gold Coin', 'DGC') {
    ...
    // Function to check if buying is allowed
    function isBuyingEnabled() external view returns (bool) {
        return buyingEnabled;
    }

    // Function to check if selling is allowed
    function isSellingEnabled() external view returns (bool) {
