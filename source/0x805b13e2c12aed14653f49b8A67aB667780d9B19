/**
 *Submitted for verification at BscScan.com on 2022-06-0101
*/
...
contract LBB is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public rewardYield = 425208;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 50 * 10**9 * 10**DECIMALS;
    ...
    address public liquidityReceiver = 0xeb80e0B58b2325bDa13d59759022D6e92648AD38;
    address public treasuryReceiver = 0xdc6580F3d88cdEC5098B2075b1DbfEC6a92f2A3E;
    address public riskFreeValueReceiver = 0xD948b3c75BeCc305665eA425D9B7822E01746caA;
    ...
    constructor() ERC20Detailed("LockPaybaby", "LBB", uint8(DECIMALS)) {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (
            ...
            require(amount <= onePercent, "ERR: Can't sell more than 2%");
            ...
            if( blkTime > tradeData[sender].lastTradeTime + TwentyFourhours) {
                ...
                require(tradeData[sender].tradeAmount + amount <= onePercent, "ERR: Can't sell more than 2% in One day");
