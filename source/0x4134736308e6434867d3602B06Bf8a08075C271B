...
contract HJOS10Inu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "HarryJeetterObamaSonic10Inu";
    ...
    address payable public devWalletAddress =
        payable(0x8D17997Eb441c9b4e405eE8E2E9afdB08305033D);
    address payable public teamWalletAddress =
        payable(0xdEb0A843B6Bc3b026a54284b83cd9978b644d7f1);
    ...
    uint256 public _buyTotalFees = 10;
    uint256 public _sellTotalFees = 20;

    uint256 public _liquidityShare = 0;
    uint256 public _marketingShare = 2000;
    uint256 public _teamShare = 2000;
    uint256 public _totalDistributionShares = 1000;

    uint256 public _totalSupply = 420069 * 1e9 * 10 ** _decimals;
    ...
    function setFees(
        ...
        require(buyTotalFees <= 15 && sellTotalFees <= 15); // cant set buy and sell fee above 15%
