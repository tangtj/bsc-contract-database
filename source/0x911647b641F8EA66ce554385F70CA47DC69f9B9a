...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2297Fd5c9F4782C21ed7855a23440EB8eBcBFbFE; // owner address
...
contract CCDCDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDC DAO";
    string private _symbol = "CCDC DAO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2297Fd5c9F4782C21ed7855a23440EB8eBcBFbFE); // Marketing Address
    address payable private teamWalletAddress = payable(0x2297Fd5c9F4782C21ed7855a23440EB8eBcBFbFE); // Team Address
