...
contract FifteenDollar is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x99b2b528F6788F936185ac472e2DdF1D246Fe345);
    address payable private _twdmkt = payable(0x99b2b528F6788F936185ac472e2DdF1D246Fe345);
    
    string private constant _name = "15 Dollar LP";
    string private constant _symbol = "15DOLLAR";
