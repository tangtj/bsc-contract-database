...
// telegram     : https://t.me/animemagicbsc
...
contract AnimeMagicBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anime Magic Bot";
    string private _symbol = "$AMBot";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x293C5af8dDfB2201E86aCcFE01E17AD73d115292); // Marketing Address
    address payable public teamWalletAddress = payable(0x293C5af8dDfB2201E86aCcFE01E17AD73d115292); // Team Address
