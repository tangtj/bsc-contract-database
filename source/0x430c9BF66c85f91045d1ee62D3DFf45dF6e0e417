...
//Telegram :https://t.me/frogarmnewcommunity
...
contract FrogArm is Context, IERC20, Ownable {
    ...
    string private _name = "Frog Arm";
    string private _symbol = "FRGARM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A3F67Fd0b1f00C251aB0001f1BcC86b1465d06a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1A3F67Fd0b1f00C251aB0001f1BcC86b1465d06a); // BuyBack Address
